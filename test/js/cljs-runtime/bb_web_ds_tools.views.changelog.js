 ...
 */
bb_web_ds_tools.views.changelog.changelog_item = (function bb_web_ds_tools$views$changelog$changelog_item(p__30759){
var map__30760 = p__30759;
var map__30760__$1 = cljs.core.__destructure_map(map__30760);
var version = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30760__$1,new cljs.core.Keyword(null,"version","version",425292698));
var date = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30760__$1,new cljs.core.Keyword(null,"date","date",-1463434462));
var sections = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30760__$1,new cljs.core.Keyword(null,"sections","sections",-886710106));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"bg-[#4f4f4f] border-l-4 border-[#8cd0d3] p-6 mb-6 rounded-r-lg shadow-md"], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex items-center justify-between mb-4"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3","h3",2067611163),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-2xl font-bold text-[#f0dfaf]"], null),["v",cljs.core.str.cljs$core$IFn$_invoke$arity$1(version)].join('')], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-[#9f9f9f] text-sm"], null),date], null)], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$changelog$changelog_item_$_iter__30761(s__30762){
return (new cljs.core.LazySeq(null,(function (){
var s__30762__$1 = s__30762;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__30762__$1);
if(temp__5825__auto__){
var s__30762__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__30762__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__30762__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__30764 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__30763 = (0);
while(true){
if((i__30763 < size__5502__auto__)){
var map__30765 = cljs.core._nth(c__5501__auto__,i__30763);
var map__30765__$1 = cljs.core.__destructure_map(map__30765);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30765__$1,new cljs.core.Keyword(null,"title","title",636505583));
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30765__$1,new cljs.core.Keyword(null,"items","items",1031954938));
cljs.core.chunk_append(b__30764,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"mb-4 last:mb-0"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h4","h4",2004862993),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-lg font-semibold text-[#8cd0d3] mb-2"], null),title], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul","ul",-1349521403),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"list-disc list-inside text-[#dcdccc] space-y-1"], null),(function (){var iter__5503__auto__ = ((function (i__30763,map__30765,map__30765__$1,title,items,c__5501__auto__,size__5502__auto__,b__30764,s__30762__$2,temp__5825__auto__,map__30760,map__30760__$1,version,date,sections){
return (function bb_web_ds_tools$views$changelog$changelog_item_$_iter__30761_$_iter__30766(s__30767){
return (new cljs.core.LazySeq(null,((function (i__30763,map__30765,map__30765__$1,title,items,c__5501__auto__,size__5502__auto__,b__30764,s__30762__$2,temp__5825__auto__,map__30760,map__30760__$1,version,date,sections){
return (function (){
var s__30767__$1 = s__30767;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__30767__$1);
if(temp__5825__auto____$1){
var s__30767__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__30767__$2)){
var c__5501__auto____$1 = cljs.core.chunk_first(s__30767__$2);
var size__5502__auto____$1 = cljs.core.count(c__5501__auto____$1);
var b__30769 = cljs.core.chunk_buffer(size__5502__auto____$1);
if((function (){var i__30768 = (0);
while(true){
if((i__30768 < size__5502__auto____$1)){
var item = cljs.core._nth(c__5501__auto____$1,i__30768);
cljs.core.chunk_append(b__30769,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"leading-relaxed"], null),item], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),item], null)));

var G__30788 = (i__30768 + (1));
i__30768 = G__30788;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30769),bb_web_ds_tools$views$changelog$changelog_item_$_iter__30761_$_iter__30766(cljs.core.chunk_rest(s__30767__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30769),null);
}
} else {
var item = cljs.core.first(s__30767__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"leading-relaxed"], null),item], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),item], null)),bb_web_ds_tools$views$changelog$changelog_item_$_iter__30761_$_iter__30766(cljs.core.rest(s__30767__$2)));
}
} else {
return null;
}
...
});})(i__30763,map__30765,map__30765__$1,title,items,c__5501__auto__,size__5502__auto__,b__30764,s__30762__$2,temp__5825__auto__,map__30760,map__30760__$1,version,date,sections))
,null,null));
});})(i__30763,map__30765,map__30765__$1,title,items,c__5501__auto__,size__5502__auto__,b__30764,s__30762__$2,temp__5825__auto__,map__30760,map__30760__$1,version,date,sections))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30764),bb_web_ds_tools$views$changelog$changelog_item_$_iter__30761(cljs.core.chunk_rest(s__30762__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30764),null);
}
} else {
var map__30773 = cljs.core.first(s__30762__$2);
var map__30773__$1 = cljs.core.__destructure_map(map__30773);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30773__$1,new cljs.core.Keyword(null,"title","title",636505583));
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30773__$1,new cljs.core.Keyword(null,"items","items",1031954938));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"mb-4 last:mb-0"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h4","h4",2004862993),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-lg font-semibold text-[#8cd0d3] mb-2"], null),title], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul","ul",-1349521403),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"list-disc list-inside text-[#dcdccc] space-y-1"], null),(function (){var iter__5503__auto__ = ((function (map__30773,map__30773__$1,title,items,s__30762__$2,temp__5825__auto__,map__30760,map__30760__$1,version,date,sections){
return (function bb_web_ds_tools$views$changelog$changelog_item_$_iter__30761_$_iter__30774(s__30775){
return (new cljs.core.LazySeq(null,(function (){
var s__30775__$1 = s__30775;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__30775__$1);
if(temp__5825__auto____$1){
var s__30775__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__30775__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__30775__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__30777 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__30776 = (0);
while(true){
if((i__30776 < size__5502__auto__)){
var item = cljs.core._nth(c__5501__auto__,i__30776);
cljs.core.chunk_append(b__30777,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"leading-relaxed"], null),item], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),item], null)));

var G__30792 = (i__30776 + (1));
i__30776 = G__30792;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30777),bb_web_ds_tools$views$changelog$changelog_item_$_iter__30761_$_iter__30774(cljs.core.chunk_rest(s__30775__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30777),null);
}
} else {
var item = cljs.core.first(s__30775__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"leading-relaxed"], null),item], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),item], null)),bb_web_ds_tools$views$changelog$changelog_item_$_iter__30761_$_iter__30774(cljs.core.rest(s__30775__$2)));
}
} else {
return null;
}
...
});})(map__30773,map__30773__$1,title,items,s__30762__$2,temp__5825__auto__,map__30760,map__30760__$1,version,date,sections))
;
return iter__5503__auto__(items);
})()], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),title], null)),bb_web_ds_tools$views$changelog$changelog_item_$_iter__30761(cljs.core.rest(s__30762__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30781),bb_web_ds_tools$views$changelog$panel_$_iter__30778(cljs.core.chunk_rest(s__30779__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30781),null);
}
} else {
var item = cljs.core.first(s__30779__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.changelog.changelog_item,item], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"version","version",425292698).cljs$core$IFn$_invoke$arity$1(item)], null)),bb_web_ds_tools$views$changelog$panel_$_iter__30778(cljs.core.rest(s__30779__$2)));
}
} else {
return null;
}
