...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28573),"#",reitit.impl.form_encode(fragment)].join('');
} else {
return G__28573;
}
} else {
...
if(cljs.core.every_QMARK_((function (p1__28589_SHARP_){
return cljs.core.contains_QMARK_(path_params,p1__28589_SHARP_);
