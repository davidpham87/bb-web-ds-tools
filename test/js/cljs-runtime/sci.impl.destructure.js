...
var G__41729 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__41730 = n;
var G__41731 = cljs.core.nnext(bs);
var G__41732 = true;
ret = G__41729;
n = G__41730;
bs = G__41731;
seen_rest_QMARK_ = G__41732;
continue;
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__41713_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__5025__auto__ = mkns;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return cljs.core.namespace(p1__41713_SHARP_);
}
})(),cljs.core.name(p1__41713_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__41714_SHARP_){
...
return cljs.core.namespace(p1__41714_SHARP_);
}
})(),cljs.core.name(p1__41714_SHARP_)),null,(1),null)),(2),null));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__41715_SHARP_,p2__41716_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__41715_SHARP_,p2__41716_SHARP_,(function (){var fexpr__41721 = cljs.core.val(entry);
return (fexpr__41721.cljs$core$IFn$_invoke$arity$1 ? fexpr__41721.cljs$core$IFn$_invoke$arity$1(p2__41716_SHARP_) : fexpr__41721.call(null,p2__41716_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__41722 = cljs.core.key(entry);
return (fexpr__41722.cljs$core$IFn$_invoke$arity$1 ? fexpr__41722.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__41722.call(null,bes));
})());
...
var G__41743 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__41744 = cljs.core.next(bes);
ret = G__41743;
bes = G__41744;
continue;
} else {
...
var temp__5823__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__41717_SHARP_){
return (cljs.core.first(p1__41717_SHARP_) instanceof cljs.core.Keyword);
}),bents));
