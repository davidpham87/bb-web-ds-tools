...
var G__36046 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__36047 = n;
var G__36048 = cljs.core.nnext(bs);
var G__36049 = true;
ret = G__36046;
n = G__36047;
bs = G__36048;
seen_rest_QMARK_ = G__36049;
continue;
} else {
...
var G__36051 = (n + (1));
var G__36052 = cljs.core.next(bs);
var G__36053 = seen_rest_QMARK_;
ret = G__36050;
n = G__36051;
bs = G__36052;
seen_rest_QMARK_ = G__36053;
continue;
}
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__36028_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__5025__auto__ = mkns;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return cljs.core.namespace(p1__36028_SHARP_);
}
})(),cljs.core.name(p1__36028_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__36029_SHARP_){
...
return cljs.core.namespace(p1__36029_SHARP_);
}
})(),cljs.core.name(p1__36029_SHARP_)),null,(1),null)),(2),null));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__36030_SHARP_,p2__36031_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__36030_SHARP_,p2__36031_SHARP_,(function (){var fexpr__36041 = cljs.core.val(entry);
return (fexpr__36041.cljs$core$IFn$_invoke$arity$1 ? fexpr__36041.cljs$core$IFn$_invoke$arity$1(p2__36031_SHARP_) : fexpr__36041.call(null,p2__36031_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__36042 = cljs.core.key(entry);
return (fexpr__36042.cljs$core$IFn$_invoke$arity$1 ? fexpr__36042.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__36042.call(null,bes));
})());
...
var G__36054 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__36055 = cljs.core.next(bes);
ret = G__36054;
bes = G__36055;
continue;
} else {
...
var temp__5823__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__36032_SHARP_){
return (cljs.core.first(p1__36032_SHARP_) instanceof cljs.core.Keyword);
}),bents));
