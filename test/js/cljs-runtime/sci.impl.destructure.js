...
var G__35951 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__35952 = n;
var G__35953 = cljs.core.nnext(bs);
var G__35954 = true;
ret = G__35951;
n = G__35952;
bs = G__35953;
seen_rest_QMARK_ = G__35954;
continue;
} else {
...
var G__35956 = (n + (1));
var G__35957 = cljs.core.next(bs);
var G__35958 = seen_rest_QMARK_;
ret = G__35955;
n = G__35956;
bs = G__35957;
seen_rest_QMARK_ = G__35958;
continue;
}
...
})(),cljs.core.name(p1__35932_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__35933_SHARP_){
...
return cljs.core.namespace(p1__35933_SHARP_);
}
})(),cljs.core.name(p1__35933_SHARP_)),null,(1),null)),(2),null));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__35937_SHARP_,p2__35938_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__35937_SHARP_,p2__35938_SHARP_,(function (){var fexpr__35948 = cljs.core.val(entry);
return (fexpr__35948.cljs$core$IFn$_invoke$arity$1 ? fexpr__35948.cljs$core$IFn$_invoke$arity$1(p2__35938_SHARP_) : fexpr__35948.call(null,p2__35938_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__35949 = cljs.core.key(entry);
return (fexpr__35949.cljs$core$IFn$_invoke$arity$1 ? fexpr__35949.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__35949.call(null,bes));
})());
...
var G__35959 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__35960 = cljs.core.next(bes);
ret = G__35959;
bes = G__35960;
continue;
} else {
...
var temp__5823__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__35939_SHARP_){
return (cljs.core.first(p1__35939_SHARP_) instanceof cljs.core.Keyword);
}),bents));
