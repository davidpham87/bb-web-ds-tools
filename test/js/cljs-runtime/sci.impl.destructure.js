...
var G__36043 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__36044 = n;
var G__36045 = cljs.core.nnext(bs);
var G__36046 = true;
ret = G__36043;
n = G__36044;
bs = G__36045;
seen_rest_QMARK_ = G__36046;
continue;
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__36000_SHARP_,p2__36001_SHARP_,(function (){var fexpr__36040 = cljs.core.val(entry);
return (fexpr__36040.cljs$core$IFn$_invoke$arity$1 ? fexpr__36040.cljs$core$IFn$_invoke$arity$1(p2__36001_SHARP_) : fexpr__36040.call(null,p2__36001_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__36041 = cljs.core.key(entry);
return (fexpr__36041.cljs$core$IFn$_invoke$arity$1 ? fexpr__36041.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__36041.call(null,bes));
})());
...
var G__36051 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__36052 = cljs.core.next(bes);
ret = G__36051;
bes = G__36052;
continue;
} else {
...
var temp__5823__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__36007_SHARP_){
return (cljs.core.first(p1__36007_SHARP_) instanceof cljs.core.Keyword);
}),bents));
