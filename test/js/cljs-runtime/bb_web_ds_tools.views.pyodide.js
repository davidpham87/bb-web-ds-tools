 ...
 */
bb_web_ds_tools.views.pyodide.initial_code = (function (){var import_fn = (function (p1__34077_SHARP_,p2__34078_SHARP_){
return ["import ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__34077_SHARP_),(cljs.core.truth_(p2__34078_SHARP_)?[" as ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p2__34078_SHARP_)].join(''):null)].join('');
});
var install_fn = (function (p1__34080_SHARP_){
return ["await micropip.install(\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__34080_SHARP_),"\")"].join('');
});
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34089__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34089__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34089__$1,new cljs.core.Keyword(null,"value","value",305978217));
var G__34091 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(type);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-code","bb-web-ds-tools.views.pyodide/set-code",-948832189),(function (db,p__34124){
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-loading","bb-web-ds-tools.views.pyodide/set-loading",-844163320),(function (db,p__34132){
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-ready","bb-web-ds-tools.views.pyodide/set-ready",-104921681),(function (db,p__34139){
var vec__34140 = p__34139;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34140,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34140,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-error","bb-web-ds-tools.views.pyodide/set-error",-1241619023),(function (db,p__34145){
var vec__34146 = p__34145;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34146,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34146,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","on-ready","bb-web-ds-tools.views.pyodide/on-ready",1916532562),(function (p__34152,_){
var map__34153 = p__34152;
var map__34153__$1 = cljs.core.__destructure_map(map__34153);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34153__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","run-code","bb-web-ds-tools.views.pyodide/run-code",-897547225),(function (_,p__34163){
var vec__34165 = p__34163;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34165,(0),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34165,(1),null);
...
})], null),"Run"], null)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),["flex-grow rounded overflow-hidden border ",bb_web_ds_tools.theme.border_default].join(''),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"height","height",1025178622),"85vh"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.editor.monaco_editor,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"value","value",305978217),code,new cljs.core.Keyword(null,"language","language",-1591107564),"python",new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"rulers","rulers",756731282),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(80)], null),new cljs.core.Keyword(null,"lineNumbers","lineNumbers",1374890941),"off"], null),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__34170_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-code","bb-web-ds-tools.views.pyodide/set-code",-948832189),p1__34170_SHARP_], null));
}),new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840),(function (p1__34173_SHARP_){
return bb_web_ds_tools.components.editor.setup_editor_actions(p1__34173_SHARP_,mac_os_QMARK_,(function (c){
