 ...
 */
bb_web_ds_tools.views.pyodide.initial_code = (function (){var import_fn = (function (p1__49650_SHARP_,p2__49651_SHARP_){
return ["import ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__49650_SHARP_),(cljs.core.truth_(p2__49651_SHARP_)?[" as ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p2__49651_SHARP_)].join(''):null)].join('');
});
var install_fn = (function (p1__49652_SHARP_){
return ["await micropip.install(\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__49652_SHARP_),"\")"].join('');
});
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","handle-dataset-update","bb-web-ds-tools.views.pyodide/handle-dataset-update",-1582082681),(function (p__49653,p__49654){
var map__49655 = p__49653;
var map__49655__$1 = cljs.core.__destructure_map(map__49655);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49655__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__49656 = p__49654;
...
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49659__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49659__$1,new cljs.core.Keyword(null,"value","value",305978217));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","handle-dataset-delete","bb-web-ds-tools.views.pyodide/handle-dataset-delete",-1207199684),(function (p__49660,p__49661){
var map__49662 = p__49660;
var map__49662__$1 = cljs.core.__destructure_map(map__49662);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49662__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__49663 = p__49661;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49663,(0),null);
var map__49666 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49663,(1),null);
var map__49666__$1 = cljs.core.__destructure_map(map__49666);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49666__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49667__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49667__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49667__$1,new cljs.core.Keyword(null,"value","value",305978217));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49667__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var G__49668 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(type);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","initialize","bb-web-ds-tools.views.pyodide/initialize",-110047080),(function (p__49675,_){
var map__49676 = p__49675;
var map__49676__$1 = cljs.core.__destructure_map(map__49676);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49676__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),cljs.core.assoc_in((function (){var G__49678 = db;
if(cljs.core.not(exists_QMARK_)){
return cljs.core.assoc_in(G__49678,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"pyodide","pyodide",-2009894763),new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","code","bb-web-ds-tools.views.pyodide/code",-1315684971)], null),bb_web_ds_tools.views.pyodide.initial_code);
} else {
return G__49678;
}
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-code","bb-web-ds-tools.views.pyodide/set-code",-948832189),(function (db,p__49682){
var vec__49683 = p__49682;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49683,(0),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-loading","bb-web-ds-tools.views.pyodide/set-loading",-844163320),(function (db,p__49686){
var vec__49687 = p__49686;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49687,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49687,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-ready","bb-web-ds-tools.views.pyodide/set-ready",-104921681),(function (db,p__49696){
var vec__49697 = p__49696;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49697,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49697,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","on-ready","bb-web-ds-tools.views.pyodide/on-ready",1916532562),(function (p__49701,_){
var map__49702 = p__49701;
var map__49702__$1 = cljs.core.__destructure_map(map__49702);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49702__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","run-code","bb-web-ds-tools.views.pyodide/run-code",-897547225),(function (_,p__49704){
var vec__49705 = p__49704;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49705,(0),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49705,(1),null);
...
var len__5749__auto___49776 = arguments.length;
var i__5750__auto___49777 = (0);
while(true){
if((i__5750__auto___49777 < len__5749__auto___49776)){
args__5755__auto__.push((arguments[i__5750__auto___49777]));

var G__49778 = (i__5750__auto___49777 + (1));
i__5750__auto___49777 = G__49778;
continue;
} else {
}
break;
...
(bb_web_ds_tools.views.pyodide.internal_view.cljs$core$IFn$_invoke$arity$variadic = (function (datasets,p__49737){
var vec__49738 = p__49737;
var map__49741 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49738,(0),null);
var map__49741__$1 = cljs.core.__destructure_map(map__49741);
var header_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49741__$1,new cljs.core.Keyword(null,"header-content","header-content",-2015916786));
...
}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (this$,p__49752){
var vec__49753 = p__49752;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49753,(0),null);
var old_datasets = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49753,(1),null);
...
var G__49782__delegate = function (datasets__$1,p__49756){
var vec__49757 = p__49756;
var map__49760 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49757,(0),null);
var map__49760__$1 = cljs.core.__destructure_map(map__49760);
var header_content__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49760__$1,new cljs.core.Keyword(null,"header-content","header-content",-2015916786));
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"w-full rounded mb-4"], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_col,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"h-full w-full p-2 space-y-2"], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"justify-between"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"items-center gap-2"], null),(function (){var or__5025__auto__ = header_content__$1;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.label,"Python Code"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.help_button,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"href","href",-793805698),bb_web_ds_tools.components.navigation.get_wiki_url(new cljs.core.Keyword(null,"code","code",1586293142)),new cljs.core.Keyword(null,"title","title",636505583),"Help: Python (Pyodide)",new cljs.core.Keyword(null,"class","class",-2030961996),"!p-1 !w-5 !h-5 opacity-50 hover:opacity-100 mb-2"], null)], null)], null);
}
...
})], null),"Run"], null)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),["flex-grow rounded overflow-hidden border  ",bb_web_ds_tools.theme.border_default].join(''),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"height","height",1025178622),"85vh"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.editor.monaco_editor,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"value","value",305978217),code,new cljs.core.Keyword(null,"language","language",-1591107564),"python",new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"rulers","rulers",756731282),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(80)], null),new cljs.core.Keyword(null,"lineNumbers","lineNumbers",1374890941),"off"], null),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__49709_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-code","bb-web-ds-tools.views.pyodide/set-code",-948832189),p1__49709_SHARP_], null));
}),new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840),(function (p1__49733_SHARP_){
return bb_web_ds_tools.components.editor.setup_editor_actions(p1__49733_SHARP_,mac_os_QMARK_,(function (c){
...
var G__49782 = function (datasets__$1,var_args){
var p__49756 = null;
if (arguments.length > 1) {
var G__49795__i = 0, G__49795__a = new Array(arguments.length -  1);
while (G__49795__i < G__49795__a.length) {G__49795__a[G__49795__i] = arguments[G__49795__i + 1]; ++G__49795__i;}
  p__49756 = new cljs.core.IndexedSeq(G__49795__a,0,null);
} 
return G__49782__delegate.call(this,datasets__$1,p__49756);};
G__49782.cljs$lang$maxFixedArity = 1;
G__49782.cljs$lang$applyTo = (function (arglist__49796){
var datasets__$1 = cljs.core.first(arglist__49796);
var p__49756 = cljs.core.rest(arglist__49796);
return G__49782__delegate(datasets__$1,p__49756);
});
...
/** @this {Function} */
(bb_web_ds_tools.views.pyodide.internal_view.cljs$lang$applyTo = (function (seq49735){
var G__49736 = cljs.core.first(seq49735);
var seq49735__$1 = cljs.core.next(seq49735);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49736,seq49735__$1);
}));
...
var args__5755__auto__ = [];
var len__5749__auto___49800 = arguments.length;
var i__5750__auto___49801 = (0);
while(true){
if((i__5750__auto___49801 < len__5749__auto___49800)){
args__5755__auto__.push((arguments[i__5750__auto___49801]));

var G__49805 = (i__5750__auto___49801 + (1));
i__5750__auto___49801 = G__49805;
continue;
} else {
}
break;
...
(bb_web_ds_tools.views.pyodide.panel.cljs$core$IFn$_invoke$arity$variadic = (function (p__49762){
var vec__49763 = p__49762;
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49763,(0),null);
...
var G__49806__delegate = function (p__49766){
var vec__49767 = p__49766;
var props__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49767,(0),null);
...
while (G__49807__i < G__49807__a.length) {G__49807__a[G__49807__i] = arguments[G__49807__i + 0]; ++G__49807__i;}
  p__49766 = new cljs.core.IndexedSeq(G__49807__a,0,null);
} 
return G__49806__delegate.call(this,p__49766);};
G__49806.cljs$lang$maxFixedArity = 0;
G__49806.cljs$lang$applyTo = (function (arglist__49808){
var p__49766 = cljs.core.seq(arglist__49808);
return G__49806__delegate(p__49766);
});
...
/** @this {Function} */
(bb_web_ds_tools.views.pyodide.panel.cljs$lang$applyTo = (function (seq49761){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq49761));
}));
