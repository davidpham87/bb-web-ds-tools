 ...
 */
bb_web_ds_tools.views.pyodide.initial_code = (function (){var import_fn = (function (p1__33954_SHARP_,p2__33956_SHARP_){
return ["import ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__33954_SHARP_),(cljs.core.truth_(p2__33956_SHARP_)?[" as ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p2__33956_SHARP_)].join(''):null)].join('');
});
var install_fn = (function (p1__33959_SHARP_){
return ["await micropip.install(\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__33959_SHARP_),"\")"].join('');
});
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33963__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33963__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33963__$1,new cljs.core.Keyword(null,"value","value",305978217));
var G__33964 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(type);
var G__33964__$1 = (((G__33964 instanceof cljs.core.Keyword))?G__33964.fqn:null);
switch (G__33964__$1) {
case "ready":
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","initialize","bb-web-ds-tools.views.pyodide/initialize",-110047080),(function (p__33984,_){
var map__33986 = p__33984;
var map__33986__$1 = cljs.core.__destructure_map(map__33986);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33986__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),cljs.core.assoc_in((function (){var G__33990 = db;
if(cljs.core.not(exists_QMARK_)){
return cljs.core.assoc_in(G__33990,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"pyodide","pyodide",-2009894763),new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","code","bb-web-ds-tools.views.pyodide/code",-1315684971)], null),bb_web_ds_tools.views.pyodide.initial_code);
} else {
return G__33990;
}
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-code","bb-web-ds-tools.views.pyodide/set-code",-948832189),(function (db,p__34015){
var vec__34017 = p__34015;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34017,(0),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-loading","bb-web-ds-tools.views.pyodide/set-loading",-844163320),(function (db,p__34024){
var vec__34025 = p__34024;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34025,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34025,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-ready","bb-web-ds-tools.views.pyodide/set-ready",-104921681),(function (db,p__34039){
var vec__34041 = p__34039;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34041,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34041,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-error","bb-web-ds-tools.views.pyodide/set-error",-1241619023),(function (db,p__34045){
var vec__34046 = p__34045;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34046,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34046,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","on-ready","bb-web-ds-tools.views.pyodide/on-ready",1916532562),(function (p__34053,_){
var map__34054 = p__34053;
var map__34054__$1 = cljs.core.__destructure_map(map__34054);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34054__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","run-code","bb-web-ds-tools.views.pyodide/run-code",-897547225),(function (_,p__34057){
var vec__34061 = p__34057;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34061,(0),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34061,(1),null);
...
})], null),"Run"], null)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),["flex-grow rounded overflow-hidden border ",bb_web_ds_tools.theme.border_default].join(''),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"height","height",1025178622),"85vh"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.editor.monaco_editor,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"value","value",305978217),code,new cljs.core.Keyword(null,"language","language",-1591107564),"python",new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"rulers","rulers",756731282),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(80)], null),new cljs.core.Keyword(null,"lineNumbers","lineNumbers",1374890941),"off"], null),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__34083_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-code","bb-web-ds-tools.views.pyodide/set-code",-948832189),p1__34083_SHARP_], null));
}),new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840),(function (p1__34085_SHARP_){
return bb_web_ds_tools.components.editor.setup_editor_actions(p1__34085_SHARP_,mac_os_QMARK_,(function (c){
