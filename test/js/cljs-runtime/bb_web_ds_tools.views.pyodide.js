...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","handle-dataset-update","bb-web-ds-tools.views.pyodide/handle-dataset-update",-1582082681),(function (p__32530,p__32531){
var map__32532 = p__32530;
var map__32532__$1 = cljs.core.__destructure_map(map__32532);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32532__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__32533 = p__32531;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32533,(0),null);
var map__32536 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32533,(1),null);
var map__32536__$1 = cljs.core.__destructure_map(map__32536);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32536__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32536__$1,new cljs.core.Keyword(null,"value","value",305978217));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","handle-dataset-delete","bb-web-ds-tools.views.pyodide/handle-dataset-delete",-1207199684),(function (p__32537,p__32538){
var map__32539 = p__32537;
var map__32539__$1 = cljs.core.__destructure_map(map__32539);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32539__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__32540 = p__32538;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32540,(0),null);
var map__32543 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32540,(1),null);
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32545__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32545__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32545__$1,new cljs.core.Keyword(null,"value","value",305978217));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32545__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var G__32550 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(type);
var G__32550__$1 = (((G__32550 instanceof cljs.core.Keyword))?G__32550.fqn:null);
switch (G__32550__$1) {
case "ready":
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","initialize","bb-web-ds-tools.views.pyodide/initialize",-110047080),(function (p__32551,_){
var map__32553 = p__32551;
var map__32553__$1 = cljs.core.__destructure_map(map__32553);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32553__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),cljs.core.assoc_in((function (){var G__32554 = db;
if(cljs.core.not(exists_QMARK_)){
return cljs.core.assoc_in(G__32554,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"pyodide","pyodide",-2009894763),new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","code","bb-web-ds-tools.views.pyodide/code",-1315684971)], null),bb_web_ds_tools.views.pyodide.initial_code);
} else {
return G__32554;
}
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-code","bb-web-ds-tools.views.pyodide/set-code",-948832189),(function (db,p__32556){
var vec__32557 = p__32556;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32557,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32557,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-loading","bb-web-ds-tools.views.pyodide/set-loading",-844163320),(function (db,p__32564){
var vec__32565 = p__32564;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32565,(0),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-ready","bb-web-ds-tools.views.pyodide/set-ready",-104921681),(function (db,p__32568){
var vec__32569 = p__32568;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32569,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32569,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","on-ready","bb-web-ds-tools.views.pyodide/on-ready",1916532562),(function (p__32572,_){
var map__32573 = p__32572;
var map__32573__$1 = cljs.core.__destructure_map(map__32573);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32573__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","run-code","bb-web-ds-tools.views.pyodide/run-code",-897547225),(function (_,p__32575){
var vec__32576 = p__32575;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32576,(0),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32576,(1),null);
...
var len__5749__auto___32642 = arguments.length;
var i__5750__auto___32643 = (0);
while(true){
if((i__5750__auto___32643 < len__5749__auto___32642)){
args__5755__auto__.push((arguments[i__5750__auto___32643]));

var G__32644 = (i__5750__auto___32643 + (1));
i__5750__auto___32643 = G__32644;
continue;
} else {
}
break;
...
(bb_web_ds_tools.views.pyodide.internal_view.cljs$core$IFn$_invoke$arity$variadic = (function (datasets,p__32588){
var vec__32589 = p__32588;
var map__32592 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32589,(0),null);
var map__32592__$1 = cljs.core.__destructure_map(map__32592);
var header_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32592__$1,new cljs.core.Keyword(null,"header-content","header-content",-2015916786));
...
}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (this$,p__32596){
var vec__32597 = p__32596;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32597,(0),null);
var old_datasets = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32597,(1),null);
...
var G__32646__delegate = function (datasets__$1,p__32600){
var vec__32601 = p__32600;
var map__32604 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32601,(0),null);
var map__32604__$1 = cljs.core.__destructure_map(map__32604);
var header_content__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32604__$1,new cljs.core.Keyword(null,"header-content","header-content",-2015916786));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.tool_view.tool_view,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"title","title",636505583),"Python Code",new cljs.core.Keyword(null,"wiki-key","wiki-key",-1495409073),new cljs.core.Keyword(null,"code","code",1586293142),new cljs.core.Keyword(null,"editor","editor",-989377770),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.editor.monaco_editor,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"value","value",305978217),code,new cljs.core.Keyword(null,"language","language",-1591107564),"python",new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"rulers","rulers",756731282),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(80)], null),new cljs.core.Keyword(null,"lineNumbers","lineNumbers",1374890941),"off"], null),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__32581_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-code","bb-web-ds-tools.views.pyodide/set-code",-948832189),p1__32581_SHARP_], null));
}),new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840),(function (p1__32582_SHARP_){
return bb_web_ds_tools.components.editor.setup_editor_actions(p1__32582_SHARP_,mac_os_QMARK_,(function (c){
...
var G__32646 = function (datasets__$1,var_args){
var p__32600 = null;
if (arguments.length > 1) {
var G__32647__i = 0, G__32647__a = new Array(arguments.length -  1);
while (G__32647__i < G__32647__a.length) {G__32647__a[G__32647__i] = arguments[G__32647__i + 1]; ++G__32647__i;}
  p__32600 = new cljs.core.IndexedSeq(G__32647__a,0,null);
} 
return G__32646__delegate.call(this,datasets__$1,p__32600);};
G__32646.cljs$lang$maxFixedArity = 1;
G__32646.cljs$lang$applyTo = (function (arglist__32648){
var datasets__$1 = cljs.core.first(arglist__32648);
var p__32600 = cljs.core.rest(arglist__32648);
return G__32646__delegate(datasets__$1,p__32600);
});
...
/** @this {Function} */
(bb_web_ds_tools.views.pyodide.internal_view.cljs$lang$applyTo = (function (seq32586){
var G__32587 = cljs.core.first(seq32586);
var seq32586__$1 = cljs.core.next(seq32586);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32587,seq32586__$1);
}));
...
var args__5755__auto__ = [];
var len__5749__auto___32649 = arguments.length;
var i__5750__auto___32650 = (0);
while(true){
if((i__5750__auto___32650 < len__5749__auto___32649)){
args__5755__auto__.push((arguments[i__5750__auto___32650]));

var G__32651 = (i__5750__auto___32650 + (1));
i__5750__auto___32650 = G__32651;
continue;
} else {
}
break;
...
(bb_web_ds_tools.views.pyodide.panel.cljs$core$IFn$_invoke$arity$variadic = (function (p__32610){
var vec__32611 = p__32610;
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32611,(0),null);
...
var G__32652__delegate = function (p__32618){
var vec__32619 = p__32618;
var props__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32619,(0),null);
...
while (G__32653__i < G__32653__a.length) {G__32653__a[G__32653__i] = arguments[G__32653__i + 0]; ++G__32653__i;}
  p__32618 = new cljs.core.IndexedSeq(G__32653__a,0,null);
} 
return G__32652__delegate.call(this,p__32618);};
G__32652.cljs$lang$maxFixedArity = 0;
G__32652.cljs$lang$applyTo = (function (arglist__32654){
var p__32618 = cljs.core.seq(arglist__32654);
return G__32652__delegate(p__32618);
});
...
/** @this {Function} */
(bb_web_ds_tools.views.pyodide.panel.cljs$lang$applyTo = (function (seq32608){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq32608));
}));
