 ...
 */
bb_web_ds_tools.views.pyodide.initial_code = (function (){var import_fn = (function (p1__34081_SHARP_,p2__34082_SHARP_){
return ["import ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__34081_SHARP_),(cljs.core.truth_(p2__34082_SHARP_)?[" as ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p2__34082_SHARP_)].join(''):null)].join('');
});
var install_fn = (function (p1__34084_SHARP_){
return ["await micropip.install(\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__34084_SHARP_),"\")"].join('');
});
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34093__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34093__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34093__$1,new cljs.core.Keyword(null,"value","value",305978217));
var G__34096 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(type);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","initialize","bb-web-ds-tools.views.pyodide/initialize",-110047080),(function (p__34117,_){
var map__34118 = p__34117;
var map__34118__$1 = cljs.core.__destructure_map(map__34118);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34118__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),cljs.core.assoc_in((function (){var G__34119 = db;
if(cljs.core.not(exists_QMARK_)){
return cljs.core.assoc_in(G__34119,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"pyodide","pyodide",-2009894763),new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","code","bb-web-ds-tools.views.pyodide/code",-1315684971)], null),bb_web_ds_tools.views.pyodide.initial_code);
} else {
return G__34119;
}
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-code","bb-web-ds-tools.views.pyodide/set-code",-948832189),(function (db,p__34146){
var vec__34148 = p__34146;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34148,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34148,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-loading","bb-web-ds-tools.views.pyodide/set-loading",-844163320),(function (db,p__34155){
var vec__34156 = p__34155;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34156,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34156,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-ready","bb-web-ds-tools.views.pyodide/set-ready",-104921681),(function (db,p__34161){
var vec__34163 = p__34161;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34163,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34163,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-error","bb-web-ds-tools.views.pyodide/set-error",-1241619023),(function (db,p__34176){
var vec__34178 = p__34176;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34178,(0),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","on-ready","bb-web-ds-tools.views.pyodide/on-ready",1916532562),(function (p__34184,_){
var map__34186 = p__34184;
var map__34186__$1 = cljs.core.__destructure_map(map__34186);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34186__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","run-code","bb-web-ds-tools.views.pyodide/run-code",-897547225),(function (_,p__34195){
var vec__34197 = p__34195;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34197,(0),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34197,(1),null);
...
})], null),"Run"], null)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),["flex-grow rounded overflow-hidden border ",bb_web_ds_tools.theme.border_default].join(''),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"height","height",1025178622),"85vh"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.editor.monaco_editor,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"value","value",305978217),code,new cljs.core.Keyword(null,"language","language",-1591107564),"python",new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"rulers","rulers",756731282),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(80)], null),new cljs.core.Keyword(null,"lineNumbers","lineNumbers",1374890941),"off"], null),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__34219_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-code","bb-web-ds-tools.views.pyodide/set-code",-948832189),p1__34219_SHARP_], null));
}),new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840),(function (p1__34220_SHARP_){
return bb_web_ds_tools.components.editor.setup_editor_actions(p1__34220_SHARP_,mac_os_QMARK_,(function (c){
