 ...
 */
bb_web_ds_tools.views.pyodide.initial_code = (function (){var import_fn = (function (p1__52109_SHARP_,p2__52110_SHARP_){
return ["import ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__52109_SHARP_),(cljs.core.truth_(p2__52110_SHARP_)?[" as ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p2__52110_SHARP_)].join(''):null)].join('');
});
var install_fn = (function (p1__52112_SHARP_){
return ["await micropip.install(\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__52112_SHARP_),"\")"].join('');
});
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52137__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52137__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52137__$1,new cljs.core.Keyword(null,"value","value",305978217));
var G__52140 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(type);
var G__52140__$1 = (((G__52140 instanceof cljs.core.Keyword))?G__52140.fqn:null);
switch (G__52140__$1) {
case "ready":
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","initialize","bb-web-ds-tools.views.pyodide/initialize",-110047080),(function (p__52145,_){
var map__52146 = p__52145;
var map__52146__$1 = cljs.core.__destructure_map(map__52146);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52146__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),cljs.core.assoc_in((function (){var G__52149 = db;
if(cljs.core.not(exists_QMARK_)){
return cljs.core.assoc_in(G__52149,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"pyodide","pyodide",-2009894763),new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","code","bb-web-ds-tools.views.pyodide/code",-1315684971)], null),bb_web_ds_tools.views.pyodide.initial_code);
} else {
return G__52149;
}
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-code","bb-web-ds-tools.views.pyodide/set-code",-948832189),(function (db,p__52161){
var vec__52162 = p__52161;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52162,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52162,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-loading","bb-web-ds-tools.views.pyodide/set-loading",-844163320),(function (db,p__52166){
var vec__52168 = p__52166;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52168,(0),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-ready","bb-web-ds-tools.views.pyodide/set-ready",-104921681),(function (db,p__52173){
var vec__52174 = p__52173;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52174,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52174,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-error","bb-web-ds-tools.views.pyodide/set-error",-1241619023),(function (db,p__52177){
var vec__52179 = p__52177;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52179,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52179,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","on-ready","bb-web-ds-tools.views.pyodide/on-ready",1916532562),(function (p__52183,_){
var map__52185 = p__52183;
var map__52185__$1 = cljs.core.__destructure_map(map__52185);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52185__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","run-code","bb-web-ds-tools.views.pyodide/run-code",-897547225),(function (_,p__52203){
var vec__52205 = p__52203;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52205,(0),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52205,(1),null);
...
})], null),"Run"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),["flex-grow rounded overflow-hidden border ",bb_web_ds_tools.theme.border_default].join(''),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"height","height",1025178622),"85vh"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.editor.monaco_editor,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"value","value",305978217),code,new cljs.core.Keyword(null,"language","language",-1591107564),"python",new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"rulers","rulers",756731282),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(80)], null),new cljs.core.Keyword(null,"lineNumbers","lineNumbers",1374890941),"off"], null),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__52208_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.pyodide","set-code","bb-web-ds-tools.views.pyodide/set-code",-948832189),p1__52208_SHARP_], null));
}),new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840),(function (p1__52209_SHARP_){
return bb_web_ds_tools.components.editor.setup_editor_actions(p1__52209_SHARP_,mac_os_QMARK_,(function (c){
