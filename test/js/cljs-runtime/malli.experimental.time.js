...
var map__60194__$1 = cljs.core.__destructure_map(map__60194);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60194__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60194__$1,new cljs.core.Keyword(null,"max","max",61366548));
...
malli.experimental.time._temporal_schema = (function malli$experimental$time$_temporal_schema(p__60195){
var map__60196 = p__60195;
var map__60196__$1 = cljs.core.__destructure_map(map__60196);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60196__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60196__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var type_properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60196__$1,new cljs.core.Keyword(null,"type-properties","type-properties",-1728352126));
return malli.core._simple_schema((function (){var G__60197 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),type,new cljs.core.Keyword(null,"pred","pred",1927423397),(function malli$experimental$time$_temporal_schema_$_pred(x){
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60197,new cljs.core.Keyword(null,"type-properties","type-properties",-1728352126),type_properties);
} else {
return G__60197;
}
})());
...
return malli.core._simple_schema(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("time","zone-id","time/zone-id",56799337),new cljs.core.Keyword(null,"pred","pred",1927423397),(function (p1__60200_SHARP_){
return (p1__60200_SHARP_ instanceof malli.experimental.time.ZoneId);
})], null));
});
malli.experimental.time._zone_offset_schema = (function malli$experimental$time$_zone_offset_schema(){
return malli.core._simple_schema(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("time","zone-offset","time/zone-offset",1887712823),new cljs.core.Keyword(null,"pred","pred",1927423397),(function (p1__60201_SHARP_){
return (p1__60201_SHARP_ instanceof malli.experimental.time.ZoneOffset);
