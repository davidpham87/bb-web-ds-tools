...
if(cljs.core.truth_((function (){var fexpr__29119 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["Mac68K",null,"Macintosh",null,"MacPPC",null,"MacIntel",null], null), null);
return (fexpr__29119.cljs$core$IFn$_invoke$arity$1 ? fexpr__29119.cljs$core$IFn$_invoke$arity$1(platform) : fexpr__29119.call(null,platform));
})())){
return new cljs.core.Keyword("portal.shortcuts","osx","portal.shortcuts/osx",300522451);
} else {
if(cljs.core.truth_((function (){var fexpr__29120 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["WinCE",null,"Windows",null,"Win32",null,"Win64",null], null), null);
return (fexpr__29120.cljs$core$IFn$_invoke$arity$1 ? fexpr__29120.cljs$core$IFn$_invoke$arity$1(platform) : fexpr__29120.call(null,platform));
})())){
...
var G__29139 = cljs.core.PersistentHashSet.createAsIfByAssoc([portal.shortcuts.event__GT_key(e)]);
var G__29139__$1 = (cljs.core.truth_(e.ctrlKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__29139,"control"):G__29139);
var G__29139__$2 = (cljs.core.truth_(e.metaKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__29139__$1,"meta"):G__29139__$1);
var G__29139__$3 = (cljs.core.truth_(e.shiftKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__29139__$2,"shift"):G__29139__$2);
if(cljs.core.truth_(e.altKey)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__29139__$3,"alt");
} else {
return G__29139__$3;
}
} else {
...
return cljs.core.some((function (p1__29143_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(mapping,p1__29143_SHARP_);
...
if(cljs.core.truth_(temp__5825__auto__)){
var e = temp__5825__auto__;
var G__29150 = e.target.tagName;
var fexpr__29149 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["SELECT",null,"INPUT",null,"BUTTON",null,"TEXTAREA",null], null), null);
return (fexpr__29149.cljs$core$IFn$_invoke$arity$1 ? fexpr__29149.cljs$core$IFn$_invoke$arity$1(G__29150) : fexpr__29149.call(null,G__29150));
} else {
return null;
}
});
portal.shortcuts.keydown = (function portal$shortcuts$keydown(e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(portal.shortcuts.log,(function (p1__29151_SHARP_){
return cljs.core.take.cljs$core$IFn$_invoke$arity$2((5),cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__29151_SHARP_,e));
}));
...
return window.addEventListener("keydown",(function (p1__29152_SHARP_){
return portal.shortcuts.keydown(p1__29152_SHARP_);
}));
} else {
return null;
}
