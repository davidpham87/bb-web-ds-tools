...
if(cljs.core.truth_((function (){var fexpr__29161 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["Mac68K",null,"Macintosh",null,"MacPPC",null,"MacIntel",null], null), null);
return (fexpr__29161.cljs$core$IFn$_invoke$arity$1 ? fexpr__29161.cljs$core$IFn$_invoke$arity$1(platform) : fexpr__29161.call(null,platform));
})())){
return new cljs.core.Keyword("portal.shortcuts","osx","portal.shortcuts/osx",300522451);
} else {
if(cljs.core.truth_((function (){var fexpr__29162 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["WinCE",null,"Windows",null,"Win32",null,"Win64",null], null), null);
return (fexpr__29162.cljs$core$IFn$_invoke$arity$1 ? fexpr__29162.cljs$core$IFn$_invoke$arity$1(platform) : fexpr__29162.call(null,platform));
})())){
...
var iter__5503__auto__ = (function portal$shortcuts$log__GT_seq_$_iter__29165(s__29166){
return (new cljs.core.LazySeq(null,(function (){
var s__29166__$1 = s__29166;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__29166__$1);
if(temp__5825__auto__){
var s__29166__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__29166__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__29166__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__29168 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__29167 = (0);
while(true){
if((i__29167 < size__5502__auto__)){
var n = cljs.core._nth(c__5501__auto__,i__29167);
cljs.core.chunk_append(b__29168,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.reverse(cljs.core.take.cljs$core$IFn$_invoke$arity$2(n,log__$1))));

var G__29190 = (i__29167 + (1));
i__29167 = G__29190;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__29168),portal$shortcuts$log__GT_seq_$_iter__29165(cljs.core.chunk_rest(s__29166__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__29168),null);
}
} else {
var n = cljs.core.first(s__29166__$2);
return cljs.core.cons(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.reverse(cljs.core.take.cljs$core$IFn$_invoke$arity$2(n,log__$1))),portal$shortcuts$log__GT_seq_$_iter__29165(cljs.core.rest(s__29166__$2)));
}
} else {
return null;
}
...
var G__29173 = cljs.core.PersistentHashSet.createAsIfByAssoc([portal.shortcuts.event__GT_key(e)]);
var G__29173__$1 = (cljs.core.truth_(e.ctrlKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__29173,"control"):G__29173);
var G__29173__$2 = (cljs.core.truth_(e.metaKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__29173__$1,"meta"):G__29173__$1);
var G__29173__$3 = (cljs.core.truth_(e.shiftKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__29173__$2,"shift"):G__29173__$2);
if(cljs.core.truth_(e.altKey)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__29173__$3,"alt");
} else {
return G__29173__$3;
}
} else {
...
return cljs.core.some((function (p1__29176_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(mapping,p1__29176_SHARP_);
...
if(cljs.core.truth_(temp__5825__auto__)){
var e = temp__5825__auto__;
var G__29183 = e.target.tagName;
var fexpr__29182 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["SELECT",null,"INPUT",null,"BUTTON",null,"TEXTAREA",null], null), null);
return (fexpr__29182.cljs$core$IFn$_invoke$arity$1 ? fexpr__29182.cljs$core$IFn$_invoke$arity$1(G__29183) : fexpr__29182.call(null,G__29183));
} else {
return null;
}
});
portal.shortcuts.keydown = (function portal$shortcuts$keydown(e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(portal.shortcuts.log,(function (p1__29184_SHARP_){
return cljs.core.take.cljs$core$IFn$_invoke$arity$2((5),cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__29184_SHARP_,e));
}));
...
return window.addEventListener("keydown",(function (p1__29185_SHARP_){
return portal.shortcuts.keydown(p1__29185_SHARP_);
}));
} else {
return null;
}
