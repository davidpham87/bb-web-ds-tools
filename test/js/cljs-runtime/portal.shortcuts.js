...
if(cljs.core.truth_((function (){var fexpr__29026 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["Mac68K",null,"Macintosh",null,"MacPPC",null,"MacIntel",null], null), null);
return (fexpr__29026.cljs$core$IFn$_invoke$arity$1 ? fexpr__29026.cljs$core$IFn$_invoke$arity$1(platform) : fexpr__29026.call(null,platform));
})())){
return new cljs.core.Keyword("portal.shortcuts","osx","portal.shortcuts/osx",300522451);
} else {
if(cljs.core.truth_((function (){var fexpr__29028 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["WinCE",null,"Windows",null,"Win32",null,"Win64",null], null), null);
return (fexpr__29028.cljs$core$IFn$_invoke$arity$1 ? fexpr__29028.cljs$core$IFn$_invoke$arity$1(platform) : fexpr__29028.call(null,platform));
})())){
...
var iter__5503__auto__ = (function portal$shortcuts$log__GT_seq_$_iter__29029(s__29030){
return (new cljs.core.LazySeq(null,(function (){
var s__29030__$1 = s__29030;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__29030__$1);
if(temp__5825__auto__){
var s__29030__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__29030__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__29030__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__29032 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__29031 = (0);
while(true){
if((i__29031 < size__5502__auto__)){
var n = cljs.core._nth(c__5501__auto__,i__29031);
cljs.core.chunk_append(b__29032,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.reverse(cljs.core.take.cljs$core$IFn$_invoke$arity$2(n,log__$1))));

var G__29065 = (i__29031 + (1));
i__29031 = G__29065;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__29032),portal$shortcuts$log__GT_seq_$_iter__29029(cljs.core.chunk_rest(s__29030__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__29032),null);
}
} else {
var n = cljs.core.first(s__29030__$2);
return cljs.core.cons(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.reverse(cljs.core.take.cljs$core$IFn$_invoke$arity$2(n,log__$1))),portal$shortcuts$log__GT_seq_$_iter__29029(cljs.core.rest(s__29030__$2)));
}
} else {
return null;
}
...
var G__29034 = cljs.core.PersistentHashSet.createAsIfByAssoc([portal.shortcuts.event__GT_key(e)]);
var G__29034__$1 = (cljs.core.truth_(e.ctrlKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__29034,"control"):G__29034);
var G__29034__$2 = (cljs.core.truth_(e.metaKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__29034__$1,"meta"):G__29034__$1);
var G__29034__$3 = (cljs.core.truth_(e.shiftKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__29034__$2,"shift"):G__29034__$2);
if(cljs.core.truth_(e.altKey)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__29034__$3,"alt");
} else {
return G__29034__$3;
}
} else {
...
if(cljs.core.truth_(temp__5825__auto__)){
var e = temp__5825__auto__;
var G__29039 = e.target.tagName;
var fexpr__29038 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["SELECT",null,"INPUT",null,"BUTTON",null,"TEXTAREA",null], null), null);
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(portal.shortcuts.log,(function (p1__29040_SHARP_){
return cljs.core.take.cljs$core$IFn$_invoke$arity$2((5),cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__29040_SHARP_,e));
}));
...
return window.addEventListener("keydown",(function (p1__29043_SHARP_){
return portal.shortcuts.keydown(p1__29043_SHARP_);
}));
} else {
return null;
}
