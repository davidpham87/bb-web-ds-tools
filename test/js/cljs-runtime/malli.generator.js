...
var malli$generator$Generator$_generator$dyn_52412 = (function (this$,options){
...
return malli$generator$Generator$_generator$dyn_52412(this$,options);
}
});
...
var G__52191 = malli.generator._child(schema,options);
var G__52192 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52191,G__52192) : malli.generator.generator.call(null,G__52191,G__52192));
});
/**
 * Return a generator of no values that is compatible with -unreachable-gen?.
 */
malli.generator._never_gen = (function malli$generator$_never_gen(p__52200){
var map__52201 = p__52200;
var map__52201__$1 = cljs.core.__destructure_map(map__52201);
var _options = map__52201__$1;
var original_generator_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52201__$1,new cljs.core.Keyword("malli.generator","original-generator-schema","malli.generator/original-generator-schema",-1122475395));
return cljs.core.with_meta(clojure.test.check.generators.sized((function (_){
return malli.core._fail_BANG_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("malli.generator","unsatisfiable-schema","malli.generator/unsatisfiable-schema",919209538),(function (){var G__52205 = cljs.core.PersistentArrayMap.EMPTY;
if(cljs.core.truth_(original_generator_schema)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52205,new cljs.core.Keyword(null,"schema","schema",-1582001791),original_generator_schema);
} else {
return G__52205;
}
})());
...
var map__52221 = malli.core.properties.cljs$core$IFn$_invoke$arity$2(schema,options);
var map__52221__$1 = cljs.core.__destructure_map(map__52221);
var gen_min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52221__$1,new cljs.core.Keyword("gen","min","gen/min",444569458));
var gen_max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52221__$1,new cljs.core.Keyword("gen","max","gen/max",61264228));
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52221__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52221__$1,new cljs.core.Keyword(null,"max","max",61366548));
...
var map__52225 = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
var map__52225__$1 = cljs.core.__destructure_map(map__52225);
var infinite_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52225__$1,new cljs.core.Keyword("gen","infinite?","gen/infinite?",-2017652832));
var NaN_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52225__$1,new cljs.core.Keyword("gen","NaN?","gen/NaN?",-1917993267));
...
return clojure.test.check.generators.double_STAR_(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$2(malli.generator.double_default,opts),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__52235_SHARP_){
var G__52240 = p1__52235_SHARP_;
if((G__52240 == null)){
return null;
} else {
return G__52240;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__52236_SHARP_){
var G__52241 = p1__52236_SHARP_;
if((G__52241 == null)){
return null;
} else {
return G__52241;
...
malli.generator.gen_vector = (function malli$generator$gen_vector(p__52244,g){
var map__52245 = p__52244;
var map__52245__$1 = cljs.core.__destructure_map(map__52245);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52245__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52245__$1,new cljs.core.Keyword(null,"max","max",61366548));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__52259_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","such-that-failure","malli.generator/such-that-failure",599634585),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__52259_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null);
});
...
var map__52282 = malli.generator._min_max(schema,options);
var map__52282__$1 = cljs.core.__destructure_map(map__52282);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52282__$1,new cljs.core.Keyword(null,"min","min",444991522));
var el = malli.generator._child(schema,options);
return malli.generator.gen_one_of(options,(function (){var G__52283 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$3((function (){var G__52284 = cljs.core.PersistentVector.EMPTY;
if((((min == null)) || ((min === (0))))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__52284,malli.generator.nil_gen);
} else {
return G__52284;
}
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__52280_SHARP_){
return malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$3(schema,p1__52280_SHARP_,options);
})),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.identity,cljs.core.vec,cljs.core.eduction,(function (p1__52281_SHARP_){
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(p1__52281_SHARP_);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__52283,(function (){var vec__52285 = malli.core.children.cljs$core$IFn$_invoke$arity$1(el);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52285,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52285,(1),null);
var G__52288 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map-of","map-of",1189682355),(function (){var or__5025__auto__ = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
...
var G__52289 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52288,G__52289) : malli.generator.generator.call(null,G__52288,G__52289));
})());
} else {
return G__52283;
}
...
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__52290_SHARP_,options) : malli.generator.generator.call(null,p1__52290_SHARP_,options));
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52299_SHARP_){
var G__52300 = cljs.core.last(p1__52299_SHARP_);
var G__52301 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52300,G__52301) : malli.generator.generator.call(null,G__52300,G__52301));
...
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__52309){
var vec__52310 = p__52309;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52310,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52310,(1),null);
...
malli.generator._entry_gen = (function malli$generator$_entry_gen(p__52314,options){
var vec__52315 = p__52314;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52315,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52315,(1),null);
var G__52318 = malli.generator.gen_fmap((function (p1__52313_SHARP_){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,p1__52313_SHARP_], null);
...
return malli.generator.gen_maybe(G__52318);
} else {
return G__52318;
}
});
malli.generator._map_gen = (function malli$generator$_map_gen(schema,options){
return malli.generator.gen_fmap(malli.generator._build_map,malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52319_SHARP_){
return malli.generator._entry_gen(p1__52319_SHARP_,options);
...
return malli.generator.gen_fmap((function (p1__52322_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,p1__52322_SHARP_);
}),malli.generator.gen_vector_distinct_by(schema,malli.generator._min_max(schema,options),(function (p1__52321_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__52321_SHARP_,(0));
}),malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52320_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__52320_SHARP_,options) : malli.generator.generator.call(null,p1__52320_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)))));
});
...
var G__52325 = (function (){var G__52326 = dschema;
var G__52327 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),scalar_ref_gen);
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52326,G__52327) : malli.generator.generator.call(null,G__52326,G__52327));
})();
if(cljs.core.realized_QMARK_(scalar_ref_gen)){
return clojure.test.check.generators.recursive_gen((function (p1__52324_SHARP_){
var G__52328 = dschema;
var G__52329 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),p1__52324_SHARP_);
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52328,G__52329) : malli.generator.generator.call(null,G__52328,G__52329));
}),G__52325);
} else {
return G__52325;
}
...
var output_generator = (function (){var G__52330 = new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(malli.core._function_info(schema));
var G__52331 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52330,G__52331) : malli.generator.generator.call(null,G__52330,G__52331));
})();
...
var G__52423__delegate = function (_){
...
while (G__52424__i < G__52424__a.length) {G__52424__a[G__52424__i] = arguments[G__52424__i + 0]; ++G__52424__i;}
  _ = new cljs.core.IndexedSeq(G__52424__a,0,null);
} 
return G__52423__delegate.call(this,_);};
G__52423.cljs$lang$maxFixedArity = 0;
G__52423.cljs$lang$applyTo = (function (arglist__52425){
var _ = cljs.core.seq(arglist__52425);
return G__52423__delegate(_);
});
...
return clojure.test.check.generators.return$(malli.core._instrument.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"schema","schema",-1582001791),schema,new cljs.core.Keyword(null,"gen","gen",142575302),(function (p1__52332_SHARP_){
return (malli.generator.generate.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generate.cljs$core$IFn$_invoke$arity$2(p1__52332_SHARP_,options) : malli.generator.generate.call(null,p1__52332_SHARP_,options));
})], null),null,options));
});
malli.generator._regex_generator = (function malli$generator$_regex_generator(schema,options){
var G__52333 = (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(schema,options) : malli.generator.generator.call(null,schema,options));
if(cljs.core.not(malli.core._regex_op_QMARK_(schema))){
return malli.generator.gen_tuple((new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[G__52333],null)));
} else {
return G__52333;
}
});
...
return malli.generator.gen_fcat(malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52334_SHARP_){
return malli.generator._re_entry_gen(p1__52334_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options))));
});
malli.generator._alt_gen = (function malli$generator$_alt_gen(schema,options){
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52335_SHARP_){
return malli.generator._re_entry_gen(p1__52335_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
});
...
var child = malli.generator._child(schema,options);
var G__52344 = malli.generator.gen_vector(malli.generator._min_max(schema,options),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__52344);
} else {
return G__52344;
}
});
...
var child = malli.generator._child(schema,options);
var G__52349 = malli.generator.gen_vector(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.max,(1))),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__52349);
} else {
return G__52349;
}
});
malli.generator._repeat_gen = (function malli$generator$_repeat_gen(schema,options){
var or__5025__auto__ = (function (){var G__52350 = malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$2(schema,options);
var G__52350__$1 = (((G__52350 == null))?null:malli.generator._not_unreachable(G__52350));
if((G__52350__$1 == null)){
return null;
} else {
var G__52352 = G__52350__$1;
if(cljs.core.truth_(malli.core._regex_op_QMARK_(malli.generator._child(schema,options)))){
return malli.generator.gen_fcat(G__52352);
} else {
return G__52352;
}
}
...
var G__52353 = cljs.core.name(namespace_unparsed);
var G__52354 = cljs.core.name(k);
return (mk_value_with_ns.cljs$core$IFn$_invoke$arity$2 ? mk_value_with_ns.cljs$core$IFn$_invoke$arity$2(G__52353,G__52354) : mk_value_with_ns.call(null,G__52353,G__52354));
...
})(),cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__52358_SHARP_){
var G__52360 = p1__52358_SHARP_;
if((G__52360 == null)){
return null;
} else {
return G__52360;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__52359_SHARP_){
var G__52362 = p1__52359_SHARP_;
if((G__52362 == null)){
return null;
} else {
return G__52362;
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.generator","default","malli.generator/default",-943988734)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__52363 = cljs.core.get_global_hierarchy;
return (fexpr__52363.cljs$core$IFn$_invoke$arity$0 ? fexpr__52363.cljs$core$IFn$_invoke$arity$0() : fexpr__52363.call(null));
})());
...
return malli.generator.gen_such_that(schema,(function (p1__52365_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__52365_SHARP_,malli.generator._child(schema,options));
...
return malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52366_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__52366_SHARP_,options) : malli.generator.generator.call(null,p1__52366_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
}));
...
var G__52367 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52368 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52367,G__52368) : malli.generator.generator.call(null,G__52367,G__52368));
}));
...
var G__52369 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52370 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52369,G__52370) : malli.generator.generator.call(null,G__52369,G__52370));
}));
...
var G__52371 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52372 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52371,G__52372) : malli.generator.generator.call(null,G__52371,G__52372));
}));
...
var G__52373 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52374 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52373,G__52374) : malli.generator.generator.call(null,G__52373,G__52374));
}));
...
var G__52375 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52376 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52375,G__52376) : malli.generator.generator.call(null,G__52375,G__52376));
}));
...
var G__52378 = new cljs.core.Keyword("gen","elements","gen/elements",657813311).cljs$core$IFn$_invoke$arity$1(props);
if((G__52378 == null)){
return null;
} else {
return malli.generator.gen_elements(G__52378);
}
});
...
var G__52379 = new cljs.core.Keyword("gen","schema","gen/schema",-1582038959).cljs$core$IFn$_invoke$arity$1(props);
if((G__52379 == null)){
return null;
} else {
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52379,options) : malli.generator.generator.call(null,G__52379,options));
}
});
...
return malli.core._cached(malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options),new cljs.core.Keyword(null,"generator","generator",-572962281),(function (p1__52380_SHARP_){
return malli.generator._create(p1__52380_SHARP_,options);
}));
}
}));
...
(malli.generator.generate.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__52385){
var map__52386 = p__52385;
var map__52386__$1 = cljs.core.__destructure_map(map__52386);
var options = map__52386__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52386__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52386__$1,new cljs.core.Keyword(null,"size","size",1098693007),(30));
...
(malli.generator.sample.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__52392){
var map__52393 = p__52392;
var map__52393__$1 = cljs.core.__destructure_map(map__52393);
var options = map__52393__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52393__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52393__$1,new cljs.core.Keyword(null,"size","size",1098693007),(10));
var gen = ((clojure.test.check.generators.generator_QMARK_(_QMARK_gen_or_schema))?_QMARK_gen_or_schema:malli.generator.generator.cljs$core$IFn$_invoke$arity$2(_QMARK_gen_or_schema,options));
return cljs.core.take.cljs$core$IFn$_invoke$arity$2(size,cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__52387_SHARP_,p2__52388_SHARP_){
return clojure.test.check.rose_tree.root(clojure.test.check.generators.call_gen(gen,p1__52387_SHARP_,p2__52388_SHARP_));
...
(malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_schema,p__52399){
var map__52400 = p__52399;
var map__52400__$1 = cljs.core.__destructure_map(map__52400);
var options = map__52400__$1;
var _EQ__GT_iterations = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52400__$1,new cljs.core.Keyword("malli.generator","=>iterations","malli.generator/=>iterations",-1726832707),(100));
...
}catch (e52401){if((e52401 instanceof Error)){
var e = e52401;
...
var map__52402 = malli.core._function_info(schema__$1);
var map__52402__$1 = cljs.core.__destructure_map(map__52402);
var input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52402__$1,new cljs.core.Keyword(null,"input","input",556931961));
var output = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52402__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var guard = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52402__$1,new cljs.core.Keyword(null,"guard","guard",-873147811));
...
if(cljs.core.truth_(and__5023__auto__)){
var G__52403 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [args,$], null);
return (valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1 ? valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1(G__52403) : valid_guard_QMARK_.call(null,G__52403));
} else {
return and__5023__auto__;
}
});
return (function (f){
var map__52404 = clojure.test.check.quick_check(_EQ__GT_iterations,clojure.test.check.properties.for_all_STAR_(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [input_generator], null),(function (p1__52394_SHARP_){
return validate(f,p1__52394_SHARP_);
})));
var map__52404__$1 = cljs.core.__destructure_map(map__52404);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52404__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var shrunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52404__$1,new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412));
...
var vec__52405 = (cljs.core.truth_(explain_input)?null:_try((function (){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,smallest);
})));
var result__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52405,(0),null);
var success = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52405,(1),null);
...
var G__52408 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(shrunk,new cljs.core.Keyword("malli.core","result","malli.core/result",1538632379),result__$1);
var G__52408__$1 = (cljs.core.truth_(explain_input)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52408,new cljs.core.Keyword("malli.core","explain-input","malli.core/explain-input",1441627811),explain_input):G__52408);
var G__52408__$2 = (cljs.core.truth_(explain_output)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52408__$1,new cljs.core.Keyword("malli.core","explain-output","malli.core/explain-output",-124321573),explain_output):G__52408__$1);
var G__52408__$3 = (cljs.core.truth_(explain_guard)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52408__$2,new cljs.core.Keyword("malli.core","explain-guard","malli.core/explain-guard",-1119572847),explain_guard):G__52408__$2);
if(cljs.core.truth_(cljs.core.ex_message(result__$1))){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__52408__$3,new cljs.core.Keyword(null,"result","result",1415092211),cljs.core.ex_message),new cljs.core.Keyword(null,"result-data","result-data",-1724248844));
} else {
return G__52408__$3;
}
}
...
var checkers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52395_SHARP_){
return malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2(p1__52395_SHARP_,options);
}),malli.core._function_schema_arities(schema));
return (function (x){
return cljs.core.seq(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__52396_SHARP_){
return (p1__52396_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__52396_SHARP_.cljs$core$IFn$_invoke$arity$1(x) : p1__52396_SHARP_.call(null,x));
}),checkers));
});
} else {
...
var schema = malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options);
return malli.core.explain.cljs$core$IFn$_invoke$arity$2(malli.core._update_options(schema,(function (p1__52409_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__52409_SHARP_,new cljs.core.Keyword("malli.core","function-checker","malli.core/function-checker",-792030936),malli.generator.function_checker);
})),f);
}));
