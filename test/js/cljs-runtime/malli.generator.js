...
var malli$generator$Generator$_generator$dyn_52490 = (function (this$,options){
...
return malli$generator$Generator$_generator$dyn_52490(this$,options);
}
});
...
var G__52269 = malli.generator._child(schema,options);
var G__52270 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52269,G__52270) : malli.generator.generator.call(null,G__52269,G__52270));
});
/**
 * Return a generator of no values that is compatible with -unreachable-gen?.
 */
malli.generator._never_gen = (function malli$generator$_never_gen(p__52279){
var map__52282 = p__52279;
var map__52282__$1 = cljs.core.__destructure_map(map__52282);
var _options = map__52282__$1;
var original_generator_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52282__$1,new cljs.core.Keyword("malli.generator","original-generator-schema","malli.generator/original-generator-schema",-1122475395));
return cljs.core.with_meta(clojure.test.check.generators.sized((function (_){
return malli.core._fail_BANG_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("malli.generator","unsatisfiable-schema","malli.generator/unsatisfiable-schema",919209538),(function (){var G__52283 = cljs.core.PersistentArrayMap.EMPTY;
if(cljs.core.truth_(original_generator_schema)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52283,new cljs.core.Keyword(null,"schema","schema",-1582001791),original_generator_schema);
} else {
return G__52283;
}
})());
...
var map__52304 = malli.core.properties.cljs$core$IFn$_invoke$arity$2(schema,options);
var map__52304__$1 = cljs.core.__destructure_map(map__52304);
var gen_min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52304__$1,new cljs.core.Keyword("gen","min","gen/min",444569458));
var gen_max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52304__$1,new cljs.core.Keyword("gen","max","gen/max",61264228));
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52304__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52304__$1,new cljs.core.Keyword(null,"max","max",61366548));
...
var map__52309 = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
var map__52309__$1 = cljs.core.__destructure_map(map__52309);
var infinite_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52309__$1,new cljs.core.Keyword("gen","infinite?","gen/infinite?",-2017652832));
var NaN_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52309__$1,new cljs.core.Keyword("gen","NaN?","gen/NaN?",-1917993267));
...
return malli.generator.gen_fmap((function (p1__52310_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,p1__52310_SHARP_);
}),gen);
});
...
return clojure.test.check.generators.double_STAR_(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$2(malli.generator.double_default,opts),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__52314_SHARP_){
var G__52316 = p1__52314_SHARP_;
if((G__52316 == null)){
return null;
} else {
return G__52316;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__52315_SHARP_){
var G__52317 = p1__52315_SHARP_;
if((G__52317 == null)){
return null;
} else {
return G__52317;
...
malli.generator.gen_vector = (function malli$generator$gen_vector(p__52319,g){
var map__52320 = p__52319;
var map__52320__$1 = cljs.core.__destructure_map(map__52320);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52320__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52320__$1,new cljs.core.Keyword(null,"max","max",61366548));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(clojure.test.check.generators.sized((function (p1__52318_SHARP_){
return clojure.test.check.generators.vector.cljs$core$IFn$_invoke$arity$3(g,min,(min + p1__52318_SHARP_));
...
malli.generator.gen_vector_distinct_by = (function malli$generator$gen_vector_distinct_by(schema,p__52328,f,g){
var map__52329 = p__52328;
var map__52329__$1 = cljs.core.__destructure_map(map__52329);
var m = map__52329__$1;
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52329__$1,new cljs.core.Keyword(null,"min","min",444991522));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
})())?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"num-elements","num-elements",1960422107),min], null):clojure.set.rename_keys(m,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"min","min",444991522),new cljs.core.Keyword(null,"min-elements","min-elements",949370780),new cljs.core.Keyword(null,"max","max",61366548),new cljs.core.Keyword(null,"max-elements","max-elements",433034073)], null))),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__52327_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","distinct-generator-failure","malli.generator/distinct-generator-failure",-2085139904),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__52327_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null)));
}
});
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__52339_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","such-that-failure","malli.generator/such-that-failure",599634585),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__52339_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null);
});
...
var map__52345 = malli.generator._min_max(schema,options);
var map__52345__$1 = cljs.core.__destructure_map(map__52345);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52345__$1,new cljs.core.Keyword(null,"min","min",444991522));
var el = malli.generator._child(schema,options);
return malli.generator.gen_one_of(options,(function (){var G__52346 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$3((function (){var G__52347 = cljs.core.PersistentVector.EMPTY;
if((((min == null)) || ((min === (0))))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__52347,malli.generator.nil_gen);
} else {
return G__52347;
}
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__52342_SHARP_){
return malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$3(schema,p1__52342_SHARP_,options);
})),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.identity,cljs.core.vec,cljs.core.eduction,(function (p1__52343_SHARP_){
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(p1__52343_SHARP_);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__52346,(function (){var vec__52348 = malli.core.children.cljs$core$IFn$_invoke$arity$1(el);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52348,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52348,(1),null);
var G__52351 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map-of","map-of",1189682355),(function (){var or__5025__auto__ = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
...
var G__52352 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52351,G__52352) : malli.generator.generator.call(null,G__52351,G__52352));
})());
} else {
return G__52346;
}
...
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__52353_SHARP_,options) : malli.generator.generator.call(null,p1__52353_SHARP_,options));
...
return malli.util.transform_entries.cljs$core$IFn$_invoke$arity$3(G__52355,(function (p1__52354_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__52356){
var vec__52357 = p__52356;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52357,(0),null);
var e = vec__52357;
var G__52360 = e;
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__52360,(2),malli.util.merge,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dispatch,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"=","=",1152933628),null,k], null)], null)], null));
} else {
return G__52360;
}
}),p1__52354_SHARP_);
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52361_SHARP_){
var G__52362 = cljs.core.last(p1__52361_SHARP_);
var G__52363 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52362,G__52363) : malli.generator.generator.call(null,G__52362,G__52363));
...
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__52364){
...
malli.generator._entry_gen = (function malli$generator$_entry_gen(p__52369,options){
var vec__52370 = p__52369;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52370,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52370,(1),null);
var G__52373 = malli.generator.gen_fmap((function (p1__52368_SHARP_){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,p1__52368_SHARP_], null);
...
return malli.generator.gen_maybe(G__52373);
} else {
return G__52373;
}
});
malli.generator._map_gen = (function malli$generator$_map_gen(schema,options){
return malli.generator.gen_fmap(malli.generator._build_map,malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52374_SHARP_){
return malli.generator._entry_gen(p1__52374_SHARP_,options);
...
return malli.generator.gen_fmap((function (p1__52377_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,p1__52377_SHARP_);
}),malli.generator.gen_vector_distinct_by(schema,malli.generator._min_max(schema,options),(function (p1__52376_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__52376_SHARP_,(0));
}),malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52375_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__52375_SHARP_,options) : malli.generator.generator.call(null,p1__52375_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)))));
});
...
var G__52390 = (function (){var G__52391 = dschema;
var G__52392 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),scalar_ref_gen);
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52391,G__52392) : malli.generator.generator.call(null,G__52391,G__52392));
})();
if(cljs.core.realized_QMARK_(scalar_ref_gen)){
return clojure.test.check.generators.recursive_gen((function (p1__52387_SHARP_){
var G__52393 = dschema;
var G__52394 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),p1__52387_SHARP_);
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52393,G__52394) : malli.generator.generator.call(null,G__52393,G__52394));
}),G__52390);
} else {
return G__52390;
}
...
var output_generator = (function (){var G__52395 = new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(malli.core._function_info(schema));
var G__52396 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52395,G__52396) : malli.generator.generator.call(null,G__52395,G__52396));
})();
...
var G__52508__delegate = function (_){
...
while (G__52509__i < G__52509__a.length) {G__52509__a[G__52509__i] = arguments[G__52509__i + 0]; ++G__52509__i;}
  _ = new cljs.core.IndexedSeq(G__52509__a,0,null);
} 
return G__52508__delegate.call(this,_);};
G__52508.cljs$lang$maxFixedArity = 0;
G__52508.cljs$lang$applyTo = (function (arglist__52510){
var _ = cljs.core.seq(arglist__52510);
return G__52508__delegate(_);
});
...
return clojure.test.check.generators.return$(malli.core._instrument.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"schema","schema",-1582001791),schema,new cljs.core.Keyword(null,"gen","gen",142575302),(function (p1__52397_SHARP_){
return (malli.generator.generate.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generate.cljs$core$IFn$_invoke$arity$2(p1__52397_SHARP_,options) : malli.generator.generate.call(null,p1__52397_SHARP_,options));
})], null),null,options));
});
malli.generator._regex_generator = (function malli$generator$_regex_generator(schema,options){
var G__52398 = (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(schema,options) : malli.generator.generator.call(null,schema,options));
if(cljs.core.not(malli.core._regex_op_QMARK_(schema))){
return malli.generator.gen_tuple((new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[G__52398],null)));
} else {
return G__52398;
}
});
...
return malli.generator.gen_fcat(malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52399_SHARP_){
return malli.generator._re_entry_gen(p1__52399_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options))));
});
malli.generator._alt_gen = (function malli$generator$_alt_gen(schema,options){
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52400_SHARP_){
return malli.generator._re_entry_gen(p1__52400_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
});
...
var child = malli.generator._child(schema,options);
var G__52401 = malli.generator.gen_vector(malli.generator._min_max(schema,options),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__52401);
} else {
return G__52401;
}
});
...
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__52402);
} else {
return G__52402;
}
});
malli.generator._repeat_gen = (function malli$generator$_repeat_gen(schema,options){
var or__5025__auto__ = (function (){var G__52403 = malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$2(schema,options);
var G__52403__$1 = (((G__52403 == null))?null:malli.generator._not_unreachable(G__52403));
if((G__52403__$1 == null)){
return null;
} else {
var G__52404 = G__52403__$1;
if(cljs.core.truth_(malli.core._regex_op_QMARK_(malli.generator._child(schema,options)))){
return malli.generator.gen_fcat(G__52404);
} else {
return G__52404;
}
}
...
var G__52406 = cljs.core.name(namespace_unparsed);
var G__52407 = cljs.core.name(k);
return (mk_value_with_ns.cljs$core$IFn$_invoke$arity$2 ? mk_value_with_ns.cljs$core$IFn$_invoke$arity$2(G__52406,G__52407) : mk_value_with_ns.call(null,G__52406,G__52407));
...
})(),cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__52410_SHARP_){
var G__52412 = p1__52410_SHARP_;
if((G__52412 == null)){
return null;
} else {
return G__52412;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__52411_SHARP_){
var G__52413 = p1__52411_SHARP_;
if((G__52413 == null)){
return null;
} else {
return G__52413;
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.generator","default","malli.generator/default",-943988734)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__52414 = cljs.core.get_global_hierarchy;
return (fexpr__52414.cljs$core$IFn$_invoke$arity$0 ? fexpr__52414.cljs$core$IFn$_invoke$arity$0() : fexpr__52414.call(null));
})());
...
return malli.generator.gen_such_that(schema,(function (p1__52415_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__52415_SHARP_,malli.generator._child(schema,options));
...
return malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52416_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__52416_SHARP_,options) : malli.generator.generator.call(null,p1__52416_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
}));
...
var G__52417 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52418 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52417,G__52418) : malli.generator.generator.call(null,G__52417,G__52418));
}));
...
var G__52419 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52420 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52419,G__52420) : malli.generator.generator.call(null,G__52419,G__52420));
}));
...
var G__52421 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52422 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52421,G__52422) : malli.generator.generator.call(null,G__52421,G__52422));
}));
...
var G__52423 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52424 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52423,G__52424) : malli.generator.generator.call(null,G__52423,G__52424));
}));
...
var G__52425 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52426 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52425,G__52426) : malli.generator.generator.call(null,G__52425,G__52426));
}));
...
var G__52427 = new cljs.core.Keyword("gen","elements","gen/elements",657813311).cljs$core$IFn$_invoke$arity$1(props);
if((G__52427 == null)){
return null;
} else {
return malli.generator.gen_elements(G__52427);
}
});
...
return malli.core._cached(malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options),new cljs.core.Keyword(null,"generator","generator",-572962281),(function (p1__52434_SHARP_){
return malli.generator._create(p1__52434_SHARP_,options);
}));
}
}));
...
(malli.generator.generate.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__52445){
var map__52447 = p__52445;
var map__52447__$1 = cljs.core.__destructure_map(map__52447);
var options = map__52447__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52447__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52447__$1,new cljs.core.Keyword(null,"size","size",1098693007),(30));
...
(malli.generator.sample.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__52454){
var map__52455 = p__52454;
var map__52455__$1 = cljs.core.__destructure_map(map__52455);
var options = map__52455__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52455__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52455__$1,new cljs.core.Keyword(null,"size","size",1098693007),(10));
var gen = ((clojure.test.check.generators.generator_QMARK_(_QMARK_gen_or_schema))?_QMARK_gen_or_schema:malli.generator.generator.cljs$core$IFn$_invoke$arity$2(_QMARK_gen_or_schema,options));
return cljs.core.take.cljs$core$IFn$_invoke$arity$2(size,cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__52449_SHARP_,p2__52450_SHARP_){
return clojure.test.check.rose_tree.root(clojure.test.check.generators.call_gen(gen,p1__52449_SHARP_,p2__52450_SHARP_));
...
(malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_schema,p__52464){
var map__52465 = p__52464;
var map__52465__$1 = cljs.core.__destructure_map(map__52465);
var options = map__52465__$1;
var _EQ__GT_iterations = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52465__$1,new cljs.core.Keyword("malli.generator","=>iterations","malli.generator/=>iterations",-1726832707),(100));
...
}catch (e52467){if((e52467 instanceof Error)){
var e = e52467;
...
var map__52469 = malli.core._function_info(schema__$1);
var map__52469__$1 = cljs.core.__destructure_map(map__52469);
var input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52469__$1,new cljs.core.Keyword(null,"input","input",556931961));
var output = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52469__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var guard = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52469__$1,new cljs.core.Keyword(null,"guard","guard",-873147811));
...
if(cljs.core.truth_(and__5023__auto__)){
var G__52472 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [args,$], null);
return (valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1 ? valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1(G__52472) : valid_guard_QMARK_.call(null,G__52472));
} else {
return and__5023__auto__;
}
});
return (function (f){
var map__52474 = clojure.test.check.quick_check(_EQ__GT_iterations,clojure.test.check.properties.for_all_STAR_(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [input_generator], null),(function (p1__52458_SHARP_){
return validate(f,p1__52458_SHARP_);
})));
var map__52474__$1 = cljs.core.__destructure_map(map__52474);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52474__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var shrunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52474__$1,new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412));
...
var vec__52476 = (cljs.core.truth_(explain_input)?null:_try((function (){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,smallest);
})));
var result__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52476,(0),null);
var success = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52476,(1),null);
...
var G__52480 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(shrunk,new cljs.core.Keyword("malli.core","result","malli.core/result",1538632379),result__$1);
var G__52480__$1 = (cljs.core.truth_(explain_input)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52480,new cljs.core.Keyword("malli.core","explain-input","malli.core/explain-input",1441627811),explain_input):G__52480);
var G__52480__$2 = (cljs.core.truth_(explain_output)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52480__$1,new cljs.core.Keyword("malli.core","explain-output","malli.core/explain-output",-124321573),explain_output):G__52480__$1);
var G__52480__$3 = (cljs.core.truth_(explain_guard)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52480__$2,new cljs.core.Keyword("malli.core","explain-guard","malli.core/explain-guard",-1119572847),explain_guard):G__52480__$2);
if(cljs.core.truth_(cljs.core.ex_message(result__$1))){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__52480__$3,new cljs.core.Keyword(null,"result","result",1415092211),cljs.core.ex_message),new cljs.core.Keyword(null,"result-data","result-data",-1724248844));
} else {
return G__52480__$3;
}
}
...
var checkers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52460_SHARP_){
return malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2(p1__52460_SHARP_,options);
}),malli.core._function_schema_arities(schema));
return (function (x){
return cljs.core.seq(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__52461_SHARP_){
return (p1__52461_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__52461_SHARP_.cljs$core$IFn$_invoke$arity$1(x) : p1__52461_SHARP_.call(null,x));
}),checkers));
});
} else {
...
var schema = malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options);
return malli.core.explain.cljs$core$IFn$_invoke$arity$2(malli.core._update_options(schema,(function (p1__52484_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__52484_SHARP_,new cljs.core.Keyword("malli.core","function-checker","malli.core/function-checker",-792030936),malli.generator.function_checker);
})),f);
}));
