...
var G__59571 = malli.generator._child(schema,options);
var G__59572 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__59571,G__59572) : malli.generator.generator.call(null,G__59571,G__59572));
});
/**
 * Return a generator of no values that is compatible with -unreachable-gen?.
 */
malli.generator._never_gen = (function malli$generator$_never_gen(p__59573){
var map__59574 = p__59573;
var map__59574__$1 = cljs.core.__destructure_map(map__59574);
var _options = map__59574__$1;
var original_generator_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59574__$1,new cljs.core.Keyword("malli.generator","original-generator-schema","malli.generator/original-generator-schema",-1122475395));
return cljs.core.with_meta(clojure.test.check.generators.sized((function (_){
return malli.core._fail_BANG_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("malli.generator","unsatisfiable-schema","malli.generator/unsatisfiable-schema",919209538),(function (){var G__59575 = cljs.core.PersistentArrayMap.EMPTY;
if(cljs.core.truth_(original_generator_schema)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__59575,new cljs.core.Keyword(null,"schema","schema",-1582001791),original_generator_schema);
} else {
return G__59575;
}
})());
...
var map__59588 = malli.core.properties.cljs$core$IFn$_invoke$arity$2(schema,options);
var map__59588__$1 = cljs.core.__destructure_map(map__59588);
var gen_min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59588__$1,new cljs.core.Keyword("gen","min","gen/min",444569458));
var gen_max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59588__$1,new cljs.core.Keyword("gen","max","gen/max",61264228));
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59588__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59588__$1,new cljs.core.Keyword(null,"max","max",61366548));
...
var map__59597 = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
var map__59597__$1 = cljs.core.__destructure_map(map__59597);
var infinite_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59597__$1,new cljs.core.Keyword("gen","infinite?","gen/infinite?",-2017652832));
var NaN_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59597__$1,new cljs.core.Keyword("gen","NaN?","gen/NaN?",-1917993267));
...
return malli.generator.gen_fmap((function (p1__59603_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,p1__59603_SHARP_);
}),gen);
});
...
return clojure.test.check.generators.double_STAR_(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$2(malli.generator.double_default,opts),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__59617_SHARP_){
var G__59619 = p1__59617_SHARP_;
if((G__59619 == null)){
return null;
} else {
return G__59619;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__59618_SHARP_){
var G__59621 = p1__59618_SHARP_;
if((G__59621 == null)){
return null;
} else {
return G__59621;
...
malli.generator.gen_vector = (function malli$generator$gen_vector(p__59627,g){
var map__59628 = p__59627;
var map__59628__$1 = cljs.core.__destructure_map(map__59628);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59628__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59628__$1,new cljs.core.Keyword(null,"max","max",61366548));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(clojure.test.check.generators.sized((function (p1__59622_SHARP_){
return clojure.test.check.generators.vector.cljs$core$IFn$_invoke$arity$3(g,min,(min + p1__59622_SHARP_));
...
malli.generator.gen_vector_distinct_by = (function malli$generator$gen_vector_distinct_by(schema,p__59635,f,g){
var map__59636 = p__59635;
var map__59636__$1 = cljs.core.__destructure_map(map__59636);
var m = map__59636__$1;
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59636__$1,new cljs.core.Keyword(null,"min","min",444991522));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
})())?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"num-elements","num-elements",1960422107),min], null):clojure.set.rename_keys(m,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"min","min",444991522),new cljs.core.Keyword(null,"min-elements","min-elements",949370780),new cljs.core.Keyword(null,"max","max",61366548),new cljs.core.Keyword(null,"max-elements","max-elements",433034073)], null))),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__59634_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","distinct-generator-failure","malli.generator/distinct-generator-failure",-2085139904),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__59634_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null)));
}
});
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__59647_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","such-that-failure","malli.generator/such-that-failure",599634585),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__59647_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null);
});
...
var map__59669 = malli.generator._min_max(schema,options);
var map__59669__$1 = cljs.core.__destructure_map(map__59669);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59669__$1,new cljs.core.Keyword(null,"min","min",444991522));
var el = malli.generator._child(schema,options);
return malli.generator.gen_one_of(options,(function (){var G__59671 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$3((function (){var G__59672 = cljs.core.PersistentVector.EMPTY;
if((((min == null)) || ((min === (0))))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__59672,malli.generator.nil_gen);
} else {
return G__59672;
}
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__59663_SHARP_){
return malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$3(schema,p1__59663_SHARP_,options);
})),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.identity,cljs.core.vec,cljs.core.eduction,(function (p1__59667_SHARP_){
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(p1__59667_SHARP_);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__59671,(function (){var vec__59673 = malli.core.children.cljs$core$IFn$_invoke$arity$1(el);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59673,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59673,(1),null);
var G__59676 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map-of","map-of",1189682355),(function (){var or__5025__auto__ = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
...
var G__59677 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__59676,G__59677) : malli.generator.generator.call(null,G__59676,G__59677));
})());
} else {
return G__59671;
}
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59679_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__59679_SHARP_,options) : malli.generator.generator.call(null,p1__59679_SHARP_,options));
...
return malli.util.transform_entries.cljs$core$IFn$_invoke$arity$3(G__59681,(function (p1__59680_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__59682){
var vec__59683 = p__59682;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59683,(0),null);
var e = vec__59683;
var G__59686 = e;
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__59686,(2),malli.util.merge,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dispatch,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"=","=",1152933628),null,k], null)], null)], null));
} else {
return G__59686;
}
}),p1__59680_SHARP_);
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59687_SHARP_){
var G__59688 = cljs.core.last(p1__59687_SHARP_);
var G__59689 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__59688,G__59689) : malli.generator.generator.call(null,G__59688,G__59689));
...
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__59690){
var vec__59691 = p__59690;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59691,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59691,(1),null);
...
malli.generator._entry_gen = (function malli$generator$_entry_gen(p__59695,options){
var vec__59696 = p__59695;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59696,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59696,(1),null);
var G__59699 = malli.generator.gen_fmap((function (p1__59694_SHARP_){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,p1__59694_SHARP_], null);
...
return malli.generator.gen_maybe(G__59699);
} else {
return G__59699;
}
});
malli.generator._map_gen = (function malli$generator$_map_gen(schema,options){
return malli.generator.gen_fmap(malli.generator._build_map,malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59700_SHARP_){
return malli.generator._entry_gen(p1__59700_SHARP_,options);
...
return malli.generator.gen_fmap((function (p1__59703_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,p1__59703_SHARP_);
}),malli.generator.gen_vector_distinct_by(schema,malli.generator._min_max(schema,options),(function (p1__59702_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__59702_SHARP_,(0));
}),malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59701_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__59701_SHARP_,options) : malli.generator.generator.call(null,p1__59701_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)))));
});
...
var G__59714 = (function (){var G__59715 = dschema;
var G__59716 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),scalar_ref_gen);
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__59715,G__59716) : malli.generator.generator.call(null,G__59715,G__59716));
})();
if(cljs.core.realized_QMARK_(scalar_ref_gen)){
return clojure.test.check.generators.recursive_gen((function (p1__59707_SHARP_){
var G__59719 = dschema;
var G__59721 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),p1__59707_SHARP_);
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__59719,G__59721) : malli.generator.generator.call(null,G__59719,G__59721));
}),G__59714);
} else {
return G__59714;
}
...
var output_generator = (function (){var G__59723 = new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(malli.core._function_info(schema));
var G__59724 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__59723,G__59724) : malli.generator.generator.call(null,G__59723,G__59724));
})();
...
var G__59827__delegate = function (_){
...
var G__59831__i = 0, G__59831__a = new Array(arguments.length -  0);
while (G__59831__i < G__59831__a.length) {G__59831__a[G__59831__i] = arguments[G__59831__i + 0]; ++G__59831__i;}
  _ = new cljs.core.IndexedSeq(G__59831__a,0,null);
} 
return G__59827__delegate.call(this,_);};
G__59827.cljs$lang$maxFixedArity = 0;
G__59827.cljs$lang$applyTo = (function (arglist__59832){
var _ = cljs.core.seq(arglist__59832);
return G__59827__delegate(_);
});
...
return clojure.test.check.generators.return$(malli.core._instrument.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"schema","schema",-1582001791),schema,new cljs.core.Keyword(null,"gen","gen",142575302),(function (p1__59726_SHARP_){
return (malli.generator.generate.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generate.cljs$core$IFn$_invoke$arity$2(p1__59726_SHARP_,options) : malli.generator.generate.call(null,p1__59726_SHARP_,options));
})], null),null,options));
});
malli.generator._regex_generator = (function malli$generator$_regex_generator(schema,options){
var G__59727 = (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(schema,options) : malli.generator.generator.call(null,schema,options));
if(cljs.core.not(malli.core._regex_op_QMARK_(schema))){
return malli.generator.gen_tuple((new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[G__59727],null)));
} else {
return G__59727;
}
});
...
return malli.generator.gen_fcat(malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59730_SHARP_){
return malli.generator._re_entry_gen(p1__59730_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options))));
});
malli.generator._alt_gen = (function malli$generator$_alt_gen(schema,options){
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59732_SHARP_){
return malli.generator._re_entry_gen(p1__59732_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
});
...
var child = malli.generator._child(schema,options);
var G__59734 = malli.generator.gen_vector(malli.generator._min_max(schema,options),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__59734);
} else {
return G__59734;
}
});
...
var or__5025__auto__ = (function (){var G__59737 = malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$2(schema,options);
var G__59737__$1 = (((G__59737 == null))?null:malli.generator._not_unreachable(G__59737));
if((G__59737__$1 == null)){
return null;
} else {
var G__59738 = G__59737__$1;
if(cljs.core.truth_(malli.core._regex_op_QMARK_(malli.generator._child(schema,options)))){
return malli.generator.gen_fcat(G__59738);
} else {
return G__59738;
}
}
...
var G__59739 = cljs.core.name(namespace_unparsed);
var G__59740 = cljs.core.name(k);
return (mk_value_with_ns.cljs$core$IFn$_invoke$arity$2 ? mk_value_with_ns.cljs$core$IFn$_invoke$arity$2(G__59739,G__59740) : mk_value_with_ns.call(null,G__59739,G__59740));
...
})(),cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__59742_SHARP_){
var G__59744 = p1__59742_SHARP_;
if((G__59744 == null)){
return null;
} else {
return G__59744;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__59743_SHARP_){
var G__59745 = p1__59743_SHARP_;
if((G__59745 == null)){
return null;
} else {
return G__59745;
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.generator","default","malli.generator/default",-943988734)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__59746 = cljs.core.get_global_hierarchy;
return (fexpr__59746.cljs$core$IFn$_invoke$arity$0 ? fexpr__59746.cljs$core$IFn$_invoke$arity$0() : fexpr__59746.call(null));
})());
...
return malli.generator.gen_such_that(schema,(function (p1__59747_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__59747_SHARP_,malli.generator._child(schema,options));
...
return malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59752_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__59752_SHARP_,options) : malli.generator.generator.call(null,p1__59752_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
}));
...
var G__59754 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__59755 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__59754,G__59755) : malli.generator.generator.call(null,G__59754,G__59755));
}));
...
var G__59756 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__59757 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__59756,G__59757) : malli.generator.generator.call(null,G__59756,G__59757));
}));
...
var G__59758 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__59759 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__59758,G__59759) : malli.generator.generator.call(null,G__59758,G__59759));
}));
...
var G__59760 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__59761 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__59760,G__59761) : malli.generator.generator.call(null,G__59760,G__59761));
}));
...
var G__59762 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__59763 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__59762,G__59763) : malli.generator.generator.call(null,G__59762,G__59763));
}));
...
var G__59764 = new cljs.core.Keyword("gen","elements","gen/elements",657813311).cljs$core$IFn$_invoke$arity$1(props);
if((G__59764 == null)){
return null;
} else {
return malli.generator.gen_elements(G__59764);
}
});
...
var G__59769 = new cljs.core.Keyword("gen","schema","gen/schema",-1582038959).cljs$core$IFn$_invoke$arity$1(props);
if((G__59769 == null)){
return null;
} else {
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__59769,options) : malli.generator.generator.call(null,G__59769,options));
}
});
...
return malli.core._cached(malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options),new cljs.core.Keyword(null,"generator","generator",-572962281),(function (p1__59771_SHARP_){
return malli.generator._create(p1__59771_SHARP_,options);
}));
}
}));
...
(malli.generator.generate.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__59776){
var map__59777 = p__59776;
var map__59777__$1 = cljs.core.__destructure_map(map__59777);
var options = map__59777__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59777__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__59777__$1,new cljs.core.Keyword(null,"size","size",1098693007),(30));
...
(malli.generator.sample.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__59782){
var map__59783 = p__59782;
var map__59783__$1 = cljs.core.__destructure_map(map__59783);
var options = map__59783__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59783__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__59783__$1,new cljs.core.Keyword(null,"size","size",1098693007),(10));
var gen = ((clojure.test.check.generators.generator_QMARK_(_QMARK_gen_or_schema))?_QMARK_gen_or_schema:malli.generator.generator.cljs$core$IFn$_invoke$arity$2(_QMARK_gen_or_schema,options));
return cljs.core.take.cljs$core$IFn$_invoke$arity$2(size,cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__59778_SHARP_,p2__59779_SHARP_){
return clojure.test.check.rose_tree.root(clojure.test.check.generators.call_gen(gen,p1__59778_SHARP_,p2__59779_SHARP_));
...
(malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_schema,p__59789){
var map__59790 = p__59789;
var map__59790__$1 = cljs.core.__destructure_map(map__59790);
var options = map__59790__$1;
var _EQ__GT_iterations = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__59790__$1,new cljs.core.Keyword("malli.generator","=>iterations","malli.generator/=>iterations",-1726832707),(100));
...
}catch (e59791){if((e59791 instanceof Error)){
var e = e59791;
...
var map__59792 = malli.core._function_info(schema__$1);
var map__59792__$1 = cljs.core.__destructure_map(map__59792);
var input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59792__$1,new cljs.core.Keyword(null,"input","input",556931961));
var output = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59792__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var guard = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59792__$1,new cljs.core.Keyword(null,"guard","guard",-873147811));
...
if(cljs.core.truth_(and__5023__auto__)){
var G__59793 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [args,$], null);
return (valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1 ? valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1(G__59793) : valid_guard_QMARK_.call(null,G__59793));
} else {
return and__5023__auto__;
}
});
return (function (f){
var map__59794 = clojure.test.check.quick_check(_EQ__GT_iterations,clojure.test.check.properties.for_all_STAR_(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [input_generator], null),(function (p1__59784_SHARP_){
return validate(f,p1__59784_SHARP_);
})));
var map__59794__$1 = cljs.core.__destructure_map(map__59794);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59794__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var shrunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59794__$1,new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412));
...
var vec__59795 = (cljs.core.truth_(explain_input)?null:_try((function (){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,smallest);
})));
var result__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59795,(0),null);
var success = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59795,(1),null);
...
var G__59798 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(shrunk,new cljs.core.Keyword("malli.core","result","malli.core/result",1538632379),result__$1);
var G__59798__$1 = (cljs.core.truth_(explain_input)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__59798,new cljs.core.Keyword("malli.core","explain-input","malli.core/explain-input",1441627811),explain_input):G__59798);
var G__59798__$2 = (cljs.core.truth_(explain_output)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__59798__$1,new cljs.core.Keyword("malli.core","explain-output","malli.core/explain-output",-124321573),explain_output):G__59798__$1);
var G__59798__$3 = (cljs.core.truth_(explain_guard)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__59798__$2,new cljs.core.Keyword("malli.core","explain-guard","malli.core/explain-guard",-1119572847),explain_guard):G__59798__$2);
if(cljs.core.truth_(cljs.core.ex_message(result__$1))){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__59798__$3,new cljs.core.Keyword(null,"result","result",1415092211),cljs.core.ex_message),new cljs.core.Keyword(null,"result-data","result-data",-1724248844));
} else {
return G__59798__$3;
}
}
...
var checkers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59785_SHARP_){
return malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2(p1__59785_SHARP_,options);
}),malli.core._function_schema_arities(schema));
return (function (x){
return cljs.core.seq(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__59786_SHARP_){
return (p1__59786_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__59786_SHARP_.cljs$core$IFn$_invoke$arity$1(x) : p1__59786_SHARP_.call(null,x));
}),checkers));
});
} else {
