...
var malli$generator$Generator$_generator$dyn_52602 = (function (this$,options){
...
return malli$generator$Generator$_generator$dyn_52602(this$,options);
}
});
...
var G__52426 = malli.generator._child(schema,options);
var G__52427 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52426,G__52427) : malli.generator.generator.call(null,G__52426,G__52427));
});
/**
 * Return a generator of no values that is compatible with -unreachable-gen?.
 */
malli.generator._never_gen = (function malli$generator$_never_gen(p__52428){
var map__52429 = p__52428;
var map__52429__$1 = cljs.core.__destructure_map(map__52429);
var _options = map__52429__$1;
var original_generator_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52429__$1,new cljs.core.Keyword("malli.generator","original-generator-schema","malli.generator/original-generator-schema",-1122475395));
return cljs.core.with_meta(clojure.test.check.generators.sized((function (_){
return malli.core._fail_BANG_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("malli.generator","unsatisfiable-schema","malli.generator/unsatisfiable-schema",919209538),(function (){var G__52432 = cljs.core.PersistentArrayMap.EMPTY;
if(cljs.core.truth_(original_generator_schema)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52432,new cljs.core.Keyword(null,"schema","schema",-1582001791),original_generator_schema);
} else {
return G__52432;
}
})());
...
var map__52435 = malli.core.properties.cljs$core$IFn$_invoke$arity$2(schema,options);
var map__52435__$1 = cljs.core.__destructure_map(map__52435);
var gen_min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52435__$1,new cljs.core.Keyword("gen","min","gen/min",444569458));
var gen_max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52435__$1,new cljs.core.Keyword("gen","max","gen/max",61264228));
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52435__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52435__$1,new cljs.core.Keyword(null,"max","max",61366548));
...
var map__52436 = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
var map__52436__$1 = cljs.core.__destructure_map(map__52436);
var infinite_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52436__$1,new cljs.core.Keyword("gen","infinite?","gen/infinite?",-2017652832));
var NaN_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52436__$1,new cljs.core.Keyword("gen","NaN?","gen/NaN?",-1917993267));
...
return malli.generator.gen_fmap((function (p1__52446_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,p1__52446_SHARP_);
}),gen);
});
...
return clojure.test.check.generators.double_STAR_(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$2(malli.generator.double_default,opts),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__52447_SHARP_){
var G__52458 = p1__52447_SHARP_;
if((G__52458 == null)){
return null;
} else {
return G__52458;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__52457_SHARP_){
var G__52459 = p1__52457_SHARP_;
if((G__52459 == null)){
return null;
} else {
return G__52459;
...
malli.generator.gen_vector = (function malli$generator$gen_vector(p__52461,g){
var map__52462 = p__52461;
var map__52462__$1 = cljs.core.__destructure_map(map__52462);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52462__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52462__$1,new cljs.core.Keyword(null,"max","max",61366548));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(clojure.test.check.generators.sized((function (p1__52460_SHARP_){
return clojure.test.check.generators.vector.cljs$core$IFn$_invoke$arity$3(g,min,(min + p1__52460_SHARP_));
...
malli.generator.gen_vector_distinct_by = (function malli$generator$gen_vector_distinct_by(schema,p__52465,f,g){
var map__52466 = p__52465;
var map__52466__$1 = cljs.core.__destructure_map(map__52466);
var m = map__52466__$1;
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52466__$1,new cljs.core.Keyword(null,"min","min",444991522));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
})())?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"num-elements","num-elements",1960422107),min], null):clojure.set.rename_keys(m,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"min","min",444991522),new cljs.core.Keyword(null,"min-elements","min-elements",949370780),new cljs.core.Keyword(null,"max","max",61366548),new cljs.core.Keyword(null,"max-elements","max-elements",433034073)], null))),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__52464_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","distinct-generator-failure","malli.generator/distinct-generator-failure",-2085139904),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__52464_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null)));
}
});
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__52475_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","such-that-failure","malli.generator/such-that-failure",599634585),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__52475_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null);
});
...
var map__52486 = malli.generator._min_max(schema,options);
var map__52486__$1 = cljs.core.__destructure_map(map__52486);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52486__$1,new cljs.core.Keyword(null,"min","min",444991522));
var el = malli.generator._child(schema,options);
return malli.generator.gen_one_of(options,(function (){var G__52488 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$3((function (){var G__52489 = cljs.core.PersistentVector.EMPTY;
if((((min == null)) || ((min === (0))))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__52489,malli.generator.nil_gen);
} else {
return G__52489;
}
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__52481_SHARP_){
return malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$3(schema,p1__52481_SHARP_,options);
})),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.identity,cljs.core.vec,cljs.core.eduction,(function (p1__52483_SHARP_){
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(p1__52483_SHARP_);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__52488,(function (){var vec__52491 = malli.core.children.cljs$core$IFn$_invoke$arity$1(el);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52491,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52491,(1),null);
var G__52494 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map-of","map-of",1189682355),(function (){var or__5025__auto__ = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
...
var G__52495 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52494,G__52495) : malli.generator.generator.call(null,G__52494,G__52495));
})());
} else {
return G__52488;
}
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52497_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__52497_SHARP_,options) : malli.generator.generator.call(null,p1__52497_SHARP_,options));
...
return malli.util.transform_entries.cljs$core$IFn$_invoke$arity$3(G__52502,(function (p1__52501_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__52503){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__52507,(2),malli.util.merge,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dispatch,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"=","=",1152933628),null,k], null)], null)], null));
} else {
return G__52507;
}
}),p1__52501_SHARP_);
...
var G__52509 = cljs.core.last(p1__52508_SHARP_);
var G__52510 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52509,G__52510) : malli.generator.generator.call(null,G__52509,G__52510));
...
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__52514){
var vec__52515 = p__52514;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52515,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52515,(1),null);
...
malli.generator._entry_gen = (function malli$generator$_entry_gen(p__52519,options){
var vec__52520 = p__52519;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52520,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52520,(1),null);
var G__52523 = malli.generator.gen_fmap((function (p1__52518_SHARP_){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,p1__52518_SHARP_], null);
...
return malli.generator.gen_maybe(G__52523);
} else {
return G__52523;
}
});
malli.generator._map_gen = (function malli$generator$_map_gen(schema,options){
return malli.generator.gen_fmap(malli.generator._build_map,malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52524_SHARP_){
return malli.generator._entry_gen(p1__52524_SHARP_,options);
...
return malli.generator.gen_fmap((function (p1__52527_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,p1__52527_SHARP_);
}),malli.generator.gen_vector_distinct_by(schema,malli.generator._min_max(schema,options),(function (p1__52526_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__52526_SHARP_,(0));
}),malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52525_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__52525_SHARP_,options) : malli.generator.generator.call(null,p1__52525_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)))));
});
...
var G__52529 = (function (){var G__52530 = dschema;
var G__52531 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),scalar_ref_gen);
...
return clojure.test.check.generators.recursive_gen((function (p1__52528_SHARP_){
var G__52532 = dschema;
var G__52533 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),p1__52528_SHARP_);
...
var output_generator = (function (){var G__52534 = new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(malli.core._function_info(schema));
var G__52535 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52534,G__52535) : malli.generator.generator.call(null,G__52534,G__52535));
})();
...
var G__52634__delegate = function (_){
...
while (G__52635__i < G__52635__a.length) {G__52635__a[G__52635__i] = arguments[G__52635__i + 0]; ++G__52635__i;}
  _ = new cljs.core.IndexedSeq(G__52635__a,0,null);
} 
return G__52634__delegate.call(this,_);};
G__52634.cljs$lang$maxFixedArity = 0;
G__52634.cljs$lang$applyTo = (function (arglist__52646){
var _ = cljs.core.seq(arglist__52646);
return G__52634__delegate(_);
});
...
return clojure.test.check.generators.return$(malli.core._instrument.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"schema","schema",-1582001791),schema,new cljs.core.Keyword(null,"gen","gen",142575302),(function (p1__52536_SHARP_){
return (malli.generator.generate.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generate.cljs$core$IFn$_invoke$arity$2(p1__52536_SHARP_,options) : malli.generator.generate.call(null,p1__52536_SHARP_,options));
})], null),null,options));
});
malli.generator._regex_generator = (function malli$generator$_regex_generator(schema,options){
var G__52537 = (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(schema,options) : malli.generator.generator.call(null,schema,options));
if(cljs.core.not(malli.core._regex_op_QMARK_(schema))){
return malli.generator.gen_tuple((new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[G__52537],null)));
} else {
return G__52537;
}
});
...
return malli.generator.gen_fcat(malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52538_SHARP_){
return malli.generator._re_entry_gen(p1__52538_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options))));
});
malli.generator._alt_gen = (function malli$generator$_alt_gen(schema,options){
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52539_SHARP_){
return malli.generator._re_entry_gen(p1__52539_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
});
...
var child = malli.generator._child(schema,options);
var G__52540 = malli.generator.gen_vector(malli.generator._min_max(schema,options),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__52540);
} else {
return G__52540;
}
});
...
var child = malli.generator._child(schema,options);
var G__52541 = malli.generator.gen_vector(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.max,(1))),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__52541);
} else {
return G__52541;
}
});
malli.generator._repeat_gen = (function malli$generator$_repeat_gen(schema,options){
var or__5025__auto__ = (function (){var G__52542 = malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$2(schema,options);
var G__52542__$1 = (((G__52542 == null))?null:malli.generator._not_unreachable(G__52542));
if((G__52542__$1 == null)){
return null;
} else {
var G__52543 = G__52542__$1;
if(cljs.core.truth_(malli.core._regex_op_QMARK_(malli.generator._child(schema,options)))){
return malli.generator.gen_fcat(G__52543);
} else {
return G__52543;
}
}
...
var G__52544 = cljs.core.name(namespace_unparsed);
var G__52545 = cljs.core.name(k);
return (mk_value_with_ns.cljs$core$IFn$_invoke$arity$2 ? mk_value_with_ns.cljs$core$IFn$_invoke$arity$2(G__52544,G__52545) : mk_value_with_ns.call(null,G__52544,G__52545));
...
})(),cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__52546_SHARP_){
var G__52548 = p1__52546_SHARP_;
if((G__52548 == null)){
return null;
} else {
return G__52548;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__52547_SHARP_){
var G__52549 = p1__52547_SHARP_;
if((G__52549 == null)){
return null;
} else {
return G__52549;
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.generator","default","malli.generator/default",-943988734)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__52550 = cljs.core.get_global_hierarchy;
return (fexpr__52550.cljs$core$IFn$_invoke$arity$0 ? fexpr__52550.cljs$core$IFn$_invoke$arity$0() : fexpr__52550.call(null));
})());
...
return malli.generator.gen_such_that(schema,(function (p1__52555_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__52555_SHARP_,malli.generator._child(schema,options));
...
return malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52556_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__52556_SHARP_,options) : malli.generator.generator.call(null,p1__52556_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
}));
...
var G__52558 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52559 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52558,G__52559) : malli.generator.generator.call(null,G__52558,G__52559));
}));
...
var G__52560 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52561 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52560,G__52561) : malli.generator.generator.call(null,G__52560,G__52561));
}));
...
var G__52562 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52563 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52562,G__52563) : malli.generator.generator.call(null,G__52562,G__52563));
}));
...
var G__52564 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52565 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52564,G__52565) : malli.generator.generator.call(null,G__52564,G__52565));
}));
...
var G__52566 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52567 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52566,G__52567) : malli.generator.generator.call(null,G__52566,G__52567));
}));
...
var G__52568 = new cljs.core.Keyword("gen","elements","gen/elements",657813311).cljs$core$IFn$_invoke$arity$1(props);
if((G__52568 == null)){
return null;
} else {
return malli.generator.gen_elements(G__52568);
}
});
...
var G__52569 = new cljs.core.Keyword("gen","schema","gen/schema",-1582038959).cljs$core$IFn$_invoke$arity$1(props);
if((G__52569 == null)){
return null;
} else {
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52569,options) : malli.generator.generator.call(null,G__52569,options));
}
});
...
return malli.core._cached(malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options),new cljs.core.Keyword(null,"generator","generator",-572962281),(function (p1__52570_SHARP_){
return malli.generator._create(p1__52570_SHARP_,options);
}));
}
}));
...
(malli.generator.generate.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__52575){
var map__52576 = p__52575;
var map__52576__$1 = cljs.core.__destructure_map(map__52576);
var options = map__52576__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52576__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52576__$1,new cljs.core.Keyword(null,"size","size",1098693007),(30));
...
(malli.generator.sample.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__52581){
var map__52582 = p__52581;
var map__52582__$1 = cljs.core.__destructure_map(map__52582);
var options = map__52582__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52582__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52582__$1,new cljs.core.Keyword(null,"size","size",1098693007),(10));
var gen = ((clojure.test.check.generators.generator_QMARK_(_QMARK_gen_or_schema))?_QMARK_gen_or_schema:malli.generator.generator.cljs$core$IFn$_invoke$arity$2(_QMARK_gen_or_schema,options));
return cljs.core.take.cljs$core$IFn$_invoke$arity$2(size,cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__52577_SHARP_,p2__52578_SHARP_){
return clojure.test.check.rose_tree.root(clojure.test.check.generators.call_gen(gen,p1__52577_SHARP_,p2__52578_SHARP_));
...
(malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_schema,p__52588){
var map__52589 = p__52588;
var map__52589__$1 = cljs.core.__destructure_map(map__52589);
var options = map__52589__$1;
var _EQ__GT_iterations = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52589__$1,new cljs.core.Keyword("malli.generator","=>iterations","malli.generator/=>iterations",-1726832707),(100));
...
}catch (e52590){if((e52590 instanceof Error)){
var e = e52590;
...
var map__52591 = malli.core._function_info(schema__$1);
var map__52591__$1 = cljs.core.__destructure_map(map__52591);
var input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52591__$1,new cljs.core.Keyword(null,"input","input",556931961));
var output = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52591__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var guard = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52591__$1,new cljs.core.Keyword(null,"guard","guard",-873147811));
...
if(cljs.core.truth_(and__5023__auto__)){
var G__52592 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [args,$], null);
return (valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1 ? valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1(G__52592) : valid_guard_QMARK_.call(null,G__52592));
} else {
return and__5023__auto__;
}
});
return (function (f){
var map__52593 = clojure.test.check.quick_check(_EQ__GT_iterations,clojure.test.check.properties.for_all_STAR_(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [input_generator], null),(function (p1__52583_SHARP_){
return validate(f,p1__52583_SHARP_);
})));
var map__52593__$1 = cljs.core.__destructure_map(map__52593);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52593__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var shrunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52593__$1,new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412));
...
var vec__52594 = (cljs.core.truth_(explain_input)?null:_try((function (){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,smallest);
})));
var result__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52594,(0),null);
var success = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52594,(1),null);
...
var checkers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52584_SHARP_){
return malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2(p1__52584_SHARP_,options);
}),malli.core._function_schema_arities(schema));
return (function (x){
return cljs.core.seq(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__52585_SHARP_){
return (p1__52585_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__52585_SHARP_.cljs$core$IFn$_invoke$arity$1(x) : p1__52585_SHARP_.call(null,x));
}),checkers));
});
} else {
