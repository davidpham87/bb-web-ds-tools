...
var malli$generator$Generator$_generator$dyn_52600 = (function (this$,options){
...
return malli$generator$Generator$_generator$dyn_52600(this$,options);
}
});
...
var G__52366 = malli.generator._child(schema,options);
var G__52367 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52366,G__52367) : malli.generator.generator.call(null,G__52366,G__52367));
});
/**
 * Return a generator of no values that is compatible with -unreachable-gen?.
 */
malli.generator._never_gen = (function malli$generator$_never_gen(p__52372){
var map__52374 = p__52372;
var map__52374__$1 = cljs.core.__destructure_map(map__52374);
var _options = map__52374__$1;
var original_generator_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52374__$1,new cljs.core.Keyword("malli.generator","original-generator-schema","malli.generator/original-generator-schema",-1122475395));
...
var map__52391 = malli.core.properties.cljs$core$IFn$_invoke$arity$2(schema,options);
var map__52391__$1 = cljs.core.__destructure_map(map__52391);
var gen_min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52391__$1,new cljs.core.Keyword("gen","min","gen/min",444569458));
var gen_max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52391__$1,new cljs.core.Keyword("gen","max","gen/max",61264228));
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52391__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52391__$1,new cljs.core.Keyword(null,"max","max",61366548));
...
var map__52395 = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
var map__52395__$1 = cljs.core.__destructure_map(map__52395);
var infinite_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52395__$1,new cljs.core.Keyword("gen","infinite?","gen/infinite?",-2017652832));
var NaN_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52395__$1,new cljs.core.Keyword("gen","NaN?","gen/NaN?",-1917993267));
...
return malli.generator.gen_fmap((function (p1__52406_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,p1__52406_SHARP_);
}),gen);
});
...
return clojure.test.check.generators.double_STAR_(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$2(malli.generator.double_default,opts),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__52413_SHARP_){
var G__52420 = p1__52413_SHARP_;
if((G__52420 == null)){
return null;
} else {
return G__52420;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__52414_SHARP_){
var G__52421 = p1__52414_SHARP_;
if((G__52421 == null)){
return null;
} else {
return G__52421;
...
malli.generator.gen_vector = (function malli$generator$gen_vector(p__52423,g){
...
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52424__$1,new cljs.core.Keyword(null,"max","max",61366548));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(clojure.test.check.generators.sized((function (p1__52422_SHARP_){
return clojure.test.check.generators.vector.cljs$core$IFn$_invoke$arity$3(g,min,(min + p1__52422_SHARP_));
...
malli.generator.gen_vector_distinct_by = (function malli$generator$gen_vector_distinct_by(schema,p__52426,f,g){
var map__52427 = p__52426;
var map__52427__$1 = cljs.core.__destructure_map(map__52427);
var m = map__52427__$1;
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52427__$1,new cljs.core.Keyword(null,"min","min",444991522));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
})())?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"num-elements","num-elements",1960422107),min], null):clojure.set.rename_keys(m,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"min","min",444991522),new cljs.core.Keyword(null,"min-elements","min-elements",949370780),new cljs.core.Keyword(null,"max","max",61366548),new cljs.core.Keyword(null,"max-elements","max-elements",433034073)], null))),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__52425_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","distinct-generator-failure","malli.generator/distinct-generator-failure",-2085139904),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__52425_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null)));
}
});
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__52430_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","such-that-failure","malli.generator/such-that-failure",599634585),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__52430_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null);
});
...
var map__52433 = malli.generator._min_max(schema,options);
var map__52433__$1 = cljs.core.__destructure_map(map__52433);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52433__$1,new cljs.core.Keyword(null,"min","min",444991522));
var el = malli.generator._child(schema,options);
return malli.generator.gen_one_of(options,(function (){var G__52434 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$3((function (){var G__52435 = cljs.core.PersistentVector.EMPTY;
if((((min == null)) || ((min === (0))))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__52435,malli.generator.nil_gen);
} else {
return G__52435;
}
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__52431_SHARP_){
return malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$3(schema,p1__52431_SHARP_,options);
})),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.identity,cljs.core.vec,cljs.core.eduction,(function (p1__52432_SHARP_){
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(p1__52432_SHARP_);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__52434,(function (){var vec__52436 = malli.core.children.cljs$core$IFn$_invoke$arity$1(el);
...
var G__52439 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map-of","map-of",1189682355),(function (){var or__5025__auto__ = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
...
var G__52440 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52439,G__52440) : malli.generator.generator.call(null,G__52439,G__52440));
})());
} else {
return G__52434;
}
...
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__52441_SHARP_,options) : malli.generator.generator.call(null,p1__52441_SHARP_,options));
...
return malli.util.transform_entries.cljs$core$IFn$_invoke$arity$3(G__52443,(function (p1__52442_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__52444){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__52448,(2),malli.util.merge,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dispatch,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"=","=",1152933628),null,k], null)], null)], null));
} else {
return G__52448;
}
}),p1__52442_SHARP_);
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52449_SHARP_){
var G__52450 = cljs.core.last(p1__52449_SHARP_);
var G__52451 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52450,G__52451) : malli.generator.generator.call(null,G__52450,G__52451));
...
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__52452){
var vec__52453 = p__52452;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52453,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52453,(1),null);
...
malli.generator._entry_gen = (function malli$generator$_entry_gen(p__52457,options){
var vec__52458 = p__52457;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52458,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52458,(1),null);
var G__52461 = malli.generator.gen_fmap((function (p1__52456_SHARP_){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,p1__52456_SHARP_], null);
...
return malli.generator.gen_maybe(G__52461);
} else {
return G__52461;
}
});
malli.generator._map_gen = (function malli$generator$_map_gen(schema,options){
return malli.generator.gen_fmap(malli.generator._build_map,malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52462_SHARP_){
return malli.generator._entry_gen(p1__52462_SHARP_,options);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,p1__52465_SHARP_);
}),malli.generator.gen_vector_distinct_by(schema,malli.generator._min_max(schema,options),(function (p1__52464_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__52464_SHARP_,(0));
}),malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52463_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__52463_SHARP_,options) : malli.generator.generator.call(null,p1__52463_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)))));
});
...
var G__52470 = (function (){var G__52472 = dschema;
var G__52473 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),scalar_ref_gen);
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52472,G__52473) : malli.generator.generator.call(null,G__52472,G__52473));
})();
if(cljs.core.realized_QMARK_(scalar_ref_gen)){
return clojure.test.check.generators.recursive_gen((function (p1__52469_SHARP_){
var G__52477 = dschema;
var G__52478 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),p1__52469_SHARP_);
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52477,G__52478) : malli.generator.generator.call(null,G__52477,G__52478));
}),G__52470);
} else {
return G__52470;
}
...
var output_generator = (function (){var G__52479 = new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(malli.core._function_info(schema));
var G__52480 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52479,G__52480) : malli.generator.generator.call(null,G__52479,G__52480));
})();
...
var G__52644__delegate = function (_){
...
var G__52644 = function (var_args){
var _ = null;
if (arguments.length > 0) {
var G__52645__i = 0, G__52645__a = new Array(arguments.length -  0);
while (G__52645__i < G__52645__a.length) {G__52645__a[G__52645__i] = arguments[G__52645__i + 0]; ++G__52645__i;}
  _ = new cljs.core.IndexedSeq(G__52645__a,0,null);
} 
return G__52644__delegate.call(this,_);};
G__52644.cljs$lang$maxFixedArity = 0;
G__52644.cljs$lang$applyTo = (function (arglist__52646){
var _ = cljs.core.seq(arglist__52646);
return G__52644__delegate(_);
});
G__52644.cljs$core$IFn$_invoke$arity$variadic = G__52644__delegate;
return G__52644;
})()
));
});
malli.generator._function_gen = (function malli$generator$_function_gen(schema,options){
return clojure.test.check.generators.return$(malli.core._instrument.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"schema","schema",-1582001791),schema,new cljs.core.Keyword(null,"gen","gen",142575302),(function (p1__52482_SHARP_){
return (malli.generator.generate.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generate.cljs$core$IFn$_invoke$arity$2(p1__52482_SHARP_,options) : malli.generator.generate.call(null,p1__52482_SHARP_,options));
})], null),null,options));
});
malli.generator._regex_generator = (function malli$generator$_regex_generator(schema,options){
var G__52483 = (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(schema,options) : malli.generator.generator.call(null,schema,options));
if(cljs.core.not(malli.core._regex_op_QMARK_(schema))){
return malli.generator.gen_tuple((new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[G__52483],null)));
} else {
return G__52483;
}
});
...
return malli.generator.gen_fcat(malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52484_SHARP_){
return malli.generator._re_entry_gen(p1__52484_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options))));
});
malli.generator._alt_gen = (function malli$generator$_alt_gen(schema,options){
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52485_SHARP_){
return malli.generator._re_entry_gen(p1__52485_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
});
...
var child = malli.generator._child(schema,options);
var G__52487 = malli.generator.gen_vector(malli.generator._min_max(schema,options),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__52487);
} else {
return G__52487;
}
});
...
var child = malli.generator._child(schema,options);
var G__52492 = malli.generator.gen_vector(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.max,(1))),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__52492);
} else {
return G__52492;
}
});
malli.generator._repeat_gen = (function malli$generator$_repeat_gen(schema,options){
var or__5025__auto__ = (function (){var G__52501 = malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$2(schema,options);
var G__52501__$1 = (((G__52501 == null))?null:malli.generator._not_unreachable(G__52501));
if((G__52501__$1 == null)){
return null;
} else {
var G__52503 = G__52501__$1;
if(cljs.core.truth_(malli.core._regex_op_QMARK_(malli.generator._child(schema,options)))){
return malli.generator.gen_fcat(G__52503);
} else {
return G__52503;
}
}
...
var G__52511 = cljs.core.name(namespace_unparsed);
var G__52512 = cljs.core.name(k);
return (mk_value_with_ns.cljs$core$IFn$_invoke$arity$2 ? mk_value_with_ns.cljs$core$IFn$_invoke$arity$2(G__52511,G__52512) : mk_value_with_ns.call(null,G__52511,G__52512));
...
})(),cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__52515_SHARP_){
var G__52517 = p1__52515_SHARP_;
if((G__52517 == null)){
return null;
} else {
return G__52517;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__52516_SHARP_){
var G__52522 = p1__52516_SHARP_;
if((G__52522 == null)){
return null;
} else {
return G__52522;
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.generator","default","malli.generator/default",-943988734)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__52525 = cljs.core.get_global_hierarchy;
...
return malli.generator.gen_such_that(schema,(function (p1__52526_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__52526_SHARP_,malli.generator._child(schema,options));
...
return malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52529_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__52529_SHARP_,options) : malli.generator.generator.call(null,p1__52529_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
}));
...
var G__52530 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52531 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52530,G__52531) : malli.generator.generator.call(null,G__52530,G__52531));
}));
...
var G__52532 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52533 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52532,G__52533) : malli.generator.generator.call(null,G__52532,G__52533));
}));
...
var G__52535 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52536 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52535,G__52536) : malli.generator.generator.call(null,G__52535,G__52536));
}));
...
var G__52537 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52538 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52537,G__52538) : malli.generator.generator.call(null,G__52537,G__52538));
}));
...
var G__52539 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52540 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52539,G__52540) : malli.generator.generator.call(null,G__52539,G__52540));
}));
...
var G__52548 = new cljs.core.Keyword("gen","elements","gen/elements",657813311).cljs$core$IFn$_invoke$arity$1(props);
if((G__52548 == null)){
return null;
} else {
return malli.generator.gen_elements(G__52548);
}
});
...
var G__52549 = new cljs.core.Keyword("gen","schema","gen/schema",-1582038959).cljs$core$IFn$_invoke$arity$1(props);
if((G__52549 == null)){
return null;
} else {
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52549,options) : malli.generator.generator.call(null,G__52549,options));
}
});
...
return malli.core._cached(malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options),new cljs.core.Keyword(null,"generator","generator",-572962281),(function (p1__52559_SHARP_){
return malli.generator._create(p1__52559_SHARP_,options);
}));
}
}));
...
(malli.generator.generate.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__52564){
var map__52565 = p__52564;
var map__52565__$1 = cljs.core.__destructure_map(map__52565);
var options = map__52565__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52565__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52565__$1,new cljs.core.Keyword(null,"size","size",1098693007),(30));
...
(malli.generator.sample.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__52580){
var map__52581 = p__52580;
var map__52581__$1 = cljs.core.__destructure_map(map__52581);
var options = map__52581__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52581__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52581__$1,new cljs.core.Keyword(null,"size","size",1098693007),(10));
var gen = ((clojure.test.check.generators.generator_QMARK_(_QMARK_gen_or_schema))?_QMARK_gen_or_schema:malli.generator.generator.cljs$core$IFn$_invoke$arity$2(_QMARK_gen_or_schema,options));
return cljs.core.take.cljs$core$IFn$_invoke$arity$2(size,cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__52566_SHARP_,p2__52567_SHARP_){
return clojure.test.check.rose_tree.root(clojure.test.check.generators.call_gen(gen,p1__52566_SHARP_,p2__52567_SHARP_));
...
var G__52596 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(shrunk,new cljs.core.Keyword("malli.core","result","malli.core/result",1538632379),result__$1);
var G__52596__$1 = (cljs.core.truth_(explain_input)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52596,new cljs.core.Keyword("malli.core","explain-input","malli.core/explain-input",1441627811),explain_input):G__52596);
var G__52596__$2 = (cljs.core.truth_(explain_output)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52596__$1,new cljs.core.Keyword("malli.core","explain-output","malli.core/explain-output",-124321573),explain_output):G__52596__$1);
var G__52596__$3 = (cljs.core.truth_(explain_guard)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52596__$2,new cljs.core.Keyword("malli.core","explain-guard","malli.core/explain-guard",-1119572847),explain_guard):G__52596__$2);
if(cljs.core.truth_(cljs.core.ex_message(result__$1))){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__52596__$3,new cljs.core.Keyword(null,"result","result",1415092211),cljs.core.ex_message),new cljs.core.Keyword(null,"result-data","result-data",-1724248844));
} else {
return G__52596__$3;
}
}
...
var schema = malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options);
return malli.core.explain.cljs$core$IFn$_invoke$arity$2(malli.core._update_options(schema,(function (p1__52597_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__52597_SHARP_,new cljs.core.Keyword("malli.core","function-checker","malli.core/function-checker",-792030936),malli.generator.function_checker);
})),f);
}));
