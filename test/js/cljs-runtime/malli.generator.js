...
var malli$generator$Generator$_generator$dyn_52673 = (function (this$,options){
...
return malli$generator$Generator$_generator$dyn_52673(this$,options);
}
});
...
var G__52485 = malli.generator._child(schema,options);
var G__52486 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52485,G__52486) : malli.generator.generator.call(null,G__52485,G__52486));
});
/**
 * Return a generator of no values that is compatible with -unreachable-gen?.
 */
malli.generator._never_gen = (function malli$generator$_never_gen(p__52490){
var map__52492 = p__52490;
var map__52492__$1 = cljs.core.__destructure_map(map__52492);
var _options = map__52492__$1;
var original_generator_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52492__$1,new cljs.core.Keyword("malli.generator","original-generator-schema","malli.generator/original-generator-schema",-1122475395));
return cljs.core.with_meta(clojure.test.check.generators.sized((function (_){
return malli.core._fail_BANG_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("malli.generator","unsatisfiable-schema","malli.generator/unsatisfiable-schema",919209538),(function (){var G__52493 = cljs.core.PersistentArrayMap.EMPTY;
if(cljs.core.truth_(original_generator_schema)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52493,new cljs.core.Keyword(null,"schema","schema",-1582001791),original_generator_schema);
} else {
return G__52493;
}
})());
...
var map__52503 = malli.core.properties.cljs$core$IFn$_invoke$arity$2(schema,options);
var map__52503__$1 = cljs.core.__destructure_map(map__52503);
var gen_min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52503__$1,new cljs.core.Keyword("gen","min","gen/min",444569458));
var gen_max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52503__$1,new cljs.core.Keyword("gen","max","gen/max",61264228));
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52503__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52503__$1,new cljs.core.Keyword(null,"max","max",61366548));
...
var map__52512 = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
var map__52512__$1 = cljs.core.__destructure_map(map__52512);
var infinite_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52512__$1,new cljs.core.Keyword("gen","infinite?","gen/infinite?",-2017652832));
var NaN_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52512__$1,new cljs.core.Keyword("gen","NaN?","gen/NaN?",-1917993267));
...
return malli.generator.gen_fmap((function (p1__52513_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,p1__52513_SHARP_);
}),gen);
});
...
return clojure.test.check.generators.double_STAR_(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$2(malli.generator.double_default,opts),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__52517_SHARP_){
var G__52519 = p1__52517_SHARP_;
if((G__52519 == null)){
return null;
} else {
return G__52519;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__52518_SHARP_){
var G__52520 = p1__52518_SHARP_;
if((G__52520 == null)){
return null;
} else {
return G__52520;
...
malli.generator.gen_vector = (function malli$generator$gen_vector(p__52522,g){
var map__52523 = p__52522;
var map__52523__$1 = cljs.core.__destructure_map(map__52523);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52523__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52523__$1,new cljs.core.Keyword(null,"max","max",61366548));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(clojure.test.check.generators.sized((function (p1__52521_SHARP_){
return clojure.test.check.generators.vector.cljs$core$IFn$_invoke$arity$3(g,min,(min + p1__52521_SHARP_));
...
malli.generator.gen_vector_distinct_by = (function malli$generator$gen_vector_distinct_by(schema,p__52537,f,g){
var map__52538 = p__52537;
var map__52538__$1 = cljs.core.__destructure_map(map__52538);
var m = map__52538__$1;
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52538__$1,new cljs.core.Keyword(null,"min","min",444991522));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
})())?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"num-elements","num-elements",1960422107),min], null):clojure.set.rename_keys(m,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"min","min",444991522),new cljs.core.Keyword(null,"min-elements","min-elements",949370780),new cljs.core.Keyword(null,"max","max",61366548),new cljs.core.Keyword(null,"max-elements","max-elements",433034073)], null))),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__52534_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","distinct-generator-failure","malli.generator/distinct-generator-failure",-2085139904),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__52534_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null)));
}
});
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__52545_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","such-that-failure","malli.generator/such-that-failure",599634585),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__52545_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null);
});
...
var map__52555 = malli.generator._min_max(schema,options);
var map__52555__$1 = cljs.core.__destructure_map(map__52555);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52555__$1,new cljs.core.Keyword(null,"min","min",444991522));
var el = malli.generator._child(schema,options);
return malli.generator.gen_one_of(options,(function (){var G__52556 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$3((function (){var G__52557 = cljs.core.PersistentVector.EMPTY;
if((((min == null)) || ((min === (0))))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__52557,malli.generator.nil_gen);
} else {
return G__52557;
}
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__52552_SHARP_){
return malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$3(schema,p1__52552_SHARP_,options);
})),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.identity,cljs.core.vec,cljs.core.eduction,(function (p1__52553_SHARP_){
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(p1__52553_SHARP_);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__52556,(function (){var vec__52558 = malli.core.children.cljs$core$IFn$_invoke$arity$1(el);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52558,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52558,(1),null);
var G__52561 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map-of","map-of",1189682355),(function (){var or__5025__auto__ = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52563_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__52563_SHARP_,options) : malli.generator.generator.call(null,p1__52563_SHARP_,options));
...
return malli.util.transform_entries.cljs$core$IFn$_invoke$arity$3(G__52565,(function (p1__52564_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__52566){
var vec__52567 = p__52566;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52567,(0),null);
var e = vec__52567;
var G__52570 = e;
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__52570,(2),malli.util.merge,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dispatch,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"=","=",1152933628),null,k], null)], null)], null));
} else {
return G__52570;
}
}),p1__52564_SHARP_);
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52571_SHARP_){
var G__52572 = cljs.core.last(p1__52571_SHARP_);
var G__52573 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52572,G__52573) : malli.generator.generator.call(null,G__52572,G__52573));
...
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__52574){
var vec__52575 = p__52574;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52575,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52575,(1),null);
...
malli.generator._entry_gen = (function malli$generator$_entry_gen(p__52579,options){
var vec__52580 = p__52579;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52580,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52580,(1),null);
var G__52583 = malli.generator.gen_fmap((function (p1__52578_SHARP_){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,p1__52578_SHARP_], null);
...
return malli.generator.gen_maybe(G__52583);
} else {
return G__52583;
}
});
malli.generator._map_gen = (function malli$generator$_map_gen(schema,options){
return malli.generator.gen_fmap(malli.generator._build_map,malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52584_SHARP_){
return malli.generator._entry_gen(p1__52584_SHARP_,options);
...
return malli.generator.gen_fmap((function (p1__52587_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,p1__52587_SHARP_);
}),malli.generator.gen_vector_distinct_by(schema,malli.generator._min_max(schema,options),(function (p1__52586_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__52586_SHARP_,(0));
}),malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52585_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__52585_SHARP_,options) : malli.generator.generator.call(null,p1__52585_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)))));
});
...
var G__52590 = (function (){var G__52591 = dschema;
var G__52592 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),scalar_ref_gen);
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52591,G__52592) : malli.generator.generator.call(null,G__52591,G__52592));
})();
if(cljs.core.realized_QMARK_(scalar_ref_gen)){
return clojure.test.check.generators.recursive_gen((function (p1__52589_SHARP_){
var G__52593 = dschema;
var G__52594 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),p1__52589_SHARP_);
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52593,G__52594) : malli.generator.generator.call(null,G__52593,G__52594));
}),G__52590);
} else {
return G__52590;
}
...
var output_generator = (function (){var G__52595 = new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(malli.core._function_info(schema));
var G__52596 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52595,G__52596) : malli.generator.generator.call(null,G__52595,G__52596));
})();
...
var G__52681__delegate = function (_){
...
while (G__52682__i < G__52682__a.length) {G__52682__a[G__52682__i] = arguments[G__52682__i + 0]; ++G__52682__i;}
  _ = new cljs.core.IndexedSeq(G__52682__a,0,null);
} 
return G__52681__delegate.call(this,_);};
G__52681.cljs$lang$maxFixedArity = 0;
G__52681.cljs$lang$applyTo = (function (arglist__52683){
var _ = cljs.core.seq(arglist__52683);
return G__52681__delegate(_);
});
...
return clojure.test.check.generators.return$(malli.core._instrument.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"schema","schema",-1582001791),schema,new cljs.core.Keyword(null,"gen","gen",142575302),(function (p1__52597_SHARP_){
return (malli.generator.generate.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generate.cljs$core$IFn$_invoke$arity$2(p1__52597_SHARP_,options) : malli.generator.generate.call(null,p1__52597_SHARP_,options));
})], null),null,options));
});
malli.generator._regex_generator = (function malli$generator$_regex_generator(schema,options){
var G__52598 = (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(schema,options) : malli.generator.generator.call(null,schema,options));
if(cljs.core.not(malli.core._regex_op_QMARK_(schema))){
return malli.generator.gen_tuple((new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[G__52598],null)));
} else {
return G__52598;
}
});
...
return malli.generator.gen_fcat(malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52600_SHARP_){
return malli.generator._re_entry_gen(p1__52600_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options))));
});
malli.generator._alt_gen = (function malli$generator$_alt_gen(schema,options){
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52601_SHARP_){
return malli.generator._re_entry_gen(p1__52601_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
});
...
var child = malli.generator._child(schema,options);
var G__52602 = malli.generator.gen_vector(malli.generator._min_max(schema,options),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__52602);
} else {
return G__52602;
}
});
...
var child = malli.generator._child(schema,options);
var G__52603 = malli.generator.gen_vector(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.max,(1))),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__52603);
} else {
return G__52603;
}
});
malli.generator._repeat_gen = (function malli$generator$_repeat_gen(schema,options){
var or__5025__auto__ = (function (){var G__52604 = malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$2(schema,options);
var G__52604__$1 = (((G__52604 == null))?null:malli.generator._not_unreachable(G__52604));
if((G__52604__$1 == null)){
return null;
} else {
var G__52605 = G__52604__$1;
if(cljs.core.truth_(malli.core._regex_op_QMARK_(malli.generator._child(schema,options)))){
return malli.generator.gen_fcat(G__52605);
} else {
return G__52605;
}
}
...
var G__52607 = cljs.core.name(namespace_unparsed);
var G__52608 = cljs.core.name(k);
return (mk_value_with_ns.cljs$core$IFn$_invoke$arity$2 ? mk_value_with_ns.cljs$core$IFn$_invoke$arity$2(G__52607,G__52608) : mk_value_with_ns.call(null,G__52607,G__52608));
...
})(),cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__52609_SHARP_){
var G__52611 = p1__52609_SHARP_;
if((G__52611 == null)){
return null;
} else {
return G__52611;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__52610_SHARP_){
var G__52612 = p1__52610_SHARP_;
if((G__52612 == null)){
return null;
} else {
return G__52612;
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.generator","default","malli.generator/default",-943988734)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__52613 = cljs.core.get_global_hierarchy;
return (fexpr__52613.cljs$core$IFn$_invoke$arity$0 ? fexpr__52613.cljs$core$IFn$_invoke$arity$0() : fexpr__52613.call(null));
})());
...
return malli.generator.gen_such_that(schema,(function (p1__52621_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__52621_SHARP_,malli.generator._child(schema,options));
...
return malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52626_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__52626_SHARP_,options) : malli.generator.generator.call(null,p1__52626_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
}));
...
var G__52630 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52631 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52630,G__52631) : malli.generator.generator.call(null,G__52630,G__52631));
}));
...
var G__52632 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52633 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52632,G__52633) : malli.generator.generator.call(null,G__52632,G__52633));
}));
...
var G__52634 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52635 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52634,G__52635) : malli.generator.generator.call(null,G__52634,G__52635));
}));
...
var G__52636 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52637 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52636,G__52637) : malli.generator.generator.call(null,G__52636,G__52637));
}));
...
var G__52638 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52639 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52638,G__52639) : malli.generator.generator.call(null,G__52638,G__52639));
}));
...
var G__52640 = new cljs.core.Keyword("gen","elements","gen/elements",657813311).cljs$core$IFn$_invoke$arity$1(props);
if((G__52640 == null)){
return null;
} else {
return malli.generator.gen_elements(G__52640);
}
});
...
var G__52641 = new cljs.core.Keyword("gen","schema","gen/schema",-1582038959).cljs$core$IFn$_invoke$arity$1(props);
if((G__52641 == null)){
return null;
} else {
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52641,options) : malli.generator.generator.call(null,G__52641,options));
}
});
...
return malli.core._cached(malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options),new cljs.core.Keyword(null,"generator","generator",-572962281),(function (p1__52642_SHARP_){
return malli.generator._create(p1__52642_SHARP_,options);
}));
}
}));
...
(malli.generator.generate.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__52647){
var map__52648 = p__52647;
var map__52648__$1 = cljs.core.__destructure_map(map__52648);
var options = map__52648__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52648__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52648__$1,new cljs.core.Keyword(null,"size","size",1098693007),(30));
...
(malli.generator.sample.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__52653){
var map__52654 = p__52653;
var map__52654__$1 = cljs.core.__destructure_map(map__52654);
var options = map__52654__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52654__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52654__$1,new cljs.core.Keyword(null,"size","size",1098693007),(10));
var gen = ((clojure.test.check.generators.generator_QMARK_(_QMARK_gen_or_schema))?_QMARK_gen_or_schema:malli.generator.generator.cljs$core$IFn$_invoke$arity$2(_QMARK_gen_or_schema,options));
return cljs.core.take.cljs$core$IFn$_invoke$arity$2(size,cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__52649_SHARP_,p2__52650_SHARP_){
return clojure.test.check.rose_tree.root(clojure.test.check.generators.call_gen(gen,p1__52649_SHARP_,p2__52650_SHARP_));
...
(malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_schema,p__52660){
var map__52661 = p__52660;
var map__52661__$1 = cljs.core.__destructure_map(map__52661);
var options = map__52661__$1;
var _EQ__GT_iterations = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52661__$1,new cljs.core.Keyword("malli.generator","=>iterations","malli.generator/=>iterations",-1726832707),(100));
...
var map__52663 = malli.core._function_info(schema__$1);
var map__52663__$1 = cljs.core.__destructure_map(map__52663);
var input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52663__$1,new cljs.core.Keyword(null,"input","input",556931961));
var output = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52663__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var guard = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52663__$1,new cljs.core.Keyword(null,"guard","guard",-873147811));
...
if(cljs.core.truth_(and__5023__auto__)){
var G__52664 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [args,$], null);
return (valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1 ? valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1(G__52664) : valid_guard_QMARK_.call(null,G__52664));
} else {
return and__5023__auto__;
}
});
return (function (f){
var map__52665 = clojure.test.check.quick_check(_EQ__GT_iterations,clojure.test.check.properties.for_all_STAR_(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [input_generator], null),(function (p1__52655_SHARP_){
return validate(f,p1__52655_SHARP_);
})));
var map__52665__$1 = cljs.core.__destructure_map(map__52665);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52665__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var shrunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52665__$1,new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412));
...
var vec__52666 = (cljs.core.truth_(explain_input)?null:_try((function (){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,smallest);
})));
var result__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52666,(0),null);
var success = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52666,(1),null);
...
var G__52669 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(shrunk,new cljs.core.Keyword("malli.core","result","malli.core/result",1538632379),result__$1);
var G__52669__$1 = (cljs.core.truth_(explain_input)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52669,new cljs.core.Keyword("malli.core","explain-input","malli.core/explain-input",1441627811),explain_input):G__52669);
var G__52669__$2 = (cljs.core.truth_(explain_output)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52669__$1,new cljs.core.Keyword("malli.core","explain-output","malli.core/explain-output",-124321573),explain_output):G__52669__$1);
var G__52669__$3 = (cljs.core.truth_(explain_guard)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52669__$2,new cljs.core.Keyword("malli.core","explain-guard","malli.core/explain-guard",-1119572847),explain_guard):G__52669__$2);
if(cljs.core.truth_(cljs.core.ex_message(result__$1))){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__52669__$3,new cljs.core.Keyword(null,"result","result",1415092211),cljs.core.ex_message),new cljs.core.Keyword(null,"result-data","result-data",-1724248844));
} else {
return G__52669__$3;
}
}
...
var checkers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52656_SHARP_){
return malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2(p1__52656_SHARP_,options);
}),malli.core._function_schema_arities(schema));
return (function (x){
return cljs.core.seq(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__52657_SHARP_){
return (p1__52657_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__52657_SHARP_.cljs$core$IFn$_invoke$arity$1(x) : p1__52657_SHARP_.call(null,x));
}),checkers));
});
} else {
...
var schema = malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options);
return malli.core.explain.cljs$core$IFn$_invoke$arity$2(malli.core._update_options(schema,(function (p1__52670_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__52670_SHARP_,new cljs.core.Keyword("malli.core","function-checker","malli.core/function-checker",-792030936),malli.generator.function_checker);
})),f);
}));
