...
var malli$generator$Generator$_generator$dyn_52435 = (function (this$,options){
...
return malli$generator$Generator$_generator$dyn_52435(this$,options);
}
});
...
var G__52201 = malli.generator._child(schema,options);
var G__52202 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52201,G__52202) : malli.generator.generator.call(null,G__52201,G__52202));
});
/**
 * Return a generator of no values that is compatible with -unreachable-gen?.
 */
malli.generator._never_gen = (function malli$generator$_never_gen(p__52205){
var map__52215 = p__52205;
var map__52215__$1 = cljs.core.__destructure_map(map__52215);
var _options = map__52215__$1;
var original_generator_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52215__$1,new cljs.core.Keyword("malli.generator","original-generator-schema","malli.generator/original-generator-schema",-1122475395));
return cljs.core.with_meta(clojure.test.check.generators.sized((function (_){
return malli.core._fail_BANG_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("malli.generator","unsatisfiable-schema","malli.generator/unsatisfiable-schema",919209538),(function (){var G__52216 = cljs.core.PersistentArrayMap.EMPTY;
if(cljs.core.truth_(original_generator_schema)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52216,new cljs.core.Keyword(null,"schema","schema",-1582001791),original_generator_schema);
} else {
return G__52216;
}
})());
...
var map__52224 = malli.core.properties.cljs$core$IFn$_invoke$arity$2(schema,options);
var map__52224__$1 = cljs.core.__destructure_map(map__52224);
var gen_min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52224__$1,new cljs.core.Keyword("gen","min","gen/min",444569458));
var gen_max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52224__$1,new cljs.core.Keyword("gen","max","gen/max",61264228));
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52224__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52224__$1,new cljs.core.Keyword(null,"max","max",61366548));
...
var map__52230 = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
var map__52230__$1 = cljs.core.__destructure_map(map__52230);
var infinite_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52230__$1,new cljs.core.Keyword("gen","infinite?","gen/infinite?",-2017652832));
var NaN_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52230__$1,new cljs.core.Keyword("gen","NaN?","gen/NaN?",-1917993267));
...
return malli.generator.gen_fmap((function (p1__52232_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,p1__52232_SHARP_);
}),gen);
});
...
return clojure.test.check.generators.double_STAR_(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$2(malli.generator.double_default,opts),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__52242_SHARP_){
...
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__52243_SHARP_){
var G__52246 = p1__52243_SHARP_;
if((G__52246 == null)){
return null;
} else {
return G__52246;
...
malli.generator.gen_vector = (function malli$generator$gen_vector(p__52252,g){
var map__52253 = p__52252;
var map__52253__$1 = cljs.core.__destructure_map(map__52253);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52253__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52253__$1,new cljs.core.Keyword(null,"max","max",61366548));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(clojure.test.check.generators.sized((function (p1__52247_SHARP_){
return clojure.test.check.generators.vector.cljs$core$IFn$_invoke$arity$3(g,min,(min + p1__52247_SHARP_));
...
malli.generator.gen_vector_distinct_by = (function malli$generator$gen_vector_distinct_by(schema,p__52255,f,g){
var map__52256 = p__52255;
var map__52256__$1 = cljs.core.__destructure_map(map__52256);
var m = map__52256__$1;
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52256__$1,new cljs.core.Keyword(null,"min","min",444991522));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
})())?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"num-elements","num-elements",1960422107),min], null):clojure.set.rename_keys(m,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"min","min",444991522),new cljs.core.Keyword(null,"min-elements","min-elements",949370780),new cljs.core.Keyword(null,"max","max",61366548),new cljs.core.Keyword(null,"max-elements","max-elements",433034073)], null))),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__52254_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","distinct-generator-failure","malli.generator/distinct-generator-failure",-2085139904),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__52254_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null)));
}
});
...
var map__52279 = malli.generator._min_max(schema,options);
var map__52279__$1 = cljs.core.__destructure_map(map__52279);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52279__$1,new cljs.core.Keyword(null,"min","min",444991522));
var el = malli.generator._child(schema,options);
return malli.generator.gen_one_of(options,(function (){var G__52284 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$3((function (){var G__52285 = cljs.core.PersistentVector.EMPTY;
if((((min == null)) || ((min === (0))))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__52285,malli.generator.nil_gen);
} else {
return G__52285;
}
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__52277_SHARP_){
return malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$3(schema,p1__52277_SHARP_,options);
})),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.identity,cljs.core.vec,cljs.core.eduction,(function (p1__52278_SHARP_){
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(p1__52278_SHARP_);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__52284,(function (){var vec__52286 = malli.core.children.cljs$core$IFn$_invoke$arity$1(el);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52286,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52286,(1),null);
var G__52289 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map-of","map-of",1189682355),(function (){var or__5025__auto__ = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
...
var G__52290 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52289,G__52290) : malli.generator.generator.call(null,G__52289,G__52290));
})());
} else {
return G__52284;
}
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52291_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__52291_SHARP_,options) : malli.generator.generator.call(null,p1__52291_SHARP_,options));
...
return malli.util.transform_entries.cljs$core$IFn$_invoke$arity$3(G__52293,(function (p1__52292_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__52294){
var vec__52295 = p__52294;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52295,(0),null);
var e = vec__52295;
var G__52298 = e;
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__52298,(2),malli.util.merge,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dispatch,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"=","=",1152933628),null,k], null)], null)], null));
} else {
return G__52298;
}
}),p1__52292_SHARP_);
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52308_SHARP_){
var G__52309 = cljs.core.last(p1__52308_SHARP_);
var G__52310 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52309,G__52310) : malli.generator.generator.call(null,G__52309,G__52310));
...
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__52311){
...
malli.generator._entry_gen = (function malli$generator$_entry_gen(p__52317,options){
var vec__52318 = p__52317;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52318,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52318,(1),null);
var G__52321 = malli.generator.gen_fmap((function (p1__52315_SHARP_){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,p1__52315_SHARP_], null);
...
return malli.generator.gen_maybe(G__52321);
} else {
return G__52321;
}
});
malli.generator._map_gen = (function malli$generator$_map_gen(schema,options){
return malli.generator.gen_fmap(malli.generator._build_map,malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52322_SHARP_){
return malli.generator._entry_gen(p1__52322_SHARP_,options);
...
return malli.generator.gen_fmap((function (p1__52325_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,p1__52325_SHARP_);
}),malli.generator.gen_vector_distinct_by(schema,malli.generator._min_max(schema,options),(function (p1__52324_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__52324_SHARP_,(0));
}),malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52323_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__52323_SHARP_,options) : malli.generator.generator.call(null,p1__52323_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)))));
});
...
var G__52331 = (function (){var G__52332 = dschema;
var G__52333 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),scalar_ref_gen);
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52332,G__52333) : malli.generator.generator.call(null,G__52332,G__52333));
})();
if(cljs.core.realized_QMARK_(scalar_ref_gen)){
return clojure.test.check.generators.recursive_gen((function (p1__52330_SHARP_){
var G__52334 = dschema;
var G__52335 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),p1__52330_SHARP_);
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52334,G__52335) : malli.generator.generator.call(null,G__52334,G__52335));
}),G__52331);
} else {
return G__52331;
}
...
var output_generator = (function (){var G__52336 = new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(malli.core._function_info(schema));
var G__52337 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52336,G__52337) : malli.generator.generator.call(null,G__52336,G__52337));
})();
...
var G__52447__delegate = function (_){
...
var G__52448__i = 0, G__52448__a = new Array(arguments.length -  0);
while (G__52448__i < G__52448__a.length) {G__52448__a[G__52448__i] = arguments[G__52448__i + 0]; ++G__52448__i;}
  _ = new cljs.core.IndexedSeq(G__52448__a,0,null);
} 
return G__52447__delegate.call(this,_);};
G__52447.cljs$lang$maxFixedArity = 0;
G__52447.cljs$lang$applyTo = (function (arglist__52449){
var _ = cljs.core.seq(arglist__52449);
return G__52447__delegate(_);
});
...
return clojure.test.check.generators.return$(malli.core._instrument.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"schema","schema",-1582001791),schema,new cljs.core.Keyword(null,"gen","gen",142575302),(function (p1__52338_SHARP_){
return (malli.generator.generate.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generate.cljs$core$IFn$_invoke$arity$2(p1__52338_SHARP_,options) : malli.generator.generate.call(null,p1__52338_SHARP_,options));
})], null),null,options));
});
malli.generator._regex_generator = (function malli$generator$_regex_generator(schema,options){
var G__52339 = (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(schema,options) : malli.generator.generator.call(null,schema,options));
if(cljs.core.not(malli.core._regex_op_QMARK_(schema))){
return malli.generator.gen_tuple((new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[G__52339],null)));
} else {
return G__52339;
}
});
...
return malli.generator.gen_fcat(malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52344_SHARP_){
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52345_SHARP_){
return malli.generator._re_entry_gen(p1__52345_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
});
...
var child = malli.generator._child(schema,options);
var G__52359 = malli.generator.gen_vector(malli.generator._min_max(schema,options),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__52359);
} else {
return G__52359;
}
});
...
var child = malli.generator._child(schema,options);
var G__52360 = malli.generator.gen_vector(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.max,(1))),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__52360);
} else {
return G__52360;
}
});
malli.generator._repeat_gen = (function malli$generator$_repeat_gen(schema,options){
var or__5025__auto__ = (function (){var G__52362 = malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$2(schema,options);
var G__52362__$1 = (((G__52362 == null))?null:malli.generator._not_unreachable(G__52362));
if((G__52362__$1 == null)){
return null;
} else {
var G__52363 = G__52362__$1;
if(cljs.core.truth_(malli.core._regex_op_QMARK_(malli.generator._child(schema,options)))){
return malli.generator.gen_fcat(G__52363);
} else {
return G__52363;
}
}
...
var G__52366 = cljs.core.name(namespace_unparsed);
var G__52367 = cljs.core.name(k);
return (mk_value_with_ns.cljs$core$IFn$_invoke$arity$2 ? mk_value_with_ns.cljs$core$IFn$_invoke$arity$2(G__52366,G__52367) : mk_value_with_ns.call(null,G__52366,G__52367));
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.generator","default","malli.generator/default",-943988734)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__52374 = cljs.core.get_global_hierarchy;
return (fexpr__52374.cljs$core$IFn$_invoke$arity$0 ? fexpr__52374.cljs$core$IFn$_invoke$arity$0() : fexpr__52374.call(null));
})());
...
return malli.generator.gen_such_that(schema,(function (p1__52376_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__52376_SHARP_,malli.generator._child(schema,options));
...
return malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52377_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__52377_SHARP_,options) : malli.generator.generator.call(null,p1__52377_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
}));
...
var G__52382 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52383 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52382,G__52383) : malli.generator.generator.call(null,G__52382,G__52383));
}));
...
var G__52385 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52386 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52385,G__52386) : malli.generator.generator.call(null,G__52385,G__52386));
}));
...
var G__52387 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52388 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52387,G__52388) : malli.generator.generator.call(null,G__52387,G__52388));
}));
...
var G__52389 = new cljs.core.Keyword("gen","elements","gen/elements",657813311).cljs$core$IFn$_invoke$arity$1(props);
if((G__52389 == null)){
return null;
} else {
return malli.generator.gen_elements(G__52389);
}
});
...
var G__52390 = new cljs.core.Keyword("gen","schema","gen/schema",-1582038959).cljs$core$IFn$_invoke$arity$1(props);
if((G__52390 == null)){
return null;
} else {
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52390,options) : malli.generator.generator.call(null,G__52390,options));
}
});
...
return malli.core._cached(malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options),new cljs.core.Keyword(null,"generator","generator",-572962281),(function (p1__52392_SHARP_){
return malli.generator._create(p1__52392_SHARP_,options);
}));
}
}));
...
(malli.generator.generate.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__52397){
var map__52398 = p__52397;
var map__52398__$1 = cljs.core.__destructure_map(map__52398);
var options = map__52398__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52398__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52398__$1,new cljs.core.Keyword(null,"size","size",1098693007),(30));
...
(malli.generator.sample.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__52403){
var map__52404 = p__52403;
var map__52404__$1 = cljs.core.__destructure_map(map__52404);
var options = map__52404__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52404__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52404__$1,new cljs.core.Keyword(null,"size","size",1098693007),(10));
var gen = ((clojure.test.check.generators.generator_QMARK_(_QMARK_gen_or_schema))?_QMARK_gen_or_schema:malli.generator.generator.cljs$core$IFn$_invoke$arity$2(_QMARK_gen_or_schema,options));
return cljs.core.take.cljs$core$IFn$_invoke$arity$2(size,cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__52399_SHARP_,p2__52400_SHARP_){
return clojure.test.check.rose_tree.root(clojure.test.check.generators.call_gen(gen,p1__52399_SHARP_,p2__52400_SHARP_));
...
(malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_schema,p__52410){
var map__52411 = p__52410;
var map__52411__$1 = cljs.core.__destructure_map(map__52411);
var options = map__52411__$1;
var _EQ__GT_iterations = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52411__$1,new cljs.core.Keyword("malli.generator","=>iterations","malli.generator/=>iterations",-1726832707),(100));
...
var map__52413 = malli.core._function_info(schema__$1);
var map__52413__$1 = cljs.core.__destructure_map(map__52413);
var input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52413__$1,new cljs.core.Keyword(null,"input","input",556931961));
var output = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52413__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var guard = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52413__$1,new cljs.core.Keyword(null,"guard","guard",-873147811));
...
if(cljs.core.truth_(and__5023__auto__)){
var G__52414 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [args,$], null);
return (valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1 ? valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1(G__52414) : valid_guard_QMARK_.call(null,G__52414));
} else {
return and__5023__auto__;
}
});
return (function (f){
var map__52415 = clojure.test.check.quick_check(_EQ__GT_iterations,clojure.test.check.properties.for_all_STAR_(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [input_generator], null),(function (p1__52405_SHARP_){
return validate(f,p1__52405_SHARP_);
})));
var map__52415__$1 = cljs.core.__destructure_map(map__52415);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52415__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var shrunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52415__$1,new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412));
...
var vec__52416 = (cljs.core.truth_(explain_input)?null:_try((function (){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,smallest);
})));
var result__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52416,(0),null);
var success = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52416,(1),null);
...
var G__52425 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(shrunk,new cljs.core.Keyword("malli.core","result","malli.core/result",1538632379),result__$1);
var G__52425__$1 = (cljs.core.truth_(explain_input)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52425,new cljs.core.Keyword("malli.core","explain-input","malli.core/explain-input",1441627811),explain_input):G__52425);
var G__52425__$2 = (cljs.core.truth_(explain_output)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52425__$1,new cljs.core.Keyword("malli.core","explain-output","malli.core/explain-output",-124321573),explain_output):G__52425__$1);
var G__52425__$3 = (cljs.core.truth_(explain_guard)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52425__$2,new cljs.core.Keyword("malli.core","explain-guard","malli.core/explain-guard",-1119572847),explain_guard):G__52425__$2);
if(cljs.core.truth_(cljs.core.ex_message(result__$1))){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__52425__$3,new cljs.core.Keyword(null,"result","result",1415092211),cljs.core.ex_message),new cljs.core.Keyword(null,"result-data","result-data",-1724248844));
} else {
return G__52425__$3;
}
}
...
var checkers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52406_SHARP_){
return malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2(p1__52406_SHARP_,options);
}),malli.core._function_schema_arities(schema));
return (function (x){
return cljs.core.seq(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__52407_SHARP_){
return (p1__52407_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__52407_SHARP_.cljs$core$IFn$_invoke$arity$1(x) : p1__52407_SHARP_.call(null,x));
}),checkers));
});
} else {
...
var schema = malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options);
return malli.core.explain.cljs$core$IFn$_invoke$arity$2(malli.core._update_options(schema,(function (p1__52432_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__52432_SHARP_,new cljs.core.Keyword("malli.core","function-checker","malli.core/function-checker",-792030936),malli.generator.function_checker);
})),f);
}));
