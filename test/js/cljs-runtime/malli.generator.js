...
var malli$generator$Generator$_generator$dyn_52706 = (function (this$,options){
...
return malli$generator$Generator$_generator$dyn_52706(this$,options);
}
});
...
var G__52428 = malli.generator._child(schema,options);
var G__52430 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52428,G__52430) : malli.generator.generator.call(null,G__52428,G__52430));
});
/**
 * Return a generator of no values that is compatible with -unreachable-gen?.
 */
malli.generator._never_gen = (function malli$generator$_never_gen(p__52431){
var map__52432 = p__52431;
var map__52432__$1 = cljs.core.__destructure_map(map__52432);
var _options = map__52432__$1;
var original_generator_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52432__$1,new cljs.core.Keyword("malli.generator","original-generator-schema","malli.generator/original-generator-schema",-1122475395));
return cljs.core.with_meta(clojure.test.check.generators.sized((function (_){
return malli.core._fail_BANG_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("malli.generator","unsatisfiable-schema","malli.generator/unsatisfiable-schema",919209538),(function (){var G__52439 = cljs.core.PersistentArrayMap.EMPTY;
if(cljs.core.truth_(original_generator_schema)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52439,new cljs.core.Keyword(null,"schema","schema",-1582001791),original_generator_schema);
} else {
return G__52439;
}
})());
...
var map__52441 = malli.core.properties.cljs$core$IFn$_invoke$arity$2(schema,options);
var map__52441__$1 = cljs.core.__destructure_map(map__52441);
var gen_min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52441__$1,new cljs.core.Keyword("gen","min","gen/min",444569458));
var gen_max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52441__$1,new cljs.core.Keyword("gen","max","gen/max",61264228));
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52441__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52441__$1,new cljs.core.Keyword(null,"max","max",61366548));
...
var map__52451 = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
var map__52451__$1 = cljs.core.__destructure_map(map__52451);
var infinite_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52451__$1,new cljs.core.Keyword("gen","infinite?","gen/infinite?",-2017652832));
var NaN_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52451__$1,new cljs.core.Keyword("gen","NaN?","gen/NaN?",-1917993267));
...
return malli.generator.gen_fmap((function (p1__52452_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,p1__52452_SHARP_);
}),gen);
});
...
return clojure.test.check.generators.double_STAR_(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$2(malli.generator.double_default,opts),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__52461_SHARP_){
var G__52464 = p1__52461_SHARP_;
if((G__52464 == null)){
return null;
} else {
return G__52464;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__52462_SHARP_){
var G__52465 = p1__52462_SHARP_;
if((G__52465 == null)){
return null;
} else {
return G__52465;
...
malli.generator.gen_vector = (function malli$generator$gen_vector(p__52471,g){
var map__52472 = p__52471;
var map__52472__$1 = cljs.core.__destructure_map(map__52472);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52472__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52472__$1,new cljs.core.Keyword(null,"max","max",61366548));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(clojure.test.check.generators.sized((function (p1__52466_SHARP_){
return clojure.test.check.generators.vector.cljs$core$IFn$_invoke$arity$3(g,min,(min + p1__52466_SHARP_));
...
malli.generator.gen_vector_distinct_by = (function malli$generator$gen_vector_distinct_by(schema,p__52485,f,g){
var map__52486 = p__52485;
var map__52486__$1 = cljs.core.__destructure_map(map__52486);
var m = map__52486__$1;
...
})())?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"num-elements","num-elements",1960422107),min], null):clojure.set.rename_keys(m,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"min","min",444991522),new cljs.core.Keyword(null,"min-elements","min-elements",949370780),new cljs.core.Keyword(null,"max","max",61366548),new cljs.core.Keyword(null,"max-elements","max-elements",433034073)], null))),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__52484_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","distinct-generator-failure","malli.generator/distinct-generator-failure",-2085139904),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__52484_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null)));
}
});
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__52505_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","such-that-failure","malli.generator/such-that-failure",599634585),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__52505_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null);
});
...
var map__52508 = malli.generator._min_max(schema,options);
var map__52508__$1 = cljs.core.__destructure_map(map__52508);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52508__$1,new cljs.core.Keyword(null,"min","min",444991522));
var el = malli.generator._child(schema,options);
return malli.generator.gen_one_of(options,(function (){var G__52509 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$3((function (){var G__52510 = cljs.core.PersistentVector.EMPTY;
if((((min == null)) || ((min === (0))))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__52510,malli.generator.nil_gen);
} else {
return G__52510;
}
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__52506_SHARP_){
return malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$3(schema,p1__52506_SHARP_,options);
})),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.identity,cljs.core.vec,cljs.core.eduction,(function (p1__52507_SHARP_){
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(p1__52507_SHARP_);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__52509,(function (){var vec__52512 = malli.core.children.cljs$core$IFn$_invoke$arity$1(el);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52512,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52512,(1),null);
var G__52515 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map-of","map-of",1189682355),(function (){var or__5025__auto__ = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
...
var G__52516 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52515,G__52516) : malli.generator.generator.call(null,G__52515,G__52516));
})());
} else {
return G__52509;
}
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52517_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__52517_SHARP_,options) : malli.generator.generator.call(null,p1__52517_SHARP_,options));
...
return malli.util.transform_entries.cljs$core$IFn$_invoke$arity$3(G__52519,(function (p1__52518_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__52520){
var vec__52521 = p__52520;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52521,(0),null);
var e = vec__52521;
var G__52524 = e;
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__52524,(2),malli.util.merge,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dispatch,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"=","=",1152933628),null,k], null)], null)], null));
} else {
return G__52524;
}
}),p1__52518_SHARP_);
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52525_SHARP_){
var G__52526 = cljs.core.last(p1__52525_SHARP_);
var G__52527 = options;
...
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__52528){
var vec__52529 = p__52528;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52529,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52529,(1),null);
...
malli.generator._entry_gen = (function malli$generator$_entry_gen(p__52546,options){
var vec__52547 = p__52546;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52547,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52547,(1),null);
var G__52550 = malli.generator.gen_fmap((function (p1__52538_SHARP_){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,p1__52538_SHARP_], null);
...
return malli.generator.gen_maybe(G__52550);
} else {
return G__52550;
}
});
malli.generator._map_gen = (function malli$generator$_map_gen(schema,options){
return malli.generator.gen_fmap(malli.generator._build_map,malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52555_SHARP_){
return malli.generator._entry_gen(p1__52555_SHARP_,options);
...
return malli.generator.gen_fmap((function (p1__52558_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,p1__52558_SHARP_);
}),malli.generator.gen_vector_distinct_by(schema,malli.generator._min_max(schema,options),(function (p1__52557_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__52557_SHARP_,(0));
}),malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52556_SHARP_){
...
var G__52564 = (function (){var G__52578 = dschema;
var G__52579 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),scalar_ref_gen);
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52578,G__52579) : malli.generator.generator.call(null,G__52578,G__52579));
})();
if(cljs.core.realized_QMARK_(scalar_ref_gen)){
return clojure.test.check.generators.recursive_gen((function (p1__52563_SHARP_){
var G__52580 = dschema;
var G__52581 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),p1__52563_SHARP_);
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52580,G__52581) : malli.generator.generator.call(null,G__52580,G__52581));
}),G__52564);
} else {
return G__52564;
}
...
var output_generator = (function (){var G__52582 = new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(malli.core._function_info(schema));
var G__52583 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52582,G__52583) : malli.generator.generator.call(null,G__52582,G__52583));
})();
...
var G__52723__delegate = function (_){
...
while (G__52724__i < G__52724__a.length) {G__52724__a[G__52724__i] = arguments[G__52724__i + 0]; ++G__52724__i;}
  _ = new cljs.core.IndexedSeq(G__52724__a,0,null);
} 
return G__52723__delegate.call(this,_);};
G__52723.cljs$lang$maxFixedArity = 0;
G__52723.cljs$lang$applyTo = (function (arglist__52726){
var _ = cljs.core.seq(arglist__52726);
return G__52723__delegate(_);
});
...
return clojure.test.check.generators.return$(malli.core._instrument.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"schema","schema",-1582001791),schema,new cljs.core.Keyword(null,"gen","gen",142575302),(function (p1__52585_SHARP_){
return (malli.generator.generate.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generate.cljs$core$IFn$_invoke$arity$2(p1__52585_SHARP_,options) : malli.generator.generate.call(null,p1__52585_SHARP_,options));
})], null),null,options));
});
malli.generator._regex_generator = (function malli$generator$_regex_generator(schema,options){
var G__52586 = (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(schema,options) : malli.generator.generator.call(null,schema,options));
if(cljs.core.not(malli.core._regex_op_QMARK_(schema))){
return malli.generator.gen_tuple((new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[G__52586],null)));
} else {
return G__52586;
}
});
...
return malli.generator.gen_fcat(malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52592_SHARP_){
return malli.generator._re_entry_gen(p1__52592_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options))));
});
malli.generator._alt_gen = (function malli$generator$_alt_gen(schema,options){
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52593_SHARP_){
return malli.generator._re_entry_gen(p1__52593_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
});
...
var child = malli.generator._child(schema,options);
var G__52598 = malli.generator.gen_vector(malli.generator._min_max(schema,options),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__52598);
} else {
return G__52598;
}
});
...
var child = malli.generator._child(schema,options);
var G__52599 = malli.generator.gen_vector(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.max,(1))),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__52599);
} else {
return G__52599;
}
});
malli.generator._repeat_gen = (function malli$generator$_repeat_gen(schema,options){
var or__5025__auto__ = (function (){var G__52600 = malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$2(schema,options);
var G__52600__$1 = (((G__52600 == null))?null:malli.generator._not_unreachable(G__52600));
if((G__52600__$1 == null)){
return null;
} else {
var G__52601 = G__52600__$1;
if(cljs.core.truth_(malli.core._regex_op_QMARK_(malli.generator._child(schema,options)))){
return malli.generator.gen_fcat(G__52601);
} else {
return G__52601;
}
}
...
var G__52602 = cljs.core.name(namespace_unparsed);
var G__52603 = cljs.core.name(k);
return (mk_value_with_ns.cljs$core$IFn$_invoke$arity$2 ? mk_value_with_ns.cljs$core$IFn$_invoke$arity$2(G__52602,G__52603) : mk_value_with_ns.call(null,G__52602,G__52603));
...
})(),cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__52610_SHARP_){
var G__52621 = p1__52610_SHARP_;
if((G__52621 == null)){
return null;
} else {
return G__52621;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__52611_SHARP_){
var G__52622 = p1__52611_SHARP_;
if((G__52622 == null)){
return null;
} else {
return G__52622;
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.generator","default","malli.generator/default",-943988734)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__52624 = cljs.core.get_global_hierarchy;
return (fexpr__52624.cljs$core$IFn$_invoke$arity$0 ? fexpr__52624.cljs$core$IFn$_invoke$arity$0() : fexpr__52624.call(null));
})());
...
return malli.generator.gen_such_that(schema,(function (p1__52627_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__52627_SHARP_,malli.generator._child(schema,options));
...
return malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52628_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__52628_SHARP_,options) : malli.generator.generator.call(null,p1__52628_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
}));
...
var G__52629 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52630 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52629,G__52630) : malli.generator.generator.call(null,G__52629,G__52630));
}));
...
var G__52631 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52632 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52631,G__52632) : malli.generator.generator.call(null,G__52631,G__52632));
}));
...
var G__52633 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52634 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52633,G__52634) : malli.generator.generator.call(null,G__52633,G__52634));
}));
...
var G__52635 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52636 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52635,G__52636) : malli.generator.generator.call(null,G__52635,G__52636));
}));
...
var G__52641 = new cljs.core.Keyword("gen","elements","gen/elements",657813311).cljs$core$IFn$_invoke$arity$1(props);
if((G__52641 == null)){
return null;
} else {
return malli.generator.gen_elements(G__52641);
}
});
...
var G__52645 = new cljs.core.Keyword("gen","schema","gen/schema",-1582038959).cljs$core$IFn$_invoke$arity$1(props);
if((G__52645 == null)){
return null;
} else {
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52645,options) : malli.generator.generator.call(null,G__52645,options));
}
});
...
return malli.core._cached(malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options),new cljs.core.Keyword(null,"generator","generator",-572962281),(function (p1__52651_SHARP_){
return malli.generator._create(p1__52651_SHARP_,options);
}));
}
}));
...
(malli.generator.generate.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__52660){
var map__52661 = p__52660;
var map__52661__$1 = cljs.core.__destructure_map(map__52661);
var options = map__52661__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52661__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52661__$1,new cljs.core.Keyword(null,"size","size",1098693007),(30));
...
(malli.generator.sample.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__52670){
var map__52671 = p__52670;
var map__52671__$1 = cljs.core.__destructure_map(map__52671);
var options = map__52671__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52671__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52671__$1,new cljs.core.Keyword(null,"size","size",1098693007),(10));
var gen = ((clojure.test.check.generators.generator_QMARK_(_QMARK_gen_or_schema))?_QMARK_gen_or_schema:malli.generator.generator.cljs$core$IFn$_invoke$arity$2(_QMARK_gen_or_schema,options));
return cljs.core.take.cljs$core$IFn$_invoke$arity$2(size,cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__52664_SHARP_,p2__52665_SHARP_){
return clojure.test.check.rose_tree.root(clojure.test.check.generators.call_gen(gen,p1__52664_SHARP_,p2__52665_SHARP_));
...
(malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_schema,p__52680){
var map__52681 = p__52680;
var map__52681__$1 = cljs.core.__destructure_map(map__52681);
var options = map__52681__$1;
var _EQ__GT_iterations = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52681__$1,new cljs.core.Keyword("malli.generator","=>iterations","malli.generator/=>iterations",-1726832707),(100));
...
}catch (e52683){if((e52683 instanceof Error)){
var e = e52683;
...
var map__52685 = malli.core._function_info(schema__$1);
var map__52685__$1 = cljs.core.__destructure_map(map__52685);
var input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52685__$1,new cljs.core.Keyword(null,"input","input",556931961));
var output = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52685__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var guard = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52685__$1,new cljs.core.Keyword(null,"guard","guard",-873147811));
...
if(cljs.core.truth_(and__5023__auto__)){
var G__52687 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [args,$], null);
return (valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1 ? valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1(G__52687) : valid_guard_QMARK_.call(null,G__52687));
} else {
return and__5023__auto__;
}
});
return (function (f){
var map__52689 = clojure.test.check.quick_check(_EQ__GT_iterations,clojure.test.check.properties.for_all_STAR_(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [input_generator], null),(function (p1__52672_SHARP_){
return validate(f,p1__52672_SHARP_);
})));
var map__52689__$1 = cljs.core.__destructure_map(map__52689);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52689__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var shrunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52689__$1,new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412));
...
var vec__52691 = (cljs.core.truth_(explain_input)?null:_try((function (){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,smallest);
})));
var result__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52691,(0),null);
var success = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52691,(1),null);
...
var G__52695 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(shrunk,new cljs.core.Keyword("malli.core","result","malli.core/result",1538632379),result__$1);
var G__52695__$1 = (cljs.core.truth_(explain_input)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52695,new cljs.core.Keyword("malli.core","explain-input","malli.core/explain-input",1441627811),explain_input):G__52695);
var G__52695__$2 = (cljs.core.truth_(explain_output)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52695__$1,new cljs.core.Keyword("malli.core","explain-output","malli.core/explain-output",-124321573),explain_output):G__52695__$1);
var G__52695__$3 = (cljs.core.truth_(explain_guard)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52695__$2,new cljs.core.Keyword("malli.core","explain-guard","malli.core/explain-guard",-1119572847),explain_guard):G__52695__$2);
if(cljs.core.truth_(cljs.core.ex_message(result__$1))){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__52695__$3,new cljs.core.Keyword(null,"result","result",1415092211),cljs.core.ex_message),new cljs.core.Keyword(null,"result-data","result-data",-1724248844));
} else {
return G__52695__$3;
}
}
...
var checkers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52674_SHARP_){
return malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2(p1__52674_SHARP_,options);
}),malli.core._function_schema_arities(schema));
return (function (x){
return cljs.core.seq(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__52675_SHARP_){
return (p1__52675_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__52675_SHARP_.cljs$core$IFn$_invoke$arity$1(x) : p1__52675_SHARP_.call(null,x));
}),checkers));
});
} else {
...
var schema = malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options);
return malli.core.explain.cljs$core$IFn$_invoke$arity$2(malli.core._update_options(schema,(function (p1__52697_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__52697_SHARP_,new cljs.core.Keyword("malli.core","function-checker","malli.core/function-checker",-792030936),malli.generator.function_checker);
})),f);
}));
