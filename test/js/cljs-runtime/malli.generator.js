...
var malli$generator$Generator$_generator$dyn_58519 = (function (this$,options){
...
return malli$generator$Generator$_generator$dyn_58519(this$,options);
}
});
...
var G__58310 = malli.generator._child(schema,options);
var G__58311 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__58310,G__58311) : malli.generator.generator.call(null,G__58310,G__58311));
});
/**
 * Return a generator of no values that is compatible with -unreachable-gen?.
 */
malli.generator._never_gen = (function malli$generator$_never_gen(p__58313){
var map__58314 = p__58313;
var map__58314__$1 = cljs.core.__destructure_map(map__58314);
var _options = map__58314__$1;
var original_generator_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58314__$1,new cljs.core.Keyword("malli.generator","original-generator-schema","malli.generator/original-generator-schema",-1122475395));
return cljs.core.with_meta(clojure.test.check.generators.sized((function (_){
return malli.core._fail_BANG_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("malli.generator","unsatisfiable-schema","malli.generator/unsatisfiable-schema",919209538),(function (){var G__58317 = cljs.core.PersistentArrayMap.EMPTY;
if(cljs.core.truth_(original_generator_schema)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__58317,new cljs.core.Keyword(null,"schema","schema",-1582001791),original_generator_schema);
} else {
return G__58317;
}
})());
...
var map__58326 = malli.core.properties.cljs$core$IFn$_invoke$arity$2(schema,options);
var map__58326__$1 = cljs.core.__destructure_map(map__58326);
var gen_min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58326__$1,new cljs.core.Keyword("gen","min","gen/min",444569458));
var gen_max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58326__$1,new cljs.core.Keyword("gen","max","gen/max",61264228));
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58326__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58326__$1,new cljs.core.Keyword(null,"max","max",61366548));
...
var map__58330 = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
var map__58330__$1 = cljs.core.__destructure_map(map__58330);
var infinite_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58330__$1,new cljs.core.Keyword("gen","infinite?","gen/infinite?",-2017652832));
var NaN_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58330__$1,new cljs.core.Keyword("gen","NaN?","gen/NaN?",-1917993267));
...
return malli.generator.gen_fmap((function (p1__58332_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,p1__58332_SHARP_);
}),gen);
});
...
return clojure.test.check.generators.double_STAR_(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$2(malli.generator.double_default,opts),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__58338_SHARP_){
var G__58341 = p1__58338_SHARP_;
if((G__58341 == null)){
return null;
} else {
return G__58341;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__58339_SHARP_){
var G__58342 = p1__58339_SHARP_;
if((G__58342 == null)){
return null;
} else {
return G__58342;
...
malli.generator.gen_vector = (function malli$generator$gen_vector(p__58344,g){
var map__58346 = p__58344;
var map__58346__$1 = cljs.core.__destructure_map(map__58346);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58346__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58346__$1,new cljs.core.Keyword(null,"max","max",61366548));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(clojure.test.check.generators.sized((function (p1__58343_SHARP_){
return clojure.test.check.generators.vector.cljs$core$IFn$_invoke$arity$3(g,min,(min + p1__58343_SHARP_));
...
malli.generator.gen_vector_distinct_by = (function malli$generator$gen_vector_distinct_by(schema,p__58351,f,g){
var map__58352 = p__58351;
var map__58352__$1 = cljs.core.__destructure_map(map__58352);
var m = map__58352__$1;
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58352__$1,new cljs.core.Keyword(null,"min","min",444991522));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
})())?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"num-elements","num-elements",1960422107),min], null):clojure.set.rename_keys(m,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"min","min",444991522),new cljs.core.Keyword(null,"min-elements","min-elements",949370780),new cljs.core.Keyword(null,"max","max",61366548),new cljs.core.Keyword(null,"max-elements","max-elements",433034073)], null))),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__58350_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","distinct-generator-failure","malli.generator/distinct-generator-failure",-2085139904),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58350_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null)));
}
});
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__58355_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","such-that-failure","malli.generator/such-that-failure",599634585),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58355_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null);
});
...
var map__58378 = malli.generator._min_max(schema,options);
var map__58378__$1 = cljs.core.__destructure_map(map__58378);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58378__$1,new cljs.core.Keyword(null,"min","min",444991522));
var el = malli.generator._child(schema,options);
return malli.generator.gen_one_of(options,(function (){var G__58379 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$3((function (){var G__58380 = cljs.core.PersistentVector.EMPTY;
if((((min == null)) || ((min === (0))))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__58380,malli.generator.nil_gen);
} else {
return G__58380;
}
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__58376_SHARP_){
return malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$3(schema,p1__58376_SHARP_,options);
})),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.identity,cljs.core.vec,cljs.core.eduction,(function (p1__58377_SHARP_){
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(p1__58377_SHARP_);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__58379,(function (){var vec__58389 = malli.core.children.cljs$core$IFn$_invoke$arity$1(el);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58389,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58389,(1),null);
var G__58392 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map-of","map-of",1189682355),(function (){var or__5025__auto__ = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
...
var G__58393 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__58392,G__58393) : malli.generator.generator.call(null,G__58392,G__58393));
})());
} else {
return G__58379;
}
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58395_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__58395_SHARP_,options) : malli.generator.generator.call(null,p1__58395_SHARP_,options));
...
return malli.util.transform_entries.cljs$core$IFn$_invoke$arity$3(G__58397,(function (p1__58396_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__58398){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__58402,(2),malli.util.merge,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dispatch,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"=","=",1152933628),null,k], null)], null)], null));
} else {
return G__58402;
}
}),p1__58396_SHARP_);
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58403_SHARP_){
var G__58404 = cljs.core.last(p1__58403_SHARP_);
var G__58405 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__58404,G__58405) : malli.generator.generator.call(null,G__58404,G__58405));
...
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__58420){
var vec__58421 = p__58420;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58421,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58421,(1),null);
...
malli.generator._entry_gen = (function malli$generator$_entry_gen(p__58427,options){
var vec__58428 = p__58427;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58428,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58428,(1),null);
var G__58431 = malli.generator.gen_fmap((function (p1__58426_SHARP_){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,p1__58426_SHARP_], null);
...
return malli.generator.gen_maybe(G__58431);
} else {
return G__58431;
}
});
malli.generator._map_gen = (function malli$generator$_map_gen(schema,options){
return malli.generator.gen_fmap(malli.generator._build_map,malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58433_SHARP_){
return malli.generator._entry_gen(p1__58433_SHARP_,options);
...
return malli.generator.gen_fmap((function (p1__58438_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,p1__58438_SHARP_);
}),malli.generator.gen_vector_distinct_by(schema,malli.generator._min_max(schema,options),(function (p1__58437_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__58437_SHARP_,(0));
}),malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58436_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__58436_SHARP_,options) : malli.generator.generator.call(null,p1__58436_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)))));
});
...
var G__58441 = (function (){var G__58442 = dschema;
var G__58443 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),scalar_ref_gen);
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__58442,G__58443) : malli.generator.generator.call(null,G__58442,G__58443));
})();
if(cljs.core.realized_QMARK_(scalar_ref_gen)){
return clojure.test.check.generators.recursive_gen((function (p1__58440_SHARP_){
var G__58444 = dschema;
var G__58445 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),p1__58440_SHARP_);
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__58444,G__58445) : malli.generator.generator.call(null,G__58444,G__58445));
}),G__58441);
} else {
return G__58441;
}
...
var output_generator = (function (){var G__58446 = new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(malli.core._function_info(schema));
var G__58447 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__58446,G__58447) : malli.generator.generator.call(null,G__58446,G__58447));
})();
...
var G__58541__delegate = function (_){
...
while (G__58542__i < G__58542__a.length) {G__58542__a[G__58542__i] = arguments[G__58542__i + 0]; ++G__58542__i;}
  _ = new cljs.core.IndexedSeq(G__58542__a,0,null);
} 
return G__58541__delegate.call(this,_);};
G__58541.cljs$lang$maxFixedArity = 0;
G__58541.cljs$lang$applyTo = (function (arglist__58543){
var _ = cljs.core.seq(arglist__58543);
return G__58541__delegate(_);
});
...
return clojure.test.check.generators.return$(malli.core._instrument.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"schema","schema",-1582001791),schema,new cljs.core.Keyword(null,"gen","gen",142575302),(function (p1__58448_SHARP_){
return (malli.generator.generate.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generate.cljs$core$IFn$_invoke$arity$2(p1__58448_SHARP_,options) : malli.generator.generate.call(null,p1__58448_SHARP_,options));
})], null),null,options));
});
malli.generator._regex_generator = (function malli$generator$_regex_generator(schema,options){
var G__58449 = (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(schema,options) : malli.generator.generator.call(null,schema,options));
if(cljs.core.not(malli.core._regex_op_QMARK_(schema))){
return malli.generator.gen_tuple((new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[G__58449],null)));
} else {
return G__58449;
}
});
...
return malli.generator.gen_fcat(malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58450_SHARP_){
return malli.generator._re_entry_gen(p1__58450_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options))));
});
malli.generator._alt_gen = (function malli$generator$_alt_gen(schema,options){
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58451_SHARP_){
return malli.generator._re_entry_gen(p1__58451_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
});
...
var child = malli.generator._child(schema,options);
var G__58453 = malli.generator.gen_vector(malli.generator._min_max(schema,options),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__58453);
} else {
return G__58453;
}
});
...
var child = malli.generator._child(schema,options);
var G__58454 = malli.generator.gen_vector(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.max,(1))),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__58454);
} else {
return G__58454;
}
});
malli.generator._repeat_gen = (function malli$generator$_repeat_gen(schema,options){
var or__5025__auto__ = (function (){var G__58455 = malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$2(schema,options);
var G__58455__$1 = (((G__58455 == null))?null:malli.generator._not_unreachable(G__58455));
if((G__58455__$1 == null)){
return null;
} else {
var G__58460 = G__58455__$1;
if(cljs.core.truth_(malli.core._regex_op_QMARK_(malli.generator._child(schema,options)))){
return malli.generator.gen_fcat(G__58460);
} else {
return G__58460;
}
}
...
var G__58461 = cljs.core.name(namespace_unparsed);
var G__58462 = cljs.core.name(k);
return (mk_value_with_ns.cljs$core$IFn$_invoke$arity$2 ? mk_value_with_ns.cljs$core$IFn$_invoke$arity$2(G__58461,G__58462) : mk_value_with_ns.call(null,G__58461,G__58462));
...
})(),cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__58463_SHARP_){
var G__58465 = p1__58463_SHARP_;
if((G__58465 == null)){
return null;
} else {
return G__58465;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__58464_SHARP_){
var G__58466 = p1__58464_SHARP_;
if((G__58466 == null)){
return null;
} else {
return G__58466;
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.generator","default","malli.generator/default",-943988734)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__58467 = cljs.core.get_global_hierarchy;
return (fexpr__58467.cljs$core$IFn$_invoke$arity$0 ? fexpr__58467.cljs$core$IFn$_invoke$arity$0() : fexpr__58467.call(null));
})());
...
return malli.generator.gen_such_that(schema,(function (p1__58468_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__58468_SHARP_,malli.generator._child(schema,options));
...
return malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58473_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__58473_SHARP_,options) : malli.generator.generator.call(null,p1__58473_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
}));
...
var G__58475 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__58476 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__58475,G__58476) : malli.generator.generator.call(null,G__58475,G__58476));
}));
...
var G__58477 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__58478 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__58477,G__58478) : malli.generator.generator.call(null,G__58477,G__58478));
}));
...
var G__58479 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__58480 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__58479,G__58480) : malli.generator.generator.call(null,G__58479,G__58480));
}));
...
var G__58481 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__58482 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__58481,G__58482) : malli.generator.generator.call(null,G__58481,G__58482));
}));
...
var G__58483 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__58484 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__58483,G__58484) : malli.generator.generator.call(null,G__58483,G__58484));
}));
...
var G__58485 = new cljs.core.Keyword("gen","elements","gen/elements",657813311).cljs$core$IFn$_invoke$arity$1(props);
if((G__58485 == null)){
return null;
} else {
return malli.generator.gen_elements(G__58485);
}
});
...
var G__58486 = new cljs.core.Keyword("gen","schema","gen/schema",-1582038959).cljs$core$IFn$_invoke$arity$1(props);
if((G__58486 == null)){
return null;
} else {
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__58486,options) : malli.generator.generator.call(null,G__58486,options));
}
});
...
return malli.core._cached(malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options),new cljs.core.Keyword(null,"generator","generator",-572962281),(function (p1__58487_SHARP_){
return malli.generator._create(p1__58487_SHARP_,options);
}));
}
}));
...
(malli.generator.generate.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__58492){
var map__58493 = p__58492;
var map__58493__$1 = cljs.core.__destructure_map(map__58493);
var options = map__58493__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58493__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__58493__$1,new cljs.core.Keyword(null,"size","size",1098693007),(30));
...
(malli.generator.sample.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__58498){
var map__58499 = p__58498;
var map__58499__$1 = cljs.core.__destructure_map(map__58499);
var options = map__58499__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58499__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__58499__$1,new cljs.core.Keyword(null,"size","size",1098693007),(10));
var gen = ((clojure.test.check.generators.generator_QMARK_(_QMARK_gen_or_schema))?_QMARK_gen_or_schema:malli.generator.generator.cljs$core$IFn$_invoke$arity$2(_QMARK_gen_or_schema,options));
return cljs.core.take.cljs$core$IFn$_invoke$arity$2(size,cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__58494_SHARP_,p2__58495_SHARP_){
return clojure.test.check.rose_tree.root(clojure.test.check.generators.call_gen(gen,p1__58494_SHARP_,p2__58495_SHARP_));
...
(malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_schema,p__58505){
var map__58506 = p__58505;
var map__58506__$1 = cljs.core.__destructure_map(map__58506);
var options = map__58506__$1;
var _EQ__GT_iterations = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__58506__$1,new cljs.core.Keyword("malli.generator","=>iterations","malli.generator/=>iterations",-1726832707),(100));
...
}catch (e58507){if((e58507 instanceof Error)){
var e = e58507;
...
var map__58508 = malli.core._function_info(schema__$1);
var map__58508__$1 = cljs.core.__destructure_map(map__58508);
var input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58508__$1,new cljs.core.Keyword(null,"input","input",556931961));
var output = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58508__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var guard = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58508__$1,new cljs.core.Keyword(null,"guard","guard",-873147811));
...
if(cljs.core.truth_(and__5023__auto__)){
var G__58509 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [args,$], null);
return (valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1 ? valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1(G__58509) : valid_guard_QMARK_.call(null,G__58509));
} else {
return and__5023__auto__;
}
});
return (function (f){
var map__58510 = clojure.test.check.quick_check(_EQ__GT_iterations,clojure.test.check.properties.for_all_STAR_(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [input_generator], null),(function (p1__58500_SHARP_){
return validate(f,p1__58500_SHARP_);
})));
var map__58510__$1 = cljs.core.__destructure_map(map__58510);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58510__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var shrunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58510__$1,new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412));
...
var vec__58511 = (cljs.core.truth_(explain_input)?null:_try((function (){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,smallest);
})));
var result__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58511,(0),null);
var success = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58511,(1),null);
...
var G__58514 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(shrunk,new cljs.core.Keyword("malli.core","result","malli.core/result",1538632379),result__$1);
var G__58514__$1 = (cljs.core.truth_(explain_input)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__58514,new cljs.core.Keyword("malli.core","explain-input","malli.core/explain-input",1441627811),explain_input):G__58514);
var G__58514__$2 = (cljs.core.truth_(explain_output)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__58514__$1,new cljs.core.Keyword("malli.core","explain-output","malli.core/explain-output",-124321573),explain_output):G__58514__$1);
var G__58514__$3 = (cljs.core.truth_(explain_guard)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__58514__$2,new cljs.core.Keyword("malli.core","explain-guard","malli.core/explain-guard",-1119572847),explain_guard):G__58514__$2);
if(cljs.core.truth_(cljs.core.ex_message(result__$1))){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__58514__$3,new cljs.core.Keyword(null,"result","result",1415092211),cljs.core.ex_message),new cljs.core.Keyword(null,"result-data","result-data",-1724248844));
} else {
return G__58514__$3;
}
}
...
var checkers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58501_SHARP_){
return malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2(p1__58501_SHARP_,options);
}),malli.core._function_schema_arities(schema));
return (function (x){
return cljs.core.seq(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__58502_SHARP_){
return (p1__58502_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__58502_SHARP_.cljs$core$IFn$_invoke$arity$1(x) : p1__58502_SHARP_.call(null,x));
}),checkers));
});
} else {
...
var schema = malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options);
return malli.core.explain.cljs$core$IFn$_invoke$arity$2(malli.core._update_options(schema,(function (p1__58515_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58515_SHARP_,new cljs.core.Keyword("malli.core","function-checker","malli.core/function-checker",-792030936),malli.generator.function_checker);
})),f);
}));
