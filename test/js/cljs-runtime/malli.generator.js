...
var malli$generator$Generator$_generator$dyn_52599 = (function (this$,options){
...
return malli$generator$Generator$_generator$dyn_52599(this$,options);
}
});
 ...
 */
malli.generator._never_gen = (function malli$generator$_never_gen(p__52376){
var map__52377 = p__52376;
var map__52377__$1 = cljs.core.__destructure_map(map__52377);
var _options = map__52377__$1;
var original_generator_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52377__$1,new cljs.core.Keyword("malli.generator","original-generator-schema","malli.generator/original-generator-schema",-1122475395));
return cljs.core.with_meta(clojure.test.check.generators.sized((function (_){
return malli.core._fail_BANG_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("malli.generator","unsatisfiable-schema","malli.generator/unsatisfiable-schema",919209538),(function (){var G__52379 = cljs.core.PersistentArrayMap.EMPTY;
if(cljs.core.truth_(original_generator_schema)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52379,new cljs.core.Keyword(null,"schema","schema",-1582001791),original_generator_schema);
} else {
return G__52379;
}
})());
...
var map__52380 = malli.core.properties.cljs$core$IFn$_invoke$arity$2(schema,options);
var map__52380__$1 = cljs.core.__destructure_map(map__52380);
var gen_min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52380__$1,new cljs.core.Keyword("gen","min","gen/min",444569458));
var gen_max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52380__$1,new cljs.core.Keyword("gen","max","gen/max",61264228));
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52380__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52380__$1,new cljs.core.Keyword(null,"max","max",61366548));
...
var map__52383 = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
var map__52383__$1 = cljs.core.__destructure_map(map__52383);
var infinite_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52383__$1,new cljs.core.Keyword("gen","infinite?","gen/infinite?",-2017652832));
var NaN_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52383__$1,new cljs.core.Keyword("gen","NaN?","gen/NaN?",-1917993267));
...
return malli.generator.gen_fmap((function (p1__52384_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,p1__52384_SHARP_);
}),gen);
});
...
return clojure.test.check.generators.double_STAR_(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$2(malli.generator.double_default,opts),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__52403_SHARP_){
var G__52408 = p1__52403_SHARP_;
if((G__52408 == null)){
return null;
} else {
return G__52408;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__52404_SHARP_){
var G__52409 = p1__52404_SHARP_;
if((G__52409 == null)){
return null;
} else {
return G__52409;
...
malli.generator.gen_vector = (function malli$generator$gen_vector(p__52411,g){
var map__52412 = p__52411;
var map__52412__$1 = cljs.core.__destructure_map(map__52412);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52412__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52412__$1,new cljs.core.Keyword(null,"max","max",61366548));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(clojure.test.check.generators.sized((function (p1__52410_SHARP_){
return clojure.test.check.generators.vector.cljs$core$IFn$_invoke$arity$3(g,min,(min + p1__52410_SHARP_));
...
malli.generator.gen_vector_distinct_by = (function malli$generator$gen_vector_distinct_by(schema,p__52430,f,g){
var map__52431 = p__52430;
var map__52431__$1 = cljs.core.__destructure_map(map__52431);
var m = map__52431__$1;
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52431__$1,new cljs.core.Keyword(null,"min","min",444991522));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
})())?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"num-elements","num-elements",1960422107),min], null):clojure.set.rename_keys(m,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"min","min",444991522),new cljs.core.Keyword(null,"min-elements","min-elements",949370780),new cljs.core.Keyword(null,"max","max",61366548),new cljs.core.Keyword(null,"max-elements","max-elements",433034073)], null))),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__52429_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","distinct-generator-failure","malli.generator/distinct-generator-failure",-2085139904),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__52429_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null)));
}
});
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__52453_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","such-that-failure","malli.generator/such-that-failure",599634585),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__52453_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null);
});
...
var map__52471 = malli.generator._min_max(schema,options);
var map__52471__$1 = cljs.core.__destructure_map(map__52471);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52471__$1,new cljs.core.Keyword(null,"min","min",444991522));
var el = malli.generator._child(schema,options);
return malli.generator.gen_one_of(options,(function (){var G__52472 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$3((function (){var G__52473 = cljs.core.PersistentVector.EMPTY;
if((((min == null)) || ((min === (0))))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__52473,malli.generator.nil_gen);
} else {
return G__52473;
}
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__52469_SHARP_){
return malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$3(schema,p1__52469_SHARP_,options);
})),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.identity,cljs.core.vec,cljs.core.eduction,(function (p1__52470_SHARP_){
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(p1__52470_SHARP_);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__52472,(function (){var vec__52475 = malli.core.children.cljs$core$IFn$_invoke$arity$1(el);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52475,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52475,(1),null);
var G__52478 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map-of","map-of",1189682355),(function (){var or__5025__auto__ = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
...
var G__52479 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52478,G__52479) : malli.generator.generator.call(null,G__52478,G__52479));
})());
} else {
return G__52472;
}
...
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__52485_SHARP_,options) : malli.generator.generator.call(null,p1__52485_SHARP_,options));
...
return malli.util.transform_entries.cljs$core$IFn$_invoke$arity$3(G__52487,(function (p1__52486_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__52488){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__52492,(2),malli.util.merge,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dispatch,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"=","=",1152933628),null,k], null)], null)], null));
} else {
return G__52492;
}
}),p1__52486_SHARP_);
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52493_SHARP_){
var G__52494 = cljs.core.last(p1__52493_SHARP_);
...
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__52504){
var vec__52505 = p__52504;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52505,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52505,(1),null);
...
malli.generator._entry_gen = (function malli$generator$_entry_gen(p__52509,options){
var vec__52510 = p__52509;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52510,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52510,(1),null);
var G__52513 = malli.generator.gen_fmap((function (p1__52508_SHARP_){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,p1__52508_SHARP_], null);
...
return malli.generator.gen_maybe(G__52513);
} else {
return G__52513;
}
});
malli.generator._map_gen = (function malli$generator$_map_gen(schema,options){
return malli.generator.gen_fmap(malli.generator._build_map,malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52514_SHARP_){
return malli.generator._entry_gen(p1__52514_SHARP_,options);
...
return malli.generator.gen_fmap((function (p1__52517_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,p1__52517_SHARP_);
}),malli.generator.gen_vector_distinct_by(schema,malli.generator._min_max(schema,options),(function (p1__52516_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__52516_SHARP_,(0));
}),malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52515_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__52515_SHARP_,options) : malli.generator.generator.call(null,p1__52515_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)))));
});
...
var G__52521 = (function (){var G__52522 = dschema;
var G__52523 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),scalar_ref_gen);
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52522,G__52523) : malli.generator.generator.call(null,G__52522,G__52523));
})();
if(cljs.core.realized_QMARK_(scalar_ref_gen)){
return clojure.test.check.generators.recursive_gen((function (p1__52519_SHARP_){
var G__52524 = dschema;
var G__52525 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),p1__52519_SHARP_);
...
var output_generator = (function (){var G__52526 = new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(malli.core._function_info(schema));
...
var G__52616__delegate = function (_){
...
while (G__52617__i < G__52617__a.length) {G__52617__a[G__52617__i] = arguments[G__52617__i + 0]; ++G__52617__i;}
  _ = new cljs.core.IndexedSeq(G__52617__a,0,null);
} 
return G__52616__delegate.call(this,_);};
G__52616.cljs$lang$maxFixedArity = 0;
G__52616.cljs$lang$applyTo = (function (arglist__52618){
var _ = cljs.core.seq(arglist__52618);
return G__52616__delegate(_);
});
...
return clojure.test.check.generators.return$(malli.core._instrument.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"schema","schema",-1582001791),schema,new cljs.core.Keyword(null,"gen","gen",142575302),(function (p1__52528_SHARP_){
return (malli.generator.generate.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generate.cljs$core$IFn$_invoke$arity$2(p1__52528_SHARP_,options) : malli.generator.generate.call(null,p1__52528_SHARP_,options));
})], null),null,options));
});
malli.generator._regex_generator = (function malli$generator$_regex_generator(schema,options){
var G__52529 = (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(schema,options) : malli.generator.generator.call(null,schema,options));
if(cljs.core.not(malli.core._regex_op_QMARK_(schema))){
return malli.generator.gen_tuple((new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[G__52529],null)));
} else {
return G__52529;
}
});
...
return malli.generator.gen_fcat(malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52530_SHARP_){
return malli.generator._re_entry_gen(p1__52530_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options))));
});
malli.generator._alt_gen = (function malli$generator$_alt_gen(schema,options){
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52531_SHARP_){
...
var child = malli.generator._child(schema,options);
var G__52532 = malli.generator.gen_vector(malli.generator._min_max(schema,options),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__52532);
} else {
return G__52532;
}
});
...
var or__5025__auto__ = (function (){var G__52535 = malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$2(schema,options);
var G__52535__$1 = (((G__52535 == null))?null:malli.generator._not_unreachable(G__52535));
if((G__52535__$1 == null)){
return null;
} else {
var G__52536 = G__52535__$1;
if(cljs.core.truth_(malli.core._regex_op_QMARK_(malli.generator._child(schema,options)))){
return malli.generator.gen_fcat(G__52536);
} else {
return G__52536;
}
}
...
var G__52540 = cljs.core.name(namespace_unparsed);
var G__52541 = cljs.core.name(k);
return (mk_value_with_ns.cljs$core$IFn$_invoke$arity$2 ? mk_value_with_ns.cljs$core$IFn$_invoke$arity$2(G__52540,G__52541) : mk_value_with_ns.call(null,G__52540,G__52541));
...
})(),cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__52542_SHARP_){
...
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__52543_SHARP_){
var G__52545 = p1__52543_SHARP_;
if((G__52545 == null)){
return null;
} else {
return G__52545;
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.generator","default","malli.generator/default",-943988734)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__52546 = cljs.core.get_global_hierarchy;
return (fexpr__52546.cljs$core$IFn$_invoke$arity$0 ? fexpr__52546.cljs$core$IFn$_invoke$arity$0() : fexpr__52546.call(null));
})());
...
return malli.generator.gen_such_that(schema,(function (p1__52552_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__52552_SHARP_,malli.generator._child(schema,options));
...
return malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52553_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__52553_SHARP_,options) : malli.generator.generator.call(null,p1__52553_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
}));
...
var G__52564 = new cljs.core.Keyword("gen","elements","gen/elements",657813311).cljs$core$IFn$_invoke$arity$1(props);
if((G__52564 == null)){
return null;
} else {
return malli.generator.gen_elements(G__52564);
}
});
...
var G__52565 = new cljs.core.Keyword("gen","schema","gen/schema",-1582038959).cljs$core$IFn$_invoke$arity$1(props);
if((G__52565 == null)){
return null;
} else {
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__52565,options) : malli.generator.generator.call(null,G__52565,options));
}
});
...
return malli.core._cached(malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options),new cljs.core.Keyword(null,"generator","generator",-572962281),(function (p1__52567_SHARP_){
return malli.generator._create(p1__52567_SHARP_,options);
}));
}
}));
...
(malli.generator.generate.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__52572){
var map__52573 = p__52572;
var map__52573__$1 = cljs.core.__destructure_map(map__52573);
var options = map__52573__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52573__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52573__$1,new cljs.core.Keyword(null,"size","size",1098693007),(30));
...
(malli.generator.sample.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__52578){
var map__52579 = p__52578;
var map__52579__$1 = cljs.core.__destructure_map(map__52579);
var options = map__52579__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52579__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52579__$1,new cljs.core.Keyword(null,"size","size",1098693007),(10));
var gen = ((clojure.test.check.generators.generator_QMARK_(_QMARK_gen_or_schema))?_QMARK_gen_or_schema:malli.generator.generator.cljs$core$IFn$_invoke$arity$2(_QMARK_gen_or_schema,options));
return cljs.core.take.cljs$core$IFn$_invoke$arity$2(size,cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__52574_SHARP_,p2__52575_SHARP_){
return clojure.test.check.rose_tree.root(clojure.test.check.generators.call_gen(gen,p1__52574_SHARP_,p2__52575_SHARP_));
...
(malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_schema,p__52586){
var map__52587 = p__52586;
var map__52587__$1 = cljs.core.__destructure_map(map__52587);
var options = map__52587__$1;
var _EQ__GT_iterations = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52587__$1,new cljs.core.Keyword("malli.generator","=>iterations","malli.generator/=>iterations",-1726832707),(100));
...
}catch (e52588){if((e52588 instanceof Error)){
var e = e52588;
...
var map__52589 = malli.core._function_info(schema__$1);
var map__52589__$1 = cljs.core.__destructure_map(map__52589);
var input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52589__$1,new cljs.core.Keyword(null,"input","input",556931961));
var output = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52589__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var guard = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52589__$1,new cljs.core.Keyword(null,"guard","guard",-873147811));
...
if(cljs.core.truth_(and__5023__auto__)){
var G__52590 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [args,$], null);
return (valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1 ? valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1(G__52590) : valid_guard_QMARK_.call(null,G__52590));
} else {
return and__5023__auto__;
}
});
return (function (f){
var map__52591 = clojure.test.check.quick_check(_EQ__GT_iterations,clojure.test.check.properties.for_all_STAR_(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [input_generator], null),(function (p1__52580_SHARP_){
return validate(f,p1__52580_SHARP_);
})));
var map__52591__$1 = cljs.core.__destructure_map(map__52591);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52591__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var shrunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52591__$1,new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412));
...
var vec__52592 = (cljs.core.truth_(explain_input)?null:_try((function (){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,smallest);
})));
var result__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52592,(0),null);
var success = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52592,(1),null);
...
var G__52595 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(shrunk,new cljs.core.Keyword("malli.core","result","malli.core/result",1538632379),result__$1);
var G__52595__$1 = (cljs.core.truth_(explain_input)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52595,new cljs.core.Keyword("malli.core","explain-input","malli.core/explain-input",1441627811),explain_input):G__52595);
var G__52595__$2 = (cljs.core.truth_(explain_output)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52595__$1,new cljs.core.Keyword("malli.core","explain-output","malli.core/explain-output",-124321573),explain_output):G__52595__$1);
var G__52595__$3 = (cljs.core.truth_(explain_guard)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52595__$2,new cljs.core.Keyword("malli.core","explain-guard","malli.core/explain-guard",-1119572847),explain_guard):G__52595__$2);
if(cljs.core.truth_(cljs.core.ex_message(result__$1))){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__52595__$3,new cljs.core.Keyword(null,"result","result",1415092211),cljs.core.ex_message),new cljs.core.Keyword(null,"result-data","result-data",-1724248844));
} else {
return G__52595__$3;
}
}
...
var checkers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52581_SHARP_){
return malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2(p1__52581_SHARP_,options);
}),malli.core._function_schema_arities(schema));
return (function (x){
return cljs.core.seq(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__52582_SHARP_){
return (p1__52582_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__52582_SHARP_.cljs$core$IFn$_invoke$arity$1(x) : p1__52582_SHARP_.call(null,x));
}),checkers));
});
} else {
...
var schema = malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options);
return malli.core.explain.cljs$core$IFn$_invoke$arity$2(malli.core._update_options(schema,(function (p1__52596_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__52596_SHARP_,new cljs.core.Keyword("malli.core","function-checker","malli.core/function-checker",-792030936),malli.generator.function_checker);
})),f);
}));
