...
var len__5749__auto___31192 = arguments.length;
var i__5750__auto___31193 = (0);
while(true){
if((i__5750__auto___31193 < len__5749__auto___31192)){
args__5755__auto__.push((arguments[i__5750__auto___31193]));

var G__31194 = (i__5750__auto___31193 + (1));
i__5750__auto___31193 = G__31194;
continue;
} else {
}
break;
...
/** @this {Function} */
(bb_web_ds_tools.views.datasets.deep_merge.cljs$lang$applyTo = (function (seq30929){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq30929));
}));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","set-active-dataset-id","bb-web-ds-tools.views.datasets/set-active-dataset-id",1361188762),(function (db,p__30979){
var vec__30980 = p__30979;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30980,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30980,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-new-dataset-state","bb-web-ds-tools.views.datasets/update-new-dataset-state",-1930125405),(function (db,p__30983){
var vec__30984 = p__30983;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30984,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30984,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30984,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","add-dataset","bb-web-ds-tools.views.datasets/add-dataset",1462625692),(function (db,p__30990){
var vec__30991 = p__30990;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30991,(0),null);
var map__30994 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30991,(1),null);
var map__30994__$1 = cljs.core.__destructure_map(map__30994);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30994__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30994__$1,new cljs.core.Keyword(null,"data","data",-232669377));
...
var data_with_ids = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__30988_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__30988_SHARP_,new cljs.core.Keyword(null,"_uuid","_uuid",797900280),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.random_uuid()));
}),valid_data);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","delete-dataset","bb-web-ds-tools.views.datasets/delete-dataset",243110744),(function (db,p__30997){
var vec__30998 = p__30997;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30998,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30998,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-dataset-name","bb-web-ds-tools.views.datasets/update-dataset-name",798576715),(function (db,p__31009){
var vec__31012 = p__31009;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31012,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31012,(1),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31012,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),(function (db,p__31023){
var vec__31027 = p__31023;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31027,(0),null);
var dataset_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31027,(1),null);
var row_uuid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31027,(2),null);
var col_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31027,(3),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31027,(4),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),(function (db,p__31036){
var vec__31037 = p__31036;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31037,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31037,(1),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31037,(2),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31037,(3),null);
...
});})(i__31043,col,c__5501__auto__,size__5502__auto__,b__31044,s__31042__$2,temp__5825__auto__))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__31044),bb_web_ds_tools$views$datasets$column_toggle_dropdown_$_iter__31041(cljs.core.chunk_rest(s__31042__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__31044),null);
}
} else {
var col = cljs.core.first(s__31042__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["flex items-center space-x-2 p-1 ",bb_web_ds_tools.theme.bg_item_hover].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"checkbox",new cljs.core.Keyword(null,"class","class",-2030961996),"w-auto",new cljs.core.Keyword(null,"checked","checked",-50955819),(!(cljs.core.contains_QMARK_(hidden_columns,col))),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__31042__$2,temp__5825__auto__){
return (function (){
if(cljs.core.contains_QMARK_(hidden_columns,col)){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"hidden-columns","hidden-columns",-1045524800),cljs.core.disj.cljs$core$IFn$_invoke$arity$2(hidden_columns,col)], null));
} else {
...
return (function (){
var map__31049 = cljs.core.deref(state);
var map__31049__$1 = cljs.core.__destructure_map(map__31049);
var fmt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31049__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var name_val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31049__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31049__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var structure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31049__$1,new cljs.core.Keyword(null,"structure","structure",1563832083));
...
});})(i__31052,f,c__5501__auto__,size__5502__auto__,b__31053,s__31051__$2,temp__5825__auto__,map__31049,map__31049__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__31053),bb_web_ds_tools$views$datasets$importer_view_$_iter__31050(cljs.core.chunk_rest(s__31051__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__31053),null);
}
} else {
var f = cljs.core.first(s__31051__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),f,new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(fmt,f))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):""),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (f,s__31051__$2,temp__5825__auto__,map__31049,map__31049__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state){
return (function (){
set_state(new cljs.core.Keyword(null,"format","format",-1306924766),f);

if(cljs.core.truth_((function (){var fexpr__31057 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"markdown","markdown",1227225089),null,new cljs.core.Keyword(null,"csv","csv",-1164440893),null,new cljs.core.Keyword(null,"tsv","tsv",-1254214356),null], null), null);
return (fexpr__31057.cljs$core$IFn$_invoke$arity$1 ? fexpr__31057.cljs$core$IFn$_invoke$arity$1(f) : fexpr__31057.call(null,f));
})())){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),new cljs.core.Keyword(null,"columnar","columnar",-1122999701));
} else {
return null;
}
});})(f,s__31051__$2,temp__5825__auto__,map__31049,map__31049__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state))
], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"markdown","markdown",1227225089)))?"MD":clojure.string.upper_case(cljs.core.name(f)))], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__31050(cljs.core.rest(s__31051__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__31061),bb_web_ds_tools$views$datasets$importer_view_$_iter__31058(cljs.core.chunk_rest(s__31059__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__31061),null);
}
} else {
var s = cljs.core.first(s__31059__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"key","key",-1516042587),s,new cljs.core.Keyword(null,"disabled","disabled",-1529784218),(!(cljs.core.contains_QMARK_(supported_structures,s))),new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(structure__$1,s))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):(((!(cljs.core.contains_QMARK_(supported_structures,s))))?"opacity-50 cursor-not-allowed":"")),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (s,s__31059__$2,temp__5825__auto__,map__31049,map__31049__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state){
return (function (){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),s);
});})(s,s__31059__$2,temp__5825__auto__,map__31049,map__31049__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state))
], null),cljs.core.get.cljs$core$IFn$_invoke$arity$2(struct_labels,s)], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__31058(cljs.core.rest(s__31059__$2)));
}
} else {
return null;
}
...
var map__31080 = dataset;
var map__31080__$1 = cljs.core.__destructure_map(map__31080);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31080__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31080__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31080__$1,new cljs.core.Keyword(null,"columns","columns",1998437288));
var view_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31080__$1,new cljs.core.Keyword(null,"view-state","view-state",-976675614));
var map__31081 = view_state;
var map__31081__$1 = cljs.core.__destructure_map(map__31081);
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31081__$1,new cljs.core.Keyword(null,"page","page",849072397));
var rows_per_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31081__$1,new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959));
var filters = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31081__$1,new cljs.core.Keyword(null,"filters","filters",974726919));
var hidden_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31081__$1,new cljs.core.Keyword(null,"hidden-columns","hidden-columns",-1045524800));
var sort_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31081__$1,new cljs.core.Keyword(null,"sort-col","sort-col",-718754882));
var sort_dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31081__$1,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757));
var map__31082 = bb_web_ds_tools.utils.dataset_processing.process_table_data(data,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(view_state,new cljs.core.Keyword(null,"columns","columns",1998437288),columns));
var map__31082__$1 = cljs.core.__destructure_map(map__31082);
var page_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31082__$1,new cljs.core.Keyword(null,"page-data","page-data",1443840710));
var total_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31082__$1,new cljs.core.Keyword(null,"total-rows","total-rows",1745495528));
var start_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31082__$1,new cljs.core.Keyword(null,"start-idx","start-idx",-1600773745));
var end_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31082__$1,new cljs.core.Keyword(null,"end-idx","end-idx",-85750788));
var visible_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31082__$1,new cljs.core.Keyword(null,"visible-columns","visible-columns",1134718660));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_col,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"space-y-4 p-4"], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),["flex-wrap gap-4 items-end ",bb_web_ds_tools.theme.bg_toolbar," p-2 rounded shadow-sm"].join('')], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.label,"Rows"], null),new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.select,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),"py-1",new cljs.core.Keyword(null,"value","value",305978217),rows_per_page,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__31077_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959),parseInt(p1__31077_SHARP_.target.value)], null));
...
});})(i__31103,col,c__5501__auto__,size__5502__auto__,b__31104,s__31102__$2,temp__5825__auto__,map__31080,map__31080__$1,id,data,columns,view_state,map__31081,map__31081__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__31082,map__31082__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__31104),bb_web_ds_tools$views$datasets$data_table_$_iter__31101(cljs.core.chunk_rest(s__31102__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__31104),null);
}
} else {
var col = cljs.core.first(s__31102__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.th,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["cursor-pointer ",bb_web_ds_tools.theme.bg_item_hover].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (col,s__31102__$2,temp__5825__auto__,map__31080,map__31080__$1,id,data,columns,view_state,map__31081,map__31081__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__31082,map__31082__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
var new_dir = ((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_col,col)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))))?new cljs.core.Keyword(null,"desc","desc",2093485764):new cljs.core.Keyword(null,"asc","asc",356854569));
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"sort-col","sort-col",-718754882),col], null));

return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757),new_dir], null));
});})(col,s__31102__$2,temp__5825__auto__,map__31080,map__31080__$1,id,data,columns,view_state,map__31081,map__31081__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__31082,map__31082__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex items-center space-x-1"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),cljs.core.name(col)], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_col,col))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-[10px] transform translate-y-px"], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))?"\u25B2":"\u25BC")], null):null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__31101(cljs.core.rest(s__31102__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__31109),bb_web_ds_tools$views$datasets$data_table_$_iter__31106(cljs.core.chunk_rest(s__31107__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__31109),null);
}
} else {
var col = cljs.core.first(s__31107__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),["filter-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(col)].join(''),new cljs.core.Keyword(null,"class","class",-2030961996),"px-3 py-1.5"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-sm",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),["Filter ",cljs.core.name(col)].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(filters,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__31107__$2,temp__5825__auto__,map__31080,map__31080__$1,id,data,columns,view_state,map__31081,map__31081__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__31082,map__31082__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__31078_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"filters","filters",974726919),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(filters,col,p1__31078_SHARP_.target.value)], null));
});})(col,s__31107__$2,temp__5825__auto__,map__31080,map__31080__$1,id,data,columns,view_state,map__31081,map__31081__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__31082,map__31082__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__31106(cljs.core.rest(s__31107__$2)));
}
} else {
return null;
}
...
return iter__5503__auto__(visible_columns);
})()], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__31114(s__31115){
return (new cljs.core.LazySeq(null,(function (){
var s__31115__$1 = s__31115;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__31115__$1);
if(temp__5825__auto__){
var s__31115__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__31115__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__31115__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__31117 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__31116 = (0);
while(true){
if((i__31116 < size__5502__auto__)){
var row = cljs.core._nth(c__5501__auto__,i__31116);
cljs.core.chunk_append(b__31117,(function (){var row_uuid = new cljs.core.Keyword(null,"_uuid","_uuid",797900280).cljs$core$IFn$_invoke$arity$1(row);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row_uuid], null),(function (){var iter__5503__auto__ = ((function (i__31116,row_uuid,row,c__5501__auto__,size__5502__auto__,b__31117,s__31115__$2,temp__5825__auto__,map__31080,map__31080__$1,id,data,columns,view_state,map__31081,map__31081__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__31082,map__31082__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function bb_web_ds_tools$views$datasets$data_table_$_iter__31114_$_iter__31118(s__31119){
return (new cljs.core.LazySeq(null,((function (i__31116,row_uuid,row,c__5501__auto__,size__5502__auto__,b__31117,s__31115__$2,temp__5825__auto__,map__31080,map__31080__$1,id,data,columns,view_state,map__31081,map__31081__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__31082,map__31082__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
var s__31119__$1 = s__31119;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__31119__$1);
if(temp__5825__auto____$1){
var s__31119__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__31119__$2)){
var c__5501__auto____$1 = cljs.core.chunk_first(s__31119__$2);
var size__5502__auto____$1 = cljs.core.count(c__5501__auto____$1);
var b__31121 = cljs.core.chunk_buffer(size__5502__auto____$1);
if((function (){var i__31120 = (0);
while(true){
if((i__31120 < size__5502__auto____$1)){
var col = cljs.core._nth(c__5501__auto____$1,i__31120);
cljs.core.chunk_append(b__31121,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__31120,i__31116,col,c__5501__auto____$1,size__5502__auto____$1,b__31121,s__31119__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__31117,s__31115__$2,temp__5825__auto__,map__31080,map__31080__$1,id,data,columns,view_state,map__31081,map__31081__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__31082,map__31082__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__31079_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__31079_SHARP_.target.value], null));
});})(i__31120,i__31116,col,c__5501__auto____$1,size__5502__auto____$1,b__31121,s__31119__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__31117,s__31115__$2,temp__5825__auto__,map__31080,map__31080__$1,id,data,columns,view_state,map__31081,map__31081__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__31082,map__31082__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__31248 = (i__31120 + (1));
i__31120 = G__31248;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__31121),bb_web_ds_tools$views$datasets$data_table_$_iter__31114_$_iter__31118(cljs.core.chunk_rest(s__31119__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__31121),null);
}
} else {
var col = cljs.core.first(s__31119__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__31116,col,s__31119__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__31117,s__31115__$2,temp__5825__auto__,map__31080,map__31080__$1,id,data,columns,view_state,map__31081,map__31081__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__31082,map__31082__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__31079_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__31079_SHARP_.target.value], null));
});})(i__31116,col,s__31119__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__31117,s__31115__$2,temp__5825__auto__,map__31080,map__31080__$1,id,data,columns,view_state,map__31081,map__31081__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__31082,map__31082__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__31114_$_iter__31118(cljs.core.rest(s__31119__$2)));
}
} else {
return null;
}
...
});})(i__31116,row_uuid,row,c__5501__auto__,size__5502__auto__,b__31117,s__31115__$2,temp__5825__auto__,map__31080,map__31080__$1,id,data,columns,view_state,map__31081,map__31081__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__31082,map__31082__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
,null,null));
});})(i__31116,row_uuid,row,c__5501__auto__,size__5502__auto__,b__31117,s__31115__$2,temp__5825__auto__,map__31080,map__31080__$1,id,data,columns,view_state,map__31081,map__31081__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__31082,map__31082__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
;
return iter__5503__auto__(visible_columns);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__31117),bb_web_ds_tools$views$datasets$data_table_$_iter__31114(cljs.core.chunk_rest(s__31115__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__31117),null);
}
} else {
var row = cljs.core.first(s__31115__$2);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row_uuid], null),(function (){var iter__5503__auto__ = ((function (row_uuid,row,s__31115__$2,temp__5825__auto__,map__31080,map__31080__$1,id,data,columns,view_state,map__31081,map__31081__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__31082,map__31082__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function bb_web_ds_tools$views$datasets$data_table_$_iter__31114_$_iter__31140(s__31141){
return (new cljs.core.LazySeq(null,(function (){
var s__31141__$1 = s__31141;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__31141__$1);
if(temp__5825__auto____$1){
var s__31141__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__31141__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__31141__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__31143 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__31142 = (0);
while(true){
if((i__31142 < size__5502__auto__)){
var col = cljs.core._nth(c__5501__auto__,i__31142);
cljs.core.chunk_append(b__31143,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__31142,col,c__5501__auto__,size__5502__auto__,b__31143,s__31141__$2,temp__5825__auto____$1,row_uuid,row,s__31115__$2,temp__5825__auto__,map__31080,map__31080__$1,id,data,columns,view_state,map__31081,map__31081__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__31082,map__31082__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__31079_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__31079_SHARP_.target.value], null));
});})(i__31142,col,c__5501__auto__,size__5502__auto__,b__31143,s__31141__$2,temp__5825__auto____$1,row_uuid,row,s__31115__$2,temp__5825__auto__,map__31080,map__31080__$1,id,data,columns,view_state,map__31081,map__31081__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__31082,map__31082__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__31261 = (i__31142 + (1));
i__31142 = G__31261;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__31143),bb_web_ds_tools$views$datasets$data_table_$_iter__31114_$_iter__31140(cljs.core.chunk_rest(s__31141__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__31143),null);
}
} else {
var col = cljs.core.first(s__31141__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__31141__$2,temp__5825__auto____$1,row_uuid,row,s__31115__$2,temp__5825__auto__,map__31080,map__31080__$1,id,data,columns,view_state,map__31081,map__31081__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__31082,map__31082__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__31079_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__31079_SHARP_.target.value], null));
});})(col,s__31141__$2,temp__5825__auto____$1,row_uuid,row,s__31115__$2,temp__5825__auto__,map__31080,map__31080__$1,id,data,columns,view_state,map__31081,map__31081__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__31082,map__31082__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__31114_$_iter__31140(cljs.core.rest(s__31141__$2)));
}
} else {
return null;
}
...
});})(row_uuid,row,s__31115__$2,temp__5825__auto__,map__31080,map__31080__$1,id,data,columns,view_state,map__31081,map__31081__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__31082,map__31082__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
;
return iter__5503__auto__(visible_columns);
})()], null);
})(),bb_web_ds_tools$views$datasets$data_table_$_iter__31114(cljs.core.rest(s__31115__$2)));
}
} else {
return null;
}
...
return (function (){
var map__31165 = cljs.core.deref(state_sub);
var map__31165__$1 = cljs.core.__destructure_map(map__31165);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31165__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var active_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31165__$1,new cljs.core.Keyword(null,"active-id","active-id",-59238656));
...
})], null),"+ New Dataset"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex-grow overflow-y-auto p-2 space-y-1"], null),((cljs.core.seq(items))?(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$dataset_list_$_iter__31166(s__31167){
return (new cljs.core.LazySeq(null,(function (){
var s__31167__$1 = s__31167;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__31167__$1);
if(temp__5825__auto__){
var s__31167__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__31167__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__31167__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__31169 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__31168 = (0);
while(true){
if((i__31168 < size__5502__auto__)){
var vec__31170 = cljs.core._nth(c__5501__auto__,i__31168);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31170,(0),null);
var ds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31170,(1),null);
cljs.core.chunk_append(b__31169,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.datasets.dataset_list_item,id,ds,active_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__31271 = (i__31168 + (1));
i__31168 = G__31271;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__31169),bb_web_ds_tools$views$datasets$dataset_list_$_iter__31166(cljs.core.chunk_rest(s__31167__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__31169),null);
}
} else {
var vec__31183 = cljs.core.first(s__31167__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31183,(0),null);
var ds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31183,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.datasets.dataset_list_item,id,ds,active_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),bb_web_ds_tools$views$datasets$dataset_list_$_iter__31166(cljs.core.rest(s__31167__$2)));
}
} else {
return null;
}
...
return (function (){
var map__31191 = cljs.core.deref(state_sub);
var map__31191__$1 = cljs.core.__destructure_map(map__31191);
var active_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31191__$1,new cljs.core.Keyword(null,"active-id","active-id",-59238656));
var active_dataset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31191__$1,new cljs.core.Keyword(null,"active-dataset","active-dataset",771380472));
