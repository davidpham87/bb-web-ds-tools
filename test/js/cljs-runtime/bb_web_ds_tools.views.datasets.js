...
var G__34725 = (i__5750__auto___34724 + (1));
i__5750__auto___34724 = G__34725;
continue;
} else {
}
break;
...
/** @this {Function} */
(bb_web_ds_tools.views.datasets.deep_merge.cljs$lang$applyTo = (function (seq34366){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq34366));
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"datasets","datasets",1896364419)], null),(function (p1__34386_SHARP_){
return bb_web_ds_tools.views.datasets.deep_merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__34386_SHARP_,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"items","items",1031954938),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"new-dataset-state","new-dataset-state",1109324301),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"name","name",1843675177),"New Dataset",new cljs.core.Keyword(null,"text","text",-1790561697),"",new cljs.core.Keyword(null,"format","format",-1306924766),new cljs.core.Keyword(null,"csv","csv",-1164440893),new cljs.core.Keyword(null,"structure","structure",1563832083),new cljs.core.Keyword(null,"columnar","columnar",-1122999701)], null)], null)], 0));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","set-active-dataset-id","bb-web-ds-tools.views.datasets/set-active-dataset-id",1361188762),(function (db,p__34448){
var vec__34451 = p__34448;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34451,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34451,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-new-dataset-state","bb-web-ds-tools.views.datasets/update-new-dataset-state",-1930125405),(function (db,p__34459){
var vec__34463 = p__34459;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34463,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34463,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34463,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","add-dataset","bb-web-ds-tools.views.datasets/add-dataset",1462625692),(function (db,p__34494){
var vec__34495 = p__34494;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34495,(0),null);
var map__34498 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34495,(1),null);
var map__34498__$1 = cljs.core.__destructure_map(map__34498);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34498__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34498__$1,new cljs.core.Keyword(null,"data","data",-232669377));
...
var data_with_ids = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__34471_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__34471_SHARP_,new cljs.core.Keyword(null,"_uuid","_uuid",797900280),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.random_uuid()));
}),valid_data);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","delete-dataset","bb-web-ds-tools.views.datasets/delete-dataset",243110744),(function (db,p__34523){
var vec__34525 = p__34523;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34525,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34525,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-dataset-name","bb-web-ds-tools.views.datasets/update-dataset-name",798576715),(function (db,p__34543){
var vec__34544 = p__34543;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34544,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34544,(1),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34544,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),(function (db,p__34547){
var vec__34548 = p__34547;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34548,(0),null);
var dataset_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34548,(1),null);
var row_uuid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34548,(2),null);
var col_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34548,(3),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34548,(4),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),(function (db,p__34553){
var vec__34554 = p__34553;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34554,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34554,(1),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34554,(2),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34554,(3),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","fetch-vega-datasets","bb-web-ds-tools.views.datasets/fetch-vega-datasets",202932363),(function (p__34571,_){
var map__34572 = p__34571;
var map__34572__$1 = cljs.core.__destructure_map(map__34572);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34572__$1,new cljs.core.Keyword(null,"db","db",993250759));
fetch("https://cdn.jsdelivr.net/npm/vega-datasets/data/").then((function (p1__34567_SHARP_){
return p1__34567_SHARP_.text();
})).then((function (p1__34568_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","receive-vega-datasets","bb-web-ds-tools.views.datasets/receive-vega-datasets",-736628262),p1__34568_SHARP_], null));
})).catch((function (p1__34569_SHARP_){
return console.error("Failed to fetch vega datasets list",p1__34569_SHARP_);
}));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","receive-vega-datasets","bb-web-ds-tools.views.datasets/receive-vega-datasets",-736628262),(function (db,p__34579){
var vec__34581 = p__34579;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34581,(0),null);
var html_content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34581,(1),null);
...
var filenames = cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.sort.cljs$core$IFn$_invoke$arity$1(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__34578_SHARP_){
return cljs.core.re_find(/\.(json|csv|tsv|md)$/,p1__34578_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34577_SHARP_){
return p1__34577_SHARP_.innerText;
}),links))));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","fetch-vega-dataset","bb-web-ds-tools.views.datasets/fetch-vega-dataset",1814090652),(function (p__34593,p__34594){
var map__34595 = p__34593;
var map__34595__$1 = cljs.core.__destructure_map(map__34595);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34595__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__34596 = p__34594;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34596,(0),null);
var filename = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34596,(1),null);
var url = ["https://cdn.jsdelivr.net/npm/vega-datasets@3/data/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(filename)].join('');
fetch(url).then((function (p1__34590_SHARP_){
return p1__34590_SHARP_.text();
})).then((function (p1__34591_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","receive-vega-dataset-content","bb-web-ds-tools.views.datasets/receive-vega-dataset-content",-385162532),filename,p1__34591_SHARP_], null));
})).catch((function (p1__34592_SHARP_){
return console.error("Failed to fetch vega dataset",p1__34592_SHARP_);
}));

return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"db","db",993250759),cljs.core.assoc_in(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","datasets","bb-web-ds-tools.views.datasets/datasets",-1461208347),new cljs.core.Keyword(null,"loading-vega-dataset?","loading-vega-dataset?",-1002270211)], null),true)], null);
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","receive-vega-dataset-content","bb-web-ds-tools.views.datasets/receive-vega-dataset-content",-385162532),(function (db,p__34599){
var vec__34600 = p__34599;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34600,(0),null);
var filename = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34600,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34600,(2),null);
var extension = cljs.core.last(clojure.string.split.cljs$core$IFn$_invoke$arity$2(filename,/\./));
var format = (function (){var G__34603 = extension;
switch (G__34603) {
case "json":
...
});})(i__34607,col,c__5501__auto__,size__5502__auto__,b__34608,s__34606__$2,temp__5825__auto__))
...
return (function (){
var map__34623 = cljs.core.deref(state);
var map__34623__$1 = cljs.core.__destructure_map(map__34623);
var fmt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34623__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var name_val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34623__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34623__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var structure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34623__$1,new cljs.core.Keyword(null,"structure","structure",1563832083));
...
var ds = cljs.core._nth(c__5501__auto__,i__34627);
...
})()], null))], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"space-x-2"], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$importer_view_$_iter__34629(s__34630){
return (new cljs.core.LazySeq(null,(function (){
...
var f = cljs.core._nth(c__5501__auto__,i__34631);
cljs.core.chunk_append(b__34632,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),f,new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(fmt,f))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):""),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__34631,f,c__5501__auto__,size__5502__auto__,b__34632,s__34630__$2,temp__5825__auto__,map__34623,map__34623__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_){
return (function (){
set_state(new cljs.core.Keyword(null,"format","format",-1306924766),f);

if(cljs.core.truth_((function (){var fexpr__34633 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"markdown","markdown",1227225089),null,new cljs.core.Keyword(null,"csv","csv",-1164440893),null,new cljs.core.Keyword(null,"tsv","tsv",-1254214356),null], null), null);
return (fexpr__34633.cljs$core$IFn$_invoke$arity$1 ? fexpr__34633.cljs$core$IFn$_invoke$arity$1(f) : fexpr__34633.call(null,f));
})())){
...
});})(i__34631,f,c__5501__auto__,size__5502__auto__,b__34632,s__34630__$2,temp__5825__auto__,map__34623,map__34623__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__34632),bb_web_ds_tools$views$datasets$importer_view_$_iter__34629(cljs.core.chunk_rest(s__34630__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__34632),null);
}
} else {
var f = cljs.core.first(s__34630__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),f,new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(fmt,f))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):""),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (f,s__34630__$2,temp__5825__auto__,map__34623,map__34623__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_){
return (function (){
set_state(new cljs.core.Keyword(null,"format","format",-1306924766),f);

if(cljs.core.truth_((function (){var fexpr__34634 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"markdown","markdown",1227225089),null,new cljs.core.Keyword(null,"csv","csv",-1164440893),null,new cljs.core.Keyword(null,"tsv","tsv",-1254214356),null], null), null);
return (fexpr__34634.cljs$core$IFn$_invoke$arity$1 ? fexpr__34634.cljs$core$IFn$_invoke$arity$1(f) : fexpr__34634.call(null,f));
})())){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),new cljs.core.Keyword(null,"columnar","columnar",-1122999701));
} else {
return null;
}
});})(f,s__34630__$2,temp__5825__auto__,map__34623,map__34623__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_))
], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"markdown","markdown",1227225089)))?"MD":clojure.string.upper_case(cljs.core.name(f)))], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__34629(cljs.core.rest(s__34630__$2)));
}
} else {
return null;
}
...
var s = cljs.core._nth(c__5501__auto__,i__34637);
cljs.core.chunk_append(b__34638,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"key","key",-1516042587),s,new cljs.core.Keyword(null,"disabled","disabled",-1529784218),(!(cljs.core.contains_QMARK_(supported_structures,s))),new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(structure__$1,s))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):(((!(cljs.core.contains_QMARK_(supported_structures,s))))?"opacity-50 cursor-not-allowed":"")),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__34637,s,c__5501__auto__,size__5502__auto__,b__34638,s__34636__$2,temp__5825__auto__,map__34623,map__34623__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_){
return (function (){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),s);
});})(i__34637,s,c__5501__auto__,size__5502__auto__,b__34638,s__34636__$2,temp__5825__auto__,map__34623,map__34623__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_))
], null),cljs.core.get.cljs$core$IFn$_invoke$arity$2(struct_labels,s)], null));

var G__34742 = (i__34637 + (1));
i__34637 = G__34742;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__34638),bb_web_ds_tools$views$datasets$importer_view_$_iter__34635(cljs.core.chunk_rest(s__34636__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__34638),null);
}
} else {
var s = cljs.core.first(s__34636__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"key","key",-1516042587),s,new cljs.core.Keyword(null,"disabled","disabled",-1529784218),(!(cljs.core.contains_QMARK_(supported_structures,s))),new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(structure__$1,s))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):(((!(cljs.core.contains_QMARK_(supported_structures,s))))?"opacity-50 cursor-not-allowed":"")),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (s,s__34636__$2,temp__5825__auto__,map__34623,map__34623__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_){
return (function (){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),s);
});})(s,s__34636__$2,temp__5825__auto__,map__34623,map__34623__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_))
], null),cljs.core.get.cljs$core$IFn$_invoke$arity$2(struct_labels,s)], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__34635(cljs.core.rest(s__34636__$2)));
}
} else {
return null;
}
...
var columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34652__$1,new cljs.core.Keyword(null,"columns","columns",1998437288));
var view_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34652__$1,new cljs.core.Keyword(null,"view-state","view-state",-976675614));
var map__34653 = view_state;
var map__34653__$1 = cljs.core.__destructure_map(map__34653);
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34653__$1,new cljs.core.Keyword(null,"page","page",849072397));
var rows_per_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34653__$1,new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959));
var filters = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34653__$1,new cljs.core.Keyword(null,"filters","filters",974726919));
var hidden_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34653__$1,new cljs.core.Keyword(null,"hidden-columns","hidden-columns",-1045524800));
var sort_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34653__$1,new cljs.core.Keyword(null,"sort-col","sort-col",-718754882));
var sort_dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34653__$1,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757));
var map__34654 = bb_web_ds_tools.utils.dataset_processing.process_table_data(data,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(view_state,new cljs.core.Keyword(null,"columns","columns",1998437288),columns));
var map__34654__$1 = cljs.core.__destructure_map(map__34654);
var page_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34654__$1,new cljs.core.Keyword(null,"page-data","page-data",1443840710));
var total_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34654__$1,new cljs.core.Keyword(null,"total-rows","total-rows",1745495528));
var start_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34654__$1,new cljs.core.Keyword(null,"start-idx","start-idx",-1600773745));
var end_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34654__$1,new cljs.core.Keyword(null,"end-idx","end-idx",-85750788));
var visible_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34654__$1,new cljs.core.Keyword(null,"visible-columns","visible-columns",1134718660));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_col,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"space-y-4 p-4"], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),["flex-wrap gap-4 items-end ",bb_web_ds_tools.theme.bg_toolbar," p-2 rounded shadow-sm"].join('')], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.label,"Rows"], null),new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.select,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),"py-1",new cljs.core.Keyword(null,"value","value",305978217),rows_per_page,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__34644_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959),parseInt(p1__34644_SHARP_.target.value)], null));
...
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"page","page",849072397),(page + (1))], null));
}),new cljs.core.Keyword(null,"disabled","disabled",-1529784218),(end_idx >= total_rows)], null),"Next"], null)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.table_container,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.table,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.thead,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__34655(s__34656){
return (new cljs.core.LazySeq(null,(function (){
var s__34656__$1 = s__34656;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__34656__$1);
if(temp__5825__auto__){
var s__34656__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__34656__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__34656__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__34658 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__34657 = (0);
while(true){
if((i__34657 < size__5502__auto__)){
var col = cljs.core._nth(c__5501__auto__,i__34657);
cljs.core.chunk_append(b__34658,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.th,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["cursor-pointer ",bb_web_ds_tools.theme.bg_item_hover].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__34657,col,c__5501__auto__,size__5502__auto__,b__34658,s__34656__$2,temp__5825__auto__,map__34652,map__34652__$1,id,data,columns,view_state,map__34653,map__34653__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__34654,map__34654__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
...
});})(i__34657,col,c__5501__auto__,size__5502__auto__,b__34658,s__34656__$2,temp__5825__auto__,map__34652,map__34652__$1,id,data,columns,view_state,map__34653,map__34653__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__34654,map__34654__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__34658),bb_web_ds_tools$views$datasets$data_table_$_iter__34655(cljs.core.chunk_rest(s__34656__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__34658),null);
}
} else {
var col = cljs.core.first(s__34656__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.th,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["cursor-pointer ",bb_web_ds_tools.theme.bg_item_hover].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (col,s__34656__$2,temp__5825__auto__,map__34652,map__34652__$1,id,data,columns,view_state,map__34653,map__34653__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__34654,map__34654__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
var new_dir = ((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_col,col)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))))?new cljs.core.Keyword(null,"desc","desc",2093485764):new cljs.core.Keyword(null,"asc","asc",356854569));
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"sort-col","sort-col",-718754882),col], null));

return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757),new_dir], null));
});})(col,s__34656__$2,temp__5825__auto__,map__34652,map__34652__$1,id,data,columns,view_state,map__34653,map__34653__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__34654,map__34654__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex items-center space-x-1"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),cljs.core.name(col)], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_col,col))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-[10px] transform translate-y-px"], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))?"\u25B2":"\u25BC")], null):null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__34655(cljs.core.rest(s__34656__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__34670),bb_web_ds_tools$views$datasets$data_table_$_iter__34667(cljs.core.chunk_rest(s__34668__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__34670),null);
}
} else {
var col = cljs.core.first(s__34668__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),["filter-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(col)].join(''),new cljs.core.Keyword(null,"class","class",-2030961996),"px-3 py-1.5"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-sm",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),["Filter ",cljs.core.name(col)].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(filters,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__34668__$2,temp__5825__auto__,map__34652,map__34652__$1,id,data,columns,view_state,map__34653,map__34653__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__34654,map__34654__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__34646_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"filters","filters",974726919),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(filters,col,p1__34646_SHARP_.target.value)], null));
});})(col,s__34668__$2,temp__5825__auto__,map__34652,map__34652__$1,id,data,columns,view_state,map__34653,map__34653__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__34654,map__34654__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__34667(cljs.core.rest(s__34668__$2)));
}
} else {
return null;
}
...
return iter__5503__auto__(visible_columns);
})()], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__34671(s__34672){
return (new cljs.core.LazySeq(null,(function (){
...
var row = cljs.core._nth(c__5501__auto__,i__34673);
cljs.core.chunk_append(b__34674,(function (){var row_uuid = new cljs.core.Keyword(null,"_uuid","_uuid",797900280).cljs$core$IFn$_invoke$arity$1(row);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row_uuid], null),(function (){var iter__5503__auto__ = ((function (i__34673,row_uuid,row,c__5501__auto__,size__5502__auto__,b__34674,s__34672__$2,temp__5825__auto__,map__34652,map__34652__$1,id,data,columns,view_state,map__34653,map__34653__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__34654,map__34654__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function bb_web_ds_tools$views$datasets$data_table_$_iter__34671_$_iter__34679(s__34680){
return (new cljs.core.LazySeq(null,((function (i__34673,row_uuid,row,c__5501__auto__,size__5502__auto__,b__34674,s__34672__$2,temp__5825__auto__,map__34652,map__34652__$1,id,data,columns,view_state,map__34653,map__34653__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__34654,map__34654__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__34682),bb_web_ds_tools$views$datasets$data_table_$_iter__34671_$_iter__34679(cljs.core.chunk_rest(s__34680__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__34682),null);
}
} else {
var col = cljs.core.first(s__34680__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__34673,col,s__34680__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__34674,s__34672__$2,temp__5825__auto__,map__34652,map__34652__$1,id,data,columns,view_state,map__34653,map__34653__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__34654,map__34654__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__34649_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__34649_SHARP_.target.value], null));
});})(i__34673,col,s__34680__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__34674,s__34672__$2,temp__5825__auto__,map__34652,map__34652__$1,id,data,columns,view_state,map__34653,map__34653__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__34654,map__34654__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__34671_$_iter__34679(cljs.core.rest(s__34680__$2)));
}
} else {
return null;
}
...
});})(i__34673,row_uuid,row,c__5501__auto__,size__5502__auto__,b__34674,s__34672__$2,temp__5825__auto__,map__34652,map__34652__$1,id,data,columns,view_state,map__34653,map__34653__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__34654,map__34654__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
,null,null));
});})(i__34673,row_uuid,row,c__5501__auto__,size__5502__auto__,b__34674,s__34672__$2,temp__5825__auto__,map__34652,map__34652__$1,id,data,columns,view_state,map__34653,map__34653__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__34654,map__34654__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
;
return iter__5503__auto__(visible_columns);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__34674),bb_web_ds_tools$views$datasets$data_table_$_iter__34671(cljs.core.chunk_rest(s__34672__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__34674),null);
}
} else {
var row = cljs.core.first(s__34672__$2);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row_uuid], null),(function (){var iter__5503__auto__ = ((function (row_uuid,row,s__34672__$2,temp__5825__auto__,map__34652,map__34652__$1,id,data,columns,view_state,map__34653,map__34653__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__34654,map__34654__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function bb_web_ds_tools$views$datasets$data_table_$_iter__34671_$_iter__34683(s__34684){
return (new cljs.core.LazySeq(null,(function (){
var s__34684__$1 = s__34684;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__34684__$1);
if(temp__5825__auto____$1){
var s__34684__$2 = temp__5825__auto____$1;
...
var col = cljs.core._nth(c__5501__auto__,i__34685);
cljs.core.chunk_append(b__34686,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__34685,col,c__5501__auto__,size__5502__auto__,b__34686,s__34684__$2,temp__5825__auto____$1,row_uuid,row,s__34672__$2,temp__5825__auto__,map__34652,map__34652__$1,id,data,columns,view_state,map__34653,map__34653__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__34654,map__34654__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__34649_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__34649_SHARP_.target.value], null));
});})(i__34685,col,c__5501__auto__,size__5502__auto__,b__34686,s__34684__$2,temp__5825__auto____$1,row_uuid,row,s__34672__$2,temp__5825__auto__,map__34652,map__34652__$1,id,data,columns,view_state,map__34653,map__34653__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__34654,map__34654__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__34778 = (i__34685 + (1));
i__34685 = G__34778;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__34686),bb_web_ds_tools$views$datasets$data_table_$_iter__34671_$_iter__34683(cljs.core.chunk_rest(s__34684__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__34686),null);
}
} else {
var col = cljs.core.first(s__34684__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__34684__$2,temp__5825__auto____$1,row_uuid,row,s__34672__$2,temp__5825__auto__,map__34652,map__34652__$1,id,data,columns,view_state,map__34653,map__34653__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__34654,map__34654__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__34649_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__34649_SHARP_.target.value], null));
});})(col,s__34684__$2,temp__5825__auto____$1,row_uuid,row,s__34672__$2,temp__5825__auto__,map__34652,map__34652__$1,id,data,columns,view_state,map__34653,map__34653__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__34654,map__34654__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__34671_$_iter__34683(cljs.core.rest(s__34684__$2)));
}
} else {
return null;
}
...
});})(row_uuid,row,s__34672__$2,temp__5825__auto__,map__34652,map__34652__$1,id,data,columns,view_state,map__34653,map__34653__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__34654,map__34654__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
;
return iter__5503__auto__(visible_columns);
})()], null);
})(),bb_web_ds_tools$views$datasets$data_table_$_iter__34671(cljs.core.rest(s__34672__$2)));
}
} else {
return null;
}
...
return (function (){
var map__34706 = cljs.core.deref(state_sub);
var map__34706__$1 = cljs.core.__destructure_map(map__34706);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34706__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var active_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34706__$1,new cljs.core.Keyword(null,"active-id","active-id",-59238656));
...
})], null),"+ New Dataset"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex-grow overflow-y-auto pt-4 space-y-1"], null),((cljs.core.seq(items))?(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$dataset_list_$_iter__34707(s__34708){
return (new cljs.core.LazySeq(null,(function (){
var s__34708__$1 = s__34708;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__34708__$1);
if(temp__5825__auto__){
var s__34708__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__34708__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__34708__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__34710 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__34709 = (0);
while(true){
if((i__34709 < size__5502__auto__)){
var vec__34711 = cljs.core._nth(c__5501__auto__,i__34709);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34711,(0),null);
var ds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34711,(1),null);
cljs.core.chunk_append(b__34710,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.datasets.dataset_list_item,id,ds,active_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__34791 = (i__34709 + (1));
i__34709 = G__34791;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__34710),bb_web_ds_tools$views$datasets$dataset_list_$_iter__34707(cljs.core.chunk_rest(s__34708__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__34710),null);
}
} else {
var vec__34714 = cljs.core.first(s__34708__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34714,(0),null);
var ds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34714,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.datasets.dataset_list_item,id,ds,active_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),bb_web_ds_tools$views$datasets$dataset_list_$_iter__34707(cljs.core.rest(s__34708__$2)));
}
} else {
return null;
}
...
return (function (){
var map__34717 = cljs.core.deref(state_sub);
var map__34717__$1 = cljs.core.__destructure_map(map__34717);
var active_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34717__$1,new cljs.core.Keyword(null,"active-id","active-id",-59238656));
var active_dataset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34717__$1,new cljs.core.Keyword(null,"active-dataset","active-dataset",771380472));
