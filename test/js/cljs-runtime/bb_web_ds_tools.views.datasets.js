...
var len__5749__auto___43807 = arguments.length;
var i__5750__auto___43808 = (0);
while(true){
if((i__5750__auto___43808 < len__5749__auto___43807)){
args__5755__auto__.push((arguments[i__5750__auto___43808]));

var G__43809 = (i__5750__auto___43808 + (1));
i__5750__auto___43808 = G__43809;
continue;
} else {
}
break;
...
/** @this {Function} */
(bb_web_ds_tools.views.datasets.deep_merge.cljs$lang$applyTo = (function (seq43572){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq43572));
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"datasets","datasets",1896364419)], null),(function (p1__43620_SHARP_){
return bb_web_ds_tools.views.datasets.deep_merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__43620_SHARP_,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"items","items",1031954938),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"new-dataset-state","new-dataset-state",1109324301),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"name","name",1843675177),"New Dataset",new cljs.core.Keyword(null,"text","text",-1790561697),"",new cljs.core.Keyword(null,"format","format",-1306924766),new cljs.core.Keyword(null,"csv","csv",-1164440893),new cljs.core.Keyword(null,"structure","structure",1563832083),new cljs.core.Keyword(null,"columnar","columnar",-1122999701)], null)], null)], 0));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","set-active-dataset-id","bb-web-ds-tools.views.datasets/set-active-dataset-id",1361188762),(function (db,p__43633){
var vec__43634 = p__43633;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43634,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43634,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-new-dataset-state","bb-web-ds-tools.views.datasets/update-new-dataset-state",-1930125405),(function (db,p__43646){
var vec__43647 = p__43646;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43647,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43647,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43647,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","add-dataset","bb-web-ds-tools.views.datasets/add-dataset",1462625692),(function (db,p__43655){
var vec__43656 = p__43655;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43656,(0),null);
var map__43659 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43656,(1),null);
var map__43659__$1 = cljs.core.__destructure_map(map__43659);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43659__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43659__$1,new cljs.core.Keyword(null,"data","data",-232669377));
...
var data_with_ids = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__43651_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__43651_SHARP_,new cljs.core.Keyword(null,"_uuid","_uuid",797900280),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.random_uuid()));
}),valid_data);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","delete-dataset","bb-web-ds-tools.views.datasets/delete-dataset",243110744),(function (db,p__43672){
var vec__43673 = p__43672;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43673,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43673,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-dataset-name","bb-web-ds-tools.views.datasets/update-dataset-name",798576715),(function (db,p__43676){
var vec__43677 = p__43676;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43677,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43677,(1),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43677,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),(function (db,p__43680){
var vec__43681 = p__43680;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43681,(0),null);
var dataset_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43681,(1),null);
var row_uuid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43681,(2),null);
var col_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43681,(3),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43681,(4),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),(function (db,p__43684){
...
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43685,(2),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43685,(3),null);
...
});})(i__43692,col,c__5501__auto__,size__5502__auto__,b__43693,s__43691__$2,temp__5825__auto__))
...
return (function (){
var map__43705 = cljs.core.deref(state);
var map__43705__$1 = cljs.core.__destructure_map(map__43705);
var fmt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43705__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var name_val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43705__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43705__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var structure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43705__$1,new cljs.core.Keyword(null,"structure","structure",1563832083));
...
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_col,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"h-full space-y-4 p-4"], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"justify-between items-center"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3","h3",2067611163),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),["text-xl font-bold ",bb_web_ds_tools.theme.text_accent].join('')], null),"Create New Dataset"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"space-x-2"], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$importer_view_$_iter__43706(s__43707){
return (new cljs.core.LazySeq(null,(function (){
var s__43707__$1 = s__43707;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__43707__$1);
if(temp__5825__auto__){
var s__43707__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__43707__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__43707__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__43709 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__43708 = (0);
while(true){
if((i__43708 < size__5502__auto__)){
var f = cljs.core._nth(c__5501__auto__,i__43708);
cljs.core.chunk_append(b__43709,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),f,new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(fmt,f))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):""),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__43708,f,c__5501__auto__,size__5502__auto__,b__43709,s__43707__$2,temp__5825__auto__,map__43705,map__43705__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state){
return (function (){
set_state(new cljs.core.Keyword(null,"format","format",-1306924766),f);

if(cljs.core.truth_((function (){var fexpr__43711 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"markdown","markdown",1227225089),null,new cljs.core.Keyword(null,"csv","csv",-1164440893),null,new cljs.core.Keyword(null,"tsv","tsv",-1254214356),null], null), null);
return (fexpr__43711.cljs$core$IFn$_invoke$arity$1 ? fexpr__43711.cljs$core$IFn$_invoke$arity$1(f) : fexpr__43711.call(null,f));
})())){
...
});})(i__43708,f,c__5501__auto__,size__5502__auto__,b__43709,s__43707__$2,temp__5825__auto__,map__43705,map__43705__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43709),bb_web_ds_tools$views$datasets$importer_view_$_iter__43706(cljs.core.chunk_rest(s__43707__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43709),null);
}
} else {
var f = cljs.core.first(s__43707__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),f,new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(fmt,f))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):""),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (f,s__43707__$2,temp__5825__auto__,map__43705,map__43705__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state){
return (function (){
set_state(new cljs.core.Keyword(null,"format","format",-1306924766),f);

if(cljs.core.truth_((function (){var fexpr__43716 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"markdown","markdown",1227225089),null,new cljs.core.Keyword(null,"csv","csv",-1164440893),null,new cljs.core.Keyword(null,"tsv","tsv",-1254214356),null], null), null);
return (fexpr__43716.cljs$core$IFn$_invoke$arity$1 ? fexpr__43716.cljs$core$IFn$_invoke$arity$1(f) : fexpr__43716.call(null,f));
})())){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),new cljs.core.Keyword(null,"columnar","columnar",-1122999701));
} else {
return null;
}
});})(f,s__43707__$2,temp__5825__auto__,map__43705,map__43705__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state))
], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"markdown","markdown",1227225089)))?"MD":clojure.string.upper_case(cljs.core.name(f)))], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__43706(cljs.core.rest(s__43707__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43723),bb_web_ds_tools$views$datasets$importer_view_$_iter__43720(cljs.core.chunk_rest(s__43721__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43723),null);
}
} else {
var s = cljs.core.first(s__43721__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"key","key",-1516042587),s,new cljs.core.Keyword(null,"disabled","disabled",-1529784218),(!(cljs.core.contains_QMARK_(supported_structures,s))),new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(structure__$1,s))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):(((!(cljs.core.contains_QMARK_(supported_structures,s))))?"opacity-50 cursor-not-allowed":"")),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (s,s__43721__$2,temp__5825__auto__,map__43705,map__43705__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state){
return (function (){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),s);
});})(s,s__43721__$2,temp__5825__auto__,map__43705,map__43705__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state))
], null),cljs.core.get.cljs$core$IFn$_invoke$arity$2(struct_labels,s)], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__43720(cljs.core.rest(s__43721__$2)));
}
} else {
return null;
}
...
var map__43736 = dataset;
var map__43736__$1 = cljs.core.__destructure_map(map__43736);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43736__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43736__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43736__$1,new cljs.core.Keyword(null,"columns","columns",1998437288));
var view_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43736__$1,new cljs.core.Keyword(null,"view-state","view-state",-976675614));
var map__43737 = view_state;
var map__43737__$1 = cljs.core.__destructure_map(map__43737);
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43737__$1,new cljs.core.Keyword(null,"page","page",849072397));
var rows_per_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43737__$1,new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959));
var filters = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43737__$1,new cljs.core.Keyword(null,"filters","filters",974726919));
var hidden_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43737__$1,new cljs.core.Keyword(null,"hidden-columns","hidden-columns",-1045524800));
var sort_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43737__$1,new cljs.core.Keyword(null,"sort-col","sort-col",-718754882));
var sort_dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43737__$1,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757));
var map__43738 = bb_web_ds_tools.utils.dataset_processing.process_table_data(data,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(view_state,new cljs.core.Keyword(null,"columns","columns",1998437288),columns));
var map__43738__$1 = cljs.core.__destructure_map(map__43738);
var page_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43738__$1,new cljs.core.Keyword(null,"page-data","page-data",1443840710));
var total_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43738__$1,new cljs.core.Keyword(null,"total-rows","total-rows",1745495528));
var start_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43738__$1,new cljs.core.Keyword(null,"start-idx","start-idx",-1600773745));
var end_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43738__$1,new cljs.core.Keyword(null,"end-idx","end-idx",-85750788));
var visible_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43738__$1,new cljs.core.Keyword(null,"visible-columns","visible-columns",1134718660));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_col,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"space-y-4 p-4"], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),["flex-wrap gap-4 items-end ",bb_web_ds_tools.theme.bg_toolbar," p-2 rounded shadow-sm"].join('')], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.label,"Rows"], null),new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.select,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),"py-1",new cljs.core.Keyword(null,"value","value",305978217),rows_per_page,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__43733_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959),parseInt(p1__43733_SHARP_.target.value)], null));
...
var col = cljs.core._nth(c__5501__auto__,i__43743);
cljs.core.chunk_append(b__43744,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.th,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["cursor-pointer ",bb_web_ds_tools.theme.bg_item_hover].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__43743,col,c__5501__auto__,size__5502__auto__,b__43744,s__43742__$2,temp__5825__auto__,map__43736,map__43736__$1,id,data,columns,view_state,map__43737,map__43737__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43738,map__43738__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
...
});})(i__43743,col,c__5501__auto__,size__5502__auto__,b__43744,s__43742__$2,temp__5825__auto__,map__43736,map__43736__$1,id,data,columns,view_state,map__43737,map__43737__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43738,map__43738__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43744),bb_web_ds_tools$views$datasets$data_table_$_iter__43741(cljs.core.chunk_rest(s__43742__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43744),null);
}
} else {
var col = cljs.core.first(s__43742__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.th,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["cursor-pointer ",bb_web_ds_tools.theme.bg_item_hover].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (col,s__43742__$2,temp__5825__auto__,map__43736,map__43736__$1,id,data,columns,view_state,map__43737,map__43737__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43738,map__43738__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
var new_dir = ((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_col,col)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))))?new cljs.core.Keyword(null,"desc","desc",2093485764):new cljs.core.Keyword(null,"asc","asc",356854569));
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"sort-col","sort-col",-718754882),col], null));

return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757),new_dir], null));
});})(col,s__43742__$2,temp__5825__auto__,map__43736,map__43736__$1,id,data,columns,view_state,map__43737,map__43737__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43738,map__43738__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex items-center space-x-1"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),cljs.core.name(col)], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_col,col))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-[10px] transform translate-y-px"], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))?"\u25B2":"\u25BC")], null):null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__43741(cljs.core.rest(s__43742__$2)));
}
} else {
return null;
}
...
})()], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tbody,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__43747(s__43748){
return (new cljs.core.LazySeq(null,(function (){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43750),bb_web_ds_tools$views$datasets$data_table_$_iter__43747(cljs.core.chunk_rest(s__43748__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43750),null);
}
} else {
var col = cljs.core.first(s__43748__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),["filter-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(col)].join(''),new cljs.core.Keyword(null,"class","class",-2030961996),"px-3 py-1.5"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-sm",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),["Filter ",cljs.core.name(col)].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(filters,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__43748__$2,temp__5825__auto__,map__43736,map__43736__$1,id,data,columns,view_state,map__43737,map__43737__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43738,map__43738__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__43734_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"filters","filters",974726919),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(filters,col,p1__43734_SHARP_.target.value)], null));
});})(col,s__43748__$2,temp__5825__auto__,map__43736,map__43736__$1,id,data,columns,view_state,map__43737,map__43737__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43738,map__43738__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__43747(cljs.core.rest(s__43748__$2)));
}
} else {
return null;
}
...
return iter__5503__auto__(visible_columns);
})()], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__43751(s__43752){
return (new cljs.core.LazySeq(null,(function (){
...
var row = cljs.core._nth(c__5501__auto__,i__43753);
cljs.core.chunk_append(b__43754,(function (){var row_uuid = new cljs.core.Keyword(null,"_uuid","_uuid",797900280).cljs$core$IFn$_invoke$arity$1(row);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row_uuid], null),(function (){var iter__5503__auto__ = ((function (i__43753,row_uuid,row,c__5501__auto__,size__5502__auto__,b__43754,s__43752__$2,temp__5825__auto__,map__43736,map__43736__$1,id,data,columns,view_state,map__43737,map__43737__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43738,map__43738__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function bb_web_ds_tools$views$datasets$data_table_$_iter__43751_$_iter__43759(s__43760){
return (new cljs.core.LazySeq(null,((function (i__43753,row_uuid,row,c__5501__auto__,size__5502__auto__,b__43754,s__43752__$2,temp__5825__auto__,map__43736,map__43736__$1,id,data,columns,view_state,map__43737,map__43737__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43738,map__43738__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
var s__43760__$1 = s__43760;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__43760__$1);
if(temp__5825__auto____$1){
var s__43760__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__43760__$2)){
var c__5501__auto____$1 = cljs.core.chunk_first(s__43760__$2);
var size__5502__auto____$1 = cljs.core.count(c__5501__auto____$1);
var b__43762 = cljs.core.chunk_buffer(size__5502__auto____$1);
if((function (){var i__43761 = (0);
while(true){
if((i__43761 < size__5502__auto____$1)){
var col = cljs.core._nth(c__5501__auto____$1,i__43761);
cljs.core.chunk_append(b__43762,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__43761,i__43753,col,c__5501__auto____$1,size__5502__auto____$1,b__43762,s__43760__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__43754,s__43752__$2,temp__5825__auto__,map__43736,map__43736__$1,id,data,columns,view_state,map__43737,map__43737__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43738,map__43738__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__43735_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__43735_SHARP_.target.value], null));
});})(i__43761,i__43753,col,c__5501__auto____$1,size__5502__auto____$1,b__43762,s__43760__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__43754,s__43752__$2,temp__5825__auto__,map__43736,map__43736__$1,id,data,columns,view_state,map__43737,map__43737__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43738,map__43738__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__43832 = (i__43761 + (1));
i__43761 = G__43832;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43762),bb_web_ds_tools$views$datasets$data_table_$_iter__43751_$_iter__43759(cljs.core.chunk_rest(s__43760__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43762),null);
}
} else {
var col = cljs.core.first(s__43760__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__43753,col,s__43760__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__43754,s__43752__$2,temp__5825__auto__,map__43736,map__43736__$1,id,data,columns,view_state,map__43737,map__43737__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43738,map__43738__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__43735_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__43735_SHARP_.target.value], null));
});})(i__43753,col,s__43760__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__43754,s__43752__$2,temp__5825__auto__,map__43736,map__43736__$1,id,data,columns,view_state,map__43737,map__43737__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43738,map__43738__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__43751_$_iter__43759(cljs.core.rest(s__43760__$2)));
}
} else {
return null;
}
...
});})(i__43753,row_uuid,row,c__5501__auto__,size__5502__auto__,b__43754,s__43752__$2,temp__5825__auto__,map__43736,map__43736__$1,id,data,columns,view_state,map__43737,map__43737__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43738,map__43738__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
,null,null));
});})(i__43753,row_uuid,row,c__5501__auto__,size__5502__auto__,b__43754,s__43752__$2,temp__5825__auto__,map__43736,map__43736__$1,id,data,columns,view_state,map__43737,map__43737__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43738,map__43738__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
;
return iter__5503__auto__(visible_columns);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43754),bb_web_ds_tools$views$datasets$data_table_$_iter__43751(cljs.core.chunk_rest(s__43752__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43754),null);
}
} else {
var row = cljs.core.first(s__43752__$2);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row_uuid], null),(function (){var iter__5503__auto__ = ((function (row_uuid,row,s__43752__$2,temp__5825__auto__,map__43736,map__43736__$1,id,data,columns,view_state,map__43737,map__43737__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43738,map__43738__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function bb_web_ds_tools$views$datasets$data_table_$_iter__43751_$_iter__43767(s__43768){
return (new cljs.core.LazySeq(null,(function (){
var s__43768__$1 = s__43768;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__43768__$1);
if(temp__5825__auto____$1){
var s__43768__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__43768__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__43768__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__43770 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__43769 = (0);
while(true){
if((i__43769 < size__5502__auto__)){
var col = cljs.core._nth(c__5501__auto__,i__43769);
cljs.core.chunk_append(b__43770,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__43769,col,c__5501__auto__,size__5502__auto__,b__43770,s__43768__$2,temp__5825__auto____$1,row_uuid,row,s__43752__$2,temp__5825__auto__,map__43736,map__43736__$1,id,data,columns,view_state,map__43737,map__43737__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43738,map__43738__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__43735_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__43735_SHARP_.target.value], null));
});})(i__43769,col,c__5501__auto__,size__5502__auto__,b__43770,s__43768__$2,temp__5825__auto____$1,row_uuid,row,s__43752__$2,temp__5825__auto__,map__43736,map__43736__$1,id,data,columns,view_state,map__43737,map__43737__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43738,map__43738__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__43835 = (i__43769 + (1));
i__43769 = G__43835;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43770),bb_web_ds_tools$views$datasets$data_table_$_iter__43751_$_iter__43767(cljs.core.chunk_rest(s__43768__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43770),null);
}
} else {
var col = cljs.core.first(s__43768__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__43768__$2,temp__5825__auto____$1,row_uuid,row,s__43752__$2,temp__5825__auto__,map__43736,map__43736__$1,id,data,columns,view_state,map__43737,map__43737__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43738,map__43738__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__43735_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__43735_SHARP_.target.value], null));
});})(col,s__43768__$2,temp__5825__auto____$1,row_uuid,row,s__43752__$2,temp__5825__auto__,map__43736,map__43736__$1,id,data,columns,view_state,map__43737,map__43737__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43738,map__43738__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__43751_$_iter__43767(cljs.core.rest(s__43768__$2)));
}
} else {
return null;
}
...
});})(row_uuid,row,s__43752__$2,temp__5825__auto__,map__43736,map__43736__$1,id,data,columns,view_state,map__43737,map__43737__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43738,map__43738__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
;
return iter__5503__auto__(visible_columns);
})()], null);
})(),bb_web_ds_tools$views$datasets$data_table_$_iter__43751(cljs.core.rest(s__43752__$2)));
}
} else {
return null;
}
...
return (function (){
var map__43784 = cljs.core.deref(state_sub);
var map__43784__$1 = cljs.core.__destructure_map(map__43784);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43784__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var active_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43784__$1,new cljs.core.Keyword(null,"active-id","active-id",-59238656));
...
})], null),"+ New Dataset"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex-grow overflow-y-auto p-2 space-y-1"], null),((cljs.core.seq(items))?(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$dataset_list_$_iter__43785(s__43786){
return (new cljs.core.LazySeq(null,(function (){
var s__43786__$1 = s__43786;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__43786__$1);
if(temp__5825__auto__){
var s__43786__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__43786__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__43786__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__43788 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__43787 = (0);
while(true){
if((i__43787 < size__5502__auto__)){
var vec__43789 = cljs.core._nth(c__5501__auto__,i__43787);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43789,(0),null);
var ds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43789,(1),null);
cljs.core.chunk_append(b__43788,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.datasets.dataset_list_item,id,ds,active_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__43841 = (i__43787 + (1));
i__43787 = G__43841;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43788),bb_web_ds_tools$views$datasets$dataset_list_$_iter__43785(cljs.core.chunk_rest(s__43786__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43788),null);
}
} else {
var vec__43793 = cljs.core.first(s__43786__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43793,(0),null);
var ds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43793,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.datasets.dataset_list_item,id,ds,active_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),bb_web_ds_tools$views$datasets$dataset_list_$_iter__43785(cljs.core.rest(s__43786__$2)));
}
} else {
return null;
}
...
var active_dataset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43798__$1,new cljs.core.Keyword(null,"active-dataset","active-dataset",771380472));
