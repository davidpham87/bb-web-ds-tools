...
/** @this {Function} */
(bb_web_ds_tools.views.datasets.deep_merge.cljs$lang$applyTo = (function (seq43547){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq43547));
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"datasets","datasets",1896364419)], null),(function (p1__43561_SHARP_){
return bb_web_ds_tools.views.datasets.deep_merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__43561_SHARP_,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"items","items",1031954938),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"new-dataset-state","new-dataset-state",1109324301),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"name","name",1843675177),"New Dataset",new cljs.core.Keyword(null,"text","text",-1790561697),"",new cljs.core.Keyword(null,"format","format",-1306924766),new cljs.core.Keyword(null,"csv","csv",-1164440893),new cljs.core.Keyword(null,"structure","structure",1563832083),new cljs.core.Keyword(null,"columnar","columnar",-1122999701)], null)], null)], 0));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","set-active-dataset-id","bb-web-ds-tools.views.datasets/set-active-dataset-id",1361188762),(function (db,p__43603){
var vec__43605 = p__43603;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43605,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43605,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-new-dataset-state","bb-web-ds-tools.views.datasets/update-new-dataset-state",-1930125405),(function (db,p__43611){
var vec__43614 = p__43611;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43614,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43614,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43614,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","add-dataset","bb-web-ds-tools.views.datasets/add-dataset",1462625692),(function (db,p__43624){
var vec__43626 = p__43624;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43626,(0),null);
...
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43629__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43629__$1,new cljs.core.Keyword(null,"data","data",-232669377));
...
var data_with_ids = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__43620_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__43620_SHARP_,new cljs.core.Keyword(null,"_uuid","_uuid",797900280),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.random_uuid()));
}),valid_data);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","delete-dataset","bb-web-ds-tools.views.datasets/delete-dataset",243110744),(function (db,p__43654){
var vec__43655 = p__43654;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43655,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43655,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-dataset-name","bb-web-ds-tools.views.datasets/update-dataset-name",798576715),(function (db,p__43665){
var vec__43667 = p__43665;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43667,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43667,(1),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43667,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),(function (db,p__43674){
var vec__43675 = p__43674;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43675,(0),null);
var dataset_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43675,(1),null);
var row_uuid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43675,(2),null);
var col_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43675,(3),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43675,(4),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),(function (db,p__43695){
var vec__43696 = p__43695;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43696,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43696,(1),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43696,(2),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43696,(3),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","fetch-vega-datasets","bb-web-ds-tools.views.datasets/fetch-vega-datasets",202932363),(function (p__43702,_){
var map__43703 = p__43702;
var map__43703__$1 = cljs.core.__destructure_map(map__43703);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43703__$1,new cljs.core.Keyword(null,"db","db",993250759));
fetch("https://cdn.jsdelivr.net/npm/vega-datasets/data/").then((function (p1__43699_SHARP_){
return p1__43699_SHARP_.text();
})).then((function (p1__43700_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","receive-vega-datasets","bb-web-ds-tools.views.datasets/receive-vega-datasets",-736628262),p1__43700_SHARP_], null));
})).catch((function (p1__43701_SHARP_){
return console.error("Failed to fetch vega datasets list",p1__43701_SHARP_);
}));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","receive-vega-datasets","bb-web-ds-tools.views.datasets/receive-vega-datasets",-736628262),(function (db,p__43706){
var vec__43707 = p__43706;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43707,(0),null);
var html_content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43707,(1),null);
...
var filenames = cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.sort.cljs$core$IFn$_invoke$arity$1(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__43705_SHARP_){
return cljs.core.re_find(/\.(json|csv|tsv|md)$/,p1__43705_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43704_SHARP_){
return p1__43704_SHARP_.innerText;
}),links))));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","fetch-vega-dataset","bb-web-ds-tools.views.datasets/fetch-vega-dataset",1814090652),(function (p__43721,p__43722){
var map__43723 = p__43721;
var map__43723__$1 = cljs.core.__destructure_map(map__43723);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43723__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__43724 = p__43722;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43724,(0),null);
var filename = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43724,(1),null);
var url = ["https://cdn.jsdelivr.net/npm/vega-datasets@3/data/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(filename)].join('');
fetch(url).then((function (p1__43718_SHARP_){
return p1__43718_SHARP_.text();
})).then((function (p1__43719_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","receive-vega-dataset-content","bb-web-ds-tools.views.datasets/receive-vega-dataset-content",-385162532),filename,p1__43719_SHARP_], null));
})).catch((function (p1__43720_SHARP_){
return console.error("Failed to fetch vega dataset",p1__43720_SHARP_);
}));

return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"db","db",993250759),cljs.core.assoc_in(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","datasets","bb-web-ds-tools.views.datasets/datasets",-1461208347),new cljs.core.Keyword(null,"loading-vega-dataset?","loading-vega-dataset?",-1002270211)], null),true)], null);
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","receive-vega-dataset-content","bb-web-ds-tools.views.datasets/receive-vega-dataset-content",-385162532),(function (db,p__43727){
var vec__43728 = p__43727;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43728,(0),null);
var filename = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43728,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43728,(2),null);
var extension = cljs.core.last(clojure.string.split.cljs$core$IFn$_invoke$arity$2(filename,/\./));
var format = (function (){var G__43733 = extension;
switch (G__43733) {
case "json":
...
});})(i__43737,col,c__5501__auto__,size__5502__auto__,b__43738,s__43736__$2,temp__5825__auto__))
...
return (function (){
var map__43750 = cljs.core.deref(state);
var map__43750__$1 = cljs.core.__destructure_map(map__43750);
var fmt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43750__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var name_val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43750__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43750__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var structure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43750__$1,new cljs.core.Keyword(null,"structure","structure",1563832083));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43754),bb_web_ds_tools$views$datasets$importer_view_$_iter__43751(cljs.core.chunk_rest(s__43752__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43754),null);
}
} else {
var ds = cljs.core.first(s__43752__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),ds,new cljs.core.Keyword(null,"value","value",305978217),ds], null),ds], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__43751(cljs.core.rest(s__43752__$2)));
}
} else {
return null;
}
...
})()], null))], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"space-x-2"], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$importer_view_$_iter__43755(s__43756){
return (new cljs.core.LazySeq(null,(function (){
var s__43756__$1 = s__43756;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__43756__$1);
if(temp__5825__auto__){
var s__43756__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__43756__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__43756__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__43758 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__43757 = (0);
while(true){
if((i__43757 < size__5502__auto__)){
var f = cljs.core._nth(c__5501__auto__,i__43757);
cljs.core.chunk_append(b__43758,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),f,new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(fmt,f))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):""),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__43757,f,c__5501__auto__,size__5502__auto__,b__43758,s__43756__$2,temp__5825__auto__,map__43750,map__43750__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_){
return (function (){
set_state(new cljs.core.Keyword(null,"format","format",-1306924766),f);

if(cljs.core.truth_((function (){var fexpr__43760 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"markdown","markdown",1227225089),null,new cljs.core.Keyword(null,"csv","csv",-1164440893),null,new cljs.core.Keyword(null,"tsv","tsv",-1254214356),null], null), null);
return (fexpr__43760.cljs$core$IFn$_invoke$arity$1 ? fexpr__43760.cljs$core$IFn$_invoke$arity$1(f) : fexpr__43760.call(null,f));
})())){
...
});})(i__43757,f,c__5501__auto__,size__5502__auto__,b__43758,s__43756__$2,temp__5825__auto__,map__43750,map__43750__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43758),bb_web_ds_tools$views$datasets$importer_view_$_iter__43755(cljs.core.chunk_rest(s__43756__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43758),null);
}
} else {
var f = cljs.core.first(s__43756__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),f,new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(fmt,f))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):""),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (f,s__43756__$2,temp__5825__auto__,map__43750,map__43750__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_){
return (function (){
set_state(new cljs.core.Keyword(null,"format","format",-1306924766),f);

if(cljs.core.truth_((function (){var fexpr__43768 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"markdown","markdown",1227225089),null,new cljs.core.Keyword(null,"csv","csv",-1164440893),null,new cljs.core.Keyword(null,"tsv","tsv",-1254214356),null], null), null);
return (fexpr__43768.cljs$core$IFn$_invoke$arity$1 ? fexpr__43768.cljs$core$IFn$_invoke$arity$1(f) : fexpr__43768.call(null,f));
})())){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),new cljs.core.Keyword(null,"columnar","columnar",-1122999701));
} else {
return null;
}
});})(f,s__43756__$2,temp__5825__auto__,map__43750,map__43750__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_))
], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"markdown","markdown",1227225089)))?"MD":clojure.string.upper_case(cljs.core.name(f)))], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__43755(cljs.core.rest(s__43756__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43772),bb_web_ds_tools$views$datasets$importer_view_$_iter__43769(cljs.core.chunk_rest(s__43770__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43772),null);
}
} else {
var s = cljs.core.first(s__43770__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"key","key",-1516042587),s,new cljs.core.Keyword(null,"disabled","disabled",-1529784218),(!(cljs.core.contains_QMARK_(supported_structures,s))),new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(structure__$1,s))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):(((!(cljs.core.contains_QMARK_(supported_structures,s))))?"opacity-50 cursor-not-allowed":"")),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (s,s__43770__$2,temp__5825__auto__,map__43750,map__43750__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_){
return (function (){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),s);
});})(s,s__43770__$2,temp__5825__auto__,map__43750,map__43750__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_))
], null),cljs.core.get.cljs$core$IFn$_invoke$arity$2(struct_labels,s)], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__43769(cljs.core.rest(s__43770__$2)));
}
} else {
return null;
}
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43788__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43788__$1,new cljs.core.Keyword(null,"columns","columns",1998437288));
var view_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43788__$1,new cljs.core.Keyword(null,"view-state","view-state",-976675614));
var map__43789 = view_state;
var map__43789__$1 = cljs.core.__destructure_map(map__43789);
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43789__$1,new cljs.core.Keyword(null,"page","page",849072397));
var rows_per_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43789__$1,new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959));
var filters = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43789__$1,new cljs.core.Keyword(null,"filters","filters",974726919));
var hidden_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43789__$1,new cljs.core.Keyword(null,"hidden-columns","hidden-columns",-1045524800));
var sort_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43789__$1,new cljs.core.Keyword(null,"sort-col","sort-col",-718754882));
var sort_dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43789__$1,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757));
var map__43790 = bb_web_ds_tools.utils.dataset_processing.process_table_data(data,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(view_state,new cljs.core.Keyword(null,"columns","columns",1998437288),columns));
var map__43790__$1 = cljs.core.__destructure_map(map__43790);
var page_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43790__$1,new cljs.core.Keyword(null,"page-data","page-data",1443840710));
var total_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43790__$1,new cljs.core.Keyword(null,"total-rows","total-rows",1745495528));
var start_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43790__$1,new cljs.core.Keyword(null,"start-idx","start-idx",-1600773745));
var end_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43790__$1,new cljs.core.Keyword(null,"end-idx","end-idx",-85750788));
var visible_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43790__$1,new cljs.core.Keyword(null,"visible-columns","visible-columns",1134718660));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_col,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"space-y-4 p-4"], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),["flex-wrap gap-4 items-end ",bb_web_ds_tools.theme.bg_toolbar," p-2 rounded shadow-sm"].join('')], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.label,"Rows"], null),new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.select,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),"py-1",new cljs.core.Keyword(null,"value","value",305978217),rows_per_page,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__43778_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959),parseInt(p1__43778_SHARP_.target.value)], null));
...
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"page","page",849072397),(page + (1))], null));
}),new cljs.core.Keyword(null,"disabled","disabled",-1529784218),(end_idx >= total_rows)], null),"Next"], null)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.table_container,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.table,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.thead,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__43797(s__43798){
return (new cljs.core.LazySeq(null,(function (){
var s__43798__$1 = s__43798;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__43798__$1);
if(temp__5825__auto__){
var s__43798__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__43798__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__43798__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__43800 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__43799 = (0);
while(true){
if((i__43799 < size__5502__auto__)){
var col = cljs.core._nth(c__5501__auto__,i__43799);
cljs.core.chunk_append(b__43800,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.th,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["cursor-pointer ",bb_web_ds_tools.theme.bg_item_hover].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__43799,col,c__5501__auto__,size__5502__auto__,b__43800,s__43798__$2,temp__5825__auto__,map__43788,map__43788__$1,id,data,columns,view_state,map__43789,map__43789__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43790,map__43790__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
...
});})(i__43799,col,c__5501__auto__,size__5502__auto__,b__43800,s__43798__$2,temp__5825__auto__,map__43788,map__43788__$1,id,data,columns,view_state,map__43789,map__43789__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43790,map__43790__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43800),bb_web_ds_tools$views$datasets$data_table_$_iter__43797(cljs.core.chunk_rest(s__43798__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43800),null);
}
} else {
var col = cljs.core.first(s__43798__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.th,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["cursor-pointer ",bb_web_ds_tools.theme.bg_item_hover].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (col,s__43798__$2,temp__5825__auto__,map__43788,map__43788__$1,id,data,columns,view_state,map__43789,map__43789__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43790,map__43790__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
var new_dir = ((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_col,col)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))))?new cljs.core.Keyword(null,"desc","desc",2093485764):new cljs.core.Keyword(null,"asc","asc",356854569));
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"sort-col","sort-col",-718754882),col], null));

return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757),new_dir], null));
});})(col,s__43798__$2,temp__5825__auto__,map__43788,map__43788__$1,id,data,columns,view_state,map__43789,map__43789__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43790,map__43790__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex items-center space-x-1"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),cljs.core.name(col)], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_col,col))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-[10px] transform translate-y-px"], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))?"\u25B2":"\u25BC")], null):null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__43797(cljs.core.rest(s__43798__$2)));
}
} else {
return null;
}
...
})()], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tbody,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__43811(s__43812){
return (new cljs.core.LazySeq(null,(function (){
var s__43812__$1 = s__43812;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__43812__$1);
if(temp__5825__auto__){
var s__43812__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__43812__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__43812__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__43814 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__43813 = (0);
while(true){
if((i__43813 < size__5502__auto__)){
var col = cljs.core._nth(c__5501__auto__,i__43813);
cljs.core.chunk_append(b__43814,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),["filter-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(col)].join(''),new cljs.core.Keyword(null,"class","class",-2030961996),"px-3 py-1.5"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-sm",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),["Filter ",cljs.core.name(col)].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(filters,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__43813,col,c__5501__auto__,size__5502__auto__,b__43814,s__43812__$2,temp__5825__auto__,map__43788,map__43788__$1,id,data,columns,view_state,map__43789,map__43789__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43790,map__43790__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__43786_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"filters","filters",974726919),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(filters,col,p1__43786_SHARP_.target.value)], null));
});})(i__43813,col,c__5501__auto__,size__5502__auto__,b__43814,s__43812__$2,temp__5825__auto__,map__43788,map__43788__$1,id,data,columns,view_state,map__43789,map__43789__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43790,map__43790__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__43990 = (i__43813 + (1));
i__43813 = G__43990;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43814),bb_web_ds_tools$views$datasets$data_table_$_iter__43811(cljs.core.chunk_rest(s__43812__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43814),null);
}
} else {
var col = cljs.core.first(s__43812__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),["filter-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(col)].join(''),new cljs.core.Keyword(null,"class","class",-2030961996),"px-3 py-1.5"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-sm",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),["Filter ",cljs.core.name(col)].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(filters,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__43812__$2,temp__5825__auto__,map__43788,map__43788__$1,id,data,columns,view_state,map__43789,map__43789__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43790,map__43790__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__43786_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"filters","filters",974726919),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(filters,col,p1__43786_SHARP_.target.value)], null));
});})(col,s__43812__$2,temp__5825__auto__,map__43788,map__43788__$1,id,data,columns,view_state,map__43789,map__43789__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43790,map__43790__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__43811(cljs.core.rest(s__43812__$2)));
}
} else {
return null;
}
...
return iter__5503__auto__(visible_columns);
})()], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__43817(s__43818){
return (new cljs.core.LazySeq(null,(function (){
var s__43818__$1 = s__43818;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__43818__$1);
if(temp__5825__auto__){
var s__43818__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__43818__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__43818__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__43820 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__43819 = (0);
while(true){
if((i__43819 < size__5502__auto__)){
var row = cljs.core._nth(c__5501__auto__,i__43819);
cljs.core.chunk_append(b__43820,(function (){var row_uuid = new cljs.core.Keyword(null,"_uuid","_uuid",797900280).cljs$core$IFn$_invoke$arity$1(row);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row_uuid], null),(function (){var iter__5503__auto__ = ((function (i__43819,row_uuid,row,c__5501__auto__,size__5502__auto__,b__43820,s__43818__$2,temp__5825__auto__,map__43788,map__43788__$1,id,data,columns,view_state,map__43789,map__43789__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43790,map__43790__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function bb_web_ds_tools$views$datasets$data_table_$_iter__43817_$_iter__43822(s__43823){
return (new cljs.core.LazySeq(null,((function (i__43819,row_uuid,row,c__5501__auto__,size__5502__auto__,b__43820,s__43818__$2,temp__5825__auto__,map__43788,map__43788__$1,id,data,columns,view_state,map__43789,map__43789__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43790,map__43790__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
var s__43823__$1 = s__43823;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__43823__$1);
if(temp__5825__auto____$1){
var s__43823__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__43823__$2)){
var c__5501__auto____$1 = cljs.core.chunk_first(s__43823__$2);
var size__5502__auto____$1 = cljs.core.count(c__5501__auto____$1);
var b__43825 = cljs.core.chunk_buffer(size__5502__auto____$1);
if((function (){var i__43824 = (0);
while(true){
if((i__43824 < size__5502__auto____$1)){
var col = cljs.core._nth(c__5501__auto____$1,i__43824);
cljs.core.chunk_append(b__43825,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__43824,i__43819,col,c__5501__auto____$1,size__5502__auto____$1,b__43825,s__43823__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__43820,s__43818__$2,temp__5825__auto__,map__43788,map__43788__$1,id,data,columns,view_state,map__43789,map__43789__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43790,map__43790__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__43787_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__43787_SHARP_.target.value], null));
});})(i__43824,i__43819,col,c__5501__auto____$1,size__5502__auto____$1,b__43825,s__43823__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__43820,s__43818__$2,temp__5825__auto__,map__43788,map__43788__$1,id,data,columns,view_state,map__43789,map__43789__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43790,map__43790__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__44004 = (i__43824 + (1));
i__43824 = G__44004;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43825),bb_web_ds_tools$views$datasets$data_table_$_iter__43817_$_iter__43822(cljs.core.chunk_rest(s__43823__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43825),null);
}
} else {
var col = cljs.core.first(s__43823__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__43819,col,s__43823__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__43820,s__43818__$2,temp__5825__auto__,map__43788,map__43788__$1,id,data,columns,view_state,map__43789,map__43789__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43790,map__43790__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__43787_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__43787_SHARP_.target.value], null));
});})(i__43819,col,s__43823__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__43820,s__43818__$2,temp__5825__auto__,map__43788,map__43788__$1,id,data,columns,view_state,map__43789,map__43789__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43790,map__43790__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__43817_$_iter__43822(cljs.core.rest(s__43823__$2)));
}
} else {
return null;
}
...
});})(i__43819,row_uuid,row,c__5501__auto__,size__5502__auto__,b__43820,s__43818__$2,temp__5825__auto__,map__43788,map__43788__$1,id,data,columns,view_state,map__43789,map__43789__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43790,map__43790__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
,null,null));
});})(i__43819,row_uuid,row,c__5501__auto__,size__5502__auto__,b__43820,s__43818__$2,temp__5825__auto__,map__43788,map__43788__$1,id,data,columns,view_state,map__43789,map__43789__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43790,map__43790__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
;
return iter__5503__auto__(visible_columns);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43820),bb_web_ds_tools$views$datasets$data_table_$_iter__43817(cljs.core.chunk_rest(s__43818__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43820),null);
}
} else {
var row = cljs.core.first(s__43818__$2);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row_uuid], null),(function (){var iter__5503__auto__ = ((function (row_uuid,row,s__43818__$2,temp__5825__auto__,map__43788,map__43788__$1,id,data,columns,view_state,map__43789,map__43789__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43790,map__43790__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function bb_web_ds_tools$views$datasets$data_table_$_iter__43817_$_iter__43828(s__43829){
return (new cljs.core.LazySeq(null,(function (){
var s__43829__$1 = s__43829;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__43829__$1);
if(temp__5825__auto____$1){
var s__43829__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__43829__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__43829__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__43831 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__43830 = (0);
while(true){
if((i__43830 < size__5502__auto__)){
var col = cljs.core._nth(c__5501__auto__,i__43830);
cljs.core.chunk_append(b__43831,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__43830,col,c__5501__auto__,size__5502__auto__,b__43831,s__43829__$2,temp__5825__auto____$1,row_uuid,row,s__43818__$2,temp__5825__auto__,map__43788,map__43788__$1,id,data,columns,view_state,map__43789,map__43789__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43790,map__43790__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__43787_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__43787_SHARP_.target.value], null));
});})(i__43830,col,c__5501__auto__,size__5502__auto__,b__43831,s__43829__$2,temp__5825__auto____$1,row_uuid,row,s__43818__$2,temp__5825__auto__,map__43788,map__43788__$1,id,data,columns,view_state,map__43789,map__43789__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43790,map__43790__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__44008 = (i__43830 + (1));
i__43830 = G__44008;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43831),bb_web_ds_tools$views$datasets$data_table_$_iter__43817_$_iter__43828(cljs.core.chunk_rest(s__43829__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43831),null);
}
} else {
var col = cljs.core.first(s__43829__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__43829__$2,temp__5825__auto____$1,row_uuid,row,s__43818__$2,temp__5825__auto__,map__43788,map__43788__$1,id,data,columns,view_state,map__43789,map__43789__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43790,map__43790__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__43787_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__43787_SHARP_.target.value], null));
});})(col,s__43829__$2,temp__5825__auto____$1,row_uuid,row,s__43818__$2,temp__5825__auto__,map__43788,map__43788__$1,id,data,columns,view_state,map__43789,map__43789__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43790,map__43790__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__43817_$_iter__43828(cljs.core.rest(s__43829__$2)));
}
} else {
return null;
}
...
});})(row_uuid,row,s__43818__$2,temp__5825__auto__,map__43788,map__43788__$1,id,data,columns,view_state,map__43789,map__43789__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__43790,map__43790__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
;
return iter__5503__auto__(visible_columns);
})()], null);
})(),bb_web_ds_tools$views$datasets$data_table_$_iter__43817(cljs.core.rest(s__43818__$2)));
}
} else {
return null;
}
...
return (function (){
var map__43853 = cljs.core.deref(state_sub);
var map__43853__$1 = cljs.core.__destructure_map(map__43853);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43853__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var active_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43853__$1,new cljs.core.Keyword(null,"active-id","active-id",-59238656));
...
})], null),"+ New Dataset"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex-grow overflow-y-auto p-2 space-y-1"], null),((cljs.core.seq(items))?(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$dataset_list_$_iter__43864(s__43865){
return (new cljs.core.LazySeq(null,(function (){
var s__43865__$1 = s__43865;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__43865__$1);
if(temp__5825__auto__){
var s__43865__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__43865__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__43865__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__43867 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__43866 = (0);
while(true){
if((i__43866 < size__5502__auto__)){
var vec__43879 = cljs.core._nth(c__5501__auto__,i__43866);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43879,(0),null);
var ds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43879,(1),null);
cljs.core.chunk_append(b__43867,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.datasets.dataset_list_item,id,ds,active_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__44026 = (i__43866 + (1));
i__43866 = G__44026;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43867),bb_web_ds_tools$views$datasets$dataset_list_$_iter__43864(cljs.core.chunk_rest(s__43865__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43867),null);
}
} else {
var vec__43887 = cljs.core.first(s__43865__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43887,(0),null);
var ds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43887,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.datasets.dataset_list_item,id,ds,active_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),bb_web_ds_tools$views$datasets$dataset_list_$_iter__43864(cljs.core.rest(s__43865__$2)));
}
} else {
return null;
}
...
return (function (){
var map__43894 = cljs.core.deref(state_sub);
var map__43894__$1 = cljs.core.__destructure_map(map__43894);
var active_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43894__$1,new cljs.core.Keyword(null,"active-id","active-id",-59238656));
var active_dataset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43894__$1,new cljs.core.Keyword(null,"active-dataset","active-dataset",771380472));
