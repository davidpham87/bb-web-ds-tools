...
var vec__22177 = cljs.core.first(xs__6385__auto__);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22177,(0),null);
var ns_info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22177,(1),null);
var iterys__5499__auto__ = ((function (s__22170__$1,vec__22177,ns,ns_info,xs__6385__auto__,temp__5825__auto__){
return (function shadow$test$env$get_test_vars_$_iter__22169_$_iter__22171(s__22172){
return (new cljs.core.LazySeq(null,((function (s__22170__$1,vec__22177,ns,ns_info,xs__6385__auto__,temp__5825__auto__){
return (function (){
...
});})(s__22170__$1,vec__22177,ns,ns_info,xs__6385__auto__,temp__5825__auto__))
,null,null));
});})(s__22170__$1,vec__22177,ns,ns_info,xs__6385__auto__,temp__5825__auto__))
;
...
var G__22209 = cljs.core.rest(s__22170__$1);
s__22170__$1 = G__22209;
continue;
}
} else {
return null;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core._PLUS_,(0),(function (){var iter__5503__auto__ = (function shadow$test$env$get_test_count_$_iter__22182(s__22183){
return (new cljs.core.LazySeq(null,(function (){
...
var c__5501__auto__ = cljs.core.chunk_first(s__22183__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__22185 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__22184 = (0);
while(true){
if((i__22184 < size__5502__auto__)){
var map__22186 = cljs.core._nth(c__5501__auto__,i__22184);
...
cljs.core.chunk_append(b__22185,cljs.core.count(vars));

var G__22217 = (i__22184 + (1));
i__22184 = G__22217;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22185),shadow$test$env$get_test_count_$_iter__22182(cljs.core.chunk_rest(s__22183__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22185),null);
}
} else {
var map__22189 = cljs.core.first(s__22183__$2);
var map__22189__$1 = cljs.core.__destructure_map(map__22189);
var test_ns = map__22189__$1;
var vars = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22189__$1,new cljs.core.Keyword(null,"vars","vars",-2046957217));
return cljs.core.cons(cljs.core.count(vars),shadow$test$env$get_test_count_$_iter__22182(cljs.core.rest(s__22183__$2)));
}
} else {
return null;
}
