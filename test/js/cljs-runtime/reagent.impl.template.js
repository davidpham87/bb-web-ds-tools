...
var G__24941 = o;
reagent.impl.template.goog$module$goog$object.set(G__24941,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__24981 = o;
reagent.impl.template.goog$module$goog$object.set(G__24981,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__25259__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__25260__i < G__25260__a.length) {G__25260__a[G__25260__i] = arguments[G__25260__i + 0]; ++G__25260__i;}
  args = new cljs.core.IndexedSeq(G__25260__a,0,null);
} 
return G__25259__delegate.call(this,args);};
G__25259.cljs$lang$maxFixedArity = 0;
G__25259.cljs$lang$applyTo = (function (arglist__25261){
var args = cljs.core.seq(arglist__25261);
return G__25259__delegate(args);
});
...
var G__25018 = props;
var G__25018__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__25018,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__25018);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__25018__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__25021 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__25021,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__25021;
}
})(),id_class);
...
var temp__5825__auto___25271 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___25271)){
var d_25272 = temp__5825__auto___25271;
if((d_25272 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_25272.s}));
} else {
...
var G__25037 = (cljs.core.count(argv) - first_child);
switch (G__25037) {
case (0):
...
var vec__25080 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25080,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25080,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25080,(2),null);
...
var temp__5829__auto___25274 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___25274 == null)){
} else {
var key_25275 = temp__5829__auto___25274;
(jsprops.key = key_25275);
}
...
var temp__5829__auto___25276 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___25276 == null)){
} else {
var key_25277 = temp__5829__auto___25276;
(jsprops.key = key_25277);
}
...
var temp__5829__auto___25281 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___25281 == null)){
} else {
var key_25284 = temp__5829__auto___25281;
(jsprops.key = key_25284);
}
...
var temp__5829__auto___25290 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___25290 == null)){
} else {
var key_25291 = temp__5829__auto___25290;
(jsprops.key = key_25291);
}
...
var temp__5829__auto___25311 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___25311 == null)){
} else {
var key_25312 = temp__5829__auto___25311;
(jsprops.key = key_25312);
}
...
var temp__5829__auto___25313 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___25313 == null)){
} else {
var key_25314 = temp__5829__auto___25313;
(jsprops.key = key_25314);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__25198_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__25198_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__25204 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25204,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25204,(1),null);
...
break;
default:
var G__25319 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__25320 = compiler;
v = G__25319;
compiler = G__25320;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template25224 = (function (opts,id,fn_to_element,parse_fn,meta25225){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta25225 = meta25225;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template25224.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_25226,meta25225__$1){
var self__ = this;
var _25226__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template25224(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta25225__$1));
}));

(reagent.impl.template.t_reagent$impl$template25224.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_25226){
var self__ = this;
var _25226__$1 = this;
return self__.meta25225;
}));

(reagent.impl.template.t_reagent$impl$template25224.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template25224.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template25224.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template25224.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template25224.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template25224.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta25225","meta25225",-1296337458,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template25224.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template25224.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template25224");

(reagent.impl.template.t_reagent$impl$template25224.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template25224");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template25224.
 */
reagent.impl.template.__GT_t_reagent$impl$template25224 = (function reagent$impl$template$__GT_t_reagent$impl$template25224(opts,id,fn_to_element,parse_fn,meta25225){
return (new reagent.impl.template.t_reagent$impl$template25224(opts,id,fn_to_element,parse_fn,meta25225));
});
...
return (new reagent.impl.template.t_reagent$impl$template25224(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
