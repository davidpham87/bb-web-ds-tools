...
var G__24780 = o;
reagent.impl.template.goog$module$goog$object.set(G__24780,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__24805 = o;
reagent.impl.template.goog$module$goog$object.set(G__24805,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__25094__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__25095__i < G__25095__a.length) {G__25095__a[G__25095__i] = arguments[G__25095__i + 0]; ++G__25095__i;}
  args = new cljs.core.IndexedSeq(G__25095__a,0,null);
} 
return G__25094__delegate.call(this,args);};
G__25094.cljs$lang$maxFixedArity = 0;
G__25094.cljs$lang$applyTo = (function (arglist__25096){
var args = cljs.core.seq(arglist__25096);
return G__25094__delegate(args);
});
...
var G__24811 = props;
var G__24811__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24811,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__24811);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24811__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__24834 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24834,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__24834;
}
})(),id_class);
...
var temp__5825__auto___25097 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___25097)){
var d_25098 = temp__5825__auto___25097;
if((d_25098 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_25098.s}));
} else {
...
var G__24837 = (cljs.core.count(argv) - first_child);
switch (G__24837) {
case (0):
...
var vec__24844 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24844,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24844,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24844,(2),null);
...
var temp__5829__auto___25117 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___25117 == null)){
} else {
var key_25118 = temp__5829__auto___25117;
(jsprops.key = key_25118);
}
...
var temp__5829__auto___25119 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___25119 == null)){
} else {
var key_25120 = temp__5829__auto___25119;
(jsprops.key = key_25120);
}
...
var temp__5829__auto___25121 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___25121 == null)){
} else {
var key_25122 = temp__5829__auto___25121;
(jsprops.key = key_25122);
}
...
var temp__5829__auto___25139 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___25139 == null)){
} else {
var key_25140 = temp__5829__auto___25139;
(jsprops.key = key_25140);
}
...
var temp__5829__auto___25141 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___25141 == null)){
} else {
var key_25153 = temp__5829__auto___25141;
(jsprops.key = key_25153);
}
...
var temp__5829__auto___25158 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___25158 == null)){
} else {
var key_25159 = temp__5829__auto___25158;
(jsprops.key = key_25159);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24921_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__24921_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__24925 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24925,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24925,(1),null);
...
break;
default:
var G__25170 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__25171 = compiler;
v = G__25170;
compiler = G__25171;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template24986 = (function (opts,id,fn_to_element,parse_fn,meta24987){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template24986.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_24988,meta24987__$1){
var self__ = this;
var _24988__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template24986(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta24987__$1));
}));

(reagent.impl.template.t_reagent$impl$template24986.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_24988){
var self__ = this;
var _24988__$1 = this;
return self__.meta24987;
}));

(reagent.impl.template.t_reagent$impl$template24986.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template24986.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template24986.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template24986.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template24986.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template24986.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta24987","meta24987",-833078679,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template24986.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template24986.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template24986");

(reagent.impl.template.t_reagent$impl$template24986.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template24986");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template24986.
 */
reagent.impl.template.__GT_t_reagent$impl$template24986 = (function reagent$impl$template$__GT_t_reagent$impl$template24986(opts,id,fn_to_element,parse_fn,meta24987){
return (new reagent.impl.template.t_reagent$impl$template24986(opts,id,fn_to_element,parse_fn,meta24987));
});
...
return (new reagent.impl.template.t_reagent$impl$template24986(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
