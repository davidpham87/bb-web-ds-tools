...
var G__24824 = o;
reagent.impl.template.goog$module$goog$object.set(G__24824,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__24976__delegate = function (args){
...
while (G__24977__i < G__24977__a.length) {G__24977__a[G__24977__i] = arguments[G__24977__i + 0]; ++G__24977__i;}
  args = new cljs.core.IndexedSeq(G__24977__a,0,null);
} 
return G__24976__delegate.call(this,args);};
G__24976.cljs$lang$maxFixedArity = 0;
G__24976.cljs$lang$applyTo = (function (arglist__24978){
var args = cljs.core.seq(arglist__24978);
return G__24976__delegate(args);
});
...
var G__24834 = o;
reagent.impl.template.goog$module$goog$object.set(G__24834,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__24980__i < G__24980__a.length) {G__24980__a[G__24980__i] = arguments[G__24980__i + 0]; ++G__24980__i;}
  args = new cljs.core.IndexedSeq(G__24980__a,0,null);
} 
...
var G__24842 = props;
var G__24842__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24842,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__24842);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24842__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__24851 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24851,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__24851;
}
})(),id_class);
...
var temp__5825__auto___24984 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___24984)){
var d_24985 = temp__5825__auto___24984;
if((d_24985 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_24985.s}));
} else {
...
var G__24862 = (cljs.core.count(argv) - first_child);
switch (G__24862) {
case (0):
...
var vec__24873 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24873,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24873,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24873,(2),null);
...
var temp__5829__auto___24991 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___24991 == null)){
} else {
var key_24993 = temp__5829__auto___24991;
(jsprops.key = key_24993);
}
...
var temp__5829__auto___24998 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___24998 == null)){
} else {
var key_24999 = temp__5829__auto___24998;
(jsprops.key = key_24999);
}
...
var temp__5829__auto___25002 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___25002 == null)){
} else {
var key_25003 = temp__5829__auto___25002;
(jsprops.key = key_25003);
}
...
var temp__5829__auto___25005 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___25005 == null)){
} else {
var key_25006 = temp__5829__auto___25005;
(jsprops.key = key_25006);
}
...
var temp__5829__auto___25007 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___25007 == null)){
} else {
var key_25008 = temp__5829__auto___25007;
(jsprops.key = key_25008);
}
...
var temp__5829__auto___25009 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___25009 == null)){
} else {
var key_25010 = temp__5829__auto___25009;
(jsprops.key = key_25010);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24911_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__24911_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__24924 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24924,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24924,(1),null);
...
break;
default:
var G__25022 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__25023 = compiler;
v = G__25022;
compiler = G__25023;
continue;
...
var G__24949 = tag;
var G__24949__$1 = (((G__24949 instanceof cljs.core.Keyword))?G__24949.fqn:null);
switch (G__24949__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template24960 = (function (opts,id,fn_to_element,parse_fn,meta24961){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template24960.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_24962,meta24961__$1){
var self__ = this;
var _24962__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template24960(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta24961__$1));
}));

(reagent.impl.template.t_reagent$impl$template24960.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_24962){
var self__ = this;
var _24962__$1 = this;
return self__.meta24961;
}));

(reagent.impl.template.t_reagent$impl$template24960.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template24960.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template24960.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template24960.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template24960.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template24960.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta24961","meta24961",-1496979708,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template24960.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template24960.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template24960");

(reagent.impl.template.t_reagent$impl$template24960.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template24960");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template24960.
 */
reagent.impl.template.__GT_t_reagent$impl$template24960 = (function reagent$impl$template$__GT_t_reagent$impl$template24960(opts,id,fn_to_element,parse_fn,meta24961){
return (new reagent.impl.template.t_reagent$impl$template24960(opts,id,fn_to_element,parse_fn,meta24961));
});
...
return (new reagent.impl.template.t_reagent$impl$template24960(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
