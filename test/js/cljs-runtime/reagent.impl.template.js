...
var G__24738 = o;
reagent.impl.template.goog$module$goog$object.set(G__24738,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__24999__i < G__24999__a.length) {G__24999__a[G__24999__i] = arguments[G__24999__i + 0]; ++G__24999__i;}
  args = new cljs.core.IndexedSeq(G__24999__a,0,null);
} 
...
var G__24751 = o;
reagent.impl.template.goog$module$goog$object.set(G__24751,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__25002__i < G__25002__a.length) {G__25002__a[G__25002__i] = arguments[G__25002__i + 0]; ++G__25002__i;}
  args = new cljs.core.IndexedSeq(G__25002__a,0,null);
} 
...
var G__24769 = props;
var G__24769__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24769,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__24769);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24769__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__24786 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24786,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__24786;
}
})(),id_class);
...
var temp__5825__auto___25006 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___25006)){
var d_25007 = temp__5825__auto___25006;
if((d_25007 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_25007.s}));
} else {
...
var G__24791 = (cljs.core.count(argv) - first_child);
switch (G__24791) {
case (0):
...
var vec__24801 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24801,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24801,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24801,(2),null);
...
var temp__5829__auto___25012 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___25012 == null)){
} else {
var key_25014 = temp__5829__auto___25012;
(jsprops.key = key_25014);
}
...
var temp__5829__auto___25015 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___25015 == null)){
} else {
var key_25016 = temp__5829__auto___25015;
(jsprops.key = key_25016);
}
...
var temp__5829__auto___25017 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___25017 == null)){
} else {
var key_25018 = temp__5829__auto___25017;
(jsprops.key = key_25018);
}
...
var temp__5829__auto___25033 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___25033 == null)){
} else {
var key_25038 = temp__5829__auto___25033;
(jsprops.key = key_25038);
}
...
var temp__5829__auto___25040 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___25040 == null)){
} else {
var key_25041 = temp__5829__auto___25040;
(jsprops.key = key_25041);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24907_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__24907_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__24945 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24945,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24945,(1),null);
...
break;
default:
var G__25043 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__25044 = compiler;
v = G__25043;
compiler = G__25044;
continue;
...
var G__24968 = tag;
var G__24968__$1 = (((G__24968 instanceof cljs.core.Keyword))?G__24968.fqn:null);
switch (G__24968__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template24982 = (function (opts,id,fn_to_element,parse_fn,meta24983){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template24982.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_24984,meta24983__$1){
var self__ = this;
var _24984__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template24982(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta24983__$1));
}));

(reagent.impl.template.t_reagent$impl$template24982.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_24984){
var self__ = this;
var _24984__$1 = this;
return self__.meta24983;
}));

(reagent.impl.template.t_reagent$impl$template24982.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template24982.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template24982.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template24982.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template24982.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template24982.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta24983","meta24983",783440242,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template24982.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template24982.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template24982");

(reagent.impl.template.t_reagent$impl$template24982.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template24982");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template24982.
 */
reagent.impl.template.__GT_t_reagent$impl$template24982 = (function reagent$impl$template$__GT_t_reagent$impl$template24982(opts,id,fn_to_element,parse_fn,meta24983){
return (new reagent.impl.template.t_reagent$impl$template24982(opts,id,fn_to_element,parse_fn,meta24983));
});
...
return (new reagent.impl.template.t_reagent$impl$template24982(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
