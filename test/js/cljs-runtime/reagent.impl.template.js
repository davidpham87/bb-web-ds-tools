...
var G__24739 = o;
reagent.impl.template.goog$module$goog$object.set(G__24739,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__24880__delegate = function (args){
...
while (G__24881__i < G__24881__a.length) {G__24881__a[G__24881__i] = arguments[G__24881__i + 0]; ++G__24881__i;}
  args = new cljs.core.IndexedSeq(G__24881__a,0,null);
} 
return G__24880__delegate.call(this,args);};
...
return G__24880__delegate(args);
});
...
var G__24740 = o;
reagent.impl.template.goog$module$goog$object.set(G__24740,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__24883__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__24884__i < G__24884__a.length) {G__24884__a[G__24884__i] = arguments[G__24884__i + 0]; ++G__24884__i;}
  args = new cljs.core.IndexedSeq(G__24884__a,0,null);
} 
return G__24883__delegate.call(this,args);};
...
return G__24883__delegate(args);
});
...
var G__24742 = props;
var G__24742__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24742,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__24742);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24742__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__24762 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24762,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__24762;
}
})(),id_class);
...
var temp__5825__auto___24886 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___24886)){
var d_24887 = temp__5825__auto___24886;
if((d_24887 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_24887.s}));
} else {
...
var G__24777 = (cljs.core.count(argv) - first_child);
switch (G__24777) {
case (0):
...
var vec__24787 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24787,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24787,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24787,(2),null);
...
var temp__5829__auto___24908 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___24908 == null)){
} else {
var key_24909 = temp__5829__auto___24908;
(jsprops.key = key_24909);
}
...
var temp__5829__auto___24910 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___24910 == null)){
} else {
var key_24915 = temp__5829__auto___24910;
(jsprops.key = key_24915);
}
...
var temp__5829__auto___24920 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___24920 == null)){
} else {
var key_24925 = temp__5829__auto___24920;
(jsprops.key = key_24925);
}
...
var temp__5829__auto___24933 = reagent.impl.util.react_key_from_vec(argv);
...
var temp__5829__auto___24950 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___24950 == null)){
} else {
var key_24951 = temp__5829__auto___24950;
(jsprops.key = key_24951);
}
...
var temp__5829__auto___24953 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___24953 == null)){
} else {
var key_24954 = temp__5829__auto___24953;
(jsprops.key = key_24954);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24816_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__24816_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__24819 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24819,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24819,(1),null);
...
break;
default:
var G__24966 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__24967 = compiler;
v = G__24966;
compiler = G__24967;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template24833 = (function (opts,id,fn_to_element,parse_fn,meta24834){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta24834 = meta24834;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template24833.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_24835,meta24834__$1){
var self__ = this;
var _24835__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template24833(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta24834__$1));
}));

(reagent.impl.template.t_reagent$impl$template24833.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_24835){
var self__ = this;
var _24835__$1 = this;
return self__.meta24834;
}));

(reagent.impl.template.t_reagent$impl$template24833.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template24833.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template24833.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template24833.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template24833.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template24833.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta24834","meta24834",529400456,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template24833.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template24833.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template24833");

(reagent.impl.template.t_reagent$impl$template24833.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template24833");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template24833.
 */
reagent.impl.template.__GT_t_reagent$impl$template24833 = (function reagent$impl$template$__GT_t_reagent$impl$template24833(opts,id,fn_to_element,parse_fn,meta24834){
return (new reagent.impl.template.t_reagent$impl$template24833(opts,id,fn_to_element,parse_fn,meta24834));
});
...
return (new reagent.impl.template.t_reagent$impl$template24833(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
