...
var G__24691 = o;
reagent.impl.template.goog$module$goog$object.set(G__24691,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__24765__delegate = function (args){
...
while (G__24768__i < G__24768__a.length) {G__24768__a[G__24768__i] = arguments[G__24768__i + 0]; ++G__24768__i;}
  args = new cljs.core.IndexedSeq(G__24768__a,0,null);
} 
return G__24765__delegate.call(this,args);};
G__24765.cljs$lang$maxFixedArity = 0;
G__24765.cljs$lang$applyTo = (function (arglist__24769){
var args = cljs.core.seq(arglist__24769);
return G__24765__delegate(args);
});
...
var G__24692 = o;
reagent.impl.template.goog$module$goog$object.set(G__24692,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__24772__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__24772 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__24773__i = 0, G__24773__a = new Array(arguments.length -  0);
while (G__24773__i < G__24773__a.length) {G__24773__a[G__24773__i] = arguments[G__24773__i + 0]; ++G__24773__i;}
  args = new cljs.core.IndexedSeq(G__24773__a,0,null);
} 
return G__24772__delegate.call(this,args);};
G__24772.cljs$lang$maxFixedArity = 0;
G__24772.cljs$lang$applyTo = (function (arglist__24774){
var args = cljs.core.seq(arglist__24774);
return G__24772__delegate(args);
});
...
var G__24700 = props;
var G__24700__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24700,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__24700);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24700__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__24707 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24707,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__24707;
}
})(),id_class);
...
var temp__5825__auto___24775 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___24775)){
var d_24776 = temp__5825__auto___24775;
if((d_24776 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_24776.s}));
} else {
...
var G__24710 = (cljs.core.count(argv) - first_child);
switch (G__24710) {
case (0):
...
var vec__24712 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24712,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24712,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24712,(2),null);
...
var temp__5829__auto___24781 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___24781 == null)){
} else {
var key_24782 = temp__5829__auto___24781;
(jsprops.key = key_24782);
}
...
var temp__5829__auto___24783 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___24783 == null)){
} else {
var key_24784 = temp__5829__auto___24783;
(jsprops.key = key_24784);
}
...
var temp__5829__auto___24785 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___24785 == null)){
} else {
var key_24786 = temp__5829__auto___24785;
(jsprops.key = key_24786);
}
...
var temp__5829__auto___24790 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___24790 == null)){
} else {
var key_24791 = temp__5829__auto___24790;
(jsprops.key = key_24791);
}
...
var temp__5829__auto___24803 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___24803 == null)){
} else {
var key_24804 = temp__5829__auto___24803;
(jsprops.key = key_24804);
}
...
var temp__5829__auto___24805 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___24805 == null)){
} else {
var key_24806 = temp__5829__auto___24805;
(jsprops.key = key_24806);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24739_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__24739_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__24741 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24741,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24741,(1),null);
...
break;
default:
var G__24808 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__24809 = compiler;
v = G__24808;
compiler = G__24809;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template24758 = (function (opts,id,fn_to_element,parse_fn,meta24759){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta24759 = meta24759;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template24758.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_24760,meta24759__$1){
var self__ = this;
var _24760__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template24758(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta24759__$1));
}));

(reagent.impl.template.t_reagent$impl$template24758.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_24760){
var self__ = this;
var _24760__$1 = this;
return self__.meta24759;
}));

(reagent.impl.template.t_reagent$impl$template24758.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template24758.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template24758.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template24758.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template24758.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template24758.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta24759","meta24759",-932984024,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template24758.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template24758.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template24758");

(reagent.impl.template.t_reagent$impl$template24758.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template24758");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template24758.
 */
reagent.impl.template.__GT_t_reagent$impl$template24758 = (function reagent$impl$template$__GT_t_reagent$impl$template24758(opts,id,fn_to_element,parse_fn,meta24759){
return (new reagent.impl.template.t_reagent$impl$template24758(opts,id,fn_to_element,parse_fn,meta24759));
});
...
return (new reagent.impl.template.t_reagent$impl$template24758(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
