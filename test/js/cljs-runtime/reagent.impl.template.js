...
var G__24823 = o;
reagent.impl.template.goog$module$goog$object.set(G__24823,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__24842 = o;
reagent.impl.template.goog$module$goog$object.set(G__24842,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__24845 = props;
var G__24845__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24845,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__24845);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24845__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__24865 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24865,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__24865;
}
})(),id_class);
...
var temp__5825__auto___25019 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___25019)){
var d_25020 = temp__5825__auto___25019;
if((d_25020 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_25020.s}));
} else {
...
var G__24897 = (cljs.core.count(argv) - first_child);
switch (G__24897) {
case (0):
...
var vec__24910 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24910,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24910,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24910,(2),null);
...
var temp__5829__auto___25024 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___25024 == null)){
} else {
var key_25025 = temp__5829__auto___25024;
...
var temp__5829__auto___25026 = reagent.impl.util.react_key_from_vec(v);
...
var temp__5829__auto___25030 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___25030 == null)){
} else {
var key_25031 = temp__5829__auto___25030;
(jsprops.key = key_25031);
}
...
var temp__5829__auto___25032 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___25032 == null)){
} else {
var key_25033 = temp__5829__auto___25032;
(jsprops.key = key_25033);
}
...
var temp__5829__auto___25034 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___25034 == null)){
} else {
var key_25035 = temp__5829__auto___25034;
(jsprops.key = key_25035);
}
...
var temp__5829__auto___25036 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___25036 == null)){
} else {
var key_25037 = temp__5829__auto___25036;
(jsprops.key = key_25037);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24982_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__24982_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__24984 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24984,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24984,(1),null);
...
break;
default:
var G__25042 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__25043 = compiler;
v = G__25042;
compiler = G__25043;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template25007 = (function (opts,id,fn_to_element,parse_fn,meta25008){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template25007.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_25009,meta25008__$1){
var self__ = this;
var _25009__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template25007(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta25008__$1));
}));

(reagent.impl.template.t_reagent$impl$template25007.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_25009){
var self__ = this;
var _25009__$1 = this;
return self__.meta25008;
}));

(reagent.impl.template.t_reagent$impl$template25007.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template25007.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template25007.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template25007.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template25007.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template25007.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta25008","meta25008",808194449,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template25007.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template25007.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template25007");

(reagent.impl.template.t_reagent$impl$template25007.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template25007");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template25007.
 */
reagent.impl.template.__GT_t_reagent$impl$template25007 = (function reagent$impl$template$__GT_t_reagent$impl$template25007(opts,id,fn_to_element,parse_fn,meta25008){
return (new reagent.impl.template.t_reagent$impl$template25007(opts,id,fn_to_element,parse_fn,meta25008));
});
...
return (new reagent.impl.template.t_reagent$impl$template25007(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
