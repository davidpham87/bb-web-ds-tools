...
while (G__25133__i < G__25133__a.length) {G__25133__a[G__25133__i] = arguments[G__25133__i + 0]; ++G__25133__i;}
  args = new cljs.core.IndexedSeq(G__25133__a,0,null);
} 
return G__25132__delegate.call(this,args);};
G__25132.cljs$lang$maxFixedArity = 0;
G__25132.cljs$lang$applyTo = (function (arglist__25136){
var args = cljs.core.seq(arglist__25136);
...
var G__24876 = o;
reagent.impl.template.goog$module$goog$object.set(G__24876,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__25140__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__25142__i < G__25142__a.length) {G__25142__a[G__25142__i] = arguments[G__25142__i + 0]; ++G__25142__i;}
  args = new cljs.core.IndexedSeq(G__25142__a,0,null);
} 
return G__25140__delegate.call(this,args);};
G__25140.cljs$lang$maxFixedArity = 0;
G__25140.cljs$lang$applyTo = (function (arglist__25143){
var args = cljs.core.seq(arglist__25143);
return G__25140__delegate(args);
});
...
var temp__5825__auto___25146 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___25146)){
var d_25147 = temp__5825__auto___25146;
if((d_25147 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_25147.s}));
} else {
...
var vec__24894 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24894,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24894,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24894,(2),null);
...
var temp__5829__auto___25171 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___25171 == null)){
} else {
var key_25172 = temp__5829__auto___25171;
(jsprops.key = key_25172);
}
...
var temp__5829__auto___25173 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___25173 == null)){
} else {
var key_25174 = temp__5829__auto___25173;
(jsprops.key = key_25174);
}
...
var temp__5829__auto___25177 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___25177 == null)){
} else {
var key_25178 = temp__5829__auto___25177;
(jsprops.key = key_25178);
}
...
var temp__5829__auto___25182 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___25182 == null)){
} else {
var key_25183 = temp__5829__auto___25182;
(jsprops.key = key_25183);
}
...
var temp__5829__auto___25210 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___25210 == null)){
} else {
var key_25211 = temp__5829__auto___25210;
(jsprops.key = key_25211);
}
...
var temp__5829__auto___25216 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___25216 == null)){
} else {
var key_25218 = temp__5829__auto___25216;
(jsprops.key = key_25218);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__25037_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__25037_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__25046 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25046,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25046,(1),null);
...
break;
default:
var G__25221 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__25222 = compiler;
v = G__25221;
compiler = G__25222;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template25128 = (function (opts,id,fn_to_element,parse_fn,meta25129){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template25128.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_25130,meta25129__$1){
var self__ = this;
var _25130__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template25128(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta25129__$1));
}));

(reagent.impl.template.t_reagent$impl$template25128.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_25130){
var self__ = this;
var _25130__$1 = this;
return self__.meta25129;
}));

(reagent.impl.template.t_reagent$impl$template25128.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template25128.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template25128.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template25128.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template25128.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template25128.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta25129","meta25129",1146225555,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template25128.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template25128.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template25128");

(reagent.impl.template.t_reagent$impl$template25128.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template25128");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template25128.
 */
reagent.impl.template.__GT_t_reagent$impl$template25128 = (function reagent$impl$template$__GT_t_reagent$impl$template25128(opts,id,fn_to_element,parse_fn,meta25129){
return (new reagent.impl.template.t_reagent$impl$template25128(opts,id,fn_to_element,parse_fn,meta25129));
});
...
return (new reagent.impl.template.t_reagent$impl$template25128(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
