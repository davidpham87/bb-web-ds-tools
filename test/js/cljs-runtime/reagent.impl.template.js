...
var G__24961 = o;
reagent.impl.template.goog$module$goog$object.set(G__24961,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__25285__delegate = function (args){
...
return G__25285__delegate.call(this,args);};
...
return G__25285__delegate(args);
});
...
var G__24976 = o;
reagent.impl.template.goog$module$goog$object.set(G__24976,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__25008 = props;
var G__25008__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__25008,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__25008);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__25008__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__25015 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__25015,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__25015;
}
})(),id_class);
...
var temp__5825__auto___25315 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___25315)){
var d_25316 = temp__5825__auto___25315;
if((d_25316 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_25316.s}));
} else {
...
var G__25038 = (cljs.core.count(argv) - first_child);
switch (G__25038) {
case (0):
...
var vec__25067 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25067,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25067,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25067,(2),null);
...
var temp__5829__auto___25332 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___25332 == null)){
} else {
var key_25333 = temp__5829__auto___25332;
(jsprops.key = key_25333);
}
...
var temp__5829__auto___25335 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___25335 == null)){
} else {
var key_25351 = temp__5829__auto___25335;
...
var temp__5829__auto___25355 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___25355 == null)){
} else {
var key_25356 = temp__5829__auto___25355;
(jsprops.key = key_25356);
}
...
var temp__5829__auto___25361 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___25361 == null)){
} else {
var key_25362 = temp__5829__auto___25361;
(jsprops.key = key_25362);
}
...
var temp__5829__auto___25382 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___25382 == null)){
} else {
var key_25383 = temp__5829__auto___25382;
(jsprops.key = key_25383);
}
...
var temp__5829__auto___25388 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___25388 == null)){
} else {
var key_25389 = temp__5829__auto___25388;
(jsprops.key = key_25389);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__25121_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__25121_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__25126 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25126,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25126,(1),null);
...
break;
default:
var G__25424 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__25425 = compiler;
v = G__25424;
compiler = G__25425;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template25172 = (function (opts,id,fn_to_element,parse_fn,meta25173){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template25172.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_25174,meta25173__$1){
var self__ = this;
var _25174__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template25172(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta25173__$1));
}));

(reagent.impl.template.t_reagent$impl$template25172.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_25174){
var self__ = this;
var _25174__$1 = this;
return self__.meta25173;
}));

(reagent.impl.template.t_reagent$impl$template25172.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template25172.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template25172.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template25172.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template25172.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template25172.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta25173","meta25173",541143319,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template25172.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template25172.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template25172");

(reagent.impl.template.t_reagent$impl$template25172.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template25172");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template25172.
 */
reagent.impl.template.__GT_t_reagent$impl$template25172 = (function reagent$impl$template$__GT_t_reagent$impl$template25172(opts,id,fn_to_element,parse_fn,meta25173){
return (new reagent.impl.template.t_reagent$impl$template25172(opts,id,fn_to_element,parse_fn,meta25173));
});
...
return (new reagent.impl.template.t_reagent$impl$template25172(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
