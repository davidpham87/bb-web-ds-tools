...
var G__24723 = o;
reagent.impl.template.goog$module$goog$object.set(G__24723,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__24969__i < G__24969__a.length) {G__24969__a[G__24969__i] = arguments[G__24969__i + 0]; ++G__24969__i;}
  args = new cljs.core.IndexedSeq(G__24969__a,0,null);
} 
...
var G__24729 = o;
reagent.impl.template.goog$module$goog$object.set(G__24729,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__24973__i < G__24973__a.length) {G__24973__a[G__24973__i] = arguments[G__24973__i + 0]; ++G__24973__i;}
  args = new cljs.core.IndexedSeq(G__24973__a,0,null);
} 
...
var args = cljs.core.seq(arglist__24974);
...
var G__24734 = props;
var G__24734__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24734,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__24734);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24734__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__24735 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24735,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__24735;
}
})(),id_class);
...
var temp__5825__auto___24981 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___24981)){
var d_24982 = temp__5825__auto___24981;
if((d_24982 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_24982.s}));
} else {
...
var G__24740 = (cljs.core.count(argv) - first_child);
switch (G__24740) {
case (0):
...
var vec__24743 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24743,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24743,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24743,(2),null);
...
var temp__5829__auto___24992 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___24992 == null)){
} else {
var key_24995 = temp__5829__auto___24992;
(jsprops.key = key_24995);
}
...
var temp__5829__auto___24997 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___24997 == null)){
} else {
var key_24998 = temp__5829__auto___24997;
(jsprops.key = key_24998);
}
...
var key_25000 = temp__5829__auto___24999;
(jsprops.key = key_25000);
}
...
var temp__5829__auto___25002 = reagent.impl.util.react_key_from_vec(argv);
...
var temp__5829__auto___25013 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___25013 == null)){
} else {
var key_25014 = temp__5829__auto___25013;
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24813_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__24813_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__24829 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24829,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24829,(1),null);
...
*/
reagent.impl.template.t_reagent$impl$template24928 = (function (opts,id,fn_to_element,parse_fn,meta24929){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template24928.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_24930,meta24929__$1){
var self__ = this;
var _24930__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template24928(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta24929__$1));
}));

(reagent.impl.template.t_reagent$impl$template24928.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_24930){
var self__ = this;
var _24930__$1 = this;
return self__.meta24929;
}));

(reagent.impl.template.t_reagent$impl$template24928.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template24928.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template24928.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template24928.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template24928.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template24928.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta24929","meta24929",-1025847724,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template24928.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template24928.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template24928");

(reagent.impl.template.t_reagent$impl$template24928.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template24928");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template24928.
 */
reagent.impl.template.__GT_t_reagent$impl$template24928 = (function reagent$impl$template$__GT_t_reagent$impl$template24928(opts,id,fn_to_element,parse_fn,meta24929){
return (new reagent.impl.template.t_reagent$impl$template24928(opts,id,fn_to_element,parse_fn,meta24929));
});
...
return (new reagent.impl.template.t_reagent$impl$template24928(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
