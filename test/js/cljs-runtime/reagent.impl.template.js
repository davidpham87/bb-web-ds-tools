...
var G__24704 = o;
reagent.impl.template.goog$module$goog$object.set(G__24704,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__24864__delegate = function (args){
...
while (G__24865__i < G__24865__a.length) {G__24865__a[G__24865__i] = arguments[G__24865__i + 0]; ++G__24865__i;}
  args = new cljs.core.IndexedSeq(G__24865__a,0,null);
} 
return G__24864__delegate.call(this,args);};
G__24864.cljs$lang$maxFixedArity = 0;
G__24864.cljs$lang$applyTo = (function (arglist__24866){
var args = cljs.core.seq(arglist__24866);
return G__24864__delegate(args);
});
...
var G__24716 = o;
reagent.impl.template.goog$module$goog$object.set(G__24716,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__24867__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__24868__i < G__24868__a.length) {G__24868__a[G__24868__i] = arguments[G__24868__i + 0]; ++G__24868__i;}
  args = new cljs.core.IndexedSeq(G__24868__a,0,null);
} 
return G__24867__delegate.call(this,args);};
G__24867.cljs$lang$maxFixedArity = 0;
G__24867.cljs$lang$applyTo = (function (arglist__24869){
var args = cljs.core.seq(arglist__24869);
return G__24867__delegate(args);
});
...
var G__24724 = props;
var G__24724__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24724,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__24724);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24724__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__24725 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24725,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__24725;
}
})(),id_class);
...
var temp__5825__auto___24882 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___24882)){
var d_24883 = temp__5825__auto___24882;
if((d_24883 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_24883.s}));
} else {
...
var G__24728 = (cljs.core.count(argv) - first_child);
switch (G__24728) {
case (0):
...
var vec__24734 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24734,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24734,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24734,(2),null);
...
var temp__5829__auto___24888 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___24888 == null)){
} else {
var key_24889 = temp__5829__auto___24888;
(jsprops.key = key_24889);
}
...
var temp__5829__auto___24901 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___24901 == null)){
} else {
var key_24903 = temp__5829__auto___24901;
(jsprops.key = key_24903);
}
...
var temp__5829__auto___24907 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___24907 == null)){
} else {
var key_24908 = temp__5829__auto___24907;
(jsprops.key = key_24908);
}
...
var temp__5829__auto___24909 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___24909 == null)){
} else {
var key_24910 = temp__5829__auto___24909;
(jsprops.key = key_24910);
}
...
var temp__5829__auto___24933 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___24933 == null)){
} else {
var key_24934 = temp__5829__auto___24933;
(jsprops.key = key_24934);
}
...
var temp__5829__auto___24935 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___24935 == null)){
} else {
var key_24936 = temp__5829__auto___24935;
(jsprops.key = key_24936);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24755_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__24755_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__24765 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24765,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24765,(1),null);
...
break;
default:
var G__24955 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__24956 = compiler;
v = G__24955;
compiler = G__24956;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template24794 = (function (opts,id,fn_to_element,parse_fn,meta24795){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template24794.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_24796,meta24795__$1){
var self__ = this;
var _24796__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template24794(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta24795__$1));
}));

(reagent.impl.template.t_reagent$impl$template24794.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_24796){
var self__ = this;
var _24796__$1 = this;
return self__.meta24795;
}));

(reagent.impl.template.t_reagent$impl$template24794.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template24794.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template24794.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template24794.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template24794.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template24794.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta24795","meta24795",-1255057481,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template24794.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template24794.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template24794");

(reagent.impl.template.t_reagent$impl$template24794.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template24794");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template24794.
 */
reagent.impl.template.__GT_t_reagent$impl$template24794 = (function reagent$impl$template$__GT_t_reagent$impl$template24794(opts,id,fn_to_element,parse_fn,meta24795){
return (new reagent.impl.template.t_reagent$impl$template24794(opts,id,fn_to_element,parse_fn,meta24795));
});
...
return (new reagent.impl.template.t_reagent$impl$template24794(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
