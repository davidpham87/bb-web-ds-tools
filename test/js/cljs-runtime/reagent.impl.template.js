...
var G__24743 = o;
reagent.impl.template.goog$module$goog$object.set(G__24743,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__24948__i < G__24948__a.length) {G__24948__a[G__24948__i] = arguments[G__24948__i + 0]; ++G__24948__i;}
  args = new cljs.core.IndexedSeq(G__24948__a,0,null);
} 
...
var G__24755 = o;
reagent.impl.template.goog$module$goog$object.set(G__24755,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
G__24952.cljs$lang$applyTo = (function (arglist__24955){
var args = cljs.core.seq(arglist__24955);
...
var G__24766 = props;
var G__24766__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24766,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__24766);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24766__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__24768 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24768,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__24768;
}
})(),id_class);
...
var temp__5825__auto___24968 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___24968)){
var d_24969 = temp__5825__auto___24968;
if((d_24969 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_24969.s}));
} else {
...
var G__24771 = (cljs.core.count(argv) - first_child);
switch (G__24771) {
case (0):
...
var vec__24781 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24781,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24781,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24781,(2),null);
...
var temp__5829__auto___24974 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___24974 == null)){
} else {
var key_24975 = temp__5829__auto___24974;
(jsprops.key = key_24975);
}
...
var temp__5829__auto___24976 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___24976 == null)){
} else {
var key_24977 = temp__5829__auto___24976;
(jsprops.key = key_24977);
}
...
var temp__5829__auto___24978 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___24978 == null)){
} else {
var key_24979 = temp__5829__auto___24978;
(jsprops.key = key_24979);
}
...
var temp__5829__auto___24981 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___24981 == null)){
} else {
var key_24982 = temp__5829__auto___24981;
(jsprops.key = key_24982);
}
...
var temp__5829__auto___24983 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___24983 == null)){
} else {
var key_24984 = temp__5829__auto___24983;
(jsprops.key = key_24984);
}
...
var temp__5829__auto___24985 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___24985 == null)){
} else {
var key_24986 = temp__5829__auto___24985;
(jsprops.key = key_24986);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24811_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__24811_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__24816 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24816,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24816,(1),null);
...
break;
default:
var G__24990 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__24991 = compiler;
v = G__24990;
compiler = G__24991;
continue;
...
var G__24862 = tag;
var G__24862__$1 = (((G__24862 instanceof cljs.core.Keyword))?G__24862.fqn:null);
switch (G__24862__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template24896 = (function (opts,id,fn_to_element,parse_fn,meta24897){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template24896.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_24898,meta24897__$1){
var self__ = this;
var _24898__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template24896(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta24897__$1));
}));

(reagent.impl.template.t_reagent$impl$template24896.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_24898){
var self__ = this;
var _24898__$1 = this;
return self__.meta24897;
}));

(reagent.impl.template.t_reagent$impl$template24896.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template24896.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template24896.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template24896.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template24896.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template24896.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta24897","meta24897",-471283325,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template24896.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template24896.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template24896");

(reagent.impl.template.t_reagent$impl$template24896.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template24896");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template24896.
 */
reagent.impl.template.__GT_t_reagent$impl$template24896 = (function reagent$impl$template$__GT_t_reagent$impl$template24896(opts,id,fn_to_element,parse_fn,meta24897){
return (new reagent.impl.template.t_reagent$impl$template24896(opts,id,fn_to_element,parse_fn,meta24897));
});
...
return (new reagent.impl.template.t_reagent$impl$template24896(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
