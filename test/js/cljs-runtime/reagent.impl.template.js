...
var G__24972 = o;
reagent.impl.template.goog$module$goog$object.set(G__24972,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__25038__delegate = function (args){
...
while (G__25039__i < G__25039__a.length) {G__25039__a[G__25039__i] = arguments[G__25039__i + 0]; ++G__25039__i;}
  args = new cljs.core.IndexedSeq(G__25039__a,0,null);
} 
return G__25038__delegate.call(this,args);};
...
return G__25038__delegate(args);
});
...
var G__24975 = o;
reagent.impl.template.goog$module$goog$object.set(G__24975,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__25048__i < G__25048__a.length) {G__25048__a[G__25048__i] = arguments[G__25048__i + 0]; ++G__25048__i;}
  args = new cljs.core.IndexedSeq(G__25048__a,0,null);
} 
return G__25046__delegate.call(this,args);};
G__25046.cljs$lang$maxFixedArity = 0;
G__25046.cljs$lang$applyTo = (function (arglist__25049){
...
var G__24981 = props;
var G__24981__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24981,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__24981);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24981__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__24985 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24985,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__24985;
}
})(),id_class);
...
var temp__5825__auto___25050 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___25050)){
var d_25052 = temp__5825__auto___25050;
if((d_25052 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_25052.s}));
} else {
...
var G__24992 = (cljs.core.count(argv) - first_child);
switch (G__24992) {
case (0):
...
var vec__24993 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24993,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24993,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24993,(2),null);
...
var temp__5829__auto___25062 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___25062 == null)){
} else {
var key_25063 = temp__5829__auto___25062;
(jsprops.key = key_25063);
}
...
var temp__5829__auto___25065 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___25065 == null)){
} else {
var key_25067 = temp__5829__auto___25065;
...
var temp__5829__auto___25070 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___25070 == null)){
} else {
var key_25071 = temp__5829__auto___25070;
...
var temp__5829__auto___25072 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___25072 == null)){
} else {
var key_25073 = temp__5829__auto___25072;
...
var temp__5829__auto___25079 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___25079 == null)){
} else {
var key_25080 = temp__5829__auto___25079;
(jsprops.key = key_25080);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__25000_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__25000_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__25003 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25003,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25003,(1),null);
...
break;
default:
var G__25088 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__25089 = compiler;
v = G__25088;
compiler = G__25089;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template25019 = (function (opts,id,fn_to_element,parse_fn,meta25020){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template25019.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_25021,meta25020__$1){
var self__ = this;
var _25021__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template25019(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta25020__$1));
}));

(reagent.impl.template.t_reagent$impl$template25019.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_25021){
var self__ = this;
var _25021__$1 = this;
return self__.meta25020;
}));

(reagent.impl.template.t_reagent$impl$template25019.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template25019.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template25019.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template25019.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template25019.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template25019.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta25020","meta25020",-1100653878,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template25019.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template25019.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template25019");

(reagent.impl.template.t_reagent$impl$template25019.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template25019");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template25019.
 */
reagent.impl.template.__GT_t_reagent$impl$template25019 = (function reagent$impl$template$__GT_t_reagent$impl$template25019(opts,id,fn_to_element,parse_fn,meta25020){
return (new reagent.impl.template.t_reagent$impl$template25019(opts,id,fn_to_element,parse_fn,meta25020));
});
...
return (new reagent.impl.template.t_reagent$impl$template25019(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
