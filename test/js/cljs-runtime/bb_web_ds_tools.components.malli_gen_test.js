...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map","map",1371690461)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__64142){
var vec__64143 = p__64142;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64143,(0),null);
...
return cljs.core.every_QMARK_((function (p1__64146_SHARP_){
return malli.core.validate.cljs$core$IFn$_invoke$arity$2(schema,p1__64146_SHARP_);
}),data);
} else {
...
var validation_results = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__64151_SHARP_){
return bb_web_ds_tools.components.malli.validate_data(schema,p1__64151_SHARP_);
}),generated_data);
...
}catch (e64153){var t__11416__auto__ = e64153;
...
return value__11369__auto__;
}catch (e64202){var t__11416__auto__ = e64202;
