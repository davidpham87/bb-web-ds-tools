...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map","map",1371690461)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__40269){
...
return cljs.core.every_QMARK_((function (p1__40273_SHARP_){
return malli.core.validate.cljs$core$IFn$_invoke$arity$2(schema,p1__40273_SHARP_);
}),data);
} else {
...
var validation_results = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__40274_SHARP_){
return bb_web_ds_tools.components.malli.validate_data(schema,p1__40274_SHARP_);
}),generated_data);
...
}catch (e40275){var t__11416__auto__ = e40275;
...
return value__11369__auto__;
}catch (e40290){var t__11416__auto__ = e40290;
