 ...
 */
bb_web_ds_tools.utils.dataset_processing.normalize_column_name = (function bb_web_ds_tools$utils$dataset_processing$normalize_column_name(col_name,p__43520){
var map__43523 = p__43520;
var map__43523__$1 = cljs.core.__destructure_map(map__43523);
var case$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43523__$1,new cljs.core.Keyword(null,"case","case",1143702196));
var output = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43523__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var s = cljs.core.name(col_name);
var s_case = (function (){var pred__43524 = cljs.core._EQ_;
var expr__43525 = case$;
if(cljs.core.truth_((pred__43524.cljs$core$IFn$_invoke$arity$2 ? pred__43524.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"snake_case","snake_case",-83605242),expr__43525) : pred__43524.call(null,new cljs.core.Keyword(null,"snake_case","snake_case",-83605242),expr__43525)))){
return bb_web_ds_tools.utils.dataset_processing.to_snake_case(s);
} else {
if(cljs.core.truth_((pred__43524.cljs$core$IFn$_invoke$arity$2 ? pred__43524.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"CamelCase","CamelCase",989004190),expr__43525) : pred__43524.call(null,new cljs.core.Keyword(null,"CamelCase","CamelCase",989004190),expr__43525)))){
return bb_web_ds_tools.utils.dataset_processing.to_camel_case(s);
} else {
if(cljs.core.truth_((pred__43524.cljs$core$IFn$_invoke$arity$2 ? pred__43524.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"kebab-case","kebab-case",2130396283),expr__43525) : pred__43524.call(null,new cljs.core.Keyword(null,"kebab-case","kebab-case",2130396283),expr__43525)))){
...
var final_val = (function (){var pred__43528 = cljs.core._EQ_;
var expr__43529 = output;
if(cljs.core.truth_((pred__43528.cljs$core$IFn$_invoke$arity$2 ? pred__43528.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"string","string",-1989541586),expr__43529) : pred__43528.call(null,new cljs.core.Keyword(null,"string","string",-1989541586),expr__43529)))){
return s_case;
} else {
if(cljs.core.truth_((pred__43528.cljs$core$IFn$_invoke$arity$2 ? pred__43528.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"keyword","keyword",811389747),expr__43529) : pred__43528.call(null,new cljs.core.Keyword(null,"keyword","keyword",811389747),expr__43529)))){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(s_case);
} else {
if(cljs.core.truth_((pred__43528.cljs$core$IFn$_invoke$arity$2 ? pred__43528.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"symbol","symbol",-1038572696),expr__43529) : pred__43528.call(null,new cljs.core.Keyword(null,"symbol","symbol",-1038572696),expr__43529)))){
...
return cljs.core.zipmap(cols,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43532_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.get.cljs$core$IFn$_invoke$arity$2(data,p1__43532_SHARP_),i);
}),cols));
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__43538 = cljs.core.get_global_hierarchy;
...
var G__43546 = bb_web_ds_tools.utils.dataset_processing.parse_json.cljs$core$IFn$_invoke$arity$1(text);
if((G__43546 == null)){
return null;
} else {
return bb_web_ds_tools.utils.dataset_processing.normalize_columnar(G__43546);
}
}));
...
var G__43547 = bb_web_ds_tools.utils.dataset_processing.parse_json.cljs$core$IFn$_invoke$arity$1(text);
if((G__43547 == null)){
return null;
} else {
return bb_web_ds_tools.utils.dataset_processing.normalize_row_arrays(G__43547);
}
}));
...
var G__43548 = clojure.edn.read_string.cljs$core$IFn$_invoke$arity$1(text);
if((G__43548 == null)){
return null;
} else {
...
var G__43549 = clojure.edn.read_string.cljs$core$IFn$_invoke$arity$1(text);
if((G__43549 == null)){
return null;
} else {
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__43550_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(row,p1__43550_SHARP_);
}),ks);
}),rows)));
});
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(row_start),clojure.string.join.cljs$core$IFn$_invoke$arity$2(cell_sep,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43551_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(row,p1__43551_SHARP_);
...
while (G__43640__i < G__43640__a.length) {G__43640__a[G__43640__i] = arguments[G__43640__i + 2]; ++G__43640__i;}
  p__43564 = new cljs.core.IndexedSeq(G__43640__a,0,null);
} 
return G__43637__delegate.call(this,_,___$1,p__43564);};
G__43637.cljs$lang$maxFixedArity = 2;
G__43637.cljs$lang$applyTo = (function (arglist__43641){
var _ = cljs.core.first(arglist__43641);
arglist__43641 = cljs.core.next(arglist__43641);
var ___$1 = cljs.core.first(arglist__43641);
var p__43564 = cljs.core.rest(arglist__43641);
...
var G__43642__delegate = function (_,___$1,p__43568){
...
var G__43642 = function (_,___$1,var_args){
var p__43568 = null;
if (arguments.length > 2) {
var G__43643__i = 0, G__43643__a = new Array(arguments.length -  2);
while (G__43643__i < G__43643__a.length) {G__43643__a[G__43643__i] = arguments[G__43643__i + 2]; ++G__43643__i;}
  p__43568 = new cljs.core.IndexedSeq(G__43643__a,0,null);
} 
return G__43642__delegate.call(this,_,___$1,p__43568);};
G__43642.cljs$lang$maxFixedArity = 2;
G__43642.cljs$lang$applyTo = (function (arglist__43644){
var _ = cljs.core.first(arglist__43644);
arglist__43644 = cljs.core.next(arglist__43644);
var ___$1 = cljs.core.first(arglist__43644);
var p__43568 = cljs.core.rest(arglist__43644);
return G__43642__delegate(_,___$1,p__43568);
});
...
var G__43645__delegate = function (_,___$1,p__43572){
...
while (G__43646__i < G__43646__a.length) {G__43646__a[G__43646__i] = arguments[G__43646__i + 2]; ++G__43646__i;}
  p__43572 = new cljs.core.IndexedSeq(G__43646__a,0,null);
} 
return G__43645__delegate.call(this,_,___$1,p__43572);};
...
var p__43572 = cljs.core.rest(arglist__43647);
return G__43645__delegate(_,___$1,p__43572);
});
...
var G__43648__delegate = function (_,structure,p__43576){
...
while (G__43649__i < G__43649__a.length) {G__43649__a[G__43649__i] = arguments[G__43649__i + 2]; ++G__43649__i;}
  p__43576 = new cljs.core.IndexedSeq(G__43649__a,0,null);
} 
return G__43648__delegate.call(this,_,structure,p__43576);};
...
var p__43576 = cljs.core.rest(arglist__43650);
return G__43648__delegate(_,structure,p__43576);
});
...
var G__43651__delegate = function (_,structure,p__43580){
...
while (G__43652__i < G__43652__a.length) {G__43652__a[G__43652__i] = arguments[G__43652__i + 2]; ++G__43652__i;}
  p__43580 = new cljs.core.IndexedSeq(G__43652__a,0,null);
} 
return G__43651__delegate.call(this,_,structure,p__43580);};
...
var p__43580 = cljs.core.rest(arglist__43653);
return G__43651__delegate(_,structure,p__43580);
});
...
var G__43654__delegate = function (_,structure,p__43586){
var vec__43587 = p__43586;
var conf = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43587,(0),null);
return bb_web_ds_tools.utils.dataset_processing.stringify_json.cljs$core$IFn$_invoke$arity$2(bb_web_ds_tools.utils.dataset_processing.get_structured_data(structure),new cljs.core.Keyword(null,"json","json",1279968570).cljs$core$IFn$_invoke$arity$1(conf));
};
...
while (G__43655__i < G__43655__a.length) {G__43655__a[G__43655__i] = arguments[G__43655__i + 2]; ++G__43655__i;}
  p__43586 = new cljs.core.IndexedSeq(G__43655__a,0,null);
} 
return G__43654__delegate.call(this,_,structure,p__43586);};
...
var p__43586 = cljs.core.rest(arglist__43656);
return G__43654__delegate(_,structure,p__43586);
});
...
var G__43657__delegate = function (_,structure,p__43590){
var vec__43591 = p__43590;
var conf = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43591,(0),null);
var sb__5670__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__43594_43658 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__43595_43659 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__43596_43660 = true;
var _STAR_print_fn_STAR__temp_val__43597_43661 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__43596_43660);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__43597_43661);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__43595_43659);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__43594_43658);
}
...
while (G__43662__i < G__43662__a.length) {G__43662__a[G__43662__i] = arguments[G__43662__i + 2]; ++G__43662__i;}
  p__43590 = new cljs.core.IndexedSeq(G__43662__a,0,null);
} 
return G__43657__delegate.call(this,_,structure,p__43590);};
...
var p__43590 = cljs.core.rest(arglist__43663);
return G__43657__delegate(_,structure,p__43590);
});
...
var G__43664__delegate = function (_,structure,p__43599){
...
while (G__43670__i < G__43670__a.length) {G__43670__a[G__43670__i] = arguments[G__43670__i + 2]; ++G__43670__i;}
  p__43599 = new cljs.core.IndexedSeq(G__43670__a,0,null);
} 
return G__43664__delegate.call(this,_,structure,p__43599);};
G__43664.cljs$lang$maxFixedArity = 2;
G__43664.cljs$lang$applyTo = (function (arglist__43671){
var _ = cljs.core.first(arglist__43671);
arglist__43671 = cljs.core.next(arglist__43671);
var structure = cljs.core.first(arglist__43671);
var p__43599 = cljs.core.rest(arglist__43671);
return G__43664__delegate(_,structure,p__43599);
});
...
var G__43672__delegate = function (_,structure,p__43608){
var vec__43609 = p__43608;
var conf = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43609,(0),null);
var sb__5670__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__43612_43673 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__43613_43674 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__43614_43675 = true;
var _STAR_print_fn_STAR__temp_val__43615_43676 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__43614_43675);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__43615_43676);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(bb_web_ds_tools.utils.dataset_processing.get_structured_data(structure));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__43613_43674);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__43612_43673);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5670__auto__);
};
...
return G__43672__delegate.call(this,_,structure,p__43608);};
G__43672.cljs$lang$maxFixedArity = 2;
G__43672.cljs$lang$applyTo = (function (arglist__43678){
...
return G__43672__delegate(_,structure,p__43608);
});
