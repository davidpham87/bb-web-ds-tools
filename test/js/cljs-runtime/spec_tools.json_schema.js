...
var map__55882 = spec_tools.impl.parse_keys(spec_tools.impl.extract_form(spec));
var map__55882__$1 = cljs.core.__destructure_map(map__55882);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55882__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55882__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55882__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55882__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var map__55883 = spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$1(form);
var map__55883__$1 = cljs.core.__destructure_map(map__55883);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55883__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__55885 = type;
var G__55885__$1 = (((G__55885 instanceof cljs.core.Keyword))?G__55885.fqn:null);
switch (G__55885__$1) {
case "map":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__55885__$1)].join('')));
...
var vec__55908 = spec_tools.impl.strip_fn_if_needed(spec);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55908,(0),null);
var minimum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55908,(1),null);
var maximum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55908,(2),null);
var ___$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55908,(3),null);
...
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55911,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55911,(1),null);
...
var extra_info = (function (){var G__55914 = cljs.core.select_keys(data,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"description","description",-1428560544)], null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55914,new cljs.core.Keyword(null,"title","title",636505583),spec_tools.impl.qualified_name(name));
} else {
return G__55914;
}
})();
