...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.swagger.core","default","spec-tools.swagger.core/default",1361779456)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__63960 = cljs.core.get_global_hierarchy;
return (fexpr__63960.cljs$core$IFn$_invoke$arity$0 ? fexpr__63960.cljs$core$IFn$_invoke$arity$0() : fexpr__63960.call(null));
})());
...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__63975){
var map__63976 = p__63975;
var map__63976__$1 = cljs.core.__destructure_map(map__63976);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63976__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63976__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__63979 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63979,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63979,(1),null);
...
var method_cache__5624__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5625__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__63999 = cljs.core.get_global_hierarchy;
...
var map__64040 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
var map__64040__$1 = cljs.core.__destructure_map(map__64040);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64040__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64040__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__64049){
var vec__64053 = p__64049;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64053,(0),null);
var map__64056 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64053,(1),null);
var map__64056__$1 = cljs.core.__destructure_map(map__64056);
var schema = map__64056__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64056__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var method_cache__5624__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5625__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__64061 = cljs.core.get_global_hierarchy;
return (fexpr__64061.cljs$core$IFn$_invoke$arity$0 ? fexpr__64061.cljs$core$IFn$_invoke$arity$0() : fexpr__64061.call(null));
})());
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$swagger$core$iter__64062(s__64063){
return (new cljs.core.LazySeq(null,(function (){
var s__64063__$1 = s__64063;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__64063__$1);
if(temp__5825__auto__){
var s__64063__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__64063__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__64063__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__64065 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__64064 = (0);
while(true){
if((i__64064 < size__5502__auto__)){
var vec__64066 = cljs.core._nth(c__5501__auto__,i__64064);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64066,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64066,(1),null);
cljs.core.chunk_append(b__64065,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__64065),spec_tools$swagger$core$iter__64062(cljs.core.chunk_rest(s__64063__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__64065),null);
}
} else {
var vec__64074 = cljs.core.first(s__64063__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64074,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64074,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__64062(cljs.core.rest(s__64063__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__64079){
var vec__64080 = p__64079;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64080,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64080,(1),null);
return spec_tools.swagger.core.extract_parameter.cljs$core$IFn$_invoke$arity$2(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__64083,p){
var vec__64084 = p__64083;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64084,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64084,(1),null);
var acc__$1 = vec__64084;
