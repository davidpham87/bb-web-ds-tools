...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.swagger.core","default","spec-tools.swagger.core/default",1361779456)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__55827 = cljs.core.get_global_hierarchy;
return (fexpr__55827.cljs$core$IFn$_invoke$arity$0 ? fexpr__55827.cljs$core$IFn$_invoke$arity$0() : fexpr__55827.call(null));
})());
...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__55859){
var map__55860 = p__55859;
var map__55860__$1 = cljs.core.__destructure_map(map__55860);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55860__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55860__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__55861 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55861,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55861,(1),null);
...
var method_cache__5624__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5625__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__55874 = cljs.core.get_global_hierarchy;
return (fexpr__55874.cljs$core$IFn$_invoke$arity$0 ? fexpr__55874.cljs$core$IFn$_invoke$arity$0() : fexpr__55874.call(null));
})());
...
var map__55880 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
var map__55880__$1 = cljs.core.__destructure_map(map__55880);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55880__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55880__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__55881){
var vec__55882 = p__55881;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55882,(0),null);
var map__55885 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55882,(1),null);
var map__55885__$1 = cljs.core.__destructure_map(map__55885);
var schema = map__55885__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55885__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var method_cache__5624__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5625__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__55888 = cljs.core.get_global_hierarchy;
return (fexpr__55888.cljs$core$IFn$_invoke$arity$0 ? fexpr__55888.cljs$core$IFn$_invoke$arity$0() : fexpr__55888.call(null));
})());
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$swagger$core$iter__55889(s__55890){
...
var vec__55905 = cljs.core._nth(c__5501__auto__,i__55891);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55905,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55905,(1),null);
cljs.core.chunk_append(b__55892,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55892),spec_tools$swagger$core$iter__55889(cljs.core.chunk_rest(s__55890__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55892),null);
}
} else {
var vec__55923 = cljs.core.first(s__55890__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55923,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55923,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__55889(cljs.core.rest(s__55890__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__55927){
var vec__55928 = p__55927;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55928,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55928,(1),null);
