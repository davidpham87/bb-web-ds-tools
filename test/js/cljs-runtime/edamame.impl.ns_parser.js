...
var len__5749__auto___34031 = arguments.length;
var i__5750__auto___34032 = (0);
while(true){
if((i__5750__auto___34032 < len__5749__auto___34031)){
args__5755__auto__.push((arguments[i__5750__auto___34032]));

var G__34033 = (i__5750__auto___34032 + (1));
i__5750__auto___34032 = G__34033;
continue;
} else {
}
break;
...
/** @this {Function} */
(edamame.impl.ns_parser.load_lib.cljs$lang$applyTo = (function (seq33962){
var G__33963 = cljs.core.first(seq33962);
var seq33962__$1 = cljs.core.next(seq33962);
var G__33965 = cljs.core.first(seq33962__$1);
var seq33962__$2 = cljs.core.next(seq33962__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33963,G__33965,seq33962__$2);
}));
...
var prefix = first__33983;
var args_STAR___$2 = seq__33982__$1;
if((prefix == null)){
...
edamame.impl.ns_parser._ns = (function edamame$impl$ns_parser$_ns(p__33994){
var vec__33996 = p__33994;
var seq__33997 = cljs.core.seq(vec__33996);
var first__33998 = cljs.core.first(seq__33997);
var seq__33997__$1 = cljs.core.next(seq__33997);
var _ns = first__33998;
var first__33998__$1 = cljs.core.first(seq__33997__$1);
var seq__33997__$2 = cljs.core.next(seq__33997__$1);
var name = first__33998__$1;
var references = seq__33997__$2;
...
var requires = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__33988_SHARP_){
return edamame.impl.ns_parser.load_libs(new cljs.core.Keyword(null,"require","require",-468001333),cljs.core.rest(p1__33988_SHARP_));
...
var imports = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__34002){
var vec__34003 = p__34002;
var seq__34004 = cljs.core.seq(vec__34003);
var first__34005 = cljs.core.first(seq__34004);
var seq__34004__$1 = cljs.core.next(seq__34004);
var _ = first__34005;
var specs = seq__34004__$1;
...
var vec__34009 = spec;
var seq__34010 = cljs.core.seq(vec__34009);
var first__34011 = cljs.core.first(seq__34010);
var seq__34010__$1 = cljs.core.next(seq__34010);
var pkg = first__34011;
var classes = seq__34010__$1;
