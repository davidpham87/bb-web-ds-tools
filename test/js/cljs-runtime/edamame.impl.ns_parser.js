...
var G__34063 = (i__5750__auto___34062 + (1));
i__5750__auto___34062 = G__34063;
continue;
} else {
}
break;
...
/** @this {Function} */
(edamame.impl.ns_parser.load_lib.cljs$lang$applyTo = (function (seq33968){
...
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33969,G__33970,seq33968__$2);
}));
...
var vec__33990 = arg;
var seq__33991 = cljs.core.seq(vec__33990);
var first__33992 = cljs.core.first(seq__33991);
var seq__33991__$1 = cljs.core.next(seq__33991);
var prefix = first__33992;
var args_STAR___$2 = seq__33991__$1;
if((prefix == null)){
...
edamame.impl.ns_parser._ns = (function edamame$impl$ns_parser$_ns(p__34020){
...
var requires = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__34011_SHARP_){
return edamame.impl.ns_parser.load_libs(new cljs.core.Keyword(null,"require","require",-468001333),cljs.core.rest(p1__34011_SHARP_));
...
var imports = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__34037){
var vec__34038 = p__34037;
var seq__34039 = cljs.core.seq(vec__34038);
var first__34040 = cljs.core.first(seq__34039);
var seq__34039__$1 = cljs.core.next(seq__34039);
var _ = first__34040;
var specs = seq__34039__$1;
...
var vec__34057 = spec;
var seq__34058 = cljs.core.seq(vec__34057);
var first__34059 = cljs.core.first(seq__34058);
var seq__34058__$1 = cljs.core.next(seq__34058);
var pkg = first__34059;
var classes = seq__34058__$1;
