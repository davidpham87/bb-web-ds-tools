...
var len__5749__auto___34087 = arguments.length;
var i__5750__auto___34088 = (0);
while(true){
if((i__5750__auto___34088 < len__5749__auto___34087)){
args__5755__auto__.push((arguments[i__5750__auto___34088]));

var G__34099 = (i__5750__auto___34088 + (1));
i__5750__auto___34088 = G__34099;
continue;
} else {
}
break;
...
/** @this {Function} */
(edamame.impl.ns_parser.load_lib.cljs$lang$applyTo = (function (seq34002){
var G__34003 = cljs.core.first(seq34002);
var seq34002__$1 = cljs.core.next(seq34002);
var G__34004 = cljs.core.first(seq34002__$1);
var seq34002__$2 = cljs.core.next(seq34002__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34003,G__34004,seq34002__$2);
}));
...
var vec__34031 = arg;
var seq__34032 = cljs.core.seq(vec__34031);
var first__34033 = cljs.core.first(seq__34032);
var seq__34032__$1 = cljs.core.next(seq__34032);
var prefix = first__34033;
var args_STAR___$2 = seq__34032__$1;
if((prefix == null)){
...
edamame.impl.ns_parser._ns = (function edamame$impl$ns_parser$_ns(p__34049){
var vec__34050 = p__34049;
var seq__34051 = cljs.core.seq(vec__34050);
var first__34052 = cljs.core.first(seq__34051);
var seq__34051__$1 = cljs.core.next(seq__34051);
var _ns = first__34052;
var first__34052__$1 = cljs.core.first(seq__34051__$1);
var seq__34051__$2 = cljs.core.next(seq__34051__$1);
var name = first__34052__$1;
var references = seq__34051__$2;
...
var requires = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__34038_SHARP_){
return edamame.impl.ns_parser.load_libs(new cljs.core.Keyword(null,"require","require",-468001333),cljs.core.rest(p1__34038_SHARP_));
...
var imports = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__34056){
var vec__34058 = p__34056;
var seq__34059 = cljs.core.seq(vec__34058);
var first__34060 = cljs.core.first(seq__34059);
var seq__34059__$1 = cljs.core.next(seq__34059);
var _ = first__34060;
var specs = seq__34059__$1;
...
var vec__34070 = spec;
var seq__34071 = cljs.core.seq(vec__34070);
var first__34072 = cljs.core.first(seq__34071);
var seq__34071__$1 = cljs.core.next(seq__34071);
var pkg = first__34072;
var classes = seq__34071__$1;
