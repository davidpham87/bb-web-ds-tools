...
var len__5749__auto___32699 = arguments.length;
var i__5750__auto___32700 = (0);
while(true){
if((i__5750__auto___32700 < len__5749__auto___32699)){
args__5755__auto__.push((arguments[i__5750__auto___32700]));

var G__32701 = (i__5750__auto___32700 + (1));
i__5750__auto___32700 = G__32701;
continue;
} else {
}
break;
...
/** @this {Function} */
(edamame.impl.ns_parser.load_lib.cljs$lang$applyTo = (function (seq32672){
var G__32673 = cljs.core.first(seq32672);
var seq32672__$1 = cljs.core.next(seq32672);
var G__32674 = cljs.core.first(seq32672__$1);
var seq32672__$2 = cljs.core.next(seq32672__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32673,G__32674,seq32672__$2);
}));
...
var vec__32678 = arg;
var seq__32679 = cljs.core.seq(vec__32678);
var first__32680 = cljs.core.first(seq__32679);
var seq__32679__$1 = cljs.core.next(seq__32679);
var prefix = first__32680;
var args_STAR___$2 = seq__32679__$1;
if((prefix == null)){
...
edamame.impl.ns_parser._ns = (function edamame$impl$ns_parser$_ns(p__32684){
...
var _ns = first__32687;
var first__32687__$1 = cljs.core.first(seq__32686__$1);
var seq__32686__$2 = cljs.core.next(seq__32686__$1);
var name = first__32687__$1;
var references = seq__32686__$2;
...
var requires = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__32682_SHARP_){
return edamame.impl.ns_parser.load_libs(new cljs.core.Keyword(null,"require","require",-468001333),cljs.core.rest(p1__32682_SHARP_));
...
var imports = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__32690){
var vec__32691 = p__32690;
var seq__32692 = cljs.core.seq(vec__32691);
var first__32693 = cljs.core.first(seq__32692);
var seq__32692__$1 = cljs.core.next(seq__32692);
var _ = first__32693;
var specs = seq__32692__$1;
...
var pkg = first__32696;
var classes = seq__32695__$1;
