...
var len__5749__auto___40226 = arguments.length;
var i__5750__auto___40227 = (0);
while(true){
if((i__5750__auto___40227 < len__5749__auto___40226)){
args__5755__auto__.push((arguments[i__5750__auto___40227]));

var G__40228 = (i__5750__auto___40227 + (1));
i__5750__auto___40227 = G__40228;
continue;
} else {
}
break;
...
/** @this {Function} */
(edamame.impl.ns_parser.load_lib.cljs$lang$applyTo = (function (seq40202){
var G__40203 = cljs.core.first(seq40202);
var seq40202__$1 = cljs.core.next(seq40202);
var G__40204 = cljs.core.first(seq40202__$1);
var seq40202__$2 = cljs.core.next(seq40202__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40203,G__40204,seq40202__$2);
}));
...
var vec__40206 = arg;
var seq__40207 = cljs.core.seq(vec__40206);
var first__40208 = cljs.core.first(seq__40207);
var seq__40207__$1 = cljs.core.next(seq__40207);
var prefix = first__40208;
var args_STAR___$2 = seq__40207__$1;
if((prefix == null)){
...
edamame.impl.ns_parser._ns = (function edamame$impl$ns_parser$_ns(p__40211){
...
var _ns = first__40214;
var first__40214__$1 = cljs.core.first(seq__40213__$1);
var seq__40213__$2 = cljs.core.next(seq__40213__$1);
var name = first__40214__$1;
var references = seq__40213__$2;
...
var requires = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__40209_SHARP_){
return edamame.impl.ns_parser.load_libs(new cljs.core.Keyword(null,"require","require",-468001333),cljs.core.rest(p1__40209_SHARP_));
...
var imports = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__40216){
var vec__40220 = p__40216;
...
var vec__40223 = spec;
var seq__40224 = cljs.core.seq(vec__40223);
var first__40225 = cljs.core.first(seq__40224);
var seq__40224__$1 = cljs.core.next(seq__40224);
var pkg = first__40225;
var classes = seq__40224__$1;
