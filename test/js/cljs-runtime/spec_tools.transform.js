...
if((x instanceof cljs.core.Keyword)){
var G__62712 = spec;
var G__62713 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__62712,G__62713) : f.call(null,G__62712,G__62713));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__62716 = spec;
var G__62717 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__62716,G__62717) : f.call(null,G__62716,G__62717));
} else {
return x;
...
if(typeof x === 'number'){
var G__62718 = spec;
var G__62719 = spec_tools.transform.number__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__62718,G__62719) : f.call(null,G__62718,G__62719));
} else {
if(typeof x === 'string'){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(spec,x) : f.call(null,spec,x));
} else {
...
}catch (e62720){if((e62720 instanceof Error)){
var ___$1 = e62720;
return x;
} else {
throw e62720;
...
}catch (e62722){if((e62722 instanceof Error)){
var ___$1 = e62722;
return x;
} else {
throw e62722;
...
}catch (e62723){if((e62723 instanceof Error)){
var ___$1 = e62723;
return x;
} else {
throw e62723;
...
}catch (e62724){if((e62724 instanceof Error)){
var ___$1 = e62724;
return x;
} else {
throw e62724;
...
}catch (e62726){if((e62726 instanceof Error)){
var ___$1 = e62726;
return x;
} else {
throw e62726;
...
}catch (e62727){if((e62727 instanceof Error)){
var ___$1 = e62727;
return x;
} else {
throw e62727;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__62728,x){
var map__62729 = p__62728;
var map__62729__$1 = cljs.core.__destructure_map(map__62729);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62729__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__62730,x){
var map__62731 = p__62730;
var map__62731__$1 = cljs.core.__destructure_map(map__62731);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62731__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__62732,x){
var map__62733 = p__62732;
var map__62733__$1 = cljs.core.__destructure_map(map__62733);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62733__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
