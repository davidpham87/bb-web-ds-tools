...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_30374 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_30374(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_30375 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_30375(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_30376 = (function (reader,ch){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_30376(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_30377 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_30377(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_30378 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_30378(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_30379 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_30379(reader);
}
});
...
var G__30392 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__30393 = s.append(c);
c = G__30392;
s = G__30393;
continue;
}
