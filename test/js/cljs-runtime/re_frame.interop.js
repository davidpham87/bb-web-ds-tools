...
return [(function (){var pred__25387 = cljs.core.instance_QMARK_;
var expr__25388 = reactive_val;
if(cljs.core.truth_((pred__25387.cljs$core$IFn$_invoke$arity$2 ? pred__25387.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__25388) : pred__25387.call(null,reagent.ratom.RAtom,expr__25388)))){
return "ra";
} else {
if(cljs.core.truth_((pred__25387.cljs$core$IFn$_invoke$arity$2 ? pred__25387.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__25388) : pred__25387.call(null,reagent.ratom.RCursor,expr__25388)))){
return "rc";
} else {
if(cljs.core.truth_((pred__25387.cljs$core$IFn$_invoke$arity$2 ? pred__25387.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__25388) : pred__25387.call(null,reagent.ratom.Reaction,expr__25388)))){
return "rx";
} else {
if(cljs.core.truth_((pred__25387.cljs$core$IFn$_invoke$arity$2 ? pred__25387.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__25388) : pred__25387.call(null,reagent.ratom.Track,expr__25388)))){
return "tr";
} else {
return "other";
}
