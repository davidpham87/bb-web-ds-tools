...
return [(function (){var pred__25550 = cljs.core.instance_QMARK_;
var expr__25551 = reactive_val;
if(cljs.core.truth_((pred__25550.cljs$core$IFn$_invoke$arity$2 ? pred__25550.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__25551) : pred__25550.call(null,reagent.ratom.RAtom,expr__25551)))){
return "ra";
} else {
if(cljs.core.truth_((pred__25550.cljs$core$IFn$_invoke$arity$2 ? pred__25550.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__25551) : pred__25550.call(null,reagent.ratom.RCursor,expr__25551)))){
return "rc";
} else {
if(cljs.core.truth_((pred__25550.cljs$core$IFn$_invoke$arity$2 ? pred__25550.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__25551) : pred__25550.call(null,reagent.ratom.Reaction,expr__25551)))){
return "rx";
} else {
if(cljs.core.truth_((pred__25550.cljs$core$IFn$_invoke$arity$2 ? pred__25550.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__25551) : pred__25550.call(null,reagent.ratom.Track,expr__25551)))){
return "tr";
} else {
return "other";
}
