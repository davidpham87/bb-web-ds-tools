...
return [(function (){var pred__25500 = cljs.core.instance_QMARK_;
var expr__25501 = reactive_val;
if(cljs.core.truth_((pred__25500.cljs$core$IFn$_invoke$arity$2 ? pred__25500.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__25501) : pred__25500.call(null,reagent.ratom.RAtom,expr__25501)))){
return "ra";
} else {
if(cljs.core.truth_((pred__25500.cljs$core$IFn$_invoke$arity$2 ? pred__25500.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__25501) : pred__25500.call(null,reagent.ratom.RCursor,expr__25501)))){
return "rc";
} else {
if(cljs.core.truth_((pred__25500.cljs$core$IFn$_invoke$arity$2 ? pred__25500.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__25501) : pred__25500.call(null,reagent.ratom.Reaction,expr__25501)))){
return "rx";
} else {
if(cljs.core.truth_((pred__25500.cljs$core$IFn$_invoke$arity$2 ? pred__25500.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__25501) : pred__25500.call(null,reagent.ratom.Track,expr__25501)))){
return "tr";
} else {
return "other";
}
