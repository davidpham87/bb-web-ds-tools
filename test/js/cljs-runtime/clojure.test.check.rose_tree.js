...
return clojure.test.check.rose_tree.make_rose((function (){var G__49798 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__49798) : f.call(null,G__49798));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49796_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__49796_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__49796_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49799_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__49799_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__49799_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__49800_SHARP_){
var G__49801 = clojure.test.check.rose_tree.root(p1__49800_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__49801) : pred.call(null,G__49801));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__5503__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__49804(s__49805){
return (new cljs.core.LazySeq(null,(function (){
var s__49805__$1 = s__49805;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__49805__$1);
if(temp__5825__auto__){
var xs__6385__auto__ = temp__5825__auto__;
var vec__49814 = cljs.core.first(xs__6385__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49814,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49814,(1),null);
var iterys__5499__auto__ = ((function (s__49805__$1,vec__49814,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__49804_$_iter__49806(s__49807){
return (new cljs.core.LazySeq(null,((function (s__49805__$1,vec__49814,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function (){
var s__49807__$1 = s__49807;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__49807__$1);
if(temp__5825__auto____$1){
var s__49807__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__49807__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__49807__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__49809 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__49808 = (0);
while(true){
if((i__49808 < size__5502__auto__)){
var child = cljs.core._nth(c__5501__auto__,i__49808);
cljs.core.chunk_append(b__49809,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__49832 = (i__49808 + (1));
i__49808 = G__49832;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49809),clojure$test$check$rose_tree$permutations_$_iter__49804_$_iter__49806(cljs.core.chunk_rest(s__49807__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49809),null);
}
} else {
var child = cljs.core.first(s__49807__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__49804_$_iter__49806(cljs.core.rest(s__49807__$2)));
}
} else {
return null;
}
...
});})(s__49805__$1,vec__49814,rose,index,xs__6385__auto__,temp__5825__auto__))
,null,null));
});})(s__49805__$1,vec__49814,rose,index,xs__6385__auto__,temp__5825__auto__))
;
var fs__5500__auto__ = cljs.core.seq(iterys__5499__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__5500__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5500__auto__,clojure$test$check$rose_tree$permutations_$_iter__49804(cljs.core.rest(s__49805__$1)));
} else {
var G__49833 = cljs.core.rest(s__49805__$1);
s__49805__$1 = G__49833;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49822_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__49822_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__49822_SHARP_));
