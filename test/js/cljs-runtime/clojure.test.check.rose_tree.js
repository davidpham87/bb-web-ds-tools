...
return cljs.core.cons(cljs.core.first(s),(function (){var G__49615 = (n - (1));
var G__49616 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__49615,G__49616) : clojure.test.check.rose_tree.exclude_nth.call(null,G__49615,G__49616));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__49619 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__49619) : f.call(null,G__49619));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49618_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__49618_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__49618_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49627_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__49627_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__49627_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__49628_SHARP_){
var G__49629 = clojure.test.check.rose_tree.root(p1__49628_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__49629) : pred.call(null,G__49629));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__5503__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__49631(s__49632){
return (new cljs.core.LazySeq(null,(function (){
var s__49632__$1 = s__49632;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__49632__$1);
if(temp__5825__auto__){
var xs__6385__auto__ = temp__5825__auto__;
var vec__49638 = cljs.core.first(xs__6385__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49638,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49638,(1),null);
var iterys__5499__auto__ = ((function (s__49632__$1,vec__49638,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__49631_$_iter__49633(s__49634){
return (new cljs.core.LazySeq(null,((function (s__49632__$1,vec__49638,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function (){
var s__49634__$1 = s__49634;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__49634__$1);
if(temp__5825__auto____$1){
var s__49634__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__49634__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__49634__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__49636 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__49635 = (0);
while(true){
if((i__49635 < size__5502__auto__)){
var child = cljs.core._nth(c__5501__auto__,i__49635);
cljs.core.chunk_append(b__49636,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__49674 = (i__49635 + (1));
i__49635 = G__49674;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49636),clojure$test$check$rose_tree$permutations_$_iter__49631_$_iter__49633(cljs.core.chunk_rest(s__49634__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49636),null);
}
} else {
var child = cljs.core.first(s__49634__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__49631_$_iter__49633(cljs.core.rest(s__49634__$2)));
}
} else {
return null;
}
...
});})(s__49632__$1,vec__49638,rose,index,xs__6385__auto__,temp__5825__auto__))
,null,null));
});})(s__49632__$1,vec__49638,rose,index,xs__6385__auto__,temp__5825__auto__))
;
var fs__5500__auto__ = cljs.core.seq(iterys__5499__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__5500__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5500__auto__,clojure$test$check$rose_tree$permutations_$_iter__49631(cljs.core.rest(s__49632__$1)));
} else {
var G__49679 = cljs.core.rest(s__49632__$1);
s__49632__$1 = G__49679;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49646_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__49646_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__49646_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49654_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__49654_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__49654_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__49655 = f;
var G__49656 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__49655,G__49656) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__49655,G__49656));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__49657 = f;
var G__49658 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__49657,G__49658) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__49657,G__49658));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {
