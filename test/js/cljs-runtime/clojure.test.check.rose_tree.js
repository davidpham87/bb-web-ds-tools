...
return cljs.core.cons(cljs.core.first(s),(function (){var G__49858 = (n - (1));
var G__49859 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__49858,G__49859) : clojure.test.check.rose_tree.exclude_nth.call(null,G__49858,G__49859));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__49868 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__49868) : f.call(null,G__49868));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49865_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__49865_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__49865_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49869_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__49869_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__49869_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__49870_SHARP_){
var G__49872 = clojure.test.check.rose_tree.root(p1__49870_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__49872) : pred.call(null,G__49872));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__5503__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__49873(s__49874){
return (new cljs.core.LazySeq(null,(function (){
var s__49874__$1 = s__49874;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__49874__$1);
if(temp__5825__auto__){
var xs__6385__auto__ = temp__5825__auto__;
var vec__49879 = cljs.core.first(xs__6385__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49879,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49879,(1),null);
var iterys__5499__auto__ = ((function (s__49874__$1,vec__49879,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__49873_$_iter__49875(s__49876){
return (new cljs.core.LazySeq(null,((function (s__49874__$1,vec__49879,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function (){
var s__49876__$1 = s__49876;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__49876__$1);
if(temp__5825__auto____$1){
var s__49876__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__49876__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__49876__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__49878 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__49877 = (0);
while(true){
if((i__49877 < size__5502__auto__)){
var child = cljs.core._nth(c__5501__auto__,i__49877);
cljs.core.chunk_append(b__49878,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__49888 = (i__49877 + (1));
i__49877 = G__49888;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49878),clojure$test$check$rose_tree$permutations_$_iter__49873_$_iter__49875(cljs.core.chunk_rest(s__49876__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49878),null);
}
} else {
var child = cljs.core.first(s__49876__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__49873_$_iter__49875(cljs.core.rest(s__49876__$2)));
}
} else {
return null;
}
...
});})(s__49874__$1,vec__49879,rose,index,xs__6385__auto__,temp__5825__auto__))
,null,null));
});})(s__49874__$1,vec__49879,rose,index,xs__6385__auto__,temp__5825__auto__))
;
var fs__5500__auto__ = cljs.core.seq(iterys__5499__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__5500__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5500__auto__,clojure$test$check$rose_tree$permutations_$_iter__49873(cljs.core.rest(s__49874__$1)));
} else {
var G__49889 = cljs.core.rest(s__49874__$1);
s__49874__$1 = G__49889;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49882_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__49882_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__49882_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49883_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__49883_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__49883_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__49884 = f;
var G__49885 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__49884,G__49885) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__49884,G__49885));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__49886 = f;
var G__49887 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__49886,G__49887) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__49886,G__49887));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {
