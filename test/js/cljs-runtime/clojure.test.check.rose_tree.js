...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49798_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__49798_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__49798_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__49799_SHARP_){
var G__49800 = clojure.test.check.rose_tree.root(p1__49799_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__49800) : pred.call(null,G__49800));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__5503__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__49801(s__49802){
return (new cljs.core.LazySeq(null,(function (){
var s__49802__$1 = s__49802;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__49802__$1);
if(temp__5825__auto__){
var xs__6385__auto__ = temp__5825__auto__;
var vec__49807 = cljs.core.first(xs__6385__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49807,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49807,(1),null);
var iterys__5499__auto__ = ((function (s__49802__$1,vec__49807,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__49801_$_iter__49803(s__49804){
return (new cljs.core.LazySeq(null,((function (s__49802__$1,vec__49807,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function (){
var s__49804__$1 = s__49804;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__49804__$1);
if(temp__5825__auto____$1){
var s__49804__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__49804__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__49804__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__49806 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__49805 = (0);
while(true){
if((i__49805 < size__5502__auto__)){
var child = cljs.core._nth(c__5501__auto__,i__49805);
cljs.core.chunk_append(b__49806,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__49852 = (i__49805 + (1));
i__49805 = G__49852;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49806),clojure$test$check$rose_tree$permutations_$_iter__49801_$_iter__49803(cljs.core.chunk_rest(s__49804__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49806),null);
}
} else {
var child = cljs.core.first(s__49804__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__49801_$_iter__49803(cljs.core.rest(s__49804__$2)));
}
} else {
return null;
}
...
});})(s__49802__$1,vec__49807,rose,index,xs__6385__auto__,temp__5825__auto__))
,null,null));
});})(s__49802__$1,vec__49807,rose,index,xs__6385__auto__,temp__5825__auto__))
;
var fs__5500__auto__ = cljs.core.seq(iterys__5499__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__5500__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5500__auto__,clojure$test$check$rose_tree$permutations_$_iter__49801(cljs.core.rest(s__49802__$1)));
} else {
var G__49853 = cljs.core.rest(s__49802__$1);
s__49802__$1 = G__49853;
continue;
}
} else {
return null;
...
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__49811_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__49811_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49819_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__49819_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__49819_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__49821 = f;
var G__49822 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__49821,G__49822) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__49821,G__49822));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__49824 = f;
var G__49825 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__49824,G__49825) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__49824,G__49825));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {
