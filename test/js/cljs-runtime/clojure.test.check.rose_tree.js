...
return cljs.core.cons(cljs.core.first(s),(function (){var G__57001 = (n - (1));
var G__57002 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__57001,G__57002) : clojure.test.check.rose_tree.exclude_nth.call(null,G__57001,G__57002));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__57007 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__57007) : f.call(null,G__57007));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57005_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__57005_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__57005_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57009_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__57009_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__57009_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57010_SHARP_){
var G__57011 = clojure.test.check.rose_tree.root(p1__57010_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__57011) : pred.call(null,G__57011));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__5503__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__57012(s__57013){
return (new cljs.core.LazySeq(null,(function (){
var s__57013__$1 = s__57013;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__57013__$1);
if(temp__5825__auto__){
var xs__6385__auto__ = temp__5825__auto__;
var vec__57019 = cljs.core.first(xs__6385__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57019,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57019,(1),null);
var iterys__5499__auto__ = ((function (s__57013__$1,vec__57019,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__57012_$_iter__57014(s__57015){
return (new cljs.core.LazySeq(null,((function (s__57013__$1,vec__57019,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function (){
var s__57015__$1 = s__57015;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__57015__$1);
if(temp__5825__auto____$1){
var s__57015__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__57015__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__57015__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__57017 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__57016 = (0);
while(true){
if((i__57016 < size__5502__auto__)){
var child = cljs.core._nth(c__5501__auto__,i__57016);
cljs.core.chunk_append(b__57017,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__57031 = (i__57016 + (1));
i__57016 = G__57031;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57017),clojure$test$check$rose_tree$permutations_$_iter__57012_$_iter__57014(cljs.core.chunk_rest(s__57015__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57017),null);
}
} else {
var child = cljs.core.first(s__57015__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__57012_$_iter__57014(cljs.core.rest(s__57015__$2)));
}
} else {
return null;
}
...
});})(s__57013__$1,vec__57019,rose,index,xs__6385__auto__,temp__5825__auto__))
,null,null));
});})(s__57013__$1,vec__57019,rose,index,xs__6385__auto__,temp__5825__auto__))
;
var fs__5500__auto__ = cljs.core.seq(iterys__5499__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__5500__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5500__auto__,clojure$test$check$rose_tree$permutations_$_iter__57012(cljs.core.rest(s__57013__$1)));
} else {
var G__57032 = cljs.core.rest(s__57013__$1);
s__57013__$1 = G__57032;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57025_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__57025_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__57025_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57026_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__57026_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__57026_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__57027 = f;
var G__57028 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__57027,G__57028) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__57027,G__57028));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__57029 = f;
var G__57030 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__57029,G__57030) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__57029,G__57030));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {
