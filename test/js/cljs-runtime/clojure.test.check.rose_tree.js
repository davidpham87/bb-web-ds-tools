...
return cljs.core.cons(cljs.core.first(s),(function (){var G__55710 = (n - (1));
var G__55712 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__55710,G__55712) : clojure.test.check.rose_tree.exclude_nth.call(null,G__55710,G__55712));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__55714 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__55714) : f.call(null,G__55714));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55713_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__55713_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__55713_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55716_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__55716_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__55716_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__55717_SHARP_){
var G__55718 = clojure.test.check.rose_tree.root(p1__55717_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__55718) : pred.call(null,G__55718));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__5503__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__55719(s__55720){
return (new cljs.core.LazySeq(null,(function (){
var s__55720__$1 = s__55720;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__55720__$1);
if(temp__5825__auto__){
var xs__6385__auto__ = temp__5825__auto__;
var vec__55725 = cljs.core.first(xs__6385__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55725,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55725,(1),null);
var iterys__5499__auto__ = ((function (s__55720__$1,vec__55725,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__55719_$_iter__55721(s__55722){
return (new cljs.core.LazySeq(null,((function (s__55720__$1,vec__55725,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function (){
var s__55722__$1 = s__55722;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__55722__$1);
if(temp__5825__auto____$1){
var s__55722__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__55722__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__55722__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__55724 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__55723 = (0);
while(true){
if((i__55723 < size__5502__auto__)){
var child = cljs.core._nth(c__5501__auto__,i__55723);
cljs.core.chunk_append(b__55724,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__55749 = (i__55723 + (1));
i__55723 = G__55749;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55724),clojure$test$check$rose_tree$permutations_$_iter__55719_$_iter__55721(cljs.core.chunk_rest(s__55722__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55724),null);
}
} else {
var child = cljs.core.first(s__55722__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__55719_$_iter__55721(cljs.core.rest(s__55722__$2)));
}
} else {
return null;
}
...
});})(s__55720__$1,vec__55725,rose,index,xs__6385__auto__,temp__5825__auto__))
,null,null));
});})(s__55720__$1,vec__55725,rose,index,xs__6385__auto__,temp__5825__auto__))
;
var fs__5500__auto__ = cljs.core.seq(iterys__5499__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__5500__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5500__auto__,clojure$test$check$rose_tree$permutations_$_iter__55719(cljs.core.rest(s__55720__$1)));
} else {
var G__55750 = cljs.core.rest(s__55720__$1);
s__55720__$1 = G__55750;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55735_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__55735_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__55735_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55738_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__55738_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__55738_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__55741 = f;
var G__55742 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__55741,G__55742) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__55741,G__55742));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__55743 = f;
var G__55744 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__55743,G__55744) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__55743,G__55744));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {
