...
clojure.test.check.clojure_test.assert_check = (function clojure$test$check$clojure_test$assert_check(p__57267){
var map__57268 = p__57267;
var map__57268__$1 = cljs.core.__destructure_map(map__57268);
var m = map__57268__$1;
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57268__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var result_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57268__$1,new cljs.core.Keyword(null,"result-data","result-data",-1724248844));
...
try{var m__56981__auto__ = m;
return clojure.test.check.clojure_test.assertions.check_results(m__56981__auto__);
 ...
 */
clojure.test.check.clojure_test.default_reporter_fn = (function clojure$test$check$clojure_test$default_reporter_fn(p__57280){
var map__57281 = p__57280;
var map__57281__$1 = cljs.core.__destructure_map(map__57281);
var args = map__57281__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57281__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__57282 = type;
...
clojure.test.check.clojure_test.get_property_name = (function clojure$test$check$clojure_test$get_property_name(p__57301){
var map__57302 = p__57301;
var map__57302__$1 = cljs.core.__destructure_map(map__57302);
var report_map = map__57302__$1;
var property_fun = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57302__$1,new cljs.core.Keyword("clojure.test.check.clojure-test","property","clojure.test.check.clojure-test/property",1356517781));
 ...
 */
clojure.test.check.clojure_test.trial_report_dots = (function clojure$test$check$clojure_test$trial_report_dots(p__57310){
var map__57311 = p__57310;
var map__57311__$1 = cljs.core.__destructure_map(map__57311);
var vec__57312 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57311__$1,new cljs.core.Keyword("clojure.test.check.clojure-test","trial","clojure.test.check.clojure-test/trial",866433060));
var so_far = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57312,(0),null);
var total = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57312,(1),null);
if((so_far > (0))){
...
var _STAR_out_STAR__orig_val__57318_57342 = cljs.core._STAR_out_STAR_;
var _STAR_out_STAR__temp_val__57320_57343 = cljs.core._STAR_out_STAR_;
(cljs.core._STAR_out_STAR_ = _STAR_out_STAR__temp_val__57320_57343);
...
}finally {(cljs.core._STAR_out_STAR_ = _STAR_out_STAR__orig_val__57318_57342);
}} else {
var begin_test_var_method_57345 = cljs.core.get_method(cljs.test.report,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"begin-test-var","begin-test-var",-908571100)], null));
...
if(cljs.core.truth_(begin_test_var_method_57345)){
return (begin_test_var_method_57345.cljs$core$IFn$_invoke$arity$1 ? begin_test_var_method_57345.cljs$core$IFn$_invoke$arity$1(m) : begin_test_var_method_57345.call(null,m));
} else {
return null;
}
}));
