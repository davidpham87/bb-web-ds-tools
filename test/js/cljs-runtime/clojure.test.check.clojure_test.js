...
clojure.test.check.clojure_test.assert_check = (function clojure$test$check$clojure_test$assert_check(p__64475){
var map__64476 = p__64475;
var map__64476__$1 = cljs.core.__destructure_map(map__64476);
var m = map__64476__$1;
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64476__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var result_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64476__$1,new cljs.core.Keyword(null,"result-data","result-data",-1724248844));
...
try{var m__64345__auto__ = m;
return clojure.test.check.clojure_test.assertions.check_results(m__64345__auto__);
}catch (e64477){var t__11416__auto__ = e64477;
 ...
 */
clojure.test.check.clojure_test.default_reporter_fn = (function clojure$test$check$clojure_test$default_reporter_fn(p__64480){
var map__64483 = p__64480;
var map__64483__$1 = cljs.core.__destructure_map(map__64483);
var args = map__64483__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64483__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__64484 = type;
var G__64484__$1 = (((G__64484 instanceof cljs.core.Keyword))?G__64484.fqn:null);
switch (G__64484__$1) {
case "complete":
...
clojure.test.check.clojure_test.get_property_name = (function clojure$test$check$clojure_test$get_property_name(p__64497){
var map__64498 = p__64497;
var map__64498__$1 = cljs.core.__destructure_map(map__64498);
var report_map = map__64498__$1;
var property_fun = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64498__$1,new cljs.core.Keyword("clojure.test.check.clojure-test","property","clojure.test.check.clojure-test/property",1356517781));
 ...
 */
clojure.test.check.clojure_test.trial_report_dots = (function clojure$test$check$clojure_test$trial_report_dots(p__64511){
var map__64512 = p__64511;
var map__64512__$1 = cljs.core.__destructure_map(map__64512);
var vec__64513 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64512__$1,new cljs.core.Keyword("clojure.test.check.clojure-test","trial","clojure.test.check.clojure-test/trial",866433060));
var so_far = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64513,(0),null);
var total = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64513,(1),null);
if((so_far > (0))){
...
var _STAR_out_STAR__orig_val__64516_64555 = cljs.core._STAR_out_STAR_;
var _STAR_out_STAR__temp_val__64517_64556 = cljs.core._STAR_out_STAR_;
(cljs.core._STAR_out_STAR_ = _STAR_out_STAR__temp_val__64517_64556);
...
}finally {(cljs.core._STAR_out_STAR_ = _STAR_out_STAR__orig_val__64516_64555);
}} else {
var begin_test_var_method_64557 = cljs.core.get_method(cljs.test.report,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"begin-test-var","begin-test-var",-908571100)], null));
...
if(cljs.core.truth_(begin_test_var_method_64557)){
return (begin_test_var_method_64557.cljs$core$IFn$_invoke$arity$1 ? begin_test_var_method_64557.cljs$core$IFn$_invoke$arity$1(m) : begin_test_var_method_64557.call(null,m));
} else {
return null;
}
}));
