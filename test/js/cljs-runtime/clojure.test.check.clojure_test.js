...
clojure.test.check.clojure_test.assert_check = (function clojure$test$check$clojure_test$assert_check(p__57173){
var map__57175 = p__57173;
var map__57175__$1 = cljs.core.__destructure_map(map__57175);
var m = map__57175__$1;
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57175__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var result_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57175__$1,new cljs.core.Keyword(null,"result-data","result-data",-1724248844));
...
try{var m__56816__auto__ = m;
return clojure.test.check.clojure_test.assertions.check_results(m__56816__auto__);
}catch (e57178){var t__11416__auto__ = e57178;
 ...
 */
clojure.test.check.clojure_test.default_reporter_fn = (function clojure$test$check$clojure_test$default_reporter_fn(p__57182){
var map__57183 = p__57182;
var map__57183__$1 = cljs.core.__destructure_map(map__57183);
var args = map__57183__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57183__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__57185 = type;
var G__57185__$1 = (((G__57185 instanceof cljs.core.Keyword))?G__57185.fqn:null);
switch (G__57185__$1) {
case "complete":
...
clojure.test.check.clojure_test.get_property_name = (function clojure$test$check$clojure_test$get_property_name(p__57191){
var map__57192 = p__57191;
var map__57192__$1 = cljs.core.__destructure_map(map__57192);
var report_map = map__57192__$1;
var property_fun = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57192__$1,new cljs.core.Keyword("clojure.test.check.clojure-test","property","clojure.test.check.clojure-test/property",1356517781));
 ...
 */
clojure.test.check.clojure_test.trial_report_dots = (function clojure$test$check$clojure_test$trial_report_dots(p__57205){
var map__57206 = p__57205;
var map__57206__$1 = cljs.core.__destructure_map(map__57206);
var vec__57207 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57206__$1,new cljs.core.Keyword("clojure.test.check.clojure-test","trial","clojure.test.check.clojure-test/trial",866433060));
var so_far = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57207,(0),null);
var total = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57207,(1),null);
if((so_far > (0))){
...
var _STAR_out_STAR__orig_val__57214_57243 = cljs.core._STAR_out_STAR_;
var _STAR_out_STAR__temp_val__57215_57244 = cljs.core._STAR_out_STAR_;
(cljs.core._STAR_out_STAR_ = _STAR_out_STAR__temp_val__57215_57244);
...
}finally {(cljs.core._STAR_out_STAR_ = _STAR_out_STAR__orig_val__57214_57243);
}} else {
var begin_test_var_method_57245 = cljs.core.get_method(cljs.test.report,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"begin-test-var","begin-test-var",-908571100)], null));
...
if(cljs.core.truth_(begin_test_var_method_57245)){
return (begin_test_var_method_57245.cljs$core$IFn$_invoke$arity$1 ? begin_test_var_method_57245.cljs$core$IFn$_invoke$arity$1(m) : begin_test_var_method_57245.call(null,m));
} else {
return null;
}
}));
