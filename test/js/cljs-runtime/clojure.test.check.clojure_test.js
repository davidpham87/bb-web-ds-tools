...
try{var m__56915__auto__ = m;
return clojure.test.check.clojure_test.assertions.check_results(m__56915__auto__);
}catch (e57212){var t__11416__auto__ = e57212;
 ...
 */
clojure.test.check.clojure_test.default_reporter_fn = (function clojure$test$check$clojure_test$default_reporter_fn(p__57220){
var map__57222 = p__57220;
var map__57222__$1 = cljs.core.__destructure_map(map__57222);
var args = map__57222__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57222__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__57225 = type;
var G__57225__$1 = (((G__57225 instanceof cljs.core.Keyword))?G__57225.fqn:null);
switch (G__57225__$1) {
case "complete":
...
clojure.test.check.clojure_test.get_property_name = (function clojure$test$check$clojure_test$get_property_name(p__57231){
var map__57232 = p__57231;
var map__57232__$1 = cljs.core.__destructure_map(map__57232);
var report_map = map__57232__$1;
var property_fun = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57232__$1,new cljs.core.Keyword("clojure.test.check.clojure-test","property","clojure.test.check.clojure-test/property",1356517781));
 ...
 */
clojure.test.check.clojure_test.trial_report_dots = (function clojure$test$check$clojure_test$trial_report_dots(p__57239){
var map__57240 = p__57239;
var map__57240__$1 = cljs.core.__destructure_map(map__57240);
var vec__57241 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57240__$1,new cljs.core.Keyword("clojure.test.check.clojure-test","trial","clojure.test.check.clojure-test/trial",866433060));
var so_far = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57241,(0),null);
var total = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57241,(1),null);
if((so_far > (0))){
...
var _STAR_out_STAR__orig_val__57245_57248 = cljs.core._STAR_out_STAR_;
var _STAR_out_STAR__temp_val__57246_57249 = cljs.core._STAR_out_STAR_;
(cljs.core._STAR_out_STAR_ = _STAR_out_STAR__temp_val__57246_57249);
...
}finally {(cljs.core._STAR_out_STAR_ = _STAR_out_STAR__orig_val__57245_57248);
}} else {
var begin_test_var_method_57250 = cljs.core.get_method(cljs.test.report,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"begin-test-var","begin-test-var",-908571100)], null));
...
if(cljs.core.truth_(begin_test_var_method_57250)){
return (begin_test_var_method_57250.cljs$core$IFn$_invoke$arity$1 ? begin_test_var_method_57250.cljs$core$IFn$_invoke$arity$1(m) : begin_test_var_method_57250.call(null,m));
} else {
return null;
}
}));
