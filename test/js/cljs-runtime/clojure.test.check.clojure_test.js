...
clojure.test.check.clojure_test.assert_check = (function clojure$test$check$clojure_test$assert_check(p__64297){
var map__64298 = p__64297;
var map__64298__$1 = cljs.core.__destructure_map(map__64298);
var m = map__64298__$1;
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64298__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var result_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64298__$1,new cljs.core.Keyword(null,"result-data","result-data",-1724248844));
...
try{var m__64177__auto__ = m;
return clojure.test.check.clojure_test.assertions.check_results(m__64177__auto__);
}catch (e64299){var t__11416__auto__ = e64299;
 ...
 */
clojure.test.check.clojure_test.default_reporter_fn = (function clojure$test$check$clojure_test$default_reporter_fn(p__64302){
var map__64303 = p__64302;
var map__64303__$1 = cljs.core.__destructure_map(map__64303);
var args = map__64303__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64303__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__64304 = type;
...
clojure.test.check.clojure_test.get_property_name = (function clojure$test$check$clojure_test$get_property_name(p__64315){
var map__64316 = p__64315;
var map__64316__$1 = cljs.core.__destructure_map(map__64316);
var report_map = map__64316__$1;
var property_fun = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64316__$1,new cljs.core.Keyword("clojure.test.check.clojure-test","property","clojure.test.check.clojure-test/property",1356517781));
 ...
 */
clojure.test.check.clojure_test.trial_report_dots = (function clojure$test$check$clojure_test$trial_report_dots(p__64327){
var map__64331 = p__64327;
var map__64331__$1 = cljs.core.__destructure_map(map__64331);
var vec__64332 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64331__$1,new cljs.core.Keyword("clojure.test.check.clojure-test","trial","clojure.test.check.clojure-test/trial",866433060));
var so_far = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64332,(0),null);
var total = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64332,(1),null);
if((so_far > (0))){
...
var _STAR_out_STAR__orig_val__64338_64370 = cljs.core._STAR_out_STAR_;
var _STAR_out_STAR__temp_val__64339_64371 = cljs.core._STAR_out_STAR_;
(cljs.core._STAR_out_STAR_ = _STAR_out_STAR__temp_val__64339_64371);
...
}finally {(cljs.core._STAR_out_STAR_ = _STAR_out_STAR__orig_val__64338_64370);
}} else {
var begin_test_var_method_64372 = cljs.core.get_method(cljs.test.report,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"begin-test-var","begin-test-var",-908571100)], null));
...
if(cljs.core.truth_(begin_test_var_method_64372)){
return (begin_test_var_method_64372.cljs$core$IFn$_invoke$arity$1 ? begin_test_var_method_64372.cljs$core$IFn$_invoke$arity$1(m) : begin_test_var_method_64372.call(null,m));
} else {
return null;
}
}));
