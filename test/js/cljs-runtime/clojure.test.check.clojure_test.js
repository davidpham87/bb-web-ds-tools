...
clojure.test.check.clojure_test.assert_check = (function clojure$test$check$clojure_test$assert_check(p__57307){
var map__57308 = p__57307;
var map__57308__$1 = cljs.core.__destructure_map(map__57308);
var m = map__57308__$1;
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57308__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var result_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57308__$1,new cljs.core.Keyword(null,"result-data","result-data",-1724248844));
...
try{var m__57001__auto__ = m;
return clojure.test.check.clojure_test.assertions.check_results(m__57001__auto__);
}catch (e57314){var t__11416__auto__ = e57314;
 ...
 */
clojure.test.check.clojure_test.default_reporter_fn = (function clojure$test$check$clojure_test$default_reporter_fn(p__57318){
var map__57320 = p__57318;
var map__57320__$1 = cljs.core.__destructure_map(map__57320);
var args = map__57320__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57320__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__57321 = type;
...
clojure.test.check.clojure_test.get_property_name = (function clojure$test$check$clojure_test$get_property_name(p__57340){
var map__57341 = p__57340;
var map__57341__$1 = cljs.core.__destructure_map(map__57341);
var report_map = map__57341__$1;
var property_fun = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57341__$1,new cljs.core.Keyword("clojure.test.check.clojure-test","property","clojure.test.check.clojure-test/property",1356517781));
 ...
 */
clojure.test.check.clojure_test.trial_report_dots = (function clojure$test$check$clojure_test$trial_report_dots(p__57356){
var map__57358 = p__57356;
var map__57358__$1 = cljs.core.__destructure_map(map__57358);
var vec__57359 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57358__$1,new cljs.core.Keyword("clojure.test.check.clojure-test","trial","clojure.test.check.clojure-test/trial",866433060));
var so_far = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57359,(0),null);
var total = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57359,(1),null);
if((so_far > (0))){
...
var _STAR_out_STAR__orig_val__57364_57379 = cljs.core._STAR_out_STAR_;
var _STAR_out_STAR__temp_val__57365_57380 = cljs.core._STAR_out_STAR_;
(cljs.core._STAR_out_STAR_ = _STAR_out_STAR__temp_val__57365_57380);
...
}finally {(cljs.core._STAR_out_STAR_ = _STAR_out_STAR__orig_val__57364_57379);
}} else {
var begin_test_var_method_57381 = cljs.core.get_method(cljs.test.report,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"begin-test-var","begin-test-var",-908571100)], null));
...
if(cljs.core.truth_(begin_test_var_method_57381)){
return (begin_test_var_method_57381.cljs$core$IFn$_invoke$arity$1 ? begin_test_var_method_57381.cljs$core$IFn$_invoke$arity$1(m) : begin_test_var_method_57381.call(null,m));
} else {
return null;
}
}));
