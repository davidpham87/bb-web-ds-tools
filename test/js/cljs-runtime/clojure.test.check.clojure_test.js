...
clojure.test.check.clojure_test.assert_check = (function clojure$test$check$clojure_test$assert_check(p__57283){
var map__57284 = p__57283;
var map__57284__$1 = cljs.core.__destructure_map(map__57284);
var m = map__57284__$1;
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57284__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var result_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57284__$1,new cljs.core.Keyword(null,"result-data","result-data",-1724248844));
...
try{var m__57152__auto__ = m;
return clojure.test.check.clojure_test.assertions.check_results(m__57152__auto__);
}catch (e57288){var t__11416__auto__ = e57288;
 ...
 */
clojure.test.check.clojure_test.default_reporter_fn = (function clojure$test$check$clojure_test$default_reporter_fn(p__57291){
var map__57292 = p__57291;
var map__57292__$1 = cljs.core.__destructure_map(map__57292);
var args = map__57292__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57292__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__57294 = type;
var G__57294__$1 = (((G__57294 instanceof cljs.core.Keyword))?G__57294.fqn:null);
switch (G__57294__$1) {
case "complete":
 ...
 */
clojure.test.check.clojure_test.trial_report_dots = (function clojure$test$check$clojure_test$trial_report_dots(p__57306){
var map__57307 = p__57306;
var map__57307__$1 = cljs.core.__destructure_map(map__57307);
var vec__57308 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57307__$1,new cljs.core.Keyword("clojure.test.check.clojure-test","trial","clojure.test.check.clojure-test/trial",866433060));
var so_far = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57308,(0),null);
var total = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57308,(1),null);
if((so_far > (0))){
...
var _STAR_out_STAR__orig_val__57314_57344 = cljs.core._STAR_out_STAR_;
var _STAR_out_STAR__temp_val__57315_57345 = cljs.core._STAR_out_STAR_;
(cljs.core._STAR_out_STAR_ = _STAR_out_STAR__temp_val__57315_57345);
...
}finally {(cljs.core._STAR_out_STAR_ = _STAR_out_STAR__orig_val__57314_57344);
}} else {
var begin_test_var_method_57348 = cljs.core.get_method(cljs.test.report,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"begin-test-var","begin-test-var",-908571100)], null));
...
if(cljs.core.truth_(begin_test_var_method_57348)){
return (begin_test_var_method_57348.cljs$core$IFn$_invoke$arity$1 ? begin_test_var_method_57348.cljs$core$IFn$_invoke$arity$1(m) : begin_test_var_method_57348.call(null,m));
} else {
return null;
}
}));
