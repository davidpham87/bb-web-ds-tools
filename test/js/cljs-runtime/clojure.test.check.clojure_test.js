...
clojure.test.check.clojure_test.assert_check = (function clojure$test$check$clojure_test$assert_check(p__65122){
var map__65123 = p__65122;
var map__65123__$1 = cljs.core.__destructure_map(map__65123);
var m = map__65123__$1;
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65123__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var result_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65123__$1,new cljs.core.Keyword(null,"result-data","result-data",-1724248844));
...
try{var m__64927__auto__ = m;
return clojure.test.check.clojure_test.assertions.check_results(m__64927__auto__);
}catch (e65125){var t__11416__auto__ = e65125;
 ...
 */
clojure.test.check.clojure_test.default_reporter_fn = (function clojure$test$check$clojure_test$default_reporter_fn(p__65127){
var map__65128 = p__65127;
var map__65128__$1 = cljs.core.__destructure_map(map__65128);
var args = map__65128__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65128__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__65129 = type;
var G__65129__$1 = (((G__65129 instanceof cljs.core.Keyword))?G__65129.fqn:null);
switch (G__65129__$1) {
case "complete":
...
clojure.test.check.clojure_test.get_property_name = (function clojure$test$check$clojure_test$get_property_name(p__65140){
var map__65141 = p__65140;
var map__65141__$1 = cljs.core.__destructure_map(map__65141);
var report_map = map__65141__$1;
var property_fun = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65141__$1,new cljs.core.Keyword("clojure.test.check.clojure-test","property","clojure.test.check.clojure-test/property",1356517781));
 ...
 */
clojure.test.check.clojure_test.trial_report_dots = (function clojure$test$check$clojure_test$trial_report_dots(p__65142){
var map__65143 = p__65142;
var map__65143__$1 = cljs.core.__destructure_map(map__65143);
var vec__65144 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65143__$1,new cljs.core.Keyword("clojure.test.check.clojure-test","trial","clojure.test.check.clojure-test/trial",866433060));
var so_far = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65144,(0),null);
var total = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65144,(1),null);
if((so_far > (0))){
...
var _STAR_out_STAR__orig_val__65147_65155 = cljs.core._STAR_out_STAR_;
var _STAR_out_STAR__temp_val__65148_65156 = cljs.core._STAR_out_STAR_;
(cljs.core._STAR_out_STAR_ = _STAR_out_STAR__temp_val__65148_65156);
...
}finally {(cljs.core._STAR_out_STAR_ = _STAR_out_STAR__orig_val__65147_65155);
}} else {
var begin_test_var_method_65157 = cljs.core.get_method(cljs.test.report,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"begin-test-var","begin-test-var",-908571100)], null));
...
if(cljs.core.truth_(begin_test_var_method_65157)){
return (begin_test_var_method_65157.cljs$core$IFn$_invoke$arity$1 ? begin_test_var_method_65157.cljs$core$IFn$_invoke$arity$1(m) : begin_test_var_method_65157.call(null,m));
} else {
return null;
}
}));
