...
var c__5501__auto__ = cljs.core.chunk_first(s__39569__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__39571 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__39570 = (0);
while(true){
if((i__39570 < size__5502__auto__)){
var child = cljs.core._nth(c__5501__auto__,i__39570);
cljs.core.chunk_append(b__39571,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),["pl-10 pr-4 py-2 text-sm cursor-pointer hover:bg-[#3f3f3f] transition-colors ",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(active_id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(child)))?"bg-[#3f3f3f] text-[#f0dfaf]":null)].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__39570,child,c__5501__auto__,size__5502__auto__,b__39571,s__39569__$2,temp__5825__auto__,has_children_QMARK_,expanded_QMARK_,active_QMARK_,map__39565,map__39565__$1,item,active_id,expanded_ids,on_select,on_toggle){
return (function (){
var G__39572 = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(child);
return (on_select.cljs$core$IFn$_invoke$arity$1 ? on_select.cljs$core$IFn$_invoke$arity$1(G__39572) : on_select.call(null,G__39572));
});})(i__39570,child,c__5501__auto__,size__5502__auto__,b__39571,s__39569__$2,temp__5825__auto__,has_children_QMARK_,expanded_QMARK_,active_QMARK_,map__39565,map__39565__$1,item,active_id,expanded_ids,on_select,on_toggle))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__39571),bb_web_ds_tools$views$settings$sidebar_item_$_iter__39568(cljs.core.chunk_rest(s__39569__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__39571),null);
}
} else {
var child = cljs.core.first(s__39569__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),["pl-10 pr-4 py-2 text-sm cursor-pointer hover:bg-[#3f3f3f] transition-colors ",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(active_id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(child)))?"bg-[#3f3f3f] text-[#f0dfaf]":null)].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (child,s__39569__$2,temp__5825__auto__,has_children_QMARK_,expanded_QMARK_,active_QMARK_,map__39565,map__39565__$1,item,active_id,expanded_ids,on_select,on_toggle){
return (function (){
var G__39573 = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(child);
return (on_select.cljs$core$IFn$_invoke$arity$1 ? on_select.cljs$core$IFn$_invoke$arity$1(G__39573) : on_select.call(null,G__39573));
});})(child,s__39569__$2,temp__5825__auto__,has_children_QMARK_,expanded_QMARK_,active_QMARK_,map__39565,map__39565__$1,item,active_id,expanded_ids,on_select,on_toggle))
], null),new cljs.core.Keyword(null,"label","label",1718410804).cljs$core$IFn$_invoke$arity$1(child)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(child)], null)),bb_web_ds_tools$views$settings$sidebar_item_$_iter__39568(cljs.core.rest(s__39569__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__39583),bb_web_ds_tools$views$settings$general_settings_$_iter__39580(cljs.core.chunk_rest(s__39581__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__39583),null);
}
} else {
var theme_name = cljs.core.first(s__39581__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.name(theme_name)], null),cljs.core.name(theme_name)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),theme_name], null)),bb_web_ds_tools$views$settings$general_settings_$_iter__39580(cljs.core.rest(s__39581__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__39619),bb_web_ds_tools$views$settings$dataset_import_settings_$_iter__39616(cljs.core.chunk_rest(s__39617__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__39619),null);
}
} else {
var c = cljs.core.first(s__39617__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.name(c)], null),cljs.core.name(c)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),c], null)),bb_web_ds_tools$views$settings$dataset_import_settings_$_iter__39616(cljs.core.rest(s__39617__$2)));
}
} else {
return null;
}
...
})()], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"mt-4"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"block text-sm font-medium mb-2"], null),"Default Column Name Type"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"select","select",1147833503),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),"bg-[#3f3f3f] text-white rounded px-3 py-2 w-full max-w-xs border border-[#4f4f4f] focus:outline-none focus:border-[#8cd0d3]",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.name(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(col_norm)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__39590_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.events.settings","set-column-normalizer-output","bb-web-ds-tools.events.settings/set-column-normalizer-output",-483881870),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(p1__39590_SHARP_.target.value)], null));
})], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$settings$dataset_import_settings_$_iter__39658(s__39659){
return (new cljs.core.LazySeq(null,(function (){
var s__39659__$1 = s__39659;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__39659__$1);
if(temp__5825__auto__){
var s__39659__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__39659__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__39659__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__39661 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__39660 = (0);
while(true){
if((i__39660 < size__5502__auto__)){
var o = cljs.core._nth(c__5501__auto__,i__39660);
cljs.core.chunk_append(b__39661,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.name(o)], null),cljs.core.name(o)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),o], null)));

var G__39773 = (i__39660 + (1));
i__39660 = G__39773;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__39661),bb_web_ds_tools$views$settings$dataset_import_settings_$_iter__39658(cljs.core.chunk_rest(s__39659__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__39661),null);
}
} else {
var o = cljs.core.first(s__39659__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.name(o)], null),cljs.core.name(o)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),o], null)),bb_web_ds_tools$views$settings$dataset_import_settings_$_iter__39658(cljs.core.rest(s__39659__$2)));
}
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"p-6 h-full overflow-y-auto"], null),(function (){var G__39681 = active_view;
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.split_view,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ratio","ratio",-926560044),new cljs.core.Keyword(null,"1-3","1-3",-870297994)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"h-full bg-[#2b2b2b] border-r border-[#3f3f3f] overflow-y-auto py-4"], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex items-center justify-between px-4 mb-4"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h2","h2",-372662728),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-xl font-bold text-[#dcdccc]"], null),"Settings"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.help_button,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"href","href",-793805698),bb_web_ds_tools.components.navigation.get_wiki_url(new cljs.core.Keyword(null,"settings","settings",1556144875)),new cljs.core.Keyword(null,"title","title",636505583),"Help: Settings",new cljs.core.Keyword(null,"class","class",-2030961996),"!p-1 !w-5 !h-5 opacity-50 hover:opacity-100"], null)], null)], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$settings$panel_$_iter__39696(s__39697){
return (new cljs.core.LazySeq(null,(function (){
var s__39697__$1 = s__39697;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__39697__$1);
if(temp__5825__auto__){
var s__39697__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__39697__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__39697__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__39699 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__39698 = (0);
while(true){
if((i__39698 < size__5502__auto__)){
var item = cljs.core._nth(c__5501__auto__,i__39698);
cljs.core.chunk_append(b__39699,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.settings.sidebar_item,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"item","item",249373802),item,new cljs.core.Keyword(null,"active-id","active-id",-59238656),active_view,new cljs.core.Keyword(null,"expanded-ids","expanded-ids",-1743520102),expanded_views,new cljs.core.Keyword(null,"on-select","on-select",-192407950),((function (i__39698,item,c__5501__auto__,size__5502__auto__,b__39699,s__39697__$2,temp__5825__auto__,active_view,expanded_views){
return (function (p1__39682_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.events.settings","set-active-view","bb-web-ds-tools.events.settings/set-active-view",-39580680),p1__39682_SHARP_], null));
});})(i__39698,item,c__5501__auto__,size__5502__auto__,b__39699,s__39697__$2,temp__5825__auto__,active_view,expanded_views))
,new cljs.core.Keyword(null,"on-toggle","on-toggle",-695538774),((function (i__39698,item,c__5501__auto__,size__5502__auto__,b__39699,s__39697__$2,temp__5825__auto__,active_view,expanded_views){
return (function (p1__39683_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.events.settings","toggle-expanded-view","bb-web-ds-tools.events.settings/toggle-expanded-view",1939359027),p1__39683_SHARP_], null));
});})(i__39698,item,c__5501__auto__,size__5502__auto__,b__39699,s__39697__$2,temp__5825__auto__,active_view,expanded_views))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__39699),bb_web_ds_tools$views$settings$panel_$_iter__39696(cljs.core.chunk_rest(s__39697__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__39699),null);
}
} else {
var item = cljs.core.first(s__39697__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.settings.sidebar_item,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"item","item",249373802),item,new cljs.core.Keyword(null,"active-id","active-id",-59238656),active_view,new cljs.core.Keyword(null,"expanded-ids","expanded-ids",-1743520102),expanded_views,new cljs.core.Keyword(null,"on-select","on-select",-192407950),((function (item,s__39697__$2,temp__5825__auto__,active_view,expanded_views){
return (function (p1__39682_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.events.settings","set-active-view","bb-web-ds-tools.events.settings/set-active-view",-39580680),p1__39682_SHARP_], null));
});})(item,s__39697__$2,temp__5825__auto__,active_view,expanded_views))
,new cljs.core.Keyword(null,"on-toggle","on-toggle",-695538774),((function (item,s__39697__$2,temp__5825__auto__,active_view,expanded_views){
return (function (p1__39683_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.events.settings","toggle-expanded-view","bb-web-ds-tools.events.settings/toggle-expanded-view",1939359027),p1__39683_SHARP_], null));
});})(item,s__39697__$2,temp__5825__auto__,active_view,expanded_views))
], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item)], null)),bb_web_ds_tools$views$settings$panel_$_iter__39696(cljs.core.rest(s__39697__$2)));
}
} else {
return null;
}
