...
var fexpr__54587 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__54587.cljs$core$IFn$_invoke$arity$1 ? fexpr__54587.cljs$core$IFn$_invoke$arity$1(type) : fexpr__54587.call(null,type));
});
...
var G__54596 = spec_tools.impl.normalize_symbol(x);
var G__54597 = null;
var G__54598 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__54596,G__54597,G__54598) : spec_tools.parse.parse_form.call(null,G__54596,G__54597,G__54598));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__54599 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__54600 = x;
var G__54601 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__54599,G__54600,G__54601) : spec_tools.parse.parse_form.call(null,G__54599,G__54600,G__54601));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__54716 = cljs.spec.alpha.form(x);
var G__54717 = options;
x = G__54716;
options = G__54717;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__54602 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__54603 = null;
var G__54629 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__54602,G__54603,G__54629) : spec_tools.parse.parse_form.call(null,G__54602,G__54603,G__54629));
} else {
...
var G__54630 = parse_data;
var G__54630__$1 = (((G__54630 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__54630));
var G__54630__$2 = (((G__54630__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__54630__$1));
var G__54630__$3 = (((G__54630__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__54630__$2));
var G__54630__$4 = (((G__54630__$3 == null))?null:cljs.core.seq(G__54630__$3));
if((G__54630__$4 == null)){
return null;
} else {
return cljs.core.set(G__54630__$4);
}
}
});
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__54633 = cljs.core.get_global_hierarchy;
return (fexpr__54633.cljs$core$IFn$_invoke$arity$0 ? fexpr__54633.cljs$core$IFn$_invoke$arity$0() : fexpr__54633.call(null));
})());
...
var map__54674 = spec_tools.impl.parse_keys(form);
var map__54674__$1 = cljs.core.__destructure_map(map__54674);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54674__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54674__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54674__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54674__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54674__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__54675 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__54675__$1 = (cljs.core.truth_((function (){var or__5025__auto__ = req;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54675,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__54675);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54675__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__54675__$1;
}
}));
...
var vec__54676 = multi_spec_form;
var seq__54677 = cljs.core.seq(vec__54676);
var first__54678 = cljs.core.first(seq__54677);
var seq__54677__$1 = cljs.core.next(seq__54677);
var _ = first__54678;
var first__54678__$1 = cljs.core.first(seq__54677__$1);
var seq__54677__$2 = cljs.core.next(seq__54677__$1);
var multi_method_symbol = first__54678__$1;
var ___$1 = seq__54677__$2;
var form = vec__54676;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__54679){
var vec__54680 = p__54679;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54680,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54680,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__54686_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__54686_SHARP_,options);
...
var type_priority = (function (p1__54703_SHARP_){
var G__54706 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__54705 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__54703_SHARP_);
return (fexpr__54705.cljs$core$IFn$_invoke$arity$1 ? fexpr__54705.cljs$core$IFn$_invoke$arity$1(G__54706) : fexpr__54705.call(null,G__54706));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54704_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__54704_SHARP_,options);
}),cljs.core.rest(form))));
}));
