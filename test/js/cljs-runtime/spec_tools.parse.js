...
var fexpr__54650 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__54650.cljs$core$IFn$_invoke$arity$1 ? fexpr__54650.cljs$core$IFn$_invoke$arity$1(type) : fexpr__54650.call(null,type));
});
...
var G__54659 = spec_tools.impl.normalize_symbol(x);
var G__54660 = null;
var G__54661 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__54659,G__54660,G__54661) : spec_tools.parse.parse_form.call(null,G__54659,G__54660,G__54661));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__54666 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__54667 = x;
var G__54668 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__54666,G__54667,G__54668) : spec_tools.parse.parse_form.call(null,G__54666,G__54667,G__54668));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__54721 = cljs.spec.alpha.form(x);
var G__54722 = options;
x = G__54721;
options = G__54722;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__54669 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__54670 = null;
var G__54671 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__54669,G__54670,G__54671) : spec_tools.parse.parse_form.call(null,G__54669,G__54670,G__54671));
} else {
...
var G__54672 = parse_data;
var G__54672__$1 = (((G__54672 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__54672));
var G__54672__$2 = (((G__54672__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__54672__$1));
var G__54672__$3 = (((G__54672__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__54672__$2));
var G__54672__$4 = (((G__54672__$3 == null))?null:cljs.core.seq(G__54672__$3));
if((G__54672__$4 == null)){
return null;
} else {
return cljs.core.set(G__54672__$4);
}
}
});
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__54673 = cljs.core.get_global_hierarchy;
return (fexpr__54673.cljs$core$IFn$_invoke$arity$0 ? fexpr__54673.cljs$core$IFn$_invoke$arity$0() : fexpr__54673.call(null));
})());
...
var map__54690 = spec_tools.impl.parse_keys(form);
var map__54690__$1 = cljs.core.__destructure_map(map__54690);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54690__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54690__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54690__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54690__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54690__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__54691 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__54691__$1 = (cljs.core.truth_((function (){var or__5025__auto__ = req;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54691,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__54691);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54691__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__54691__$1;
}
}));
...
var vec__54692 = multi_spec_form;
...
var multi_method_symbol = first__54694__$1;
var ___$1 = seq__54693__$2;
var form = vec__54692;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__54695){
var vec__54696 = p__54695;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54696,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54696,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__54699_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__54699_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54700_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__54700_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__54702_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__54702_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54703_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__54703_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__54704 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__54704__$1 = cljs.core.__destructure_map(map__54704);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54704__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__54705 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__54705__$1 = cljs.core.__destructure_map(map__54705);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54705__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__54706,options){
var vec__54707 = p__54706;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54707,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54707,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54707,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__54711,options){
var vec__54712 = p__54711;
var seq__54713 = cljs.core.seq(vec__54712);
var first__54714 = cljs.core.first(seq__54713);
var seq__54713__$1 = cljs.core.next(seq__54713);
var ___$1 = first__54714;
var values = seq__54713__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54710_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__54710_SHARP_,options);
}),values);
...
var type_priority = (function (p1__54716_SHARP_){
var G__54719 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__54718 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__54716_SHARP_);
return (fexpr__54718.cljs$core$IFn$_invoke$arity$1 ? fexpr__54718.cljs$core$IFn$_invoke$arity$1(G__54719) : fexpr__54718.call(null,G__54719));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54717_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__54717_SHARP_,options);
}),cljs.core.rest(form))));
}));
