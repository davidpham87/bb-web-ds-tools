...
var fexpr__54417 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__54417.cljs$core$IFn$_invoke$arity$1 ? fexpr__54417.cljs$core$IFn$_invoke$arity$1(type) : fexpr__54417.call(null,type));
});
...
var G__54439 = spec_tools.impl.normalize_symbol(x);
var G__54440 = null;
var G__54441 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__54439,G__54440,G__54441) : spec_tools.parse.parse_form.call(null,G__54439,G__54440,G__54441));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__54442 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__54443 = x;
var G__54444 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__54442,G__54443,G__54444) : spec_tools.parse.parse_form.call(null,G__54442,G__54443,G__54444));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__54546 = cljs.spec.alpha.form(x);
var G__54547 = options;
x = G__54546;
options = G__54547;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__54445 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__54446 = null;
var G__54447 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__54445,G__54446,G__54447) : spec_tools.parse.parse_form.call(null,G__54445,G__54446,G__54447));
} else {
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__54467 = cljs.core.get_global_hierarchy;
return (fexpr__54467.cljs$core$IFn$_invoke$arity$0 ? fexpr__54467.cljs$core$IFn$_invoke$arity$0() : fexpr__54467.call(null));
})());
...
var map__54513 = spec_tools.impl.parse_keys(form);
var map__54513__$1 = cljs.core.__destructure_map(map__54513);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54513__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54513__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54513__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54513__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54513__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__54514 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__54514__$1 = (cljs.core.truth_((function (){var or__5025__auto__ = req;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54514,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__54514);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54514__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__54514__$1;
}
}));
...
var vec__54515 = multi_spec_form;
var seq__54516 = cljs.core.seq(vec__54515);
var first__54517 = cljs.core.first(seq__54516);
var seq__54516__$1 = cljs.core.next(seq__54516);
var _ = first__54517;
var first__54517__$1 = cljs.core.first(seq__54516__$1);
var seq__54516__$2 = cljs.core.next(seq__54516__$1);
var multi_method_symbol = first__54517__$1;
var ___$1 = seq__54516__$2;
var form = vec__54515;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__54518){
var vec__54519 = p__54518;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54519,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54519,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__54523_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__54523_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54525_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__54525_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__54526_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__54526_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54527_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__54527_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__54528 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__54528__$1 = cljs.core.__destructure_map(map__54528);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54528__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__54531 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__54531__$1 = cljs.core.__destructure_map(map__54531);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54531__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__54532,options){
var vec__54533 = p__54532;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54533,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54533,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54533,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__54537,options){
var vec__54538 = p__54537;
var seq__54539 = cljs.core.seq(vec__54538);
var first__54540 = cljs.core.first(seq__54539);
var seq__54539__$1 = cljs.core.next(seq__54539);
var ___$1 = first__54540;
var values = seq__54539__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54536_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__54536_SHARP_,options);
}),values);
...
var type_priority = (function (p1__54541_SHARP_){
var G__54544 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__54543 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__54541_SHARP_);
return (fexpr__54543.cljs$core$IFn$_invoke$arity$1 ? fexpr__54543.cljs$core$IFn$_invoke$arity$1(G__54544) : fexpr__54543.call(null,G__54544));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54542_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__54542_SHARP_,options);
}),cljs.core.rest(form))));
}));
