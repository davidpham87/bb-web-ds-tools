...
var G__61800 = spec_tools.impl.normalize_symbol(x);
var G__61801 = null;
...
var G__61804 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__61805 = x;
var G__61806 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__61804,G__61805,G__61806) : spec_tools.parse.parse_form.call(null,G__61804,G__61805,G__61806));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__61914 = cljs.spec.alpha.form(x);
var G__61915 = options;
x = G__61914;
options = G__61915;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__61807 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__61808 = null;
var G__61809 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__61807,G__61808,G__61809) : spec_tools.parse.parse_form.call(null,G__61807,G__61808,G__61809));
} else {
...
var G__61831 = parse_data;
var G__61831__$1 = (((G__61831 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__61831));
var G__61831__$2 = (((G__61831__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__61831__$1));
var G__61831__$3 = (((G__61831__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__61831__$2));
var G__61831__$4 = (((G__61831__$3 == null))?null:cljs.core.seq(G__61831__$3));
if((G__61831__$4 == null)){
return null;
} else {
return cljs.core.set(G__61831__$4);
}
}
});
...
var map__61878 = spec_tools.impl.parse_keys(form);
var map__61878__$1 = cljs.core.__destructure_map(map__61878);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61878__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61878__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61878__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61878__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61878__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__61879 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__61879__$1 = (cljs.core.truth_((function (){var or__5025__auto__ = req;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61879,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__61879);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61879__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__61879__$1;
}
}));
...
var vec__61882 = multi_spec_form;
var seq__61883 = cljs.core.seq(vec__61882);
var first__61884 = cljs.core.first(seq__61883);
var seq__61883__$1 = cljs.core.next(seq__61883);
var _ = first__61884;
var first__61884__$1 = cljs.core.first(seq__61883__$1);
var seq__61883__$2 = cljs.core.next(seq__61883__$1);
var multi_method_symbol = first__61884__$1;
var ___$1 = seq__61883__$2;
var form = vec__61882;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__61885){
var vec__61886 = p__61885;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61886,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61886,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__61891_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__61891_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__61892_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__61892_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__61893_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__61893_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61894_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__61894_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__61897,options){
var vec__61898 = p__61897;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61898,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61898,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61898,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__61902,options){
var vec__61903 = p__61902;
var seq__61904 = cljs.core.seq(vec__61903);
var first__61905 = cljs.core.first(seq__61904);
var seq__61904__$1 = cljs.core.next(seq__61904);
var ___$1 = first__61905;
var values = seq__61904__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__61901_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__61901_SHARP_,options);
}),values);
...
var type_priority = (function (p1__61906_SHARP_){
var G__61909 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__61908 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__61906_SHARP_);
return (fexpr__61908.cljs$core$IFn$_invoke$arity$1 ? fexpr__61908.cljs$core$IFn$_invoke$arity$1(G__61909) : fexpr__61908.call(null,G__61909));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61907_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__61907_SHARP_,options);
}),cljs.core.rest(form))));
}));
