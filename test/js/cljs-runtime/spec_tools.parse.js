...
var fexpr__61377 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__61377.cljs$core$IFn$_invoke$arity$1 ? fexpr__61377.cljs$core$IFn$_invoke$arity$1(type) : fexpr__61377.call(null,type));
});
...
var G__61407 = spec_tools.impl.normalize_symbol(x);
var G__61408 = null;
var G__61409 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__61407,G__61408,G__61409) : spec_tools.parse.parse_form.call(null,G__61407,G__61408,G__61409));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__61410 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__61411 = x;
var G__61412 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__61410,G__61411,G__61412) : spec_tools.parse.parse_form.call(null,G__61410,G__61411,G__61412));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__61502 = cljs.spec.alpha.form(x);
var G__61503 = options;
x = G__61502;
options = G__61503;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__61415 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__61416 = null;
var G__61417 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__61415,G__61416,G__61417) : spec_tools.parse.parse_form.call(null,G__61415,G__61416,G__61417));
} else {
...
var G__61450 = parse_data;
var G__61450__$1 = (((G__61450 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__61450));
var G__61450__$2 = (((G__61450__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__61450__$1));
var G__61450__$3 = (((G__61450__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__61450__$2));
var G__61450__$4 = (((G__61450__$3 == null))?null:cljs.core.seq(G__61450__$3));
if((G__61450__$4 == null)){
return null;
} else {
return cljs.core.set(G__61450__$4);
}
}
});
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__61453 = cljs.core.get_global_hierarchy;
return (fexpr__61453.cljs$core$IFn$_invoke$arity$0 ? fexpr__61453.cljs$core$IFn$_invoke$arity$0() : fexpr__61453.call(null));
})());
...
var map__61460 = spec_tools.impl.parse_keys(form);
var map__61460__$1 = cljs.core.__destructure_map(map__61460);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61460__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61460__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61460__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61460__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61460__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__61461 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__61461__$1 = (cljs.core.truth_((function (){var or__5025__auto__ = req;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61461,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__61461);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61461__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__61461__$1;
}
}));
...
var vec__61462 = multi_spec_form;
var seq__61463 = cljs.core.seq(vec__61462);
var first__61464 = cljs.core.first(seq__61463);
var seq__61463__$1 = cljs.core.next(seq__61463);
var _ = first__61464;
var first__61464__$1 = cljs.core.first(seq__61463__$1);
var seq__61463__$2 = cljs.core.next(seq__61463__$1);
var multi_method_symbol = first__61464__$1;
var ___$1 = seq__61463__$2;
var form = vec__61462;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__61465){
var vec__61466 = p__61465;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61466,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61466,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__61472_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__61472_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__61475_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__61475_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__61476_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__61476_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61477_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__61477_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__61478 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__61478__$1 = cljs.core.__destructure_map(map__61478);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61478__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__61479 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__61479__$1 = cljs.core.__destructure_map(map__61479);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61479__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__61480,options){
var vec__61481 = p__61480;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61481,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61481,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61481,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__61485,options){
var vec__61486 = p__61485;
var seq__61487 = cljs.core.seq(vec__61486);
var first__61488 = cljs.core.first(seq__61487);
var seq__61487__$1 = cljs.core.next(seq__61487);
var ___$1 = first__61488;
var values = seq__61487__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__61484_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__61484_SHARP_,options);
}),values);
...
var type_priority = (function (p1__61489_SHARP_){
var G__61492 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__61491 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__61489_SHARP_);
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61490_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__61490_SHARP_,options);
}),cljs.core.rest(form))));
}));
