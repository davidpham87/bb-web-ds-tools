...
var fexpr__54494 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__54494.cljs$core$IFn$_invoke$arity$1 ? fexpr__54494.cljs$core$IFn$_invoke$arity$1(type) : fexpr__54494.call(null,type));
});
...
var G__54509 = spec_tools.impl.normalize_symbol(x);
var G__54510 = null;
var G__54511 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__54509,G__54510,G__54511) : spec_tools.parse.parse_form.call(null,G__54509,G__54510,G__54511));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__54512 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__54513 = x;
var G__54514 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__54512,G__54513,G__54514) : spec_tools.parse.parse_form.call(null,G__54512,G__54513,G__54514));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__54635 = cljs.spec.alpha.form(x);
var G__54636 = options;
x = G__54635;
options = G__54636;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__54515 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__54516 = null;
var G__54517 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__54515,G__54516,G__54517) : spec_tools.parse.parse_form.call(null,G__54515,G__54516,G__54517));
} else {
...
var G__54535 = parse_data;
var G__54535__$1 = (((G__54535 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__54535));
var G__54535__$2 = (((G__54535__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__54535__$1));
var G__54535__$3 = (((G__54535__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__54535__$2));
var G__54535__$4 = (((G__54535__$3 == null))?null:cljs.core.seq(G__54535__$3));
if((G__54535__$4 == null)){
return null;
} else {
return cljs.core.set(G__54535__$4);
}
}
});
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__54538 = cljs.core.get_global_hierarchy;
return (fexpr__54538.cljs$core$IFn$_invoke$arity$0 ? fexpr__54538.cljs$core$IFn$_invoke$arity$0() : fexpr__54538.call(null));
})());
...
var map__54599 = spec_tools.impl.parse_keys(form);
var map__54599__$1 = cljs.core.__destructure_map(map__54599);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54599__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54599__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54599__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54599__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54599__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
...
var G__54601__$1 = (cljs.core.truth_((function (){var or__5025__auto__ = req;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54601,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__54601);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54601__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__54601__$1;
}
}));
...
var vec__54602 = multi_spec_form;
var seq__54603 = cljs.core.seq(vec__54602);
var first__54604 = cljs.core.first(seq__54603);
var seq__54603__$1 = cljs.core.next(seq__54603);
var _ = first__54604;
var first__54604__$1 = cljs.core.first(seq__54603__$1);
var seq__54603__$2 = cljs.core.next(seq__54603__$1);
var multi_method_symbol = first__54604__$1;
var ___$1 = seq__54603__$2;
var form = vec__54602;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__54605){
var vec__54606 = p__54605;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54606,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54606,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__54609_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__54609_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54612_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__54612_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__54613_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__54613_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54614_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__54614_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__54615 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__54615__$1 = cljs.core.__destructure_map(map__54615);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54615__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__54616 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__54616__$1 = cljs.core.__destructure_map(map__54616);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54616__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__54617,options){
var vec__54618 = p__54617;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54618,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54618,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54618,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__54624,options){
var vec__54625 = p__54624;
var seq__54626 = cljs.core.seq(vec__54625);
var first__54627 = cljs.core.first(seq__54626);
var seq__54626__$1 = cljs.core.next(seq__54626);
var ___$1 = first__54627;
var values = seq__54626__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__54623_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__54623_SHARP_,options);
}),values);
...
var type_priority = (function (p1__54628_SHARP_){
var G__54631 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__54630 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__54628_SHARP_);
return (fexpr__54630.cljs$core$IFn$_invoke$arity$1 ? fexpr__54630.cljs$core$IFn$_invoke$arity$1(G__54631) : fexpr__54630.call(null,G__54631));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54629_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__54629_SHARP_,options);
}),cljs.core.rest(form))));
}));
