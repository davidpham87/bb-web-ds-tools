...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.core","navigate","bb-web-ds-tools.core/navigate",-787989557),(function (_,p__40497){
var vec__40498 = p__40497;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40498,(0),null);
var route_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40498,(1),null);
var params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40498,(2),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40498,(3),null);
...
re_frame.core.reg_fx(new cljs.core.Keyword(null,"navigate","navigate",657596805),(function (p__40501){
var vec__40502 = p__40501;
var route_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40502,(0),null);
var params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40502,(1),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40502,(2),null);
...
var temp__5823__auto__ = cljs.core.some((function (p1__40505_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"route","route",329891309).cljs$core$IFn$_invoke$arity$1(p1__40505_SHARP_),route_name)){
...
if(cljs.core.truth_((function (){var fexpr__40506 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"code-tab","code-tab",-2022166816),null,new cljs.core.Keyword(null,"malli-tab","malli-tab",1001902861),null], null), null);
return (fexpr__40506.cljs$core$IFn$_invoke$arity$1 ? fexpr__40506.cljs$core$IFn$_invoke$arity$1(route_name) : fexpr__40506.call(null,route_name));
})())){
var G__40507 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(route_name),/-/)));
return (bb_web_ds_tools.core.get_route_label.cljs$core$IFn$_invoke$arity$1 ? bb_web_ds_tools.core.get_route_label.cljs$core$IFn$_invoke$arity$1(G__40507) : bb_web_ds_tools.core.get_route_label.call(null,G__40507));
} else {
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.core","load-shared-state","bb-web-ds-tools.core/load-shared-state",-1474832379),(function (db,p__40508){
var vec__40510 = p__40508;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40510,(0),null);
var encoded_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40510,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.core","navigated","bb-web-ds-tools.core/navigated",386373854),(function (p__40513,p__40514){
var map__40515 = p__40513;
var map__40515__$1 = cljs.core.__destructure_map(map__40515);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40515__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__40516 = p__40514;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40516,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40516,(1),null);
...
var dispatches = (function (){var G__40519 = cljs.core.PersistentVector.EMPTY;
var G__40519__$1 = (cljs.core.truth_(state_str)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__40519,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.core","load-shared-state","bb-web-ds-tools.core/load-shared-state",-1474832379),state_str], null)):G__40519);
var G__40519__$2 = (cljs.core.truth_((function (){var and__5023__auto__ = tab;
if(cljs.core.truth_(and__5023__auto__)){
var fexpr__40520 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"malli-tab","malli-tab",1001902861),null,new cljs.core.Keyword(null,"malli","malli",814072082),null], null), null);
return (fexpr__40520.cljs$core$IFn$_invoke$arity$1 ? fexpr__40520.cljs$core$IFn$_invoke$arity$1(route_name) : fexpr__40520.call(null,route_name));
} else {
return and__5023__auto__;
}
})())?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__40519__$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli","set-active-tab","malli/set-active-tab",227854602),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(tab)], null)):G__40519__$1);
if(cljs.core.truth_((function (){var and__5023__auto__ = tab;
if(cljs.core.truth_(and__5023__auto__)){
var fexpr__40522 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"code-tab","code-tab",-2022166816),null,new cljs.core.Keyword(null,"code","code",1586293142),null], null), null);
return (fexpr__40522.cljs$core$IFn$_invoke$arity$1 ? fexpr__40522.cljs$core$IFn$_invoke$arity$1(route_name) : fexpr__40522.call(null,route_name));
} else {
return and__5023__auto__;
}
})())){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__40519__$2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.code","set-active-tab","bb-web-ds-tools.views.code/set-active-tab",-1083304053),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(tab)], null));
} else {
return G__40519__$2;
}
})();
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.core","code-changed","bb-web-ds-tools.core/code-changed",-2041081013),(function (db,p__40530){
var vec__40531 = p__40530;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40531,(0),null);
var new_code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40531,(1),null);
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__40536 = cljs.core.get_global_hierarchy;
return (fexpr__40536.cljs$core$IFn$_invoke$arity$0 ? fexpr__40536.cljs$core$IFn$_invoke$arity$0() : fexpr__40536.call(null));
})());
