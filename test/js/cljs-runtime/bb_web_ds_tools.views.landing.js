 ...
 */
bb_web_ds_tools.views.landing.nav_card = (function bb_web_ds_tools$views$landing$nav_card(p__44122){
var map__44123 = p__44122;
var map__44123__$1 = cljs.core.__destructure_map(map__44123);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44123__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var route = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44123__$1,new cljs.core.Keyword(null,"route","route",329891309));
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44123__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__44138),bb_web_ds_tools$views$landing$landing_page_$_iter__44135(cljs.core.chunk_rest(s__44136__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__44138),null);
}
} else {
var item = cljs.core.first(s__44136__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.landing.nav_card,item], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"route","route",329891309).cljs$core$IFn$_invoke$arity$1(item)], null)),bb_web_ds_tools$views$landing$landing_page_$_iter__44135(cljs.core.rest(s__44136__$2)));
}
} else {
return null;
}
