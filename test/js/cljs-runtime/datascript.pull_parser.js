...
(datascript.pull_parser.PullAttr.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5325__auto__,k45926,else__5326__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k45926,else__5326__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5346__auto__,p__45937){
var vec__45938 = p__45937;
var k__5347__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45938,(0),null);
var v__5348__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45938,(1),null);
...
(datascript.pull_parser.PullAttr.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__45925){
var self__ = this;
var G__45925__$1 = this;
return (new cljs.core.RecordIter((0),G__45925__$1,12,new cljs.core.PersistentVector(null, 12, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"as","as",1148689641),new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword(null,"limit","limit",-1355822363),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"pattern","pattern",242135423),new cljs.core.Keyword(null,"recursion-limit","recursion-limit",52345639),new cljs.core.Keyword(null,"recursive?","recursive?",1340075244),new cljs.core.Keyword(null,"reverse?","reverse?",-1672868474),new cljs.core.Keyword(null,"xform","xform",-1725711008),new cljs.core.Keyword(null,"multival?","multival?",1072388383),new cljs.core.Keyword(null,"ref?","ref?",1932693720),new cljs.core.Keyword(null,"component?","component?",407783990)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(datascript.pull_parser.PullAttr.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this45927,other45928){
var self__ = this;
var this45927__$1 = this;
return (((!((other45928 == null)))) && ((((this45927__$1.constructor === other45928.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45927__$1.as,other45928.as)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45927__$1.default,other45928.default)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45927__$1.limit,other45928.limit)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45927__$1.name,other45928.name)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45927__$1.pattern,other45928.pattern)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45927__$1.recursion_limit,other45928.recursion_limit)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45927__$1.recursive_QMARK_,other45928.recursive_QMARK_)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45927__$1.reverse_QMARK_,other45928.reverse_QMARK_)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45927__$1.xform,other45928.xform)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45927__$1.multival_QMARK_,other45928.multival_QMARK_)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45927__$1.ref_QMARK_,other45928.ref_QMARK_)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45927__$1.component_QMARK_,other45928.component_QMARK_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45927__$1.__extmap,other45928.__extmap)))))))))))))))))))))))))))));
}));
...
(datascript.pull_parser.PullAttr.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5330__auto__,k45926){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k45926);

}
}));

(datascript.pull_parser.PullAttr.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5331__auto__,k__5332__auto__,G__45925){
var self__ = this;
var this__5331__auto____$1 = this;
var pred__45946 = cljs.core.keyword_identical_QMARK_;
var expr__45947 = k__5332__auto__;
if(cljs.core.truth_((pred__45946.cljs$core$IFn$_invoke$arity$2 ? pred__45946.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"as","as",1148689641),expr__45947) : pred__45946.call(null,new cljs.core.Keyword(null,"as","as",1148689641),expr__45947)))){
return (new datascript.pull_parser.PullAttr(G__45925,self__.default$,self__.limit,self__.name,self__.pattern,self__.recursion_limit,self__.recursive_QMARK_,self__.reverse_QMARK_,self__.xform,self__.multival_QMARK_,self__.ref_QMARK_,self__.component_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45946.cljs$core$IFn$_invoke$arity$2 ? pred__45946.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),expr__45947) : pred__45946.call(null,new cljs.core.Keyword(null,"default","default",-1987822328),expr__45947)))){
return (new datascript.pull_parser.PullAttr(self__.as,G__45925,self__.limit,self__.name,self__.pattern,self__.recursion_limit,self__.recursive_QMARK_,self__.reverse_QMARK_,self__.xform,self__.multival_QMARK_,self__.ref_QMARK_,self__.component_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45946.cljs$core$IFn$_invoke$arity$2 ? pred__45946.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"limit","limit",-1355822363),expr__45947) : pred__45946.call(null,new cljs.core.Keyword(null,"limit","limit",-1355822363),expr__45947)))){
return (new datascript.pull_parser.PullAttr(self__.as,self__.default$,G__45925,self__.name,self__.pattern,self__.recursion_limit,self__.recursive_QMARK_,self__.reverse_QMARK_,self__.xform,self__.multival_QMARK_,self__.ref_QMARK_,self__.component_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45946.cljs$core$IFn$_invoke$arity$2 ? pred__45946.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"name","name",1843675177),expr__45947) : pred__45946.call(null,new cljs.core.Keyword(null,"name","name",1843675177),expr__45947)))){
return (new datascript.pull_parser.PullAttr(self__.as,self__.default$,self__.limit,G__45925,self__.pattern,self__.recursion_limit,self__.recursive_QMARK_,self__.reverse_QMARK_,self__.xform,self__.multival_QMARK_,self__.ref_QMARK_,self__.component_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45946.cljs$core$IFn$_invoke$arity$2 ? pred__45946.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"pattern","pattern",242135423),expr__45947) : pred__45946.call(null,new cljs.core.Keyword(null,"pattern","pattern",242135423),expr__45947)))){
return (new datascript.pull_parser.PullAttr(self__.as,self__.default$,self__.limit,self__.name,G__45925,self__.recursion_limit,self__.recursive_QMARK_,self__.reverse_QMARK_,self__.xform,self__.multival_QMARK_,self__.ref_QMARK_,self__.component_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45946.cljs$core$IFn$_invoke$arity$2 ? pred__45946.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"recursion-limit","recursion-limit",52345639),expr__45947) : pred__45946.call(null,new cljs.core.Keyword(null,"recursion-limit","recursion-limit",52345639),expr__45947)))){
return (new datascript.pull_parser.PullAttr(self__.as,self__.default$,self__.limit,self__.name,self__.pattern,G__45925,self__.recursive_QMARK_,self__.reverse_QMARK_,self__.xform,self__.multival_QMARK_,self__.ref_QMARK_,self__.component_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45946.cljs$core$IFn$_invoke$arity$2 ? pred__45946.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"recursive?","recursive?",1340075244),expr__45947) : pred__45946.call(null,new cljs.core.Keyword(null,"recursive?","recursive?",1340075244),expr__45947)))){
return (new datascript.pull_parser.PullAttr(self__.as,self__.default$,self__.limit,self__.name,self__.pattern,self__.recursion_limit,G__45925,self__.reverse_QMARK_,self__.xform,self__.multival_QMARK_,self__.ref_QMARK_,self__.component_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45946.cljs$core$IFn$_invoke$arity$2 ? pred__45946.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"reverse?","reverse?",-1672868474),expr__45947) : pred__45946.call(null,new cljs.core.Keyword(null,"reverse?","reverse?",-1672868474),expr__45947)))){
return (new datascript.pull_parser.PullAttr(self__.as,self__.default$,self__.limit,self__.name,self__.pattern,self__.recursion_limit,self__.recursive_QMARK_,G__45925,self__.xform,self__.multival_QMARK_,self__.ref_QMARK_,self__.component_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45946.cljs$core$IFn$_invoke$arity$2 ? pred__45946.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"xform","xform",-1725711008),expr__45947) : pred__45946.call(null,new cljs.core.Keyword(null,"xform","xform",-1725711008),expr__45947)))){
return (new datascript.pull_parser.PullAttr(self__.as,self__.default$,self__.limit,self__.name,self__.pattern,self__.recursion_limit,self__.recursive_QMARK_,self__.reverse_QMARK_,G__45925,self__.multival_QMARK_,self__.ref_QMARK_,self__.component_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45946.cljs$core$IFn$_invoke$arity$2 ? pred__45946.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"multival?","multival?",1072388383),expr__45947) : pred__45946.call(null,new cljs.core.Keyword(null,"multival?","multival?",1072388383),expr__45947)))){
return (new datascript.pull_parser.PullAttr(self__.as,self__.default$,self__.limit,self__.name,self__.pattern,self__.recursion_limit,self__.recursive_QMARK_,self__.reverse_QMARK_,self__.xform,G__45925,self__.ref_QMARK_,self__.component_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45946.cljs$core$IFn$_invoke$arity$2 ? pred__45946.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"ref?","ref?",1932693720),expr__45947) : pred__45946.call(null,new cljs.core.Keyword(null,"ref?","ref?",1932693720),expr__45947)))){
return (new datascript.pull_parser.PullAttr(self__.as,self__.default$,self__.limit,self__.name,self__.pattern,self__.recursion_limit,self__.recursive_QMARK_,self__.reverse_QMARK_,self__.xform,self__.multival_QMARK_,G__45925,self__.component_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45946.cljs$core$IFn$_invoke$arity$2 ? pred__45946.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"component?","component?",407783990),expr__45947) : pred__45946.call(null,new cljs.core.Keyword(null,"component?","component?",407783990),expr__45947)))){
return (new datascript.pull_parser.PullAttr(self__.as,self__.default$,self__.limit,self__.name,self__.pattern,self__.recursion_limit,self__.recursive_QMARK_,self__.reverse_QMARK_,self__.xform,self__.multival_QMARK_,self__.ref_QMARK_,G__45925,self__.__meta,self__.__extmap,null));
} else {
return (new datascript.pull_parser.PullAttr(self__.as,self__.default$,self__.limit,self__.name,self__.pattern,self__.recursion_limit,self__.recursive_QMARK_,self__.reverse_QMARK_,self__.xform,self__.multival_QMARK_,self__.ref_QMARK_,self__.component_QMARK_,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5332__auto__,G__45925),null));
}
}
}
}
...
(datascript.pull_parser.PullAttr.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5322__auto__,G__45925){
var self__ = this;
var this__5322__auto____$1 = this;
return (new datascript.pull_parser.PullAttr(self__.as,self__.default$,self__.limit,self__.name,self__.pattern,self__.recursion_limit,self__.recursive_QMARK_,self__.reverse_QMARK_,self__.xform,self__.multival_QMARK_,self__.ref_QMARK_,self__.component_QMARK_,G__45925,self__.__extmap,self__.__hash));
}));
 ...
 */
datascript.pull_parser.map__GT_PullAttr = (function datascript$pull_parser$map__GT_PullAttr(G__45929){
var extmap__5365__auto__ = (function (){var G__45949 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__45929,new cljs.core.Keyword(null,"as","as",1148689641),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword(null,"limit","limit",-1355822363),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"pattern","pattern",242135423),new cljs.core.Keyword(null,"recursion-limit","recursion-limit",52345639),new cljs.core.Keyword(null,"recursive?","recursive?",1340075244),new cljs.core.Keyword(null,"reverse?","reverse?",-1672868474),new cljs.core.Keyword(null,"xform","xform",-1725711008),new cljs.core.Keyword(null,"multival?","multival?",1072388383),new cljs.core.Keyword(null,"ref?","ref?",1932693720),new cljs.core.Keyword(null,"component?","component?",407783990)], 0));
if(cljs.core.record_QMARK_(G__45929)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__45949);
} else {
return G__45949;
}
})();
return (new datascript.pull_parser.PullAttr(new cljs.core.Keyword(null,"as","as",1148689641).cljs$core$IFn$_invoke$arity$1(G__45929),new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(G__45929),new cljs.core.Keyword(null,"limit","limit",-1355822363).cljs$core$IFn$_invoke$arity$1(G__45929),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(G__45929),new cljs.core.Keyword(null,"pattern","pattern",242135423).cljs$core$IFn$_invoke$arity$1(G__45929),new cljs.core.Keyword(null,"recursion-limit","recursion-limit",52345639).cljs$core$IFn$_invoke$arity$1(G__45929),new cljs.core.Keyword(null,"recursive?","recursive?",1340075244).cljs$core$IFn$_invoke$arity$1(G__45929),new cljs.core.Keyword(null,"reverse?","reverse?",-1672868474).cljs$core$IFn$_invoke$arity$1(G__45929),new cljs.core.Keyword(null,"xform","xform",-1725711008).cljs$core$IFn$_invoke$arity$1(G__45929),new cljs.core.Keyword(null,"multival?","multival?",1072388383).cljs$core$IFn$_invoke$arity$1(G__45929),new cljs.core.Keyword(null,"ref?","ref?",1932693720).cljs$core$IFn$_invoke$arity$1(G__45929),new cljs.core.Keyword(null,"component?","component?",407783990).cljs$core$IFn$_invoke$arity$1(G__45929),null,cljs.core.not_empty(extmap__5365__auto__),null));
});
...
(datascript.pull_parser.PullPattern.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5325__auto__,k45951,else__5326__auto__){
var self__ = this;
var this__5325__auto____$1 = this;
var G__45967 = k45951;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k45951,else__5326__auto__);
...
var self__ = this;
var this__5343__auto____$1 = this;
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5346__auto__,p__45970){
var vec__45971 = p__45970;
var k__5347__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45971,(0),null);
var v__5348__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45971,(1),null);
return (f__5344__auto__.cljs$core$IFn$_invoke$arity$3 ? f__5344__auto__.cljs$core$IFn$_invoke$arity$3(ret__5346__auto__,k__5347__auto__,v__5348__auto__) : f__5344__auto__.call(null,ret__5346__auto__,k__5347__auto__,v__5348__auto__));
}),init__5345__auto__,this__5343__auto____$1);
}));
...
(datascript.pull_parser.PullPattern.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__45950){
var self__ = this;
var G__45950__$1 = this;
return (new cljs.core.RecordIter((0),G__45950__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"attrs","attrs",-2090668713),new cljs.core.Keyword(null,"first-attr","first-attr",-1993039831),new cljs.core.Keyword(null,"last-attr","last-attr",-526000708),new cljs.core.Keyword(null,"reverse-attrs","reverse-attrs",630097702),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(datascript.pull_parser.PullPattern.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this45952,other45953){
var self__ = this;
var this45952__$1 = this;
return (((!((other45953 == null)))) && ((((this45952__$1.constructor === other45953.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45952__$1.attrs,other45953.attrs)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45952__$1.first_attr,other45953.first_attr)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45952__$1.last_attr,other45953.last_attr)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45952__$1.reverse_attrs,other45953.reverse_attrs)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45952__$1.wildcard_QMARK_,other45953.wildcard_QMARK_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45952__$1.__extmap,other45953.__extmap)))))))))))))));
}));
...
(datascript.pull_parser.PullPattern.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5330__auto__,k45951){
var self__ = this;
var this__5330__auto____$1 = this;
var G__45978 = k45951;
var G__45978__$1 = (((G__45978 instanceof cljs.core.Keyword))?G__45978.fqn:null);
switch (G__45978__$1) {
case "attrs":
case "first-attr":
case "last-attr":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k45951);

}
}));

(datascript.pull_parser.PullPattern.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5331__auto__,k__5332__auto__,G__45950){
var self__ = this;
var this__5331__auto____$1 = this;
var pred__45979 = cljs.core.keyword_identical_QMARK_;
var expr__45980 = k__5332__auto__;
if(cljs.core.truth_((pred__45979.cljs$core$IFn$_invoke$arity$2 ? pred__45979.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"attrs","attrs",-2090668713),expr__45980) : pred__45979.call(null,new cljs.core.Keyword(null,"attrs","attrs",-2090668713),expr__45980)))){
return (new datascript.pull_parser.PullPattern(G__45950,self__.first_attr,self__.last_attr,self__.reverse_attrs,self__.wildcard_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45979.cljs$core$IFn$_invoke$arity$2 ? pred__45979.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"first-attr","first-attr",-1993039831),expr__45980) : pred__45979.call(null,new cljs.core.Keyword(null,"first-attr","first-attr",-1993039831),expr__45980)))){
return (new datascript.pull_parser.PullPattern(self__.attrs,G__45950,self__.last_attr,self__.reverse_attrs,self__.wildcard_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45979.cljs$core$IFn$_invoke$arity$2 ? pred__45979.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"last-attr","last-attr",-526000708),expr__45980) : pred__45979.call(null,new cljs.core.Keyword(null,"last-attr","last-attr",-526000708),expr__45980)))){
return (new datascript.pull_parser.PullPattern(self__.attrs,self__.first_attr,G__45950,self__.reverse_attrs,self__.wildcard_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45979.cljs$core$IFn$_invoke$arity$2 ? pred__45979.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"reverse-attrs","reverse-attrs",630097702),expr__45980) : pred__45979.call(null,new cljs.core.Keyword(null,"reverse-attrs","reverse-attrs",630097702),expr__45980)))){
return (new datascript.pull_parser.PullPattern(self__.attrs,self__.first_attr,self__.last_attr,G__45950,self__.wildcard_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45979.cljs$core$IFn$_invoke$arity$2 ? pred__45979.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101),expr__45980) : pred__45979.call(null,new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101),expr__45980)))){
return (new datascript.pull_parser.PullPattern(self__.attrs,self__.first_attr,self__.last_attr,self__.reverse_attrs,G__45950,self__.__meta,self__.__extmap,null));
} else {
return (new datascript.pull_parser.PullPattern(self__.attrs,self__.first_attr,self__.last_attr,self__.reverse_attrs,self__.wildcard_QMARK_,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5332__auto__,G__45950),null));
}
}
}
}
...
(datascript.pull_parser.PullPattern.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5322__auto__,G__45950){
var self__ = this;
var this__5322__auto____$1 = this;
return (new datascript.pull_parser.PullPattern(self__.attrs,self__.first_attr,self__.last_attr,self__.reverse_attrs,self__.wildcard_QMARK_,G__45950,self__.__extmap,self__.__hash));
}));
 ...
 */
datascript.pull_parser.map__GT_PullPattern = (function datascript$pull_parser$map__GT_PullPattern(G__45954){
var extmap__5365__auto__ = (function (){var G__45989 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__45954,new cljs.core.Keyword(null,"attrs","attrs",-2090668713),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"first-attr","first-attr",-1993039831),new cljs.core.Keyword(null,"last-attr","last-attr",-526000708),new cljs.core.Keyword(null,"reverse-attrs","reverse-attrs",630097702),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101)], 0));
if(cljs.core.record_QMARK_(G__45954)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__45989);
} else {
return G__45989;
}
})();
return (new datascript.pull_parser.PullPattern(new cljs.core.Keyword(null,"attrs","attrs",-2090668713).cljs$core$IFn$_invoke$arity$1(G__45954),new cljs.core.Keyword(null,"first-attr","first-attr",-1993039831).cljs$core$IFn$_invoke$arity$1(G__45954),new cljs.core.Keyword(null,"last-attr","last-attr",-526000708).cljs$core$IFn$_invoke$arity$1(G__45954),new cljs.core.Keyword(null,"reverse-attrs","reverse-attrs",630097702).cljs$core$IFn$_invoke$arity$1(G__45954),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101).cljs$core$IFn$_invoke$arity$1(G__45954),null,cljs.core.not_empty(extmap__5365__auto__),null));
});
...
var temp__5829__auto__ = (function (){var G__46002 = db;
var G__46003 = cljs.core.first(attr_spec);
return (datascript.pull_parser.parse_attr_spec.cljs$core$IFn$_invoke$arity$2 ? datascript.pull_parser.parse_attr_spec.cljs$core$IFn$_invoke$arity$2(G__46002,G__46003) : datascript.pull_parser.parse_attr_spec.call(null,G__46002,G__46003));
})();
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (pull_attr__$1,p__46010){
var vec__46011 = p__46010;
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46011,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46011,(1),null);
var G__46015 = key;
...
if(cljs.core.truth_((function (){var G__46017 = cljs.core.first(attr_spec);
var fexpr__46016 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol(null,"limit","limit",284709164,null),null,"limit",null], null), null);
return (fexpr__46016.cljs$core$IFn$_invoke$arity$1 ? fexpr__46016.cljs$core$IFn$_invoke$arity$1(G__46017) : fexpr__46016.call(null,G__46017));
})())){
datascript.pull_parser.check(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(attr_spec),(3)),expected,attr_spec);

var vec__46018 = attr_spec;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46018,(0),null);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46018,(1),null);
var limit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46018,(2),null);
...
if(cljs.core.truth_((function (){var G__46022 = cljs.core.first(attr_spec);
var fexpr__46021 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol(null,"default","default",-347290801,null),null,"default",null], null), null);
...
var vec__46023 = attr_spec;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46023,(0),null);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46023,(1),null);
var default$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46023,(2),null);
var pull_attr = (datascript.pull_parser.parse_attr_spec.cljs$core$IFn$_invoke$arity$2 ? datascript.pull_parser.parse_attr_spec.cljs$core$IFn$_invoke$arity$2(db,attr) : datascript.pull_parser.parse_attr_spec.call(null,db,attr));
...
if((((attr_spec instanceof cljs.core.Keyword)) || (((typeof attr_spec === 'string') && (cljs.core.not((function (){var fexpr__46034 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["limit",null,"default",null], null), null);
return (fexpr__46034.cljs$core$IFn$_invoke$arity$1 ? fexpr__46034.cljs$core$IFn$_invoke$arity$1(attr_spec) : fexpr__46034.call(null,attr_spec));
})())))))){
...
return cljs.core.some((function (p__46043){
var vec__46044 = p__46043;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46044,(0),null);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46044,(1),null);
...
var temp__5827__auto__ = datascript.pull_parser.index_of((function (p1__46049_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"as","as",1148689641).cljs$core$IFn$_invoke$arity$1(p1__46049_SHARP_),new cljs.core.Keyword(null,"as","as",1148689641).cljs$core$IFn$_invoke$arity$1(pull_attr));
...
var G__46063 = attr.name;
var fexpr__46062 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("db","id","db/id",-1388397098),null,":db/id",null], null), null);
return (fexpr__46062.cljs$core$IFn$_invoke$arity$1 ? fexpr__46062.cljs$core$IFn$_invoke$arity$1(G__46063) : fexpr__46062.call(null,G__46063));
...
var G__46176 = cljs.core.next(pattern__$1);
var G__46177 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(result,new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101),true);
pattern__$1 = G__46176;
result = G__46177;
continue;
} else {
...
,result,attr_spec);
var G__46178 = cljs.core.next(pattern__$1);
var G__46179 = result_SINGLEQUOTE_;
pattern__$1 = G__46178;
result = G__46179;
continue;
} else {
var pull_attr = datascript.pull_parser.parse_attr_spec(db,attr_spec);
...
var G__46182 = cljs.core.next(pattern__$1);
var G__46183 = datascript.pull_parser.conj_attr(result,pull_attr);
pattern__$1 = G__46182;
result = G__46183;
continue;
