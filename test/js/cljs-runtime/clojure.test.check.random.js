...
var clojure$test$check$random$IRandom$rand_long$dyn_49645 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_49645(rng);
}
});
...
var G__49633 = z;
if(((24) > (function (){var G__49634 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__49634) : clojure.test.check.random.longs.bit_count.call(null,G__49634));
})())){
return clojure.test.check.random.longs.bit_xor(G__49633,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__49633;
}
});
...
var G__49652 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__49653 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__49652;
ret = G__49653;
continue;
}
