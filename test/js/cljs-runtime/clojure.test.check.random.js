...
var clojure$test$check$random$IRandom$rand_long$dyn_49874 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_49874(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_49875 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_49875(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_49876 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_49876(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_49878 = (function (rng,n){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_49878(rng,n);
}
});
...
var G__49885 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__49886 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__49885;
ret = G__49886;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__49853){
var map__49854 = p__49853;
var map__49854__$1 = cljs.core.__destructure_map(map__49854);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49854__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__49855 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49855,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49855,(1),null);
