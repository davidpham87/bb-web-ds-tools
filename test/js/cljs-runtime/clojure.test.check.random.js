...
var clojure$test$check$random$IRandom$rand_long$dyn_56598 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_56598(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_56603 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_56603(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_56604 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_56604(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_56605 = (function (rng,n){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_56605(rng,n);
}
});
...
var G__56573 = z;
if(((24) > (function (){var G__56575 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__56575) : clojure.test.check.random.longs.bit_count.call(null,G__56575));
})())){
return clojure.test.check.random.longs.bit_xor(G__56573,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__56573;
}
});
...
var G__56607 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__56608 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__56607;
ret = G__56608;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__56590){
var map__56591 = p__56590;
var map__56591__$1 = cljs.core.__destructure_map(map__56591);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56591__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__56592 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56592,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56592,(1),null);
