...
var clojure$test$check$random$IRandom$rand_long$dyn_49818 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_49818(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_49819 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_49819(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_49820 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_49820(rng);
}
});
...
var G__49794 = z;
if(((24) > (function (){var G__49795 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__49795) : clojure.test.check.random.longs.bit_count.call(null,G__49795));
})())){
return clojure.test.check.random.longs.bit_xor(G__49794,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__49794;
}
});
...
var G__49824 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__49825 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__49824;
ret = G__49825;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__49802){
var map__49803 = p__49802;
var map__49803__$1 = cljs.core.__destructure_map(map__49803);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49803__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
