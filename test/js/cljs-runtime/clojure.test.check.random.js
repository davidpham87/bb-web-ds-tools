...
var clojure$test$check$random$IRandom$rand_long$dyn_57795 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_57795(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_57796 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_57796(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_57798 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_57798(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_57800 = (function (rng,n){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_57800(rng,n);
}
});
...
var G__57781 = z;
if(((24) > (function (){var G__57782 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__57782) : clojure.test.check.random.longs.bit_count.call(null,G__57782));
})())){
return clojure.test.check.random.longs.bit_xor(G__57781,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__57781;
}
});
...
var G__57802 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__57803 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__57802;
ret = G__57803;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__57788){
var map__57789 = p__57788;
var map__57789__$1 = cljs.core.__destructure_map(map__57789);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57789__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__57790 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57790,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57790,(1),null);
