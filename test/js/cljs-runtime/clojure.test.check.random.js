...
var clojure$test$check$random$IRandom$rand_long$dyn_55736 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_55736(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_55737 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_55737(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_55739 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_55739(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_55740 = (function (rng,n){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_55740(rng,n);
}
});
...
var G__55709 = z;
if(((24) > (function (){var G__55711 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__55711) : clojure.test.check.random.longs.bit_count.call(null,G__55711));
})())){
return clojure.test.check.random.longs.bit_xor(G__55709,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__55709;
}
});
...
var G__55746 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__55747 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__55746;
ret = G__55747;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__55728){
var map__55729 = p__55728;
var map__55729__$1 = cljs.core.__destructure_map(map__55729);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55729__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__55730 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55730,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55730,(1),null);
