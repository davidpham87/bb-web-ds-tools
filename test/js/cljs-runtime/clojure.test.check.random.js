...
var clojure$test$check$random$IRandom$rand_long$dyn_49804 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_49804(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_49805 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_49805(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_49806 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_49806(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_49809 = (function (rng,n){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_49809(rng,n);
}
});
...
var G__49820 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__49821 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__49820;
ret = G__49821;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__49797){
var map__49798 = p__49797;
var map__49798__$1 = cljs.core.__destructure_map(map__49798);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49798__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__49799 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49799,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49799,(1),null);
