...
var clojure$test$check$random$IRandom$rand_long$dyn_49750 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_49750(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_49751 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_49751(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_49752 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_49752(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_49754 = (function (rng,n){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_49754(rng,n);
}
});
...
var G__49728 = z;
if(((24) > (function (){var G__49729 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__49729) : clojure.test.check.random.longs.bit_count.call(null,G__49729));
})())){
return clojure.test.check.random.longs.bit_xor(G__49728,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__49728;
}
});
...
var G__49756 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__49757 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__49756;
ret = G__49757;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__49743){
var map__49744 = p__49743;
var map__49744__$1 = cljs.core.__destructure_map(map__49744);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49744__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__49745 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49745,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49745,(1),null);
