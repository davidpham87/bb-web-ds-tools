...
var clojure$test$check$random$IRandom$rand_long$dyn_57003 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_57003(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_57004 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_57004(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_57006 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_57006(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_57008 = (function (rng,n){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_57008(rng,n);
}
});
...
var G__56991 = z;
if(((24) > (function (){var G__56992 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__56992) : clojure.test.check.random.longs.bit_count.call(null,G__56992));
})())){
return clojure.test.check.random.longs.bit_xor(G__56991,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__56991;
}
});
...
var G__57022 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__57023 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__57022;
ret = G__57023;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__56994){
var map__56995 = p__56994;
var map__56995__$1 = cljs.core.__destructure_map(map__56995);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56995__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__56996 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56996,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56996,(1),null);
