...
var clojure$test$check$random$IRandom$rand_long$dyn_57214 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_57214(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_57215 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_57215(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_57216 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_57216(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_57217 = (function (rng,n){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_57217(rng,n);
}
});
...
var G__57198 = z;
if(((24) > (function (){var G__57199 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__57199) : clojure.test.check.random.longs.bit_count.call(null,G__57199));
})())){
return clojure.test.check.random.longs.bit_xor(G__57198,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__57198;
}
});
...
var G__57223 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__57224 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__57223;
ret = G__57224;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__57207){
var map__57208 = p__57207;
var map__57208__$1 = cljs.core.__destructure_map(map__57208);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57208__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__57209 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57209,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57209,(1),null);
