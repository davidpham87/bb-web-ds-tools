...
var clojure$test$check$random$IRandom$rand_long$dyn_49860 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_49860(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_49861 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_49861(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_49862 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_49862(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_49863 = (function (rng,n){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_49863(rng,n);
}
});
...
var G__49848 = z;
if(((24) > (function (){var G__49849 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__49849) : clojure.test.check.random.longs.bit_count.call(null,G__49849));
})())){
return clojure.test.check.random.longs.bit_xor(G__49848,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__49848;
}
});
...
var G__49866 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__49867 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__49866;
ret = G__49867;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__49851){
var map__49852 = p__49851;
var map__49852__$1 = cljs.core.__destructure_map(map__49852);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49852__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__49853 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49853,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49853,(1),null);
