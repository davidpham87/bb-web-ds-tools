...
var G__24651 = shadow_root.activeElement;
active_element = G__24651;
continue;
} else {
...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__24617){
var map__24618 = p__24617;
var map__24618__$1 = cljs.core.__destructure_map(map__24618);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24618__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var _STAR_force_set_dom_value_STAR__orig_val__24621 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__24622 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__24622);
...
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__24621);
}}));
} else {
...
(jsprops.onChange = (function (p1__24633_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__24633_SHARP_);
}));
