...
var G__24717 = shadow_root.activeElement;
active_element = G__24717;
continue;
} else {
...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__24658){
var map__24660 = p__24658;
var map__24660__$1 = cljs.core.__destructure_map(map__24660);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24660__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var _STAR_force_set_dom_value_STAR__orig_val__24669 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__24670 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__24670);
...
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__24669);
}}));
} else {
...
(jsprops.onChange = (function (p1__24690_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__24690_SHARP_);
}));
