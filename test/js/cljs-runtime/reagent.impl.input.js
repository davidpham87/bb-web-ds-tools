...
var G__24605 = shadow_root.activeElement;
active_element = G__24605;
continue;
} else {
...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__24569){
var map__24570 = p__24569;
var map__24570__$1 = cljs.core.__destructure_map(map__24570);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24570__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(jsprops.onChange = (function (p1__24585_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__24585_SHARP_);
}));
