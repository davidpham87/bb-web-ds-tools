...
var vec__54291 = cljs.core.rest(expr);
...
var vec__54294 = first__54293;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54294,(0),null);
var form = seq__54292__$1;
...
var G__54297 = x;
var G__54297__$1 = (((G__54297 == null))?null:spec_tools.impl.polish(G__54297));
var G__54297__$2 = (((G__54297__$1 == null))?null:cljs.core.name(G__54297__$1));
if((G__54297__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54297__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__54298 = x;
var G__54298__$1 = (((G__54298 == null))?null:cljs.core.name(G__54298));
if((G__54298__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54298__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__54299){
var map__54300 = p__54299;
var map__54300__$1 = cljs.core.__destructure_map(map__54300);
var data = map__54300__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54300__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54300__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54300__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54300__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__54301){
var map__54302 = p__54301;
var map__54302__$1 = cljs.core.__destructure_map(map__54302);
var data = map__54302__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54302__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54302__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__54303 = data;
var G__54303__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54303,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__54303);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54303__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__54303__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__54307 = form;
var G__54307__$1 = (((G__54307 == null))?null:cljs.core.rest(G__54307));
if((G__54307__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54307__$1);
}
})();
var G__54308 = m;
var G__54308__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54308,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__54304_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54304_SHARP_)));
})):G__54308);
var G__54308__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54308__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__54305_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54305_SHARP_)));
})):G__54308__$1);
var G__54308__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54308__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__54306_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__54306_SHARP_));
})):G__54308__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__54308__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__54309 = (function (){var G__54310 = form;
var G__54310__$1 = (((G__54310 == null))?null:cljs.core.rest(G__54310));
if((G__54310__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54310__$1);
}
})();
var map__54309__$1 = cljs.core.__destructure_map(map__54309);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54309__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54309__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54309__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54309__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__54314 = (function (){var and__5023__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__54319 = form;
var G__54319__$1 = (((G__54319 == null))?null:cljs.core.seq(G__54319));
var G__54319__$2 = (((G__54319__$1 == null))?null:cljs.core.first(G__54319__$1));
if((G__54319__$2 == null)){
return null;
} else {
var fexpr__54320 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__54320.cljs$core$IFn$_invoke$arity$1 ? fexpr__54320.cljs$core$IFn$_invoke$arity$1(G__54319__$2) : fexpr__54320.call(null,G__54319__$2));
}
})():null));
});
/**
...
var len__5749__auto___54405 = arguments.length;
var i__5750__auto___54406 = (0);
while(true){
if((i__5750__auto___54406 < len__5749__auto___54405)){
args__5755__auto__.push((arguments[i__5750__auto___54406]));

var G__54407 = (i__5750__auto___54406 + (1));
i__5750__auto___54406 = G__54407;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq54321){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq54321));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__54322){
var vec__54323 = p__54322;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54323,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54323,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__54329){
var map__54330 = p__54329;
var map__54330__$1 = cljs.core.__destructure_map(map__54330);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54330__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54330__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54330__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54330__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__54326_SHARP_){
return cljs.core.map_QMARK_(p1__54326_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__54327_SHARP_){
return cljs.core.contains_QMARK_(p1__54327_SHARP_,x);
});
}),req_keys));
