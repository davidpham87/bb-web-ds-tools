...
var vec__54516 = cljs.core.rest(expr);
var seq__54517 = cljs.core.seq(vec__54516);
var first__54518 = cljs.core.first(seq__54517);
var seq__54517__$1 = cljs.core.next(seq__54517);
var vec__54519 = first__54518;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54519,(0),null);
var form = seq__54517__$1;
...
var G__54522 = x;
var G__54522__$1 = (((G__54522 == null))?null:spec_tools.impl.polish(G__54522));
var G__54522__$2 = (((G__54522__$1 == null))?null:cljs.core.name(G__54522__$1));
if((G__54522__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54522__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__54523 = x;
var G__54523__$1 = (((G__54523 == null))?null:cljs.core.name(G__54523));
if((G__54523__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54523__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__54527){
var map__54528 = p__54527;
var map__54528__$1 = cljs.core.__destructure_map(map__54528);
var data = map__54528__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54528__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54528__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54528__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54528__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__54529){
var map__54530 = p__54529;
var map__54530__$1 = cljs.core.__destructure_map(map__54530);
var data = map__54530__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54530__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54530__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__54531 = data;
var G__54531__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54531,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__54531);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54531__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__54531__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__54535 = form;
var G__54535__$1 = (((G__54535 == null))?null:cljs.core.rest(G__54535));
if((G__54535__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54535__$1);
}
})();
var G__54536 = m;
var G__54536__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54536,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__54532_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54532_SHARP_)));
})):G__54536);
var G__54536__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54536__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__54533_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54533_SHARP_)));
})):G__54536__$1);
var G__54536__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54536__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__54534_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__54534_SHARP_));
})):G__54536__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__54536__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__54537 = (function (){var G__54538 = form;
var G__54538__$1 = (((G__54538 == null))?null:cljs.core.rest(G__54538));
if((G__54538__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54538__$1);
}
})();
var map__54537__$1 = cljs.core.__destructure_map(map__54537);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54537__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54537__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
...
var G__54539 = (function (){var and__5023__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__54543 = form;
var G__54543__$1 = (((G__54543 == null))?null:cljs.core.seq(G__54543));
var G__54543__$2 = (((G__54543__$1 == null))?null:cljs.core.first(G__54543__$1));
if((G__54543__$2 == null)){
return null;
} else {
var fexpr__54544 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__54544.cljs$core$IFn$_invoke$arity$1 ? fexpr__54544.cljs$core$IFn$_invoke$arity$1(G__54543__$2) : fexpr__54544.call(null,G__54543__$2));
}
})():null));
});
/**
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq54545){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq54545));
}));
