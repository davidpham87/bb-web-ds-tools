...
var vec__54488 = cljs.core.rest(expr);
var seq__54489 = cljs.core.seq(vec__54488);
var first__54490 = cljs.core.first(seq__54489);
var seq__54489__$1 = cljs.core.next(seq__54489);
var vec__54491 = first__54490;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54491,(0),null);
var form = seq__54489__$1;
...
var G__54494 = x;
var G__54494__$1 = (((G__54494 == null))?null:spec_tools.impl.polish(G__54494));
var G__54494__$2 = (((G__54494__$1 == null))?null:cljs.core.name(G__54494__$1));
if((G__54494__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54494__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__54499 = x;
var G__54499__$1 = (((G__54499 == null))?null:cljs.core.name(G__54499));
if((G__54499__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54499__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__54509){
var map__54510 = p__54509;
var map__54510__$1 = cljs.core.__destructure_map(map__54510);
var data = map__54510__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54510__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54510__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54510__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54510__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__54536){
var map__54537 = p__54536;
var map__54537__$1 = cljs.core.__destructure_map(map__54537);
var data = map__54537__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54537__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54537__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__54538 = data;
var G__54538__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54538,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__54538);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54538__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__54538__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__54542 = form;
var G__54542__$1 = (((G__54542 == null))?null:cljs.core.rest(G__54542));
if((G__54542__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54542__$1);
}
})();
var G__54543 = m;
var G__54543__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54543,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__54539_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54539_SHARP_)));
})):G__54543);
var G__54543__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54543__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__54540_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54540_SHARP_)));
})):G__54543__$1);
var G__54543__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54543__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__54541_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__54541_SHARP_));
})):G__54543__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__54543__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__54544 = (function (){var G__54545 = form;
var G__54545__$1 = (((G__54545 == null))?null:cljs.core.rest(G__54545));
if((G__54545__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54545__$1);
}
})();
var map__54544__$1 = cljs.core.__destructure_map(map__54544);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54544__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54544__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54544__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54544__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__54555 = (function (){var and__5023__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__54571 = form;
var G__54571__$1 = (((G__54571 == null))?null:cljs.core.seq(G__54571));
var G__54571__$2 = (((G__54571__$1 == null))?null:cljs.core.first(G__54571__$1));
if((G__54571__$2 == null)){
return null;
} else {
var fexpr__54577 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__54577.cljs$core$IFn$_invoke$arity$1 ? fexpr__54577.cljs$core$IFn$_invoke$arity$1(G__54571__$2) : fexpr__54577.call(null,G__54571__$2));
}
})():null));
});
/**
...
var len__5749__auto___54654 = arguments.length;
var i__5750__auto___54655 = (0);
while(true){
if((i__5750__auto___54655 < len__5749__auto___54654)){
args__5755__auto__.push((arguments[i__5750__auto___54655]));

var G__54656 = (i__5750__auto___54655 + (1));
i__5750__auto___54655 = G__54656;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq54580){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq54580));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__54581){
var vec__54582 = p__54581;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54582,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54582,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__54614){
var map__54615 = p__54614;
var map__54615__$1 = cljs.core.__destructure_map(map__54615);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54615__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54615__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54615__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54615__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__54610_SHARP_){
return cljs.core.map_QMARK_(p1__54610_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__54611_SHARP_){
return cljs.core.contains_QMARK_(p1__54611_SHARP_,x);
});
}),req_keys));
