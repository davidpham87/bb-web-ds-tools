...
var vec__61748 = cljs.core.rest(expr);
...
var vec__61751 = first__61750;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61751,(0),null);
var form = seq__61749__$1;
...
var G__61754 = x;
var G__61754__$1 = (((G__61754 == null))?null:spec_tools.impl.polish(G__61754));
var G__61754__$2 = (((G__61754__$1 == null))?null:cljs.core.name(G__61754__$1));
if((G__61754__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__61754__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__61755 = x;
var G__61755__$1 = (((G__61755 == null))?null:cljs.core.name(G__61755));
if((G__61755__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__61755__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__61756){
var map__61757 = p__61756;
var map__61757__$1 = cljs.core.__destructure_map(map__61757);
var data = map__61757__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61757__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61757__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61757__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61757__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__61758){
var map__61759 = p__61758;
var map__61759__$1 = cljs.core.__destructure_map(map__61759);
var data = map__61759__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61759__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61759__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__61760 = data;
var G__61760__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61760,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__61760);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61760__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__61760__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__61764 = form;
var G__61764__$1 = (((G__61764 == null))?null:cljs.core.rest(G__61764));
if((G__61764__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__61764__$1);
}
})();
var G__61765 = m;
var G__61765__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61765,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__61761_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__61761_SHARP_)));
})):G__61765);
var G__61765__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61765__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__61762_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__61762_SHARP_)));
})):G__61765__$1);
var G__61765__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61765__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__61763_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__61763_SHARP_));
})):G__61765__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__61765__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__61766 = (function (){var G__61767 = form;
var G__61767__$1 = (((G__61767 == null))?null:cljs.core.rest(G__61767));
if((G__61767__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__61767__$1);
}
})();
var map__61766__$1 = cljs.core.__destructure_map(map__61766);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61766__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61766__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61766__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61766__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__61768 = (function (){var and__5023__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__61769 = form;
var G__61769__$1 = (((G__61769 == null))?null:cljs.core.seq(G__61769));
var G__61769__$2 = (((G__61769__$1 == null))?null:cljs.core.first(G__61769__$1));
if((G__61769__$2 == null)){
return null;
} else {
var fexpr__61770 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__61770.cljs$core$IFn$_invoke$arity$1 ? fexpr__61770.cljs$core$IFn$_invoke$arity$1(G__61769__$2) : fexpr__61770.call(null,G__61769__$2));
}
})():null));
});
/**
...
var len__5749__auto___61784 = arguments.length;
var i__5750__auto___61785 = (0);
while(true){
if((i__5750__auto___61785 < len__5749__auto___61784)){
args__5755__auto__.push((arguments[i__5750__auto___61785]));

var G__61786 = (i__5750__auto___61785 + (1));
i__5750__auto___61785 = G__61786;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq61771){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq61771));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__61772){
var vec__61773 = p__61772;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61773,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61773,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__61781){
var map__61782 = p__61781;
var map__61782__$1 = cljs.core.__destructure_map(map__61782);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61782__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61782__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61782__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61782__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__61779_SHARP_){
return cljs.core.map_QMARK_(p1__61779_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__61780_SHARP_){
return cljs.core.contains_QMARK_(p1__61780_SHARP_,x);
});
}),req_keys));
