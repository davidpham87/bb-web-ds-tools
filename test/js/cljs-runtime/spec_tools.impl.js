...
var vec__61845 = cljs.core.rest(expr);
var seq__61846 = cljs.core.seq(vec__61845);
var first__61847 = cljs.core.first(seq__61846);
var seq__61846__$1 = cljs.core.next(seq__61846);
var vec__61848 = first__61847;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61848,(0),null);
var form = seq__61846__$1;
...
var G__61851 = x;
var G__61851__$1 = (((G__61851 == null))?null:spec_tools.impl.polish(G__61851));
var G__61851__$2 = (((G__61851__$1 == null))?null:cljs.core.name(G__61851__$1));
if((G__61851__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__61851__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__61855 = x;
var G__61855__$1 = (((G__61855 == null))?null:cljs.core.name(G__61855));
if((G__61855__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__61855__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__61856){
var map__61857 = p__61856;
var map__61857__$1 = cljs.core.__destructure_map(map__61857);
var data = map__61857__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61857__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61857__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61857__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61857__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__61858){
var map__61859 = p__61858;
var map__61859__$1 = cljs.core.__destructure_map(map__61859);
var data = map__61859__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61859__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61859__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__61860 = data;
var G__61860__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61860,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__61860);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61860__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__61860__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__61864 = form;
var G__61864__$1 = (((G__61864 == null))?null:cljs.core.rest(G__61864));
if((G__61864__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__61864__$1);
}
})();
var G__61865 = m;
var G__61865__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61865,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__61861_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__61861_SHARP_)));
})):G__61865);
var G__61865__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61865__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__61862_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__61862_SHARP_)));
})):G__61865__$1);
var G__61865__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61865__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__61863_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__61863_SHARP_));
})):G__61865__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__61865__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__61866 = (function (){var G__61867 = form;
var G__61867__$1 = (((G__61867 == null))?null:cljs.core.rest(G__61867));
if((G__61867__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__61867__$1);
}
})();
var map__61866__$1 = cljs.core.__destructure_map(map__61866);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61866__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61866__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61866__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61866__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__61868 = (function (){var and__5023__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__61869 = form;
var G__61869__$1 = (((G__61869 == null))?null:cljs.core.seq(G__61869));
var G__61869__$2 = (((G__61869__$1 == null))?null:cljs.core.first(G__61869__$1));
if((G__61869__$2 == null)){
return null;
} else {
var fexpr__61870 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__61870.cljs$core$IFn$_invoke$arity$1 ? fexpr__61870.cljs$core$IFn$_invoke$arity$1(G__61869__$2) : fexpr__61870.call(null,G__61869__$2));
}
})():null));
});
/**
...
var len__5749__auto___61895 = arguments.length;
var i__5750__auto___61896 = (0);
while(true){
if((i__5750__auto___61896 < len__5749__auto___61895)){
args__5755__auto__.push((arguments[i__5750__auto___61896]));

var G__61897 = (i__5750__auto___61896 + (1));
i__5750__auto___61896 = G__61897;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq61874){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq61874));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__61875){
var vec__61876 = p__61875;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61876,(0),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__61885){
var map__61886 = p__61885;
var map__61886__$1 = cljs.core.__destructure_map(map__61886);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61886__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61886__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61886__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61886__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__61883_SHARP_){
return cljs.core.map_QMARK_(p1__61883_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__61884_SHARP_){
return cljs.core.contains_QMARK_(p1__61884_SHARP_,x);
});
}),req_keys));
