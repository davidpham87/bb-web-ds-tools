...
var vec__54303 = cljs.core.rest(expr);
var seq__54304 = cljs.core.seq(vec__54303);
var first__54305 = cljs.core.first(seq__54304);
var seq__54304__$1 = cljs.core.next(seq__54304);
var vec__54306 = first__54305;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54306,(0),null);
var form = seq__54304__$1;
...
var G__54309 = x;
var G__54309__$1 = (((G__54309 == null))?null:spec_tools.impl.polish(G__54309));
var G__54309__$2 = (((G__54309__$1 == null))?null:cljs.core.name(G__54309__$1));
if((G__54309__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54309__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__54310 = x;
var G__54310__$1 = (((G__54310 == null))?null:cljs.core.name(G__54310));
if((G__54310__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54310__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__54311){
var map__54312 = p__54311;
var map__54312__$1 = cljs.core.__destructure_map(map__54312);
var data = map__54312__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54312__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54312__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54312__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54312__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__54317){
var map__54318 = p__54317;
var map__54318__$1 = cljs.core.__destructure_map(map__54318);
var data = map__54318__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54318__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54318__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__54319 = data;
var G__54319__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54319,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__54319);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54319__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__54319__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__54323 = form;
var G__54323__$1 = (((G__54323 == null))?null:cljs.core.rest(G__54323));
if((G__54323__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54323__$1);
}
})();
var G__54324 = m;
var G__54324__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54324,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__54320_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54320_SHARP_)));
})):G__54324);
var G__54324__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54324__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__54321_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54321_SHARP_)));
})):G__54324__$1);
var G__54324__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54324__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__54322_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__54322_SHARP_));
})):G__54324__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__54324__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__54325 = (function (){var G__54326 = form;
var G__54326__$1 = (((G__54326 == null))?null:cljs.core.rest(G__54326));
if((G__54326__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54326__$1);
}
})();
var map__54325__$1 = cljs.core.__destructure_map(map__54325);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54325__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54325__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54325__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54325__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__54327 = (function (){var and__5023__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__54328 = form;
var G__54328__$1 = (((G__54328 == null))?null:cljs.core.seq(G__54328));
var G__54328__$2 = (((G__54328__$1 == null))?null:cljs.core.first(G__54328__$1));
if((G__54328__$2 == null)){
return null;
} else {
var fexpr__54329 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__54329.cljs$core$IFn$_invoke$arity$1 ? fexpr__54329.cljs$core$IFn$_invoke$arity$1(G__54328__$2) : fexpr__54329.call(null,G__54328__$2));
}
})():null));
});
/**
...
var len__5749__auto___54402 = arguments.length;
var i__5750__auto___54403 = (0);
while(true){
if((i__5750__auto___54403 < len__5749__auto___54402)){
args__5755__auto__.push((arguments[i__5750__auto___54403]));

var G__54404 = (i__5750__auto___54403 + (1));
i__5750__auto___54403 = G__54404;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq54331){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq54331));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__54336){
var vec__54337 = p__54336;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54337,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54337,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__54361){
var map__54362 = p__54361;
var map__54362__$1 = cljs.core.__destructure_map(map__54362);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54362__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54362__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54362__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54362__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__54355_SHARP_){
return cljs.core.map_QMARK_(p1__54355_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__54356_SHARP_){
return cljs.core.contains_QMARK_(p1__54356_SHARP_,x);
});
}),req_keys));
