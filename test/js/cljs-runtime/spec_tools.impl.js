...
var vec__54399 = cljs.core.rest(expr);
var seq__54400 = cljs.core.seq(vec__54399);
var first__54401 = cljs.core.first(seq__54400);
var seq__54400__$1 = cljs.core.next(seq__54400);
var vec__54402 = first__54401;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54402,(0),null);
var form = seq__54400__$1;
...
var G__54406 = x;
var G__54406__$1 = (((G__54406 == null))?null:spec_tools.impl.polish(G__54406));
var G__54406__$2 = (((G__54406__$1 == null))?null:cljs.core.name(G__54406__$1));
if((G__54406__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54406__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__54410 = x;
var G__54410__$1 = (((G__54410 == null))?null:cljs.core.name(G__54410));
if((G__54410__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54410__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__54412){
var map__54413 = p__54412;
var map__54413__$1 = cljs.core.__destructure_map(map__54413);
var data = map__54413__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54413__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54413__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54413__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54413__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__54414){
var map__54415 = p__54414;
var map__54415__$1 = cljs.core.__destructure_map(map__54415);
var data = map__54415__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54415__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54415__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__54416 = data;
var G__54416__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54416,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__54416);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54416__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__54416__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__54421 = form;
var G__54421__$1 = (((G__54421 == null))?null:cljs.core.rest(G__54421));
if((G__54421__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54421__$1);
}
})();
var G__54422 = m;
var G__54422__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54422,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__54418_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54418_SHARP_)));
})):G__54422);
var G__54422__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54422__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__54419_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54419_SHARP_)));
})):G__54422__$1);
var G__54422__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54422__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__54420_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__54420_SHARP_));
})):G__54422__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__54422__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__54423 = (function (){var G__54424 = form;
var G__54424__$1 = (((G__54424 == null))?null:cljs.core.rest(G__54424));
if((G__54424__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54424__$1);
}
})();
var map__54423__$1 = cljs.core.__destructure_map(map__54423);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54423__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54423__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54423__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54423__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__54443 = (function (){var and__5023__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__54444 = form;
var G__54444__$1 = (((G__54444 == null))?null:cljs.core.seq(G__54444));
var G__54444__$2 = (((G__54444__$1 == null))?null:cljs.core.first(G__54444__$1));
if((G__54444__$2 == null)){
return null;
} else {
var fexpr__54453 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__54453.cljs$core$IFn$_invoke$arity$1 ? fexpr__54453.cljs$core$IFn$_invoke$arity$1(G__54444__$2) : fexpr__54453.call(null,G__54444__$2));
}
})():null));
});
/**
...
var len__5749__auto___54546 = arguments.length;
var i__5750__auto___54547 = (0);
while(true){
if((i__5750__auto___54547 < len__5749__auto___54546)){
args__5755__auto__.push((arguments[i__5750__auto___54547]));

var G__54552 = (i__5750__auto___54547 + (1));
i__5750__auto___54547 = G__54552;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq54471){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq54471));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__54485){
var vec__54486 = p__54485;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54486,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54486,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__54503){
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__54489_SHARP_){
return cljs.core.map_QMARK_(p1__54489_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__54490_SHARP_){
return cljs.core.contains_QMARK_(p1__54490_SHARP_,x);
});
}),req_keys));
