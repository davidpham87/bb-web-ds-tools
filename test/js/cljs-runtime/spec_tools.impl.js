...
var vec__54380 = cljs.core.rest(expr);
var seq__54381 = cljs.core.seq(vec__54380);
var first__54382 = cljs.core.first(seq__54381);
var seq__54381__$1 = cljs.core.next(seq__54381);
var vec__54383 = first__54382;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54383,(0),null);
var form = seq__54381__$1;
...
var G__54386 = x;
var G__54386__$1 = (((G__54386 == null))?null:spec_tools.impl.polish(G__54386));
var G__54386__$2 = (((G__54386__$1 == null))?null:cljs.core.name(G__54386__$1));
if((G__54386__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54386__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__54388 = x;
var G__54388__$1 = (((G__54388 == null))?null:cljs.core.name(G__54388));
if((G__54388__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54388__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__54390){
var map__54391 = p__54390;
var map__54391__$1 = cljs.core.__destructure_map(map__54391);
var data = map__54391__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54391__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54391__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54391__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54391__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__54392){
var map__54393 = p__54392;
var map__54393__$1 = cljs.core.__destructure_map(map__54393);
var data = map__54393__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54393__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54393__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__54394 = data;
var G__54394__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54394,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__54394);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54394__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__54394__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__54398 = form;
var G__54398__$1 = (((G__54398 == null))?null:cljs.core.rest(G__54398));
if((G__54398__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54398__$1);
}
})();
var G__54399 = m;
var G__54399__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54399,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__54395_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54395_SHARP_)));
})):G__54399);
var G__54399__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54399__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__54396_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54396_SHARP_)));
})):G__54399__$1);
var G__54399__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54399__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__54397_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__54397_SHARP_));
})):G__54399__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__54399__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__54400 = (function (){var G__54401 = form;
var G__54401__$1 = (((G__54401 == null))?null:cljs.core.rest(G__54401));
if((G__54401__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54401__$1);
}
})();
var map__54400__$1 = cljs.core.__destructure_map(map__54400);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54400__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54400__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54400__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54400__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__54402 = (function (){var and__5023__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__54403 = form;
var G__54403__$1 = (((G__54403 == null))?null:cljs.core.seq(G__54403));
var G__54403__$2 = (((G__54403__$1 == null))?null:cljs.core.first(G__54403__$1));
if((G__54403__$2 == null)){
return null;
} else {
var fexpr__54407 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__54407.cljs$core$IFn$_invoke$arity$1 ? fexpr__54407.cljs$core$IFn$_invoke$arity$1(G__54403__$2) : fexpr__54407.call(null,G__54403__$2));
}
})():null));
});
/**
...
var len__5749__auto___54431 = arguments.length;
var i__5750__auto___54432 = (0);
while(true){
if((i__5750__auto___54432 < len__5749__auto___54431)){
args__5755__auto__.push((arguments[i__5750__auto___54432]));

var G__54433 = (i__5750__auto___54432 + (1));
i__5750__auto___54432 = G__54433;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq54410){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq54410));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__54411){
var vec__54412 = p__54411;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54412,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54412,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__54417){
var map__54418 = p__54417;
var map__54418__$1 = cljs.core.__destructure_map(map__54418);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54418__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54418__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54418__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54418__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__54415_SHARP_){
return cljs.core.map_QMARK_(p1__54415_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__54416_SHARP_){
return cljs.core.contains_QMARK_(p1__54416_SHARP_,x);
});
}),req_keys));
