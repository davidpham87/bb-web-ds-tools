...
var vec__61660 = cljs.core.rest(expr);
...
var vec__61663 = first__61662;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61663,(0),null);
var form = seq__61661__$1;
...
var G__61666 = x;
var G__61666__$1 = (((G__61666 == null))?null:spec_tools.impl.polish(G__61666));
var G__61666__$2 = (((G__61666__$1 == null))?null:cljs.core.name(G__61666__$1));
if((G__61666__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__61666__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__61667 = x;
var G__61667__$1 = (((G__61667 == null))?null:cljs.core.name(G__61667));
if((G__61667__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__61667__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__61668){
var map__61669 = p__61668;
var map__61669__$1 = cljs.core.__destructure_map(map__61669);
var data = map__61669__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61669__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61669__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61669__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61669__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__61670){
var map__61671 = p__61670;
var map__61671__$1 = cljs.core.__destructure_map(map__61671);
var data = map__61671__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61671__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61671__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__61675 = data;
var G__61675__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61675,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__61675);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61675__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__61675__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__61679 = form;
var G__61679__$1 = (((G__61679 == null))?null:cljs.core.rest(G__61679));
if((G__61679__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__61679__$1);
}
})();
var G__61680 = m;
var G__61680__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61680,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__61676_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__61676_SHARP_)));
})):G__61680);
var G__61680__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61680__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__61677_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__61677_SHARP_)));
})):G__61680__$1);
var G__61680__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61680__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__61678_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__61678_SHARP_));
})):G__61680__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__61680__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__61681 = (function (){var G__61682 = form;
var G__61682__$1 = (((G__61682 == null))?null:cljs.core.rest(G__61682));
if((G__61682__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__61682__$1);
}
})();
var map__61681__$1 = cljs.core.__destructure_map(map__61681);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61681__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61681__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61681__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61681__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__61683 = (function (){var and__5023__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__61684 = form;
var G__61684__$1 = (((G__61684 == null))?null:cljs.core.seq(G__61684));
var G__61684__$2 = (((G__61684__$1 == null))?null:cljs.core.first(G__61684__$1));
if((G__61684__$2 == null)){
return null;
} else {
var fexpr__61685 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__61685.cljs$core$IFn$_invoke$arity$1 ? fexpr__61685.cljs$core$IFn$_invoke$arity$1(G__61684__$2) : fexpr__61685.call(null,G__61684__$2));
}
})():null));
});
/**
...
var len__5749__auto___61720 = arguments.length;
var i__5750__auto___61721 = (0);
while(true){
if((i__5750__auto___61721 < len__5749__auto___61720)){
args__5755__auto__.push((arguments[i__5750__auto___61721]));

var G__61722 = (i__5750__auto___61721 + (1));
i__5750__auto___61721 = G__61722;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq61686){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq61686));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__61690){
var vec__61691 = p__61690;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61691,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61691,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__61700){
var map__61701 = p__61700;
var map__61701__$1 = cljs.core.__destructure_map(map__61701);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61701__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61701__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61701__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61701__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__61698_SHARP_){
return cljs.core.map_QMARK_(p1__61698_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__61699_SHARP_){
return cljs.core.contains_QMARK_(p1__61699_SHARP_,x);
});
}),req_keys));
