...
var vec__54389 = cljs.core.rest(expr);
var seq__54390 = cljs.core.seq(vec__54389);
var first__54391 = cljs.core.first(seq__54390);
var seq__54390__$1 = cljs.core.next(seq__54390);
var vec__54392 = first__54391;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54392,(0),null);
var form = seq__54390__$1;
...
var G__54395 = x;
var G__54395__$1 = (((G__54395 == null))?null:spec_tools.impl.polish(G__54395));
var G__54395__$2 = (((G__54395__$1 == null))?null:cljs.core.name(G__54395__$1));
if((G__54395__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54395__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__54396 = x;
var G__54396__$1 = (((G__54396 == null))?null:cljs.core.name(G__54396));
if((G__54396__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54396__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__54397){
var map__54398 = p__54397;
var map__54398__$1 = cljs.core.__destructure_map(map__54398);
var data = map__54398__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54398__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54398__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54398__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54398__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__54399){
var map__54400 = p__54399;
var map__54400__$1 = cljs.core.__destructure_map(map__54400);
var data = map__54400__$1;
...
var G__54401 = data;
var G__54401__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54401,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__54401);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54401__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__54401__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__54405 = form;
var G__54405__$1 = (((G__54405 == null))?null:cljs.core.rest(G__54405));
if((G__54405__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54405__$1);
}
})();
var G__54406 = m;
var G__54406__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54406,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__54402_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54402_SHARP_)));
})):G__54406);
var G__54406__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54406__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__54403_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54403_SHARP_)));
})):G__54406__$1);
var G__54406__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54406__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__54404_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__54404_SHARP_));
})):G__54406__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__54406__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__54410 = (function (){var G__54411 = form;
var G__54411__$1 = (((G__54411 == null))?null:cljs.core.rest(G__54411));
if((G__54411__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54411__$1);
}
})();
var map__54410__$1 = cljs.core.__destructure_map(map__54410);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54410__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54410__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54410__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54410__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__54416 = (function (){var and__5023__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__54417 = form;
var G__54417__$1 = (((G__54417 == null))?null:cljs.core.seq(G__54417));
var G__54417__$2 = (((G__54417__$1 == null))?null:cljs.core.first(G__54417__$1));
if((G__54417__$2 == null)){
return null;
} else {
var fexpr__54418 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__54418.cljs$core$IFn$_invoke$arity$1 ? fexpr__54418.cljs$core$IFn$_invoke$arity$1(G__54417__$2) : fexpr__54418.call(null,G__54417__$2));
}
})():null));
});
/**
...
var len__5749__auto___54491 = arguments.length;
var i__5750__auto___54492 = (0);
while(true){
if((i__5750__auto___54492 < len__5749__auto___54491)){
args__5755__auto__.push((arguments[i__5750__auto___54492]));

var G__54493 = (i__5750__auto___54492 + (1));
i__5750__auto___54492 = G__54493;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq54419){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq54419));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__54420){
var vec__54421 = p__54420;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54421,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54421,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__54432){
var map__54433 = p__54432;
var map__54433__$1 = cljs.core.__destructure_map(map__54433);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54433__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54433__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54433__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54433__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__54429_SHARP_){
return cljs.core.map_QMARK_(p1__54429_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__54430_SHARP_){
return cljs.core.contains_QMARK_(p1__54430_SHARP_,x);
});
}),req_keys));
