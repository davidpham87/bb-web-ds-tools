...
var vec__61672 = cljs.core.rest(expr);
...
var vec__61675 = first__61674;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61675,(0),null);
var form = seq__61673__$1;
...
var G__61678 = x;
var G__61678__$1 = (((G__61678 == null))?null:spec_tools.impl.polish(G__61678));
var G__61678__$2 = (((G__61678__$1 == null))?null:cljs.core.name(G__61678__$1));
if((G__61678__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__61678__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__61679 = x;
var G__61679__$1 = (((G__61679 == null))?null:cljs.core.name(G__61679));
if((G__61679__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__61679__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__61680){
var map__61681 = p__61680;
var map__61681__$1 = cljs.core.__destructure_map(map__61681);
var data = map__61681__$1;
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__61682){
var map__61683 = p__61682;
var map__61683__$1 = cljs.core.__destructure_map(map__61683);
var data = map__61683__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61683__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61683__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__61684 = data;
var G__61684__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61684,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__61684);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61684__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__61684__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__61688 = form;
var G__61688__$1 = (((G__61688 == null))?null:cljs.core.rest(G__61688));
if((G__61688__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__61688__$1);
}
})();
var G__61689 = m;
var G__61689__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61689,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__61685_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__61685_SHARP_)));
})):G__61689);
var G__61689__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61689__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__61686_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__61686_SHARP_)));
})):G__61689__$1);
var G__61689__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61689__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__61687_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__61687_SHARP_));
})):G__61689__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__61689__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__61691 = (function (){var G__61692 = form;
var G__61692__$1 = (((G__61692 == null))?null:cljs.core.rest(G__61692));
if((G__61692__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__61692__$1);
}
})();
var map__61691__$1 = cljs.core.__destructure_map(map__61691);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61691__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61691__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61691__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61691__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__61697 = (function (){var and__5023__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__61702 = form;
var G__61702__$1 = (((G__61702 == null))?null:cljs.core.seq(G__61702));
var G__61702__$2 = (((G__61702__$1 == null))?null:cljs.core.first(G__61702__$1));
if((G__61702__$2 == null)){
return null;
} else {
var fexpr__61703 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__61703.cljs$core$IFn$_invoke$arity$1 ? fexpr__61703.cljs$core$IFn$_invoke$arity$1(G__61702__$2) : fexpr__61703.call(null,G__61702__$2));
}
})():null));
});
/**
...
var len__5749__auto___61812 = arguments.length;
var i__5750__auto___61815 = (0);
while(true){
if((i__5750__auto___61815 < len__5749__auto___61812)){
args__5755__auto__.push((arguments[i__5750__auto___61815]));

var G__61816 = (i__5750__auto___61815 + (1));
i__5750__auto___61815 = G__61816;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq61719){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq61719));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__61720){
var vec__61721 = p__61720;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61721,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61721,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__61764){
var map__61765 = p__61764;
var map__61765__$1 = cljs.core.__destructure_map(map__61765);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61765__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61765__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61765__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61765__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__61762_SHARP_){
return cljs.core.map_QMARK_(p1__61762_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__61763_SHARP_){
return cljs.core.contains_QMARK_(p1__61763_SHARP_,x);
});
}),req_keys));
