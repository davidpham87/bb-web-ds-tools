...
var vec__54512 = cljs.core.rest(expr);
...
var vec__54515 = first__54514;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54515,(0),null);
var form = seq__54513__$1;
...
var G__54518 = x;
var G__54518__$1 = (((G__54518 == null))?null:spec_tools.impl.polish(G__54518));
var G__54518__$2 = (((G__54518__$1 == null))?null:cljs.core.name(G__54518__$1));
if((G__54518__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54518__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__54521 = x;
var G__54521__$1 = (((G__54521 == null))?null:cljs.core.name(G__54521));
if((G__54521__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54521__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__54523){
var map__54527 = p__54523;
var map__54527__$1 = cljs.core.__destructure_map(map__54527);
var data = map__54527__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54527__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54527__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54527__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54527__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__54551){
var map__54552 = p__54551;
var map__54552__$1 = cljs.core.__destructure_map(map__54552);
var data = map__54552__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54552__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54552__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__54558 = data;
var G__54558__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54558,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__54558);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54558__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__54558__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__54564 = form;
var G__54564__$1 = (((G__54564 == null))?null:cljs.core.rest(G__54564));
if((G__54564__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54564__$1);
}
})();
var G__54565 = m;
var G__54565__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54565,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__54560_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54560_SHARP_)));
})):G__54565);
var G__54565__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54565__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__54561_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54561_SHARP_)));
})):G__54565__$1);
var G__54565__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54565__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__54562_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__54562_SHARP_));
})):G__54565__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__54565__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__54566 = (function (){var G__54567 = form;
var G__54567__$1 = (((G__54567 == null))?null:cljs.core.rest(G__54567));
if((G__54567__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54567__$1);
}
})();
var map__54566__$1 = cljs.core.__destructure_map(map__54566);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54566__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54566__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54566__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54566__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__54572 = (function (){var and__5023__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__54575 = form;
var G__54575__$1 = (((G__54575 == null))?null:cljs.core.seq(G__54575));
var G__54575__$2 = (((G__54575__$1 == null))?null:cljs.core.first(G__54575__$1));
if((G__54575__$2 == null)){
return null;
} else {
var fexpr__54576 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__54576.cljs$core$IFn$_invoke$arity$1 ? fexpr__54576.cljs$core$IFn$_invoke$arity$1(G__54575__$2) : fexpr__54576.call(null,G__54575__$2));
}
})():null));
});
/**
...
var len__5749__auto___54604 = arguments.length;
var i__5750__auto___54605 = (0);
while(true){
if((i__5750__auto___54605 < len__5749__auto___54604)){
args__5755__auto__.push((arguments[i__5750__auto___54605]));

var G__54606 = (i__5750__auto___54605 + (1));
i__5750__auto___54605 = G__54606;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq54577){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq54577));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__54578){
var vec__54579 = p__54578;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54579,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54579,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__54589){
var map__54590 = p__54589;
var map__54590__$1 = cljs.core.__destructure_map(map__54590);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54590__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54590__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54590__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54590__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__54587_SHARP_){
return cljs.core.map_QMARK_(p1__54587_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__54588_SHARP_){
return cljs.core.contains_QMARK_(p1__54588_SHARP_,x);
});
}),req_keys));
