...
var vec__54419 = cljs.core.rest(expr);
var seq__54420 = cljs.core.seq(vec__54419);
var first__54421 = cljs.core.first(seq__54420);
var seq__54420__$1 = cljs.core.next(seq__54420);
var vec__54422 = first__54421;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54422,(0),null);
var form = seq__54420__$1;
...
var G__54429 = x;
var G__54429__$1 = (((G__54429 == null))?null:spec_tools.impl.polish(G__54429));
var G__54429__$2 = (((G__54429__$1 == null))?null:cljs.core.name(G__54429__$1));
if((G__54429__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54429__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__54430 = x;
var G__54430__$1 = (((G__54430 == null))?null:cljs.core.name(G__54430));
if((G__54430__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54430__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__54431){
var map__54432 = p__54431;
var map__54432__$1 = cljs.core.__destructure_map(map__54432);
var data = map__54432__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54432__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54432__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54432__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54432__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__54450){
var map__54451 = p__54450;
var map__54451__$1 = cljs.core.__destructure_map(map__54451);
var data = map__54451__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54451__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54451__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__54455 = data;
var G__54455__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54455,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__54455);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54455__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__54455__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__54473 = form;
var G__54473__$1 = (((G__54473 == null))?null:cljs.core.rest(G__54473));
if((G__54473__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54473__$1);
}
})();
var G__54478 = m;
var G__54478__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54478,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__54463_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54463_SHARP_)));
})):G__54478);
var G__54478__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54478__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__54468_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54468_SHARP_)));
})):G__54478__$1);
var G__54478__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54478__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__54469_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__54469_SHARP_));
})):G__54478__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__54478__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__54479 = (function (){var G__54480 = form;
var G__54480__$1 = (((G__54480 == null))?null:cljs.core.rest(G__54480));
if((G__54480__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54480__$1);
}
})();
var map__54479__$1 = cljs.core.__destructure_map(map__54479);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54479__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54479__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54479__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54479__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__54481 = (function (){var and__5023__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__54494 = form;
var G__54494__$1 = (((G__54494 == null))?null:cljs.core.seq(G__54494));
var G__54494__$2 = (((G__54494__$1 == null))?null:cljs.core.first(G__54494__$1));
if((G__54494__$2 == null)){
return null;
} else {
var fexpr__54495 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__54495.cljs$core$IFn$_invoke$arity$1 ? fexpr__54495.cljs$core$IFn$_invoke$arity$1(G__54494__$2) : fexpr__54495.call(null,G__54494__$2));
}
})():null));
});
/**
...
var len__5749__auto___54590 = arguments.length;
var i__5750__auto___54591 = (0);
while(true){
if((i__5750__auto___54591 < len__5749__auto___54590)){
args__5755__auto__.push((arguments[i__5750__auto___54591]));

var G__54592 = (i__5750__auto___54591 + (1));
i__5750__auto___54591 = G__54592;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq54513){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq54513));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__54527){
var vec__54535 = p__54527;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54535,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54535,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__54549){
var map__54550 = p__54549;
var map__54550__$1 = cljs.core.__destructure_map(map__54550);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54550__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54550__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54550__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54550__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__54547_SHARP_){
return cljs.core.map_QMARK_(p1__54547_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__54548_SHARP_){
return cljs.core.contains_QMARK_(p1__54548_SHARP_,x);
});
}),req_keys));
