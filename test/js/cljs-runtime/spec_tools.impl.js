...
var vec__54454 = cljs.core.rest(expr);
var seq__54455 = cljs.core.seq(vec__54454);
var first__54456 = cljs.core.first(seq__54455);
var seq__54455__$1 = cljs.core.next(seq__54455);
var vec__54457 = first__54456;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54457,(0),null);
var form = seq__54455__$1;
...
var G__54463 = x;
var G__54463__$1 = (((G__54463 == null))?null:spec_tools.impl.polish(G__54463));
var G__54463__$2 = (((G__54463__$1 == null))?null:cljs.core.name(G__54463__$1));
if((G__54463__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54463__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__54464 = x;
var G__54464__$1 = (((G__54464 == null))?null:cljs.core.name(G__54464));
if((G__54464__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54464__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__54465){
var map__54466 = p__54465;
var map__54466__$1 = cljs.core.__destructure_map(map__54466);
var data = map__54466__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54466__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54466__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54466__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54466__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__54467){
var map__54468 = p__54467;
var map__54468__$1 = cljs.core.__destructure_map(map__54468);
var data = map__54468__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54468__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54468__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__54469 = data;
var G__54469__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54469,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__54469);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54469__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__54469__$1;
}
});
...
var G__54474 = m;
var G__54474__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54474,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__54470_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54470_SHARP_)));
})):G__54474);
var G__54474__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54474__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__54471_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54471_SHARP_)));
})):G__54474__$1);
var G__54474__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54474__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__54472_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__54472_SHARP_));
})):G__54474__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__54474__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__54475 = (function (){var G__54476 = form;
var G__54476__$1 = (((G__54476 == null))?null:cljs.core.rest(G__54476));
if((G__54476__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54476__$1);
}
})();
var map__54475__$1 = cljs.core.__destructure_map(map__54475);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54475__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54475__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
...
var G__54477 = (function (){var and__5023__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__54481 = form;
var G__54481__$1 = (((G__54481 == null))?null:cljs.core.seq(G__54481));
var G__54481__$2 = (((G__54481__$1 == null))?null:cljs.core.first(G__54481__$1));
if((G__54481__$2 == null)){
return null;
} else {
var fexpr__54482 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__54482.cljs$core$IFn$_invoke$arity$1 ? fexpr__54482.cljs$core$IFn$_invoke$arity$1(G__54481__$2) : fexpr__54482.call(null,G__54481__$2));
}
})():null));
});
/**
...
var len__5749__auto___54574 = arguments.length;
var i__5750__auto___54575 = (0);
while(true){
if((i__5750__auto___54575 < len__5749__auto___54574)){
args__5755__auto__.push((arguments[i__5750__auto___54575]));

var G__54576 = (i__5750__auto___54575 + (1));
i__5750__auto___54575 = G__54576;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq54487){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq54487));
}));
...
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54489,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54489,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__54502){
var map__54504 = p__54502;
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__54498_SHARP_){
return cljs.core.map_QMARK_(p1__54498_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__54499_SHARP_){
return cljs.core.contains_QMARK_(p1__54499_SHARP_,x);
});
}),req_keys));
