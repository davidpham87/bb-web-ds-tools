...
var G__61195 = db;
var G__61196 = e;
var G__61197 = cljs.core.volatile_BANG_(false);
var G__61198 = cljs.core.volatile_BANG_(cljs.core.PersistentArrayMap.EMPTY);
return (datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4 ? datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4(G__61195,G__61196,G__61197,G__61198) : datascript.impl.entity.__GT_Entity.call(null,G__61195,G__61196,G__61197,G__61198));
} else {
return null;
}
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__61201_SHARP_,p2__61202_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__61201_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__61202_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
} else {
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__61203_SHARP_,p2__61204_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__61203_SHARP_,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__61204_SHARP_));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
if(datascript.db.ref_QMARK_(db,a)){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__61206_SHARP_,p2__61207_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__61206_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"e","e",1381269198).cljs$core$IFn$_invoke$arity$1(p2__61207_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
return not_found;
...
var iter__5503__auto__ = (function datascript$impl$entity$js_seq_$_iter__61209(s__61210){
return (new cljs.core.LazySeq(null,(function (){
var s__61210__$1 = s__61210;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__61210__$1);
if(temp__5825__auto__){
var s__61210__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__61210__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__61210__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__61212 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__61211 = (0);
while(true){
if((i__61211 < size__5502__auto__)){
var vec__61216 = cljs.core._nth(c__5501__auto__,i__61211);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61216,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61216,(1),null);
cljs.core.chunk_append(b__61212,((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)));

var G__61299 = (i__61211 + (1));
i__61211 = G__61299;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61212),datascript$impl$entity$js_seq_$_iter__61209(cljs.core.chunk_rest(s__61210__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61212),null);
}
} else {
var vec__61221 = cljs.core.first(s__61210__$2);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61221,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61221,(1),null);
return cljs.core.cons(((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)),datascript$impl$entity$js_seq_$_iter__61209(cljs.core.rest(s__61210__$2)));
}
} else {
return null;
}
...
var G__61300 = null;
var G__61300__1 = (function (f){
var self__ = this;
var this$ = this;
var seq__61227 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__61228 = null;
var count__61229 = (0);
var i__61230 = (0);
while(true){
if((i__61230 < count__61229)){
var vec__61257 = chunk__61228.cljs$core$IIndexed$_nth$arity$2(null,i__61230);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61257,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61257,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__61302 = seq__61227;
var G__61303 = chunk__61228;
var G__61304 = count__61229;
var G__61305 = (i__61230 + (1));
seq__61227 = G__61302;
chunk__61228 = G__61303;
count__61229 = G__61304;
i__61230 = G__61305;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__61227);
if(temp__5825__auto__){
var seq__61227__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__61227__$1)){
var c__5548__auto__ = cljs.core.chunk_first(seq__61227__$1);
var G__61306 = cljs.core.chunk_rest(seq__61227__$1);
var G__61307 = c__5548__auto__;
var G__61308 = cljs.core.count(c__5548__auto__);
var G__61309 = (0);
seq__61227 = G__61306;
chunk__61228 = G__61307;
count__61229 = G__61308;
i__61230 = G__61309;
continue;
} else {
var vec__61261 = cljs.core.first(seq__61227__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61261,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61261,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__61310 = cljs.core.next(seq__61227__$1);
var G__61311 = null;
var G__61312 = (0);
var G__61313 = (0);
seq__61227 = G__61310;
chunk__61228 = G__61311;
count__61229 = G__61312;
i__61230 = G__61313;
continue;
}
} else {
...
var G__61300__2 = (function (f,use_as_this){
var self__ = this;
var this$ = this;
var seq__61265 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__61266 = null;
var count__61267 = (0);
var i__61268 = (0);
while(true){
if((i__61268 < count__61267)){
var vec__61277 = chunk__61266.cljs$core$IIndexed$_nth$arity$2(null,i__61268);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61277,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61277,(1),null);
f.call(use_as_this,v,a,this$);


var G__61314 = seq__61265;
var G__61315 = chunk__61266;
var G__61316 = count__61267;
var G__61317 = (i__61268 + (1));
seq__61265 = G__61314;
chunk__61266 = G__61315;
count__61267 = G__61316;
i__61268 = G__61317;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__61265);
if(temp__5825__auto__){
var seq__61265__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__61265__$1)){
var c__5548__auto__ = cljs.core.chunk_first(seq__61265__$1);
var G__61319 = cljs.core.chunk_rest(seq__61265__$1);
var G__61320 = c__5548__auto__;
var G__61321 = cljs.core.count(c__5548__auto__);
var G__61322 = (0);
seq__61265 = G__61319;
chunk__61266 = G__61320;
count__61267 = G__61321;
i__61268 = G__61322;
continue;
} else {
var vec__61281 = cljs.core.first(seq__61265__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61281,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61281,(1),null);
f.call(use_as_this,v,a,this$);


var G__61324 = cljs.core.next(seq__61265__$1);
var G__61325 = null;
var G__61326 = (0);
var G__61327 = (0);
seq__61265 = G__61324;
chunk__61266 = G__61325;
count__61267 = G__61326;
i__61268 = G__61327;
continue;
}
} else {
...
G__61300 = function(f,use_as_this){
switch(arguments.length){
case 1:
return G__61300__1.call(this,f);
case 2:
return G__61300__2.call(this,f,use_as_this);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__61300.cljs$core$IFn$_invoke$arity$1 = G__61300__1;
G__61300.cljs$core$IFn$_invoke$arity$2 = G__61300__2;
return G__61300;
})()
);
...
var G__61284 = (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2(this$,attr) : datascript.impl.entity.lookup_entity.call(null,this$,attr));
if(datascript.db.multival_QMARK_(self__.db,attr)){
return datascript.impl.entity.multival__GT_js(G__61284);
} else {
return G__61284;
}
}
...
var self__ = this;
var self__ = this;
var G__61289 = (arguments.length - (1));
switch (G__61289) {
case (1):
...
(datascript.impl.entity.Entity.prototype.apply = (function (self__,args61226){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args61226)));
}));
...
var temp__5827__auto__ = (function (){var fexpr__61294 = cljs.core.deref(this$.cache);
return (fexpr__61294.cljs$core$IFn$_invoke$arity$1 ? fexpr__61294.cljs$core$IFn$_invoke$arity$1(attr) : fexpr__61294.call(null,attr));
})();
...
var temp__5825__auto___61396 = cljs.core.not_empty(datascript.db._search(e.db,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [e.eid], null)));
if(cljs.core.truth_(temp__5825__auto___61396)){
var datoms_61397 = temp__5825__auto___61396;
cljs.core.vreset_BANG_(e.cache,datascript.impl.entity.touch_components(e.db,datascript.impl.entity.datoms__GT_cache(e.db,datoms_61397)));
