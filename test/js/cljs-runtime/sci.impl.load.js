...
var referred__$1 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ns,p__35309){
var vec__35310 = p__35309;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35310,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35310,(1),null);
...
sci.impl.load.handle_require_libspec_env = (function sci$impl$load$handle_require_libspec_env(_ctx,env,current_ns,the_loaded_ns,lib_name,p__35398){
var map__35399 = p__35398;
var map__35399__$1 = cljs.core.__destructure_map(map__35399);
var opts = map__35399__$1;
var as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35399__$1,new cljs.core.Keyword(null,"as","as",1148689641));
var refer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35399__$1,new cljs.core.Keyword(null,"refer","refer",-964295553));
var refer_macros = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35399__$1,new cljs.core.Keyword(null,"refer-macros","refer-macros",-1906841953));
var rename = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35399__$1,new cljs.core.Keyword(null,"rename","rename",1508157613));
var exclude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35399__$1,new cljs.core.Keyword(null,"exclude","exclude",-1230250334));
var only = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35399__$1,new cljs.core.Keyword(null,"only","only",1907811652));
var use = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35399__$1,new cljs.core.Keyword(null,"use","use",-1846382424));
var or__5025__auto__ = ((typeof lib_name === 'string')?(function (){var vec__35400 = sci.impl.load.lib_PLUS_path(lib_name);
var lib_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35400,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35400,(1),null);
...
if(cljs.core.truth_(temp__5823__auto__)){
var vec__35436 = temp__5823__auto__;
var _k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35436,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35436,(1),null);
return v;
} else {
...
var temp__5825__auto___35728 = (function (){var G__35477 = the_loaded_ns;
var G__35477__$1 = (((G__35477 == null))?null:new cljs.core.Keyword(null,"obj","obj",981763962).cljs$core$IFn$_invoke$arity$1(G__35477));
var G__35477__$2 = (((G__35477__$1 == null))?null:cljs.core.meta(G__35477__$1));
if((G__35477__$2 == null)){
return null;
} else {
return new cljs.core.Keyword("sci.impl","required-fn","sci.impl/required-fn",2082701278).cljs$core$IFn$_invoke$arity$1(G__35477__$2);
}
})();
if(cljs.core.truth_(temp__5825__auto___35728)){
var on_loaded_35729 = temp__5825__auto___35728;
var G__35478_35730 = cljs.core.PersistentArrayMap.EMPTY;
(on_loaded_35729.cljs$core$IFn$_invoke$arity$1 ? on_loaded_35729.cljs$core$IFn$_invoke$arity$1(G__35478_35730) : on_loaded_35729.call(null,G__35478_35730));
} else {
}
...
var loaded_libs_var_35733 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(env__$1,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469),new cljs.core.Symbol(null,"clojure.core","clojure.core",-189332625,null),new cljs.core.Symbol(null,"*loaded-libs*","*loaded-libs*",1951428860,null)], null));
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(cljs.core.deref(loaded_libs_var_35733),cljs.core.conj,lib);
...
var or__5025__auto__ = ((js_lib_QMARK_)?(function (){var vec__35527 = sci.impl.load.lib_PLUS_path(lib__$1);
var lib__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35527,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35527,(1),null);
...
var reload = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35538__$1,new cljs.core.Keyword(null,"reload","reload",863702807));
var reload_all = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35538__$1,new cljs.core.Keyword(null,"reload-all","reload-all",761570200));
...
var temp__5823__auto___35736__$1 = (cljs.core.truth_(reload_STAR_)?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(namespaces,lib__$1));
if(cljs.core.truth_(temp__5823__auto___35736__$1)){
var the_loaded_ns_35737 = temp__5823__auto___35736__$1;
var loading_35738 = new cljs.core.Keyword(null,"loading","loading",-737050189).cljs$core$IFn$_invoke$arity$1(ctx);
if(cljs.core.truth_((function (){var and__5023__auto__ = loading_35738;
if(cljs.core.truth_(and__5023__auto__)){
return (((!(cljs.core.contains_QMARK_(new cljs.core.Keyword(null,"loaded-libs","loaded-libs",-1156389652).cljs$core$IFn$_invoke$arity$1(env),lib__$1)))) && (cljs.core.nat_int_QMARK_(loading_35738.indexOf(lib__$1))));
} else {
return and__5023__auto__;
}
})())){
...
var loading__$1 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(loading_35738,lib__$1);
...
cljs.core.reset_BANG_(env_STAR_,sci.impl.load.handle_require_libspec_env(ctx,env,cnn,the_loaded_ns_35737,lib__$1,opts));
}
}
} else {
var temp__5823__auto___35741__$2 = new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334).cljs$core$IFn$_invoke$arity$1(env);
if(cljs.core.truth_(temp__5823__auto___35741__$2)){
var load_fn_35742 = temp__5823__auto___35741__$2;
var curr_ns_35743 = cljs.core.deref(sci.impl.utils.current_ns);
var temp__5823__auto___35744__$3 = (function (){var G__35539 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"namespace","namespace",-377510372),lib__$1,new cljs.core.Keyword(null,"libname","libname",135992497),lib__$1,new cljs.core.Keyword(null,"ctx","ctx",-493610118),ctx,new cljs.core.Keyword(null,"opts","opts",155075701),opts,new cljs.core.Keyword(null,"ns","ns",441598760),sci.impl.types.getName(curr_ns_35743),new cljs.core.Keyword(null,"reload","reload",863702807),(function (){var or__5025__auto____$1 = reload;
if(cljs.core.truth_(or__5025__auto____$1)){
return or__5025__auto____$1;
} else {
return reload_all;
...
return (load_fn_35742.cljs$core$IFn$_invoke$arity$1 ? load_fn_35742.cljs$core$IFn$_invoke$arity$1(G__35539) : load_fn_35742.call(null,G__35539));
})();
if(cljs.core.truth_(temp__5823__auto___35744__$3)){
var map__35540_35745 = temp__5823__auto___35744__$3;
var map__35540_35746__$1 = cljs.core.__destructure_map(map__35540_35745);
var file_35747 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35540_35746__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var source_35748 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35540_35746__$1,new cljs.core.Keyword(null,"source","source",-433931539));
var handled_35749 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35540_35746__$1,new cljs.core.Keyword(null,"handled","handled",1889700151));
var ctx_35750__$1 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ctx,new cljs.core.Keyword(null,"bindings","bindings",1271397192),cljs.core.PersistentArrayMap.EMPTY),new cljs.core.Keyword(null,"reload-all","reload-all",761570200),reload_all),new cljs.core.Keyword(null,"loading","loading",-737050189),(function (loading){
if((loading == null)){
...
if(cljs.core.truth_(source_35748)){
try{sci.impl.vars.push_thread_bindings(cljs.core.PersistentArrayMap.createAsIfByAssoc([sci.impl.utils.current_ns,curr_ns_35743,sci.impl.utils.current_file,file_35747]));

try{var fexpr__35550_35754 = cljs.core.deref(sci.impl.utils.eval_string_STAR_);
(fexpr__35550_35754.cljs$core$IFn$_invoke$arity$2 ? fexpr__35550_35754.cljs$core$IFn$_invoke$arity$2(ctx_35750__$1,source_35748) : fexpr__35550_35754.call(null,ctx_35750__$1,source_35748));
...
if(cljs.core.truth_(handled_35749)){
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(env_STAR_,(function (env__$1){
...
var or__5025__auto___35757__$1 = (cljs.core.truth_(reload_STAR_)?(function (){var temp__5825__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(namespaces,lib__$1);
if(cljs.core.truth_(temp__5825__auto__)){
...
if(cljs.core.truth_(or__5025__auto___35757__$1)){
} else {
...
var len__5749__auto___35760 = arguments.length;
var i__5750__auto___35761 = (0);
while(true){
if((i__5750__auto___35761 < len__5749__auto___35760)){
args__5755__auto__.push((arguments[i__5750__auto___35761]));

var G__35762 = (i__5750__auto___35761 + (1));
i__5750__auto___35761 = G__35762;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.load.load_lib.cljs$lang$applyTo = (function (seq35567){
var G__35568 = cljs.core.first(seq35567);
var seq35567__$1 = cljs.core.next(seq35567);
var G__35569 = cljs.core.first(seq35567__$1);
var seq35567__$2 = cljs.core.next(seq35567__$1);
var G__35570 = cljs.core.first(seq35567__$2);
var seq35567__$3 = cljs.core.next(seq35567__$2);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35568,G__35569,G__35570,seq35567__$3);
}));
...
var seq__35595 = cljs.core.seq(args_STAR___$1);
var chunk__35596 = null;
var count__35597 = (0);
var i__35598 = (0);
while(true){
if((i__35598 < count__35597)){
var arg = chunk__35596.cljs$core$IIndexed$_nth$arity$2(null,i__35598);
...
var vec__35632_35772 = arg;
var seq__35633_35773 = cljs.core.seq(vec__35632_35772);
var first__35634_35774 = cljs.core.first(seq__35633_35773);
var seq__35633_35775__$1 = cljs.core.next(seq__35633_35773);
var prefix_35776 = first__35634_35774;
var args_STAR__35777__$2 = seq__35633_35775__$1;
if((prefix_35776 == null)){
sci.impl.utils.throw_error_with_location.cljs$core$IFn$_invoke$arity$2("prefix cannot be nil",args);
} else {
}

var seq__35635_35778 = cljs.core.seq(args_STAR__35777__$2);
var chunk__35636_35779 = null;
var count__35637_35780 = (0);
var i__35638_35781 = (0);
while(true){
if((i__35638_35781 < count__35637_35780)){
var arg_35782__$1 = chunk__35636_35779.cljs$core$IIndexed$_nth$arity$2(null,i__35638_35781);
cljs.core.apply.cljs$core$IFn$_invoke$arity$4(sci.impl.load.load_lib,ctx,prefix_35776,sci.impl.load.prependss(arg_35782__$1,opts));


var G__35784 = seq__35635_35778;
var G__35785 = chunk__35636_35779;
var G__35786 = count__35637_35780;
var G__35787 = (i__35638_35781 + (1));
seq__35635_35778 = G__35784;
chunk__35636_35779 = G__35785;
count__35637_35780 = G__35786;
i__35638_35781 = G__35787;
continue;
} else {
var temp__5825__auto___35789 = cljs.core.seq(seq__35635_35778);
if(temp__5825__auto___35789){
var seq__35635_35791__$1 = temp__5825__auto___35789;
if(cljs.core.chunked_seq_QMARK_(seq__35635_35791__$1)){
var c__5548__auto___35792 = cljs.core.chunk_first(seq__35635_35791__$1);
var G__35793 = cljs.core.chunk_rest(seq__35635_35791__$1);
var G__35794 = c__5548__auto___35792;
var G__35795 = cljs.core.count(c__5548__auto___35792);
var G__35796 = (0);
seq__35635_35778 = G__35793;
chunk__35636_35779 = G__35794;
count__35637_35780 = G__35795;
i__35638_35781 = G__35796;
continue;
} else {
var arg_35797__$1 = cljs.core.first(seq__35635_35791__$1);
cljs.core.apply.cljs$core$IFn$_invoke$arity$4(sci.impl.load.load_lib,ctx,prefix_35776,sci.impl.load.prependss(arg_35797__$1,opts));


var G__35798 = cljs.core.next(seq__35635_35791__$1);
var G__35799 = null;
var G__35800 = (0);
var G__35801 = (0);
seq__35635_35778 = G__35798;
chunk__35636_35779 = G__35799;
count__35637_35780 = G__35800;
i__35638_35781 = G__35801;
continue;
}
} else {
}
...
var G__35802 = seq__35595;
var G__35803 = chunk__35596;
var G__35804 = count__35597;
var G__35805 = (i__35598 + (1));
seq__35595 = G__35802;
chunk__35596 = G__35803;
count__35597 = G__35804;
i__35598 = G__35805;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__35595);
if(temp__5825__auto__){
var seq__35595__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__35595__$1)){
var c__5548__auto__ = cljs.core.chunk_first(seq__35595__$1);
var G__35806 = cljs.core.chunk_rest(seq__35595__$1);
var G__35807 = c__5548__auto__;
var G__35808 = cljs.core.count(c__5548__auto__);
var G__35809 = (0);
seq__35595 = G__35806;
chunk__35596 = G__35807;
count__35597 = G__35808;
i__35598 = G__35809;
continue;
} else {
var arg = cljs.core.first(seq__35595__$1);
if(sci.impl.load.libspec_QMARK_(arg)){
cljs.core.apply.cljs$core$IFn$_invoke$arity$4(sci.impl.load.load_lib,ctx,null,sci.impl.load.prependss(arg,opts));
} else {
var vec__35647_35811 = arg;
var seq__35648_35812 = cljs.core.seq(vec__35647_35811);
var first__35649_35813 = cljs.core.first(seq__35648_35812);
var seq__35648_35814__$1 = cljs.core.next(seq__35648_35812);
var prefix_35815 = first__35649_35813;
var args_STAR__35816__$2 = seq__35648_35814__$1;
if((prefix_35815 == null)){
sci.impl.utils.throw_error_with_location.cljs$core$IFn$_invoke$arity$2("prefix cannot be nil",args);
} else {
}

var seq__35651_35819 = cljs.core.seq(args_STAR__35816__$2);
var chunk__35652_35820 = null;
var count__35653_35821 = (0);
var i__35654_35823 = (0);
while(true){
if((i__35654_35823 < count__35653_35821)){
var arg_35824__$1 = chunk__35652_35820.cljs$core$IIndexed$_nth$arity$2(null,i__35654_35823);
cljs.core.apply.cljs$core$IFn$_invoke$arity$4(sci.impl.load.load_lib,ctx,prefix_35815,sci.impl.load.prependss(arg_35824__$1,opts));


var G__35825 = seq__35651_35819;
var G__35826 = chunk__35652_35820;
var G__35827 = count__35653_35821;
var G__35828 = (i__35654_35823 + (1));
seq__35651_35819 = G__35825;
chunk__35652_35820 = G__35826;
count__35653_35821 = G__35827;
i__35654_35823 = G__35828;
continue;
} else {
var temp__5825__auto___35829__$1 = cljs.core.seq(seq__35651_35819);
if(temp__5825__auto___35829__$1){
var seq__35651_35830__$1 = temp__5825__auto___35829__$1;
if(cljs.core.chunked_seq_QMARK_(seq__35651_35830__$1)){
var c__5548__auto___35832 = cljs.core.chunk_first(seq__35651_35830__$1);
var G__35833 = cljs.core.chunk_rest(seq__35651_35830__$1);
var G__35834 = c__5548__auto___35832;
var G__35835 = cljs.core.count(c__5548__auto___35832);
var G__35836 = (0);
seq__35651_35819 = G__35833;
chunk__35652_35820 = G__35834;
count__35653_35821 = G__35835;
i__35654_35823 = G__35836;
continue;
} else {
var arg_35837__$1 = cljs.core.first(seq__35651_35830__$1);
cljs.core.apply.cljs$core$IFn$_invoke$arity$4(sci.impl.load.load_lib,ctx,prefix_35815,sci.impl.load.prependss(arg_35837__$1,opts));


var G__35838 = cljs.core.next(seq__35651_35830__$1);
var G__35839 = null;
var G__35840 = (0);
var G__35841 = (0);
seq__35651_35819 = G__35838;
chunk__35652_35820 = G__35839;
count__35653_35821 = G__35840;
i__35654_35823 = G__35841;
continue;
}
} else {
}
...
var G__35842 = cljs.core.next(seq__35595__$1);
var G__35843 = null;
var G__35844 = (0);
var G__35845 = (0);
seq__35595 = G__35842;
chunk__35596 = G__35843;
count__35597 = G__35844;
i__35598 = G__35845;
continue;
}
} else {
...
var args__5755__auto__ = [];
var len__5749__auto___35846 = arguments.length;
var i__5750__auto___35848 = (0);
while(true){
if((i__5750__auto___35848 < len__5749__auto___35846)){
args__5755__auto__.push((arguments[i__5750__auto___35848]));

var G__35850 = (i__5750__auto___35848 + (1));
i__5750__auto___35848 = G__35850;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.load.eval_require.cljs$lang$applyTo = (function (seq35657){
var G__35658 = cljs.core.first(seq35657);
var seq35657__$1 = cljs.core.next(seq35657);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35658,seq35657__$1);
}));
...
var G__35855 = (i__5750__auto___35854 + (1));
i__5750__auto___35854 = G__35855;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.load.eval_require_macros.cljs$lang$applyTo = (function (seq35661){
var G__35662 = cljs.core.first(seq35661);
var seq35661__$1 = cljs.core.next(seq35661);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35662,seq35661__$1);
}));
...
var args__5755__auto__ = [];
var len__5749__auto___35858 = arguments.length;
var i__5750__auto___35859 = (0);
while(true){
if((i__5750__auto___35859 < len__5749__auto___35858)){
...
/** @this {Function} */
(sci.impl.load.eval_use.cljs$lang$applyTo = (function (seq35668){
var G__35669 = cljs.core.first(seq35668);
var seq35668__$1 = cljs.core.next(seq35668);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35669,seq35668__$1);
}));
...
var G__35673_35864 = k;
var G__35673_35865__$1 = (((G__35673_35864 instanceof cljs.core.Keyword))?G__35673_35864.fqn:null);
switch (G__35673_35865__$1) {
case "exclude":
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"env","env",-1815813235).cljs$core$IFn$_invoke$arity$1(ctx),((function (exprs__$1,G__35673_35864,G__35673_35865__$1,vec__35670,k,v,ns_sym){
return (function (env){
var cnn = sci.impl.utils.current_ns_name();
...
});})(exprs__$1,G__35673_35864,G__35673_35865__$1,vec__35670,k,v,ns_sym))
);
...
var other_ns = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(env,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469),ns_sym], null));
var the_current_ns__$1 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (exprs__$1,cnn,namespaces,the_current_ns,other_ns,G__35673_35864,G__35673_35865__$1,vec__35670,k,v,ns_sym){
return (function (acc,p__35685){
var vec__35687 = p__35685;
var original_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35687,(0),null);
var new_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35687,(1),null);
...
});})(exprs__$1,cnn,namespaces,the_current_ns,other_ns,G__35673_35864,G__35673_35865__$1,vec__35670,k,v,ns_sym))
,the_current_ns,v);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35673_35865__$1)].join('')));

}

var G__35870 = cljs.core.nnext(exprs__$1);
exprs__$1 = G__35870;
continue;
} else {
return null;
...
var args__5755__auto__ = [];
var len__5749__auto___35881 = arguments.length;
var i__5750__auto___35882 = (0);
while(true){
if((i__5750__auto___35882 < len__5749__auto___35881)){
args__5755__auto__.push((arguments[i__5750__auto___35882]));

var G__35883 = (i__5750__auto___35882 + (1));
i__5750__auto___35882 = G__35883;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.load.eval_refer.cljs$lang$applyTo = (function (seq35706){
var G__35707 = cljs.core.first(seq35706);
var seq35706__$1 = cljs.core.next(seq35706);
var G__35708 = cljs.core.first(seq35706__$1);
var seq35706__$2 = cljs.core.next(seq35706__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35707,G__35708,seq35706__$2);
}));
