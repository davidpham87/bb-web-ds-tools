...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__24265 = c;
var G__24265__$1 = (((G__24265 == null))?null:G__24265.prototype);
if((G__24265__$1 == null)){
return null;
} else {
return G__24265__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__24269 = c;
...
while (G__24456__i < G__24456__a.length) {G__24456__a[G__24456__i] = arguments[G__24456__i + 0]; ++G__24456__i;}
  args = new cljs.core.IndexedSeq(G__24456__a,0,null);
} 
return G__24454__delegate.call(this,args);};
G__24454.cljs$lang$maxFixedArity = 0;
G__24454.cljs$lang$applyTo = (function (arglist__24457){
...
var or__5025__auto__ = (function (){var G__24287 = c;
var G__24287__$1 = (((G__24287 == null))?null:G__24287.constructor);
if((G__24287__$1 == null)){
return null;
} else {
return G__24287__$1.displayName;
}
})();
...
var G__24288 = c;
var G__24288__$1 = (((G__24288 == null))?null:G__24288.constructor);
if((G__24288__$1 == null)){
return null;
} else {
return G__24288__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__24289 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__24290 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__24290);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__24289);
}});
...
var G__24291 = reagent.impl.component.goog$module$goog$object.get(component_state,"cljsRatom");
if((G__24291 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__24291);
}
} else {
return null;
}
...
var renders_24485 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_24486 = cljs.core.first(cljs.core.vals(renders_24485));
...
if((cljs.core.count(renders_24485) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_24485))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_24486)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_24486], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var _STAR_current_component_STAR__orig_val__24402 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__24403 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__24403);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__24402);
}});
...
var vec__24404 = shadow.js.shim.module$react.useReducer(cljs.core.inc,(0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24404,(0),null);
var force_update = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24404,(1),null);
