...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.repl","eval-code","bb-web-ds-tools.views.repl/eval-code",1526213909),(function (_,p__49757){
var vec__49758 = p__49757;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49758,(0),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49758,(1),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49758,(2),null);
...
var instance_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49762,(1),null);
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("bb-web-ds-tools.views.repl","repl-instance-state","bb-web-ds-tools.views.repl/repl-instance-state",1214249521),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p__49771,_){
var vec__49772 = p__49771;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49772,(0),null);
var instance_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49772,(1),null);
...
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49779,(0),null);
var mac_os_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49779,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.repl","update-code","bb-web-ds-tools.views.repl/update-code",-179820027),(function (db,p__49785){
var vec__49786 = p__49785;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49786,(0),null);
var instance_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49786,(1),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49786,(2),null);
...
i = G__49842;
stack = G__49843;
in_string_QMARK_ = G__49844;
continue;
} else {
if(cljs.core.contains_QMARK_(delims,c)){
var G__49845 = (i - (1));
var G__49846 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(stack,(delims.cljs$core$IFn$_invoke$arity$1 ? delims.cljs$core$IFn$_invoke$arity$1(c) : delims.call(null,c)));
var G__49847 = false;
i = G__49845;
stack = G__49846;
in_string_QMARK_ = G__49847;
continue;
} else {
...
var G__49848 = (i - (1));
var G__49849 = new_stack;
var G__49850 = false;
i = G__49848;
stack = G__49849;
in_string_QMARK_ = G__49850;
continue;
}
} else {
var G__49851 = (i - (1));
 ...
 */
bb_web_ds_tools.views.repl.repl_instance = (function bb_web_ds_tools$views$repl$repl_instance(p__49791){
var map__49792 = p__49791;
var map__49792__$1 = cljs.core.__destructure_map(map__49792);
var instance_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49792__$1,new cljs.core.Keyword(null,"instance-id","instance-id",951361263));
var header_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49792__$1,new cljs.core.Keyword(null,"header-content","header-content",-2015916786));
...
return (function (){
var map__49793 = cljs.core.deref(state_sub);
var map__49793__$1 = cljs.core.__destructure_map(map__49793);
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49793__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var mac_os_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49793__$1,new cljs.core.Keyword(null,"mac-os?","mac-os?",-1478507137));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.tool_view.tool_view,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"title","title",636505583),"Clojure Code",new cljs.core.Keyword(null,"wiki-key","wiki-key",-1495409073),new cljs.core.Keyword(null,"code","code",1586293142),new cljs.core.Keyword(null,"editor","editor",-989377770),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.editor.monaco_editor,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"value","value",305978217),code,new cljs.core.Keyword(null,"language","language",-1591107564),"clojure",new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"rulers","rulers",756731282),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(80)], null),new cljs.core.Keyword(null,"lineNumbers","lineNumbers",1374890941),"off"], null),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__49789_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.repl","update-code","bb-web-ds-tools.views.repl/update-code",-179820027),instance_id,p1__49789_SHARP_], null));
}),new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840),(function (p1__49790_SHARP_){
return bb_web_ds_tools.views.repl.setup_editor_actions(p1__49790_SHARP_,instance_id,mac_os_QMARK_);
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49794__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49794__$1,new cljs.core.Keyword(null,"event","event",301435442));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49794__$1,new cljs.core.Keyword(null,"value","value",305978217));
var G__49795 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(type);
...
var len__5749__auto___49863 = arguments.length;
var i__5750__auto___49864 = (0);
while(true){
if((i__5750__auto___49864 < len__5749__auto___49863)){
args__5755__auto__.push((arguments[i__5750__auto___49864]));

var G__49865 = (i__5750__auto___49864 + (1));
i__5750__auto___49864 = G__49865;
continue;
} else {
}
break;
...
(bb_web_ds_tools.views.repl.panel.cljs$core$IFn$_invoke$arity$variadic = (function (p__49797){
var vec__49798 = p__49797;
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49798,(0),null);
...
var G__49866__delegate = function (p__49805){
var vec__49806 = p__49805;
var props__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49806,(0),null);
...
var G__49868__i = 0, G__49868__a = new Array(arguments.length -  0);
while (G__49868__i < G__49868__a.length) {G__49868__a[G__49868__i] = arguments[G__49868__i + 0]; ++G__49868__i;}
  p__49805 = new cljs.core.IndexedSeq(G__49868__a,0,null);
} 
return G__49866__delegate.call(this,p__49805);};
G__49866.cljs$lang$maxFixedArity = 0;
G__49866.cljs$lang$applyTo = (function (arglist__49869){
var p__49805 = cljs.core.seq(arglist__49869);
return G__49866__delegate(p__49805);
});
...
/** @this {Function} */
(bb_web_ds_tools.views.repl.panel.cljs$lang$applyTo = (function (seq49796){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq49796));
}));
