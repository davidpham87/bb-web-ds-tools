...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","path-value","bb-web-ds-tools.views.app-db/path-value",1939920672),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__30712){
var vec__30713 = p__30712;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30713,(0),null);
var path_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30713,(1),null);
...
}catch (e30716){var ___$1 = e30716;
return new cljs.core.Keyword("bb-web-ds-tools.views.app-db","error","bb-web-ds-tools.views.app-db/error",-336701303);
}})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","set-active-path","bb-web-ds-tools.views.app-db/set-active-path",153735738),(function (db,p__30717){
var vec__30718 = p__30717;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30718,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30718,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","add-watch-path","bb-web-ds-tools.views.app-db/add-watch-path",1822864858),(function (db,p__30721){
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","remove-watch-path","bb-web-ds-tools.views.app-db/remove-watch-path",178630062),(function (db,p__30766){
var vec__30773 = p__30766;
...
var new_paths = cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__30756_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__30756_SHARP_,path_str);
}),watched_paths));
...
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30785,(0),null);
var old_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30785,(1),null);
var new_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30785,(2),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","open-in-portal","bb-web-ds-tools.views.app-db/open-in-portal",-1055334551),(function (p__30798,_){
var map__30800 = p__30798;
var map__30800__$1 = cljs.core.__destructure_map(map__30800);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30800__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
var c__23420__auto___30823 = temp__5829__auto___30822;
if((with_let30817.generation === c__23420__auto___30823.ratomGeneration)){
...
(with_let30817.generation = c__23420__auto___30823.ratomGeneration);
}
