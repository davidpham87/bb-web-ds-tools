...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","path-value","bb-web-ds-tools.views.app-db/path-value",1939920672),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__30688){
var vec__30689 = p__30688;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30689,(0),null);
var path_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30689,(1),null);
...
}catch (e30692){var ___$1 = e30692;
return new cljs.core.Keyword("bb-web-ds-tools.views.app-db","error","bb-web-ds-tools.views.app-db/error",-336701303);
}})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","set-active-path","bb-web-ds-tools.views.app-db/set-active-path",153735738),(function (db,p__30693){
var vec__30694 = p__30693;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30694,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30694,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","add-watch-path","bb-web-ds-tools.views.app-db/add-watch-path",1822864858),(function (db,p__30697){
var vec__30698 = p__30697;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30698,(0),null);
var path_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30698,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","update-watch-path","bb-web-ds-tools.views.app-db/update-watch-path",-1498068284),(function (db,p__30719){
var vec__30764 = p__30719;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30764,(0),null);
var old_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30764,(1),null);
var new_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30764,(2),null);
...
var G__30767 = cljs.core.assoc_in(db,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"watched-paths","watched-paths",-1266999052)], null),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(paths,idx,new_path));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(active_path,old_path)){
return cljs.core.assoc_in(G__30767,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"active-path","active-path",-899675889)], null),new_path);
} else {
return G__30767;
}
}
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","open-in-portal","bb-web-ds-tools.views.app-db/open-in-portal",-1055334551),(function (p__30768,_){
var map__30769 = p__30768;
var map__30769__$1 = cljs.core.__destructure_map(map__30769);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30769__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
})], null),"+ New Watch"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex-grow overflow-y-auto p-2 space-y-1"], null),((cljs.core.seq(watched_paths))?(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$app_db$path_list_$_iter__30789(s__30790){
return (new cljs.core.LazySeq(null,(function (){
var s__30790__$1 = s__30790;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__30790__$1);
if(temp__5825__auto__){
var s__30790__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__30790__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__30790__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__30792 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__30791 = (0);
while(true){
if((i__30791 < size__5502__auto__)){
var path = cljs.core._nth(c__5501__auto__,i__30791);
cljs.core.chunk_append(b__30792,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.app_db.path_list_item,path,cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(path,active_path)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),path], null)));

var G__30807 = (i__30791 + (1));
i__30791 = G__30807;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30792),bb_web_ds_tools$views$app_db$path_list_$_iter__30789(cljs.core.chunk_rest(s__30790__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30792),null);
}
} else {
var path = cljs.core.first(s__30790__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.app_db.path_list_item,path,cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(path,active_path)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),path], null)),bb_web_ds_tools$views$app_db$path_list_$_iter__30789(cljs.core.rest(s__30790__$2)));
}
} else {
return null;
}
...
var with_let30803 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let30803","with-let30803",1408106493));
var temp__5829__auto___30810 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5829__auto___30810 == null)){
} else {
var c__23337__auto___30811 = temp__5829__auto___30810;
if((with_let30803.generation === c__23337__auto___30811.ratomGeneration)){
...
(with_let30803.generation = c__23337__auto___30811.ratomGeneration);
}

var init30804 = (with_let30803.length === (0));
var new_path = ((((init30804) || (cljs.core.not(with_let30803.hasOwnProperty((0))))))?(with_let30803[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1("")):(with_let30803[(0)]));
var res30805 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.card,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"p-8 flex flex-col items-center justify-center space-y-4 bg-transparent shadow-none h-full"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3","h3",2067611163),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-xl font-bold"], null),"Watch New Path"], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"w-full max-w-lg"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(new_path),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__30802_SHARP_){
return cljs.core.reset_BANG_(new_path,p1__30802_SHARP_.target.value);
