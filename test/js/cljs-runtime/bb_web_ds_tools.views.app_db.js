...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","path-value","bb-web-ds-tools.views.app-db/path-value",1939920672),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__30721){
var vec__30722 = p__30721;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30722,(0),null);
var path_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30722,(1),null);
...
}catch (e30725){var ___$1 = e30725;
return new cljs.core.Keyword("bb-web-ds-tools.views.app-db","error","bb-web-ds-tools.views.app-db/error",-336701303);
}})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","set-active-path","bb-web-ds-tools.views.app-db/set-active-path",153735738),(function (db,p__30726){
var vec__30727 = p__30726;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30727,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30727,(1),null);
...
}),new cljs.core.Keyword(null,"on-key-down","on-key-down",-1374733765),(function (p1__30800_SHARP_){
var G__30801 = p1__30800_SHARP_.key;
switch (G__30801) {
case "Enter":
...
})], null),"+ New Watch"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex-grow overflow-y-auto p-2 space-y-1"], null),((cljs.core.seq(watched_paths))?(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$app_db$path_list_$_iter__30810(s__30811){
return (new cljs.core.LazySeq(null,(function (){
var s__30811__$1 = s__30811;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__30811__$1);
if(temp__5825__auto__){
var s__30811__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__30811__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__30811__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__30813 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__30812 = (0);
while(true){
if((i__30812 < size__5502__auto__)){
var path = cljs.core._nth(c__5501__auto__,i__30812);
cljs.core.chunk_append(b__30813,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.app_db.path_list_item,path,cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(path,active_path)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),path], null)));

var G__30821 = (i__30812 + (1));
i__30812 = G__30821;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30813),bb_web_ds_tools$views$app_db$path_list_$_iter__30810(cljs.core.chunk_rest(s__30811__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30813),null);
}
} else {
var path = cljs.core.first(s__30811__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.app_db.path_list_item,path,cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(path,active_path)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),path], null)),bb_web_ds_tools$views$app_db$path_list_$_iter__30810(cljs.core.rest(s__30811__$2)));
}
} else {
return null;
}
...
var c__23409__auto___30823 = temp__5829__auto___30822;
if((with_let30817.generation === c__23409__auto___30823.ratomGeneration)){
...
(with_let30817.generation = c__23409__auto___30823.ratomGeneration);
}
