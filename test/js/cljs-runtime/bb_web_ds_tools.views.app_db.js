...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","path-value","bb-web-ds-tools.views.app-db/path-value",1939920672),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__30698){
var vec__30699 = p__30698;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30699,(0),null);
var path_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30699,(1),null);
...
}catch (e30702){var ___$1 = e30702;
return new cljs.core.Keyword("bb-web-ds-tools.views.app-db","error","bb-web-ds-tools.views.app-db/error",-336701303);
}})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","set-active-path","bb-web-ds-tools.views.app-db/set-active-path",153735738),(function (db,p__30749){
var vec__30753 = p__30749;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30753,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30753,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","add-watch-path","bb-web-ds-tools.views.app-db/add-watch-path",1822864858),(function (db,p__30762){
var vec__30764 = p__30762;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30764,(0),null);
var path_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30764,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","update-watch-path","bb-web-ds-tools.views.app-db/update-watch-path",-1498068284),(function (db,p__30783){
var vec__30786 = p__30783;
...
return cljs.core.assoc_in(G__30789,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"active-path","active-path",-899675889)], null),new_path);
} else {
return G__30789;
}
}
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","open-in-portal","bb-web-ds-tools.views.app-db/open-in-portal",-1055334551),(function (p__30790,_){
var map__30791 = p__30790;
var map__30791__$1 = cljs.core.__destructure_map(map__30791);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30791__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
var c__23722__auto___30823 = temp__5829__auto___30822;
if((with_let30804.generation === c__23722__auto___30823.ratomGeneration)){
...
(with_let30804.generation = c__23722__auto___30823.ratomGeneration);
}
