...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","path-value","bb-web-ds-tools.views.app-db/path-value",1939920672),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__30826){
...
}catch (e30830){var ___$1 = e30830;
return new cljs.core.Keyword("bb-web-ds-tools.views.app-db","error","bb-web-ds-tools.views.app-db/error",-336701303);
}})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","set-active-path","bb-web-ds-tools.views.app-db/set-active-path",153735738),(function (db,p__30843){
var vec__30849 = p__30843;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30849,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30849,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","add-watch-path","bb-web-ds-tools.views.app-db/add-watch-path",1822864858),(function (db,p__30869){
var vec__30875 = p__30869;
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","open-in-portal","bb-web-ds-tools.views.app-db/open-in-portal",-1055334551),(function (p__30900,_){
var map__30901 = p__30900;
var map__30901__$1 = cljs.core.__destructure_map(map__30901);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30901__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
})], null),"+ New Watch"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex-grow overflow-y-auto p-2 space-y-1"], null),((cljs.core.seq(watched_paths))?(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$app_db$path_list_$_iter__30916(s__30917){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30919),bb_web_ds_tools$views$app_db$path_list_$_iter__30916(cljs.core.chunk_rest(s__30917__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30919),null);
}
} else {
var path = cljs.core.first(s__30917__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.app_db.path_list_item,path,cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(path,active_path)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),path], null)),bb_web_ds_tools$views$app_db$path_list_$_iter__30916(cljs.core.rest(s__30917__$2)));
}
} else {
return null;
}
...
var with_let30922 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let30922","with-let30922",-991041613));
var temp__5829__auto___30930 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5829__auto___30930 == null)){
} else {
var c__23811__auto___30931 = temp__5829__auto___30930;
if((with_let30922.generation === c__23811__auto___30931.ratomGeneration)){
...
(with_let30922.generation = c__23811__auto___30931.ratomGeneration);
}

var init30923 = (with_let30922.length === (0));
var new_path = ((((init30923) || (cljs.core.not(with_let30922.hasOwnProperty((0))))))?(with_let30922[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1("")):(with_let30922[(0)]));
