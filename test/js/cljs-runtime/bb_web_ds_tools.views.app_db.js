...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","path-value","bb-web-ds-tools.views.app-db/path-value",1939920672),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__22610){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"app-db","app-db",865606302)], null),(function (p1__22623_SHARP_){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"watched-paths","watched-paths",-1266999052),cljs.core.PersistentVector.EMPTY,new cljs.core.Keyword(null,"active-path","active-path",-899675889),null], null),p1__22623_SHARP_], 0));
}));
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","set-active-path","bb-web-ds-tools.views.app-db/set-active-path",153735738),(function (db,p__22624){
var vec__22625 = p__22624;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22625,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22625,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","add-watch-path","bb-web-ds-tools.views.app-db/add-watch-path",1822864858),(function (db,p__22628){
var vec__22634 = p__22628;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22634,(0),null);
var path_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22634,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","update-watch-path","bb-web-ds-tools.views.app-db/update-watch-path",-1498068284),(function (db,p__22643){
var vec__22649 = p__22643;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22649,(0),null);
var old_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22649,(1),null);
var new_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22649,(2),null);
...
var G__22652 = cljs.core.assoc_in(db,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"watched-paths","watched-paths",-1266999052)], null),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(paths,idx,new_path));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(active_path,old_path)){
return cljs.core.assoc_in(G__22652,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"active-path","active-path",-899675889)], null),new_path);
} else {
return G__22652;
}
}
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","open-in-portal","bb-web-ds-tools.views.app-db/open-in-portal",-1055334551),(function (p__22653,_){
var map__22654 = p__22653;
var map__22654__$1 = cljs.core.__destructure_map(map__22654);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22654__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
var with_let22669 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let22669","with-let22669",1003889694));
var temp__5829__auto___22679 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5829__auto___22679 == null)){
} else {
var c__20886__auto___22680 = temp__5829__auto___22679;
if((with_let22669.generation === c__20886__auto___22680.ratomGeneration)){
...
(with_let22669.generation = c__20886__auto___22680.ratomGeneration);
}

var init22670 = (with_let22669.length === (0));
var new_path = ((((init22670) || (cljs.core.not(with_let22669.hasOwnProperty((0))))))?(with_let22669[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1("")):(with_let22669[(0)]));
var res22671 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.card,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"p-8 flex flex-col items-center justify-center space-y-4 bg-transparent shadow-none h-full"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3","h3",2067611163),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-xl font-bold"], null),"Watch New Path"], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"w-full max-w-lg"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(new_path),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__22668_SHARP_){
return cljs.core.reset_BANG_(new_path,p1__22668_SHARP_.target.value);
