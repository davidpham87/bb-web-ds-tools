...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","path-value","bb-web-ds-tools.views.app-db/path-value",1939920672),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__30831){
var vec__30836 = p__30831;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30836,(0),null);
var path_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30836,(1),null);
...
}catch (e30842){var ___$1 = e30842;
return new cljs.core.Keyword("bb-web-ds-tools.views.app-db","error","bb-web-ds-tools.views.app-db/error",-336701303);
}})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","set-active-path","bb-web-ds-tools.views.app-db/set-active-path",153735738),(function (db,p__30863){
var vec__30865 = p__30863;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30865,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30865,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","add-watch-path","bb-web-ds-tools.views.app-db/add-watch-path",1822864858),(function (db,p__30874){
var vec__30875 = p__30874;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30875,(0),null);
var path_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30875,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","remove-watch-path","bb-web-ds-tools.views.app-db/remove-watch-path",178630062),(function (db,p__30888){
var vec__30889 = p__30888;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30889,(0),null);
var path_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30889,(1),null);
var watched_paths = cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"watched-paths","watched-paths",-1266999052)], null),cljs.core.PersistentVector.EMPTY);
var new_paths = cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__30887_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__30887_SHARP_,path_str);
}),watched_paths));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","update-watch-path","bb-web-ds-tools.views.app-db/update-watch-path",-1498068284),(function (db,p__30893){
var vec__30894 = p__30893;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30894,(0),null);
var old_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30894,(1),null);
var new_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30894,(2),null);
...
var G__30897 = cljs.core.assoc_in(db,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"watched-paths","watched-paths",-1266999052)], null),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(paths,idx,new_path));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(active_path,old_path)){
return cljs.core.assoc_in(G__30897,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"active-path","active-path",-899675889)], null),new_path);
} else {
return G__30897;
}
}
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","open-in-portal","bb-web-ds-tools.views.app-db/open-in-portal",-1055334551),(function (p__30898,_){
var map__30899 = p__30898;
var map__30899__$1 = cljs.core.__destructure_map(map__30899);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30899__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
var G__30904 = p1__30901_SHARP_.key;
switch (G__30904) {
case "Enter":
...
var with_let30916 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let30916","with-let30916",663393020));
var temp__5829__auto___30927 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5829__auto___30927 == null)){
} else {
var c__23442__auto___30928 = temp__5829__auto___30927;
if((with_let30916.generation === c__23442__auto___30928.ratomGeneration)){
...
(with_let30916.generation = c__23442__auto___30928.ratomGeneration);
}

var init30917 = (with_let30916.length === (0));
var new_path = ((((init30917) || (cljs.core.not(with_let30916.hasOwnProperty((0))))))?(with_let30916[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1("")):(with_let30916[(0)]));
var res30918 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.card,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"p-8 flex flex-col items-center justify-center space-y-4 bg-transparent shadow-none h-full"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3","h3",2067611163),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-xl font-bold"], null),"Watch New Path"], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"w-full max-w-lg"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(new_path),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__30914_SHARP_){
return cljs.core.reset_BANG_(new_path,p1__30914_SHARP_.target.value);
