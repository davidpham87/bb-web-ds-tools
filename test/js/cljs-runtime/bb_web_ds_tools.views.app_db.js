...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","path-value","bb-web-ds-tools.views.app-db/path-value",1939920672),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__30728){
var vec__30729 = p__30728;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30729,(0),null);
var path_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30729,(1),null);
...
}catch (e30732){var ___$1 = e30732;
return new cljs.core.Keyword("bb-web-ds-tools.views.app-db","error","bb-web-ds-tools.views.app-db/error",-336701303);
}})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","set-active-path","bb-web-ds-tools.views.app-db/set-active-path",153735738),(function (db,p__30733){
var vec__30734 = p__30733;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30734,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30734,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","add-watch-path","bb-web-ds-tools.views.app-db/add-watch-path",1822864858),(function (db,p__30788){
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","remove-watch-path","bb-web-ds-tools.views.app-db/remove-watch-path",178630062),(function (db,p__30793){
var vec__30794 = p__30793;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30794,(0),null);
var path_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30794,(1),null);
var watched_paths = cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"watched-paths","watched-paths",-1266999052)], null),cljs.core.PersistentVector.EMPTY);
var new_paths = cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__30792_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__30792_SHARP_,path_str);
}),watched_paths));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","update-watch-path","bb-web-ds-tools.views.app-db/update-watch-path",-1498068284),(function (db,p__30799){
var vec__30800 = p__30799;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30800,(0),null);
var old_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30800,(1),null);
var new_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30800,(2),null);
...
return cljs.core.assoc_in(G__30803,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"active-path","active-path",-899675889)], null),new_path);
} else {
return G__30803;
}
}
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","open-in-portal","bb-web-ds-tools.views.app-db/open-in-portal",-1055334551),(function (p__30804,_){
var map__30805 = p__30804;
var map__30805__$1 = cljs.core.__destructure_map(map__30805);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30805__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
})], null),"+ New Watch"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex-grow overflow-y-auto p-2 space-y-1"], null),((cljs.core.seq(watched_paths))?(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$app_db$path_list_$_iter__30815(s__30816){
return (new cljs.core.LazySeq(null,(function (){
var s__30816__$1 = s__30816;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__30816__$1);
if(temp__5825__auto__){
var s__30816__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__30816__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__30816__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__30818 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__30817 = (0);
while(true){
if((i__30817 < size__5502__auto__)){
var path = cljs.core._nth(c__5501__auto__,i__30817);
cljs.core.chunk_append(b__30818,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.app_db.path_list_item,path,cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(path,active_path)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),path], null)));

var G__30834 = (i__30817 + (1));
i__30817 = G__30834;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30818),bb_web_ds_tools$views$app_db$path_list_$_iter__30815(cljs.core.chunk_rest(s__30816__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30818),null);
}
} else {
var path = cljs.core.first(s__30816__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.app_db.path_list_item,path,cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(path,active_path)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),path], null)),bb_web_ds_tools$views$app_db$path_list_$_iter__30815(cljs.core.rest(s__30816__$2)));
}
} else {
return null;
}
...
var with_let30823 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let30823","with-let30823",-1145677280));
var temp__5829__auto___30836 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5829__auto___30836 == null)){
} else {
var c__23439__auto___30838 = temp__5829__auto___30836;
if((with_let30823.generation === c__23439__auto___30838.ratomGeneration)){
...
(with_let30823.generation = c__23439__auto___30838.ratomGeneration);
}

var init30824 = (with_let30823.length === (0));
var new_path = ((((init30824) || (cljs.core.not(with_let30823.hasOwnProperty((0))))))?(with_let30823[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1("")):(with_let30823[(0)]));
var res30825 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.card,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"p-8 flex flex-col items-center justify-center space-y-4 bg-transparent shadow-none h-full"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3","h3",2067611163),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-xl font-bold"], null),"Watch New Path"], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"w-full max-w-lg"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(new_path),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__30821_SHARP_){
return cljs.core.reset_BANG_(new_path,p1__30821_SHARP_.target.value);
