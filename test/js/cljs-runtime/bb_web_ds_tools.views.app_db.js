...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","path-value","bb-web-ds-tools.views.app-db/path-value",1939920672),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__30769){
...
}catch (e30773){var ___$1 = e30773;
return new cljs.core.Keyword("bb-web-ds-tools.views.app-db","error","bb-web-ds-tools.views.app-db/error",-336701303);
}})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","set-active-path","bb-web-ds-tools.views.app-db/set-active-path",153735738),(function (db,p__30774){
var vec__30775 = p__30774;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30775,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30775,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","add-watch-path","bb-web-ds-tools.views.app-db/add-watch-path",1822864858),(function (db,p__30778){
var vec__30779 = p__30778;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30779,(0),null);
var path_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30779,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","open-in-portal","bb-web-ds-tools.views.app-db/open-in-portal",-1055334551),(function (p__30795,_){
var map__30796 = p__30795;
var map__30796__$1 = cljs.core.__destructure_map(map__30796);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30796__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
})], null),"+ New Watch"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex-grow overflow-y-auto p-2 space-y-1"], null),((cljs.core.seq(watched_paths))?(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$app_db$path_list_$_iter__30808(s__30809){
return (new cljs.core.LazySeq(null,(function (){
var s__30809__$1 = s__30809;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__30809__$1);
if(temp__5825__auto__){
var s__30809__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__30809__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__30809__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__30811 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__30810 = (0);
while(true){
if((i__30810 < size__5502__auto__)){
var path = cljs.core._nth(c__5501__auto__,i__30810);
cljs.core.chunk_append(b__30811,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.app_db.path_list_item,path,cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(path,active_path)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),path], null)));

var G__30827 = (i__30810 + (1));
i__30810 = G__30827;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30811),bb_web_ds_tools$views$app_db$path_list_$_iter__30808(cljs.core.chunk_rest(s__30809__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30811),null);
}
} else {
var path = cljs.core.first(s__30809__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.app_db.path_list_item,path,cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(path,active_path)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),path], null)),bb_web_ds_tools$views$app_db$path_list_$_iter__30808(cljs.core.rest(s__30809__$2)));
}
} else {
return null;
}
...
var temp__5829__auto___30828 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5829__auto___30828 == null)){
} else {
var c__23360__auto___30829 = temp__5829__auto___30828;
if((with_let30817.generation === c__23360__auto___30829.ratomGeneration)){
...
(with_let30817.generation = c__23360__auto___30829.ratomGeneration);
}
