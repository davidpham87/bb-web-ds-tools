...
var node = (function (){var G__65748 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__65749 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__65750 = style_string_65832;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__65748,G__65749,G__65750) : cljs_test_display.core.n.call(null,G__65748,G__65749,G__65750));
})();
...
var len__5749__auto___65836 = arguments.length;
var i__5750__auto___65837 = (0);
while(true){
if((i__5750__auto___65837 < len__5749__auto___65836)){
args__5755__auto__.push((arguments[i__5750__auto___65837]));

var G__65838 = (i__5750__auto___65837 + (1));
i__5750__auto___65837 = G__65838;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq65761){
...
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65762,G__65763,seq65761__$2);
}));
...
var vec__65764 = ((clojure.string.starts_with_QMARK_(cljs.core.first(classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.first(classes),(1)),cljs.core.rest(classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65764,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65764,(1),null);
var G__65773 = cljs.core.PersistentArrayMap.EMPTY;
var G__65773__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__65773,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__65773);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__65773__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__65773__$1;
}
} else {
...
return (function() { 
var G__65846__delegate = function (klass,contents){
var vec__65774 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65774,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65774,(1),null);
...
var G__65846 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__65847__i = 0, G__65847__a = new Array(arguments.length -  1);
while (G__65847__i < G__65847__a.length) {G__65847__a[G__65847__i] = arguments[G__65847__i + 1]; ++G__65847__i;}
  contents = new cljs.core.IndexedSeq(G__65847__a,0,null);
} 
return G__65846__delegate.call(this,klass,contents);};
G__65846.cljs$lang$maxFixedArity = 1;
G__65846.cljs$lang$applyTo = (function (arglist__65848){
var klass = cljs.core.first(arglist__65848);
var contents = cljs.core.rest(arglist__65848);
return G__65846__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__65785){
var map__65786 = p__65785;
var map__65786__$1 = cljs.core.__destructure_map(map__65786);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65786__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65786__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__65793){
var map__65794 = p__65793;
var map__65794__$1 = cljs.core.__destructure_map(map__65794);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65794__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65794__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__65795){
var map__65796 = p__65795;
var map__65796__$1 = cljs.core.__destructure_map(map__65796);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65796__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65796__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__65802_SHARP_){
return cljs.core.cons(new_current_node,p1__65802_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__65804 = cljs_test_display.core.current_var_info();
var map__65804__$1 = cljs.core.__destructure_map(map__65804);
var info = map__65804__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65804__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65804__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65804__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__65803_SHARP_){
return cljs.core.cons(node,p1__65803_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__65807){
var map__65808 = p__65807;
var map__65808__$1 = cljs.core.__destructure_map(map__65808);
var m = map__65808__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65808__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65808__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65808__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65808__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__65811 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__65811) : formatter_fn.call(null,G__65811));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__65812 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__65812) : formatter_fn.call(null,G__65812));
})()], 0));
});
...
var temp__5825__auto___65856 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___65856)){
var message_65857 = temp__5825__auto___65856;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_65857], 0));
} else {
}
...
var temp__5825__auto___65858 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___65858)){
var message_65859 = temp__5825__auto___65858;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_65859], 0));
} else {
}
