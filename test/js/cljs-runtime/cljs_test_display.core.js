...
var node = (function (){var G__67182 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__67183 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__67184 = style_string_67267;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__67182,G__67183,G__67184) : cljs_test_display.core.n.call(null,G__67182,G__67183,G__67184));
})();
...
var len__5749__auto___67268 = arguments.length;
var i__5750__auto___67269 = (0);
while(true){
if((i__5750__auto___67269 < len__5749__auto___67268)){
args__5755__auto__.push((arguments[i__5750__auto___67269]));

var G__67270 = (i__5750__auto___67269 + (1));
i__5750__auto___67269 = G__67270;
continue;
} else {
}
break;
...
return cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5756__auto__);
});
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq67185){
var G__67186 = cljs.core.first(seq67185);
var seq67185__$1 = cljs.core.next(seq67185);
var G__67187 = cljs.core.first(seq67185__$1);
var seq67185__$2 = cljs.core.next(seq67185__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__67186,G__67187,seq67185__$2);
}));
...
var vec__67205 = ((clojure.string.starts_with_QMARK_(cljs.core.first(classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.first(classes),(1)),cljs.core.rest(classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67205,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67205,(1),null);
var G__67212 = cljs.core.PersistentArrayMap.EMPTY;
var G__67212__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67212,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__67212);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67212__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__67212__$1;
}
} else {
...
return (function() { 
var G__67281__delegate = function (klass,contents){
var vec__67213 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67213,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67213,(1),null);
...
var G__67281 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__67285__i = 0, G__67285__a = new Array(arguments.length -  1);
while (G__67285__i < G__67285__a.length) {G__67285__a[G__67285__i] = arguments[G__67285__i + 1]; ++G__67285__i;}
  contents = new cljs.core.IndexedSeq(G__67285__a,0,null);
} 
return G__67281__delegate.call(this,klass,contents);};
G__67281.cljs$lang$maxFixedArity = 1;
G__67281.cljs$lang$applyTo = (function (arglist__67286){
var klass = cljs.core.first(arglist__67286);
var contents = cljs.core.rest(arglist__67286);
return G__67281__delegate(klass,contents);
});
G__67281.cljs$core$IFn$_invoke$arity$variadic = G__67281__delegate;
return G__67281;
})()
;
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__67224){
var map__67225 = p__67224;
var map__67225__$1 = cljs.core.__destructure_map(map__67225);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67225__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67225__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__67232){
var map__67233 = p__67232;
var map__67233__$1 = cljs.core.__destructure_map(map__67233);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67233__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67233__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
var node = cljs_test_display.core.div(new cljs.core.Keyword(null,"test-fail","test-fail",-1337227951),cljs_test_display.core.contexts_node(),cljs_test_display.core.div(new cljs.core.Keyword(null,"fail-body","fail-body",91617623),(function (){var temp__5825__auto__ = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__67240){
var map__67241 = p__67240;
var map__67241__$1 = cljs.core.__destructure_map(map__67241);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67241__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67241__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__67242_SHARP_){
return cljs.core.cons(new_current_node,p1__67242_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__67244 = cljs_test_display.core.current_var_info();
var map__67244__$1 = cljs.core.__destructure_map(map__67244);
var info = map__67244__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67244__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67244__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67244__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__67243_SHARP_){
return cljs.core.cons(node,p1__67243_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__67245){
var map__67247 = p__67245;
var map__67247__$1 = cljs.core.__destructure_map(map__67247);
var m = map__67247__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67247__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67247__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67247__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67247__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__67252 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__67252) : formatter_fn.call(null,G__67252));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__67253 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__67253) : formatter_fn.call(null,G__67253));
})()], 0));
});
...
var temp__5825__auto___67297 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___67297)){
var message_67298 = temp__5825__auto___67297;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_67298], 0));
} else {
}
...
var temp__5825__auto___67303 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___67303)){
var message_67304 = temp__5825__auto___67303;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_67304], 0));
} else {
}
