...
var node = (function (){var G__67312 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__67313 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__67314 = style_string_67441;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__67312,G__67313,G__67314) : cljs_test_display.core.n.call(null,G__67312,G__67313,G__67314));
})();
...
var len__5749__auto___67443 = arguments.length;
var i__5750__auto___67444 = (0);
while(true){
if((i__5750__auto___67444 < len__5749__auto___67443)){
args__5755__auto__.push((arguments[i__5750__auto___67444]));

var G__67445 = (i__5750__auto___67444 + (1));
i__5750__auto___67444 = G__67445;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq67317){
var G__67318 = cljs.core.first(seq67317);
var seq67317__$1 = cljs.core.next(seq67317);
var G__67319 = cljs.core.first(seq67317__$1);
var seq67317__$2 = cljs.core.next(seq67317__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__67318,G__67319,seq67317__$2);
}));
...
var vec__67341 = ((clojure.string.starts_with_QMARK_(cljs.core.first(classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.first(classes),(1)),cljs.core.rest(classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67341,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67341,(1),null);
var G__67346 = cljs.core.PersistentArrayMap.EMPTY;
var G__67346__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67346,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__67346);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67346__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__67346__$1;
}
} else {
...
return (function() { 
var G__67449__delegate = function (klass,contents){
var vec__67351 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67351,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67351,(1),null);
...
var G__67449 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__67450__i = 0, G__67450__a = new Array(arguments.length -  1);
while (G__67450__i < G__67450__a.length) {G__67450__a[G__67450__i] = arguments[G__67450__i + 1]; ++G__67450__i;}
  contents = new cljs.core.IndexedSeq(G__67450__a,0,null);
} 
return G__67449__delegate.call(this,klass,contents);};
G__67449.cljs$lang$maxFixedArity = 1;
G__67449.cljs$lang$applyTo = (function (arglist__67451){
var klass = cljs.core.first(arglist__67451);
var contents = cljs.core.rest(arglist__67451);
return G__67449__delegate(klass,contents);
});
G__67449.cljs$core$IFn$_invoke$arity$variadic = G__67449__delegate;
return G__67449;
})()
;
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__67368){
var map__67369 = p__67368;
var map__67369__$1 = cljs.core.__destructure_map(map__67369);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67369__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67369__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__67377){
var map__67382 = p__67377;
var map__67382__$1 = cljs.core.__destructure_map(map__67382);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67382__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67382__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__67385){
var map__67386 = p__67385;
var map__67386__$1 = cljs.core.__destructure_map(map__67386);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67386__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67386__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__67391_SHARP_){
return cljs.core.cons(new_current_node,p1__67391_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__67393 = cljs_test_display.core.current_var_info();
var map__67393__$1 = cljs.core.__destructure_map(map__67393);
var info = map__67393__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67393__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67393__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67393__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__67392_SHARP_){
return cljs.core.cons(node,p1__67392_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__67395){
var map__67396 = p__67395;
var map__67396__$1 = cljs.core.__destructure_map(map__67396);
var m = map__67396__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67396__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67396__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67396__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67396__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__67408 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__67408) : formatter_fn.call(null,G__67408));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__67409 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__67409) : formatter_fn.call(null,G__67409));
})()], 0));
});
...
var temp__5825__auto___67464 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___67464)){
var message_67465 = temp__5825__auto___67464;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_67465], 0));
} else {
}
...
var temp__5825__auto___67467 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___67467)){
var message_67468 = temp__5825__auto___67467;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_67468], 0));
} else {
}
