...
var node = (function (){var G__65762 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__65763 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__65764 = style_string_65857;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__65762,G__65763,G__65764) : cljs_test_display.core.n.call(null,G__65762,G__65763,G__65764));
})();
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq65765){
var G__65766 = cljs.core.first(seq65765);
var seq65765__$1 = cljs.core.next(seq65765);
var G__65767 = cljs.core.first(seq65765__$1);
var seq65765__$2 = cljs.core.next(seq65765__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65766,G__65767,seq65765__$2);
}));
...
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65774,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65774,(1),null);
var G__65777 = cljs.core.PersistentArrayMap.EMPTY;
var G__65777__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__65777,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__65777);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__65777__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__65777__$1;
}
} else {
...
return (function() { 
var G__65866__delegate = function (klass,contents){
var vec__65784 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65784,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65784,(1),null);
...
var G__65866 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__65867__i = 0, G__65867__a = new Array(arguments.length -  1);
while (G__65867__i < G__65867__a.length) {G__65867__a[G__65867__i] = arguments[G__65867__i + 1]; ++G__65867__i;}
  contents = new cljs.core.IndexedSeq(G__65867__a,0,null);
} 
return G__65866__delegate.call(this,klass,contents);};
G__65866.cljs$lang$maxFixedArity = 1;
G__65866.cljs$lang$applyTo = (function (arglist__65868){
var klass = cljs.core.first(arglist__65868);
var contents = cljs.core.rest(arglist__65868);
return G__65866__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__65795){
var map__65796 = p__65795;
var map__65796__$1 = cljs.core.__destructure_map(map__65796);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65796__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65796__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__65797){
var map__65798 = p__65797;
var map__65798__$1 = cljs.core.__destructure_map(map__65798);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65798__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65798__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__65804){
var map__65805 = p__65804;
var map__65805__$1 = cljs.core.__destructure_map(map__65805);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65805__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65805__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__65808_SHARP_){
return cljs.core.cons(new_current_node,p1__65808_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__65812 = cljs_test_display.core.current_var_info();
var map__65812__$1 = cljs.core.__destructure_map(map__65812);
var info = map__65812__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65812__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65812__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65812__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__65811_SHARP_){
return cljs.core.cons(node,p1__65811_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__65814){
var map__65816 = p__65814;
var map__65816__$1 = cljs.core.__destructure_map(map__65816);
var m = map__65816__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65816__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65816__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65816__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65816__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__65817 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__65817) : formatter_fn.call(null,G__65817));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__65818 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__65818) : formatter_fn.call(null,G__65818));
})()], 0));
});
...
var temp__5825__auto___65874 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___65874)){
var message_65875 = temp__5825__auto___65874;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_65875], 0));
} else {
}
...
var temp__5825__auto___65876 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___65876)){
var message_65877 = temp__5825__auto___65876;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_65877], 0));
} else {
}
