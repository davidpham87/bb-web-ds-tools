...
var node = (function (){var G__65794 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__65795 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__65796 = style_string_65876;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__65794,G__65795,G__65796) : cljs_test_display.core.n.call(null,G__65794,G__65795,G__65796));
})();
...
var len__5749__auto___65877 = arguments.length;
var i__5750__auto___65878 = (0);
while(true){
if((i__5750__auto___65878 < len__5749__auto___65877)){
args__5755__auto__.push((arguments[i__5750__auto___65878]));

var G__65879 = (i__5750__auto___65878 + (1));
i__5750__auto___65878 = G__65879;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq65797){
var G__65798 = cljs.core.first(seq65797);
var seq65797__$1 = cljs.core.next(seq65797);
var G__65799 = cljs.core.first(seq65797__$1);
var seq65797__$2 = cljs.core.next(seq65797__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65798,G__65799,seq65797__$2);
}));
...
var vec__65805 = ((clojure.string.starts_with_QMARK_(cljs.core.first(classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.first(classes),(1)),cljs.core.rest(classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65805,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65805,(1),null);
var G__65808 = cljs.core.PersistentArrayMap.EMPTY;
var G__65808__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__65808,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__65808);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__65808__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__65808__$1;
}
} else {
...
return (function() { 
var G__65884__delegate = function (klass,contents){
var vec__65809 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65809,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65809,(1),null);
...
var G__65884 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__65885__i = 0, G__65885__a = new Array(arguments.length -  1);
while (G__65885__i < G__65885__a.length) {G__65885__a[G__65885__i] = arguments[G__65885__i + 1]; ++G__65885__i;}
  contents = new cljs.core.IndexedSeq(G__65885__a,0,null);
} 
return G__65884__delegate.call(this,klass,contents);};
G__65884.cljs$lang$maxFixedArity = 1;
G__65884.cljs$lang$applyTo = (function (arglist__65886){
var klass = cljs.core.first(arglist__65886);
var contents = cljs.core.rest(arglist__65886);
return G__65884__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__65818){
var map__65820 = p__65818;
var map__65820__$1 = cljs.core.__destructure_map(map__65820);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65820__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65820__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__65827){
var map__65828 = p__65827;
var map__65828__$1 = cljs.core.__destructure_map(map__65828);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65828__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65828__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__65829){
var map__65834 = p__65829;
var map__65834__$1 = cljs.core.__destructure_map(map__65834);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65834__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65834__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__65851_SHARP_){
return cljs.core.cons(new_current_node,p1__65851_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__65853 = cljs_test_display.core.current_var_info();
var map__65853__$1 = cljs.core.__destructure_map(map__65853);
var info = map__65853__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65853__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65853__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65853__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__65852_SHARP_){
return cljs.core.cons(node,p1__65852_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__65855){
var map__65857 = p__65855;
var map__65857__$1 = cljs.core.__destructure_map(map__65857);
var m = map__65857__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65857__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65857__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65857__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65857__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__65858 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__65858) : formatter_fn.call(null,G__65858));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__65859 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__65859) : formatter_fn.call(null,G__65859));
})()], 0));
});
...
var temp__5825__auto___65899 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___65899)){
var message_65900 = temp__5825__auto___65899;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_65900], 0));
} else {
}
...
var temp__5825__auto___65901 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___65901)){
var message_65902 = temp__5825__auto___65901;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_65902], 0));
} else {
}
