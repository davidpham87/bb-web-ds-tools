...
var node = (function (){var G__65668 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__65671 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__65672 = style_string_65759;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__65668,G__65671,G__65672) : cljs_test_display.core.n.call(null,G__65668,G__65671,G__65672));
})();
...
var len__5749__auto___65760 = arguments.length;
var i__5750__auto___65761 = (0);
while(true){
if((i__5750__auto___65761 < len__5749__auto___65760)){
args__5755__auto__.push((arguments[i__5750__auto___65761]));

var G__65762 = (i__5750__auto___65761 + (1));
i__5750__auto___65761 = G__65762;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq65674){
var G__65675 = cljs.core.first(seq65674);
var seq65674__$1 = cljs.core.next(seq65674);
var G__65676 = cljs.core.first(seq65674__$1);
var seq65674__$2 = cljs.core.next(seq65674__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65675,G__65676,seq65674__$2);
}));
...
var vec__65677 = ((clojure.string.starts_with_QMARK_(cljs.core.first(classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.first(classes),(1)),cljs.core.rest(classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65677,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65677,(1),null);
var G__65680 = cljs.core.PersistentArrayMap.EMPTY;
var G__65680__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__65680,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__65680);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__65680__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__65680__$1;
}
} else {
...
return (function() { 
var G__65768__delegate = function (klass,contents){
var vec__65681 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65681,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65681,(1),null);
...
var G__65768 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__65769__i = 0, G__65769__a = new Array(arguments.length -  1);
while (G__65769__i < G__65769__a.length) {G__65769__a[G__65769__i] = arguments[G__65769__i + 1]; ++G__65769__i;}
  contents = new cljs.core.IndexedSeq(G__65769__a,0,null);
} 
return G__65768__delegate.call(this,klass,contents);};
G__65768.cljs$lang$maxFixedArity = 1;
G__65768.cljs$lang$applyTo = (function (arglist__65770){
var klass = cljs.core.first(arglist__65770);
var contents = cljs.core.rest(arglist__65770);
return G__65768__delegate(klass,contents);
});
G__65768.cljs$core$IFn$_invoke$arity$variadic = G__65768__delegate;
return G__65768;
})()
;
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__65694){
var map__65695 = p__65694;
var map__65695__$1 = cljs.core.__destructure_map(map__65695);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65695__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65695__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__65704){
var map__65705 = p__65704;
var map__65705__$1 = cljs.core.__destructure_map(map__65705);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65705__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65705__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__65719){
var map__65720 = p__65719;
var map__65720__$1 = cljs.core.__destructure_map(map__65720);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65720__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65720__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__65727_SHARP_){
return cljs.core.cons(new_current_node,p1__65727_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__65729 = cljs_test_display.core.current_var_info();
var map__65729__$1 = cljs.core.__destructure_map(map__65729);
var info = map__65729__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65729__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65729__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65729__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__65728_SHARP_){
return cljs.core.cons(node,p1__65728_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__65736){
var map__65737 = p__65736;
var map__65737__$1 = cljs.core.__destructure_map(map__65737);
var m = map__65737__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65737__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65737__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65737__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65737__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__65744 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__65744) : formatter_fn.call(null,G__65744));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__65745 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__65745) : formatter_fn.call(null,G__65745));
})()], 0));
});
...
var temp__5825__auto___65794 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___65794)){
var message_65799 = temp__5825__auto___65794;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_65799], 0));
} else {
}
...
var temp__5825__auto___65800 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___65800)){
var message_65801 = temp__5825__auto___65800;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_65801], 0));
} else {
}
