...
var node = (function (){var G__65803 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__65804 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__65805 = style_string_65881;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__65803,G__65804,G__65805) : cljs_test_display.core.n.call(null,G__65803,G__65804,G__65805));
})();
...
var len__5749__auto___65886 = arguments.length;
var i__5750__auto___65887 = (0);
while(true){
if((i__5750__auto___65887 < len__5749__auto___65886)){
args__5755__auto__.push((arguments[i__5750__auto___65887]));

var G__65889 = (i__5750__auto___65887 + (1));
i__5750__auto___65887 = G__65889;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq65807){
var G__65809 = cljs.core.first(seq65807);
var seq65807__$1 = cljs.core.next(seq65807);
var G__65810 = cljs.core.first(seq65807__$1);
var seq65807__$2 = cljs.core.next(seq65807__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65809,G__65810,seq65807__$2);
}));
...
var vec__65811 = ((clojure.string.starts_with_QMARK_(cljs.core.first(classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.first(classes),(1)),cljs.core.rest(classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65811,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65811,(1),null);
var G__65814 = cljs.core.PersistentArrayMap.EMPTY;
var G__65814__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__65814,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__65814);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__65814__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__65814__$1;
}
} else {
...
return (function() { 
var G__65891__delegate = function (klass,contents){
var vec__65816 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65816,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65816,(1),null);
...
var G__65891 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__65892__i = 0, G__65892__a = new Array(arguments.length -  1);
while (G__65892__i < G__65892__a.length) {G__65892__a[G__65892__i] = arguments[G__65892__i + 1]; ++G__65892__i;}
  contents = new cljs.core.IndexedSeq(G__65892__a,0,null);
} 
return G__65891__delegate.call(this,klass,contents);};
G__65891.cljs$lang$maxFixedArity = 1;
G__65891.cljs$lang$applyTo = (function (arglist__65893){
var klass = cljs.core.first(arglist__65893);
var contents = cljs.core.rest(arglist__65893);
return G__65891__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__65825){
var map__65826 = p__65825;
var map__65826__$1 = cljs.core.__destructure_map(map__65826);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65826__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65826__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__65847){
var map__65848 = p__65847;
var map__65848__$1 = cljs.core.__destructure_map(map__65848);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65848__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65848__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__65851){
var map__65852 = p__65851;
var map__65852__$1 = cljs.core.__destructure_map(map__65852);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65852__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65852__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__65853_SHARP_){
return cljs.core.cons(new_current_node,p1__65853_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__65855 = cljs_test_display.core.current_var_info();
var map__65855__$1 = cljs.core.__destructure_map(map__65855);
var info = map__65855__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65855__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65855__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65855__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__65854_SHARP_){
return cljs.core.cons(node,p1__65854_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__65860){
var map__65861 = p__65860;
var map__65861__$1 = cljs.core.__destructure_map(map__65861);
var m = map__65861__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65861__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65861__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65861__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65861__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__65867 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__65867) : formatter_fn.call(null,G__65867));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__65869 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__65869) : formatter_fn.call(null,G__65869));
})()], 0));
});
...
var temp__5825__auto___65903 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___65903)){
var message_65904 = temp__5825__auto___65903;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_65904], 0));
} else {
}
...
var temp__5825__auto___65905 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___65905)){
var message_65906 = temp__5825__auto___65905;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_65906], 0));
} else {
}
