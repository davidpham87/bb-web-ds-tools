...
var node = (function (){var G__65723 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__65724 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__65725 = style_string_65826;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__65723,G__65724,G__65725) : cljs_test_display.core.n.call(null,G__65723,G__65724,G__65725));
})();
...
var vec__65736 = ((clojure.string.starts_with_QMARK_(cljs.core.first(classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.first(classes),(1)),cljs.core.rest(classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65736,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65736,(1),null);
var G__65739 = cljs.core.PersistentArrayMap.EMPTY;
var G__65739__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__65739,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__65739);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__65739__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__65739__$1;
}
} else {
...
return (function() { 
var G__65830__delegate = function (klass,contents){
var vec__65760 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65760,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65760,(1),null);
...
var G__65830 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__65831__i = 0, G__65831__a = new Array(arguments.length -  1);
while (G__65831__i < G__65831__a.length) {G__65831__a[G__65831__i] = arguments[G__65831__i + 1]; ++G__65831__i;}
  contents = new cljs.core.IndexedSeq(G__65831__a,0,null);
} 
return G__65830__delegate.call(this,klass,contents);};
G__65830.cljs$lang$maxFixedArity = 1;
G__65830.cljs$lang$applyTo = (function (arglist__65832){
var klass = cljs.core.first(arglist__65832);
var contents = cljs.core.rest(arglist__65832);
return G__65830__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__65767){
var map__65768 = p__65767;
var map__65768__$1 = cljs.core.__destructure_map(map__65768);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65768__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65768__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__65779){
var map__65780 = p__65779;
var map__65780__$1 = cljs.core.__destructure_map(map__65780);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65780__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65780__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__65785){
var map__65786 = p__65785;
var map__65786__$1 = cljs.core.__destructure_map(map__65786);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65786__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65786__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__65787_SHARP_){
return cljs.core.cons(new_current_node,p1__65787_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__65793 = cljs_test_display.core.current_var_info();
var map__65793__$1 = cljs.core.__destructure_map(map__65793);
var info = map__65793__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65793__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65793__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65793__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__65789_SHARP_){
return cljs.core.cons(node,p1__65789_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__65794){
var map__65795 = p__65794;
var map__65795__$1 = cljs.core.__destructure_map(map__65795);
var m = map__65795__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65795__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65795__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65795__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65795__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__65797 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__65797) : formatter_fn.call(null,G__65797));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__65798 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__65798) : formatter_fn.call(null,G__65798));
})()], 0));
});
...
var temp__5825__auto___65875 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___65875)){
var message_65876 = temp__5825__auto___65875;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_65876], 0));
} else {
}
...
var temp__5825__auto___65877 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___65877)){
var message_65878 = temp__5825__auto___65877;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_65878], 0));
} else {
}
