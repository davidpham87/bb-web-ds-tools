...
var node = (function (){var G__65986 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__65987 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__65988 = style_string_66083;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__65986,G__65987,G__65988) : cljs_test_display.core.n.call(null,G__65986,G__65987,G__65988));
})();
...
var len__5749__auto___66084 = arguments.length;
var i__5750__auto___66085 = (0);
while(true){
if((i__5750__auto___66085 < len__5749__auto___66084)){
args__5755__auto__.push((arguments[i__5750__auto___66085]));

var G__66086 = (i__5750__auto___66085 + (1));
i__5750__auto___66085 = G__66086;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq66002){
var G__66003 = cljs.core.first(seq66002);
var seq66002__$1 = cljs.core.next(seq66002);
var G__66004 = cljs.core.first(seq66002__$1);
var seq66002__$2 = cljs.core.next(seq66002__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__66003,G__66004,seq66002__$2);
}));
...
var vec__66011 = ((clojure.string.starts_with_QMARK_(cljs.core.first(classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.first(classes),(1)),cljs.core.rest(classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66011,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66011,(1),null);
var G__66014 = cljs.core.PersistentArrayMap.EMPTY;
var G__66014__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__66014,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__66014);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__66014__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__66014__$1;
}
} else {
...
return (function() { 
var G__66089__delegate = function (klass,contents){
var vec__66015 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66015,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66015,(1),null);
...
var G__66089 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__66090__i = 0, G__66090__a = new Array(arguments.length -  1);
while (G__66090__i < G__66090__a.length) {G__66090__a[G__66090__i] = arguments[G__66090__i + 1]; ++G__66090__i;}
  contents = new cljs.core.IndexedSeq(G__66090__a,0,null);
} 
return G__66089__delegate.call(this,klass,contents);};
G__66089.cljs$lang$maxFixedArity = 1;
G__66089.cljs$lang$applyTo = (function (arglist__66091){
var klass = cljs.core.first(arglist__66091);
var contents = cljs.core.rest(arglist__66091);
return G__66089__delegate(klass,contents);
});
G__66089.cljs$core$IFn$_invoke$arity$variadic = G__66089__delegate;
return G__66089;
})()
;
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__66026){
var map__66027 = p__66026;
var map__66027__$1 = cljs.core.__destructure_map(map__66027);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66027__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66027__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__66034){
var map__66035 = p__66034;
var map__66035__$1 = cljs.core.__destructure_map(map__66035);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66035__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66035__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__66037){
var map__66038 = p__66037;
var map__66038__$1 = cljs.core.__destructure_map(map__66038);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66038__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66038__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__66043_SHARP_){
return cljs.core.cons(new_current_node,p1__66043_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__66047 = cljs_test_display.core.current_var_info();
var map__66047__$1 = cljs.core.__destructure_map(map__66047);
var info = map__66047__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66047__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66047__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66047__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__66045_SHARP_){
return cljs.core.cons(node,p1__66045_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__66050){
var map__66051 = p__66050;
var map__66051__$1 = cljs.core.__destructure_map(map__66051);
var m = map__66051__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66051__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66051__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66051__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66051__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__66053 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__66053) : formatter_fn.call(null,G__66053));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__66054 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__66054) : formatter_fn.call(null,G__66054));
})()], 0));
});
...
var temp__5825__auto___66103 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___66103)){
var message_66104 = temp__5825__auto___66103;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_66104], 0));
} else {
}
...
var temp__5825__auto___66105 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___66105)){
var message_66106 = temp__5825__auto___66105;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_66106], 0));
} else {
}
