...
var node = (function (){var G__65520 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__65521 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__65522 = style_string_65673;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__65520,G__65521,G__65522) : cljs_test_display.core.n.call(null,G__65520,G__65521,G__65522));
})();
...
var len__5749__auto___65684 = arguments.length;
var i__5750__auto___65685 = (0);
while(true){
if((i__5750__auto___65685 < len__5749__auto___65684)){
args__5755__auto__.push((arguments[i__5750__auto___65685]));

var G__65686 = (i__5750__auto___65685 + (1));
i__5750__auto___65685 = G__65686;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq65523){
var G__65524 = cljs.core.first(seq65523);
var seq65523__$1 = cljs.core.next(seq65523);
var G__65525 = cljs.core.first(seq65523__$1);
var seq65523__$2 = cljs.core.next(seq65523__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65524,G__65525,seq65523__$2);
}));
...
var vec__65545 = ((clojure.string.starts_with_QMARK_(cljs.core.first(classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.first(classes),(1)),cljs.core.rest(classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65545,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65545,(1),null);
var G__65548 = cljs.core.PersistentArrayMap.EMPTY;
var G__65548__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__65548,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__65548);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__65548__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__65548__$1;
}
} else {
...
return (function() { 
var G__65687__delegate = function (klass,contents){
var vec__65551 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65551,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65551,(1),null);
...
var G__65687 = function (klass,var_args){
var contents = null;
...
while (G__65688__i < G__65688__a.length) {G__65688__a[G__65688__i] = arguments[G__65688__i + 1]; ++G__65688__i;}
  contents = new cljs.core.IndexedSeq(G__65688__a,0,null);
} 
return G__65687__delegate.call(this,klass,contents);};
G__65687.cljs$lang$maxFixedArity = 1;
G__65687.cljs$lang$applyTo = (function (arglist__65689){
var klass = cljs.core.first(arglist__65689);
var contents = cljs.core.rest(arglist__65689);
return G__65687__delegate(klass,contents);
});
G__65687.cljs$core$IFn$_invoke$arity$variadic = G__65687__delegate;
return G__65687;
})()
;
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__65578){
var map__65583 = p__65578;
var map__65583__$1 = cljs.core.__destructure_map(map__65583);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65583__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65583__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__65605){
var map__65606 = p__65605;
var map__65606__$1 = cljs.core.__destructure_map(map__65606);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65606__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65606__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__65608){
var map__65609 = p__65608;
var map__65609__$1 = cljs.core.__destructure_map(map__65609);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65609__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65609__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__65612_SHARP_){
return cljs.core.cons(new_current_node,p1__65612_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__65621 = cljs_test_display.core.current_var_info();
var map__65621__$1 = cljs.core.__destructure_map(map__65621);
var info = map__65621__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65621__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65621__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65621__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__65620_SHARP_){
return cljs.core.cons(node,p1__65620_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__65628){
var map__65629 = p__65628;
var map__65629__$1 = cljs.core.__destructure_map(map__65629);
var m = map__65629__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65629__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65629__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65629__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65629__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__65643 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__65643) : formatter_fn.call(null,G__65643));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__65647 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__65647) : formatter_fn.call(null,G__65647));
})()], 0));
});
...
var temp__5825__auto___65709 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___65709)){
var message_65710 = temp__5825__auto___65709;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_65710], 0));
} else {
}
...
var temp__5825__auto___65711 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___65711)){
var message_65712 = temp__5825__auto___65711;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_65712], 0));
} else {
}
