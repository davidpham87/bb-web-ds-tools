...
var node = (function (){var G__67211 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__67212 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__67213 = style_string_67300;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__67211,G__67212,G__67213) : cljs_test_display.core.n.call(null,G__67211,G__67212,G__67213));
})();
...
var len__5749__auto___67301 = arguments.length;
var i__5750__auto___67302 = (0);
while(true){
if((i__5750__auto___67302 < len__5749__auto___67301)){
args__5755__auto__.push((arguments[i__5750__auto___67302]));

var G__67303 = (i__5750__auto___67302 + (1));
i__5750__auto___67302 = G__67303;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq67214){
var G__67215 = cljs.core.first(seq67214);
var seq67214__$1 = cljs.core.next(seq67214);
var G__67216 = cljs.core.first(seq67214__$1);
var seq67214__$2 = cljs.core.next(seq67214__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__67215,G__67216,seq67214__$2);
}));
...
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67219,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67219,(1),null);
var G__67225 = cljs.core.PersistentArrayMap.EMPTY;
var G__67225__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67225,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__67225);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67225__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__67225__$1;
}
} else {
...
return (function() { 
var G__67308__delegate = function (klass,contents){
var vec__67229 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67229,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67229,(1),null);
...
var G__67308 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__67309__i = 0, G__67309__a = new Array(arguments.length -  1);
while (G__67309__i < G__67309__a.length) {G__67309__a[G__67309__i] = arguments[G__67309__i + 1]; ++G__67309__i;}
  contents = new cljs.core.IndexedSeq(G__67309__a,0,null);
} 
return G__67308__delegate.call(this,klass,contents);};
G__67308.cljs$lang$maxFixedArity = 1;
G__67308.cljs$lang$applyTo = (function (arglist__67310){
var klass = cljs.core.first(arglist__67310);
var contents = cljs.core.rest(arglist__67310);
return G__67308__delegate(klass,contents);
});
G__67308.cljs$core$IFn$_invoke$arity$variadic = G__67308__delegate;
return G__67308;
})()
;
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__67242){
var map__67246 = p__67242;
var map__67246__$1 = cljs.core.__destructure_map(map__67246);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67246__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__67263){
var map__67264 = p__67263;
var map__67264__$1 = cljs.core.__destructure_map(map__67264);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67264__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67264__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__67271){
var map__67272 = p__67271;
var map__67272__$1 = cljs.core.__destructure_map(map__67272);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67272__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67272__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__67279_SHARP_){
return cljs.core.cons(new_current_node,p1__67279_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__67281 = cljs_test_display.core.current_var_info();
var map__67281__$1 = cljs.core.__destructure_map(map__67281);
var info = map__67281__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67281__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67281__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67281__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__67280_SHARP_){
return cljs.core.cons(node,p1__67280_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__67282){
var map__67283 = p__67282;
var map__67283__$1 = cljs.core.__destructure_map(map__67283);
var m = map__67283__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67283__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67283__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67283__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67283__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__67289 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__67289) : formatter_fn.call(null,G__67289));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__67290 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__67290) : formatter_fn.call(null,G__67290));
})()], 0));
});
...
var temp__5825__auto___67334 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___67334)){
var message_67335 = temp__5825__auto___67334;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_67335], 0));
} else {
}
...
var temp__5825__auto___67336 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___67336)){
var message_67337 = temp__5825__auto___67336;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_67337], 0));
} else {
}
