...
var node = (function (){var G__65180 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__65181 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__65182 = style_string_65263;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__65180,G__65181,G__65182) : cljs_test_display.core.n.call(null,G__65180,G__65181,G__65182));
})();
...
var len__5749__auto___65267 = arguments.length;
var i__5750__auto___65268 = (0);
while(true){
if((i__5750__auto___65268 < len__5749__auto___65267)){
args__5755__auto__.push((arguments[i__5750__auto___65268]));

var G__65269 = (i__5750__auto___65268 + (1));
i__5750__auto___65268 = G__65269;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq65184){
var G__65185 = cljs.core.first(seq65184);
var seq65184__$1 = cljs.core.next(seq65184);
var G__65186 = cljs.core.first(seq65184__$1);
var seq65184__$2 = cljs.core.next(seq65184__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65185,G__65186,seq65184__$2);
}));
...
var vec__65192 = ((clojure.string.starts_with_QMARK_(cljs.core.first(classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.first(classes),(1)),cljs.core.rest(classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65192,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65192,(1),null);
var G__65196 = cljs.core.PersistentArrayMap.EMPTY;
var G__65196__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__65196,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__65196);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__65196__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__65196__$1;
}
} else {
...
return (function() { 
var G__65270__delegate = function (klass,contents){
var vec__65198 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65198,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65198,(1),null);
...
var G__65270 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__65271__i = 0, G__65271__a = new Array(arguments.length -  1);
while (G__65271__i < G__65271__a.length) {G__65271__a[G__65271__i] = arguments[G__65271__i + 1]; ++G__65271__i;}
  contents = new cljs.core.IndexedSeq(G__65271__a,0,null);
} 
return G__65270__delegate.call(this,klass,contents);};
G__65270.cljs$lang$maxFixedArity = 1;
G__65270.cljs$lang$applyTo = (function (arglist__65272){
var klass = cljs.core.first(arglist__65272);
var contents = cljs.core.rest(arglist__65272);
return G__65270__delegate(klass,contents);
});
G__65270.cljs$core$IFn$_invoke$arity$variadic = G__65270__delegate;
return G__65270;
})()
;
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__65205){
var map__65206 = p__65205;
var map__65206__$1 = cljs.core.__destructure_map(map__65206);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65206__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65206__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__65213){
var map__65214 = p__65213;
var map__65214__$1 = cljs.core.__destructure_map(map__65214);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65214__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65214__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__65222){
var map__65223 = p__65222;
var map__65223__$1 = cljs.core.__destructure_map(map__65223);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65223__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65223__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__65237_SHARP_){
return cljs.core.cons(new_current_node,p1__65237_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__65239 = cljs_test_display.core.current_var_info();
var map__65239__$1 = cljs.core.__destructure_map(map__65239);
var info = map__65239__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65239__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65239__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65239__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__65238_SHARP_){
return cljs.core.cons(node,p1__65238_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__65242){
var map__65243 = p__65242;
var map__65243__$1 = cljs.core.__destructure_map(map__65243);
var m = map__65243__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65243__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65243__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65243__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65243__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__65244 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__65244) : formatter_fn.call(null,G__65244));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__65245 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__65245) : formatter_fn.call(null,G__65245));
})()], 0));
});
...
var temp__5825__auto___65285 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___65285)){
var message_65286 = temp__5825__auto___65285;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_65286], 0));
} else {
}
...
var temp__5825__auto___65287 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___65287)){
var message_65288 = temp__5825__auto___65287;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_65288], 0));
} else {
}
