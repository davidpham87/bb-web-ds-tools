...
var node = (function (){var G__65779 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__65780 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__65781 = style_string_65857;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__65779,G__65780,G__65781) : cljs_test_display.core.n.call(null,G__65779,G__65780,G__65781));
})();
...
var len__5749__auto___65858 = arguments.length;
var i__5750__auto___65859 = (0);
while(true){
if((i__5750__auto___65859 < len__5749__auto___65858)){
args__5755__auto__.push((arguments[i__5750__auto___65859]));

var G__65860 = (i__5750__auto___65859 + (1));
i__5750__auto___65859 = G__65860;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq65782){
var G__65783 = cljs.core.first(seq65782);
var seq65782__$1 = cljs.core.next(seq65782);
var G__65784 = cljs.core.first(seq65782__$1);
var seq65782__$2 = cljs.core.next(seq65782__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65783,G__65784,seq65782__$2);
}));
...
var vec__65791 = ((clojure.string.starts_with_QMARK_(cljs.core.first(classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.first(classes),(1)),cljs.core.rest(classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65791,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65791,(1),null);
var G__65794 = cljs.core.PersistentArrayMap.EMPTY;
var G__65794__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__65794,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__65794);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__65794__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__65794__$1;
}
} else {
...
return (function() { 
var G__65863__delegate = function (klass,contents){
var vec__65801 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65801,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65801,(1),null);
...
var G__65863 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__65864__i = 0, G__65864__a = new Array(arguments.length -  1);
while (G__65864__i < G__65864__a.length) {G__65864__a[G__65864__i] = arguments[G__65864__i + 1]; ++G__65864__i;}
  contents = new cljs.core.IndexedSeq(G__65864__a,0,null);
} 
return G__65863__delegate.call(this,klass,contents);};
G__65863.cljs$lang$maxFixedArity = 1;
G__65863.cljs$lang$applyTo = (function (arglist__65865){
var klass = cljs.core.first(arglist__65865);
var contents = cljs.core.rest(arglist__65865);
return G__65863__delegate(klass,contents);
});
G__65863.cljs$core$IFn$_invoke$arity$variadic = G__65863__delegate;
return G__65863;
})()
;
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__65806){
var map__65807 = p__65806;
var map__65807__$1 = cljs.core.__destructure_map(map__65807);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65807__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65807__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__65813){
var map__65814 = p__65813;
var map__65814__$1 = cljs.core.__destructure_map(map__65814);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65814__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65814__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__65817){
var map__65819 = p__65817;
var map__65819__$1 = cljs.core.__destructure_map(map__65819);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65819__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65819__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__65821_SHARP_){
return cljs.core.cons(new_current_node,p1__65821_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__65825 = cljs_test_display.core.current_var_info();
var map__65825__$1 = cljs.core.__destructure_map(map__65825);
var info = map__65825__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65825__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65825__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65825__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__65824_SHARP_){
return cljs.core.cons(node,p1__65824_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__65826){
var map__65827 = p__65826;
var map__65827__$1 = cljs.core.__destructure_map(map__65827);
var m = map__65827__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65827__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65827__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65827__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65827__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__65828 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__65828) : formatter_fn.call(null,G__65828));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__65829 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__65829) : formatter_fn.call(null,G__65829));
})()], 0));
});
...
var temp__5825__auto___65885 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___65885)){
var message_65886 = temp__5825__auto___65885;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_65886], 0));
} else {
}
...
var temp__5825__auto___65887 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___65887)){
var message_65888 = temp__5825__auto___65887;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_65888], 0));
} else {
}
