...
var node = (function (){var G__68900 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__68901 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__68902 = style_string_69154;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__68900,G__68901,G__68902) : cljs_test_display.core.n.call(null,G__68900,G__68901,G__68902));
})();
...
var len__5749__auto___69156 = arguments.length;
var i__5750__auto___69157 = (0);
while(true){
if((i__5750__auto___69157 < len__5749__auto___69156)){
args__5755__auto__.push((arguments[i__5750__auto___69157]));

var G__69159 = (i__5750__auto___69157 + (1));
i__5750__auto___69157 = G__69159;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq68903){
var G__68904 = cljs.core.first(seq68903);
var seq68903__$1 = cljs.core.next(seq68903);
var G__68905 = cljs.core.first(seq68903__$1);
var seq68903__$2 = cljs.core.next(seq68903__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__68904,G__68905,seq68903__$2);
}));
...
var vec__68912 = ((clojure.string.starts_with_QMARK_(cljs.core.first(classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.first(classes),(1)),cljs.core.rest(classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68912,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68912,(1),null);
var G__68915 = cljs.core.PersistentArrayMap.EMPTY;
var G__68915__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__68915,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__68915);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__68915__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__68915__$1;
}
} else {
...
return (function() { 
var G__69161__delegate = function (klass,contents){
var vec__68916 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68916,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68916,(1),null);
...
var G__69161 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__69162__i = 0, G__69162__a = new Array(arguments.length -  1);
while (G__69162__i < G__69162__a.length) {G__69162__a[G__69162__i] = arguments[G__69162__i + 1]; ++G__69162__i;}
  contents = new cljs.core.IndexedSeq(G__69162__a,0,null);
} 
return G__69161__delegate.call(this,klass,contents);};
G__69161.cljs$lang$maxFixedArity = 1;
G__69161.cljs$lang$applyTo = (function (arglist__69163){
var klass = cljs.core.first(arglist__69163);
var contents = cljs.core.rest(arglist__69163);
return G__69161__delegate(klass,contents);
});
G__69161.cljs$core$IFn$_invoke$arity$variadic = G__69161__delegate;
return G__69161;
})()
;
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__68927){
var map__68928 = p__68927;
var map__68928__$1 = cljs.core.__destructure_map(map__68928);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68928__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68928__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__68931){
var map__68932 = p__68931;
var map__68932__$1 = cljs.core.__destructure_map(map__68932);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68932__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68932__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__68934){
var map__68935 = p__68934;
var map__68935__$1 = cljs.core.__destructure_map(map__68935);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68935__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68935__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__68938_SHARP_){
return cljs.core.cons(new_current_node,p1__68938_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__68944 = cljs_test_display.core.current_var_info();
var map__68944__$1 = cljs.core.__destructure_map(map__68944);
var info = map__68944__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68944__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68944__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68944__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__68942_SHARP_){
return cljs.core.cons(node,p1__68942_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__68946){
var map__68947 = p__68946;
var map__68947__$1 = cljs.core.__destructure_map(map__68947);
var m = map__68947__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68947__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68947__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68947__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68947__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__68975 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__68975) : formatter_fn.call(null,G__68975));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__68976 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__68976) : formatter_fn.call(null,G__68976));
})()], 0));
});
...
var temp__5825__auto___69290 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___69290)){
var message_69291 = temp__5825__auto___69290;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_69291], 0));
} else {
}
...
var temp__5825__auto___69292 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___69292)){
var message_69293 = temp__5825__auto___69292;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_69293], 0));
} else {
}
