...
var node = (function (){var G__65671 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__65672 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__65673 = style_string_65800;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__65671,G__65672,G__65673) : cljs_test_display.core.n.call(null,G__65671,G__65672,G__65673));
})();
...
var len__5749__auto___65801 = arguments.length;
var i__5750__auto___65802 = (0);
while(true){
if((i__5750__auto___65802 < len__5749__auto___65801)){
args__5755__auto__.push((arguments[i__5750__auto___65802]));

var G__65803 = (i__5750__auto___65802 + (1));
i__5750__auto___65802 = G__65803;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq65683){
var G__65687 = cljs.core.first(seq65683);
var seq65683__$1 = cljs.core.next(seq65683);
var G__65688 = cljs.core.first(seq65683__$1);
var seq65683__$2 = cljs.core.next(seq65683__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65687,G__65688,seq65683__$2);
}));
...
var vec__65712 = ((clojure.string.starts_with_QMARK_(cljs.core.first(classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.first(classes),(1)),cljs.core.rest(classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65712,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65712,(1),null);
var G__65715 = cljs.core.PersistentArrayMap.EMPTY;
var G__65715__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__65715,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__65715);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__65715__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__65715__$1;
}
} else {
...
return (function() { 
var G__65808__delegate = function (klass,contents){
var vec__65728 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65728,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65728,(1),null);
...
var G__65808 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__65809__i = 0, G__65809__a = new Array(arguments.length -  1);
while (G__65809__i < G__65809__a.length) {G__65809__a[G__65809__i] = arguments[G__65809__i + 1]; ++G__65809__i;}
  contents = new cljs.core.IndexedSeq(G__65809__a,0,null);
} 
return G__65808__delegate.call(this,klass,contents);};
G__65808.cljs$lang$maxFixedArity = 1;
G__65808.cljs$lang$applyTo = (function (arglist__65810){
var klass = cljs.core.first(arglist__65810);
var contents = cljs.core.rest(arglist__65810);
return G__65808__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__65739){
var map__65740 = p__65739;
var map__65740__$1 = cljs.core.__destructure_map(map__65740);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65740__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65740__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__65746){
var map__65747 = p__65746;
var map__65747__$1 = cljs.core.__destructure_map(map__65747);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65747__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65747__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__65757){
var map__65761 = p__65757;
var map__65761__$1 = cljs.core.__destructure_map(map__65761);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65761__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65761__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__65775_SHARP_){
return cljs.core.cons(new_current_node,p1__65775_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__65777 = cljs_test_display.core.current_var_info();
var map__65777__$1 = cljs.core.__destructure_map(map__65777);
var info = map__65777__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65777__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65777__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65777__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__65776_SHARP_){
return cljs.core.cons(node,p1__65776_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__65780){
var map__65781 = p__65780;
var map__65781__$1 = cljs.core.__destructure_map(map__65781);
var m = map__65781__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65781__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65781__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65781__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65781__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__65782 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__65782) : formatter_fn.call(null,G__65782));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__65783 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__65783) : formatter_fn.call(null,G__65783));
})()], 0));
});
...
var temp__5825__auto___65817 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___65817)){
var message_65818 = temp__5825__auto___65817;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_65818], 0));
} else {
}
...
var temp__5825__auto___65820 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5825__auto___65820)){
var message_65821 = temp__5825__auto___65820;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_65821], 0));
} else {
}
