...
var malli$json_schema$JsonSchema$_accept$dyn_52471 = (function (this$,children,options){
...
return malli$json_schema$JsonSchema$_accept$dyn_52471(this$,children,options);
}
});
...
malli.json_schema._ref = (function malli$json_schema$_ref(schema,p__52331){
var map__52332 = p__52331;
var map__52332__$1 = cljs.core.__destructure_map(map__52332);
var options = map__52332__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52332__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var definitions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52332__$1,new cljs.core.Keyword("malli.json-schema","definitions","malli.json-schema/definitions",1666750607));
var definitions_path = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52332__$1,new cljs.core.Keyword("malli.json-schema","definitions-path","malli.json-schema/definitions-path",10213173),"#/definitions/");
var ref = (function (){var $ = malli.core._ref(schema);
if(cljs.core.var_QMARK_($)){
var map__52334 = cljs.core.meta($);
var map__52334__$1 = cljs.core.__destructure_map(map__52334);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52334__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52334__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var child_52472 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(definitions,cljs.core.assoc,ref,(transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(child_52472,options) : transform.call(null,child_52472,options)));
}
...
malli.json_schema._schema = (function malli$json_schema$_schema(schema,p__52336){
var map__52337 = p__52336;
var map__52337__$1 = cljs.core.__destructure_map(map__52337);
var options = map__52337__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52337__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
if(cljs.core.truth_(malli.core._ref(schema))){
return malli.json_schema._ref(schema,options);
} else {
var G__52339 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52340 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52339,G__52340) : transform.call(null,G__52339,G__52340));
}
});
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.json-schema","default","malli.json-schema/default",-421449099)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__52342 = cljs.core.get_global_hierarchy;
return (fexpr__52342.cljs$core$IFn$_invoke$arity$0 ? fexpr__52342.cljs$core$IFn$_invoke$arity$0() : fexpr__52342.call(null));
})());
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">",">",-555517146),(function (_,___$1,p__52368,___$2){
var vec__52369 = p__52368;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52369,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">=",">=",-623615505),(function (_,___$1,p__52372,___$2){
var vec__52373 = p__52372;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52373,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<","<",-646864291),(function (_,___$1,p__52376,___$2){
var vec__52377 = p__52376;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52377,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<=","<=",-395636158),(function (_,___$1,p__52380,___$2){
var vec__52381 = p__52380;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52381,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"=","=",1152933628),(function (_,___$1,p__52387,___$2){
var vec__52388 = p__52387;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52388,(0),null);
...
var default$ = (function (){var G__52394 = children;
var G__52394__$1 = (((G__52394 == null))?null:cljs.core.remove.cljs$core$IFn$_invoke$arity$2(malli.core._comp.cljs$core$IFn$_invoke$arity$2(ks,cljs.core.first),G__52394));
var G__52394__$2 = (((G__52394__$1 == null))?null:cljs.core.first(G__52394__$1));
if((G__52394__$2 == null)){
return null;
} else {
return cljs.core.last(G__52394__$2);
}
})();
var map__52393 = default$;
var map__52393__$1 = cljs.core.__destructure_map(map__52393);
var additionalProperties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52393__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392));
var properties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52393__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52393__$1,new cljs.core.Keyword(null,"required","required",1807647006));
...
var G__52399 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([default$,object], 0));
var G__52399__$1 = ((cljs.core.seq(required))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52399,new cljs.core.Keyword(null,"required","required",1807647006),required):G__52399);
var G__52399__$2 = (cljs.core.truth_(closed)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52399__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),false):G__52399__$1);
if(cljs.core.truth_(default$)){
var G__52400 = G__52399__$2;
var G__52400__$1 = (cljs.core.truth_(additionalProperties_SINGLEQUOTE_)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52400,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),additionalProperties_SINGLEQUOTE_):G__52400);
var G__52400__$2 = (cljs.core.truth_(properties_SINGLEQUOTE_)?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__52400__$1,new cljs.core.Keyword(null,"properties","properties",685819552),cljs.core.merge,properties_SINGLEQUOTE_):G__52400__$1);
if(cljs.core.truth_(required_SINGLEQUOTE_)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__52400__$2,new cljs.core.Keyword(null,"required","required",1807647006),cljs.core.comp.cljs$core$IFn$_invoke$arity$3(cljs.core.vec,cljs.core.distinct,cljs.core.into),required_SINGLEQUOTE_);
} else {
return G__52400__$2;
}
} else {
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var G__52421 = malli.core._infer(children);
if((G__52421 == null)){
return null;
} else {
return (malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2 ? malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2(G__52421,options) : malli.json_schema._transform.call(null,G__52421,options));
}
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"merge","merge",-1804319409),(function (_,schema,___$1,p__52438){
var map__52439 = p__52438;
var map__52439__$1 = cljs.core.__destructure_map(map__52439);
var options = map__52439__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52439__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__52448 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52449 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52448,G__52449) : transform.call(null,G__52448,G__52449));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"union","union",2142937499),(function (_,schema,___$1,p__52450){
var map__52451 = p__52450;
var map__52451__$1 = cljs.core.__destructure_map(map__52451);
var options = map__52451__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52451__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__52452 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52453 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52452,G__52453) : transform.call(null,G__52452,G__52453));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"select-keys","select-keys",1945879180),(function (_,schema,___$1,p__52454){
var map__52455 = p__52454;
var map__52455__$1 = cljs.core.__destructure_map(map__52455);
var options = map__52455__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52455__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__52456 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52457 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52456,G__52457) : transform.call(null,G__52456,G__52457));
}));
...
var G__52468 = malli.json_schema._transform(_QMARK_schema,options__$1);
if(cljs.core.seq(cljs.core.deref(definitions))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52468,new cljs.core.Keyword(null,"definitions","definitions",167529986),cljs.core.deref(definitions));
} else {
return G__52468;
}
}));
