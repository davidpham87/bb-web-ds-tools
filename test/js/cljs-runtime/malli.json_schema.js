...
var malli$json_schema$JsonSchema$_accept$dyn_52429 = (function (this$,children,options){
...
return malli$json_schema$JsonSchema$_accept$dyn_52429(this$,children,options);
}
});
...
malli.json_schema._ref = (function malli$json_schema$_ref(schema,p__52318){
var map__52319 = p__52318;
var map__52319__$1 = cljs.core.__destructure_map(map__52319);
var options = map__52319__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52319__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var definitions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52319__$1,new cljs.core.Keyword("malli.json-schema","definitions","malli.json-schema/definitions",1666750607));
var definitions_path = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52319__$1,new cljs.core.Keyword("malli.json-schema","definitions-path","malli.json-schema/definitions-path",10213173),"#/definitions/");
var ref = (function (){var $ = malli.core._ref(schema);
if(cljs.core.var_QMARK_($)){
var map__52320 = cljs.core.meta($);
var map__52320__$1 = cljs.core.__destructure_map(map__52320);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52320__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52320__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var child_52430 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(definitions,cljs.core.assoc,ref,(transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(child_52430,options) : transform.call(null,child_52430,options)));
}
...
malli.json_schema._schema = (function malli$json_schema$_schema(schema,p__52325){
var map__52326 = p__52325;
var map__52326__$1 = cljs.core.__destructure_map(map__52326);
var options = map__52326__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52326__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
if(cljs.core.truth_(malli.core._ref(schema))){
return malli.json_schema._ref(schema,options);
} else {
var G__52327 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52328 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52327,G__52328) : transform.call(null,G__52327,G__52328));
}
});
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.json-schema","default","malli.json-schema/default",-421449099)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__52329 = cljs.core.get_global_hierarchy;
return (fexpr__52329.cljs$core$IFn$_invoke$arity$0 ? fexpr__52329.cljs$core$IFn$_invoke$arity$0() : fexpr__52329.call(null));
})());
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">",">",-555517146),(function (_,___$1,p__52345,___$2){
var vec__52346 = p__52345;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52346,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">=",">=",-623615505),(function (_,___$1,p__52349,___$2){
var vec__52350 = p__52349;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52350,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<","<",-646864291),(function (_,___$1,p__52353,___$2){
var vec__52354 = p__52353;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52354,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<=","<=",-395636158),(function (_,___$1,p__52359,___$2){
var vec__52360 = p__52359;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52360,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"=","=",1152933628),(function (_,___$1,p__52366,___$2){
var vec__52367 = p__52366;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52367,(0),null);
...
var default$ = (function (){var G__52373 = children;
var G__52373__$1 = (((G__52373 == null))?null:cljs.core.remove.cljs$core$IFn$_invoke$arity$2(malli.core._comp.cljs$core$IFn$_invoke$arity$2(ks,cljs.core.first),G__52373));
var G__52373__$2 = (((G__52373__$1 == null))?null:cljs.core.first(G__52373__$1));
if((G__52373__$2 == null)){
return null;
} else {
return cljs.core.last(G__52373__$2);
}
})();
var map__52372 = default$;
var map__52372__$1 = cljs.core.__destructure_map(map__52372);
var additionalProperties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52372__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392));
var properties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52372__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52372__$1,new cljs.core.Keyword(null,"required","required",1807647006));
...
var object = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),"object",new cljs.core.Keyword(null,"properties","properties",685819552),cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.array_map,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__52375){
var vec__52376 = p__52375;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52376,(0),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52376,(1),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52376,(2),null);
...
var G__52379 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([default$,object], 0));
var G__52379__$1 = ((cljs.core.seq(required))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52379,new cljs.core.Keyword(null,"required","required",1807647006),required):G__52379);
var G__52379__$2 = (cljs.core.truth_(closed)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52379__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),false):G__52379__$1);
if(cljs.core.truth_(default$)){
var G__52381 = G__52379__$2;
var G__52381__$1 = (cljs.core.truth_(additionalProperties_SINGLEQUOTE_)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52381,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),additionalProperties_SINGLEQUOTE_):G__52381);
var G__52381__$2 = (cljs.core.truth_(properties_SINGLEQUOTE_)?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__52381__$1,new cljs.core.Keyword(null,"properties","properties",685819552),cljs.core.merge,properties_SINGLEQUOTE_):G__52381__$1);
if(cljs.core.truth_(required_SINGLEQUOTE_)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__52381__$2,new cljs.core.Keyword(null,"required","required",1807647006),cljs.core.comp.cljs$core$IFn$_invoke$arity$3(cljs.core.vec,cljs.core.distinct,cljs.core.into),required_SINGLEQUOTE_);
} else {
return G__52381__$2;
}
} else {
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var G__52386 = malli.core._infer(children);
if((G__52386 == null)){
return null;
} else {
return (malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2 ? malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2(G__52386,options) : malli.json_schema._transform.call(null,G__52386,options));
}
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"merge","merge",-1804319409),(function (_,schema,___$1,p__52403){
var map__52404 = p__52403;
var map__52404__$1 = cljs.core.__destructure_map(map__52404);
var options = map__52404__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52404__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__52408 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52409 = options;
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"union","union",2142937499),(function (_,schema,___$1,p__52410){
var map__52411 = p__52410;
var map__52411__$1 = cljs.core.__destructure_map(map__52411);
var options = map__52411__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52411__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__52412 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52413 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52412,G__52413) : transform.call(null,G__52412,G__52413));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"select-keys","select-keys",1945879180),(function (_,schema,___$1,p__52415){
var map__52416 = p__52415;
var map__52416__$1 = cljs.core.__destructure_map(map__52416);
var options = map__52416__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52416__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__52417 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52418 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52417,G__52418) : transform.call(null,G__52417,G__52418));
}));
...
var G__52428 = malli.json_schema._transform(_QMARK_schema,options__$1);
if(cljs.core.seq(cljs.core.deref(definitions))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52428,new cljs.core.Keyword(null,"definitions","definitions",167529986),cljs.core.deref(definitions));
} else {
return G__52428;
}
}));
