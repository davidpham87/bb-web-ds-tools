...
var malli$json_schema$JsonSchema$_accept$dyn_52281 = (function (this$,children,options){
...
return malli$json_schema$JsonSchema$_accept$dyn_52281(this$,children,options);
}
});
...
malli.json_schema._ref = (function malli$json_schema$_ref(schema,p__52168){
var map__52172 = p__52168;
var map__52172__$1 = cljs.core.__destructure_map(map__52172);
var options = map__52172__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52172__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var definitions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52172__$1,new cljs.core.Keyword("malli.json-schema","definitions","malli.json-schema/definitions",1666750607));
var definitions_path = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52172__$1,new cljs.core.Keyword("malli.json-schema","definitions-path","malli.json-schema/definitions-path",10213173),"#/definitions/");
var ref = (function (){var $ = malli.core._ref(schema);
if(cljs.core.var_QMARK_($)){
var map__52173 = cljs.core.meta($);
var map__52173__$1 = cljs.core.__destructure_map(map__52173);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52173__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52173__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var child_52284 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(definitions,cljs.core.assoc,ref,(transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(child_52284,options) : transform.call(null,child_52284,options)));
}
...
malli.json_schema._schema = (function malli$json_schema$_schema(schema,p__52176){
var map__52177 = p__52176;
var map__52177__$1 = cljs.core.__destructure_map(map__52177);
var options = map__52177__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52177__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
if(cljs.core.truth_(malli.core._ref(schema))){
return malli.json_schema._ref(schema,options);
} else {
var G__52178 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52179 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52178,G__52179) : transform.call(null,G__52178,G__52179));
}
});
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.json-schema","default","malli.json-schema/default",-421449099)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__52181 = cljs.core.get_global_hierarchy;
return (fexpr__52181.cljs$core$IFn$_invoke$arity$0 ? fexpr__52181.cljs$core$IFn$_invoke$arity$0() : fexpr__52181.call(null));
})());
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">",">",-555517146),(function (_,___$1,p__52218,___$2){
var vec__52219 = p__52218;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52219,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">=",">=",-623615505),(function (_,___$1,p__52225,___$2){
var vec__52226 = p__52225;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52226,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<","<",-646864291),(function (_,___$1,p__52229,___$2){
var vec__52230 = p__52229;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52230,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<=","<=",-395636158),(function (_,___$1,p__52233,___$2){
var vec__52234 = p__52233;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52234,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"=","=",1152933628),(function (_,___$1,p__52237,___$2){
var vec__52238 = p__52237;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52238,(0),null);
...
var default$ = (function (){var G__52242 = children;
var G__52242__$1 = (((G__52242 == null))?null:cljs.core.remove.cljs$core$IFn$_invoke$arity$2(malli.core._comp.cljs$core$IFn$_invoke$arity$2(ks,cljs.core.first),G__52242));
var G__52242__$2 = (((G__52242__$1 == null))?null:cljs.core.first(G__52242__$1));
if((G__52242__$2 == null)){
return null;
} else {
return cljs.core.last(G__52242__$2);
}
})();
var map__52241 = default$;
var map__52241__$1 = cljs.core.__destructure_map(map__52241);
var additionalProperties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52241__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392));
var properties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52241__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52241__$1,new cljs.core.Keyword(null,"required","required",1807647006));
...
var object = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),"object",new cljs.core.Keyword(null,"properties","properties",685819552),cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.array_map,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__52244){
var vec__52245 = p__52244;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52245,(0),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52245,(1),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52245,(2),null);
...
var G__52248 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([default$,object], 0));
var G__52248__$1 = ((cljs.core.seq(required))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52248,new cljs.core.Keyword(null,"required","required",1807647006),required):G__52248);
var G__52248__$2 = (cljs.core.truth_(closed)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52248__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),false):G__52248__$1);
if(cljs.core.truth_(default$)){
var G__52249 = G__52248__$2;
var G__52249__$1 = (cljs.core.truth_(additionalProperties_SINGLEQUOTE_)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52249,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),additionalProperties_SINGLEQUOTE_):G__52249);
var G__52249__$2 = (cljs.core.truth_(properties_SINGLEQUOTE_)?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__52249__$1,new cljs.core.Keyword(null,"properties","properties",685819552),cljs.core.merge,properties_SINGLEQUOTE_):G__52249__$1);
if(cljs.core.truth_(required_SINGLEQUOTE_)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__52249__$2,new cljs.core.Keyword(null,"required","required",1807647006),cljs.core.comp.cljs$core$IFn$_invoke$arity$3(cljs.core.vec,cljs.core.distinct,cljs.core.into),required_SINGLEQUOTE_);
} else {
return G__52249__$2;
}
} else {
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var G__52250 = malli.core._infer(children);
if((G__52250 == null)){
return null;
} else {
return (malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2 ? malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2(G__52250,options) : malli.json_schema._transform.call(null,G__52250,options));
}
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"merge","merge",-1804319409),(function (_,schema,___$1,p__52255){
var map__52256 = p__52255;
var map__52256__$1 = cljs.core.__destructure_map(map__52256);
var options = map__52256__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52256__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__52257 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52258 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52257,G__52258) : transform.call(null,G__52257,G__52258));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"union","union",2142937499),(function (_,schema,___$1,p__52259){
var map__52260 = p__52259;
var map__52260__$1 = cljs.core.__destructure_map(map__52260);
var options = map__52260__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52260__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__52261 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52262 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52261,G__52262) : transform.call(null,G__52261,G__52262));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"select-keys","select-keys",1945879180),(function (_,schema,___$1,p__52263){
var map__52264 = p__52263;
var map__52264__$1 = cljs.core.__destructure_map(map__52264);
var options = map__52264__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52264__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__52265 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52266 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52265,G__52266) : transform.call(null,G__52265,G__52266));
}));
...
var G__52274 = malli.json_schema._transform(_QMARK_schema,options__$1);
if(cljs.core.seq(cljs.core.deref(definitions))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52274,new cljs.core.Keyword(null,"definitions","definitions",167529986),cljs.core.deref(definitions));
} else {
return G__52274;
}
}));
