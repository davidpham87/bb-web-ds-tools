...
var malli$json_schema$JsonSchema$_accept$dyn_52374 = (function (this$,children,options){
...
return malli$json_schema$JsonSchema$_accept$dyn_52374(this$,children,options);
}
});
...
malli.json_schema._ref = (function malli$json_schema$_ref(schema,p__52246){
var map__52247 = p__52246;
var map__52247__$1 = cljs.core.__destructure_map(map__52247);
var options = map__52247__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52247__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var definitions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52247__$1,new cljs.core.Keyword("malli.json-schema","definitions","malli.json-schema/definitions",1666750607));
var definitions_path = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52247__$1,new cljs.core.Keyword("malli.json-schema","definitions-path","malli.json-schema/definitions-path",10213173),"#/definitions/");
var ref = (function (){var $ = malli.core._ref(schema);
if(cljs.core.var_QMARK_($)){
var map__52252 = cljs.core.meta($);
var map__52252__$1 = cljs.core.__destructure_map(map__52252);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52252__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52252__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var child_52375 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(definitions,cljs.core.assoc,ref,(transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(child_52375,options) : transform.call(null,child_52375,options)));
}
...
malli.json_schema._schema = (function malli$json_schema$_schema(schema,p__52253){
var map__52254 = p__52253;
var map__52254__$1 = cljs.core.__destructure_map(map__52254);
var options = map__52254__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52254__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
if(cljs.core.truth_(malli.core._ref(schema))){
return malli.json_schema._ref(schema,options);
} else {
var G__52256 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52257 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52256,G__52257) : transform.call(null,G__52256,G__52257));
}
});
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.json-schema","default","malli.json-schema/default",-421449099)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__52259 = cljs.core.get_global_hierarchy;
return (fexpr__52259.cljs$core$IFn$_invoke$arity$0 ? fexpr__52259.cljs$core$IFn$_invoke$arity$0() : fexpr__52259.call(null));
})());
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">",">",-555517146),(function (_,___$1,p__52286,___$2){
var vec__52287 = p__52286;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52287,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">=",">=",-623615505),(function (_,___$1,p__52291,___$2){
var vec__52292 = p__52291;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52292,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<","<",-646864291),(function (_,___$1,p__52297,___$2){
var vec__52298 = p__52297;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52298,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<=","<=",-395636158),(function (_,___$1,p__52301,___$2){
var vec__52302 = p__52301;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52302,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"=","=",1152933628),(function (_,___$1,p__52309,___$2){
var vec__52310 = p__52309;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52310,(0),null);
...
var default$ = (function (){var G__52316 = children;
var G__52316__$1 = (((G__52316 == null))?null:cljs.core.remove.cljs$core$IFn$_invoke$arity$2(malli.core._comp.cljs$core$IFn$_invoke$arity$2(ks,cljs.core.first),G__52316));
var G__52316__$2 = (((G__52316__$1 == null))?null:cljs.core.first(G__52316__$1));
if((G__52316__$2 == null)){
return null;
} else {
return cljs.core.last(G__52316__$2);
}
})();
var map__52315 = default$;
var map__52315__$1 = cljs.core.__destructure_map(map__52315);
var additionalProperties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52315__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392));
var properties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52315__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52315__$1,new cljs.core.Keyword(null,"required","required",1807647006));
...
var G__52326 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([default$,object], 0));
var G__52326__$1 = ((cljs.core.seq(required))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52326,new cljs.core.Keyword(null,"required","required",1807647006),required):G__52326);
var G__52326__$2 = (cljs.core.truth_(closed)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52326__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),false):G__52326__$1);
if(cljs.core.truth_(default$)){
var G__52327 = G__52326__$2;
var G__52327__$1 = (cljs.core.truth_(additionalProperties_SINGLEQUOTE_)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52327,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),additionalProperties_SINGLEQUOTE_):G__52327);
var G__52327__$2 = (cljs.core.truth_(properties_SINGLEQUOTE_)?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__52327__$1,new cljs.core.Keyword(null,"properties","properties",685819552),cljs.core.merge,properties_SINGLEQUOTE_):G__52327__$1);
if(cljs.core.truth_(required_SINGLEQUOTE_)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__52327__$2,new cljs.core.Keyword(null,"required","required",1807647006),cljs.core.comp.cljs$core$IFn$_invoke$arity$3(cljs.core.vec,cljs.core.distinct,cljs.core.into),required_SINGLEQUOTE_);
} else {
return G__52327__$2;
}
} else {
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var G__52332 = malli.core._infer(children);
if((G__52332 == null)){
return null;
} else {
return (malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2 ? malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2(G__52332,options) : malli.json_schema._transform.call(null,G__52332,options));
}
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"merge","merge",-1804319409),(function (_,schema,___$1,p__52345){
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"union","union",2142937499),(function (_,schema,___$1,p__52352){
var map__52353 = p__52352;
var map__52353__$1 = cljs.core.__destructure_map(map__52353);
var options = map__52353__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52353__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__52354 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52355 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52354,G__52355) : transform.call(null,G__52354,G__52355));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"select-keys","select-keys",1945879180),(function (_,schema,___$1,p__52356){
var map__52357 = p__52356;
var map__52357__$1 = cljs.core.__destructure_map(map__52357);
var options = map__52357__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52357__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__52358 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52359 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52358,G__52359) : transform.call(null,G__52358,G__52359));
}));
...
var G__52368 = malli.json_schema._transform(_QMARK_schema,options__$1);
if(cljs.core.seq(cljs.core.deref(definitions))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52368,new cljs.core.Keyword(null,"definitions","definitions",167529986),cljs.core.deref(definitions));
} else {
return G__52368;
}
}));
