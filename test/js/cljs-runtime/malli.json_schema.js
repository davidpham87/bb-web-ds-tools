...
var malli$json_schema$JsonSchema$_accept$dyn_52412 = (function (this$,children,options){
...
return malli$json_schema$JsonSchema$_accept$dyn_52412(this$,children,options);
}
});
...
malli.json_schema._ref = (function malli$json_schema$_ref(schema,p__52302){
var map__52303 = p__52302;
var map__52303__$1 = cljs.core.__destructure_map(map__52303);
var options = map__52303__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52303__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var definitions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52303__$1,new cljs.core.Keyword("malli.json-schema","definitions","malli.json-schema/definitions",1666750607));
var definitions_path = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52303__$1,new cljs.core.Keyword("malli.json-schema","definitions-path","malli.json-schema/definitions-path",10213173),"#/definitions/");
var ref = (function (){var $ = malli.core._ref(schema);
if(cljs.core.var_QMARK_($)){
var map__52305 = cljs.core.meta($);
var map__52305__$1 = cljs.core.__destructure_map(map__52305);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52305__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52305__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var child_52415 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(definitions,cljs.core.assoc,ref,(transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(child_52415,options) : transform.call(null,child_52415,options)));
}
...
malli.json_schema._schema = (function malli$json_schema$_schema(schema,p__52306){
var map__52307 = p__52306;
var map__52307__$1 = cljs.core.__destructure_map(map__52307);
var options = map__52307__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52307__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
if(cljs.core.truth_(malli.core._ref(schema))){
return malli.json_schema._ref(schema,options);
} else {
var G__52308 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52309 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52308,G__52309) : transform.call(null,G__52308,G__52309));
}
});
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.json-schema","default","malli.json-schema/default",-421449099)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__52310 = cljs.core.get_global_hierarchy;
return (fexpr__52310.cljs$core$IFn$_invoke$arity$0 ? fexpr__52310.cljs$core$IFn$_invoke$arity$0() : fexpr__52310.call(null));
})());
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">",">",-555517146),(function (_,___$1,p__52326,___$2){
var vec__52327 = p__52326;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52327,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">=",">=",-623615505),(function (_,___$1,p__52330,___$2){
var vec__52331 = p__52330;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52331,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<","<",-646864291),(function (_,___$1,p__52338,___$2){
var vec__52339 = p__52338;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52339,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<=","<=",-395636158),(function (_,___$1,p__52342,___$2){
var vec__52343 = p__52342;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52343,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"=","=",1152933628),(function (_,___$1,p__52347,___$2){
var vec__52348 = p__52347;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52348,(0),null);
...
var default$ = (function (){var G__52359 = children;
var G__52359__$1 = (((G__52359 == null))?null:cljs.core.remove.cljs$core$IFn$_invoke$arity$2(malli.core._comp.cljs$core$IFn$_invoke$arity$2(ks,cljs.core.first),G__52359));
var G__52359__$2 = (((G__52359__$1 == null))?null:cljs.core.first(G__52359__$1));
if((G__52359__$2 == null)){
return null;
} else {
return cljs.core.last(G__52359__$2);
}
})();
var map__52358 = default$;
var map__52358__$1 = cljs.core.__destructure_map(map__52358);
var additionalProperties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52358__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392));
var properties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52358__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52358__$1,new cljs.core.Keyword(null,"required","required",1807647006));
...
var G__52365 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([default$,object], 0));
var G__52365__$1 = ((cljs.core.seq(required))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52365,new cljs.core.Keyword(null,"required","required",1807647006),required):G__52365);
var G__52365__$2 = (cljs.core.truth_(closed)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52365__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),false):G__52365__$1);
if(cljs.core.truth_(default$)){
var G__52366 = G__52365__$2;
var G__52366__$1 = (cljs.core.truth_(additionalProperties_SINGLEQUOTE_)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52366,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),additionalProperties_SINGLEQUOTE_):G__52366);
var G__52366__$2 = (cljs.core.truth_(properties_SINGLEQUOTE_)?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__52366__$1,new cljs.core.Keyword(null,"properties","properties",685819552),cljs.core.merge,properties_SINGLEQUOTE_):G__52366__$1);
if(cljs.core.truth_(required_SINGLEQUOTE_)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__52366__$2,new cljs.core.Keyword(null,"required","required",1807647006),cljs.core.comp.cljs$core$IFn$_invoke$arity$3(cljs.core.vec,cljs.core.distinct,cljs.core.into),required_SINGLEQUOTE_);
} else {
return G__52366__$2;
}
} else {
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var G__52368 = malli.core._infer(children);
if((G__52368 == null)){
return null;
} else {
return (malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2 ? malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2(G__52368,options) : malli.json_schema._transform.call(null,G__52368,options));
}
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"merge","merge",-1804319409),(function (_,schema,___$1,p__52388){
var map__52389 = p__52388;
var map__52389__$1 = cljs.core.__destructure_map(map__52389);
var options = map__52389__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52389__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__52391 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52392 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52391,G__52392) : transform.call(null,G__52391,G__52392));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"union","union",2142937499),(function (_,schema,___$1,p__52393){
var map__52394 = p__52393;
var map__52394__$1 = cljs.core.__destructure_map(map__52394);
var options = map__52394__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52394__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__52395 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52396 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52395,G__52396) : transform.call(null,G__52395,G__52396));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"select-keys","select-keys",1945879180),(function (_,schema,___$1,p__52397){
var map__52398 = p__52397;
var map__52398__$1 = cljs.core.__destructure_map(map__52398);
var options = map__52398__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52398__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__52399 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52400 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52399,G__52400) : transform.call(null,G__52399,G__52400));
}));
...
var G__52409 = malli.json_schema._transform(_QMARK_schema,options__$1);
if(cljs.core.seq(cljs.core.deref(definitions))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52409,new cljs.core.Keyword(null,"definitions","definitions",167529986),cljs.core.deref(definitions));
} else {
return G__52409;
}
}));
