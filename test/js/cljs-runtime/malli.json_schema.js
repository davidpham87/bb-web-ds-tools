...
var malli$json_schema$JsonSchema$_accept$dyn_59733 = (function (this$,children,options){
...
return malli$json_schema$JsonSchema$_accept$dyn_59733(this$,children,options);
}
});
...
malli.json_schema._ref = (function malli$json_schema$_ref(schema,p__59606){
var map__59608 = p__59606;
var map__59608__$1 = cljs.core.__destructure_map(map__59608);
var options = map__59608__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59608__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var definitions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59608__$1,new cljs.core.Keyword("malli.json-schema","definitions","malli.json-schema/definitions",1666750607));
var definitions_path = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__59608__$1,new cljs.core.Keyword("malli.json-schema","definitions-path","malli.json-schema/definitions-path",10213173),"#/definitions/");
var ref = (function (){var $ = malli.core._ref(schema);
if(cljs.core.var_QMARK_($)){
var map__59610 = cljs.core.meta($);
var map__59610__$1 = cljs.core.__destructure_map(map__59610);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59610__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59610__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var child_59735 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(definitions,cljs.core.assoc,ref,(transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(child_59735,options) : transform.call(null,child_59735,options)));
}
...
malli.json_schema._schema = (function malli$json_schema$_schema(schema,p__59612){
var map__59613 = p__59612;
var map__59613__$1 = cljs.core.__destructure_map(map__59613);
var options = map__59613__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59613__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
if(cljs.core.truth_(malli.core._ref(schema))){
return malli.json_schema._ref(schema,options);
} else {
var G__59615 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__59616 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__59615,G__59616) : transform.call(null,G__59615,G__59616));
}
});
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.json-schema","default","malli.json-schema/default",-421449099)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__59623 = cljs.core.get_global_hierarchy;
return (fexpr__59623.cljs$core$IFn$_invoke$arity$0 ? fexpr__59623.cljs$core$IFn$_invoke$arity$0() : fexpr__59623.call(null));
})());
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">",">",-555517146),(function (_,___$1,p__59639,___$2){
var vec__59640 = p__59639;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59640,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">=",">=",-623615505),(function (_,___$1,p__59643,___$2){
var vec__59644 = p__59643;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59644,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<","<",-646864291),(function (_,___$1,p__59648,___$2){
var vec__59649 = p__59648;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59649,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<=","<=",-395636158),(function (_,___$1,p__59652,___$2){
var vec__59653 = p__59652;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59653,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"=","=",1152933628),(function (_,___$1,p__59656,___$2){
var vec__59657 = p__59656;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59657,(0),null);
...
var default$ = (function (){var G__59661 = children;
var G__59661__$1 = (((G__59661 == null))?null:cljs.core.remove.cljs$core$IFn$_invoke$arity$2(malli.core._comp.cljs$core$IFn$_invoke$arity$2(ks,cljs.core.first),G__59661));
var G__59661__$2 = (((G__59661__$1 == null))?null:cljs.core.first(G__59661__$1));
if((G__59661__$2 == null)){
return null;
} else {
return cljs.core.last(G__59661__$2);
}
})();
var map__59660 = default$;
var map__59660__$1 = cljs.core.__destructure_map(map__59660);
var additionalProperties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59660__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392));
var properties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59660__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59660__$1,new cljs.core.Keyword(null,"required","required",1807647006));
...
var object = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),"object",new cljs.core.Keyword(null,"properties","properties",685819552),cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.array_map,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__59662){
var vec__59664 = p__59662;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59664,(0),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59664,(1),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59664,(2),null);
...
var G__59668 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([default$,object], 0));
var G__59668__$1 = ((cljs.core.seq(required))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__59668,new cljs.core.Keyword(null,"required","required",1807647006),required):G__59668);
var G__59668__$2 = (cljs.core.truth_(closed)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__59668__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),false):G__59668__$1);
if(cljs.core.truth_(default$)){
var G__59670 = G__59668__$2;
var G__59670__$1 = (cljs.core.truth_(additionalProperties_SINGLEQUOTE_)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__59670,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),additionalProperties_SINGLEQUOTE_):G__59670);
var G__59670__$2 = (cljs.core.truth_(properties_SINGLEQUOTE_)?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__59670__$1,new cljs.core.Keyword(null,"properties","properties",685819552),cljs.core.merge,properties_SINGLEQUOTE_):G__59670__$1);
if(cljs.core.truth_(required_SINGLEQUOTE_)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__59670__$2,new cljs.core.Keyword(null,"required","required",1807647006),cljs.core.comp.cljs$core$IFn$_invoke$arity$3(cljs.core.vec,cljs.core.distinct,cljs.core.into),required_SINGLEQUOTE_);
} else {
return G__59670__$2;
}
} else {
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var G__59678 = malli.core._infer(children);
if((G__59678 == null)){
return null;
} else {
return (malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2 ? malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2(G__59678,options) : malli.json_schema._transform.call(null,G__59678,options));
}
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"merge","merge",-1804319409),(function (_,schema,___$1,p__59705){
var map__59706 = p__59705;
var map__59706__$1 = cljs.core.__destructure_map(map__59706);
var options = map__59706__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59706__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__59708 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__59709 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__59708,G__59709) : transform.call(null,G__59708,G__59709));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"union","union",2142937499),(function (_,schema,___$1,p__59710){
var map__59711 = p__59710;
var map__59711__$1 = cljs.core.__destructure_map(map__59711);
var options = map__59711__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59711__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__59712 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__59713 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__59712,G__59713) : transform.call(null,G__59712,G__59713));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"select-keys","select-keys",1945879180),(function (_,schema,___$1,p__59717){
var map__59718 = p__59717;
var map__59718__$1 = cljs.core.__destructure_map(map__59718);
var options = map__59718__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59718__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__59720 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__59722 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__59720,G__59722) : transform.call(null,G__59720,G__59722));
}));
...
var G__59731 = malli.json_schema._transform(_QMARK_schema,options__$1);
if(cljs.core.seq(cljs.core.deref(definitions))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__59731,new cljs.core.Keyword(null,"definitions","definitions",167529986),cljs.core.deref(definitions));
} else {
return G__59731;
}
}));
