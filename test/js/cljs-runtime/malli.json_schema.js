...
var malli$json_schema$JsonSchema$_accept$dyn_52494 = (function (this$,children,options){
...
return malli$json_schema$JsonSchema$_accept$dyn_52494(this$,children,options);
}
});
...
malli.json_schema._ref = (function malli$json_schema$_ref(schema,p__52378){
var map__52379 = p__52378;
var map__52379__$1 = cljs.core.__destructure_map(map__52379);
var options = map__52379__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52379__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var definitions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52379__$1,new cljs.core.Keyword("malli.json-schema","definitions","malli.json-schema/definitions",1666750607));
var definitions_path = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52379__$1,new cljs.core.Keyword("malli.json-schema","definitions-path","malli.json-schema/definitions-path",10213173),"#/definitions/");
var ref = (function (){var $ = malli.core._ref(schema);
if(cljs.core.var_QMARK_($)){
var map__52380 = cljs.core.meta($);
var map__52380__$1 = cljs.core.__destructure_map(map__52380);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52380__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52380__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var child_52496 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(definitions,cljs.core.assoc,ref,(transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(child_52496,options) : transform.call(null,child_52496,options)));
}
...
malli.json_schema._schema = (function malli$json_schema$_schema(schema,p__52381){
var map__52382 = p__52381;
var map__52382__$1 = cljs.core.__destructure_map(map__52382);
var options = map__52382__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52382__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
if(cljs.core.truth_(malli.core._ref(schema))){
return malli.json_schema._ref(schema,options);
} else {
var G__52383 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52384 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52383,G__52384) : transform.call(null,G__52383,G__52384));
}
});
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.json-schema","default","malli.json-schema/default",-421449099)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__52385 = cljs.core.get_global_hierarchy;
return (fexpr__52385.cljs$core$IFn$_invoke$arity$0 ? fexpr__52385.cljs$core$IFn$_invoke$arity$0() : fexpr__52385.call(null));
})());
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">",">",-555517146),(function (_,___$1,p__52409,___$2){
var vec__52410 = p__52409;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52410,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">=",">=",-623615505),(function (_,___$1,p__52413,___$2){
var vec__52414 = p__52413;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52414,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<","<",-646864291),(function (_,___$1,p__52417,___$2){
var vec__52418 = p__52417;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52418,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<=","<=",-395636158),(function (_,___$1,p__52425,___$2){
var vec__52426 = p__52425;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52426,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"=","=",1152933628),(function (_,___$1,p__52429,___$2){
var vec__52431 = p__52429;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52431,(0),null);
...
var default$ = (function (){var G__52439 = children;
var G__52439__$1 = (((G__52439 == null))?null:cljs.core.remove.cljs$core$IFn$_invoke$arity$2(malli.core._comp.cljs$core$IFn$_invoke$arity$2(ks,cljs.core.first),G__52439));
var G__52439__$2 = (((G__52439__$1 == null))?null:cljs.core.first(G__52439__$1));
if((G__52439__$2 == null)){
return null;
} else {
return cljs.core.last(G__52439__$2);
}
})();
var map__52437 = default$;
var map__52437__$1 = cljs.core.__destructure_map(map__52437);
var additionalProperties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52437__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392));
var properties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52437__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52437__$1,new cljs.core.Keyword(null,"required","required",1807647006));
...
var G__52445 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([default$,object], 0));
var G__52445__$1 = ((cljs.core.seq(required))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52445,new cljs.core.Keyword(null,"required","required",1807647006),required):G__52445);
var G__52445__$2 = (cljs.core.truth_(closed)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52445__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),false):G__52445__$1);
if(cljs.core.truth_(default$)){
var G__52447 = G__52445__$2;
var G__52447__$1 = (cljs.core.truth_(additionalProperties_SINGLEQUOTE_)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52447,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),additionalProperties_SINGLEQUOTE_):G__52447);
var G__52447__$2 = (cljs.core.truth_(properties_SINGLEQUOTE_)?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__52447__$1,new cljs.core.Keyword(null,"properties","properties",685819552),cljs.core.merge,properties_SINGLEQUOTE_):G__52447__$1);
if(cljs.core.truth_(required_SINGLEQUOTE_)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__52447__$2,new cljs.core.Keyword(null,"required","required",1807647006),cljs.core.comp.cljs$core$IFn$_invoke$arity$3(cljs.core.vec,cljs.core.distinct,cljs.core.into),required_SINGLEQUOTE_);
} else {
return G__52447__$2;
}
} else {
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var G__52452 = malli.core._infer(children);
if((G__52452 == null)){
return null;
} else {
return (malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2 ? malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2(G__52452,options) : malli.json_schema._transform.call(null,G__52452,options));
}
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"merge","merge",-1804319409),(function (_,schema,___$1,p__52460){
var map__52461 = p__52460;
var map__52461__$1 = cljs.core.__destructure_map(map__52461);
var options = map__52461__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52461__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__52462 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52463 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52462,G__52463) : transform.call(null,G__52462,G__52463));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"union","union",2142937499),(function (_,schema,___$1,p__52467){
var map__52468 = p__52467;
var map__52468__$1 = cljs.core.__destructure_map(map__52468);
var options = map__52468__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52468__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__52469 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52470 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52469,G__52470) : transform.call(null,G__52469,G__52470));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"select-keys","select-keys",1945879180),(function (_,schema,___$1,p__52472){
var map__52473 = p__52472;
var map__52473__$1 = cljs.core.__destructure_map(map__52473);
var options = map__52473__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52473__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__52474 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52475 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52474,G__52475) : transform.call(null,G__52474,G__52475));
}));
...
var G__52490 = malli.json_schema._transform(_QMARK_schema,options__$1);
if(cljs.core.seq(cljs.core.deref(definitions))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52490,new cljs.core.Keyword(null,"definitions","definitions",167529986),cljs.core.deref(definitions));
} else {
return G__52490;
}
}));
