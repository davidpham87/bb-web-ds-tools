...
var malli$json_schema$JsonSchema$_accept$dyn_52298 = (function (this$,children,options){
...
return malli$json_schema$JsonSchema$_accept$dyn_52298(this$,children,options);
}
});
...
malli.json_schema._ref = (function malli$json_schema$_ref(schema,p__52165){
var map__52166 = p__52165;
var map__52166__$1 = cljs.core.__destructure_map(map__52166);
var options = map__52166__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52166__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var definitions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52166__$1,new cljs.core.Keyword("malli.json-schema","definitions","malli.json-schema/definitions",1666750607));
var definitions_path = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52166__$1,new cljs.core.Keyword("malli.json-schema","definitions-path","malli.json-schema/definitions-path",10213173),"#/definitions/");
var ref = (function (){var $ = malli.core._ref(schema);
if(cljs.core.var_QMARK_($)){
var map__52167 = cljs.core.meta($);
var map__52167__$1 = cljs.core.__destructure_map(map__52167);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52167__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52167__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var child_52303 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(definitions,cljs.core.assoc,ref,(transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(child_52303,options) : transform.call(null,child_52303,options)));
}
...
malli.json_schema._schema = (function malli$json_schema$_schema(schema,p__52174){
var map__52175 = p__52174;
var map__52175__$1 = cljs.core.__destructure_map(map__52175);
var options = map__52175__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52175__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
if(cljs.core.truth_(malli.core._ref(schema))){
return malli.json_schema._ref(schema,options);
} else {
var G__52176 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52177 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52176,G__52177) : transform.call(null,G__52176,G__52177));
}
});
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.json-schema","default","malli.json-schema/default",-421449099)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__52180 = cljs.core.get_global_hierarchy;
return (fexpr__52180.cljs$core$IFn$_invoke$arity$0 ? fexpr__52180.cljs$core$IFn$_invoke$arity$0() : fexpr__52180.call(null));
})());
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">",">",-555517146),(function (_,___$1,p__52217,___$2){
var vec__52218 = p__52217;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52218,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">=",">=",-623615505),(function (_,___$1,p__52224,___$2){
var vec__52225 = p__52224;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52225,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<","<",-646864291),(function (_,___$1,p__52228,___$2){
var vec__52229 = p__52228;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52229,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<=","<=",-395636158),(function (_,___$1,p__52232,___$2){
var vec__52233 = p__52232;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52233,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"=","=",1152933628),(function (_,___$1,p__52239,___$2){
var vec__52240 = p__52239;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52240,(0),null);
...
var default$ = (function (){var G__52248 = children;
var G__52248__$1 = (((G__52248 == null))?null:cljs.core.remove.cljs$core$IFn$_invoke$arity$2(malli.core._comp.cljs$core$IFn$_invoke$arity$2(ks,cljs.core.first),G__52248));
var G__52248__$2 = (((G__52248__$1 == null))?null:cljs.core.first(G__52248__$1));
if((G__52248__$2 == null)){
return null;
} else {
return cljs.core.last(G__52248__$2);
}
})();
var map__52247 = default$;
var map__52247__$1 = cljs.core.__destructure_map(map__52247);
var additionalProperties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52247__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392));
var properties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52247__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52247__$1,new cljs.core.Keyword(null,"required","required",1807647006));
...
var G__52254 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([default$,object], 0));
var G__52254__$1 = ((cljs.core.seq(required))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52254,new cljs.core.Keyword(null,"required","required",1807647006),required):G__52254);
var G__52254__$2 = (cljs.core.truth_(closed)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52254__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),false):G__52254__$1);
if(cljs.core.truth_(default$)){
var G__52255 = G__52254__$2;
var G__52255__$1 = (cljs.core.truth_(additionalProperties_SINGLEQUOTE_)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52255,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),additionalProperties_SINGLEQUOTE_):G__52255);
var G__52255__$2 = (cljs.core.truth_(properties_SINGLEQUOTE_)?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__52255__$1,new cljs.core.Keyword(null,"properties","properties",685819552),cljs.core.merge,properties_SINGLEQUOTE_):G__52255__$1);
if(cljs.core.truth_(required_SINGLEQUOTE_)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__52255__$2,new cljs.core.Keyword(null,"required","required",1807647006),cljs.core.comp.cljs$core$IFn$_invoke$arity$3(cljs.core.vec,cljs.core.distinct,cljs.core.into),required_SINGLEQUOTE_);
} else {
return G__52255__$2;
}
} else {
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var G__52258 = malli.core._infer(children);
if((G__52258 == null)){
return null;
} else {
return (malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2 ? malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2(G__52258,options) : malli.json_schema._transform.call(null,G__52258,options));
}
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"merge","merge",-1804319409),(function (_,schema,___$1,p__52272){
var map__52274 = p__52272;
var map__52274__$1 = cljs.core.__destructure_map(map__52274);
var options = map__52274__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52274__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__52275 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52276 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52275,G__52276) : transform.call(null,G__52275,G__52276));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"union","union",2142937499),(function (_,schema,___$1,p__52277){
var map__52278 = p__52277;
var map__52278__$1 = cljs.core.__destructure_map(map__52278);
var options = map__52278__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52278__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__52280 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52281 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52280,G__52281) : transform.call(null,G__52280,G__52281));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"select-keys","select-keys",1945879180),(function (_,schema,___$1,p__52284){
var map__52285 = p__52284;
var map__52285__$1 = cljs.core.__destructure_map(map__52285);
var options = map__52285__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52285__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__52286 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__52287 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__52286,G__52287) : transform.call(null,G__52286,G__52287));
}));
...
var G__52294 = malli.json_schema._transform(_QMARK_schema,options__$1);
if(cljs.core.seq(cljs.core.deref(definitions))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52294,new cljs.core.Keyword(null,"definitions","definitions",167529986),cljs.core.deref(definitions));
} else {
return G__52294;
}
}));
