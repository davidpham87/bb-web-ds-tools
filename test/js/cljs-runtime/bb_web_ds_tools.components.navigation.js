...
var with_let28763 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let28763","with-let28763",-978326356));
var temp__5829__auto___28783 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5829__auto___28783 == null)){
} else {
var c__23511__auto___28784 = temp__5829__auto___28783;
if((with_let28763.generation === c__23511__auto___28784.ratomGeneration)){
...
(with_let28763.generation = c__23511__auto___28784.ratomGeneration);
}

var init28764 = (with_let28763.length === (0));
var open_QMARK_ = ((((init28764) || (cljs.core.not(with_let28763.hasOwnProperty((0))))))?(with_let28763[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false)):(with_let28763[(0)]));
var close_fn = ((((init28764) || (cljs.core.not(with_let28763.hasOwnProperty((1))))))?(with_let28763[(1)] = (function (){
...
while(true){
if((i__5750__auto___28787 < len__5749__auto___28786)){
args__5755__auto__.push((arguments[i__5750__auto___28787]));

var G__28788 = (i__5750__auto___28787 + (1));
i__5750__auto___28787 = G__28788;
continue;
} else {
}
break;
 ...
 *  vector: A hiccup vector.
 */
bb_web_ds_tools.components.navigation.top_bar = (function bb_web_ds_tools$components$navigation$top_bar(p__28781){
var map__28782 = p__28781;
var map__28782__$1 = cljs.core.__destructure_map(map__28782);
var active_label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28782__$1,new cljs.core.Keyword(null,"active-label","active-label",1965964916));
