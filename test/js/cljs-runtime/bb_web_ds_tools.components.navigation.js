...
var with_let28715 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let28715","with-let28715",257726649));
var temp__5829__auto___28736 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5829__auto___28736 == null)){
} else {
var c__23639__auto___28737 = temp__5829__auto___28736;
if((with_let28715.generation === c__23639__auto___28737.ratomGeneration)){
...
(with_let28715.generation = c__23639__auto___28737.ratomGeneration);
}

var init28716 = (with_let28715.length === (0));
var open_QMARK_ = ((((init28716) || (cljs.core.not(with_let28715.hasOwnProperty((0))))))?(with_let28715[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false)):(with_let28715[(0)]));
var close_fn = ((((init28716) || (cljs.core.not(with_let28715.hasOwnProperty((1))))))?(with_let28715[(1)] = (function (){
return cljs.core.reset_BANG_(open_QMARK_,false);
})):(with_let28715[(1)]));
var res28717 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"relative"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["p-2 rounded hover:bg-white/10 transition-colors ",bb_web_ds_tools.theme.text_primary].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
...
var len__5749__auto___28753 = arguments.length;
var i__5750__auto___28754 = (0);
while(true){
if((i__5750__auto___28754 < len__5749__auto___28753)){
args__5755__auto__.push((arguments[i__5750__auto___28754]));

var G__28755 = (i__5750__auto___28754 + (1));
i__5750__auto___28754 = G__28755;
continue;
} else {
}
break;
...
/** @this {Function} */
(bb_web_ds_tools.components.navigation.portal_to_top_bar.cljs$lang$applyTo = (function (seq28729){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq28729));
}));
...
var active_label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28735__$1,new cljs.core.Keyword(null,"active-label","active-label",1965964916));
