...
var with_let28810 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let28810","with-let28810",-1423611788));
var temp__5829__auto___28831 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5829__auto___28831 == null)){
} else {
var c__23811__auto___28832 = temp__5829__auto___28831;
if((with_let28810.generation === c__23811__auto___28832.ratomGeneration)){
...
(with_let28810.generation = c__23811__auto___28832.ratomGeneration);
}

var init28811 = (with_let28810.length === (0));
var open_QMARK_ = ((((init28811) || (cljs.core.not(with_let28810.hasOwnProperty((0))))))?(with_let28810[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false)):(with_let28810[(0)]));
var close_fn = ((((init28811) || (cljs.core.not(with_let28810.hasOwnProperty((1))))))?(with_let28810[(1)] = (function (){
 ...
 *  vector: A hiccup vector.
 */
bb_web_ds_tools.components.navigation.top_bar = (function bb_web_ds_tools$components$navigation$top_bar(p__28829){
var map__28830 = p__28829;
var map__28830__$1 = cljs.core.__destructure_map(map__28830);
var active_label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28830__$1,new cljs.core.Keyword(null,"active-label","active-label",1965964916));
