...
var with_let28712 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let28712","with-let28712",1865049326));
var temp__5829__auto___28750 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5829__auto___28750 == null)){
} else {
var c__23539__auto___28751 = temp__5829__auto___28750;
if((with_let28712.generation === c__23539__auto___28751.ratomGeneration)){
...
(with_let28712.generation = c__23539__auto___28751.ratomGeneration);
}

var init28713 = (with_let28712.length === (0));
var open_QMARK_ = ((((init28713) || (cljs.core.not(with_let28712.hasOwnProperty((0))))))?(with_let28712[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false)):(with_let28712[(0)]));
var close_fn = ((((init28713) || (cljs.core.not(with_let28712.hasOwnProperty((1))))))?(with_let28712[(1)] = (function (){
return cljs.core.reset_BANG_(open_QMARK_,false);
})):(with_let28712[(1)]));
var res28714 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"relative"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["p-2 rounded hover:bg-white/10 transition-colors ",bb_web_ds_tools.theme.text_primary].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
...
var len__5749__auto___28758 = arguments.length;
var i__5750__auto___28759 = (0);
while(true){
if((i__5750__auto___28759 < len__5749__auto___28758)){
args__5755__auto__.push((arguments[i__5750__auto___28759]));

var G__28760 = (i__5750__auto___28759 + (1));
i__5750__auto___28759 = G__28760;
continue;
} else {
}
break;
 ...
 *  vector: A hiccup vector.
 */
bb_web_ds_tools.components.navigation.top_bar = (function bb_web_ds_tools$components$navigation$top_bar(p__28748){
var map__28749 = p__28748;
var map__28749__$1 = cljs.core.__destructure_map(map__28749);
var active_label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28749__$1,new cljs.core.Keyword(null,"active-label","active-label",1965964916));
