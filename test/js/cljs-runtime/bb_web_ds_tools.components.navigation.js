...
var c__23512__auto___28749 = temp__5829__auto___28748;
if((with_let28710.generation === c__23512__auto___28749.ratomGeneration)){
...
(with_let28710.generation = c__23512__auto___28749.ratomGeneration);
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28717),bb_web_ds_tools$components$navigation$menu_button_$_iter__28714(cljs.core.chunk_rest(s__28715__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28717),null);
}
} else {
var item = cljs.core.first(s__28715__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"href","href",-793805698),reitit.frontend.easy.href.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"route","route",329891309).cljs$core$IFn$_invoke$arity$1(item)),new cljs.core.Keyword(null,"class","class",-2030961996),["block px-4 py-2 text-sm ",bb_web_ds_tools.theme.text_primary," hover:bg-white/5 flex items-center gap-2"].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),close_fn], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.Keyword(null,"icon","icon",1679606541).cljs$core$IFn$_invoke$arity$1(item)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.Keyword(null,"label","label",1718410804).cljs$core$IFn$_invoke$arity$1(item)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"route","route",329891309).cljs$core$IFn$_invoke$arity$1(item)], null)),bb_web_ds_tools$components$navigation$menu_button_$_iter__28714(cljs.core.rest(s__28715__$2)));
}
} else {
return null;
}
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.components.navigation","set-top-bar-ref","bb-web-ds-tools.components.navigation/set-top-bar-ref",1693658101),(function (db,p__28723){
var vec__28724 = p__28723;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28724,(0),null);
var ref = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28724,(1),null);
 ...
 *  vector: A hiccup vector.
 */
bb_web_ds_tools.components.navigation.top_bar = (function bb_web_ds_tools$components$navigation$top_bar(p__28746){
var map__28747 = p__28746;
var map__28747__$1 = cljs.core.__destructure_map(map__28747);
var active_label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28747__$1,new cljs.core.Keyword(null,"active-label","active-label",1965964916));
