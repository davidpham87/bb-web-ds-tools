...
var with_let28796 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let28796","with-let28796",-1700958116));
var temp__5829__auto___28815 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5829__auto___28815 == null)){
} else {
var c__23430__auto___28816 = temp__5829__auto___28815;
if((with_let28796.generation === c__23430__auto___28816.ratomGeneration)){
...
(with_let28796.generation = c__23430__auto___28816.ratomGeneration);
}

var init28797 = (with_let28796.length === (0));
var open_QMARK_ = ((((init28797) || (cljs.core.not(with_let28796.hasOwnProperty((0))))))?(with_let28796[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false)):(with_let28796[(0)]));
var close_fn = ((((init28797) || (cljs.core.not(with_let28796.hasOwnProperty((1))))))?(with_let28796[(1)] = (function (){
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.components.navigation","set-top-bar-ref","bb-web-ds-tools.components.navigation/set-top-bar-ref",1693658101),(function (db,p__28803){
var vec__28804 = p__28803;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28804,(0),null);
var ref = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28804,(1),null);
...
var len__5749__auto___28820 = arguments.length;
var i__5750__auto___28821 = (0);
while(true){
if((i__5750__auto___28821 < len__5749__auto___28820)){
args__5755__auto__.push((arguments[i__5750__auto___28821]));

var G__28822 = (i__5750__auto___28821 + (1));
i__5750__auto___28821 = G__28822;
continue;
} else {
}
break;
...
/** @this {Function} */
(bb_web_ds_tools.components.navigation.portal_to_top_bar.cljs$lang$applyTo = (function (seq28807){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq28807));
}));
 ...
 *  vector: A hiccup vector.
 */
bb_web_ds_tools.components.navigation.top_bar = (function bb_web_ds_tools$components$navigation$top_bar(p__28810){
var map__28811 = p__28810;
var map__28811__$1 = cljs.core.__destructure_map(map__28811);
var active_label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28811__$1,new cljs.core.Keyword(null,"active-label","active-label",1965964916));
