...
var with_let28767 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let28767","with-let28767",-1050847266));
var temp__5829__auto___28808 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5829__auto___28808 == null)){
} else {
var c__23442__auto___28809 = temp__5829__auto___28808;
if((with_let28767.generation === c__23442__auto___28809.ratomGeneration)){
...
(with_let28767.generation = c__23442__auto___28809.ratomGeneration);
}

var init28768 = (with_let28767.length === (0));
var open_QMARK_ = ((((init28768) || (cljs.core.not(with_let28767.hasOwnProperty((0))))))?(with_let28767[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false)):(with_let28767[(0)]));
var close_fn = ((((init28768) || (cljs.core.not(with_let28767.hasOwnProperty((1))))))?(with_let28767[(1)] = (function (){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28781),bb_web_ds_tools$components$navigation$menu_button_$_iter__28778(cljs.core.chunk_rest(s__28779__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28781),null);
}
} else {
var item = cljs.core.first(s__28779__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"href","href",-793805698),reitit.frontend.easy.href.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"route","route",329891309).cljs$core$IFn$_invoke$arity$1(item)),new cljs.core.Keyword(null,"class","class",-2030961996),["block px-4 py-2 text-sm ",bb_web_ds_tools.theme.text_primary," hover:bg-white/5 flex items-center gap-2"].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),close_fn], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.Keyword(null,"icon","icon",1679606541).cljs$core$IFn$_invoke$arity$1(item)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.Keyword(null,"label","label",1718410804).cljs$core$IFn$_invoke$arity$1(item)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"route","route",329891309).cljs$core$IFn$_invoke$arity$1(item)], null)),bb_web_ds_tools$components$navigation$menu_button_$_iter__28778(cljs.core.rest(s__28779__$2)));
}
} else {
return null;
}
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.components.navigation","set-top-bar-ref","bb-web-ds-tools.components.navigation/set-top-bar-ref",1693658101),(function (db,p__28788){
var vec__28789 = p__28788;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28789,(0),null);
var ref = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28789,(1),null);
...
var len__5749__auto___28817 = arguments.length;
var i__5750__auto___28818 = (0);
while(true){
if((i__5750__auto___28818 < len__5749__auto___28817)){
args__5755__auto__.push((arguments[i__5750__auto___28818]));

var G__28819 = (i__5750__auto___28818 + (1));
i__5750__auto___28818 = G__28819;
continue;
} else {
}
break;
...
/** @this {Function} */
(bb_web_ds_tools.components.navigation.portal_to_top_bar.cljs$lang$applyTo = (function (seq28792){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq28792));
}));
 ...
 *  vector: A hiccup vector.
 */
bb_web_ds_tools.components.navigation.top_bar = (function bb_web_ds_tools$components$navigation$top_bar(p__28798){
var map__28801 = p__28798;
var map__28801__$1 = cljs.core.__destructure_map(map__28801);
var active_label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28801__$1,new cljs.core.Keyword(null,"active-label","active-label",1965964916));
