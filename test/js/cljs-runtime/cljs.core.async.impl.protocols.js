...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30804 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30804(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30805 = (function (port,val,fn1_handler){
var x__5373__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30805(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30806 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30806(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30807 = (function (chan){
var x__5373__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30807(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30808 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30808(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30809 = (function (h){
var x__5373__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30809(h);
}
});
