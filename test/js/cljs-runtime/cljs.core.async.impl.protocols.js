...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30794 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30794(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30795 = (function (port,val,fn1_handler){
var x__5373__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30795(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30799 = (function (chan){
var x__5373__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30799(chan);
}
});
