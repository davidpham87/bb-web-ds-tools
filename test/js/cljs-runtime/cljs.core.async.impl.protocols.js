...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30792 = (function (port,val,fn1_handler){
var x__5373__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30792(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30796 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30796(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30801 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30801(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30804 = (function (h){
var x__5373__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30804(h);
}
});
