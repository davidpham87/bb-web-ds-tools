...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30868 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30868(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30869 = (function (port,val,fn1_handler){
var x__5373__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30869(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30870 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30870(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30871 = (function (chan){
var x__5373__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30871(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30872 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30872(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30873 = (function (h){
var x__5373__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30873(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_30875 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_30875(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_30876 = (function (b){
var x__5373__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_30876(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_30877 = (function (b,itm){
var x__5373__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_30877(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_30878 = (function (b){
var x__5373__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_30878(b);
}
});
