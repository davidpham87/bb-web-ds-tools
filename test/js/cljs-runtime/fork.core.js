...
fork.core.initialize_state = (function fork$core$initialize_state(p__43142){
var map__43143 = p__43142;
var map__43143__$1 = cljs.core.__destructure_map(map__43143);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43143__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var keywordize_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43143__$1,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252));
var initial_values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43143__$1,new cljs.core.Keyword(null,"initial-values","initial-values",1392120293));
var initial_touched = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43143__$1,new cljs.core.Keyword(null,"initial-touched","initial-touched",-1887894494));
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,(function (p1__43158_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$4(p1__43158_SHARP_,new cljs.core.Keyword(null,"values","values",372645556),cljs.core.merge,new_values),new cljs.core.Keyword(null,"touched","touched",-609134419),(function (x,y){
...
return cljs.core.not_empty(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__43177){
var vec__43178 = p__43177;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43178,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43178,(1),null);
...
var len__5749__auto___43279 = arguments.length;
var i__5750__auto___43280 = (0);
while(true){
if((i__5750__auto___43280 < len__5749__auto___43279)){
args__5755__auto__.push((arguments[i__5750__auto___43280]));

var G__43281 = (i__5750__auto___43280 + (1));
i__5750__auto___43280 = G__43281;
continue;
} else {
}
break;
...
(fork.core.disable.cljs$core$IFn$_invoke$arity$variadic = (function (state,p__43189){
var vec__43190 = p__43189;
var ks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43190,(0),null);
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.update,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181),(function (p1__43185_SHARP_){
return fork.core.disable_logic(p1__43185_SHARP_,ks);
}));
}));
...
/** @this {Function} */
(fork.core.disable.cljs$lang$applyTo = (function (seq43186){
var G__43187 = cljs.core.first(seq43186);
var seq43186__$1 = cljs.core.next(seq43186);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43187,seq43186__$1);
}));
...
var G__43289 = (i__5750__auto___43283 + (1));
i__5750__auto___43283 = G__43289;
continue;
} else {
}
break;
...
(fork.core.enable.cljs$core$IFn$_invoke$arity$variadic = (function (state,p__43199){
var vec__43200 = p__43199;
var ks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43200,(0),null);
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.update,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181),(function (p1__43194_SHARP_){
return fork.core.enable_logic(p1__43194_SHARP_,ks);
}));
}));
...
/** @this {Function} */
(fork.core.enable.cljs$lang$applyTo = (function (seq43195){
var G__43196 = cljs.core.first(seq43195);
var seq43195__$1 = cljs.core.next(seq43195);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43196,seq43195__$1);
}));
...
fork.core.set_handle_change_one = (function fork$core$set_handle_change_one(deref_state,p__43212){
var map__43213 = p__43212;
var map__43213__$1 = cljs.core.__destructure_map(map__43213);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43213__$1,new cljs.core.Keyword(null,"value","value",305978217));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43213__$1,new cljs.core.Keyword(null,"path","path",-188191168));
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,(function (p1__43216_SHARP_){
return fork.core.set_handle_change_one(p1__43216_SHARP_,params);
}));
} else {
...
fork.core.set_handle_blur = (function fork$core$set_handle_blur(p__43223,state){
...
var vec__43227 = cljs.core.last(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__43226_SHARP_,p2__43225_SHARP_){
if(typeof p2__43225_SHARP_ === 'number'){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__43226_SHARP_,p2__43225_SHARP_], null);
} else {
return null;
}
}),touched_el)));
var position = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43227,(0),null);
var curr_idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43227,(1),null);
if((curr_idx > idx)){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(s,cljs.core.cons(new cljs.core.Keyword(null,"values","values",372645556),vec_field_array_key),fork.core.vec_remove,idx),new cljs.core.Keyword(null,"touched","touched",-609134419),(function (p1__43230_SHARP_){
return fork.core.fieldarray_update_touched(p1__43230_SHARP_,vec_field_array_key,idx);
}));
}));
});
...
fork.core.handle_submit = (function fork$core$handle_submit(evt,p__43232){
var map__43233 = p__43232;
var map__43233__$1 = cljs.core.__destructure_map(map__43233);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43233__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var server = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43233__$1,new cljs.core.Keyword(null,"server","server",1499190120));
var on_submit = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43233__$1,new cljs.core.Keyword(null,"on-submit","on-submit",1227871159));
var prevent_default_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43233__$1,new cljs.core.Keyword(null,"prevent-default?","prevent-default?",-1165567888));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43233__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var validation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43233__$1,new cljs.core.Keyword(null,"validation","validation",-2141396518));
var already_submitting_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43233__$1,new cljs.core.Keyword(null,"already-submitting?","already-submitting?",1438118407));
var reset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43233__$1,new cljs.core.Keyword(null,"reset","reset",-800929946));
...
if(((cljs.core.not(already_submitting_QMARK_)) && ((((validation == null)) && ((((fork.core.resolve_server_validation(server) == null)) && (cljs.core.every_QMARK_((function (p1__43231_SHARP_){
return new cljs.core.Keyword(null,"waiting?","waiting?",-2117257215).cljs$core$IFn$_invoke$arity$1(p1__43231_SHARP_) === false;
...
var G__43238 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"state","state",-1988618099),state,new cljs.core.Keyword(null,"path","path",-188191168),path,new cljs.core.Keyword(null,"values","values",372645556),new cljs.core.Keyword(null,"values","values",372645556).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),new cljs.core.Keyword(null,"dirty","dirty",729553281),fork.core.dirty(new cljs.core.Keyword(null,"values","values",372645556).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"initial-values","initial-values",1392120293).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),new cljs.core.Keyword(null,"touched-values","touched-values",-1817885644).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state))], 0))),new cljs.core.Keyword(null,"reset","reset",-800929946),reset], null);
return (on_submit.cljs$core$IFn$_invoke$arity$1 ? on_submit.cljs$core$IFn$_invoke$arity$1(G__43238) : on_submit.call(null,G__43238));
} else {
return null;
}
});
fork.core.send_server_request = (function fork$core$send_server_request(http_fn,p__43239){
var map__43240 = p__43239;
var map__43240__$1 = cljs.core.__destructure_map(map__43240);
var validation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43240__$1,new cljs.core.Keyword(null,"validation","validation",-2141396518));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43240__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var debounce = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43240__$1,new cljs.core.Keyword(null,"debounce","debounce",-871550296));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43240__$1,new cljs.core.Keyword(null,"value","value",305978217));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43240__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var evt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43240__$1,new cljs.core.Keyword(null,"evt","evt",-1251566867));
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43240__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var server_dispatch_logic = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43240__$1,new cljs.core.Keyword(null,"server-dispatch-logic","server-dispatch-logic",-465441551));
var throttle = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43240__$1,new cljs.core.Keyword(null,"throttle","throttle",-1860340776));
var input_key = name;
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.update_in,cljs.core.cons(new cljs.core.Keyword(null,"values","values",372645556),vec_field_array_key),(function (p1__43251_SHARP_){
return fork.core.vec_insert_at(fork.core.vec_remove(p1__43251_SHARP_,dragged_idx),dropped_idx,cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__43251_SHARP_,dragged_idx));
}));
});
fork.core.current_target_idx = (function fork$core$current_target_idx(state,k){
var G__43257 = cljs.core.deref(state);
var G__43257__$1 = (((G__43257 == null))?null:new cljs.core.Keyword(null,"drag-and-drop","drag-and-drop",-1528484051).cljs$core$IFn$_invoke$arity$1(G__43257));
var G__43257__$2 = (((G__43257__$1 == null))?null:(k.cljs$core$IFn$_invoke$arity$1 ? k.cljs$core$IFn$_invoke$arity$1(G__43257__$1) : k.call(null,G__43257__$1)));
if((G__43257__$2 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"idx-of-element-droppable-location","idx-of-element-droppable-location",1338425922).cljs$core$IFn$_invoke$arity$1(G__43257__$2);
}
});
fork.core.current_dragged_idx = (function fork$core$current_dragged_idx(state,k){
var G__43259 = cljs.core.deref(state);
var G__43259__$1 = (((G__43259 == null))?null:new cljs.core.Keyword(null,"drag-and-drop","drag-and-drop",-1528484051).cljs$core$IFn$_invoke$arity$1(G__43259));
var G__43259__$2 = (((G__43259__$1 == null))?null:(k.cljs$core$IFn$_invoke$arity$1 ? k.cljs$core$IFn$_invoke$arity$1(G__43259__$1) : k.call(null,G__43259__$1)));
if((G__43259__$2 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"idx-of-item-being-dragged","idx-of-item-being-dragged",1912676382).cljs$core$IFn$_invoke$arity$1(G__43259__$2);
}
});
...
}),(function (p1__43262_SHARP_){
return fork.core.set_handle_blur(p1__43262_SHARP_,state);
...
}),(function (p1__43261_SHARP_){
return fork.core.set_handle_change(p1__43261_SHARP_,state);
}),(function (k,idx){
...
return (function (p__43267,component){
var map__43268 = p__43267;
var map__43268__$1 = cljs.core.__destructure_map(map__43268);
var args = map__43268__$1;
var props__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43268__$1,new cljs.core.Keyword(null,"props","props",453281727));
