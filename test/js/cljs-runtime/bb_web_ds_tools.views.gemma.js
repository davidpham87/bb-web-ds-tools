...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.gemma","set-loading","bb-web-ds-tools.views.gemma/set-loading",1961048351),(function (db,p__32988){
var vec__32989 = p__32988;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32989,(0),null);
var loading_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32989,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.gemma","set-error","bb-web-ds-tools.views.gemma/set-error",1578779084),(function (db,p__32995){
var vec__32997 = p__32995;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32997,(0),null);
var error = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32997,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.gemma","add-message","bb-web-ds-tools.views.gemma/add-message",-287683400),(function (db,p__33001){
var vec__33002 = p__33001;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33002,(0),null);
var role = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33002,(1),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33002,(2),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.gemma","load-model","bb-web-ds-tools.views.gemma/load-model",595672016),(function (p__33005,p__33006){
var map__33008 = p__33005;
var map__33008__$1 = cljs.core.__destructure_map(map__33008);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33008__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__33009 = p__33006;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33009,(0),null);
var model_url = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33009,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.gemma","send-message","bb-web-ds-tools.views.gemma/send-message",1070168611),(function (p__33013,p__33014){
var map__33016 = p__33013;
var map__33016__$1 = cljs.core.__destructure_map(map__33016);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33016__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__33017 = p__33014;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33017,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33017,(1),null);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [fork.reagent.form,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"initial-values","initial-values",1392120293),new cljs.core.PersistentArrayMap(null, 1, ["url",""], null),new cljs.core.Keyword(null,"prevent-default?","prevent-default?",-1165567888),true,new cljs.core.Keyword(null,"on-submit","on-submit",1227871159),(function (p__33028){
var map__33029 = p__33028;
var map__33029__$1 = cljs.core.__destructure_map(map__33029);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33029__$1,new cljs.core.Keyword(null,"values","values",372645556));
...
var loading_QMARK_ = cljs.core.deref(loading_QMARK__sub);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [fork.reagent.form,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"initial-values","initial-values",1392120293),new cljs.core.PersistentArrayMap(null, 1, ["text",""], null),new cljs.core.Keyword(null,"prevent-default?","prevent-default?",-1165567888),true,new cljs.core.Keyword(null,"on-submit","on-submit",1227871159),(function (p__33043){
var map__33048 = p__33043;
var map__33048__$1 = cljs.core.__destructure_map(map__33048);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33048__$1,new cljs.core.Keyword(null,"values","values",372645556));
var reset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33048__$1,new cljs.core.Keyword(null,"reset","reset",-800929946));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__33089),bb_web_ds_tools$views$gemma$chat_interface_$_iter__33086(cljs.core.chunk_rest(s__33087__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__33089),null);
}
} else {
var vec__33108 = cljs.core.first(s__33087__$2);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33108,(0),null);
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33108,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),idx,new cljs.core.Keyword(null,"class","class",-2030961996),["mb-4 ",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"role","role",-736691072).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"user","user",1532431356)))?"text-right":"text-left")].join('')], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),["inline-block px-4 py-2 rounded-lg max-w-[80%] ",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"role","role",-736691072).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"user","user",1532431356)))?"bg-[#7f9f7f] text-[#3f3f3f]":"bg-[#4f4f4f] text-[#dcdccc] border border-[#5f5f5f]")].join('')], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-xs opacity-75 mb-1 font-bold"], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"role","role",-736691072).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"user","user",1532431356)))?"You":"Gemma")], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.Keyword(null,"content","content",15833224).cljs$core$IFn$_invoke$arity$1(msg)], null)], null)], null),bb_web_ds_tools$views$gemma$chat_interface_$_iter__33086(cljs.core.rest(s__33087__$2)));
}
} else {
return null;
}
