...
var map__36239 = cljs.core.meta(iobj);
var map__36239__$1 = cljs.core.__destructure_map(map__36239);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36239__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36239__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__36239__$1,new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.utils.current_file));
...
var map__36249 = (function (){var or__5025__auto__ = stack;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
var G__36250 = env;
var G__36250__$1 = (((G__36250 == null))?null:cljs.core.deref(G__36250));
var G__36250__$2 = (((G__36250__$1 == null))?null:new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557).cljs$core$IFn$_invoke$arity$1(G__36250__$1));
var G__36250__$3 = (((G__36250__$2 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__36250__$2,id));
var G__36250__$4 = (((G__36250__$3 == null))?null:cljs.core.deref(G__36250__$3));
var G__36250__$5 = (((G__36250__$4 == null))?null:cljs.core.last(G__36250__$4));
if((G__36250__$5 == null)){
return null;
} else {
return cljs.core.meta(G__36250__$5);
}
}
})();
var map__36249__$1 = cljs.core.__destructure_map(map__36249);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36249__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36249__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36249__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
var new_exception = (function (){var new_d = (function (){var G__36253 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("sci","error","sci/error",-979082803),new cljs.core.Keyword(null,"line","line",212345235),line,new cljs.core.Keyword(null,"column","column",2078222095),column,new cljs.core.Keyword(null,"message","message",-406056002),ex_msg__$1,new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557),st,new cljs.core.Keyword(null,"file","file",-1269645878),file], null);
if(cljs.core.truth_(phase)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36253,new cljs.core.Keyword(null,"phase","phase",575722892),phase);
} else {
return G__36253;
}
})();
...
var len__5749__auto___36295 = arguments.length;
var i__5750__auto___36296 = (0);
while(true){
if((i__5750__auto___36296 < len__5749__auto___36295)){
args__5755__auto__.push((arguments[i__5750__auto___36296]));

var G__36297 = (i__5750__auto___36296 + (1));
i__5750__auto___36296 = G__36297;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.vary_meta_STAR_.cljs$lang$applyTo = (function (seq36257){
var G__36258 = cljs.core.first(seq36257);
var seq36257__$1 = cljs.core.next(seq36257);
var G__36259 = cljs.core.first(seq36257__$1);
var seq36257__$2 = cljs.core.next(seq36257__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36258,G__36259,seq36257__$2);
}));

sci.impl.utils.strip_core_ns = (function sci$impl$utils$strip_core_ns(sym){
var G__36266 = cljs.core.namespace(sym);
switch (G__36266) {
case "clojure.core":
case "cljs.core":
...
var fexpr__36267 = cljs.core.deref(sci.impl.utils.eval_form_state);
return (fexpr__36267.cljs$core$IFn$_invoke$arity$2 ? fexpr__36267.cljs$core$IFn$_invoke$arity$2(sci_ctx,form) : fexpr__36267.call(null,sci_ctx,form));
});
/**
...
return cljs.core.cons(run,(function (){var G__36268 = pred;
var G__36269 = (new cljs.core.LazySeq(null,(function (){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2(cljs.core.count(run),s);
}),null,null));
return (sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2 ? sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2(G__36268,G__36269) : sci.impl.utils.split_when.call(null,G__36268,G__36269));
})());
} else {
return null;
}
...
var G__36299 = cljs.core.next(params__$1);
var G__36300 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,cljs.core.first(params__$1));
var G__36301 = lets;
params__$1 = G__36299;
new_params = G__36300;
lets = G__36301;
...
var G__36302 = cljs.core.next(params__$1);
var G__36303 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,gparam);
var G__36304 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(lets,cljs.core.first(params__$1)),gparam);
params__$1 = G__36302;
new_params = G__36303;
lets = G__36304;
continue;
...
var G__36272 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(expr_meta,new cljs.core.Keyword(null,"ns","ns",441598760),cljs.core.deref(sci.impl.utils.current_ns),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.utils.current_file)], 0));
if(cljs.core.truth_(special_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36272,new cljs.core.Keyword(null,"special","special",-1125941630),true);
} else {
return G__36272;
}
}));
...
var args__5755__auto__ = [];
var len__5749__auto___36306 = arguments.length;
var i__5750__auto___36307 = (0);
while(true){
if((i__5750__auto___36307 < len__5749__auto___36306)){
args__5755__auto__.push((arguments[i__5750__auto___36307]));

var G__36308 = (i__5750__auto___36307 + (1));
i__5750__auto___36307 = G__36308;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.log.cljs$lang$applyTo = (function (seq36273){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq36273));
}));
...
var G__36281 = sci.impl.utils.new_var.cljs$core$IFn$_invoke$arity$4(name,null,null,false);
sci.impl.vars.unbind(G__36281);
