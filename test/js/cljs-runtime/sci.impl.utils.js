...
var map__36286 = cljs.core.meta(iobj);
var map__36286__$1 = cljs.core.__destructure_map(map__36286);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36286__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36286__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__36286__$1,new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.utils.current_file));
...
var map__36297 = (function (){var or__5025__auto__ = stack;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
var G__36298 = env;
var G__36298__$1 = (((G__36298 == null))?null:cljs.core.deref(G__36298));
var G__36298__$2 = (((G__36298__$1 == null))?null:new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557).cljs$core$IFn$_invoke$arity$1(G__36298__$1));
var G__36298__$3 = (((G__36298__$2 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__36298__$2,id));
var G__36298__$4 = (((G__36298__$3 == null))?null:cljs.core.deref(G__36298__$3));
var G__36298__$5 = (((G__36298__$4 == null))?null:cljs.core.last(G__36298__$4));
if((G__36298__$5 == null)){
return null;
} else {
return cljs.core.meta(G__36298__$5);
}
}
})();
var map__36297__$1 = cljs.core.__destructure_map(map__36297);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36297__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36297__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36297__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
var new_exception = (function (){var new_d = (function (){var G__36299 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("sci","error","sci/error",-979082803),new cljs.core.Keyword(null,"line","line",212345235),line,new cljs.core.Keyword(null,"column","column",2078222095),column,new cljs.core.Keyword(null,"message","message",-406056002),ex_msg__$1,new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557),st,new cljs.core.Keyword(null,"file","file",-1269645878),file], null);
if(cljs.core.truth_(phase)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36299,new cljs.core.Keyword(null,"phase","phase",575722892),phase);
} else {
return G__36299;
}
})();
...
var len__5749__auto___36330 = arguments.length;
var i__5750__auto___36332 = (0);
while(true){
if((i__5750__auto___36332 < len__5749__auto___36330)){
args__5755__auto__.push((arguments[i__5750__auto___36332]));

var G__36333 = (i__5750__auto___36332 + (1));
i__5750__auto___36332 = G__36333;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.vary_meta_STAR_.cljs$lang$applyTo = (function (seq36301){
var G__36302 = cljs.core.first(seq36301);
var seq36301__$1 = cljs.core.next(seq36301);
var G__36303 = cljs.core.first(seq36301__$1);
var seq36301__$2 = cljs.core.next(seq36301__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36302,G__36303,seq36301__$2);
}));

sci.impl.utils.strip_core_ns = (function sci$impl$utils$strip_core_ns(sym){
var G__36304 = cljs.core.namespace(sym);
switch (G__36304) {
case "clojure.core":
case "cljs.core":
...
var fexpr__36305 = cljs.core.deref(sci.impl.utils.eval_form_state);
return (fexpr__36305.cljs$core$IFn$_invoke$arity$2 ? fexpr__36305.cljs$core$IFn$_invoke$arity$2(sci_ctx,form) : fexpr__36305.call(null,sci_ctx,form));
});
/**
...
return cljs.core.cons(run,(function (){var G__36306 = pred;
var G__36307 = (new cljs.core.LazySeq(null,(function (){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2(cljs.core.count(run),s);
}),null,null));
return (sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2 ? sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2(G__36306,G__36307) : sci.impl.utils.split_when.call(null,G__36306,G__36307));
})());
} else {
return null;
}
...
var G__36338 = cljs.core.next(params__$1);
var G__36339 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,cljs.core.first(params__$1));
var G__36340 = lets;
params__$1 = G__36338;
new_params = G__36339;
lets = G__36340;
...
var G__36341 = cljs.core.next(params__$1);
var G__36342 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,gparam);
var G__36343 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(lets,cljs.core.first(params__$1)),gparam);
params__$1 = G__36341;
new_params = G__36342;
lets = G__36343;
continue;
...
var G__36310 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(expr_meta,new cljs.core.Keyword(null,"ns","ns",441598760),cljs.core.deref(sci.impl.utils.current_ns),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.utils.current_file)], 0));
if(cljs.core.truth_(special_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36310,new cljs.core.Keyword(null,"special","special",-1125941630),true);
} else {
return G__36310;
}
}));
...
var args__5755__auto__ = [];
var len__5749__auto___36345 = arguments.length;
var i__5750__auto___36346 = (0);
while(true){
if((i__5750__auto___36346 < len__5749__auto___36345)){
args__5755__auto__.push((arguments[i__5750__auto___36346]));

var G__36347 = (i__5750__auto___36346 + (1));
i__5750__auto___36346 = G__36347;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.log.cljs$lang$applyTo = (function (seq36311){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq36311));
}));
...
var G__36321 = sci.impl.utils.new_var.cljs$core$IFn$_invoke$arity$4(name,null,null,false);
sci.impl.vars.unbind(G__36321);
