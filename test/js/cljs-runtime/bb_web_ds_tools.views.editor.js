 ...
 */
bb_web_ds_tools.views.editor.editor_form = (function bb_web_ds_tools$views$editor$editor_form(p__43395){
var map__43396 = p__43395;
var map__43396__$1 = cljs.core.__destructure_map(map__43396);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__43396__$1,new cljs.core.Keyword(null,"path","path",-188191168),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"editor-form","editor-form",2054255699)], null));
var initial_code = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__43396__$1,new cljs.core.Keyword(null,"initial-code","initial-code",-1940969145),cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.core","code","bb-web-ds-tools.core/code",-403485604)], null))));
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [fork.re_frame.form,new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"initial-values","initial-values",1392120293),new cljs.core.PersistentArrayMap(null, 1, ["code",initial_code__$1], null),new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true,new cljs.core.Keyword(null,"path","path",-188191168),path,new cljs.core.Keyword(null,"prevent-default?","prevent-default?",-1165567888),true,new cljs.core.Keyword(null,"clean-on-unmount?","clean-on-unmount?",-1144411068),true,new cljs.core.Keyword(null,"on-submit","on-submit",1227871159),(function (p__43399){
var map__43401 = p__43399;
var map__43401__$1 = cljs.core.__destructure_map(map__43401);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43401__$1,new cljs.core.Keyword(null,"values","values",372645556));
