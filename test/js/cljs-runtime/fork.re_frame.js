...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-dispatch-logic","fork.re-frame/server-dispatch-logic",-1023921676),(function (db,p__49313){
var vec__49314 = p__49313;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49314,(0),null);
var config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49314,(1),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49314,(2),null);
...
var G__49317 = db;
var G__49317__$1 = ((cljs.core.seq(input_names))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__49317,path,(function (m){
...
return cljs.core.assoc_in(G__49317__$1,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"server","server",1499190120),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(config),new cljs.core.Keyword(null,"waiting?","waiting?",-2117257215)], null)),true);
} else {
return G__49317__$1;
}
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-set-waiting","fork.re-frame/server-set-waiting",-1277872097),(function (db,p__49318){
var vec__49319 = p__49318;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49319,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49319,(1),null);
var input_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49319,(2),null);
var bool = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49319,(3),null);
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("fork.re-frame","db","fork.re-frame/db",503486154),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__49322){
var vec__49323 = p__49322;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49323,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49323,(1),null);
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,path);
})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","clean","fork.re-frame/clean",-448599170),(function (db,p__49326){
var vec__49327 = p__49326;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49327,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49327,(1),null);
...
var G__49347__delegate = function (ks){
...
while (G__49348__i < G__49348__a.length) {G__49348__a[G__49348__i] = arguments[G__49348__i + 0]; ++G__49348__i;}
  ks = new cljs.core.IndexedSeq(G__49348__a,0,null);
} 
return G__49347__delegate.call(this,ks);};
G__49347.cljs$lang$maxFixedArity = 0;
G__49347.cljs$lang$applyTo = (function (arglist__49349){
var ks = cljs.core.seq(arglist__49349);
return G__49347__delegate(ks);
});
G__49347.cljs$core$IFn$_invoke$arity$variadic = G__49347__delegate;
return G__49347;
})()
,(function (p1__49336_SHARP_){
return fork.core.handle_blur(p1__49336_SHARP_,state);
}),(function (p1__49330_SHARP_){
return fork.core.set_values(p1__49330_SHARP_,state);
}),(function (p1__49335_SHARP_){
return fork.core.handle_change(p1__49335_SHARP_,state);
}),(function() { 
var G__49350__delegate = function (ks){
return fork.core.enable.cljs$core$IFn$_invoke$arity$variadic(state,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([ks], 0));
};
var G__49350 = function (var_args){
var ks = null;
if (arguments.length > 0) {
...
while (G__49351__i < G__49351__a.length) {G__49351__a[G__49351__i] = arguments[G__49351__i + 0]; ++G__49351__i;}
  ks = new cljs.core.IndexedSeq(G__49351__a,0,null);
} 
return G__49350__delegate.call(this,ks);};
G__49350.cljs$lang$maxFixedArity = 0;
G__49350.cljs$lang$applyTo = (function (arglist__49352){
var ks = cljs.core.seq(arglist__49352);
return G__49350__delegate(ks);
});
G__49350.cljs$core$IFn$_invoke$arity$variadic = G__49350__delegate;
return G__49350;
})()
,(function() { 
var G__49353__delegate = function (ks){
return fork.core.set_untouched(ks,state);
};
var G__49353 = function (var_args){
var ks = null;
if (arguments.length > 0) {
var G__49354__i = 0, G__49354__a = new Array(arguments.length -  0);
while (G__49354__i < G__49354__a.length) {G__49354__a[G__49354__i] = arguments[G__49354__i + 0]; ++G__49354__i;}
  ks = new cljs.core.IndexedSeq(G__49354__a,0,null);
} 
return G__49353__delegate.call(this,ks);};
G__49353.cljs$lang$maxFixedArity = 0;
G__49353.cljs$lang$applyTo = (function (arglist__49355){
var ks = cljs.core.seq(arglist__49355);
return G__49353__delegate(ks);
});
G__49353.cljs$core$IFn$_invoke$arity$variadic = G__49353__delegate;
return G__49353;
})()
,(function() { 
var G__49356__delegate = function (p__49338){
var vec__49339 = p__49338;
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49339,(0),null);
...
var p__49338 = null;
if (arguments.length > 0) {
var G__49357__i = 0, G__49357__a = new Array(arguments.length -  0);
while (G__49357__i < G__49357__a.length) {G__49357__a[G__49357__i] = arguments[G__49357__i + 0]; ++G__49357__i;}
  p__49338 = new cljs.core.IndexedSeq(G__49357__a,0,null);
} 
return G__49356__delegate.call(this,p__49338);};
G__49356.cljs$lang$maxFixedArity = 0;
G__49356.cljs$lang$applyTo = (function (arglist__49358){
var p__49338 = cljs.core.seq(arglist__49358);
return G__49356__delegate(p__49338);
});
G__49356.cljs$core$IFn$_invoke$arity$variadic = G__49356__delegate;
return G__49356;
})()
,(function (p1__49334_SHARP_){
return fork.core.set_handle_blur(p1__49334_SHARP_,state);
}),(function() { 
var G__49359__delegate = function (ks){
...
while (G__49360__i < G__49360__a.length) {G__49360__a[G__49360__i] = arguments[G__49360__i + 0]; ++G__49360__i;}
  ks = new cljs.core.IndexedSeq(G__49360__a,0,null);
} 
return G__49359__delegate.call(this,ks);};
G__49359.cljs$lang$maxFixedArity = 0;
G__49359.cljs$lang$applyTo = (function (arglist__49361){
var ks = cljs.core.seq(arglist__49361);
return G__49359__delegate(ks);
});
...
}),(function (p1__49332_SHARP_){
return fork.core.normalize_name(p1__49332_SHARP_,props);
...
return fork.core.set_handle_change(p1__49333_SHARP_,state);
}),(function (p1__49331_SHARP_){
return fork.core.disabled_QMARK_(state,p1__49331_SHARP_);
})]);
