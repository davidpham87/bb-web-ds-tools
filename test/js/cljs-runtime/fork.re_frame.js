...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-dispatch-logic","fork.re-frame/server-dispatch-logic",-1023921676),(function (db,p__31070){
var vec__31071 = p__31070;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31071,(0),null);
var config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31071,(1),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31071,(2),null);
...
var G__31074 = db;
var G__31074__$1 = ((cljs.core.seq(input_names))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__31074,path,(function (m){
...
return cljs.core.assoc_in(G__31074__$1,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"server","server",1499190120),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(config),new cljs.core.Keyword(null,"waiting?","waiting?",-2117257215)], null)),true);
} else {
return G__31074__$1;
}
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-set-waiting","fork.re-frame/server-set-waiting",-1277872097),(function (db,p__31075){
var vec__31083 = p__31075;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31083,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31083,(1),null);
var input_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31083,(2),null);
var bool = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31083,(3),null);
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("fork.re-frame","db","fork.re-frame/db",503486154),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__31086){
var vec__31087 = p__31086;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31087,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31087,(1),null);
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,path);
})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","clean","fork.re-frame/clean",-448599170),(function (db,p__31090){
var vec__31091 = p__31090;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31091,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31091,(1),null);
...
var G__31125__delegate = function (ks){
...
while (G__31126__i < G__31126__a.length) {G__31126__a[G__31126__i] = arguments[G__31126__i + 0]; ++G__31126__i;}
  ks = new cljs.core.IndexedSeq(G__31126__a,0,null);
} 
return G__31125__delegate.call(this,ks);};
G__31125.cljs$lang$maxFixedArity = 0;
G__31125.cljs$lang$applyTo = (function (arglist__31127){
var ks = cljs.core.seq(arglist__31127);
return G__31125__delegate(ks);
});
G__31125.cljs$core$IFn$_invoke$arity$variadic = G__31125__delegate;
return G__31125;
})()
,(function (p1__31100_SHARP_){
return fork.core.handle_blur(p1__31100_SHARP_,state);
}),(function (p1__31094_SHARP_){
return fork.core.set_values(p1__31094_SHARP_,state);
}),(function (p1__31099_SHARP_){
return fork.core.handle_change(p1__31099_SHARP_,state);
}),(function() { 
var G__31128__delegate = function (ks){
...
while (G__31129__i < G__31129__a.length) {G__31129__a[G__31129__i] = arguments[G__31129__i + 0]; ++G__31129__i;}
  ks = new cljs.core.IndexedSeq(G__31129__a,0,null);
} 
return G__31128__delegate.call(this,ks);};
G__31128.cljs$lang$maxFixedArity = 0;
G__31128.cljs$lang$applyTo = (function (arglist__31130){
var ks = cljs.core.seq(arglist__31130);
return G__31128__delegate(ks);
});
G__31128.cljs$core$IFn$_invoke$arity$variadic = G__31128__delegate;
return G__31128;
})()
,(function() { 
var G__31131__delegate = function (ks){
...
while (G__31132__i < G__31132__a.length) {G__31132__a[G__31132__i] = arguments[G__31132__i + 0]; ++G__31132__i;}
  ks = new cljs.core.IndexedSeq(G__31132__a,0,null);
} 
return G__31131__delegate.call(this,ks);};
G__31131.cljs$lang$maxFixedArity = 0;
G__31131.cljs$lang$applyTo = (function (arglist__31133){
var ks = cljs.core.seq(arglist__31133);
return G__31131__delegate(ks);
});
G__31131.cljs$core$IFn$_invoke$arity$variadic = G__31131__delegate;
return G__31131;
})()
,(function() { 
var G__31134__delegate = function (p__31110){
var vec__31111 = p__31110;
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31111,(0),null);
...
while (G__31144__i < G__31144__a.length) {G__31144__a[G__31144__i] = arguments[G__31144__i + 0]; ++G__31144__i;}
  p__31110 = new cljs.core.IndexedSeq(G__31144__a,0,null);
} 
return G__31134__delegate.call(this,p__31110);};
G__31134.cljs$lang$maxFixedArity = 0;
G__31134.cljs$lang$applyTo = (function (arglist__31145){
var p__31110 = cljs.core.seq(arglist__31145);
return G__31134__delegate(p__31110);
});
G__31134.cljs$core$IFn$_invoke$arity$variadic = G__31134__delegate;
return G__31134;
})()
,(function (p1__31098_SHARP_){
return fork.core.set_handle_blur(p1__31098_SHARP_,state);
}),(function() { 
var G__31146__delegate = function (ks){
...
while (G__31147__i < G__31147__a.length) {G__31147__a[G__31147__i] = arguments[G__31147__i + 0]; ++G__31147__i;}
  ks = new cljs.core.IndexedSeq(G__31147__a,0,null);
} 
return G__31146__delegate.call(this,ks);};
G__31146.cljs$lang$maxFixedArity = 0;
G__31146.cljs$lang$applyTo = (function (arglist__31148){
var ks = cljs.core.seq(arglist__31148);
return G__31146__delegate(ks);
});
...
}),(function (p1__31096_SHARP_){
return fork.core.normalize_name(p1__31096_SHARP_,props);
...
}),(function (p1__31097_SHARP_){
return fork.core.set_handle_change(p1__31097_SHARP_,state);
}),(function (p1__31095_SHARP_){
return fork.core.disabled_QMARK_(state,p1__31095_SHARP_);
})]);
