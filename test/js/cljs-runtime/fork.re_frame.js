...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-dispatch-logic","fork.re-frame/server-dispatch-logic",-1023921676),(function (db,p__49463){
var vec__49465 = p__49463;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49465,(0),null);
var config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49465,(1),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49465,(2),null);
...
var G__49468 = db;
var G__49468__$1 = ((cljs.core.seq(input_names))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__49468,path,(function (m){
...
return cljs.core.assoc_in(G__49468__$1,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"server","server",1499190120),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(config),new cljs.core.Keyword(null,"waiting?","waiting?",-2117257215)], null)),true);
} else {
return G__49468__$1;
}
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-set-waiting","fork.re-frame/server-set-waiting",-1277872097),(function (db,p__49469){
var vec__49470 = p__49469;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49470,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49470,(1),null);
var input_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49470,(2),null);
var bool = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49470,(3),null);
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("fork.re-frame","db","fork.re-frame/db",503486154),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__49473){
var vec__49474 = p__49473;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49474,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49474,(1),null);
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,path);
})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","clean","fork.re-frame/clean",-448599170),(function (db,p__49477){
var vec__49478 = p__49477;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49478,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49478,(1),null);
...
var G__49585__delegate = function (ks){
...
var G__49585 = function (var_args){
var ks = null;
if (arguments.length > 0) {
var G__49586__i = 0, G__49586__a = new Array(arguments.length -  0);
while (G__49586__i < G__49586__a.length) {G__49586__a[G__49586__i] = arguments[G__49586__i + 0]; ++G__49586__i;}
  ks = new cljs.core.IndexedSeq(G__49586__a,0,null);
} 
return G__49585__delegate.call(this,ks);};
G__49585.cljs$lang$maxFixedArity = 0;
G__49585.cljs$lang$applyTo = (function (arglist__49587){
var ks = cljs.core.seq(arglist__49587);
return G__49585__delegate(ks);
});
G__49585.cljs$core$IFn$_invoke$arity$variadic = G__49585__delegate;
return G__49585;
})()
,(function (p1__49487_SHARP_){
return fork.core.handle_blur(p1__49487_SHARP_,state);
}),(function (p1__49481_SHARP_){
return fork.core.set_values(p1__49481_SHARP_,state);
}),(function (p1__49486_SHARP_){
return fork.core.handle_change(p1__49486_SHARP_,state);
}),(function() { 
var G__49588__delegate = function (ks){
return fork.core.enable.cljs$core$IFn$_invoke$arity$variadic(state,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([ks], 0));
};
var G__49588 = function (var_args){
var ks = null;
if (arguments.length > 0) {
var G__49589__i = 0, G__49589__a = new Array(arguments.length -  0);
while (G__49589__i < G__49589__a.length) {G__49589__a[G__49589__i] = arguments[G__49589__i + 0]; ++G__49589__i;}
  ks = new cljs.core.IndexedSeq(G__49589__a,0,null);
} 
return G__49588__delegate.call(this,ks);};
G__49588.cljs$lang$maxFixedArity = 0;
G__49588.cljs$lang$applyTo = (function (arglist__49590){
var ks = cljs.core.seq(arglist__49590);
return G__49588__delegate(ks);
});
G__49588.cljs$core$IFn$_invoke$arity$variadic = G__49588__delegate;
return G__49588;
})()
,(function() { 
var G__49591__delegate = function (ks){
...
while (G__49592__i < G__49592__a.length) {G__49592__a[G__49592__i] = arguments[G__49592__i + 0]; ++G__49592__i;}
  ks = new cljs.core.IndexedSeq(G__49592__a,0,null);
} 
return G__49591__delegate.call(this,ks);};
G__49591.cljs$lang$maxFixedArity = 0;
G__49591.cljs$lang$applyTo = (function (arglist__49593){
var ks = cljs.core.seq(arglist__49593);
return G__49591__delegate(ks);
});
G__49591.cljs$core$IFn$_invoke$arity$variadic = G__49591__delegate;
return G__49591;
})()
,(function() { 
var G__49594__delegate = function (p__49511){
var vec__49515 = p__49511;
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49515,(0),null);
...
while (G__49595__i < G__49595__a.length) {G__49595__a[G__49595__i] = arguments[G__49595__i + 0]; ++G__49595__i;}
  p__49511 = new cljs.core.IndexedSeq(G__49595__a,0,null);
} 
return G__49594__delegate.call(this,p__49511);};
G__49594.cljs$lang$maxFixedArity = 0;
G__49594.cljs$lang$applyTo = (function (arglist__49596){
var p__49511 = cljs.core.seq(arglist__49596);
return G__49594__delegate(p__49511);
});
G__49594.cljs$core$IFn$_invoke$arity$variadic = G__49594__delegate;
return G__49594;
})()
,(function (p1__49485_SHARP_){
return fork.core.set_handle_blur(p1__49485_SHARP_,state);
}),(function() { 
var G__49597__delegate = function (ks){
...
while (G__49598__i < G__49598__a.length) {G__49598__a[G__49598__i] = arguments[G__49598__i + 0]; ++G__49598__i;}
  ks = new cljs.core.IndexedSeq(G__49598__a,0,null);
} 
return G__49597__delegate.call(this,ks);};
G__49597.cljs$lang$maxFixedArity = 0;
G__49597.cljs$lang$applyTo = (function (arglist__49599){
var ks = cljs.core.seq(arglist__49599);
return G__49597__delegate(ks);
});
...
}),(function (p1__49483_SHARP_){
return fork.core.normalize_name(p1__49483_SHARP_,props);
...
}),(function (p1__49484_SHARP_){
return fork.core.set_handle_change(p1__49484_SHARP_,state);
}),(function (p1__49482_SHARP_){
return fork.core.disabled_QMARK_(state,p1__49482_SHARP_);
})]);
