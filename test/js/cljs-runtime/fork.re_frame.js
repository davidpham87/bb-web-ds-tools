...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-dispatch-logic","fork.re-frame/server-dispatch-logic",-1023921676),(function (db,p__49902){
var vec__49903 = p__49902;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49903,(0),null);
var config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49903,(1),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49903,(2),null);
...
var G__49906 = db;
var G__49906__$1 = ((cljs.core.seq(input_names))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__49906,path,(function (m){
...
return cljs.core.assoc_in(G__49906__$1,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"server","server",1499190120),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(config),new cljs.core.Keyword(null,"waiting?","waiting?",-2117257215)], null)),true);
} else {
return G__49906__$1;
}
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-set-waiting","fork.re-frame/server-set-waiting",-1277872097),(function (db,p__49907){
var vec__49908 = p__49907;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49908,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49908,(1),null);
var input_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49908,(2),null);
var bool = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49908,(3),null);
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("fork.re-frame","db","fork.re-frame/db",503486154),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__49911){
var vec__49912 = p__49911;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49912,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49912,(1),null);
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,path);
})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","clean","fork.re-frame/clean",-448599170),(function (db,p__49915){
var vec__49916 = p__49915;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49916,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49916,(1),null);
...
var G__50020__delegate = function (ks){
...
while (G__50021__i < G__50021__a.length) {G__50021__a[G__50021__i] = arguments[G__50021__i + 0]; ++G__50021__i;}
  ks = new cljs.core.IndexedSeq(G__50021__a,0,null);
} 
return G__50020__delegate.call(this,ks);};
G__50020.cljs$lang$maxFixedArity = 0;
G__50020.cljs$lang$applyTo = (function (arglist__50022){
var ks = cljs.core.seq(arglist__50022);
return G__50020__delegate(ks);
});
G__50020.cljs$core$IFn$_invoke$arity$variadic = G__50020__delegate;
return G__50020;
})()
,(function (p1__49925_SHARP_){
return fork.core.handle_blur(p1__49925_SHARP_,state);
}),(function (p1__49919_SHARP_){
return fork.core.set_values(p1__49919_SHARP_,state);
}),(function (p1__49924_SHARP_){
return fork.core.handle_change(p1__49924_SHARP_,state);
}),(function() { 
var G__50023__delegate = function (ks){
...
while (G__50024__i < G__50024__a.length) {G__50024__a[G__50024__i] = arguments[G__50024__i + 0]; ++G__50024__i;}
  ks = new cljs.core.IndexedSeq(G__50024__a,0,null);
} 
return G__50023__delegate.call(this,ks);};
G__50023.cljs$lang$maxFixedArity = 0;
G__50023.cljs$lang$applyTo = (function (arglist__50025){
var ks = cljs.core.seq(arglist__50025);
return G__50023__delegate(ks);
});
G__50023.cljs$core$IFn$_invoke$arity$variadic = G__50023__delegate;
return G__50023;
})()
,(function() { 
var G__50026__delegate = function (ks){
return fork.core.set_untouched(ks,state);
};
var G__50026 = function (var_args){
var ks = null;
if (arguments.length > 0) {
var G__50027__i = 0, G__50027__a = new Array(arguments.length -  0);
while (G__50027__i < G__50027__a.length) {G__50027__a[G__50027__i] = arguments[G__50027__i + 0]; ++G__50027__i;}
  ks = new cljs.core.IndexedSeq(G__50027__a,0,null);
} 
return G__50026__delegate.call(this,ks);};
G__50026.cljs$lang$maxFixedArity = 0;
G__50026.cljs$lang$applyTo = (function (arglist__50028){
var ks = cljs.core.seq(arglist__50028);
return G__50026__delegate(ks);
});
G__50026.cljs$core$IFn$_invoke$arity$variadic = G__50026__delegate;
return G__50026;
})()
,(function() { 
var G__50029__delegate = function (p__49927){
var vec__49928 = p__49927;
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49928,(0),null);
...
var G__50029 = function (var_args){
var p__49927 = null;
if (arguments.length > 0) {
...
while (G__50030__i < G__50030__a.length) {G__50030__a[G__50030__i] = arguments[G__50030__i + 0]; ++G__50030__i;}
  p__49927 = new cljs.core.IndexedSeq(G__50030__a,0,null);
} 
return G__50029__delegate.call(this,p__49927);};
G__50029.cljs$lang$maxFixedArity = 0;
G__50029.cljs$lang$applyTo = (function (arglist__50031){
var p__49927 = cljs.core.seq(arglist__50031);
return G__50029__delegate(p__49927);
});
G__50029.cljs$core$IFn$_invoke$arity$variadic = G__50029__delegate;
return G__50029;
})()
,(function (p1__49923_SHARP_){
return fork.core.set_handle_blur(p1__49923_SHARP_,state);
}),(function() { 
var G__50032__delegate = function (ks){
return fork.core.set_touched(ks,state);
};
var G__50032 = function (var_args){
var ks = null;
if (arguments.length > 0) {
var G__50033__i = 0, G__50033__a = new Array(arguments.length -  0);
while (G__50033__i < G__50033__a.length) {G__50033__a[G__50033__i] = arguments[G__50033__i + 0]; ++G__50033__i;}
  ks = new cljs.core.IndexedSeq(G__50033__a,0,null);
} 
return G__50032__delegate.call(this,ks);};
G__50032.cljs$lang$maxFixedArity = 0;
G__50032.cljs$lang$applyTo = (function (arglist__50034){
var ks = cljs.core.seq(arglist__50034);
return G__50032__delegate(ks);
});
G__50032.cljs$core$IFn$_invoke$arity$variadic = G__50032__delegate;
return G__50032;
})()
,(function (k){
return fork.core.touched(state,k);
}),(function (p1__49921_SHARP_){
return fork.core.normalize_name(p1__49921_SHARP_,props);
...
}),(function (p1__49922_SHARP_){
return fork.core.set_handle_change(p1__49922_SHARP_,state);
}),(function (p1__49920_SHARP_){
return fork.core.disabled_QMARK_(state,p1__49920_SHARP_);
})]);
