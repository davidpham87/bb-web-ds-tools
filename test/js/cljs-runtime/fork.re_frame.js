...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-dispatch-logic","fork.re-frame/server-dispatch-logic",-1023921676),(function (db,p__50017){
var vec__50018 = p__50017;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50018,(0),null);
var config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50018,(1),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50018,(2),null);
...
var G__50023 = db;
var G__50023__$1 = ((cljs.core.seq(input_names))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__50023,path,(function (m){
...
return cljs.core.assoc_in(G__50023__$1,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"server","server",1499190120),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(config),new cljs.core.Keyword(null,"waiting?","waiting?",-2117257215)], null)),true);
} else {
return G__50023__$1;
}
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-set-waiting","fork.re-frame/server-set-waiting",-1277872097),(function (db,p__50028){
var vec__50029 = p__50028;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50029,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50029,(1),null);
var input_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50029,(2),null);
var bool = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50029,(3),null);
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("fork.re-frame","db","fork.re-frame/db",503486154),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__50035){
var vec__50036 = p__50035;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50036,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50036,(1),null);
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,path);
})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","clean","fork.re-frame/clean",-448599170),(function (db,p__50040){
var vec__50042 = p__50040;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50042,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50042,(1),null);
...
var G__50105__delegate = function (ks){
...
while (G__50106__i < G__50106__a.length) {G__50106__a[G__50106__i] = arguments[G__50106__i + 0]; ++G__50106__i;}
  ks = new cljs.core.IndexedSeq(G__50106__a,0,null);
} 
return G__50105__delegate.call(this,ks);};
G__50105.cljs$lang$maxFixedArity = 0;
G__50105.cljs$lang$applyTo = (function (arglist__50107){
var ks = cljs.core.seq(arglist__50107);
return G__50105__delegate(ks);
});
G__50105.cljs$core$IFn$_invoke$arity$variadic = G__50105__delegate;
return G__50105;
})()
,(function (p1__50054_SHARP_){
return fork.core.handle_blur(p1__50054_SHARP_,state);
}),(function (p1__50047_SHARP_){
return fork.core.set_values(p1__50047_SHARP_,state);
}),(function (p1__50053_SHARP_){
return fork.core.handle_change(p1__50053_SHARP_,state);
}),(function() { 
var G__50111__delegate = function (ks){
...
var ks = null;
if (arguments.length > 0) {
var G__50113__i = 0, G__50113__a = new Array(arguments.length -  0);
while (G__50113__i < G__50113__a.length) {G__50113__a[G__50113__i] = arguments[G__50113__i + 0]; ++G__50113__i;}
  ks = new cljs.core.IndexedSeq(G__50113__a,0,null);
} 
return G__50111__delegate.call(this,ks);};
G__50111.cljs$lang$maxFixedArity = 0;
G__50111.cljs$lang$applyTo = (function (arglist__50114){
var ks = cljs.core.seq(arglist__50114);
return G__50111__delegate(ks);
});
G__50111.cljs$core$IFn$_invoke$arity$variadic = G__50111__delegate;
return G__50111;
})()
,(function() { 
var G__50115__delegate = function (ks){
...
while (G__50116__i < G__50116__a.length) {G__50116__a[G__50116__i] = arguments[G__50116__i + 0]; ++G__50116__i;}
  ks = new cljs.core.IndexedSeq(G__50116__a,0,null);
} 
return G__50115__delegate.call(this,ks);};
G__50115.cljs$lang$maxFixedArity = 0;
G__50115.cljs$lang$applyTo = (function (arglist__50118){
var ks = cljs.core.seq(arglist__50118);
return G__50115__delegate(ks);
});
G__50115.cljs$core$IFn$_invoke$arity$variadic = G__50115__delegate;
return G__50115;
})()
,(function() { 
var G__50119__delegate = function (p__50064){
var vec__50065 = p__50064;
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50065,(0),null);
...
var G__50119 = function (var_args){
var p__50064 = null;
if (arguments.length > 0) {
...
while (G__50124__i < G__50124__a.length) {G__50124__a[G__50124__i] = arguments[G__50124__i + 0]; ++G__50124__i;}
  p__50064 = new cljs.core.IndexedSeq(G__50124__a,0,null);
} 
return G__50119__delegate.call(this,p__50064);};
G__50119.cljs$lang$maxFixedArity = 0;
G__50119.cljs$lang$applyTo = (function (arglist__50125){
var p__50064 = cljs.core.seq(arglist__50125);
return G__50119__delegate(p__50064);
});
G__50119.cljs$core$IFn$_invoke$arity$variadic = G__50119__delegate;
return G__50119;
})()
,(function (p1__50052_SHARP_){
return fork.core.set_handle_blur(p1__50052_SHARP_,state);
}),(function() { 
var G__50126__delegate = function (ks){
...
while (G__50127__i < G__50127__a.length) {G__50127__a[G__50127__i] = arguments[G__50127__i + 0]; ++G__50127__i;}
  ks = new cljs.core.IndexedSeq(G__50127__a,0,null);
} 
return G__50126__delegate.call(this,ks);};
G__50126.cljs$lang$maxFixedArity = 0;
G__50126.cljs$lang$applyTo = (function (arglist__50128){
var ks = cljs.core.seq(arglist__50128);
return G__50126__delegate(ks);
});
...
}),(function (p1__50050_SHARP_){
return fork.core.normalize_name(p1__50050_SHARP_,props);
...
}),(function (p1__50051_SHARP_){
return fork.core.set_handle_change(p1__50051_SHARP_,state);
}),(function (p1__50049_SHARP_){
return fork.core.disabled_QMARK_(state,p1__50049_SHARP_);
})]);
