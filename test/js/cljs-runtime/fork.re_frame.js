...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-dispatch-logic","fork.re-frame/server-dispatch-logic",-1023921676),(function (db,p__49588){
var vec__49590 = p__49588;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49590,(0),null);
var config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49590,(1),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49590,(2),null);
...
var G__49594 = db;
var G__49594__$1 = ((cljs.core.seq(input_names))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__49594,path,(function (m){
...
return cljs.core.assoc_in(G__49594__$1,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"server","server",1499190120),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(config),new cljs.core.Keyword(null,"waiting?","waiting?",-2117257215)], null)),true);
} else {
return G__49594__$1;
}
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-set-waiting","fork.re-frame/server-set-waiting",-1277872097),(function (db,p__49599){
var vec__49600 = p__49599;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49600,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49600,(1),null);
var input_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49600,(2),null);
var bool = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49600,(3),null);
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("fork.re-frame","db","fork.re-frame/db",503486154),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__49605){
var vec__49606 = p__49605;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49606,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49606,(1),null);
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,path);
})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","clean","fork.re-frame/clean",-448599170),(function (db,p__49610){
var vec__49612 = p__49610;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49612,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49612,(1),null);
...
var G__49676__delegate = function (ks){
...
var G__49676 = function (var_args){
var ks = null;
...
while (G__49678__i < G__49678__a.length) {G__49678__a[G__49678__i] = arguments[G__49678__i + 0]; ++G__49678__i;}
  ks = new cljs.core.IndexedSeq(G__49678__a,0,null);
} 
return G__49676__delegate.call(this,ks);};
G__49676.cljs$lang$maxFixedArity = 0;
G__49676.cljs$lang$applyTo = (function (arglist__49680){
var ks = cljs.core.seq(arglist__49680);
return G__49676__delegate(ks);
});
G__49676.cljs$core$IFn$_invoke$arity$variadic = G__49676__delegate;
return G__49676;
})()
,(function (p1__49625_SHARP_){
return fork.core.handle_blur(p1__49625_SHARP_,state);
}),(function (p1__49619_SHARP_){
return fork.core.set_values(p1__49619_SHARP_,state);
}),(function (p1__49624_SHARP_){
return fork.core.handle_change(p1__49624_SHARP_,state);
}),(function() { 
var G__49683__delegate = function (ks){
return fork.core.enable.cljs$core$IFn$_invoke$arity$variadic(state,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([ks], 0));
};
var G__49683 = function (var_args){
var ks = null;
if (arguments.length > 0) {
...
while (G__49685__i < G__49685__a.length) {G__49685__a[G__49685__i] = arguments[G__49685__i + 0]; ++G__49685__i;}
  ks = new cljs.core.IndexedSeq(G__49685__a,0,null);
} 
return G__49683__delegate.call(this,ks);};
G__49683.cljs$lang$maxFixedArity = 0;
G__49683.cljs$lang$applyTo = (function (arglist__49687){
var ks = cljs.core.seq(arglist__49687);
return G__49683__delegate(ks);
});
G__49683.cljs$core$IFn$_invoke$arity$variadic = G__49683__delegate;
return G__49683;
})()
,(function() { 
var G__49688__delegate = function (ks){
return fork.core.set_untouched(ks,state);
};
var G__49688 = function (var_args){
var ks = null;
if (arguments.length > 0) {
var G__49689__i = 0, G__49689__a = new Array(arguments.length -  0);
while (G__49689__i < G__49689__a.length) {G__49689__a[G__49689__i] = arguments[G__49689__i + 0]; ++G__49689__i;}
  ks = new cljs.core.IndexedSeq(G__49689__a,0,null);
} 
return G__49688__delegate.call(this,ks);};
G__49688.cljs$lang$maxFixedArity = 0;
G__49688.cljs$lang$applyTo = (function (arglist__49690){
var ks = cljs.core.seq(arglist__49690);
return G__49688__delegate(ks);
});
G__49688.cljs$core$IFn$_invoke$arity$variadic = G__49688__delegate;
return G__49688;
})()
,(function() { 
var G__49691__delegate = function (p__49632){
var vec__49633 = p__49632;
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49633,(0),null);
...
var p__49632 = null;
if (arguments.length > 0) {
var G__49699__i = 0, G__49699__a = new Array(arguments.length -  0);
while (G__49699__i < G__49699__a.length) {G__49699__a[G__49699__i] = arguments[G__49699__i + 0]; ++G__49699__i;}
  p__49632 = new cljs.core.IndexedSeq(G__49699__a,0,null);
} 
return G__49691__delegate.call(this,p__49632);};
G__49691.cljs$lang$maxFixedArity = 0;
G__49691.cljs$lang$applyTo = (function (arglist__49700){
var p__49632 = cljs.core.seq(arglist__49700);
return G__49691__delegate(p__49632);
});
G__49691.cljs$core$IFn$_invoke$arity$variadic = G__49691__delegate;
return G__49691;
})()
,(function (p1__49623_SHARP_){
return fork.core.set_handle_blur(p1__49623_SHARP_,state);
}),(function() { 
var G__49701__delegate = function (ks){
return fork.core.set_touched(ks,state);
};
var G__49701 = function (var_args){
var ks = null;
if (arguments.length > 0) {
var G__49702__i = 0, G__49702__a = new Array(arguments.length -  0);
while (G__49702__i < G__49702__a.length) {G__49702__a[G__49702__i] = arguments[G__49702__i + 0]; ++G__49702__i;}
  ks = new cljs.core.IndexedSeq(G__49702__a,0,null);
} 
return G__49701__delegate.call(this,ks);};
G__49701.cljs$lang$maxFixedArity = 0;
G__49701.cljs$lang$applyTo = (function (arglist__49703){
var ks = cljs.core.seq(arglist__49703);
return G__49701__delegate(ks);
});
G__49701.cljs$core$IFn$_invoke$arity$variadic = G__49701__delegate;
return G__49701;
})()
,(function (k){
return fork.core.touched(state,k);
}),(function (p1__49621_SHARP_){
return fork.core.normalize_name(p1__49621_SHARP_,props);
...
}),(function (p1__49622_SHARP_){
return fork.core.set_handle_change(p1__49622_SHARP_,state);
}),(function (p1__49620_SHARP_){
return fork.core.disabled_QMARK_(state,p1__49620_SHARP_);
})]);
