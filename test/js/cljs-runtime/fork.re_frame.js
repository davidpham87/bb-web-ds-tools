...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-dispatch-logic","fork.re-frame/server-dispatch-logic",-1023921676),(function (db,p__49324){
var vec__49325 = p__49324;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49325,(0),null);
var config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49325,(1),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49325,(2),null);
...
var G__49328 = db;
var G__49328__$1 = ((cljs.core.seq(input_names))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__49328,path,(function (m){
...
return cljs.core.assoc_in(G__49328__$1,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"server","server",1499190120),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(config),new cljs.core.Keyword(null,"waiting?","waiting?",-2117257215)], null)),true);
} else {
return G__49328__$1;
}
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-set-waiting","fork.re-frame/server-set-waiting",-1277872097),(function (db,p__49329){
var vec__49330 = p__49329;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49330,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49330,(1),null);
var input_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49330,(2),null);
var bool = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49330,(3),null);
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("fork.re-frame","db","fork.re-frame/db",503486154),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__49337){
var vec__49338 = p__49337;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49338,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49338,(1),null);
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,path);
})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","clean","fork.re-frame/clean",-448599170),(function (db,p__49345){
var vec__49347 = p__49345;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49347,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49347,(1),null);
...
var G__49365__delegate = function (ks){
...
while (G__49366__i < G__49366__a.length) {G__49366__a[G__49366__i] = arguments[G__49366__i + 0]; ++G__49366__i;}
  ks = new cljs.core.IndexedSeq(G__49366__a,0,null);
} 
return G__49365__delegate.call(this,ks);};
G__49365.cljs$lang$maxFixedArity = 0;
G__49365.cljs$lang$applyTo = (function (arglist__49367){
var ks = cljs.core.seq(arglist__49367);
return G__49365__delegate(ks);
});
G__49365.cljs$core$IFn$_invoke$arity$variadic = G__49365__delegate;
return G__49365;
})()
,(function (p1__49359_SHARP_){
return fork.core.handle_blur(p1__49359_SHARP_,state);
}),(function (p1__49353_SHARP_){
return fork.core.set_values(p1__49353_SHARP_,state);
}),(function (p1__49358_SHARP_){
return fork.core.handle_change(p1__49358_SHARP_,state);
}),(function() { 
var G__49368__delegate = function (ks){
...
while (G__49369__i < G__49369__a.length) {G__49369__a[G__49369__i] = arguments[G__49369__i + 0]; ++G__49369__i;}
  ks = new cljs.core.IndexedSeq(G__49369__a,0,null);
} 
return G__49368__delegate.call(this,ks);};
G__49368.cljs$lang$maxFixedArity = 0;
G__49368.cljs$lang$applyTo = (function (arglist__49370){
var ks = cljs.core.seq(arglist__49370);
return G__49368__delegate(ks);
});
G__49368.cljs$core$IFn$_invoke$arity$variadic = G__49368__delegate;
return G__49368;
})()
,(function() { 
var G__49371__delegate = function (ks){
...
while (G__49372__i < G__49372__a.length) {G__49372__a[G__49372__i] = arguments[G__49372__i + 0]; ++G__49372__i;}
  ks = new cljs.core.IndexedSeq(G__49372__a,0,null);
} 
return G__49371__delegate.call(this,ks);};
G__49371.cljs$lang$maxFixedArity = 0;
G__49371.cljs$lang$applyTo = (function (arglist__49373){
var ks = cljs.core.seq(arglist__49373);
return G__49371__delegate(ks);
});
G__49371.cljs$core$IFn$_invoke$arity$variadic = G__49371__delegate;
return G__49371;
})()
,(function() { 
var G__49374__delegate = function (p__49361){
var vec__49362 = p__49361;
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49362,(0),null);
...
while (G__49375__i < G__49375__a.length) {G__49375__a[G__49375__i] = arguments[G__49375__i + 0]; ++G__49375__i;}
  p__49361 = new cljs.core.IndexedSeq(G__49375__a,0,null);
} 
return G__49374__delegate.call(this,p__49361);};
G__49374.cljs$lang$maxFixedArity = 0;
G__49374.cljs$lang$applyTo = (function (arglist__49376){
var p__49361 = cljs.core.seq(arglist__49376);
return G__49374__delegate(p__49361);
});
G__49374.cljs$core$IFn$_invoke$arity$variadic = G__49374__delegate;
return G__49374;
})()
,(function (p1__49357_SHARP_){
return fork.core.set_handle_blur(p1__49357_SHARP_,state);
}),(function() { 
var G__49377__delegate = function (ks){
return fork.core.set_touched(ks,state);
};
var G__49377 = function (var_args){
var ks = null;
if (arguments.length > 0) {
var G__49378__i = 0, G__49378__a = new Array(arguments.length -  0);
while (G__49378__i < G__49378__a.length) {G__49378__a[G__49378__i] = arguments[G__49378__i + 0]; ++G__49378__i;}
  ks = new cljs.core.IndexedSeq(G__49378__a,0,null);
} 
return G__49377__delegate.call(this,ks);};
G__49377.cljs$lang$maxFixedArity = 0;
G__49377.cljs$lang$applyTo = (function (arglist__49379){
var ks = cljs.core.seq(arglist__49379);
return G__49377__delegate(ks);
});
...
}),(function (p1__49355_SHARP_){
return fork.core.normalize_name(p1__49355_SHARP_,props);
...
}),(function (p1__49356_SHARP_){
return fork.core.set_handle_change(p1__49356_SHARP_,state);
}),(function (p1__49354_SHARP_){
return fork.core.disabled_QMARK_(state,p1__49354_SHARP_);
})]);
