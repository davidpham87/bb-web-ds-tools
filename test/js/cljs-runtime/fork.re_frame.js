...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-dispatch-logic","fork.re-frame/server-dispatch-logic",-1023921676),(function (db,p__43660){
var vec__43661 = p__43660;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43661,(0),null);
var config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43661,(1),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43661,(2),null);
...
var G__43675 = db;
var G__43675__$1 = ((cljs.core.seq(input_names))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__43675,path,(function (m){
...
return cljs.core.assoc_in(G__43675__$1,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"server","server",1499190120),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(config),new cljs.core.Keyword(null,"waiting?","waiting?",-2117257215)], null)),true);
} else {
return G__43675__$1;
}
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-set-waiting","fork.re-frame/server-set-waiting",-1277872097),(function (db,p__43676){
var vec__43677 = p__43676;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43677,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43677,(1),null);
var input_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43677,(2),null);
var bool = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43677,(3),null);
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("fork.re-frame","db","fork.re-frame/db",503486154),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__43680){
var vec__43681 = p__43680;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43681,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43681,(1),null);
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,path);
})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","clean","fork.re-frame/clean",-448599170),(function (db,p__43684){
var vec__43685 = p__43684;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43685,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43685,(1),null);
...
var G__43754__delegate = function (ks){
...
while (G__43755__i < G__43755__a.length) {G__43755__a[G__43755__i] = arguments[G__43755__i + 0]; ++G__43755__i;}
  ks = new cljs.core.IndexedSeq(G__43755__a,0,null);
} 
return G__43754__delegate.call(this,ks);};
G__43754.cljs$lang$maxFixedArity = 0;
G__43754.cljs$lang$applyTo = (function (arglist__43756){
var ks = cljs.core.seq(arglist__43756);
return G__43754__delegate(ks);
});
G__43754.cljs$core$IFn$_invoke$arity$variadic = G__43754__delegate;
return G__43754;
})()
,(function (p1__43716_SHARP_){
return fork.core.handle_blur(p1__43716_SHARP_,state);
}),(function (p1__43710_SHARP_){
return fork.core.set_values(p1__43710_SHARP_,state);
}),(function (p1__43715_SHARP_){
return fork.core.handle_change(p1__43715_SHARP_,state);
}),(function() { 
var G__43757__delegate = function (ks){
...
while (G__43758__i < G__43758__a.length) {G__43758__a[G__43758__i] = arguments[G__43758__i + 0]; ++G__43758__i;}
  ks = new cljs.core.IndexedSeq(G__43758__a,0,null);
} 
return G__43757__delegate.call(this,ks);};
G__43757.cljs$lang$maxFixedArity = 0;
G__43757.cljs$lang$applyTo = (function (arglist__43759){
var ks = cljs.core.seq(arglist__43759);
return G__43757__delegate(ks);
});
G__43757.cljs$core$IFn$_invoke$arity$variadic = G__43757__delegate;
return G__43757;
})()
,(function() { 
var G__43760__delegate = function (ks){
return fork.core.set_untouched(ks,state);
};
var G__43760 = function (var_args){
var ks = null;
if (arguments.length > 0) {
var G__43762__i = 0, G__43762__a = new Array(arguments.length -  0);
while (G__43762__i < G__43762__a.length) {G__43762__a[G__43762__i] = arguments[G__43762__i + 0]; ++G__43762__i;}
  ks = new cljs.core.IndexedSeq(G__43762__a,0,null);
} 
return G__43760__delegate.call(this,ks);};
G__43760.cljs$lang$maxFixedArity = 0;
G__43760.cljs$lang$applyTo = (function (arglist__43763){
var ks = cljs.core.seq(arglist__43763);
return G__43760__delegate(ks);
});
G__43760.cljs$core$IFn$_invoke$arity$variadic = G__43760__delegate;
return G__43760;
})()
,(function() { 
var G__43764__delegate = function (p__43730){
var vec__43731 = p__43730;
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43731,(0),null);
...
while (G__43767__i < G__43767__a.length) {G__43767__a[G__43767__i] = arguments[G__43767__i + 0]; ++G__43767__i;}
  p__43730 = new cljs.core.IndexedSeq(G__43767__a,0,null);
} 
return G__43764__delegate.call(this,p__43730);};
G__43764.cljs$lang$maxFixedArity = 0;
G__43764.cljs$lang$applyTo = (function (arglist__43769){
var p__43730 = cljs.core.seq(arglist__43769);
return G__43764__delegate(p__43730);
});
G__43764.cljs$core$IFn$_invoke$arity$variadic = G__43764__delegate;
return G__43764;
})()
,(function (p1__43714_SHARP_){
return fork.core.set_handle_blur(p1__43714_SHARP_,state);
}),(function() { 
var G__43771__delegate = function (ks){
...
while (G__43772__i < G__43772__a.length) {G__43772__a[G__43772__i] = arguments[G__43772__i + 0]; ++G__43772__i;}
  ks = new cljs.core.IndexedSeq(G__43772__a,0,null);
} 
return G__43771__delegate.call(this,ks);};
G__43771.cljs$lang$maxFixedArity = 0;
G__43771.cljs$lang$applyTo = (function (arglist__43773){
var ks = cljs.core.seq(arglist__43773);
return G__43771__delegate(ks);
});
...
}),(function (p1__43712_SHARP_){
return fork.core.normalize_name(p1__43712_SHARP_,props);
...
}),(function (p1__43713_SHARP_){
return fork.core.set_handle_change(p1__43713_SHARP_,state);
}),(function (p1__43711_SHARP_){
return fork.core.disabled_QMARK_(state,p1__43711_SHARP_);
})]);
