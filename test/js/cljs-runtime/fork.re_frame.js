...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-dispatch-logic","fork.re-frame/server-dispatch-logic",-1023921676),(function (db,p__43609){
var vec__43610 = p__43609;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43610,(0),null);
var config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43610,(1),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43610,(2),null);
...
var G__43616 = db;
var G__43616__$1 = ((cljs.core.seq(input_names))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__43616,path,(function (m){
...
return cljs.core.assoc_in(G__43616__$1,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"server","server",1499190120),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(config),new cljs.core.Keyword(null,"waiting?","waiting?",-2117257215)], null)),true);
} else {
return G__43616__$1;
}
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-set-waiting","fork.re-frame/server-set-waiting",-1277872097),(function (db,p__43620){
var vec__43621 = p__43620;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43621,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43621,(1),null);
var input_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43621,(2),null);
var bool = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43621,(3),null);
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("fork.re-frame","db","fork.re-frame/db",503486154),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__43624){
var vec__43625 = p__43624;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43625,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43625,(1),null);
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,path);
})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","clean","fork.re-frame/clean",-448599170),(function (db,p__43628){
var vec__43629 = p__43628;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43629,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43629,(1),null);
...
var G__43668__delegate = function (ks){
...
while (G__43669__i < G__43669__a.length) {G__43669__a[G__43669__i] = arguments[G__43669__i + 0]; ++G__43669__i;}
  ks = new cljs.core.IndexedSeq(G__43669__a,0,null);
} 
return G__43668__delegate.call(this,ks);};
G__43668.cljs$lang$maxFixedArity = 0;
G__43668.cljs$lang$applyTo = (function (arglist__43670){
var ks = cljs.core.seq(arglist__43670);
return G__43668__delegate(ks);
});
G__43668.cljs$core$IFn$_invoke$arity$variadic = G__43668__delegate;
return G__43668;
})()
,(function (p1__43638_SHARP_){
return fork.core.handle_blur(p1__43638_SHARP_,state);
}),(function (p1__43632_SHARP_){
return fork.core.set_values(p1__43632_SHARP_,state);
}),(function (p1__43637_SHARP_){
return fork.core.handle_change(p1__43637_SHARP_,state);
}),(function() { 
var G__43671__delegate = function (ks){
...
while (G__43672__i < G__43672__a.length) {G__43672__a[G__43672__i] = arguments[G__43672__i + 0]; ++G__43672__i;}
  ks = new cljs.core.IndexedSeq(G__43672__a,0,null);
} 
return G__43671__delegate.call(this,ks);};
G__43671.cljs$lang$maxFixedArity = 0;
G__43671.cljs$lang$applyTo = (function (arglist__43673){
var ks = cljs.core.seq(arglist__43673);
return G__43671__delegate(ks);
});
G__43671.cljs$core$IFn$_invoke$arity$variadic = G__43671__delegate;
return G__43671;
})()
,(function() { 
var G__43674__delegate = function (ks){
...
while (G__43675__i < G__43675__a.length) {G__43675__a[G__43675__i] = arguments[G__43675__i + 0]; ++G__43675__i;}
  ks = new cljs.core.IndexedSeq(G__43675__a,0,null);
} 
return G__43674__delegate.call(this,ks);};
G__43674.cljs$lang$maxFixedArity = 0;
G__43674.cljs$lang$applyTo = (function (arglist__43676){
var ks = cljs.core.seq(arglist__43676);
return G__43674__delegate(ks);
});
G__43674.cljs$core$IFn$_invoke$arity$variadic = G__43674__delegate;
return G__43674;
})()
,(function() { 
var G__43677__delegate = function (p__43661){
var vec__43662 = p__43661;
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43662,(0),null);
...
while (G__43678__i < G__43678__a.length) {G__43678__a[G__43678__i] = arguments[G__43678__i + 0]; ++G__43678__i;}
  p__43661 = new cljs.core.IndexedSeq(G__43678__a,0,null);
} 
return G__43677__delegate.call(this,p__43661);};
G__43677.cljs$lang$maxFixedArity = 0;
G__43677.cljs$lang$applyTo = (function (arglist__43679){
var p__43661 = cljs.core.seq(arglist__43679);
return G__43677__delegate(p__43661);
});
G__43677.cljs$core$IFn$_invoke$arity$variadic = G__43677__delegate;
return G__43677;
})()
,(function (p1__43636_SHARP_){
return fork.core.set_handle_blur(p1__43636_SHARP_,state);
}),(function() { 
var G__43680__delegate = function (ks){
...
while (G__43681__i < G__43681__a.length) {G__43681__a[G__43681__i] = arguments[G__43681__i + 0]; ++G__43681__i;}
  ks = new cljs.core.IndexedSeq(G__43681__a,0,null);
} 
return G__43680__delegate.call(this,ks);};
G__43680.cljs$lang$maxFixedArity = 0;
G__43680.cljs$lang$applyTo = (function (arglist__43687){
var ks = cljs.core.seq(arglist__43687);
return G__43680__delegate(ks);
});
...
}),(function (p1__43634_SHARP_){
return fork.core.normalize_name(p1__43634_SHARP_,props);
...
}),(function (p1__43635_SHARP_){
return fork.core.set_handle_change(p1__43635_SHARP_,state);
