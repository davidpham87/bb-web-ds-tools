...
var map__45297 = bb_web_ds_tools.views.honeysql.get_honeysql_state(db);
var map__45297__$1 = cljs.core.__destructure_map(map__45297);
var input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45297__$1,new cljs.core.Keyword(null,"input","input",556931961));
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("honeysql","panel-state","honeysql/panel-state",-660162611),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("honeysql","input","honeysql/input",201662062)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("honeysql","output","honeysql/output",-656227780)], null),(function (p__45298,_){
var vec__45299 = p__45298;
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45299,(0),null);
var output = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45299,(1),null);
