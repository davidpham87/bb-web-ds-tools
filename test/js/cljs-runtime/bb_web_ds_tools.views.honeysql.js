...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("honeysql","update-input","honeysql/update-input",1611103297),(function (db,p__41158){
var vec__41159 = p__41158;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41159,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41159,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("honeysql","convert-to-sql","honeysql/convert-to-sql",1363941562),(function (p__41162,_){
var map__41163 = p__41162;
var map__41163__$1 = cljs.core.__destructure_map(map__41163);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41163__$1,new cljs.core.Keyword(null,"db","db",993250759));
var map__41164 = bb_web_ds_tools.views.honeysql.get_honeysql_state(db);
var map__41164__$1 = cljs.core.__destructure_map(map__41164);
var input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41164__$1,new cljs.core.Keyword(null,"input","input",556931961));
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("honeysql","panel-state","honeysql/panel-state",-660162611),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("honeysql","input","honeysql/input",201662062)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("honeysql","output","honeysql/output",-656227780)], null),(function (p__41165,_){
var vec__41166 = p__41165;
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41166,(0),null);
var output = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41166,(1),null);
