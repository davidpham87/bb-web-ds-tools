...
var vec__26573_26620 = clojure.data.diff(orig_db,new_db);
var only_before_26621 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26573_26620,(0),null);
var only_after_26622 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26573_26620,(1),null);
var db_changed_QMARK__26623 = (((!((only_before_26621 == null)))) || ((!((only_after_26622 == null)))));
if(db_changed_QMARK__26623){
...
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"log","log",-1595516004),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["only before:",only_before_26621], 0));

re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"log","log",-1595516004),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["only after :",only_after_26622], 0));
...
var vec__26576 = re_frame.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$2(context,new cljs.core.Keyword(null,"event","event",301435442));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26576,(0),null);
var payload = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26576,(1),null);
var event = vec__26576;
...
try{try{var map__26588 = re_frame.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$1(context);
var map__26588__$1 = cljs.core.__destructure_map(map__26588);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26588__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26588__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
}})():(function (){var map__26589 = re_frame.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$1(context);
var map__26589__$1 = cljs.core.__destructure_map(map__26589);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26589__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26589__$1,new cljs.core.Keyword(null,"event","event",301435442));
return re_frame.interceptor.assoc_effect(context,new cljs.core.Keyword(null,"db","db",993250759),(handler_fn.cljs$core$IFn$_invoke$arity$2 ? handler_fn.cljs$core$IFn$_invoke$arity$2(db,event) : handler_fn.call(null,db,event)));
})());
...
var new_context = ((re_frame.trace.is_trace_enabled_QMARK_())?(function (){var _STAR_current_trace_STAR__orig_val__26593 = re_frame.trace._STAR_current_trace_STAR_;
var _STAR_current_trace_STAR__temp_val__26594 = re_frame.trace.start_trace(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"op-type","op-type",-1636141668),new cljs.core.Keyword("event","handler","event/handler",-295903150),new cljs.core.Keyword(null,"operation","operation",-1267664310),re_frame.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$2(context,new cljs.core.Keyword(null,"original-event","original-event",2121330403))], null));
...
if(re_frame.trace.is_trace_enabled_QMARK_()){
var new_trace__26178__auto___26634 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.update.cljs$core$IFn$_invoke$arity$4(re_frame.trace._STAR_current_trace_STAR_,new cljs.core.Keyword(null,"tags","tags",1771418977),cljs.core.merge,new cljs.core.Keyword(null,"tags","tags",1771418977).cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tags","tags",1771418977),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"effects","effects",-282369292),re_frame.interceptor.get_effect.cljs$core$IFn$_invoke$arity$1(new_context),new cljs.core.Keyword(null,"coeffects","coeffects",497912985),re_frame.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$1(context)], null)], null))),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tags","tags",1771418977),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"effects","effects",-282369292),re_frame.interceptor.get_effect.cljs$core$IFn$_invoke$arity$1(new_context),new cljs.core.Keyword(null,"coeffects","coeffects",497912985),re_frame.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$1(context)], null)], null),new cljs.core.Keyword(null,"tags","tags",1771418977))], 0));
(re_frame.trace._STAR_current_trace_STAR_ = new_trace__26178__auto___26634);
...
var len__5749__auto___26635 = arguments.length;
var i__5750__auto___26636 = (0);
while(true){
if((i__5750__auto___26636 < len__5749__auto___26635)){
args__5755__auto__.push((arguments[i__5750__auto___26636]));

var G__26637 = (i__5750__auto___26636 + (1));
i__5750__auto___26636 = G__26637;
continue;
} else {
}
break;
...
var args__5755__auto__ = [];
var len__5749__auto___26641 = arguments.length;
var i__5750__auto___26642 = (0);
while(true){
if((i__5750__auto___26642 < len__5749__auto___26641)){
args__5755__auto__.push((arguments[i__5750__auto___26642]));

var G__26643 = (i__5750__auto___26642 + (1));
i__5750__auto___26642 = G__26643;
continue;
} else {
}
break;
...
var new_ins = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26610_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(new_db,p1__26610_SHARP_);
}),in_paths);
var old_ins = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26611_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(old_db,p1__26611_SHARP_);
}),in_paths);
...
/** @this {Function} */
(re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq26612){
...
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26613,G__26614,seq26612__$2);
}));
