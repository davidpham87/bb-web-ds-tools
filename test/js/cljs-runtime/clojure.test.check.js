...
var vec__51216 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51216,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51216,(1),null);
...
var len__5749__auto___51303 = arguments.length;
var i__5750__auto___51304 = (0);
while(true){
if((i__5750__auto___51304 < len__5749__auto___51303)){
args__5755__auto__.push((arguments[i__5750__auto___51304]));

var G__51305 = (i__5750__auto___51304 + (1));
i__5750__auto___51304 = G__51305;
continue;
} else {
}
break;
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__51223){
var map__51224 = p__51223;
var map__51224__$1 = cljs.core.__destructure_map(map__51224);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51224__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51224__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51224__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__51225 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51225,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51225,(1),null);
...
var vec__51239 = size_seq__$1;
var seq__51240 = cljs.core.seq(vec__51239);
var first__51241 = cljs.core.first(seq__51240);
var seq__51240__$1 = cljs.core.next(seq__51240);
var size = first__51241;
var rest_size_seq = seq__51240__$1;
var vec__51242 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51242,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51242,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq51220){
var G__51221 = cljs.core.first(seq51220);
var seq51220__$1 = cljs.core.next(seq51220);
var G__51222 = cljs.core.first(seq51220__$1);
var seq51220__$2 = cljs.core.next(seq51220__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51221,G__51222,seq51220__$2);
}));
...
var map__51248 = smallest;
var map__51248__$1 = cljs.core.__destructure_map(map__51248);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51248__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__51334 = tail;
var G__51335 = current_smallest;
var G__51336 = (total_nodes_visited + (1));
var G__51337 = depth;
nodes = G__51334;
current_smallest = G__51335;
total_nodes_visited = G__51336;
depth = G__51337;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__51261_51338 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__51261_51338) : reporter_fn.call(null,G__51261_51338));

var temp__5823__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5823__auto__){
var children = temp__5823__auto__;
var G__51339 = children;
var G__51340 = new_smallest;
var G__51341 = (total_nodes_visited + (1));
var G__51342 = (depth + (1));
nodes = G__51339;
...
var G__51343 = tail;
var G__51344 = new_smallest;
var G__51345 = (total_nodes_visited + (1));
var G__51346 = depth;
nodes = G__51343;
current_smallest = G__51344;
total_nodes_visited = G__51345;
depth = G__51346;
continue;
}
}
...
var G__51266_51347 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__51266_51347) : reporter_fn.call(null,G__51266_51347));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__51263_SHARP_){
var G__51275 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__51263_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__51275) : reporter_fn.call(null,G__51275));
}));
var G__51276_51348 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__51276_51348) : reporter_fn.call(null,G__51276_51348));
