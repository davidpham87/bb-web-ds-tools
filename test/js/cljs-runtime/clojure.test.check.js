...
var vec__51158 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51158,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51158,(1),null);
...
var len__5749__auto___51284 = arguments.length;
var i__5750__auto___51285 = (0);
while(true){
if((i__5750__auto___51285 < len__5749__auto___51284)){
args__5755__auto__.push((arguments[i__5750__auto___51285]));

var G__51292 = (i__5750__auto___51285 + (1));
i__5750__auto___51285 = G__51292;
continue;
} else {
}
break;
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__51188){
var map__51189 = p__51188;
var map__51189__$1 = cljs.core.__destructure_map(map__51189);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51189__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51189__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51189__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__51190 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51190,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51190,(1),null);
...
var vec__51207 = size_seq__$1;
var seq__51208 = cljs.core.seq(vec__51207);
var first__51209 = cljs.core.first(seq__51208);
var seq__51208__$1 = cljs.core.next(seq__51208);
var size = first__51209;
var rest_size_seq = seq__51208__$1;
var vec__51210 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51210,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51210,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq51162){
var G__51163 = cljs.core.first(seq51162);
var seq51162__$1 = cljs.core.next(seq51162);
var G__51164 = cljs.core.first(seq51162__$1);
var seq51162__$2 = cljs.core.next(seq51162__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51163,G__51164,seq51162__$2);
}));
...
var map__51230 = smallest;
var map__51230__$1 = cljs.core.__destructure_map(map__51230);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51230__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__51315 = tail;
var G__51316 = current_smallest;
var G__51317 = (total_nodes_visited + (1));
var G__51318 = depth;
nodes = G__51315;
current_smallest = G__51316;
total_nodes_visited = G__51317;
depth = G__51318;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__51239_51319 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__51239_51319) : reporter_fn.call(null,G__51239_51319));

var temp__5823__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5823__auto__){
var children = temp__5823__auto__;
var G__51320 = children;
var G__51321 = new_smallest;
var G__51322 = (total_nodes_visited + (1));
var G__51323 = (depth + (1));
nodes = G__51320;
current_smallest = G__51321;
total_nodes_visited = G__51322;
depth = G__51323;
continue;
} else {
var G__51324 = tail;
var G__51325 = new_smallest;
var G__51326 = (total_nodes_visited + (1));
var G__51327 = depth;
nodes = G__51324;
current_smallest = G__51325;
total_nodes_visited = G__51326;
depth = G__51327;
continue;
}
}
...
var G__51260_51331 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__51260_51331) : reporter_fn.call(null,G__51260_51331));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__51256_SHARP_){
var G__51261 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__51256_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__51261) : reporter_fn.call(null,G__51261));
}));
var G__51262_51332 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__51262_51332) : reporter_fn.call(null,G__51262_51332));
