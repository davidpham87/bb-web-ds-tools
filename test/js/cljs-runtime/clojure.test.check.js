...
var vec__58097 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58097,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58097,(1),null);
...
var len__5749__auto___58179 = arguments.length;
var i__5750__auto___58180 = (0);
while(true){
if((i__5750__auto___58180 < len__5749__auto___58179)){
args__5755__auto__.push((arguments[i__5750__auto___58180]));

var G__58181 = (i__5750__auto___58180 + (1));
i__5750__auto___58180 = G__58181;
continue;
} else {
}
break;
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__58106){
var map__58107 = p__58106;
var map__58107__$1 = cljs.core.__destructure_map(map__58107);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58107__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__58107__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__58107__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__58108 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58108,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58108,(1),null);
...
var vec__58122 = size_seq__$1;
var seq__58123 = cljs.core.seq(vec__58122);
var first__58124 = cljs.core.first(seq__58123);
var seq__58123__$1 = cljs.core.next(seq__58123);
var size = first__58124;
var rest_size_seq = seq__58123__$1;
var vec__58125 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58125,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58125,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq58102){
var G__58103 = cljs.core.first(seq58102);
var seq58102__$1 = cljs.core.next(seq58102);
var G__58104 = cljs.core.first(seq58102__$1);
var seq58102__$2 = cljs.core.next(seq58102__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58103,G__58104,seq58102__$2);
}));
...
var map__58141 = smallest;
var map__58141__$1 = cljs.core.__destructure_map(map__58141);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58141__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__58196 = tail;
var G__58197 = current_smallest;
var G__58198 = (total_nodes_visited + (1));
var G__58199 = depth;
nodes = G__58196;
current_smallest = G__58197;
total_nodes_visited = G__58198;
depth = G__58199;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__58148_58200 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__58148_58200) : reporter_fn.call(null,G__58148_58200));

var temp__5823__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5823__auto__){
var children = temp__5823__auto__;
var G__58201 = children;
var G__58202 = new_smallest;
var G__58203 = (total_nodes_visited + (1));
var G__58204 = (depth + (1));
nodes = G__58201;
current_smallest = G__58202;
total_nodes_visited = G__58203;
depth = G__58204;
continue;
} else {
var G__58205 = tail;
var G__58206 = new_smallest;
var G__58207 = (total_nodes_visited + (1));
var G__58208 = depth;
nodes = G__58205;
current_smallest = G__58206;
total_nodes_visited = G__58207;
depth = G__58208;
continue;
}
}
...
var G__58163_58209 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__58163_58209) : reporter_fn.call(null,G__58163_58209));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__58162_SHARP_){
var G__58164 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__58162_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__58164) : reporter_fn.call(null,G__58164));
}));
var G__58166_58210 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__58166_58210) : reporter_fn.call(null,G__58166_58210));
