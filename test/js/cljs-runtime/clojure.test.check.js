...
var vec__47388 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47388,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47388,(1),null);
...
var len__5749__auto___47496 = arguments.length;
var i__5750__auto___47497 = (0);
while(true){
if((i__5750__auto___47497 < len__5749__auto___47496)){
args__5755__auto__.push((arguments[i__5750__auto___47497]));

var G__47498 = (i__5750__auto___47497 + (1));
i__5750__auto___47497 = G__47498;
continue;
} else {
}
break;
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__47399){
var map__47401 = p__47399;
var map__47401__$1 = cljs.core.__destructure_map(map__47401);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47401__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__47401__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__47401__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__47402 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47402,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47402,(1),null);
...
var vec__47414 = size_seq__$1;
var seq__47415 = cljs.core.seq(vec__47414);
var first__47416 = cljs.core.first(seq__47415);
var seq__47415__$1 = cljs.core.next(seq__47415);
var size = first__47416;
var rest_size_seq = seq__47415__$1;
var vec__47417 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47417,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47417,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq47393){
var G__47394 = cljs.core.first(seq47393);
var seq47393__$1 = cljs.core.next(seq47393);
var G__47395 = cljs.core.first(seq47393__$1);
var seq47393__$2 = cljs.core.next(seq47393__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47394,G__47395,seq47393__$2);
}));
...
var map__47437 = smallest;
var map__47437__$1 = cljs.core.__destructure_map(map__47437);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47437__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__47513 = tail;
var G__47514 = current_smallest;
var G__47515 = (total_nodes_visited + (1));
var G__47516 = depth;
nodes = G__47513;
current_smallest = G__47514;
total_nodes_visited = G__47515;
depth = G__47516;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__47445_47517 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__47445_47517) : reporter_fn.call(null,G__47445_47517));

var temp__5823__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5823__auto__){
var children = temp__5823__auto__;
var G__47518 = children;
var G__47519 = new_smallest;
var G__47520 = (total_nodes_visited + (1));
var G__47521 = (depth + (1));
nodes = G__47518;
current_smallest = G__47519;
total_nodes_visited = G__47520;
depth = G__47521;
continue;
} else {
var G__47522 = tail;
var G__47523 = new_smallest;
var G__47524 = (total_nodes_visited + (1));
var G__47525 = depth;
nodes = G__47522;
current_smallest = G__47523;
total_nodes_visited = G__47524;
depth = G__47525;
continue;
}
}
...
var G__47454_47526 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__47454_47526) : reporter_fn.call(null,G__47454_47526));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__47450_SHARP_){
var G__47455 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__47450_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__47455) : reporter_fn.call(null,G__47455));
}));
var G__47456_47527 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__47456_47527) : reporter_fn.call(null,G__47456_47527));
