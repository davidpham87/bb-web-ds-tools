...
var vec__51063 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51063,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51063,(1),null);
...
var len__5749__auto___51107 = arguments.length;
var i__5750__auto___51108 = (0);
while(true){
if((i__5750__auto___51108 < len__5749__auto___51107)){
args__5755__auto__.push((arguments[i__5750__auto___51108]));

var G__51109 = (i__5750__auto___51108 + (1));
i__5750__auto___51108 = G__51109;
continue;
} else {
}
break;
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__51069){
var map__51070 = p__51069;
var map__51070__$1 = cljs.core.__destructure_map(map__51070);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51070__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51070__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51070__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__51071 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51071,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51071,(1),null);
...
var vec__51082 = size_seq__$1;
var seq__51083 = cljs.core.seq(vec__51082);
var first__51084 = cljs.core.first(seq__51083);
var seq__51083__$1 = cljs.core.next(seq__51083);
var size = first__51084;
var rest_size_seq = seq__51083__$1;
var vec__51085 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51085,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51085,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq51066){
var G__51067 = cljs.core.first(seq51066);
var seq51066__$1 = cljs.core.next(seq51066);
var G__51068 = cljs.core.first(seq51066__$1);
var seq51066__$2 = cljs.core.next(seq51066__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51067,G__51068,seq51066__$2);
}));
...
var map__51091 = smallest;
var map__51091__$1 = cljs.core.__destructure_map(map__51091);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51091__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__51122 = tail;
var G__51123 = current_smallest;
var G__51124 = (total_nodes_visited + (1));
var G__51125 = depth;
nodes = G__51122;
current_smallest = G__51123;
total_nodes_visited = G__51124;
depth = G__51125;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__51096_51126 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__51096_51126) : reporter_fn.call(null,G__51096_51126));

var temp__5823__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5823__auto__){
var children = temp__5823__auto__;
var G__51130 = children;
var G__51131 = new_smallest;
var G__51132 = (total_nodes_visited + (1));
var G__51133 = (depth + (1));
nodes = G__51130;
current_smallest = G__51131;
total_nodes_visited = G__51132;
depth = G__51133;
continue;
} else {
var G__51134 = tail;
var G__51135 = new_smallest;
var G__51136 = (total_nodes_visited + (1));
var G__51137 = depth;
nodes = G__51134;
current_smallest = G__51135;
total_nodes_visited = G__51136;
depth = G__51137;
continue;
}
}
...
var G__51102_51138 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__51102_51138) : reporter_fn.call(null,G__51102_51138));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__51101_SHARP_){
var G__51104 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__51101_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__51104) : reporter_fn.call(null,G__51104));
}));
var G__51105_51139 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__51105_51139) : reporter_fn.call(null,G__51105_51139));
