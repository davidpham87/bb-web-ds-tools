...
var vec__58451 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58451,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58451,(1),null);
...
var len__5749__auto___58551 = arguments.length;
var i__5750__auto___58552 = (0);
while(true){
if((i__5750__auto___58552 < len__5749__auto___58551)){
args__5755__auto__.push((arguments[i__5750__auto___58552]));

var G__58555 = (i__5750__auto___58552 + (1));
i__5750__auto___58552 = G__58555;
continue;
} else {
}
break;
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__58468){
var map__58469 = p__58468;
var map__58469__$1 = cljs.core.__destructure_map(map__58469);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58469__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__58469__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__58469__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__58470 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58470,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58470,(1),null);
...
var size = first__58482;
var rest_size_seq = seq__58481__$1;
var vec__58483 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58483,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58483,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq58465){
var G__58466 = cljs.core.first(seq58465);
var seq58465__$1 = cljs.core.next(seq58465);
var G__58467 = cljs.core.first(seq58465__$1);
var seq58465__$2 = cljs.core.next(seq58465__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58466,G__58467,seq58465__$2);
}));
...
var map__58495 = smallest;
var map__58495__$1 = cljs.core.__destructure_map(map__58495);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58495__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__58570 = tail;
var G__58571 = current_smallest;
var G__58572 = (total_nodes_visited + (1));
var G__58573 = depth;
nodes = G__58570;
current_smallest = G__58571;
total_nodes_visited = G__58572;
depth = G__58573;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__58507_58574 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__58507_58574) : reporter_fn.call(null,G__58507_58574));

var temp__5823__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5823__auto__){
var children = temp__5823__auto__;
var G__58576 = children;
var G__58577 = new_smallest;
var G__58578 = (total_nodes_visited + (1));
var G__58579 = (depth + (1));
nodes = G__58576;
current_smallest = G__58577;
total_nodes_visited = G__58578;
depth = G__58579;
continue;
} else {
var G__58580 = tail;
var G__58581 = new_smallest;
var G__58582 = (total_nodes_visited + (1));
var G__58583 = depth;
nodes = G__58580;
current_smallest = G__58581;
total_nodes_visited = G__58582;
depth = G__58583;
continue;
}
}
...
var G__58515_58585 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__58515_58585) : reporter_fn.call(null,G__58515_58585));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__58510_SHARP_){
var G__58516 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__58510_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__58516) : reporter_fn.call(null,G__58516));
}));
var G__58517_58586 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__58517_58586) : reporter_fn.call(null,G__58517_58586));
