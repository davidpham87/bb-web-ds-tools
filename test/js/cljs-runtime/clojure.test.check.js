...
var vec__51296 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51296,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51296,(1),null);
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__51305){
var map__51306 = p__51305;
var map__51306__$1 = cljs.core.__destructure_map(map__51306);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51306__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51306__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51306__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__51307 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51307,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51307,(1),null);
...
var vec__51319 = size_seq__$1;
var seq__51320 = cljs.core.seq(vec__51319);
var first__51321 = cljs.core.first(seq__51320);
var seq__51320__$1 = cljs.core.next(seq__51320);
var size = first__51321;
var rest_size_seq = seq__51320__$1;
var vec__51322 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51322,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51322,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq51301){
var G__51302 = cljs.core.first(seq51301);
var seq51301__$1 = cljs.core.next(seq51301);
var G__51303 = cljs.core.first(seq51301__$1);
var seq51301__$2 = cljs.core.next(seq51301__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51302,G__51303,seq51301__$2);
}));
...
var map__51333 = smallest;
var map__51333__$1 = cljs.core.__destructure_map(map__51333);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51333__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__51433 = tail;
var G__51434 = current_smallest;
var G__51435 = (total_nodes_visited + (1));
var G__51436 = depth;
nodes = G__51433;
current_smallest = G__51434;
total_nodes_visited = G__51435;
depth = G__51436;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__51349_51437 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__51349_51437) : reporter_fn.call(null,G__51349_51437));

var temp__5823__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5823__auto__){
var children = temp__5823__auto__;
var G__51439 = children;
var G__51440 = new_smallest;
var G__51441 = (total_nodes_visited + (1));
var G__51442 = (depth + (1));
nodes = G__51439;
current_smallest = G__51440;
total_nodes_visited = G__51441;
depth = G__51442;
continue;
} else {
var G__51443 = tail;
var G__51444 = new_smallest;
var G__51445 = (total_nodes_visited + (1));
var G__51446 = depth;
nodes = G__51443;
current_smallest = G__51444;
total_nodes_visited = G__51445;
depth = G__51446;
continue;
}
}
...
var G__51355_51447 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__51355_51447) : reporter_fn.call(null,G__51355_51447));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__51353_SHARP_){
var G__51356 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__51353_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__51356) : reporter_fn.call(null,G__51356));
}));
var G__51358_51451 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__51358_51451) : reporter_fn.call(null,G__51358_51451));
