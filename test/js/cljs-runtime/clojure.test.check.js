...
var vec__51193 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51193,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51193,(1),null);
...
var len__5749__auto___51294 = arguments.length;
var i__5750__auto___51295 = (0);
while(true){
if((i__5750__auto___51295 < len__5749__auto___51294)){
args__5755__auto__.push((arguments[i__5750__auto___51295]));

var G__51296 = (i__5750__auto___51295 + (1));
i__5750__auto___51295 = G__51296;
continue;
} else {
}
break;
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__51200){
var map__51201 = p__51200;
var map__51201__$1 = cljs.core.__destructure_map(map__51201);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51201__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51201__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51201__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__51205 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51205,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51205,(1),null);
...
var size = first__51229;
var rest_size_seq = seq__51228__$1;
var vec__51230 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51230,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51230,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq51197){
var G__51198 = cljs.core.first(seq51197);
var seq51197__$1 = cljs.core.next(seq51197);
var G__51199 = cljs.core.first(seq51197__$1);
var seq51197__$2 = cljs.core.next(seq51197__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51198,G__51199,seq51197__$2);
}));
...
var map__51253 = smallest;
var map__51253__$1 = cljs.core.__destructure_map(map__51253);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51253__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__51304 = tail;
var G__51305 = current_smallest;
var G__51306 = (total_nodes_visited + (1));
var G__51307 = depth;
nodes = G__51304;
current_smallest = G__51305;
total_nodes_visited = G__51306;
depth = G__51307;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__51260_51308 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__51260_51308) : reporter_fn.call(null,G__51260_51308));

var temp__5823__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5823__auto__){
var children = temp__5823__auto__;
var G__51310 = children;
var G__51311 = new_smallest;
var G__51312 = (total_nodes_visited + (1));
var G__51313 = (depth + (1));
nodes = G__51310;
current_smallest = G__51311;
total_nodes_visited = G__51312;
depth = G__51313;
continue;
} else {
var G__51314 = tail;
var G__51315 = new_smallest;
var G__51316 = (total_nodes_visited + (1));
var G__51317 = depth;
nodes = G__51314;
current_smallest = G__51315;
total_nodes_visited = G__51316;
depth = G__51317;
continue;
}
}
...
var G__51274_51318 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__51274_51318) : reporter_fn.call(null,G__51274_51318));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__51262_SHARP_){
var G__51281 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__51262_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__51281) : reporter_fn.call(null,G__51281));
}));
var G__51282_51319 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__51282_51319) : reporter_fn.call(null,G__51282_51319));
