...
var vec__51323 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51323,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51323,(1),null);
...
var G__51413 = (i__5750__auto___51412 + (1));
i__5750__auto___51412 = G__51413;
continue;
} else {
}
break;
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__51341){
var map__51342 = p__51341;
var map__51342__$1 = cljs.core.__destructure_map(map__51342);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51342__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51342__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51342__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__51351 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51351,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51351,(1),null);
...
var vec__51374 = size_seq__$1;
var seq__51375 = cljs.core.seq(vec__51374);
var first__51376 = cljs.core.first(seq__51375);
var seq__51375__$1 = cljs.core.next(seq__51375);
var size = first__51376;
var rest_size_seq = seq__51375__$1;
var vec__51377 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51377,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51377,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq51333){
var G__51334 = cljs.core.first(seq51333);
var seq51333__$1 = cljs.core.next(seq51333);
var G__51335 = cljs.core.first(seq51333__$1);
var seq51333__$2 = cljs.core.next(seq51333__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51334,G__51335,seq51333__$2);
}));
...
var map__51393 = smallest;
var map__51393__$1 = cljs.core.__destructure_map(map__51393);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51393__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__51418 = tail;
var G__51419 = current_smallest;
var G__51420 = (total_nodes_visited + (1));
var G__51421 = depth;
nodes = G__51418;
current_smallest = G__51419;
total_nodes_visited = G__51420;
depth = G__51421;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__51402_51422 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__51402_51422) : reporter_fn.call(null,G__51402_51422));

var temp__5823__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5823__auto__){
var children = temp__5823__auto__;
var G__51423 = children;
var G__51424 = new_smallest;
var G__51425 = (total_nodes_visited + (1));
var G__51426 = (depth + (1));
nodes = G__51423;
current_smallest = G__51424;
total_nodes_visited = G__51425;
depth = G__51426;
continue;
} else {
var G__51427 = tail;
var G__51428 = new_smallest;
var G__51429 = (total_nodes_visited + (1));
var G__51430 = depth;
nodes = G__51427;
current_smallest = G__51428;
total_nodes_visited = G__51429;
depth = G__51430;
continue;
}
}
...
var G__51407_51431 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__51407_51431) : reporter_fn.call(null,G__51407_51431));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__51406_SHARP_){
var G__51408 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__51406_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__51408) : reporter_fn.call(null,G__51408));
}));
var G__51409_51432 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__51409_51432) : reporter_fn.call(null,G__51409_51432));
