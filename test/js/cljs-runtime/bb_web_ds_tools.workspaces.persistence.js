...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.workspaces.persistence","save-datasets","bb-web-ds-tools.workspaces.persistence/save-datasets",-553694078),(function (p__49100,_){
var map__49101 = p__49100;
var map__49101__$1 = cljs.core.__destructure_map(map__49101);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49101__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.workspaces.persistence","datasets-loaded","bb-web-ds-tools.workspaces.persistence/datasets-loaded",1851286842),(function (db,p__49102){
var vec__49103 = p__49102;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49103,(0),null);
var datasets = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49103,(1),null);
