...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.workspaces.persistence","save-datasets","bb-web-ds-tools.workspaces.persistence/save-datasets",-553694078),(function (p__49462,_){
var map__49463 = p__49462;
var map__49463__$1 = cljs.core.__destructure_map(map__49463);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49463__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.workspaces.persistence","datasets-loaded","bb-web-ds-tools.workspaces.persistence/datasets-loaded",1851286842),(function (db,p__49464){
var vec__49465 = p__49464;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49465,(0),null);
var datasets = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49465,(1),null);
