...
return Reflect.construct(constructor$,args.map((function (p1__36313_SHARP_){
return sci.impl.types.eval(p1__36313_SHARP_,ctx,bindings);
})));
});
sci.impl.interop.invoke_static_method = (function sci$impl$interop$invoke_static_method(ctx,bindings,class$,method,args){
return Reflect.apply(method,class$,args.map((function (p1__36314_SHARP_){
