...
var args__$1 = args.map((function (p1__36072_SHARP_){
...
return Reflect.construct(constructor$,args.map((function (p1__36092_SHARP_){
return sci.impl.types.eval(p1__36092_SHARP_,ctx,bindings);
})));
});
sci.impl.interop.invoke_static_method = (function sci$impl$interop$invoke_static_method(ctx,bindings,class$,method,args){
return Reflect.apply(method,class$,args.map((function (p1__36099_SHARP_){
return sci.impl.types.eval(p1__36099_SHARP_,ctx,bindings);
})));
});
