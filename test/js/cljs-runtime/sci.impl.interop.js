...
var args__$1 = args.map((function (p1__36069_SHARP_){
return sci.impl.types.eval(p1__36069_SHARP_,ctx,bindings);
}));
...
return Reflect.construct(constructor$,args.map((function (p1__36084_SHARP_){
return sci.impl.types.eval(p1__36084_SHARP_,ctx,bindings);
})));
});
