...
var args__$1 = args.map((function (p1__36088_SHARP_){
return sci.impl.types.eval(p1__36088_SHARP_,ctx,bindings);
}));
...
return Reflect.construct(constructor$,args.map((function (p1__36098_SHARP_){
return sci.impl.types.eval(p1__36098_SHARP_,ctx,bindings);
})));
});
...
if(cljs.core.truth_(temp__5823__auto__)){
var vec__36104 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36104,(0),null);
