...
var args__$1 = args.map((function (p1__36349_SHARP_){
return sci.impl.types.eval(p1__36349_SHARP_,ctx,bindings);
}));
...
return Reflect.construct(constructor$,args.map((function (p1__36372_SHARP_){
return sci.impl.types.eval(p1__36372_SHARP_,ctx,bindings);
})));
});
sci.impl.interop.invoke_static_method = (function sci$impl$interop$invoke_static_method(ctx,bindings,class$,method,args){
return Reflect.apply(method,class$,args.map((function (p1__36373_SHARP_){
return sci.impl.types.eval(p1__36373_SHARP_,ctx,bindings);
})));
});
...
if(cljs.core.truth_(temp__5823__auto__)){
var vec__36374 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36374,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36374,(1),null);
