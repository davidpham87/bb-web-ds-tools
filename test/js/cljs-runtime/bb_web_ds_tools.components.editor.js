...
try{var map__30677 = reagent.core.props(this$);
var map__30677__$1 = cljs.core.__destructure_map(map__30677);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30677__$1,new cljs.core.Keyword(null,"value","value",305978217));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30677__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30677__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30677__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30677__$1,new cljs.core.Keyword(null,"on-focus","on-focus",-13737624));
var on_blur = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30677__$1,new cljs.core.Keyword(null,"on-blur","on-blur",814300747));
var on_mount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30677__$1,new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30677__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var sub_30713 = editor.onDidChangeModelContent((function (){
cljs.core.reset_BANG_(ignore_change_QMARK_,true);

var new_val_30714 = editor.getValue();
var temp__5825__auto___30715 = cljs.core.deref(on_change_ref);
if(cljs.core.truth_(temp__5825__auto___30715)){
var handler_30716 = temp__5825__auto___30715;
if(cljs.core.vector_QMARK_(handler_30716)){
re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(handler_30716,new_val_30714));
} else {
(handler_30716.cljs$core$IFn$_invoke$arity$1 ? handler_30716.cljs$core$IFn$_invoke$arity$1(new_val_30714) : handler_30716.call(null,new_val_30714));
}
} else {
}
...
cljs.core.reset_BANG_(subscription,sub_30713);
...
}catch (e30673){if((e30673 instanceof Error)){
var e = e30673;
...
var map__30692 = reagent.core.props(this$);
var map__30692__$1 = cljs.core.__destructure_map(map__30692);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30692__$1,new cljs.core.Keyword(null,"value","value",305978217));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30692__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30692__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30692__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30692__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var lang_30717 = (function (){var or__5025__auto__ = language;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
var G__30694 = mode;
...
var model_30718 = editor.getModel();
var current_lang_30719 = (cljs.core.truth_(model_30718)?model_30718.getLanguageId():null);
if(cljs.core.truth_((function (){var and__5023__auto__ = model_30718;
if(cljs.core.truth_(and__5023__auto__)){
var and__5023__auto____$1 = lang_30717;
if(cljs.core.truth_(and__5023__auto____$1)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(current_lang_30719,lang_30717);
} else {
...
shadow.js.shim.module$monaco_editor$esm$vs$editor$editor_api.editor.setModelLanguage(model_30718,lang_30717);
} else {
}
...
var temp__5825__auto___30721 = cljs.core.deref(subscription);
if(cljs.core.truth_(temp__5825__auto___30721)){
var sub_30722 = temp__5825__auto___30721;
sub_30722.dispose();
} else {
}
...
var map__30695 = props;
var map__30695__$1 = cljs.core.__destructure_map(map__30695);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30695__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30695__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var G__30700 = bb_web_ds_tools.components.editor.get_code_to_eval(ed);
return (eval_action.cljs$core$IFn$_invoke$arity$1 ? eval_action.cljs$core$IFn$_invoke$arity$1(G__30700) : eval_action.call(null,G__30700));
})], null)));
});
/**
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$components$editor$render_output_$_iter__30703(s__30704){
return (new cljs.core.LazySeq(null,(function (){
var s__30704__$1 = s__30704;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__30704__$1);
if(temp__5825__auto__){
var s__30704__$2 = temp__5825__auto__;
...
var map__30707 = cljs.core._nth(c__5501__auto__,i__30705);
var map__30707__$1 = cljs.core.__destructure_map(map__30707);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30707__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30707__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
cljs.core.chunk_append(b__30706,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__30708 = type;
var G__30708__$1 = (((G__30708 instanceof cljs.core.Keyword))?G__30708.fqn:null);
switch (G__30708__$1) {
case "result":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30708__$1)].join('')));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30706),bb_web_ds_tools$components$editor$render_output_$_iter__30703(cljs.core.chunk_rest(s__30704__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30706),null);
}
} else {
var map__30709 = cljs.core.first(s__30704__$2);
var map__30709__$1 = cljs.core.__destructure_map(map__30709);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30709__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30709__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__30710 = type;
...
})()], null),text], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.random_uuid()], null)),bb_web_ds_tools$components$editor$render_output_$_iter__30703(cljs.core.rest(s__30704__$2)));
}
} else {
return null;
}
