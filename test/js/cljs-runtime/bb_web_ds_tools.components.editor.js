...
try{var map__30689 = reagent.core.props(this$);
var map__30689__$1 = cljs.core.__destructure_map(map__30689);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30689__$1,new cljs.core.Keyword(null,"value","value",305978217));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30689__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30689__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30689__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30689__$1,new cljs.core.Keyword(null,"on-focus","on-focus",-13737624));
var on_blur = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30689__$1,new cljs.core.Keyword(null,"on-blur","on-blur",814300747));
var on_mount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30689__$1,new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30689__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var sub_30784 = editor.onDidChangeModelContent((function (){
cljs.core.reset_BANG_(ignore_change_QMARK_,true);

var new_val_30785 = editor.getValue();
var temp__5825__auto___30786 = cljs.core.deref(on_change_ref);
if(cljs.core.truth_(temp__5825__auto___30786)){
var handler_30787 = temp__5825__auto___30786;
if(cljs.core.vector_QMARK_(handler_30787)){
re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(handler_30787,new_val_30785));
} else {
(handler_30787.cljs$core$IFn$_invoke$arity$1 ? handler_30787.cljs$core$IFn$_invoke$arity$1(new_val_30785) : handler_30787.call(null,new_val_30785));
}
} else {
}
...
cljs.core.reset_BANG_(subscription,sub_30784);
...
}catch (e30688){if((e30688 instanceof Error)){
var e = e30688;
...
}}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (this$,p__30691){
var vec__30692 = p__30691;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30692,(0),null);
var old_props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30692,(1),null);
var map__30699 = reagent.core.props(this$);
var map__30699__$1 = cljs.core.__destructure_map(map__30699);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30699__$1,new cljs.core.Keyword(null,"value","value",305978217));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30699__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30699__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30699__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30699__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var lang_30788 = (function (){var or__5025__auto__ = language;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
var G__30742 = mode;
...
var model_30789 = editor.getModel();
var current_lang_30790 = (cljs.core.truth_(model_30789)?model_30789.getLanguageId():null);
if(cljs.core.truth_((function (){var and__5023__auto__ = model_30789;
if(cljs.core.truth_(and__5023__auto__)){
var and__5023__auto____$1 = lang_30788;
if(cljs.core.truth_(and__5023__auto____$1)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(current_lang_30790,lang_30788);
} else {
...
shadow.js.shim.module$monaco_editor$esm$vs$editor$editor_api.editor.setModelLanguage(model_30789,lang_30788);
} else {
}
...
var temp__5825__auto___30792 = cljs.core.deref(subscription);
if(cljs.core.truth_(temp__5825__auto___30792)){
var sub_30793 = temp__5825__auto___30792;
sub_30793.dispose();
} else {
}
...
var map__30752 = props;
var map__30752__$1 = cljs.core.__destructure_map(map__30752);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30752__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30752__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var G__30764 = bb_web_ds_tools.components.editor.get_code_to_eval(ed);
return (eval_action.cljs$core$IFn$_invoke$arity$1 ? eval_action.cljs$core$IFn$_invoke$arity$1(G__30764) : eval_action.call(null,G__30764));
})], null)));
});
/**
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$components$editor$render_output_$_iter__30766(s__30767){
return (new cljs.core.LazySeq(null,(function (){
var s__30767__$1 = s__30767;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__30767__$1);
if(temp__5825__auto__){
var s__30767__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__30767__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__30767__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__30769 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__30768 = (0);
while(true){
if((i__30768 < size__5502__auto__)){
var map__30770 = cljs.core._nth(c__5501__auto__,i__30768);
var map__30770__$1 = cljs.core.__destructure_map(map__30770);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30770__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30770__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
cljs.core.chunk_append(b__30769,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__30771 = type;
var G__30771__$1 = (((G__30771 instanceof cljs.core.Keyword))?G__30771.fqn:null);
switch (G__30771__$1) {
case "result":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30771__$1)].join('')));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30769),bb_web_ds_tools$components$editor$render_output_$_iter__30766(cljs.core.chunk_rest(s__30767__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30769),null);
}
} else {
var map__30772 = cljs.core.first(s__30767__$2);
var map__30772__$1 = cljs.core.__destructure_map(map__30772);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30772__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30772__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__30773 = type;
...
})()], null),text], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.random_uuid()], null)),bb_web_ds_tools$components$editor$render_output_$_iter__30766(cljs.core.rest(s__30767__$2)));
}
} else {
return null;
}
