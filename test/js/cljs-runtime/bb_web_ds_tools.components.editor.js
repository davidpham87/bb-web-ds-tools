...
return true;
}catch (e30684){if((e30684 instanceof Error)){
var e = e30684;
...
var sub_30807 = editor.onDidChangeModelContent((function (){
cljs.core.reset_BANG_(ignore_change_QMARK_,true);

var new_val_30808 = editor.getValue();
var temp__5825__auto___30809 = cljs.core.deref(on_change_ref);
if(cljs.core.truth_(temp__5825__auto___30809)){
var handler_30810 = temp__5825__auto___30809;
if(cljs.core.vector_QMARK_(handler_30810)){
re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(handler_30810,new_val_30808));
} else {
(handler_30810.cljs$core$IFn$_invoke$arity$1 ? handler_30810.cljs$core$IFn$_invoke$arity$1(new_val_30808) : handler_30810.call(null,new_val_30808));
}
} else {
}
...
cljs.core.reset_BANG_(subscription,sub_30807);
...
}}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (this$,p__30739){
var vec__30740 = p__30739;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30740,(0),null);
var old_props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30740,(1),null);
var map__30752 = reagent.core.props(this$);
var map__30752__$1 = cljs.core.__destructure_map(map__30752);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30752__$1,new cljs.core.Keyword(null,"value","value",305978217));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30752__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30752__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30752__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30752__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var lang_30811 = (function (){var or__5025__auto__ = language;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
var G__30762 = mode;
...
var model_30812 = editor.getModel();
var current_lang_30813 = (cljs.core.truth_(model_30812)?model_30812.getLanguageId():null);
if(cljs.core.truth_((function (){var and__5023__auto__ = model_30812;
if(cljs.core.truth_(and__5023__auto__)){
var and__5023__auto____$1 = lang_30811;
if(cljs.core.truth_(and__5023__auto____$1)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(current_lang_30813,lang_30811);
} else {
...
shadow.js.shim.module$monaco_editor$esm$vs$editor$editor_api.editor.setModelLanguage(model_30812,lang_30811);
} else {
}
...
var temp__5825__auto___30815 = cljs.core.deref(subscription);
if(cljs.core.truth_(temp__5825__auto___30815)){
var sub_30816 = temp__5825__auto___30815;
sub_30816.dispose();
} else {
}
...
var G__30775 = bb_web_ds_tools.components.editor.get_code_to_eval(ed);
return (eval_action.cljs$core$IFn$_invoke$arity$1 ? eval_action.cljs$core$IFn$_invoke$arity$1(G__30775) : eval_action.call(null,G__30775));
})], null)));
});
/**
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$components$editor$render_output_$_iter__30786(s__30787){
return (new cljs.core.LazySeq(null,(function (){
var s__30787__$1 = s__30787;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__30787__$1);
if(temp__5825__auto__){
var s__30787__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__30787__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__30787__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__30789 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__30788 = (0);
while(true){
if((i__30788 < size__5502__auto__)){
var map__30792 = cljs.core._nth(c__5501__auto__,i__30788);
var map__30792__$1 = cljs.core.__destructure_map(map__30792);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30792__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30792__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
cljs.core.chunk_append(b__30789,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__30794 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30794__$1)].join('')));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30789),bb_web_ds_tools$components$editor$render_output_$_iter__30786(cljs.core.chunk_rest(s__30787__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30789),null);
}
} else {
var map__30796 = cljs.core.first(s__30787__$2);
var map__30796__$1 = cljs.core.__destructure_map(map__30796);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30796__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30796__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__30797 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30797__$1)].join('')));

}
})()], null),text], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.random_uuid()], null)),bb_web_ds_tools$components$editor$render_output_$_iter__30786(cljs.core.rest(s__30787__$2)));
}
} else {
return null;
}
