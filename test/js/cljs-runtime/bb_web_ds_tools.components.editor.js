...
try{var map__30795 = reagent.core.props(this$);
...
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30795__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30795__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30795__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30795__$1,new cljs.core.Keyword(null,"on-focus","on-focus",-13737624));
var on_blur = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30795__$1,new cljs.core.Keyword(null,"on-blur","on-blur",814300747));
var on_mount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30795__$1,new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840));
...
var sub_30888 = editor.onDidChangeModelContent((function (){
cljs.core.reset_BANG_(ignore_change_QMARK_,true);

var new_val_30889 = editor.getValue();
var temp__5825__auto___30890 = cljs.core.deref(on_change_ref);
if(cljs.core.truth_(temp__5825__auto___30890)){
var handler_30891 = temp__5825__auto___30890;
if(cljs.core.vector_QMARK_(handler_30891)){
re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(handler_30891,new_val_30889));
} else {
(handler_30891.cljs$core$IFn$_invoke$arity$1 ? handler_30891.cljs$core$IFn$_invoke$arity$1(new_val_30889) : handler_30891.call(null,new_val_30889));
}
} else {
}
...
cljs.core.reset_BANG_(subscription,sub_30888);
...
var map__30805 = props;
var map__30805__$1 = cljs.core.__destructure_map(map__30805);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30805__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30805__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var G__30806 = bb_web_ds_tools.components.editor.get_code_to_eval(ed);
return (eval_action.cljs$core$IFn$_invoke$arity$1 ? eval_action.cljs$core$IFn$_invoke$arity$1(G__30806) : eval_action.call(null,G__30806));
})], null)));
});
/**
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$components$editor$render_output_$_iter__30807(s__30808){
...
var map__30851 = cljs.core._nth(c__5501__auto__,i__30809);
var map__30851__$1 = cljs.core.__destructure_map(map__30851);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30851__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30851__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
cljs.core.chunk_append(b__30810,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__30852 = type;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30810),bb_web_ds_tools$components$editor$render_output_$_iter__30807(cljs.core.chunk_rest(s__30808__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30810),null);
}
} else {
var map__30853 = cljs.core.first(s__30808__$2);
var map__30853__$1 = cljs.core.__destructure_map(map__30853);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30853__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30853__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__30854 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30854__$1)].join('')));

}
})()], null),text], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.random_uuid()], null)),bb_web_ds_tools$components$editor$render_output_$_iter__30807(cljs.core.rest(s__30808__$2)));
}
} else {
return null;
}
