...
var sub_30799 = editor.onDidChangeModelContent((function (){
cljs.core.reset_BANG_(ignore_change_QMARK_,true);

var new_val_30800 = editor.getValue();
var temp__5825__auto___30801 = cljs.core.deref(on_change_ref);
if(cljs.core.truth_(temp__5825__auto___30801)){
var handler_30802 = temp__5825__auto___30801;
if(cljs.core.vector_QMARK_(handler_30802)){
re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(handler_30802,new_val_30800));
} else {
(handler_30802.cljs$core$IFn$_invoke$arity$1 ? handler_30802.cljs$core$IFn$_invoke$arity$1(new_val_30800) : handler_30802.call(null,new_val_30800));
}
} else {
}
...
cljs.core.reset_BANG_(subscription,sub_30799);
...
var map__30695 = reagent.core.props(this$);
var map__30695__$1 = cljs.core.__destructure_map(map__30695);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30695__$1,new cljs.core.Keyword(null,"value","value",305978217));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30695__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30695__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30695__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30695__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var lang_30803 = (function (){var or__5025__auto__ = language;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
var G__30707 = mode;
...
var model_30804 = editor.getModel();
var current_lang_30805 = (cljs.core.truth_(model_30804)?model_30804.getLanguageId():null);
if(cljs.core.truth_((function (){var and__5023__auto__ = model_30804;
if(cljs.core.truth_(and__5023__auto__)){
var and__5023__auto____$1 = lang_30803;
if(cljs.core.truth_(and__5023__auto____$1)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(current_lang_30805,lang_30803);
} else {
...
shadow.js.shim.module$monaco_editor$esm$vs$editor$editor_api.editor.setModelLanguage(model_30804,lang_30803);
} else {
}
...
var temp__5825__auto___30811 = cljs.core.deref(subscription);
if(cljs.core.truth_(temp__5825__auto___30811)){
var sub_30812 = temp__5825__auto___30811;
sub_30812.dispose();
} else {
}
...
var map__30744 = props;
var map__30744__$1 = cljs.core.__destructure_map(map__30744);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30744__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30744__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var G__30759 = bb_web_ds_tools.components.editor.get_code_to_eval(ed);
return (eval_action.cljs$core$IFn$_invoke$arity$1 ? eval_action.cljs$core$IFn$_invoke$arity$1(G__30759) : eval_action.call(null,G__30759));
})], null)));
});
/**
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$components$editor$render_output_$_iter__30765(s__30766){
return (new cljs.core.LazySeq(null,(function (){
var s__30766__$1 = s__30766;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__30766__$1);
if(temp__5825__auto__){
var s__30766__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__30766__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__30766__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__30768 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__30767 = (0);
while(true){
if((i__30767 < size__5502__auto__)){
var map__30774 = cljs.core._nth(c__5501__auto__,i__30767);
var map__30774__$1 = cljs.core.__destructure_map(map__30774);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30774__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30774__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
cljs.core.chunk_append(b__30768,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__30776 = type;
var G__30776__$1 = (((G__30776 instanceof cljs.core.Keyword))?G__30776.fqn:null);
switch (G__30776__$1) {
case "result":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30776__$1)].join('')));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30768),bb_web_ds_tools$components$editor$render_output_$_iter__30765(cljs.core.chunk_rest(s__30766__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30768),null);
}
} else {
var map__30783 = cljs.core.first(s__30766__$2);
var map__30783__$1 = cljs.core.__destructure_map(map__30783);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30783__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30783__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__30784 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30784__$1)].join('')));

}
})()], null),text], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.random_uuid()], null)),bb_web_ds_tools$components$editor$render_output_$_iter__30765(cljs.core.rest(s__30766__$2)));
}
} else {
return null;
}
