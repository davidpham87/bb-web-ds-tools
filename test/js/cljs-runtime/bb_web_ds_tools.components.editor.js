...
try{var map__30660 = reagent.core.props(this$);
var map__30660__$1 = cljs.core.__destructure_map(map__30660);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30660__$1,new cljs.core.Keyword(null,"value","value",305978217));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30660__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30660__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30660__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30660__$1,new cljs.core.Keyword(null,"on-focus","on-focus",-13737624));
var on_blur = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30660__$1,new cljs.core.Keyword(null,"on-blur","on-blur",814300747));
var on_mount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30660__$1,new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30660__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var sub_30707 = editor.onDidChangeModelContent((function (){
cljs.core.reset_BANG_(ignore_change_QMARK_,true);

var new_val_30708 = editor.getValue();
var temp__5825__auto___30709 = cljs.core.deref(on_change_ref);
if(cljs.core.truth_(temp__5825__auto___30709)){
var handler_30710 = temp__5825__auto___30709;
if(cljs.core.vector_QMARK_(handler_30710)){
re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(handler_30710,new_val_30708));
} else {
(handler_30710.cljs$core$IFn$_invoke$arity$1 ? handler_30710.cljs$core$IFn$_invoke$arity$1(new_val_30708) : handler_30710.call(null,new_val_30708));
}
} else {
}
...
cljs.core.reset_BANG_(subscription,sub_30707);
...
}catch (e30659){if((e30659 instanceof Error)){
var e = e30659;
...
}}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (this$,p__30681){
var vec__30682 = p__30681;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30682,(0),null);
var old_props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30682,(1),null);
var map__30685 = reagent.core.props(this$);
var map__30685__$1 = cljs.core.__destructure_map(map__30685);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30685__$1,new cljs.core.Keyword(null,"value","value",305978217));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30685__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30685__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30685__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30685__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var lang_30725 = (function (){var or__5025__auto__ = language;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
var G__30686 = mode;
...
var model_30726 = editor.getModel();
var current_lang_30727 = (cljs.core.truth_(model_30726)?model_30726.getLanguageId():null);
if(cljs.core.truth_((function (){var and__5023__auto__ = model_30726;
if(cljs.core.truth_(and__5023__auto__)){
var and__5023__auto____$1 = lang_30725;
if(cljs.core.truth_(and__5023__auto____$1)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(current_lang_30727,lang_30725);
} else {
...
shadow.js.shim.module$monaco_editor$esm$vs$editor$editor_api.editor.setModelLanguage(model_30726,lang_30725);
} else {
}
...
var temp__5825__auto___30729 = cljs.core.deref(subscription);
if(cljs.core.truth_(temp__5825__auto___30729)){
var sub_30730 = temp__5825__auto___30729;
sub_30730.dispose();
} else {
}
...
var map__30690 = props;
var map__30690__$1 = cljs.core.__destructure_map(map__30690);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30690__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30690__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var G__30695 = bb_web_ds_tools.components.editor.get_code_to_eval(ed);
return (eval_action.cljs$core$IFn$_invoke$arity$1 ? eval_action.cljs$core$IFn$_invoke$arity$1(G__30695) : eval_action.call(null,G__30695));
})], null)));
});
/**
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$components$editor$render_output_$_iter__30696(s__30697){
return (new cljs.core.LazySeq(null,(function (){
var s__30697__$1 = s__30697;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__30697__$1);
if(temp__5825__auto__){
var s__30697__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__30697__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__30697__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__30699 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__30698 = (0);
while(true){
if((i__30698 < size__5502__auto__)){
var map__30702 = cljs.core._nth(c__5501__auto__,i__30698);
var map__30702__$1 = cljs.core.__destructure_map(map__30702);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30702__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30702__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
cljs.core.chunk_append(b__30699,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__30703 = type;
var G__30703__$1 = (((G__30703 instanceof cljs.core.Keyword))?G__30703.fqn:null);
switch (G__30703__$1) {
case "result":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30703__$1)].join('')));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30699),bb_web_ds_tools$components$editor$render_output_$_iter__30696(cljs.core.chunk_rest(s__30697__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30699),null);
}
} else {
var map__30704 = cljs.core.first(s__30697__$2);
var map__30704__$1 = cljs.core.__destructure_map(map__30704);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30704__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30704__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__30705 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30705__$1)].join('')));

}
})()], null),text], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.random_uuid()], null)),bb_web_ds_tools$components$editor$render_output_$_iter__30696(cljs.core.rest(s__30697__$2)));
}
} else {
return null;
}
