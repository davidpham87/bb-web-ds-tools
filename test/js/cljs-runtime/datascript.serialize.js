...
if((!((next_attr == null)))){
var G__62609 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(attrs,next_attr);
attrs = G__62609;
continue;
} else {
 ...
 * avet     :: [<index in eavt> ...]
 */
datascript.serialize.serializable_impl = (function datascript$serialize$serializable_impl(db,p__62466){
var map__62467 = p__62466;
var map__62467__$1 = cljs.core.__destructure_map(map__62467);
var freeze_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__62467__$1,new cljs.core.Keyword(null,"freeze-fn","freeze-fn",-575885995),cljs.core.pr_str);
var freeze_kw = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__62467__$1,new cljs.core.Keyword(null,"freeze-kw","freeze-kw",391758233),datascript.serialize.freeze_kw);
...
var e = d.e;
var a = (function (){var G__62493 = d.a;
return (attrs_map.cljs$core$IFn$_invoke$arity$1 ? attrs_map.cljs$core$IFn$_invoke$arity$1(G__62493) : attrs_map.call(null,G__62493));
})();
var v = write_v(d.v);
...
var schema = (function (){var G__62506 = new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1(db);
return (freeze_fn.cljs$core$IFn$_invoke$arity$1 ? freeze_fn.cljs$core$IFn$_invoke$arity$1(G__62506) : freeze_fn.call(null,G__62506));
})();
...
var pred__62550 = cljs.core._EQ__EQ_;
var expr__62551 = marker;
if(cljs.core.truth_((pred__62550.cljs$core$IFn$_invoke$arity$2 ? pred__62550.cljs$core$IFn$_invoke$arity$2((0),expr__62551) : pred__62550.call(null,(0),expr__62551)))){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(keywords,datascript.serialize.array_get(v,(1)));
} else {
if(cljs.core.truth_((pred__62550.cljs$core$IFn$_invoke$arity$2 ? pred__62550.cljs$core$IFn$_invoke$arity$2((1),expr__62551) : pred__62550.call(null,(1),expr__62551)))){
var G__62554 = datascript.serialize.array_get(v,(1));
return (thaw_fn.cljs$core$IFn$_invoke$arity$1 ? thaw_fn.cljs$core$IFn$_invoke$arity$1(G__62554) : thaw_fn.call(null,G__62554));
} else {
if(cljs.core.truth_((pred__62550.cljs$core$IFn$_invoke$arity$2 ? pred__62550.cljs$core$IFn$_invoke$arity$2((2),expr__62551) : pred__62550.call(null,(2),expr__62551)))){
return Infinity;
} else {
if(cljs.core.truth_((pred__62550.cljs$core$IFn$_invoke$arity$2 ? pred__62550.cljs$core$IFn$_invoke$arity$2((3),expr__62551) : pred__62550.call(null,(3),expr__62551)))){
return -Infinity;
} else {
if(cljs.core.truth_((pred__62550.cljs$core$IFn$_invoke$arity$2 ? pred__62550.cljs$core$IFn$_invoke$arity$2((4),expr__62551) : pred__62550.call(null,(4),expr__62551)))){
return NaN;
} else {
...
var aevt = (function (){var G__62567 = datascript.serialize.dict_get(from,"aevt");
if((G__62567 == null)){
return null;
} else {
return datascript.serialize.amap((function (p1__62522_SHARP_){
return (eavt[p1__62522_SHARP_]);
}),G__62567);
}
})();
var avet = (function (){var G__62568 = datascript.serialize.dict_get(from,"avet");
if((G__62568 == null)){
return null;
} else {
return datascript.serialize.amap((function (p1__62523_SHARP_){
return (eavt[p1__62523_SHARP_]);
}),G__62568);
}
})();
var settings = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"branching-factor","branching-factor",1903198601),datascript.serialize.dict_get(from,"branching-factor"),new cljs.core.Keyword(null,"ref-type","ref-type",-1367328851),(function (){var G__62570 = datascript.serialize.dict_get(from,"ref-type");
if((G__62570 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__62570);
}
