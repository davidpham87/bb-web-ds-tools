...
if((!((next_attr == null)))){
var G__62597 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(attrs,next_attr);
attrs = G__62597;
continue;
} else {
 ...
 * avet     :: [<index in eavt> ...]
 */
datascript.serialize.serializable_impl = (function datascript$serialize$serializable_impl(db,p__62515){
var map__62516 = p__62515;
var map__62516__$1 = cljs.core.__destructure_map(map__62516);
var freeze_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__62516__$1,new cljs.core.Keyword(null,"freeze-fn","freeze-fn",-575885995),cljs.core.pr_str);
var freeze_kw = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__62516__$1,new cljs.core.Keyword(null,"freeze-kw","freeze-kw",391758233),datascript.serialize.freeze_kw);
...
var e = d.e;
var a = (function (){var G__62532 = d.a;
return (attrs_map.cljs$core$IFn$_invoke$arity$1 ? attrs_map.cljs$core$IFn$_invoke$arity$1(G__62532) : attrs_map.call(null,G__62532));
})();
var v = write_v(d.v);
...
var schema = (function (){var G__62537 = new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1(db);
return (freeze_fn.cljs$core$IFn$_invoke$arity$1 ? freeze_fn.cljs$core$IFn$_invoke$arity$1(G__62537) : freeze_fn.call(null,G__62537));
})();
...
var pred__62571 = cljs.core._EQ__EQ_;
var expr__62572 = marker;
if(cljs.core.truth_((pred__62571.cljs$core$IFn$_invoke$arity$2 ? pred__62571.cljs$core$IFn$_invoke$arity$2((0),expr__62572) : pred__62571.call(null,(0),expr__62572)))){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(keywords,datascript.serialize.array_get(v,(1)));
} else {
if(cljs.core.truth_((pred__62571.cljs$core$IFn$_invoke$arity$2 ? pred__62571.cljs$core$IFn$_invoke$arity$2((1),expr__62572) : pred__62571.call(null,(1),expr__62572)))){
var G__62574 = datascript.serialize.array_get(v,(1));
return (thaw_fn.cljs$core$IFn$_invoke$arity$1 ? thaw_fn.cljs$core$IFn$_invoke$arity$1(G__62574) : thaw_fn.call(null,G__62574));
} else {
if(cljs.core.truth_((pred__62571.cljs$core$IFn$_invoke$arity$2 ? pred__62571.cljs$core$IFn$_invoke$arity$2((2),expr__62572) : pred__62571.call(null,(2),expr__62572)))){
return Infinity;
} else {
if(cljs.core.truth_((pred__62571.cljs$core$IFn$_invoke$arity$2 ? pred__62571.cljs$core$IFn$_invoke$arity$2((3),expr__62572) : pred__62571.call(null,(3),expr__62572)))){
return -Infinity;
} else {
if(cljs.core.truth_((pred__62571.cljs$core$IFn$_invoke$arity$2 ? pred__62571.cljs$core$IFn$_invoke$arity$2((4),expr__62572) : pred__62571.call(null,(4),expr__62572)))){
return NaN;
} else {
...
var aevt = (function (){var G__62585 = datascript.serialize.dict_get(from,"aevt");
if((G__62585 == null)){
return null;
} else {
return datascript.serialize.amap((function (p1__62554_SHARP_){
return (eavt[p1__62554_SHARP_]);
}),G__62585);
}
})();
var avet = (function (){var G__62586 = datascript.serialize.dict_get(from,"avet");
if((G__62586 == null)){
return null;
} else {
return datascript.serialize.amap((function (p1__62555_SHARP_){
return (eavt[p1__62555_SHARP_]);
}),G__62586);
}
})();
var settings = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"branching-factor","branching-factor",1903198601),datascript.serialize.dict_get(from,"branching-factor"),new cljs.core.Keyword(null,"ref-type","ref-type",-1367328851),(function (){var G__62587 = datascript.serialize.dict_get(from,"ref-type");
if((G__62587 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__62587);
}
