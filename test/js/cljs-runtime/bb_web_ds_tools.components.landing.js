 ...
 *   
 */
bb_web_ds_tools.components.landing.canvas_card = (function bb_web_ds_tools$components$landing$canvas_card(p__44083){
var map__44084 = p__44083;
var map__44084__$1 = cljs.core.__destructure_map(map__44084);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44084__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44084__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
var route = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44084__$1,new cljs.core.Keyword(null,"route","route",329891309));
var draw_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44084__$1,new cljs.core.Keyword(null,"draw-fn","draw-fn",-1155888705));
...
var map__44103 = cljs.core.deref(dimensions);
var map__44103__$1 = cljs.core.__destructure_map(map__44103);
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44103__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44103__$1,new cljs.core.Keyword(null,"height","height",1025178622));
if((((width > (0))) && ((height > (0))))){
...
var temp__5825__auto___44292 = cljs.core.deref(animation_id);
if(cljs.core.truth_(temp__5825__auto___44292)){
var id_44293 = temp__5825__auto___44292;
cancelAnimationFrame(id_44293);
} else {
}
...
})], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),["relative h-40 w-full ",bb_web_ds_tools.theme.bg_sidebar," border-b ",bb_web_ds_tools.theme.border_main].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"canvas","canvas",-1798817489),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ref","ref",1289896967),(function (p1__44082_SHARP_){
return cljs.core.reset_BANG_(canvas_ref,p1__44082_SHARP_);
...
var offset_44305 = (i * (1000));
var y_pos_44306 = ((-50) + cljs.core.mod(((t + offset_44305) * 0.05),(100)));
var x_pos_44307 = (cx + ((60) * Math.sin(((t + offset_44305) * 0.002))));
if((((y_pos_44306 > (-50))) && ((y_pos_44306 < (50))))){
ctx.beginPath();

ctx.arc(x_pos_44307,(cy + y_pos_44306),(3),(0),(Math.PI * (2)));
...
var n__5616__auto___44313 = total_lines;
var i_44314 = (0);
while(true){
if((i_44314 < n__5616__auto___44313)){
var y_44316 = (start_y + (i_44314 * line_h));
var chars_44317 = (function (){var x__5113__auto__ = chars_per_line;
var y__5114__auto__ = (function (){var x__5110__auto__ = (0);
var y__5111__auto__ = (typer_pos - (i_44314 * chars_per_line));
return ((x__5110__auto__ > y__5111__auto__) ? x__5110__auto__ : y__5111__auto__);
})();
return ((x__5113__auto__ < y__5114__auto__) ? x__5113__auto__ : y__5114__auto__);
})();
if((chars_44317 > (0))){
(ctx.fillStyle = ((cljs.core.even_QMARK_(i_44314))?new cljs.core.Keyword("bb-web-ds-tools.theme","keyword","bb-web-ds-tools.theme/keyword",6462773).cljs$core$IFn$_invoke$arity$1(bb_web_ds_tools.components.landing.zenburn):new cljs.core.Keyword("bb-web-ds-tools.theme","string","bb-web-ds-tools.theme/string",1496885044).cljs$core$IFn$_invoke$arity$1(bb_web_ds_tools.components.landing.zenburn)));

ctx.fillRect(start_x,y_44316,(chars_44317 * (5)),(8));
} else {
}

var G__44318 = (i_44314 + (1));
i_44314 = G__44318;
continue;
} else {
}
...
while(true){
if((i < n__5616__auto__)){
var freq_44322 = (0.002 + (i * 0.001));
var height_44323 = ((30) + ((40) * Math.abs(Math.sin((t * freq_44322)))));
var x_44324 = (start_x + (i * (bar_w + gap)));
var y_44325 = (base_y - height_44323);
...
ctx.fillRect(x_44324,y_44325,bar_w,height_44323);
...
var progress_44334 = cljs.core.mod((t * 0.001),(2));
var p_44335 = (function (){var x__5113__auto__ = (1);
var y__5114__auto__ = progress_44334;
return ((x__5113__auto__ < y__5114__auto__) ? x__5113__auto__ : y__5114__auto__);
})();
if((p_44335 > (0))){
ctx.beginPath();
...
var seq__44174 = cljs.core.seq(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),"SELECT",new cljs.core.Keyword("bb-web-ds-tools.theme","keyword","bb-web-ds-tools.theme/keyword",6462773).cljs$core$IFn$_invoke$arity$1(bb_web_ds_tools.components.landing.zenburn)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1),"FROM",new cljs.core.Keyword("bb-web-ds-tools.theme","string","bb-web-ds-tools.theme/string",1496885044).cljs$core$IFn$_invoke$arity$1(bb_web_ds_tools.components.landing.zenburn)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(2),"WHERE",new cljs.core.Keyword("bb-web-ds-tools.theme","number","bb-web-ds-tools.theme/number",-309038900).cljs$core$IFn$_invoke$arity$1(bb_web_ds_tools.components.landing.zenburn)], null)], null));
var chunk__44175 = null;
var count__44176 = (0);
var i__44177 = (0);
while(true){
if((i__44177 < count__44176)){
var vec__44205 = chunk__44175.cljs$core$IIndexed$_nth$arity$2(null,i__44177);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44205,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44205,(1),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44205,(2),null);
var theta_44339 = (angle + (i * ((Math.PI * (2)) / (3))));
var x_44340 = (cx + (orbit_r * Math.cos(theta_44339)));
var y_44341 = (cy + (orbit_r * Math.sin(theta_44339)));
(ctx.fillStyle = color);

(ctx.font = "14px sans-serif");

ctx.fillText(text,x_44340,y_44341);


var G__44342 = seq__44174;
var G__44343 = chunk__44175;
var G__44344 = count__44176;
var G__44345 = (i__44177 + (1));
seq__44174 = G__44342;
chunk__44175 = G__44343;
count__44176 = G__44344;
i__44177 = G__44345;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__44174);
if(temp__5825__auto__){
var seq__44174__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__44174__$1)){
var c__5548__auto__ = cljs.core.chunk_first(seq__44174__$1);
var G__44346 = cljs.core.chunk_rest(seq__44174__$1);
var G__44347 = c__5548__auto__;
var G__44348 = cljs.core.count(c__5548__auto__);
var G__44349 = (0);
seq__44174 = G__44346;
chunk__44175 = G__44347;
count__44176 = G__44348;
i__44177 = G__44349;
continue;
} else {
var vec__44208 = cljs.core.first(seq__44174__$1);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44208,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44208,(1),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44208,(2),null);
var theta_44350 = (angle + (i * ((Math.PI * (2)) / (3))));
var x_44351 = (cx + (orbit_r * Math.cos(theta_44350)));
var y_44352 = (cy + (orbit_r * Math.sin(theta_44350)));
(ctx.fillStyle = color);

(ctx.font = "14px sans-serif");

ctx.fillText(text,x_44351,y_44352);


var G__44353 = cljs.core.next(seq__44174__$1);
var G__44354 = null;
var G__44355 = (0);
var G__44356 = (0);
seq__44174 = G__44353;
chunk__44175 = G__44354;
count__44176 = G__44355;
i__44177 = G__44356;
continue;
}
} else {
...
var n__5616__auto___44357 = (100);
var i_44358 = (0);
while(true){
if((i_44358 < n__5616__auto___44357)){
var x_44359 = ((cx - (100)) + (i_44358 * (2)));
var y_44360 = (cy + ((40) * Math.sin(((i_44358 * 0.1) + (t * 0.005)))));
if((i_44358 === (0))){
ctx.moveTo(x_44359,y_44360);
} else {
ctx.lineTo(x_44359,y_44360);
}

var G__44376 = (i_44358 + (1));
i_44358 = G__44376;
continue;
} else {
}
...
while(true){
if((i < n__5616__auto__)){
var offset_44377 = (i * (20));
var x_44378 = ((cx - (100)) + (offset_44377 * (2)));
var y_44379 = (cy + ((40) * Math.sin(((offset_44377 * 0.1) + (t * 0.005)))));
ctx.beginPath();

ctx.arc(x_44378,y_44379,(4),(0),(Math.PI * (2)));
...
var blink_44381 = cljs.core.mod((t * 5.0E-4),(5));
if((blink_44381 > 4.8)){
(ctx.fillStyle = new cljs.core.Keyword("bb-web-ds-tools.theme","diff-add","bb-web-ds-tools.theme/diff-add",-617408210).cljs$core$IFn$_invoke$arity$1(bb_web_ds_tools.components.landing.zenburn));
...
var outer_r_44382 = r;
var inner_r_44383 = (r * 0.8);
var hole_r_44384 = (r * 0.3);
var n__5616__auto___44385 = (teeth * (2));
var i_44386 = (0);
while(true){
if((i_44386 < n__5616__auto___44385)){
var angle_44390 = (i_44386 * (Math.PI / teeth));
var rad_44391 = ((cljs.core.even_QMARK_(i_44386))?outer_r_44382:inner_r_44383);
ctx.lineTo((rad_44391 * Math.cos(angle_44390)),(rad_44391 * Math.sin(angle_44390)));

var G__44392 = (i_44386 + (1));
i_44386 = G__44392;
continue;
} else {
}
...
ctx.arc((0),(0),hole_r_44384,(0),(Math.PI * (2)));
...
var seq__44230 = cljs.core.seq(cljs.core.range.cljs$core$IFn$_invoke$arity$1((10)));
var chunk__44231 = null;
var count__44232 = (0);
var i__44233 = (0);
while(true){
if((i__44233 < count__44232)){
var i = chunk__44231.cljs$core$IIndexed$_nth$arity$2(null,i__44233);
var y_44395 = (((200) + (i * (20))) - scroll_y);
if((((y_44395 > (0))) && ((y_44395 < (200))))){
ctx.fillText(["- Update ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)," fixed stuff"].join(''),(20),y_44395);
} else {
}


var G__44396 = seq__44230;
var G__44397 = chunk__44231;
var G__44398 = count__44232;
var G__44399 = (i__44233 + (1));
seq__44230 = G__44396;
chunk__44231 = G__44397;
count__44232 = G__44398;
i__44233 = G__44399;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__44230);
if(temp__5825__auto__){
var seq__44230__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__44230__$1)){
var c__5548__auto__ = cljs.core.chunk_first(seq__44230__$1);
var G__44400 = cljs.core.chunk_rest(seq__44230__$1);
var G__44401 = c__5548__auto__;
var G__44402 = cljs.core.count(c__5548__auto__);
var G__44403 = (0);
seq__44230 = G__44400;
chunk__44231 = G__44401;
count__44232 = G__44402;
i__44233 = G__44403;
continue;
} else {
var i = cljs.core.first(seq__44230__$1);
var y_44404 = (((200) + (i * (20))) - scroll_y);
if((((y_44404 > (0))) && ((y_44404 < (200))))){
ctx.fillText(["- Update ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)," fixed stuff"].join(''),(20),y_44404);
} else {
}


var G__44405 = cljs.core.next(seq__44230__$1);
var G__44406 = null;
var G__44407 = (0);
var G__44408 = (0);
seq__44230 = G__44405;
chunk__44231 = G__44406;
count__44232 = G__44407;
i__44233 = G__44408;
continue;
}
} else {
