 ...
 *   
 */
bb_web_ds_tools.components.landing.canvas_card = (function bb_web_ds_tools$components$landing$canvas_card(p__44012){
var map__44013 = p__44012;
var map__44013__$1 = cljs.core.__destructure_map(map__44013);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44013__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44013__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
var route = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44013__$1,new cljs.core.Keyword(null,"route","route",329891309));
var draw_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44013__$1,new cljs.core.Keyword(null,"draw-fn","draw-fn",-1155888705));
...
})], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),["relative h-40 w-full ",bb_web_ds_tools.theme.bg_sidebar," border-b ",bb_web_ds_tools.theme.border_main].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"canvas","canvas",-1798817489),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ref","ref",1289896967),(function (p1__44011_SHARP_){
return cljs.core.reset_BANG_(canvas_ref,p1__44011_SHARP_);
...
var offset_44215 = (i * (1000));
var y_pos_44216 = ((-50) + cljs.core.mod(((t + offset_44215) * 0.05),(100)));
var x_pos_44217 = (cx + ((60) * Math.sin(((t + offset_44215) * 0.002))));
if((((y_pos_44216 > (-50))) && ((y_pos_44216 < (50))))){
ctx.beginPath();

ctx.arc(x_pos_44217,(cy + y_pos_44216),(3),(0),(Math.PI * (2)));
...
var n__5616__auto___44223 = total_lines;
var i_44224 = (0);
while(true){
if((i_44224 < n__5616__auto___44223)){
var y_44226 = (start_y + (i_44224 * line_h));
var chars_44227 = (function (){var x__5113__auto__ = chars_per_line;
var y__5114__auto__ = (function (){var x__5110__auto__ = (0);
var y__5111__auto__ = (typer_pos - (i_44224 * chars_per_line));
return ((x__5110__auto__ > y__5111__auto__) ? x__5110__auto__ : y__5111__auto__);
})();
return ((x__5113__auto__ < y__5114__auto__) ? x__5113__auto__ : y__5114__auto__);
})();
if((chars_44227 > (0))){
(ctx.fillStyle = ((cljs.core.even_QMARK_(i_44224))?new cljs.core.Keyword("bb-web-ds-tools.theme","keyword","bb-web-ds-tools.theme/keyword",6462773).cljs$core$IFn$_invoke$arity$1(bb_web_ds_tools.components.landing.zenburn):new cljs.core.Keyword("bb-web-ds-tools.theme","string","bb-web-ds-tools.theme/string",1496885044).cljs$core$IFn$_invoke$arity$1(bb_web_ds_tools.components.landing.zenburn)));

ctx.fillRect(start_x,y_44226,(chars_44227 * (5)),(8));
} else {
}

var G__44228 = (i_44224 + (1));
i_44224 = G__44228;
continue;
} else {
}
...
while(true){
if((i < n__5616__auto__)){
var freq_44232 = (0.002 + (i * 0.001));
var height_44233 = ((30) + ((40) * Math.abs(Math.sin((t * freq_44232)))));
var x_44234 = (start_x + (i * (bar_w + gap)));
var y_44235 = (base_y - height_44233);
...
ctx.fillRect(x_44234,y_44235,bar_w,height_44233);
...
var progress_44237 = cljs.core.mod((t * 0.001),(2));
var p_44238 = (function (){var x__5113__auto__ = (1);
var y__5114__auto__ = progress_44237;
return ((x__5113__auto__ < y__5114__auto__) ? x__5113__auto__ : y__5114__auto__);
})();
if((p_44238 > (0))){
ctx.beginPath();
...
var seq__44080 = cljs.core.seq(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),"SELECT",new cljs.core.Keyword("bb-web-ds-tools.theme","keyword","bb-web-ds-tools.theme/keyword",6462773).cljs$core$IFn$_invoke$arity$1(bb_web_ds_tools.components.landing.zenburn)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1),"FROM",new cljs.core.Keyword("bb-web-ds-tools.theme","string","bb-web-ds-tools.theme/string",1496885044).cljs$core$IFn$_invoke$arity$1(bb_web_ds_tools.components.landing.zenburn)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(2),"WHERE",new cljs.core.Keyword("bb-web-ds-tools.theme","number","bb-web-ds-tools.theme/number",-309038900).cljs$core$IFn$_invoke$arity$1(bb_web_ds_tools.components.landing.zenburn)], null)], null));
var chunk__44081 = null;
var count__44082 = (0);
var i__44083 = (0);
while(true){
if((i__44083 < count__44082)){
var vec__44107 = chunk__44081.cljs$core$IIndexed$_nth$arity$2(null,i__44083);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44107,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44107,(1),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44107,(2),null);
var theta_44244 = (angle + (i * ((Math.PI * (2)) / (3))));
var x_44245 = (cx + (orbit_r * Math.cos(theta_44244)));
var y_44246 = (cy + (orbit_r * Math.sin(theta_44244)));
(ctx.fillStyle = color);

(ctx.font = "14px sans-serif");

ctx.fillText(text,x_44245,y_44246);


var G__44247 = seq__44080;
var G__44248 = chunk__44081;
var G__44249 = count__44082;
var G__44250 = (i__44083 + (1));
seq__44080 = G__44247;
chunk__44081 = G__44248;
count__44082 = G__44249;
i__44083 = G__44250;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__44080);
if(temp__5825__auto__){
var seq__44080__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__44080__$1)){
var c__5548__auto__ = cljs.core.chunk_first(seq__44080__$1);
var G__44251 = cljs.core.chunk_rest(seq__44080__$1);
var G__44252 = c__5548__auto__;
var G__44253 = cljs.core.count(c__5548__auto__);
var G__44254 = (0);
seq__44080 = G__44251;
chunk__44081 = G__44252;
count__44082 = G__44253;
i__44083 = G__44254;
continue;
} else {
var vec__44126 = cljs.core.first(seq__44080__$1);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44126,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44126,(1),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44126,(2),null);
var theta_44255 = (angle + (i * ((Math.PI * (2)) / (3))));
var x_44256 = (cx + (orbit_r * Math.cos(theta_44255)));
var y_44257 = (cy + (orbit_r * Math.sin(theta_44255)));
(ctx.fillStyle = color);

(ctx.font = "14px sans-serif");

ctx.fillText(text,x_44256,y_44257);


var G__44258 = cljs.core.next(seq__44080__$1);
var G__44259 = null;
var G__44260 = (0);
var G__44261 = (0);
seq__44080 = G__44258;
chunk__44081 = G__44259;
count__44082 = G__44260;
i__44083 = G__44261;
continue;
}
} else {
...
var n__5616__auto___44263 = (100);
var i_44264 = (0);
while(true){
if((i_44264 < n__5616__auto___44263)){
var x_44265 = ((cx - (100)) + (i_44264 * (2)));
var y_44266 = (cy + ((40) * Math.sin(((i_44264 * 0.1) + (t * 0.005)))));
if((i_44264 === (0))){
ctx.moveTo(x_44265,y_44266);
} else {
ctx.lineTo(x_44265,y_44266);
}

var G__44267 = (i_44264 + (1));
i_44264 = G__44267;
continue;
} else {
}
...
while(true){
if((i < n__5616__auto__)){
var offset_44268 = (i * (20));
var x_44269 = ((cx - (100)) + (offset_44268 * (2)));
var y_44270 = (cy + ((40) * Math.sin(((offset_44268 * 0.1) + (t * 0.005)))));
ctx.beginPath();

ctx.arc(x_44269,y_44270,(4),(0),(Math.PI * (2)));
...
var blink_44273 = cljs.core.mod((t * 5.0E-4),(5));
if((blink_44273 > 4.8)){
(ctx.fillStyle = new cljs.core.Keyword("bb-web-ds-tools.theme","diff-add","bb-web-ds-tools.theme/diff-add",-617408210).cljs$core$IFn$_invoke$arity$1(bb_web_ds_tools.components.landing.zenburn));
...
var outer_r_44275 = r;
var inner_r_44276 = (r * 0.8);
var hole_r_44277 = (r * 0.3);
var n__5616__auto___44278 = (teeth * (2));
var i_44279 = (0);
while(true){
if((i_44279 < n__5616__auto___44278)){
var angle_44281 = (i_44279 * (Math.PI / teeth));
var rad_44282 = ((cljs.core.even_QMARK_(i_44279))?outer_r_44275:inner_r_44276);
ctx.lineTo((rad_44282 * Math.cos(angle_44281)),(rad_44282 * Math.sin(angle_44281)));

var G__44283 = (i_44279 + (1));
i_44279 = G__44283;
continue;
} else {
}
...
ctx.arc((0),(0),hole_r_44277,(0),(Math.PI * (2)));
...
var seq__44162 = cljs.core.seq(cljs.core.range.cljs$core$IFn$_invoke$arity$1((10)));
var chunk__44163 = null;
var count__44164 = (0);
var i__44165 = (0);
while(true){
if((i__44165 < count__44164)){
var i = chunk__44163.cljs$core$IIndexed$_nth$arity$2(null,i__44165);
var y_44284 = (((200) + (i * (20))) - scroll_y);
if((((y_44284 > (0))) && ((y_44284 < (200))))){
ctx.fillText(["- Update ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)," fixed stuff"].join(''),(20),y_44284);
} else {
}


var G__44288 = seq__44162;
var G__44289 = chunk__44163;
var G__44290 = count__44164;
var G__44291 = (i__44165 + (1));
seq__44162 = G__44288;
chunk__44163 = G__44289;
count__44164 = G__44290;
i__44165 = G__44291;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__44162);
if(temp__5825__auto__){
var seq__44162__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__44162__$1)){
var c__5548__auto__ = cljs.core.chunk_first(seq__44162__$1);
var G__44292 = cljs.core.chunk_rest(seq__44162__$1);
var G__44293 = c__5548__auto__;
var G__44294 = cljs.core.count(c__5548__auto__);
var G__44295 = (0);
seq__44162 = G__44292;
chunk__44163 = G__44293;
count__44164 = G__44294;
i__44165 = G__44295;
continue;
} else {
var i = cljs.core.first(seq__44162__$1);
var y_44296 = (((200) + (i * (20))) - scroll_y);
if((((y_44296 > (0))) && ((y_44296 < (200))))){
ctx.fillText(["- Update ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)," fixed stuff"].join(''),(20),y_44296);
} else {
}


var G__44297 = cljs.core.next(seq__44162__$1);
var G__44298 = null;
var G__44299 = (0);
var G__44300 = (0);
seq__44162 = G__44297;
chunk__44163 = G__44298;
count__44164 = G__44299;
i__44165 = G__44300;
continue;
}
} else {
