...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__67239_SHARP_){
return html_coll.item(p1__67239_SHARP_);
...
return cljs.core.some((function (p1__67240_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("icon",p1__67240_SHARP_);
...
var ctx_67246 = cvs.getContext("2d");
(ctx_67246.fillStyle = color);

ctx_67246.fillRect((0),(0),size,size);
