...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__67147_SHARP_){
return html_coll.item(p1__67147_SHARP_);
...
return cljs.core.some((function (p1__67148_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("icon",p1__67148_SHARP_);
...
var ctx_67151 = cvs.getContext("2d");
(ctx_67151.fillStyle = color);

ctx_67151.fillRect((0),(0),size,size);
