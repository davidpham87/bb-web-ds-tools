...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__65569_SHARP_){
return html_coll.item(p1__65569_SHARP_);
...
return cljs.core.some((function (p1__65570_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("icon",p1__65570_SHARP_);
...
var ctx_65591 = cvs.getContext("2d");
(ctx_65591.fillStyle = color);

ctx_65591.fillRect((0),(0),size,size);
