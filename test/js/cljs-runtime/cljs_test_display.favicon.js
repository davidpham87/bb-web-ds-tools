...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__68845_SHARP_){
return html_coll.item(p1__68845_SHARP_);
...
return cljs.core.some((function (p1__68847_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("icon",p1__68847_SHARP_);
...
var ctx_68912 = cvs.getContext("2d");
(ctx_68912.fillStyle = color);

ctx_68912.fillRect((0),(0),size,size);
