...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__65509_SHARP_){
return html_coll.item(p1__65509_SHARP_);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("icon",p1__65510_SHARP_);
...
var ctx_65543 = cvs.getContext("2d");
(ctx_65543.fillStyle = color);

ctx_65543.fillRect((0),(0),size,size);
