...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__68687_SHARP_){
return html_coll.item(p1__68687_SHARP_);
...
return cljs.core.some((function (p1__68689_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("icon",p1__68689_SHARP_);
...
var ctx_68710 = cvs.getContext("2d");
(ctx_68710.fillStyle = color);

ctx_68710.fillRect((0),(0),size,size);
