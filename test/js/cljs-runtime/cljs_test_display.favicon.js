...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__68118_SHARP_){
return html_coll.item(p1__68118_SHARP_);
...
return cljs.core.some((function (p1__68120_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("icon",p1__68120_SHARP_);
...
var ctx_68129 = cvs.getContext("2d");
(ctx_68129.fillStyle = color);

ctx_68129.fillRect((0),(0),size,size);
