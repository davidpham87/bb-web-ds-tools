...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__65026_SHARP_){
return html_coll.item(p1__65026_SHARP_);
...
return cljs.core.some((function (p1__65029_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("icon",p1__65029_SHARP_);
...
var ctx_65104 = cvs.getContext("2d");
(ctx_65104.fillStyle = color);

ctx_65104.fillRect((0),(0),size,size);
