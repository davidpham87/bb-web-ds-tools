...
var _STAR_print_newline_STAR__orig_val__52602_52676 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__52603_52677 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__52604_52678 = true;
var _STAR_print_fn_STAR__temp_val__52605_52679 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__52604_52678);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__52605_52679);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__52603_52677);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__52602_52676);
}
...
var type = first__52614;
var tail = seq__52613__$1;
var vec__52615 = ((cljs.core.map_QMARK_(cljs.core.first(tail)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(tail),cljs.core.rest(tail)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,tail], null));
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52615,(0),null);
var entries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52615,(1),null);
...
var vec__52618 = ((has_props_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.second(entry),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(entry,(2))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.second(entry)], null));
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52618,(0),null);
var v_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52618,(1),null);
var vals = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52611_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__52611_SHARP_,k);
}),maps);
...
var G__52622 = cljs.core.first(schema);
var fexpr__52621 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"sequential","sequential",-1082983960),null,new cljs.core.Keyword(null,"vector","vector",1902966158),null,new cljs.core.Keyword(null,"set","set",304602554),null], null), null);
return (fexpr__52621.cljs$core$IFn$_invoke$arity$1 ? fexpr__52621.cljs$core$IFn$_invoke$arity$1(G__52622) : fexpr__52621.call(null,G__52622));
} else {
return and__5023__auto__;
}
})())){
var vec__52623 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52623,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52623,(1),null);
...
var vec__52626 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52626,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52626,(1),null);
...
var G__52629 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(node);
...
if(cljs.core.truth_((function (){var fexpr__52636 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("time","local-date","time/local-date",1831222439),null,new cljs.core.Keyword("time","local-date-time","time/local-date-time",-1739557259),null,new cljs.core.Keyword("time","instant","time/instant",641198777),null], null), null);
return (fexpr__52636.cljs$core$IFn$_invoke$arity$1 ? fexpr__52636.cljs$core$IFn$_invoke$arity$1(s_type) : fexpr__52636.call(null,s_type));
})())){
var times = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__52633_SHARP_){
return (!((p1__52633_SHARP_ == null)));
}),d);
 ...
 */
bb_web_ds_tools.components.malli.inference_panel = (function bb_web_ds_tools$components$malli$inference_panel(p__52644){
var map__52645 = p__52644;
var map__52645__$1 = cljs.core.__destructure_map(map__52645);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52645__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52645__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_infer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52645__$1,new cljs.core.Keyword(null,"on-infer","on-infer",78181482));
var inferred_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52645__$1,new cljs.core.Keyword(null,"inferred-schema","inferred-schema",1558411545));
 ...
 *       vector: A hiccup vector.
 */
bb_web_ds_tools.components.malli.generation_panel = (function bb_web_ds_tools$components$malli$generation_panel(p__52646){
var map__52648 = p__52646;
var map__52648__$1 = cljs.core.__destructure_map(map__52648);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52648__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52648__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_generate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52648__$1,new cljs.core.Keyword(null,"on-generate","on-generate",-1231561477));
var generated_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52648__$1,new cljs.core.Keyword(null,"generated-data","generated-data",-924406973));
