...
var _STAR_print_newline_STAR__orig_val__60593_60677 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__60594_60678 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__60595_60679 = true;
var _STAR_print_fn_STAR__temp_val__60596_60680 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__60595_60679);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__60596_60680);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__60594_60678);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__60593_60677);
}
...
var output = (function (){var G__60601 = format;
var G__60601__$1 = (((G__60601 instanceof cljs.core.Keyword))?G__60601.fqn:null);
switch (G__60601__$1) {
case "edn":
...
var type = first__60607;
var tail = seq__60606__$1;
var vec__60608 = ((cljs.core.map_QMARK_(cljs.core.first(tail)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(tail),cljs.core.rest(tail)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,tail], null));
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60608,(0),null);
var entries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60608,(1),null);
...
var vec__60613 = ((has_props_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.second(entry),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(entry,(2))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.second(entry)], null));
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60613,(0),null);
var v_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60613,(1),null);
var vals = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__60603_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__60603_SHARP_,k);
}),maps);
...
var G__60619 = cljs.core.first(schema);
var fexpr__60618 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"sequential","sequential",-1082983960),null,new cljs.core.Keyword(null,"vector","vector",1902966158),null,new cljs.core.Keyword(null,"set","set",304602554),null], null), null);
return (fexpr__60618.cljs$core$IFn$_invoke$arity$1 ? fexpr__60618.cljs$core$IFn$_invoke$arity$1(G__60619) : fexpr__60618.call(null,G__60619));
} else {
return and__5023__auto__;
}
})())){
var vec__60621 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60621,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60621,(1),null);
...
var vec__60626 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60626,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60626,(1),null);
...
var G__60633 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(node);
var G__60633__$1 = (((G__60633 instanceof cljs.core.Keyword))?G__60633.fqn:null);
switch (G__60633__$1) {
case "map":
...
if(cljs.core.truth_((function (){var fexpr__60646 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("time","local-date","time/local-date",1831222439),null,new cljs.core.Keyword("time","local-date-time","time/local-date-time",-1739557259),null,new cljs.core.Keyword("time","instant","time/instant",641198777),null], null), null);
return (fexpr__60646.cljs$core$IFn$_invoke$arity$1 ? fexpr__60646.cljs$core$IFn$_invoke$arity$1(s_type) : fexpr__60646.call(null,s_type));
})())){
var times = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__60638_SHARP_){
return (!((p1__60638_SHARP_ == null)));
}),d);
...
var data = (function (){var G__60656 = format;
 ...
 */
bb_web_ds_tools.components.malli.inference_panel = (function bb_web_ds_tools$components$malli$inference_panel(p__60664){
var map__60665 = p__60664;
var map__60665__$1 = cljs.core.__destructure_map(map__60665);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60665__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60665__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_infer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60665__$1,new cljs.core.Keyword(null,"on-infer","on-infer",78181482));
var inferred_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60665__$1,new cljs.core.Keyword(null,"inferred-schema","inferred-schema",1558411545));
 ...
 *       vector: A hiccup vector.
 */
bb_web_ds_tools.components.malli.generation_panel = (function bb_web_ds_tools$components$malli$generation_panel(p__60667){
var map__60668 = p__60667;
var map__60668__$1 = cljs.core.__destructure_map(map__60668);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60668__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60668__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_generate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60668__$1,new cljs.core.Keyword(null,"on-generate","on-generate",-1231561477));
var generated_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60668__$1,new cljs.core.Keyword(null,"generated-data","generated-data",-924406973));
