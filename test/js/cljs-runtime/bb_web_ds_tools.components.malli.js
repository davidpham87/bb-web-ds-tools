...
var _STAR_print_newline_STAR__orig_val__52619_52709 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__52620_52710 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__52621_52711 = true;
var _STAR_print_fn_STAR__temp_val__52622_52712 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__52621_52711);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__52622_52712);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__52620_52710);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__52619_52709);
}
...
var output = (function (){var G__52629 = format;
var G__52629__$1 = (((G__52629 instanceof cljs.core.Keyword))?G__52629.fqn:null);
switch (G__52629__$1) {
case "edn":
...
var vec__52631 = schema;
var seq__52632 = cljs.core.seq(vec__52631);
var first__52633 = cljs.core.first(seq__52632);
var seq__52632__$1 = cljs.core.next(seq__52632);
var type = first__52633;
var tail = seq__52632__$1;
var vec__52634 = ((cljs.core.map_QMARK_(cljs.core.first(tail)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(tail),cljs.core.rest(tail)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,tail], null));
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52634,(0),null);
var entries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52634,(1),null);
...
var vec__52637 = ((has_props_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.second(entry),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(entry,(2))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.second(entry)], null));
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52637,(0),null);
var v_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52637,(1),null);
var vals = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52630_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__52630_SHARP_,k);
}),maps);
...
var G__52641 = cljs.core.first(schema);
var fexpr__52640 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"sequential","sequential",-1082983960),null,new cljs.core.Keyword(null,"vector","vector",1902966158),null,new cljs.core.Keyword(null,"set","set",304602554),null], null), null);
return (fexpr__52640.cljs$core$IFn$_invoke$arity$1 ? fexpr__52640.cljs$core$IFn$_invoke$arity$1(G__52641) : fexpr__52640.call(null,G__52641));
} else {
return and__5023__auto__;
}
})())){
var vec__52642 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52642,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52642,(1),null);
...
var vec__52645 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52645,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52645,(1),null);
...
var G__52648 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(node);
...
if(cljs.core.truth_((function (){var fexpr__52671 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("time","local-date","time/local-date",1831222439),null,new cljs.core.Keyword("time","local-date-time","time/local-date-time",-1739557259),null,new cljs.core.Keyword("time","instant","time/instant",641198777),null], null), null);
return (fexpr__52671.cljs$core$IFn$_invoke$arity$1 ? fexpr__52671.cljs$core$IFn$_invoke$arity$1(s_type) : fexpr__52671.call(null,s_type));
})())){
var times = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__52650_SHARP_){
return (!((p1__52650_SHARP_ == null)));
}),d);
 ...
 */
bb_web_ds_tools.components.malli.inference_panel = (function bb_web_ds_tools$components$malli$inference_panel(p__52699){
var map__52700 = p__52699;
var map__52700__$1 = cljs.core.__destructure_map(map__52700);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52700__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52700__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_infer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52700__$1,new cljs.core.Keyword(null,"on-infer","on-infer",78181482));
var inferred_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52700__$1,new cljs.core.Keyword(null,"inferred-schema","inferred-schema",1558411545));
 ...
 *       vector: A hiccup vector.
 */
bb_web_ds_tools.components.malli.generation_panel = (function bb_web_ds_tools$components$malli$generation_panel(p__52706){
var map__52708 = p__52706;
var map__52708__$1 = cljs.core.__destructure_map(map__52708);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52708__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52708__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_generate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52708__$1,new cljs.core.Keyword(null,"on-generate","on-generate",-1231561477));
var generated_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52708__$1,new cljs.core.Keyword(null,"generated-data","generated-data",-924406973));
