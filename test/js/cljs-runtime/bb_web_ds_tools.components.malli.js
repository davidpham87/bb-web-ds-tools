...
var _STAR_print_newline_STAR__orig_val__52602_52665 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__52603_52666 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__52604_52667 = true;
var _STAR_print_fn_STAR__temp_val__52605_52668 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__52604_52667);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__52605_52668);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__52603_52666);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__52602_52665);
}
...
var output = (function (){var G__52609 = format;
...
var type = first__52615;
var tail = seq__52614__$1;
var vec__52616 = ((cljs.core.map_QMARK_(cljs.core.first(tail)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(tail),cljs.core.rest(tail)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,tail], null));
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52616,(0),null);
var entries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52616,(1),null);
...
var vec__52619 = ((has_props_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.second(entry),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(entry,(2))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.second(entry)], null));
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52619,(0),null);
var v_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52619,(1),null);
var vals = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52610_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__52610_SHARP_,k);
}),maps);
...
var G__52623 = cljs.core.first(schema);
var fexpr__52622 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"sequential","sequential",-1082983960),null,new cljs.core.Keyword(null,"vector","vector",1902966158),null,new cljs.core.Keyword(null,"set","set",304602554),null], null), null);
return (fexpr__52622.cljs$core$IFn$_invoke$arity$1 ? fexpr__52622.cljs$core$IFn$_invoke$arity$1(G__52623) : fexpr__52622.call(null,G__52623));
} else {
return and__5023__auto__;
}
})())){
var vec__52624 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52624,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52624,(1),null);
...
var vec__52628 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52628,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52628,(1),null);
...
var G__52631 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(node);
...
if(cljs.core.truth_((function (){var fexpr__52651 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("time","local-date","time/local-date",1831222439),null,new cljs.core.Keyword("time","local-date-time","time/local-date-time",-1739557259),null,new cljs.core.Keyword("time","instant","time/instant",641198777),null], null), null);
return (fexpr__52651.cljs$core$IFn$_invoke$arity$1 ? fexpr__52651.cljs$core$IFn$_invoke$arity$1(s_type) : fexpr__52651.call(null,s_type));
})())){
var times = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__52639_SHARP_){
return (!((p1__52639_SHARP_ == null)));
}),d);
 ...
 */
bb_web_ds_tools.components.malli.inference_panel = (function bb_web_ds_tools$components$malli$inference_panel(p__52658){
var map__52659 = p__52658;
var map__52659__$1 = cljs.core.__destructure_map(map__52659);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52659__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52659__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_infer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52659__$1,new cljs.core.Keyword(null,"on-infer","on-infer",78181482));
var inferred_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52659__$1,new cljs.core.Keyword(null,"inferred-schema","inferred-schema",1558411545));
 ...
 *       vector: A hiccup vector.
 */
bb_web_ds_tools.components.malli.generation_panel = (function bb_web_ds_tools$components$malli$generation_panel(p__52660){
var map__52661 = p__52660;
var map__52661__$1 = cljs.core.__destructure_map(map__52661);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52661__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52661__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_generate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52661__$1,new cljs.core.Keyword(null,"on-generate","on-generate",-1231561477));
var generated_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52661__$1,new cljs.core.Keyword(null,"generated-data","generated-data",-924406973));
