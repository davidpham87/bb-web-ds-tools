...
var _STAR_print_newline_STAR__orig_val__52612_52663 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__52613_52664 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__52614_52665 = true;
var _STAR_print_fn_STAR__temp_val__52615_52666 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__52614_52665);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__52615_52666);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__52613_52664);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__52612_52663);
}
...
var output = (function (){var G__52622 = format;
...
var seq__52625 = cljs.core.seq(vec__52624);
var first__52626 = cljs.core.first(seq__52625);
var seq__52625__$1 = cljs.core.next(seq__52625);
var type = first__52626;
var tail = seq__52625__$1;
var vec__52627 = ((cljs.core.map_QMARK_(cljs.core.first(tail)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(tail),cljs.core.rest(tail)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,tail], null));
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52627,(0),null);
var entries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52627,(1),null);
...
var vec__52630 = ((has_props_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.second(entry),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(entry,(2))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.second(entry)], null));
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52630,(0),null);
var v_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52630,(1),null);
var vals = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52623_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__52623_SHARP_,k);
}),maps);
...
var G__52637 = cljs.core.first(schema);
var fexpr__52636 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"sequential","sequential",-1082983960),null,new cljs.core.Keyword(null,"vector","vector",1902966158),null,new cljs.core.Keyword(null,"set","set",304602554),null], null), null);
return (fexpr__52636.cljs$core$IFn$_invoke$arity$1 ? fexpr__52636.cljs$core$IFn$_invoke$arity$1(G__52637) : fexpr__52636.call(null,G__52637));
} else {
return and__5023__auto__;
}
})())){
var vec__52639 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52639,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52639,(1),null);
...
var G__52645 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(node);
...
var G__52655 = format;
var G__52655__$1 = (((G__52655 instanceof cljs.core.Keyword))?G__52655.fqn:null);
switch (G__52655__$1) {
case "edn":
 ...
 */
bb_web_ds_tools.components.malli.inference_panel = (function bb_web_ds_tools$components$malli$inference_panel(p__52659){
var map__52660 = p__52659;
var map__52660__$1 = cljs.core.__destructure_map(map__52660);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52660__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52660__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_infer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52660__$1,new cljs.core.Keyword(null,"on-infer","on-infer",78181482));
var inferred_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52660__$1,new cljs.core.Keyword(null,"inferred-schema","inferred-schema",1558411545));
 ...
 *       vector: A hiccup vector.
 */
bb_web_ds_tools.components.malli.generation_panel = (function bb_web_ds_tools$components$malli$generation_panel(p__52661){
var map__52662 = p__52661;
var map__52662__$1 = cljs.core.__destructure_map(map__52662);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52662__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52662__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_generate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52662__$1,new cljs.core.Keyword(null,"on-generate","on-generate",-1231561477));
var generated_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52662__$1,new cljs.core.Keyword(null,"generated-data","generated-data",-924406973));
