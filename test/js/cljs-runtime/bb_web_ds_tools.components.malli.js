...
var _STAR_print_newline_STAR__orig_val__37933_38109 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__37934_38110 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__37935_38111 = true;
var _STAR_print_fn_STAR__temp_val__37936_38112 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__37935_38111);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__37936_38112);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__37934_38110);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__37933_38109);
}
...
var output = (function (){var G__37943 = format;
...
var type = first__37951;
var tail = seq__37950__$1;
var vec__37952 = ((cljs.core.map_QMARK_(cljs.core.first(tail)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(tail),cljs.core.rest(tail)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,tail], null));
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37952,(0),null);
var entries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37952,(1),null);
...
var vec__37955 = ((has_props_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.second(entry),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(entry,(2))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.second(entry)], null));
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37955,(0),null);
var v_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37955,(1),null);
var vals = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37944_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__37944_SHARP_,k);
}),maps);
...
var G__37959 = cljs.core.first(schema);
var fexpr__37958 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"sequential","sequential",-1082983960),null,new cljs.core.Keyword(null,"vector","vector",1902966158),null,new cljs.core.Keyword(null,"set","set",304602554),null], null), null);
return (fexpr__37958.cljs$core$IFn$_invoke$arity$1 ? fexpr__37958.cljs$core$IFn$_invoke$arity$1(G__37959) : fexpr__37958.call(null,G__37959));
} else {
return and__5023__auto__;
}
})())){
var vec__37960 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37960,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37960,(1),null);
...
var vec__37963 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37963,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37963,(1),null);
...
var G__37966 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(node);
...
if(cljs.core.truth_((function (){var fexpr__38036 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("time","local-date","time/local-date",1831222439),null,new cljs.core.Keyword("time","local-date-time","time/local-date-time",-1739557259),null,new cljs.core.Keyword("time","instant","time/instant",641198777),null], null), null);
return (fexpr__38036.cljs$core$IFn$_invoke$arity$1 ? fexpr__38036.cljs$core$IFn$_invoke$arity$1(s_type) : fexpr__38036.call(null,s_type));
})())){
var times = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__37974_SHARP_){
return (!((p1__37974_SHARP_ == null)));
}),d);
...
var data = (function (){var G__38055 = format;
var G__38055__$1 = (((G__38055 instanceof cljs.core.Keyword))?G__38055.fqn:null);
switch (G__38055__$1) {
case "edn":
try{return bb_web_ds_tools.components.malli.read_edn(generated_data);
}catch (e38061){var _ = e38061;
return null;
}
break;
case "json":
 ...
 */
bb_web_ds_tools.components.malli.inference_panel = (function bb_web_ds_tools$components$malli$inference_panel(p__38086){
var map__38087 = p__38086;
var map__38087__$1 = cljs.core.__destructure_map(map__38087);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38087__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38087__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_infer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38087__$1,new cljs.core.Keyword(null,"on-infer","on-infer",78181482));
var inferred_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38087__$1,new cljs.core.Keyword(null,"inferred-schema","inferred-schema",1558411545));
 ...
 *       vector: A hiccup vector.
 */
bb_web_ds_tools.components.malli.generation_panel = (function bb_web_ds_tools$components$malli$generation_panel(p__38088){
var map__38089 = p__38088;
var map__38089__$1 = cljs.core.__destructure_map(map__38089);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38089__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38089__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_generate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38089__$1,new cljs.core.Keyword(null,"on-generate","on-generate",-1231561477));
var generated_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38089__$1,new cljs.core.Keyword(null,"generated-data","generated-data",-924406973));
