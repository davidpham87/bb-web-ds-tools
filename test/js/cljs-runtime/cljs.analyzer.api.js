...
try{var _STAR_private_var_access_nowarn_STAR__orig_val__61264 = cljs.analyzer._STAR_private_var_access_nowarn_STAR_;
var _STAR_private_var_access_nowarn_STAR__temp_val__61265 = true;
(cljs.analyzer._STAR_private_var_access_nowarn_STAR_ = _STAR_private_var_access_nowarn_STAR__temp_val__61265);

try{return cljs.analyzer.resolve_var.cljs$core$IFn$_invoke$arity$3(env,sym,cljs.analyzer.confirm_var_exists_throw());
}finally {(cljs.analyzer._STAR_private_var_access_nowarn_STAR_ = _STAR_private_var_access_nowarn_STAR__orig_val__61264);
}}catch (e61262){var e = e61262;
...
(cljs.analyzer.api.the_ns.cljs$core$IFn$_invoke$arity$1 = (function (ns){
return cljs.analyzer.api.the_ns.cljs$core$IFn$_invoke$arity$2(cljs.env._STAR_compiler_STAR_,ns);
}));

(cljs.analyzer.api.the_ns.cljs$core$IFn$_invoke$arity$2 = (function (state,sym){
if((sym instanceof cljs.core.Symbol)){
} else {
throw (new Error("Assert failed: (symbol? sym)"));
}

var or__5025__auto__ = cljs.analyzer.api.find_ns.cljs$core$IFn$_invoke$arity$2(state,sym);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["No namespace found: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sym)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ns","ns",441598760),sym], null));
}
}));

(cljs.analyzer.api.the_ns.cljs$lang$maxFixedArity = 2);
...
var ns__$1 = cljs.analyzer.api.the_ns.cljs$core$IFn$_invoke$arity$2(state,ns);
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"macros","macros",811339431).cljs$core$IFn$_invoke$arity$1(ns__$1),new cljs.core.Keyword(null,"defs","defs",1398449717).cljs$core$IFn$_invoke$arity$1(ns__$1)], 0));
}));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__61327){
var vec__61328 = p__61327;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61328,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61328,(1),null);
