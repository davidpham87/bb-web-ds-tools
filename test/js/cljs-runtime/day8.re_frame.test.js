...
*/
day8.re_frame.test.t_day8$re_frame$test59568 = (function (f,initial_test_context,meta59569){
this.f = f;
this.initial_test_context = initial_test_context;
this.meta59569 = meta59569;
this.cljs$lang$protocol_mask$partition0$ = 393217;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(day8.re_frame.test.t_day8$re_frame$test59568.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_59570,meta59569__$1){
var self__ = this;
var _59570__$1 = this;
return (new day8.re_frame.test.t_day8$re_frame$test59568(self__.f,self__.initial_test_context,meta59569__$1));
}));

(day8.re_frame.test.t_day8$re_frame$test59568.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_59570){
var self__ = this;
var _59570__$1 = this;
return self__.meta59569;
}));

(day8.re_frame.test.t_day8$re_frame$test59568.prototype.cljs$test$IAsyncTest$ = cljs.core.PROTOCOL_SENTINEL);

(day8.re_frame.test.t_day8$re_frame$test59568.prototype.call = (function (unused__11801__auto__){
var self__ = this;
var self__ = this;
var G__59572 = (arguments.length - (1));
switch (G__59572) {
case (1):
...
(day8.re_frame.test.t_day8$re_frame$test59568.prototype.apply = (function (self__,args59571){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args59571)));
}));

(day8.re_frame.test.t_day8$re_frame$test59568.prototype.cljs$core$IFn$_invoke$arity$1 = (function (done){
var self__ = this;
...
(day8.re_frame.test.t_day8$re_frame$test59568.getBasis = (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"f","f",43394975,null),new cljs.core.Symbol(null,"initial-test-context","initial-test-context",385492639,null),new cljs.core.Symbol(null,"meta59569","meta59569",703976783,null)], null);
}));

(day8.re_frame.test.t_day8$re_frame$test59568.cljs$lang$type = true);

(day8.re_frame.test.t_day8$re_frame$test59568.cljs$lang$ctorStr = "day8.re-frame.test/t_day8$re_frame$test59568");

(day8.re_frame.test.t_day8$re_frame$test59568.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"day8.re-frame.test/t_day8$re_frame$test59568");
}));

/**
 * Positional factory function for day8.re-frame.test/t_day8$re_frame$test59568.
 */
day8.re_frame.test.__GT_t_day8$re_frame$test59568 = (function day8$re_frame$test$__GT_t_day8$re_frame$test59568(f,initial_test_context,meta59569){
return (new day8.re_frame.test.t_day8$re_frame$test59568(f,initial_test_context,meta59569));
});
...
return (new day8.re_frame.test.t_day8$re_frame$test59568(f,initial_test_context,null));
});
/**
...
var event_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59574,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59574,(1),null);
...
var map__59577 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(day8.re_frame.test.test_context_STAR_,cljs.core.update,new cljs.core.Keyword(null,"max-wait-for-depth","max-wait-for-depth",639503457),cljs.core.inc);
var map__59577__$1 = cljs.core.__destructure_map(map__59577);
var test_context = map__59577__$1;
var done = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59577__$1,new cljs.core.Keyword(null,"done","done",-889844188));
var wait_for_depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59577__$1,new cljs.core.Keyword(null,"max-wait-for-depth","max-wait-for-depth",639503457));
...
}catch (e59578){var t__11416__auto__ = e59578;
...
var restore_fn__59496__auto__ = re_frame.core.make_restore_fn();
...
var _STAR_handling_STAR__orig_val__59579 = day8.re_frame.test._STAR_handling_STAR_;
var _STAR_handling_STAR__temp_val__59580 = true;
(day8.re_frame.test._STAR_handling_STAR_ = _STAR_handling_STAR__temp_val__59580);
...
}finally {(day8.re_frame.test._STAR_handling_STAR_ = _STAR_handling_STAR__orig_val__59579);
}}
});
var dispatch_orig_val__59581 = re_frame.core.dispatch;
var dispatch_orig_val__59582 = re_frame.router.dispatch;
var dispatch_temp_val__59583 = new_dispatch;
var dispatch_temp_val__59584 = new_dispatch;
(re_frame.core.dispatch = dispatch_temp_val__59583);

(re_frame.router.dispatch = dispatch_temp_val__59584);

try{return (f.cljs$core$IFn$_invoke$arity$0 ? f.cljs$core$IFn$_invoke$arity$0() : f.call(null));
}finally {(re_frame.router.dispatch = dispatch_orig_val__59582);

(re_frame.core.dispatch = dispatch_orig_val__59581);
}}finally {day8.re_frame.test.clear_test_context();

restore_fn__59496__auto__();
}});
