...
*/
day8.re_frame.test.t_day8$re_frame$test59014 = (function (f,initial_test_context,meta59015){
this.f = f;
...
(day8.re_frame.test.t_day8$re_frame$test59014.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_59016,meta59015__$1){
var self__ = this;
var _59016__$1 = this;
return (new day8.re_frame.test.t_day8$re_frame$test59014(self__.f,self__.initial_test_context,meta59015__$1));
}));

(day8.re_frame.test.t_day8$re_frame$test59014.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_59016){
var self__ = this;
var _59016__$1 = this;
return self__.meta59015;
}));

(day8.re_frame.test.t_day8$re_frame$test59014.prototype.cljs$test$IAsyncTest$ = cljs.core.PROTOCOL_SENTINEL);

(day8.re_frame.test.t_day8$re_frame$test59014.prototype.call = (function (unused__11801__auto__){
var self__ = this;
var self__ = this;
var G__59018 = (arguments.length - (1));
switch (G__59018) {
case (1):
...
(day8.re_frame.test.t_day8$re_frame$test59014.prototype.apply = (function (self__,args59017){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args59017)));
}));

(day8.re_frame.test.t_day8$re_frame$test59014.prototype.cljs$core$IFn$_invoke$arity$1 = (function (done){
var self__ = this;
...
(day8.re_frame.test.t_day8$re_frame$test59014.getBasis = (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"f","f",43394975,null),new cljs.core.Symbol(null,"initial-test-context","initial-test-context",385492639,null),new cljs.core.Symbol(null,"meta59015","meta59015",1302135514,null)], null);
}));

(day8.re_frame.test.t_day8$re_frame$test59014.cljs$lang$type = true);

(day8.re_frame.test.t_day8$re_frame$test59014.cljs$lang$ctorStr = "day8.re-frame.test/t_day8$re_frame$test59014");

(day8.re_frame.test.t_day8$re_frame$test59014.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"day8.re-frame.test/t_day8$re_frame$test59014");
}));

/**
 * Positional factory function for day8.re-frame.test/t_day8$re_frame$test59014.
 */
day8.re_frame.test.__GT_t_day8$re_frame$test59014 = (function day8$re_frame$test$__GT_t_day8$re_frame$test59014(f,initial_test_context,meta59015){
return (new day8.re_frame.test.t_day8$re_frame$test59014(f,initial_test_context,meta59015));
});
...
return (new day8.re_frame.test.t_day8$re_frame$test59014(f,initial_test_context,null));
});
/**
...
var event_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59020,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59020,(1),null);
...
var map__59023 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(day8.re_frame.test.test_context_STAR_,cljs.core.update,new cljs.core.Keyword(null,"max-wait-for-depth","max-wait-for-depth",639503457),cljs.core.inc);
var map__59023__$1 = cljs.core.__destructure_map(map__59023);
var test_context = map__59023__$1;
var done = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59023__$1,new cljs.core.Keyword(null,"done","done",-889844188));
var wait_for_depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59023__$1,new cljs.core.Keyword(null,"max-wait-for-depth","max-wait-for-depth",639503457));
...
}catch (e59024){var t__11416__auto__ = e59024;
...
var restore_fn__58942__auto__ = re_frame.core.make_restore_fn();
...
var _STAR_handling_STAR__orig_val__59025 = day8.re_frame.test._STAR_handling_STAR_;
var _STAR_handling_STAR__temp_val__59026 = true;
(day8.re_frame.test._STAR_handling_STAR_ = _STAR_handling_STAR__temp_val__59026);
...
}finally {(day8.re_frame.test._STAR_handling_STAR_ = _STAR_handling_STAR__orig_val__59025);
}}
});
var dispatch_orig_val__59027 = re_frame.core.dispatch;
var dispatch_orig_val__59028 = re_frame.router.dispatch;
var dispatch_temp_val__59029 = new_dispatch;
var dispatch_temp_val__59030 = new_dispatch;
(re_frame.core.dispatch = dispatch_temp_val__59029);

(re_frame.router.dispatch = dispatch_temp_val__59030);

try{return (f.cljs$core$IFn$_invoke$arity$0 ? f.cljs$core$IFn$_invoke$arity$0() : f.call(null));
}finally {(re_frame.router.dispatch = dispatch_orig_val__59028);

(re_frame.core.dispatch = dispatch_orig_val__59027);
}}finally {day8.re_frame.test.clear_test_context();

restore_fn__58942__auto__();
}});
