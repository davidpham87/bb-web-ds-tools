...
*/
datascript.lru.t_datascript$lru60047 = (function (limit,_STAR_impl,meta60048){
this.limit = limit;
...
(datascript.lru.t_datascript$lru60047.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60049,meta60048__$1){
var self__ = this;
var _60049__$1 = this;
return (new datascript.lru.t_datascript$lru60047(self__.limit,self__._STAR_impl,meta60048__$1));
}));

(datascript.lru.t_datascript$lru60047.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60049){
var self__ = this;
var _60049__$1 = this;
return self__.meta60048;
}));

(datascript.lru.t_datascript$lru60047.prototype.datascript$lru$ICache$ = cljs.core.PROTOCOL_SENTINEL);

(datascript.lru.t_datascript$lru60047.prototype.datascript$lru$ICache$_get$arity$3 = (function (_,key,compute_fn){
var self__ = this;
var ___$1 = this;
...
(datascript.lru.t_datascript$lru60047.getBasis = (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"limit","limit",284709164,null),new cljs.core.Symbol(null,"*impl","*impl",1858309677,null),new cljs.core.Symbol(null,"meta60048","meta60048",-1287205711,null)], null);
}));

(datascript.lru.t_datascript$lru60047.cljs$lang$type = true);

(datascript.lru.t_datascript$lru60047.cljs$lang$ctorStr = "datascript.lru/t_datascript$lru60047");

(datascript.lru.t_datascript$lru60047.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"datascript.lru/t_datascript$lru60047");
}));

/**
 * Positional factory function for datascript.lru/t_datascript$lru60047.
 */
datascript.lru.__GT_t_datascript$lru60047 = (function datascript$lru$__GT_t_datascript$lru60047(limit,_STAR_impl,meta60048){
return (new datascript.lru.t_datascript$lru60047(limit,_STAR_impl,meta60048));
});


datascript.lru.cache = (function datascript$lru$cache(limit){
var _STAR_impl = cljs.core.volatile_BANG_(datascript.lru.lru(limit));
return (new datascript.lru.t_datascript$lru60047(limit,_STAR_impl,cljs.core.PersistentArrayMap.EMPTY));
});
