...
var G__59493 = (new datascript.lru.LRU(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_value,k,v),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(gen_key,gen,k),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_gen,k,gen),(gen + (1)),limit));
return (datascript.lru.cleanup_lru.cljs$core$IFn$_invoke$arity$1 ? datascript.lru.cleanup_lru.cljs$core$IFn$_invoke$arity$1(G__59493) : datascript.lru.cleanup_lru.call(null,G__59493));
}
});
...
var gen = lru.gen;
var limit = lru.limit;
var vec__59494 = cljs.core.first(gen_key);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59494,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59494,(1),null);
...
var datascript$lru$ICache$_get$dyn_59512 = (function (this$,key,compute_fn){
...
return datascript$lru$ICache$_get$dyn_59512(this$,key,compute_fn);
}
});
...
*/
datascript.lru.t_datascript$lru59503 = (function (limit,_STAR_impl,meta59504){
this.limit = limit;
this._STAR_impl = _STAR_impl;
this.meta59504 = meta59504;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(datascript.lru.t_datascript$lru59503.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_59505,meta59504__$1){
var self__ = this;
var _59505__$1 = this;
return (new datascript.lru.t_datascript$lru59503(self__.limit,self__._STAR_impl,meta59504__$1));
}));

(datascript.lru.t_datascript$lru59503.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_59505){
var self__ = this;
var _59505__$1 = this;
return self__.meta59504;
}));

(datascript.lru.t_datascript$lru59503.prototype.datascript$lru$ICache$ = cljs.core.PROTOCOL_SENTINEL);

(datascript.lru.t_datascript$lru59503.prototype.datascript$lru$ICache$_get$arity$3 = (function (_,key,compute_fn){
var self__ = this;
var ___$1 = this;
...
(datascript.lru.t_datascript$lru59503.getBasis = (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"limit","limit",284709164,null),new cljs.core.Symbol(null,"*impl","*impl",1858309677,null),new cljs.core.Symbol(null,"meta59504","meta59504",1385469341,null)], null);
}));

(datascript.lru.t_datascript$lru59503.cljs$lang$type = true);

(datascript.lru.t_datascript$lru59503.cljs$lang$ctorStr = "datascript.lru/t_datascript$lru59503");

(datascript.lru.t_datascript$lru59503.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"datascript.lru/t_datascript$lru59503");
}));

/**
 * Positional factory function for datascript.lru/t_datascript$lru59503.
 */
datascript.lru.__GT_t_datascript$lru59503 = (function datascript$lru$__GT_t_datascript$lru59503(limit,_STAR_impl,meta59504){
return (new datascript.lru.t_datascript$lru59503(limit,_STAR_impl,meta59504));
});


datascript.lru.cache = (function datascript$lru$cache(limit){
var _STAR_impl = cljs.core.volatile_BANG_(datascript.lru.lru(limit));
return (new datascript.lru.t_datascript$lru59503(limit,_STAR_impl,cljs.core.PersistentArrayMap.EMPTY));
});
