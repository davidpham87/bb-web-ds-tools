...
var G__60030 = (new datascript.lru.LRU(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_value,k,v),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(gen_key,gen,k),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_gen,k,gen),(gen + (1)),limit));
return (datascript.lru.cleanup_lru.cljs$core$IFn$_invoke$arity$1 ? datascript.lru.cleanup_lru.cljs$core$IFn$_invoke$arity$1(G__60030) : datascript.lru.cleanup_lru.call(null,G__60030));
}
});
...
var gen = lru.gen;
var limit = lru.limit;
var vec__60031 = cljs.core.first(gen_key);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60031,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60031,(1),null);
...
var datascript$lru$ICache$_get$dyn_60037 = (function (this$,key,compute_fn){
...
return datascript$lru$ICache$_get$dyn_60037(this$,key,compute_fn);
}
});
...
*/
datascript.lru.t_datascript$lru60034 = (function (limit,_STAR_impl,meta60035){
this.limit = limit;
this._STAR_impl = _STAR_impl;
this.meta60035 = meta60035;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(datascript.lru.t_datascript$lru60034.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60036,meta60035__$1){
var self__ = this;
var _60036__$1 = this;
return (new datascript.lru.t_datascript$lru60034(self__.limit,self__._STAR_impl,meta60035__$1));
}));

(datascript.lru.t_datascript$lru60034.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60036){
var self__ = this;
var _60036__$1 = this;
return self__.meta60035;
}));

(datascript.lru.t_datascript$lru60034.prototype.datascript$lru$ICache$ = cljs.core.PROTOCOL_SENTINEL);

(datascript.lru.t_datascript$lru60034.prototype.datascript$lru$ICache$_get$arity$3 = (function (_,key,compute_fn){
var self__ = this;
var ___$1 = this;
...
(datascript.lru.t_datascript$lru60034.getBasis = (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"limit","limit",284709164,null),new cljs.core.Symbol(null,"*impl","*impl",1858309677,null),new cljs.core.Symbol(null,"meta60035","meta60035",1323474003,null)], null);
}));

(datascript.lru.t_datascript$lru60034.cljs$lang$type = true);

(datascript.lru.t_datascript$lru60034.cljs$lang$ctorStr = "datascript.lru/t_datascript$lru60034");

(datascript.lru.t_datascript$lru60034.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"datascript.lru/t_datascript$lru60034");
}));

/**
 * Positional factory function for datascript.lru/t_datascript$lru60034.
 */
datascript.lru.__GT_t_datascript$lru60034 = (function datascript$lru$__GT_t_datascript$lru60034(limit,_STAR_impl,meta60035){
return (new datascript.lru.t_datascript$lru60034(limit,_STAR_impl,meta60035));
});


datascript.lru.cache = (function datascript$lru$cache(limit){
var _STAR_impl = cljs.core.volatile_BANG_(datascript.lru.lru(limit));
return (new datascript.lru.t_datascript$lru60034(limit,_STAR_impl,cljs.core.PersistentArrayMap.EMPTY));
});
