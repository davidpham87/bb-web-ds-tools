...
return cljs.core._write(writer__5311__auto__,"datascript.lru/LRU");
}));
...
var gen = lru.gen;
var limit = lru.limit;
var temp__5823__auto__ = (key_gen.cljs$core$IFn$_invoke$arity$2 ? key_gen.cljs$core$IFn$_invoke$arity$2(k,null) : key_gen.call(null,k,null));
...
var G__59960 = (new datascript.lru.LRU(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_value,k,v),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(gen_key,gen,k),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_gen,k,gen),(gen + (1)),limit));
return (datascript.lru.cleanup_lru.cljs$core$IFn$_invoke$arity$1 ? datascript.lru.cleanup_lru.cljs$core$IFn$_invoke$arity$1(G__59960) : datascript.lru.cleanup_lru.call(null,G__59960));
}
});
...
var gen = lru.gen;
var limit = lru.limit;
var vec__59962 = cljs.core.first(gen_key);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59962,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59962,(1),null);
...
var datascript$lru$ICache$_get$dyn_60000 = (function (this$,key,compute_fn){
var x__5373__auto__ = (((this$ == null))?null:this$);
var m__5374__auto__ = (datascript.lru._get[goog.typeOf(x__5373__auto__)]);
if((!((m__5374__auto__ == null)))){
return (m__5374__auto__.cljs$core$IFn$_invoke$arity$3 ? m__5374__auto__.cljs$core$IFn$_invoke$arity$3(this$,key,compute_fn) : m__5374__auto__.call(null,this$,key,compute_fn));
} else {
var m__5372__auto__ = (datascript.lru._get["_"]);
if((!((m__5372__auto__ == null)))){
return (m__5372__auto__.cljs$core$IFn$_invoke$arity$3 ? m__5372__auto__.cljs$core$IFn$_invoke$arity$3(this$,key,compute_fn) : m__5372__auto__.call(null,this$,key,compute_fn));
} else {
...
return datascript$lru$ICache$_get$dyn_60000(this$,key,compute_fn);
}
});
...
*/
datascript.lru.t_datascript$lru59981 = (function (limit,_STAR_impl,meta59982){
this.limit = limit;
this._STAR_impl = _STAR_impl;
this.meta59982 = meta59982;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(datascript.lru.t_datascript$lru59981.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_59983,meta59982__$1){
var self__ = this;
var _59983__$1 = this;
return (new datascript.lru.t_datascript$lru59981(self__.limit,self__._STAR_impl,meta59982__$1));
}));

(datascript.lru.t_datascript$lru59981.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_59983){
var self__ = this;
var _59983__$1 = this;
return self__.meta59982;
}));

(datascript.lru.t_datascript$lru59981.prototype.datascript$lru$ICache$ = cljs.core.PROTOCOL_SENTINEL);

(datascript.lru.t_datascript$lru59981.prototype.datascript$lru$ICache$_get$arity$3 = (function (_,key,compute_fn){
var self__ = this;
var ___$1 = this;
...
(datascript.lru.t_datascript$lru59981.getBasis = (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"limit","limit",284709164,null),new cljs.core.Symbol(null,"*impl","*impl",1858309677,null),new cljs.core.Symbol(null,"meta59982","meta59982",1083747615,null)], null);
}));

(datascript.lru.t_datascript$lru59981.cljs$lang$type = true);

(datascript.lru.t_datascript$lru59981.cljs$lang$ctorStr = "datascript.lru/t_datascript$lru59981");

(datascript.lru.t_datascript$lru59981.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"datascript.lru/t_datascript$lru59981");
}));

/**
 * Positional factory function for datascript.lru/t_datascript$lru59981.
 */
datascript.lru.__GT_t_datascript$lru59981 = (function datascript$lru$__GT_t_datascript$lru59981(limit,_STAR_impl,meta59982){
return (new datascript.lru.t_datascript$lru59981(limit,_STAR_impl,meta59982));
});


datascript.lru.cache = (function datascript$lru$cache(limit){
var _STAR_impl = cljs.core.volatile_BANG_(datascript.lru.lru(limit));
return (new datascript.lru.t_datascript$lru59981(limit,_STAR_impl,cljs.core.PersistentArrayMap.EMPTY));
});
