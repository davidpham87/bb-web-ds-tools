...
var G__66717 = executor;
var G__66717__$1 = (((G__66717 instanceof cljs.core.Keyword))?G__66717.fqn:null);
switch (G__66717__$1) {
case "default":
return cljs.core.deref(promesa.exec.default_executor);
...
*/
promesa.exec.t_promesa$exec66739 = (function (meta66740){
this.meta66740 = meta66740;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(promesa.exec.t_promesa$exec66739.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_66741,meta66740__$1){
var self__ = this;
var _66741__$1 = this;
return (new promesa.exec.t_promesa$exec66739(meta66740__$1));
}));

(promesa.exec.t_promesa$exec66739.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_66741){
var self__ = this;
var _66741__$1 = this;
return self__.meta66740;
}));

(promesa.exec.t_promesa$exec66739.prototype.promesa$protocols$IExecutor$ = cljs.core.PROTOCOL_SENTINEL);

(promesa.exec.t_promesa$exec66739.prototype.promesa$protocols$IExecutor$_exec_BANG_$arity$2 = (function (this$,f){
var self__ = this;
var this$__$1 = this;
try{(f.cljs$core$IFn$_invoke$arity$0 ? f.cljs$core$IFn$_invoke$arity$0() : f.call(null));

return null;
}catch (e66742){var _ = e66742;
return null;
}}));

(promesa.exec.t_promesa$exec66739.prototype.promesa$protocols$IExecutor$_run_BANG_$arity$2 = (function (this$,f){
var self__ = this;
var this$__$1 = this;
try{return promesa.protocols._promise(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(promesa.exec.noop,f));
}catch (e66743){var cause = e66743;
return promesa.protocols._promise(cause);
}}));

(promesa.exec.t_promesa$exec66739.prototype.promesa$protocols$IExecutor$_submit_BANG_$arity$2 = (function (this$,f){
var self__ = this;
var this$__$1 = this;
try{return promesa.protocols._promise((f.cljs$core$IFn$_invoke$arity$0 ? f.cljs$core$IFn$_invoke$arity$0() : f.call(null)));
}catch (e66744){var cause = e66744;
return promesa.protocols._promise(cause);
}}));

(promesa.exec.t_promesa$exec66739.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta66740","meta66740",1054806120,null)], null);
}));

(promesa.exec.t_promesa$exec66739.cljs$lang$type = true);

(promesa.exec.t_promesa$exec66739.cljs$lang$ctorStr = "promesa.exec/t_promesa$exec66739");

(promesa.exec.t_promesa$exec66739.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"promesa.exec/t_promesa$exec66739");
}));

/**
 * Positional factory function for promesa.exec/t_promesa$exec66739.
 */
promesa.exec.__GT_t_promesa$exec66739 = (function promesa$exec$__GT_t_promesa$exec66739(meta66740){
return (new promesa.exec.t_promesa$exec66739(meta66740));
});
...
return (new promesa.exec.t_promesa$exec66739(cljs.core.PersistentArrayMap.EMPTY));
});
 ...
 * @implements {cljs.core.IWithMeta}
*/
promesa.exec.t_promesa$exec66745 = (function (meta66746){
this.meta66746 = meta66746;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(promesa.exec.t_promesa$exec66745.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_66747,meta66746__$1){
var self__ = this;
var _66747__$1 = this;
return (new promesa.exec.t_promesa$exec66745(meta66746__$1));
}));

(promesa.exec.t_promesa$exec66745.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_66747){
var self__ = this;
var _66747__$1 = this;
return self__.meta66746;
}));

(promesa.exec.t_promesa$exec66745.prototype.promesa$protocols$IExecutor$ = cljs.core.PROTOCOL_SENTINEL);

(promesa.exec.t_promesa$exec66745.prototype.promesa$protocols$IExecutor$_exec_BANG_$arity$2 = (function (this$,f){
var self__ = this;
var this$__$1 = this;
return promesa.impl.promise.nextTick(f);
}));

(promesa.exec.t_promesa$exec66745.prototype.promesa$protocols$IExecutor$_run_BANG_$arity$2 = (function (this$,f){
var self__ = this;
var this$__$1 = this;
return promesa.protocols._fmap(promesa.protocols._fmap(promesa.protocols._promise(null),(function (_){
try{return (f.cljs$core$IFn$_invoke$arity$0 ? f.cljs$core$IFn$_invoke$arity$0() : f.call(null));
}catch (e66748){var ___$1 = e66748;
return null;
}})),promesa.exec.noop);
}));

(promesa.exec.t_promesa$exec66745.prototype.promesa$protocols$IExecutor$_submit_BANG_$arity$2 = (function (this$,f){
var self__ = this;
var this$__$1 = this;
...
(promesa.exec.t_promesa$exec66745.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta66746","meta66746",-516096343,null)], null);
}));

(promesa.exec.t_promesa$exec66745.cljs$lang$type = true);

(promesa.exec.t_promesa$exec66745.cljs$lang$ctorStr = "promesa.exec/t_promesa$exec66745");

(promesa.exec.t_promesa$exec66745.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"promesa.exec/t_promesa$exec66745");
}));

/**
 * Positional factory function for promesa.exec/t_promesa$exec66745.
 */
promesa.exec.__GT_t_promesa$exec66745 = (function promesa$exec$__GT_t_promesa$exec66745(meta66746){
return (new promesa.exec.t_promesa$exec66745(meta66746));
});
...
return (new promesa.exec.t_promesa$exec66745(cljs.core.PersistentArrayMap.EMPTY));
});
...
var len__5749__auto___66764 = arguments.length;
var i__5750__auto___66765 = (0);
while(true){
if((i__5750__auto___66765 < len__5749__auto___66764)){
args__5755__auto__.push((arguments[i__5750__auto___66765]));

var G__66766 = (i__5750__auto___66765 + (1));
i__5750__auto___66765 = G__66766;
continue;
} else {
}
break;
...
(promesa.exec.scheduled_executor.cljs$core$IFn$_invoke$arity$variadic = (function (p__66751){
var map__66752 = p__66751;
var map__66752__$1 = cljs.core.__destructure_map(map__66752);
var parallelism = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__66752__$1,new cljs.core.Keyword(null,"parallelism","parallelism",-930922333),(1));
var factory = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66752__$1,new cljs.core.Keyword(null,"factory","factory",63933746));
...
/** @this {Function} */
(promesa.exec.scheduled_executor.cljs$lang$applyTo = (function (seq66750){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq66750));
}));
