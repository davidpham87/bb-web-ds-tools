...
var i_32325 = (0);
while(true){
if((i_32325 < arr.length)){
(arr[i_32325] = null);

var G__32326 = (i_32325 + (1));
i_32325 = G__32326;
continue;
} else {
}
...
var i_32333 = (self__.level + (1));
while(true){
if((i_32333 <= (new_level + (1)))){
(update[i_32333] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_32335 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_32335[i]));
} else {
x__$2.forward.push((((i < links_32335.length))?(links_32335[i]):null));
}

if((i < links_32335.length)){
(links_32335[i] = x__$2);
} else {
links_32335.push(x__$2);
}
...
var i_32337 = (0);
while(true){
if((i_32337 <= self__.level)){
var links_32338 = (update[i_32337]).forward;
if((x__$1 === (((i_32337 < links_32338.length))?(links_32338[i_32337]):null))){
(links_32338[i_32337] = (x__$1.forward[i_32337]));

var G__32341 = (i_32337 + (1));
i_32337 = G__32341;
continue;
} else {
var G__32342 = (i_32337 + (1));
i_32337 = G__32342;
continue;
}
} else {
...
var G__32345 = nx;
var G__32346 = (level__$1 - (1));
x = G__32345;
level__$1 = G__32346;
continue;
} else {
var G__32347 = x;
var G__32348 = (level__$1 - (1));
x = G__32347;
level__$1 = G__32348;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__32352 = nx;
var G__32353 = (level__$1 - (1));
x = G__32352;
level__$1 = G__32353;
continue;
} else {
var G__32354 = x;
var G__32355 = (level__$1 - (1));
x = G__32354;
level__$1 = G__32355;
continue;
}
