...
var reitit$coercion$Coercion$_get_name$dyn_28443 = (function (this$){
...
return reitit$coercion$Coercion$_get_name$dyn_28443(this$);
}
});
...
var reitit$coercion$Coercion$_get_apidocs$dyn_28451 = (function (this$,specification,data){
var x__5373__auto__ = (((this$ == null))?null:this$);
...
return reitit$coercion$Coercion$_get_apidocs$dyn_28451(this$,specification,data);
}
});

var reitit$coercion$Coercion$_get_model_apidocs$dyn_28461 = (function (this$,specification,model,options){
var x__5373__auto__ = (((this$ == null))?null:this$);
...
return reitit$coercion$Coercion$_get_model_apidocs$dyn_28461(this$,specification,model,options);
}
});

var reitit$coercion$Coercion$_compile_model$dyn_28463 = (function (this$,model,name){
var x__5373__auto__ = (((this$ == null))?null:this$);
...
return reitit$coercion$Coercion$_compile_model$dyn_28463(this$,model,name);
}
});
...
var extmap__5365__auto__ = (function (){var G__28316 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__28294,new cljs.core.Keyword(null,"in","in",-1531184865),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.Keyword(null,"keywordize?","keywordize?",-234306912),new cljs.core.Keyword(null,"open?","open?",1238443125)], 0));
...
var extract_response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__28355__$1,new cljs.core.Keyword(null,"extract-response-format","extract-response-format",-303544140),reitit.coercion.extract_response_format_default);
var serialize_failed_result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28355__$1,new cljs.core.Keyword(null,"serialize-failed-result","serialize-failed-result",391398953));
if(cljs.core.truth_(coercion)){
...
var crc = (cljs.core.truth_(route_request)?(function (){var G__28405 = reitit.coercion.content_request_coercer(coercion,route_request,opts);
if((G__28405 == null)){
return null;
} else {
return (new cljs.core.PersistentArrayMap(null,(1),[new cljs.core.Keyword(null,"request","request",1772954723),G__28405],null));
}
})():null);
var rcs = reitit.coercion.request_coercers.cljs$core$IFn$_invoke$arity$3(coercion,parameters,(function (){var G__28407 = opts;
if(cljs.core.truth_(route_request)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28407,new cljs.core.Keyword("reitit.coercion","skip","reitit.coercion/skip",-2123160930),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"body","body",-2049205669),null], null), null));
} else {
return G__28407;
}
})());
...
var vec__28419 = cljs.core._nth(c__5501__auto__,i__28412);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28419,(0),null);
var model = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28419,(1),null);
...
var vec__28429 = cljs.core.first(s__28411__$2);
