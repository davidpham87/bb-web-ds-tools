...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.openapi.core","default","spec-tools.openapi.core/default",-940305094)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__55954 = cljs.core.get_global_hierarchy;
return (fexpr__55954.cljs$core$IFn$_invoke$arity$0 ? fexpr__55954.cljs$core$IFn$_invoke$arity$0() : fexpr__55954.call(null));
})());
...
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55959,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55959,(1),null);
...
return cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__55966_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__55966_SHARP_),"null");
...
})(),new cljs.core.Keyword(null,"required","required",1807647006),(function (){var G__55967 = in$;
...
spec_tools.openapi.core.extract_object_param = (function spec_tools$openapi$core$extract_object_param(in$,p__55969){
var map__55970 = p__55969;
var map__55970__$1 = cljs.core.__destructure_map(map__55970);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55970__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55970__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__55971){
var vec__55972 = p__55971;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55972,(0),null);
var map__55975 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55972,(1),null);
var map__55975__$1 = cljs.core.__destructure_map(map__55975);
var schema = map__55975__$1;
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55975__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
...
})(),new cljs.core.Keyword(null,"required","required",1807647006),(function (){var G__55976 = in$;
...
var method_cache__5624__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5625__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__55979 = cljs.core.get_global_hierarchy;
return (fexpr__55979.cljs$core$IFn$_invoke$arity$0 ? fexpr__55979.cljs$core$IFn$_invoke$arity$0() : fexpr__55979.call(null));
})());
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$openapi$core$iter__55981(s__55982){
return (new cljs.core.LazySeq(null,(function (){
var s__55982__$1 = s__55982;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__55982__$1);
if(temp__5825__auto__){
var s__55982__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55982__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__55982__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__55984 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__55983 = (0);
while(true){
if((i__55983 < size__5502__auto__)){
var vec__55985 = cljs.core._nth(c__5501__auto__,i__55983);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55985,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55985,(1),null);
cljs.core.chunk_append(b__55984,cljs.core.PersistentArrayMap.createAsIfByAssoc([name,spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)]));

var G__56094 = (i__55983 + (1));
i__55983 = G__56094;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55984),spec_tools$openapi$core$iter__55981(cljs.core.chunk_rest(s__55982__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55984),null);
}
} else {
var vec__55989 = cljs.core.first(s__55982__$2);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55989,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55989,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([name,spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)]),spec_tools$openapi$core$iter__55981(cljs.core.rest(s__55982__$2)));
}
} else {
return null;
}
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$openapi$core$iter__55992(s__55993){
return (new cljs.core.LazySeq(null,(function (){
var s__55993__$1 = s__55993;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__55993__$1);
if(temp__5825__auto__){
var s__55993__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55993__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__55993__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__55995 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__55994 = (0);
while(true){
if((i__55994 < size__5502__auto__)){
var vec__55997 = cljs.core._nth(c__5501__auto__,i__55994);
var content_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55997,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55997,(1),null);
cljs.core.chunk_append(b__55995,cljs.core.PersistentArrayMap.createAsIfByAssoc([content_type,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)], null)]));

var G__56095 = (i__55994 + (1));
i__55994 = G__56095;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55995),spec_tools$openapi$core$iter__55992(cljs.core.chunk_rest(s__55993__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55995),null);
}
} else {
var vec__56002 = cljs.core.first(s__55993__$2);
var content_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56002,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56002,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([content_type,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)], null)]),spec_tools$openapi$core$iter__55992(cljs.core.rest(s__55993__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__56008){
var vec__56009 = p__56008;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56009,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56009,(1),null);
return spec_tools.openapi.core.extract_parameter(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__56013,p){
var vec__56015 = p__56013;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56015,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56015,(1),null);
var acc__$1 = vec__56015;
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$openapi$core$iter__56019(s__56020){
return (new cljs.core.LazySeq(null,(function (){
var s__56020__$1 = s__56020;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__56020__$1);
if(temp__5825__auto__){
var s__56020__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56020__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__56020__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__56022 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__56021 = (0);
while(true){
if((i__56021 < size__5502__auto__)){
var vec__56058 = cljs.core._nth(c__5501__auto__,i__56021);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56058,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56058,(1),null);
cljs.core.chunk_append(b__56022,cljs.core.PersistentArrayMap.createAsIfByAssoc([name,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(spec_tools.openapi.core.extract_single_param(new cljs.core.Keyword(null,"header","header",119441134),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(spec)),new cljs.core.Keyword(null,"in","in",-1531184865)),new cljs.core.Keyword(null,"name","name",1843675177))]));

var G__56096 = (i__56021 + (1));
i__56021 = G__56096;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56022),spec_tools$openapi$core$iter__56019(cljs.core.chunk_rest(s__56020__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56022),null);
}
} else {
var vec__56061 = cljs.core.first(s__56020__$2);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56061,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56061,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([name,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(spec_tools.openapi.core.extract_single_param(new cljs.core.Keyword(null,"header","header",119441134),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(spec)),new cljs.core.Keyword(null,"in","in",-1531184865)),new cljs.core.Keyword(null,"name","name",1843675177))]),spec_tools$openapi$core$iter__56019(cljs.core.rest(s__56020__$2)));
}
} else {
return null;
}
