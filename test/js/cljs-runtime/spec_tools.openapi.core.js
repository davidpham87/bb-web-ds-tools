...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.openapi.core","default","spec-tools.openapi.core/default",-940305094)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__55771 = cljs.core.get_global_hierarchy;
return (fexpr__55771.cljs$core$IFn$_invoke$arity$0 ? fexpr__55771.cljs$core$IFn$_invoke$arity$0() : fexpr__55771.call(null));
})());
...
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55780,(1),null);
...
return cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__55786_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__55786_SHARP_),"null");
...
})(),new cljs.core.Keyword(null,"required","required",1807647006),(function (){var G__55791 = in$;
...
spec_tools.openapi.core.extract_object_param = (function spec_tools$openapi$core$extract_object_param(in$,p__55797){
var map__55798 = p__55797;
var map__55798__$1 = cljs.core.__destructure_map(map__55798);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55798__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55798__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__55799){
var vec__55800 = p__55799;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55800,(0),null);
var map__55803 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55800,(1),null);
var map__55803__$1 = cljs.core.__destructure_map(map__55803);
var schema = map__55803__$1;
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55803__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
...
})(),new cljs.core.Keyword(null,"required","required",1807647006),(function (){var G__55804 = in$;
var G__55804__$1 = (((G__55804 instanceof cljs.core.Keyword))?G__55804.fqn:null);
switch (G__55804__$1) {
case "path":
return true;
...
var method_cache__5624__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5625__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__55808 = cljs.core.get_global_hierarchy;
return (fexpr__55808.cljs$core$IFn$_invoke$arity$0 ? fexpr__55808.cljs$core$IFn$_invoke$arity$0() : fexpr__55808.call(null));
})());
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$openapi$core$iter__55813(s__55814){
return (new cljs.core.LazySeq(null,(function (){
var s__55814__$1 = s__55814;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__55814__$1);
if(temp__5825__auto__){
var s__55814__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55814__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__55814__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__55816 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__55815 = (0);
while(true){
if((i__55815 < size__5502__auto__)){
var vec__55819 = cljs.core._nth(c__5501__auto__,i__55815);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55819,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55819,(1),null);
cljs.core.chunk_append(b__55816,cljs.core.PersistentArrayMap.createAsIfByAssoc([name,spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)]));

var G__55877 = (i__55815 + (1));
i__55815 = G__55877;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55816),spec_tools$openapi$core$iter__55813(cljs.core.chunk_rest(s__55814__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55816),null);
}
} else {
var vec__55824 = cljs.core.first(s__55814__$2);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55824,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55824,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([name,spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)]),spec_tools$openapi$core$iter__55813(cljs.core.rest(s__55814__$2)));
}
} else {
return null;
}
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$openapi$core$iter__55828(s__55829){
return (new cljs.core.LazySeq(null,(function (){
var s__55829__$1 = s__55829;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__55829__$1);
if(temp__5825__auto__){
var s__55829__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55829__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__55829__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__55831 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__55830 = (0);
while(true){
if((i__55830 < size__5502__auto__)){
var vec__55832 = cljs.core._nth(c__5501__auto__,i__55830);
var content_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55832,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55832,(1),null);
cljs.core.chunk_append(b__55831,cljs.core.PersistentArrayMap.createAsIfByAssoc([content_type,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)], null)]));

var G__55879 = (i__55830 + (1));
i__55830 = G__55879;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55831),spec_tools$openapi$core$iter__55828(cljs.core.chunk_rest(s__55829__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55831),null);
}
} else {
var vec__55835 = cljs.core.first(s__55829__$2);
var content_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55835,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55835,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([content_type,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)], null)]),spec_tools$openapi$core$iter__55828(cljs.core.rest(s__55829__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__55839){
var vec__55840 = p__55839;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55840,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55840,(1),null);
return spec_tools.openapi.core.extract_parameter(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__55843,p){
var vec__55844 = p__55843;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55844,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55844,(1),null);
var acc__$1 = vec__55844;
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$openapi$core$iter__55847(s__55848){
return (new cljs.core.LazySeq(null,(function (){
var s__55848__$1 = s__55848;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__55848__$1);
if(temp__5825__auto__){
var s__55848__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55848__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__55848__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__55850 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__55849 = (0);
while(true){
if((i__55849 < size__5502__auto__)){
var vec__55851 = cljs.core._nth(c__5501__auto__,i__55849);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55851,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55851,(1),null);
cljs.core.chunk_append(b__55850,cljs.core.PersistentArrayMap.createAsIfByAssoc([name,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(spec_tools.openapi.core.extract_single_param(new cljs.core.Keyword(null,"header","header",119441134),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(spec)),new cljs.core.Keyword(null,"in","in",-1531184865)),new cljs.core.Keyword(null,"name","name",1843675177))]));

var G__55886 = (i__55849 + (1));
i__55849 = G__55886;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55850),spec_tools$openapi$core$iter__55847(cljs.core.chunk_rest(s__55848__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55850),null);
}
} else {
var vec__55854 = cljs.core.first(s__55848__$2);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55854,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55854,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([name,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(spec_tools.openapi.core.extract_single_param(new cljs.core.Keyword(null,"header","header",119441134),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(spec)),new cljs.core.Keyword(null,"in","in",-1531184865)),new cljs.core.Keyword(null,"name","name",1843675177))]),spec_tools$openapi$core$iter__55847(cljs.core.rest(s__55848__$2)));
}
} else {
return null;
}
