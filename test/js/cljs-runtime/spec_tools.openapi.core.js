...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.openapi.core","default","spec-tools.openapi.core/default",-940305094)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__55889 = cljs.core.get_global_hierarchy;
return (fexpr__55889.cljs$core$IFn$_invoke$arity$0 ? fexpr__55889.cljs$core$IFn$_invoke$arity$0() : fexpr__55889.call(null));
})());
...
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55897,(1),null);
...
return cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__55912_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__55912_SHARP_),"null");
...
})(),new cljs.core.Keyword(null,"required","required",1807647006),(function (){var G__55916 = in$;
...
spec_tools.openapi.core.extract_object_param = (function spec_tools$openapi$core$extract_object_param(in$,p__55937){
var map__55938 = p__55937;
var map__55938__$1 = cljs.core.__destructure_map(map__55938);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55938__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55938__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__55940){
var vec__55942 = p__55940;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55942,(0),null);
var map__55945 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55942,(1),null);
var map__55945__$1 = cljs.core.__destructure_map(map__55945);
var schema = map__55945__$1;
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55945__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
...
})(),new cljs.core.Keyword(null,"required","required",1807647006),(function (){var G__55946 = in$;
...
var method_cache__5624__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5625__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__55968 = cljs.core.get_global_hierarchy;
return (fexpr__55968.cljs$core$IFn$_invoke$arity$0 ? fexpr__55968.cljs$core$IFn$_invoke$arity$0() : fexpr__55968.call(null));
})());
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$openapi$core$iter__55971(s__55972){
return (new cljs.core.LazySeq(null,(function (){
var s__55972__$1 = s__55972;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__55972__$1);
if(temp__5825__auto__){
var s__55972__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55972__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__55972__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__55974 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__55973 = (0);
while(true){
if((i__55973 < size__5502__auto__)){
var vec__55980 = cljs.core._nth(c__5501__auto__,i__55973);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55980,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55980,(1),null);
cljs.core.chunk_append(b__55974,cljs.core.PersistentArrayMap.createAsIfByAssoc([name,spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)]));

var G__56056 = (i__55973 + (1));
i__55973 = G__56056;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55974),spec_tools$openapi$core$iter__55971(cljs.core.chunk_rest(s__55972__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55974),null);
}
} else {
var vec__55985 = cljs.core.first(s__55972__$2);
...
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([name,spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)]),spec_tools$openapi$core$iter__55971(cljs.core.rest(s__55972__$2)));
}
} else {
return null;
}
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$openapi$core$iter__55989(s__55990){
return (new cljs.core.LazySeq(null,(function (){
var s__55990__$1 = s__55990;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__55990__$1);
if(temp__5825__auto__){
var s__55990__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55990__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__55990__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__55992 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__55991 = (0);
while(true){
if((i__55991 < size__5502__auto__)){
var vec__55994 = cljs.core._nth(c__5501__auto__,i__55991);
var content_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55994,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55994,(1),null);
cljs.core.chunk_append(b__55992,cljs.core.PersistentArrayMap.createAsIfByAssoc([content_type,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)], null)]));

var G__56057 = (i__55991 + (1));
i__55991 = G__56057;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55992),spec_tools$openapi$core$iter__55989(cljs.core.chunk_rest(s__55990__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55992),null);
}
} else {
var vec__55997 = cljs.core.first(s__55990__$2);
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__56007){
var vec__56008 = p__56007;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56008,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56008,(1),null);
return spec_tools.openapi.core.extract_parameter(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__56011,p){
var vec__56012 = p__56011;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56012,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56012,(1),null);
var acc__$1 = vec__56012;
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$openapi$core$iter__56016(s__56017){
return (new cljs.core.LazySeq(null,(function (){
var s__56017__$1 = s__56017;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__56017__$1);
if(temp__5825__auto__){
var s__56017__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56017__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__56017__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__56019 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__56018 = (0);
while(true){
if((i__56018 < size__5502__auto__)){
var vec__56021 = cljs.core._nth(c__5501__auto__,i__56018);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56021,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56021,(1),null);
cljs.core.chunk_append(b__56019,cljs.core.PersistentArrayMap.createAsIfByAssoc([name,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(spec_tools.openapi.core.extract_single_param(new cljs.core.Keyword(null,"header","header",119441134),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(spec)),new cljs.core.Keyword(null,"in","in",-1531184865)),new cljs.core.Keyword(null,"name","name",1843675177))]));

var G__56059 = (i__56018 + (1));
i__56018 = G__56059;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56019),spec_tools$openapi$core$iter__56016(cljs.core.chunk_rest(s__56017__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56019),null);
}
} else {
var vec__56028 = cljs.core.first(s__56017__$2);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56028,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56028,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([name,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(spec_tools.openapi.core.extract_single_param(new cljs.core.Keyword(null,"header","header",119441134),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(spec)),new cljs.core.Keyword(null,"in","in",-1531184865)),new cljs.core.Keyword(null,"name","name",1843675177))]),spec_tools$openapi$core$iter__56016(cljs.core.rest(s__56017__$2)));
}
} else {
return null;
}
