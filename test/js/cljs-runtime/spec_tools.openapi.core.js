...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.openapi.core","default","spec-tools.openapi.core/default",-940305094)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__39842 = cljs.core.get_global_hierarchy;
return (fexpr__39842.cljs$core$IFn$_invoke$arity$0 ? fexpr__39842.cljs$core$IFn$_invoke$arity$0() : fexpr__39842.call(null));
})());
...
var vec__39843 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39843,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39843,(1),null);
...
return cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__39848_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__39848_SHARP_),"null");
...
})(),new cljs.core.Keyword(null,"required","required",1807647006),(function (){var G__39849 = in$;
var G__39849__$1 = (((G__39849 instanceof cljs.core.Keyword))?G__39849.fqn:null);
switch (G__39849__$1) {
case "path":
return true;
...
spec_tools.openapi.core.extract_object_param = (function spec_tools$openapi$core$extract_object_param(in$,p__39850){
var map__39851 = p__39850;
var map__39851__$1 = cljs.core.__destructure_map(map__39851);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39851__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39851__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__39852){
var vec__39853 = p__39852;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39853,(0),null);
var map__39856 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39853,(1),null);
var map__39856__$1 = cljs.core.__destructure_map(map__39856);
var schema = map__39856__$1;
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39856__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
...
})(),new cljs.core.Keyword(null,"required","required",1807647006),(function (){var G__39857 = in$;
...
var method_cache__5624__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5625__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__39858 = cljs.core.get_global_hierarchy;
return (fexpr__39858.cljs$core$IFn$_invoke$arity$0 ? fexpr__39858.cljs$core$IFn$_invoke$arity$0() : fexpr__39858.call(null));
})());
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$openapi$core$iter__39859(s__39860){
return (new cljs.core.LazySeq(null,(function (){
var s__39860__$1 = s__39860;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__39860__$1);
if(temp__5825__auto__){
var s__39860__$2 = temp__5825__auto__;
...
var vec__39863 = cljs.core._nth(c__5501__auto__,i__39861);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39863,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39863,(1),null);
cljs.core.chunk_append(b__39862,cljs.core.PersistentArrayMap.createAsIfByAssoc([name,spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)]));

var G__39902 = (i__39861 + (1));
i__39861 = G__39902;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__39862),spec_tools$openapi$core$iter__39859(cljs.core.chunk_rest(s__39860__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__39862),null);
}
} else {
var vec__39866 = cljs.core.first(s__39860__$2);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39866,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39866,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([name,spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)]),spec_tools$openapi$core$iter__39859(cljs.core.rest(s__39860__$2)));
}
} else {
return null;
}
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$openapi$core$iter__39869(s__39870){
return (new cljs.core.LazySeq(null,(function (){
var s__39870__$1 = s__39870;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__39870__$1);
if(temp__5825__auto__){
var s__39870__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__39870__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__39870__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__39872 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__39871 = (0);
while(true){
if((i__39871 < size__5502__auto__)){
var vec__39873 = cljs.core._nth(c__5501__auto__,i__39871);
var content_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39873,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39873,(1),null);
cljs.core.chunk_append(b__39872,cljs.core.PersistentArrayMap.createAsIfByAssoc([content_type,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)], null)]));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__39872),spec_tools$openapi$core$iter__39869(cljs.core.chunk_rest(s__39870__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__39872),null);
}
} else {
var vec__39876 = cljs.core.first(s__39870__$2);
var content_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39876,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39876,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([content_type,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)], null)]),spec_tools$openapi$core$iter__39869(cljs.core.rest(s__39870__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__39879){
var vec__39880 = p__39879;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39880,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39880,(1),null);
return spec_tools.openapi.core.extract_parameter(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__39883,p){
var vec__39884 = p__39883;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39884,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39884,(1),null);
var acc__$1 = vec__39884;
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$openapi$core$iter__39887(s__39888){
return (new cljs.core.LazySeq(null,(function (){
var s__39888__$1 = s__39888;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__39888__$1);
if(temp__5825__auto__){
var s__39888__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__39888__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__39888__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__39890 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__39889 = (0);
while(true){
if((i__39889 < size__5502__auto__)){
var vec__39891 = cljs.core._nth(c__5501__auto__,i__39889);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39891,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39891,(1),null);
cljs.core.chunk_append(b__39890,cljs.core.PersistentArrayMap.createAsIfByAssoc([name,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(spec_tools.openapi.core.extract_single_param(new cljs.core.Keyword(null,"header","header",119441134),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(spec)),new cljs.core.Keyword(null,"in","in",-1531184865)),new cljs.core.Keyword(null,"name","name",1843675177))]));

var G__39904 = (i__39889 + (1));
i__39889 = G__39904;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__39890),spec_tools$openapi$core$iter__39887(cljs.core.chunk_rest(s__39888__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__39890),null);
}
} else {
var vec__39894 = cljs.core.first(s__39888__$2);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39894,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39894,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([name,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(spec_tools.openapi.core.extract_single_param(new cljs.core.Keyword(null,"header","header",119441134),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(spec)),new cljs.core.Keyword(null,"in","in",-1531184865)),new cljs.core.Keyword(null,"name","name",1843675177))]),spec_tools$openapi$core$iter__39887(cljs.core.rest(s__39888__$2)));
}
} else {
return null;
}
