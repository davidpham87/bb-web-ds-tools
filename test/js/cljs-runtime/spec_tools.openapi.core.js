...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.openapi.core","default","spec-tools.openapi.core/default",-940305094)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__63164 = cljs.core.get_global_hierarchy;
return (fexpr__63164.cljs$core$IFn$_invoke$arity$0 ? fexpr__63164.cljs$core$IFn$_invoke$arity$0() : fexpr__63164.call(null));
})());
...
var vec__63166 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63166,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63166,(1),null);
...
return cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__63178_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__63178_SHARP_),"null");
...
})(),new cljs.core.Keyword(null,"required","required",1807647006),(function (){var G__63183 = in$;
...
spec_tools.openapi.core.extract_object_param = (function spec_tools$openapi$core$extract_object_param(in$,p__63184){
var map__63186 = p__63184;
var map__63186__$1 = cljs.core.__destructure_map(map__63186);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63186__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63186__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__63188){
var vec__63189 = p__63188;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63189,(0),null);
var map__63192 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63189,(1),null);
var map__63192__$1 = cljs.core.__destructure_map(map__63192);
var schema = map__63192__$1;
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63192__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
...
})(),new cljs.core.Keyword(null,"required","required",1807647006),(function (){var G__63193 = in$;
...
var method_cache__5624__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5625__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__63201 = cljs.core.get_global_hierarchy;
return (fexpr__63201.cljs$core$IFn$_invoke$arity$0 ? fexpr__63201.cljs$core$IFn$_invoke$arity$0() : fexpr__63201.call(null));
})());
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$openapi$core$iter__63203(s__63204){
return (new cljs.core.LazySeq(null,(function (){
var s__63204__$1 = s__63204;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__63204__$1);
if(temp__5825__auto__){
var s__63204__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__63204__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__63204__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__63206 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__63205 = (0);
while(true){
if((i__63205 < size__5502__auto__)){
var vec__63212 = cljs.core._nth(c__5501__auto__,i__63205);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63212,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63212,(1),null);
cljs.core.chunk_append(b__63206,cljs.core.PersistentArrayMap.createAsIfByAssoc([name,spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)]));

var G__63300 = (i__63205 + (1));
i__63205 = G__63300;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63206),spec_tools$openapi$core$iter__63203(cljs.core.chunk_rest(s__63204__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63206),null);
}
} else {
var vec__63218 = cljs.core.first(s__63204__$2);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63218,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63218,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([name,spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)]),spec_tools$openapi$core$iter__63203(cljs.core.rest(s__63204__$2)));
}
} else {
return null;
}
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$openapi$core$iter__63225(s__63226){
return (new cljs.core.LazySeq(null,(function (){
var s__63226__$1 = s__63226;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__63226__$1);
if(temp__5825__auto__){
var s__63226__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__63226__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__63226__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__63228 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__63227 = (0);
while(true){
if((i__63227 < size__5502__auto__)){
var vec__63233 = cljs.core._nth(c__5501__auto__,i__63227);
var content_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63233,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63233,(1),null);
cljs.core.chunk_append(b__63228,cljs.core.PersistentArrayMap.createAsIfByAssoc([content_type,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)], null)]));

var G__63301 = (i__63227 + (1));
i__63227 = G__63301;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63228),spec_tools$openapi$core$iter__63225(cljs.core.chunk_rest(s__63226__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63228),null);
}
} else {
var vec__63240 = cljs.core.first(s__63226__$2);
var content_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63240,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63240,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([content_type,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)], null)]),spec_tools$openapi$core$iter__63225(cljs.core.rest(s__63226__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__63243){
var vec__63244 = p__63243;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63244,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63244,(1),null);
return spec_tools.openapi.core.extract_parameter(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__63248,p){
var vec__63249 = p__63248;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63249,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63249,(1),null);
var acc__$1 = vec__63249;
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$openapi$core$iter__63253(s__63254){
return (new cljs.core.LazySeq(null,(function (){
var s__63254__$1 = s__63254;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__63254__$1);
if(temp__5825__auto__){
var s__63254__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__63254__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__63254__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__63256 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__63255 = (0);
while(true){
if((i__63255 < size__5502__auto__)){
var vec__63257 = cljs.core._nth(c__5501__auto__,i__63255);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63257,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63257,(1),null);
cljs.core.chunk_append(b__63256,cljs.core.PersistentArrayMap.createAsIfByAssoc([name,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(spec_tools.openapi.core.extract_single_param(new cljs.core.Keyword(null,"header","header",119441134),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(spec)),new cljs.core.Keyword(null,"in","in",-1531184865)),new cljs.core.Keyword(null,"name","name",1843675177))]));

var G__63302 = (i__63255 + (1));
i__63255 = G__63302;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63256),spec_tools$openapi$core$iter__63253(cljs.core.chunk_rest(s__63254__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63256),null);
}
} else {
var vec__63272 = cljs.core.first(s__63254__$2);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63272,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63272,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([name,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(spec_tools.openapi.core.extract_single_param(new cljs.core.Keyword(null,"header","header",119441134),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(spec)),new cljs.core.Keyword(null,"in","in",-1531184865)),new cljs.core.Keyword(null,"name","name",1843675177))]),spec_tools$openapi$core$iter__63253(cljs.core.rest(s__63254__$2)));
}
} else {
return null;
}
