...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.openapi.core","default","spec-tools.openapi.core/default",-940305094)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__63225 = cljs.core.get_global_hierarchy;
return (fexpr__63225.cljs$core$IFn$_invoke$arity$0 ? fexpr__63225.cljs$core$IFn$_invoke$arity$0() : fexpr__63225.call(null));
})());
...
var vec__63248 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63248,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63248,(1),null);
...
return cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__63259_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__63259_SHARP_),"null");
...
})(),new cljs.core.Keyword(null,"required","required",1807647006),(function (){var G__63261 = in$;
var G__63261__$1 = (((G__63261 instanceof cljs.core.Keyword))?G__63261.fqn:null);
switch (G__63261__$1) {
case "path":
return true;
...
spec_tools.openapi.core.extract_object_param = (function spec_tools$openapi$core$extract_object_param(in$,p__63263){
var map__63264 = p__63263;
var map__63264__$1 = cljs.core.__destructure_map(map__63264);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63264__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63264__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__63266){
var vec__63267 = p__63266;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63267,(0),null);
var map__63270 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63267,(1),null);
var map__63270__$1 = cljs.core.__destructure_map(map__63270);
var schema = map__63270__$1;
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63270__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
...
})(),new cljs.core.Keyword(null,"required","required",1807647006),(function (){var G__63271 = in$;
...
var method_cache__5624__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5625__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__63273 = cljs.core.get_global_hierarchy;
return (fexpr__63273.cljs$core$IFn$_invoke$arity$0 ? fexpr__63273.cljs$core$IFn$_invoke$arity$0() : fexpr__63273.call(null));
})());
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$openapi$core$iter__63275(s__63276){
return (new cljs.core.LazySeq(null,(function (){
var s__63276__$1 = s__63276;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__63276__$1);
if(temp__5825__auto__){
var s__63276__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__63276__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__63276__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__63278 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__63277 = (0);
while(true){
if((i__63277 < size__5502__auto__)){
var vec__63279 = cljs.core._nth(c__5501__auto__,i__63277);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63279,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63279,(1),null);
cljs.core.chunk_append(b__63278,cljs.core.PersistentArrayMap.createAsIfByAssoc([name,spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)]));

var G__63350 = (i__63277 + (1));
i__63277 = G__63350;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63278),spec_tools$openapi$core$iter__63275(cljs.core.chunk_rest(s__63276__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63278),null);
}
} else {
var vec__63283 = cljs.core.first(s__63276__$2);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63283,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63283,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([name,spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)]),spec_tools$openapi$core$iter__63275(cljs.core.rest(s__63276__$2)));
}
} else {
return null;
}
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$openapi$core$iter__63286(s__63287){
return (new cljs.core.LazySeq(null,(function (){
var s__63287__$1 = s__63287;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__63287__$1);
if(temp__5825__auto__){
var s__63287__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__63287__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__63287__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__63289 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__63288 = (0);
while(true){
if((i__63288 < size__5502__auto__)){
var vec__63291 = cljs.core._nth(c__5501__auto__,i__63288);
var content_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63291,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63291,(1),null);
cljs.core.chunk_append(b__63289,cljs.core.PersistentArrayMap.createAsIfByAssoc([content_type,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)], null)]));

var G__63351 = (i__63288 + (1));
i__63288 = G__63351;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63289),spec_tools$openapi$core$iter__63286(cljs.core.chunk_rest(s__63287__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63289),null);
}
} else {
var vec__63294 = cljs.core.first(s__63287__$2);
var content_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63294,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63294,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([content_type,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)], null)]),spec_tools$openapi$core$iter__63286(cljs.core.rest(s__63287__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__63297){
var vec__63298 = p__63297;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63298,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63298,(1),null);
return spec_tools.openapi.core.extract_parameter(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__63301,p){
var vec__63302 = p__63301;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63302,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63302,(1),null);
var acc__$1 = vec__63302;
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$openapi$core$iter__63305(s__63306){
return (new cljs.core.LazySeq(null,(function (){
var s__63306__$1 = s__63306;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__63306__$1);
if(temp__5825__auto__){
var s__63306__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__63306__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__63306__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__63308 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__63307 = (0);
while(true){
if((i__63307 < size__5502__auto__)){
var vec__63309 = cljs.core._nth(c__5501__auto__,i__63307);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63309,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63309,(1),null);
cljs.core.chunk_append(b__63308,cljs.core.PersistentArrayMap.createAsIfByAssoc([name,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(spec_tools.openapi.core.extract_single_param(new cljs.core.Keyword(null,"header","header",119441134),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(spec)),new cljs.core.Keyword(null,"in","in",-1531184865)),new cljs.core.Keyword(null,"name","name",1843675177))]));

var G__63354 = (i__63307 + (1));
i__63307 = G__63354;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63308),spec_tools$openapi$core$iter__63305(cljs.core.chunk_rest(s__63306__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63308),null);
}
} else {
var vec__63316 = cljs.core.first(s__63306__$2);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63316,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63316,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([name,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(spec_tools.openapi.core.extract_single_param(new cljs.core.Keyword(null,"header","header",119441134),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(spec)),new cljs.core.Keyword(null,"in","in",-1531184865)),new cljs.core.Keyword(null,"name","name",1843675177))]),spec_tools$openapi$core$iter__63305(cljs.core.rest(s__63306__$2)));
}
} else {
return null;
}
