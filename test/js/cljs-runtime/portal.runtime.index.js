...
portal.runtime.index.html = (function portal$runtime$index$html(p__29069){
var map__29070 = p__29069;
var map__29070__$1 = cljs.core.__destructure_map(map__29070);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__29070__$1,new cljs.core.Keyword(null,"name","name",1843675177),"portal");
var version = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__29070__$1,new cljs.core.Keyword(null,"version","version",425292698),"0.62.0");
var host = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29070__$1,new cljs.core.Keyword(null,"host","host",-1558485167));
var port = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29070__$1,new cljs.core.Keyword(null,"port","port",1534937262));
var session_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29070__$1,new cljs.core.Keyword(null,"session-id","session-id",-1147060351));
var code_url = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__29070__$1,new cljs.core.Keyword(null,"code-url","code-url",532390406),"main.js");
var platform = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__29070__$1,new cljs.core.Keyword(null,"platform","platform",-1086422114),"node");
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29070__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
