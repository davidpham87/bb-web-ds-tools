...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.code","set-active-tab","bb-web-ds-tools.views.code/set-active-tab",-1083304053),(function (db,p__38689){
var vec__38690 = p__38689;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38690,(0),null);
var tab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38690,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.code","set-mobile-view-mode","bb-web-ds-tools.views.code/set-mobile-view-mode",192678378),(function (db,p__38693){
var vec__38694 = p__38693;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38694,(0),null);
var mode = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38694,(1),null);
...
var is_md_QMARK_ = (function (){var with_let38699 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let38699","with-let38699",-1837866714));
var temp__5829__auto___38705 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5829__auto___38705 == null)){
} else {
var c__20886__auto___38706 = temp__5829__auto___38705;
if((with_let38699.generation === c__20886__auto___38706.ratomGeneration)){
...
(with_let38699.generation = c__20886__auto___38706.ratomGeneration);
}

var init38700 = (with_let38699.length === (0));
var mql = ((((init38700) || (cljs.core.not(with_let38699.hasOwnProperty((0))))))?(with_let38699[(0)] = window.matchMedia("(min-width: 768px)")):(with_let38699[(0)]));
var match = ((((init38700) || (cljs.core.not(with_let38699.hasOwnProperty((1))))))?(with_let38699[(1)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(mql.matches)):(with_let38699[(1)]));
var handler = ((((init38700) || (cljs.core.not(with_let38699.hasOwnProperty((2))))))?(with_let38699[(2)] = (function (e){
return cljs.core.reset_BANG_(match,e.matches);
})):(with_let38699[(2)]));
var res38701 = (function (){
mql.addEventListener("change",handler);

return cljs.core.deref(match);
})()
;
var destroy__20885__auto___38711 = (function (){
return mql.removeEventListener("change",handler);
});
if(reagent.ratom.reactive_QMARK_()){
if((with_let38699.destroy == null)){
(with_let38699.destroy = destroy__20885__auto___38711);
} else {
}
} else {
destroy__20885__auto___38711();
}
...
var tabs_component = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.nav_tabs,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"tabs","tabs",-779855354),tabs,new cljs.core.Keyword(null,"active-tab-id","active-tab-id",1961631694),active_tab,new cljs.core.Keyword(null,"class","class",-2030961996),"border-b-0 bg-transparent px-0 text-xs",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__38697_SHARP_){
