...
var clojure$test$check$results$Result$pass_QMARK_$dyn_50708 = (function (result){
...
return clojure$test$check$results$Result$pass_QMARK_$dyn_50708(result);
}
});

var clojure$test$check$results$Result$result_data$dyn_50709 = (function (result){
var x__5373__auto__ = (((result == null))?null:result);
...
return clojure$test$check$results$Result$result_data$dyn_50709(result);
}
});
