...
var clojure$test$check$results$Result$pass_QMARK_$dyn_50872 = (function (result){
...
return clojure$test$check$results$Result$pass_QMARK_$dyn_50872(result);
}
});

var clojure$test$check$results$Result$result_data$dyn_50873 = (function (result){
var x__5373__auto__ = (((result == null))?null:result);
...
return clojure$test$check$results$Result$result_data$dyn_50873(result);
}
});
