...
var clojure$test$check$results$Result$pass_QMARK_$dyn_50654 = (function (result){
...
return clojure$test$check$results$Result$pass_QMARK_$dyn_50654(result);
}
});

var clojure$test$check$results$Result$result_data$dyn_50659 = (function (result){
var x__5373__auto__ = (((result == null))?null:result);
...
return clojure$test$check$results$Result$result_data$dyn_50659(result);
}
});
