...
var clojure$test$check$results$Result$pass_QMARK_$dyn_58078 = (function (result){
...
return clojure$test$check$results$Result$pass_QMARK_$dyn_58078(result);
}
});

var clojure$test$check$results$Result$result_data$dyn_58081 = (function (result){
var x__5373__auto__ = (((result == null))?null:result);
...
return clojure$test$check$results$Result$result_data$dyn_58081(result);
}
});
