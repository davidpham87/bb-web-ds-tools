...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.vega-lite","set-data-input","bb-web-ds-tools.views.vega-lite/set-data-input",672681982),(function (db,p__38540){
var vec__38541 = p__38540;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38541,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38541,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.vega-lite","set-config-input","bb-web-ds-tools.views.vega-lite/set-config-input",1175394425),(function (db,p__38544){
var vec__38545 = p__38544;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38545,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38545,(1),null);
return cljs.core.assoc_in(db,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("bb-web-ds-tools.views.vega-lite","config-input","bb-web-ds-tools.views.vega-lite/config-input",-593303029)], null),val);
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.vega-lite","set-config-mode","bb-web-ds-tools.views.vega-lite/set-config-mode",1935491083),(function (db,p__38549){
var vec__38550 = p__38549;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38550,(0),null);
var new_mode = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38550,(1),null);
...
var _STAR_print_newline_STAR__orig_val__38574_38804 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__38575_38805 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__38576_38806 = true;
var _STAR_print_fn_STAR__temp_val__38577_38807 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__38576_38806);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__38577_38807);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(edn_data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__38575_38805);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__38574_38804);
}
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.vega-lite","set-active-config-name","bb-web-ds-tools.views.vega-lite/set-active-config-name",-1337470050),(function (db,p__38597){
var vec__38599 = p__38597;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38599,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38599,(1),null);
return cljs.core.assoc_in(db,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("bb-web-ds-tools.views.vega-lite","active-config-name","bb-web-ds-tools.views.vega-lite/active-config-name",-1463263112)], null),name);
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.vega-lite","set-format","bb-web-ds-tools.views.vega-lite/set-format",600148309),(function (db,p__38604){
var vec__38605 = p__38604;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38605,(0),null);
var fmt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38605,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.vega-lite","set-structure","bb-web-ds-tools.views.vega-lite/set-structure",-607755948),(function (db,p__38608){
var vec__38609 = p__38608;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38609,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38609,(1),null);
return cljs.core.assoc_in(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.vega-lite","vega-lite","bb-web-ds-tools.views.vega-lite/vega-lite",348810215),new cljs.core.Keyword("bb-web-ds-tools.views.vega-lite","structure","bb-web-ds-tools.views.vega-lite/structure",1637845102)], null),s);
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.vega-lite","set-active-left-tab","bb-web-ds-tools.views.vega-lite/set-active-left-tab",300865662),(function (db,p__38613){
var vec__38614 = p__38613;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38614,(0),null);
var tab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38614,(1),null);
return cljs.core.assoc_in(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.vega-lite","vega-lite","bb-web-ds-tools.views.vega-lite/vega-lite",348810215),new cljs.core.Keyword("bb-web-ds-tools.views.vega-lite","active-left-tab","bb-web-ds-tools.views.vega-lite/active-left-tab",-1047612510)], null),tab);
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.vega-lite","set-active-right-tab","bb-web-ds-tools.views.vega-lite/set-active-right-tab",-490897405),(function (db,p__38617){
var vec__38618 = p__38617;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38618,(0),null);
var tab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38618,(1),null);
return cljs.core.assoc_in(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.vega-lite","vega-lite","bb-web-ds-tools.views.vega-lite/vega-lite",348810215),new cljs.core.Keyword("bb-web-ds-tools.views.vega-lite","active-right-tab","bb-web-ds-tools.views.vega-lite/active-right-tab",-638097379)], null),tab);
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.vega-lite","save-config","bb-web-ds-tools.views.vega-lite/save-config",1789695845),(function (db,p__38624){
var vec__38625 = p__38624;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38625,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38625,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.vega-lite","load-config","bb-web-ds-tools.views.vega-lite/load-config",-2057445703),(function (db,p__38628){
var vec__38629 = p__38628;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38629,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38629,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.vega-lite","delete-config","bb-web-ds-tools.views.vega-lite/delete-config",-602454691),(function (db,p__38632){
var vec__38633 = p__38632;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38633,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38633,(1),null);
...
var G__38640 = db;
var G__38640__$1 = cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(G__38640,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),new cljs.core.Keyword(null,"saved-configs","saved-configs",1634320315)], null),cljs.core.dissoc,name)
;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(active_name,name)){
return cljs.core.assoc_in(G__38640__$1,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("bb-web-ds-tools.views.vega-lite","active-config-name","bb-web-ds-tools.views.vega-lite/active-config-name",-1463263112)], null),null);
} else {
return G__38640__$1;
}
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.vega-lite","import-dataset","bb-web-ds-tools.views.vega-lite/import-dataset",1691198254),(function (p__38642,p__38643){
var map__38644 = p__38642;
var map__38644__$1 = cljs.core.__destructure_map(map__38644);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38644__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__38645 = p__38643;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38645,(0),null);
var dataset_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38645,(1),null);
...
var clean_data = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__38641_SHARP_){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(p1__38641_SHARP_,new cljs.core.Keyword(null,"_uuid","_uuid",797900280));
}),data);
var data_str = (function (){var sb__5670__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__38650_38862 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__38651_38863 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__38652_38864 = true;
var _STAR_print_fn_STAR__temp_val__38653_38865 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__38652_38864);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__38653_38865);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(clean_data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__38651_38863);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__38650_38862);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5670__auto__);
})();
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38665__$1)].join('')));
 ...
 */
bb_web_ds_tools.views.vega_lite.vega_viz = (function bb_web_ds_tools$views$vega_lite$vega_viz(p__38667){
var map__38668 = p__38667;
var map__38668__$1 = cljs.core.__destructure_map(map__38668);
var spec_obj = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38668__$1,new cljs.core.Keyword(null,"spec-obj","spec-obj",-642575778));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38668__$1,new cljs.core.Keyword(null,"data","data",-232669377));
...
})], null),"Save"], null),(cljs.core.truth_(cljs.core.deref(open_QMARK_))?new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),["absolute top-8 right-0 z-50 p-2 rounded shadow-lg border ",bb_web_ds_tools.theme.bg_input," ",bb_web_ds_tools.theme.border_default," flex items-center space-x-2"].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"class","class",-2030961996),"w-32 text-xs",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Name",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(name_input),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__38673_SHARP_){
return cljs.core.reset_BANG_(name_input,p1__38673_SHARP_.target.value);
...
});})(i__38694,vec__38700,id,ds,c__5501__auto__,size__5502__auto__,b__38695,s__38693__$2,temp__5825__auto__,G__38685,G__38685__$1,data_input,config_input,parsed_data,active_left_tab,active_right_tab,datasets,config_mode,saved_configs,active_config_name,parsed_config_obj,format,inferred_schema,tabs))
], null),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(ds)], null));

var G__38939 = (i__38694 + (1));
i__38694 = G__38939;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38695),bb_web_ds_tools$views$vega_lite$panel_render_$_iter__38692(cljs.core.chunk_rest(s__38693__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38695),null);
}
} else {
var vec__38703 = cljs.core.first(s__38693__$2);
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),id,new cljs.core.Keyword(null,"class","class",-2030961996),["cursor-pointer px-2 py-1 text-xs ",bb_web_ds_tools.theme.bg_item_hover," truncate"].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__38703,id,ds,s__38693__$2,temp__5825__auto__,G__38685,G__38685__$1,data_input,config_input,parsed_data,active_left_tab,active_right_tab,datasets,config_mode,saved_configs,active_config_name,parsed_config_obj,format,inferred_schema,tabs){
return (function (){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.vega-lite","import-dataset","bb-web-ds-tools.views.vega-lite/import-dataset",1691198254),id], null));
});})(vec__38703,id,ds,s__38693__$2,temp__5825__auto__,G__38685,G__38685__$1,data_input,config_input,parsed_data,active_left_tab,active_right_tab,datasets,config_mode,saved_configs,active_config_name,parsed_config_obj,format,inferred_schema,tabs))
], null),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(ds)], null),bb_web_ds_tools$views$vega_lite$panel_render_$_iter__38692(cljs.core.rest(s__38693__$2)));
}
} else {
return null;
}
...
})(),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__38683_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.vega-lite","load-config","bb-web-ds-tools.views.vega-lite/load-config",-2057445703),p1__38683_SHARP_.target.value], null));
})], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),""], null),"Select Config..."], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$vega_lite$panel_render_$_iter__38706(s__38707){
return (new cljs.core.LazySeq(null,(function (){
var s__38707__$1 = s__38707;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__38707__$1);
if(temp__5825__auto__){
var s__38707__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__38707__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__38707__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__38709 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__38708 = (0);
while(true){
if((i__38708 < size__5502__auto__)){
var name = cljs.core._nth(c__5501__auto__,i__38708);
cljs.core.chunk_append(b__38709,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),name,new cljs.core.Keyword(null,"value","value",305978217),name], null),name], null));

var G__38962 = (i__38708 + (1));
i__38708 = G__38962;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38709),bb_web_ds_tools$views$vega_lite$panel_render_$_iter__38706(cljs.core.chunk_rest(s__38707__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38709),null);
}
} else {
var name = cljs.core.first(s__38707__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),name,new cljs.core.Keyword(null,"value","value",305978217),name], null),name], null),bb_web_ds_tools$views$vega_lite$panel_render_$_iter__38706(cljs.core.rest(s__38707__$2)));
}
} else {
return null;
}
...
})], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.dustbin_icon], null)], null):null)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex-grow relative"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.editor.monaco_editor,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"value","value",305978217),config_input,new cljs.core.Keyword(null,"language","language",-1591107564),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(config_mode,new cljs.core.Keyword(null,"json","json",1279968570)))?"json":"clojure"),new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"rulers","rulers",756731282),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(80)], null),new cljs.core.Keyword(null,"minimap","minimap",-1428643929),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"enabled","enabled",1195909756),false], null)], null),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__38684_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.vega-lite","set-config-input","bb-web-ds-tools.views.vega-lite/set-config-input",1175394425),p1__38684_SHARP_], null));
})], null)], null)], null)], null);
...
})], null),"Send to Portal"], null):null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex-grow overflow-hidden relative bg-white"], null),(function (){var G__38716 = active_right_tab;
...
var _STAR_print_newline_STAR__orig_val__38717_38986 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__38718_38987 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__38719_38988 = true;
var _STAR_print_fn_STAR__temp_val__38720_38989 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__38719_38988);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__38720_38989);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(parsed_data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__38718_38987);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__38717_38986);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5670__auto__);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),["h-full w-full ",bb_web_ds_tools.theme.bg_page].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.editor.monaco_editor,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"value","value",305978217),(function (){var sb__5670__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__38721_38993 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__38722_38994 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__38723_38995 = true;
var _STAR_print_fn_STAR__temp_val__38724_38996 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__38723_38995);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__38724_38996);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(inferred_schema);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__38722_38994);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__38721_38993);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5670__auto__);
})(),new cljs.core.Keyword(null,"language","language",-1591107564),"clojure",new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"readOnly","readOnly",-1749118317),true,new cljs.core.Keyword(null,"minimap","minimap",-1428643929),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"enabled","enabled",1195909756),false], null)], null)], null)], null)], null);
} else {
