    ...
    (testing "Scenario 1: Large Dataset, Low Cardinality (Standard Enum)"
      (let [unique-vals (map #(str "Val" %) (range 50))
        ...
        (is (= [:map
                [:a
                 [:enum
                  "Val0" "Val1" "Val10" "Val11" "Val12" "Val13" "Val14" "Val15" "Val16" "Val17"
                  "Val18" "Val19" "Val2" "Val20" "Val21" "Val22" "Val23" "Val24" "Val25" "Val26"
                  "Val27" "Val28" "Val29" "Val3" "Val30" "Val31" "Val32" "Val33" "Val34" "Val35"
                  "Val36" "Val37" "Val38" "Val39" "Val4" "Val40" "Val41" "Val42" "Val43" "Val44"
                  "Val45" "Val46" "Val47" "Val48" "Val49" "Val5" "Val6" "Val7" "Val8" "Val9"]]]
               schema))))
        ...
        (is (= [:map
                [:a
                 [:enum
                  ...
                  "V45" "V46" "V47" "V48" "V49" "V5" "V6" "V7" "V8" "V9"]]]
               schema))))
