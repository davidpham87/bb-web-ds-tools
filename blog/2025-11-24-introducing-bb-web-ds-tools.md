...
Will it eat your battery life? Look, freedom isn't free, and neither is the
electricity required to run a Large Language Model on a MacBook Air.

## What is this thing?

It's a dashboard built with **ClojureScript**, because we like our parentheses
like we like our government: nested, confusing, and surprisingly powerful if
...
*   **Privacy:** Your data never leaves your computer. It stays right there in
    the browser memory. This means even *we* can't see your embarrassing CSV
    files named `final_final_v2_ACTUALLY_FINAL.csv`.
*   **Polyglot:** We have Python. We have R. We have Clojure. It’s like the
    United Nations of programming languages, but with less arguing and more
    stack traces.

So go ahead. Give it a spin. It’s free, it’s local, and it definitely won’t
mine crypto in the background. (It won't. We checked. We think.)
