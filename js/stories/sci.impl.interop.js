...
var args__$1 = args.map((function (p1__28960_SHARP_){
...
return Reflect.construct(constructor$,args.map((function (p1__28972_SHARP_){
return sci.impl.types.eval(p1__28972_SHARP_,ctx,bindings);
})));
});
sci.impl.interop.invoke_static_method = (function sci$impl$interop$invoke_static_method(ctx,bindings,class$,method,args){
return Reflect.apply(method,class$,args.map((function (p1__28987_SHARP_){
return sci.impl.types.eval(p1__28987_SHARP_,ctx,bindings);
})));
});
...
if(cljs.core.truth_(temp__5823__auto__)){
var vec__28994 = temp__5823__auto__;
