...
var len__5749__auto___38129 = arguments.length;
var i__5750__auto___38130 = (0);
while(true){
if((i__5750__auto___38130 < len__5749__auto___38129)){
args__5755__auto__.push((arguments[i__5750__auto___38130]));

var G__38131 = (i__5750__auto___38130 + (1));
i__5750__auto___38130 = G__38131;
continue;
} else {
}
break;
...
/** @this {Function} */
(bb_web_ds_tools.views.datasets.deep_merge.cljs$lang$applyTo = (function (seq37934){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq37934));
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"datasets","datasets",1896364419)], null),(function (p1__37943_SHARP_){
return bb_web_ds_tools.views.datasets.deep_merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__37943_SHARP_,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"items","items",1031954938),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"new-dataset-state","new-dataset-state",1109324301),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"name","name",1843675177),"New Dataset",new cljs.core.Keyword(null,"text","text",-1790561697),"",new cljs.core.Keyword(null,"format","format",-1306924766),new cljs.core.Keyword(null,"csv","csv",-1164440893),new cljs.core.Keyword(null,"structure","structure",1563832083),new cljs.core.Keyword(null,"columnar","columnar",-1122999701)], null)], null)], 0));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","set-active-dataset-id","bb-web-ds-tools.views.datasets/set-active-dataset-id",1361188762),(function (db,p__37978){
var vec__37979 = p__37978;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37979,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37979,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-new-dataset-state","bb-web-ds-tools.views.datasets/update-new-dataset-state",-1930125405),(function (db,p__37982){
var vec__37983 = p__37982;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37983,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37983,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37983,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","add-dataset","bb-web-ds-tools.views.datasets/add-dataset",1462625692),(function (db,p__38018){
var vec__38019 = p__38018;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38019,(0),null);
var map__38022 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38019,(1),null);
var map__38022__$1 = cljs.core.__destructure_map(map__38022);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38022__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38022__$1,new cljs.core.Keyword(null,"data","data",-232669377));
...
var data_with_ids = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__37986_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__37986_SHARP_,new cljs.core.Keyword(null,"_uuid","_uuid",797900280),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.random_uuid()));
}),valid_data);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","delete-dataset","bb-web-ds-tools.views.datasets/delete-dataset",243110744),(function (db,p__38023){
var vec__38024 = p__38023;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38024,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38024,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-dataset-name","bb-web-ds-tools.views.datasets/update-dataset-name",798576715),(function (db,p__38027){
var vec__38028 = p__38027;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38028,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38028,(1),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38028,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),(function (db,p__38031){
var vec__38032 = p__38031;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38032,(0),null);
var dataset_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38032,(1),null);
var row_uuid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38032,(2),null);
var col_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38032,(3),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38032,(4),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),(function (db,p__38035){
var vec__38036 = p__38035;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38036,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38036,(1),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38036,(2),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38036,(3),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","fetch-vega-datasets","bb-web-ds-tools.views.datasets/fetch-vega-datasets",202932363),(function (p__38042,_){
var map__38043 = p__38042;
var map__38043__$1 = cljs.core.__destructure_map(map__38043);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38043__$1,new cljs.core.Keyword(null,"db","db",993250759));
fetch("https://cdn.jsdelivr.net/npm/vega-datasets/data/").then((function (p1__38039_SHARP_){
return p1__38039_SHARP_.text();
})).then((function (p1__38040_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","receive-vega-datasets","bb-web-ds-tools.views.datasets/receive-vega-datasets",-736628262),p1__38040_SHARP_], null));
})).catch((function (p1__38041_SHARP_){
return console.error("Failed to fetch vega datasets list",p1__38041_SHARP_);
}));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","receive-vega-datasets","bb-web-ds-tools.views.datasets/receive-vega-datasets",-736628262),(function (db,p__38046){
var vec__38047 = p__38046;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38047,(0),null);
var html_content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38047,(1),null);
...
var filenames = cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.sort.cljs$core$IFn$_invoke$arity$1(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__38045_SHARP_){
return cljs.core.re_find(/\.(json|csv|tsv|md)$/,p1__38045_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38044_SHARP_){
return p1__38044_SHARP_.innerText;
}),links))));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","fetch-vega-dataset","bb-web-ds-tools.views.datasets/fetch-vega-dataset",1814090652),(function (p__38053,p__38054){
var map__38055 = p__38053;
var map__38055__$1 = cljs.core.__destructure_map(map__38055);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38055__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__38056 = p__38054;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38056,(0),null);
var filename = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38056,(1),null);
var url = ["https://cdn.jsdelivr.net/npm/vega-datasets@3/data/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(filename)].join('');
fetch(url).then((function (p1__38050_SHARP_){
return p1__38050_SHARP_.text();
})).then((function (p1__38051_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","receive-vega-dataset-content","bb-web-ds-tools.views.datasets/receive-vega-dataset-content",-385162532),filename,p1__38051_SHARP_], null));
})).catch((function (p1__38052_SHARP_){
return console.error("Failed to fetch vega dataset",p1__38052_SHARP_);
}));

return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"db","db",993250759),cljs.core.assoc_in(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","datasets","bb-web-ds-tools.views.datasets/datasets",-1461208347),new cljs.core.Keyword(null,"loading-vega-dataset?","loading-vega-dataset?",-1002270211)], null),true)], null);
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","receive-vega-dataset-content","bb-web-ds-tools.views.datasets/receive-vega-dataset-content",-385162532),(function (db,p__38059){
var vec__38060 = p__38059;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38060,(0),null);
var filename = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38060,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38060,(2),null);
var extension = cljs.core.last(clojure.string.split.cljs$core$IFn$_invoke$arity$2(filename,/\./));
var format = (function (){var G__38063 = extension;
switch (G__38063) {
case "json":
...
});})(i__38067,col,c__5501__auto__,size__5502__auto__,b__38068,s__38066__$2,temp__5825__auto__))
...
return (function (){
var map__38071 = cljs.core.deref(state);
var map__38071__$1 = cljs.core.__destructure_map(map__38071);
var fmt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38071__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var name_val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38071__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38071__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var structure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38071__$1,new cljs.core.Keyword(null,"structure","structure",1563832083));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38075),bb_web_ds_tools$views$datasets$importer_view_$_iter__38072(cljs.core.chunk_rest(s__38073__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38075),null);
}
} else {
var ds = cljs.core.first(s__38073__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),ds,new cljs.core.Keyword(null,"value","value",305978217),ds], null),ds], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__38072(cljs.core.rest(s__38073__$2)));
}
} else {
return null;
}
...
})()], null))], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"space-x-2"], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$importer_view_$_iter__38076(s__38077){
return (new cljs.core.LazySeq(null,(function (){
var s__38077__$1 = s__38077;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__38077__$1);
if(temp__5825__auto__){
var s__38077__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__38077__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__38077__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__38079 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__38078 = (0);
while(true){
if((i__38078 < size__5502__auto__)){
var f = cljs.core._nth(c__5501__auto__,i__38078);
cljs.core.chunk_append(b__38079,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),f,new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(fmt,f))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):""),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__38078,f,c__5501__auto__,size__5502__auto__,b__38079,s__38077__$2,temp__5825__auto__,map__38071,map__38071__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_){
return (function (){
set_state(new cljs.core.Keyword(null,"format","format",-1306924766),f);

if(cljs.core.truth_((function (){var fexpr__38080 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"markdown","markdown",1227225089),null,new cljs.core.Keyword(null,"csv","csv",-1164440893),null,new cljs.core.Keyword(null,"tsv","tsv",-1254214356),null], null), null);
return (fexpr__38080.cljs$core$IFn$_invoke$arity$1 ? fexpr__38080.cljs$core$IFn$_invoke$arity$1(f) : fexpr__38080.call(null,f));
})())){
...
});})(i__38078,f,c__5501__auto__,size__5502__auto__,b__38079,s__38077__$2,temp__5825__auto__,map__38071,map__38071__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38079),bb_web_ds_tools$views$datasets$importer_view_$_iter__38076(cljs.core.chunk_rest(s__38077__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38079),null);
}
} else {
var f = cljs.core.first(s__38077__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),f,new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(fmt,f))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):""),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (f,s__38077__$2,temp__5825__auto__,map__38071,map__38071__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_){
return (function (){
set_state(new cljs.core.Keyword(null,"format","format",-1306924766),f);

if(cljs.core.truth_((function (){var fexpr__38081 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"markdown","markdown",1227225089),null,new cljs.core.Keyword(null,"csv","csv",-1164440893),null,new cljs.core.Keyword(null,"tsv","tsv",-1254214356),null], null), null);
return (fexpr__38081.cljs$core$IFn$_invoke$arity$1 ? fexpr__38081.cljs$core$IFn$_invoke$arity$1(f) : fexpr__38081.call(null,f));
})())){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),new cljs.core.Keyword(null,"columnar","columnar",-1122999701));
} else {
return null;
}
});})(f,s__38077__$2,temp__5825__auto__,map__38071,map__38071__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_))
], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"markdown","markdown",1227225089)))?"MD":clojure.string.upper_case(cljs.core.name(f)))], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__38076(cljs.core.rest(s__38077__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38085),bb_web_ds_tools$views$datasets$importer_view_$_iter__38082(cljs.core.chunk_rest(s__38083__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38085),null);
}
} else {
var s = cljs.core.first(s__38083__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"key","key",-1516042587),s,new cljs.core.Keyword(null,"disabled","disabled",-1529784218),(!(cljs.core.contains_QMARK_(supported_structures,s))),new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(structure__$1,s))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):(((!(cljs.core.contains_QMARK_(supported_structures,s))))?"opacity-50 cursor-not-allowed":"")),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (s,s__38083__$2,temp__5825__auto__,map__38071,map__38071__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_){
return (function (){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),s);
});})(s,s__38083__$2,temp__5825__auto__,map__38071,map__38071__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_))
], null),cljs.core.get.cljs$core$IFn$_invoke$arity$2(struct_labels,s)], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__38082(cljs.core.rest(s__38083__$2)));
}
} else {
return null;
}
...
var map__38090 = dataset;
var map__38090__$1 = cljs.core.__destructure_map(map__38090);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38090__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38090__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38090__$1,new cljs.core.Keyword(null,"columns","columns",1998437288));
var view_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38090__$1,new cljs.core.Keyword(null,"view-state","view-state",-976675614));
var map__38091 = view_state;
var map__38091__$1 = cljs.core.__destructure_map(map__38091);
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38091__$1,new cljs.core.Keyword(null,"page","page",849072397));
var rows_per_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38091__$1,new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959));
var filters = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38091__$1,new cljs.core.Keyword(null,"filters","filters",974726919));
var hidden_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38091__$1,new cljs.core.Keyword(null,"hidden-columns","hidden-columns",-1045524800));
var sort_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38091__$1,new cljs.core.Keyword(null,"sort-col","sort-col",-718754882));
var sort_dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38091__$1,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757));
var map__38092 = bb_web_ds_tools.utils.dataset_processing.process_table_data(data,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(view_state,new cljs.core.Keyword(null,"columns","columns",1998437288),columns));
var map__38092__$1 = cljs.core.__destructure_map(map__38092);
var page_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38092__$1,new cljs.core.Keyword(null,"page-data","page-data",1443840710));
var total_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38092__$1,new cljs.core.Keyword(null,"total-rows","total-rows",1745495528));
var start_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38092__$1,new cljs.core.Keyword(null,"start-idx","start-idx",-1600773745));
var end_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38092__$1,new cljs.core.Keyword(null,"end-idx","end-idx",-85750788));
var visible_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38092__$1,new cljs.core.Keyword(null,"visible-columns","visible-columns",1134718660));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_col,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"space-y-4 p-4"], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),["flex-wrap gap-4 items-end ",bb_web_ds_tools.theme.bg_toolbar," p-2 rounded shadow-sm"].join('')], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.label,"Rows"], null),new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.select,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),"py-1",new cljs.core.Keyword(null,"value","value",305978217),rows_per_page,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__38087_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959),parseInt(p1__38087_SHARP_.target.value)], null));
...
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"page","page",849072397),(page + (1))], null));
}),new cljs.core.Keyword(null,"disabled","disabled",-1529784218),(end_idx >= total_rows)], null),"Next"], null)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.table_container,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.table,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.thead,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__38093(s__38094){
return (new cljs.core.LazySeq(null,(function (){
var s__38094__$1 = s__38094;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__38094__$1);
if(temp__5825__auto__){
var s__38094__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__38094__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__38094__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__38096 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__38095 = (0);
while(true){
if((i__38095 < size__5502__auto__)){
var col = cljs.core._nth(c__5501__auto__,i__38095);
cljs.core.chunk_append(b__38096,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.th,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["cursor-pointer ",bb_web_ds_tools.theme.bg_item_hover].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__38095,col,c__5501__auto__,size__5502__auto__,b__38096,s__38094__$2,temp__5825__auto__,map__38090,map__38090__$1,id,data,columns,view_state,map__38091,map__38091__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38092,map__38092__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
...
});})(i__38095,col,c__5501__auto__,size__5502__auto__,b__38096,s__38094__$2,temp__5825__auto__,map__38090,map__38090__$1,id,data,columns,view_state,map__38091,map__38091__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38092,map__38092__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38096),bb_web_ds_tools$views$datasets$data_table_$_iter__38093(cljs.core.chunk_rest(s__38094__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38096),null);
}
} else {
var col = cljs.core.first(s__38094__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.th,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["cursor-pointer ",bb_web_ds_tools.theme.bg_item_hover].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (col,s__38094__$2,temp__5825__auto__,map__38090,map__38090__$1,id,data,columns,view_state,map__38091,map__38091__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38092,map__38092__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
var new_dir = ((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_col,col)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))))?new cljs.core.Keyword(null,"desc","desc",2093485764):new cljs.core.Keyword(null,"asc","asc",356854569));
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"sort-col","sort-col",-718754882),col], null));

return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757),new_dir], null));
});})(col,s__38094__$2,temp__5825__auto__,map__38090,map__38090__$1,id,data,columns,view_state,map__38091,map__38091__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38092,map__38092__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex items-center space-x-1"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),cljs.core.name(col)], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_col,col))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-[10px] transform translate-y-px"], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))?"\u25B2":"\u25BC")], null):null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__38093(cljs.core.rest(s__38094__$2)));
}
} else {
return null;
}
...
})()], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tbody,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__38097(s__38098){
return (new cljs.core.LazySeq(null,(function (){
var s__38098__$1 = s__38098;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__38098__$1);
if(temp__5825__auto__){
var s__38098__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__38098__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__38098__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__38100 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__38099 = (0);
while(true){
if((i__38099 < size__5502__auto__)){
var col = cljs.core._nth(c__5501__auto__,i__38099);
cljs.core.chunk_append(b__38100,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),["filter-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(col)].join(''),new cljs.core.Keyword(null,"class","class",-2030961996),"px-3 py-1.5"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-sm",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),["Filter ",cljs.core.name(col)].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(filters,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__38099,col,c__5501__auto__,size__5502__auto__,b__38100,s__38098__$2,temp__5825__auto__,map__38090,map__38090__$1,id,data,columns,view_state,map__38091,map__38091__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38092,map__38092__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__38088_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"filters","filters",974726919),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(filters,col,p1__38088_SHARP_.target.value)], null));
});})(i__38099,col,c__5501__auto__,size__5502__auto__,b__38100,s__38098__$2,temp__5825__auto__,map__38090,map__38090__$1,id,data,columns,view_state,map__38091,map__38091__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38092,map__38092__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__38182 = (i__38099 + (1));
i__38099 = G__38182;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38100),bb_web_ds_tools$views$datasets$data_table_$_iter__38097(cljs.core.chunk_rest(s__38098__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38100),null);
}
} else {
var col = cljs.core.first(s__38098__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),["filter-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(col)].join(''),new cljs.core.Keyword(null,"class","class",-2030961996),"px-3 py-1.5"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-sm",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),["Filter ",cljs.core.name(col)].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(filters,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__38098__$2,temp__5825__auto__,map__38090,map__38090__$1,id,data,columns,view_state,map__38091,map__38091__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38092,map__38092__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__38088_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"filters","filters",974726919),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(filters,col,p1__38088_SHARP_.target.value)], null));
});})(col,s__38098__$2,temp__5825__auto__,map__38090,map__38090__$1,id,data,columns,view_state,map__38091,map__38091__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38092,map__38092__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__38097(cljs.core.rest(s__38098__$2)));
}
} else {
return null;
}
...
return iter__5503__auto__(visible_columns);
})()], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__38101(s__38102){
return (new cljs.core.LazySeq(null,(function (){
var s__38102__$1 = s__38102;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__38102__$1);
if(temp__5825__auto__){
var s__38102__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__38102__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__38102__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__38104 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__38103 = (0);
while(true){
if((i__38103 < size__5502__auto__)){
var row = cljs.core._nth(c__5501__auto__,i__38103);
cljs.core.chunk_append(b__38104,(function (){var row_uuid = new cljs.core.Keyword(null,"_uuid","_uuid",797900280).cljs$core$IFn$_invoke$arity$1(row);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row_uuid], null),(function (){var iter__5503__auto__ = ((function (i__38103,row_uuid,row,c__5501__auto__,size__5502__auto__,b__38104,s__38102__$2,temp__5825__auto__,map__38090,map__38090__$1,id,data,columns,view_state,map__38091,map__38091__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38092,map__38092__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function bb_web_ds_tools$views$datasets$data_table_$_iter__38101_$_iter__38105(s__38106){
return (new cljs.core.LazySeq(null,((function (i__38103,row_uuid,row,c__5501__auto__,size__5502__auto__,b__38104,s__38102__$2,temp__5825__auto__,map__38090,map__38090__$1,id,data,columns,view_state,map__38091,map__38091__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38092,map__38092__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
var s__38106__$1 = s__38106;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__38106__$1);
if(temp__5825__auto____$1){
var s__38106__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__38106__$2)){
var c__5501__auto____$1 = cljs.core.chunk_first(s__38106__$2);
var size__5502__auto____$1 = cljs.core.count(c__5501__auto____$1);
var b__38108 = cljs.core.chunk_buffer(size__5502__auto____$1);
if((function (){var i__38107 = (0);
while(true){
if((i__38107 < size__5502__auto____$1)){
var col = cljs.core._nth(c__5501__auto____$1,i__38107);
cljs.core.chunk_append(b__38108,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__38107,i__38103,col,c__5501__auto____$1,size__5502__auto____$1,b__38108,s__38106__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__38104,s__38102__$2,temp__5825__auto__,map__38090,map__38090__$1,id,data,columns,view_state,map__38091,map__38091__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38092,map__38092__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__38089_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__38089_SHARP_.target.value], null));
});})(i__38107,i__38103,col,c__5501__auto____$1,size__5502__auto____$1,b__38108,s__38106__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__38104,s__38102__$2,temp__5825__auto__,map__38090,map__38090__$1,id,data,columns,view_state,map__38091,map__38091__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38092,map__38092__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__38186 = (i__38107 + (1));
i__38107 = G__38186;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38108),bb_web_ds_tools$views$datasets$data_table_$_iter__38101_$_iter__38105(cljs.core.chunk_rest(s__38106__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38108),null);
}
} else {
var col = cljs.core.first(s__38106__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__38103,col,s__38106__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__38104,s__38102__$2,temp__5825__auto__,map__38090,map__38090__$1,id,data,columns,view_state,map__38091,map__38091__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38092,map__38092__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__38089_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__38089_SHARP_.target.value], null));
});})(i__38103,col,s__38106__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__38104,s__38102__$2,temp__5825__auto__,map__38090,map__38090__$1,id,data,columns,view_state,map__38091,map__38091__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38092,map__38092__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__38101_$_iter__38105(cljs.core.rest(s__38106__$2)));
}
} else {
return null;
}
...
});})(i__38103,row_uuid,row,c__5501__auto__,size__5502__auto__,b__38104,s__38102__$2,temp__5825__auto__,map__38090,map__38090__$1,id,data,columns,view_state,map__38091,map__38091__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38092,map__38092__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
,null,null));
});})(i__38103,row_uuid,row,c__5501__auto__,size__5502__auto__,b__38104,s__38102__$2,temp__5825__auto__,map__38090,map__38090__$1,id,data,columns,view_state,map__38091,map__38091__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38092,map__38092__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
;
return iter__5503__auto__(visible_columns);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38104),bb_web_ds_tools$views$datasets$data_table_$_iter__38101(cljs.core.chunk_rest(s__38102__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38104),null);
}
} else {
var row = cljs.core.first(s__38102__$2);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row_uuid], null),(function (){var iter__5503__auto__ = ((function (row_uuid,row,s__38102__$2,temp__5825__auto__,map__38090,map__38090__$1,id,data,columns,view_state,map__38091,map__38091__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38092,map__38092__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function bb_web_ds_tools$views$datasets$data_table_$_iter__38101_$_iter__38109(s__38110){
return (new cljs.core.LazySeq(null,(function (){
var s__38110__$1 = s__38110;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__38110__$1);
if(temp__5825__auto____$1){
var s__38110__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__38110__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__38110__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__38112 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__38111 = (0);
while(true){
if((i__38111 < size__5502__auto__)){
var col = cljs.core._nth(c__5501__auto__,i__38111);
cljs.core.chunk_append(b__38112,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__38111,col,c__5501__auto__,size__5502__auto__,b__38112,s__38110__$2,temp__5825__auto____$1,row_uuid,row,s__38102__$2,temp__5825__auto__,map__38090,map__38090__$1,id,data,columns,view_state,map__38091,map__38091__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38092,map__38092__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__38089_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__38089_SHARP_.target.value], null));
});})(i__38111,col,c__5501__auto__,size__5502__auto__,b__38112,s__38110__$2,temp__5825__auto____$1,row_uuid,row,s__38102__$2,temp__5825__auto__,map__38090,map__38090__$1,id,data,columns,view_state,map__38091,map__38091__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38092,map__38092__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__38192 = (i__38111 + (1));
i__38111 = G__38192;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38112),bb_web_ds_tools$views$datasets$data_table_$_iter__38101_$_iter__38109(cljs.core.chunk_rest(s__38110__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38112),null);
}
} else {
var col = cljs.core.first(s__38110__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__38110__$2,temp__5825__auto____$1,row_uuid,row,s__38102__$2,temp__5825__auto__,map__38090,map__38090__$1,id,data,columns,view_state,map__38091,map__38091__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38092,map__38092__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__38089_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__38089_SHARP_.target.value], null));
});})(col,s__38110__$2,temp__5825__auto____$1,row_uuid,row,s__38102__$2,temp__5825__auto__,map__38090,map__38090__$1,id,data,columns,view_state,map__38091,map__38091__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38092,map__38092__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__38101_$_iter__38109(cljs.core.rest(s__38110__$2)));
}
} else {
return null;
}
...
});})(row_uuid,row,s__38102__$2,temp__5825__auto__,map__38090,map__38090__$1,id,data,columns,view_state,map__38091,map__38091__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38092,map__38092__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
;
return iter__5503__auto__(visible_columns);
})()], null);
})(),bb_web_ds_tools$views$datasets$data_table_$_iter__38101(cljs.core.rest(s__38102__$2)));
}
} else {
return null;
}
...
return (function (){
var map__38117 = cljs.core.deref(state_sub);
var map__38117__$1 = cljs.core.__destructure_map(map__38117);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38117__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var active_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38117__$1,new cljs.core.Keyword(null,"active-id","active-id",-59238656));
...
})], null),"+ New Dataset"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex-grow overflow-y-auto p-2 space-y-1"], null),((cljs.core.seq(items))?(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$dataset_list_$_iter__38118(s__38119){
return (new cljs.core.LazySeq(null,(function (){
var s__38119__$1 = s__38119;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__38119__$1);
if(temp__5825__auto__){
var s__38119__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__38119__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__38119__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__38121 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__38120 = (0);
while(true){
if((i__38120 < size__5502__auto__)){
var vec__38122 = cljs.core._nth(c__5501__auto__,i__38120);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38122,(0),null);
var ds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38122,(1),null);
cljs.core.chunk_append(b__38121,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.datasets.dataset_list_item,id,ds,active_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__38201 = (i__38120 + (1));
i__38120 = G__38201;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38121),bb_web_ds_tools$views$datasets$dataset_list_$_iter__38118(cljs.core.chunk_rest(s__38119__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38121),null);
}
} else {
var vec__38125 = cljs.core.first(s__38119__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38125,(0),null);
var ds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38125,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.datasets.dataset_list_item,id,ds,active_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),bb_web_ds_tools$views$datasets$dataset_list_$_iter__38118(cljs.core.rest(s__38119__$2)));
}
} else {
return null;
}
...
return (function (){
var map__38128 = cljs.core.deref(state_sub);
var map__38128__$1 = cljs.core.__destructure_map(map__38128);
var active_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38128__$1,new cljs.core.Keyword(null,"active-id","active-id",-59238656));
var active_dataset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38128__$1,new cljs.core.Keyword(null,"active-dataset","active-dataset",771380472));
