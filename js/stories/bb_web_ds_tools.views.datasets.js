...
var len__5749__auto___38127 = arguments.length;
var i__5750__auto___38128 = (0);
while(true){
if((i__5750__auto___38128 < len__5749__auto___38127)){
args__5755__auto__.push((arguments[i__5750__auto___38128]));

var G__38129 = (i__5750__auto___38128 + (1));
i__5750__auto___38128 = G__38129;
continue;
} else {
}
break;
...
/** @this {Function} */
(bb_web_ds_tools.views.datasets.deep_merge.cljs$lang$applyTo = (function (seq37932){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq37932));
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"datasets","datasets",1896364419)], null),(function (p1__37939_SHARP_){
return bb_web_ds_tools.views.datasets.deep_merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__37939_SHARP_,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"items","items",1031954938),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"new-dataset-state","new-dataset-state",1109324301),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"name","name",1843675177),"New Dataset",new cljs.core.Keyword(null,"text","text",-1790561697),"",new cljs.core.Keyword(null,"format","format",-1306924766),new cljs.core.Keyword(null,"csv","csv",-1164440893),new cljs.core.Keyword(null,"structure","structure",1563832083),new cljs.core.Keyword(null,"columnar","columnar",-1122999701)], null)], null)], 0));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","set-active-dataset-id","bb-web-ds-tools.views.datasets/set-active-dataset-id",1361188762),(function (db,p__37974){
var vec__37975 = p__37974;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37975,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37975,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-new-dataset-state","bb-web-ds-tools.views.datasets/update-new-dataset-state",-1930125405),(function (db,p__37978){
var vec__37979 = p__37978;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37979,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37979,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37979,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","add-dataset","bb-web-ds-tools.views.datasets/add-dataset",1462625692),(function (db,p__38014){
var vec__38015 = p__38014;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38015,(0),null);
var map__38018 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38015,(1),null);
var map__38018__$1 = cljs.core.__destructure_map(map__38018);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38018__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38018__$1,new cljs.core.Keyword(null,"data","data",-232669377));
...
var data_with_ids = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__37982_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__37982_SHARP_,new cljs.core.Keyword(null,"_uuid","_uuid",797900280),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.random_uuid()));
}),valid_data);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","delete-dataset","bb-web-ds-tools.views.datasets/delete-dataset",243110744),(function (db,p__38019){
var vec__38020 = p__38019;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38020,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38020,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-dataset-name","bb-web-ds-tools.views.datasets/update-dataset-name",798576715),(function (db,p__38025){
var vec__38026 = p__38025;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38026,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38026,(1),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38026,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),(function (db,p__38029){
var vec__38030 = p__38029;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38030,(0),null);
var dataset_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38030,(1),null);
var row_uuid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38030,(2),null);
var col_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38030,(3),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38030,(4),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),(function (db,p__38033){
var vec__38034 = p__38033;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38034,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38034,(1),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38034,(2),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38034,(3),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","fetch-vega-datasets","bb-web-ds-tools.views.datasets/fetch-vega-datasets",202932363),(function (p__38040,_){
var map__38041 = p__38040;
var map__38041__$1 = cljs.core.__destructure_map(map__38041);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38041__$1,new cljs.core.Keyword(null,"db","db",993250759));
fetch("https://cdn.jsdelivr.net/npm/vega-datasets/data/").then((function (p1__38037_SHARP_){
return p1__38037_SHARP_.text();
})).then((function (p1__38038_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","receive-vega-datasets","bb-web-ds-tools.views.datasets/receive-vega-datasets",-736628262),p1__38038_SHARP_], null));
})).catch((function (p1__38039_SHARP_){
return console.error("Failed to fetch vega datasets list",p1__38039_SHARP_);
}));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","receive-vega-datasets","bb-web-ds-tools.views.datasets/receive-vega-datasets",-736628262),(function (db,p__38044){
var vec__38045 = p__38044;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38045,(0),null);
var html_content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38045,(1),null);
...
var filenames = cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.sort.cljs$core$IFn$_invoke$arity$1(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__38043_SHARP_){
return cljs.core.re_find(/\.(json|csv|tsv|md)$/,p1__38043_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38042_SHARP_){
return p1__38042_SHARP_.innerText;
}),links))));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","fetch-vega-dataset","bb-web-ds-tools.views.datasets/fetch-vega-dataset",1814090652),(function (p__38051,p__38052){
...
var vec__38054 = p__38052;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38054,(0),null);
var filename = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38054,(1),null);
var url = ["https://cdn.jsdelivr.net/npm/vega-datasets@3/data/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(filename)].join('');
fetch(url).then((function (p1__38048_SHARP_){
return p1__38048_SHARP_.text();
})).then((function (p1__38049_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","receive-vega-dataset-content","bb-web-ds-tools.views.datasets/receive-vega-dataset-content",-385162532),filename,p1__38049_SHARP_], null));
})).catch((function (p1__38050_SHARP_){
return console.error("Failed to fetch vega dataset",p1__38050_SHARP_);
}));

return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"db","db",993250759),cljs.core.assoc_in(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","datasets","bb-web-ds-tools.views.datasets/datasets",-1461208347),new cljs.core.Keyword(null,"loading-vega-dataset?","loading-vega-dataset?",-1002270211)], null),true)], null);
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","receive-vega-dataset-content","bb-web-ds-tools.views.datasets/receive-vega-dataset-content",-385162532),(function (db,p__38057){
var vec__38058 = p__38057;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38058,(0),null);
var filename = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38058,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38058,(2),null);
var extension = cljs.core.last(clojure.string.split.cljs$core$IFn$_invoke$arity$2(filename,/\./));
var format = (function (){var G__38061 = extension;
switch (G__38061) {
case "json":
...
});})(i__38065,col,c__5501__auto__,size__5502__auto__,b__38066,s__38064__$2,temp__5825__auto__))
...
return (function (){
var map__38069 = cljs.core.deref(state);
var map__38069__$1 = cljs.core.__destructure_map(map__38069);
var fmt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38069__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var name_val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38069__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38069__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var structure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38069__$1,new cljs.core.Keyword(null,"structure","structure",1563832083));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38073),bb_web_ds_tools$views$datasets$importer_view_$_iter__38070(cljs.core.chunk_rest(s__38071__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38073),null);
}
} else {
var ds = cljs.core.first(s__38071__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),ds,new cljs.core.Keyword(null,"value","value",305978217),ds], null),ds], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__38070(cljs.core.rest(s__38071__$2)));
}
} else {
return null;
}
...
})()], null))], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"space-x-2"], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$importer_view_$_iter__38074(s__38075){
return (new cljs.core.LazySeq(null,(function (){
var s__38075__$1 = s__38075;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__38075__$1);
if(temp__5825__auto__){
var s__38075__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__38075__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__38075__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__38077 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__38076 = (0);
while(true){
if((i__38076 < size__5502__auto__)){
var f = cljs.core._nth(c__5501__auto__,i__38076);
cljs.core.chunk_append(b__38077,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),f,new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(fmt,f))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):""),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__38076,f,c__5501__auto__,size__5502__auto__,b__38077,s__38075__$2,temp__5825__auto__,map__38069,map__38069__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_){
return (function (){
set_state(new cljs.core.Keyword(null,"format","format",-1306924766),f);

if(cljs.core.truth_((function (){var fexpr__38078 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"markdown","markdown",1227225089),null,new cljs.core.Keyword(null,"csv","csv",-1164440893),null,new cljs.core.Keyword(null,"tsv","tsv",-1254214356),null], null), null);
return (fexpr__38078.cljs$core$IFn$_invoke$arity$1 ? fexpr__38078.cljs$core$IFn$_invoke$arity$1(f) : fexpr__38078.call(null,f));
})())){
...
});})(i__38076,f,c__5501__auto__,size__5502__auto__,b__38077,s__38075__$2,temp__5825__auto__,map__38069,map__38069__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38077),bb_web_ds_tools$views$datasets$importer_view_$_iter__38074(cljs.core.chunk_rest(s__38075__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38077),null);
}
} else {
var f = cljs.core.first(s__38075__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),f,new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(fmt,f))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):""),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (f,s__38075__$2,temp__5825__auto__,map__38069,map__38069__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_){
return (function (){
set_state(new cljs.core.Keyword(null,"format","format",-1306924766),f);

if(cljs.core.truth_((function (){var fexpr__38079 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"markdown","markdown",1227225089),null,new cljs.core.Keyword(null,"csv","csv",-1164440893),null,new cljs.core.Keyword(null,"tsv","tsv",-1254214356),null], null), null);
return (fexpr__38079.cljs$core$IFn$_invoke$arity$1 ? fexpr__38079.cljs$core$IFn$_invoke$arity$1(f) : fexpr__38079.call(null,f));
})())){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),new cljs.core.Keyword(null,"columnar","columnar",-1122999701));
} else {
return null;
}
});})(f,s__38075__$2,temp__5825__auto__,map__38069,map__38069__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_))
], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"markdown","markdown",1227225089)))?"MD":clojure.string.upper_case(cljs.core.name(f)))], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__38074(cljs.core.rest(s__38075__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38083),bb_web_ds_tools$views$datasets$importer_view_$_iter__38080(cljs.core.chunk_rest(s__38081__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38083),null);
}
} else {
var s = cljs.core.first(s__38081__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"key","key",-1516042587),s,new cljs.core.Keyword(null,"disabled","disabled",-1529784218),(!(cljs.core.contains_QMARK_(supported_structures,s))),new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(structure__$1,s))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):(((!(cljs.core.contains_QMARK_(supported_structures,s))))?"opacity-50 cursor-not-allowed":"")),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (s,s__38081__$2,temp__5825__auto__,map__38069,map__38069__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_){
return (function (){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),s);
});})(s,s__38081__$2,temp__5825__auto__,map__38069,map__38069__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_))
], null),cljs.core.get.cljs$core$IFn$_invoke$arity$2(struct_labels,s)], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__38080(cljs.core.rest(s__38081__$2)));
}
} else {
return null;
}
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38088__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38088__$1,new cljs.core.Keyword(null,"columns","columns",1998437288));
var view_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38088__$1,new cljs.core.Keyword(null,"view-state","view-state",-976675614));
var map__38089 = view_state;
var map__38089__$1 = cljs.core.__destructure_map(map__38089);
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38089__$1,new cljs.core.Keyword(null,"page","page",849072397));
var rows_per_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38089__$1,new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959));
var filters = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38089__$1,new cljs.core.Keyword(null,"filters","filters",974726919));
var hidden_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38089__$1,new cljs.core.Keyword(null,"hidden-columns","hidden-columns",-1045524800));
var sort_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38089__$1,new cljs.core.Keyword(null,"sort-col","sort-col",-718754882));
var sort_dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38089__$1,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757));
var map__38090 = bb_web_ds_tools.utils.dataset_processing.process_table_data(data,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(view_state,new cljs.core.Keyword(null,"columns","columns",1998437288),columns));
var map__38090__$1 = cljs.core.__destructure_map(map__38090);
var page_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38090__$1,new cljs.core.Keyword(null,"page-data","page-data",1443840710));
var total_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38090__$1,new cljs.core.Keyword(null,"total-rows","total-rows",1745495528));
var start_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38090__$1,new cljs.core.Keyword(null,"start-idx","start-idx",-1600773745));
var end_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38090__$1,new cljs.core.Keyword(null,"end-idx","end-idx",-85750788));
var visible_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38090__$1,new cljs.core.Keyword(null,"visible-columns","visible-columns",1134718660));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_col,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"space-y-4 p-4"], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),["flex-wrap gap-4 items-end ",bb_web_ds_tools.theme.bg_toolbar," p-2 rounded shadow-sm"].join('')], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.label,"Rows"], null),new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.select,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),"py-1",new cljs.core.Keyword(null,"value","value",305978217),rows_per_page,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__38085_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959),parseInt(p1__38085_SHARP_.target.value)], null));
...
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"page","page",849072397),(page + (1))], null));
}),new cljs.core.Keyword(null,"disabled","disabled",-1529784218),(end_idx >= total_rows)], null),"Next"], null)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.table_container,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.table,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.thead,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__38091(s__38092){
return (new cljs.core.LazySeq(null,(function (){
var s__38092__$1 = s__38092;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__38092__$1);
if(temp__5825__auto__){
var s__38092__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__38092__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__38092__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__38094 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__38093 = (0);
while(true){
if((i__38093 < size__5502__auto__)){
var col = cljs.core._nth(c__5501__auto__,i__38093);
cljs.core.chunk_append(b__38094,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.th,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["cursor-pointer ",bb_web_ds_tools.theme.bg_item_hover].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__38093,col,c__5501__auto__,size__5502__auto__,b__38094,s__38092__$2,temp__5825__auto__,map__38088,map__38088__$1,id,data,columns,view_state,map__38089,map__38089__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38090,map__38090__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
...
});})(i__38093,col,c__5501__auto__,size__5502__auto__,b__38094,s__38092__$2,temp__5825__auto__,map__38088,map__38088__$1,id,data,columns,view_state,map__38089,map__38089__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38090,map__38090__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38094),bb_web_ds_tools$views$datasets$data_table_$_iter__38091(cljs.core.chunk_rest(s__38092__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38094),null);
}
} else {
var col = cljs.core.first(s__38092__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.th,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["cursor-pointer ",bb_web_ds_tools.theme.bg_item_hover].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (col,s__38092__$2,temp__5825__auto__,map__38088,map__38088__$1,id,data,columns,view_state,map__38089,map__38089__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38090,map__38090__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
var new_dir = ((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_col,col)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))))?new cljs.core.Keyword(null,"desc","desc",2093485764):new cljs.core.Keyword(null,"asc","asc",356854569));
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"sort-col","sort-col",-718754882),col], null));

return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757),new_dir], null));
});})(col,s__38092__$2,temp__5825__auto__,map__38088,map__38088__$1,id,data,columns,view_state,map__38089,map__38089__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38090,map__38090__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex items-center space-x-1"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),cljs.core.name(col)], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_col,col))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-[10px] transform translate-y-px"], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))?"\u25B2":"\u25BC")], null):null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__38091(cljs.core.rest(s__38092__$2)));
}
} else {
return null;
}
...
})()], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tbody,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__38095(s__38096){
return (new cljs.core.LazySeq(null,(function (){
var s__38096__$1 = s__38096;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__38096__$1);
if(temp__5825__auto__){
var s__38096__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__38096__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__38096__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__38098 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__38097 = (0);
while(true){
if((i__38097 < size__5502__auto__)){
var col = cljs.core._nth(c__5501__auto__,i__38097);
cljs.core.chunk_append(b__38098,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),["filter-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(col)].join(''),new cljs.core.Keyword(null,"class","class",-2030961996),"px-3 py-1.5"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-sm",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),["Filter ",cljs.core.name(col)].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(filters,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__38097,col,c__5501__auto__,size__5502__auto__,b__38098,s__38096__$2,temp__5825__auto__,map__38088,map__38088__$1,id,data,columns,view_state,map__38089,map__38089__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38090,map__38090__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__38086_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"filters","filters",974726919),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(filters,col,p1__38086_SHARP_.target.value)], null));
});})(i__38097,col,c__5501__auto__,size__5502__auto__,b__38098,s__38096__$2,temp__5825__auto__,map__38088,map__38088__$1,id,data,columns,view_state,map__38089,map__38089__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38090,map__38090__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__38194 = (i__38097 + (1));
i__38097 = G__38194;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38098),bb_web_ds_tools$views$datasets$data_table_$_iter__38095(cljs.core.chunk_rest(s__38096__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38098),null);
}
} else {
var col = cljs.core.first(s__38096__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),["filter-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(col)].join(''),new cljs.core.Keyword(null,"class","class",-2030961996),"px-3 py-1.5"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-sm",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),["Filter ",cljs.core.name(col)].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(filters,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__38096__$2,temp__5825__auto__,map__38088,map__38088__$1,id,data,columns,view_state,map__38089,map__38089__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38090,map__38090__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__38086_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"filters","filters",974726919),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(filters,col,p1__38086_SHARP_.target.value)], null));
});})(col,s__38096__$2,temp__5825__auto__,map__38088,map__38088__$1,id,data,columns,view_state,map__38089,map__38089__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38090,map__38090__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__38095(cljs.core.rest(s__38096__$2)));
}
} else {
return null;
}
...
return iter__5503__auto__(visible_columns);
})()], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__38099(s__38100){
return (new cljs.core.LazySeq(null,(function (){
var s__38100__$1 = s__38100;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__38100__$1);
if(temp__5825__auto__){
var s__38100__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__38100__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__38100__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__38102 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__38101 = (0);
while(true){
if((i__38101 < size__5502__auto__)){
var row = cljs.core._nth(c__5501__auto__,i__38101);
cljs.core.chunk_append(b__38102,(function (){var row_uuid = new cljs.core.Keyword(null,"_uuid","_uuid",797900280).cljs$core$IFn$_invoke$arity$1(row);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row_uuid], null),(function (){var iter__5503__auto__ = ((function (i__38101,row_uuid,row,c__5501__auto__,size__5502__auto__,b__38102,s__38100__$2,temp__5825__auto__,map__38088,map__38088__$1,id,data,columns,view_state,map__38089,map__38089__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38090,map__38090__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function bb_web_ds_tools$views$datasets$data_table_$_iter__38099_$_iter__38103(s__38104){
return (new cljs.core.LazySeq(null,((function (i__38101,row_uuid,row,c__5501__auto__,size__5502__auto__,b__38102,s__38100__$2,temp__5825__auto__,map__38088,map__38088__$1,id,data,columns,view_state,map__38089,map__38089__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38090,map__38090__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
var s__38104__$1 = s__38104;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__38104__$1);
if(temp__5825__auto____$1){
var s__38104__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__38104__$2)){
var c__5501__auto____$1 = cljs.core.chunk_first(s__38104__$2);
var size__5502__auto____$1 = cljs.core.count(c__5501__auto____$1);
var b__38106 = cljs.core.chunk_buffer(size__5502__auto____$1);
if((function (){var i__38105 = (0);
while(true){
if((i__38105 < size__5502__auto____$1)){
var col = cljs.core._nth(c__5501__auto____$1,i__38105);
cljs.core.chunk_append(b__38106,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__38105,i__38101,col,c__5501__auto____$1,size__5502__auto____$1,b__38106,s__38104__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__38102,s__38100__$2,temp__5825__auto__,map__38088,map__38088__$1,id,data,columns,view_state,map__38089,map__38089__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38090,map__38090__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__38087_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__38087_SHARP_.target.value], null));
});})(i__38105,i__38101,col,c__5501__auto____$1,size__5502__auto____$1,b__38106,s__38104__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__38102,s__38100__$2,temp__5825__auto__,map__38088,map__38088__$1,id,data,columns,view_state,map__38089,map__38089__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38090,map__38090__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__38195 = (i__38105 + (1));
i__38105 = G__38195;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38106),bb_web_ds_tools$views$datasets$data_table_$_iter__38099_$_iter__38103(cljs.core.chunk_rest(s__38104__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38106),null);
}
} else {
var col = cljs.core.first(s__38104__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__38101,col,s__38104__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__38102,s__38100__$2,temp__5825__auto__,map__38088,map__38088__$1,id,data,columns,view_state,map__38089,map__38089__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38090,map__38090__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__38087_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__38087_SHARP_.target.value], null));
});})(i__38101,col,s__38104__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__38102,s__38100__$2,temp__5825__auto__,map__38088,map__38088__$1,id,data,columns,view_state,map__38089,map__38089__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38090,map__38090__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__38099_$_iter__38103(cljs.core.rest(s__38104__$2)));
}
} else {
return null;
}
...
});})(i__38101,row_uuid,row,c__5501__auto__,size__5502__auto__,b__38102,s__38100__$2,temp__5825__auto__,map__38088,map__38088__$1,id,data,columns,view_state,map__38089,map__38089__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38090,map__38090__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
,null,null));
});})(i__38101,row_uuid,row,c__5501__auto__,size__5502__auto__,b__38102,s__38100__$2,temp__5825__auto__,map__38088,map__38088__$1,id,data,columns,view_state,map__38089,map__38089__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38090,map__38090__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
;
return iter__5503__auto__(visible_columns);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38102),bb_web_ds_tools$views$datasets$data_table_$_iter__38099(cljs.core.chunk_rest(s__38100__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38102),null);
}
} else {
var row = cljs.core.first(s__38100__$2);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row_uuid], null),(function (){var iter__5503__auto__ = ((function (row_uuid,row,s__38100__$2,temp__5825__auto__,map__38088,map__38088__$1,id,data,columns,view_state,map__38089,map__38089__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38090,map__38090__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function bb_web_ds_tools$views$datasets$data_table_$_iter__38099_$_iter__38107(s__38108){
return (new cljs.core.LazySeq(null,(function (){
var s__38108__$1 = s__38108;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__38108__$1);
if(temp__5825__auto____$1){
var s__38108__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__38108__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__38108__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__38110 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__38109 = (0);
while(true){
if((i__38109 < size__5502__auto__)){
var col = cljs.core._nth(c__5501__auto__,i__38109);
cljs.core.chunk_append(b__38110,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__38109,col,c__5501__auto__,size__5502__auto__,b__38110,s__38108__$2,temp__5825__auto____$1,row_uuid,row,s__38100__$2,temp__5825__auto__,map__38088,map__38088__$1,id,data,columns,view_state,map__38089,map__38089__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38090,map__38090__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__38087_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__38087_SHARP_.target.value], null));
});})(i__38109,col,c__5501__auto__,size__5502__auto__,b__38110,s__38108__$2,temp__5825__auto____$1,row_uuid,row,s__38100__$2,temp__5825__auto__,map__38088,map__38088__$1,id,data,columns,view_state,map__38089,map__38089__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38090,map__38090__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__38201 = (i__38109 + (1));
i__38109 = G__38201;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38110),bb_web_ds_tools$views$datasets$data_table_$_iter__38099_$_iter__38107(cljs.core.chunk_rest(s__38108__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38110),null);
}
} else {
var col = cljs.core.first(s__38108__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__38108__$2,temp__5825__auto____$1,row_uuid,row,s__38100__$2,temp__5825__auto__,map__38088,map__38088__$1,id,data,columns,view_state,map__38089,map__38089__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38090,map__38090__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__38087_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__38087_SHARP_.target.value], null));
});})(col,s__38108__$2,temp__5825__auto____$1,row_uuid,row,s__38100__$2,temp__5825__auto__,map__38088,map__38088__$1,id,data,columns,view_state,map__38089,map__38089__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38090,map__38090__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__38099_$_iter__38107(cljs.core.rest(s__38108__$2)));
}
} else {
return null;
}
...
});})(row_uuid,row,s__38100__$2,temp__5825__auto__,map__38088,map__38088__$1,id,data,columns,view_state,map__38089,map__38089__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38090,map__38090__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
;
return iter__5503__auto__(visible_columns);
})()], null);
})(),bb_web_ds_tools$views$datasets$data_table_$_iter__38099(cljs.core.rest(s__38100__$2)));
}
} else {
return null;
}
...
return (function (){
var map__38115 = cljs.core.deref(state_sub);
var map__38115__$1 = cljs.core.__destructure_map(map__38115);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38115__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var active_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38115__$1,new cljs.core.Keyword(null,"active-id","active-id",-59238656));
...
})], null),"+ New Dataset"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex-grow overflow-y-auto p-2 space-y-1"], null),((cljs.core.seq(items))?(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$dataset_list_$_iter__38116(s__38117){
return (new cljs.core.LazySeq(null,(function (){
var s__38117__$1 = s__38117;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__38117__$1);
if(temp__5825__auto__){
var s__38117__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__38117__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__38117__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__38119 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__38118 = (0);
while(true){
if((i__38118 < size__5502__auto__)){
var vec__38120 = cljs.core._nth(c__5501__auto__,i__38118);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38120,(0),null);
var ds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38120,(1),null);
cljs.core.chunk_append(b__38119,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.datasets.dataset_list_item,id,ds,active_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__38218 = (i__38118 + (1));
i__38118 = G__38218;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38119),bb_web_ds_tools$views$datasets$dataset_list_$_iter__38116(cljs.core.chunk_rest(s__38117__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38119),null);
}
} else {
var vec__38123 = cljs.core.first(s__38117__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38123,(0),null);
var ds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38123,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.datasets.dataset_list_item,id,ds,active_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),bb_web_ds_tools$views$datasets$dataset_list_$_iter__38116(cljs.core.rest(s__38117__$2)));
}
} else {
return null;
}
...
return (function (){
var map__38126 = cljs.core.deref(state_sub);
var map__38126__$1 = cljs.core.__destructure_map(map__38126);
var active_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38126__$1,new cljs.core.Keyword(null,"active-id","active-id",-59238656));
var active_dataset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38126__$1,new cljs.core.Keyword(null,"active-dataset","active-dataset",771380472));
