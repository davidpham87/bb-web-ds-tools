...
var len__5749__auto___38216 = arguments.length;
var i__5750__auto___38217 = (0);
while(true){
if((i__5750__auto___38217 < len__5749__auto___38216)){
args__5755__auto__.push((arguments[i__5750__auto___38217]));

var G__38218 = (i__5750__auto___38217 + (1));
i__5750__auto___38217 = G__38218;
continue;
} else {
}
break;
...
/** @this {Function} */
(bb_web_ds_tools.views.datasets.deep_merge.cljs$lang$applyTo = (function (seq38082){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq38082));
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"datasets","datasets",1896364419)], null),(function (p1__38083_SHARP_){
return bb_web_ds_tools.views.datasets.deep_merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__38083_SHARP_,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"items","items",1031954938),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"new-dataset-state","new-dataset-state",1109324301),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"name","name",1843675177),"New Dataset",new cljs.core.Keyword(null,"text","text",-1790561697),"",new cljs.core.Keyword(null,"format","format",-1306924766),new cljs.core.Keyword(null,"csv","csv",-1164440893),new cljs.core.Keyword(null,"structure","structure",1563832083),new cljs.core.Keyword(null,"columnar","columnar",-1122999701)], null)], null)], 0));
...
var active_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38093,(0),null);
var active_dataset = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38093,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","set-active-dataset-id","bb-web-ds-tools.views.datasets/set-active-dataset-id",1361188762),(function (db,p__38096){
var vec__38097 = p__38096;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38097,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38097,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-new-dataset-state","bb-web-ds-tools.views.datasets/update-new-dataset-state",-1930125405),(function (db,p__38100){
var vec__38101 = p__38100;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38101,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38101,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38101,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","add-dataset","bb-web-ds-tools.views.datasets/add-dataset",1462625692),(function (db,p__38105){
var vec__38106 = p__38105;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38106,(0),null);
var map__38109 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38106,(1),null);
var map__38109__$1 = cljs.core.__destructure_map(map__38109);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38109__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38109__$1,new cljs.core.Keyword(null,"data","data",-232669377));
...
var data_with_ids = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__38104_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__38104_SHARP_,new cljs.core.Keyword(null,"_uuid","_uuid",797900280),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.random_uuid()));
}),valid_data);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","delete-dataset","bb-web-ds-tools.views.datasets/delete-dataset",243110744),(function (db,p__38110){
var vec__38111 = p__38110;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38111,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38111,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-dataset-name","bb-web-ds-tools.views.datasets/update-dataset-name",798576715),(function (db,p__38114){
var vec__38115 = p__38114;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38115,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38115,(1),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38115,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),(function (db,p__38118){
var vec__38119 = p__38118;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38119,(0),null);
var dataset_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38119,(1),null);
var row_uuid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38119,(2),null);
var col_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38119,(3),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38119,(4),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),(function (db,p__38122){
var vec__38123 = p__38122;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38123,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38123,(1),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38123,(2),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38123,(3),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","fetch-vega-datasets","bb-web-ds-tools.views.datasets/fetch-vega-datasets",202932363),(function (p__38129,_){
var map__38130 = p__38129;
var map__38130__$1 = cljs.core.__destructure_map(map__38130);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38130__$1,new cljs.core.Keyword(null,"db","db",993250759));
fetch("https://cdn.jsdelivr.net/npm/vega-datasets/data/").then((function (p1__38126_SHARP_){
return p1__38126_SHARP_.text();
})).then((function (p1__38127_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","receive-vega-datasets","bb-web-ds-tools.views.datasets/receive-vega-datasets",-736628262),p1__38127_SHARP_], null));
})).catch((function (p1__38128_SHARP_){
return console.error("Failed to fetch vega datasets list",p1__38128_SHARP_);
}));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","receive-vega-datasets","bb-web-ds-tools.views.datasets/receive-vega-datasets",-736628262),(function (db,p__38133){
var vec__38134 = p__38133;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38134,(0),null);
var html_content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38134,(1),null);
...
var filenames = cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.sort.cljs$core$IFn$_invoke$arity$1(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__38132_SHARP_){
return cljs.core.re_find(/\.(json|csv|tsv|md)$/,p1__38132_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38131_SHARP_){
return p1__38131_SHARP_.innerText;
}),links))));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","fetch-vega-dataset","bb-web-ds-tools.views.datasets/fetch-vega-dataset",1814090652),(function (p__38140,p__38141){
var map__38142 = p__38140;
var map__38142__$1 = cljs.core.__destructure_map(map__38142);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38142__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__38143 = p__38141;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38143,(0),null);
var filename = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38143,(1),null);
var url = ["https://cdn.jsdelivr.net/npm/vega-datasets@3/data/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(filename)].join('');
fetch(url).then((function (p1__38137_SHARP_){
return p1__38137_SHARP_.text();
})).then((function (p1__38138_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","receive-vega-dataset-content","bb-web-ds-tools.views.datasets/receive-vega-dataset-content",-385162532),filename,p1__38138_SHARP_], null));
})).catch((function (p1__38139_SHARP_){
return console.error("Failed to fetch vega dataset",p1__38139_SHARP_);
}));

return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"db","db",993250759),cljs.core.assoc_in(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","datasets","bb-web-ds-tools.views.datasets/datasets",-1461208347),new cljs.core.Keyword(null,"loading-vega-dataset?","loading-vega-dataset?",-1002270211)], null),true)], null);
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","receive-vega-dataset-content","bb-web-ds-tools.views.datasets/receive-vega-dataset-content",-385162532),(function (db,p__38146){
var vec__38147 = p__38146;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38147,(0),null);
var filename = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38147,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38147,(2),null);
var extension = cljs.core.last(clojure.string.split.cljs$core$IFn$_invoke$arity$2(filename,/\./));
var format = (function (){var G__38150 = extension;
switch (G__38150) {
case "json":
...
});})(i__38154,col,c__5501__auto__,size__5502__auto__,b__38155,s__38153__$2,temp__5825__auto__))
...
return (function (){
var map__38158 = cljs.core.deref(state);
var map__38158__$1 = cljs.core.__destructure_map(map__38158);
var fmt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38158__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var name_val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38158__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38158__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var structure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38158__$1,new cljs.core.Keyword(null,"structure","structure",1563832083));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38162),bb_web_ds_tools$views$datasets$importer_view_$_iter__38159(cljs.core.chunk_rest(s__38160__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38162),null);
}
} else {
var ds = cljs.core.first(s__38160__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),ds,new cljs.core.Keyword(null,"value","value",305978217),ds], null),ds], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__38159(cljs.core.rest(s__38160__$2)));
}
} else {
return null;
}
...
})()], null))], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"space-x-2"], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$importer_view_$_iter__38163(s__38164){
return (new cljs.core.LazySeq(null,(function (){
var s__38164__$1 = s__38164;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__38164__$1);
if(temp__5825__auto__){
var s__38164__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__38164__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__38164__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__38166 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__38165 = (0);
while(true){
if((i__38165 < size__5502__auto__)){
var f = cljs.core._nth(c__5501__auto__,i__38165);
cljs.core.chunk_append(b__38166,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),f,new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(fmt,f))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):""),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__38165,f,c__5501__auto__,size__5502__auto__,b__38166,s__38164__$2,temp__5825__auto__,map__38158,map__38158__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_){
return (function (){
set_state(new cljs.core.Keyword(null,"format","format",-1306924766),f);

if(cljs.core.truth_((function (){var fexpr__38167 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"markdown","markdown",1227225089),null,new cljs.core.Keyword(null,"csv","csv",-1164440893),null,new cljs.core.Keyword(null,"tsv","tsv",-1254214356),null], null), null);
return (fexpr__38167.cljs$core$IFn$_invoke$arity$1 ? fexpr__38167.cljs$core$IFn$_invoke$arity$1(f) : fexpr__38167.call(null,f));
})())){
...
});})(i__38165,f,c__5501__auto__,size__5502__auto__,b__38166,s__38164__$2,temp__5825__auto__,map__38158,map__38158__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38166),bb_web_ds_tools$views$datasets$importer_view_$_iter__38163(cljs.core.chunk_rest(s__38164__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38166),null);
}
} else {
var f = cljs.core.first(s__38164__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),f,new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(fmt,f))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):""),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (f,s__38164__$2,temp__5825__auto__,map__38158,map__38158__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_){
return (function (){
set_state(new cljs.core.Keyword(null,"format","format",-1306924766),f);

if(cljs.core.truth_((function (){var fexpr__38168 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"markdown","markdown",1227225089),null,new cljs.core.Keyword(null,"csv","csv",-1164440893),null,new cljs.core.Keyword(null,"tsv","tsv",-1254214356),null], null), null);
return (fexpr__38168.cljs$core$IFn$_invoke$arity$1 ? fexpr__38168.cljs$core$IFn$_invoke$arity$1(f) : fexpr__38168.call(null,f));
})())){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),new cljs.core.Keyword(null,"columnar","columnar",-1122999701));
} else {
return null;
}
});})(f,s__38164__$2,temp__5825__auto__,map__38158,map__38158__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_))
], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"markdown","markdown",1227225089)))?"MD":clojure.string.upper_case(cljs.core.name(f)))], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__38163(cljs.core.rest(s__38164__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38172),bb_web_ds_tools$views$datasets$importer_view_$_iter__38169(cljs.core.chunk_rest(s__38170__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38172),null);
}
} else {
var s = cljs.core.first(s__38170__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"key","key",-1516042587),s,new cljs.core.Keyword(null,"disabled","disabled",-1529784218),(!(cljs.core.contains_QMARK_(supported_structures,s))),new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(structure__$1,s))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):(((!(cljs.core.contains_QMARK_(supported_structures,s))))?"opacity-50 cursor-not-allowed":"")),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (s,s__38170__$2,temp__5825__auto__,map__38158,map__38158__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_){
return (function (){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),s);
});})(s,s__38170__$2,temp__5825__auto__,map__38158,map__38158__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_))
], null),cljs.core.get.cljs$core$IFn$_invoke$arity$2(struct_labels,s)], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__38169(cljs.core.rest(s__38170__$2)));
}
} else {
return null;
}
...
var map__38177 = dataset;
var map__38177__$1 = cljs.core.__destructure_map(map__38177);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38177__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38177__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38177__$1,new cljs.core.Keyword(null,"columns","columns",1998437288));
var view_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38177__$1,new cljs.core.Keyword(null,"view-state","view-state",-976675614));
var map__38178 = view_state;
var map__38178__$1 = cljs.core.__destructure_map(map__38178);
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38178__$1,new cljs.core.Keyword(null,"page","page",849072397));
var rows_per_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38178__$1,new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959));
var filters = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38178__$1,new cljs.core.Keyword(null,"filters","filters",974726919));
var hidden_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38178__$1,new cljs.core.Keyword(null,"hidden-columns","hidden-columns",-1045524800));
var sort_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38178__$1,new cljs.core.Keyword(null,"sort-col","sort-col",-718754882));
var sort_dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38178__$1,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757));
var map__38179 = bb_web_ds_tools.utils.dataset_processing.process_table_data(data,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(view_state,new cljs.core.Keyword(null,"columns","columns",1998437288),columns));
var map__38179__$1 = cljs.core.__destructure_map(map__38179);
var page_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38179__$1,new cljs.core.Keyword(null,"page-data","page-data",1443840710));
var total_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38179__$1,new cljs.core.Keyword(null,"total-rows","total-rows",1745495528));
var start_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38179__$1,new cljs.core.Keyword(null,"start-idx","start-idx",-1600773745));
var end_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38179__$1,new cljs.core.Keyword(null,"end-idx","end-idx",-85750788));
var visible_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38179__$1,new cljs.core.Keyword(null,"visible-columns","visible-columns",1134718660));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_col,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"space-y-4 p-4"], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),["flex-wrap gap-4 items-end ",bb_web_ds_tools.theme.bg_toolbar," p-2 rounded shadow-sm"].join('')], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.label,"Rows"], null),new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.select,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),"py-1",new cljs.core.Keyword(null,"value","value",305978217),rows_per_page,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__38174_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959),parseInt(p1__38174_SHARP_.target.value)], null));
...
});})(i__38182,col,c__5501__auto__,size__5502__auto__,b__38183,s__38181__$2,temp__5825__auto__,map__38177,map__38177__$1,id,data,columns,view_state,map__38178,map__38178__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38179,map__38179__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38183),bb_web_ds_tools$views$datasets$data_table_$_iter__38180(cljs.core.chunk_rest(s__38181__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38183),null);
}
} else {
var col = cljs.core.first(s__38181__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.th,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["cursor-pointer ",bb_web_ds_tools.theme.bg_item_hover].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (col,s__38181__$2,temp__5825__auto__,map__38177,map__38177__$1,id,data,columns,view_state,map__38178,map__38178__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38179,map__38179__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
var new_dir = ((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_col,col)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))))?new cljs.core.Keyword(null,"desc","desc",2093485764):new cljs.core.Keyword(null,"asc","asc",356854569));
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"sort-col","sort-col",-718754882),col], null));

return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757),new_dir], null));
});})(col,s__38181__$2,temp__5825__auto__,map__38177,map__38177__$1,id,data,columns,view_state,map__38178,map__38178__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38179,map__38179__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex items-center space-x-1"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),cljs.core.name(col)], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_col,col))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-[10px] transform translate-y-px"], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))?"\u25B2":"\u25BC")], null):null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__38180(cljs.core.rest(s__38181__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38187),bb_web_ds_tools$views$datasets$data_table_$_iter__38184(cljs.core.chunk_rest(s__38185__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38187),null);
}
} else {
var col = cljs.core.first(s__38185__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),["filter-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(col)].join(''),new cljs.core.Keyword(null,"class","class",-2030961996),"px-3 py-1.5"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-sm",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),["Filter ",cljs.core.name(col)].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(filters,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__38185__$2,temp__5825__auto__,map__38177,map__38177__$1,id,data,columns,view_state,map__38178,map__38178__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38179,map__38179__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__38175_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"filters","filters",974726919),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(filters,col,p1__38175_SHARP_.target.value)], null));
});})(col,s__38185__$2,temp__5825__auto__,map__38177,map__38177__$1,id,data,columns,view_state,map__38178,map__38178__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38179,map__38179__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__38184(cljs.core.rest(s__38185__$2)));
}
} else {
return null;
}
...
return iter__5503__auto__(visible_columns);
})()], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__38188(s__38189){
return (new cljs.core.LazySeq(null,(function (){
var s__38189__$1 = s__38189;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__38189__$1);
if(temp__5825__auto__){
var s__38189__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__38189__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__38189__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__38191 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__38190 = (0);
while(true){
if((i__38190 < size__5502__auto__)){
var row = cljs.core._nth(c__5501__auto__,i__38190);
cljs.core.chunk_append(b__38191,(function (){var row_uuid = new cljs.core.Keyword(null,"_uuid","_uuid",797900280).cljs$core$IFn$_invoke$arity$1(row);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row_uuid], null),(function (){var iter__5503__auto__ = ((function (i__38190,row_uuid,row,c__5501__auto__,size__5502__auto__,b__38191,s__38189__$2,temp__5825__auto__,map__38177,map__38177__$1,id,data,columns,view_state,map__38178,map__38178__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38179,map__38179__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function bb_web_ds_tools$views$datasets$data_table_$_iter__38188_$_iter__38192(s__38193){
return (new cljs.core.LazySeq(null,((function (i__38190,row_uuid,row,c__5501__auto__,size__5502__auto__,b__38191,s__38189__$2,temp__5825__auto__,map__38177,map__38177__$1,id,data,columns,view_state,map__38178,map__38178__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38179,map__38179__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
var s__38193__$1 = s__38193;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__38193__$1);
if(temp__5825__auto____$1){
var s__38193__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__38193__$2)){
var c__5501__auto____$1 = cljs.core.chunk_first(s__38193__$2);
var size__5502__auto____$1 = cljs.core.count(c__5501__auto____$1);
var b__38195 = cljs.core.chunk_buffer(size__5502__auto____$1);
if((function (){var i__38194 = (0);
while(true){
if((i__38194 < size__5502__auto____$1)){
var col = cljs.core._nth(c__5501__auto____$1,i__38194);
cljs.core.chunk_append(b__38195,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__38194,i__38190,col,c__5501__auto____$1,size__5502__auto____$1,b__38195,s__38193__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__38191,s__38189__$2,temp__5825__auto__,map__38177,map__38177__$1,id,data,columns,view_state,map__38178,map__38178__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38179,map__38179__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__38176_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__38176_SHARP_.target.value], null));
});})(i__38194,i__38190,col,c__5501__auto____$1,size__5502__auto____$1,b__38195,s__38193__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__38191,s__38189__$2,temp__5825__auto__,map__38177,map__38177__$1,id,data,columns,view_state,map__38178,map__38178__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38179,map__38179__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__38284 = (i__38194 + (1));
i__38194 = G__38284;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38195),bb_web_ds_tools$views$datasets$data_table_$_iter__38188_$_iter__38192(cljs.core.chunk_rest(s__38193__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38195),null);
}
} else {
var col = cljs.core.first(s__38193__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__38190,col,s__38193__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__38191,s__38189__$2,temp__5825__auto__,map__38177,map__38177__$1,id,data,columns,view_state,map__38178,map__38178__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38179,map__38179__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__38176_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__38176_SHARP_.target.value], null));
});})(i__38190,col,s__38193__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__38191,s__38189__$2,temp__5825__auto__,map__38177,map__38177__$1,id,data,columns,view_state,map__38178,map__38178__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38179,map__38179__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__38188_$_iter__38192(cljs.core.rest(s__38193__$2)));
}
} else {
return null;
}
...
});})(i__38190,row_uuid,row,c__5501__auto__,size__5502__auto__,b__38191,s__38189__$2,temp__5825__auto__,map__38177,map__38177__$1,id,data,columns,view_state,map__38178,map__38178__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38179,map__38179__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
,null,null));
});})(i__38190,row_uuid,row,c__5501__auto__,size__5502__auto__,b__38191,s__38189__$2,temp__5825__auto__,map__38177,map__38177__$1,id,data,columns,view_state,map__38178,map__38178__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38179,map__38179__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
;
return iter__5503__auto__(visible_columns);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38191),bb_web_ds_tools$views$datasets$data_table_$_iter__38188(cljs.core.chunk_rest(s__38189__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38191),null);
}
} else {
var row = cljs.core.first(s__38189__$2);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row_uuid], null),(function (){var iter__5503__auto__ = ((function (row_uuid,row,s__38189__$2,temp__5825__auto__,map__38177,map__38177__$1,id,data,columns,view_state,map__38178,map__38178__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38179,map__38179__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function bb_web_ds_tools$views$datasets$data_table_$_iter__38188_$_iter__38196(s__38197){
return (new cljs.core.LazySeq(null,(function (){
var s__38197__$1 = s__38197;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__38197__$1);
if(temp__5825__auto____$1){
var s__38197__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__38197__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__38197__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__38199 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__38198 = (0);
while(true){
if((i__38198 < size__5502__auto__)){
var col = cljs.core._nth(c__5501__auto__,i__38198);
cljs.core.chunk_append(b__38199,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__38198,col,c__5501__auto__,size__5502__auto__,b__38199,s__38197__$2,temp__5825__auto____$1,row_uuid,row,s__38189__$2,temp__5825__auto__,map__38177,map__38177__$1,id,data,columns,view_state,map__38178,map__38178__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38179,map__38179__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__38176_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__38176_SHARP_.target.value], null));
});})(i__38198,col,c__5501__auto__,size__5502__auto__,b__38199,s__38197__$2,temp__5825__auto____$1,row_uuid,row,s__38189__$2,temp__5825__auto__,map__38177,map__38177__$1,id,data,columns,view_state,map__38178,map__38178__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38179,map__38179__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__38287 = (i__38198 + (1));
i__38198 = G__38287;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38199),bb_web_ds_tools$views$datasets$data_table_$_iter__38188_$_iter__38196(cljs.core.chunk_rest(s__38197__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38199),null);
}
} else {
var col = cljs.core.first(s__38197__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__38197__$2,temp__5825__auto____$1,row_uuid,row,s__38189__$2,temp__5825__auto__,map__38177,map__38177__$1,id,data,columns,view_state,map__38178,map__38178__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38179,map__38179__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__38176_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__38176_SHARP_.target.value], null));
});})(col,s__38197__$2,temp__5825__auto____$1,row_uuid,row,s__38189__$2,temp__5825__auto__,map__38177,map__38177__$1,id,data,columns,view_state,map__38178,map__38178__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38179,map__38179__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__38188_$_iter__38196(cljs.core.rest(s__38197__$2)));
}
} else {
return null;
}
...
});})(row_uuid,row,s__38189__$2,temp__5825__auto__,map__38177,map__38177__$1,id,data,columns,view_state,map__38178,map__38178__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__38179,map__38179__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
;
return iter__5503__auto__(visible_columns);
})()], null);
})(),bb_web_ds_tools$views$datasets$data_table_$_iter__38188(cljs.core.rest(s__38189__$2)));
}
} else {
return null;
}
...
return (function (){
var map__38204 = cljs.core.deref(state_sub);
var map__38204__$1 = cljs.core.__destructure_map(map__38204);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38204__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var active_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38204__$1,new cljs.core.Keyword(null,"active-id","active-id",-59238656));
...
})], null),"+ New Dataset"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex-grow overflow-y-auto pt-4 space-y-1"], null),((cljs.core.seq(items))?(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$dataset_list_$_iter__38205(s__38206){
return (new cljs.core.LazySeq(null,(function (){
var s__38206__$1 = s__38206;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__38206__$1);
if(temp__5825__auto__){
var s__38206__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__38206__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__38206__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__38208 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__38207 = (0);
while(true){
if((i__38207 < size__5502__auto__)){
var vec__38209 = cljs.core._nth(c__5501__auto__,i__38207);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38209,(0),null);
var ds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38209,(1),null);
cljs.core.chunk_append(b__38208,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.datasets.dataset_list_item,id,ds,active_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__38307 = (i__38207 + (1));
i__38207 = G__38307;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38208),bb_web_ds_tools$views$datasets$dataset_list_$_iter__38205(cljs.core.chunk_rest(s__38206__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38208),null);
}
} else {
var vec__38212 = cljs.core.first(s__38206__$2);
...
return (function (){
var map__38215 = cljs.core.deref(state_sub);
var map__38215__$1 = cljs.core.__destructure_map(map__38215);
var active_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38215__$1,new cljs.core.Keyword(null,"active-id","active-id",-59238656));
var active_dataset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38215__$1,new cljs.core.Keyword(null,"active-dataset","active-dataset",771380472));
