...
var len__5749__auto___47419 = arguments.length;
var i__5750__auto___47420 = (0);
while(true){
if((i__5750__auto___47420 < len__5749__auto___47419)){
args__5755__auto__.push((arguments[i__5750__auto___47420]));

var G__47421 = (i__5750__auto___47420 + (1));
i__5750__auto___47420 = G__47421;
continue;
} else {
}
break;
...
/** @this {Function} */
(bb_web_ds_tools.views.datasets.deep_merge.cljs$lang$applyTo = (function (seq46991){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq46991));
}));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","set-active-dataset-id","bb-web-ds-tools.views.datasets/set-active-dataset-id",1361188762),(function (db,p__47071){
var vec__47072 = p__47071;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47072,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47072,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-new-dataset-state","bb-web-ds-tools.views.datasets/update-new-dataset-state",-1930125405),(function (db,p__47075){
var vec__47076 = p__47075;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47076,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47076,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47076,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","add-dataset","bb-web-ds-tools.views.datasets/add-dataset",1462625692),(function (db,p__47100){
var vec__47103 = p__47100;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47103,(0),null);
var map__47106 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47103,(1),null);
var map__47106__$1 = cljs.core.__destructure_map(map__47106);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47106__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47106__$1,new cljs.core.Keyword(null,"data","data",-232669377));
...
var data_with_ids = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__47080_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__47080_SHARP_,new cljs.core.Keyword(null,"_uuid","_uuid",797900280),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.random_uuid()));
}),valid_data);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","delete-dataset","bb-web-ds-tools.views.datasets/delete-dataset",243110744),(function (db,p__47119){
var vec__47120 = p__47119;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47120,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47120,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-dataset-name","bb-web-ds-tools.views.datasets/update-dataset-name",798576715),(function (db,p__47128){
var vec__47129 = p__47128;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47129,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47129,(1),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47129,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),(function (db,p__47133){
var vec__47135 = p__47133;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47135,(0),null);
var dataset_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47135,(1),null);
var row_uuid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47135,(2),null);
var col_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47135,(3),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47135,(4),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),(function (db,p__47146){
var vec__47148 = p__47146;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47148,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47148,(1),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47148,(2),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47148,(3),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","fetch-vega-datasets","bb-web-ds-tools.views.datasets/fetch-vega-datasets",202932363),(function (p__47173,_){
var map__47174 = p__47173;
var map__47174__$1 = cljs.core.__destructure_map(map__47174);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47174__$1,new cljs.core.Keyword(null,"db","db",993250759));
fetch("https://cdn.jsdelivr.net/npm/vega-datasets/data/").then((function (p1__47154_SHARP_){
return p1__47154_SHARP_.text();
})).then((function (p1__47155_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","receive-vega-datasets","bb-web-ds-tools.views.datasets/receive-vega-datasets",-736628262),p1__47155_SHARP_], null));
})).catch((function (p1__47170_SHARP_){
return console.error("Failed to fetch vega datasets list",p1__47170_SHARP_);
}));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","receive-vega-datasets","bb-web-ds-tools.views.datasets/receive-vega-datasets",-736628262),(function (db,p__47181){
var vec__47182 = p__47181;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47182,(0),null);
var html_content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47182,(1),null);
...
var filenames = cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.sort.cljs$core$IFn$_invoke$arity$1(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__47180_SHARP_){
return cljs.core.re_find(/\.(json|csv|tsv|md)$/,p1__47180_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__47178_SHARP_){
return p1__47178_SHARP_.innerText;
}),links))));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","fetch-vega-dataset","bb-web-ds-tools.views.datasets/fetch-vega-dataset",1814090652),(function (p__47191,p__47192){
var map__47208 = p__47191;
var map__47208__$1 = cljs.core.__destructure_map(map__47208);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47208__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__47210 = p__47192;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47210,(0),null);
var filename = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47210,(1),null);
var url = ["https://cdn.jsdelivr.net/npm/vega-datasets@3/data/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(filename)].join('');
fetch(url).then((function (p1__47187_SHARP_){
return p1__47187_SHARP_.text();
})).then((function (p1__47188_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","receive-vega-dataset-content","bb-web-ds-tools.views.datasets/receive-vega-dataset-content",-385162532),filename,p1__47188_SHARP_], null));
})).catch((function (p1__47189_SHARP_){
return console.error("Failed to fetch vega dataset",p1__47189_SHARP_);
}));

return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"db","db",993250759),cljs.core.assoc_in(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","datasets","bb-web-ds-tools.views.datasets/datasets",-1461208347),new cljs.core.Keyword(null,"loading-vega-dataset?","loading-vega-dataset?",-1002270211)], null),true)], null);
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","receive-vega-dataset-content","bb-web-ds-tools.views.datasets/receive-vega-dataset-content",-385162532),(function (db,p__47219){
var vec__47220 = p__47219;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47220,(0),null);
var filename = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47220,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47220,(2),null);
var extension = cljs.core.last(clojure.string.split.cljs$core$IFn$_invoke$arity$2(filename,/\./));
var format = (function (){var G__47225 = extension;
switch (G__47225) {
case "json":
...
});})(i__47251,col,c__5501__auto__,size__5502__auto__,b__47252,s__47250__$2,temp__5825__auto__))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47252),bb_web_ds_tools$views$datasets$column_toggle_dropdown_$_iter__47249(cljs.core.chunk_rest(s__47250__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47252),null);
}
} else {
var col = cljs.core.first(s__47250__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["flex items-center space-x-2 p-1 ",bb_web_ds_tools.theme.bg_item_hover].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"checkbox",new cljs.core.Keyword(null,"class","class",-2030961996),"w-auto",new cljs.core.Keyword(null,"checked","checked",-50955819),(!(cljs.core.contains_QMARK_(hidden_columns,col))),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__47250__$2,temp__5825__auto__){
return (function (){
if(cljs.core.contains_QMARK_(hidden_columns,col)){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"hidden-columns","hidden-columns",-1045524800),cljs.core.disj.cljs$core$IFn$_invoke$arity$2(hidden_columns,col)], null));
} else {
...
return (function (){
var map__47259 = cljs.core.deref(state);
var map__47259__$1 = cljs.core.__destructure_map(map__47259);
var fmt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47259__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var name_val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47259__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47259__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var structure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47259__$1,new cljs.core.Keyword(null,"structure","structure",1563832083));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47273),bb_web_ds_tools$views$datasets$importer_view_$_iter__47270(cljs.core.chunk_rest(s__47271__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47273),null);
}
} else {
var ds = cljs.core.first(s__47271__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),ds,new cljs.core.Keyword(null,"value","value",305978217),ds], null),ds], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__47270(cljs.core.rest(s__47271__$2)));
}
} else {
return null;
}
...
})()], null))], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"space-x-2"], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$importer_view_$_iter__47280(s__47281){
return (new cljs.core.LazySeq(null,(function (){
var s__47281__$1 = s__47281;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__47281__$1);
if(temp__5825__auto__){
var s__47281__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__47281__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__47281__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__47283 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__47282 = (0);
while(true){
if((i__47282 < size__5502__auto__)){
var f = cljs.core._nth(c__5501__auto__,i__47282);
cljs.core.chunk_append(b__47283,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),f,new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(fmt,f))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):""),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__47282,f,c__5501__auto__,size__5502__auto__,b__47283,s__47281__$2,temp__5825__auto__,map__47259,map__47259__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_){
return (function (){
set_state(new cljs.core.Keyword(null,"format","format",-1306924766),f);

if(cljs.core.truth_((function (){var fexpr__47287 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"markdown","markdown",1227225089),null,new cljs.core.Keyword(null,"csv","csv",-1164440893),null,new cljs.core.Keyword(null,"tsv","tsv",-1254214356),null], null), null);
return (fexpr__47287.cljs$core$IFn$_invoke$arity$1 ? fexpr__47287.cljs$core$IFn$_invoke$arity$1(f) : fexpr__47287.call(null,f));
})())){
...
});})(i__47282,f,c__5501__auto__,size__5502__auto__,b__47283,s__47281__$2,temp__5825__auto__,map__47259,map__47259__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47283),bb_web_ds_tools$views$datasets$importer_view_$_iter__47280(cljs.core.chunk_rest(s__47281__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47283),null);
}
} else {
var f = cljs.core.first(s__47281__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),f,new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(fmt,f))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):""),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (f,s__47281__$2,temp__5825__auto__,map__47259,map__47259__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_){
return (function (){
set_state(new cljs.core.Keyword(null,"format","format",-1306924766),f);

if(cljs.core.truth_((function (){var fexpr__47293 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"markdown","markdown",1227225089),null,new cljs.core.Keyword(null,"csv","csv",-1164440893),null,new cljs.core.Keyword(null,"tsv","tsv",-1254214356),null], null), null);
return (fexpr__47293.cljs$core$IFn$_invoke$arity$1 ? fexpr__47293.cljs$core$IFn$_invoke$arity$1(f) : fexpr__47293.call(null,f));
})())){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),new cljs.core.Keyword(null,"columnar","columnar",-1122999701));
} else {
return null;
}
});})(f,s__47281__$2,temp__5825__auto__,map__47259,map__47259__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_))
], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"markdown","markdown",1227225089)))?"MD":clojure.string.upper_case(cljs.core.name(f)))], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__47280(cljs.core.rest(s__47281__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47300),bb_web_ds_tools$views$datasets$importer_view_$_iter__47297(cljs.core.chunk_rest(s__47298__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47300),null);
}
} else {
var s = cljs.core.first(s__47298__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"key","key",-1516042587),s,new cljs.core.Keyword(null,"disabled","disabled",-1529784218),(!(cljs.core.contains_QMARK_(supported_structures,s))),new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(structure__$1,s))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):(((!(cljs.core.contains_QMARK_(supported_structures,s))))?"opacity-50 cursor-not-allowed":"")),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (s,s__47298__$2,temp__5825__auto__,map__47259,map__47259__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_){
return (function (){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),s);
});})(s,s__47298__$2,temp__5825__auto__,map__47259,map__47259__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state,vega_list,loading_list_QMARK_,loading_dataset_QMARK_))
], null),cljs.core.get.cljs$core$IFn$_invoke$arity$2(struct_labels,s)], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__47297(cljs.core.rest(s__47298__$2)));
}
} else {
return null;
}
...
var map__47341 = dataset;
var map__47341__$1 = cljs.core.__destructure_map(map__47341);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47341__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47341__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47341__$1,new cljs.core.Keyword(null,"columns","columns",1998437288));
var view_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47341__$1,new cljs.core.Keyword(null,"view-state","view-state",-976675614));
var map__47342 = view_state;
var map__47342__$1 = cljs.core.__destructure_map(map__47342);
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47342__$1,new cljs.core.Keyword(null,"page","page",849072397));
var rows_per_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47342__$1,new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959));
var filters = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47342__$1,new cljs.core.Keyword(null,"filters","filters",974726919));
var hidden_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47342__$1,new cljs.core.Keyword(null,"hidden-columns","hidden-columns",-1045524800));
var sort_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47342__$1,new cljs.core.Keyword(null,"sort-col","sort-col",-718754882));
var sort_dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47342__$1,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757));
var map__47343 = bb_web_ds_tools.utils.dataset_processing.process_table_data(data,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(view_state,new cljs.core.Keyword(null,"columns","columns",1998437288),columns));
var map__47343__$1 = cljs.core.__destructure_map(map__47343);
var page_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47343__$1,new cljs.core.Keyword(null,"page-data","page-data",1443840710));
var total_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47343__$1,new cljs.core.Keyword(null,"total-rows","total-rows",1745495528));
var start_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47343__$1,new cljs.core.Keyword(null,"start-idx","start-idx",-1600773745));
var end_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47343__$1,new cljs.core.Keyword(null,"end-idx","end-idx",-85750788));
var visible_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47343__$1,new cljs.core.Keyword(null,"visible-columns","visible-columns",1134718660));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_col,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"space-y-4 p-4"], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),["flex-wrap gap-4 items-end ",bb_web_ds_tools.theme.bg_toolbar," p-2 rounded shadow-sm"].join('')], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.label,"Rows"], null),new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.select,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),"py-1",new cljs.core.Keyword(null,"value","value",305978217),rows_per_page,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__47321_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959),parseInt(p1__47321_SHARP_.target.value)], null));
...
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"page","page",849072397),(page + (1))], null));
}),new cljs.core.Keyword(null,"disabled","disabled",-1529784218),(end_idx >= total_rows)], null),"Next"], null)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.table_container,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.table,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.thead,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__47355(s__47356){
return (new cljs.core.LazySeq(null,(function (){
var s__47356__$1 = s__47356;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__47356__$1);
if(temp__5825__auto__){
var s__47356__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__47356__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__47356__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__47358 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__47357 = (0);
while(true){
if((i__47357 < size__5502__auto__)){
var col = cljs.core._nth(c__5501__auto__,i__47357);
cljs.core.chunk_append(b__47358,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.th,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["cursor-pointer ",bb_web_ds_tools.theme.bg_item_hover].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__47357,col,c__5501__auto__,size__5502__auto__,b__47358,s__47356__$2,temp__5825__auto__,map__47341,map__47341__$1,id,data,columns,view_state,map__47342,map__47342__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__47343,map__47343__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
...
});})(i__47357,col,c__5501__auto__,size__5502__auto__,b__47358,s__47356__$2,temp__5825__auto__,map__47341,map__47341__$1,id,data,columns,view_state,map__47342,map__47342__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__47343,map__47343__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47358),bb_web_ds_tools$views$datasets$data_table_$_iter__47355(cljs.core.chunk_rest(s__47356__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47358),null);
}
} else {
var col = cljs.core.first(s__47356__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.th,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["cursor-pointer ",bb_web_ds_tools.theme.bg_item_hover].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (col,s__47356__$2,temp__5825__auto__,map__47341,map__47341__$1,id,data,columns,view_state,map__47342,map__47342__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__47343,map__47343__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
var new_dir = ((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_col,col)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))))?new cljs.core.Keyword(null,"desc","desc",2093485764):new cljs.core.Keyword(null,"asc","asc",356854569));
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"sort-col","sort-col",-718754882),col], null));

return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757),new_dir], null));
});})(col,s__47356__$2,temp__5825__auto__,map__47341,map__47341__$1,id,data,columns,view_state,map__47342,map__47342__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__47343,map__47343__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex items-center space-x-1"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),cljs.core.name(col)], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_col,col))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-[10px] transform translate-y-px"], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))?"\u25B2":"\u25BC")], null):null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__47355(cljs.core.rest(s__47356__$2)));
}
} else {
return null;
}
...
})()], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tbody,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__47384(s__47385){
return (new cljs.core.LazySeq(null,(function (){
var s__47385__$1 = s__47385;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__47385__$1);
if(temp__5825__auto__){
var s__47385__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__47385__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__47385__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__47387 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__47386 = (0);
while(true){
if((i__47386 < size__5502__auto__)){
var col = cljs.core._nth(c__5501__auto__,i__47386);
cljs.core.chunk_append(b__47387,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),["filter-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(col)].join(''),new cljs.core.Keyword(null,"class","class",-2030961996),"px-3 py-1.5"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-sm",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),["Filter ",cljs.core.name(col)].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(filters,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__47386,col,c__5501__auto__,size__5502__auto__,b__47387,s__47385__$2,temp__5825__auto__,map__47341,map__47341__$1,id,data,columns,view_state,map__47342,map__47342__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__47343,map__47343__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__47337_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"filters","filters",974726919),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(filters,col,p1__47337_SHARP_.target.value)], null));
});})(i__47386,col,c__5501__auto__,size__5502__auto__,b__47387,s__47385__$2,temp__5825__auto__,map__47341,map__47341__$1,id,data,columns,view_state,map__47342,map__47342__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__47343,map__47343__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__47486 = (i__47386 + (1));
i__47386 = G__47486;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47387),bb_web_ds_tools$views$datasets$data_table_$_iter__47384(cljs.core.chunk_rest(s__47385__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47387),null);
}
} else {
var col = cljs.core.first(s__47385__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),["filter-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(col)].join(''),new cljs.core.Keyword(null,"class","class",-2030961996),"px-3 py-1.5"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-sm",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),["Filter ",cljs.core.name(col)].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(filters,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__47385__$2,temp__5825__auto__,map__47341,map__47341__$1,id,data,columns,view_state,map__47342,map__47342__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__47343,map__47343__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__47337_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"filters","filters",974726919),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(filters,col,p1__47337_SHARP_.target.value)], null));
});})(col,s__47385__$2,temp__5825__auto__,map__47341,map__47341__$1,id,data,columns,view_state,map__47342,map__47342__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__47343,map__47343__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__47384(cljs.core.rest(s__47385__$2)));
}
} else {
return null;
}
...
return iter__5503__auto__(visible_columns);
})()], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__47391(s__47392){
return (new cljs.core.LazySeq(null,(function (){
var s__47392__$1 = s__47392;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__47392__$1);
if(temp__5825__auto__){
var s__47392__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__47392__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__47392__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__47394 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__47393 = (0);
while(true){
if((i__47393 < size__5502__auto__)){
var row = cljs.core._nth(c__5501__auto__,i__47393);
cljs.core.chunk_append(b__47394,(function (){var row_uuid = new cljs.core.Keyword(null,"_uuid","_uuid",797900280).cljs$core$IFn$_invoke$arity$1(row);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row_uuid], null),(function (){var iter__5503__auto__ = ((function (i__47393,row_uuid,row,c__5501__auto__,size__5502__auto__,b__47394,s__47392__$2,temp__5825__auto__,map__47341,map__47341__$1,id,data,columns,view_state,map__47342,map__47342__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__47343,map__47343__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function bb_web_ds_tools$views$datasets$data_table_$_iter__47391_$_iter__47395(s__47396){
return (new cljs.core.LazySeq(null,((function (i__47393,row_uuid,row,c__5501__auto__,size__5502__auto__,b__47394,s__47392__$2,temp__5825__auto__,map__47341,map__47341__$1,id,data,columns,view_state,map__47342,map__47342__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__47343,map__47343__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
var s__47396__$1 = s__47396;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__47396__$1);
if(temp__5825__auto____$1){
var s__47396__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__47396__$2)){
var c__5501__auto____$1 = cljs.core.chunk_first(s__47396__$2);
var size__5502__auto____$1 = cljs.core.count(c__5501__auto____$1);
var b__47398 = cljs.core.chunk_buffer(size__5502__auto____$1);
if((function (){var i__47397 = (0);
while(true){
if((i__47397 < size__5502__auto____$1)){
var col = cljs.core._nth(c__5501__auto____$1,i__47397);
cljs.core.chunk_append(b__47398,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__47397,i__47393,col,c__5501__auto____$1,size__5502__auto____$1,b__47398,s__47396__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__47394,s__47392__$2,temp__5825__auto__,map__47341,map__47341__$1,id,data,columns,view_state,map__47342,map__47342__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__47343,map__47343__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__47338_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__47338_SHARP_.target.value], null));
});})(i__47397,i__47393,col,c__5501__auto____$1,size__5502__auto____$1,b__47398,s__47396__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__47394,s__47392__$2,temp__5825__auto__,map__47341,map__47341__$1,id,data,columns,view_state,map__47342,map__47342__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__47343,map__47343__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__47491 = (i__47397 + (1));
i__47397 = G__47491;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47398),bb_web_ds_tools$views$datasets$data_table_$_iter__47391_$_iter__47395(cljs.core.chunk_rest(s__47396__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47398),null);
}
} else {
var col = cljs.core.first(s__47396__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__47393,col,s__47396__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__47394,s__47392__$2,temp__5825__auto__,map__47341,map__47341__$1,id,data,columns,view_state,map__47342,map__47342__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__47343,map__47343__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__47338_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__47338_SHARP_.target.value], null));
});})(i__47393,col,s__47396__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__47394,s__47392__$2,temp__5825__auto__,map__47341,map__47341__$1,id,data,columns,view_state,map__47342,map__47342__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__47343,map__47343__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__47391_$_iter__47395(cljs.core.rest(s__47396__$2)));
}
} else {
return null;
}
...
});})(i__47393,row_uuid,row,c__5501__auto__,size__5502__auto__,b__47394,s__47392__$2,temp__5825__auto__,map__47341,map__47341__$1,id,data,columns,view_state,map__47342,map__47342__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__47343,map__47343__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
,null,null));
});})(i__47393,row_uuid,row,c__5501__auto__,size__5502__auto__,b__47394,s__47392__$2,temp__5825__auto__,map__47341,map__47341__$1,id,data,columns,view_state,map__47342,map__47342__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__47343,map__47343__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
;
return iter__5503__auto__(visible_columns);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47394),bb_web_ds_tools$views$datasets$data_table_$_iter__47391(cljs.core.chunk_rest(s__47392__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47394),null);
}
} else {
var row = cljs.core.first(s__47392__$2);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row_uuid], null),(function (){var iter__5503__auto__ = ((function (row_uuid,row,s__47392__$2,temp__5825__auto__,map__47341,map__47341__$1,id,data,columns,view_state,map__47342,map__47342__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__47343,map__47343__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function bb_web_ds_tools$views$datasets$data_table_$_iter__47391_$_iter__47399(s__47400){
return (new cljs.core.LazySeq(null,(function (){
var s__47400__$1 = s__47400;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__47400__$1);
if(temp__5825__auto____$1){
var s__47400__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__47400__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__47400__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__47402 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__47401 = (0);
while(true){
if((i__47401 < size__5502__auto__)){
var col = cljs.core._nth(c__5501__auto__,i__47401);
cljs.core.chunk_append(b__47402,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__47401,col,c__5501__auto__,size__5502__auto__,b__47402,s__47400__$2,temp__5825__auto____$1,row_uuid,row,s__47392__$2,temp__5825__auto__,map__47341,map__47341__$1,id,data,columns,view_state,map__47342,map__47342__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__47343,map__47343__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__47338_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__47338_SHARP_.target.value], null));
});})(i__47401,col,c__5501__auto__,size__5502__auto__,b__47402,s__47400__$2,temp__5825__auto____$1,row_uuid,row,s__47392__$2,temp__5825__auto__,map__47341,map__47341__$1,id,data,columns,view_state,map__47342,map__47342__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__47343,map__47343__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__47505 = (i__47401 + (1));
i__47401 = G__47505;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47402),bb_web_ds_tools$views$datasets$data_table_$_iter__47391_$_iter__47399(cljs.core.chunk_rest(s__47400__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47402),null);
}
} else {
var col = cljs.core.first(s__47400__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__47400__$2,temp__5825__auto____$1,row_uuid,row,s__47392__$2,temp__5825__auto__,map__47341,map__47341__$1,id,data,columns,view_state,map__47342,map__47342__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__47343,map__47343__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__47338_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__47338_SHARP_.target.value], null));
});})(col,s__47400__$2,temp__5825__auto____$1,row_uuid,row,s__47392__$2,temp__5825__auto__,map__47341,map__47341__$1,id,data,columns,view_state,map__47342,map__47342__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__47343,map__47343__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__47391_$_iter__47399(cljs.core.rest(s__47400__$2)));
}
} else {
return null;
}
...
});})(row_uuid,row,s__47392__$2,temp__5825__auto__,map__47341,map__47341__$1,id,data,columns,view_state,map__47342,map__47342__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__47343,map__47343__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
;
return iter__5503__auto__(visible_columns);
})()], null);
})(),bb_web_ds_tools$views$datasets$data_table_$_iter__47391(cljs.core.rest(s__47392__$2)));
}
} else {
return null;
}
...
})], null),"+ New Dataset"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex-grow overflow-y-auto pt-4 space-y-1"], null),((cljs.core.seq(items))?(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$dataset_list_$_iter__47408(s__47409){
return (new cljs.core.LazySeq(null,(function (){
var s__47409__$1 = s__47409;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__47409__$1);
if(temp__5825__auto__){
var s__47409__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__47409__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__47409__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__47411 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__47410 = (0);
while(true){
if((i__47410 < size__5502__auto__)){
var vec__47412 = cljs.core._nth(c__5501__auto__,i__47410);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47412,(0),null);
var ds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47412,(1),null);
cljs.core.chunk_append(b__47411,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.datasets.dataset_list_item,id,ds,active_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__47522 = (i__47410 + (1));
i__47410 = G__47522;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47411),bb_web_ds_tools$views$datasets$dataset_list_$_iter__47408(cljs.core.chunk_rest(s__47409__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47411),null);
}
} else {
var vec__47415 = cljs.core.first(s__47409__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47415,(0),null);
var ds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47415,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.datasets.dataset_list_item,id,ds,active_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),bb_web_ds_tools$views$datasets$dataset_list_$_iter__47408(cljs.core.rest(s__47409__$2)));
}
} else {
return null;
}
...
return (function (){
var map__47418 = cljs.core.deref(state_sub);
var map__47418__$1 = cljs.core.__destructure_map(map__47418);
var active_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47418__$1,new cljs.core.Keyword(null,"active-id","active-id",-59238656));
var active_dataset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47418__$1,new cljs.core.Keyword(null,"active-dataset","active-dataset",771380472));
