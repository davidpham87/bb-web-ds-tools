...
var malli$generator$Generator$_generator$dyn_33064 = (function (this$,options){
...
return malli$generator$Generator$_generator$dyn_33064(this$,options);
}
});
 ...
 */
malli.generator._never_gen = (function malli$generator$_never_gen(p__32843){
var map__32844 = p__32843;
var map__32844__$1 = cljs.core.__destructure_map(map__32844);
var _options = map__32844__$1;
var original_generator_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32844__$1,new cljs.core.Keyword("malli.generator","original-generator-schema","malli.generator/original-generator-schema",-1122475395));
return cljs.core.with_meta(clojure.test.check.generators.sized((function (_){
return malli.core._fail_BANG_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("malli.generator","unsatisfiable-schema","malli.generator/unsatisfiable-schema",919209538),(function (){var G__32845 = cljs.core.PersistentArrayMap.EMPTY;
if(cljs.core.truth_(original_generator_schema)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32845,new cljs.core.Keyword(null,"schema","schema",-1582001791),original_generator_schema);
} else {
return G__32845;
}
})());
...
var map__32858 = malli.core.properties.cljs$core$IFn$_invoke$arity$2(schema,options);
var map__32858__$1 = cljs.core.__destructure_map(map__32858);
var gen_min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32858__$1,new cljs.core.Keyword("gen","min","gen/min",444569458));
var gen_max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32858__$1,new cljs.core.Keyword("gen","max","gen/max",61264228));
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32858__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32858__$1,new cljs.core.Keyword(null,"max","max",61366548));
...
var map__32871 = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
var map__32871__$1 = cljs.core.__destructure_map(map__32871);
var infinite_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32871__$1,new cljs.core.Keyword("gen","infinite?","gen/infinite?",-2017652832));
var NaN_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32871__$1,new cljs.core.Keyword("gen","NaN?","gen/NaN?",-1917993267));
...
return malli.generator.gen_fmap((function (p1__32873_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,p1__32873_SHARP_);
}),gen);
});
...
return clojure.test.check.generators.double_STAR_(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$2(malli.generator.double_default,opts),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__32879_SHARP_){
var G__32881 = p1__32879_SHARP_;
if((G__32881 == null)){
return null;
} else {
return G__32881;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__32880_SHARP_){
var G__32883 = p1__32880_SHARP_;
if((G__32883 == null)){
return null;
} else {
return G__32883;
...
malli.generator.gen_vector = (function malli$generator$gen_vector(p__32885,g){
var map__32886 = p__32885;
var map__32886__$1 = cljs.core.__destructure_map(map__32886);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32886__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32886__$1,new cljs.core.Keyword(null,"max","max",61366548));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(clojure.test.check.generators.sized((function (p1__32884_SHARP_){
return clojure.test.check.generators.vector.cljs$core$IFn$_invoke$arity$3(g,min,(min + p1__32884_SHARP_));
...
malli.generator.gen_vector_distinct_by = (function malli$generator$gen_vector_distinct_by(schema,p__32888,f,g){
var map__32889 = p__32888;
var map__32889__$1 = cljs.core.__destructure_map(map__32889);
var m = map__32889__$1;
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32889__$1,new cljs.core.Keyword(null,"min","min",444991522));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
})())?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"num-elements","num-elements",1960422107),min], null):clojure.set.rename_keys(m,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"min","min",444991522),new cljs.core.Keyword(null,"min-elements","min-elements",949370780),new cljs.core.Keyword(null,"max","max",61366548),new cljs.core.Keyword(null,"max-elements","max-elements",433034073)], null))),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__32887_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","distinct-generator-failure","malli.generator/distinct-generator-failure",-2085139904),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__32887_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null)));
}
});
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__32895_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","such-that-failure","malli.generator/such-that-failure",599634585),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__32895_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null);
});
...
return malli.util.transform_entries.cljs$core$IFn$_invoke$arity$3(G__32914,(function (p1__32913_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__32916){
var vec__32917 = p__32916;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32917,(0),null);
var e = vec__32917;
var G__32920 = e;
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__32920,(2),malli.util.merge,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dispatch,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"=","=",1152933628),null,k], null)], null)], null));
} else {
return G__32920;
}
}),p1__32913_SHARP_);
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32923_SHARP_){
var G__32925 = cljs.core.last(p1__32923_SHARP_);
var G__32926 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32925,G__32926) : malli.generator.generator.call(null,G__32925,G__32926));
...
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__32927){
var vec__32928 = p__32927;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32928,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32928,(1),null);
...
malli.generator._entry_gen = (function malli$generator$_entry_gen(p__32932,options){
var vec__32933 = p__32932;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32933,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32933,(1),null);
var G__32936 = malli.generator.gen_fmap((function (p1__32931_SHARP_){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,p1__32931_SHARP_], null);
...
return malli.generator.gen_maybe(G__32936);
} else {
return G__32936;
}
});
malli.generator._map_gen = (function malli$generator$_map_gen(schema,options){
return malli.generator.gen_fmap(malli.generator._build_map,malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32937_SHARP_){
return malli.generator._entry_gen(p1__32937_SHARP_,options);
...
return malli.generator.gen_fmap((function (p1__32940_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,p1__32940_SHARP_);
}),malli.generator.gen_vector_distinct_by(schema,malli.generator._min_max(schema,options),(function (p1__32939_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__32939_SHARP_,(0));
}),malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32938_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__32938_SHARP_,options) : malli.generator.generator.call(null,p1__32938_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)))));
});
...
var G__32943 = (function (){var G__32944 = dschema;
var G__32945 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),scalar_ref_gen);
...
var G__32946 = dschema;
var G__32947 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),p1__32942_SHARP_);
...
var output_generator = (function (){var G__32948 = new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(malli.core._function_info(schema));
...
var G__33069__delegate = function (_){
...
while (G__33070__i < G__33070__a.length) {G__33070__a[G__33070__i] = arguments[G__33070__i + 0]; ++G__33070__i;}
  _ = new cljs.core.IndexedSeq(G__33070__a,0,null);
} 
return G__33069__delegate.call(this,_);};
G__33069.cljs$lang$maxFixedArity = 0;
G__33069.cljs$lang$applyTo = (function (arglist__33071){
var _ = cljs.core.seq(arglist__33071);
return G__33069__delegate(_);
});
...
return clojure.test.check.generators.return$(malli.core._instrument.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"schema","schema",-1582001791),schema,new cljs.core.Keyword(null,"gen","gen",142575302),(function (p1__32950_SHARP_){
return (malli.generator.generate.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generate.cljs$core$IFn$_invoke$arity$2(p1__32950_SHARP_,options) : malli.generator.generate.call(null,p1__32950_SHARP_,options));
})], null),null,options));
});
malli.generator._regex_generator = (function malli$generator$_regex_generator(schema,options){
var G__32951 = (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(schema,options) : malli.generator.generator.call(null,schema,options));
if(cljs.core.not(malli.core._regex_op_QMARK_(schema))){
return malli.generator.gen_tuple((new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[G__32951],null)));
} else {
return G__32951;
}
});
...
return malli.generator.gen_fcat(malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32952_SHARP_){
return malli.generator._re_entry_gen(p1__32952_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options))));
});
malli.generator._alt_gen = (function malli$generator$_alt_gen(schema,options){
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32953_SHARP_){
return malli.generator._re_entry_gen(p1__32953_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
});
...
var child = malli.generator._child(schema,options);
var G__32970 = malli.generator.gen_vector(malli.generator._min_max(schema,options),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__32970);
} else {
return G__32970;
}
});
...
var or__5025__auto__ = (function (){var G__32976 = malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$2(schema,options);
var G__32976__$1 = (((G__32976 == null))?null:malli.generator._not_unreachable(G__32976));
if((G__32976__$1 == null)){
return null;
} else {
var G__32977 = G__32976__$1;
if(cljs.core.truth_(malli.core._regex_op_QMARK_(malli.generator._child(schema,options)))){
return malli.generator.gen_fcat(G__32977);
} else {
return G__32977;
}
}
...
var G__32978 = cljs.core.name(namespace_unparsed);
var G__32979 = cljs.core.name(k);
return (mk_value_with_ns.cljs$core$IFn$_invoke$arity$2 ? mk_value_with_ns.cljs$core$IFn$_invoke$arity$2(G__32978,G__32979) : mk_value_with_ns.call(null,G__32978,G__32979));
...
})(),cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__32981_SHARP_){
var G__32983 = p1__32981_SHARP_;
if((G__32983 == null)){
return null;
} else {
return G__32983;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__32982_SHARP_){
var G__32984 = p1__32982_SHARP_;
if((G__32984 == null)){
return null;
} else {
return G__32984;
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.generator","default","malli.generator/default",-943988734)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__32985 = cljs.core.get_global_hierarchy;
return (fexpr__32985.cljs$core$IFn$_invoke$arity$0 ? fexpr__32985.cljs$core$IFn$_invoke$arity$0() : fexpr__32985.call(null));
})());
...
return malli.generator.gen_such_that(schema,(function (p1__32988_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__32988_SHARP_,malli.generator._child(schema,options));
...
return malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32996_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__32996_SHARP_,options) : malli.generator.generator.call(null,p1__32996_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
}));
...
var G__33001 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__33002 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__33001,G__33002) : malli.generator.generator.call(null,G__33001,G__33002));
}));
...
var G__33003 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__33004 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__33003,G__33004) : malli.generator.generator.call(null,G__33003,G__33004));
}));
...
var G__33005 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__33006 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__33005,G__33006) : malli.generator.generator.call(null,G__33005,G__33006));
}));
...
var G__33009 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__33010 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__33009,G__33010) : malli.generator.generator.call(null,G__33009,G__33010));
}));
...
var G__33011 = new cljs.core.Keyword("gen","elements","gen/elements",657813311).cljs$core$IFn$_invoke$arity$1(props);
if((G__33011 == null)){
return null;
} else {
return malli.generator.gen_elements(G__33011);
}
});
...
return malli.core._cached(malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options),new cljs.core.Keyword(null,"generator","generator",-572962281),(function (p1__33013_SHARP_){
return malli.generator._create(p1__33013_SHARP_,options);
}));
}
}));
...
(malli.generator.generate.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__33022){
var map__33023 = p__33022;
var map__33023__$1 = cljs.core.__destructure_map(map__33023);
var options = map__33023__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33023__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__33023__$1,new cljs.core.Keyword(null,"size","size",1098693007),(30));
...
(malli.generator.sample.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__33029){
var map__33030 = p__33029;
var map__33030__$1 = cljs.core.__destructure_map(map__33030);
var options = map__33030__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33030__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__33030__$1,new cljs.core.Keyword(null,"size","size",1098693007),(10));
var gen = ((clojure.test.check.generators.generator_QMARK_(_QMARK_gen_or_schema))?_QMARK_gen_or_schema:malli.generator.generator.cljs$core$IFn$_invoke$arity$2(_QMARK_gen_or_schema,options));
return cljs.core.take.cljs$core$IFn$_invoke$arity$2(size,cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__33024_SHARP_,p2__33025_SHARP_){
return clojure.test.check.rose_tree.root(clojure.test.check.generators.call_gen(gen,p1__33024_SHARP_,p2__33025_SHARP_));
...
(malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_schema,p__33046){
var map__33049 = p__33046;
var map__33049__$1 = cljs.core.__destructure_map(map__33049);
var options = map__33049__$1;
var _EQ__GT_iterations = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__33049__$1,new cljs.core.Keyword("malli.generator","=>iterations","malli.generator/=>iterations",-1726832707),(100));
...
}catch (e33050){if((e33050 instanceof Error)){
var e = e33050;
...
var map__33051 = malli.core._function_info(schema__$1);
var map__33051__$1 = cljs.core.__destructure_map(map__33051);
var input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33051__$1,new cljs.core.Keyword(null,"input","input",556931961));
var output = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33051__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var guard = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33051__$1,new cljs.core.Keyword(null,"guard","guard",-873147811));
...
if(cljs.core.truth_(and__5023__auto__)){
var G__33052 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [args,$], null);
return (valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1 ? valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1(G__33052) : valid_guard_QMARK_.call(null,G__33052));
} else {
return and__5023__auto__;
}
});
return (function (f){
var map__33053 = clojure.test.check.quick_check(_EQ__GT_iterations,clojure.test.check.properties.for_all_STAR_(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [input_generator], null),(function (p1__33032_SHARP_){
return validate(f,p1__33032_SHARP_);
})));
var map__33053__$1 = cljs.core.__destructure_map(map__33053);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33053__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var shrunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33053__$1,new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412));
...
var vec__33054 = (cljs.core.truth_(explain_input)?null:_try((function (){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,smallest);
})));
var result__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33054,(0),null);
var success = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33054,(1),null);
...
var G__33057 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(shrunk,new cljs.core.Keyword("malli.core","result","malli.core/result",1538632379),result__$1);
var G__33057__$1 = (cljs.core.truth_(explain_input)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33057,new cljs.core.Keyword("malli.core","explain-input","malli.core/explain-input",1441627811),explain_input):G__33057);
var G__33057__$2 = (cljs.core.truth_(explain_output)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33057__$1,new cljs.core.Keyword("malli.core","explain-output","malli.core/explain-output",-124321573),explain_output):G__33057__$1);
var G__33057__$3 = (cljs.core.truth_(explain_guard)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33057__$2,new cljs.core.Keyword("malli.core","explain-guard","malli.core/explain-guard",-1119572847),explain_guard):G__33057__$2);
if(cljs.core.truth_(cljs.core.ex_message(result__$1))){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__33057__$3,new cljs.core.Keyword(null,"result","result",1415092211),cljs.core.ex_message),new cljs.core.Keyword(null,"result-data","result-data",-1724248844));
} else {
return G__33057__$3;
}
}
...
var checkers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33036_SHARP_){
return malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2(p1__33036_SHARP_,options);
}),malli.core._function_schema_arities(schema));
return (function (x){
return cljs.core.seq(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__33037_SHARP_){
return (p1__33037_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__33037_SHARP_.cljs$core$IFn$_invoke$arity$1(x) : p1__33037_SHARP_.call(null,x));
}),checkers));
});
} else {
...
var schema = malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options);
return malli.core.explain.cljs$core$IFn$_invoke$arity$2(malli.core._update_options(schema,(function (p1__33059_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__33059_SHARP_,new cljs.core.Keyword("malli.core","function-checker","malli.core/function-checker",-792030936),malli.generator.function_checker);
})),f);
}));
