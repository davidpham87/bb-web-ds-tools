...
var malli$generator$Generator$_generator$dyn_33115 = (function (this$,options){
...
return malli$generator$Generator$_generator$dyn_33115(this$,options);
}
});
...
var G__32791 = malli.generator._child(schema,options);
var G__32792 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32791,G__32792) : malli.generator.generator.call(null,G__32791,G__32792));
});
/**
 * Return a generator of no values that is compatible with -unreachable-gen?.
 */
malli.generator._never_gen = (function malli$generator$_never_gen(p__32793){
var map__32794 = p__32793;
var map__32794__$1 = cljs.core.__destructure_map(map__32794);
var _options = map__32794__$1;
var original_generator_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32794__$1,new cljs.core.Keyword("malli.generator","original-generator-schema","malli.generator/original-generator-schema",-1122475395));
return cljs.core.with_meta(clojure.test.check.generators.sized((function (_){
return malli.core._fail_BANG_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("malli.generator","unsatisfiable-schema","malli.generator/unsatisfiable-schema",919209538),(function (){var G__32795 = cljs.core.PersistentArrayMap.EMPTY;
if(cljs.core.truth_(original_generator_schema)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32795,new cljs.core.Keyword(null,"schema","schema",-1582001791),original_generator_schema);
} else {
return G__32795;
}
})());
...
var map__32814 = malli.core.properties.cljs$core$IFn$_invoke$arity$2(schema,options);
var map__32814__$1 = cljs.core.__destructure_map(map__32814);
var gen_min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32814__$1,new cljs.core.Keyword("gen","min","gen/min",444569458));
var gen_max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32814__$1,new cljs.core.Keyword("gen","max","gen/max",61264228));
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32814__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32814__$1,new cljs.core.Keyword(null,"max","max",61366548));
...
var map__32815 = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
var map__32815__$1 = cljs.core.__destructure_map(map__32815);
var infinite_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32815__$1,new cljs.core.Keyword("gen","infinite?","gen/infinite?",-2017652832));
var NaN_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32815__$1,new cljs.core.Keyword("gen","NaN?","gen/NaN?",-1917993267));
...
return malli.generator.gen_fmap((function (p1__32816_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,p1__32816_SHARP_);
}),gen);
});
...
return clojure.test.check.generators.double_STAR_(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$2(malli.generator.double_default,opts),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__32821_SHARP_){
var G__32823 = p1__32821_SHARP_;
if((G__32823 == null)){
return null;
} else {
return G__32823;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__32822_SHARP_){
var G__32824 = p1__32822_SHARP_;
if((G__32824 == null)){
return null;
} else {
return G__32824;
...
malli.generator.gen_vector = (function malli$generator$gen_vector(p__32829,g){
...
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32830__$1,new cljs.core.Keyword(null,"max","max",61366548));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(clojure.test.check.generators.sized((function (p1__32825_SHARP_){
return clojure.test.check.generators.vector.cljs$core$IFn$_invoke$arity$3(g,min,(min + p1__32825_SHARP_));
...
malli.generator.gen_vector_distinct_by = (function malli$generator$gen_vector_distinct_by(schema,p__32834,f,g){
var map__32835 = p__32834;
var map__32835__$1 = cljs.core.__destructure_map(map__32835);
var m = map__32835__$1;
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32835__$1,new cljs.core.Keyword(null,"min","min",444991522));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
})())?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"num-elements","num-elements",1960422107),min], null):clojure.set.rename_keys(m,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"min","min",444991522),new cljs.core.Keyword(null,"min-elements","min-elements",949370780),new cljs.core.Keyword(null,"max","max",61366548),new cljs.core.Keyword(null,"max-elements","max-elements",433034073)], null))),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__32831_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","distinct-generator-failure","malli.generator/distinct-generator-failure",-2085139904),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__32831_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null)));
}
});
...
var map__32849 = malli.generator._min_max(schema,options);
var map__32849__$1 = cljs.core.__destructure_map(map__32849);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32849__$1,new cljs.core.Keyword(null,"min","min",444991522));
var el = malli.generator._child(schema,options);
return malli.generator.gen_one_of(options,(function (){var G__32850 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$3((function (){var G__32851 = cljs.core.PersistentVector.EMPTY;
if((((min == null)) || ((min === (0))))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__32851,malli.generator.nil_gen);
} else {
return G__32851;
}
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__32847_SHARP_){
return malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$3(schema,p1__32847_SHARP_,options);
})),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.identity,cljs.core.vec,cljs.core.eduction,(function (p1__32848_SHARP_){
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(p1__32848_SHARP_);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__32850,(function (){var vec__32852 = malli.core.children.cljs$core$IFn$_invoke$arity$1(el);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32852,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32852,(1),null);
var G__32855 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map-of","map-of",1189682355),(function (){var or__5025__auto__ = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
...
var G__32856 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32855,G__32856) : malli.generator.generator.call(null,G__32855,G__32856));
})());
} else {
return G__32850;
}
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32857_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__32857_SHARP_,options) : malli.generator.generator.call(null,p1__32857_SHARP_,options));
...
return malli.util.transform_entries.cljs$core$IFn$_invoke$arity$3(G__32859,(function (p1__32858_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__32860){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__32864,(2),malli.util.merge,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dispatch,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"=","=",1152933628),null,k], null)], null)], null));
} else {
return G__32864;
}
}),p1__32858_SHARP_);
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32865_SHARP_){
var G__32866 = cljs.core.last(p1__32865_SHARP_);
var G__32867 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32866,G__32867) : malli.generator.generator.call(null,G__32866,G__32867));
...
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__32871){
var vec__32872 = p__32871;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32872,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32872,(1),null);
...
malli.generator._entry_gen = (function malli$generator$_entry_gen(p__32876,options){
var vec__32881 = p__32876;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32881,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32881,(1),null);
var G__32884 = malli.generator.gen_fmap((function (p1__32875_SHARP_){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,p1__32875_SHARP_], null);
...
return malli.generator.gen_maybe(G__32884);
} else {
return G__32884;
}
});
malli.generator._map_gen = (function malli$generator$_map_gen(schema,options){
return malli.generator.gen_fmap(malli.generator._build_map,malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32885_SHARP_){
return malli.generator._entry_gen(p1__32885_SHARP_,options);
...
var output_generator = (function (){var G__32898 = new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(malli.core._function_info(schema));
var G__32899 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32898,G__32899) : malli.generator.generator.call(null,G__32898,G__32899));
})();
...
return clojure.test.check.generators.return$(malli.core._instrument.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"schema","schema",-1582001791),schema,new cljs.core.Keyword(null,"gen","gen",142575302),(function (p1__32900_SHARP_){
return (malli.generator.generate.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generate.cljs$core$IFn$_invoke$arity$2(p1__32900_SHARP_,options) : malli.generator.generate.call(null,p1__32900_SHARP_,options));
})], null),null,options));
});
malli.generator._regex_generator = (function malli$generator$_regex_generator(schema,options){
var G__32901 = (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(schema,options) : malli.generator.generator.call(null,schema,options));
if(cljs.core.not(malli.core._regex_op_QMARK_(schema))){
return malli.generator.gen_tuple((new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[G__32901],null)));
} else {
return G__32901;
}
});
...
return malli.generator.gen_fcat(malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32903_SHARP_){
return malli.generator._re_entry_gen(p1__32903_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options))));
});
malli.generator._alt_gen = (function malli$generator$_alt_gen(schema,options){
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32904_SHARP_){
return malli.generator._re_entry_gen(p1__32904_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
});
...
var child = malli.generator._child(schema,options);
var G__32908 = malli.generator.gen_vector(malli.generator._min_max(schema,options),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__32908);
} else {
return G__32908;
}
});
...
var child = malli.generator._child(schema,options);
var G__32909 = malli.generator.gen_vector(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.max,(1))),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__32909);
} else {
return G__32909;
}
});
malli.generator._repeat_gen = (function malli$generator$_repeat_gen(schema,options){
var or__5025__auto__ = (function (){var G__32910 = malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$2(schema,options);
var G__32910__$1 = (((G__32910 == null))?null:malli.generator._not_unreachable(G__32910));
if((G__32910__$1 == null)){
return null;
} else {
var G__32911 = G__32910__$1;
if(cljs.core.truth_(malli.core._regex_op_QMARK_(malli.generator._child(schema,options)))){
return malli.generator.gen_fcat(G__32911);
} else {
return G__32911;
}
}
...
var G__32912 = cljs.core.name(namespace_unparsed);
var G__32913 = cljs.core.name(k);
return (mk_value_with_ns.cljs$core$IFn$_invoke$arity$2 ? mk_value_with_ns.cljs$core$IFn$_invoke$arity$2(G__32912,G__32913) : mk_value_with_ns.call(null,G__32912,G__32913));
...
})(),cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__32918_SHARP_){
var G__32920 = p1__32918_SHARP_;
if((G__32920 == null)){
return null;
} else {
return G__32920;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__32919_SHARP_){
var G__32937 = p1__32919_SHARP_;
if((G__32937 == null)){
return null;
} else {
return G__32937;
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.generator","default","malli.generator/default",-943988734)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__32943 = cljs.core.get_global_hierarchy;
...
return malli.generator.gen_such_that(schema,(function (p1__32951_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__32951_SHARP_,malli.generator._child(schema,options));
...
return malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32954_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__32954_SHARP_,options) : malli.generator.generator.call(null,p1__32954_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
}));
...
var G__32973 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__32974 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32973,G__32974) : malli.generator.generator.call(null,G__32973,G__32974));
}));
...
var G__32975 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__32976 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32975,G__32976) : malli.generator.generator.call(null,G__32975,G__32976));
}));
...
var G__32977 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__32978 = options;
...
var G__32986 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__32987 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32986,G__32987) : malli.generator.generator.call(null,G__32986,G__32987));
}));
...
var G__32988 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__32989 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32988,G__32989) : malli.generator.generator.call(null,G__32988,G__32989));
}));
...
var G__33003 = new cljs.core.Keyword("gen","elements","gen/elements",657813311).cljs$core$IFn$_invoke$arity$1(props);
if((G__33003 == null)){
return null;
} else {
return malli.generator.gen_elements(G__33003);
}
});
...
var G__33012 = new cljs.core.Keyword("gen","schema","gen/schema",-1582038959).cljs$core$IFn$_invoke$arity$1(props);
if((G__33012 == null)){
return null;
} else {
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__33012,options) : malli.generator.generator.call(null,G__33012,options));
}
});
...
return malli.core._cached(malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options),new cljs.core.Keyword(null,"generator","generator",-572962281),(function (p1__33022_SHARP_){
return malli.generator._create(p1__33022_SHARP_,options);
}));
}
}));
...
(malli.generator.generate.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__33037){
var map__33038 = p__33037;
var map__33038__$1 = cljs.core.__destructure_map(map__33038);
var options = map__33038__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33038__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__33038__$1,new cljs.core.Keyword(null,"size","size",1098693007),(30));
...
(malli.generator.sample.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__33049){
var map__33050 = p__33049;
var map__33050__$1 = cljs.core.__destructure_map(map__33050);
var options = map__33050__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33050__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__33050__$1,new cljs.core.Keyword(null,"size","size",1098693007),(10));
var gen = ((clojure.test.check.generators.generator_QMARK_(_QMARK_gen_or_schema))?_QMARK_gen_or_schema:malli.generator.generator.cljs$core$IFn$_invoke$arity$2(_QMARK_gen_or_schema,options));
return cljs.core.take.cljs$core$IFn$_invoke$arity$2(size,cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__33045_SHARP_,p2__33046_SHARP_){
return clojure.test.check.rose_tree.root(clojure.test.check.generators.call_gen(gen,p1__33045_SHARP_,p2__33046_SHARP_));
...
(malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_schema,p__33066){
var map__33067 = p__33066;
var map__33067__$1 = cljs.core.__destructure_map(map__33067);
var options = map__33067__$1;
var _EQ__GT_iterations = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__33067__$1,new cljs.core.Keyword("malli.generator","=>iterations","malli.generator/=>iterations",-1726832707),(100));
...
}catch (e33068){if((e33068 instanceof Error)){
var e = e33068;
...
var map__33087 = malli.core._function_info(schema__$1);
var map__33087__$1 = cljs.core.__destructure_map(map__33087);
var input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33087__$1,new cljs.core.Keyword(null,"input","input",556931961));
var output = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33087__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var guard = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33087__$1,new cljs.core.Keyword(null,"guard","guard",-873147811));
...
if(cljs.core.truth_(and__5023__auto__)){
var G__33088 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [args,$], null);
return (valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1 ? valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1(G__33088) : valid_guard_QMARK_.call(null,G__33088));
} else {
return and__5023__auto__;
}
});
return (function (f){
var map__33089 = clojure.test.check.quick_check(_EQ__GT_iterations,clojure.test.check.properties.for_all_STAR_(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [input_generator], null),(function (p1__33061_SHARP_){
return validate(f,p1__33061_SHARP_);
})));
var map__33089__$1 = cljs.core.__destructure_map(map__33089);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33089__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var shrunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33089__$1,new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412));
...
var vec__33092 = (cljs.core.truth_(explain_input)?null:_try((function (){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,smallest);
})));
var result__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33092,(0),null);
var success = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33092,(1),null);
...
var G__33105 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(shrunk,new cljs.core.Keyword("malli.core","result","malli.core/result",1538632379),result__$1);
var G__33105__$1 = (cljs.core.truth_(explain_input)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33105,new cljs.core.Keyword("malli.core","explain-input","malli.core/explain-input",1441627811),explain_input):G__33105);
var G__33105__$2 = (cljs.core.truth_(explain_output)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33105__$1,new cljs.core.Keyword("malli.core","explain-output","malli.core/explain-output",-124321573),explain_output):G__33105__$1);
var G__33105__$3 = (cljs.core.truth_(explain_guard)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33105__$2,new cljs.core.Keyword("malli.core","explain-guard","malli.core/explain-guard",-1119572847),explain_guard):G__33105__$2);
if(cljs.core.truth_(cljs.core.ex_message(result__$1))){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__33105__$3,new cljs.core.Keyword(null,"result","result",1415092211),cljs.core.ex_message),new cljs.core.Keyword(null,"result-data","result-data",-1724248844));
} else {
return G__33105__$3;
}
}
...
var checkers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33062_SHARP_){
return malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2(p1__33062_SHARP_,options);
}),malli.core._function_schema_arities(schema));
return (function (x){
return cljs.core.seq(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__33063_SHARP_){
return (p1__33063_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__33063_SHARP_.cljs$core$IFn$_invoke$arity$1(x) : p1__33063_SHARP_.call(null,x));
}),checkers));
});
} else {
...
var schema = malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options);
return malli.core.explain.cljs$core$IFn$_invoke$arity$2(malli.core._update_options(schema,(function (p1__33106_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__33106_SHARP_,new cljs.core.Keyword("malli.core","function-checker","malli.core/function-checker",-792030936),malli.generator.function_checker);
})),f);
}));
