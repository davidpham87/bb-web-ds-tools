...
var malli$generator$Generator$_generator$dyn_33023 = (function (this$,options){
...
return malli$generator$Generator$_generator$dyn_33023(this$,options);
}
});
...
var G__32799 = malli.generator._child(schema,options);
var G__32800 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32799,G__32800) : malli.generator.generator.call(null,G__32799,G__32800));
});
/**
 * Return a generator of no values that is compatible with -unreachable-gen?.
 */
malli.generator._never_gen = (function malli$generator$_never_gen(p__32801){
var map__32802 = p__32801;
var map__32802__$1 = cljs.core.__destructure_map(map__32802);
var _options = map__32802__$1;
var original_generator_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32802__$1,new cljs.core.Keyword("malli.generator","original-generator-schema","malli.generator/original-generator-schema",-1122475395));
return cljs.core.with_meta(clojure.test.check.generators.sized((function (_){
return malli.core._fail_BANG_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("malli.generator","unsatisfiable-schema","malli.generator/unsatisfiable-schema",919209538),(function (){var G__32803 = cljs.core.PersistentArrayMap.EMPTY;
if(cljs.core.truth_(original_generator_schema)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32803,new cljs.core.Keyword(null,"schema","schema",-1582001791),original_generator_schema);
} else {
return G__32803;
}
})());
...
var map__32816 = malli.core.properties.cljs$core$IFn$_invoke$arity$2(schema,options);
var map__32816__$1 = cljs.core.__destructure_map(map__32816);
var gen_min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32816__$1,new cljs.core.Keyword("gen","min","gen/min",444569458));
var gen_max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32816__$1,new cljs.core.Keyword("gen","max","gen/max",61264228));
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32816__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32816__$1,new cljs.core.Keyword(null,"max","max",61366548));
...
var map__32819 = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
var map__32819__$1 = cljs.core.__destructure_map(map__32819);
var infinite_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32819__$1,new cljs.core.Keyword("gen","infinite?","gen/infinite?",-2017652832));
var NaN_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32819__$1,new cljs.core.Keyword("gen","NaN?","gen/NaN?",-1917993267));
...
return malli.generator.gen_fmap((function (p1__32825_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,p1__32825_SHARP_);
}),gen);
});
...
return clojure.test.check.generators.double_STAR_(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$2(malli.generator.double_default,opts),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__32831_SHARP_){
var G__32833 = p1__32831_SHARP_;
if((G__32833 == null)){
return null;
} else {
return G__32833;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__32832_SHARP_){
var G__32834 = p1__32832_SHARP_;
if((G__32834 == null)){
return null;
} else {
return G__32834;
...
malli.generator.gen_vector = (function malli$generator$gen_vector(p__32839,g){
var map__32840 = p__32839;
var map__32840__$1 = cljs.core.__destructure_map(map__32840);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32840__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32840__$1,new cljs.core.Keyword(null,"max","max",61366548));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(clojure.test.check.generators.sized((function (p1__32835_SHARP_){
return clojure.test.check.generators.vector.cljs$core$IFn$_invoke$arity$3(g,min,(min + p1__32835_SHARP_));
...
malli.generator.gen_vector_distinct_by = (function malli$generator$gen_vector_distinct_by(schema,p__32842,f,g){
var map__32843 = p__32842;
var map__32843__$1 = cljs.core.__destructure_map(map__32843);
var m = map__32843__$1;
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32843__$1,new cljs.core.Keyword(null,"min","min",444991522));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
})())?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"num-elements","num-elements",1960422107),min], null):clojure.set.rename_keys(m,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"min","min",444991522),new cljs.core.Keyword(null,"min-elements","min-elements",949370780),new cljs.core.Keyword(null,"max","max",61366548),new cljs.core.Keyword(null,"max-elements","max-elements",433034073)], null))),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__32841_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","distinct-generator-failure","malli.generator/distinct-generator-failure",-2085139904),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__32841_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null)));
}
});
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__32846_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","such-that-failure","malli.generator/such-that-failure",599634585),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__32846_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null);
});
...
var map__32850 = malli.generator._min_max(schema,options);
var map__32850__$1 = cljs.core.__destructure_map(map__32850);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32850__$1,new cljs.core.Keyword(null,"min","min",444991522));
var el = malli.generator._child(schema,options);
return malli.generator.gen_one_of(options,(function (){var G__32851 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$3((function (){var G__32852 = cljs.core.PersistentVector.EMPTY;
if((((min == null)) || ((min === (0))))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__32852,malli.generator.nil_gen);
} else {
return G__32852;
}
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__32848_SHARP_){
return malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$3(schema,p1__32848_SHARP_,options);
})),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.identity,cljs.core.vec,cljs.core.eduction,(function (p1__32849_SHARP_){
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(p1__32849_SHARP_);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__32851,(function (){var vec__32855 = malli.core.children.cljs$core$IFn$_invoke$arity$1(el);
...
var G__32858 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map-of","map-of",1189682355),(function (){var or__5025__auto__ = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
...
var G__32859 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32858,G__32859) : malli.generator.generator.call(null,G__32858,G__32859));
})());
} else {
return G__32851;
}
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32860_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__32860_SHARP_,options) : malli.generator.generator.call(null,p1__32860_SHARP_,options));
...
return malli.util.transform_entries.cljs$core$IFn$_invoke$arity$3(G__32867,(function (p1__32861_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__32868){
var vec__32869 = p__32868;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32869,(0),null);
var e = vec__32869;
var G__32872 = e;
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__32872,(2),malli.util.merge,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dispatch,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"=","=",1152933628),null,k], null)], null)], null));
} else {
return G__32872;
}
}),p1__32861_SHARP_);
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32873_SHARP_){
var G__32874 = cljs.core.last(p1__32873_SHARP_);
var G__32875 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32874,G__32875) : malli.generator.generator.call(null,G__32874,G__32875));
...
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__32876){
var vec__32877 = p__32876;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32877,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32877,(1),null);
...
malli.generator._entry_gen = (function malli$generator$_entry_gen(p__32881,options){
var vec__32882 = p__32881;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32882,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32882,(1),null);
var G__32885 = malli.generator.gen_fmap((function (p1__32880_SHARP_){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,p1__32880_SHARP_], null);
...
return malli.generator.gen_maybe(G__32885);
} else {
return G__32885;
}
});
malli.generator._map_gen = (function malli$generator$_map_gen(schema,options){
return malli.generator.gen_fmap(malli.generator._build_map,malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32886_SHARP_){
return malli.generator._entry_gen(p1__32886_SHARP_,options);
...
return malli.generator.gen_fmap((function (p1__32889_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,p1__32889_SHARP_);
}),malli.generator.gen_vector_distinct_by(schema,malli.generator._min_max(schema,options),(function (p1__32888_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__32888_SHARP_,(0));
}),malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32887_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__32887_SHARP_,options) : malli.generator.generator.call(null,p1__32887_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)))));
});
...
var G__32892 = (function (){var G__32893 = dschema;
var G__32894 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),scalar_ref_gen);
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32893,G__32894) : malli.generator.generator.call(null,G__32893,G__32894));
})();
if(cljs.core.realized_QMARK_(scalar_ref_gen)){
return clojure.test.check.generators.recursive_gen((function (p1__32891_SHARP_){
var G__32895 = dschema;
var G__32896 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),p1__32891_SHARP_);
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32895,G__32896) : malli.generator.generator.call(null,G__32895,G__32896));
}),G__32892);
} else {
return G__32892;
}
...
var output_generator = (function (){var G__32897 = new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(malli.core._function_info(schema));
var G__32898 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32897,G__32898) : malli.generator.generator.call(null,G__32897,G__32898));
})();
...
var G__33049__delegate = function (_){
...
while (G__33059__i < G__33059__a.length) {G__33059__a[G__33059__i] = arguments[G__33059__i + 0]; ++G__33059__i;}
  _ = new cljs.core.IndexedSeq(G__33059__a,0,null);
} 
return G__33049__delegate.call(this,_);};
G__33049.cljs$lang$maxFixedArity = 0;
G__33049.cljs$lang$applyTo = (function (arglist__33060){
var _ = cljs.core.seq(arglist__33060);
return G__33049__delegate(_);
});
...
return clojure.test.check.generators.return$(malli.core._instrument.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"schema","schema",-1582001791),schema,new cljs.core.Keyword(null,"gen","gen",142575302),(function (p1__32899_SHARP_){
return (malli.generator.generate.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generate.cljs$core$IFn$_invoke$arity$2(p1__32899_SHARP_,options) : malli.generator.generate.call(null,p1__32899_SHARP_,options));
})], null),null,options));
});
malli.generator._regex_generator = (function malli$generator$_regex_generator(schema,options){
var G__32900 = (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(schema,options) : malli.generator.generator.call(null,schema,options));
if(cljs.core.not(malli.core._regex_op_QMARK_(schema))){
return malli.generator.gen_tuple((new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[G__32900],null)));
} else {
return G__32900;
}
});
...
return malli.generator.gen_fcat(malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32901_SHARP_){
return malli.generator._re_entry_gen(p1__32901_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options))));
});
malli.generator._alt_gen = (function malli$generator$_alt_gen(schema,options){
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32902_SHARP_){
return malli.generator._re_entry_gen(p1__32902_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
});
...
var child = malli.generator._child(schema,options);
var G__32903 = malli.generator.gen_vector(malli.generator._min_max(schema,options),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__32903);
} else {
return G__32903;
}
});
...
var child = malli.generator._child(schema,options);
var G__32904 = malli.generator.gen_vector(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.max,(1))),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__32904);
} else {
return G__32904;
}
});
malli.generator._repeat_gen = (function malli$generator$_repeat_gen(schema,options){
var or__5025__auto__ = (function (){var G__32905 = malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$2(schema,options);
var G__32905__$1 = (((G__32905 == null))?null:malli.generator._not_unreachable(G__32905));
if((G__32905__$1 == null)){
return null;
} else {
var G__32906 = G__32905__$1;
if(cljs.core.truth_(malli.core._regex_op_QMARK_(malli.generator._child(schema,options)))){
return malli.generator.gen_fcat(G__32906);
} else {
return G__32906;
}
}
...
var G__32907 = cljs.core.name(namespace_unparsed);
var G__32908 = cljs.core.name(k);
return (mk_value_with_ns.cljs$core$IFn$_invoke$arity$2 ? mk_value_with_ns.cljs$core$IFn$_invoke$arity$2(G__32907,G__32908) : mk_value_with_ns.call(null,G__32907,G__32908));
...
})(),cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__32909_SHARP_){
var G__32911 = p1__32909_SHARP_;
if((G__32911 == null)){
return null;
} else {
return G__32911;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__32910_SHARP_){
var G__32912 = p1__32910_SHARP_;
if((G__32912 == null)){
return null;
} else {
return G__32912;
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.generator","default","malli.generator/default",-943988734)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__32913 = cljs.core.get_global_hierarchy;
return (fexpr__32913.cljs$core$IFn$_invoke$arity$0 ? fexpr__32913.cljs$core$IFn$_invoke$arity$0() : fexpr__32913.call(null));
})());
...
return malli.generator.gen_such_that(schema,(function (p1__32926_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__32926_SHARP_,malli.generator._child(schema,options));
...
return malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32936_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__32936_SHARP_,options) : malli.generator.generator.call(null,p1__32936_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
}));
...
var G__32944 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__32945 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32944,G__32945) : malli.generator.generator.call(null,G__32944,G__32945));
}));
...
var G__32947 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__32948 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32947,G__32948) : malli.generator.generator.call(null,G__32947,G__32948));
}));
...
var G__32949 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__32950 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32949,G__32950) : malli.generator.generator.call(null,G__32949,G__32950));
}));
...
var G__32951 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__32952 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32951,G__32952) : malli.generator.generator.call(null,G__32951,G__32952));
}));
...
var G__32953 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__32954 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32953,G__32954) : malli.generator.generator.call(null,G__32953,G__32954));
}));
...
var G__32955 = new cljs.core.Keyword("gen","elements","gen/elements",657813311).cljs$core$IFn$_invoke$arity$1(props);
if((G__32955 == null)){
return null;
} else {
return malli.generator.gen_elements(G__32955);
}
});
...
var G__32956 = new cljs.core.Keyword("gen","schema","gen/schema",-1582038959).cljs$core$IFn$_invoke$arity$1(props);
if((G__32956 == null)){
return null;
} else {
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32956,options) : malli.generator.generator.call(null,G__32956,options));
}
});
...
return malli.core._cached(malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options),new cljs.core.Keyword(null,"generator","generator",-572962281),(function (p1__32958_SHARP_){
return malli.generator._create(p1__32958_SHARP_,options);
}));
}
}));
...
(malli.generator.generate.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__32966){
var map__32967 = p__32966;
var map__32967__$1 = cljs.core.__destructure_map(map__32967);
var options = map__32967__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32967__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__32967__$1,new cljs.core.Keyword(null,"size","size",1098693007),(30));
...
(malli.generator.sample.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__32975){
var map__32976 = p__32975;
var map__32976__$1 = cljs.core.__destructure_map(map__32976);
var options = map__32976__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32976__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__32976__$1,new cljs.core.Keyword(null,"size","size",1098693007),(10));
var gen = ((clojure.test.check.generators.generator_QMARK_(_QMARK_gen_or_schema))?_QMARK_gen_or_schema:malli.generator.generator.cljs$core$IFn$_invoke$arity$2(_QMARK_gen_or_schema,options));
return cljs.core.take.cljs$core$IFn$_invoke$arity$2(size,cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__32968_SHARP_,p2__32969_SHARP_){
return clojure.test.check.rose_tree.root(clojure.test.check.generators.call_gen(gen,p1__32968_SHARP_,p2__32969_SHARP_));
...
(malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_schema,p__32983){
var map__32984 = p__32983;
var map__32984__$1 = cljs.core.__destructure_map(map__32984);
var options = map__32984__$1;
var _EQ__GT_iterations = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__32984__$1,new cljs.core.Keyword("malli.generator","=>iterations","malli.generator/=>iterations",-1726832707),(100));
...
var map__32986 = malli.core._function_info(schema__$1);
var map__32986__$1 = cljs.core.__destructure_map(map__32986);
var input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32986__$1,new cljs.core.Keyword(null,"input","input",556931961));
var output = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32986__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var guard = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32986__$1,new cljs.core.Keyword(null,"guard","guard",-873147811));
...
if(cljs.core.truth_(and__5023__auto__)){
var G__32990 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [args,$], null);
return (valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1 ? valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1(G__32990) : valid_guard_QMARK_.call(null,G__32990));
} else {
return and__5023__auto__;
}
});
return (function (f){
var map__32995 = clojure.test.check.quick_check(_EQ__GT_iterations,clojure.test.check.properties.for_all_STAR_(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [input_generator], null),(function (p1__32978_SHARP_){
return validate(f,p1__32978_SHARP_);
})));
var map__32995__$1 = cljs.core.__destructure_map(map__32995);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32995__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var shrunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32995__$1,new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412));
...
var vec__32998 = (cljs.core.truth_(explain_input)?null:_try((function (){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,smallest);
})));
var result__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32998,(0),null);
var success = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32998,(1),null);
...
var G__33001 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(shrunk,new cljs.core.Keyword("malli.core","result","malli.core/result",1538632379),result__$1);
var G__33001__$1 = (cljs.core.truth_(explain_input)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33001,new cljs.core.Keyword("malli.core","explain-input","malli.core/explain-input",1441627811),explain_input):G__33001);
var G__33001__$2 = (cljs.core.truth_(explain_output)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33001__$1,new cljs.core.Keyword("malli.core","explain-output","malli.core/explain-output",-124321573),explain_output):G__33001__$1);
var G__33001__$3 = (cljs.core.truth_(explain_guard)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33001__$2,new cljs.core.Keyword("malli.core","explain-guard","malli.core/explain-guard",-1119572847),explain_guard):G__33001__$2);
if(cljs.core.truth_(cljs.core.ex_message(result__$1))){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__33001__$3,new cljs.core.Keyword(null,"result","result",1415092211),cljs.core.ex_message),new cljs.core.Keyword(null,"result-data","result-data",-1724248844));
} else {
return G__33001__$3;
}
}
...
var checkers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32979_SHARP_){
return malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2(p1__32979_SHARP_,options);
}),malli.core._function_schema_arities(schema));
return (function (x){
return cljs.core.seq(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__32980_SHARP_){
return (p1__32980_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__32980_SHARP_.cljs$core$IFn$_invoke$arity$1(x) : p1__32980_SHARP_.call(null,x));
}),checkers));
});
} else {
...
var schema = malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options);
return malli.core.explain.cljs$core$IFn$_invoke$arity$2(malli.core._update_options(schema,(function (p1__33003_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__33003_SHARP_,new cljs.core.Keyword("malli.core","function-checker","malli.core/function-checker",-792030936),malli.generator.function_checker);
})),f);
}));
