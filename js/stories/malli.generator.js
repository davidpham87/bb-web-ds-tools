...
var malli$generator$Generator$_generator$dyn_33181 = (function (this$,options){
...
return malli$generator$Generator$_generator$dyn_33181(this$,options);
}
});
...
var G__32754 = malli.generator._child(schema,options);
var G__32755 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32754,G__32755) : malli.generator.generator.call(null,G__32754,G__32755));
});
/**
 * Return a generator of no values that is compatible with -unreachable-gen?.
 */
malli.generator._never_gen = (function malli$generator$_never_gen(p__32756){
var map__32757 = p__32756;
var map__32757__$1 = cljs.core.__destructure_map(map__32757);
var _options = map__32757__$1;
var original_generator_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32757__$1,new cljs.core.Keyword("malli.generator","original-generator-schema","malli.generator/original-generator-schema",-1122475395));
return cljs.core.with_meta(clojure.test.check.generators.sized((function (_){
return malli.core._fail_BANG_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("malli.generator","unsatisfiable-schema","malli.generator/unsatisfiable-schema",919209538),(function (){var G__32758 = cljs.core.PersistentArrayMap.EMPTY;
if(cljs.core.truth_(original_generator_schema)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32758,new cljs.core.Keyword(null,"schema","schema",-1582001791),original_generator_schema);
} else {
return G__32758;
}
})());
...
var map__32779 = malli.core.properties.cljs$core$IFn$_invoke$arity$2(schema,options);
var map__32779__$1 = cljs.core.__destructure_map(map__32779);
var gen_min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32779__$1,new cljs.core.Keyword("gen","min","gen/min",444569458));
var gen_max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32779__$1,new cljs.core.Keyword("gen","max","gen/max",61264228));
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32779__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32779__$1,new cljs.core.Keyword(null,"max","max",61366548));
...
var map__32793 = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
var map__32793__$1 = cljs.core.__destructure_map(map__32793);
var infinite_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32793__$1,new cljs.core.Keyword("gen","infinite?","gen/infinite?",-2017652832));
var NaN_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32793__$1,new cljs.core.Keyword("gen","NaN?","gen/NaN?",-1917993267));
...
return malli.generator.gen_fmap((function (p1__32795_SHARP_){
...
return clojure.test.check.generators.double_STAR_(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$2(malli.generator.double_default,opts),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__32801_SHARP_){
var G__32803 = p1__32801_SHARP_;
if((G__32803 == null)){
return null;
} else {
return G__32803;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__32802_SHARP_){
var G__32804 = p1__32802_SHARP_;
if((G__32804 == null)){
return null;
} else {
return G__32804;
...
malli.generator.gen_vector = (function malli$generator$gen_vector(p__32806,g){
var map__32807 = p__32806;
var map__32807__$1 = cljs.core.__destructure_map(map__32807);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32807__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32807__$1,new cljs.core.Keyword(null,"max","max",61366548));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(clojure.test.check.generators.sized((function (p1__32805_SHARP_){
return clojure.test.check.generators.vector.cljs$core$IFn$_invoke$arity$3(g,min,(min + p1__32805_SHARP_));
...
malli.generator.gen_vector_distinct_by = (function malli$generator$gen_vector_distinct_by(schema,p__32810,f,g){
var map__32811 = p__32810;
var map__32811__$1 = cljs.core.__destructure_map(map__32811);
var m = map__32811__$1;
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32811__$1,new cljs.core.Keyword(null,"min","min",444991522));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
})())?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"num-elements","num-elements",1960422107),min], null):clojure.set.rename_keys(m,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"min","min",444991522),new cljs.core.Keyword(null,"min-elements","min-elements",949370780),new cljs.core.Keyword(null,"max","max",61366548),new cljs.core.Keyword(null,"max-elements","max-elements",433034073)], null))),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__32809_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","distinct-generator-failure","malli.generator/distinct-generator-failure",-2085139904),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__32809_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null)));
}
});
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__32814_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","such-that-failure","malli.generator/such-that-failure",599634585),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__32814_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null);
});
...
var map__32821 = malli.generator._min_max(schema,options);
var map__32821__$1 = cljs.core.__destructure_map(map__32821);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32821__$1,new cljs.core.Keyword(null,"min","min",444991522));
var el = malli.generator._child(schema,options);
return malli.generator.gen_one_of(options,(function (){var G__32822 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$3((function (){var G__32823 = cljs.core.PersistentVector.EMPTY;
if((((min == null)) || ((min === (0))))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__32823,malli.generator.nil_gen);
} else {
return G__32823;
}
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__32816_SHARP_){
return malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$3(schema,p1__32816_SHARP_,options);
})),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.identity,cljs.core.vec,cljs.core.eduction,(function (p1__32817_SHARP_){
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(p1__32817_SHARP_);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__32822,(function (){var vec__32830 = malli.core.children.cljs$core$IFn$_invoke$arity$1(el);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32830,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32830,(1),null);
var G__32833 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map-of","map-of",1189682355),(function (){var or__5025__auto__ = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
...
var G__32834 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32833,G__32834) : malli.generator.generator.call(null,G__32833,G__32834));
})());
} else {
return G__32822;
}
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32838_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__32838_SHARP_,options) : malli.generator.generator.call(null,p1__32838_SHARP_,options));
...
return malli.util.transform_entries.cljs$core$IFn$_invoke$arity$3(G__32851,(function (p1__32840_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__32854){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__32858,(2),malli.util.merge,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dispatch,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"=","=",1152933628),null,k], null)], null)], null));
} else {
return G__32858;
}
}),p1__32840_SHARP_);
...
var G__32863 = cljs.core.last(p1__32860_SHARP_);
...
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__32874){
var vec__32875 = p__32874;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32875,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32875,(1),null);
...
malli.generator._entry_gen = (function malli$generator$_entry_gen(p__32883,options){
var vec__32884 = p__32883;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32884,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32884,(1),null);
var G__32887 = malli.generator.gen_fmap((function (p1__32881_SHARP_){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,p1__32881_SHARP_], null);
...
return malli.generator.gen_maybe(G__32887);
} else {
return G__32887;
}
});
malli.generator._map_gen = (function malli$generator$_map_gen(schema,options){
return malli.generator.gen_fmap(malli.generator._build_map,malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32897_SHARP_){
return malli.generator._entry_gen(p1__32897_SHARP_,options);
...
return malli.generator.gen_fmap((function (p1__32903_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,p1__32903_SHARP_);
}),malli.generator.gen_vector_distinct_by(schema,malli.generator._min_max(schema,options),(function (p1__32902_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__32902_SHARP_,(0));
}),malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32901_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__32901_SHARP_,options) : malli.generator.generator.call(null,p1__32901_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)))));
});
...
var G__32934 = (function (){var G__32935 = dschema;
var G__32936 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),scalar_ref_gen);
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32935,G__32936) : malli.generator.generator.call(null,G__32935,G__32936));
})();
if(cljs.core.realized_QMARK_(scalar_ref_gen)){
return clojure.test.check.generators.recursive_gen((function (p1__32925_SHARP_){
var G__32938 = dschema;
var G__32939 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),p1__32925_SHARP_);
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32938,G__32939) : malli.generator.generator.call(null,G__32938,G__32939));
}),G__32934);
} else {
return G__32934;
}
...
var output_generator = (function (){var G__32946 = new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(malli.core._function_info(schema));
...
var G__33211__delegate = function (_){
...
while (G__33212__i < G__33212__a.length) {G__33212__a[G__33212__i] = arguments[G__33212__i + 0]; ++G__33212__i;}
  _ = new cljs.core.IndexedSeq(G__33212__a,0,null);
} 
return G__33211__delegate.call(this,_);};
G__33211.cljs$lang$maxFixedArity = 0;
G__33211.cljs$lang$applyTo = (function (arglist__33213){
var _ = cljs.core.seq(arglist__33213);
return G__33211__delegate(_);
});
...
return clojure.test.check.generators.return$(malli.core._instrument.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"schema","schema",-1582001791),schema,new cljs.core.Keyword(null,"gen","gen",142575302),(function (p1__32960_SHARP_){
return (malli.generator.generate.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generate.cljs$core$IFn$_invoke$arity$2(p1__32960_SHARP_,options) : malli.generator.generate.call(null,p1__32960_SHARP_,options));
})], null),null,options));
});
malli.generator._regex_generator = (function malli$generator$_regex_generator(schema,options){
var G__32965 = (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(schema,options) : malli.generator.generator.call(null,schema,options));
if(cljs.core.not(malli.core._regex_op_QMARK_(schema))){
return malli.generator.gen_tuple((new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[G__32965],null)));
} else {
return G__32965;
}
});
...
return malli.generator.gen_fcat(malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32967_SHARP_){
return malli.generator._re_entry_gen(p1__32967_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options))));
});
malli.generator._alt_gen = (function malli$generator$_alt_gen(schema,options){
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32969_SHARP_){
return malli.generator._re_entry_gen(p1__32969_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
});
...
var child = malli.generator._child(schema,options);
var G__32975 = malli.generator.gen_vector(malli.generator._min_max(schema,options),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__32975);
} else {
return G__32975;
}
});
...
var child = malli.generator._child(schema,options);
var G__32978 = malli.generator.gen_vector(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.max,(1))),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__32978);
} else {
return G__32978;
}
});
malli.generator._repeat_gen = (function malli$generator$_repeat_gen(schema,options){
var or__5025__auto__ = (function (){var G__32979 = malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$2(schema,options);
var G__32979__$1 = (((G__32979 == null))?null:malli.generator._not_unreachable(G__32979));
if((G__32979__$1 == null)){
return null;
} else {
var G__32980 = G__32979__$1;
if(cljs.core.truth_(malli.core._regex_op_QMARK_(malli.generator._child(schema,options)))){
return malli.generator.gen_fcat(G__32980);
} else {
return G__32980;
}
}
...
var G__33001 = cljs.core.name(namespace_unparsed);
var G__33002 = cljs.core.name(k);
return (mk_value_with_ns.cljs$core$IFn$_invoke$arity$2 ? mk_value_with_ns.cljs$core$IFn$_invoke$arity$2(G__33001,G__33002) : mk_value_with_ns.call(null,G__33001,G__33002));
...
})(),cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__33007_SHARP_){
var G__33010 = p1__33007_SHARP_;
if((G__33010 == null)){
return null;
} else {
return G__33010;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__33008_SHARP_){
var G__33011 = p1__33008_SHARP_;
if((G__33011 == null)){
return null;
} else {
return G__33011;
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.generator","default","malli.generator/default",-943988734)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__33012 = cljs.core.get_global_hierarchy;
return (fexpr__33012.cljs$core$IFn$_invoke$arity$0 ? fexpr__33012.cljs$core$IFn$_invoke$arity$0() : fexpr__33012.call(null));
})());
...
return malli.generator.gen_such_that(schema,(function (p1__33014_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__33014_SHARP_,malli.generator._child(schema,options));
...
return malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33063_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__33063_SHARP_,options) : malli.generator.generator.call(null,p1__33063_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
}));
...
var G__33093 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__33094 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__33093,G__33094) : malli.generator.generator.call(null,G__33093,G__33094));
}));
...
var G__33095 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__33096 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__33095,G__33096) : malli.generator.generator.call(null,G__33095,G__33096));
}));
...
var G__33097 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__33098 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__33097,G__33098) : malli.generator.generator.call(null,G__33097,G__33098));
}));
...
var G__33099 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__33100 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__33099,G__33100) : malli.generator.generator.call(null,G__33099,G__33100));
}));
...
var G__33101 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__33102 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__33101,G__33102) : malli.generator.generator.call(null,G__33101,G__33102));
}));
...
var G__33105 = new cljs.core.Keyword("gen","elements","gen/elements",657813311).cljs$core$IFn$_invoke$arity$1(props);
if((G__33105 == null)){
return null;
} else {
return malli.generator.gen_elements(G__33105);
}
});
...
var G__33106 = new cljs.core.Keyword("gen","schema","gen/schema",-1582038959).cljs$core$IFn$_invoke$arity$1(props);
if((G__33106 == null)){
return null;
} else {
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__33106,options) : malli.generator.generator.call(null,G__33106,options));
}
});
...
(malli.generator.generate.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__33122){
var map__33123 = p__33122;
var map__33123__$1 = cljs.core.__destructure_map(map__33123);
var options = map__33123__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33123__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__33123__$1,new cljs.core.Keyword(null,"size","size",1098693007),(30));
...
(malli.generator.sample.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__33128){
var map__33129 = p__33128;
var map__33129__$1 = cljs.core.__destructure_map(map__33129);
var options = map__33129__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33129__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__33129__$1,new cljs.core.Keyword(null,"size","size",1098693007),(10));
var gen = ((clojure.test.check.generators.generator_QMARK_(_QMARK_gen_or_schema))?_QMARK_gen_or_schema:malli.generator.generator.cljs$core$IFn$_invoke$arity$2(_QMARK_gen_or_schema,options));
return cljs.core.take.cljs$core$IFn$_invoke$arity$2(size,cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__33124_SHARP_,p2__33125_SHARP_){
return clojure.test.check.rose_tree.root(clojure.test.check.generators.call_gen(gen,p1__33124_SHARP_,p2__33125_SHARP_));
...
(malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_schema,p__33140){
var map__33147 = p__33140;
var map__33147__$1 = cljs.core.__destructure_map(map__33147);
var options = map__33147__$1;
var _EQ__GT_iterations = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__33147__$1,new cljs.core.Keyword("malli.generator","=>iterations","malli.generator/=>iterations",-1726832707),(100));
...
var map__33149 = malli.core._function_info(schema__$1);
var map__33149__$1 = cljs.core.__destructure_map(map__33149);
var input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33149__$1,new cljs.core.Keyword(null,"input","input",556931961));
var output = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33149__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var guard = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33149__$1,new cljs.core.Keyword(null,"guard","guard",-873147811));
...
if(cljs.core.truth_(and__5023__auto__)){
var G__33150 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [args,$], null);
return (valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1 ? valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1(G__33150) : valid_guard_QMARK_.call(null,G__33150));
} else {
return and__5023__auto__;
}
});
return (function (f){
var map__33151 = clojure.test.check.quick_check(_EQ__GT_iterations,clojure.test.check.properties.for_all_STAR_(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [input_generator], null),(function (p1__33135_SHARP_){
return validate(f,p1__33135_SHARP_);
})));
var map__33151__$1 = cljs.core.__destructure_map(map__33151);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33151__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var shrunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33151__$1,new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412));
...
var vec__33153 = (cljs.core.truth_(explain_input)?null:_try((function (){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,smallest);
})));
var result__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33153,(0),null);
var success = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33153,(1),null);
...
var G__33156 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(shrunk,new cljs.core.Keyword("malli.core","result","malli.core/result",1538632379),result__$1);
var G__33156__$1 = (cljs.core.truth_(explain_input)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33156,new cljs.core.Keyword("malli.core","explain-input","malli.core/explain-input",1441627811),explain_input):G__33156);
var G__33156__$2 = (cljs.core.truth_(explain_output)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33156__$1,new cljs.core.Keyword("malli.core","explain-output","malli.core/explain-output",-124321573),explain_output):G__33156__$1);
var G__33156__$3 = (cljs.core.truth_(explain_guard)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33156__$2,new cljs.core.Keyword("malli.core","explain-guard","malli.core/explain-guard",-1119572847),explain_guard):G__33156__$2);
if(cljs.core.truth_(cljs.core.ex_message(result__$1))){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__33156__$3,new cljs.core.Keyword(null,"result","result",1415092211),cljs.core.ex_message),new cljs.core.Keyword(null,"result-data","result-data",-1724248844));
} else {
return G__33156__$3;
}
}
...
var checkers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33136_SHARP_){
return malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2(p1__33136_SHARP_,options);
}),malli.core._function_schema_arities(schema));
return (function (x){
return cljs.core.seq(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__33137_SHARP_){
return (p1__33137_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__33137_SHARP_.cljs$core$IFn$_invoke$arity$1(x) : p1__33137_SHARP_.call(null,x));
}),checkers));
});
} else {
...
var schema = malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options);
return malli.core.explain.cljs$core$IFn$_invoke$arity$2(malli.core._update_options(schema,(function (p1__33165_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__33165_SHARP_,new cljs.core.Keyword("malli.core","function-checker","malli.core/function-checker",-792030936),malli.generator.function_checker);
})),f);
}));
