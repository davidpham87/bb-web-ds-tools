...
var malli$generator$Generator$_generator$dyn_33212 = (function (this$,options){
...
return malli$generator$Generator$_generator$dyn_33212(this$,options);
}
});
...
var G__32914 = malli.generator._child(schema,options);
var G__32915 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32914,G__32915) : malli.generator.generator.call(null,G__32914,G__32915));
});
/**
 * Return a generator of no values that is compatible with -unreachable-gen?.
 */
malli.generator._never_gen = (function malli$generator$_never_gen(p__32916){
var map__32918 = p__32916;
var map__32918__$1 = cljs.core.__destructure_map(map__32918);
var _options = map__32918__$1;
var original_generator_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32918__$1,new cljs.core.Keyword("malli.generator","original-generator-schema","malli.generator/original-generator-schema",-1122475395));
return cljs.core.with_meta(clojure.test.check.generators.sized((function (_){
return malli.core._fail_BANG_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("malli.generator","unsatisfiable-schema","malli.generator/unsatisfiable-schema",919209538),(function (){var G__32921 = cljs.core.PersistentArrayMap.EMPTY;
if(cljs.core.truth_(original_generator_schema)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32921,new cljs.core.Keyword(null,"schema","schema",-1582001791),original_generator_schema);
} else {
return G__32921;
}
})());
...
var map__32933 = malli.core.properties.cljs$core$IFn$_invoke$arity$2(schema,options);
var map__32933__$1 = cljs.core.__destructure_map(map__32933);
var gen_min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32933__$1,new cljs.core.Keyword("gen","min","gen/min",444569458));
var gen_max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32933__$1,new cljs.core.Keyword("gen","max","gen/max",61264228));
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32933__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32933__$1,new cljs.core.Keyword(null,"max","max",61366548));
...
var map__32942 = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
var map__32942__$1 = cljs.core.__destructure_map(map__32942);
var infinite_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32942__$1,new cljs.core.Keyword("gen","infinite?","gen/infinite?",-2017652832));
var NaN_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32942__$1,new cljs.core.Keyword("gen","NaN?","gen/NaN?",-1917993267));
...
return malli.generator.gen_fmap((function (p1__32952_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,p1__32952_SHARP_);
}),gen);
});
...
return clojure.test.check.generators.double_STAR_(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$2(malli.generator.double_default,opts),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__32953_SHARP_){
var G__32960 = p1__32953_SHARP_;
if((G__32960 == null)){
return null;
} else {
return G__32960;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__32954_SHARP_){
var G__32962 = p1__32954_SHARP_;
if((G__32962 == null)){
return null;
} else {
return G__32962;
...
malli.generator.gen_vector = (function malli$generator$gen_vector(p__32964,g){
var map__32967 = p__32964;
var map__32967__$1 = cljs.core.__destructure_map(map__32967);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32967__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32967__$1,new cljs.core.Keyword(null,"max","max",61366548));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(clojure.test.check.generators.sized((function (p1__32963_SHARP_){
return clojure.test.check.generators.vector.cljs$core$IFn$_invoke$arity$3(g,min,(min + p1__32963_SHARP_));
...
malli.generator.gen_vector_distinct_by = (function malli$generator$gen_vector_distinct_by(schema,p__32970,f,g){
var map__32971 = p__32970;
var map__32971__$1 = cljs.core.__destructure_map(map__32971);
var m = map__32971__$1;
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32971__$1,new cljs.core.Keyword(null,"min","min",444991522));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
})())?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"num-elements","num-elements",1960422107),min], null):clojure.set.rename_keys(m,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"min","min",444991522),new cljs.core.Keyword(null,"min-elements","min-elements",949370780),new cljs.core.Keyword(null,"max","max",61366548),new cljs.core.Keyword(null,"max-elements","max-elements",433034073)], null))),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__32969_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","distinct-generator-failure","malli.generator/distinct-generator-failure",-2085139904),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__32969_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null)));
}
});
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__32974_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","such-that-failure","malli.generator/such-that-failure",599634585),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__32974_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null);
});
...
var map__32977 = malli.generator._min_max(schema,options);
var map__32977__$1 = cljs.core.__destructure_map(map__32977);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32977__$1,new cljs.core.Keyword(null,"min","min",444991522));
var el = malli.generator._child(schema,options);
return malli.generator.gen_one_of(options,(function (){var G__32978 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$3((function (){var G__32979 = cljs.core.PersistentVector.EMPTY;
if((((min == null)) || ((min === (0))))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__32979,malli.generator.nil_gen);
} else {
return G__32979;
}
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__32975_SHARP_){
return malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$3(schema,p1__32975_SHARP_,options);
})),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.identity,cljs.core.vec,cljs.core.eduction,(function (p1__32976_SHARP_){
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(p1__32976_SHARP_);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__32978,(function (){var vec__32980 = malli.core.children.cljs$core$IFn$_invoke$arity$1(el);
...
var G__32983 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map-of","map-of",1189682355),(function (){var or__5025__auto__ = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
...
var G__32984 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32983,G__32984) : malli.generator.generator.call(null,G__32983,G__32984));
})());
} else {
return G__32978;
}
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32985_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__32985_SHARP_,options) : malli.generator.generator.call(null,p1__32985_SHARP_,options));
...
return malli.util.transform_entries.cljs$core$IFn$_invoke$arity$3(G__32987,(function (p1__32986_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__32988){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__32992,(2),malli.util.merge,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dispatch,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"=","=",1152933628),null,k], null)], null)], null));
} else {
return G__32992;
}
}),p1__32986_SHARP_);
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32993_SHARP_){
var G__32994 = cljs.core.last(p1__32993_SHARP_);
...
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__32996){
...
malli.generator._entry_gen = (function malli$generator$_entry_gen(p__33001,options){
var vec__33002 = p__33001;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33002,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33002,(1),null);
var G__33005 = malli.generator.gen_fmap((function (p1__33000_SHARP_){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,p1__33000_SHARP_], null);
...
return malli.generator.gen_maybe(G__33005);
} else {
return G__33005;
}
});
malli.generator._map_gen = (function malli$generator$_map_gen(schema,options){
return malli.generator.gen_fmap(malli.generator._build_map,malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33006_SHARP_){
return malli.generator._entry_gen(p1__33006_SHARP_,options);
...
return malli.generator.gen_fmap((function (p1__33009_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,p1__33009_SHARP_);
}),malli.generator.gen_vector_distinct_by(schema,malli.generator._min_max(schema,options),(function (p1__33008_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__33008_SHARP_,(0));
}),malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33007_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__33007_SHARP_,options) : malli.generator.generator.call(null,p1__33007_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)))));
});
...
var G__33013 = (function (){var G__33014 = dschema;
var G__33015 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),scalar_ref_gen);
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__33014,G__33015) : malli.generator.generator.call(null,G__33014,G__33015));
})();
if(cljs.core.realized_QMARK_(scalar_ref_gen)){
return clojure.test.check.generators.recursive_gen((function (p1__33010_SHARP_){
var G__33016 = dschema;
var G__33017 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),p1__33010_SHARP_);
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__33016,G__33017) : malli.generator.generator.call(null,G__33016,G__33017));
}),G__33013);
} else {
return G__33013;
}
...
var output_generator = (function (){var G__33018 = new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(malli.core._function_info(schema));
...
var G__33243__delegate = function (_){
...
while (G__33244__i < G__33244__a.length) {G__33244__a[G__33244__i] = arguments[G__33244__i + 0]; ++G__33244__i;}
  _ = new cljs.core.IndexedSeq(G__33244__a,0,null);
} 
return G__33243__delegate.call(this,_);};
G__33243.cljs$lang$maxFixedArity = 0;
G__33243.cljs$lang$applyTo = (function (arglist__33245){
var _ = cljs.core.seq(arglist__33245);
return G__33243__delegate(_);
});
...
return clojure.test.check.generators.return$(malli.core._instrument.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"schema","schema",-1582001791),schema,new cljs.core.Keyword(null,"gen","gen",142575302),(function (p1__33025_SHARP_){
return (malli.generator.generate.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generate.cljs$core$IFn$_invoke$arity$2(p1__33025_SHARP_,options) : malli.generator.generate.call(null,p1__33025_SHARP_,options));
})], null),null,options));
});
malli.generator._regex_generator = (function malli$generator$_regex_generator(schema,options){
var G__33028 = (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(schema,options) : malli.generator.generator.call(null,schema,options));
if(cljs.core.not(malli.core._regex_op_QMARK_(schema))){
return malli.generator.gen_tuple((new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[G__33028],null)));
} else {
return G__33028;
}
});
...
return malli.generator.gen_fcat(malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33031_SHARP_){
return malli.generator._re_entry_gen(p1__33031_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options))));
});
malli.generator._alt_gen = (function malli$generator$_alt_gen(schema,options){
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33033_SHARP_){
return malli.generator._re_entry_gen(p1__33033_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
});
...
var child = malli.generator._child(schema,options);
var G__33034 = malli.generator.gen_vector(malli.generator._min_max(schema,options),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__33034);
} else {
return G__33034;
}
});
...
var child = malli.generator._child(schema,options);
var G__33035 = malli.generator.gen_vector(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.max,(1))),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__33035);
} else {
return G__33035;
}
});
malli.generator._repeat_gen = (function malli$generator$_repeat_gen(schema,options){
var or__5025__auto__ = (function (){var G__33036 = malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$2(schema,options);
var G__33036__$1 = (((G__33036 == null))?null:malli.generator._not_unreachable(G__33036));
if((G__33036__$1 == null)){
return null;
} else {
var G__33037 = G__33036__$1;
if(cljs.core.truth_(malli.core._regex_op_QMARK_(malli.generator._child(schema,options)))){
return malli.generator.gen_fcat(G__33037);
} else {
return G__33037;
}
}
...
var G__33039 = cljs.core.name(namespace_unparsed);
var G__33040 = cljs.core.name(k);
return (mk_value_with_ns.cljs$core$IFn$_invoke$arity$2 ? mk_value_with_ns.cljs$core$IFn$_invoke$arity$2(G__33039,G__33040) : mk_value_with_ns.call(null,G__33039,G__33040));
...
})(),cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__33045_SHARP_){
var G__33050 = p1__33045_SHARP_;
if((G__33050 == null)){
return null;
} else {
return G__33050;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__33046_SHARP_){
var G__33051 = p1__33046_SHARP_;
if((G__33051 == null)){
return null;
} else {
return G__33051;
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.generator","default","malli.generator/default",-943988734)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__33055 = cljs.core.get_global_hierarchy;
return (fexpr__33055.cljs$core$IFn$_invoke$arity$0 ? fexpr__33055.cljs$core$IFn$_invoke$arity$0() : fexpr__33055.call(null));
})());
...
return malli.generator.gen_such_that(schema,(function (p1__33058_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__33058_SHARP_,malli.generator._child(schema,options));
...
return malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33075_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__33075_SHARP_,options) : malli.generator.generator.call(null,p1__33075_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
}));
...
var G__33084 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__33085 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__33084,G__33085) : malli.generator.generator.call(null,G__33084,G__33085));
}));
...
var G__33086 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__33087 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__33086,G__33087) : malli.generator.generator.call(null,G__33086,G__33087));
}));
...
var G__33088 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__33089 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__33088,G__33089) : malli.generator.generator.call(null,G__33088,G__33089));
}));
...
var G__33090 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__33091 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__33090,G__33091) : malli.generator.generator.call(null,G__33090,G__33091));
}));
...
var G__33092 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__33093 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__33092,G__33093) : malli.generator.generator.call(null,G__33092,G__33093));
}));
...
var G__33101 = new cljs.core.Keyword("gen","elements","gen/elements",657813311).cljs$core$IFn$_invoke$arity$1(props);
if((G__33101 == null)){
return null;
} else {
return malli.generator.gen_elements(G__33101);
}
});
...
var G__33102 = new cljs.core.Keyword("gen","schema","gen/schema",-1582038959).cljs$core$IFn$_invoke$arity$1(props);
if((G__33102 == null)){
return null;
} else {
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__33102,options) : malli.generator.generator.call(null,G__33102,options));
}
});
...
return malli.core._cached(malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options),new cljs.core.Keyword(null,"generator","generator",-572962281),(function (p1__33114_SHARP_){
return malli.generator._create(p1__33114_SHARP_,options);
}));
}
}));
...
(malli.generator.generate.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__33135){
var map__33137 = p__33135;
var map__33137__$1 = cljs.core.__destructure_map(map__33137);
var options = map__33137__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33137__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__33137__$1,new cljs.core.Keyword(null,"size","size",1098693007),(30));
...
(malli.generator.sample.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__33159){
var map__33160 = p__33159;
var map__33160__$1 = cljs.core.__destructure_map(map__33160);
var options = map__33160__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33160__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__33160__$1,new cljs.core.Keyword(null,"size","size",1098693007),(10));
var gen = ((clojure.test.check.generators.generator_QMARK_(_QMARK_gen_or_schema))?_QMARK_gen_or_schema:malli.generator.generator.cljs$core$IFn$_invoke$arity$2(_QMARK_gen_or_schema,options));
return cljs.core.take.cljs$core$IFn$_invoke$arity$2(size,cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__33142_SHARP_,p2__33143_SHARP_){
return clojure.test.check.rose_tree.root(clojure.test.check.generators.call_gen(gen,p1__33142_SHARP_,p2__33143_SHARP_));
...
(malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_schema,p__33166){
var map__33167 = p__33166;
var map__33167__$1 = cljs.core.__destructure_map(map__33167);
var options = map__33167__$1;
var _EQ__GT_iterations = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__33167__$1,new cljs.core.Keyword("malli.generator","=>iterations","malli.generator/=>iterations",-1726832707),(100));
...
var map__33173 = malli.core._function_info(schema__$1);
var map__33173__$1 = cljs.core.__destructure_map(map__33173);
var input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33173__$1,new cljs.core.Keyword(null,"input","input",556931961));
var output = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33173__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var guard = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33173__$1,new cljs.core.Keyword(null,"guard","guard",-873147811));
...
if(cljs.core.truth_(and__5023__auto__)){
var G__33179 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [args,$], null);
return (valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1 ? valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1(G__33179) : valid_guard_QMARK_.call(null,G__33179));
} else {
return and__5023__auto__;
}
});
return (function (f){
var map__33180 = clojure.test.check.quick_check(_EQ__GT_iterations,clojure.test.check.properties.for_all_STAR_(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [input_generator], null),(function (p1__33161_SHARP_){
return validate(f,p1__33161_SHARP_);
})));
var map__33180__$1 = cljs.core.__destructure_map(map__33180);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33180__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var shrunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33180__$1,new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412));
...
var vec__33183 = (cljs.core.truth_(explain_input)?null:_try((function (){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,smallest);
})));
var result__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33183,(0),null);
var success = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33183,(1),null);
...
var G__33189 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(shrunk,new cljs.core.Keyword("malli.core","result","malli.core/result",1538632379),result__$1);
var G__33189__$1 = (cljs.core.truth_(explain_input)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33189,new cljs.core.Keyword("malli.core","explain-input","malli.core/explain-input",1441627811),explain_input):G__33189);
var G__33189__$2 = (cljs.core.truth_(explain_output)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33189__$1,new cljs.core.Keyword("malli.core","explain-output","malli.core/explain-output",-124321573),explain_output):G__33189__$1);
var G__33189__$3 = (cljs.core.truth_(explain_guard)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33189__$2,new cljs.core.Keyword("malli.core","explain-guard","malli.core/explain-guard",-1119572847),explain_guard):G__33189__$2);
if(cljs.core.truth_(cljs.core.ex_message(result__$1))){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__33189__$3,new cljs.core.Keyword(null,"result","result",1415092211),cljs.core.ex_message),new cljs.core.Keyword(null,"result-data","result-data",-1724248844));
} else {
return G__33189__$3;
}
}
...
var checkers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33162_SHARP_){
return malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2(p1__33162_SHARP_,options);
}),malli.core._function_schema_arities(schema));
return (function (x){
return cljs.core.seq(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__33163_SHARP_){
return (p1__33163_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__33163_SHARP_.cljs$core$IFn$_invoke$arity$1(x) : p1__33163_SHARP_.call(null,x));
}),checkers));
});
} else {
...
var schema = malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options);
return malli.core.explain.cljs$core$IFn$_invoke$arity$2(malli.core._update_options(schema,(function (p1__33197_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__33197_SHARP_,new cljs.core.Keyword("malli.core","function-checker","malli.core/function-checker",-792030936),malli.generator.function_checker);
})),f);
}));
