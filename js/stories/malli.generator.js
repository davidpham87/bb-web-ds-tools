...
var malli$generator$Generator$_generator$dyn_33128 = (function (this$,options){
...
return malli$generator$Generator$_generator$dyn_33128(this$,options);
}
});
...
var G__32715 = malli.generator._child(schema,options);
var G__32716 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32715,G__32716) : malli.generator.generator.call(null,G__32715,G__32716));
});
/**
...
var map__32754 = malli.core.properties.cljs$core$IFn$_invoke$arity$2(schema,options);
var map__32754__$1 = cljs.core.__destructure_map(map__32754);
var gen_min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32754__$1,new cljs.core.Keyword("gen","min","gen/min",444569458));
var gen_max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32754__$1,new cljs.core.Keyword("gen","max","gen/max",61264228));
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32754__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32754__$1,new cljs.core.Keyword(null,"max","max",61366548));
...
var map__32757 = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
var map__32757__$1 = cljs.core.__destructure_map(map__32757);
var infinite_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32757__$1,new cljs.core.Keyword("gen","infinite?","gen/infinite?",-2017652832));
var NaN_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32757__$1,new cljs.core.Keyword("gen","NaN?","gen/NaN?",-1917993267));
...
return malli.generator.gen_fmap((function (p1__32760_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,p1__32760_SHARP_);
}),gen);
});
...
return clojure.test.check.generators.double_STAR_(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$2(malli.generator.double_default,opts),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__32767_SHARP_){
var G__32769 = p1__32767_SHARP_;
if((G__32769 == null)){
return null;
} else {
return G__32769;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__32768_SHARP_){
var G__32770 = p1__32768_SHARP_;
if((G__32770 == null)){
return null;
} else {
return G__32770;
...
malli.generator.gen_vector = (function malli$generator$gen_vector(p__32773,g){
var map__32775 = p__32773;
var map__32775__$1 = cljs.core.__destructure_map(map__32775);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32775__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32775__$1,new cljs.core.Keyword(null,"max","max",61366548));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(clojure.test.check.generators.sized((function (p1__32772_SHARP_){
return clojure.test.check.generators.vector.cljs$core$IFn$_invoke$arity$3(g,min,(min + p1__32772_SHARP_));
...
malli.generator.gen_vector_distinct_by = (function malli$generator$gen_vector_distinct_by(schema,p__32779,f,g){
var map__32780 = p__32779;
var map__32780__$1 = cljs.core.__destructure_map(map__32780);
var m = map__32780__$1;
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32780__$1,new cljs.core.Keyword(null,"min","min",444991522));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
})())?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"num-elements","num-elements",1960422107),min], null):clojure.set.rename_keys(m,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"min","min",444991522),new cljs.core.Keyword(null,"min-elements","min-elements",949370780),new cljs.core.Keyword(null,"max","max",61366548),new cljs.core.Keyword(null,"max-elements","max-elements",433034073)], null))),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__32777_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","distinct-generator-failure","malli.generator/distinct-generator-failure",-2085139904),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__32777_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null)));
}
});
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__32790_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","such-that-failure","malli.generator/such-that-failure",599634585),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__32790_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null);
});
...
var map__32802 = malli.generator._min_max(schema,options);
...
return malli.generator.gen_one_of(options,(function (){var G__32803 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$3((function (){var G__32804 = cljs.core.PersistentVector.EMPTY;
if((((min == null)) || ((min === (0))))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__32804,malli.generator.nil_gen);
} else {
return G__32804;
}
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__32800_SHARP_){
return malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$3(schema,p1__32800_SHARP_,options);
})),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.identity,cljs.core.vec,cljs.core.eduction,(function (p1__32801_SHARP_){
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(p1__32801_SHARP_);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__32803,(function (){var vec__32810 = malli.core.children.cljs$core$IFn$_invoke$arity$1(el);
...
var G__32813 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map-of","map-of",1189682355),(function (){var or__5025__auto__ = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32815_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__32815_SHARP_,options) : malli.generator.generator.call(null,p1__32815_SHARP_,options));
...
return malli.util.transform_entries.cljs$core$IFn$_invoke$arity$3(G__32817,(function (p1__32816_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__32826){
var vec__32827 = p__32826;
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__32830,(2),malli.util.merge,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dispatch,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"=","=",1152933628),null,k], null)], null)], null));
} else {
return G__32830;
}
}),p1__32816_SHARP_);
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32831_SHARP_){
var G__32832 = cljs.core.last(p1__32831_SHARP_);
var G__32833 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32832,G__32833) : malli.generator.generator.call(null,G__32832,G__32833));
...
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__32834){
...
malli.generator._entry_gen = (function malli$generator$_entry_gen(p__32846,options){
var vec__32847 = p__32846;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32847,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32847,(1),null);
var G__32850 = malli.generator.gen_fmap((function (p1__32845_SHARP_){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,p1__32845_SHARP_], null);
...
return malli.generator.gen_maybe(G__32850);
} else {
return G__32850;
}
});
malli.generator._map_gen = (function malli$generator$_map_gen(schema,options){
return malli.generator.gen_fmap(malli.generator._build_map,malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32851_SHARP_){
return malli.generator._entry_gen(p1__32851_SHARP_,options);
...
return malli.generator.gen_fmap((function (p1__32854_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,p1__32854_SHARP_);
}),malli.generator.gen_vector_distinct_by(schema,malli.generator._min_max(schema,options),(function (p1__32853_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__32853_SHARP_,(0));
}),malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32852_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__32852_SHARP_,options) : malli.generator.generator.call(null,p1__32852_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)))));
});
...
var G__32859 = (function (){var G__32860 = dschema;
var G__32861 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),scalar_ref_gen);
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32860,G__32861) : malli.generator.generator.call(null,G__32860,G__32861));
})();
if(cljs.core.realized_QMARK_(scalar_ref_gen)){
return clojure.test.check.generators.recursive_gen((function (p1__32858_SHARP_){
var G__32862 = dschema;
var G__32863 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),p1__32858_SHARP_);
...
var output_generator = (function (){var G__32864 = new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(malli.core._function_info(schema));
var G__32865 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32864,G__32865) : malli.generator.generator.call(null,G__32864,G__32865));
})();
...
var G__33196__delegate = function (_){
...
while (G__33197__i < G__33197__a.length) {G__33197__a[G__33197__i] = arguments[G__33197__i + 0]; ++G__33197__i;}
  _ = new cljs.core.IndexedSeq(G__33197__a,0,null);
} 
return G__33196__delegate.call(this,_);};
G__33196.cljs$lang$maxFixedArity = 0;
G__33196.cljs$lang$applyTo = (function (arglist__33198){
var _ = cljs.core.seq(arglist__33198);
return G__33196__delegate(_);
});
...
return clojure.test.check.generators.return$(malli.core._instrument.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"schema","schema",-1582001791),schema,new cljs.core.Keyword(null,"gen","gen",142575302),(function (p1__32866_SHARP_){
return (malli.generator.generate.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generate.cljs$core$IFn$_invoke$arity$2(p1__32866_SHARP_,options) : malli.generator.generate.call(null,p1__32866_SHARP_,options));
})], null),null,options));
});
malli.generator._regex_generator = (function malli$generator$_regex_generator(schema,options){
var G__32867 = (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(schema,options) : malli.generator.generator.call(null,schema,options));
if(cljs.core.not(malli.core._regex_op_QMARK_(schema))){
return malli.generator.gen_tuple((new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[G__32867],null)));
} else {
return G__32867;
}
});
...
return malli.generator.gen_fcat(malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32868_SHARP_){
return malli.generator._re_entry_gen(p1__32868_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options))));
});
malli.generator._alt_gen = (function malli$generator$_alt_gen(schema,options){
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32869_SHARP_){
...
var child = malli.generator._child(schema,options);
var G__32870 = malli.generator.gen_vector(malli.generator._min_max(schema,options),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__32870);
} else {
return G__32870;
}
});
...
var child = malli.generator._child(schema,options);
var G__32871 = malli.generator.gen_vector(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.max,(1))),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__32871);
} else {
return G__32871;
}
});
malli.generator._repeat_gen = (function malli$generator$_repeat_gen(schema,options){
var or__5025__auto__ = (function (){var G__32878 = malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$2(schema,options);
var G__32878__$1 = (((G__32878 == null))?null:malli.generator._not_unreachable(G__32878));
if((G__32878__$1 == null)){
return null;
} else {
var G__32879 = G__32878__$1;
if(cljs.core.truth_(malli.core._regex_op_QMARK_(malli.generator._child(schema,options)))){
return malli.generator.gen_fcat(G__32879);
} else {
return G__32879;
}
}
...
var G__32881 = cljs.core.name(namespace_unparsed);
var G__32882 = cljs.core.name(k);
return (mk_value_with_ns.cljs$core$IFn$_invoke$arity$2 ? mk_value_with_ns.cljs$core$IFn$_invoke$arity$2(G__32881,G__32882) : mk_value_with_ns.call(null,G__32881,G__32882));
...
})(),cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__32890_SHARP_){
var G__32892 = p1__32890_SHARP_;
if((G__32892 == null)){
return null;
} else {
return G__32892;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__32891_SHARP_){
var G__32899 = p1__32891_SHARP_;
if((G__32899 == null)){
return null;
} else {
return G__32899;
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.generator","default","malli.generator/default",-943988734)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__32903 = cljs.core.get_global_hierarchy;
return (fexpr__32903.cljs$core$IFn$_invoke$arity$0 ? fexpr__32903.cljs$core$IFn$_invoke$arity$0() : fexpr__32903.call(null));
})());
...
return malli.generator.gen_such_that(schema,(function (p1__32913_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__32913_SHARP_,malli.generator._child(schema,options));
...
return malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32947_SHARP_){
...
var G__32990 = new cljs.core.Keyword("gen","elements","gen/elements",657813311).cljs$core$IFn$_invoke$arity$1(props);
if((G__32990 == null)){
return null;
} else {
return malli.generator.gen_elements(G__32990);
}
});
...
var G__32993 = new cljs.core.Keyword("gen","schema","gen/schema",-1582038959).cljs$core$IFn$_invoke$arity$1(props);
if((G__32993 == null)){
return null;
} else {
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__32993,options) : malli.generator.generator.call(null,G__32993,options));
}
});
...
return malli.core._cached(malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options),new cljs.core.Keyword(null,"generator","generator",-572962281),(function (p1__33006_SHARP_){
return malli.generator._create(p1__33006_SHARP_,options);
}));
}
}));
...
(malli.generator.generate.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__33013){
var map__33014 = p__33013;
var map__33014__$1 = cljs.core.__destructure_map(map__33014);
var options = map__33014__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33014__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__33014__$1,new cljs.core.Keyword(null,"size","size",1098693007),(30));
...
var gen = ((clojure.test.check.generators.generator_QMARK_(_QMARK_gen_or_schema))?_QMARK_gen_or_schema:malli.generator.generator.cljs$core$IFn$_invoke$arity$2(_QMARK_gen_or_schema,options));
return cljs.core.take.cljs$core$IFn$_invoke$arity$2(size,cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__33043_SHARP_,p2__33045_SHARP_){
return clojure.test.check.rose_tree.root(clojure.test.check.generators.call_gen(gen,p1__33043_SHARP_,p2__33045_SHARP_));
...
(malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_schema,p__33062){
var map__33063 = p__33062;
var map__33063__$1 = cljs.core.__destructure_map(map__33063);
var options = map__33063__$1;
var _EQ__GT_iterations = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__33063__$1,new cljs.core.Keyword("malli.generator","=>iterations","malli.generator/=>iterations",-1726832707),(100));
...
}catch (e33071){if((e33071 instanceof Error)){
var e = e33071;
...
var map__33073 = malli.core._function_info(schema__$1);
var map__33073__$1 = cljs.core.__destructure_map(map__33073);
var input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33073__$1,new cljs.core.Keyword(null,"input","input",556931961));
var output = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33073__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var guard = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33073__$1,new cljs.core.Keyword(null,"guard","guard",-873147811));
...
if(cljs.core.truth_(and__5023__auto__)){
var G__33074 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [args,$], null);
return (valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1 ? valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1(G__33074) : valid_guard_QMARK_.call(null,G__33074));
} else {
return and__5023__auto__;
}
});
return (function (f){
var map__33075 = clojure.test.check.quick_check(_EQ__GT_iterations,clojure.test.check.properties.for_all_STAR_(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [input_generator], null),(function (p1__33056_SHARP_){
return validate(f,p1__33056_SHARP_);
})));
var map__33075__$1 = cljs.core.__destructure_map(map__33075);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33075__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var shrunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33075__$1,new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412));
...
var vec__33076 = (cljs.core.truth_(explain_input)?null:_try((function (){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,smallest);
})));
var result__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33076,(0),null);
var success = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33076,(1),null);
...
var G__33087 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(shrunk,new cljs.core.Keyword("malli.core","result","malli.core/result",1538632379),result__$1);
var G__33087__$1 = (cljs.core.truth_(explain_input)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33087,new cljs.core.Keyword("malli.core","explain-input","malli.core/explain-input",1441627811),explain_input):G__33087);
var G__33087__$2 = (cljs.core.truth_(explain_output)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33087__$1,new cljs.core.Keyword("malli.core","explain-output","malli.core/explain-output",-124321573),explain_output):G__33087__$1);
var G__33087__$3 = (cljs.core.truth_(explain_guard)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33087__$2,new cljs.core.Keyword("malli.core","explain-guard","malli.core/explain-guard",-1119572847),explain_guard):G__33087__$2);
if(cljs.core.truth_(cljs.core.ex_message(result__$1))){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__33087__$3,new cljs.core.Keyword(null,"result","result",1415092211),cljs.core.ex_message),new cljs.core.Keyword(null,"result-data","result-data",-1724248844));
} else {
return G__33087__$3;
}
}
...
var checkers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33057_SHARP_){
return malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2(p1__33057_SHARP_,options);
}),malli.core._function_schema_arities(schema));
return (function (x){
return cljs.core.seq(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__33058_SHARP_){
return (p1__33058_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__33058_SHARP_.cljs$core$IFn$_invoke$arity$1(x) : p1__33058_SHARP_.call(null,x));
}),checkers));
});
} else {
...
var schema = malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options);
return malli.core.explain.cljs$core$IFn$_invoke$arity$2(malli.core._update_options(schema,(function (p1__33094_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__33094_SHARP_,new cljs.core.Keyword("malli.core","function-checker","malli.core/function-checker",-792030936),malli.generator.function_checker);
})),f);
}));
