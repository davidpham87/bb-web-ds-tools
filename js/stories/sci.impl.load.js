...
var referred__$1 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ns,p__40901){
var vec__40902 = p__40901;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40902,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40902,(1),null);
...
sci.impl.load.handle_require_libspec_env = (function sci$impl$load$handle_require_libspec_env(_ctx,env,current_ns,the_loaded_ns,lib_name,p__40935){
var map__40936 = p__40935;
var map__40936__$1 = cljs.core.__destructure_map(map__40936);
var opts = map__40936__$1;
var as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40936__$1,new cljs.core.Keyword(null,"as","as",1148689641));
var refer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40936__$1,new cljs.core.Keyword(null,"refer","refer",-964295553));
var refer_macros = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40936__$1,new cljs.core.Keyword(null,"refer-macros","refer-macros",-1906841953));
var rename = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40936__$1,new cljs.core.Keyword(null,"rename","rename",1508157613));
var exclude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40936__$1,new cljs.core.Keyword(null,"exclude","exclude",-1230250334));
var only = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40936__$1,new cljs.core.Keyword(null,"only","only",1907811652));
var use = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40936__$1,new cljs.core.Keyword(null,"use","use",-1846382424));
var or__5025__auto__ = ((typeof lib_name === 'string')?(function (){var vec__40937 = sci.impl.load.lib_PLUS_path(lib_name);
var lib_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40937,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40937,(1),null);
...
if(cljs.core.truth_(temp__5823__auto__)){
var vec__40950 = temp__5823__auto__;
var _k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40950,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40950,(1),null);
return v;
} else {
...
var temp__5825__auto___41528 = (function (){var G__40953 = the_loaded_ns;
var G__40953__$1 = (((G__40953 == null))?null:new cljs.core.Keyword(null,"obj","obj",981763962).cljs$core$IFn$_invoke$arity$1(G__40953));
var G__40953__$2 = (((G__40953__$1 == null))?null:cljs.core.meta(G__40953__$1));
if((G__40953__$2 == null)){
return null;
} else {
return new cljs.core.Keyword("sci.impl","required-fn","sci.impl/required-fn",2082701278).cljs$core$IFn$_invoke$arity$1(G__40953__$2);
}
})();
if(cljs.core.truth_(temp__5825__auto___41528)){
var on_loaded_41529 = temp__5825__auto___41528;
var G__40958_41530 = cljs.core.PersistentArrayMap.EMPTY;
(on_loaded_41529.cljs$core$IFn$_invoke$arity$1 ? on_loaded_41529.cljs$core$IFn$_invoke$arity$1(G__40958_41530) : on_loaded_41529.call(null,G__40958_41530));
} else {
}
...
var or__5025__auto__ = ((js_lib_QMARK_)?(function (){var vec__40996 = sci.impl.load.lib_PLUS_path(lib__$1);
var lib__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40996,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40996,(1),null);
...
var reload = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40999__$1,new cljs.core.Keyword(null,"reload","reload",863702807));
var reload_all = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40999__$1,new cljs.core.Keyword(null,"reload-all","reload-all",761570200));
...
var temp__5823__auto___41536__$1 = (cljs.core.truth_(reload_STAR_)?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(namespaces,lib__$1));
if(cljs.core.truth_(temp__5823__auto___41536__$1)){
var the_loaded_ns_41537 = temp__5823__auto___41536__$1;
var loading_41538 = new cljs.core.Keyword(null,"loading","loading",-737050189).cljs$core$IFn$_invoke$arity$1(ctx);
if(cljs.core.truth_((function (){var and__5023__auto__ = loading_41538;
if(cljs.core.truth_(and__5023__auto__)){
return (((!(cljs.core.contains_QMARK_(new cljs.core.Keyword(null,"loaded-libs","loaded-libs",-1156389652).cljs$core$IFn$_invoke$arity$1(env),lib__$1)))) && (cljs.core.nat_int_QMARK_(loading_41538.indexOf(lib__$1))));
} else {
return and__5023__auto__;
}
})())){
...
var loading__$1 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(loading_41538,lib__$1);
...
cljs.core.reset_BANG_(env_STAR_,sci.impl.load.handle_require_libspec_env(ctx,env,cnn,the_loaded_ns_41537,lib__$1,opts));
}
}
} else {
var temp__5823__auto___41541__$2 = new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334).cljs$core$IFn$_invoke$arity$1(env);
if(cljs.core.truth_(temp__5823__auto___41541__$2)){
var load_fn_41543 = temp__5823__auto___41541__$2;
var curr_ns_41544 = cljs.core.deref(sci.impl.utils.current_ns);
var temp__5823__auto___41545__$3 = (function (){var G__41014 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"namespace","namespace",-377510372),lib__$1,new cljs.core.Keyword(null,"libname","libname",135992497),lib__$1,new cljs.core.Keyword(null,"ctx","ctx",-493610118),ctx,new cljs.core.Keyword(null,"opts","opts",155075701),opts,new cljs.core.Keyword(null,"ns","ns",441598760),sci.impl.types.getName(curr_ns_41544),new cljs.core.Keyword(null,"reload","reload",863702807),(function (){var or__5025__auto____$1 = reload;
if(cljs.core.truth_(or__5025__auto____$1)){
return or__5025__auto____$1;
} else {
return reload_all;
...
return (load_fn_41543.cljs$core$IFn$_invoke$arity$1 ? load_fn_41543.cljs$core$IFn$_invoke$arity$1(G__41014) : load_fn_41543.call(null,G__41014));
})();
if(cljs.core.truth_(temp__5823__auto___41545__$3)){
var map__41030_41547 = temp__5823__auto___41545__$3;
var map__41030_41548__$1 = cljs.core.__destructure_map(map__41030_41547);
var file_41549 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41030_41548__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var source_41550 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41030_41548__$1,new cljs.core.Keyword(null,"source","source",-433931539));
var handled_41551 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41030_41548__$1,new cljs.core.Keyword(null,"handled","handled",1889700151));
...
if(cljs.core.truth_(source_41550)){
try{sci.impl.vars.push_thread_bindings(cljs.core.PersistentArrayMap.createAsIfByAssoc([sci.impl.utils.current_ns,curr_ns_41544,sci.impl.utils.current_file,file_41549]));

try{var fexpr__41048_41553 = cljs.core.deref(sci.impl.utils.eval_string_STAR_);
(fexpr__41048_41553.cljs$core$IFn$_invoke$arity$2 ? fexpr__41048_41553.cljs$core$IFn$_invoke$arity$2(ctx_41552__$1,source_41550) : fexpr__41048_41553.call(null,ctx_41552__$1,source_41550));
...
if(cljs.core.truth_(handled_41551)){
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(env_STAR_,(function (env__$1){
...
var or__5025__auto___41555__$1 = (cljs.core.truth_(reload_STAR_)?(function (){var temp__5825__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(namespaces,lib__$1);
if(cljs.core.truth_(temp__5825__auto__)){
...
if(cljs.core.truth_(or__5025__auto___41555__$1)){
} else {
...
var len__5749__auto___41557 = arguments.length;
var i__5750__auto___41558 = (0);
while(true){
if((i__5750__auto___41558 < len__5749__auto___41557)){
args__5755__auto__.push((arguments[i__5750__auto___41558]));

var G__41559 = (i__5750__auto___41558 + (1));
i__5750__auto___41558 = G__41559;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.load.load_lib.cljs$lang$applyTo = (function (seq41068){
var G__41069 = cljs.core.first(seq41068);
var seq41068__$1 = cljs.core.next(seq41068);
var G__41070 = cljs.core.first(seq41068__$1);
var seq41068__$2 = cljs.core.next(seq41068__$1);
var G__41071 = cljs.core.first(seq41068__$2);
var seq41068__$3 = cljs.core.next(seq41068__$2);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41069,G__41070,G__41071,seq41068__$3);
}));
...
var seq__41130 = cljs.core.seq(args_STAR___$1);
var chunk__41131 = null;
var count__41132 = (0);
var i__41133 = (0);
while(true){
if((i__41133 < count__41132)){
var arg = chunk__41131.cljs$core$IIndexed$_nth$arity$2(null,i__41133);
...
var vec__41201_41569 = arg;
var seq__41202_41570 = cljs.core.seq(vec__41201_41569);
var first__41203_41571 = cljs.core.first(seq__41202_41570);
var seq__41202_41572__$1 = cljs.core.next(seq__41202_41570);
var prefix_41573 = first__41203_41571;
var args_STAR__41574__$2 = seq__41202_41572__$1;
if((prefix_41573 == null)){
sci.impl.utils.throw_error_with_location.cljs$core$IFn$_invoke$arity$2("prefix cannot be nil",args);
} else {
}

var seq__41204_41575 = cljs.core.seq(args_STAR__41574__$2);
var chunk__41205_41576 = null;
var count__41206_41577 = (0);
var i__41207_41578 = (0);
while(true){
if((i__41207_41578 < count__41206_41577)){
var arg_41579__$1 = chunk__41205_41576.cljs$core$IIndexed$_nth$arity$2(null,i__41207_41578);
cljs.core.apply.cljs$core$IFn$_invoke$arity$4(sci.impl.load.load_lib,ctx,prefix_41573,sci.impl.load.prependss(arg_41579__$1,opts));


var G__41580 = seq__41204_41575;
var G__41581 = chunk__41205_41576;
var G__41582 = count__41206_41577;
var G__41583 = (i__41207_41578 + (1));
seq__41204_41575 = G__41580;
chunk__41205_41576 = G__41581;
count__41206_41577 = G__41582;
i__41207_41578 = G__41583;
continue;
} else {
var temp__5825__auto___41584 = cljs.core.seq(seq__41204_41575);
if(temp__5825__auto___41584){
var seq__41204_41585__$1 = temp__5825__auto___41584;
if(cljs.core.chunked_seq_QMARK_(seq__41204_41585__$1)){
var c__5548__auto___41586 = cljs.core.chunk_first(seq__41204_41585__$1);
var G__41587 = cljs.core.chunk_rest(seq__41204_41585__$1);
var G__41588 = c__5548__auto___41586;
var G__41589 = cljs.core.count(c__5548__auto___41586);
var G__41590 = (0);
seq__41204_41575 = G__41587;
chunk__41205_41576 = G__41588;
count__41206_41577 = G__41589;
i__41207_41578 = G__41590;
continue;
} else {
var arg_41591__$1 = cljs.core.first(seq__41204_41585__$1);
cljs.core.apply.cljs$core$IFn$_invoke$arity$4(sci.impl.load.load_lib,ctx,prefix_41573,sci.impl.load.prependss(arg_41591__$1,opts));


var G__41594 = cljs.core.next(seq__41204_41585__$1);
var G__41595 = null;
var G__41596 = (0);
var G__41597 = (0);
seq__41204_41575 = G__41594;
chunk__41205_41576 = G__41595;
count__41206_41577 = G__41596;
i__41207_41578 = G__41597;
continue;
}
} else {
}
...
var G__41598 = seq__41130;
var G__41599 = chunk__41131;
var G__41600 = count__41132;
var G__41601 = (i__41133 + (1));
seq__41130 = G__41598;
chunk__41131 = G__41599;
count__41132 = G__41600;
i__41133 = G__41601;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__41130);
if(temp__5825__auto__){
var seq__41130__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__41130__$1)){
var c__5548__auto__ = cljs.core.chunk_first(seq__41130__$1);
var G__41602 = cljs.core.chunk_rest(seq__41130__$1);
var G__41603 = c__5548__auto__;
var G__41604 = cljs.core.count(c__5548__auto__);
var G__41605 = (0);
seq__41130 = G__41602;
chunk__41131 = G__41603;
count__41132 = G__41604;
i__41133 = G__41605;
continue;
} else {
var arg = cljs.core.first(seq__41130__$1);
if(sci.impl.load.libspec_QMARK_(arg)){
cljs.core.apply.cljs$core$IFn$_invoke$arity$4(sci.impl.load.load_lib,ctx,null,sci.impl.load.prependss(arg,opts));
} else {
var vec__41208_41607 = arg;
var seq__41209_41608 = cljs.core.seq(vec__41208_41607);
var first__41210_41609 = cljs.core.first(seq__41209_41608);
var seq__41209_41610__$1 = cljs.core.next(seq__41209_41608);
var prefix_41611 = first__41210_41609;
var args_STAR__41612__$2 = seq__41209_41610__$1;
if((prefix_41611 == null)){
sci.impl.utils.throw_error_with_location.cljs$core$IFn$_invoke$arity$2("prefix cannot be nil",args);
} else {
}

var seq__41240_41613 = cljs.core.seq(args_STAR__41612__$2);
var chunk__41241_41614 = null;
var count__41242_41615 = (0);
var i__41243_41616 = (0);
while(true){
if((i__41243_41616 < count__41242_41615)){
var arg_41617__$1 = chunk__41241_41614.cljs$core$IIndexed$_nth$arity$2(null,i__41243_41616);
cljs.core.apply.cljs$core$IFn$_invoke$arity$4(sci.impl.load.load_lib,ctx,prefix_41611,sci.impl.load.prependss(arg_41617__$1,opts));


var G__41618 = seq__41240_41613;
var G__41619 = chunk__41241_41614;
var G__41620 = count__41242_41615;
var G__41621 = (i__41243_41616 + (1));
seq__41240_41613 = G__41618;
chunk__41241_41614 = G__41619;
count__41242_41615 = G__41620;
i__41243_41616 = G__41621;
continue;
} else {
var temp__5825__auto___41622__$1 = cljs.core.seq(seq__41240_41613);
if(temp__5825__auto___41622__$1){
var seq__41240_41624__$1 = temp__5825__auto___41622__$1;
if(cljs.core.chunked_seq_QMARK_(seq__41240_41624__$1)){
var c__5548__auto___41625 = cljs.core.chunk_first(seq__41240_41624__$1);
var G__41626 = cljs.core.chunk_rest(seq__41240_41624__$1);
var G__41627 = c__5548__auto___41625;
var G__41628 = cljs.core.count(c__5548__auto___41625);
var G__41629 = (0);
seq__41240_41613 = G__41626;
chunk__41241_41614 = G__41627;
count__41242_41615 = G__41628;
i__41243_41616 = G__41629;
continue;
} else {
var arg_41630__$1 = cljs.core.first(seq__41240_41624__$1);
cljs.core.apply.cljs$core$IFn$_invoke$arity$4(sci.impl.load.load_lib,ctx,prefix_41611,sci.impl.load.prependss(arg_41630__$1,opts));


var G__41631 = cljs.core.next(seq__41240_41624__$1);
var G__41632 = null;
var G__41633 = (0);
var G__41634 = (0);
seq__41240_41613 = G__41631;
chunk__41241_41614 = G__41632;
count__41242_41615 = G__41633;
i__41243_41616 = G__41634;
continue;
}
} else {
}
...
var G__41635 = cljs.core.next(seq__41130__$1);
var G__41636 = null;
var G__41637 = (0);
var G__41638 = (0);
seq__41130 = G__41635;
chunk__41131 = G__41636;
count__41132 = G__41637;
i__41133 = G__41638;
continue;
}
} else {
...
var args__5755__auto__ = [];
var len__5749__auto___41640 = arguments.length;
var i__5750__auto___41641 = (0);
while(true){
if((i__5750__auto___41641 < len__5749__auto___41640)){
args__5755__auto__.push((arguments[i__5750__auto___41641]));

var G__41643 = (i__5750__auto___41641 + (1));
i__5750__auto___41641 = G__41643;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.load.eval_require.cljs$lang$applyTo = (function (seq41244){
var G__41245 = cljs.core.first(seq41244);
var seq41244__$1 = cljs.core.next(seq41244);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41245,seq41244__$1);
}));

sci.impl.load.eval_require_macros = (function sci$impl$load$eval_require_macros(var_args){
var args__5755__auto__ = [];
var len__5749__auto___41646 = arguments.length;
var i__5750__auto___41647 = (0);
while(true){
if((i__5750__auto___41647 < len__5749__auto___41646)){
args__5755__auto__.push((arguments[i__5750__auto___41647]));

var G__41648 = (i__5750__auto___41647 + (1));
i__5750__auto___41647 = G__41648;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.load.eval_require_macros.cljs$lang$applyTo = (function (seq41285){
var G__41286 = cljs.core.first(seq41285);
var seq41285__$1 = cljs.core.next(seq41285);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41286,seq41285__$1);
}));
...
var args__5755__auto__ = [];
var len__5749__auto___41653 = arguments.length;
var i__5750__auto___41654 = (0);
while(true){
if((i__5750__auto___41654 < len__5749__auto___41653)){
args__5755__auto__.push((arguments[i__5750__auto___41654]));

var G__41655 = (i__5750__auto___41654 + (1));
i__5750__auto___41654 = G__41655;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.load.eval_use.cljs$lang$applyTo = (function (seq41323){
var G__41324 = cljs.core.first(seq41323);
var seq41323__$1 = cljs.core.next(seq41323);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41324,seq41323__$1);
}));
...
var vec__41367 = exprs__$1;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41367,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41367,(1),null);
var G__41370_41658 = k;
var G__41370_41659__$1 = (((G__41370_41658 instanceof cljs.core.Keyword))?G__41370_41658.fqn:null);
switch (G__41370_41659__$1) {
case "exclude":
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"env","env",-1815813235).cljs$core$IFn$_invoke$arity$1(ctx),((function (exprs__$1,G__41370_41658,G__41370_41659__$1,vec__41367,k,v,ns_sym){
return (function (env){
var cnn = sci.impl.utils.current_ns_name();
...
});})(exprs__$1,G__41370_41658,G__41370_41659__$1,vec__41367,k,v,ns_sym))
);
...
var other_ns = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(env,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469),ns_sym], null));
var the_current_ns__$1 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (exprs__$1,cnn,namespaces,the_current_ns,other_ns,G__41370_41658,G__41370_41659__$1,vec__41367,k,v,ns_sym){
return (function (acc,p__41371){
var vec__41372 = p__41371;
var original_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41372,(0),null);
var new_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41372,(1),null);
...
});})(exprs__$1,cnn,namespaces,the_current_ns,other_ns,G__41370_41658,G__41370_41659__$1,vec__41367,k,v,ns_sym))
,the_current_ns,v);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41370_41659__$1)].join('')));

}

var G__41665 = cljs.core.nnext(exprs__$1);
exprs__$1 = G__41665;
continue;
} else {
return null;
...
var args__5755__auto__ = [];
var len__5749__auto___41675 = arguments.length;
var i__5750__auto___41676 = (0);
while(true){
if((i__5750__auto___41676 < len__5749__auto___41675)){
args__5755__auto__.push((arguments[i__5750__auto___41676]));

var G__41677 = (i__5750__auto___41676 + (1));
i__5750__auto___41676 = G__41677;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.load.eval_refer.cljs$lang$applyTo = (function (seq41470){
var G__41472 = cljs.core.first(seq41470);
var seq41470__$1 = cljs.core.next(seq41470);
var G__41473 = cljs.core.first(seq41470__$1);
var seq41470__$2 = cljs.core.next(seq41470__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41472,G__41473,seq41470__$2);
}));
