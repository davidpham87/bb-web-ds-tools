...
var reitit$frontend$history$History$_href$dyn_36500 = (function (this$,path){
var x__5373__auto__ = (((this$ == null))?null:this$);
...
return reitit$frontend$history$History$_href$dyn_36500(this$,path);
}
});
...
var extmap__5365__auto__ = (function (){var G__36411 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__36399,new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"router","router",1091916230),new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472),new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801),new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173)], 0));
...
var G__36506 = el__$1.parentNode;
el__$1 = G__36506;
continue;
}
} else {
...
var expr__36434 = k__5332__auto__;
if(cljs.core.truth_((pred__36433.cljs$core$IFn$_invoke$arity$2 ? pred__36433.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),expr__36434) : pred__36433.call(null,new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),expr__36434)))){
...
if(cljs.core.truth_((pred__36433.cljs$core$IFn$_invoke$arity$2 ? pred__36433.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"router","router",1091916230),expr__36434) : pred__36433.call(null,new cljs.core.Keyword(null,"router","router",1091916230),expr__36434)))){
...
if(cljs.core.truth_((pred__36433.cljs$core$IFn$_invoke$arity$2 ? pred__36433.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"listen-key","listen-key",51973686),expr__36434) : pred__36433.call(null,new cljs.core.Keyword(null,"listen-key","listen-key",51973686),expr__36434)))){
...
if(cljs.core.truth_((pred__36433.cljs$core$IFn$_invoke$arity$2 ? pred__36433.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"click-listen-key","click-listen-key",642240955),expr__36434) : pred__36433.call(null,new cljs.core.Keyword(null,"click-listen-key","click-listen-key",642240955),expr__36434)))){
...
(reitit.frontend.history.start_BANG_.cljs$core$IFn$_invoke$arity$3 = (function (router,on_navigate,p__36461){
var map__36462 = p__36461;
var map__36462__$1 = cljs.core.__destructure_map(map__36462);
var opts = map__36462__$1;
var use_fragment = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__36462__$1,new cljs.core.Keyword(null,"use-fragment","use-fragment",-1617737154),true);
