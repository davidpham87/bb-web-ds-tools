...
var vec__31644 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31644,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31644,(1),null);
...
var len__5749__auto___31725 = arguments.length;
var i__5750__auto___31726 = (0);
while(true){
if((i__5750__auto___31726 < len__5749__auto___31725)){
args__5755__auto__.push((arguments[i__5750__auto___31726]));

var G__31727 = (i__5750__auto___31726 + (1));
i__5750__auto___31726 = G__31727;
continue;
} else {
}
break;
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__31654){
var map__31655 = p__31654;
var map__31655__$1 = cljs.core.__destructure_map(map__31655);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31655__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__31655__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__31655__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__31656 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31656,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31656,(1),null);
...
var vec__31669 = size_seq__$1;
var seq__31670 = cljs.core.seq(vec__31669);
var first__31671 = cljs.core.first(seq__31670);
var seq__31670__$1 = cljs.core.next(seq__31670);
var size = first__31671;
var rest_size_seq = seq__31670__$1;
var vec__31672 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31672,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31672,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq31651){
var G__31652 = cljs.core.first(seq31651);
var seq31651__$1 = cljs.core.next(seq31651);
var G__31653 = cljs.core.first(seq31651__$1);
var seq31651__$2 = cljs.core.next(seq31651__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31652,G__31653,seq31651__$2);
}));
...
var map__31685 = smallest;
var map__31685__$1 = cljs.core.__destructure_map(map__31685);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31685__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__31739 = tail;
var G__31740 = current_smallest;
var G__31741 = (total_nodes_visited + (1));
var G__31742 = depth;
nodes = G__31739;
current_smallest = G__31740;
total_nodes_visited = G__31741;
depth = G__31742;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__31697_31743 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31697_31743) : reporter_fn.call(null,G__31697_31743));

var temp__5823__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5823__auto__){
var children = temp__5823__auto__;
var G__31744 = children;
var G__31745 = new_smallest;
var G__31746 = (total_nodes_visited + (1));
var G__31747 = (depth + (1));
nodes = G__31744;
current_smallest = G__31745;
total_nodes_visited = G__31746;
depth = G__31747;
continue;
} else {
var G__31748 = tail;
var G__31749 = new_smallest;
var G__31750 = (total_nodes_visited + (1));
var G__31751 = depth;
nodes = G__31748;
current_smallest = G__31749;
total_nodes_visited = G__31750;
depth = G__31751;
continue;
}
}
...
var G__31710_31754 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31710_31754) : reporter_fn.call(null,G__31710_31754));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__31698_SHARP_){
var G__31711 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__31698_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31711) : reporter_fn.call(null,G__31711));
}));
var G__31712_31760 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31712_31760) : reporter_fn.call(null,G__31712_31760));
