...
var vec__31646 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31646,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31646,(1),null);
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__31662){
var map__31663 = p__31662;
var map__31663__$1 = cljs.core.__destructure_map(map__31663);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31663__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__31663__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__31663__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__31667 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31667,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31667,(1),null);
...
var vec__31686 = size_seq__$1;
var seq__31687 = cljs.core.seq(vec__31686);
var first__31688 = cljs.core.first(seq__31687);
var seq__31687__$1 = cljs.core.next(seq__31687);
var size = first__31688;
var rest_size_seq = seq__31687__$1;
var vec__31689 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31689,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31689,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq31652){
...
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31653,G__31654,seq31652__$2);
}));
...
var map__31706 = smallest;
var map__31706__$1 = cljs.core.__destructure_map(map__31706);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31706__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__31717_31743 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31717_31743) : reporter_fn.call(null,G__31717_31743));
...
var G__31723_31752 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31723_31752) : reporter_fn.call(null,G__31723_31752));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__31718_SHARP_){
var G__31724 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__31718_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31724) : reporter_fn.call(null,G__31724));
}));
var G__31725_31753 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31725_31753) : reporter_fn.call(null,G__31725_31753));
