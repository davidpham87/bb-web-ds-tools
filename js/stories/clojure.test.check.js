...
var vec__31818 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31818,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31818,(1),null);
...
var len__5749__auto___31892 = arguments.length;
var i__5750__auto___31893 = (0);
while(true){
if((i__5750__auto___31893 < len__5749__auto___31892)){
args__5755__auto__.push((arguments[i__5750__auto___31893]));

var G__31894 = (i__5750__auto___31893 + (1));
i__5750__auto___31893 = G__31894;
continue;
} else {
}
break;
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__31827){
var map__31828 = p__31827;
var map__31828__$1 = cljs.core.__destructure_map(map__31828);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31828__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__31828__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__31828__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__31829 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31829,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31829,(1),null);
...
var vec__31842 = size_seq__$1;
var seq__31843 = cljs.core.seq(vec__31842);
var first__31844 = cljs.core.first(seq__31843);
var seq__31843__$1 = cljs.core.next(seq__31843);
var size = first__31844;
var rest_size_seq = seq__31843__$1;
var vec__31845 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31845,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31845,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq31822){
var G__31823 = cljs.core.first(seq31822);
var seq31822__$1 = cljs.core.next(seq31822);
var G__31824 = cljs.core.first(seq31822__$1);
var seq31822__$2 = cljs.core.next(seq31822__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31823,G__31824,seq31822__$2);
}));
...
var map__31857 = smallest;
var map__31857__$1 = cljs.core.__destructure_map(map__31857);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31857__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__31900 = tail;
var G__31901 = current_smallest;
var G__31902 = (total_nodes_visited + (1));
var G__31903 = depth;
nodes = G__31900;
current_smallest = G__31901;
total_nodes_visited = G__31902;
depth = G__31903;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__31872_31904 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31872_31904) : reporter_fn.call(null,G__31872_31904));

var temp__5823__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5823__auto__){
var children = temp__5823__auto__;
var G__31907 = children;
var G__31908 = new_smallest;
var G__31909 = (total_nodes_visited + (1));
var G__31910 = (depth + (1));
nodes = G__31907;
current_smallest = G__31908;
total_nodes_visited = G__31909;
depth = G__31910;
continue;
} else {
var G__31912 = tail;
var G__31913 = new_smallest;
var G__31914 = (total_nodes_visited + (1));
var G__31915 = depth;
nodes = G__31912;
current_smallest = G__31913;
total_nodes_visited = G__31914;
depth = G__31915;
continue;
}
}
...
var G__31878_31917 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31878_31917) : reporter_fn.call(null,G__31878_31917));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__31873_SHARP_){
var G__31879 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__31873_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31879) : reporter_fn.call(null,G__31879));
}));
var G__31881_31921 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31881_31921) : reporter_fn.call(null,G__31881_31921));
