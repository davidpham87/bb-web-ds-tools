...
var vec__31723 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31723,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31723,(1),null);
...
var len__5749__auto___31803 = arguments.length;
var i__5750__auto___31804 = (0);
while(true){
if((i__5750__auto___31804 < len__5749__auto___31803)){
args__5755__auto__.push((arguments[i__5750__auto___31804]));

var G__31805 = (i__5750__auto___31804 + (1));
i__5750__auto___31804 = G__31805;
continue;
} else {
}
break;
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__31732){
var map__31733 = p__31732;
var map__31733__$1 = cljs.core.__destructure_map(map__31733);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31733__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__31733__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__31733__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__31734 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31734,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31734,(1),null);
...
var vec__31750 = size_seq__$1;
var seq__31751 = cljs.core.seq(vec__31750);
var first__31752 = cljs.core.first(seq__31751);
var seq__31751__$1 = cljs.core.next(seq__31751);
var size = first__31752;
var rest_size_seq = seq__31751__$1;
var vec__31753 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31753,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31753,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq31727){
...
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31728,G__31729,seq31727__$2);
}));
...
var map__31763 = smallest;
var map__31763__$1 = cljs.core.__destructure_map(map__31763);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31763__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__31815 = tail;
var G__31816 = current_smallest;
var G__31817 = (total_nodes_visited + (1));
var G__31818 = depth;
nodes = G__31815;
current_smallest = G__31816;
total_nodes_visited = G__31817;
depth = G__31818;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__31773_31819 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31773_31819) : reporter_fn.call(null,G__31773_31819));

var temp__5823__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5823__auto__){
var children = temp__5823__auto__;
var G__31820 = children;
var G__31821 = new_smallest;
var G__31822 = (total_nodes_visited + (1));
var G__31823 = (depth + (1));
nodes = G__31820;
current_smallest = G__31821;
total_nodes_visited = G__31822;
depth = G__31823;
continue;
} else {
var G__31824 = tail;
var G__31825 = new_smallest;
var G__31826 = (total_nodes_visited + (1));
var G__31827 = depth;
nodes = G__31824;
current_smallest = G__31825;
total_nodes_visited = G__31826;
depth = G__31827;
continue;
}
}
...
var G__31791_31828 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31791_31828) : reporter_fn.call(null,G__31791_31828));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__31790_SHARP_){
var G__31792 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__31790_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31792) : reporter_fn.call(null,G__31792));
}));
var G__31793_31829 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31793_31829) : reporter_fn.call(null,G__31793_31829));
