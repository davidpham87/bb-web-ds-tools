...
var vec__31756 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31756,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31756,(1),null);
...
var len__5749__auto___31839 = arguments.length;
var i__5750__auto___31840 = (0);
while(true){
if((i__5750__auto___31840 < len__5749__auto___31839)){
args__5755__auto__.push((arguments[i__5750__auto___31840]));

var G__31842 = (i__5750__auto___31840 + (1));
i__5750__auto___31840 = G__31842;
continue;
} else {
}
break;
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__31772){
var map__31773 = p__31772;
var map__31773__$1 = cljs.core.__destructure_map(map__31773);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31773__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__31773__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__31773__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__31774 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31774,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31774,(1),null);
...
var vec__31796 = size_seq__$1;
var seq__31797 = cljs.core.seq(vec__31796);
var first__31798 = cljs.core.first(seq__31797);
var seq__31797__$1 = cljs.core.next(seq__31797);
var size = first__31798;
var rest_size_seq = seq__31797__$1;
var vec__31799 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31799,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31799,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq31759){
var G__31760 = cljs.core.first(seq31759);
var seq31759__$1 = cljs.core.next(seq31759);
var G__31761 = cljs.core.first(seq31759__$1);
var seq31759__$2 = cljs.core.next(seq31759__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31760,G__31761,seq31759__$2);
}));
...
var map__31816 = smallest;
var map__31816__$1 = cljs.core.__destructure_map(map__31816);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31816__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__31847 = tail;
var G__31848 = current_smallest;
var G__31849 = (total_nodes_visited + (1));
var G__31850 = depth;
nodes = G__31847;
current_smallest = G__31848;
total_nodes_visited = G__31849;
depth = G__31850;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__31830_31851 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31830_31851) : reporter_fn.call(null,G__31830_31851));

var temp__5823__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5823__auto__){
var children = temp__5823__auto__;
var G__31852 = children;
var G__31853 = new_smallest;
var G__31854 = (total_nodes_visited + (1));
var G__31855 = (depth + (1));
nodes = G__31852;
current_smallest = G__31853;
total_nodes_visited = G__31854;
depth = G__31855;
continue;
} else {
var G__31856 = tail;
var G__31857 = new_smallest;
var G__31858 = (total_nodes_visited + (1));
var G__31859 = depth;
nodes = G__31856;
current_smallest = G__31857;
total_nodes_visited = G__31858;
depth = G__31859;
continue;
}
}
...
var G__31832_31860 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31832_31860) : reporter_fn.call(null,G__31832_31860));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__31831_SHARP_){
var G__31833 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__31831_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31833) : reporter_fn.call(null,G__31833));
}));
var G__31834_31861 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31834_31861) : reporter_fn.call(null,G__31834_31861));
