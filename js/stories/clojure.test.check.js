...
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31734_31801) : reporter_fn.call(null,G__31734_31801));
...
var vec__31742 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31742,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31742,(1),null);
...
var len__5749__auto___31815 = arguments.length;
var i__5750__auto___31816 = (0);
while(true){
if((i__5750__auto___31816 < len__5749__auto___31815)){
args__5755__auto__.push((arguments[i__5750__auto___31816]));

var G__31817 = (i__5750__auto___31816 + (1));
i__5750__auto___31816 = G__31817;
continue;
} else {
}
break;
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__31750){
var map__31751 = p__31750;
var map__31751__$1 = cljs.core.__destructure_map(map__31751);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31751__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__31751__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__31751__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__31755 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31755,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31755,(1),null);
...
var size = first__31767;
var rest_size_seq = seq__31766__$1;
var vec__31768 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31768,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31768,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq31746){
var G__31747 = cljs.core.first(seq31746);
var seq31746__$1 = cljs.core.next(seq31746);
var G__31748 = cljs.core.first(seq31746__$1);
var seq31746__$2 = cljs.core.next(seq31746__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31747,G__31748,seq31746__$2);
}));
...
var map__31777 = smallest;
var map__31777__$1 = cljs.core.__destructure_map(map__31777);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31777__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__31823 = tail;
var G__31824 = current_smallest;
var G__31825 = (total_nodes_visited + (1));
var G__31826 = depth;
nodes = G__31823;
current_smallest = G__31824;
total_nodes_visited = G__31825;
depth = G__31826;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__31793_31828 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31793_31828) : reporter_fn.call(null,G__31793_31828));

var temp__5823__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5823__auto__){
var children = temp__5823__auto__;
var G__31829 = children;
var G__31830 = new_smallest;
var G__31831 = (total_nodes_visited + (1));
var G__31832 = (depth + (1));
nodes = G__31829;
current_smallest = G__31830;
total_nodes_visited = G__31831;
depth = G__31832;
continue;
} else {
var G__31833 = tail;
var G__31834 = new_smallest;
var G__31835 = (total_nodes_visited + (1));
var G__31836 = depth;
nodes = G__31833;
current_smallest = G__31834;
total_nodes_visited = G__31835;
depth = G__31836;
continue;
}
}
...
var G__31798_31838 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31798_31838) : reporter_fn.call(null,G__31798_31838));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__31794_SHARP_){
var G__31799 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__31794_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31799) : reporter_fn.call(null,G__31799));
}));
var G__31800_31839 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__31800_31839) : reporter_fn.call(null,G__31800_31839));
