...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("malli","set-max-enum-values","malli/set-max-enum-values",-2140449014),(function (db,p__38232){
var vec__38233 = p__38232;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38233,(0),null);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38233,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("malli","set-input-format","malli/set-input-format",1977658647),(function (db,p__38241){
var vec__38242 = p__38241;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38242,(0),null);
var fmt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38242,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("malli","set-generation-samples","malli/set-generation-samples",-986788539),(function (db,p__38245){
var vec__38246 = p__38245;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38246,(0),null);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38246,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("malli","set-generation-format","malli/set-generation-format",-404570060),(function (db,p__38249){
var vec__38250 = p__38249;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38250,(0),null);
var fmt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38250,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("malli","parse-schema-and-generate","malli/parse-schema-and-generate",-173808732),(function (p__38253,_){
var map__38254 = p__38253;
var map__38254__$1 = cljs.core.__destructure_map(map__38254);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38254__$1,new cljs.core.Keyword(null,"db","db",993250759));
var map__38255 = bb_web_ds_tools.views.malli.get_malli_state(db);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("malli","infer-schema","malli/infer-schema",-2069021170),(function (p__38264,_){
var map__38265 = p__38264;
var map__38265__$1 = cljs.core.__destructure_map(map__38265);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38265__$1,new cljs.core.Keyword(null,"db","db",993250759));
var map__38266 = bb_web_ds_tools.views.malli.get_malli_state(db);
var map__38266__$1 = cljs.core.__destructure_map(map__38266);
var inference_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38266__$1,new cljs.core.Keyword(null,"inference-input","inference-input",1942128493));
var input_fmt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38266__$1,new cljs.core.Keyword(null,"input-fmt","input-fmt",-995230963));
var max_enum_values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38266__$1,new cljs.core.Keyword(null,"max-enum-values","max-enum-values",1635637276));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("malli","save-dataset","malli/save-dataset",1216700074),(function (p__38269,_){
var map__38270 = p__38269;
var map__38270__$1 = cljs.core.__destructure_map(map__38270);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38270__$1,new cljs.core.Keyword(null,"db","db",993250759));
var map__38271 = bb_web_ds_tools.views.malli.get_malli_state(db);
var map__38271__$1 = cljs.core.__destructure_map(map__38271);
var generated_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38271__$1,new cljs.core.Keyword(null,"generated-data","generated-data",-924406973));
var generation_fmt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38271__$1,new cljs.core.Keyword(null,"generation-fmt","generation-fmt",239967584));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("malli","validate","malli/validate",-313382926),(function (p__38278,_){
var map__38279 = p__38278;
var map__38279__$1 = cljs.core.__destructure_map(map__38279);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38279__$1,new cljs.core.Keyword(null,"db","db",993250759));
var map__38280 = bb_web_ds_tools.views.malli.get_malli_state(db);
var map__38280__$1 = cljs.core.__destructure_map(map__38280);
var schema_text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38280__$1,new cljs.core.Keyword(null,"schema-text","schema-text",-90970505));
var inference_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38280__$1,new cljs.core.Keyword(null,"inference-input","inference-input",1942128493));
var input_fmt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38280__$1,new cljs.core.Keyword(null,"input-fmt","input-fmt",-995230963));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("malli","transform-json","malli/transform-json",-1883425606),(function (p__38282,_){
var map__38283 = p__38282;
var map__38283__$1 = cljs.core.__destructure_map(map__38283);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38283__$1,new cljs.core.Keyword(null,"db","db",993250759));
var map__38284 = bb_web_ds_tools.views.malli.get_malli_state(db);
var map__38284__$1 = cljs.core.__destructure_map(map__38284);
var schema_text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38284__$1,new cljs.core.Keyword(null,"schema-text","schema-text",-90970505));
var schema_result = bb_web_ds_tools.components.malli.parse_schema_and_generate(schema_text);
if(cljs.core.truth_(new cljs.core.Keyword(null,"success","success",1890645906).cljs$core$IFn$_invoke$arity$1(schema_result))){
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("malli","validation-view-state","malli/validation-view-state",1493956709),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli","schema-text","malli/schema-text",-196762812)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli","inference-input","malli/inference-input",2111715866)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli","input-format","malli/input-format",-455291986)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli","validation-result","malli/validation-result",-1935991260)], null),(function (p__38296,_){
var vec__38298 = p__38296;
...
var map__38308 = props;
var map__38308__$1 = cljs.core.__destructure_map(map__38308);
var primary = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38308__$1,new cljs.core.Keyword(null,"primary","primary",817773892));
var active = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38308__$1,new cljs.core.Keyword(null,"active","active",1895962068));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38308__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38315),bb_web_ds_tools$views$malli$unified_view_$_iter__38312(cljs.core.chunk_rest(s__38313__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38315),null);
}
} else {
var vec__38319 = cljs.core.first(s__38313__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38319,(0),null);
var editor_config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38319,(1),null);
