...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__22715__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__22716__i < G__22716__a.length) {G__22716__a[G__22716__i] = arguments[G__22716__i + 0]; ++G__22716__i;}
  args = new cljs.core.IndexedSeq(G__22716__a,0,null);
} 
return G__22715__delegate.call(this,args);};
G__22715.cljs$lang$maxFixedArity = 0;
G__22715.cljs$lang$applyTo = (function (arglist__22717){
var args = cljs.core.seq(arglist__22717);
return G__22715__delegate(args);
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22577 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22577,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22577;
}
})(),id_class);
...
var temp__5825__auto___22718 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___22718)){
var d_22719 = temp__5825__auto___22718;
if((d_22719 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_22719.s}));
} else {
...
var G__22580 = (cljs.core.count(argv) - first_child);
switch (G__22580) {
case (0):
...
var vec__22586 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22586,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22586,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22586,(2),null);
...
var key_22738 = temp__5829__auto___22737;
(jsprops.key = key_22738);
}
...
var temp__5829__auto___22739 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22739 == null)){
} else {
var key_22740 = temp__5829__auto___22739;
(jsprops.key = key_22740);
}
...
var temp__5829__auto___22742 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22742 == null)){
} else {
var key_22743 = temp__5829__auto___22742;
...
var temp__5829__auto___22755 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___22755 == null)){
} else {
var key_22757 = temp__5829__auto___22755;
(jsprops.key = key_22757);
}
...
var temp__5829__auto___22775 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22775 == null)){
} else {
var key_22776 = temp__5829__auto___22775;
(jsprops.key = key_22776);
}
...
var temp__5829__auto___22779 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22779 == null)){
} else {
var key_22781 = temp__5829__auto___22779;
(jsprops.key = key_22781);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22637_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22637_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22649 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22649,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22649,(1),null);
...
break;
default:
var G__22808 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22809 = compiler;
v = G__22808;
compiler = G__22809;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template22681 = (function (opts,id,fn_to_element,parse_fn,meta22682){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22681.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22683,meta22682__$1){
var self__ = this;
var _22683__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22681(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22682__$1));
}));

(reagent.impl.template.t_reagent$impl$template22681.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22683){
var self__ = this;
var _22683__$1 = this;
return self__.meta22682;
}));

(reagent.impl.template.t_reagent$impl$template22681.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22681.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22681.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22681.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22681.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22681.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22682","meta22682",-768602461,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22681.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22681.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22681");

(reagent.impl.template.t_reagent$impl$template22681.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template22681");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22681.
 */
reagent.impl.template.__GT_t_reagent$impl$template22681 = (function reagent$impl$template$__GT_t_reagent$impl$template22681(opts,id,fn_to_element,parse_fn,meta22682){
return (new reagent.impl.template.t_reagent$impl$template22681(opts,id,fn_to_element,parse_fn,meta22682));
});
...
return (new reagent.impl.template.t_reagent$impl$template22681(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
