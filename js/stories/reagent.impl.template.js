...
var G__22576 = o;
reagent.impl.template.goog$module$goog$object.set(G__22576,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__22728__delegate = function (args){
...
return G__22728__delegate.call(this,args);};
...
return G__22728__delegate(args);
});
...
var G__22584 = o;
reagent.impl.template.goog$module$goog$object.set(G__22584,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__22736__i < G__22736__a.length) {G__22736__a[G__22736__i] = arguments[G__22736__i + 0]; ++G__22736__i;}
  args = new cljs.core.IndexedSeq(G__22736__a,0,null);
} 
...
var G__22600 = props;
var G__22600__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22600,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22600);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22600__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22616 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22616,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22616;
}
})(),id_class);
...
var temp__5825__auto___22738 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___22738)){
var d_22739 = temp__5825__auto___22738;
if((d_22739 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_22739.s}));
} else {
...
var G__22633 = (cljs.core.count(argv) - first_child);
switch (G__22633) {
case (0):
...
var vec__22645 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22645,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22645,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22645,(2),null);
...
var temp__5829__auto___22746 = reagent.impl.util.react_key_from_vec(v);
...
var temp__5829__auto___22748 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22748 == null)){
} else {
var key_22749 = temp__5829__auto___22748;
(jsprops.key = key_22749);
}
...
var temp__5829__auto___22751 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22751 == null)){
} else {
var key_22753 = temp__5829__auto___22751;
(jsprops.key = key_22753);
}
...
var temp__5829__auto___22757 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___22757 == null)){
} else {
var key_22758 = temp__5829__auto___22757;
(jsprops.key = key_22758);
}
...
var temp__5829__auto___22765 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
...
var temp__5829__auto___22768 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22768 == null)){
} else {
var key_22769 = temp__5829__auto___22768;
(jsprops.key = key_22769);
}
...
var ctx = ({});
var vec__22692 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22692,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22692,(1),null);
...
break;
default:
var G__22778 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22779 = compiler;
v = G__22778;
compiler = G__22779;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template22709 = (function (opts,id,fn_to_element,parse_fn,meta22710){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22709.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22711,meta22710__$1){
var self__ = this;
var _22711__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22709(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22710__$1));
}));

(reagent.impl.template.t_reagent$impl$template22709.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22711){
var self__ = this;
var _22711__$1 = this;
return self__.meta22710;
}));

(reagent.impl.template.t_reagent$impl$template22709.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22709.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22709.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22709.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22709.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22709.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22710","meta22710",-1503771000,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22709.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22709.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22709");

(reagent.impl.template.t_reagent$impl$template22709.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template22709");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22709.
 */
reagent.impl.template.__GT_t_reagent$impl$template22709 = (function reagent$impl$template$__GT_t_reagent$impl$template22709(opts,id,fn_to_element,parse_fn,meta22710){
return (new reagent.impl.template.t_reagent$impl$template22709(opts,id,fn_to_element,parse_fn,meta22710));
});
...
return (new reagent.impl.template.t_reagent$impl$template22709(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
