...
var G__22622 = o;
reagent.impl.template.goog$module$goog$object.set(G__22622,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__22632 = o;
reagent.impl.template.goog$module$goog$object.set(G__22632,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__22633 = props;
var G__22633__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22633,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22633);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22633__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22643 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22643,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22643;
}
})(),id_class);
...
var G__22645 = (cljs.core.count(argv) - first_child);
switch (G__22645) {
case (0):
...
var vec__22653 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22653,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22653,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22653,(2),null);
...
var temp__5829__auto___22730 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22730 == null)){
} else {
var key_22731 = temp__5829__auto___22730;
...
var temp__5829__auto___22733 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22733 == null)){
} else {
var key_22734 = temp__5829__auto___22733;
(jsprops.key = key_22734);
}
...
var temp__5829__auto___22735 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22735 == null)){
} else {
var key_22737 = temp__5829__auto___22735;
(jsprops.key = key_22737);
}
...
var temp__5829__auto___22742 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___22742 == null)){
} else {
var key_22744 = temp__5829__auto___22742;
(jsprops.key = key_22744);
}
...
var temp__5829__auto___22756 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22756 == null)){
} else {
var key_22757 = temp__5829__auto___22756;
...
var temp__5829__auto___22763 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22763 == null)){
} else {
var key_22765 = temp__5829__auto___22763;
(jsprops.key = key_22765);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22678_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22678_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22679 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22679,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22679,(1),null);
...
break;
default:
var G__22785 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22786 = compiler;
v = G__22785;
compiler = G__22786;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template22701 = (function (opts,id,fn_to_element,parse_fn,meta22702){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22701.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22703,meta22702__$1){
var self__ = this;
var _22703__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22701(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22702__$1));
}));

(reagent.impl.template.t_reagent$impl$template22701.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22703){
var self__ = this;
var _22703__$1 = this;
return self__.meta22702;
}));

(reagent.impl.template.t_reagent$impl$template22701.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22701.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22701.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22701.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22701.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22701.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22702","meta22702",989191070,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22701.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22701.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22701");

(reagent.impl.template.t_reagent$impl$template22701.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template22701");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22701.
 */
reagent.impl.template.__GT_t_reagent$impl$template22701 = (function reagent$impl$template$__GT_t_reagent$impl$template22701(opts,id,fn_to_element,parse_fn,meta22702){
return (new reagent.impl.template.t_reagent$impl$template22701(opts,id,fn_to_element,parse_fn,meta22702));
});
...
return (new reagent.impl.template.t_reagent$impl$template22701(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
