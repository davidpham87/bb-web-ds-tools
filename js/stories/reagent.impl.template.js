...
var G__22468 = o;
reagent.impl.template.goog$module$goog$object.set(G__22468,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__22524__delegate = function (args){
...
while (G__22525__i < G__22525__a.length) {G__22525__a[G__22525__i] = arguments[G__22525__i + 0]; ++G__22525__i;}
  args = new cljs.core.IndexedSeq(G__22525__a,0,null);
} 
return G__22524__delegate.call(this,args);};
G__22524.cljs$lang$maxFixedArity = 0;
G__22524.cljs$lang$applyTo = (function (arglist__22528){
var args = cljs.core.seq(arglist__22528);
return G__22524__delegate(args);
});
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__22533__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__22534__i < G__22534__a.length) {G__22534__a[G__22534__i] = arguments[G__22534__i + 0]; ++G__22534__i;}
  args = new cljs.core.IndexedSeq(G__22534__a,0,null);
} 
return G__22533__delegate.call(this,args);};
G__22533.cljs$lang$maxFixedArity = 0;
G__22533.cljs$lang$applyTo = (function (arglist__22537){
var args = cljs.core.seq(arglist__22537);
return G__22533__delegate(args);
});
...
var G__22472 = props;
var G__22472__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22472,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22472);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22472__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22473 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22473,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22473;
}
})(),id_class);
...
var temp__5825__auto___22544 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___22544)){
var d_22547 = temp__5825__auto___22544;
if((d_22547 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_22547.s}));
} else {
...
var G__22474 = (cljs.core.count(argv) - first_child);
switch (G__22474) {
case (0):
...
var vec__22475 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22475,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22475,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22475,(2),null);
...
var temp__5829__auto___22565 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22565 == null)){
} else {
var key_22567 = temp__5829__auto___22565;
(jsprops.key = key_22567);
}
...
var temp__5829__auto___22569 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22569 == null)){
} else {
var key_22570 = temp__5829__auto___22569;
(jsprops.key = key_22570);
}
...
var temp__5829__auto___22594 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22594 == null)){
} else {
var key_22595 = temp__5829__auto___22594;
(jsprops.key = key_22595);
}
...
var temp__5829__auto___22598 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22598 == null)){
} else {
var key_22600 = temp__5829__auto___22598;
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22488_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22488_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22490 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22490,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22490,(1),null);
...
break;
default:
var G__22619 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22620 = compiler;
v = G__22619;
compiler = G__22620;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template22500 = (function (opts,id,fn_to_element,parse_fn,meta22501){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22500.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22502,meta22501__$1){
var self__ = this;
var _22502__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22500(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22501__$1));
}));

(reagent.impl.template.t_reagent$impl$template22500.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22502){
var self__ = this;
var _22502__$1 = this;
return self__.meta22501;
}));

(reagent.impl.template.t_reagent$impl$template22500.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22500.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22500.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22500.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22500.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22500.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22501","meta22501",1942918068,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22500.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22500.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22500");

(reagent.impl.template.t_reagent$impl$template22500.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template22500");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22500.
 */
reagent.impl.template.__GT_t_reagent$impl$template22500 = (function reagent$impl$template$__GT_t_reagent$impl$template22500(opts,id,fn_to_element,parse_fn,meta22501){
return (new reagent.impl.template.t_reagent$impl$template22500(opts,id,fn_to_element,parse_fn,meta22501));
});
...
return (new reagent.impl.template.t_reagent$impl$template22500(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
