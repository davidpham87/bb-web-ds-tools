...
var G__22486 = o;
reagent.impl.template.goog$module$goog$object.set(G__22486,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__22580__i < G__22580__a.length) {G__22580__a[G__22580__i] = arguments[G__22580__i + 0]; ++G__22580__i;}
  args = new cljs.core.IndexedSeq(G__22580__a,0,null);
} 
return G__22579__delegate.call(this,args);};
G__22579.cljs$lang$maxFixedArity = 0;
G__22579.cljs$lang$applyTo = (function (arglist__22582){
var args = cljs.core.seq(arglist__22582);
...
var G__22489 = o;
reagent.impl.template.goog$module$goog$object.set(G__22489,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22491 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22491,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22491;
}
})(),id_class);
...
var temp__5825__auto___22587 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___22587)){
var d_22588 = temp__5825__auto___22587;
if((d_22588 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_22588.s}));
} else {
...
var G__22493 = (cljs.core.count(argv) - first_child);
switch (G__22493) {
case (0):
...
var vec__22503 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22503,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22503,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22503,(2),null);
...
var temp__5829__auto___22594 = reagent.impl.util.react_key_from_vec(v);
...
var temp__5829__auto___22604 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22604 == null)){
} else {
var key_22606 = temp__5829__auto___22604;
...
var temp__5829__auto___22607 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22607 == null)){
} else {
var key_22608 = temp__5829__auto___22607;
(jsprops.key = key_22608);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22531_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22531_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22532 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22532,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22532,(1),null);
...
break;
default:
var G__22615 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22616 = compiler;
v = G__22615;
compiler = G__22616;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template22550 = (function (opts,id,fn_to_element,parse_fn,meta22551){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22550.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22552,meta22551__$1){
var self__ = this;
var _22552__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22550(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22551__$1));
}));

(reagent.impl.template.t_reagent$impl$template22550.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22552){
var self__ = this;
var _22552__$1 = this;
return self__.meta22551;
}));

(reagent.impl.template.t_reagent$impl$template22550.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22550.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22550.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22550.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22550.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22550.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22551","meta22551",-443177373,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22550.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22550.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22550");

(reagent.impl.template.t_reagent$impl$template22550.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template22550");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22550.
 */
reagent.impl.template.__GT_t_reagent$impl$template22550 = (function reagent$impl$template$__GT_t_reagent$impl$template22550(opts,id,fn_to_element,parse_fn,meta22551){
return (new reagent.impl.template.t_reagent$impl$template22550(opts,id,fn_to_element,parse_fn,meta22551));
});
...
return (new reagent.impl.template.t_reagent$impl$template22550(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
