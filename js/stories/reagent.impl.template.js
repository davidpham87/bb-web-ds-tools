...
var G__22595 = o;
reagent.impl.template.goog$module$goog$object.set(G__22595,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__22746__i = 0, G__22746__a = new Array(arguments.length -  0);
while (G__22746__i < G__22746__a.length) {G__22746__a[G__22746__i] = arguments[G__22746__i + 0]; ++G__22746__i;}
  args = new cljs.core.IndexedSeq(G__22746__a,0,null);
} 
return G__22744__delegate.call(this,args);};
G__22744.cljs$lang$maxFixedArity = 0;
G__22744.cljs$lang$applyTo = (function (arglist__22747){
var args = cljs.core.seq(arglist__22747);
...
var G__22616 = o;
reagent.impl.template.goog$module$goog$object.set(G__22616,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__22770__i < G__22770__a.length) {G__22770__a[G__22770__i] = arguments[G__22770__i + 0]; ++G__22770__i;}
  args = new cljs.core.IndexedSeq(G__22770__a,0,null);
} 
...
var G__22628 = props;
var G__22628__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22628,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22628);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22628__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22629 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22629,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22629;
}
})(),id_class);
...
var temp__5825__auto___22774 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___22774)){
var d_22775 = temp__5825__auto___22774;
if((d_22775 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_22775.s}));
} else {
...
var G__22641 = (cljs.core.count(argv) - first_child);
switch (G__22641) {
case (0):
...
var vec__22659 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22659,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22659,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22659,(2),null);
...
var temp__5829__auto___22785 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22785 == null)){
} else {
var key_22786 = temp__5829__auto___22785;
(jsprops.key = key_22786);
}
...
var temp__5829__auto___22787 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22787 == null)){
} else {
var key_22788 = temp__5829__auto___22787;
(jsprops.key = key_22788);
}
...
var temp__5829__auto___22816 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22816 == null)){
} else {
var key_22820 = temp__5829__auto___22816;
(jsprops.key = key_22820);
}
...
var temp__5829__auto___22824 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___22824 == null)){
} else {
var key_22825 = temp__5829__auto___22824;
(jsprops.key = key_22825);
}
...
var temp__5829__auto___22843 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22843 == null)){
} else {
var key_22844 = temp__5829__auto___22843;
(jsprops.key = key_22844);
}
...
var temp__5829__auto___22845 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22845 == null)){
} else {
var key_22846 = temp__5829__auto___22845;
(jsprops.key = key_22846);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22695_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22695_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22700 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22700,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22700,(1),null);
...
break;
default:
var G__22869 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22870 = compiler;
v = G__22869;
compiler = G__22870;
continue;
...
var G__22711 = tag;
var G__22711__$1 = (((G__22711 instanceof cljs.core.Keyword))?G__22711.fqn:null);
switch (G__22711__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template22719 = (function (opts,id,fn_to_element,parse_fn,meta22720){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22719.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22721,meta22720__$1){
var self__ = this;
var _22721__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22719(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22720__$1));
}));

(reagent.impl.template.t_reagent$impl$template22719.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22721){
var self__ = this;
var _22721__$1 = this;
return self__.meta22720;
}));

(reagent.impl.template.t_reagent$impl$template22719.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22719.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22719.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22719.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22719.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22719.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22720","meta22720",-390189890,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22719.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22719.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22719");

(reagent.impl.template.t_reagent$impl$template22719.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template22719");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22719.
 */
reagent.impl.template.__GT_t_reagent$impl$template22719 = (function reagent$impl$template$__GT_t_reagent$impl$template22719(opts,id,fn_to_element,parse_fn,meta22720){
return (new reagent.impl.template.t_reagent$impl$template22719(opts,id,fn_to_element,parse_fn,meta22720));
});
...
return (new reagent.impl.template.t_reagent$impl$template22719(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
