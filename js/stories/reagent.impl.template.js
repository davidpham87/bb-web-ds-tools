...
var G__22488 = o;
reagent.impl.template.goog$module$goog$object.set(G__22488,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__22589__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__22589 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__22590__i = 0, G__22590__a = new Array(arguments.length -  0);
while (G__22590__i < G__22590__a.length) {G__22590__a[G__22590__i] = arguments[G__22590__i + 0]; ++G__22590__i;}
  args = new cljs.core.IndexedSeq(G__22590__a,0,null);
} 
return G__22589__delegate.call(this,args);};
G__22589.cljs$lang$maxFixedArity = 0;
G__22589.cljs$lang$applyTo = (function (arglist__22591){
var args = cljs.core.seq(arglist__22591);
return G__22589__delegate(args);
});
G__22589.cljs$core$IFn$_invoke$arity$variadic = G__22589__delegate;
return G__22589;
})()
;
} else {
...
var G__22500 = o;
reagent.impl.template.goog$module$goog$object.set(G__22500,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__22593__i < G__22593__a.length) {G__22593__a[G__22593__i] = arguments[G__22593__i + 0]; ++G__22593__i;}
  args = new cljs.core.IndexedSeq(G__22593__a,0,null);
} 
...
var G__22514 = props;
var G__22514__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22514,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22514);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22514__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var temp__5825__auto___22597 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___22597)){
var d_22598 = temp__5825__auto___22597;
if((d_22598 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_22598.s}));
} else {
...
var G__22527 = (cljs.core.count(argv) - first_child);
switch (G__22527) {
case (0):
...
var vec__22533 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22533,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22533,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22533,(2),null);
...
var temp__5829__auto___22600 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22600 == null)){
} else {
var key_22601 = temp__5829__auto___22600;
(jsprops.key = key_22601);
}
...
var temp__5829__auto___22602 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22602 == null)){
} else {
var key_22603 = temp__5829__auto___22602;
(jsprops.key = key_22603);
}
...
var temp__5829__auto___22604 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22604 == null)){
} else {
var key_22605 = temp__5829__auto___22604;
(jsprops.key = key_22605);
}
...
var temp__5829__auto___22607 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___22607 == null)){
} else {
var key_22609 = temp__5829__auto___22607;
...
var key_22613 = temp__5829__auto___22612;
...
var temp__5829__auto___22614 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22614 == null)){
} else {
var key_22615 = temp__5829__auto___22614;
...
var ctx = ({});
var vec__22566 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22566,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22566,(1),null);
...
*/
reagent.impl.template.t_reagent$impl$template22575 = (function (opts,id,fn_to_element,parse_fn,meta22576){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22575.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22577,meta22576__$1){
var self__ = this;
var _22577__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22575(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22576__$1));
}));

(reagent.impl.template.t_reagent$impl$template22575.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22577){
var self__ = this;
var _22577__$1 = this;
return self__.meta22576;
}));

(reagent.impl.template.t_reagent$impl$template22575.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22575.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22575.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22575.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22575.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22575.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22576","meta22576",-1927302903,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22575.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22575.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22575");

(reagent.impl.template.t_reagent$impl$template22575.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template22575");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22575.
 */
reagent.impl.template.__GT_t_reagent$impl$template22575 = (function reagent$impl$template$__GT_t_reagent$impl$template22575(opts,id,fn_to_element,parse_fn,meta22576){
return (new reagent.impl.template.t_reagent$impl$template22575(opts,id,fn_to_element,parse_fn,meta22576));
});
...
return (new reagent.impl.template.t_reagent$impl$template22575(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
