...
var G__22553 = o;
reagent.impl.template.goog$module$goog$object.set(G__22553,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__22600__i < G__22600__a.length) {G__22600__a[G__22600__i] = arguments[G__22600__i + 0]; ++G__22600__i;}
  args = new cljs.core.IndexedSeq(G__22600__a,0,null);
} 
...
var args = cljs.core.seq(arglist__22601);
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__22602__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__22603__i < G__22603__a.length) {G__22603__a[G__22603__i] = arguments[G__22603__i + 0]; ++G__22603__i;}
  args = new cljs.core.IndexedSeq(G__22603__a,0,null);
} 
return G__22602__delegate.call(this,args);};
G__22602.cljs$lang$maxFixedArity = 0;
G__22602.cljs$lang$applyTo = (function (arglist__22604){
var args = cljs.core.seq(arglist__22604);
return G__22602__delegate(args);
});
...
var temp__5825__auto___22608 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___22608)){
var d_22611 = temp__5825__auto___22608;
if((d_22611 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_22611.s}));
} else {
...
var G__22561 = (cljs.core.count(argv) - first_child);
switch (G__22561) {
case (0):
...
var temp__5829__auto___22632 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22632 == null)){
} else {
var key_22633 = temp__5829__auto___22632;
(jsprops.key = key_22633);
}
...
var temp__5829__auto___22636 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22636 == null)){
} else {
var key_22638 = temp__5829__auto___22636;
...
var temp__5829__auto___22644 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___22644 == null)){
} else {
var key_22645 = temp__5829__auto___22644;
(jsprops.key = key_22645);
}
...
var temp__5829__auto___22662 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22662 == null)){
} else {
var key_22663 = temp__5829__auto___22662;
(jsprops.key = key_22663);
}
...
var temp__5829__auto___22664 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22575_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22575_SHARP_);
}),s));
});
...
*/
reagent.impl.template.t_reagent$impl$template22586 = (function (opts,id,fn_to_element,parse_fn,meta22587){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22586.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22588,meta22587__$1){
var self__ = this;
var _22588__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22586(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22587__$1));
}));

(reagent.impl.template.t_reagent$impl$template22586.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22588){
var self__ = this;
var _22588__$1 = this;
return self__.meta22587;
}));

(reagent.impl.template.t_reagent$impl$template22586.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22586.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22586.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22586.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22586.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22586.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22587","meta22587",1915542571,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22586.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22586.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22586");

(reagent.impl.template.t_reagent$impl$template22586.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template22586");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22586.
 */
reagent.impl.template.__GT_t_reagent$impl$template22586 = (function reagent$impl$template$__GT_t_reagent$impl$template22586(opts,id,fn_to_element,parse_fn,meta22587){
return (new reagent.impl.template.t_reagent$impl$template22586(opts,id,fn_to_element,parse_fn,meta22587));
});
...
return (new reagent.impl.template.t_reagent$impl$template22586(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
