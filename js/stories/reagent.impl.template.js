...
var G__22358 = o;
reagent.impl.template.goog$module$goog$object.set(G__22358,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__22426__delegate = function (args){
...
while (G__22427__i < G__22427__a.length) {G__22427__a[G__22427__i] = arguments[G__22427__i + 0]; ++G__22427__i;}
  args = new cljs.core.IndexedSeq(G__22427__a,0,null);
} 
return G__22426__delegate.call(this,args);};
G__22426.cljs$lang$maxFixedArity = 0;
G__22426.cljs$lang$applyTo = (function (arglist__22428){
var args = cljs.core.seq(arglist__22428);
return G__22426__delegate(args);
});
...
var G__22366 = o;
reagent.impl.template.goog$module$goog$object.set(G__22366,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__22431__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__22434__i < G__22434__a.length) {G__22434__a[G__22434__i] = arguments[G__22434__i + 0]; ++G__22434__i;}
  args = new cljs.core.IndexedSeq(G__22434__a,0,null);
} 
return G__22431__delegate.call(this,args);};
G__22431.cljs$lang$maxFixedArity = 0;
G__22431.cljs$lang$applyTo = (function (arglist__22435){
var args = cljs.core.seq(arglist__22435);
...
var G__22367 = props;
var G__22367__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22367,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22367);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22367__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22372 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22372,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22372;
}
})(),id_class);
...
var temp__5825__auto___22438 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___22438)){
var d_22440 = temp__5825__auto___22438;
if((d_22440 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_22440.s}));
} else {
...
var G__22373 = (cljs.core.count(argv) - first_child);
switch (G__22373) {
case (0):
...
var vec__22378 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22378,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22378,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22378,(2),null);
...
var temp__5829__auto___22446 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22446 == null)){
} else {
var key_22447 = temp__5829__auto___22446;
(jsprops.key = key_22447);
}
...
var temp__5829__auto___22451 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22451 == null)){
} else {
var key_22454 = temp__5829__auto___22451;
(jsprops.key = key_22454);
}
...
var temp__5829__auto___22456 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22456 == null)){
} else {
var key_22458 = temp__5829__auto___22456;
(jsprops.key = key_22458);
}
...
var temp__5829__auto___22463 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___22463 == null)){
} else {
var key_22464 = temp__5829__auto___22463;
(jsprops.key = key_22464);
}
...
var temp__5829__auto___22476 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22476 == null)){
} else {
var key_22477 = temp__5829__auto___22476;
(jsprops.key = key_22477);
}
...
var temp__5829__auto___22478 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22478 == null)){
} else {
var key_22495 = temp__5829__auto___22478;
(jsprops.key = key_22495);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22390_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22390_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22395 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22395,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22395,(1),null);
...
break;
default:
var G__22501 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22502 = compiler;
v = G__22501;
compiler = G__22502;
continue;
...
var G__22406 = tag;
var G__22406__$1 = (((G__22406 instanceof cljs.core.Keyword))?G__22406.fqn:null);
switch (G__22406__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template22412 = (function (opts,id,fn_to_element,parse_fn,meta22413){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22412.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22414,meta22413__$1){
var self__ = this;
var _22414__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22412(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22413__$1));
}));

(reagent.impl.template.t_reagent$impl$template22412.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22414){
var self__ = this;
var _22414__$1 = this;
return self__.meta22413;
}));

(reagent.impl.template.t_reagent$impl$template22412.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22412.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22412.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22412.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22412.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22412.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22413","meta22413",-2106388110,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22412.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22412.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22412");

(reagent.impl.template.t_reagent$impl$template22412.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template22412");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22412.
 */
reagent.impl.template.__GT_t_reagent$impl$template22412 = (function reagent$impl$template$__GT_t_reagent$impl$template22412(opts,id,fn_to_element,parse_fn,meta22413){
return (new reagent.impl.template.t_reagent$impl$template22412(opts,id,fn_to_element,parse_fn,meta22413));
});
...
return (new reagent.impl.template.t_reagent$impl$template22412(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
