...
while (G__22715__i < G__22715__a.length) {G__22715__a[G__22715__i] = arguments[G__22715__i + 0]; ++G__22715__i;}
  args = new cljs.core.IndexedSeq(G__22715__a,0,null);
} 
...
var G__22582 = o;
reagent.impl.template.goog$module$goog$object.set(G__22582,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22619 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22619,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22619;
}
})(),id_class);
...
var temp__5825__auto___22730 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___22730)){
var d_22732 = temp__5825__auto___22730;
if((d_22732 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_22732.s}));
} else {
...
var G__22635 = (cljs.core.count(argv) - first_child);
switch (G__22635) {
case (0):
...
var vec__22649 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22649,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22649,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22649,(2),null);
...
var temp__5829__auto___22741 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22741 == null)){
} else {
var key_22742 = temp__5829__auto___22741;
(jsprops.key = key_22742);
}
...
var temp__5829__auto___22743 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22743 == null)){
} else {
var key_22744 = temp__5829__auto___22743;
...
var temp__5829__auto___22745 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22745 == null)){
} else {
var key_22746 = temp__5829__auto___22745;
(jsprops.key = key_22746);
}
...
var temp__5829__auto___22748 = reagent.impl.util.react_key_from_vec(argv);
...
var temp__5829__auto___22757 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22757 == null)){
} else {
var key_22760 = temp__5829__auto___22757;
(jsprops.key = key_22760);
}
...
var temp__5829__auto___22761 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22761 == null)){
} else {
var key_22771 = temp__5829__auto___22761;
(jsprops.key = key_22771);
}
...
var ctx = ({});
var vec__22694 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22694,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22694,(1),null);
...
break;
default:
var G__22784 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22785 = compiler;
v = G__22784;
compiler = G__22785;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template22705 = (function (opts,id,fn_to_element,parse_fn,meta22706){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22705.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22707,meta22706__$1){
var self__ = this;
var _22707__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22705(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22706__$1));
}));

(reagent.impl.template.t_reagent$impl$template22705.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22707){
var self__ = this;
var _22707__$1 = this;
return self__.meta22706;
}));

(reagent.impl.template.t_reagent$impl$template22705.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22705.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22705.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22705.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22705.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22705.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22706","meta22706",-172319497,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22705.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22705.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22705");

(reagent.impl.template.t_reagent$impl$template22705.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template22705");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22705.
 */
reagent.impl.template.__GT_t_reagent$impl$template22705 = (function reagent$impl$template$__GT_t_reagent$impl$template22705(opts,id,fn_to_element,parse_fn,meta22706){
return (new reagent.impl.template.t_reagent$impl$template22705(opts,id,fn_to_element,parse_fn,meta22706));
});
...
return (new reagent.impl.template.t_reagent$impl$template22705(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
