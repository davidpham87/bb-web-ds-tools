...
var G__22404 = o;
reagent.impl.template.goog$module$goog$object.set(G__22404,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__22414 = o;
reagent.impl.template.goog$module$goog$object.set(G__22414,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__22507__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__22508__i < G__22508__a.length) {G__22508__a[G__22508__i] = arguments[G__22508__i + 0]; ++G__22508__i;}
  args = new cljs.core.IndexedSeq(G__22508__a,0,null);
} 
return G__22507__delegate.call(this,args);};
...
return G__22507__delegate(args);
});
...
var G__22419 = props;
var G__22419__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22419,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22419);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22419__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var temp__5825__auto___22513 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___22513)){
var d_22515 = temp__5825__auto___22513;
if((d_22515 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_22515.s}));
} else {
...
var G__22428 = (cljs.core.count(argv) - first_child);
switch (G__22428) {
case (0):
...
var vec__22444 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22444,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22444,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22444,(2),null);
...
var temp__5829__auto___22521 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22521 == null)){
} else {
var key_22522 = temp__5829__auto___22521;
(jsprops.key = key_22522);
}
...
var temp__5829__auto___22523 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22523 == null)){
} else {
var key_22524 = temp__5829__auto___22523;
(jsprops.key = key_22524);
}
...
var temp__5829__auto___22525 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22525 == null)){
} else {
var key_22526 = temp__5829__auto___22525;
(jsprops.key = key_22526);
}
...
var temp__5829__auto___22527 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___22527 == null)){
} else {
var key_22528 = temp__5829__auto___22527;
(jsprops.key = key_22528);
}
...
var temp__5829__auto___22534 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22534 == null)){
} else {
var key_22536 = temp__5829__auto___22534;
(jsprops.key = key_22536);
}
...
var temp__5829__auto___22537 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22537 == null)){
} else {
var key_22538 = temp__5829__auto___22537;
...
var ctx = ({});
var vec__22481 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22481,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22481,(1),null);
...
break;
default:
var G__22546 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22547 = compiler;
v = G__22546;
compiler = G__22547;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template22496 = (function (opts,id,fn_to_element,parse_fn,meta22497){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22496.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22498,meta22497__$1){
var self__ = this;
var _22498__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22496(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22497__$1));
}));

(reagent.impl.template.t_reagent$impl$template22496.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22498){
var self__ = this;
var _22498__$1 = this;
return self__.meta22497;
}));

(reagent.impl.template.t_reagent$impl$template22496.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22496.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22496.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22496.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22496.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22496.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22497","meta22497",438149341,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22496.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22496.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22496");

(reagent.impl.template.t_reagent$impl$template22496.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template22496");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22496.
 */
reagent.impl.template.__GT_t_reagent$impl$template22496 = (function reagent$impl$template$__GT_t_reagent$impl$template22496(opts,id,fn_to_element,parse_fn,meta22497){
return (new reagent.impl.template.t_reagent$impl$template22496(opts,id,fn_to_element,parse_fn,meta22497));
});
...
return (new reagent.impl.template.t_reagent$impl$template22496(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
