...
var G__22484 = o;
reagent.impl.template.goog$module$goog$object.set(G__22484,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__22596__i < G__22596__a.length) {G__22596__a[G__22596__i] = arguments[G__22596__i + 0]; ++G__22596__i;}
  args = new cljs.core.IndexedSeq(G__22596__a,0,null);
} 
...
var G__22488 = o;
reagent.impl.template.goog$module$goog$object.set(G__22488,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__22604__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__22608__i < G__22608__a.length) {G__22608__a[G__22608__i] = arguments[G__22608__i + 0]; ++G__22608__i;}
  args = new cljs.core.IndexedSeq(G__22608__a,0,null);
} 
return G__22604__delegate.call(this,args);};
G__22604.cljs$lang$maxFixedArity = 0;
G__22604.cljs$lang$applyTo = (function (arglist__22609){
var args = cljs.core.seq(arglist__22609);
return G__22604__delegate(args);
});
...
var G__22490 = props;
var G__22490__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22490,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22490);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22490__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22503 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22503,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22503;
}
})(),id_class);
...
var temp__5825__auto___22620 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___22620)){
var d_22622 = temp__5825__auto___22620;
if((d_22622 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_22622.s}));
} else {
...
var G__22524 = (cljs.core.count(argv) - first_child);
switch (G__22524) {
case (0):
...
var vec__22529 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22529,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22529,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22529,(2),null);
...
var temp__5829__auto___22638 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22638 == null)){
} else {
var key_22639 = temp__5829__auto___22638;
(jsprops.key = key_22639);
}
...
var temp__5829__auto___22642 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22642 == null)){
} else {
var key_22643 = temp__5829__auto___22642;
(jsprops.key = key_22643);
}
...
var temp__5829__auto___22653 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22653 == null)){
} else {
var key_22654 = temp__5829__auto___22653;
(jsprops.key = key_22654);
}
...
var temp__5829__auto___22655 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___22655 == null)){
} else {
var key_22657 = temp__5829__auto___22655;
...
var temp__5829__auto___22663 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22663 == null)){
} else {
var key_22664 = temp__5829__auto___22663;
(jsprops.key = key_22664);
}
...
var temp__5829__auto___22667 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22564_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22564_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22565 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22565,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22565,(1),null);
...
break;
default:
var G__22677 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22678 = compiler;
v = G__22677;
compiler = G__22678;
continue;
...
var G__22570 = tag;
var G__22570__$1 = (((G__22570 instanceof cljs.core.Keyword))?G__22570.fqn:null);
switch (G__22570__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template22572 = (function (opts,id,fn_to_element,parse_fn,meta22573){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22572.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22574,meta22573__$1){
var self__ = this;
var _22574__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22572(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22573__$1));
}));

(reagent.impl.template.t_reagent$impl$template22572.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22574){
var self__ = this;
var _22574__$1 = this;
return self__.meta22573;
}));

(reagent.impl.template.t_reagent$impl$template22572.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22572.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22572.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22572.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22572.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22572.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22573","meta22573",376484252,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22572.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22572.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22572");

(reagent.impl.template.t_reagent$impl$template22572.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template22572");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22572.
 */
reagent.impl.template.__GT_t_reagent$impl$template22572 = (function reagent$impl$template$__GT_t_reagent$impl$template22572(opts,id,fn_to_element,parse_fn,meta22573){
return (new reagent.impl.template.t_reagent$impl$template22572(opts,id,fn_to_element,parse_fn,meta22573));
});
...
return (new reagent.impl.template.t_reagent$impl$template22572(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
