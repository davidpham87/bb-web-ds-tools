...
var G__22552 = o;
reagent.impl.template.goog$module$goog$object.set(G__22552,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__22558 = props;
var G__22558__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22558,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22558);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22558__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22559 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22559,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22559;
}
})(),id_class);
...
var temp__5825__auto___22601 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___22601)){
var d_22602 = temp__5825__auto___22601;
if((d_22602 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_22602.s}));
} else {
...
var G__22560 = (cljs.core.count(argv) - first_child);
switch (G__22560) {
case (0):
...
var temp__5829__auto___22609 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22609 == null)){
} else {
var key_22610 = temp__5829__auto___22609;
(jsprops.key = key_22610);
}
...
var temp__5829__auto___22611 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22611 == null)){
} else {
var key_22612 = temp__5829__auto___22611;
(jsprops.key = key_22612);
}
...
var temp__5829__auto___22613 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22613 == null)){
} else {
var key_22614 = temp__5829__auto___22613;
(jsprops.key = key_22614);
}
...
var temp__5829__auto___22617 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___22617 == null)){
} else {
var key_22618 = temp__5829__auto___22617;
(jsprops.key = key_22618);
}
...
var temp__5829__auto___22620 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22620 == null)){
} else {
var key_22621 = temp__5829__auto___22620;
(jsprops.key = key_22621);
}
...
var temp__5829__auto___22623 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22623 == null)){
} else {
var key_22624 = temp__5829__auto___22623;
(jsprops.key = key_22624);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22565_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22565_SHARP_);
}),s));
});
...
break;
default:
var G__22629 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22630 = compiler;
v = G__22629;
compiler = G__22630;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template22578 = (function (opts,id,fn_to_element,parse_fn,meta22579){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22578.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22580,meta22579__$1){
var self__ = this;
var _22580__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22578(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22579__$1));
}));

(reagent.impl.template.t_reagent$impl$template22578.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22580){
var self__ = this;
var _22580__$1 = this;
return self__.meta22579;
}));

(reagent.impl.template.t_reagent$impl$template22578.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22578.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22578.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22578.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22578.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22578.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22579","meta22579",93894790,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22578.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22578.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22578");

(reagent.impl.template.t_reagent$impl$template22578.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template22578");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22578.
 */
reagent.impl.template.__GT_t_reagent$impl$template22578 = (function reagent$impl$template$__GT_t_reagent$impl$template22578(opts,id,fn_to_element,parse_fn,meta22579){
return (new reagent.impl.template.t_reagent$impl$template22578(opts,id,fn_to_element,parse_fn,meta22579));
});
...
return (new reagent.impl.template.t_reagent$impl$template22578(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
