...
var G__22605 = o;
reagent.impl.template.goog$module$goog$object.set(G__22605,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
G__22749.cljs$lang$applyTo = (function (arglist__22753){
...
var G__22622 = o;
reagent.impl.template.goog$module$goog$object.set(G__22622,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__22754__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__22755__i < G__22755__a.length) {G__22755__a[G__22755__i] = arguments[G__22755__i + 0]; ++G__22755__i;}
  args = new cljs.core.IndexedSeq(G__22755__a,0,null);
} 
return G__22754__delegate.call(this,args);};
G__22754.cljs$lang$maxFixedArity = 0;
G__22754.cljs$lang$applyTo = (function (arglist__22756){
var args = cljs.core.seq(arglist__22756);
return G__22754__delegate(args);
});
...
var G__22634 = props;
var G__22634__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22634,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22634);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22634__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var temp__5825__auto___22757 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___22757)){
var d_22758 = temp__5825__auto___22757;
if((d_22758 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_22758.s}));
} else {
...
var G__22651 = (cljs.core.count(argv) - first_child);
switch (G__22651) {
case (0):
...
var vec__22664 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22664,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22664,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22664,(2),null);
...
var temp__5829__auto___22765 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22765 == null)){
} else {
var key_22766 = temp__5829__auto___22765;
(jsprops.key = key_22766);
}
...
var temp__5829__auto___22767 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22767 == null)){
} else {
var key_22768 = temp__5829__auto___22767;
(jsprops.key = key_22768);
}
...
var temp__5829__auto___22769 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22769 == null)){
} else {
var key_22770 = temp__5829__auto___22769;
(jsprops.key = key_22770);
}
...
var temp__5829__auto___22774 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___22774 == null)){
} else {
var key_22775 = temp__5829__auto___22774;
(jsprops.key = key_22775);
}
...
var temp__5829__auto___22783 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22783 == null)){
} else {
var key_22784 = temp__5829__auto___22783;
(jsprops.key = key_22784);
}
...
var temp__5829__auto___22786 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22786 == null)){
} else {
var key_22788 = temp__5829__auto___22786;
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22698_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22698_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22703 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22703,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22703,(1),null);
...
break;
default:
var G__22797 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22798 = compiler;
v = G__22797;
compiler = G__22798;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template22724 = (function (opts,id,fn_to_element,parse_fn,meta22725){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22724.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22726,meta22725__$1){
var self__ = this;
var _22726__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22724(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22725__$1));
}));

(reagent.impl.template.t_reagent$impl$template22724.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22726){
var self__ = this;
var _22726__$1 = this;
return self__.meta22725;
}));

(reagent.impl.template.t_reagent$impl$template22724.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22724.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22724.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22724.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22724.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22724.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22725","meta22725",570795464,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22724.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22724.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22724");

(reagent.impl.template.t_reagent$impl$template22724.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template22724");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22724.
 */
reagent.impl.template.__GT_t_reagent$impl$template22724 = (function reagent$impl$template$__GT_t_reagent$impl$template22724(opts,id,fn_to_element,parse_fn,meta22725){
return (new reagent.impl.template.t_reagent$impl$template22724(opts,id,fn_to_element,parse_fn,meta22725));
});
...
return (new reagent.impl.template.t_reagent$impl$template22724(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
