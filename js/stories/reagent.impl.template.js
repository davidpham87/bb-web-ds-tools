...
var G__22563 = o;
reagent.impl.template.goog$module$goog$object.set(G__22563,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__22712__delegate = function (args){
...
while (G__22713__i < G__22713__a.length) {G__22713__a[G__22713__i] = arguments[G__22713__i + 0]; ++G__22713__i;}
  args = new cljs.core.IndexedSeq(G__22713__a,0,null);
} 
return G__22712__delegate.call(this,args);};
G__22712.cljs$lang$maxFixedArity = 0;
G__22712.cljs$lang$applyTo = (function (arglist__22714){
var args = cljs.core.seq(arglist__22714);
return G__22712__delegate(args);
});
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__22717__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__22717 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__22718__i < G__22718__a.length) {G__22718__a[G__22718__i] = arguments[G__22718__i + 0]; ++G__22718__i;}
  args = new cljs.core.IndexedSeq(G__22718__a,0,null);
} 
return G__22717__delegate.call(this,args);};
G__22717.cljs$lang$maxFixedArity = 0;
G__22717.cljs$lang$applyTo = (function (arglist__22719){
var args = cljs.core.seq(arglist__22719);
return G__22717__delegate(args);
});
...
var temp__5825__auto___22724 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___22724)){
var d_22725 = temp__5825__auto___22724;
if((d_22725 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_22725.s}));
} else {
...
var vec__22590 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22590,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22590,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22590,(2),null);
...
var temp__5829__auto___22729 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22729 == null)){
} else {
var key_22731 = temp__5829__auto___22729;
(jsprops.key = key_22731);
}
...
var temp__5829__auto___22734 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22734 == null)){
} else {
var key_22735 = temp__5829__auto___22734;
(jsprops.key = key_22735);
}
...
var temp__5829__auto___22737 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22737 == null)){
} else {
var key_22739 = temp__5829__auto___22737;
(jsprops.key = key_22739);
}
...
var temp__5829__auto___22746 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___22746 == null)){
} else {
var key_22747 = temp__5829__auto___22746;
(jsprops.key = key_22747);
}
...
var temp__5829__auto___22754 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22754 == null)){
} else {
var key_22755 = temp__5829__auto___22754;
(jsprops.key = key_22755);
}
...
var temp__5829__auto___22758 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22758 == null)){
} else {
var key_22759 = temp__5829__auto___22758;
(jsprops.key = key_22759);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22636_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22636_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22641 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22641,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22641,(1),null);
...
break;
default:
var G__22768 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22769 = compiler;
v = G__22768;
compiler = G__22769;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template22697 = (function (opts,id,fn_to_element,parse_fn,meta22698){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22697.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22699,meta22698__$1){
var self__ = this;
var _22699__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22697(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22698__$1));
}));

(reagent.impl.template.t_reagent$impl$template22697.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22699){
var self__ = this;
var _22699__$1 = this;
return self__.meta22698;
}));

(reagent.impl.template.t_reagent$impl$template22697.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22697.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22697.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22697.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22697.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22697.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22698","meta22698",1875019752,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22697.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22697.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22697");

(reagent.impl.template.t_reagent$impl$template22697.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template22697");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22697.
 */
reagent.impl.template.__GT_t_reagent$impl$template22697 = (function reagent$impl$template$__GT_t_reagent$impl$template22697(opts,id,fn_to_element,parse_fn,meta22698){
return (new reagent.impl.template.t_reagent$impl$template22697(opts,id,fn_to_element,parse_fn,meta22698));
});
...
return (new reagent.impl.template.t_reagent$impl$template22697(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
