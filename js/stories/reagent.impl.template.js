...
var G__22472 = o;
reagent.impl.template.goog$module$goog$object.set(G__22472,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__22513__i = 0, G__22513__a = new Array(arguments.length -  0);
while (G__22513__i < G__22513__a.length) {G__22513__a[G__22513__i] = arguments[G__22513__i + 0]; ++G__22513__i;}
  args = new cljs.core.IndexedSeq(G__22513__a,0,null);
} 
return G__22512__delegate.call(this,args);};
G__22512.cljs$lang$maxFixedArity = 0;
G__22512.cljs$lang$applyTo = (function (arglist__22514){
var args = cljs.core.seq(arglist__22514);
...
var G__22473 = o;
reagent.impl.template.goog$module$goog$object.set(G__22473,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__22523__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__22524__i < G__22524__a.length) {G__22524__a[G__22524__i] = arguments[G__22524__i + 0]; ++G__22524__i;}
  args = new cljs.core.IndexedSeq(G__22524__a,0,null);
} 
return G__22523__delegate.call(this,args);};
G__22523.cljs$lang$maxFixedArity = 0;
G__22523.cljs$lang$applyTo = (function (arglist__22525){
var args = cljs.core.seq(arglist__22525);
return G__22523__delegate(args);
});
...
var G__22480 = props;
var G__22480__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22480,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22480);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22480__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22483 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22483,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22483;
}
})(),id_class);
...
var temp__5825__auto___22538 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___22538)){
var d_22541 = temp__5825__auto___22538;
if((d_22541 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_22541.s}));
} else {
...
var G__22484 = (cljs.core.count(argv) - first_child);
switch (G__22484) {
case (0):
...
var vec__22485 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22485,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22485,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22485,(2),null);
...
var temp__5829__auto___22562 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22562 == null)){
} else {
var key_22563 = temp__5829__auto___22562;
(jsprops.key = key_22563);
}
...
var temp__5829__auto___22564 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22564 == null)){
} else {
var key_22565 = temp__5829__auto___22564;
(jsprops.key = key_22565);
}
...
var temp__5829__auto___22574 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22574 == null)){
} else {
var key_22575 = temp__5829__auto___22574;
(jsprops.key = key_22575);
}
...
var temp__5829__auto___22576 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___22576 == null)){
} else {
var key_22577 = temp__5829__auto___22576;
(jsprops.key = key_22577);
}
...
var temp__5829__auto___22596 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22596 == null)){
} else {
var key_22597 = temp__5829__auto___22596;
(jsprops.key = key_22597);
}
...
var temp__5829__auto___22612 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22612 == null)){
} else {
var key_22615 = temp__5829__auto___22612;
(jsprops.key = key_22615);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22491_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22491_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22493 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22493,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22493,(1),null);
...
break;
default:
var G__22641 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22642 = compiler;
v = G__22641;
compiler = G__22642;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template22501 = (function (opts,id,fn_to_element,parse_fn,meta22502){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22501.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22503,meta22502__$1){
var self__ = this;
var _22503__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22501(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22502__$1));
}));

(reagent.impl.template.t_reagent$impl$template22501.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22503){
var self__ = this;
var _22503__$1 = this;
return self__.meta22502;
}));

(reagent.impl.template.t_reagent$impl$template22501.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22501.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22501.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22501.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22501.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22501.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22502","meta22502",1842581124,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22501.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22501.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22501");

(reagent.impl.template.t_reagent$impl$template22501.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template22501");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22501.
 */
reagent.impl.template.__GT_t_reagent$impl$template22501 = (function reagent$impl$template$__GT_t_reagent$impl$template22501(opts,id,fn_to_element,parse_fn,meta22502){
return (new reagent.impl.template.t_reagent$impl$template22501(opts,id,fn_to_element,parse_fn,meta22502));
});
...
return (new reagent.impl.template.t_reagent$impl$template22501(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
