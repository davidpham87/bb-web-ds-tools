...
if((!((next_attr == null)))){
var G__49891 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(attrs,next_attr);
attrs = G__49891;
continue;
} else {
 ...
 * avet     :: [<index in eavt> ...]
 */
datascript.serialize.serializable_impl = (function datascript$serialize$serializable_impl(db,p__49813){
var map__49814 = p__49813;
var map__49814__$1 = cljs.core.__destructure_map(map__49814);
var freeze_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__49814__$1,new cljs.core.Keyword(null,"freeze-fn","freeze-fn",-575885995),cljs.core.pr_str);
var freeze_kw = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__49814__$1,new cljs.core.Keyword(null,"freeze-kw","freeze-kw",391758233),datascript.serialize.freeze_kw);
...
var schema = (function (){var G__49836 = new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1(db);
return (freeze_fn.cljs$core$IFn$_invoke$arity$1 ? freeze_fn.cljs$core$IFn$_invoke$arity$1(G__49836) : freeze_fn.call(null,G__49836));
})();
...
var pred__49877 = cljs.core._EQ__EQ_;
var expr__49878 = marker;
if(cljs.core.truth_((pred__49877.cljs$core$IFn$_invoke$arity$2 ? pred__49877.cljs$core$IFn$_invoke$arity$2((0),expr__49878) : pred__49877.call(null,(0),expr__49878)))){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(keywords,datascript.serialize.array_get(v,(1)));
} else {
if(cljs.core.truth_((pred__49877.cljs$core$IFn$_invoke$arity$2 ? pred__49877.cljs$core$IFn$_invoke$arity$2((1),expr__49878) : pred__49877.call(null,(1),expr__49878)))){
var G__49880 = datascript.serialize.array_get(v,(1));
return (thaw_fn.cljs$core$IFn$_invoke$arity$1 ? thaw_fn.cljs$core$IFn$_invoke$arity$1(G__49880) : thaw_fn.call(null,G__49880));
} else {
if(cljs.core.truth_((pred__49877.cljs$core$IFn$_invoke$arity$2 ? pred__49877.cljs$core$IFn$_invoke$arity$2((2),expr__49878) : pred__49877.call(null,(2),expr__49878)))){
return Infinity;
} else {
if(cljs.core.truth_((pred__49877.cljs$core$IFn$_invoke$arity$2 ? pred__49877.cljs$core$IFn$_invoke$arity$2((3),expr__49878) : pred__49877.call(null,(3),expr__49878)))){
return -Infinity;
} else {
if(cljs.core.truth_((pred__49877.cljs$core$IFn$_invoke$arity$2 ? pred__49877.cljs$core$IFn$_invoke$arity$2((4),expr__49878) : pred__49877.call(null,(4),expr__49878)))){
return NaN;
} else {
...
var aevt = (function (){var G__49881 = datascript.serialize.dict_get(from,"aevt");
if((G__49881 == null)){
return null;
} else {
return datascript.serialize.amap((function (p1__49851_SHARP_){
return (eavt[p1__49851_SHARP_]);
}),G__49881);
}
})();
var avet = (function (){var G__49882 = datascript.serialize.dict_get(from,"avet");
if((G__49882 == null)){
return null;
} else {
return datascript.serialize.amap((function (p1__49852_SHARP_){
return (eavt[p1__49852_SHARP_]);
}),G__49882);
}
})();
var settings = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"branching-factor","branching-factor",1903198601),datascript.serialize.dict_get(from,"branching-factor"),new cljs.core.Keyword(null,"ref-type","ref-type",-1367328851),(function (){var G__49883 = datascript.serialize.dict_get(from,"ref-type");
if((G__49883 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__49883);
}
