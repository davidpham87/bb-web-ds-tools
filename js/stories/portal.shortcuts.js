...
if(cljs.core.truth_((function (){var fexpr__36998 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["Mac68K",null,"Macintosh",null,"MacPPC",null,"MacIntel",null], null), null);
return (fexpr__36998.cljs$core$IFn$_invoke$arity$1 ? fexpr__36998.cljs$core$IFn$_invoke$arity$1(platform) : fexpr__36998.call(null,platform));
})())){
return new cljs.core.Keyword("portal.shortcuts","osx","portal.shortcuts/osx",300522451);
} else {
if(cljs.core.truth_((function (){var fexpr__36999 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["WinCE",null,"Windows",null,"Win32",null,"Win64",null], null), null);
return (fexpr__36999.cljs$core$IFn$_invoke$arity$1 ? fexpr__36999.cljs$core$IFn$_invoke$arity$1(platform) : fexpr__36999.call(null,platform));
})())){
...
var iter__5503__auto__ = (function portal$shortcuts$log__GT_seq_$_iter__37005(s__37006){
return (new cljs.core.LazySeq(null,(function (){
var s__37006__$1 = s__37006;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__37006__$1);
if(temp__5825__auto__){
var s__37006__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__37006__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__37006__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__37008 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__37007 = (0);
while(true){
if((i__37007 < size__5502__auto__)){
var n = cljs.core._nth(c__5501__auto__,i__37007);
cljs.core.chunk_append(b__37008,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.reverse(cljs.core.take.cljs$core$IFn$_invoke$arity$2(n,log__$1))));

var G__37033 = (i__37007 + (1));
i__37007 = G__37033;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37008),portal$shortcuts$log__GT_seq_$_iter__37005(cljs.core.chunk_rest(s__37006__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37008),null);
}
} else {
var n = cljs.core.first(s__37006__$2);
return cljs.core.cons(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.reverse(cljs.core.take.cljs$core$IFn$_invoke$arity$2(n,log__$1))),portal$shortcuts$log__GT_seq_$_iter__37005(cljs.core.rest(s__37006__$2)));
}
} else {
return null;
}
...
var G__37013 = cljs.core.PersistentHashSet.createAsIfByAssoc([portal.shortcuts.event__GT_key(e)]);
var G__37013__$1 = (cljs.core.truth_(e.ctrlKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__37013,"control"):G__37013);
var G__37013__$2 = (cljs.core.truth_(e.metaKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__37013__$1,"meta"):G__37013__$1);
var G__37013__$3 = (cljs.core.truth_(e.shiftKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__37013__$2,"shift"):G__37013__$2);
if(cljs.core.truth_(e.altKey)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__37013__$3,"alt");
} else {
return G__37013__$3;
}
} else {
...
return cljs.core.some((function (p1__37018_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(mapping,p1__37018_SHARP_);
...
if(cljs.core.truth_(temp__5825__auto__)){
var e = temp__5825__auto__;
var G__37020 = e.target.tagName;
var fexpr__37019 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["SELECT",null,"INPUT",null,"BUTTON",null,"TEXTAREA",null], null), null);
return (fexpr__37019.cljs$core$IFn$_invoke$arity$1 ? fexpr__37019.cljs$core$IFn$_invoke$arity$1(G__37020) : fexpr__37019.call(null,G__37020));
} else {
return null;
}
});
portal.shortcuts.keydown = (function portal$shortcuts$keydown(e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(portal.shortcuts.log,(function (p1__37021_SHARP_){
return cljs.core.take.cljs$core$IFn$_invoke$arity$2((5),cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__37021_SHARP_,e));
}));
...
return window.addEventListener("keydown",(function (p1__37022_SHARP_){
return portal.shortcuts.keydown(p1__37022_SHARP_);
}));
} else {
return null;
}
