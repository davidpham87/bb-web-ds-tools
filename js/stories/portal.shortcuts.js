...
if(cljs.core.truth_((function (){var fexpr__36905 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["Mac68K",null,"Macintosh",null,"MacPPC",null,"MacIntel",null], null), null);
return (fexpr__36905.cljs$core$IFn$_invoke$arity$1 ? fexpr__36905.cljs$core$IFn$_invoke$arity$1(platform) : fexpr__36905.call(null,platform));
})())){
return new cljs.core.Keyword("portal.shortcuts","osx","portal.shortcuts/osx",300522451);
} else {
if(cljs.core.truth_((function (){var fexpr__36906 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["WinCE",null,"Windows",null,"Win32",null,"Win64",null], null), null);
return (fexpr__36906.cljs$core$IFn$_invoke$arity$1 ? fexpr__36906.cljs$core$IFn$_invoke$arity$1(platform) : fexpr__36906.call(null,platform));
})())){
...
var iter__5503__auto__ = (function portal$shortcuts$log__GT_seq_$_iter__36909(s__36910){
return (new cljs.core.LazySeq(null,(function (){
var s__36910__$1 = s__36910;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__36910__$1);
if(temp__5825__auto__){
var s__36910__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__36910__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__36910__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__36912 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__36911 = (0);
while(true){
if((i__36911 < size__5502__auto__)){
var n = cljs.core._nth(c__5501__auto__,i__36911);
cljs.core.chunk_append(b__36912,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.reverse(cljs.core.take.cljs$core$IFn$_invoke$arity$2(n,log__$1))));

var G__36936 = (i__36911 + (1));
i__36911 = G__36936;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__36912),portal$shortcuts$log__GT_seq_$_iter__36909(cljs.core.chunk_rest(s__36910__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__36912),null);
}
} else {
var n = cljs.core.first(s__36910__$2);
return cljs.core.cons(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.reverse(cljs.core.take.cljs$core$IFn$_invoke$arity$2(n,log__$1))),portal$shortcuts$log__GT_seq_$_iter__36909(cljs.core.rest(s__36910__$2)));
}
} else {
return null;
}
...
var G__36915 = cljs.core.PersistentHashSet.createAsIfByAssoc([portal.shortcuts.event__GT_key(e)]);
var G__36915__$1 = (cljs.core.truth_(e.ctrlKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__36915,"control"):G__36915);
var G__36915__$2 = (cljs.core.truth_(e.metaKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__36915__$1,"meta"):G__36915__$1);
var G__36915__$3 = (cljs.core.truth_(e.shiftKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__36915__$2,"shift"):G__36915__$2);
if(cljs.core.truth_(e.altKey)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__36915__$3,"alt");
} else {
return G__36915__$3;
}
} else {
...
return cljs.core.some((function (p1__36920_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(mapping,p1__36920_SHARP_);
...
if(cljs.core.truth_(temp__5825__auto__)){
var e = temp__5825__auto__;
var G__36923 = e.target.tagName;
var fexpr__36922 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["SELECT",null,"INPUT",null,"BUTTON",null,"TEXTAREA",null], null), null);
return (fexpr__36922.cljs$core$IFn$_invoke$arity$1 ? fexpr__36922.cljs$core$IFn$_invoke$arity$1(G__36923) : fexpr__36922.call(null,G__36923));
} else {
return null;
}
});
portal.shortcuts.keydown = (function portal$shortcuts$keydown(e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(portal.shortcuts.log,(function (p1__36924_SHARP_){
return cljs.core.take.cljs$core$IFn$_invoke$arity$2((5),cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__36924_SHARP_,e));
}));
...
return window.addEventListener("keydown",(function (p1__36927_SHARP_){
return portal.shortcuts.keydown(p1__36927_SHARP_);
}));
} else {
return null;
}
