...
if(cljs.core.truth_((function (){var fexpr__36989 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["Mac68K",null,"Macintosh",null,"MacPPC",null,"MacIntel",null], null), null);
return (fexpr__36989.cljs$core$IFn$_invoke$arity$1 ? fexpr__36989.cljs$core$IFn$_invoke$arity$1(platform) : fexpr__36989.call(null,platform));
})())){
return new cljs.core.Keyword("portal.shortcuts","osx","portal.shortcuts/osx",300522451);
} else {
if(cljs.core.truth_((function (){var fexpr__36990 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["WinCE",null,"Windows",null,"Win32",null,"Win64",null], null), null);
return (fexpr__36990.cljs$core$IFn$_invoke$arity$1 ? fexpr__36990.cljs$core$IFn$_invoke$arity$1(platform) : fexpr__36990.call(null,platform));
})())){
...
var G__37000 = cljs.core.PersistentHashSet.createAsIfByAssoc([portal.shortcuts.event__GT_key(e)]);
var G__37000__$1 = (cljs.core.truth_(e.ctrlKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__37000,"control"):G__37000);
var G__37000__$2 = (cljs.core.truth_(e.metaKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__37000__$1,"meta"):G__37000__$1);
var G__37000__$3 = (cljs.core.truth_(e.shiftKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__37000__$2,"shift"):G__37000__$2);
if(cljs.core.truth_(e.altKey)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__37000__$3,"alt");
} else {
return G__37000__$3;
}
} else {
...
return cljs.core.some((function (p1__37003_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(mapping,p1__37003_SHARP_);
...
if(cljs.core.truth_(temp__5825__auto__)){
var e = temp__5825__auto__;
var G__37008 = e.target.tagName;
var fexpr__37007 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["SELECT",null,"INPUT",null,"BUTTON",null,"TEXTAREA",null], null), null);
return (fexpr__37007.cljs$core$IFn$_invoke$arity$1 ? fexpr__37007.cljs$core$IFn$_invoke$arity$1(G__37008) : fexpr__37007.call(null,G__37008));
} else {
return null;
}
});
portal.shortcuts.keydown = (function portal$shortcuts$keydown(e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(portal.shortcuts.log,(function (p1__37009_SHARP_){
return cljs.core.take.cljs$core$IFn$_invoke$arity$2((5),cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__37009_SHARP_,e));
}));
...
return window.addEventListener("keydown",(function (p1__37011_SHARP_){
return portal.shortcuts.keydown(p1__37011_SHARP_);
}));
} else {
return null;
}
