...
if(cljs.core.truth_((function (){var fexpr__37249 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["Mac68K",null,"Macintosh",null,"MacPPC",null,"MacIntel",null], null), null);
return (fexpr__37249.cljs$core$IFn$_invoke$arity$1 ? fexpr__37249.cljs$core$IFn$_invoke$arity$1(platform) : fexpr__37249.call(null,platform));
})())){
return new cljs.core.Keyword("portal.shortcuts","osx","portal.shortcuts/osx",300522451);
} else {
if(cljs.core.truth_((function (){var fexpr__37250 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["WinCE",null,"Windows",null,"Win32",null,"Win64",null], null), null);
return (fexpr__37250.cljs$core$IFn$_invoke$arity$1 ? fexpr__37250.cljs$core$IFn$_invoke$arity$1(platform) : fexpr__37250.call(null,platform));
})())){
...
var iter__5503__auto__ = (function portal$shortcuts$log__GT_seq_$_iter__37252(s__37253){
...
var n = cljs.core._nth(c__5501__auto__,i__37254);
cljs.core.chunk_append(b__37255,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.reverse(cljs.core.take.cljs$core$IFn$_invoke$arity$2(n,log__$1))));

var G__37273 = (i__37254 + (1));
i__37254 = G__37273;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37255),portal$shortcuts$log__GT_seq_$_iter__37252(cljs.core.chunk_rest(s__37253__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37255),null);
}
} else {
var n = cljs.core.first(s__37253__$2);
return cljs.core.cons(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.reverse(cljs.core.take.cljs$core$IFn$_invoke$arity$2(n,log__$1))),portal$shortcuts$log__GT_seq_$_iter__37252(cljs.core.rest(s__37253__$2)));
}
} else {
return null;
}
...
var G__37258 = cljs.core.PersistentHashSet.createAsIfByAssoc([portal.shortcuts.event__GT_key(e)]);
var G__37258__$1 = (cljs.core.truth_(e.ctrlKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__37258,"control"):G__37258);
var G__37258__$2 = (cljs.core.truth_(e.metaKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__37258__$1,"meta"):G__37258__$1);
var G__37258__$3 = (cljs.core.truth_(e.shiftKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__37258__$2,"shift"):G__37258__$2);
if(cljs.core.truth_(e.altKey)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__37258__$3,"alt");
} else {
return G__37258__$3;
}
} else {
...
return cljs.core.some((function (p1__37261_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(mapping,p1__37261_SHARP_);
...
if(cljs.core.truth_(temp__5825__auto__)){
var e = temp__5825__auto__;
var G__37263 = e.target.tagName;
var fexpr__37262 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["SELECT",null,"INPUT",null,"BUTTON",null,"TEXTAREA",null], null), null);
return (fexpr__37262.cljs$core$IFn$_invoke$arity$1 ? fexpr__37262.cljs$core$IFn$_invoke$arity$1(G__37263) : fexpr__37262.call(null,G__37263));
} else {
return null;
}
});
portal.shortcuts.keydown = (function portal$shortcuts$keydown(e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(portal.shortcuts.log,(function (p1__37266_SHARP_){
return cljs.core.take.cljs$core$IFn$_invoke$arity$2((5),cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__37266_SHARP_,e));
}));
...
return window.addEventListener("keydown",(function (p1__37267_SHARP_){
return portal.shortcuts.keydown(p1__37267_SHARP_);
}));
} else {
return null;
}
