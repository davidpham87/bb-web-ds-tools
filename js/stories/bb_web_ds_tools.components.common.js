...
/** @this {Function} */
(bb_web_ds_tools.components.common.button_xs.cljs$lang$applyTo = (function (seq24758){
...
/** @this {Function} */
(bb_web_ds_tools.components.common.button_info.cljs$lang$applyTo = (function (seq24765){
 ...
 *  vector: A hiccup vector.
 */
bb_web_ds_tools.components.common.input = (function bb_web_ds_tools$components$common$input(p__24781){
var map__24782 = p__24781;
var map__24782__$1 = cljs.core.__destructure_map(map__24782);
var props = map__24782__$1;
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24782__$1,new cljs.core.Keyword(null,"value","value",305978217));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24782__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var on_change_event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24782__$1,new cljs.core.Keyword(null,"on-change-event","on-change-event",-1723026359));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24782__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24782__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24782__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var checked = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24782__$1,new cljs.core.Keyword(null,"checked","checked",-50955819));
...
/** @this {Function} */
(bb_web_ds_tools.components.common.th.cljs$lang$applyTo = (function (seq24837){
...
/** @this {Function} */
(bb_web_ds_tools.components.common.td.cljs$lang$applyTo = (function (seq24842){
var G__24843 = cljs.core.first(seq24842);
var seq24842__$1 = cljs.core.next(seq24842);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24843,seq24842__$1);
}));
...
var on_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24869__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
cljs.core.chunk_append(b__24868,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),["flex items-center px-4 py-2 cursor-pointer border-t border-l border-r rounded-t-md min-w-fit ",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,active_tab_id))?[bb_web_ds_tools.theme.bg_card," ",bb_web_ds_tools.theme.border_default," ",bb_web_ds_tools.theme.text_accent," -mb-px pb-2.5 z-10"].join(''):[bb_web_ds_tools.theme.bg_input," border-transparent ",bb_web_ds_tools.theme.text_secondary," hover:bg-opacity-80 pb-2 mb-0 opacity-70 hover:opacity-100"].join(''))].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__24867,map__24869,map__24869__$1,id,label,on_close,c__5501__auto__,size__5502__auto__,b__24868,s__24859__$2,temp__5825__auto__,map__24857,map__24857__$1,tabs,active_tab_id,on_change,on_add,class$){
return (function (){
if(cljs.core.truth_(on_change)){
...
});})(i__24867,map__24869,map__24869__$1,id,label,on_close,c__5501__auto__,size__5502__auto__,b__24868,s__24859__$2,temp__5825__auto__,map__24857,map__24857__$1,tabs,active_tab_id,on_change,on_add,class$))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__24868),bb_web_ds_tools$components$common$tabs_$_iter__24858(cljs.core.chunk_rest(s__24859__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__24868),null);
}
} else {
var map__24872 = cljs.core.first(s__24859__$2);
var map__24872__$1 = cljs.core.__destructure_map(map__24872);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24872__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24872__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var on_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24872__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),["flex items-center px-4 py-2 cursor-pointer border-t border-l border-r rounded-t-md min-w-fit ",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,active_tab_id))?[bb_web_ds_tools.theme.bg_card," ",bb_web_ds_tools.theme.border_default," ",bb_web_ds_tools.theme.text_accent," -mb-px pb-2.5 z-10"].join(''):[bb_web_ds_tools.theme.bg_input," border-transparent ",bb_web_ds_tools.theme.text_secondary," hover:bg-opacity-80 pb-2 mb-0 opacity-70 hover:opacity-100"].join(''))].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__24872,map__24872__$1,id,label,on_close,s__24859__$2,temp__5825__auto__,map__24857,map__24857__$1,tabs,active_tab_id,on_change,on_add,class$){
return (function (){
if(cljs.core.truth_(on_change)){
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(id) : on_change.call(null,id));
} else {
...
});})(map__24872,map__24872__$1,id,label,on_close,s__24859__$2,temp__5825__auto__,map__24857,map__24857__$1,tabs,active_tab_id,on_change,on_add,class$))
], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"whitespace-nowrap font-medium text-sm"], null),label], null),(cljs.core.truth_(on_close)?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),["ml-2 p-0.5 rounded hover:bg-white/10 ",bb_web_ds_tools.theme.text_muted," hover:text-red-400 transition-colors"].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__24872,map__24872__$1,id,label,on_close,s__24859__$2,temp__5825__auto__,map__24857,map__24857__$1,tabs,active_tab_id,on_change,on_add,class$){
return (function (e){
e.stopPropagation();
 ...
 *  vector: A hiccup vector.
 */
bb_web_ds_tools.components.common.nav_tabs = (function bb_web_ds_tools$components$common$nav_tabs(p__24873){
var map__24874 = p__24873;
var map__24874__$1 = cljs.core.__destructure_map(map__24874);
var tabs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24874__$1,new cljs.core.Keyword(null,"tabs","tabs",-779855354));
var active_tab_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24874__$1,new cljs.core.Keyword(null,"active-tab-id","active-tab-id",1961631694));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24874__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24874__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),["flex flex-row space-x-6 border-b ",bb_web_ds_tools.theme.border_default," px-4 ",bb_web_ds_tools.theme.bg_toolbar," shrink-0 ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(class$)].join('')], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$components$common$nav_tabs_$_iter__24875(s__24876){
return (new cljs.core.LazySeq(null,(function (){
var s__24876__$1 = s__24876;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__24876__$1);
if(temp__5825__auto__){
var s__24876__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__24876__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__24876__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__24878 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__24877 = (0);
while(true){
if((i__24877 < size__5502__auto__)){
var map__24879 = cljs.core._nth(c__5501__auto__,i__24877);
...
});})(i__24877,map__24879,map__24879__$1,id,label,c__5501__auto__,size__5502__auto__,b__24878,s__24876__$2,temp__5825__auto__,map__24874,map__24874__$1,tabs,active_tab_id,on_change,class$))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__24878),bb_web_ds_tools$components$common$nav_tabs_$_iter__24875(cljs.core.chunk_rest(s__24876__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__24878),null);
}
} else {
var map__24890 = cljs.core.first(s__24876__$2);
var map__24890__$1 = cljs.core.__destructure_map(map__24890);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24890__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24890__$1,new cljs.core.Keyword(null,"label","label",1718410804));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),["py-3 font-medium transition-colors border-b-2 ",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(active_tab_id,id))?["border-[#f0dfaf] ",bb_web_ds_tools.theme.text_accent].join(''):["border-transparent ",bb_web_ds_tools.theme.text_secondary," hover:text-[#dcdccc]"].join(''))].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__24890,map__24890__$1,id,label,s__24876__$2,temp__5825__auto__,map__24874,map__24874__$1,tabs,active_tab_id,on_change,class$){
return (function (){
if(cljs.core.truth_(on_change)){
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(id) : on_change.call(null,id));
} else {
...
});})(map__24890,map__24890__$1,id,label,s__24876__$2,temp__5825__auto__,map__24874,map__24874__$1,tabs,active_tab_id,on_change,class$))
], null),label], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.str.cljs$core$IFn$_invoke$arity$1(id)], null)),bb_web_ds_tools$components$common$nav_tabs_$_iter__24875(cljs.core.rest(s__24876__$2)));
}
} else {
return null;
}
