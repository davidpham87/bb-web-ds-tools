...
var G__48974 = db;
var G__48975 = e;
var G__48976 = cljs.core.volatile_BANG_(false);
var G__48977 = cljs.core.volatile_BANG_(cljs.core.PersistentArrayMap.EMPTY);
return (datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4 ? datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4(G__48974,G__48975,G__48976,G__48977) : datascript.impl.entity.__GT_Entity.call(null,G__48974,G__48975,G__48976,G__48977));
} else {
return null;
}
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__48978_SHARP_,p2__48979_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__48978_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__48979_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
} else {
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__48980_SHARP_,p2__48981_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__48980_SHARP_,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__48981_SHARP_));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
if(datascript.db.ref_QMARK_(db,a)){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__48982_SHARP_,p2__48983_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__48982_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"e","e",1381269198).cljs$core$IFn$_invoke$arity$1(p2__48983_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
return not_found;
...
var iter__5503__auto__ = (function datascript$impl$entity$js_seq_$_iter__48984(s__48985){
return (new cljs.core.LazySeq(null,(function (){
var s__48985__$1 = s__48985;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__48985__$1);
if(temp__5825__auto__){
var s__48985__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__48985__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__48985__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__48987 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__48986 = (0);
while(true){
if((i__48986 < size__5502__auto__)){
var vec__48988 = cljs.core._nth(c__5501__auto__,i__48986);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48988,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48988,(1),null);
cljs.core.chunk_append(b__48987,((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)));

var G__49072 = (i__48986 + (1));
i__48986 = G__49072;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__48987),datascript$impl$entity$js_seq_$_iter__48984(cljs.core.chunk_rest(s__48985__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__48987),null);
}
} else {
var vec__48991 = cljs.core.first(s__48985__$2);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48991,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48991,(1),null);
return cljs.core.cons(((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)),datascript$impl$entity$js_seq_$_iter__48984(cljs.core.rest(s__48985__$2)));
}
} else {
return null;
}
...
var G__49073 = null;
var G__49073__1 = (function (f){
var self__ = this;
var this$ = this;
var seq__48999 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__49000 = null;
var count__49001 = (0);
var i__49002 = (0);
while(true){
if((i__49002 < count__49001)){
var vec__49010 = chunk__49000.cljs$core$IIndexed$_nth$arity$2(null,i__49002);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49010,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49010,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__49075 = seq__48999;
var G__49076 = chunk__49000;
var G__49077 = count__49001;
var G__49078 = (i__49002 + (1));
seq__48999 = G__49075;
chunk__49000 = G__49076;
count__49001 = G__49077;
i__49002 = G__49078;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__48999);
if(temp__5825__auto__){
var seq__48999__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__48999__$1)){
var c__5548__auto__ = cljs.core.chunk_first(seq__48999__$1);
var G__49079 = cljs.core.chunk_rest(seq__48999__$1);
var G__49080 = c__5548__auto__;
var G__49081 = cljs.core.count(c__5548__auto__);
var G__49082 = (0);
seq__48999 = G__49079;
chunk__49000 = G__49080;
count__49001 = G__49081;
i__49002 = G__49082;
continue;
} else {
var vec__49013 = cljs.core.first(seq__48999__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49013,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49013,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__49083 = cljs.core.next(seq__48999__$1);
var G__49084 = null;
var G__49085 = (0);
var G__49086 = (0);
seq__48999 = G__49083;
chunk__49000 = G__49084;
count__49001 = G__49085;
i__49002 = G__49086;
continue;
}
} else {
...
var G__49073__2 = (function (f,use_as_this){
var self__ = this;
var this$ = this;
var seq__49016 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__49017 = null;
var count__49018 = (0);
var i__49019 = (0);
while(true){
if((i__49019 < count__49018)){
var vec__49026 = chunk__49017.cljs$core$IIndexed$_nth$arity$2(null,i__49019);
...
var G__49088 = seq__49016;
var G__49089 = chunk__49017;
var G__49090 = count__49018;
var G__49091 = (i__49019 + (1));
seq__49016 = G__49088;
chunk__49017 = G__49089;
count__49018 = G__49090;
i__49019 = G__49091;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__49016);
if(temp__5825__auto__){
var seq__49016__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__49016__$1)){
var c__5548__auto__ = cljs.core.chunk_first(seq__49016__$1);
var G__49092 = cljs.core.chunk_rest(seq__49016__$1);
var G__49093 = c__5548__auto__;
var G__49094 = cljs.core.count(c__5548__auto__);
var G__49095 = (0);
seq__49016 = G__49092;
chunk__49017 = G__49093;
count__49018 = G__49094;
i__49019 = G__49095;
continue;
} else {
var vec__49029 = cljs.core.first(seq__49016__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49029,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49029,(1),null);
f.call(use_as_this,v,a,this$);


var G__49096 = cljs.core.next(seq__49016__$1);
var G__49097 = null;
var G__49098 = (0);
var G__49099 = (0);
seq__49016 = G__49096;
chunk__49017 = G__49097;
count__49018 = G__49098;
i__49019 = G__49099;
continue;
}
} else {
...
G__49073 = function(f,use_as_this){
switch(arguments.length){
case 1:
return G__49073__1.call(this,f);
case 2:
return G__49073__2.call(this,f,use_as_this);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__49073.cljs$core$IFn$_invoke$arity$1 = G__49073__1;
G__49073.cljs$core$IFn$_invoke$arity$2 = G__49073__2;
return G__49073;
})()
);
...
var G__49033 = (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2(this$,attr) : datascript.impl.entity.lookup_entity.call(null,this$,attr));
if(datascript.db.multival_QMARK_(self__.db,attr)){
return datascript.impl.entity.multival__GT_js(G__49033);
} else {
return G__49033;
}
}
...
var self__ = this;
var self__ = this;
var G__49041 = (arguments.length - (1));
switch (G__49041) {
case (1):
...
(datascript.impl.entity.Entity.prototype.apply = (function (self__,args48996){
var self__ = this;
var self____$1 = this;
...
var temp__5827__auto__ = (function (){var fexpr__49044 = cljs.core.deref(this$.cache);
return (fexpr__49044.cljs$core$IFn$_invoke$arity$1 ? fexpr__49044.cljs$core$IFn$_invoke$arity$1(attr) : fexpr__49044.call(null,attr));
})();
...
var temp__5825__auto___49103 = cljs.core.not_empty(datascript.db._search(e.db,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [e.eid], null)));
if(cljs.core.truth_(temp__5825__auto___49103)){
var datoms_49104 = temp__5825__auto___49103;
cljs.core.vreset_BANG_(e.cache,datascript.impl.entity.touch_components(e.db,datascript.impl.entity.datoms__GT_cache(e.db,datoms_49104)));
