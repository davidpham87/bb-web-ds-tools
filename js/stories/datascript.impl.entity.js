...
var G__49292 = db;
var G__49293 = e;
var G__49294 = cljs.core.volatile_BANG_(false);
var G__49295 = cljs.core.volatile_BANG_(cljs.core.PersistentArrayMap.EMPTY);
return (datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4 ? datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4(G__49292,G__49293,G__49294,G__49295) : datascript.impl.entity.__GT_Entity.call(null,G__49292,G__49293,G__49294,G__49295));
} else {
return null;
}
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__49297_SHARP_,p2__49298_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__49297_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__49298_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
} else {
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__49299_SHARP_,p2__49300_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__49299_SHARP_,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__49300_SHARP_));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
if(datascript.db.ref_QMARK_(db,a)){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__49301_SHARP_,p2__49302_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__49301_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"e","e",1381269198).cljs$core$IFn$_invoke$arity$1(p2__49302_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
return not_found;
...
var iter__5503__auto__ = (function datascript$impl$entity$js_seq_$_iter__49304(s__49305){
return (new cljs.core.LazySeq(null,(function (){
var s__49305__$1 = s__49305;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__49305__$1);
if(temp__5825__auto__){
var s__49305__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__49305__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__49305__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__49307 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__49306 = (0);
while(true){
if((i__49306 < size__5502__auto__)){
var vec__49315 = cljs.core._nth(c__5501__auto__,i__49306);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49315,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49315,(1),null);
cljs.core.chunk_append(b__49307,((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)));

var G__49400 = (i__49306 + (1));
i__49306 = G__49400;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49307),datascript$impl$entity$js_seq_$_iter__49304(cljs.core.chunk_rest(s__49305__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49307),null);
}
} else {
var vec__49318 = cljs.core.first(s__49305__$2);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49318,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49318,(1),null);
return cljs.core.cons(((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)),datascript$impl$entity$js_seq_$_iter__49304(cljs.core.rest(s__49305__$2)));
}
} else {
return null;
}
...
var G__49407 = null;
var G__49407__1 = (function (f){
var self__ = this;
var this$ = this;
var seq__49322 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__49323 = null;
var count__49324 = (0);
var i__49325 = (0);
while(true){
if((i__49325 < count__49324)){
var vec__49342 = chunk__49323.cljs$core$IIndexed$_nth$arity$2(null,i__49325);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49342,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49342,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__49421 = seq__49322;
var G__49422 = chunk__49323;
var G__49423 = count__49324;
var G__49424 = (i__49325 + (1));
seq__49322 = G__49421;
chunk__49323 = G__49422;
count__49324 = G__49423;
i__49325 = G__49424;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__49322);
if(temp__5825__auto__){
var seq__49322__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__49322__$1)){
var c__5548__auto__ = cljs.core.chunk_first(seq__49322__$1);
var G__49425 = cljs.core.chunk_rest(seq__49322__$1);
var G__49426 = c__5548__auto__;
var G__49427 = cljs.core.count(c__5548__auto__);
var G__49428 = (0);
seq__49322 = G__49425;
chunk__49323 = G__49426;
count__49324 = G__49427;
i__49325 = G__49428;
continue;
} else {
var vec__49355 = cljs.core.first(seq__49322__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49355,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49355,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__49437 = cljs.core.next(seq__49322__$1);
var G__49438 = null;
var G__49439 = (0);
var G__49440 = (0);
seq__49322 = G__49437;
chunk__49323 = G__49438;
count__49324 = G__49439;
i__49325 = G__49440;
continue;
}
} else {
...
var G__49407__2 = (function (f,use_as_this){
var self__ = this;
var this$ = this;
var seq__49358 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__49359 = null;
var count__49360 = (0);
var i__49361 = (0);
while(true){
if((i__49361 < count__49360)){
var vec__49370 = chunk__49359.cljs$core$IIndexed$_nth$arity$2(null,i__49361);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49370,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49370,(1),null);
f.call(use_as_this,v,a,this$);


var G__49446 = seq__49358;
var G__49447 = chunk__49359;
var G__49448 = count__49360;
var G__49449 = (i__49361 + (1));
seq__49358 = G__49446;
chunk__49359 = G__49447;
count__49360 = G__49448;
i__49361 = G__49449;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__49358);
if(temp__5825__auto__){
var seq__49358__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__49358__$1)){
var c__5548__auto__ = cljs.core.chunk_first(seq__49358__$1);
var G__49450 = cljs.core.chunk_rest(seq__49358__$1);
var G__49451 = c__5548__auto__;
var G__49452 = cljs.core.count(c__5548__auto__);
var G__49453 = (0);
seq__49358 = G__49450;
chunk__49359 = G__49451;
count__49360 = G__49452;
i__49361 = G__49453;
continue;
} else {
var vec__49374 = cljs.core.first(seq__49358__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49374,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49374,(1),null);
f.call(use_as_this,v,a,this$);


var G__49454 = cljs.core.next(seq__49358__$1);
var G__49455 = null;
var G__49456 = (0);
var G__49457 = (0);
seq__49358 = G__49454;
chunk__49359 = G__49455;
count__49360 = G__49456;
i__49361 = G__49457;
continue;
}
} else {
...
G__49407 = function(f,use_as_this){
switch(arguments.length){
case 1:
return G__49407__1.call(this,f);
case 2:
return G__49407__2.call(this,f,use_as_this);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__49407.cljs$core$IFn$_invoke$arity$1 = G__49407__1;
G__49407.cljs$core$IFn$_invoke$arity$2 = G__49407__2;
return G__49407;
})()
);
...
var G__49378 = (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2(this$,attr) : datascript.impl.entity.lookup_entity.call(null,this$,attr));
if(datascript.db.multival_QMARK_(self__.db,attr)){
return datascript.impl.entity.multival__GT_js(G__49378);
} else {
return G__49378;
}
}
...
var self__ = this;
var self__ = this;
var G__49383 = (arguments.length - (1));
switch (G__49383) {
case (1):
...
(datascript.impl.entity.Entity.prototype.apply = (function (self__,args49321){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args49321)));
}));
...
var temp__5827__auto__ = (function (){var fexpr__49387 = cljs.core.deref(this$.cache);
return (fexpr__49387.cljs$core$IFn$_invoke$arity$1 ? fexpr__49387.cljs$core$IFn$_invoke$arity$1(attr) : fexpr__49387.call(null,attr));
})();
...
var temp__5825__auto___49504 = cljs.core.not_empty(datascript.db._search(e.db,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [e.eid], null)));
if(cljs.core.truth_(temp__5825__auto___49504)){
var datoms_49505 = temp__5825__auto___49504;
cljs.core.vreset_BANG_(e.cache,datascript.impl.entity.touch_components(e.db,datascript.impl.entity.datoms__GT_cache(e.db,datoms_49505)));
