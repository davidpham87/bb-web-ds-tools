...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-dispatch-logic","fork.re-frame/server-dispatch-logic",-1023921676),(function (db,p__25146){
var vec__25147 = p__25146;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25147,(0),null);
var config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25147,(1),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25147,(2),null);
...
var G__25150 = db;
var G__25150__$1 = ((cljs.core.seq(input_names))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__25150,path,(function (m){
...
return cljs.core.assoc_in(G__25150__$1,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"server","server",1499190120),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(config),new cljs.core.Keyword(null,"waiting?","waiting?",-2117257215)], null)),true);
} else {
return G__25150__$1;
}
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-set-waiting","fork.re-frame/server-set-waiting",-1277872097),(function (db,p__25159){
var vec__25160 = p__25159;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25160,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25160,(1),null);
var input_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25160,(2),null);
var bool = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25160,(3),null);
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("fork.re-frame","db","fork.re-frame/db",503486154),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__25163){
var vec__25164 = p__25163;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25164,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25164,(1),null);
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,path);
})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","clean","fork.re-frame/clean",-448599170),(function (db,p__25167){
var vec__25168 = p__25167;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25168,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25168,(1),null);
...
var G__25189__delegate = function (ks){
...
while (G__25190__i < G__25190__a.length) {G__25190__a[G__25190__i] = arguments[G__25190__i + 0]; ++G__25190__i;}
  ks = new cljs.core.IndexedSeq(G__25190__a,0,null);
} 
return G__25189__delegate.call(this,ks);};
G__25189.cljs$lang$maxFixedArity = 0;
G__25189.cljs$lang$applyTo = (function (arglist__25191){
var ks = cljs.core.seq(arglist__25191);
return G__25189__delegate(ks);
});
G__25189.cljs$core$IFn$_invoke$arity$variadic = G__25189__delegate;
return G__25189;
})()
,(function (p1__25181_SHARP_){
return fork.core.handle_blur(p1__25181_SHARP_,state);
}),(function (p1__25175_SHARP_){
return fork.core.set_values(p1__25175_SHARP_,state);
}),(function (p1__25180_SHARP_){
return fork.core.handle_change(p1__25180_SHARP_,state);
}),(function() { 
var G__25192__delegate = function (ks){
...
while (G__25193__i < G__25193__a.length) {G__25193__a[G__25193__i] = arguments[G__25193__i + 0]; ++G__25193__i;}
  ks = new cljs.core.IndexedSeq(G__25193__a,0,null);
} 
return G__25192__delegate.call(this,ks);};
G__25192.cljs$lang$maxFixedArity = 0;
G__25192.cljs$lang$applyTo = (function (arglist__25194){
var ks = cljs.core.seq(arglist__25194);
return G__25192__delegate(ks);
});
G__25192.cljs$core$IFn$_invoke$arity$variadic = G__25192__delegate;
return G__25192;
})()
,(function() { 
var G__25195__delegate = function (ks){
...
while (G__25196__i < G__25196__a.length) {G__25196__a[G__25196__i] = arguments[G__25196__i + 0]; ++G__25196__i;}
  ks = new cljs.core.IndexedSeq(G__25196__a,0,null);
} 
return G__25195__delegate.call(this,ks);};
G__25195.cljs$lang$maxFixedArity = 0;
G__25195.cljs$lang$applyTo = (function (arglist__25197){
var ks = cljs.core.seq(arglist__25197);
return G__25195__delegate(ks);
});
G__25195.cljs$core$IFn$_invoke$arity$variadic = G__25195__delegate;
return G__25195;
})()
,(function() { 
var G__25198__delegate = function (p__25185){
var vec__25186 = p__25185;
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25186,(0),null);
...
while (G__25199__i < G__25199__a.length) {G__25199__a[G__25199__i] = arguments[G__25199__i + 0]; ++G__25199__i;}
  p__25185 = new cljs.core.IndexedSeq(G__25199__a,0,null);
} 
return G__25198__delegate.call(this,p__25185);};
G__25198.cljs$lang$maxFixedArity = 0;
G__25198.cljs$lang$applyTo = (function (arglist__25200){
var p__25185 = cljs.core.seq(arglist__25200);
return G__25198__delegate(p__25185);
});
G__25198.cljs$core$IFn$_invoke$arity$variadic = G__25198__delegate;
return G__25198;
})()
,(function (p1__25179_SHARP_){
return fork.core.set_handle_blur(p1__25179_SHARP_,state);
}),(function() { 
var G__25201__delegate = function (ks){
...
while (G__25202__i < G__25202__a.length) {G__25202__a[G__25202__i] = arguments[G__25202__i + 0]; ++G__25202__i;}
  ks = new cljs.core.IndexedSeq(G__25202__a,0,null);
} 
return G__25201__delegate.call(this,ks);};
G__25201.cljs$lang$maxFixedArity = 0;
G__25201.cljs$lang$applyTo = (function (arglist__25203){
var ks = cljs.core.seq(arglist__25203);
return G__25201__delegate(ks);
});
...
}),(function (p1__25177_SHARP_){
return fork.core.normalize_name(p1__25177_SHARP_,props);
...
return fork.core.set_handle_change(p1__25178_SHARP_,state);
}),(function (p1__25176_SHARP_){
return fork.core.disabled_QMARK_(state,p1__25176_SHARP_);
})]);
