...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-dispatch-logic","fork.re-frame/server-dispatch-logic",-1023921676),(function (db,p__25001){
var vec__25002 = p__25001;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25002,(0),null);
var config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25002,(1),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25002,(2),null);
...
var G__25005 = db;
var G__25005__$1 = ((cljs.core.seq(input_names))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__25005,path,(function (m){
...
return cljs.core.assoc_in(G__25005__$1,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"server","server",1499190120),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(config),new cljs.core.Keyword(null,"waiting?","waiting?",-2117257215)], null)),true);
} else {
return G__25005__$1;
}
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-set-waiting","fork.re-frame/server-set-waiting",-1277872097),(function (db,p__25006){
var vec__25007 = p__25006;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25007,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25007,(1),null);
var input_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25007,(2),null);
var bool = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25007,(3),null);
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("fork.re-frame","db","fork.re-frame/db",503486154),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__25010){
var vec__25011 = p__25010;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25011,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25011,(1),null);
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,path);
})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","clean","fork.re-frame/clean",-448599170),(function (db,p__25014){
var vec__25015 = p__25014;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25015,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25015,(1),null);
...
,(function (p1__25026_SHARP_){
return fork.core.handle_blur(p1__25026_SHARP_,state);
}),(function (p1__25020_SHARP_){
return fork.core.set_values(p1__25020_SHARP_,state);
}),(function (p1__25025_SHARP_){
return fork.core.handle_change(p1__25025_SHARP_,state);
}),(function() { 
...
,(function() { 
var G__25059__delegate = function (p__25032){
...
while (G__25060__i < G__25060__a.length) {G__25060__a[G__25060__i] = arguments[G__25060__i + 0]; ++G__25060__i;}
  p__25032 = new cljs.core.IndexedSeq(G__25060__a,0,null);
} 
return G__25059__delegate.call(this,p__25032);};
G__25059.cljs$lang$maxFixedArity = 0;
G__25059.cljs$lang$applyTo = (function (arglist__25061){
var p__25032 = cljs.core.seq(arglist__25061);
return G__25059__delegate(p__25032);
});
G__25059.cljs$core$IFn$_invoke$arity$variadic = G__25059__delegate;
return G__25059;
})()
,(function (p1__25024_SHARP_){
return fork.core.set_handle_blur(p1__25024_SHARP_,state);
}),(function() { 
var G__25062__delegate = function (ks){
...
while (G__25063__i < G__25063__a.length) {G__25063__a[G__25063__i] = arguments[G__25063__i + 0]; ++G__25063__i;}
  ks = new cljs.core.IndexedSeq(G__25063__a,0,null);
} 
return G__25062__delegate.call(this,ks);};
G__25062.cljs$lang$maxFixedArity = 0;
G__25062.cljs$lang$applyTo = (function (arglist__25064){
var ks = cljs.core.seq(arglist__25064);
return G__25062__delegate(ks);
});
...
}),(function (p1__25022_SHARP_){
return fork.core.normalize_name(p1__25022_SHARP_,props);
...
}),(function (p1__25023_SHARP_){
return fork.core.set_handle_change(p1__25023_SHARP_,state);
}),(function (p1__25021_SHARP_){
return fork.core.disabled_QMARK_(state,p1__25021_SHARP_);
})]);
