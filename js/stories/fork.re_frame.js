...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-dispatch-logic","fork.re-frame/server-dispatch-logic",-1023921676),(function (db,p__25396){
var vec__25397 = p__25396;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25397,(0),null);
var config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25397,(1),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25397,(2),null);
...
var G__25411 = db;
var G__25411__$1 = ((cljs.core.seq(input_names))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__25411,path,(function (m){
...
return cljs.core.assoc_in(G__25411__$1,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"server","server",1499190120),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(config),new cljs.core.Keyword(null,"waiting?","waiting?",-2117257215)], null)),true);
} else {
return G__25411__$1;
}
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-set-waiting","fork.re-frame/server-set-waiting",-1277872097),(function (db,p__25412){
var vec__25413 = p__25412;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25413,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25413,(1),null);
var input_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25413,(2),null);
var bool = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25413,(3),null);
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("fork.re-frame","db","fork.re-frame/db",503486154),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__25418){
var vec__25419 = p__25418;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25419,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25419,(1),null);
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,path);
})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","clean","fork.re-frame/clean",-448599170),(function (db,p__25422){
var vec__25423 = p__25422;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25423,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25423,(1),null);
...
var G__25446__delegate = function (ks){
...
while (G__25447__i < G__25447__a.length) {G__25447__a[G__25447__i] = arguments[G__25447__i + 0]; ++G__25447__i;}
  ks = new cljs.core.IndexedSeq(G__25447__a,0,null);
} 
return G__25446__delegate.call(this,ks);};
G__25446.cljs$lang$maxFixedArity = 0;
G__25446.cljs$lang$applyTo = (function (arglist__25448){
var ks = cljs.core.seq(arglist__25448);
return G__25446__delegate(ks);
});
G__25446.cljs$core$IFn$_invoke$arity$variadic = G__25446__delegate;
return G__25446;
})()
,(function (p1__25432_SHARP_){
return fork.core.handle_blur(p1__25432_SHARP_,state);
}),(function (p1__25426_SHARP_){
return fork.core.set_values(p1__25426_SHARP_,state);
}),(function (p1__25431_SHARP_){
return fork.core.handle_change(p1__25431_SHARP_,state);
}),(function() { 
var G__25449__delegate = function (ks){
...
while (G__25450__i < G__25450__a.length) {G__25450__a[G__25450__i] = arguments[G__25450__i + 0]; ++G__25450__i;}
  ks = new cljs.core.IndexedSeq(G__25450__a,0,null);
} 
return G__25449__delegate.call(this,ks);};
G__25449.cljs$lang$maxFixedArity = 0;
G__25449.cljs$lang$applyTo = (function (arglist__25451){
var ks = cljs.core.seq(arglist__25451);
return G__25449__delegate(ks);
});
G__25449.cljs$core$IFn$_invoke$arity$variadic = G__25449__delegate;
return G__25449;
})()
,(function() { 
var G__25452__delegate = function (ks){
...
while (G__25453__i < G__25453__a.length) {G__25453__a[G__25453__i] = arguments[G__25453__i + 0]; ++G__25453__i;}
  ks = new cljs.core.IndexedSeq(G__25453__a,0,null);
} 
return G__25452__delegate.call(this,ks);};
G__25452.cljs$lang$maxFixedArity = 0;
G__25452.cljs$lang$applyTo = (function (arglist__25454){
var ks = cljs.core.seq(arglist__25454);
return G__25452__delegate(ks);
});
G__25452.cljs$core$IFn$_invoke$arity$variadic = G__25452__delegate;
return G__25452;
})()
,(function() { 
var G__25455__delegate = function (p__25436){
var vec__25437 = p__25436;
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25437,(0),null);
...
while (G__25456__i < G__25456__a.length) {G__25456__a[G__25456__i] = arguments[G__25456__i + 0]; ++G__25456__i;}
  p__25436 = new cljs.core.IndexedSeq(G__25456__a,0,null);
} 
return G__25455__delegate.call(this,p__25436);};
G__25455.cljs$lang$maxFixedArity = 0;
G__25455.cljs$lang$applyTo = (function (arglist__25457){
var p__25436 = cljs.core.seq(arglist__25457);
return G__25455__delegate(p__25436);
});
G__25455.cljs$core$IFn$_invoke$arity$variadic = G__25455__delegate;
return G__25455;
})()
,(function (p1__25430_SHARP_){
return fork.core.set_handle_blur(p1__25430_SHARP_,state);
}),(function() { 
var G__25458__delegate = function (ks){
...
while (G__25459__i < G__25459__a.length) {G__25459__a[G__25459__i] = arguments[G__25459__i + 0]; ++G__25459__i;}
  ks = new cljs.core.IndexedSeq(G__25459__a,0,null);
} 
return G__25458__delegate.call(this,ks);};
G__25458.cljs$lang$maxFixedArity = 0;
G__25458.cljs$lang$applyTo = (function (arglist__25460){
var ks = cljs.core.seq(arglist__25460);
return G__25458__delegate(ks);
});
...
}),(function (p1__25428_SHARP_){
return fork.core.normalize_name(p1__25428_SHARP_,props);
...
}),(function (p1__25429_SHARP_){
return fork.core.set_handle_change(p1__25429_SHARP_,state);
}),(function (p1__25427_SHARP_){
return fork.core.disabled_QMARK_(state,p1__25427_SHARP_);
})]);
