...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-dispatch-logic","fork.re-frame/server-dispatch-logic",-1023921676),(function (db,p__25214){
var vec__25215 = p__25214;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25215,(0),null);
var config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25215,(1),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25215,(2),null);
...
var G__25221 = db;
var G__25221__$1 = ((cljs.core.seq(input_names))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__25221,path,(function (m){
...
return cljs.core.assoc_in(G__25221__$1,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"server","server",1499190120),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(config),new cljs.core.Keyword(null,"waiting?","waiting?",-2117257215)], null)),true);
} else {
return G__25221__$1;
}
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-set-waiting","fork.re-frame/server-set-waiting",-1277872097),(function (db,p__25222){
var vec__25223 = p__25222;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25223,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25223,(1),null);
var input_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25223,(2),null);
var bool = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25223,(3),null);
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("fork.re-frame","db","fork.re-frame/db",503486154),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__25226){
var vec__25227 = p__25226;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25227,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25227,(1),null);
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,path);
})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","clean","fork.re-frame/clean",-448599170),(function (db,p__25230){
var vec__25231 = p__25230;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25231,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25231,(1),null);
...
var G__25248__delegate = function (ks){
...
while (G__25249__i < G__25249__a.length) {G__25249__a[G__25249__i] = arguments[G__25249__i + 0]; ++G__25249__i;}
  ks = new cljs.core.IndexedSeq(G__25249__a,0,null);
} 
return G__25248__delegate.call(this,ks);};
G__25248.cljs$lang$maxFixedArity = 0;
G__25248.cljs$lang$applyTo = (function (arglist__25250){
var ks = cljs.core.seq(arglist__25250);
return G__25248__delegate(ks);
});
G__25248.cljs$core$IFn$_invoke$arity$variadic = G__25248__delegate;
return G__25248;
})()
,(function (p1__25240_SHARP_){
return fork.core.handle_blur(p1__25240_SHARP_,state);
}),(function (p1__25234_SHARP_){
return fork.core.set_values(p1__25234_SHARP_,state);
}),(function (p1__25239_SHARP_){
return fork.core.handle_change(p1__25239_SHARP_,state);
}),(function() { 
var G__25251__delegate = function (ks){
...
while (G__25252__i < G__25252__a.length) {G__25252__a[G__25252__i] = arguments[G__25252__i + 0]; ++G__25252__i;}
  ks = new cljs.core.IndexedSeq(G__25252__a,0,null);
} 
return G__25251__delegate.call(this,ks);};
G__25251.cljs$lang$maxFixedArity = 0;
G__25251.cljs$lang$applyTo = (function (arglist__25253){
var ks = cljs.core.seq(arglist__25253);
return G__25251__delegate(ks);
});
G__25251.cljs$core$IFn$_invoke$arity$variadic = G__25251__delegate;
return G__25251;
})()
,(function() { 
var G__25254__delegate = function (ks){
...
while (G__25255__i < G__25255__a.length) {G__25255__a[G__25255__i] = arguments[G__25255__i + 0]; ++G__25255__i;}
  ks = new cljs.core.IndexedSeq(G__25255__a,0,null);
} 
return G__25254__delegate.call(this,ks);};
G__25254.cljs$lang$maxFixedArity = 0;
G__25254.cljs$lang$applyTo = (function (arglist__25256){
var ks = cljs.core.seq(arglist__25256);
return G__25254__delegate(ks);
});
G__25254.cljs$core$IFn$_invoke$arity$variadic = G__25254__delegate;
return G__25254;
})()
,(function() { 
var G__25257__delegate = function (p__25242){
var vec__25243 = p__25242;
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25243,(0),null);
...
while (G__25258__i < G__25258__a.length) {G__25258__a[G__25258__i] = arguments[G__25258__i + 0]; ++G__25258__i;}
  p__25242 = new cljs.core.IndexedSeq(G__25258__a,0,null);
} 
return G__25257__delegate.call(this,p__25242);};
G__25257.cljs$lang$maxFixedArity = 0;
G__25257.cljs$lang$applyTo = (function (arglist__25259){
var p__25242 = cljs.core.seq(arglist__25259);
return G__25257__delegate(p__25242);
});
G__25257.cljs$core$IFn$_invoke$arity$variadic = G__25257__delegate;
return G__25257;
})()
,(function (p1__25238_SHARP_){
return fork.core.set_handle_blur(p1__25238_SHARP_,state);
}),(function() { 
var G__25260__delegate = function (ks){
...
while (G__25261__i < G__25261__a.length) {G__25261__a[G__25261__i] = arguments[G__25261__i + 0]; ++G__25261__i;}
  ks = new cljs.core.IndexedSeq(G__25261__a,0,null);
} 
return G__25260__delegate.call(this,ks);};
G__25260.cljs$lang$maxFixedArity = 0;
G__25260.cljs$lang$applyTo = (function (arglist__25262){
var ks = cljs.core.seq(arglist__25262);
return G__25260__delegate(ks);
});
...
}),(function (p1__25236_SHARP_){
return fork.core.normalize_name(p1__25236_SHARP_,props);
...
}),(function (p1__25237_SHARP_){
return fork.core.set_handle_change(p1__25237_SHARP_,state);
}),(function (p1__25235_SHARP_){
return fork.core.disabled_QMARK_(state,p1__25235_SHARP_);
})]);
