...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-dispatch-logic","fork.re-frame/server-dispatch-logic",-1023921676),(function (db,p__25169){
var vec__25170 = p__25169;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25170,(0),null);
var config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25170,(1),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25170,(2),null);
...
var G__25173 = db;
var G__25173__$1 = ((cljs.core.seq(input_names))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__25173,path,(function (m){
...
return cljs.core.assoc_in(G__25173__$1,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"server","server",1499190120),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(config),new cljs.core.Keyword(null,"waiting?","waiting?",-2117257215)], null)),true);
} else {
return G__25173__$1;
}
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-set-waiting","fork.re-frame/server-set-waiting",-1277872097),(function (db,p__25176){
var vec__25177 = p__25176;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25177,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25177,(1),null);
var input_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25177,(2),null);
var bool = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25177,(3),null);
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("fork.re-frame","db","fork.re-frame/db",503486154),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__25180){
var vec__25181 = p__25180;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25181,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25181,(1),null);
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,path);
})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","clean","fork.re-frame/clean",-448599170),(function (db,p__25184){
var vec__25185 = p__25184;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25185,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25185,(1),null);
...
var G__25208__delegate = function (ks){
...
while (G__25209__i < G__25209__a.length) {G__25209__a[G__25209__i] = arguments[G__25209__i + 0]; ++G__25209__i;}
  ks = new cljs.core.IndexedSeq(G__25209__a,0,null);
} 
return G__25208__delegate.call(this,ks);};
G__25208.cljs$lang$maxFixedArity = 0;
G__25208.cljs$lang$applyTo = (function (arglist__25210){
var ks = cljs.core.seq(arglist__25210);
return G__25208__delegate(ks);
});
G__25208.cljs$core$IFn$_invoke$arity$variadic = G__25208__delegate;
return G__25208;
})()
,(function (p1__25194_SHARP_){
return fork.core.handle_blur(p1__25194_SHARP_,state);
}),(function (p1__25188_SHARP_){
return fork.core.set_values(p1__25188_SHARP_,state);
}),(function (p1__25193_SHARP_){
return fork.core.handle_change(p1__25193_SHARP_,state);
}),(function() { 
var G__25214__delegate = function (ks){
...
while (G__25215__i < G__25215__a.length) {G__25215__a[G__25215__i] = arguments[G__25215__i + 0]; ++G__25215__i;}
  ks = new cljs.core.IndexedSeq(G__25215__a,0,null);
} 
return G__25214__delegate.call(this,ks);};
G__25214.cljs$lang$maxFixedArity = 0;
G__25214.cljs$lang$applyTo = (function (arglist__25216){
var ks = cljs.core.seq(arglist__25216);
return G__25214__delegate(ks);
});
G__25214.cljs$core$IFn$_invoke$arity$variadic = G__25214__delegate;
return G__25214;
})()
,(function() { 
var G__25217__delegate = function (ks){
...
while (G__25218__i < G__25218__a.length) {G__25218__a[G__25218__i] = arguments[G__25218__i + 0]; ++G__25218__i;}
  ks = new cljs.core.IndexedSeq(G__25218__a,0,null);
} 
return G__25217__delegate.call(this,ks);};
G__25217.cljs$lang$maxFixedArity = 0;
G__25217.cljs$lang$applyTo = (function (arglist__25219){
var ks = cljs.core.seq(arglist__25219);
return G__25217__delegate(ks);
});
G__25217.cljs$core$IFn$_invoke$arity$variadic = G__25217__delegate;
return G__25217;
})()
,(function() { 
var G__25220__delegate = function (p__25198){
var vec__25199 = p__25198;
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25199,(0),null);
...
while (G__25221__i < G__25221__a.length) {G__25221__a[G__25221__i] = arguments[G__25221__i + 0]; ++G__25221__i;}
  p__25198 = new cljs.core.IndexedSeq(G__25221__a,0,null);
} 
return G__25220__delegate.call(this,p__25198);};
G__25220.cljs$lang$maxFixedArity = 0;
G__25220.cljs$lang$applyTo = (function (arglist__25222){
var p__25198 = cljs.core.seq(arglist__25222);
return G__25220__delegate(p__25198);
});
G__25220.cljs$core$IFn$_invoke$arity$variadic = G__25220__delegate;
return G__25220;
})()
,(function (p1__25192_SHARP_){
return fork.core.set_handle_blur(p1__25192_SHARP_,state);
}),(function() { 
var G__25223__delegate = function (ks){
...
while (G__25224__i < G__25224__a.length) {G__25224__a[G__25224__i] = arguments[G__25224__i + 0]; ++G__25224__i;}
  ks = new cljs.core.IndexedSeq(G__25224__a,0,null);
} 
return G__25223__delegate.call(this,ks);};
G__25223.cljs$lang$maxFixedArity = 0;
G__25223.cljs$lang$applyTo = (function (arglist__25225){
var ks = cljs.core.seq(arglist__25225);
return G__25223__delegate(ks);
});
...
return fork.core.normalize_name(p1__25190_SHARP_,props);
...
}),(function (p1__25191_SHARP_){
return fork.core.set_handle_change(p1__25191_SHARP_,state);
}),(function (p1__25189_SHARP_){
return fork.core.disabled_QMARK_(state,p1__25189_SHARP_);
})]);
