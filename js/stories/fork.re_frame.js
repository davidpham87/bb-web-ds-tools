...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-dispatch-logic","fork.re-frame/server-dispatch-logic",-1023921676),(function (db,p__25203){
var vec__25204 = p__25203;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25204,(0),null);
var config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25204,(1),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25204,(2),null);
...
var G__25207 = db;
var G__25207__$1 = ((cljs.core.seq(input_names))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__25207,path,(function (m){
...
return cljs.core.assoc_in(G__25207__$1,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"server","server",1499190120),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(config),new cljs.core.Keyword(null,"waiting?","waiting?",-2117257215)], null)),true);
} else {
return G__25207__$1;
}
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-set-waiting","fork.re-frame/server-set-waiting",-1277872097),(function (db,p__25210){
var vec__25211 = p__25210;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25211,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25211,(1),null);
var input_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25211,(2),null);
var bool = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25211,(3),null);
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("fork.re-frame","db","fork.re-frame/db",503486154),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__25214){
var vec__25215 = p__25214;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25215,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25215,(1),null);
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,path);
})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","clean","fork.re-frame/clean",-448599170),(function (db,p__25218){
var vec__25219 = p__25218;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25219,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25219,(1),null);
...
var G__25265__delegate = function (ks){
...
while (G__25266__i < G__25266__a.length) {G__25266__a[G__25266__i] = arguments[G__25266__i + 0]; ++G__25266__i;}
  ks = new cljs.core.IndexedSeq(G__25266__a,0,null);
} 
return G__25265__delegate.call(this,ks);};
G__25265.cljs$lang$maxFixedArity = 0;
G__25265.cljs$lang$applyTo = (function (arglist__25270){
var ks = cljs.core.seq(arglist__25270);
return G__25265__delegate(ks);
});
G__25265.cljs$core$IFn$_invoke$arity$variadic = G__25265__delegate;
return G__25265;
})()
,(function (p1__25234_SHARP_){
return fork.core.handle_blur(p1__25234_SHARP_,state);
}),(function (p1__25228_SHARP_){
return fork.core.set_values(p1__25228_SHARP_,state);
}),(function (p1__25233_SHARP_){
return fork.core.handle_change(p1__25233_SHARP_,state);
}),(function() { 
var G__25271__delegate = function (ks){
...
while (G__25272__i < G__25272__a.length) {G__25272__a[G__25272__i] = arguments[G__25272__i + 0]; ++G__25272__i;}
  ks = new cljs.core.IndexedSeq(G__25272__a,0,null);
} 
return G__25271__delegate.call(this,ks);};
G__25271.cljs$lang$maxFixedArity = 0;
G__25271.cljs$lang$applyTo = (function (arglist__25273){
var ks = cljs.core.seq(arglist__25273);
return G__25271__delegate(ks);
});
G__25271.cljs$core$IFn$_invoke$arity$variadic = G__25271__delegate;
return G__25271;
})()
,(function() { 
var G__25274__delegate = function (ks){
...
while (G__25275__i < G__25275__a.length) {G__25275__a[G__25275__i] = arguments[G__25275__i + 0]; ++G__25275__i;}
  ks = new cljs.core.IndexedSeq(G__25275__a,0,null);
} 
return G__25274__delegate.call(this,ks);};
G__25274.cljs$lang$maxFixedArity = 0;
G__25274.cljs$lang$applyTo = (function (arglist__25276){
var ks = cljs.core.seq(arglist__25276);
return G__25274__delegate(ks);
});
G__25274.cljs$core$IFn$_invoke$arity$variadic = G__25274__delegate;
return G__25274;
})()
,(function() { 
var G__25277__delegate = function (p__25236){
var vec__25237 = p__25236;
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25237,(0),null);
...
while (G__25279__i < G__25279__a.length) {G__25279__a[G__25279__i] = arguments[G__25279__i + 0]; ++G__25279__i;}
  p__25236 = new cljs.core.IndexedSeq(G__25279__a,0,null);
} 
return G__25277__delegate.call(this,p__25236);};
G__25277.cljs$lang$maxFixedArity = 0;
G__25277.cljs$lang$applyTo = (function (arglist__25281){
var p__25236 = cljs.core.seq(arglist__25281);
return G__25277__delegate(p__25236);
});
G__25277.cljs$core$IFn$_invoke$arity$variadic = G__25277__delegate;
return G__25277;
})()
,(function (p1__25232_SHARP_){
return fork.core.set_handle_blur(p1__25232_SHARP_,state);
}),(function() { 
var G__25283__delegate = function (ks){
...
while (G__25284__i < G__25284__a.length) {G__25284__a[G__25284__i] = arguments[G__25284__i + 0]; ++G__25284__i;}
  ks = new cljs.core.IndexedSeq(G__25284__a,0,null);
} 
return G__25283__delegate.call(this,ks);};
G__25283.cljs$lang$maxFixedArity = 0;
G__25283.cljs$lang$applyTo = (function (arglist__25286){
var ks = cljs.core.seq(arglist__25286);
return G__25283__delegate(ks);
});
...
}),(function (p1__25230_SHARP_){
return fork.core.normalize_name(p1__25230_SHARP_,props);
...
}),(function (p1__25231_SHARP_){
return fork.core.set_handle_change(p1__25231_SHARP_,state);
}),(function (p1__25229_SHARP_){
return fork.core.disabled_QMARK_(state,p1__25229_SHARP_);
})]);
