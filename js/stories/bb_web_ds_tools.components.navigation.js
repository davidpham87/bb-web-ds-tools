...
var with_let36722 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let36722","with-let36722",-1393384648));
var temp__5829__auto___36744 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5829__auto___36744 == null)){
} else {
var c__21985__auto___36745 = temp__5829__auto___36744;
if((with_let36722.generation === c__21985__auto___36745.ratomGeneration)){
...
(with_let36722.generation = c__21985__auto___36745.ratomGeneration);
}

var init36723 = (with_let36722.length === (0));
var open_QMARK_ = ((((init36723) || (cljs.core.not(with_let36722.hasOwnProperty((0))))))?(with_let36722[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false)):(with_let36722[(0)]));
var close_fn = ((((init36723) || (cljs.core.not(with_let36722.hasOwnProperty((1))))))?(with_let36722[(1)] = (function (){
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.components.navigation","set-top-bar-ref","bb-web-ds-tools.components.navigation/set-top-bar-ref",1693658101),(function (db,p__36732){
var vec__36733 = p__36732;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36733,(0),null);
var ref = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36733,(1),null);
...
var len__5749__auto___36747 = arguments.length;
var i__5750__auto___36748 = (0);
while(true){
if((i__5750__auto___36748 < len__5749__auto___36747)){
args__5755__auto__.push((arguments[i__5750__auto___36748]));

var G__36749 = (i__5750__auto___36748 + (1));
i__5750__auto___36748 = G__36749;
continue;
} else {
}
break;
...
/** @this {Function} */
(bb_web_ds_tools.components.navigation.portal_to_top_bar.cljs$lang$applyTo = (function (seq36738){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq36738));
}));
 ...
 *  vector: A hiccup vector.
 */
bb_web_ds_tools.components.navigation.top_bar = (function bb_web_ds_tools$components$navigation$top_bar(p__36739){
var map__36740 = p__36739;
var map__36740__$1 = cljs.core.__destructure_map(map__36740);
var active_label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36740__$1,new cljs.core.Keyword(null,"active-label","active-label",1965964916));
