...
var with_let36637 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let36637","with-let36637",-833624538));
var temp__5829__auto___36660 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5829__auto___36660 == null)){
} else {
var c__21945__auto___36661 = temp__5829__auto___36660;
if((with_let36637.generation === c__21945__auto___36661.ratomGeneration)){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__36643),bb_web_ds_tools$components$navigation$menu_button_$_iter__36640(cljs.core.chunk_rest(s__36641__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__36643),null);
}
} else {
var item = cljs.core.first(s__36641__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"href","href",-793805698),reitit.frontend.easy.href.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"route","route",329891309).cljs$core$IFn$_invoke$arity$1(item)),new cljs.core.Keyword(null,"class","class",-2030961996),["block px-4 py-2 text-sm ",bb_web_ds_tools.theme.text_primary," hover:bg-white/5 flex items-center gap-2"].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),close_fn], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.Keyword(null,"icon","icon",1679606541).cljs$core$IFn$_invoke$arity$1(item)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.Keyword(null,"label","label",1718410804).cljs$core$IFn$_invoke$arity$1(item)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"route","route",329891309).cljs$core$IFn$_invoke$arity$1(item)], null)),bb_web_ds_tools$components$navigation$menu_button_$_iter__36640(cljs.core.rest(s__36641__$2)));
}
} else {
return null;
}
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.components.navigation","set-top-bar-ref","bb-web-ds-tools.components.navigation/set-top-bar-ref",1693658101),(function (db,p__36645){
var vec__36646 = p__36645;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36646,(0),null);
var ref = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36646,(1),null);
...
var len__5749__auto___36664 = arguments.length;
var i__5750__auto___36665 = (0);
while(true){
if((i__5750__auto___36665 < len__5749__auto___36664)){
args__5755__auto__.push((arguments[i__5750__auto___36665]));

var G__36666 = (i__5750__auto___36665 + (1));
i__5750__auto___36665 = G__36666;
continue;
} else {
}
break;
...
/** @this {Function} */
(bb_web_ds_tools.components.navigation.portal_to_top_bar.cljs$lang$applyTo = (function (seq36650){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq36650));
}));
 ...
 *  vector: A hiccup vector.
 */
bb_web_ds_tools.components.navigation.top_bar = (function bb_web_ds_tools$components$navigation$top_bar(p__36656){
var map__36657 = p__36656;
var map__36657__$1 = cljs.core.__destructure_map(map__36657);
var active_label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36657__$1,new cljs.core.Keyword(null,"active-label","active-label",1965964916));
