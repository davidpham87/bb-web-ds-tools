...
var with_let36643 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let36643","with-let36643",1834765944));
var temp__5829__auto___36689 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5829__auto___36689 == null)){
} else {
var c__22007__auto___36690 = temp__5829__auto___36689;
if((with_let36643.generation === c__22007__auto___36690.ratomGeneration)){
...
(with_let36643.generation = c__22007__auto___36690.ratomGeneration);
}

var init36644 = (with_let36643.length === (0));
var open_QMARK_ = ((((init36644) || (cljs.core.not(with_let36643.hasOwnProperty((0))))))?(with_let36643[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false)):(with_let36643[(0)]));
var close_fn = ((((init36644) || (cljs.core.not(with_let36643.hasOwnProperty((1))))))?(with_let36643[(1)] = (function (){
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.components.navigation","set-top-bar-ref","bb-web-ds-tools.components.navigation/set-top-bar-ref",1693658101),(function (db,p__36661){
var vec__36664 = p__36661;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36664,(0),null);
var ref = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36664,(1),null);
...
var len__5749__auto___36694 = arguments.length;
var i__5750__auto___36696 = (0);
while(true){
if((i__5750__auto___36696 < len__5749__auto___36694)){
args__5755__auto__.push((arguments[i__5750__auto___36696]));

var G__36697 = (i__5750__auto___36696 + (1));
i__5750__auto___36696 = G__36697;
continue;
} else {
}
break;
...
/** @this {Function} */
(bb_web_ds_tools.components.navigation.portal_to_top_bar.cljs$lang$applyTo = (function (seq36680){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq36680));
}));
 ...
 *  vector: A hiccup vector.
 */
bb_web_ds_tools.components.navigation.top_bar = (function bb_web_ds_tools$components$navigation$top_bar(p__36685){
var map__36686 = p__36685;
var map__36686__$1 = cljs.core.__destructure_map(map__36686);
var active_label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36686__$1,new cljs.core.Keyword(null,"active-label","active-label",1965964916));
