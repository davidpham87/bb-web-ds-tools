 ...
 *   
 */
bb_web_ds_tools.components.landing.canvas_card = (function bb_web_ds_tools$components$landing$canvas_card(p__24897){
var map__24898 = p__24897;
var map__24898__$1 = cljs.core.__destructure_map(map__24898);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24898__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24898__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
var route = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24898__$1,new cljs.core.Keyword(null,"route","route",329891309));
var draw_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24898__$1,new cljs.core.Keyword(null,"draw-fn","draw-fn",-1155888705));
...
var map__24902 = cljs.core.deref(dimensions);
var map__24902__$1 = cljs.core.__destructure_map(map__24902);
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24902__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24902__$1,new cljs.core.Keyword(null,"height","height",1025178622));
if((((width > (0))) && ((height > (0))))){
...
})], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),["relative h-40 w-full ",bb_web_ds_tools.theme.bg_sidebar," border-b ",bb_web_ds_tools.theme.border_main].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"canvas","canvas",-1798817489),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ref","ref",1289896967),(function (p1__24896_SHARP_){
return cljs.core.reset_BANG_(canvas_ref,p1__24896_SHARP_);
...
var offset_24967 = (i * (1000));
var y_pos_24968 = ((-50) + cljs.core.mod(((t + offset_24967) * 0.05),(100)));
var x_pos_24969 = (cx + ((60) * Math.sin(((t + offset_24967) * 0.002))));
if((((y_pos_24968 > (-50))) && ((y_pos_24968 < (50))))){
ctx.beginPath();

ctx.arc(x_pos_24969,(cy + y_pos_24968),(3),(0),(Math.PI * (2)));
...
var n__5616__auto___24972 = total_lines;
var i_24973 = (0);
while(true){
if((i_24973 < n__5616__auto___24972)){
var y_24974 = (start_y + (i_24973 * line_h));
var chars_24975 = (function (){var x__5113__auto__ = chars_per_line;
var y__5114__auto__ = (function (){var x__5110__auto__ = (0);
var y__5111__auto__ = (typer_pos - (i_24973 * chars_per_line));
return ((x__5110__auto__ > y__5111__auto__) ? x__5110__auto__ : y__5111__auto__);
})();
return ((x__5113__auto__ < y__5114__auto__) ? x__5113__auto__ : y__5114__auto__);
})();
if((chars_24975 > (0))){
(ctx.fillStyle = ((cljs.core.even_QMARK_(i_24973))?new cljs.core.Keyword("bb-web-ds-tools.theme","keyword","bb-web-ds-tools.theme/keyword",6462773).cljs$core$IFn$_invoke$arity$1(bb_web_ds_tools.components.landing.zenburn):new cljs.core.Keyword("bb-web-ds-tools.theme","string","bb-web-ds-tools.theme/string",1496885044).cljs$core$IFn$_invoke$arity$1(bb_web_ds_tools.components.landing.zenburn)));

ctx.fillRect(start_x,y_24974,(chars_24975 * (5)),(8));
} else {
}

var G__24976 = (i_24973 + (1));
i_24973 = G__24976;
continue;
} else {
}
...
while(true){
if((i < n__5616__auto__)){
var freq_24977 = (0.002 + (i * 0.001));
var height_24978 = ((30) + ((40) * Math.abs(Math.sin((t * freq_24977)))));
var x_24979 = (start_x + (i * (bar_w + gap)));
var y_24980 = (base_y - height_24978);
...
ctx.fillRect(x_24979,y_24980,bar_w,height_24978);
...
var progress_24982 = cljs.core.mod((t * 0.001),(2));
var p_24983 = (function (){var x__5113__auto__ = (1);
var y__5114__auto__ = progress_24982;
return ((x__5113__auto__ < y__5114__auto__) ? x__5113__auto__ : y__5114__auto__);
})();
if((p_24983 > (0))){
ctx.beginPath();
...
var theta_24984 = (angle + (i * ((Math.PI * (2)) / (3))));
var x_24985 = (cx + (orbit_r * Math.cos(theta_24984)));
var y_24986 = (cy + (orbit_r * Math.sin(theta_24984)));
(ctx.fillStyle = color);

(ctx.font = "14px sans-serif");

ctx.fillText(text,x_24985,y_24986);


var G__24987 = seq__24939;
var G__24988 = chunk__24940;
var G__24989 = count__24941;
var G__24990 = (i__24942 + (1));
seq__24939 = G__24987;
chunk__24940 = G__24988;
count__24941 = G__24989;
i__24942 = G__24990;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__24939);
if(temp__5825__auto__){
var seq__24939__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__24939__$1)){
var c__5548__auto__ = cljs.core.chunk_first(seq__24939__$1);
var G__24991 = cljs.core.chunk_rest(seq__24939__$1);
var G__24992 = c__5548__auto__;
var G__24993 = cljs.core.count(c__5548__auto__);
var G__24994 = (0);
seq__24939 = G__24991;
chunk__24940 = G__24992;
count__24941 = G__24993;
i__24942 = G__24994;
continue;
} else {
var vec__24953 = cljs.core.first(seq__24939__$1);
...
var theta_24995 = (angle + (i * ((Math.PI * (2)) / (3))));
var x_24996 = (cx + (orbit_r * Math.cos(theta_24995)));
var y_24997 = (cy + (orbit_r * Math.sin(theta_24995)));
(ctx.fillStyle = color);

(ctx.font = "14px sans-serif");

ctx.fillText(text,x_24996,y_24997);


var G__24998 = cljs.core.next(seq__24939__$1);
var G__24999 = null;
var G__25000 = (0);
var G__25001 = (0);
seq__24939 = G__24998;
chunk__24940 = G__24999;
count__24941 = G__25000;
i__24942 = G__25001;
continue;
}
} else {
...
var n__5616__auto___25002 = (100);
var i_25003 = (0);
while(true){
if((i_25003 < n__5616__auto___25002)){
var x_25004 = ((cx - (100)) + (i_25003 * (2)));
var y_25005 = (cy + ((40) * Math.sin(((i_25003 * 0.1) + (t * 0.005)))));
if((i_25003 === (0))){
ctx.moveTo(x_25004,y_25005);
} else {
ctx.lineTo(x_25004,y_25005);
}

var G__25006 = (i_25003 + (1));
i_25003 = G__25006;
continue;
} else {
}
...
while(true){
if((i < n__5616__auto__)){
var offset_25007 = (i * (20));
var x_25008 = ((cx - (100)) + (offset_25007 * (2)));
var y_25009 = (cy + ((40) * Math.sin(((offset_25007 * 0.1) + (t * 0.005)))));
ctx.beginPath();

ctx.arc(x_25008,y_25009,(4),(0),(Math.PI * (2)));
...
var blink_25011 = cljs.core.mod((t * 5.0E-4),(5));
if((blink_25011 > 4.8)){
(ctx.fillStyle = new cljs.core.Keyword("bb-web-ds-tools.theme","diff-add","bb-web-ds-tools.theme/diff-add",-617408210).cljs$core$IFn$_invoke$arity$1(bb_web_ds_tools.components.landing.zenburn));
...
var outer_r_25012 = r;
var inner_r_25013 = (r * 0.8);
var hole_r_25014 = (r * 0.3);
var n__5616__auto___25015 = (teeth * (2));
var i_25016 = (0);
while(true){
if((i_25016 < n__5616__auto___25015)){
var angle_25017 = (i_25016 * (Math.PI / teeth));
var rad_25018 = ((cljs.core.even_QMARK_(i_25016))?outer_r_25012:inner_r_25013);
ctx.lineTo((rad_25018 * Math.cos(angle_25017)),(rad_25018 * Math.sin(angle_25017)));

var G__25019 = (i_25016 + (1));
i_25016 = G__25019;
continue;
} else {
}
...
ctx.arc((0),(0),hole_r_25014,(0),(Math.PI * (2)));
...
var y_25020 = (((200) + (i * (20))) - scroll_y);
if((((y_25020 > (0))) && ((y_25020 < (200))))){
ctx.fillText(["- Update ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)," fixed stuff"].join(''),(20),y_25020);
} else {
}


var G__25021 = seq__24957;
var G__25022 = chunk__24958;
var G__25023 = count__24959;
var G__25024 = (i__24960 + (1));
seq__24957 = G__25021;
chunk__24958 = G__25022;
count__24959 = G__25023;
i__24960 = G__25024;
continue;
} else {
...
var G__25025 = cljs.core.chunk_rest(seq__24957__$1);
var G__25026 = c__5548__auto__;
var G__25027 = cljs.core.count(c__5548__auto__);
var G__25028 = (0);
seq__24957 = G__25025;
chunk__24958 = G__25026;
count__24959 = G__25027;
i__24960 = G__25028;
continue;
} else {
var i = cljs.core.first(seq__24957__$1);
var y_25029 = (((200) + (i * (20))) - scroll_y);
if((((y_25029 > (0))) && ((y_25029 < (200))))){
ctx.fillText(["- Update ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)," fixed stuff"].join(''),(20),y_25029);
} else {
}


var G__25030 = cljs.core.next(seq__24957__$1);
var G__25031 = null;
var G__25032 = (0);
var G__25033 = (0);
seq__24957 = G__25030;
chunk__24958 = G__25031;
count__24959 = G__25032;
i__24960 = G__25033;
continue;
}
} else {
