 ...
 *   
 */
bb_web_ds_tools.components.landing.canvas_card = (function bb_web_ds_tools$components$landing$canvas_card(p__25066){
var map__25067 = p__25066;
var map__25067__$1 = cljs.core.__destructure_map(map__25067);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25067__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25067__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
var route = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25067__$1,new cljs.core.Keyword(null,"route","route",329891309));
var draw_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25067__$1,new cljs.core.Keyword(null,"draw-fn","draw-fn",-1155888705));
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25067__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
var map__25068 = cljs.core.deref(dimensions);
var map__25068__$1 = cljs.core.__destructure_map(map__25068);
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25068__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25068__$1,new cljs.core.Keyword(null,"height","height",1025178622));
if((((width > (0))) && ((height > (0))))){
...
var temp__5825__auto___25079 = cljs.core.deref(animation_id);
if(cljs.core.truth_(temp__5825__auto___25079)){
var id_25080__$1 = temp__5825__auto___25079;
cancelAnimationFrame(id_25080__$1);
} else {
}
...
})], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),["relative w-full h-64 ",bb_web_ds_tools.theme.bg_sidebar," border-b ",bb_web_ds_tools.theme.border_main].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"canvas","canvas",-1798817489),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ref","ref",1289896967),(function (p1__25062_SHARP_){
return cljs.core.reset_BANG_(canvas_ref,p1__25062_SHARP_);
...
bb_web_ds_tools.components.landing.animated_icon = (function bb_web_ds_tools$components$landing$animated_icon(p__25071){
var map__25072 = p__25071;
var map__25072__$1 = cljs.core.__destructure_map(map__25072);
var draw_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25072__$1,new cljs.core.Keyword(null,"draw-fn","draw-fn",-1155888705));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25072__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var canvas_ref = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(null);
var animation_id = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(null);
var resize_observer = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(null);
var dimensions = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"width","width",-384071477),(0),new cljs.core.Keyword(null,"height","height",1025178622),(0)], null));
...
var elapsed = (Date.now() - start_time);
var map__25073 = cljs.core.deref(dimensions);
var map__25073__$1 = cljs.core.__destructure_map(map__25073);
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25073__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25073__$1,new cljs.core.Keyword(null,"height","height",1025178622));
if((((width > (0))) && ((height > (0))))){
(draw_fn.cljs$core$IFn$_invoke$arity$4 ? draw_fn.cljs$core$IFn$_invoke$arity$4(ctx,width,height,elapsed) : draw_fn.call(null,ctx,width,height,elapsed));
} else {
}
...
var temp__5825__auto___25081 = cljs.core.deref(animation_id);
if(cljs.core.truth_(temp__5825__auto___25081)){
var id_25082 = temp__5825__auto___25081;
cancelAnimationFrame(id_25082);
} else {
}
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"canvas","canvas",-1798817489),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ref","ref",1289896967),(function (p1__25070_SHARP_){
return cljs.core.reset_BANG_(canvas_ref,p1__25070_SHARP_);
