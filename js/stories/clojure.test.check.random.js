...
var clojure$test$check$random$IRandom$rand_long$dyn_30079 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_30079(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_30080 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_30080(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_30082 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_30082(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_30083 = (function (rng,n){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_30083(rng,n);
}
});
...
var G__30065 = z;
if(((24) > (function (){var G__30066 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__30066) : clojure.test.check.random.longs.bit_count.call(null,G__30066));
})())){
return clojure.test.check.random.longs.bit_xor(G__30065,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__30065;
}
});
...
var G__30086 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__30087 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__30086;
ret = G__30087;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__30071){
var map__30072 = p__30071;
var map__30072__$1 = cljs.core.__destructure_map(map__30072);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30072__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__30073 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30073,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30073,(1),null);
