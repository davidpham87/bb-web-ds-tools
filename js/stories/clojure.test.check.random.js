...
var clojure$test$check$random$IRandom$rand_long$dyn_30032 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_30032(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_30034 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_30034(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_30038 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_30038(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_30041 = (function (rng,n){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_30041(rng,n);
}
});
...
var G__30054 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__30055 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__30054;
ret = G__30055;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__30024){
var map__30025 = p__30024;
var map__30025__$1 = cljs.core.__destructure_map(map__30025);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30025__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__30026 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30026,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30026,(1),null);
