...
var clojure$test$check$random$IRandom$rand_double$dyn_29919 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_29919(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_29920 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_29920(rng);
}
});
...
var G__29905 = z;
if(((24) > (function (){var G__29906 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__29906) : clojure.test.check.random.longs.bit_count.call(null,G__29906));
})())){
return clojure.test.check.random.longs.bit_xor(G__29905,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__29905;
}
});
...
var G__29924 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__29925 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__29924;
ret = G__29925;
continue;
}
...
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29911__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__29912 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29912,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29912,(1),null);
