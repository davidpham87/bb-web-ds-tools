...
var clojure$test$check$random$IRandom$rand_long$dyn_30002 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_30002(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_30003 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_30003(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_30004 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_30004(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_30005 = (function (rng,n){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_30005(rng,n);
}
});
...
var G__29990 = z;
if(((24) > (function (){var G__29991 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__29991) : clojure.test.check.random.longs.bit_count.call(null,G__29991));
})())){
return clojure.test.check.random.longs.bit_xor(G__29990,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__29990;
}
});
...
var G__30009 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__30010 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__30009;
ret = G__30010;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__29994){
var map__29996 = p__29994;
var map__29996__$1 = cljs.core.__destructure_map(map__29996);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29996__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__29997 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29997,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29997,(1),null);
