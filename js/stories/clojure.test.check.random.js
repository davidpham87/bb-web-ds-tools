...
var clojure$test$check$random$IRandom$rand_long$dyn_29931 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_29931(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_29932 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_29932(rng);
}
});
...
var G__29937 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__29938 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__29937;
ret = G__29938;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__29924){
var map__29925 = p__29924;
var map__29925__$1 = cljs.core.__destructure_map(map__29925);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29925__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__29926 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29926,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29926,(1),null);
