...
var clojure$test$check$random$IRandom$rand_long$dyn_29945 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_29945(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_29947 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_29947(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_29948 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_29948(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_29949 = (function (rng,n){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_29949(rng,n);
}
});
...
var G__29929 = z;
if(((24) > (function (){var G__29931 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__29931) : clojure.test.check.random.longs.bit_count.call(null,G__29931));
})())){
return clojure.test.check.random.longs.bit_xor(G__29929,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__29929;
}
});
...
var G__29951 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__29952 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__29951;
ret = G__29952;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__29938){
var map__29939 = p__29938;
var map__29939__$1 = cljs.core.__destructure_map(map__29939);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29939__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__29940 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29940,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29940,(1),null);
