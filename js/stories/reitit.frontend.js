...
var new_query = ((cljs.core.fn_QMARK_(new_query_or_update_fn))?(function (){var G__36345 = reitit.frontend.query_params(uri);
return (new_query_or_update_fn.cljs$core$IFn$_invoke$arity$1 ? new_query_or_update_fn.cljs$core$IFn$_invoke$arity$1(G__36345) : new_query_or_update_fn.call(null,G__36345));
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36354),"#",reitit.impl.form_encode(fragment)].join('');
} else {
return G__36354;
}
} else {
...
(reitit.frontend.match_by_path.cljs$core$IFn$_invoke$arity$3 = (function (router,path,p__36361){
var map__36362 = p__36361;
var map__36362__$1 = cljs.core.__destructure_map(map__36362);
var on_coercion_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36362__$1,new cljs.core.Keyword(null,"on-coercion-error","on-coercion-error",-970787));
var uri = goog.Uri.parse(path);
...
if(cljs.core.every_QMARK_((function (p1__36371_SHARP_){
return cljs.core.contains_QMARK_(path_params,p1__36371_SHARP_);
