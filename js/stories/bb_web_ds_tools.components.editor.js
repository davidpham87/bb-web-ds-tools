...
try{var map__20848 = reagent.core.props(this$);
var map__20848__$1 = cljs.core.__destructure_map(map__20848);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20848__$1,new cljs.core.Keyword(null,"value","value",305978217));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20848__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20848__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20848__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20848__$1,new cljs.core.Keyword(null,"on-focus","on-focus",-13737624));
var on_blur = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20848__$1,new cljs.core.Keyword(null,"on-blur","on-blur",814300747));
var on_mount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20848__$1,new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20848__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var sub_20871 = editor.onDidChangeModelContent((function (){
cljs.core.reset_BANG_(ignore_change_QMARK_,true);

var new_val_20872 = editor.getValue();
var temp__5825__auto___20873 = cljs.core.deref(on_change_ref);
if(cljs.core.truth_(temp__5825__auto___20873)){
var handler_20874 = temp__5825__auto___20873;
if(cljs.core.vector_QMARK_(handler_20874)){
re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(handler_20874,new_val_20872));
} else {
(handler_20874.cljs$core$IFn$_invoke$arity$1 ? handler_20874.cljs$core$IFn$_invoke$arity$1(new_val_20872) : handler_20874.call(null,new_val_20872));
}
} else {
}
...
cljs.core.reset_BANG_(subscription,sub_20871);
...
}catch (e20847){if((e20847 instanceof Error)){
var e = e20847;
...
}}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (this$,p__20854){
var vec__20855 = p__20854;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20855,(0),null);
var old_props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20855,(1),null);
var map__20858 = reagent.core.props(this$);
var map__20858__$1 = cljs.core.__destructure_map(map__20858);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20858__$1,new cljs.core.Keyword(null,"value","value",305978217));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20858__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20858__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20858__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20858__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var lang_20876 = (function (){var or__5025__auto__ = language;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
var G__20859 = mode;
...
var model_20877 = editor.getModel();
var current_lang_20878 = (cljs.core.truth_(model_20877)?model_20877.getLanguageId():null);
if(cljs.core.truth_((function (){var and__5023__auto__ = model_20877;
if(cljs.core.truth_(and__5023__auto__)){
var and__5023__auto____$1 = lang_20876;
if(cljs.core.truth_(and__5023__auto____$1)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(current_lang_20878,lang_20876);
} else {
...
shadow.js.shim.module$monaco_editor$esm$vs$editor$editor_api.editor.setModelLanguage(model_20877,lang_20876);
} else {
}
...
var temp__5825__auto___20880 = cljs.core.deref(subscription);
if(cljs.core.truth_(temp__5825__auto___20880)){
var sub_20881 = temp__5825__auto___20880;
sub_20881.dispose();
} else {
}
...
var map__20860 = props;
var map__20860__$1 = cljs.core.__destructure_map(map__20860);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20860__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20860__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var G__20861 = bb_web_ds_tools.components.editor.get_code_to_eval(ed);
return (eval_action.cljs$core$IFn$_invoke$arity$1 ? eval_action.cljs$core$IFn$_invoke$arity$1(G__20861) : eval_action.call(null,G__20861));
})], null)));
});
/**
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$components$editor$render_output_$_iter__20862(s__20863){
return (new cljs.core.LazySeq(null,(function (){
var s__20863__$1 = s__20863;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__20863__$1);
if(temp__5825__auto__){
var s__20863__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__20863__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__20863__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__20865 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__20864 = (0);
while(true){
if((i__20864 < size__5502__auto__)){
var map__20866 = cljs.core._nth(c__5501__auto__,i__20864);
var map__20866__$1 = cljs.core.__destructure_map(map__20866);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20866__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20866__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
cljs.core.chunk_append(b__20865,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__20867 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20867__$1)].join('')));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__20865),bb_web_ds_tools$components$editor$render_output_$_iter__20862(cljs.core.chunk_rest(s__20863__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__20865),null);
}
} else {
var map__20868 = cljs.core.first(s__20863__$2);
var map__20868__$1 = cljs.core.__destructure_map(map__20868);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20868__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20868__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__20869 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20869__$1)].join('')));

}
})()], null),text], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.random_uuid()], null)),bb_web_ds_tools$components$editor$render_output_$_iter__20862(cljs.core.rest(s__20863__$2)));
}
} else {
return null;
}
