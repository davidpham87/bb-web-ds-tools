...
return true;
}catch (e24832){if((e24832 instanceof Error)){
var e = e24832;
...
var sub_24866 = editor.onDidChangeModelContent((function (){
cljs.core.reset_BANG_(ignore_change_QMARK_,true);

var new_val_24867 = editor.getValue();
var temp__5825__auto___24868 = cljs.core.deref(on_change_ref);
if(cljs.core.truth_(temp__5825__auto___24868)){
var handler_24869 = temp__5825__auto___24868;
if(cljs.core.vector_QMARK_(handler_24869)){
re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(handler_24869,new_val_24867));
} else {
(handler_24869.cljs$core$IFn$_invoke$arity$1 ? handler_24869.cljs$core$IFn$_invoke$arity$1(new_val_24867) : handler_24869.call(null,new_val_24867));
}
} else {
}
...
cljs.core.reset_BANG_(subscription,sub_24866);
...
var map__24846 = reagent.core.props(this$);
var map__24846__$1 = cljs.core.__destructure_map(map__24846);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24846__$1,new cljs.core.Keyword(null,"value","value",305978217));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24846__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24846__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24846__$1,new cljs.core.Keyword(null,"options","options",99638489));
...
var lang_24870 = (function (){var or__5025__auto__ = language;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
var G__24847 = mode;
...
var model_24871 = editor.getModel();
var current_lang_24872 = (cljs.core.truth_(model_24871)?model_24871.getLanguageId():null);
if(cljs.core.truth_((function (){var and__5023__auto__ = model_24871;
if(cljs.core.truth_(and__5023__auto__)){
var and__5023__auto____$1 = lang_24870;
if(cljs.core.truth_(and__5023__auto____$1)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(current_lang_24872,lang_24870);
} else {
...
shadow.js.shim.module$monaco_editor$esm$vs$editor$editor_api.editor.setModelLanguage(model_24871,lang_24870);
} else {
}
...
var temp__5825__auto___24874 = cljs.core.deref(subscription);
if(cljs.core.truth_(temp__5825__auto___24874)){
var sub_24875 = temp__5825__auto___24874;
sub_24875.dispose();
} else {
}
...
var G__24851 = bb_web_ds_tools.components.editor.get_code_to_eval(ed);
return (eval_action.cljs$core$IFn$_invoke$arity$1 ? eval_action.cljs$core$IFn$_invoke$arity$1(G__24851) : eval_action.call(null,G__24851));
})], null)));
});
/**
...
var map__24858 = cljs.core.first(s__24853__$2);
var map__24858__$1 = cljs.core.__destructure_map(map__24858);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24858__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24858__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__24859 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24859__$1)].join('')));
