...
var sub_24859 = editor.onDidChangeModelContent((function (){
cljs.core.reset_BANG_(ignore_change_QMARK_,true);

var new_val_24860 = editor.getValue();
var temp__5825__auto___24861 = cljs.core.deref(on_change_ref);
if(cljs.core.truth_(temp__5825__auto___24861)){
var handler_24862 = temp__5825__auto___24861;
if(cljs.core.vector_QMARK_(handler_24862)){
re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(handler_24862,new_val_24860));
} else {
(handler_24862.cljs$core$IFn$_invoke$arity$1 ? handler_24862.cljs$core$IFn$_invoke$arity$1(new_val_24860) : handler_24862.call(null,new_val_24860));
}
} else {
}
...
cljs.core.reset_BANG_(subscription,sub_24859);
...
var lang_24863 = (function (){var or__5025__auto__ = language;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
var G__24841 = mode;
...
var model_24864 = editor.getModel();
var current_lang_24865 = (cljs.core.truth_(model_24864)?model_24864.getLanguageId():null);
if(cljs.core.truth_((function (){var and__5023__auto__ = model_24864;
if(cljs.core.truth_(and__5023__auto__)){
var and__5023__auto____$1 = lang_24863;
if(cljs.core.truth_(and__5023__auto____$1)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(current_lang_24865,lang_24863);
} else {
...
shadow.js.shim.module$monaco_editor$esm$vs$editor$editor_api.editor.setModelLanguage(model_24864,lang_24863);
} else {
}
...
var temp__5825__auto___24867 = cljs.core.deref(subscription);
if(cljs.core.truth_(temp__5825__auto___24867)){
var sub_24868 = temp__5825__auto___24867;
sub_24868.dispose();
} else {
}
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$components$editor$render_output_$_iter__24846(s__24847){
return (new cljs.core.LazySeq(null,(function (){
var s__24847__$1 = s__24847;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__24847__$1);
if(temp__5825__auto__){
var s__24847__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__24847__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__24847__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__24849 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__24848 = (0);
while(true){
if((i__24848 < size__5502__auto__)){
var map__24850 = cljs.core._nth(c__5501__auto__,i__24848);
...
cljs.core.chunk_append(b__24849,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__24851 = type;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__24849),bb_web_ds_tools$components$editor$render_output_$_iter__24846(cljs.core.chunk_rest(s__24847__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__24849),null);
}
} else {
var map__24854 = cljs.core.first(s__24847__$2);
...
})()], null),text], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.random_uuid()], null)),bb_web_ds_tools$components$editor$render_output_$_iter__24846(cljs.core.rest(s__24847__$2)));
}
} else {
return null;
}
