...
return true;
}catch (e24864){if((e24864 instanceof Error)){
var e = e24864;
...
try{var map__24869 = reagent.core.props(this$);
var map__24869__$1 = cljs.core.__destructure_map(map__24869);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24869__$1,new cljs.core.Keyword(null,"value","value",305978217));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24869__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24869__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24869__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24869__$1,new cljs.core.Keyword(null,"on-focus","on-focus",-13737624));
var on_blur = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24869__$1,new cljs.core.Keyword(null,"on-blur","on-blur",814300747));
var on_mount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24869__$1,new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24869__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var sub_24921 = editor.onDidChangeModelContent((function (){
cljs.core.reset_BANG_(ignore_change_QMARK_,true);

var new_val_24922 = editor.getValue();
var temp__5825__auto___24923 = cljs.core.deref(on_change_ref);
if(cljs.core.truth_(temp__5825__auto___24923)){
var handler_24924 = temp__5825__auto___24923;
if(cljs.core.vector_QMARK_(handler_24924)){
re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(handler_24924,new_val_24922));
} else {
(handler_24924.cljs$core$IFn$_invoke$arity$1 ? handler_24924.cljs$core$IFn$_invoke$arity$1(new_val_24922) : handler_24924.call(null,new_val_24922));
}
} else {
}
...
cljs.core.reset_BANG_(subscription,sub_24921);
...
}catch (e24868){if((e24868 instanceof Error)){
var e = e24868;
...
var lang_24925 = (function (){var or__5025__auto__ = language;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
var G__24882 = mode;
...
var model_24926 = editor.getModel();
var current_lang_24927 = (cljs.core.truth_(model_24926)?model_24926.getLanguageId():null);
if(cljs.core.truth_((function (){var and__5023__auto__ = model_24926;
if(cljs.core.truth_(and__5023__auto__)){
var and__5023__auto____$1 = lang_24925;
if(cljs.core.truth_(and__5023__auto____$1)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(current_lang_24927,lang_24925);
} else {
...
shadow.js.shim.module$monaco_editor$esm$vs$editor$editor_api.editor.setModelLanguage(model_24926,lang_24925);
} else {
}
...
var temp__5825__auto___24930 = cljs.core.deref(subscription);
if(cljs.core.truth_(temp__5825__auto___24930)){
var sub_24931 = temp__5825__auto___24930;
sub_24931.dispose();
} else {
}
...
var map__24891 = props;
var map__24891__$1 = cljs.core.__destructure_map(map__24891);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24891__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24891__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var G__24902 = bb_web_ds_tools.components.editor.get_code_to_eval(ed);
return (eval_action.cljs$core$IFn$_invoke$arity$1 ? eval_action.cljs$core$IFn$_invoke$arity$1(G__24902) : eval_action.call(null,G__24902));
})], null)));
});
/**
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$components$editor$render_output_$_iter__24903(s__24904){
return (new cljs.core.LazySeq(null,(function (){
var s__24904__$1 = s__24904;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__24904__$1);
if(temp__5825__auto__){
var s__24904__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__24904__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__24904__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__24906 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__24905 = (0);
while(true){
if((i__24905 < size__5502__auto__)){
var map__24910 = cljs.core._nth(c__5501__auto__,i__24905);
var map__24910__$1 = cljs.core.__destructure_map(map__24910);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24910__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24910__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
cljs.core.chunk_append(b__24906,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__24914 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24914__$1)].join('')));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__24906),bb_web_ds_tools$components$editor$render_output_$_iter__24903(cljs.core.chunk_rest(s__24904__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__24906),null);
}
} else {
var map__24915 = cljs.core.first(s__24904__$2);
var map__24915__$1 = cljs.core.__destructure_map(map__24915);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24915__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24915__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__24916 = type;
var G__24916__$1 = (((G__24916 instanceof cljs.core.Keyword))?G__24916.fqn:null);
switch (G__24916__$1) {
case "result":
return bb_web_ds_tools.theme.text_primary;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24916__$1)].join('')));

}
})()], null),text], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.random_uuid()], null)),bb_web_ds_tools$components$editor$render_output_$_iter__24903(cljs.core.rest(s__24904__$2)));
}
} else {
return null;
}
