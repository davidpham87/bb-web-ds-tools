...
try{var map__24979 = reagent.core.props(this$);
var map__24979__$1 = cljs.core.__destructure_map(map__24979);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24979__$1,new cljs.core.Keyword(null,"value","value",305978217));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24979__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24979__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24979__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24979__$1,new cljs.core.Keyword(null,"on-focus","on-focus",-13737624));
var on_blur = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24979__$1,new cljs.core.Keyword(null,"on-blur","on-blur",814300747));
var on_mount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24979__$1,new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24979__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var sub_24999 = editor.onDidChangeModelContent((function (){
cljs.core.reset_BANG_(ignore_change_QMARK_,true);

var new_val_25000 = editor.getValue();
var temp__5825__auto___25001 = cljs.core.deref(on_change_ref);
if(cljs.core.truth_(temp__5825__auto___25001)){
var handler_25002 = temp__5825__auto___25001;
if(cljs.core.vector_QMARK_(handler_25002)){
re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(handler_25002,new_val_25000));
} else {
(handler_25002.cljs$core$IFn$_invoke$arity$1 ? handler_25002.cljs$core$IFn$_invoke$arity$1(new_val_25000) : handler_25002.call(null,new_val_25000));
}
} else {
}
...
cljs.core.reset_BANG_(subscription,sub_24999);
...
}catch (e24978){if((e24978 instanceof Error)){
var e = e24978;
...
}}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (this$,p__24982){
var vec__24983 = p__24982;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24983,(0),null);
var old_props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24983,(1),null);
var map__24986 = reagent.core.props(this$);
...
var lang_25003 = (function (){var or__5025__auto__ = language;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
var G__24987 = mode;
...
var model_25004 = editor.getModel();
var current_lang_25005 = (cljs.core.truth_(model_25004)?model_25004.getLanguageId():null);
if(cljs.core.truth_((function (){var and__5023__auto__ = model_25004;
if(cljs.core.truth_(and__5023__auto__)){
var and__5023__auto____$1 = lang_25003;
if(cljs.core.truth_(and__5023__auto____$1)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(current_lang_25005,lang_25003);
} else {
...
shadow.js.shim.module$monaco_editor$esm$vs$editor$editor_api.editor.setModelLanguage(model_25004,lang_25003);
} else {
}
...
var temp__5825__auto___25007 = cljs.core.deref(subscription);
if(cljs.core.truth_(temp__5825__auto___25007)){
var sub_25008 = temp__5825__auto___25007;
sub_25008.dispose();
} else {
}
...
var map__24988 = props;
var map__24988__$1 = cljs.core.__destructure_map(map__24988);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24988__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24988__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var G__24989 = bb_web_ds_tools.components.editor.get_code_to_eval(ed);
return (eval_action.cljs$core$IFn$_invoke$arity$1 ? eval_action.cljs$core$IFn$_invoke$arity$1(G__24989) : eval_action.call(null,G__24989));
})], null)));
});
/**
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$components$editor$render_output_$_iter__24990(s__24991){
return (new cljs.core.LazySeq(null,(function (){
var s__24991__$1 = s__24991;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__24991__$1);
if(temp__5825__auto__){
var s__24991__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__24991__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__24991__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__24993 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__24992 = (0);
while(true){
if((i__24992 < size__5502__auto__)){
var map__24994 = cljs.core._nth(c__5501__auto__,i__24992);
var map__24994__$1 = cljs.core.__destructure_map(map__24994);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24994__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24994__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
cljs.core.chunk_append(b__24993,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__24995 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24995__$1)].join('')));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__24993),bb_web_ds_tools$components$editor$render_output_$_iter__24990(cljs.core.chunk_rest(s__24991__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__24993),null);
}
} else {
var map__24996 = cljs.core.first(s__24991__$2);
...
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24996__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__24997 = type;
var G__24997__$1 = (((G__24997 instanceof cljs.core.Keyword))?G__24997.fqn:null);
switch (G__24997__$1) {
case "result":
return bb_web_ds_tools.theme.text_primary;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24997__$1)].join('')));

}
})()], null),text], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.random_uuid()], null)),bb_web_ds_tools$components$editor$render_output_$_iter__24990(cljs.core.rest(s__24991__$2)));
}
} else {
return null;
}
