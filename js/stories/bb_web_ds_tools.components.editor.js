...
return true;
}catch (e24830){if((e24830 instanceof Error)){
var e = e24830;
...
try{var map__24832 = reagent.core.props(this$);
...
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24832__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24832__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24832__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24832__$1,new cljs.core.Keyword(null,"on-focus","on-focus",-13737624));
var on_blur = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24832__$1,new cljs.core.Keyword(null,"on-blur","on-blur",814300747));
var on_mount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24832__$1,new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840));
...
var sub_24861 = editor.onDidChangeModelContent((function (){
cljs.core.reset_BANG_(ignore_change_QMARK_,true);

var new_val_24862 = editor.getValue();
var temp__5825__auto___24863 = cljs.core.deref(on_change_ref);
if(cljs.core.truth_(temp__5825__auto___24863)){
var handler_24864 = temp__5825__auto___24863;
if(cljs.core.vector_QMARK_(handler_24864)){
re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(handler_24864,new_val_24862));
} else {
(handler_24864.cljs$core$IFn$_invoke$arity$1 ? handler_24864.cljs$core$IFn$_invoke$arity$1(new_val_24862) : handler_24864.call(null,new_val_24862));
}
} else {
}
...
cljs.core.reset_BANG_(subscription,sub_24861);
...
}}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (this$,p__24836){
var vec__24837 = p__24836;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24837,(0),null);
var old_props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24837,(1),null);
var map__24840 = reagent.core.props(this$);
var map__24840__$1 = cljs.core.__destructure_map(map__24840);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24840__$1,new cljs.core.Keyword(null,"value","value",305978217));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24840__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24840__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24840__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24840__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var lang_24865 = (function (){var or__5025__auto__ = language;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
var G__24843 = mode;
...
var model_24866 = editor.getModel();
var current_lang_24867 = (cljs.core.truth_(model_24866)?model_24866.getLanguageId():null);
if(cljs.core.truth_((function (){var and__5023__auto__ = model_24866;
if(cljs.core.truth_(and__5023__auto__)){
var and__5023__auto____$1 = lang_24865;
if(cljs.core.truth_(and__5023__auto____$1)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(current_lang_24867,lang_24865);
} else {
...
shadow.js.shim.module$monaco_editor$esm$vs$editor$editor_api.editor.setModelLanguage(model_24866,lang_24865);
} else {
}
...
var temp__5825__auto___24869 = cljs.core.deref(subscription);
if(cljs.core.truth_(temp__5825__auto___24869)){
var sub_24870 = temp__5825__auto___24869;
sub_24870.dispose();
} else {
}
...
var map__24844 = props;
var map__24844__$1 = cljs.core.__destructure_map(map__24844);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24844__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24844__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var G__24847 = bb_web_ds_tools.components.editor.get_code_to_eval(ed);
return (eval_action.cljs$core$IFn$_invoke$arity$1 ? eval_action.cljs$core$IFn$_invoke$arity$1(G__24847) : eval_action.call(null,G__24847));
})], null)));
});
/**
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$components$editor$render_output_$_iter__24848(s__24849){
return (new cljs.core.LazySeq(null,(function (){
var s__24849__$1 = s__24849;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__24849__$1);
if(temp__5825__auto__){
var s__24849__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__24849__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__24849__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__24853 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__24852 = (0);
while(true){
if((i__24852 < size__5502__auto__)){
var map__24854 = cljs.core._nth(c__5501__auto__,i__24852);
var map__24854__$1 = cljs.core.__destructure_map(map__24854);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24854__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24854__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
cljs.core.chunk_append(b__24853,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__24855 = type;
var G__24855__$1 = (((G__24855 instanceof cljs.core.Keyword))?G__24855.fqn:null);
switch (G__24855__$1) {
case "result":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24855__$1)].join('')));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__24853),bb_web_ds_tools$components$editor$render_output_$_iter__24848(cljs.core.chunk_rest(s__24849__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__24853),null);
}
} else {
var map__24856 = cljs.core.first(s__24849__$2);
...
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__24857 = type;
...
})()], null),text], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.random_uuid()], null)),bb_web_ds_tools$components$editor$render_output_$_iter__24848(cljs.core.rest(s__24849__$2)));
}
} else {
return null;
}
