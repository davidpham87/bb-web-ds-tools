...
try{var map__24913 = reagent.core.props(this$);
var map__24913__$1 = cljs.core.__destructure_map(map__24913);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24913__$1,new cljs.core.Keyword(null,"value","value",305978217));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24913__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24913__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24913__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24913__$1,new cljs.core.Keyword(null,"on-focus","on-focus",-13737624));
var on_blur = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24913__$1,new cljs.core.Keyword(null,"on-blur","on-blur",814300747));
var on_mount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24913__$1,new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840));
...
var sub_24972 = editor.onDidChangeModelContent((function (){
cljs.core.reset_BANG_(ignore_change_QMARK_,true);

var new_val_24973 = editor.getValue();
var temp__5825__auto___24974 = cljs.core.deref(on_change_ref);
if(cljs.core.truth_(temp__5825__auto___24974)){
var handler_24975 = temp__5825__auto___24974;
if(cljs.core.vector_QMARK_(handler_24975)){
re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(handler_24975,new_val_24973));
} else {
(handler_24975.cljs$core$IFn$_invoke$arity$1 ? handler_24975.cljs$core$IFn$_invoke$arity$1(new_val_24973) : handler_24975.call(null,new_val_24973));
}
} else {
}
...
cljs.core.reset_BANG_(subscription,sub_24972);
...
}}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (this$,p__24916){
var vec__24917 = p__24916;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24917,(0),null);
var old_props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24917,(1),null);
var map__24920 = reagent.core.props(this$);
var map__24920__$1 = cljs.core.__destructure_map(map__24920);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24920__$1,new cljs.core.Keyword(null,"value","value",305978217));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24920__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24920__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24920__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24920__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var lang_24977 = (function (){var or__5025__auto__ = language;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
var G__24921 = mode;
...
var model_24978 = editor.getModel();
var current_lang_24979 = (cljs.core.truth_(model_24978)?model_24978.getLanguageId():null);
if(cljs.core.truth_((function (){var and__5023__auto__ = model_24978;
if(cljs.core.truth_(and__5023__auto__)){
var and__5023__auto____$1 = lang_24977;
if(cljs.core.truth_(and__5023__auto____$1)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(current_lang_24979,lang_24977);
} else {
...
shadow.js.shim.module$monaco_editor$esm$vs$editor$editor_api.editor.setModelLanguage(model_24978,lang_24977);
} else {
}
...
var temp__5825__auto___24981 = cljs.core.deref(subscription);
if(cljs.core.truth_(temp__5825__auto___24981)){
var sub_24982 = temp__5825__auto___24981;
sub_24982.dispose();
} else {
}
...
var map__24934 = props;
var map__24934__$1 = cljs.core.__destructure_map(map__24934);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24934__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24934__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var G__24943 = bb_web_ds_tools.components.editor.get_code_to_eval(ed);
return (eval_action.cljs$core$IFn$_invoke$arity$1 ? eval_action.cljs$core$IFn$_invoke$arity$1(G__24943) : eval_action.call(null,G__24943));
})], null)));
});
/**
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$components$editor$render_output_$_iter__24951(s__24952){
return (new cljs.core.LazySeq(null,(function (){
var s__24952__$1 = s__24952;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__24952__$1);
if(temp__5825__auto__){
var s__24952__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__24952__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__24952__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__24954 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__24953 = (0);
while(true){
if((i__24953 < size__5502__auto__)){
var map__24955 = cljs.core._nth(c__5501__auto__,i__24953);
var map__24955__$1 = cljs.core.__destructure_map(map__24955);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24955__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24955__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
cljs.core.chunk_append(b__24954,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__24956 = type;
var G__24956__$1 = (((G__24956 instanceof cljs.core.Keyword))?G__24956.fqn:null);
switch (G__24956__$1) {
case "result":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24956__$1)].join('')));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__24954),bb_web_ds_tools$components$editor$render_output_$_iter__24951(cljs.core.chunk_rest(s__24952__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__24954),null);
}
} else {
var map__24969 = cljs.core.first(s__24952__$2);
...
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__24970 = type;
...
})()], null),text], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.random_uuid()], null)),bb_web_ds_tools$components$editor$render_output_$_iter__24951(cljs.core.rest(s__24952__$2)));
}
} else {
return null;
}
