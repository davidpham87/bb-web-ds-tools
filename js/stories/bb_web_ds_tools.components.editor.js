...
}}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (this$,p__24908){
var vec__24909 = p__24908;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24909,(0),null);
var old_props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24909,(1),null);
var map__24912 = reagent.core.props(this$);
var map__24912__$1 = cljs.core.__destructure_map(map__24912);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24912__$1,new cljs.core.Keyword(null,"value","value",305978217));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24912__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24912__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24912__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24912__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var lang_24948 = (function (){var or__5025__auto__ = language;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
var G__24914 = mode;
...
var model_24949 = editor.getModel();
var current_lang_24950 = (cljs.core.truth_(model_24949)?model_24949.getLanguageId():null);
if(cljs.core.truth_((function (){var and__5023__auto__ = model_24949;
if(cljs.core.truth_(and__5023__auto__)){
var and__5023__auto____$1 = lang_24948;
if(cljs.core.truth_(and__5023__auto____$1)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(current_lang_24950,lang_24948);
} else {
...
shadow.js.shim.module$monaco_editor$esm$vs$editor$editor_api.editor.setModelLanguage(model_24949,lang_24948);
} else {
}
...
var temp__5825__auto___24952 = cljs.core.deref(subscription);
if(cljs.core.truth_(temp__5825__auto___24952)){
var sub_24953 = temp__5825__auto___24952;
sub_24953.dispose();
} else {
}
...
var map__24919 = props;
var map__24919__$1 = cljs.core.__destructure_map(map__24919);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24919__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24919__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var G__24922 = bb_web_ds_tools.components.editor.get_code_to_eval(ed);
return (eval_action.cljs$core$IFn$_invoke$arity$1 ? eval_action.cljs$core$IFn$_invoke$arity$1(G__24922) : eval_action.call(null,G__24922));
})], null)));
});
/**
...
var map__24931 = cljs.core._nth(c__5501__auto__,i__24929);
var map__24931__$1 = cljs.core.__destructure_map(map__24931);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24931__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24931__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
cljs.core.chunk_append(b__24930,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__24932 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24932__$1)].join('')));
...
var map__24935 = cljs.core.first(s__24928__$2);
...
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__24936 = type;
