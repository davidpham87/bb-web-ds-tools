...
try{var map__24840 = reagent.core.props(this$);
...
var on_focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24840__$1,new cljs.core.Keyword(null,"on-focus","on-focus",-13737624));
var on_blur = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24840__$1,new cljs.core.Keyword(null,"on-blur","on-blur",814300747));
var on_mount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24840__$1,new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840));
...
var sub_24873 = editor.onDidChangeModelContent((function (){
cljs.core.reset_BANG_(ignore_change_QMARK_,true);

var new_val_24874 = editor.getValue();
var temp__5825__auto___24875 = cljs.core.deref(on_change_ref);
if(cljs.core.truth_(temp__5825__auto___24875)){
var handler_24876 = temp__5825__auto___24875;
if(cljs.core.vector_QMARK_(handler_24876)){
re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(handler_24876,new_val_24874));
} else {
(handler_24876.cljs$core$IFn$_invoke$arity$1 ? handler_24876.cljs$core$IFn$_invoke$arity$1(new_val_24874) : handler_24876.call(null,new_val_24874));
}
} else {
}
...
cljs.core.reset_BANG_(subscription,sub_24873);
...
}catch (e24839){if((e24839 instanceof Error)){
var e = e24839;
...
}}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (this$,p__24844){
var vec__24845 = p__24844;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24845,(0),null);
var old_props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24845,(1),null);
var map__24848 = reagent.core.props(this$);
var map__24848__$1 = cljs.core.__destructure_map(map__24848);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24848__$1,new cljs.core.Keyword(null,"value","value",305978217));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24848__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24848__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24848__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24848__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var lang_24878 = (function (){var or__5025__auto__ = language;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
var G__24849 = mode;
...
var model_24879 = editor.getModel();
var current_lang_24880 = (cljs.core.truth_(model_24879)?model_24879.getLanguageId():null);
if(cljs.core.truth_((function (){var and__5023__auto__ = model_24879;
if(cljs.core.truth_(and__5023__auto__)){
var and__5023__auto____$1 = lang_24878;
if(cljs.core.truth_(and__5023__auto____$1)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(current_lang_24880,lang_24878);
} else {
...
shadow.js.shim.module$monaco_editor$esm$vs$editor$editor_api.editor.setModelLanguage(model_24879,lang_24878);
} else {
}
...
var temp__5825__auto___24882 = cljs.core.deref(subscription);
if(cljs.core.truth_(temp__5825__auto___24882)){
var sub_24883 = temp__5825__auto___24882;
sub_24883.dispose();
} else {
}
...
var map__24851 = props;
var map__24851__$1 = cljs.core.__destructure_map(map__24851);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24851__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24851__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var G__24856 = bb_web_ds_tools.components.editor.get_code_to_eval(ed);
return (eval_action.cljs$core$IFn$_invoke$arity$1 ? eval_action.cljs$core$IFn$_invoke$arity$1(G__24856) : eval_action.call(null,G__24856));
})], null)));
});
/**
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$components$editor$render_output_$_iter__24859(s__24860){
...
var map__24863 = cljs.core._nth(c__5501__auto__,i__24861);
var map__24863__$1 = cljs.core.__destructure_map(map__24863);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24863__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24863__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
cljs.core.chunk_append(b__24862,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__24864 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24864__$1)].join('')));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__24862),bb_web_ds_tools$components$editor$render_output_$_iter__24859(cljs.core.chunk_rest(s__24860__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__24862),null);
}
} else {
var map__24869 = cljs.core.first(s__24860__$2);
var map__24869__$1 = cljs.core.__destructure_map(map__24869);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24869__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24869__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__24870 = type;
var G__24870__$1 = (((G__24870 instanceof cljs.core.Keyword))?G__24870.fqn:null);
switch (G__24870__$1) {
case "result":
return bb_web_ds_tools.theme.text_primary;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24870__$1)].join('')));

}
})()], null),text], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.random_uuid()], null)),bb_web_ds_tools$components$editor$render_output_$_iter__24859(cljs.core.rest(s__24860__$2)));
}
} else {
return null;
}
