...
var sub_24881 = editor.onDidChangeModelContent((function (){
cljs.core.reset_BANG_(ignore_change_QMARK_,true);

var new_val_24882 = editor.getValue();
var temp__5825__auto___24883 = cljs.core.deref(on_change_ref);
if(cljs.core.truth_(temp__5825__auto___24883)){
var handler_24884 = temp__5825__auto___24883;
if(cljs.core.vector_QMARK_(handler_24884)){
re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(handler_24884,new_val_24882));
} else {
(handler_24884.cljs$core$IFn$_invoke$arity$1 ? handler_24884.cljs$core$IFn$_invoke$arity$1(new_val_24882) : handler_24884.call(null,new_val_24882));
}
} else {
}
...
cljs.core.reset_BANG_(subscription,sub_24881);
...
var lang_24885 = (function (){var or__5025__auto__ = language;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
var G__24850 = mode;
...
var model_24886 = editor.getModel();
var current_lang_24887 = (cljs.core.truth_(model_24886)?model_24886.getLanguageId():null);
if(cljs.core.truth_((function (){var and__5023__auto__ = model_24886;
if(cljs.core.truth_(and__5023__auto__)){
var and__5023__auto____$1 = lang_24885;
if(cljs.core.truth_(and__5023__auto____$1)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(current_lang_24887,lang_24885);
} else {
...
shadow.js.shim.module$monaco_editor$esm$vs$editor$editor_api.editor.setModelLanguage(model_24886,lang_24885);
} else {
}
...
var temp__5825__auto___24889 = cljs.core.deref(subscription);
if(cljs.core.truth_(temp__5825__auto___24889)){
var sub_24891 = temp__5825__auto___24889;
sub_24891.dispose();
} else {
}
...
var G__24860 = bb_web_ds_tools.components.editor.get_code_to_eval(ed);
return (eval_action.cljs$core$IFn$_invoke$arity$1 ? eval_action.cljs$core$IFn$_invoke$arity$1(G__24860) : eval_action.call(null,G__24860));
})], null)));
});
/**
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$components$editor$render_output_$_iter__24861(s__24862){
...
var b__24864 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__24863 = (0);
while(true){
if((i__24863 < size__5502__auto__)){
var map__24865 = cljs.core._nth(c__5501__auto__,i__24863);
var map__24865__$1 = cljs.core.__destructure_map(map__24865);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24865__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24865__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
cljs.core.chunk_append(b__24864,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__24866 = type;
var G__24866__$1 = (((G__24866 instanceof cljs.core.Keyword))?G__24866.fqn:null);
switch (G__24866__$1) {
case "result":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24866__$1)].join('')));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__24864),bb_web_ds_tools$components$editor$render_output_$_iter__24861(cljs.core.chunk_rest(s__24862__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__24864),null);
}
} else {
var map__24870 = cljs.core.first(s__24862__$2);
...
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24870__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__24871 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24871__$1)].join('')));

}
})()], null),text], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.random_uuid()], null)),bb_web_ds_tools$components$editor$render_output_$_iter__24861(cljs.core.rest(s__24862__$2)));
}
} else {
return null;
}
