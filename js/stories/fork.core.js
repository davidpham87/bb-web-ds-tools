...
fork.core.initialize_state = (function fork$core$initialize_state(p__24945){
var map__24949 = p__24945;
var map__24949__$1 = cljs.core.__destructure_map(map__24949);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24949__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
...
var initial_values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24949__$1,new cljs.core.Keyword(null,"initial-values","initial-values",1392120293));
var initial_touched = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24949__$1,new cljs.core.Keyword(null,"initial-touched","initial-touched",-1887894494));
...
var el_name = (function (){var G__24957 = t;
var G__24957__$1 = (((G__24957 instanceof cljs.core.Keyword))?G__24957.fqn:null);
switch (G__24957__$1) {
case "evt":
...
fork.core.normalize_name = (function fork$core$normalize_name(k,p__24958){
var map__24959 = p__24958;
var map__24959__$1 = cljs.core.__destructure_map(map__24959);
var keywordize_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24959__$1,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252));
...
return cljs.core.not_empty(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__24964){
...
fork.core.set_handle_blur = (function fork$core$set_handle_blur(p__25003,state){
var map__25004 = p__25003;
var map__25004__$1 = cljs.core.__destructure_map(map__25004);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25004__$1,new cljs.core.Keyword(null,"value","value",305978217));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25004__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var path__$1 = fork.core.vectorize_path(path);
...
var vec__25012 = cljs.core.last(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__25011_SHARP_,p2__25010_SHARP_){
if(typeof p2__25010_SHARP_ === 'number'){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__25011_SHARP_,p2__25010_SHARP_], null);
} else {
return null;
}
}),touched_el)));
var position = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25012,(0),null);
var curr_idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25012,(1),null);
if((curr_idx > idx)){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(s,cljs.core.cons(new cljs.core.Keyword(null,"values","values",372645556),vec_field_array_key),fork.core.vec_remove,idx),new cljs.core.Keyword(null,"touched","touched",-609134419),(function (p1__25016_SHARP_){
return fork.core.fieldarray_update_touched(p1__25016_SHARP_,vec_field_array_key,idx);
}));
}));
});
...
fork.core.handle_submit = (function fork$core$handle_submit(evt,p__25021){
var map__25022 = p__25021;
var map__25022__$1 = cljs.core.__destructure_map(map__25022);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25022__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var server = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25022__$1,new cljs.core.Keyword(null,"server","server",1499190120));
var on_submit = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25022__$1,new cljs.core.Keyword(null,"on-submit","on-submit",1227871159));
var prevent_default_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25022__$1,new cljs.core.Keyword(null,"prevent-default?","prevent-default?",-1165567888));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25022__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var validation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25022__$1,new cljs.core.Keyword(null,"validation","validation",-2141396518));
var already_submitting_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25022__$1,new cljs.core.Keyword(null,"already-submitting?","already-submitting?",1438118407));
var reset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25022__$1,new cljs.core.Keyword(null,"reset","reset",-800929946));
...
if(((cljs.core.not(already_submitting_QMARK_)) && ((((validation == null)) && ((((fork.core.resolve_server_validation(server) == null)) && (cljs.core.every_QMARK_((function (p1__25020_SHARP_){
return new cljs.core.Keyword(null,"waiting?","waiting?",-2117257215).cljs$core$IFn$_invoke$arity$1(p1__25020_SHARP_) === false;
...
var G__25023 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"state","state",-1988618099),state,new cljs.core.Keyword(null,"path","path",-188191168),path,new cljs.core.Keyword(null,"values","values",372645556),new cljs.core.Keyword(null,"values","values",372645556).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),new cljs.core.Keyword(null,"dirty","dirty",729553281),fork.core.dirty(new cljs.core.Keyword(null,"values","values",372645556).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"initial-values","initial-values",1392120293).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),new cljs.core.Keyword(null,"touched-values","touched-values",-1817885644).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state))], 0))),new cljs.core.Keyword(null,"reset","reset",-800929946),reset], null);
return (on_submit.cljs$core$IFn$_invoke$arity$1 ? on_submit.cljs$core$IFn$_invoke$arity$1(G__25023) : on_submit.call(null,G__25023));
} else {
return null;
}
});
fork.core.send_server_request = (function fork$core$send_server_request(http_fn,p__25024){
var map__25025 = p__25024;
var map__25025__$1 = cljs.core.__destructure_map(map__25025);
var validation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25025__$1,new cljs.core.Keyword(null,"validation","validation",-2141396518));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25025__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var debounce = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25025__$1,new cljs.core.Keyword(null,"debounce","debounce",-871550296));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25025__$1,new cljs.core.Keyword(null,"value","value",305978217));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25025__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var evt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25025__$1,new cljs.core.Keyword(null,"evt","evt",-1251566867));
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25025__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var server_dispatch_logic = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25025__$1,new cljs.core.Keyword(null,"server-dispatch-logic","server-dispatch-logic",-465441551));
var throttle = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25025__$1,new cljs.core.Keyword(null,"throttle","throttle",-1860340776));
var input_key = name;
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.update_in,cljs.core.cons(new cljs.core.Keyword(null,"values","values",372645556),vec_field_array_key),(function (p1__25058_SHARP_){
return fork.core.vec_insert_at(fork.core.vec_remove(p1__25058_SHARP_,dragged_idx),dropped_idx,cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__25058_SHARP_,dragged_idx));
}));
});
fork.core.current_target_idx = (function fork$core$current_target_idx(state,k){
var G__25063 = cljs.core.deref(state);
var G__25063__$1 = (((G__25063 == null))?null:new cljs.core.Keyword(null,"drag-and-drop","drag-and-drop",-1528484051).cljs$core$IFn$_invoke$arity$1(G__25063));
var G__25063__$2 = (((G__25063__$1 == null))?null:(k.cljs$core$IFn$_invoke$arity$1 ? k.cljs$core$IFn$_invoke$arity$1(G__25063__$1) : k.call(null,G__25063__$1)));
if((G__25063__$2 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"idx-of-element-droppable-location","idx-of-element-droppable-location",1338425922).cljs$core$IFn$_invoke$arity$1(G__25063__$2);
}
});
fork.core.current_dragged_idx = (function fork$core$current_dragged_idx(state,k){
var G__25064 = cljs.core.deref(state);
var G__25064__$1 = (((G__25064 == null))?null:new cljs.core.Keyword(null,"drag-and-drop","drag-and-drop",-1528484051).cljs$core$IFn$_invoke$arity$1(G__25064));
var G__25064__$2 = (((G__25064__$1 == null))?null:(k.cljs$core$IFn$_invoke$arity$1 ? k.cljs$core$IFn$_invoke$arity$1(G__25064__$1) : k.call(null,G__25064__$1)));
if((G__25064__$2 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"idx-of-item-being-dragged","idx-of-item-being-dragged",1912676382).cljs$core$IFn$_invoke$arity$1(G__25064__$2);
}
});
...
}),(function (p1__25066_SHARP_){
return fork.core.set_handle_blur(p1__25066_SHARP_,state);
...
}),(function (p1__25065_SHARP_){
return fork.core.set_handle_change(p1__25065_SHARP_,state);
}),(function (k,idx){
