...
fork.core.initialize_state = (function fork$core$initialize_state(p__24957){
var map__24958 = p__24957;
var map__24958__$1 = cljs.core.__destructure_map(map__24958);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24958__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var keywordize_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24958__$1,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252));
var initial_values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24958__$1,new cljs.core.Keyword(null,"initial-values","initial-values",1392120293));
var initial_touched = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24958__$1,new cljs.core.Keyword(null,"initial-touched","initial-touched",-1887894494));
...
var el_name = (function (){var G__24960 = t;
...
fork.core.normalize_name = (function fork$core$normalize_name(k,p__24961){
var map__24962 = p__24961;
var map__24962__$1 = cljs.core.__destructure_map(map__24962);
var keywordize_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24962__$1,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252));
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,(function (p1__24963_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$4(p1__24963_SHARP_,new cljs.core.Keyword(null,"values","values",372645556),cljs.core.merge,new_values),new cljs.core.Keyword(null,"touched","touched",-609134419),(function (x,y){
...
return cljs.core.not_empty(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__24968){
var vec__24969 = p__24968;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24969,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24969,(1),null);
...
var len__5749__auto___25085 = arguments.length;
var i__5750__auto___25086 = (0);
while(true){
if((i__5750__auto___25086 < len__5749__auto___25085)){
args__5755__auto__.push((arguments[i__5750__auto___25086]));

var G__25087 = (i__5750__auto___25086 + (1));
i__5750__auto___25086 = G__25087;
continue;
} else {
}
break;
...
(fork.core.disable.cljs$core$IFn$_invoke$arity$variadic = (function (state,p__24975){
var vec__24976 = p__24975;
var ks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24976,(0),null);
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.update,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181),(function (p1__24972_SHARP_){
return fork.core.disable_logic(p1__24972_SHARP_,ks);
}));
}));
...
/** @this {Function} */
(fork.core.disable.cljs$lang$applyTo = (function (seq24973){
var G__24974 = cljs.core.first(seq24973);
var seq24973__$1 = cljs.core.next(seq24973);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24974,seq24973__$1);
}));
...
(fork.core.enable.cljs$core$IFn$_invoke$arity$variadic = (function (state,p__24982){
var vec__24983 = p__24982;
var ks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24983,(0),null);
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.update,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181),(function (p1__24979_SHARP_){
return fork.core.enable_logic(p1__24979_SHARP_,ks);
}));
}));
...
/** @this {Function} */
(fork.core.enable.cljs$lang$applyTo = (function (seq24980){
var G__24981 = cljs.core.first(seq24980);
var seq24980__$1 = cljs.core.next(seq24980);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24981,seq24980__$1);
}));
...
fork.core.set_handle_change_one = (function fork$core$set_handle_change_one(deref_state,p__24992){
var map__24993 = p__24992;
var map__24993__$1 = cljs.core.__destructure_map(map__24993);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24993__$1,new cljs.core.Keyword(null,"value","value",305978217));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24993__$1,new cljs.core.Keyword(null,"path","path",-188191168));
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,(function (p1__24994_SHARP_){
return fork.core.set_handle_change_one(p1__24994_SHARP_,params);
}));
} else {
...
fork.core.set_handle_blur = (function fork$core$set_handle_blur(p__24995,state){
var map__24996 = p__24995;
var map__24996__$1 = cljs.core.__destructure_map(map__24996);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24996__$1,new cljs.core.Keyword(null,"value","value",305978217));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24996__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var path__$1 = fork.core.vectorize_path(path);
...
var vec__24999 = cljs.core.last(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__24998_SHARP_,p2__24997_SHARP_){
if(typeof p2__24997_SHARP_ === 'number'){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__24998_SHARP_,p2__24997_SHARP_], null);
} else {
return null;
}
}),touched_el)));
var position = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24999,(0),null);
var curr_idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24999,(1),null);
if((curr_idx > idx)){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(s,cljs.core.cons(new cljs.core.Keyword(null,"values","values",372645556),vec_field_array_key),fork.core.vec_remove,idx),new cljs.core.Keyword(null,"touched","touched",-609134419),(function (p1__25002_SHARP_){
return fork.core.fieldarray_update_touched(p1__25002_SHARP_,vec_field_array_key,idx);
}));
}));
});
...
fork.core.handle_submit = (function fork$core$handle_submit(evt,p__25008){
var map__25009 = p__25008;
var map__25009__$1 = cljs.core.__destructure_map(map__25009);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25009__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var server = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25009__$1,new cljs.core.Keyword(null,"server","server",1499190120));
var on_submit = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25009__$1,new cljs.core.Keyword(null,"on-submit","on-submit",1227871159));
var prevent_default_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25009__$1,new cljs.core.Keyword(null,"prevent-default?","prevent-default?",-1165567888));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25009__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var validation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25009__$1,new cljs.core.Keyword(null,"validation","validation",-2141396518));
var already_submitting_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25009__$1,new cljs.core.Keyword(null,"already-submitting?","already-submitting?",1438118407));
var reset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25009__$1,new cljs.core.Keyword(null,"reset","reset",-800929946));
...
if(((cljs.core.not(already_submitting_QMARK_)) && ((((validation == null)) && ((((fork.core.resolve_server_validation(server) == null)) && (cljs.core.every_QMARK_((function (p1__25007_SHARP_){
return new cljs.core.Keyword(null,"waiting?","waiting?",-2117257215).cljs$core$IFn$_invoke$arity$1(p1__25007_SHARP_) === false;
...
var G__25016 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"state","state",-1988618099),state,new cljs.core.Keyword(null,"path","path",-188191168),path,new cljs.core.Keyword(null,"values","values",372645556),new cljs.core.Keyword(null,"values","values",372645556).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),new cljs.core.Keyword(null,"dirty","dirty",729553281),fork.core.dirty(new cljs.core.Keyword(null,"values","values",372645556).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"initial-values","initial-values",1392120293).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),new cljs.core.Keyword(null,"touched-values","touched-values",-1817885644).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state))], 0))),new cljs.core.Keyword(null,"reset","reset",-800929946),reset], null);
return (on_submit.cljs$core$IFn$_invoke$arity$1 ? on_submit.cljs$core$IFn$_invoke$arity$1(G__25016) : on_submit.call(null,G__25016));
} else {
return null;
}
});
fork.core.send_server_request = (function fork$core$send_server_request(http_fn,p__25017){
var map__25018 = p__25017;
var map__25018__$1 = cljs.core.__destructure_map(map__25018);
var validation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25018__$1,new cljs.core.Keyword(null,"validation","validation",-2141396518));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25018__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var debounce = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25018__$1,new cljs.core.Keyword(null,"debounce","debounce",-871550296));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25018__$1,new cljs.core.Keyword(null,"value","value",305978217));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25018__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var evt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25018__$1,new cljs.core.Keyword(null,"evt","evt",-1251566867));
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25018__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var server_dispatch_logic = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25018__$1,new cljs.core.Keyword(null,"server-dispatch-logic","server-dispatch-logic",-465441551));
var throttle = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25018__$1,new cljs.core.Keyword(null,"throttle","throttle",-1860340776));
var input_key = name;
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.update_in,cljs.core.cons(new cljs.core.Keyword(null,"values","values",372645556),vec_field_array_key),(function (p1__25026_SHARP_){
return fork.core.vec_insert_at(fork.core.vec_remove(p1__25026_SHARP_,dragged_idx),dropped_idx,cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__25026_SHARP_,dragged_idx));
}));
});
fork.core.current_target_idx = (function fork$core$current_target_idx(state,k){
var G__25030 = cljs.core.deref(state);
var G__25030__$1 = (((G__25030 == null))?null:new cljs.core.Keyword(null,"drag-and-drop","drag-and-drop",-1528484051).cljs$core$IFn$_invoke$arity$1(G__25030));
var G__25030__$2 = (((G__25030__$1 == null))?null:(k.cljs$core$IFn$_invoke$arity$1 ? k.cljs$core$IFn$_invoke$arity$1(G__25030__$1) : k.call(null,G__25030__$1)));
if((G__25030__$2 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"idx-of-element-droppable-location","idx-of-element-droppable-location",1338425922).cljs$core$IFn$_invoke$arity$1(G__25030__$2);
}
});
fork.core.current_dragged_idx = (function fork$core$current_dragged_idx(state,k){
var G__25046 = cljs.core.deref(state);
var G__25046__$1 = (((G__25046 == null))?null:new cljs.core.Keyword(null,"drag-and-drop","drag-and-drop",-1528484051).cljs$core$IFn$_invoke$arity$1(G__25046));
var G__25046__$2 = (((G__25046__$1 == null))?null:(k.cljs$core$IFn$_invoke$arity$1 ? k.cljs$core$IFn$_invoke$arity$1(G__25046__$1) : k.call(null,G__25046__$1)));
if((G__25046__$2 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"idx-of-item-being-dragged","idx-of-item-being-dragged",1912676382).cljs$core$IFn$_invoke$arity$1(G__25046__$2);
}
});
...
}),(function (p1__25048_SHARP_){
return fork.core.set_handle_blur(p1__25048_SHARP_,state);
...
}),(function (p1__25047_SHARP_){
return fork.core.set_handle_change(p1__25047_SHARP_,state);
}),(function (k,idx){
...
return (function (p__25059,component){
var map__25060 = p__25059;
var map__25060__$1 = cljs.core.__destructure_map(map__25060);
var args = map__25060__$1;
var props__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25060__$1,new cljs.core.Keyword(null,"props","props",453281727));
