...
fork.core.initialize_state = (function fork$core$initialize_state(p__24942){
var map__24943 = p__24942;
var map__24943__$1 = cljs.core.__destructure_map(map__24943);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24943__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
...
var initial_values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24943__$1,new cljs.core.Keyword(null,"initial-values","initial-values",1392120293));
var initial_touched = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24943__$1,new cljs.core.Keyword(null,"initial-touched","initial-touched",-1887894494));
...
var len__5749__auto___25069 = arguments.length;
var i__5750__auto___25070 = (0);
while(true){
if((i__5750__auto___25070 < len__5749__auto___25069)){
args__5755__auto__.push((arguments[i__5750__auto___25070]));

var G__25071 = (i__5750__auto___25070 + (1));
i__5750__auto___25070 = G__25071;
continue;
} else {
}
break;
...
(fork.core.disable.cljs$core$IFn$_invoke$arity$variadic = (function (state,p__24958){
var vec__24959 = p__24958;
var ks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24959,(0),null);
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.update,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181),(function (p1__24955_SHARP_){
return fork.core.disable_logic(p1__24955_SHARP_,ks);
}));
}));
...
/** @this {Function} */
(fork.core.disable.cljs$lang$applyTo = (function (seq24956){
var G__24957 = cljs.core.first(seq24956);
var seq24956__$1 = cljs.core.next(seq24956);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24957,seq24956__$1);
}));
...
var G__25086 = (i__5750__auto___25077 + (1));
i__5750__auto___25077 = G__25086;
continue;
} else {
}
break;
...
(fork.core.enable.cljs$core$IFn$_invoke$arity$variadic = (function (state,p__24965){
var vec__24966 = p__24965;
var ks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24966,(0),null);
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.update,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181),(function (p1__24962_SHARP_){
return fork.core.enable_logic(p1__24962_SHARP_,ks);
}));
}));
...
/** @this {Function} */
(fork.core.enable.cljs$lang$applyTo = (function (seq24963){
var G__24964 = cljs.core.first(seq24963);
var seq24963__$1 = cljs.core.next(seq24963);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24964,seq24963__$1);
}));
...
fork.core.set_handle_change_one = (function fork$core$set_handle_change_one(deref_state,p__24981){
var map__24982 = p__24981;
var map__24982__$1 = cljs.core.__destructure_map(map__24982);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24982__$1,new cljs.core.Keyword(null,"value","value",305978217));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24982__$1,new cljs.core.Keyword(null,"path","path",-188191168));
...
return fork.core.set_handle_change_one(p1__24983_SHARP_,params);
}));
} else {
...
fork.core.set_handle_blur = (function fork$core$set_handle_blur(p__24986,state){
var map__24987 = p__24986;
var map__24987__$1 = cljs.core.__destructure_map(map__24987);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24987__$1,new cljs.core.Keyword(null,"value","value",305978217));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24987__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var path__$1 = fork.core.vectorize_path(path);
...
var vec__24994 = cljs.core.last(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__24991_SHARP_,p2__24990_SHARP_){
if(typeof p2__24990_SHARP_ === 'number'){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__24991_SHARP_,p2__24990_SHARP_], null);
} else {
return null;
}
}),touched_el)));
var position = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24994,(0),null);
var curr_idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24994,(1),null);
if((curr_idx > idx)){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(s,cljs.core.cons(new cljs.core.Keyword(null,"values","values",372645556),vec_field_array_key),fork.core.vec_remove,idx),new cljs.core.Keyword(null,"touched","touched",-609134419),(function (p1__24999_SHARP_){
return fork.core.fieldarray_update_touched(p1__24999_SHARP_,vec_field_array_key,idx);
}));
}));
});
...
fork.core.handle_submit = (function fork$core$handle_submit(evt,p__25005){
var map__25012 = p__25005;
var map__25012__$1 = cljs.core.__destructure_map(map__25012);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25012__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var server = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25012__$1,new cljs.core.Keyword(null,"server","server",1499190120));
var on_submit = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25012__$1,new cljs.core.Keyword(null,"on-submit","on-submit",1227871159));
var prevent_default_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25012__$1,new cljs.core.Keyword(null,"prevent-default?","prevent-default?",-1165567888));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25012__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var validation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25012__$1,new cljs.core.Keyword(null,"validation","validation",-2141396518));
var already_submitting_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25012__$1,new cljs.core.Keyword(null,"already-submitting?","already-submitting?",1438118407));
var reset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25012__$1,new cljs.core.Keyword(null,"reset","reset",-800929946));
...
if(((cljs.core.not(already_submitting_QMARK_)) && ((((validation == null)) && ((((fork.core.resolve_server_validation(server) == null)) && (cljs.core.every_QMARK_((function (p1__25003_SHARP_){
return new cljs.core.Keyword(null,"waiting?","waiting?",-2117257215).cljs$core$IFn$_invoke$arity$1(p1__25003_SHARP_) === false;
...
var G__25019 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"state","state",-1988618099),state,new cljs.core.Keyword(null,"path","path",-188191168),path,new cljs.core.Keyword(null,"values","values",372645556),new cljs.core.Keyword(null,"values","values",372645556).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),new cljs.core.Keyword(null,"dirty","dirty",729553281),fork.core.dirty(new cljs.core.Keyword(null,"values","values",372645556).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"initial-values","initial-values",1392120293).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),new cljs.core.Keyword(null,"touched-values","touched-values",-1817885644).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state))], 0))),new cljs.core.Keyword(null,"reset","reset",-800929946),reset], null);
return (on_submit.cljs$core$IFn$_invoke$arity$1 ? on_submit.cljs$core$IFn$_invoke$arity$1(G__25019) : on_submit.call(null,G__25019));
} else {
return null;
}
});
fork.core.send_server_request = (function fork$core$send_server_request(http_fn,p__25032){
var map__25033 = p__25032;
var map__25033__$1 = cljs.core.__destructure_map(map__25033);
var validation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25033__$1,new cljs.core.Keyword(null,"validation","validation",-2141396518));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25033__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var debounce = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25033__$1,new cljs.core.Keyword(null,"debounce","debounce",-871550296));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25033__$1,new cljs.core.Keyword(null,"value","value",305978217));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25033__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var evt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25033__$1,new cljs.core.Keyword(null,"evt","evt",-1251566867));
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25033__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var server_dispatch_logic = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25033__$1,new cljs.core.Keyword(null,"server-dispatch-logic","server-dispatch-logic",-465441551));
var throttle = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25033__$1,new cljs.core.Keyword(null,"throttle","throttle",-1860340776));
var input_key = name;
...
return (function (p__25052,component){
var map__25053 = p__25052;
var map__25053__$1 = cljs.core.__destructure_map(map__25053);
var args = map__25053__$1;
var props__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25053__$1,new cljs.core.Keyword(null,"props","props",453281727));
