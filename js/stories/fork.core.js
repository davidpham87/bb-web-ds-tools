...
$CLJS.SHADOW_ENV.setLoaded("fork.core.js");
...
fork.core.initialize_state = (function fork$core$initialize_state(p__24971){
var map__24972 = p__24971;
var map__24972__$1 = cljs.core.__destructure_map(map__24972);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24972__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var keywordize_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24972__$1,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252));
var initial_values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24972__$1,new cljs.core.Keyword(null,"initial-values","initial-values",1392120293));
var initial_touched = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24972__$1,new cljs.core.Keyword(null,"initial-touched","initial-touched",-1887894494));
...
var el_name = (function (){var G__24982 = t;
...
fork.core.normalize_name = (function fork$core$normalize_name(k,p__24990){
var map__24991 = p__24990;
var map__24991__$1 = cljs.core.__destructure_map(map__24991);
var keywordize_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24991__$1,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252));
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,(function (p1__25003_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$4(p1__25003_SHARP_,new cljs.core.Keyword(null,"values","values",372645556),cljs.core.merge,new_values),new cljs.core.Keyword(null,"touched","touched",-609134419),(function (x,y){
...
return cljs.core.not_empty(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__25040){
var vec__25041 = p__25040;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25041,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25041,(1),null);
...
var len__5749__auto___25121 = arguments.length;
var i__5750__auto___25122 = (0);
while(true){
if((i__5750__auto___25122 < len__5749__auto___25121)){
args__5755__auto__.push((arguments[i__5750__auto___25122]));

var G__25123 = (i__5750__auto___25122 + (1));
i__5750__auto___25122 = G__25123;
continue;
} else {
}
break;
...
(fork.core.disable.cljs$core$IFn$_invoke$arity$variadic = (function (state,p__25048){
var vec__25049 = p__25048;
var ks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25049,(0),null);
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.update,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181),(function (p1__25045_SHARP_){
return fork.core.disable_logic(p1__25045_SHARP_,ks);
}));
}));
...
/** @this {Function} */
(fork.core.disable.cljs$lang$applyTo = (function (seq25046){
var G__25047 = cljs.core.first(seq25046);
var seq25046__$1 = cljs.core.next(seq25046);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25047,seq25046__$1);
}));
...
(fork.core.enable.cljs$core$IFn$_invoke$arity$variadic = (function (state,p__25055){
var vec__25056 = p__25055;
var ks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25056,(0),null);
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.update,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181),(function (p1__25052_SHARP_){
return fork.core.enable_logic(p1__25052_SHARP_,ks);
}));
}));
...
/** @this {Function} */
(fork.core.enable.cljs$lang$applyTo = (function (seq25053){
var G__25054 = cljs.core.first(seq25053);
var seq25053__$1 = cljs.core.next(seq25053);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25054,seq25053__$1);
}));
...
fork.core.set_handle_change_one = (function fork$core$set_handle_change_one(deref_state,p__25059){
var map__25060 = p__25059;
var map__25060__$1 = cljs.core.__destructure_map(map__25060);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25060__$1,new cljs.core.Keyword(null,"value","value",305978217));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25060__$1,new cljs.core.Keyword(null,"path","path",-188191168));
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,(function (p1__25061_SHARP_){
return fork.core.set_handle_change_one(p1__25061_SHARP_,params);
}));
} else {
...
fork.core.set_handle_blur = (function fork$core$set_handle_blur(p__25062,state){
var map__25063 = p__25062;
var map__25063__$1 = cljs.core.__destructure_map(map__25063);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25063__$1,new cljs.core.Keyword(null,"value","value",305978217));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25063__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var path__$1 = fork.core.vectorize_path(path);
...
var vec__25066 = cljs.core.last(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__25065_SHARP_,p2__25064_SHARP_){
if(typeof p2__25064_SHARP_ === 'number'){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__25065_SHARP_,p2__25064_SHARP_], null);
} else {
return null;
}
}),touched_el)));
var position = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25066,(0),null);
var curr_idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25066,(1),null);
if((curr_idx > idx)){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(s,cljs.core.cons(new cljs.core.Keyword(null,"values","values",372645556),vec_field_array_key),fork.core.vec_remove,idx),new cljs.core.Keyword(null,"touched","touched",-609134419),(function (p1__25069_SHARP_){
return fork.core.fieldarray_update_touched(p1__25069_SHARP_,vec_field_array_key,idx);
}));
}));
});
...
fork.core.handle_submit = (function fork$core$handle_submit(evt,p__25071){
var map__25072 = p__25071;
var map__25072__$1 = cljs.core.__destructure_map(map__25072);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25072__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var server = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25072__$1,new cljs.core.Keyword(null,"server","server",1499190120));
var on_submit = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25072__$1,new cljs.core.Keyword(null,"on-submit","on-submit",1227871159));
var prevent_default_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25072__$1,new cljs.core.Keyword(null,"prevent-default?","prevent-default?",-1165567888));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25072__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var validation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25072__$1,new cljs.core.Keyword(null,"validation","validation",-2141396518));
var already_submitting_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25072__$1,new cljs.core.Keyword(null,"already-submitting?","already-submitting?",1438118407));
var reset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25072__$1,new cljs.core.Keyword(null,"reset","reset",-800929946));
...
if(((cljs.core.not(already_submitting_QMARK_)) && ((((validation == null)) && ((((fork.core.resolve_server_validation(server) == null)) && (cljs.core.every_QMARK_((function (p1__25070_SHARP_){
return new cljs.core.Keyword(null,"waiting?","waiting?",-2117257215).cljs$core$IFn$_invoke$arity$1(p1__25070_SHARP_) === false;
...
var G__25073 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"state","state",-1988618099),state,new cljs.core.Keyword(null,"path","path",-188191168),path,new cljs.core.Keyword(null,"values","values",372645556),new cljs.core.Keyword(null,"values","values",372645556).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),new cljs.core.Keyword(null,"dirty","dirty",729553281),fork.core.dirty(new cljs.core.Keyword(null,"values","values",372645556).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"initial-values","initial-values",1392120293).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),new cljs.core.Keyword(null,"touched-values","touched-values",-1817885644).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state))], 0))),new cljs.core.Keyword(null,"reset","reset",-800929946),reset], null);
return (on_submit.cljs$core$IFn$_invoke$arity$1 ? on_submit.cljs$core$IFn$_invoke$arity$1(G__25073) : on_submit.call(null,G__25073));
} else {
return null;
}
});
fork.core.send_server_request = (function fork$core$send_server_request(http_fn,p__25076){
var map__25079 = p__25076;
var map__25079__$1 = cljs.core.__destructure_map(map__25079);
var validation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25079__$1,new cljs.core.Keyword(null,"validation","validation",-2141396518));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25079__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var debounce = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25079__$1,new cljs.core.Keyword(null,"debounce","debounce",-871550296));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25079__$1,new cljs.core.Keyword(null,"value","value",305978217));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25079__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var evt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25079__$1,new cljs.core.Keyword(null,"evt","evt",-1251566867));
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25079__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var server_dispatch_logic = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25079__$1,new cljs.core.Keyword(null,"server-dispatch-logic","server-dispatch-logic",-465441551));
var throttle = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25079__$1,new cljs.core.Keyword(null,"throttle","throttle",-1860340776));
var input_key = name;
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.update_in,cljs.core.cons(new cljs.core.Keyword(null,"values","values",372645556),vec_field_array_key),(function (p1__25090_SHARP_){
return fork.core.vec_insert_at(fork.core.vec_remove(p1__25090_SHARP_,dragged_idx),dropped_idx,cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__25090_SHARP_,dragged_idx));
}));
});
fork.core.current_target_idx = (function fork$core$current_target_idx(state,k){
var G__25095 = cljs.core.deref(state);
var G__25095__$1 = (((G__25095 == null))?null:new cljs.core.Keyword(null,"drag-and-drop","drag-and-drop",-1528484051).cljs$core$IFn$_invoke$arity$1(G__25095));
var G__25095__$2 = (((G__25095__$1 == null))?null:(k.cljs$core$IFn$_invoke$arity$1 ? k.cljs$core$IFn$_invoke$arity$1(G__25095__$1) : k.call(null,G__25095__$1)));
if((G__25095__$2 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"idx-of-element-droppable-location","idx-of-element-droppable-location",1338425922).cljs$core$IFn$_invoke$arity$1(G__25095__$2);
}
});
fork.core.current_dragged_idx = (function fork$core$current_dragged_idx(state,k){
var G__25096 = cljs.core.deref(state);
var G__25096__$1 = (((G__25096 == null))?null:new cljs.core.Keyword(null,"drag-and-drop","drag-and-drop",-1528484051).cljs$core$IFn$_invoke$arity$1(G__25096));
var G__25096__$2 = (((G__25096__$1 == null))?null:(k.cljs$core$IFn$_invoke$arity$1 ? k.cljs$core$IFn$_invoke$arity$1(G__25096__$1) : k.call(null,G__25096__$1)));
if((G__25096__$2 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"idx-of-item-being-dragged","idx-of-item-being-dragged",1912676382).cljs$core$IFn$_invoke$arity$1(G__25096__$2);
}
});
...
}),(function (p1__25100_SHARP_){
return fork.core.set_handle_blur(p1__25100_SHARP_,state);
...
}),(function (p1__25099_SHARP_){
return fork.core.set_handle_change(p1__25099_SHARP_,state);
}),(function (k,idx){
...
return (function (p__25110,component){
var map__25112 = p__25110;
var map__25112__$1 = cljs.core.__destructure_map(map__25112);
var args = map__25112__$1;
var props__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25112__$1,new cljs.core.Keyword(null,"props","props",453281727));
