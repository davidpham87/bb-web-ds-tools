...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_33327 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_33327(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_33328 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_33328(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_33329 = (function (reader,ch){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_33329(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_33330 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_33330(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_33331 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_33331(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_33332 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_33332(reader);
}
});
...
var G__33368 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__33369 = s.append(c);
c = G__33368;
s = G__33369;
continue;
}
