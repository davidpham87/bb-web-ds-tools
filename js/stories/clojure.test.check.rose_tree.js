...
return cljs.core.cons(cljs.core.first(s),(function (){var G__30042 = (n - (1));
var G__30043 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__30042,G__30043) : clojure.test.check.rose_tree.exclude_nth.call(null,G__30042,G__30043));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__30048 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__30048) : f.call(null,G__30048));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30046_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__30046_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__30046_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30049_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__30049_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__30049_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__30050_SHARP_){
var G__30052 = clojure.test.check.rose_tree.root(p1__30050_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__30052) : pred.call(null,G__30052));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__5503__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__30055(s__30056){
return (new cljs.core.LazySeq(null,(function (){
...
var vec__30062 = cljs.core.first(xs__6385__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30062,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30062,(1),null);
var iterys__5499__auto__ = ((function (s__30056__$1,vec__30062,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__30055_$_iter__30057(s__30058){
return (new cljs.core.LazySeq(null,((function (s__30056__$1,vec__30062,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function (){
var s__30058__$1 = s__30058;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__30058__$1);
if(temp__5825__auto____$1){
var s__30058__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__30058__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__30058__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__30060 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__30059 = (0);
while(true){
if((i__30059 < size__5502__auto__)){
var child = cljs.core._nth(c__5501__auto__,i__30059);
cljs.core.chunk_append(b__30060,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__30123 = (i__30059 + (1));
i__30059 = G__30123;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30060),clojure$test$check$rose_tree$permutations_$_iter__30055_$_iter__30057(cljs.core.chunk_rest(s__30058__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30060),null);
}
} else {
var child = cljs.core.first(s__30058__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__30055_$_iter__30057(cljs.core.rest(s__30058__$2)));
}
} else {
return null;
}
...
});})(s__30056__$1,vec__30062,rose,index,xs__6385__auto__,temp__5825__auto__))
,null,null));
});})(s__30056__$1,vec__30062,rose,index,xs__6385__auto__,temp__5825__auto__))
;
var fs__5500__auto__ = cljs.core.seq(iterys__5499__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__5500__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5500__auto__,clojure$test$check$rose_tree$permutations_$_iter__30055(cljs.core.rest(s__30056__$1)));
} else {
var G__30125 = cljs.core.rest(s__30056__$1);
s__30056__$1 = G__30125;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30067_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__30067_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__30067_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30070_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__30070_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__30070_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__30071 = f;
var G__30072 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__30071,G__30072) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__30071,G__30072));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__30073 = f;
var G__30074 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__30073,G__30074) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__30073,G__30074));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {
