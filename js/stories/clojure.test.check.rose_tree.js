...
return cljs.core.cons(cljs.core.first(s),(function (){var G__30118 = (n - (1));
var G__30119 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__30118,G__30119) : clojure.test.check.rose_tree.exclude_nth.call(null,G__30118,G__30119));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__30121 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__30121) : f.call(null,G__30121));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30120_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__30120_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__30120_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30122_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__30122_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__30122_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__30123_SHARP_){
var G__30124 = clojure.test.check.rose_tree.root(p1__30123_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__30124) : pred.call(null,G__30124));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__5503__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__30125(s__30126){
return (new cljs.core.LazySeq(null,(function (){
var s__30126__$1 = s__30126;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__30126__$1);
if(temp__5825__auto__){
var xs__6385__auto__ = temp__5825__auto__;
var vec__30133 = cljs.core.first(xs__6385__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30133,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30133,(1),null);
var iterys__5499__auto__ = ((function (s__30126__$1,vec__30133,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__30125_$_iter__30127(s__30128){
return (new cljs.core.LazySeq(null,((function (s__30126__$1,vec__30133,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function (){
var s__30128__$1 = s__30128;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__30128__$1);
if(temp__5825__auto____$1){
var s__30128__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__30128__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__30128__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__30130 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__30129 = (0);
while(true){
if((i__30129 < size__5502__auto__)){
var child = cljs.core._nth(c__5501__auto__,i__30129);
cljs.core.chunk_append(b__30130,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__30168 = (i__30129 + (1));
i__30129 = G__30168;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30130),clojure$test$check$rose_tree$permutations_$_iter__30125_$_iter__30127(cljs.core.chunk_rest(s__30128__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30130),null);
}
} else {
var child = cljs.core.first(s__30128__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__30125_$_iter__30127(cljs.core.rest(s__30128__$2)));
}
} else {
return null;
}
...
});})(s__30126__$1,vec__30133,rose,index,xs__6385__auto__,temp__5825__auto__))
,null,null));
});})(s__30126__$1,vec__30133,rose,index,xs__6385__auto__,temp__5825__auto__))
;
var fs__5500__auto__ = cljs.core.seq(iterys__5499__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__5500__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5500__auto__,clojure$test$check$rose_tree$permutations_$_iter__30125(cljs.core.rest(s__30126__$1)));
} else {
var G__30169 = cljs.core.rest(s__30126__$1);
s__30126__$1 = G__30169;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30137_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__30137_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__30137_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30143_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__30143_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__30143_SHARP_));
