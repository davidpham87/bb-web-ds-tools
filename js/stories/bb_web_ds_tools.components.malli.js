...
var _STAR_print_newline_STAR__orig_val__36342_36491 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__36343_36492 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__36344_36493 = true;
var _STAR_print_fn_STAR__temp_val__36345_36494 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__36344_36493);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__36345_36494);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__36343_36492);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__36342_36491);
}
...
var output = (function (){var G__36366 = format;
var G__36366__$1 = (((G__36366 instanceof cljs.core.Keyword))?G__36366.fqn:null);
switch (G__36366__$1) {
case "edn":
...
var vec__36368 = schema;
var seq__36369 = cljs.core.seq(vec__36368);
var first__36370 = cljs.core.first(seq__36369);
var seq__36369__$1 = cljs.core.next(seq__36369);
var type = first__36370;
var tail = seq__36369__$1;
var vec__36371 = ((cljs.core.map_QMARK_(cljs.core.first(tail)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(tail),cljs.core.rest(tail)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,tail], null));
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36371,(0),null);
var entries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36371,(1),null);
...
var vec__36376 = ((has_props_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.second(entry),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(entry,(2))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.second(entry)], null));
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36376,(0),null);
var v_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36376,(1),null);
var vals = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36367_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__36367_SHARP_,k);
}),maps);
...
var G__36380 = cljs.core.first(schema);
var fexpr__36379 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"sequential","sequential",-1082983960),null,new cljs.core.Keyword(null,"vector","vector",1902966158),null,new cljs.core.Keyword(null,"set","set",304602554),null], null), null);
return (fexpr__36379.cljs$core$IFn$_invoke$arity$1 ? fexpr__36379.cljs$core$IFn$_invoke$arity$1(G__36380) : fexpr__36379.call(null,G__36380));
} else {
return and__5023__auto__;
}
})())){
var vec__36381 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36381,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36381,(1),null);
...
var vec__36384 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36384,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36384,(1),null);
...
var G__36395 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(node);
var G__36395__$1 = (((G__36395 instanceof cljs.core.Keyword))?G__36395.fqn:null);
switch (G__36395__$1) {
case "map":
...
if(cljs.core.truth_((function (){var fexpr__36417 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("time","local-date","time/local-date",1831222439),null,new cljs.core.Keyword("time","local-date-time","time/local-date-time",-1739557259),null,new cljs.core.Keyword("time","instant","time/instant",641198777),null], null), null);
return (fexpr__36417.cljs$core$IFn$_invoke$arity$1 ? fexpr__36417.cljs$core$IFn$_invoke$arity$1(s_type) : fexpr__36417.call(null,s_type));
})())){
var times = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__36405_SHARP_){
return (!((p1__36405_SHARP_ == null)));
}),d);
 ...
 */
bb_web_ds_tools.components.malli.inference_panel = (function bb_web_ds_tools$components$malli$inference_panel(p__36479){
var map__36480 = p__36479;
var map__36480__$1 = cljs.core.__destructure_map(map__36480);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36480__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36480__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_infer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36480__$1,new cljs.core.Keyword(null,"on-infer","on-infer",78181482));
var inferred_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36480__$1,new cljs.core.Keyword(null,"inferred-schema","inferred-schema",1558411545));
 ...
 *       vector: A hiccup vector.
 */
bb_web_ds_tools.components.malli.generation_panel = (function bb_web_ds_tools$components$malli$generation_panel(p__36488){
var map__36489 = p__36488;
var map__36489__$1 = cljs.core.__destructure_map(map__36489);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36489__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36489__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_generate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36489__$1,new cljs.core.Keyword(null,"on-generate","on-generate",-1231561477));
var generated_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36489__$1,new cljs.core.Keyword(null,"generated-data","generated-data",-924406973));
