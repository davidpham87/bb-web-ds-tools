...
var _STAR_print_newline_STAR__orig_val__35749_35882 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__35750_35883 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__35751_35884 = true;
var _STAR_print_fn_STAR__temp_val__35752_35885 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__35751_35884);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__35752_35885);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__35750_35883);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__35749_35882);
}
...
var output = (function (){var G__35762 = format;
...
var vec__35767 = schema;
var seq__35768 = cljs.core.seq(vec__35767);
var first__35769 = cljs.core.first(seq__35768);
var seq__35768__$1 = cljs.core.next(seq__35768);
var type = first__35769;
var tail = seq__35768__$1;
var vec__35770 = ((cljs.core.map_QMARK_(cljs.core.first(tail)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(tail),cljs.core.rest(tail)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,tail], null));
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35770,(0),null);
var entries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35770,(1),null);
...
var vec__35792 = ((has_props_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.second(entry),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(entry,(2))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.second(entry)], null));
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35792,(0),null);
var v_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35792,(1),null);
var vals = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35763_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__35763_SHARP_,k);
}),maps);
...
var G__35796 = cljs.core.first(schema);
var fexpr__35795 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"sequential","sequential",-1082983960),null,new cljs.core.Keyword(null,"vector","vector",1902966158),null,new cljs.core.Keyword(null,"set","set",304602554),null], null), null);
return (fexpr__35795.cljs$core$IFn$_invoke$arity$1 ? fexpr__35795.cljs$core$IFn$_invoke$arity$1(G__35796) : fexpr__35795.call(null,G__35796));
} else {
return and__5023__auto__;
}
})())){
var vec__35797 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35797,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35797,(1),null);
...
var vec__35801 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35801,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35801,(1),null);
...
var G__35812 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(node);
 ...
 */
bb_web_ds_tools.components.malli.inference_panel = (function bb_web_ds_tools$components$malli$inference_panel(p__35878){
var map__35879 = p__35878;
var map__35879__$1 = cljs.core.__destructure_map(map__35879);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35879__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35879__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_infer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35879__$1,new cljs.core.Keyword(null,"on-infer","on-infer",78181482));
var inferred_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35879__$1,new cljs.core.Keyword(null,"inferred-schema","inferred-schema",1558411545));
 ...
 *       vector: A hiccup vector.
 */
bb_web_ds_tools.components.malli.generation_panel = (function bb_web_ds_tools$components$malli$generation_panel(p__35880){
var map__35881 = p__35880;
var map__35881__$1 = cljs.core.__destructure_map(map__35881);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35881__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35881__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_generate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35881__$1,new cljs.core.Keyword(null,"on-generate","on-generate",-1231561477));
var generated_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35881__$1,new cljs.core.Keyword(null,"generated-data","generated-data",-924406973));
