...
var _STAR_print_newline_STAR__orig_val__35888_36203 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__35889_36204 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__35890_36205 = true;
var _STAR_print_fn_STAR__temp_val__35891_36206 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__35890_36205);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__35891_36206);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__35889_36204);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__35888_36203);
}
...
var output = (function (){var G__35897 = format;
var G__35897__$1 = (((G__35897 instanceof cljs.core.Keyword))?G__35897.fqn:null);
switch (G__35897__$1) {
case "edn":
...
var vec__35916 = schema;
var seq__35917 = cljs.core.seq(vec__35916);
var first__35918 = cljs.core.first(seq__35917);
var seq__35917__$1 = cljs.core.next(seq__35917);
var type = first__35918;
var tail = seq__35917__$1;
var vec__35919 = ((cljs.core.map_QMARK_(cljs.core.first(tail)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(tail),cljs.core.rest(tail)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,tail], null));
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35919,(0),null);
var entries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35919,(1),null);
...
var vec__35927 = ((has_props_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.second(entry),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(entry,(2))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.second(entry)], null));
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35927,(0),null);
var v_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35927,(1),null);
var vals = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35898_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__35898_SHARP_,k);
}),maps);
...
var G__35941 = cljs.core.first(schema);
var fexpr__35940 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"sequential","sequential",-1082983960),null,new cljs.core.Keyword(null,"vector","vector",1902966158),null,new cljs.core.Keyword(null,"set","set",304602554),null], null), null);
return (fexpr__35940.cljs$core$IFn$_invoke$arity$1 ? fexpr__35940.cljs$core$IFn$_invoke$arity$1(G__35941) : fexpr__35940.call(null,G__35941));
} else {
return and__5023__auto__;
}
})())){
var vec__35942 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35942,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35942,(1),null);
...
var vec__35988 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35988,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35988,(1),null);
...
var G__36001 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(node);
...
if(cljs.core.truth_((function (){var fexpr__36125 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("time","local-date","time/local-date",1831222439),null,new cljs.core.Keyword("time","local-date-time","time/local-date-time",-1739557259),null,new cljs.core.Keyword("time","instant","time/instant",641198777),null], null), null);
return (fexpr__36125.cljs$core$IFn$_invoke$arity$1 ? fexpr__36125.cljs$core$IFn$_invoke$arity$1(s_type) : fexpr__36125.call(null,s_type));
})())){
var times = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__36046_SHARP_){
return (!((p1__36046_SHARP_ == null)));
}),d);
 ...
 */
bb_web_ds_tools.components.malli.inference_panel = (function bb_web_ds_tools$components$malli$inference_panel(p__36181){
var map__36182 = p__36181;
var map__36182__$1 = cljs.core.__destructure_map(map__36182);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36182__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36182__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_infer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36182__$1,new cljs.core.Keyword(null,"on-infer","on-infer",78181482));
var inferred_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36182__$1,new cljs.core.Keyword(null,"inferred-schema","inferred-schema",1558411545));
 ...
 *       vector: A hiccup vector.
 */
bb_web_ds_tools.components.malli.generation_panel = (function bb_web_ds_tools$components$malli$generation_panel(p__36183){
var map__36184 = p__36183;
var map__36184__$1 = cljs.core.__destructure_map(map__36184);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36184__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36184__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_generate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36184__$1,new cljs.core.Keyword(null,"on-generate","on-generate",-1231561477));
var generated_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36184__$1,new cljs.core.Keyword(null,"generated-data","generated-data",-924406973));
