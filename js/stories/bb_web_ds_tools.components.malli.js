...
var _STAR_print_newline_STAR__orig_val__27290_27491 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__27291_27492 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__27292_27493 = true;
var _STAR_print_fn_STAR__temp_val__27293_27494 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__27292_27493);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__27293_27494);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__27291_27492);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__27290_27491);
}
...
var type = first__27302;
var tail = seq__27301__$1;
var vec__27303 = ((cljs.core.map_QMARK_(cljs.core.first(tail)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(tail),cljs.core.rest(tail)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,tail], null));
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27303,(0),null);
var entries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27303,(1),null);
...
var vec__27306 = ((has_props_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.second(entry),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(entry,(2))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.second(entry)], null));
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27306,(0),null);
var v_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27306,(1),null);
...
var G__27310 = cljs.core.first(schema);
var fexpr__27309 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"sequential","sequential",-1082983960),null,new cljs.core.Keyword(null,"vector","vector",1902966158),null,new cljs.core.Keyword(null,"set","set",304602554),null], null), null);
return (fexpr__27309.cljs$core$IFn$_invoke$arity$1 ? fexpr__27309.cljs$core$IFn$_invoke$arity$1(G__27310) : fexpr__27309.call(null,G__27310));
} else {
return and__5023__auto__;
}
})())){
var vec__27311 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27311,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27311,(1),null);
...
var vec__27314 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27314,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27314,(1),null);
...
var G__27321 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(node);
...
if(cljs.core.truth_((function (){var fexpr__27361 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("time","local-date","time/local-date",1831222439),null,new cljs.core.Keyword("time","local-date-time","time/local-date-time",-1739557259),null,new cljs.core.Keyword("time","instant","time/instant",641198777),null], null), null);
return (fexpr__27361.cljs$core$IFn$_invoke$arity$1 ? fexpr__27361.cljs$core$IFn$_invoke$arity$1(s_type) : fexpr__27361.call(null,s_type));
})())){
var times = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__27340_SHARP_){
return (!((p1__27340_SHARP_ == null)));
}),d);
...
var data = (function (){var G__27384 = format;
 ...
 */
bb_web_ds_tools.components.malli.inference_panel = (function bb_web_ds_tools$components$malli$inference_panel(p__27438){
var map__27439 = p__27438;
var map__27439__$1 = cljs.core.__destructure_map(map__27439);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27439__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27439__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_infer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27439__$1,new cljs.core.Keyword(null,"on-infer","on-infer",78181482));
var inferred_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27439__$1,new cljs.core.Keyword(null,"inferred-schema","inferred-schema",1558411545));
 ...
 *       vector: A hiccup vector.
 */
bb_web_ds_tools.components.malli.generation_panel = (function bb_web_ds_tools$components$malli$generation_panel(p__27455){
var map__27458 = p__27455;
var map__27458__$1 = cljs.core.__destructure_map(map__27458);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27458__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27458__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_generate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27458__$1,new cljs.core.Keyword(null,"on-generate","on-generate",-1231561477));
var generated_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27458__$1,new cljs.core.Keyword(null,"generated-data","generated-data",-924406973));
