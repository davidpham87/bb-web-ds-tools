...
var _STAR_print_newline_STAR__orig_val__34481_34591 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__34482_34592 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__34483_34593 = true;
var _STAR_print_fn_STAR__temp_val__34484_34594 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__34483_34593);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__34484_34594);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__34482_34592);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__34481_34591);
}
...
var output = (function (){var G__34492 = format;
...
var type = first__34516;
var tail = seq__34515__$1;
var vec__34517 = ((cljs.core.map_QMARK_(cljs.core.first(tail)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(tail),cljs.core.rest(tail)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,tail], null));
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34517,(0),null);
var entries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34517,(1),null);
...
var vec__34521 = ((has_props_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.second(entry),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(entry,(2))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.second(entry)], null));
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34521,(0),null);
var v_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34521,(1),null);
var vals = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34496_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__34496_SHARP_,k);
}),maps);
...
var G__34526 = cljs.core.first(schema);
var fexpr__34525 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"sequential","sequential",-1082983960),null,new cljs.core.Keyword(null,"vector","vector",1902966158),null,new cljs.core.Keyword(null,"set","set",304602554),null], null), null);
return (fexpr__34525.cljs$core$IFn$_invoke$arity$1 ? fexpr__34525.cljs$core$IFn$_invoke$arity$1(G__34526) : fexpr__34525.call(null,G__34526));
} else {
return and__5023__auto__;
}
})())){
var vec__34533 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34533,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34533,(1),null);
...
var vec__34536 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34536,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34536,(1),null);
...
var G__34550 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(node);
...
if(cljs.core.truth_((function (){var fexpr__34561 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("time","local-date","time/local-date",1831222439),null,new cljs.core.Keyword("time","local-date-time","time/local-date-time",-1739557259),null,new cljs.core.Keyword("time","instant","time/instant",641198777),null], null), null);
return (fexpr__34561.cljs$core$IFn$_invoke$arity$1 ? fexpr__34561.cljs$core$IFn$_invoke$arity$1(s_type) : fexpr__34561.call(null,s_type));
})())){
var times = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__34552_SHARP_){
return (!((p1__34552_SHARP_ == null)));
}),d);
 ...
 */
bb_web_ds_tools.components.malli.inference_panel = (function bb_web_ds_tools$components$malli$inference_panel(p__34586){
var map__34587 = p__34586;
var map__34587__$1 = cljs.core.__destructure_map(map__34587);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34587__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34587__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_infer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34587__$1,new cljs.core.Keyword(null,"on-infer","on-infer",78181482));
var inferred_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34587__$1,new cljs.core.Keyword(null,"inferred-schema","inferred-schema",1558411545));
 ...
 *       vector: A hiccup vector.
 */
bb_web_ds_tools.components.malli.generation_panel = (function bb_web_ds_tools$components$malli$generation_panel(p__34588){
var map__34589 = p__34588;
var map__34589__$1 = cljs.core.__destructure_map(map__34589);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34589__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34589__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_generate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34589__$1,new cljs.core.Keyword(null,"on-generate","on-generate",-1231561477));
var generated_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34589__$1,new cljs.core.Keyword(null,"generated-data","generated-data",-924406973));
