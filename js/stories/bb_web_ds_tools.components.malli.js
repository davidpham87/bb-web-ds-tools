...
var _STAR_print_newline_STAR__orig_val__34481_34573 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__34482_34574 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__34483_34575 = true;
var _STAR_print_fn_STAR__temp_val__34484_34576 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__34483_34575);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__34484_34576);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__34482_34574);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__34481_34573);
}
...
var output = (function (){var G__34493 = format;
...
var vec__34501 = schema;
var seq__34502 = cljs.core.seq(vec__34501);
var first__34503 = cljs.core.first(seq__34502);
var seq__34502__$1 = cljs.core.next(seq__34502);
var type = first__34503;
var tail = seq__34502__$1;
var vec__34504 = ((cljs.core.map_QMARK_(cljs.core.first(tail)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(tail),cljs.core.rest(tail)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,tail], null));
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34504,(0),null);
var entries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34504,(1),null);
...
var vec__34511 = ((has_props_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.second(entry),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(entry,(2))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.second(entry)], null));
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34511,(0),null);
var v_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34511,(1),null);
var vals = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34495_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__34495_SHARP_,k);
}),maps);
...
var G__34518 = cljs.core.first(schema);
var fexpr__34517 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"sequential","sequential",-1082983960),null,new cljs.core.Keyword(null,"vector","vector",1902966158),null,new cljs.core.Keyword(null,"set","set",304602554),null], null), null);
return (fexpr__34517.cljs$core$IFn$_invoke$arity$1 ? fexpr__34517.cljs$core$IFn$_invoke$arity$1(G__34518) : fexpr__34517.call(null,G__34518));
} else {
return and__5023__auto__;
}
})())){
var vec__34522 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34522,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34522,(1),null);
...
var vec__34525 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34525,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34525,(1),null);
...
var G__34528 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(node);
...
if(cljs.core.truth_((function (){var fexpr__34556 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("time","local-date","time/local-date",1831222439),null,new cljs.core.Keyword("time","local-date-time","time/local-date-time",-1739557259),null,new cljs.core.Keyword("time","instant","time/instant",641198777),null], null), null);
return (fexpr__34556.cljs$core$IFn$_invoke$arity$1 ? fexpr__34556.cljs$core$IFn$_invoke$arity$1(s_type) : fexpr__34556.call(null,s_type));
})())){
var times = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__34543_SHARP_){
return (!((p1__34543_SHARP_ == null)));
}),d);
 ...
 */
bb_web_ds_tools.components.malli.inference_panel = (function bb_web_ds_tools$components$malli$inference_panel(p__34568){
var map__34569 = p__34568;
var map__34569__$1 = cljs.core.__destructure_map(map__34569);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34569__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34569__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_infer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34569__$1,new cljs.core.Keyword(null,"on-infer","on-infer",78181482));
var inferred_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34569__$1,new cljs.core.Keyword(null,"inferred-schema","inferred-schema",1558411545));
 ...
 *       vector: A hiccup vector.
 */
bb_web_ds_tools.components.malli.generation_panel = (function bb_web_ds_tools$components$malli$generation_panel(p__34571){
var map__34572 = p__34571;
var map__34572__$1 = cljs.core.__destructure_map(map__34572);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34572__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34572__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_generate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34572__$1,new cljs.core.Keyword(null,"on-generate","on-generate",-1231561477));
var generated_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34572__$1,new cljs.core.Keyword(null,"generated-data","generated-data",-924406973));
