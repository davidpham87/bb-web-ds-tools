...
var _STAR_print_newline_STAR__orig_val__27290_27359 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__27291_27360 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__27292_27361 = true;
var _STAR_print_fn_STAR__temp_val__27293_27362 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__27292_27361);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__27293_27362);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__27291_27360);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__27290_27359);
}
...
var type = first__27306;
var tail = seq__27305__$1;
var vec__27307 = ((cljs.core.map_QMARK_(cljs.core.first(tail)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(tail),cljs.core.rest(tail)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,tail], null));
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27307,(0),null);
var entries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27307,(1),null);
...
return new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword(null,"schema-type","schema-type",-1474759536),type,new cljs.core.Keyword(null,"props","props",453281727),props,new cljs.core.Keyword(null,"children","children",-940561982),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__27303_SHARP_){
return bb_web_ds_tools.components.malli.annotate_map_entry(p1__27303_SHARP_,maps);
}),entries)], null);
} else {
if(cljs.core.truth_((function (){var and__5023__auto__ = cljs.core.vector_QMARK_(schema);
if(and__5023__auto__){
var G__27311 = cljs.core.first(schema);
var fexpr__27310 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"sequential","sequential",-1082983960),null,new cljs.core.Keyword(null,"vector","vector",1902966158),null,new cljs.core.Keyword(null,"set","set",304602554),null], null), null);
return (fexpr__27310.cljs$core$IFn$_invoke$arity$1 ? fexpr__27310.cljs$core$IFn$_invoke$arity$1(G__27311) : fexpr__27310.call(null,G__27311));
} else {
return and__5023__auto__;
}
})())){
var vec__27312 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27312,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27312,(1),null);
...
var vec__27315 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27315,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27315,(1),null);
...
var G__27318 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(node);
...
if(cljs.core.truth_((function (){var fexpr__27345 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("time","local-date","time/local-date",1831222439),null,new cljs.core.Keyword("time","local-date-time","time/local-date-time",-1739557259),null,new cljs.core.Keyword("time","instant","time/instant",641198777),null], null), null);
return (fexpr__27345.cljs$core$IFn$_invoke$arity$1 ? fexpr__27345.cljs$core$IFn$_invoke$arity$1(s_type) : fexpr__27345.call(null,s_type));
})())){
var times = cljs.core.sort.cljs$core$IFn$_invoke$arity$2(bb_web_ds_tools.components.malli.compare_time,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__27339_SHARP_){
return (!((p1__27339_SHARP_ == null)));
}),d));
...
var data = (function (){var G__27348 = format;
 ...
 */
bb_web_ds_tools.components.malli.inference_panel = (function bb_web_ds_tools$components$malli$inference_panel(p__27353){
var map__27354 = p__27353;
var map__27354__$1 = cljs.core.__destructure_map(map__27354);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27354__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27354__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_infer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27354__$1,new cljs.core.Keyword(null,"on-infer","on-infer",78181482));
var inferred_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27354__$1,new cljs.core.Keyword(null,"inferred-schema","inferred-schema",1558411545));
 ...
 *       vector: A hiccup vector.
 */
bb_web_ds_tools.components.malli.generation_panel = (function bb_web_ds_tools$components$malli$generation_panel(p__27355){
var map__27356 = p__27355;
var map__27356__$1 = cljs.core.__destructure_map(map__27356);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27356__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27356__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_generate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27356__$1,new cljs.core.Keyword(null,"on-generate","on-generate",-1231561477));
var generated_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27356__$1,new cljs.core.Keyword(null,"generated-data","generated-data",-924406973));
