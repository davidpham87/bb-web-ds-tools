...
var _STAR_print_newline_STAR__orig_val__27290_27487 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__27291_27488 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__27292_27489 = true;
var _STAR_print_fn_STAR__temp_val__27293_27490 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__27292_27489);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__27293_27490);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__27291_27488);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__27290_27487);
}
...
var output = (function (){var G__27298 = format;
...
bb_web_ds_tools.components.malli.annotate_map_entry = (function bb_web_ds_tools$components$malli$annotate_map_entry(entry,maps){
if(cljs.core.vector_QMARK_(entry)){
var has_props_QMARK_ = cljs.core.map_QMARK_(cljs.core.second(entry));
var k = cljs.core.first(entry);
var vec__27300 = ((has_props_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.second(entry),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(entry,(2))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.second(entry)], null));
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27300,(0),null);
var v_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27300,(1),null);
var vals = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27299_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__27299_SHARP_,k);
}),maps);
return new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"entry","entry",505168823),new cljs.core.Keyword(null,"key","key",-1516042587),k,new cljs.core.Keyword(null,"props","props",453281727),p,new cljs.core.Keyword(null,"child","child",623967545),(bb_web_ds_tools.components.malli.annotate_schema.cljs$core$IFn$_invoke$arity$2 ? bb_web_ds_tools.components.malli.annotate_schema.cljs$core$IFn$_invoke$arity$2(v_schema,vals) : bb_web_ds_tools.components.malli.annotate_schema.call(null,v_schema,vals))], null);
} else {
...
var type = first__27319;
var tail = seq__27318__$1;
var vec__27320 = ((cljs.core.map_QMARK_(cljs.core.first(tail)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(tail),cljs.core.rest(tail)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,tail], null));
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27320,(0),null);
var entries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27320,(1),null);
...
return new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword(null,"schema-type","schema-type",-1474759536),type,new cljs.core.Keyword(null,"props","props",453281727),props,new cljs.core.Keyword(null,"children","children",-940561982),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__27311_SHARP_){
return bb_web_ds_tools.components.malli.annotate_map_entry(p1__27311_SHARP_,maps);
}),entries)], null);
} else {
if(cljs.core.truth_((function (){var and__5023__auto__ = cljs.core.vector_QMARK_(schema);
if(and__5023__auto__){
var G__27335 = cljs.core.first(schema);
var fexpr__27334 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"sequential","sequential",-1082983960),null,new cljs.core.Keyword(null,"vector","vector",1902966158),null,new cljs.core.Keyword(null,"set","set",304602554),null], null), null);
return (fexpr__27334.cljs$core$IFn$_invoke$arity$1 ? fexpr__27334.cljs$core$IFn$_invoke$arity$1(G__27335) : fexpr__27334.call(null,G__27335));
} else {
return and__5023__auto__;
}
})())){
var vec__27336 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27336,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27336,(1),null);
...
var vec__27341 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27341,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27341,(1),null);
...
var G__27354 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(node);
...
bb_web_ds_tools.components.malli.refine_enum = (function bb_web_ds_tools$components$malli$refine_enum(node,max_values){
...
bb_web_ds_tools.components.malli.add_min_max = (function bb_web_ds_tools$components$malli$add_min_max(node,min_val,max_val){
...
bb_web_ds_tools.components.malli.refine_leaf = (function bb_web_ds_tools$components$malli$refine_leaf(node,max_values){
var s = new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1(node);
var d = new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(node);
...
var dates = cljs.core.sort.cljs$core$IFn$_invoke$arity$1(cljs.core.filter.cljs$core$IFn$_invoke$arity$2(cljs.core.inst_QMARK_,d));
if(cljs.core.seq(dates)){
return bb_web_ds_tools.components.malli.add_min_max(node,cljs.core.first(dates),cljs.core.last(dates));
} else {
return node;
}
} else {
if(cljs.core.truth_((function (){var fexpr__27395 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("time","local-date","time/local-date",1831222439),null,new cljs.core.Keyword("time","local-date-time","time/local-date-time",-1739557259),null,new cljs.core.Keyword("time","instant","time/instant",641198777),null], null), null);
return (fexpr__27395.cljs$core$IFn$_invoke$arity$1 ? fexpr__27395.cljs$core$IFn$_invoke$arity$1(s_type) : fexpr__27395.call(null,s_type));
})())){
var times = cljs.core.sort.cljs$core$IFn$_invoke$arity$2(bb_web_ds_tools.components.malli.compare_time,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__27384_SHARP_){
return (!((p1__27384_SHARP_ == null)));
}),d));
if(cljs.core.seq(times)){
return bb_web_ds_tools.components.malli.add_min_max(node,cljs.core.first(times),cljs.core.last(times));
} else {
return node;
}
} else {
...
return bb_web_ds_tools.components.malli.refine_leaf(node,max_values);
} else {
return node;
}
}),annotated);
...
var data = (function (){var G__27430 = format;
 ...
 */
bb_web_ds_tools.components.malli.inference_panel = (function bb_web_ds_tools$components$malli$inference_panel(p__27448){
var map__27451 = p__27448;
var map__27451__$1 = cljs.core.__destructure_map(map__27451);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27451__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27451__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_infer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27451__$1,new cljs.core.Keyword(null,"on-infer","on-infer",78181482));
var inferred_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27451__$1,new cljs.core.Keyword(null,"inferred-schema","inferred-schema",1558411545));
 ...
 *       vector: A hiccup vector.
 */
bb_web_ds_tools.components.malli.generation_panel = (function bb_web_ds_tools$components$malli$generation_panel(p__27456){
var map__27457 = p__27456;
var map__27457__$1 = cljs.core.__destructure_map(map__27457);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27457__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27457__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_generate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27457__$1,new cljs.core.Keyword(null,"on-generate","on-generate",-1231561477));
var generated_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27457__$1,new cljs.core.Keyword(null,"generated-data","generated-data",-924406973));
