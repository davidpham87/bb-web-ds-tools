...
var _STAR_print_newline_STAR__orig_val__34606_34815 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__34607_34816 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__34608_34817 = true;
var _STAR_print_fn_STAR__temp_val__34609_34818 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__34608_34817);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__34609_34818);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__34607_34816);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__34606_34815);
}
...
var output = (function (){var G__34638 = format;
...
var vec__34654 = schema;
var seq__34655 = cljs.core.seq(vec__34654);
var first__34656 = cljs.core.first(seq__34655);
var seq__34655__$1 = cljs.core.next(seq__34655);
var type = first__34656;
var tail = seq__34655__$1;
var vec__34657 = ((cljs.core.map_QMARK_(cljs.core.first(tail)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(tail),cljs.core.rest(tail)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,tail], null));
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34657,(0),null);
var entries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34657,(1),null);
...
var vec__34673 = ((has_props_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.second(entry),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(entry,(2))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.second(entry)], null));
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34673,(0),null);
var v_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34673,(1),null);
var vals = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34649_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__34649_SHARP_,k);
}),maps);
...
var G__34677 = cljs.core.first(schema);
var fexpr__34676 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"sequential","sequential",-1082983960),null,new cljs.core.Keyword(null,"vector","vector",1902966158),null,new cljs.core.Keyword(null,"set","set",304602554),null], null), null);
return (fexpr__34676.cljs$core$IFn$_invoke$arity$1 ? fexpr__34676.cljs$core$IFn$_invoke$arity$1(G__34677) : fexpr__34676.call(null,G__34677));
} else {
return and__5023__auto__;
}
})())){
var vec__34678 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34678,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34678,(1),null);
...
var vec__34684 = schema;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34684,(0),null);
var child_schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34684,(1),null);
...
var G__34703 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(node);
var G__34703__$1 = (((G__34703 instanceof cljs.core.Keyword))?G__34703.fqn:null);
switch (G__34703__$1) {
case "map":
...
if(cljs.core.truth_((function (){var fexpr__34725 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("time","local-date","time/local-date",1831222439),null,new cljs.core.Keyword("time","local-date-time","time/local-date-time",-1739557259),null,new cljs.core.Keyword("time","instant","time/instant",641198777),null], null), null);
return (fexpr__34725.cljs$core$IFn$_invoke$arity$1 ? fexpr__34725.cljs$core$IFn$_invoke$arity$1(s_type) : fexpr__34725.call(null,s_type));
})())){
var times = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__34716_SHARP_){
return (!((p1__34716_SHARP_ == null)));
}),d);
 ...
 */
bb_web_ds_tools.components.malli.inference_panel = (function bb_web_ds_tools$components$malli$inference_panel(p__34768){
var map__34769 = p__34768;
var map__34769__$1 = cljs.core.__destructure_map(map__34769);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34769__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34769__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_infer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34769__$1,new cljs.core.Keyword(null,"on-infer","on-infer",78181482));
var inferred_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34769__$1,new cljs.core.Keyword(null,"inferred-schema","inferred-schema",1558411545));
 ...
 *       vector: A hiccup vector.
 */
bb_web_ds_tools.components.malli.generation_panel = (function bb_web_ds_tools$components$malli$generation_panel(p__34784){
var map__34785 = p__34784;
var map__34785__$1 = cljs.core.__destructure_map(map__34785);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34785__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34785__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var on_generate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34785__$1,new cljs.core.Keyword(null,"on-generate","on-generate",-1231561477));
var generated_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34785__$1,new cljs.core.Keyword(null,"generated-data","generated-data",-924406973));
