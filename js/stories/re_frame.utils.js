...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__23032){
...
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__23036_SHARP_,current);
});})(stack,path,current))
...
var G__23081 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(stack,cljs.core.disj.cljs$core$IFn$_invoke$arity$2(cljs.core.set(neighbors),visited));
var G__23082 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path,current);
stack = G__23081;
path = G__23082;
continue;
} else {
var G__23083 = cljs.core.pop(stack);
var G__23084 = path;
stack = G__23083;
path = G__23084;
continue;
...
var in_degree = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__23049){
var vec__23050 = p__23049;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23050,(0),null);
var neighbors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23050,(1),null);
...
return (cljs.core.get.cljs$core$IFn$_invoke$arity$3(in_degree,p1__23046_SHARP_,(0)) === (0));
});})(in_degree,ks))
,ks);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((0),cljs.core.get.cljs$core$IFn$_invoke$arity$2(updated_in_degree,p1__23047_SHARP_));
});})(q,sorted,in_degree__$1,current,neighbors,updated_in_degree,in_degree,ks))
,neighbors));
var G__23086 = new_q;
var G__23087 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(sorted,current);
var G__23088 = updated_in_degree;
q = G__23086;
sorted = G__23087;
in_degree__$1 = G__23088;
continue;
} else {
...
return re_frame.utils.find_cycle(graph,cljs.core.set(sorted),p1__23048_SHARP_);
...
var args__5755__auto__ = [];
var len__5749__auto___23089 = arguments.length;
var i__5750__auto___23090 = (0);
while(true){
if((i__5750__auto___23090 < len__5749__auto___23089)){
args__5755__auto__.push((arguments[i__5750__auto___23090]));

var G__23091 = (i__5750__auto___23090 + (1));
i__5750__auto___23090 = G__23091;
continue;
} else {
}
break;
...
/** @this {Function} */
(re_frame.utils.safe_update_in.cljs$lang$applyTo = (function (seq23067){
...
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23068,G__23069,G__23070,seq23067__$3);
}));
...
var G__23094 = new_data;
var G__23095 = cljs.core.pop(path);
m = G__23094;
path = G__23095;
continue;
}
