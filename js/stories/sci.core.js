...
var G__47077 = sci.core.new_var.cljs$core$IFn$_invoke$arity$3(name,null,null);
sci.impl.vars.unbind(G__47077);
...
var G__47080 = sci.core.new_dynamic_var.cljs$core$IFn$_invoke$arity$3(name,null,null);
sci.impl.vars.unbind(G__47080);
...
var new_m = (function (){var G__47093 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ns","ns",441598760),sci_ns,new cljs.core.Keyword(null,"name","name",1843675177),nm], null);
var G__47093__$1 = (cljs.core.truth_(macro)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47093,new cljs.core.Keyword(null,"macro","macro",-867863404),true):G__47093);
var G__47093__$2 = (cljs.core.truth_(doc)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47093__$1,new cljs.core.Keyword(null,"doc","doc",1913296891),doc):G__47093__$1);
var G__47093__$3 = (cljs.core.truth_(arglists)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47093__$2,new cljs.core.Keyword(null,"arglists","arglists",1661989754),arglists):G__47093__$2);
if(cljs.core.truth_(dynamic)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47093__$3,new cljs.core.Keyword(null,"dynamic","dynamic",704819571),dynamic);
} else {
return G__47093__$3;
}
})();
...
var len__5749__auto___47223 = arguments.length;
var i__5750__auto___47224 = (0);
while(true){
if((i__5750__auto___47224 < len__5749__auto___47223)){
args_arr__5774__auto__.push((arguments[i__5750__auto___47224]));

var G__47225 = (i__5750__auto___47224 + (1));
i__5750__auto___47224 = G__47225;
continue;
} else {
}
break;
...
var _STAR_unrestricted_STAR__orig_val__47108 = sci.impl.unrestrict._STAR_unrestricted_STAR_;
var _STAR_unrestricted_STAR__temp_val__47109 = true;
(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__temp_val__47109);

try{return sci.impl.vars.alter_var_root.cljs$core$IFn$_invoke$arity$2(v,f);
}finally {(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__orig_val__47108);
}}));

(sci.core.alter_var_root.cljs$core$IFn$_invoke$arity$variadic = (function (v,f,args){
var _STAR_unrestricted_STAR__orig_val__47113 = sci.impl.unrestrict._STAR_unrestricted_STAR_;
var _STAR_unrestricted_STAR__temp_val__47114 = true;
(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__temp_val__47114);

try{return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(sci.impl.vars.alter_var_root,v,f,args);
}finally {(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__orig_val__47113);
}}));

/** @this {Function} */
(sci.core.alter_var_root.cljs$lang$applyTo = (function (seq47104){
...
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47105,G__47106,seq47104__$2);
}));
...
var G__47163 = ex;
var G__47163__$1 = (((G__47163 == null))?null:cljs.core.ex_data(G__47163));
var G__47163__$2 = (((G__47163__$1 == null))?null:new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557).cljs$core$IFn$_invoke$arity$1(G__47163__$1));
if((G__47163__$2 == null)){
return null;
} else {
return sci.impl.callstack.stacktrace(G__47163__$2);
}
});
/**
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ns_map,p__47174){
var vec__47175 = p__47174;
var var_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47175,(0),null);
var var$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47175,(1),null);
...
sci.core.process_publics = (function sci$core$process_publics(publics,p__47181){
var map__47182 = p__47181;
var map__47182__$1 = cljs.core.__destructure_map(map__47182);
var exclude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47182__$1,new cljs.core.Keyword(null,"exclude","exclude",-1230250334));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ns_map,p__47186){
var vec__47187 = p__47186;
var var_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47187,(0),null);
var var$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47187,(1),null);
...
return sci.core.normalize_meta(cljs.core.select_keys(p1__47191_SHARP_,opts));
});
} else {
return (function (p1__47192_SHARP_){
return sci.core.normalize_meta(cljs.core.select_keys(p1__47192_SHARP_,new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"no-doc","no-doc",1559921891),new cljs.core.Keyword(null,"macro","macro",-867863404),new cljs.core.Keyword("sci","macro","sci/macro",-868536151),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"dynamic","dynamic",704819571)], null)));
});
...
var G__47215 = sym;
var fexpr__47212 = cljs.core.deref(sci.impl.utils.eval_resolve_state);
return (fexpr__47212.cljs$core$IFn$_invoke$arity$3 ? fexpr__47212.cljs$core$IFn$_invoke$arity$3(G__47213,G__47214,G__47215) : fexpr__47212.call(null,G__47213,G__47214,G__47215));
});
/**
