...
var n__5616__auto___25083 = cols;
var i_25084 = (0);
while(true){
if((i_25084 < n__5616__auto___25083)){
var n__5616__auto___25085__$1 = rows;
var j_25086 = (0);
while(true){
if((j_25086 < n__5616__auto___25085__$1)){
(ctx.fillStyle = ((cljs.core.even_QMARK_((i_25084 + j_25086)))?new cljs.core.Keyword("portal.colors","background2","portal.colors/background2",-2075622390).cljs$core$IFn$_invoke$arity$1(bb_web_ds_tools.components.landing.animations.common.zenburn):new cljs.core.Keyword("portal.colors","background","portal.colors/background",-1400610375).cljs$core$IFn$_invoke$arity$1(bb_web_ds_tools.components.landing.animations.common.zenburn)));

ctx.fillRect((start_x + (i_25084 * cell_w)),(start_y + (j_25086 * cell_h)),(cell_w - (2)),(cell_h - (2)));
...
ctx.fillRect(((start_x + (i_25084 * cell_w)) + (4)),((start_y + (j_25086 * cell_h)) + (4)),(12),(4));

var G__25087 = (j_25086 + (1));
j_25086 = G__25087;
continue;
} else {
}
...
var n__5616__auto___25089 = rows;
var j_25090 = (0);
while(true){
if((j_25090 < n__5616__auto___25089)){
var row_progress_25091 = cljs.core.mod(((t * 0.002) + (j_25090 * 0.2)),1.0);
var x_25092 = ((start_x + ((4) * cell_w)) + (row_progress_25091 * (40)));
var y_25093 = (start_y + (j_25090 * cell_h));
...
ctx.fillRect(x_25092,y_25093,(12),(4));
...
var n__5616__auto___25095 = rows;
var i_25096 = (0);
while(true){
if((i_25096 < n__5616__auto___25095)){
var n__5616__auto___25097__$1 = cols;
var j_25098 = (0);
while(true){
if((j_25098 < n__5616__auto___25097__$1)){
(ctx.fillStyle = ((cljs.core.even_QMARK_((i_25096 + j_25098)))?new cljs.core.Keyword("portal.colors","background2","portal.colors/background2",-2075622390).cljs$core$IFn$_invoke$arity$1(bb_web_ds_tools.components.landing.animations.common.zenburn):new cljs.core.Keyword("portal.colors","background","portal.colors/background",-1400610375).cljs$core$IFn$_invoke$arity$1(bb_web_ds_tools.components.landing.animations.common.zenburn)));

ctx.fillRect((start_x + (i_25096 * cell_w)),(start_y + (j_25098 * cell_h)),(cell_w - (2)),(cell_h - (2)));

(ctx.fillStyle = new cljs.core.Keyword("portal.colors","string","portal.colors/string",-1452455936).cljs$core$IFn$_invoke$arity$1(bb_web_ds_tools.components.landing.animations.common.zenburn));

ctx.fillRect(((start_x + (i_25096 * cell_w)) + (4)),((start_y + (j_25098 * cell_h)) + (4)),(12),(4));

var G__25099 = (j_25098 + (1));
j_25098 = G__25099;
continue;
} else {
}
...
var n__5616__auto___25101 = cols;
var i_25102 = (0);
while(true){
if((i_25102 < n__5616__auto___25101)){
var freq_25103 = (0.002 + (i_25102 * 0.001));
var height_25104 = ((20) + ((30) * Math.abs(Math.sin((t * freq_25103)))));
var x_25105 = (start_x + (i_25102 * (bar_w + gap)));
var y_25106 = (base_y - height_25104);
...
ctx.fillRect(x_25105,y_25106,bar_w,height_25104);

var G__25107 = (i_25102 + (1));
i_25102 = G__25107;
continue;
} else {
}
