...
$CLJS.SHADOW_ENV.setLoaded("malli.json_schema.js");
...
var malli$json_schema$JsonSchema$_accept$dyn_33264 = (function (this$,children,options){
...
return malli$json_schema$JsonSchema$_accept$dyn_33264(this$,children,options);
}
});
...
malli.json_schema._ref = (function malli$json_schema$_ref(schema,p__33011){
var map__33012 = p__33011;
var map__33012__$1 = cljs.core.__destructure_map(map__33012);
var options = map__33012__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33012__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var definitions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33012__$1,new cljs.core.Keyword("malli.json-schema","definitions","malli.json-schema/definitions",1666750607));
var definitions_path = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__33012__$1,new cljs.core.Keyword("malli.json-schema","definitions-path","malli.json-schema/definitions-path",10213173),"#/definitions/");
var ref = (function (){var $ = malli.core._ref(schema);
if(cljs.core.var_QMARK_($)){
var map__33020 = cljs.core.meta($);
var map__33020__$1 = cljs.core.__destructure_map(map__33020);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33020__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33020__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var child_33265 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(definitions,cljs.core.assoc,ref,(transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(child_33265,options) : transform.call(null,child_33265,options)));
}
...
malli.json_schema._schema = (function malli$json_schema$_schema(schema,p__33021){
var map__33022 = p__33021;
var map__33022__$1 = cljs.core.__destructure_map(map__33022);
var options = map__33022__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33022__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
if(cljs.core.truth_(malli.core._ref(schema))){
return malli.json_schema._ref(schema,options);
} else {
var G__33023 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__33024 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__33023,G__33024) : transform.call(null,G__33023,G__33024));
}
});
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.json-schema","default","malli.json-schema/default",-421449099)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__33032 = cljs.core.get_global_hierarchy;
return (fexpr__33032.cljs$core$IFn$_invoke$arity$0 ? fexpr__33032.cljs$core$IFn$_invoke$arity$0() : fexpr__33032.call(null));
})());
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">",">",-555517146),(function (_,___$1,p__33106,___$2){
var vec__33117 = p__33106;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33117,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">=",">=",-623615505),(function (_,___$1,p__33120,___$2){
var vec__33121 = p__33120;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33121,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<","<",-646864291),(function (_,___$1,p__33124,___$2){
var vec__33126 = p__33124;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33126,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<=","<=",-395636158),(function (_,___$1,p__33130,___$2){
var vec__33131 = p__33130;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33131,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"=","=",1152933628),(function (_,___$1,p__33136,___$2){
var vec__33138 = p__33136;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33138,(0),null);
...
var default$ = (function (){var G__33187 = children;
var G__33187__$1 = (((G__33187 == null))?null:cljs.core.remove.cljs$core$IFn$_invoke$arity$2(malli.core._comp.cljs$core$IFn$_invoke$arity$2(ks,cljs.core.first),G__33187));
var G__33187__$2 = (((G__33187__$1 == null))?null:cljs.core.first(G__33187__$1));
if((G__33187__$2 == null)){
return null;
} else {
return cljs.core.last(G__33187__$2);
}
})();
var map__33186 = default$;
var map__33186__$1 = cljs.core.__destructure_map(map__33186);
var additionalProperties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33186__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392));
var properties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33186__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33186__$1,new cljs.core.Keyword(null,"required","required",1807647006));
...
var G__33196 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([default$,object], 0));
var G__33196__$1 = ((cljs.core.seq(required))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33196,new cljs.core.Keyword(null,"required","required",1807647006),required):G__33196);
var G__33196__$2 = (cljs.core.truth_(closed)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33196__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),false):G__33196__$1);
if(cljs.core.truth_(default$)){
var G__33199 = G__33196__$2;
var G__33199__$1 = (cljs.core.truth_(additionalProperties_SINGLEQUOTE_)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33199,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),additionalProperties_SINGLEQUOTE_):G__33199);
var G__33199__$2 = (cljs.core.truth_(properties_SINGLEQUOTE_)?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__33199__$1,new cljs.core.Keyword(null,"properties","properties",685819552),cljs.core.merge,properties_SINGLEQUOTE_):G__33199__$1);
if(cljs.core.truth_(required_SINGLEQUOTE_)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__33199__$2,new cljs.core.Keyword(null,"required","required",1807647006),cljs.core.comp.cljs$core$IFn$_invoke$arity$3(cljs.core.vec,cljs.core.distinct,cljs.core.into),required_SINGLEQUOTE_);
} else {
return G__33199__$2;
}
} else {
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var G__33216 = malli.core._infer(children);
if((G__33216 == null)){
return null;
} else {
return (malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2 ? malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2(G__33216,options) : malli.json_schema._transform.call(null,G__33216,options));
}
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"merge","merge",-1804319409),(function (_,schema,___$1,p__33246){
var map__33247 = p__33246;
var map__33247__$1 = cljs.core.__destructure_map(map__33247);
var options = map__33247__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33247__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__33248 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__33249 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__33248,G__33249) : transform.call(null,G__33248,G__33249));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"union","union",2142937499),(function (_,schema,___$1,p__33250){
var map__33251 = p__33250;
var map__33251__$1 = cljs.core.__destructure_map(map__33251);
var options = map__33251__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33251__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__33252 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__33253 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__33252,G__33253) : transform.call(null,G__33252,G__33253));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"select-keys","select-keys",1945879180),(function (_,schema,___$1,p__33255){
var map__33256 = p__33255;
var map__33256__$1 = cljs.core.__destructure_map(map__33256);
var options = map__33256__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33256__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__33257 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__33258 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__33257,G__33258) : transform.call(null,G__33257,G__33258));
}));
...
var G__33263 = malli.json_schema._transform(_QMARK_schema,options__$1);
if(cljs.core.seq(cljs.core.deref(definitions))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33263,new cljs.core.Keyword(null,"definitions","definitions",167529986),cljs.core.deref(definitions));
} else {
return G__33263;
}
}));
