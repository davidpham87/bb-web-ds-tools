...
var malli$json_schema$JsonSchema$_accept$dyn_32941 = (function (this$,children,options){
...
return malli$json_schema$JsonSchema$_accept$dyn_32941(this$,children,options);
}
});
...
malli.json_schema._ref = (function malli$json_schema$_ref(schema,p__32835){
var map__32836 = p__32835;
var map__32836__$1 = cljs.core.__destructure_map(map__32836);
var options = map__32836__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32836__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var definitions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32836__$1,new cljs.core.Keyword("malli.json-schema","definitions","malli.json-schema/definitions",1666750607));
var definitions_path = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__32836__$1,new cljs.core.Keyword("malli.json-schema","definitions-path","malli.json-schema/definitions-path",10213173),"#/definitions/");
var ref = (function (){var $ = malli.core._ref(schema);
if(cljs.core.var_QMARK_($)){
var map__32837 = cljs.core.meta($);
var map__32837__$1 = cljs.core.__destructure_map(map__32837);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32837__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32837__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var child_32964 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(definitions,cljs.core.assoc,ref,(transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(child_32964,options) : transform.call(null,child_32964,options)));
}
...
malli.json_schema._schema = (function malli$json_schema$_schema(schema,p__32838){
var map__32839 = p__32838;
var map__32839__$1 = cljs.core.__destructure_map(map__32839);
var options = map__32839__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32839__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
if(cljs.core.truth_(malli.core._ref(schema))){
return malli.json_schema._ref(schema,options);
} else {
var G__32840 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__32841 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__32840,G__32841) : transform.call(null,G__32840,G__32841));
}
});
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.json-schema","default","malli.json-schema/default",-421449099)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__32846 = cljs.core.get_global_hierarchy;
return (fexpr__32846.cljs$core$IFn$_invoke$arity$0 ? fexpr__32846.cljs$core$IFn$_invoke$arity$0() : fexpr__32846.call(null));
})());
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">",">",-555517146),(function (_,___$1,p__32857,___$2){
var vec__32858 = p__32857;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32858,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">=",">=",-623615505),(function (_,___$1,p__32861,___$2){
var vec__32862 = p__32861;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32862,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<","<",-646864291),(function (_,___$1,p__32865,___$2){
var vec__32866 = p__32865;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32866,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<=","<=",-395636158),(function (_,___$1,p__32869,___$2){
var vec__32870 = p__32869;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32870,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"=","=",1152933628),(function (_,___$1,p__32873,___$2){
var vec__32874 = p__32873;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32874,(0),null);
...
var default$ = (function (){var G__32878 = children;
var G__32878__$1 = (((G__32878 == null))?null:cljs.core.remove.cljs$core$IFn$_invoke$arity$2(malli.core._comp.cljs$core$IFn$_invoke$arity$2(ks,cljs.core.first),G__32878));
var G__32878__$2 = (((G__32878__$1 == null))?null:cljs.core.first(G__32878__$1));
if((G__32878__$2 == null)){
return null;
} else {
return cljs.core.last(G__32878__$2);
}
})();
var map__32877 = default$;
var map__32877__$1 = cljs.core.__destructure_map(map__32877);
var additionalProperties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32877__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392));
var properties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32877__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32877__$1,new cljs.core.Keyword(null,"required","required",1807647006));
...
var G__32888 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([default$,object], 0));
var G__32888__$1 = ((cljs.core.seq(required))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32888,new cljs.core.Keyword(null,"required","required",1807647006),required):G__32888);
var G__32888__$2 = (cljs.core.truth_(closed)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32888__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),false):G__32888__$1);
if(cljs.core.truth_(default$)){
var G__32889 = G__32888__$2;
var G__32889__$1 = (cljs.core.truth_(additionalProperties_SINGLEQUOTE_)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32889,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),additionalProperties_SINGLEQUOTE_):G__32889);
var G__32889__$2 = (cljs.core.truth_(properties_SINGLEQUOTE_)?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__32889__$1,new cljs.core.Keyword(null,"properties","properties",685819552),cljs.core.merge,properties_SINGLEQUOTE_):G__32889__$1);
if(cljs.core.truth_(required_SINGLEQUOTE_)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__32889__$2,new cljs.core.Keyword(null,"required","required",1807647006),cljs.core.comp.cljs$core$IFn$_invoke$arity$3(cljs.core.vec,cljs.core.distinct,cljs.core.into),required_SINGLEQUOTE_);
} else {
return G__32889__$2;
}
} else {
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var G__32896 = malli.core._infer(children);
if((G__32896 == null)){
return null;
} else {
return (malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2 ? malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2(G__32896,options) : malli.json_schema._transform.call(null,G__32896,options));
}
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"merge","merge",-1804319409),(function (_,schema,___$1,p__32913){
var map__32914 = p__32913;
var map__32914__$1 = cljs.core.__destructure_map(map__32914);
var options = map__32914__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32914__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__32915 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__32916 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__32915,G__32916) : transform.call(null,G__32915,G__32916));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"union","union",2142937499),(function (_,schema,___$1,p__32917){
var map__32918 = p__32917;
var map__32918__$1 = cljs.core.__destructure_map(map__32918);
var options = map__32918__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32918__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__32922 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__32923 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__32922,G__32923) : transform.call(null,G__32922,G__32923));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"select-keys","select-keys",1945879180),(function (_,schema,___$1,p__32924){
var map__32925 = p__32924;
var map__32925__$1 = cljs.core.__destructure_map(map__32925);
var options = map__32925__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32925__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__32927 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__32928 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__32927,G__32928) : transform.call(null,G__32927,G__32928));
}));
...
var G__32940 = malli.json_schema._transform(_QMARK_schema,options__$1);
if(cljs.core.seq(cljs.core.deref(definitions))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32940,new cljs.core.Keyword(null,"definitions","definitions",167529986),cljs.core.deref(definitions));
} else {
return G__32940;
}
}));
