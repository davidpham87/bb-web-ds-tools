...
var malli$json_schema$JsonSchema$_accept$dyn_32794 = (function (this$,children,options){
...
return malli$json_schema$JsonSchema$_accept$dyn_32794(this$,children,options);
}
});
...
malli.json_schema._ref = (function malli$json_schema$_ref(schema,p__32662){
var map__32663 = p__32662;
var map__32663__$1 = cljs.core.__destructure_map(map__32663);
var options = map__32663__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32663__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var definitions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32663__$1,new cljs.core.Keyword("malli.json-schema","definitions","malli.json-schema/definitions",1666750607));
var definitions_path = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__32663__$1,new cljs.core.Keyword("malli.json-schema","definitions-path","malli.json-schema/definitions-path",10213173),"#/definitions/");
var ref = (function (){var $ = malli.core._ref(schema);
if(cljs.core.var_QMARK_($)){
var map__32664 = cljs.core.meta($);
var map__32664__$1 = cljs.core.__destructure_map(map__32664);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32664__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32664__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var child_32800 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(definitions,cljs.core.assoc,ref,(transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(child_32800,options) : transform.call(null,child_32800,options)));
}
...
malli.json_schema._schema = (function malli$json_schema$_schema(schema,p__32666){
var map__32667 = p__32666;
var map__32667__$1 = cljs.core.__destructure_map(map__32667);
var options = map__32667__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32667__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
if(cljs.core.truth_(malli.core._ref(schema))){
return malli.json_schema._ref(schema,options);
} else {
var G__32669 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__32670 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__32669,G__32670) : transform.call(null,G__32669,G__32670));
}
});
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.json-schema","default","malli.json-schema/default",-421449099)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__32671 = cljs.core.get_global_hierarchy;
return (fexpr__32671.cljs$core$IFn$_invoke$arity$0 ? fexpr__32671.cljs$core$IFn$_invoke$arity$0() : fexpr__32671.call(null));
})());
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">",">",-555517146),(function (_,___$1,p__32696,___$2){
var vec__32697 = p__32696;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32697,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">=",">=",-623615505),(function (_,___$1,p__32700,___$2){
var vec__32701 = p__32700;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32701,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<","<",-646864291),(function (_,___$1,p__32707,___$2){
var vec__32708 = p__32707;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32708,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<=","<=",-395636158),(function (_,___$1,p__32714,___$2){
var vec__32715 = p__32714;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32715,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"=","=",1152933628),(function (_,___$1,p__32718,___$2){
var vec__32719 = p__32718;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32719,(0),null);
...
var default$ = (function (){var G__32723 = children;
var G__32723__$1 = (((G__32723 == null))?null:cljs.core.remove.cljs$core$IFn$_invoke$arity$2(malli.core._comp.cljs$core$IFn$_invoke$arity$2(ks,cljs.core.first),G__32723));
var G__32723__$2 = (((G__32723__$1 == null))?null:cljs.core.first(G__32723__$1));
if((G__32723__$2 == null)){
return null;
} else {
return cljs.core.last(G__32723__$2);
}
})();
var map__32722 = default$;
var map__32722__$1 = cljs.core.__destructure_map(map__32722);
var additionalProperties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32722__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392));
var properties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32722__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32722__$1,new cljs.core.Keyword(null,"required","required",1807647006));
...
var G__32731 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([default$,object], 0));
var G__32731__$1 = ((cljs.core.seq(required))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32731,new cljs.core.Keyword(null,"required","required",1807647006),required):G__32731);
var G__32731__$2 = (cljs.core.truth_(closed)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32731__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),false):G__32731__$1);
if(cljs.core.truth_(default$)){
var G__32733 = G__32731__$2;
var G__32733__$1 = (cljs.core.truth_(additionalProperties_SINGLEQUOTE_)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32733,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),additionalProperties_SINGLEQUOTE_):G__32733);
var G__32733__$2 = (cljs.core.truth_(properties_SINGLEQUOTE_)?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__32733__$1,new cljs.core.Keyword(null,"properties","properties",685819552),cljs.core.merge,properties_SINGLEQUOTE_):G__32733__$1);
if(cljs.core.truth_(required_SINGLEQUOTE_)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__32733__$2,new cljs.core.Keyword(null,"required","required",1807647006),cljs.core.comp.cljs$core$IFn$_invoke$arity$3(cljs.core.vec,cljs.core.distinct,cljs.core.into),required_SINGLEQUOTE_);
} else {
return G__32733__$2;
}
} else {
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var G__32734 = malli.core._infer(children);
if((G__32734 == null)){
return null;
} else {
return (malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2 ? malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2(G__32734,options) : malli.json_schema._transform.call(null,G__32734,options));
}
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"merge","merge",-1804319409),(function (_,schema,___$1,p__32747){
var map__32748 = p__32747;
var map__32748__$1 = cljs.core.__destructure_map(map__32748);
var options = map__32748__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32748__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__32750 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__32751 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__32750,G__32751) : transform.call(null,G__32750,G__32751));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"union","union",2142937499),(function (_,schema,___$1,p__32753){
var map__32754 = p__32753;
var map__32754__$1 = cljs.core.__destructure_map(map__32754);
var options = map__32754__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32754__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__32755 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__32756 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__32755,G__32756) : transform.call(null,G__32755,G__32756));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"select-keys","select-keys",1945879180),(function (_,schema,___$1,p__32759){
var map__32761 = p__32759;
var map__32761__$1 = cljs.core.__destructure_map(map__32761);
var options = map__32761__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32761__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__32762 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__32763 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__32762,G__32763) : transform.call(null,G__32762,G__32763));
}));
...
var G__32786 = malli.json_schema._transform(_QMARK_schema,options__$1);
if(cljs.core.seq(cljs.core.deref(definitions))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32786,new cljs.core.Keyword(null,"definitions","definitions",167529986),cljs.core.deref(definitions));
} else {
return G__32786;
}
}));
