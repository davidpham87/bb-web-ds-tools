...
var malli$json_schema$JsonSchema$_accept$dyn_32972 = (function (this$,children,options){
...
return malli$json_schema$JsonSchema$_accept$dyn_32972(this$,children,options);
}
});
...
malli.json_schema._ref = (function malli$json_schema$_ref(schema,p__32825){
var map__32826 = p__32825;
var map__32826__$1 = cljs.core.__destructure_map(map__32826);
var options = map__32826__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32826__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var definitions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32826__$1,new cljs.core.Keyword("malli.json-schema","definitions","malli.json-schema/definitions",1666750607));
var definitions_path = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__32826__$1,new cljs.core.Keyword("malli.json-schema","definitions-path","malli.json-schema/definitions-path",10213173),"#/definitions/");
var ref = (function (){var $ = malli.core._ref(schema);
if(cljs.core.var_QMARK_($)){
var map__32827 = cljs.core.meta($);
var map__32827__$1 = cljs.core.__destructure_map(map__32827);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32827__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32827__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var child_32975 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(definitions,cljs.core.assoc,ref,(transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(child_32975,options) : transform.call(null,child_32975,options)));
}
...
malli.json_schema._schema = (function malli$json_schema$_schema(schema,p__32831){
var map__32832 = p__32831;
var map__32832__$1 = cljs.core.__destructure_map(map__32832);
var options = map__32832__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32832__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
if(cljs.core.truth_(malli.core._ref(schema))){
return malli.json_schema._ref(schema,options);
} else {
var G__32833 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__32834 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__32833,G__32834) : transform.call(null,G__32833,G__32834));
}
});
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.json-schema","default","malli.json-schema/default",-421449099)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__32842 = cljs.core.get_global_hierarchy;
return (fexpr__32842.cljs$core$IFn$_invoke$arity$0 ? fexpr__32842.cljs$core$IFn$_invoke$arity$0() : fexpr__32842.call(null));
})());
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">",">",-555517146),(function (_,___$1,p__32870,___$2){
var vec__32871 = p__32870;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32871,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">=",">=",-623615505),(function (_,___$1,p__32874,___$2){
var vec__32875 = p__32874;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32875,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<","<",-646864291),(function (_,___$1,p__32878,___$2){
var vec__32879 = p__32878;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32879,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<=","<=",-395636158),(function (_,___$1,p__32882,___$2){
var vec__32883 = p__32882;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32883,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"=","=",1152933628),(function (_,___$1,p__32887,___$2){
var vec__32889 = p__32887;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32889,(0),null);
...
var default$ = (function (){var G__32897 = children;
var G__32897__$1 = (((G__32897 == null))?null:cljs.core.remove.cljs$core$IFn$_invoke$arity$2(malli.core._comp.cljs$core$IFn$_invoke$arity$2(ks,cljs.core.first),G__32897));
var G__32897__$2 = (((G__32897__$1 == null))?null:cljs.core.first(G__32897__$1));
if((G__32897__$2 == null)){
return null;
} else {
return cljs.core.last(G__32897__$2);
}
})();
var map__32896 = default$;
var map__32896__$1 = cljs.core.__destructure_map(map__32896);
var additionalProperties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32896__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392));
var properties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32896__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32896__$1,new cljs.core.Keyword(null,"required","required",1807647006));
...
var G__32902 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([default$,object], 0));
var G__32902__$1 = ((cljs.core.seq(required))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32902,new cljs.core.Keyword(null,"required","required",1807647006),required):G__32902);
var G__32902__$2 = (cljs.core.truth_(closed)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32902__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),false):G__32902__$1);
if(cljs.core.truth_(default$)){
var G__32903 = G__32902__$2;
var G__32903__$1 = (cljs.core.truth_(additionalProperties_SINGLEQUOTE_)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32903,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),additionalProperties_SINGLEQUOTE_):G__32903);
var G__32903__$2 = (cljs.core.truth_(properties_SINGLEQUOTE_)?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__32903__$1,new cljs.core.Keyword(null,"properties","properties",685819552),cljs.core.merge,properties_SINGLEQUOTE_):G__32903__$1);
if(cljs.core.truth_(required_SINGLEQUOTE_)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__32903__$2,new cljs.core.Keyword(null,"required","required",1807647006),cljs.core.comp.cljs$core$IFn$_invoke$arity$3(cljs.core.vec,cljs.core.distinct,cljs.core.into),required_SINGLEQUOTE_);
} else {
return G__32903__$2;
}
} else {
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var G__32911 = malli.core._infer(children);
if((G__32911 == null)){
return null;
} else {
return (malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2 ? malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2(G__32911,options) : malli.json_schema._transform.call(null,G__32911,options));
}
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"merge","merge",-1804319409),(function (_,schema,___$1,p__32944){
var map__32945 = p__32944;
var map__32945__$1 = cljs.core.__destructure_map(map__32945);
var options = map__32945__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32945__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__32946 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__32947 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__32946,G__32947) : transform.call(null,G__32946,G__32947));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"union","union",2142937499),(function (_,schema,___$1,p__32954){
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"select-keys","select-keys",1945879180),(function (_,schema,___$1,p__32961){
var map__32962 = p__32961;
var map__32962__$1 = cljs.core.__destructure_map(map__32962);
var options = map__32962__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32962__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__32963 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__32964 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__32963,G__32964) : transform.call(null,G__32963,G__32964));
}));
...
var G__32969 = malli.json_schema._transform(_QMARK_schema,options__$1);
if(cljs.core.seq(cljs.core.deref(definitions))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32969,new cljs.core.Keyword(null,"definitions","definitions",167529986),cljs.core.deref(definitions));
} else {
return G__32969;
}
}));
