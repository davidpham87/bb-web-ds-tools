...
return (function() { 
var G__22416__delegate = function (args){
...
while (G__22417__i < G__22417__a.length) {G__22417__a[G__22417__i] = arguments[G__22417__i + 0]; ++G__22417__i;}
  args = new cljs.core.IndexedSeq(G__22417__a,0,null);
} 
return G__22416__delegate.call(this,args);};
G__22416.cljs$lang$maxFixedArity = 0;
G__22416.cljs$lang$applyTo = (function (arglist__22418){
var args = cljs.core.seq(arglist__22418);
return G__22416__delegate(args);
});
...
var or__5025__auto__ = (function (){var G__22218 = c;
var G__22218__$1 = (((G__22218 == null))?null:G__22218.constructor);
if((G__22218__$1 == null)){
return null;
} else {
return G__22218__$1.displayName;
}
})();
...
var G__22228 = c;
var G__22228__$1 = (((G__22228 == null))?null:G__22228.constructor);
if((G__22228__$1 == null)){
return null;
} else {
return G__22228__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__22233 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22234 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22234);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22233);
}});
...
var G__22242 = reagent.impl.component.goog$module$goog$object.get(component_state,"cljsRatom");
if((G__22242 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__22242);
}
} else {
return null;
}
...
var renders_22463 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_22464 = cljs.core.first(cljs.core.vals(renders_22463));
...
if((cljs.core.count(renders_22463) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_22463))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_22464)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_22464], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__22330 = o;
reagent.impl.component.goog$module$goog$object.set(G__22330,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__22362 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22363 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22363);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22362);
}});
...
var vec__22369 = shadow.js.shim.module$react.useReducer(cljs.core.inc,(0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22369,(0),null);
var force_update = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22369,(1),null);
