...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22197 = c;
var G__22197__$1 = (((G__22197 == null))?null:G__22197.prototype);
if((G__22197__$1 == null)){
return null;
} else {
return G__22197__$1.reagentRender;
}
})() == null)))));
});
...
return (function() { 
var G__22453__delegate = function (args){
...
return G__22453__delegate.call(this,args);};
...
return G__22453__delegate(args);
});
...
var G__22227 = reagent.impl.component.goog$module$goog$object.get(component_state,"cljsRatom");
if((G__22227 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__22227);
}
} else {
return null;
}
...
var renders_22470 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_22471 = cljs.core.first(cljs.core.vals(renders_22470));
...
if((cljs.core.count(renders_22470) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_22470))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_22471)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_22471], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__22271 = o;
reagent.impl.component.goog$module$goog$object.set(G__22271,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__22382 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22383 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22383);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22382);
}});
...
var vec__22404 = shadow.js.shim.module$react.useReducer(cljs.core.inc,(0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22404,(0),null);
var force_update = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22404,(1),null);
