...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22148 = c;
...
return (function() { 
var G__22299__delegate = function (args){
...
while (G__22300__i < G__22300__a.length) {G__22300__a[G__22300__i] = arguments[G__22300__i + 0]; ++G__22300__i;}
  args = new cljs.core.IndexedSeq(G__22300__a,0,null);
} 
return G__22299__delegate.call(this,args);};
G__22299.cljs$lang$maxFixedArity = 0;
G__22299.cljs$lang$applyTo = (function (arglist__22301){
var args = cljs.core.seq(arglist__22301);
return G__22299__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__22178 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22179 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22179);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22178);
}});
...
var G__22199 = reagent.impl.component.goog$module$goog$object.get(component_state,"cljsRatom");
if((G__22199 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__22199);
}
} else {
return null;
}
...
var renders_22314 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_22315 = cljs.core.first(cljs.core.vals(renders_22314));
...
if((cljs.core.count(renders_22314) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_22314))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_22315)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_22315], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__22266 = o;
reagent.impl.component.goog$module$goog$object.set(G__22266,cljs.core.name(k),v);
...
while (G__22337__i < G__22337__a.length) {G__22337__a[G__22337__i] = arguments[G__22337__i + 0]; ++G__22337__i;}
  args = new cljs.core.IndexedSeq(G__22337__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__22284 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22285 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22285);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22284);
}});
...
var vec__22286 = shadow.js.shim.module$react.useReducer(cljs.core.inc,(0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22286,(0),null);
var force_update = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22286,(1),null);
