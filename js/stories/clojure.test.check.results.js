...
var clojure$test$check$results$Result$pass_QMARK_$dyn_31490 = (function (result){
...
return clojure$test$check$results$Result$pass_QMARK_$dyn_31490(result);
}
});

var clojure$test$check$results$Result$result_data$dyn_31493 = (function (result){
var x__5373__auto__ = (((result == null))?null:result);
...
return clojure$test$check$results$Result$result_data$dyn_31493(result);
}
});
