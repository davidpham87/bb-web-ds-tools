...
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44743_44857) : reporter_fn.call(null,G__44743_44857));
...
var vec__44750 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44750,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44750,(1),null);
...
var len__5749__auto___44865 = arguments.length;
var i__5750__auto___44866 = (0);
while(true){
if((i__5750__auto___44866 < len__5749__auto___44865)){
args__5755__auto__.push((arguments[i__5750__auto___44866]));

var G__44867 = (i__5750__auto___44866 + (1));
i__5750__auto___44866 = G__44867;
continue;
} else {
}
break;
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__44760){
var map__44761 = p__44760;
var map__44761__$1 = cljs.core.__destructure_map(map__44761);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44761__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__44761__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__44761__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__44763 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44763,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44763,(1),null);
...
var size = first__44788;
var rest_size_seq = seq__44787__$1;
var vec__44789 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44789,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44789,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq44754){
var G__44755 = cljs.core.first(seq44754);
var seq44754__$1 = cljs.core.next(seq44754);
var G__44756 = cljs.core.first(seq44754__$1);
var seq44754__$2 = cljs.core.next(seq44754__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44755,G__44756,seq44754__$2);
}));
...
var map__44819 = smallest;
var map__44819__$1 = cljs.core.__destructure_map(map__44819);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44819__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__44876 = tail;
var G__44877 = current_smallest;
var G__44878 = (total_nodes_visited + (1));
var G__44879 = depth;
nodes = G__44876;
current_smallest = G__44877;
total_nodes_visited = G__44878;
depth = G__44879;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__44832_44880 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44832_44880) : reporter_fn.call(null,G__44832_44880));

var temp__5823__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5823__auto__){
var children = temp__5823__auto__;
var G__44881 = children;
var G__44882 = new_smallest;
var G__44883 = (total_nodes_visited + (1));
var G__44884 = (depth + (1));
nodes = G__44881;
current_smallest = G__44882;
total_nodes_visited = G__44883;
depth = G__44884;
continue;
} else {
var G__44885 = tail;
var G__44886 = new_smallest;
var G__44887 = (total_nodes_visited + (1));
var G__44888 = depth;
nodes = G__44885;
current_smallest = G__44886;
total_nodes_visited = G__44887;
depth = G__44888;
continue;
}
}
...
var G__44854_44890 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44854_44890) : reporter_fn.call(null,G__44854_44890));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__44843_SHARP_){
var G__44855 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__44843_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44855) : reporter_fn.call(null,G__44855));
}));
var G__44856_44891 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44856_44891) : reporter_fn.call(null,G__44856_44891));
