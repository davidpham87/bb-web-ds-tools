...
var vec__44818 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44818,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44818,(1),null);
...
var len__5749__auto___44887 = arguments.length;
var i__5750__auto___44889 = (0);
while(true){
if((i__5750__auto___44889 < len__5749__auto___44887)){
args__5755__auto__.push((arguments[i__5750__auto___44889]));

var G__44891 = (i__5750__auto___44889 + (1));
i__5750__auto___44889 = G__44891;
continue;
} else {
}
break;
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__44830){
var map__44831 = p__44830;
var map__44831__$1 = cljs.core.__destructure_map(map__44831);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44831__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__44831__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__44831__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__44832 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44832,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44832,(1),null);
...
var size = first__44849;
var rest_size_seq = seq__44848__$1;
var vec__44851 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44851,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44851,(1),null);
...
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44857_44902) : reporter_fn.call(null,G__44857_44902));

var G__44903 = so_far__$1;
var G__44904 = rest_size_seq;
var G__44905 = r2;
so_far = G__44903;
size_seq__$1 = G__44904;
rstate = G__44905;
continue;
} else {
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq44825){
var G__44826 = cljs.core.first(seq44825);
var seq44825__$1 = cljs.core.next(seq44825);
var G__44827 = cljs.core.first(seq44825__$1);
var seq44825__$2 = cljs.core.next(seq44825__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44826,G__44827,seq44825__$2);
}));
...
var map__44858 = smallest;
var map__44858__$1 = cljs.core.__destructure_map(map__44858);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44858__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__44918 = tail;
var G__44919 = current_smallest;
var G__44920 = (total_nodes_visited + (1));
var G__44921 = depth;
nodes = G__44918;
current_smallest = G__44919;
total_nodes_visited = G__44920;
depth = G__44921;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__44870_44922 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44870_44922) : reporter_fn.call(null,G__44870_44922));

var temp__5823__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5823__auto__){
var children = temp__5823__auto__;
var G__44923 = children;
var G__44924 = new_smallest;
var G__44925 = (total_nodes_visited + (1));
var G__44926 = (depth + (1));
nodes = G__44923;
current_smallest = G__44924;
total_nodes_visited = G__44925;
depth = G__44926;
continue;
} else {
var G__44927 = tail;
var G__44928 = new_smallest;
var G__44929 = (total_nodes_visited + (1));
var G__44930 = depth;
nodes = G__44927;
current_smallest = G__44928;
total_nodes_visited = G__44929;
depth = G__44930;
continue;
}
}
...
var G__44875_44932 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44875_44932) : reporter_fn.call(null,G__44875_44932));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__44871_SHARP_){
var G__44880 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__44871_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44880) : reporter_fn.call(null,G__44880));
}));
var G__44881_44934 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44881_44934) : reporter_fn.call(null,G__44881_44934));
