...
var vec__44904 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44904,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44904,(1),null);
...
var len__5749__auto___44967 = arguments.length;
var i__5750__auto___44968 = (0);
while(true){
if((i__5750__auto___44968 < len__5749__auto___44967)){
args__5755__auto__.push((arguments[i__5750__auto___44968]));

var G__44969 = (i__5750__auto___44968 + (1));
i__5750__auto___44968 = G__44969;
continue;
} else {
}
break;
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__44914){
var map__44915 = p__44914;
var map__44915__$1 = cljs.core.__destructure_map(map__44915);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44915__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__44915__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__44915__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__44916 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44916,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44916,(1),null);
...
var size = first__44934;
var rest_size_seq = seq__44933__$1;
var vec__44935 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44935,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44935,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq44908){
var G__44909 = cljs.core.first(seq44908);
var seq44908__$1 = cljs.core.next(seq44908);
var G__44910 = cljs.core.first(seq44908__$1);
var seq44908__$2 = cljs.core.next(seq44908__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44909,G__44910,seq44908__$2);
}));
...
var map__44939 = smallest;
var map__44939__$1 = cljs.core.__destructure_map(map__44939);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44939__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__44978 = tail;
var G__44979 = current_smallest;
var G__44980 = (total_nodes_visited + (1));
var G__44981 = depth;
nodes = G__44978;
current_smallest = G__44979;
total_nodes_visited = G__44980;
depth = G__44981;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__44946_44982 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44946_44982) : reporter_fn.call(null,G__44946_44982));

var temp__5823__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5823__auto__){
var children = temp__5823__auto__;
var G__45004 = children;
var G__45005 = new_smallest;
var G__45006 = (total_nodes_visited + (1));
var G__45007 = (depth + (1));
nodes = G__45004;
current_smallest = G__45005;
total_nodes_visited = G__45006;
depth = G__45007;
continue;
} else {
var G__45008 = tail;
var G__45009 = new_smallest;
var G__45010 = (total_nodes_visited + (1));
var G__45011 = depth;
nodes = G__45008;
current_smallest = G__45009;
total_nodes_visited = G__45010;
depth = G__45011;
continue;
}
}
...
var G__44955_45012 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44955_45012) : reporter_fn.call(null,G__44955_45012));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__44951_SHARP_){
var G__44956 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__44951_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44956) : reporter_fn.call(null,G__44956));
}));
var G__44957_45013 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44957_45013) : reporter_fn.call(null,G__44957_45013));
