...
var vec__44925 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44925,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44925,(1),null);
...
var len__5749__auto___45001 = arguments.length;
var i__5750__auto___45002 = (0);
while(true){
if((i__5750__auto___45002 < len__5749__auto___45001)){
args__5755__auto__.push((arguments[i__5750__auto___45002]));

var G__45003 = (i__5750__auto___45002 + (1));
i__5750__auto___45002 = G__45003;
continue;
} else {
}
break;
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__44934){
var map__44935 = p__44934;
var map__44935__$1 = cljs.core.__destructure_map(map__44935);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44935__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__44935__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__44935__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__44936 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44936,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44936,(1),null);
...
var size = first__44952;
var rest_size_seq = seq__44951__$1;
var vec__44953 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44953,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44953,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq44930){
...
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44931,G__44932,seq44930__$2);
}));
...
var map__44961 = smallest;
var map__44961__$1 = cljs.core.__destructure_map(map__44961);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44961__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__45020 = tail;
var G__45021 = current_smallest;
var G__45022 = (total_nodes_visited + (1));
var G__45024 = depth;
nodes = G__45020;
current_smallest = G__45021;
total_nodes_visited = G__45022;
depth = G__45024;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__44971_45025 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44971_45025) : reporter_fn.call(null,G__44971_45025));

var temp__5823__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5823__auto__){
var children = temp__5823__auto__;
var G__45026 = children;
var G__45027 = new_smallest;
var G__45028 = (total_nodes_visited + (1));
var G__45029 = (depth + (1));
nodes = G__45026;
current_smallest = G__45027;
total_nodes_visited = G__45028;
depth = G__45029;
continue;
} else {
var G__45030 = tail;
var G__45031 = new_smallest;
var G__45032 = (total_nodes_visited + (1));
var G__45033 = depth;
nodes = G__45030;
current_smallest = G__45031;
total_nodes_visited = G__45032;
depth = G__45033;
continue;
}
}
...
var G__44978_45034 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44978_45034) : reporter_fn.call(null,G__44978_45034));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__44977_SHARP_){
var G__44979 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__44977_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44979) : reporter_fn.call(null,G__44979));
}));
var G__44980_45036 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__44980_45036) : reporter_fn.call(null,G__44980_45036));
