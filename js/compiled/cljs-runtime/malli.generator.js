...
var malli$generator$Generator$_generator$dyn_46235 = (function (this$,options){
...
return malli$generator$Generator$_generator$dyn_46235(this$,options);
}
});
...
var G__46002 = malli.generator._child(schema,options);
var G__46003 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__46002,G__46003) : malli.generator.generator.call(null,G__46002,G__46003));
});
/**
 * Return a generator of no values that is compatible with -unreachable-gen?.
 */
malli.generator._never_gen = (function malli$generator$_never_gen(p__46004){
var map__46005 = p__46004;
var map__46005__$1 = cljs.core.__destructure_map(map__46005);
var _options = map__46005__$1;
var original_generator_schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46005__$1,new cljs.core.Keyword("malli.generator","original-generator-schema","malli.generator/original-generator-schema",-1122475395));
return cljs.core.with_meta(clojure.test.check.generators.sized((function (_){
return malli.core._fail_BANG_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("malli.generator","unsatisfiable-schema","malli.generator/unsatisfiable-schema",919209538),(function (){var G__46019 = cljs.core.PersistentArrayMap.EMPTY;
if(cljs.core.truth_(original_generator_schema)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46019,new cljs.core.Keyword(null,"schema","schema",-1582001791),original_generator_schema);
} else {
return G__46019;
}
})());
...
var map__46055 = malli.core.properties.cljs$core$IFn$_invoke$arity$2(schema,options);
var map__46055__$1 = cljs.core.__destructure_map(map__46055);
var gen_min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46055__$1,new cljs.core.Keyword("gen","min","gen/min",444569458));
var gen_max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46055__$1,new cljs.core.Keyword("gen","max","gen/max",61264228));
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46055__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46055__$1,new cljs.core.Keyword(null,"max","max",61366548));
...
var map__46064 = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
var map__46064__$1 = cljs.core.__destructure_map(map__46064);
var infinite_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46064__$1,new cljs.core.Keyword("gen","infinite?","gen/infinite?",-2017652832));
var NaN_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46064__$1,new cljs.core.Keyword("gen","NaN?","gen/NaN?",-1917993267));
...
return malli.generator.gen_fmap((function (p1__46078_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,p1__46078_SHARP_);
}),gen);
});
...
return clojure.test.check.generators.double_STAR_(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$2(malli.generator.double_default,opts),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__46079_SHARP_){
var G__46098 = p1__46079_SHARP_;
if((G__46098 == null)){
return null;
} else {
return G__46098;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__46080_SHARP_){
var G__46099 = p1__46080_SHARP_;
if((G__46099 == null)){
return null;
} else {
return G__46099;
...
malli.generator.gen_vector = (function malli$generator$gen_vector(p__46103,g){
var map__46104 = p__46103;
var map__46104__$1 = cljs.core.__destructure_map(map__46104);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46104__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46104__$1,new cljs.core.Keyword(null,"max","max",61366548));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(clojure.test.check.generators.sized((function (p1__46100_SHARP_){
return clojure.test.check.generators.vector.cljs$core$IFn$_invoke$arity$3(g,min,(min + p1__46100_SHARP_));
...
malli.generator.gen_vector_distinct_by = (function malli$generator$gen_vector_distinct_by(schema,p__46109,f,g){
var map__46110 = p__46109;
var map__46110__$1 = cljs.core.__destructure_map(map__46110);
var m = map__46110__$1;
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46110__$1,new cljs.core.Keyword(null,"min","min",444991522));
if(malli.generator._unreachable_gen_QMARK_(g)){
...
})())?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"num-elements","num-elements",1960422107),min], null):clojure.set.rename_keys(m,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"min","min",444991522),new cljs.core.Keyword(null,"min-elements","min-elements",949370780),new cljs.core.Keyword(null,"max","max",61366548),new cljs.core.Keyword(null,"max-elements","max-elements",433034073)], null))),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__46106_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","distinct-generator-failure","malli.generator/distinct-generator-failure",-2085139904),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__46106_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null)));
}
});
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max-tries","max-tries",-1824441792),(100),new cljs.core.Keyword(null,"ex-fn","ex-fn",-284925510),(function (p1__46114_SHARP_){
return malli.core._exception(new cljs.core.Keyword("malli.generator","such-that-failure","malli.generator/such-that-failure",599634585),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__46114_SHARP_,new cljs.core.Keyword(null,"schema","schema",-1582001791),schema));
})], null);
});
...
var map__46118 = malli.generator._min_max(schema,options);
var map__46118__$1 = cljs.core.__destructure_map(map__46118);
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46118__$1,new cljs.core.Keyword(null,"min","min",444991522));
var el = malli.generator._child(schema,options);
return malli.generator.gen_one_of(options,(function (){var G__46119 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$3((function (){var G__46120 = cljs.core.PersistentVector.EMPTY;
if((((min == null)) || ((min === (0))))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__46120,malli.generator.nil_gen);
} else {
return G__46120;
}
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__46115_SHARP_){
return malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$3(schema,p1__46115_SHARP_,options);
})),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.identity,cljs.core.vec,cljs.core.eduction,(function (p1__46116_SHARP_){
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(p1__46116_SHARP_);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__46119,(function (){var vec__46121 = malli.core.children.cljs$core$IFn$_invoke$arity$1(el);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46121,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46121,(1),null);
var G__46124 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map-of","map-of",1189682355),(function (){var or__5025__auto__ = malli.core.properties.cljs$core$IFn$_invoke$arity$1(schema);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
...
var G__46125 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__46124,G__46125) : malli.generator.generator.call(null,G__46124,G__46125));
})());
} else {
return G__46119;
}
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46126_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__46126_SHARP_,options) : malli.generator.generator.call(null,p1__46126_SHARP_,options));
...
return malli.util.transform_entries.cljs$core$IFn$_invoke$arity$3(G__46128,(function (p1__46127_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__46129){
var vec__46130 = p__46129;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46130,(0),null);
var e = vec__46130;
var G__46133 = e;
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__46133,(2),malli.util.merge,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dispatch,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"=","=",1152933628),null,k], null)], null)], null));
} else {
return G__46133;
}
}),p1__46127_SHARP_);
...
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46134_SHARP_){
var G__46135 = cljs.core.last(p1__46134_SHARP_);
var G__46136 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__46135,G__46136) : malli.generator.generator.call(null,G__46135,G__46136));
...
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__46137){
var vec__46138 = p__46137;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46138,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46138,(1),null);
...
malli.generator._entry_gen = (function malli$generator$_entry_gen(p__46142,options){
var vec__46143 = p__46142;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46143,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46143,(1),null);
var G__46146 = malli.generator.gen_fmap((function (p1__46141_SHARP_){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,p1__46141_SHARP_], null);
...
return malli.generator.gen_maybe(G__46146);
} else {
return G__46146;
}
});
malli.generator._map_gen = (function malli$generator$_map_gen(schema,options){
return malli.generator.gen_fmap(malli.generator._build_map,malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46147_SHARP_){
return malli.generator._entry_gen(p1__46147_SHARP_,options);
...
return malli.generator.gen_fmap((function (p1__46150_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,p1__46150_SHARP_);
}),malli.generator.gen_vector_distinct_by(schema,malli.generator._min_max(schema,options),(function (p1__46149_SHARP_){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__46149_SHARP_,(0));
}),malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46148_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__46148_SHARP_,options) : malli.generator.generator.call(null,p1__46148_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)))));
});
...
var G__46152 = (function (){var G__46153 = dschema;
var G__46154 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),scalar_ref_gen);
...
return clojure.test.check.generators.recursive_gen((function (p1__46151_SHARP_){
var G__46155 = dschema;
var G__46156 = cljs.core.assoc_in(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("malli.generator","rec-gen","malli.generator/rec-gen",65631558),ref_id], null),p1__46151_SHARP_);
...
var output_generator = (function (){var G__46157 = new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(malli.core._function_info(schema));
...
var G__46269__delegate = function (_){
...
var G__46269 = function (var_args){
var _ = null;
...
while (G__46270__i < G__46270__a.length) {G__46270__a[G__46270__i] = arguments[G__46270__i + 0]; ++G__46270__i;}
  _ = new cljs.core.IndexedSeq(G__46270__a,0,null);
} 
return G__46269__delegate.call(this,_);};
G__46269.cljs$lang$maxFixedArity = 0;
G__46269.cljs$lang$applyTo = (function (arglist__46271){
var _ = cljs.core.seq(arglist__46271);
return G__46269__delegate(_);
});
G__46269.cljs$core$IFn$_invoke$arity$variadic = G__46269__delegate;
return G__46269;
})()
));
});
malli.generator._function_gen = (function malli$generator$_function_gen(schema,options){
return clojure.test.check.generators.return$(malli.core._instrument.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"schema","schema",-1582001791),schema,new cljs.core.Keyword(null,"gen","gen",142575302),(function (p1__46159_SHARP_){
return (malli.generator.generate.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generate.cljs$core$IFn$_invoke$arity$2(p1__46159_SHARP_,options) : malli.generator.generate.call(null,p1__46159_SHARP_,options));
})], null),null,options));
});
malli.generator._regex_generator = (function malli$generator$_regex_generator(schema,options){
var G__46160 = (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(schema,options) : malli.generator.generator.call(null,schema,options));
if(cljs.core.not(malli.core._regex_op_QMARK_(schema))){
return malli.generator.gen_tuple((new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[G__46160],null)));
} else {
return G__46160;
}
});
...
return malli.generator.gen_fcat(malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46161_SHARP_){
return malli.generator._re_entry_gen(p1__46161_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options))));
});
malli.generator._alt_gen = (function malli$generator$_alt_gen(schema,options){
return malli.generator.gen_one_of(options,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46162_SHARP_){
return malli.generator._re_entry_gen(p1__46162_SHARP_,options);
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
});
...
var child = malli.generator._child(schema,options);
var G__46163 = malli.generator.gen_vector(malli.generator._min_max(schema,options),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__46163);
} else {
return G__46163;
}
});
...
var child = malli.generator._child(schema,options);
var G__46164 = malli.generator.gen_vector(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.max,(1))),(malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(child,options) : malli.generator.generator.call(null,child,options)));
if(cljs.core.truth_(malli.core._regex_op_QMARK_(child))){
return malli.generator.gen_fcat(G__46164);
} else {
return G__46164;
}
});
malli.generator._repeat_gen = (function malli$generator$_repeat_gen(schema,options){
var or__5025__auto__ = (function (){var G__46165 = malli.generator._coll_gen.cljs$core$IFn$_invoke$arity$2(schema,options);
var G__46165__$1 = (((G__46165 == null))?null:malli.generator._not_unreachable(G__46165));
if((G__46165__$1 == null)){
return null;
} else {
var G__46166 = G__46165__$1;
if(cljs.core.truth_(malli.core._regex_op_QMARK_(malli.generator._child(schema,options)))){
return malli.generator.gen_fcat(G__46166);
} else {
return G__46166;
}
}
...
var G__46167 = cljs.core.name(namespace_unparsed);
var G__46168 = cljs.core.name(k);
return (mk_value_with_ns.cljs$core$IFn$_invoke$arity$2 ? mk_value_with_ns.cljs$core$IFn$_invoke$arity$2(G__46167,G__46168) : mk_value_with_ns.call(null,G__46167,G__46168));
...
})(),cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(malli.generator._min_max(schema,options),new cljs.core.Keyword(null,"min","min",444991522),(function (p1__46169_SHARP_){
var G__46172 = p1__46169_SHARP_;
if((G__46172 == null)){
return null;
} else {
return G__46172;
}
})),new cljs.core.Keyword(null,"max","max",61366548),(function (p1__46170_SHARP_){
var G__46173 = p1__46170_SHARP_;
if((G__46173 == null)){
return null;
} else {
return G__46173;
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.generator","default","malli.generator/default",-943988734)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__46174 = cljs.core.get_global_hierarchy;
return (fexpr__46174.cljs$core$IFn$_invoke$arity$0 ? fexpr__46174.cljs$core$IFn$_invoke$arity$0() : fexpr__46174.call(null));
})());
...
return malli.generator.gen_such_that(schema,(function (p1__46175_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__46175_SHARP_,malli.generator._child(schema,options));
...
return malli.generator.gen_tuple(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46177_SHARP_){
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(p1__46177_SHARP_,options) : malli.generator.generator.call(null,p1__46177_SHARP_,options));
}),malli.core.children.cljs$core$IFn$_invoke$arity$2(schema,options)));
}));
...
var G__46178 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__46179 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__46178,G__46179) : malli.generator.generator.call(null,G__46178,G__46179));
}));
...
var G__46180 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__46181 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__46180,G__46181) : malli.generator.generator.call(null,G__46180,G__46181));
}));
...
var G__46185 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__46186 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__46185,G__46186) : malli.generator.generator.call(null,G__46185,G__46186));
}));
...
var G__46189 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__46190 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__46189,G__46190) : malli.generator.generator.call(null,G__46189,G__46190));
}));
...
var G__46193 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__46194 = options;
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__46193,G__46194) : malli.generator.generator.call(null,G__46193,G__46194));
}));
...
var G__46199 = new cljs.core.Keyword("gen","elements","gen/elements",657813311).cljs$core$IFn$_invoke$arity$1(props);
if((G__46199 == null)){
return null;
} else {
return malli.generator.gen_elements(G__46199);
}
});
...
var G__46200 = new cljs.core.Keyword("gen","schema","gen/schema",-1582038959).cljs$core$IFn$_invoke$arity$1(props);
if((G__46200 == null)){
return null;
} else {
return (malli.generator.generator.cljs$core$IFn$_invoke$arity$2 ? malli.generator.generator.cljs$core$IFn$_invoke$arity$2(G__46200,options) : malli.generator.generator.call(null,G__46200,options));
}
});
...
return malli.core._cached(malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options),new cljs.core.Keyword(null,"generator","generator",-572962281),(function (p1__46201_SHARP_){
return malli.generator._create(p1__46201_SHARP_,options);
}));
}
}));
...
(malli.generator.generate.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__46209){
var map__46210 = p__46209;
var map__46210__$1 = cljs.core.__destructure_map(map__46210);
var options = map__46210__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46210__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__46210__$1,new cljs.core.Keyword(null,"size","size",1098693007),(30));
...
(malli.generator.sample.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_gen_or_schema,p__46215){
var map__46216 = p__46215;
var map__46216__$1 = cljs.core.__destructure_map(map__46216);
var options = map__46216__$1;
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46216__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__46216__$1,new cljs.core.Keyword(null,"size","size",1098693007),(10));
var gen = ((clojure.test.check.generators.generator_QMARK_(_QMARK_gen_or_schema))?_QMARK_gen_or_schema:malli.generator.generator.cljs$core$IFn$_invoke$arity$2(_QMARK_gen_or_schema,options));
return cljs.core.take.cljs$core$IFn$_invoke$arity$2(size,cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__46211_SHARP_,p2__46212_SHARP_){
return clojure.test.check.rose_tree.root(clojure.test.check.generators.call_gen(gen,p1__46211_SHARP_,p2__46212_SHARP_));
...
(malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2 = (function (_QMARK_schema,p__46222){
var map__46223 = p__46222;
var map__46223__$1 = cljs.core.__destructure_map(map__46223);
var options = map__46223__$1;
var _EQ__GT_iterations = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__46223__$1,new cljs.core.Keyword("malli.generator","=>iterations","malli.generator/=>iterations",-1726832707),(100));
...
}catch (e46224){if((e46224 instanceof Error)){
var e = e46224;
...
var map__46225 = malli.core._function_info(schema__$1);
var map__46225__$1 = cljs.core.__destructure_map(map__46225);
var input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46225__$1,new cljs.core.Keyword(null,"input","input",556931961));
var output = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46225__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var guard = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46225__$1,new cljs.core.Keyword(null,"guard","guard",-873147811));
...
if(cljs.core.truth_(and__5023__auto__)){
var G__46226 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [args,$], null);
return (valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1 ? valid_guard_QMARK_.cljs$core$IFn$_invoke$arity$1(G__46226) : valid_guard_QMARK_.call(null,G__46226));
} else {
return and__5023__auto__;
}
});
return (function (f){
var map__46227 = clojure.test.check.quick_check(_EQ__GT_iterations,clojure.test.check.properties.for_all_STAR_(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [input_generator], null),(function (p1__46217_SHARP_){
return validate(f,p1__46217_SHARP_);
})));
var map__46227__$1 = cljs.core.__destructure_map(map__46227);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46227__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var shrunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46227__$1,new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412));
...
var vec__46228 = (cljs.core.truth_(explain_input)?null:_try((function (){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,smallest);
})));
var result__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46228,(0),null);
var success = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46228,(1),null);
...
var G__46231 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(shrunk,new cljs.core.Keyword("malli.core","result","malli.core/result",1538632379),result__$1);
var G__46231__$1 = (cljs.core.truth_(explain_input)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46231,new cljs.core.Keyword("malli.core","explain-input","malli.core/explain-input",1441627811),explain_input):G__46231);
var G__46231__$2 = (cljs.core.truth_(explain_output)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46231__$1,new cljs.core.Keyword("malli.core","explain-output","malli.core/explain-output",-124321573),explain_output):G__46231__$1);
var G__46231__$3 = (cljs.core.truth_(explain_guard)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46231__$2,new cljs.core.Keyword("malli.core","explain-guard","malli.core/explain-guard",-1119572847),explain_guard):G__46231__$2);
if(cljs.core.truth_(cljs.core.ex_message(result__$1))){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__46231__$3,new cljs.core.Keyword(null,"result","result",1415092211),cljs.core.ex_message),new cljs.core.Keyword(null,"result-data","result-data",-1724248844));
} else {
return G__46231__$3;
}
}
...
var checkers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46218_SHARP_){
return malli.generator.function_checker.cljs$core$IFn$_invoke$arity$2(p1__46218_SHARP_,options);
}),malli.core._function_schema_arities(schema));
return (function (x){
return cljs.core.seq(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__46219_SHARP_){
return (p1__46219_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__46219_SHARP_.cljs$core$IFn$_invoke$arity$1(x) : p1__46219_SHARP_.call(null,x));
}),checkers));
});
} else {
...
var schema = malli.core.schema.cljs$core$IFn$_invoke$arity$2(_QMARK_schema,options);
return malli.core.explain.cljs$core$IFn$_invoke$arity$2(malli.core._update_options(schema,(function (p1__46232_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__46232_SHARP_,new cljs.core.Keyword("malli.core","function-checker","malli.core/function-checker",-792030936),malli.generator.function_checker);
})),f);
}));
