...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.openapi.core","default","spec-tools.openapi.core/default",-940305094)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__54534 = cljs.core.get_global_hierarchy;
return (fexpr__54534.cljs$core$IFn$_invoke$arity$0 ? fexpr__54534.cljs$core$IFn$_invoke$arity$0() : fexpr__54534.call(null));
})());
...
var vec__54539 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54539,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54539,(1),null);
...
return cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__54548_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__54548_SHARP_),"null");
...
})(),new cljs.core.Keyword(null,"required","required",1807647006),(function (){var G__54552 = in$;
...
spec_tools.openapi.core.extract_object_param = (function spec_tools$openapi$core$extract_object_param(in$,p__54553){
var map__54554 = p__54553;
var map__54554__$1 = cljs.core.__destructure_map(map__54554);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54554__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54554__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__54555){
var vec__54556 = p__54555;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54556,(0),null);
var map__54559 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54556,(1),null);
var map__54559__$1 = cljs.core.__destructure_map(map__54559);
var schema = map__54559__$1;
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54559__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
...
})(),new cljs.core.Keyword(null,"required","required",1807647006),(function (){var G__54560 = in$;
...
var method_cache__5624__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5625__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__54588 = cljs.core.get_global_hierarchy;
return (fexpr__54588.cljs$core$IFn$_invoke$arity$0 ? fexpr__54588.cljs$core$IFn$_invoke$arity$0() : fexpr__54588.call(null));
})());
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$openapi$core$iter__54592(s__54593){
return (new cljs.core.LazySeq(null,(function (){
var s__54593__$1 = s__54593;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__54593__$1);
if(temp__5825__auto__){
var s__54593__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__54593__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__54593__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__54595 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__54594 = (0);
while(true){
if((i__54594 < size__5502__auto__)){
var vec__54596 = cljs.core._nth(c__5501__auto__,i__54594);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54596,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54596,(1),null);
cljs.core.chunk_append(b__54595,cljs.core.PersistentArrayMap.createAsIfByAssoc([name,spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)]));

var G__54670 = (i__54594 + (1));
i__54594 = G__54670;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__54595),spec_tools$openapi$core$iter__54592(cljs.core.chunk_rest(s__54593__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__54595),null);
}
} else {
var vec__54599 = cljs.core.first(s__54593__$2);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54599,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54599,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([name,spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)]),spec_tools$openapi$core$iter__54592(cljs.core.rest(s__54593__$2)));
}
} else {
return null;
}
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$openapi$core$iter__54602(s__54603){
return (new cljs.core.LazySeq(null,(function (){
var s__54603__$1 = s__54603;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__54603__$1);
if(temp__5825__auto__){
var s__54603__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__54603__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__54603__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__54605 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__54604 = (0);
while(true){
if((i__54604 < size__5502__auto__)){
var vec__54611 = cljs.core._nth(c__5501__auto__,i__54604);
var content_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54611,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54611,(1),null);
cljs.core.chunk_append(b__54605,cljs.core.PersistentArrayMap.createAsIfByAssoc([content_type,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)], null)]));

var G__54671 = (i__54604 + (1));
i__54604 = G__54671;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__54605),spec_tools$openapi$core$iter__54602(cljs.core.chunk_rest(s__54603__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__54605),null);
}
} else {
var vec__54616 = cljs.core.first(s__54603__$2);
var content_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54616,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54616,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([content_type,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)], null)]),spec_tools$openapi$core$iter__54602(cljs.core.rest(s__54603__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__54620){
var vec__54621 = p__54620;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54621,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54621,(1),null);
return spec_tools.openapi.core.extract_parameter(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__54624,p){
var vec__54625 = p__54624;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54625,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54625,(1),null);
var acc__$1 = vec__54625;
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$openapi$core$iter__54629(s__54630){
return (new cljs.core.LazySeq(null,(function (){
var s__54630__$1 = s__54630;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__54630__$1);
if(temp__5825__auto__){
var s__54630__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__54630__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__54630__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__54632 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__54631 = (0);
while(true){
if((i__54631 < size__5502__auto__)){
var vec__54638 = cljs.core._nth(c__5501__auto__,i__54631);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54638,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54638,(1),null);
cljs.core.chunk_append(b__54632,cljs.core.PersistentArrayMap.createAsIfByAssoc([name,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(spec_tools.openapi.core.extract_single_param(new cljs.core.Keyword(null,"header","header",119441134),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(spec)),new cljs.core.Keyword(null,"in","in",-1531184865)),new cljs.core.Keyword(null,"name","name",1843675177))]));

var G__54678 = (i__54631 + (1));
i__54631 = G__54678;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__54632),spec_tools$openapi$core$iter__54629(cljs.core.chunk_rest(s__54630__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__54632),null);
}
} else {
var vec__54642 = cljs.core.first(s__54630__$2);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54642,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54642,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([name,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(spec_tools.openapi.core.extract_single_param(new cljs.core.Keyword(null,"header","header",119441134),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(spec)),new cljs.core.Keyword(null,"in","in",-1531184865)),new cljs.core.Keyword(null,"name","name",1843675177))]),spec_tools$openapi$core$iter__54629(cljs.core.rest(s__54630__$2)));
}
} else {
return null;
}
