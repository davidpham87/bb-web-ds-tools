...
var vec__50857 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50857,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50857,(1),null);
...
return cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__50869_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__50869_SHARP_),"null");
...
})(),new cljs.core.Keyword(null,"required","required",1807647006),(function (){var G__50871 = in$;
var G__50871__$1 = (((G__50871 instanceof cljs.core.Keyword))?G__50871.fqn:null);
switch (G__50871__$1) {
case "path":
return true;
...
spec_tools.openapi.core.extract_object_param = (function spec_tools$openapi$core$extract_object_param(in$,p__50873){
var map__50874 = p__50873;
var map__50874__$1 = cljs.core.__destructure_map(map__50874);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50874__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50874__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__50876){
var vec__50881 = p__50876;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50881,(0),null);
var map__50884 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50881,(1),null);
var map__50884__$1 = cljs.core.__destructure_map(map__50884);
var schema = map__50884__$1;
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50884__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
...
})(),new cljs.core.Keyword(null,"required","required",1807647006),(function (){var G__50885 = in$;
var G__50885__$1 = (((G__50885 instanceof cljs.core.Keyword))?G__50885.fqn:null);
switch (G__50885__$1) {
case "path":
return true;
...
var method_cache__5624__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5625__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__50891 = cljs.core.get_global_hierarchy;
return (fexpr__50891.cljs$core$IFn$_invoke$arity$0 ? fexpr__50891.cljs$core$IFn$_invoke$arity$0() : fexpr__50891.call(null));
})());
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$openapi$core$iter__50895(s__50896){
return (new cljs.core.LazySeq(null,(function (){
var s__50896__$1 = s__50896;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__50896__$1);
if(temp__5825__auto__){
var s__50896__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__50896__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__50896__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__50898 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__50897 = (0);
while(true){
if((i__50897 < size__5502__auto__)){
var vec__50910 = cljs.core._nth(c__5501__auto__,i__50897);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50910,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50910,(1),null);
cljs.core.chunk_append(b__50898,cljs.core.PersistentArrayMap.createAsIfByAssoc([name,spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)]));

var G__50957 = (i__50897 + (1));
i__50897 = G__50957;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50898),spec_tools$openapi$core$iter__50895(cljs.core.chunk_rest(s__50896__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50898),null);
}
} else {
var vec__50913 = cljs.core.first(s__50896__$2);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50913,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50913,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([name,spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)]),spec_tools$openapi$core$iter__50895(cljs.core.rest(s__50896__$2)));
}
} else {
return null;
}
...
var vec__50922 = cljs.core._nth(c__5501__auto__,i__50919);
var content_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50922,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50922,(1),null);
cljs.core.chunk_append(b__50920,cljs.core.PersistentArrayMap.createAsIfByAssoc([content_type,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)], null)]));

var G__50963 = (i__50919 + (1));
i__50919 = G__50963;
continue;
} else {
return true;
...
var vec__50925 = cljs.core.first(s__50918__$2);
var content_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50925,(0),null);
var schema = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50925,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([content_type,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(schema)], null)]),spec_tools$openapi$core$iter__50917(cljs.core.rest(s__50918__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__50929){
var vec__50930 = p__50929;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50930,(0),null);
...
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__50933,p){
var vec__50934 = p__50933;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50934,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50934,(1),null);
var acc__$1 = vec__50934;
...
})(),(function (){var iter__5503__auto__ = (function spec_tools$openapi$core$iter__50939(s__50940){
return (new cljs.core.LazySeq(null,(function (){
var s__50940__$1 = s__50940;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__50940__$1);
if(temp__5825__auto__){
var s__50940__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__50940__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__50940__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__50942 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__50941 = (0);
while(true){
if((i__50941 < size__5502__auto__)){
var vec__50943 = cljs.core._nth(c__5501__auto__,i__50941);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50943,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50943,(1),null);
cljs.core.chunk_append(b__50942,cljs.core.PersistentArrayMap.createAsIfByAssoc([name,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(spec_tools.openapi.core.extract_single_param(new cljs.core.Keyword(null,"header","header",119441134),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(spec)),new cljs.core.Keyword(null,"in","in",-1531184865)),new cljs.core.Keyword(null,"name","name",1843675177))]));

var G__50972 = (i__50941 + (1));
i__50941 = G__50972;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50942),spec_tools$openapi$core$iter__50939(cljs.core.chunk_rest(s__50940__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50942),null);
}
} else {
var vec__50946 = cljs.core.first(s__50940__$2);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50946,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50946,(1),null);
return cljs.core.cons(cljs.core.PersistentArrayMap.createAsIfByAssoc([name,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(spec_tools.openapi.core.extract_single_param(new cljs.core.Keyword(null,"header","header",119441134),spec_tools.openapi.core.transform.cljs$core$IFn$_invoke$arity$1(spec)),new cljs.core.Keyword(null,"in","in",-1531184865)),new cljs.core.Keyword(null,"name","name",1843675177))]),spec_tools$openapi$core$iter__50939(cljs.core.rest(s__50940__$2)));
}
} else {
return null;
}
