...
var clojure$test$check$random$IRandom$rand_long$dyn_43444 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_43444(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_43445 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_43445(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_43446 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_43446(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_43447 = (function (rng,n){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_43447(rng,n);
}
});
...
var G__43432 = z;
if(((24) > (function (){var G__43433 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__43433) : clojure.test.check.random.longs.bit_count.call(null,G__43433));
})())){
return clojure.test.check.random.longs.bit_xor(G__43432,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__43432;
}
});
...
var G__43449 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__43450 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__43449;
ret = G__43450;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__43435){
var map__43436 = p__43435;
var map__43436__$1 = cljs.core.__destructure_map(map__43436);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43436__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__43437 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43437,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43437,(1),null);
