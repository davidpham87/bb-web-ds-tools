...
var clojure$test$check$random$IRandom$rand_long$dyn_43422 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_43422(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_43423 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_43423(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_43424 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_43424(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_43425 = (function (rng,n){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_43425(rng,n);
}
});
...
var G__43428 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__43429 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__43428;
ret = G__43429;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__43415){
var map__43416 = p__43415;
var map__43416__$1 = cljs.core.__destructure_map(map__43416);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43416__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__43417 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43417,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43417,(1),null);
