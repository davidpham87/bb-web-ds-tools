...
var clojure$test$check$random$IRandom$rand_long$dyn_43437 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_43437(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_43438 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_43438(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_43439 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_43439(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_43440 = (function (rng,n){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_43440(rng,n);
}
});
...
var G__43410 = z;
if(((24) > (function (){var G__43411 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__43411) : clojure.test.check.random.longs.bit_count.call(null,G__43411));
})())){
return clojure.test.check.random.longs.bit_xor(G__43410,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__43410;
}
});
...
var G__43445 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__43446 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__43445;
ret = G__43446;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__43430){
...
var vec__43432 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43432,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43432,(1),null);
