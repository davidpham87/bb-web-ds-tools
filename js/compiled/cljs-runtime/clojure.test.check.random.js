...
var clojure$test$check$random$IRandom$rand_long$dyn_39013 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_39013(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_39017 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_39017(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_39020 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_39020(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_39023 = (function (rng,n){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_39023(rng,n);
}
});
...
var G__38971 = z;
if(((24) > (function (){var G__38972 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__38972) : clojure.test.check.random.longs.bit_count.call(null,G__38972));
})())){
return clojure.test.check.random.longs.bit_xor(G__38971,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__38971;
}
});
...
var G__39038 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__39039 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__39038;
ret = G__39039;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__38998){
var map__39000 = p__38998;
var map__39000__$1 = cljs.core.__destructure_map(map__39000);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39000__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__39001 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39001,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39001,(1),null);
