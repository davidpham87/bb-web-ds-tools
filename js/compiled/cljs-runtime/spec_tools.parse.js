...
var fexpr__53137 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__53137.cljs$core$IFn$_invoke$arity$1 ? fexpr__53137.cljs$core$IFn$_invoke$arity$1(type) : fexpr__53137.call(null,type));
});
...
var G__53144 = spec_tools.impl.normalize_symbol(x);
var G__53145 = null;
var G__53146 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__53144,G__53145,G__53146) : spec_tools.parse.parse_form.call(null,G__53144,G__53145,G__53146));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__53172 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__53173 = x;
var G__53174 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__53172,G__53173,G__53174) : spec_tools.parse.parse_form.call(null,G__53172,G__53173,G__53174));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__53266 = cljs.spec.alpha.form(x);
var G__53267 = options;
x = G__53266;
options = G__53267;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__53175 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__53176 = null;
var G__53177 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__53175,G__53176,G__53177) : spec_tools.parse.parse_form.call(null,G__53175,G__53176,G__53177));
} else {
...
var G__53212 = parse_data;
var G__53212__$1 = (((G__53212 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__53212));
var G__53212__$2 = (((G__53212__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__53212__$1));
var G__53212__$3 = (((G__53212__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__53212__$2));
var G__53212__$4 = (((G__53212__$3 == null))?null:cljs.core.seq(G__53212__$3));
if((G__53212__$4 == null)){
return null;
} else {
return cljs.core.set(G__53212__$4);
}
}
});
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__53214 = cljs.core.get_global_hierarchy;
return (fexpr__53214.cljs$core$IFn$_invoke$arity$0 ? fexpr__53214.cljs$core$IFn$_invoke$arity$0() : fexpr__53214.call(null));
})());
...
var map__53227 = spec_tools.impl.parse_keys(form);
var map__53227__$1 = cljs.core.__destructure_map(map__53227);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53227__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53227__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53227__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53227__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53227__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__53228 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__53228__$1 = (cljs.core.truth_((function (){var or__5025__auto__ = req;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53228,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__53228);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53228__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__53228__$1;
}
}));
...
var vec__53229 = multi_spec_form;
...
var _ = first__53231;
var first__53231__$1 = cljs.core.first(seq__53230__$1);
var seq__53230__$2 = cljs.core.next(seq__53230__$1);
var multi_method_symbol = first__53231__$1;
var ___$1 = seq__53230__$2;
var form = vec__53229;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__53232){
var vec__53233 = p__53232;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53233,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53233,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__53236_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__53236_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__53237_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__53237_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__53238_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__53238_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53239_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__53239_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__53240 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__53240__$1 = cljs.core.__destructure_map(map__53240);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53240__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__53241 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__53241__$1 = cljs.core.__destructure_map(map__53241);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53241__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__53242,options){
var vec__53243 = p__53242;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53243,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53243,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53243,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__53247,options){
var vec__53248 = p__53247;
var seq__53249 = cljs.core.seq(vec__53248);
var first__53250 = cljs.core.first(seq__53249);
var seq__53249__$1 = cljs.core.next(seq__53249);
var ___$1 = first__53250;
var values = seq__53249__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__53246_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__53246_SHARP_,options);
}),values);
...
var type_priority = (function (p1__53259_SHARP_){
var G__53262 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__53261 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__53259_SHARP_);
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53260_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__53260_SHARP_,options);
}),cljs.core.rest(form))));
}));
