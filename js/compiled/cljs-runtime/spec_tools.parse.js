...
var fexpr__52941 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__52941.cljs$core$IFn$_invoke$arity$1 ? fexpr__52941.cljs$core$IFn$_invoke$arity$1(type) : fexpr__52941.call(null,type));
});
...
var G__52975 = spec_tools.impl.normalize_symbol(x);
var G__52976 = null;
var G__52977 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__52975,G__52976,G__52977) : spec_tools.parse.parse_form.call(null,G__52975,G__52976,G__52977));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__52978 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__52979 = x;
var G__52980 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__52978,G__52979,G__52980) : spec_tools.parse.parse_form.call(null,G__52978,G__52979,G__52980));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__53068 = cljs.spec.alpha.form(x);
var G__53069 = options;
x = G__53068;
options = G__53069;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__52981 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__52982 = null;
var G__52983 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__52981,G__52982,G__52983) : spec_tools.parse.parse_form.call(null,G__52981,G__52982,G__52983));
} else {
...
var G__53017 = parse_data;
var G__53017__$1 = (((G__53017 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__53017));
var G__53017__$2 = (((G__53017__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__53017__$1));
var G__53017__$3 = (((G__53017__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__53017__$2));
var G__53017__$4 = (((G__53017__$3 == null))?null:cljs.core.seq(G__53017__$3));
if((G__53017__$4 == null)){
return null;
} else {
return cljs.core.set(G__53017__$4);
}
}
});
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__53019 = cljs.core.get_global_hierarchy;
return (fexpr__53019.cljs$core$IFn$_invoke$arity$0 ? fexpr__53019.cljs$core$IFn$_invoke$arity$0() : fexpr__53019.call(null));
})());
...
var map__53026 = spec_tools.impl.parse_keys(form);
var map__53026__$1 = cljs.core.__destructure_map(map__53026);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53026__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53026__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53026__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53026__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53026__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__53027 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__53027__$1 = (cljs.core.truth_((function (){var or__5025__auto__ = req;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53027,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__53027);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53027__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__53027__$1;
}
}));
...
var vec__53028 = multi_spec_form;
var seq__53029 = cljs.core.seq(vec__53028);
var first__53030 = cljs.core.first(seq__53029);
var seq__53029__$1 = cljs.core.next(seq__53029);
var _ = first__53030;
var first__53030__$1 = cljs.core.first(seq__53029__$1);
var seq__53029__$2 = cljs.core.next(seq__53029__$1);
var multi_method_symbol = first__53030__$1;
var ___$1 = seq__53029__$2;
var form = vec__53028;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__53035){
var vec__53037 = p__53035;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53037,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53037,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__53040_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__53040_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__53041_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__53041_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__53042_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__53042_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53043_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__53043_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__53044 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__53044__$1 = cljs.core.__destructure_map(map__53044);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53044__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__53045 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__53045__$1 = cljs.core.__destructure_map(map__53045);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53045__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__53046,options){
var vec__53047 = p__53046;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53047,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53047,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53047,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__53051,options){
...
var ___$1 = first__53054;
var values = seq__53053__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__53050_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__53050_SHARP_,options);
}),values);
...
var type_priority = (function (p1__53055_SHARP_){
var G__53058 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__53057 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__53055_SHARP_);
return (fexpr__53057.cljs$core$IFn$_invoke$arity$1 ? fexpr__53057.cljs$core$IFn$_invoke$arity$1(G__53058) : fexpr__53057.call(null,G__53058));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53056_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__53056_SHARP_,options);
}),cljs.core.rest(form))));
}));
