...
var fexpr__49362 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__49362.cljs$core$IFn$_invoke$arity$1 ? fexpr__49362.cljs$core$IFn$_invoke$arity$1(type) : fexpr__49362.call(null,type));
});
...
var G__49395 = spec_tools.impl.normalize_symbol(x);
var G__49396 = null;
var G__49397 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__49395,G__49396,G__49397) : spec_tools.parse.parse_form.call(null,G__49395,G__49396,G__49397));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__49398 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__49399 = x;
var G__49400 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__49398,G__49399,G__49400) : spec_tools.parse.parse_form.call(null,G__49398,G__49399,G__49400));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__49561 = cljs.spec.alpha.form(x);
var G__49562 = options;
x = G__49561;
options = G__49562;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__49401 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__49402 = null;
var G__49403 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__49401,G__49402,G__49403) : spec_tools.parse.parse_form.call(null,G__49401,G__49402,G__49403));
} else {
...
var G__49434 = parse_data;
var G__49434__$1 = (((G__49434 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__49434));
var G__49434__$2 = (((G__49434__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__49434__$1));
var G__49434__$3 = (((G__49434__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__49434__$2));
var G__49434__$4 = (((G__49434__$3 == null))?null:cljs.core.seq(G__49434__$3));
if((G__49434__$4 == null)){
return null;
} else {
return cljs.core.set(G__49434__$4);
}
}
});
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__49435 = cljs.core.get_global_hierarchy;
return (fexpr__49435.cljs$core$IFn$_invoke$arity$0 ? fexpr__49435.cljs$core$IFn$_invoke$arity$0() : fexpr__49435.call(null));
})());
...
var map__49494 = spec_tools.impl.parse_keys(form);
var map__49494__$1 = cljs.core.__destructure_map(map__49494);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49494__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49494__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49494__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49494__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49494__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__49495 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__49495__$1 = (cljs.core.truth_((function (){var or__5025__auto__ = req;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49495,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__49495);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49495__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__49495__$1;
}
}));
...
var vec__49511 = multi_spec_form;
...
var _ = first__49513;
var first__49513__$1 = cljs.core.first(seq__49512__$1);
var seq__49512__$2 = cljs.core.next(seq__49512__$1);
var multi_method_symbol = first__49513__$1;
var ___$1 = seq__49512__$2;
var form = vec__49511;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__49526){
var vec__49527 = p__49526;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49527,(0),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__49535_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__49535_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__49537_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__49537_SHARP_,options);
}),cljs.core.rest(form));
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__49539_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49540_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__49540_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__49541 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__49541__$1 = cljs.core.__destructure_map(map__49541);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49541__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__49542 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__49542__$1 = cljs.core.__destructure_map(map__49542);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49542__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__49543,options){
var vec__49544 = p__49543;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49544,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49544,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49544,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__49550,options){
...
var ___$1 = first__49553;
var values = seq__49552__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__49549_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__49549_SHARP_,options);
}),values);
...
var type_priority = (function (p1__49554_SHARP_){
var G__49557 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__49556 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__49554_SHARP_);
return (fexpr__49556.cljs$core$IFn$_invoke$arity$1 ? fexpr__49556.cljs$core$IFn$_invoke$arity$1(G__49557) : fexpr__49556.call(null,G__49557));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49555_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__49555_SHARP_,options);
}),cljs.core.rest(form))));
}));
