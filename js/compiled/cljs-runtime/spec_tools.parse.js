...
var fexpr__49385 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__49385.cljs$core$IFn$_invoke$arity$1 ? fexpr__49385.cljs$core$IFn$_invoke$arity$1(type) : fexpr__49385.call(null,type));
});
...
var G__49422 = spec_tools.impl.normalize_symbol(x);
var G__49423 = null;
var G__49424 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__49422,G__49423,G__49424) : spec_tools.parse.parse_form.call(null,G__49422,G__49423,G__49424));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__49425 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__49426 = x;
var G__49427 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__49425,G__49426,G__49427) : spec_tools.parse.parse_form.call(null,G__49425,G__49426,G__49427));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__49560 = cljs.spec.alpha.form(x);
var G__49561 = options;
x = G__49560;
options = G__49561;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__49428 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__49429 = null;
var G__49430 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__49428,G__49429,G__49430) : spec_tools.parse.parse_form.call(null,G__49428,G__49429,G__49430));
} else {
...
var G__49443 = parse_data;
var G__49443__$1 = (((G__49443 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__49443));
var G__49443__$2 = (((G__49443__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__49443__$1));
var G__49443__$3 = (((G__49443__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__49443__$2));
var G__49443__$4 = (((G__49443__$3 == null))?null:cljs.core.seq(G__49443__$3));
if((G__49443__$4 == null)){
return null;
} else {
return cljs.core.set(G__49443__$4);
}
}
});
...
var map__49527 = spec_tools.impl.parse_keys(form);
var map__49527__$1 = cljs.core.__destructure_map(map__49527);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49527__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49527__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49527__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49527__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49527__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
...
var G__49528__$1 = (cljs.core.truth_((function (){var or__5025__auto__ = req;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49528,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__49528);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49528__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__49528__$1;
}
}));
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__49538_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__49538_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__49541_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__49541_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__49542_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__49542_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49543_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__49543_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__49545 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__49545__$1 = cljs.core.__destructure_map(map__49545);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49545__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__49546,options){
var vec__49547 = p__49546;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49547,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49547,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49547,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__49551,options){
var vec__49552 = p__49551;
var seq__49553 = cljs.core.seq(vec__49552);
var first__49554 = cljs.core.first(seq__49553);
var seq__49553__$1 = cljs.core.next(seq__49553);
var ___$1 = first__49554;
var values = seq__49553__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__49550_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__49550_SHARP_,options);
}),values);
...
var type_priority = (function (p1__49555_SHARP_){
...
var fexpr__49557 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__49555_SHARP_);
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49556_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__49556_SHARP_,options);
}),cljs.core.rest(form))));
}));
