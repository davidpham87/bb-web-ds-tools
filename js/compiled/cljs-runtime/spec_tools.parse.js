...
var fexpr__53065 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__53065.cljs$core$IFn$_invoke$arity$1 ? fexpr__53065.cljs$core$IFn$_invoke$arity$1(type) : fexpr__53065.call(null,type));
});
...
var G__53075 = spec_tools.impl.normalize_symbol(x);
var G__53076 = null;
var G__53077 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__53075,G__53076,G__53077) : spec_tools.parse.parse_form.call(null,G__53075,G__53076,G__53077));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__53078 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__53079 = x;
var G__53080 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__53078,G__53079,G__53080) : spec_tools.parse.parse_form.call(null,G__53078,G__53079,G__53080));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__53215 = cljs.spec.alpha.form(x);
var G__53216 = options;
x = G__53215;
options = G__53216;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__53081 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__53082 = null;
var G__53083 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__53081,G__53082,G__53083) : spec_tools.parse.parse_form.call(null,G__53081,G__53082,G__53083));
} else {
...
var G__53084 = parse_data;
var G__53084__$1 = (((G__53084 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__53084));
var G__53084__$2 = (((G__53084__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__53084__$1));
var G__53084__$3 = (((G__53084__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__53084__$2));
var G__53084__$4 = (((G__53084__$3 == null))?null:cljs.core.seq(G__53084__$3));
if((G__53084__$4 == null)){
return null;
} else {
return cljs.core.set(G__53084__$4);
}
}
});
...
var map__53117 = spec_tools.impl.parse_keys(form);
var map__53117__$1 = cljs.core.__destructure_map(map__53117);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53117__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53117__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53117__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53117__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53117__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__53126 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__53126__$1 = (cljs.core.truth_((function (){var or__5025__auto__ = req;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53126,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__53126);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53126__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__53126__$1;
}
}));
...
var vec__53145 = multi_spec_form;
var seq__53146 = cljs.core.seq(vec__53145);
var first__53147 = cljs.core.first(seq__53146);
var seq__53146__$1 = cljs.core.next(seq__53146);
var _ = first__53147;
var first__53147__$1 = cljs.core.first(seq__53146__$1);
var seq__53146__$2 = cljs.core.next(seq__53146__$1);
var multi_method_symbol = first__53147__$1;
var ___$1 = seq__53146__$2;
var form = vec__53145;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__53160){
var vec__53161 = p__53160;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53161,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53161,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__53164_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__53164_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__53165_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__53165_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__53166_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__53166_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53167_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__53167_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__53168 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__53168__$1 = cljs.core.__destructure_map(map__53168);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53168__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__53181 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__53181__$1 = cljs.core.__destructure_map(map__53181);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53181__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__53182,options){
var vec__53183 = p__53182;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53183,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53183,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53183,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__53199,options){
var vec__53205 = p__53199;
var seq__53206 = cljs.core.seq(vec__53205);
var first__53207 = cljs.core.first(seq__53206);
var seq__53206__$1 = cljs.core.next(seq__53206);
var ___$1 = first__53207;
var values = seq__53206__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__53195_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__53195_SHARP_,options);
}),values);
...
var type_priority = (function (p1__53208_SHARP_){
var G__53211 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__53210 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__53208_SHARP_);
return (fexpr__53210.cljs$core$IFn$_invoke$arity$1 ? fexpr__53210.cljs$core$IFn$_invoke$arity$1(G__53211) : fexpr__53210.call(null,G__53211));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53209_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__53209_SHARP_,options);
}),cljs.core.rest(form))));
}));
