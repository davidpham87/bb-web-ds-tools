...
var len__5749__auto___23966 = arguments.length;
var i__5750__auto___23967 = (0);
while(true){
if((i__5750__auto___23967 < len__5749__auto___23966)){
args__5755__auto__.push((arguments[i__5750__auto___23967]));

var G__23968 = (i__5750__auto___23967 + (1));
i__5750__auto___23967 = G__23968;
continue;
} else {
}
break;
...
(re_frame.interceptor.__GT_interceptor.cljs$core$IFn$_invoke$arity$variadic = (function (p__23810){
var map__23811 = p__23810;
var map__23811__$1 = cljs.core.__destructure_map(map__23811);
var m = map__23811__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23811__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var comment = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23811__$1,new cljs.core.Keyword(null,"comment","comment",532206069));
var before = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23811__$1,new cljs.core.Keyword(null,"before","before",-1633692388));
var after = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23811__$1,new cljs.core.Keyword(null,"after","after",594996914));
if(re_frame.interop.debug_enabled_QMARK_){
var temp__5823__auto___23969 = cljs.core.seq(clojure.set.difference.cljs$core$IFn$_invoke$arity$variadic(cljs.core.set(cljs.core.keys(m)),re_frame.interceptor.mandatory_interceptor_keys,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([re_frame.interceptor.optional_interceptor_keys], 0)));
if(temp__5823__auto___23969){
var unknown_keys_23970 = temp__5823__auto___23969;
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["re-frame: ->interceptor",m,"has unknown keys:",unknown_keys_23970], 0));
} else {
}
} else {
}

var G__23815 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__5025__auto__ = id;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23815,new cljs.core.Keyword(null,"comment","comment",532206069),comment);
} else {
return G__23815;
}
}));
...
/** @this {Function} */
(re_frame.interceptor.__GT_interceptor.cljs$lang$applyTo = (function (seq23809){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq23809));
}));
...
var args__5755__auto__ = [];
var len__5749__auto___23987 = arguments.length;
var i__5750__auto___23988 = (0);
while(true){
if((i__5750__auto___23988 < len__5749__auto___23987)){
args__5755__auto__.push((arguments[i__5750__auto___23988]));

var G__23989 = (i__5750__auto___23988 + (1));
i__5750__auto___23988 = G__23989;
continue;
} else {
}
break;
...
/** @this {Function} */
(re_frame.interceptor.update_effect.cljs$lang$applyTo = (function (seq23822){
...
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23823,G__23824,G__23825,seq23822__$3);
}));
...
var G__24010 = (i__5750__auto___23994 + (1));
i__5750__auto___23994 = G__24010;
continue;
} else {
}
break;
...
/** @this {Function} */
(re_frame.interceptor.update_coeffect.cljs$lang$applyTo = (function (seq23843){
var G__23844 = cljs.core.first(seq23843);
var seq23843__$1 = cljs.core.next(seq23843);
var G__23845 = cljs.core.first(seq23843__$1);
var seq23843__$2 = cljs.core.next(seq23843__$1);
var G__23846 = cljs.core.first(seq23843__$2);
var seq23843__$3 = cljs.core.next(seq23843__$2);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23844,G__23845,G__23846,seq23843__$3);
}));
...
re_frame.interceptor.invoke_interceptor_fn = (function re_frame$interceptor$invoke_interceptor_fn(p__23866,interceptor,direction){
var map__23887 = p__23866;
var map__23887__$1 = cljs.core.__destructure_map(map__23887);
var context = map__23887__$1;
var original_exception_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23887__$1,new cljs.core.Keyword("re-frame.interceptor","original-exception?","re-frame.interceptor/original-exception?",-527923945));
...
/** @this {Function} */
(re_frame.interceptor.merge_ex_data.cljs$lang$applyTo = (function (seq23915){
var G__23916 = cljs.core.first(seq23915);
var seq23915__$1 = cljs.core.next(seq23915);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23916,seq23915__$1);
}));
...
var map__23934 = cljs.core.ex_data(re_frame_error);
var map__23934__$1 = cljs.core.__destructure_map(map__23934);
var event_v = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23934__$1,new cljs.core.Keyword(null,"event-v","event-v",1378681365));
var direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23934__$1,new cljs.core.Keyword(null,"direction","direction",-633359395));
var interceptor = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23934__$1,new cljs.core.Keyword(null,"interceptor","interceptor",1127739076));
...
return (fexpr__23939.cljs$core$IFn$_invoke$arity$1 ? fexpr__23939.cljs$core$IFn$_invoke$arity$1(interceptor) : fexpr__23939.call(null,interceptor));
})();
...
var G__23956 = cljs.core.ex_cause(e);
var G__23957 = re_frame.interceptor.merge_ex_data.cljs$core$IFn$_invoke$arity$variadic(e,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"event-v","event-v",1378681365),event_v], null)], 0));
return (error_handler.cljs$core$IFn$_invoke$arity$2 ? error_handler.cljs$core$IFn$_invoke$arity$2(G__23956,G__23957) : error_handler.call(null,G__23956,G__23957));
}}
});
