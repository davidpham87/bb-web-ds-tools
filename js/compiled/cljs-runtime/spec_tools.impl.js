...
var vec__52955 = cljs.core.rest(expr);
...
var vec__52958 = first__52957;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52958,(0),null);
var form = seq__52956__$1;
...
var G__52961 = x;
var G__52961__$1 = (((G__52961 == null))?null:spec_tools.impl.polish(G__52961));
var G__52961__$2 = (((G__52961__$1 == null))?null:cljs.core.name(G__52961__$1));
if((G__52961__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__52961__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__52962 = x;
var G__52962__$1 = (((G__52962 == null))?null:cljs.core.name(G__52962));
if((G__52962__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__52962__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__52963){
var map__52964 = p__52963;
var map__52964__$1 = cljs.core.__destructure_map(map__52964);
var data = map__52964__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52964__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52964__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52964__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52964__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__52965){
var map__52966 = p__52965;
var map__52966__$1 = cljs.core.__destructure_map(map__52966);
var data = map__52966__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52966__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52966__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__52967 = data;
var G__52967__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__52967,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__52967);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__52967__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__52967__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__52971 = form;
var G__52971__$1 = (((G__52971 == null))?null:cljs.core.rest(G__52971));
if((G__52971__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__52971__$1);
}
})();
var G__52972 = m;
var G__52972__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__52972,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__52968_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__52968_SHARP_)));
})):G__52972);
var G__52972__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__52972__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__52969_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__52969_SHARP_)));
})):G__52972__$1);
var G__52972__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__52972__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__52970_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__52970_SHARP_));
})):G__52972__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__52972__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__52973 = (function (){var G__52974 = form;
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52973__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52973__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52973__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52973__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__52975 = (function (){var and__5023__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__52979 = form;
var G__52979__$1 = (((G__52979 == null))?null:cljs.core.seq(G__52979));
var G__52979__$2 = (((G__52979__$1 == null))?null:cljs.core.first(G__52979__$1));
if((G__52979__$2 == null)){
return null;
} else {
var fexpr__52980 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__52980.cljs$core$IFn$_invoke$arity$1 ? fexpr__52980.cljs$core$IFn$_invoke$arity$1(G__52979__$2) : fexpr__52980.call(null,G__52979__$2));
}
})():null));
});
/**
...
var len__5749__auto___52999 = arguments.length;
var i__5750__auto___53000 = (0);
while(true){
if((i__5750__auto___53000 < len__5749__auto___52999)){
args__5755__auto__.push((arguments[i__5750__auto___53000]));

var G__53001 = (i__5750__auto___53000 + (1));
i__5750__auto___53000 = G__53001;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq52981){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq52981));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__52982){
var vec__52983 = p__52982;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52983,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52983,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__52988){
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__52986_SHARP_){
return cljs.core.map_QMARK_(p1__52986_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__52987_SHARP_){
return cljs.core.contains_QMARK_(p1__52987_SHARP_,x);
});
}),req_keys));
