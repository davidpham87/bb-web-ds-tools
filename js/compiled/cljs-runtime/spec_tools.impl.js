...
var vec__53025 = cljs.core.rest(expr);
...
var vec__53028 = first__53027;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53028,(0),null);
var form = seq__53026__$1;
...
var G__53031 = x;
var G__53031__$1 = (((G__53031 == null))?null:spec_tools.impl.polish(G__53031));
var G__53031__$2 = (((G__53031__$1 == null))?null:cljs.core.name(G__53031__$1));
if((G__53031__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__53031__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__53032 = x;
var G__53032__$1 = (((G__53032 == null))?null:cljs.core.name(G__53032));
if((G__53032__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__53032__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__53033){
var map__53034 = p__53033;
var map__53034__$1 = cljs.core.__destructure_map(map__53034);
var data = map__53034__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53034__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53034__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53034__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53034__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__53035){
var map__53036 = p__53035;
var map__53036__$1 = cljs.core.__destructure_map(map__53036);
var data = map__53036__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53036__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53036__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__53037 = data;
var G__53037__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__53037,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__53037);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__53037__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__53037__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__53041 = form;
var G__53041__$1 = (((G__53041 == null))?null:cljs.core.rest(G__53041));
if((G__53041__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__53041__$1);
}
})();
var G__53043 = m;
var G__53043__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__53043,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__53038_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__53038_SHARP_)));
})):G__53043);
var G__53043__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__53043__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__53039_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__53039_SHARP_)));
})):G__53043__$1);
var G__53043__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__53043__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__53040_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__53040_SHARP_));
})):G__53043__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__53043__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__53045 = (function (){var G__53046 = form;
var G__53046__$1 = (((G__53046 == null))?null:cljs.core.rest(G__53046));
if((G__53046__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__53046__$1);
}
})();
var map__53045__$1 = cljs.core.__destructure_map(map__53045);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53045__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53045__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53045__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53045__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__53051 = (function (){var and__5023__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__53052 = form;
var G__53052__$1 = (((G__53052 == null))?null:cljs.core.seq(G__53052));
var G__53052__$2 = (((G__53052__$1 == null))?null:cljs.core.first(G__53052__$1));
if((G__53052__$2 == null)){
return null;
} else {
var fexpr__53053 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__53053.cljs$core$IFn$_invoke$arity$1 ? fexpr__53053.cljs$core$IFn$_invoke$arity$1(G__53052__$2) : fexpr__53053.call(null,G__53052__$2));
}
})():null));
});
/**
...
var len__5749__auto___53072 = arguments.length;
var i__5750__auto___53073 = (0);
while(true){
if((i__5750__auto___53073 < len__5749__auto___53072)){
args__5755__auto__.push((arguments[i__5750__auto___53073]));

var G__53074 = (i__5750__auto___53073 + (1));
i__5750__auto___53073 = G__53074;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq53056){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq53056));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__53057){
var vec__53058 = p__53057;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53058,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53058,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__53063){
var map__53064 = p__53063;
var map__53064__$1 = cljs.core.__destructure_map(map__53064);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53064__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53064__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53064__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53064__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__53061_SHARP_){
return cljs.core.map_QMARK_(p1__53061_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__53062_SHARP_){
return cljs.core.contains_QMARK_(p1__53062_SHARP_,x);
});
}),req_keys));
