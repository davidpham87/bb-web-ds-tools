...
var clojure$test$check$results$Result$pass_QMARK_$dyn_44356 = (function (result){
...
return clojure$test$check$results$Result$pass_QMARK_$dyn_44356(result);
}
});

var clojure$test$check$results$Result$result_data$dyn_44357 = (function (result){
var x__5373__auto__ = (((result == null))?null:result);
...
return clojure$test$check$results$Result$result_data$dyn_44357(result);
}
});
