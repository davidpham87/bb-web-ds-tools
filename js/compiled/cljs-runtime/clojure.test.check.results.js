...
var clojure$test$check$results$Result$pass_QMARK_$dyn_44498 = (function (result){
...
return clojure$test$check$results$Result$pass_QMARK_$dyn_44498(result);
}
});

var clojure$test$check$results$Result$result_data$dyn_44499 = (function (result){
var x__5373__auto__ = (((result == null))?null:result);
...
return clojure$test$check$results$Result$result_data$dyn_44499(result);
}
});
