...
var malli$json_schema$JsonSchema$_accept$dyn_46140 = (function (this$,children,options){
...
return malli$json_schema$JsonSchema$_accept$dyn_46140(this$,children,options);
}
});
...
malli.json_schema._ref = (function malli$json_schema$_ref(schema,p__45974){
...
var definitions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45975__$1,new cljs.core.Keyword("malli.json-schema","definitions","malli.json-schema/definitions",1666750607));
var definitions_path = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__45975__$1,new cljs.core.Keyword("malli.json-schema","definitions-path","malli.json-schema/definitions-path",10213173),"#/definitions/");
var ref = (function (){var $ = malli.core._ref(schema);
if(cljs.core.var_QMARK_($)){
var map__45976 = cljs.core.meta($);
var map__45976__$1 = cljs.core.__destructure_map(map__45976);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45976__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45976__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var child_46141 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(definitions,cljs.core.assoc,ref,(transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(child_46141,options) : transform.call(null,child_46141,options)));
}
...
malli.json_schema._schema = (function malli$json_schema$_schema(schema,p__45977){
var map__45978 = p__45977;
var map__45978__$1 = cljs.core.__destructure_map(map__45978);
var options = map__45978__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45978__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
if(cljs.core.truth_(malli.core._ref(schema))){
return malli.json_schema._ref(schema,options);
} else {
var G__45979 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__45980 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__45979,G__45980) : transform.call(null,G__45979,G__45980));
}
});
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.json-schema","default","malli.json-schema/default",-421449099)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__45982 = cljs.core.get_global_hierarchy;
return (fexpr__45982.cljs$core$IFn$_invoke$arity$0 ? fexpr__45982.cljs$core$IFn$_invoke$arity$0() : fexpr__45982.call(null));
})());
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">",">",-555517146),(function (_,___$1,p__46024,___$2){
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">=",">=",-623615505),(function (_,___$1,p__46029,___$2){
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<","<",-646864291),(function (_,___$1,p__46034,___$2){
var vec__46035 = p__46034;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46035,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<=","<=",-395636158),(function (_,___$1,p__46038,___$2){
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"=","=",1152933628),(function (_,___$1,p__46044,___$2){
var vec__46045 = p__46044;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46045,(0),null);
...
var default$ = (function (){var G__46056 = children;
var G__46056__$1 = (((G__46056 == null))?null:cljs.core.remove.cljs$core$IFn$_invoke$arity$2(malli.core._comp.cljs$core$IFn$_invoke$arity$2(ks,cljs.core.first),G__46056));
var G__46056__$2 = (((G__46056__$1 == null))?null:cljs.core.first(G__46056__$1));
if((G__46056__$2 == null)){
return null;
} else {
return cljs.core.last(G__46056__$2);
}
})();
var map__46055 = default$;
var map__46055__$1 = cljs.core.__destructure_map(map__46055);
var additionalProperties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46055__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392));
var properties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46055__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46055__$1,new cljs.core.Keyword(null,"required","required",1807647006));
...
var G__46070 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([default$,object], 0));
var G__46070__$1 = ((cljs.core.seq(required))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46070,new cljs.core.Keyword(null,"required","required",1807647006),required):G__46070);
var G__46070__$2 = (cljs.core.truth_(closed)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46070__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),false):G__46070__$1);
if(cljs.core.truth_(default$)){
var G__46072 = G__46070__$2;
var G__46072__$1 = (cljs.core.truth_(additionalProperties_SINGLEQUOTE_)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46072,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),additionalProperties_SINGLEQUOTE_):G__46072);
var G__46072__$2 = (cljs.core.truth_(properties_SINGLEQUOTE_)?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__46072__$1,new cljs.core.Keyword(null,"properties","properties",685819552),cljs.core.merge,properties_SINGLEQUOTE_):G__46072__$1);
if(cljs.core.truth_(required_SINGLEQUOTE_)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__46072__$2,new cljs.core.Keyword(null,"required","required",1807647006),cljs.core.comp.cljs$core$IFn$_invoke$arity$3(cljs.core.vec,cljs.core.distinct,cljs.core.into),required_SINGLEQUOTE_);
} else {
return G__46072__$2;
}
} else {
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var G__46092 = malli.core._infer(children);
if((G__46092 == null)){
return null;
} else {
return (malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2 ? malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2(G__46092,options) : malli.json_schema._transform.call(null,G__46092,options));
}
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"merge","merge",-1804319409),(function (_,schema,___$1,p__46116){
var map__46117 = p__46116;
var map__46117__$1 = cljs.core.__destructure_map(map__46117);
var options = map__46117__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46117__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__46118 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__46119 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__46118,G__46119) : transform.call(null,G__46118,G__46119));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"union","union",2142937499),(function (_,schema,___$1,p__46120){
var map__46121 = p__46120;
var map__46121__$1 = cljs.core.__destructure_map(map__46121);
var options = map__46121__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46121__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__46123 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__46124 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__46123,G__46124) : transform.call(null,G__46123,G__46124));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"select-keys","select-keys",1945879180),(function (_,schema,___$1,p__46126){
var map__46127 = p__46126;
var map__46127__$1 = cljs.core.__destructure_map(map__46127);
var options = map__46127__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46127__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__46128 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__46129 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__46128,G__46129) : transform.call(null,G__46128,G__46129));
}));
...
var G__46135 = malli.json_schema._transform(_QMARK_schema,options__$1);
if(cljs.core.seq(cljs.core.deref(definitions))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46135,new cljs.core.Keyword(null,"definitions","definitions",167529986),cljs.core.deref(definitions));
} else {
return G__46135;
}
}));
