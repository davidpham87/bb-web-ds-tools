...
var malli$json_schema$JsonSchema$_accept$dyn_46107 = (function (this$,children,options){
...
return malli$json_schema$JsonSchema$_accept$dyn_46107(this$,children,options);
}
});
...
malli.json_schema._ref = (function malli$json_schema$_ref(schema,p__45991){
var map__45992 = p__45991;
var map__45992__$1 = cljs.core.__destructure_map(map__45992);
var options = map__45992__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45992__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var definitions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45992__$1,new cljs.core.Keyword("malli.json-schema","definitions","malli.json-schema/definitions",1666750607));
var definitions_path = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__45992__$1,new cljs.core.Keyword("malli.json-schema","definitions-path","malli.json-schema/definitions-path",10213173),"#/definitions/");
var ref = (function (){var $ = malli.core._ref(schema);
if(cljs.core.var_QMARK_($)){
var map__45993 = cljs.core.meta($);
var map__45993__$1 = cljs.core.__destructure_map(map__45993);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45993__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45993__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var child_46108 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(definitions,cljs.core.assoc,ref,(transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(child_46108,options) : transform.call(null,child_46108,options)));
}
...
malli.json_schema._schema = (function malli$json_schema$_schema(schema,p__45994){
var map__45995 = p__45994;
var map__45995__$1 = cljs.core.__destructure_map(map__45995);
var options = map__45995__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45995__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
if(cljs.core.truth_(malli.core._ref(schema))){
return malli.json_schema._ref(schema,options);
} else {
var G__45996 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__45997 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__45996,G__45997) : transform.call(null,G__45996,G__45997));
}
});
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.json-schema","default","malli.json-schema/default",-421449099)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__45998 = cljs.core.get_global_hierarchy;
return (fexpr__45998.cljs$core$IFn$_invoke$arity$0 ? fexpr__45998.cljs$core$IFn$_invoke$arity$0() : fexpr__45998.call(null));
})());
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">",">",-555517146),(function (_,___$1,p__46023,___$2){
var vec__46026 = p__46023;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46026,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">=",">=",-623615505),(function (_,___$1,p__46031,___$2){
var vec__46032 = p__46031;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46032,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<","<",-646864291),(function (_,___$1,p__46036,___$2){
var vec__46037 = p__46036;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46037,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<=","<=",-395636158),(function (_,___$1,p__46040,___$2){
var vec__46041 = p__46040;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46041,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"=","=",1152933628),(function (_,___$1,p__46045,___$2){
var vec__46046 = p__46045;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46046,(0),null);
...
var default$ = (function (){var G__46053 = children;
var G__46053__$1 = (((G__46053 == null))?null:cljs.core.remove.cljs$core$IFn$_invoke$arity$2(malli.core._comp.cljs$core$IFn$_invoke$arity$2(ks,cljs.core.first),G__46053));
var G__46053__$2 = (((G__46053__$1 == null))?null:cljs.core.first(G__46053__$1));
if((G__46053__$2 == null)){
return null;
} else {
return cljs.core.last(G__46053__$2);
}
})();
var map__46052 = default$;
var map__46052__$1 = cljs.core.__destructure_map(map__46052);
var additionalProperties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46052__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392));
var properties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46052__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46052__$1,new cljs.core.Keyword(null,"required","required",1807647006));
...
var G__46061 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([default$,object], 0));
var G__46061__$1 = ((cljs.core.seq(required))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46061,new cljs.core.Keyword(null,"required","required",1807647006),required):G__46061);
var G__46061__$2 = (cljs.core.truth_(closed)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46061__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),false):G__46061__$1);
if(cljs.core.truth_(default$)){
var G__46063 = G__46061__$2;
var G__46063__$1 = (cljs.core.truth_(additionalProperties_SINGLEQUOTE_)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46063,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),additionalProperties_SINGLEQUOTE_):G__46063);
var G__46063__$2 = (cljs.core.truth_(properties_SINGLEQUOTE_)?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__46063__$1,new cljs.core.Keyword(null,"properties","properties",685819552),cljs.core.merge,properties_SINGLEQUOTE_):G__46063__$1);
if(cljs.core.truth_(required_SINGLEQUOTE_)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__46063__$2,new cljs.core.Keyword(null,"required","required",1807647006),cljs.core.comp.cljs$core$IFn$_invoke$arity$3(cljs.core.vec,cljs.core.distinct,cljs.core.into),required_SINGLEQUOTE_);
} else {
return G__46063__$2;
}
} else {
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var G__46072 = malli.core._infer(children);
if((G__46072 == null)){
return null;
} else {
return (malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2 ? malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2(G__46072,options) : malli.json_schema._transform.call(null,G__46072,options));
}
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"merge","merge",-1804319409),(function (_,schema,___$1,p__46081){
var map__46082 = p__46081;
var map__46082__$1 = cljs.core.__destructure_map(map__46082);
var options = map__46082__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46082__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__46083 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__46084 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__46083,G__46084) : transform.call(null,G__46083,G__46084));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"union","union",2142937499),(function (_,schema,___$1,p__46085){
var map__46086 = p__46085;
var map__46086__$1 = cljs.core.__destructure_map(map__46086);
var options = map__46086__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46086__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__46087 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__46088 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__46087,G__46088) : transform.call(null,G__46087,G__46088));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"select-keys","select-keys",1945879180),(function (_,schema,___$1,p__46089){
var map__46090 = p__46089;
var map__46090__$1 = cljs.core.__destructure_map(map__46090);
var options = map__46090__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46090__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__46091 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__46092 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__46091,G__46092) : transform.call(null,G__46091,G__46092));
}));
...
var G__46105 = malli.json_schema._transform(_QMARK_schema,options__$1);
if(cljs.core.seq(cljs.core.deref(definitions))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46105,new cljs.core.Keyword(null,"definitions","definitions",167529986),cljs.core.deref(definitions));
} else {
return G__46105;
}
}));
