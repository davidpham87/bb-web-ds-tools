...
var malli$json_schema$JsonSchema$_accept$dyn_46108 = (function (this$,children,options){
...
return malli$json_schema$JsonSchema$_accept$dyn_46108(this$,children,options);
}
});
...
malli.json_schema._ref = (function malli$json_schema$_ref(schema,p__46005){
var map__46006 = p__46005;
var map__46006__$1 = cljs.core.__destructure_map(map__46006);
var options = map__46006__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46006__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var definitions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46006__$1,new cljs.core.Keyword("malli.json-schema","definitions","malli.json-schema/definitions",1666750607));
var definitions_path = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__46006__$1,new cljs.core.Keyword("malli.json-schema","definitions-path","malli.json-schema/definitions-path",10213173),"#/definitions/");
var ref = (function (){var $ = malli.core._ref(schema);
if(cljs.core.var_QMARK_($)){
var map__46008 = cljs.core.meta($);
var map__46008__$1 = cljs.core.__destructure_map(map__46008);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46008__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46008__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var child_46109 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(definitions,cljs.core.assoc,ref,(transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(child_46109,options) : transform.call(null,child_46109,options)));
}
...
malli.json_schema._schema = (function malli$json_schema$_schema(schema,p__46012){
var map__46013 = p__46012;
var map__46013__$1 = cljs.core.__destructure_map(map__46013);
var options = map__46013__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46013__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
if(cljs.core.truth_(malli.core._ref(schema))){
return malli.json_schema._ref(schema,options);
} else {
var G__46014 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__46015 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__46014,G__46015) : transform.call(null,G__46014,G__46015));
}
});
...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.json-schema","default","malli.json-schema/default",-421449099)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__46021 = cljs.core.get_global_hierarchy;
return (fexpr__46021.cljs$core$IFn$_invoke$arity$0 ? fexpr__46021.cljs$core$IFn$_invoke$arity$0() : fexpr__46021.call(null));
})());
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">",">",-555517146),(function (_,___$1,p__46044,___$2){
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,">=",">=",-623615505),(function (_,___$1,p__46048,___$2){
var vec__46049 = p__46048;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46049,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<","<",-646864291),(function (_,___$1,p__46053,___$2){
var vec__46054 = p__46053;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46054,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"<=","<=",-395636158),(function (_,___$1,p__46057,___$2){
var vec__46058 = p__46057;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46058,(0),null);
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"=","=",1152933628),(function (_,___$1,p__46061,___$2){
var vec__46062 = p__46061;
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46062,(0),null);
...
var default$ = (function (){var G__46067 = children;
var G__46067__$1 = (((G__46067 == null))?null:cljs.core.remove.cljs$core$IFn$_invoke$arity$2(malli.core._comp.cljs$core$IFn$_invoke$arity$2(ks,cljs.core.first),G__46067));
var G__46067__$2 = (((G__46067__$1 == null))?null:cljs.core.first(G__46067__$1));
if((G__46067__$2 == null)){
return null;
} else {
return cljs.core.last(G__46067__$2);
}
})();
var map__46066 = default$;
var map__46066__$1 = cljs.core.__destructure_map(map__46066);
var additionalProperties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46066__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392));
var properties_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46066__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46066__$1,new cljs.core.Keyword(null,"required","required",1807647006));
...
var G__46075 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([default$,object], 0));
var G__46075__$1 = ((cljs.core.seq(required))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46075,new cljs.core.Keyword(null,"required","required",1807647006),required):G__46075);
var G__46075__$2 = (cljs.core.truth_(closed)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46075__$1,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),false):G__46075__$1);
if(cljs.core.truth_(default$)){
var G__46077 = G__46075__$2;
var G__46077__$1 = (cljs.core.truth_(additionalProperties_SINGLEQUOTE_)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46077,new cljs.core.Keyword(null,"additionalProperties","additionalProperties",-1203767392),additionalProperties_SINGLEQUOTE_):G__46077);
var G__46077__$2 = (cljs.core.truth_(properties_SINGLEQUOTE_)?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__46077__$1,new cljs.core.Keyword(null,"properties","properties",685819552),cljs.core.merge,properties_SINGLEQUOTE_):G__46077__$1);
if(cljs.core.truth_(required_SINGLEQUOTE_)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__46077__$2,new cljs.core.Keyword(null,"required","required",1807647006),cljs.core.comp.cljs$core$IFn$_invoke$arity$3(cljs.core.vec,cljs.core.distinct,cljs.core.into),required_SINGLEQUOTE_);
} else {
return G__46077__$2;
}
} else {
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var G__46082 = malli.core._infer(children);
if((G__46082 == null)){
return null;
} else {
return (malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2 ? malli.json_schema._transform.cljs$core$IFn$_invoke$arity$2(G__46082,options) : malli.json_schema._transform.call(null,G__46082,options));
}
...
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"merge","merge",-1804319409),(function (_,schema,___$1,p__46091){
var map__46092 = p__46091;
var map__46092__$1 = cljs.core.__destructure_map(map__46092);
var options = map__46092__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46092__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__46093 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__46094 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__46093,G__46094) : transform.call(null,G__46093,G__46094));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"union","union",2142937499),(function (_,schema,___$1,p__46095){
var map__46096 = p__46095;
var map__46096__$1 = cljs.core.__destructure_map(map__46096);
var options = map__46096__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46096__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__46097 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__46098 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__46097,G__46098) : transform.call(null,G__46097,G__46098));
}));
malli.json_schema.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"select-keys","select-keys",1945879180),(function (_,schema,___$1,p__46099){
var map__46100 = p__46099;
var map__46100__$1 = cljs.core.__destructure_map(map__46100);
var options = map__46100__$1;
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46100__$1,new cljs.core.Keyword("malli.json-schema","transform","malli.json-schema/transform",-1255228521));
var G__46101 = malli.core.deref.cljs$core$IFn$_invoke$arity$1(schema);
var G__46102 = options;
return (transform.cljs$core$IFn$_invoke$arity$2 ? transform.cljs$core$IFn$_invoke$arity$2(G__46101,G__46102) : transform.call(null,G__46101,G__46102));
}));
...
var G__46107 = malli.json_schema._transform(_QMARK_schema,options__$1);
if(cljs.core.seq(cljs.core.deref(definitions))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__46107,new cljs.core.Keyword(null,"definitions","definitions",167529986),cljs.core.deref(definitions));
} else {
return G__46107;
}
}));
