...
spec_tools.swagger.core.accept_spec = (function (){var method_table__5622__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var prefer_table__5623__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var method_cache__5624__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5625__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.swagger.core","default","spec-tools.swagger.core/default",1361779456)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__54465 = cljs.core.get_global_hierarchy;
return (fexpr__54465.cljs$core$IFn$_invoke$arity$0 ? fexpr__54465.cljs$core$IFn$_invoke$arity$0() : fexpr__54465.call(null));
})());
return (new cljs.core.MultiFn(cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("spec-tools.swagger.core","accept-spec"),spec_tools.swagger.core.spec_dispatch,new cljs.core.Keyword("spec-tools.swagger.core","default","spec-tools.swagger.core/default",1361779456),hierarchy__5626__auto__,method_table__5622__auto__,prefer_table__5623__auto__,method_cache__5624__auto__,cached_hierarchy__5625__auto__));
})();
}
...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__54484){
var map__54485 = p__54484;
var map__54485__$1 = cljs.core.__destructure_map(map__54485);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54485__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54485__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__54493 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54493,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54493,(1),null);
var swagger_meta = spec_tools.impl.unlift_keys(data,"swagger");
var or__5025__auto__ = new cljs.core.Keyword(null,"swagger","swagger",-79684232).cljs$core$IFn$_invoke$arity$1(data);
...
spec_tools.swagger.core.extract_parameter = (function (){var method_table__5622__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var prefer_table__5623__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var method_cache__5624__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5625__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__54549 = cljs.core.get_global_hierarchy;
return (fexpr__54549.cljs$core$IFn$_invoke$arity$0 ? fexpr__54549.cljs$core$IFn$_invoke$arity$0() : fexpr__54549.call(null));
})());
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"in","in",-1531184865),"body",new cljs.core.Keyword(null,"name","name",1843675177),(function (){var or__5025__auto__ = spec_tools.impl.qualified_name(spec_tools.core.spec_name(spec));
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return "body";
}
})(),new cljs.core.Keyword(null,"description","description",-1428560544),(function (){var or__5025__auto__ = spec_tools.core.spec_description(spec);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return "";
...
var map__54550 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
var map__54550__$1 = cljs.core.__destructure_map(map__54550);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54550__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54550__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__54551){
var vec__54552 = p__54551;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54552,(0),null);
var map__54555 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54552,(1),null);
var map__54555__$1 = cljs.core.__destructure_map(map__54555);
var schema = map__54555__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54555__$1,new cljs.core.Keyword(null,"type","type",1174270348));
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"in","in",-1531184865),cljs.core.name(in$),new cljs.core.Keyword(null,"name","name",1843675177),k,new cljs.core.Keyword(null,"description","description",-1428560544),(function (){var or__5025__auto__ = spec_tools.core.spec_description(spec);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return "";
...
spec_tools.swagger.core.expand = (function (){var method_table__5622__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var prefer_table__5623__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var method_cache__5624__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5625__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__54560 = cljs.core.get_global_hierarchy;
return (fexpr__54560.cljs$core$IFn$_invoke$arity$0 ? fexpr__54560.cljs$core$IFn$_invoke$arity$0() : fexpr__54560.call(null));
})());
...
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"responses","responses",1257546453),cljs.core.into.cljs$core$IFn$_invoke$arity$2((function (){var or__5025__auto__ = new cljs.core.Keyword(null,"responses","responses",1257546453).cljs$core$IFn$_invoke$arity$1(acc);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return cljs.core.PersistentArrayMap.EMPTY;
}
})(),(function (){var iter__5503__auto__ = (function spec_tools$swagger$core$iter__54567(s__54568){
return (new cljs.core.LazySeq(null,(function (){
var s__54568__$1 = s__54568;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__54568__$1);
if(temp__5825__auto__){
var s__54568__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__54568__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__54568__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__54570 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__54569 = (0);
while(true){
if((i__54569 < size__5502__auto__)){
var vec__54571 = cljs.core._nth(c__5501__auto__,i__54569);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54571,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54571,(1),null);
cljs.core.chunk_append(b__54570,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__54570),spec_tools$swagger$core$iter__54567(cljs.core.chunk_rest(s__54568__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__54570),null);
}
} else {
var vec__54574 = cljs.core.first(s__54568__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54574,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54574,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__54567(cljs.core.rest(s__54568__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__54579){
var vec__54580 = p__54579;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54580,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54580,(1),null);
return spec_tools.swagger.core.extract_parameter.cljs$core$IFn$_invoke$arity$2(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__54583,p){
var vec__54584 = p__54583;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54584,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54584,(1),null);
var acc__$1 = vec__54584;
