...
var G__54870__delegate = function (args){
...
while (G__54871__i < G__54871__a.length) {G__54871__a[G__54871__i] = arguments[G__54871__i + 0]; ++G__54871__i;}
  args = new cljs.core.IndexedSeq(G__54871__a,0,null);
} 
return G__54870__delegate.call(this,args);};
G__54870.cljs$lang$maxFixedArity = 0;
G__54870.cljs$lang$applyTo = (function (arglist__54872){
var args = cljs.core.seq(arglist__54872);
return G__54870__delegate(args);
});
...
var G__54873 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(acc,form);
acc = G__54873;
continue;
} else {
var res = (function (){try{return sci.core.eval_form(bb_web_ds_tools.workers.sci.sci_ctx,form);
}catch (e54865){var e = e54865;
...
var G__54874 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(acc,res);
acc = G__54874;
continue;
}
}
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54867__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54867__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var G__54869 = type;
switch (G__54869) {
case "eval":
