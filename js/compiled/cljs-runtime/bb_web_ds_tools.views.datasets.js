...
var len__5749__auto___28589 = arguments.length;
var i__5750__auto___28590 = (0);
while(true){
if((i__5750__auto___28590 < len__5749__auto___28589)){
args__5755__auto__.push((arguments[i__5750__auto___28590]));

var G__28591 = (i__5750__auto___28590 + (1));
i__5750__auto___28590 = G__28591;
continue;
} else {
}
break;
...
/** @this {Function} */
(bb_web_ds_tools.views.datasets.deep_merge.cljs$lang$applyTo = (function (seq28419){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq28419));
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"datasets","datasets",1896364419)], null),(function (p1__28436_SHARP_){
return bb_web_ds_tools.views.datasets.deep_merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__28436_SHARP_,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"items","items",1031954938),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"new-dataset-state","new-dataset-state",1109324301),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"name","name",1843675177),"New Dataset",new cljs.core.Keyword(null,"text","text",-1790561697),"",new cljs.core.Keyword(null,"format","format",-1306924766),new cljs.core.Keyword(null,"csv","csv",-1164440893),new cljs.core.Keyword(null,"structure","structure",1563832083),new cljs.core.Keyword(null,"columnar","columnar",-1122999701)], null)], null)], 0));
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","active-dataset","bb-web-ds-tools.views.datasets/active-dataset",366618334),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","items","bb-web-ds-tools.views.datasets/items",-2099094664)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","active-dataset-id","bb-web-ds-tools.views.datasets/active-dataset-id",-1144874757)], null),(function (p__28440){
var vec__28441 = p__28440;
var items = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28441,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28441,(1),null);
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(items,id);
})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","set-active-dataset-id","bb-web-ds-tools.views.datasets/set-active-dataset-id",1361188762),(function (db,p__28444){
var vec__28445 = p__28444;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28445,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28445,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-new-dataset-state","bb-web-ds-tools.views.datasets/update-new-dataset-state",-1930125405),(function (db,p__28452){
var vec__28453 = p__28452;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28453,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28453,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28453,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","add-dataset","bb-web-ds-tools.views.datasets/add-dataset",1462625692),(function (db,p__28457){
var vec__28458 = p__28457;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28458,(0),null);
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28461__$1,new cljs.core.Keyword(null,"data","data",-232669377));
...
var data_with_ids = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__28456_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__28456_SHARP_,new cljs.core.Keyword(null,"_uuid","_uuid",797900280),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.random_uuid()));
}),valid_data);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","delete-dataset","bb-web-ds-tools.views.datasets/delete-dataset",243110744),(function (db,p__28466){
var vec__28467 = p__28466;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28467,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28467,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-dataset-name","bb-web-ds-tools.views.datasets/update-dataset-name",798576715),(function (db,p__28470){
var vec__28471 = p__28470;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28471,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28471,(1),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28471,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),(function (db,p__28474){
var vec__28475 = p__28474;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28475,(0),null);
var dataset_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28475,(1),null);
var row_uuid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28475,(2),null);
var col_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28475,(3),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28475,(4),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),(function (db,p__28481){
var vec__28482 = p__28481;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28482,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28482,(1),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28482,(2),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28482,(3),null);
...
});})(i__28487,col,c__5501__auto__,size__5502__auto__,b__28488,s__28486__$2,temp__5825__auto__))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28488),bb_web_ds_tools$views$datasets$column_toggle_dropdown_$_iter__28485(cljs.core.chunk_rest(s__28486__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28488),null);
}
} else {
var col = cljs.core.first(s__28486__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["flex items-center space-x-2 p-1 ",bb_web_ds_tools.theme.bg_item_hover].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"checkbox",new cljs.core.Keyword(null,"class","class",-2030961996),"w-auto",new cljs.core.Keyword(null,"checked","checked",-50955819),(!(cljs.core.contains_QMARK_(hidden_columns,col))),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__28486__$2,temp__5825__auto__){
return (function (){
if(cljs.core.contains_QMARK_(hidden_columns,col)){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"hidden-columns","hidden-columns",-1045524800),cljs.core.disj.cljs$core$IFn$_invoke$arity$2(hidden_columns,col)], null));
} else {
...
return (function (){
var map__28493 = cljs.core.deref(state);
var map__28493__$1 = cljs.core.__destructure_map(map__28493);
var name_val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28493__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28493__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28493__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var structure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28493__$1,new cljs.core.Keyword(null,"structure","structure",1563832083));
...
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_col,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"h-full space-y-4 p-4"], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"justify-between items-center"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3","h3",2067611163),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),["text-xl font-bold ",bb_web_ds_tools.theme.text_accent].join('')], null),"Create New Dataset"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"space-x-2"], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$importer_view_$_iter__28494(s__28495){
return (new cljs.core.LazySeq(null,(function (){
var s__28495__$1 = s__28495;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__28495__$1);
if(temp__5825__auto__){
var s__28495__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__28495__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__28495__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__28497 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__28496 = (0);
while(true){
if((i__28496 < size__5502__auto__)){
var fmt = cljs.core._nth(c__5501__auto__,i__28496);
cljs.core.chunk_append(b__28497,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),fmt,new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(format,fmt))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):""),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__28496,fmt,c__5501__auto__,size__5502__auto__,b__28497,s__28495__$2,temp__5825__auto__,map__28493,map__28493__$1,name_val,text,format,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state){
return (function (){
set_state(new cljs.core.Keyword(null,"format","format",-1306924766),fmt);

if(cljs.core.truth_((function (){var fexpr__28499 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"markdown","markdown",1227225089),null,new cljs.core.Keyword(null,"csv","csv",-1164440893),null,new cljs.core.Keyword(null,"tsv","tsv",-1254214356),null], null), null);
return (fexpr__28499.cljs$core$IFn$_invoke$arity$1 ? fexpr__28499.cljs$core$IFn$_invoke$arity$1(fmt) : fexpr__28499.call(null,fmt));
})())){
...
});})(i__28496,fmt,c__5501__auto__,size__5502__auto__,b__28497,s__28495__$2,temp__5825__auto__,map__28493,map__28493__$1,name_val,text,format,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28497),bb_web_ds_tools$views$datasets$importer_view_$_iter__28494(cljs.core.chunk_rest(s__28495__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28497),null);
}
} else {
var fmt = cljs.core.first(s__28495__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),fmt,new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(format,fmt))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):""),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (fmt,s__28495__$2,temp__5825__auto__,map__28493,map__28493__$1,name_val,text,format,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state){
return (function (){
set_state(new cljs.core.Keyword(null,"format","format",-1306924766),fmt);

if(cljs.core.truth_((function (){var fexpr__28500 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"markdown","markdown",1227225089),null,new cljs.core.Keyword(null,"csv","csv",-1164440893),null,new cljs.core.Keyword(null,"tsv","tsv",-1254214356),null], null), null);
return (fexpr__28500.cljs$core$IFn$_invoke$arity$1 ? fexpr__28500.cljs$core$IFn$_invoke$arity$1(fmt) : fexpr__28500.call(null,fmt));
})())){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),new cljs.core.Keyword(null,"columnar","columnar",-1122999701));
} else {
return null;
}
});})(fmt,s__28495__$2,temp__5825__auto__,map__28493,map__28493__$1,name_val,text,format,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state))
], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(fmt,new cljs.core.Keyword(null,"markdown","markdown",1227225089)))?"MD":clojure.string.upper_case(cljs.core.name(fmt)))], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__28494(cljs.core.rest(s__28495__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28506),bb_web_ds_tools$views$datasets$importer_view_$_iter__28503(cljs.core.chunk_rest(s__28504__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28506),null);
}
} else {
var s = cljs.core.first(s__28504__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"key","key",-1516042587),s,new cljs.core.Keyword(null,"disabled","disabled",-1529784218),(!(cljs.core.contains_QMARK_(supported_structures,s))),new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(structure__$1,s))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):(((!(cljs.core.contains_QMARK_(supported_structures,s))))?"opacity-50 cursor-not-allowed":"")),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (s,s__28504__$2,temp__5825__auto__,map__28493,map__28493__$1,name_val,text,format,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state){
return (function (){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),s);
});})(s,s__28504__$2,temp__5825__auto__,map__28493,map__28493__$1,name_val,text,format,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state))
], null),cljs.core.get.cljs$core$IFn$_invoke$arity$2(struct_labels,s)], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__28503(cljs.core.rest(s__28504__$2)));
}
} else {
return null;
}
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28513__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28513__$1,new cljs.core.Keyword(null,"columns","columns",1998437288));
var view_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28513__$1,new cljs.core.Keyword(null,"view-state","view-state",-976675614));
var map__28514 = view_state;
var map__28514__$1 = cljs.core.__destructure_map(map__28514);
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28514__$1,new cljs.core.Keyword(null,"page","page",849072397));
var rows_per_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28514__$1,new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959));
var filters = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28514__$1,new cljs.core.Keyword(null,"filters","filters",974726919));
var hidden_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28514__$1,new cljs.core.Keyword(null,"hidden-columns","hidden-columns",-1045524800));
var sort_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28514__$1,new cljs.core.Keyword(null,"sort-col","sort-col",-718754882));
var sort_dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28514__$1,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757));
var map__28515 = bb_web_ds_tools.utils.dataset_processing.process_table_data(data,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(view_state,new cljs.core.Keyword(null,"columns","columns",1998437288),columns));
var map__28515__$1 = cljs.core.__destructure_map(map__28515);
var page_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28515__$1,new cljs.core.Keyword(null,"page-data","page-data",1443840710));
var total_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28515__$1,new cljs.core.Keyword(null,"total-rows","total-rows",1745495528));
var start_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28515__$1,new cljs.core.Keyword(null,"start-idx","start-idx",-1600773745));
var end_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28515__$1,new cljs.core.Keyword(null,"end-idx","end-idx",-85750788));
var visible_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28515__$1,new cljs.core.Keyword(null,"visible-columns","visible-columns",1134718660));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_col,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"space-y-4 p-4"], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),["flex-wrap gap-4 items-end ",bb_web_ds_tools.theme.bg_toolbar," p-2 rounded shadow-sm"].join('')], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.label,"Rows"], null),new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.select,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),"py-1",new cljs.core.Keyword(null,"value","value",305978217),rows_per_page,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__28510_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959),parseInt(p1__28510_SHARP_.target.value)], null));
...
var col = cljs.core._nth(c__5501__auto__,i__28520);
cljs.core.chunk_append(b__28521,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.th,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["cursor-pointer ",bb_web_ds_tools.theme.bg_item_hover].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__28520,col,c__5501__auto__,size__5502__auto__,b__28521,s__28519__$2,temp__5825__auto__,map__28513,map__28513__$1,id,data,columns,view_state,map__28514,map__28514__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28515,map__28515__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
...
});})(i__28520,col,c__5501__auto__,size__5502__auto__,b__28521,s__28519__$2,temp__5825__auto__,map__28513,map__28513__$1,id,data,columns,view_state,map__28514,map__28514__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28515,map__28515__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28521),bb_web_ds_tools$views$datasets$data_table_$_iter__28518(cljs.core.chunk_rest(s__28519__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28521),null);
}
} else {
var col = cljs.core.first(s__28519__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.th,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["cursor-pointer ",bb_web_ds_tools.theme.bg_item_hover].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (col,s__28519__$2,temp__5825__auto__,map__28513,map__28513__$1,id,data,columns,view_state,map__28514,map__28514__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28515,map__28515__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
var new_dir = ((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_col,col)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))))?new cljs.core.Keyword(null,"desc","desc",2093485764):new cljs.core.Keyword(null,"asc","asc",356854569));
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"sort-col","sort-col",-718754882),col], null));

return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757),new_dir], null));
});})(col,s__28519__$2,temp__5825__auto__,map__28513,map__28513__$1,id,data,columns,view_state,map__28514,map__28514__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28515,map__28515__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex items-center space-x-1"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),cljs.core.name(col)], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_col,col))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-[10px] transform translate-y-px"], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))?"\u25B2":"\u25BC")], null):null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__28518(cljs.core.rest(s__28519__$2)));
}
} else {
return null;
}
...
})()], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tbody,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__28522(s__28523){
return (new cljs.core.LazySeq(null,(function (){
var s__28523__$1 = s__28523;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__28523__$1);
if(temp__5825__auto__){
var s__28523__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__28523__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__28523__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__28525 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__28524 = (0);
while(true){
if((i__28524 < size__5502__auto__)){
var col = cljs.core._nth(c__5501__auto__,i__28524);
cljs.core.chunk_append(b__28525,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),["filter-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(col)].join(''),new cljs.core.Keyword(null,"class","class",-2030961996),"px-3 py-1.5"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-sm",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),["Filter ",cljs.core.name(col)].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(filters,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__28524,col,c__5501__auto__,size__5502__auto__,b__28525,s__28523__$2,temp__5825__auto__,map__28513,map__28513__$1,id,data,columns,view_state,map__28514,map__28514__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28515,map__28515__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__28511_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"filters","filters",974726919),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(filters,col,p1__28511_SHARP_.target.value)], null));
});})(i__28524,col,c__5501__auto__,size__5502__auto__,b__28525,s__28523__$2,temp__5825__auto__,map__28513,map__28513__$1,id,data,columns,view_state,map__28514,map__28514__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28515,map__28515__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__28620 = (i__28524 + (1));
i__28524 = G__28620;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28525),bb_web_ds_tools$views$datasets$data_table_$_iter__28522(cljs.core.chunk_rest(s__28523__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28525),null);
}
} else {
var col = cljs.core.first(s__28523__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),["filter-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(col)].join(''),new cljs.core.Keyword(null,"class","class",-2030961996),"px-3 py-1.5"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-sm",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),["Filter ",cljs.core.name(col)].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(filters,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__28523__$2,temp__5825__auto__,map__28513,map__28513__$1,id,data,columns,view_state,map__28514,map__28514__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28515,map__28515__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__28511_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"filters","filters",974726919),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(filters,col,p1__28511_SHARP_.target.value)], null));
});})(col,s__28523__$2,temp__5825__auto__,map__28513,map__28513__$1,id,data,columns,view_state,map__28514,map__28514__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28515,map__28515__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__28522(cljs.core.rest(s__28523__$2)));
}
} else {
return null;
}
...
return iter__5503__auto__(visible_columns);
})()], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__28528(s__28529){
return (new cljs.core.LazySeq(null,(function (){
var s__28529__$1 = s__28529;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__28529__$1);
if(temp__5825__auto__){
var s__28529__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__28529__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__28529__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__28531 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__28530 = (0);
while(true){
if((i__28530 < size__5502__auto__)){
var row = cljs.core._nth(c__5501__auto__,i__28530);
cljs.core.chunk_append(b__28531,(function (){var row_uuid = new cljs.core.Keyword(null,"_uuid","_uuid",797900280).cljs$core$IFn$_invoke$arity$1(row);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row_uuid], null),(function (){var iter__5503__auto__ = ((function (i__28530,row_uuid,row,c__5501__auto__,size__5502__auto__,b__28531,s__28529__$2,temp__5825__auto__,map__28513,map__28513__$1,id,data,columns,view_state,map__28514,map__28514__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28515,map__28515__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function bb_web_ds_tools$views$datasets$data_table_$_iter__28528_$_iter__28532(s__28533){
return (new cljs.core.LazySeq(null,((function (i__28530,row_uuid,row,c__5501__auto__,size__5502__auto__,b__28531,s__28529__$2,temp__5825__auto__,map__28513,map__28513__$1,id,data,columns,view_state,map__28514,map__28514__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28515,map__28515__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
var s__28533__$1 = s__28533;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__28533__$1);
if(temp__5825__auto____$1){
var s__28533__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__28533__$2)){
var c__5501__auto____$1 = cljs.core.chunk_first(s__28533__$2);
var size__5502__auto____$1 = cljs.core.count(c__5501__auto____$1);
var b__28535 = cljs.core.chunk_buffer(size__5502__auto____$1);
if((function (){var i__28534 = (0);
while(true){
if((i__28534 < size__5502__auto____$1)){
var col = cljs.core._nth(c__5501__auto____$1,i__28534);
cljs.core.chunk_append(b__28535,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__28534,i__28530,col,c__5501__auto____$1,size__5502__auto____$1,b__28535,s__28533__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__28531,s__28529__$2,temp__5825__auto__,map__28513,map__28513__$1,id,data,columns,view_state,map__28514,map__28514__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28515,map__28515__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__28512_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__28512_SHARP_.target.value], null));
});})(i__28534,i__28530,col,c__5501__auto____$1,size__5502__auto____$1,b__28535,s__28533__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__28531,s__28529__$2,temp__5825__auto__,map__28513,map__28513__$1,id,data,columns,view_state,map__28514,map__28514__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28515,map__28515__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28535),bb_web_ds_tools$views$datasets$data_table_$_iter__28528_$_iter__28532(cljs.core.chunk_rest(s__28533__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28535),null);
}
} else {
var col = cljs.core.first(s__28533__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__28530,col,s__28533__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__28531,s__28529__$2,temp__5825__auto__,map__28513,map__28513__$1,id,data,columns,view_state,map__28514,map__28514__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28515,map__28515__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__28512_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__28512_SHARP_.target.value], null));
});})(i__28530,col,s__28533__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__28531,s__28529__$2,temp__5825__auto__,map__28513,map__28513__$1,id,data,columns,view_state,map__28514,map__28514__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28515,map__28515__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__28528_$_iter__28532(cljs.core.rest(s__28533__$2)));
}
} else {
return null;
}
...
});})(i__28530,row_uuid,row,c__5501__auto__,size__5502__auto__,b__28531,s__28529__$2,temp__5825__auto__,map__28513,map__28513__$1,id,data,columns,view_state,map__28514,map__28514__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28515,map__28515__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
,null,null));
});})(i__28530,row_uuid,row,c__5501__auto__,size__5502__auto__,b__28531,s__28529__$2,temp__5825__auto__,map__28513,map__28513__$1,id,data,columns,view_state,map__28514,map__28514__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28515,map__28515__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
;
return iter__5503__auto__(visible_columns);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28531),bb_web_ds_tools$views$datasets$data_table_$_iter__28528(cljs.core.chunk_rest(s__28529__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28531),null);
}
} else {
var row = cljs.core.first(s__28529__$2);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row_uuid], null),(function (){var iter__5503__auto__ = ((function (row_uuid,row,s__28529__$2,temp__5825__auto__,map__28513,map__28513__$1,id,data,columns,view_state,map__28514,map__28514__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28515,map__28515__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function bb_web_ds_tools$views$datasets$data_table_$_iter__28528_$_iter__28541(s__28542){
return (new cljs.core.LazySeq(null,(function (){
var s__28542__$1 = s__28542;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__28542__$1);
if(temp__5825__auto____$1){
var s__28542__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__28542__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__28542__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__28544 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__28543 = (0);
while(true){
if((i__28543 < size__5502__auto__)){
var col = cljs.core._nth(c__5501__auto__,i__28543);
cljs.core.chunk_append(b__28544,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__28543,col,c__5501__auto__,size__5502__auto__,b__28544,s__28542__$2,temp__5825__auto____$1,row_uuid,row,s__28529__$2,temp__5825__auto__,map__28513,map__28513__$1,id,data,columns,view_state,map__28514,map__28514__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28515,map__28515__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__28512_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__28512_SHARP_.target.value], null));
});})(i__28543,col,c__5501__auto__,size__5502__auto__,b__28544,s__28542__$2,temp__5825__auto____$1,row_uuid,row,s__28529__$2,temp__5825__auto__,map__28513,map__28513__$1,id,data,columns,view_state,map__28514,map__28514__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28515,map__28515__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__28623 = (i__28543 + (1));
i__28543 = G__28623;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28544),bb_web_ds_tools$views$datasets$data_table_$_iter__28528_$_iter__28541(cljs.core.chunk_rest(s__28542__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28544),null);
}
} else {
var col = cljs.core.first(s__28542__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__28542__$2,temp__5825__auto____$1,row_uuid,row,s__28529__$2,temp__5825__auto__,map__28513,map__28513__$1,id,data,columns,view_state,map__28514,map__28514__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28515,map__28515__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__28512_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__28512_SHARP_.target.value], null));
});})(col,s__28542__$2,temp__5825__auto____$1,row_uuid,row,s__28529__$2,temp__5825__auto__,map__28513,map__28513__$1,id,data,columns,view_state,map__28514,map__28514__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28515,map__28515__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__28528_$_iter__28541(cljs.core.rest(s__28542__$2)));
}
} else {
return null;
}
...
});})(row_uuid,row,s__28529__$2,temp__5825__auto__,map__28513,map__28513__$1,id,data,columns,view_state,map__28514,map__28514__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28515,map__28515__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
;
return iter__5503__auto__(visible_columns);
})()], null);
})(),bb_web_ds_tools$views$datasets$data_table_$_iter__28528(cljs.core.rest(s__28529__$2)));
}
} else {
return null;
}
...
})], null),"+ New Dataset"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex-grow overflow-y-auto p-2 space-y-1"], null),((cljs.core.seq(items))?(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$dataset_list_$_iter__28575(s__28576){
return (new cljs.core.LazySeq(null,(function (){
var s__28576__$1 = s__28576;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__28576__$1);
if(temp__5825__auto__){
var s__28576__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__28576__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__28576__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__28578 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__28577 = (0);
while(true){
if((i__28577 < size__5502__auto__)){
var vec__28579 = cljs.core._nth(c__5501__auto__,i__28577);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28579,(0),null);
var ds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28579,(1),null);
cljs.core.chunk_append(b__28578,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.datasets.dataset_list_item,id,ds,active_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__28625 = (i__28577 + (1));
i__28577 = G__28625;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28578),bb_web_ds_tools$views$datasets$dataset_list_$_iter__28575(cljs.core.chunk_rest(s__28576__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28578),null);
}
} else {
var vec__28582 = cljs.core.first(s__28576__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28582,(0),null);
var ds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28582,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.datasets.dataset_list_item,id,ds,active_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),bb_web_ds_tools$views$datasets$dataset_list_$_iter__28575(cljs.core.rest(s__28576__$2)));
}
} else {
return null;
}
