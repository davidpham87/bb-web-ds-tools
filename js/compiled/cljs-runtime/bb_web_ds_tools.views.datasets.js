...
var len__5749__auto___37484 = arguments.length;
var i__5750__auto___37493 = (0);
while(true){
if((i__5750__auto___37493 < len__5749__auto___37484)){
args__5755__auto__.push((arguments[i__5750__auto___37493]));

var G__37494 = (i__5750__auto___37493 + (1));
i__5750__auto___37493 = G__37494;
continue;
} else {
}
break;
...
/** @this {Function} */
(bb_web_ds_tools.views.datasets.deep_merge.cljs$lang$applyTo = (function (seq37309){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq37309));
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"datasets","datasets",1896364419)], null),(function (p1__37319_SHARP_){
return bb_web_ds_tools.views.datasets.deep_merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__37319_SHARP_,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"items","items",1031954938),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"new-dataset-state","new-dataset-state",1109324301),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"name","name",1843675177),"New Dataset",new cljs.core.Keyword(null,"text","text",-1790561697),"",new cljs.core.Keyword(null,"format","format",-1306924766),new cljs.core.Keyword(null,"csv","csv",-1164440893),new cljs.core.Keyword(null,"structure","structure",1563832083),new cljs.core.Keyword(null,"columnar","columnar",-1122999701)], null)], null)], 0));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","set-active-dataset-id","bb-web-ds-tools.views.datasets/set-active-dataset-id",1361188762),(function (db,p__37336){
var vec__37337 = p__37336;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37337,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37337,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-new-dataset-state","bb-web-ds-tools.views.datasets/update-new-dataset-state",-1930125405),(function (db,p__37341){
var vec__37342 = p__37341;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37342,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37342,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37342,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","add-dataset","bb-web-ds-tools.views.datasets/add-dataset",1462625692),(function (db,p__37347){
var vec__37348 = p__37347;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37348,(0),null);
var map__37351 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37348,(1),null);
var map__37351__$1 = cljs.core.__destructure_map(map__37351);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37351__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37351__$1,new cljs.core.Keyword(null,"data","data",-232669377));
...
var data_with_ids = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__37345_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__37345_SHARP_,new cljs.core.Keyword(null,"_uuid","_uuid",797900280),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.random_uuid()));
}),valid_data);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","delete-dataset","bb-web-ds-tools.views.datasets/delete-dataset",243110744),(function (db,p__37352){
var vec__37353 = p__37352;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37353,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37353,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-dataset-name","bb-web-ds-tools.views.datasets/update-dataset-name",798576715),(function (db,p__37357){
...
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37358,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),(function (db,p__37363){
var vec__37364 = p__37363;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37364,(0),null);
var dataset_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37364,(1),null);
var row_uuid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37364,(2),null);
var col_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37364,(3),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37364,(4),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),(function (db,p__37367){
var vec__37368 = p__37367;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37368,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37368,(1),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37368,(2),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37368,(3),null);
...
});})(i__37373,col,c__5501__auto__,size__5502__auto__,b__37374,s__37372__$2,temp__5825__auto__))
...
return (function (){
var map__37378 = cljs.core.deref(state);
var map__37378__$1 = cljs.core.__destructure_map(map__37378);
var fmt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37378__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var name_val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37378__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37378__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var structure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37378__$1,new cljs.core.Keyword(null,"structure","structure",1563832083));
...
var f = cljs.core._nth(c__5501__auto__,i__37381);
cljs.core.chunk_append(b__37382,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),f,new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(fmt,f))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):""),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__37381,f,c__5501__auto__,size__5502__auto__,b__37382,s__37380__$2,temp__5825__auto__,map__37378,map__37378__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state){
return (function (){
set_state(new cljs.core.Keyword(null,"format","format",-1306924766),f);

if(cljs.core.truth_((function (){var fexpr__37383 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"markdown","markdown",1227225089),null,new cljs.core.Keyword(null,"csv","csv",-1164440893),null,new cljs.core.Keyword(null,"tsv","tsv",-1254214356),null], null), null);
return (fexpr__37383.cljs$core$IFn$_invoke$arity$1 ? fexpr__37383.cljs$core$IFn$_invoke$arity$1(f) : fexpr__37383.call(null,f));
})())){
...
});})(i__37381,f,c__5501__auto__,size__5502__auto__,b__37382,s__37380__$2,temp__5825__auto__,map__37378,map__37378__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state))
...
var f = cljs.core.first(s__37380__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),f,new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(fmt,f))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):""),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (f,s__37380__$2,temp__5825__auto__,map__37378,map__37378__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state){
return (function (){
set_state(new cljs.core.Keyword(null,"format","format",-1306924766),f);

if(cljs.core.truth_((function (){var fexpr__37384 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"markdown","markdown",1227225089),null,new cljs.core.Keyword(null,"csv","csv",-1164440893),null,new cljs.core.Keyword(null,"tsv","tsv",-1254214356),null], null), null);
return (fexpr__37384.cljs$core$IFn$_invoke$arity$1 ? fexpr__37384.cljs$core$IFn$_invoke$arity$1(f) : fexpr__37384.call(null,f));
})())){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),new cljs.core.Keyword(null,"columnar","columnar",-1122999701));
} else {
return null;
}
});})(f,s__37380__$2,temp__5825__auto__,map__37378,map__37378__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state))
], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"markdown","markdown",1227225089)))?"MD":clojure.string.upper_case(cljs.core.name(f)))], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__37379(cljs.core.rest(s__37380__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37388),bb_web_ds_tools$views$datasets$importer_view_$_iter__37385(cljs.core.chunk_rest(s__37386__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37388),null);
}
} else {
var s = cljs.core.first(s__37386__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"key","key",-1516042587),s,new cljs.core.Keyword(null,"disabled","disabled",-1529784218),(!(cljs.core.contains_QMARK_(supported_structures,s))),new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(structure__$1,s))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):(((!(cljs.core.contains_QMARK_(supported_structures,s))))?"opacity-50 cursor-not-allowed":"")),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (s,s__37386__$2,temp__5825__auto__,map__37378,map__37378__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state){
return (function (){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),s);
});})(s,s__37386__$2,temp__5825__auto__,map__37378,map__37378__$1,fmt,name_val,text,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state))
], null),cljs.core.get.cljs$core$IFn$_invoke$arity$2(struct_labels,s)], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__37385(cljs.core.rest(s__37386__$2)));
}
} else {
return null;
}
...
var map__37401 = dataset;
var map__37401__$1 = cljs.core.__destructure_map(map__37401);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37401__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37401__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37401__$1,new cljs.core.Keyword(null,"columns","columns",1998437288));
var view_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37401__$1,new cljs.core.Keyword(null,"view-state","view-state",-976675614));
var map__37402 = view_state;
var map__37402__$1 = cljs.core.__destructure_map(map__37402);
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37402__$1,new cljs.core.Keyword(null,"page","page",849072397));
var rows_per_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37402__$1,new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959));
var filters = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37402__$1,new cljs.core.Keyword(null,"filters","filters",974726919));
var hidden_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37402__$1,new cljs.core.Keyword(null,"hidden-columns","hidden-columns",-1045524800));
var sort_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37402__$1,new cljs.core.Keyword(null,"sort-col","sort-col",-718754882));
var sort_dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37402__$1,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757));
var map__37403 = bb_web_ds_tools.utils.dataset_processing.process_table_data(data,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(view_state,new cljs.core.Keyword(null,"columns","columns",1998437288),columns));
var map__37403__$1 = cljs.core.__destructure_map(map__37403);
var page_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37403__$1,new cljs.core.Keyword(null,"page-data","page-data",1443840710));
var total_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37403__$1,new cljs.core.Keyword(null,"total-rows","total-rows",1745495528));
var start_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37403__$1,new cljs.core.Keyword(null,"start-idx","start-idx",-1600773745));
var end_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37403__$1,new cljs.core.Keyword(null,"end-idx","end-idx",-85750788));
var visible_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37403__$1,new cljs.core.Keyword(null,"visible-columns","visible-columns",1134718660));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_col,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"space-y-4 p-4"], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),["flex-wrap gap-4 items-end ",bb_web_ds_tools.theme.bg_toolbar," p-2 rounded shadow-sm"].join('')], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.label,"Rows"], null),new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.select,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),"py-1",new cljs.core.Keyword(null,"value","value",305978217),rows_per_page,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__37397_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959),parseInt(p1__37397_SHARP_.target.value)], null));
...
cljs.core.chunk_append(b__37407,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.th,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["cursor-pointer ",bb_web_ds_tools.theme.bg_item_hover].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__37406,col,c__5501__auto__,size__5502__auto__,b__37407,s__37405__$2,temp__5825__auto__,map__37401,map__37401__$1,id,data,columns,view_state,map__37402,map__37402__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37403,map__37403__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37407),bb_web_ds_tools$views$datasets$data_table_$_iter__37404(cljs.core.chunk_rest(s__37405__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37407),null);
}
} else {
var col = cljs.core.first(s__37405__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.th,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["cursor-pointer ",bb_web_ds_tools.theme.bg_item_hover].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (col,s__37405__$2,temp__5825__auto__,map__37401,map__37401__$1,id,data,columns,view_state,map__37402,map__37402__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37403,map__37403__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
var new_dir = ((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_col,col)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))))?new cljs.core.Keyword(null,"desc","desc",2093485764):new cljs.core.Keyword(null,"asc","asc",356854569));
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"sort-col","sort-col",-718754882),col], null));

return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757),new_dir], null));
});})(col,s__37405__$2,temp__5825__auto__,map__37401,map__37401__$1,id,data,columns,view_state,map__37402,map__37402__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37403,map__37403__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex items-center space-x-1"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),cljs.core.name(col)], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_col,col))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-[10px] transform translate-y-px"], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))?"\u25B2":"\u25BC")], null):null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__37404(cljs.core.rest(s__37405__$2)));
}
} else {
return null;
}
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),["filter-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(col)].join(''),new cljs.core.Keyword(null,"class","class",-2030961996),"px-3 py-1.5"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-sm",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),["Filter ",cljs.core.name(col)].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(filters,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__37423__$2,temp__5825__auto__,map__37401,map__37401__$1,id,data,columns,view_state,map__37402,map__37402__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37403,map__37403__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__37398_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"filters","filters",974726919),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(filters,col,p1__37398_SHARP_.target.value)], null));
});})(col,s__37423__$2,temp__5825__auto__,map__37401,map__37401__$1,id,data,columns,view_state,map__37402,map__37402__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37403,map__37403__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__37422(cljs.core.rest(s__37423__$2)));
}
} else {
return null;
}
...
return iter__5503__auto__(visible_columns);
})()], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__37429(s__37430){
return (new cljs.core.LazySeq(null,(function (){
var s__37430__$1 = s__37430;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__37430__$1);
if(temp__5825__auto__){
var s__37430__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__37430__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__37430__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__37432 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__37431 = (0);
while(true){
if((i__37431 < size__5502__auto__)){
var row = cljs.core._nth(c__5501__auto__,i__37431);
cljs.core.chunk_append(b__37432,(function (){var row_uuid = new cljs.core.Keyword(null,"_uuid","_uuid",797900280).cljs$core$IFn$_invoke$arity$1(row);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row_uuid], null),(function (){var iter__5503__auto__ = ((function (i__37431,row_uuid,row,c__5501__auto__,size__5502__auto__,b__37432,s__37430__$2,temp__5825__auto__,map__37401,map__37401__$1,id,data,columns,view_state,map__37402,map__37402__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37403,map__37403__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function bb_web_ds_tools$views$datasets$data_table_$_iter__37429_$_iter__37441(s__37442){
return (new cljs.core.LazySeq(null,((function (i__37431,row_uuid,row,c__5501__auto__,size__5502__auto__,b__37432,s__37430__$2,temp__5825__auto__,map__37401,map__37401__$1,id,data,columns,view_state,map__37402,map__37402__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37403,map__37403__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
var s__37442__$1 = s__37442;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__37442__$1);
if(temp__5825__auto____$1){
var s__37442__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__37442__$2)){
var c__5501__auto____$1 = cljs.core.chunk_first(s__37442__$2);
var size__5502__auto____$1 = cljs.core.count(c__5501__auto____$1);
var b__37444 = cljs.core.chunk_buffer(size__5502__auto____$1);
if((function (){var i__37443 = (0);
while(true){
if((i__37443 < size__5502__auto____$1)){
var col = cljs.core._nth(c__5501__auto____$1,i__37443);
cljs.core.chunk_append(b__37444,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__37443,i__37431,col,c__5501__auto____$1,size__5502__auto____$1,b__37444,s__37442__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__37432,s__37430__$2,temp__5825__auto__,map__37401,map__37401__$1,id,data,columns,view_state,map__37402,map__37402__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37403,map__37403__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__37399_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__37399_SHARP_.target.value], null));
});})(i__37443,i__37431,col,c__5501__auto____$1,size__5502__auto____$1,b__37444,s__37442__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__37432,s__37430__$2,temp__5825__auto__,map__37401,map__37401__$1,id,data,columns,view_state,map__37402,map__37402__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37403,map__37403__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__37501 = (i__37443 + (1));
i__37443 = G__37501;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37444),bb_web_ds_tools$views$datasets$data_table_$_iter__37429_$_iter__37441(cljs.core.chunk_rest(s__37442__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37444),null);
}
} else {
var col = cljs.core.first(s__37442__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__37431,col,s__37442__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__37432,s__37430__$2,temp__5825__auto__,map__37401,map__37401__$1,id,data,columns,view_state,map__37402,map__37402__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37403,map__37403__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__37399_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__37399_SHARP_.target.value], null));
});})(i__37431,col,s__37442__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__37432,s__37430__$2,temp__5825__auto__,map__37401,map__37401__$1,id,data,columns,view_state,map__37402,map__37402__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37403,map__37403__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__37429_$_iter__37441(cljs.core.rest(s__37442__$2)));
}
} else {
return null;
}
...
});})(i__37431,row_uuid,row,c__5501__auto__,size__5502__auto__,b__37432,s__37430__$2,temp__5825__auto__,map__37401,map__37401__$1,id,data,columns,view_state,map__37402,map__37402__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37403,map__37403__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
,null,null));
});})(i__37431,row_uuid,row,c__5501__auto__,size__5502__auto__,b__37432,s__37430__$2,temp__5825__auto__,map__37401,map__37401__$1,id,data,columns,view_state,map__37402,map__37402__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37403,map__37403__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
;
return iter__5503__auto__(visible_columns);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37432),bb_web_ds_tools$views$datasets$data_table_$_iter__37429(cljs.core.chunk_rest(s__37430__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37432),null);
}
} else {
var row = cljs.core.first(s__37430__$2);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row_uuid], null),(function (){var iter__5503__auto__ = ((function (row_uuid,row,s__37430__$2,temp__5825__auto__,map__37401,map__37401__$1,id,data,columns,view_state,map__37402,map__37402__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37403,map__37403__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function bb_web_ds_tools$views$datasets$data_table_$_iter__37429_$_iter__37445(s__37446){
return (new cljs.core.LazySeq(null,(function (){
var s__37446__$1 = s__37446;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__37446__$1);
if(temp__5825__auto____$1){
var s__37446__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__37446__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__37446__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__37448 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__37447 = (0);
while(true){
if((i__37447 < size__5502__auto__)){
var col = cljs.core._nth(c__5501__auto__,i__37447);
cljs.core.chunk_append(b__37448,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__37447,col,c__5501__auto__,size__5502__auto__,b__37448,s__37446__$2,temp__5825__auto____$1,row_uuid,row,s__37430__$2,temp__5825__auto__,map__37401,map__37401__$1,id,data,columns,view_state,map__37402,map__37402__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37403,map__37403__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__37399_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__37399_SHARP_.target.value], null));
});})(i__37447,col,c__5501__auto__,size__5502__auto__,b__37448,s__37446__$2,temp__5825__auto____$1,row_uuid,row,s__37430__$2,temp__5825__auto__,map__37401,map__37401__$1,id,data,columns,view_state,map__37402,map__37402__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37403,map__37403__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__37504 = (i__37447 + (1));
i__37447 = G__37504;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37448),bb_web_ds_tools$views$datasets$data_table_$_iter__37429_$_iter__37445(cljs.core.chunk_rest(s__37446__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37448),null);
}
} else {
var col = cljs.core.first(s__37446__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__37446__$2,temp__5825__auto____$1,row_uuid,row,s__37430__$2,temp__5825__auto__,map__37401,map__37401__$1,id,data,columns,view_state,map__37402,map__37402__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37403,map__37403__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__37399_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__37399_SHARP_.target.value], null));
});})(col,s__37446__$2,temp__5825__auto____$1,row_uuid,row,s__37430__$2,temp__5825__auto__,map__37401,map__37401__$1,id,data,columns,view_state,map__37402,map__37402__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37403,map__37403__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__37429_$_iter__37445(cljs.core.rest(s__37446__$2)));
}
} else {
return null;
}
...
});})(row_uuid,row,s__37430__$2,temp__5825__auto__,map__37401,map__37401__$1,id,data,columns,view_state,map__37402,map__37402__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37403,map__37403__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
;
return iter__5503__auto__(visible_columns);
})()], null);
})(),bb_web_ds_tools$views$datasets$data_table_$_iter__37429(cljs.core.rest(s__37430__$2)));
}
} else {
return null;
}
...
return (function (){
var map__37457 = cljs.core.deref(state_sub);
var map__37457__$1 = cljs.core.__destructure_map(map__37457);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37457__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var active_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37457__$1,new cljs.core.Keyword(null,"active-id","active-id",-59238656));
...
})], null),"+ New Dataset"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex-grow overflow-y-auto p-2 space-y-1"], null),((cljs.core.seq(items))?(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$dataset_list_$_iter__37458(s__37459){
return (new cljs.core.LazySeq(null,(function (){
...
var vec__37462 = cljs.core._nth(c__5501__auto__,i__37460);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37462,(0),null);
var ds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37462,(1),null);
cljs.core.chunk_append(b__37461,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.datasets.dataset_list_item,id,ds,active_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__37517 = (i__37460 + (1));
i__37460 = G__37517;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37461),bb_web_ds_tools$views$datasets$dataset_list_$_iter__37458(cljs.core.chunk_rest(s__37459__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37461),null);
}
} else {
var vec__37465 = cljs.core.first(s__37459__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37465,(0),null);
var ds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37465,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.datasets.dataset_list_item,id,ds,active_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),bb_web_ds_tools$views$datasets$dataset_list_$_iter__37458(cljs.core.rest(s__37459__$2)));
}
} else {
return null;
}
...
return (function (){
var map__37468 = cljs.core.deref(state_sub);
var map__37468__$1 = cljs.core.__destructure_map(map__37468);
var active_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37468__$1,new cljs.core.Keyword(null,"active-id","active-id",-59238656));
var active_dataset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37468__$1,new cljs.core.Keyword(null,"active-dataset","active-dataset",771380472));
