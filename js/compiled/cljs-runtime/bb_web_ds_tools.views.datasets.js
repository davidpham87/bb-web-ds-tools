...
var len__5749__auto___37556 = arguments.length;
var i__5750__auto___37557 = (0);
while(true){
if((i__5750__auto___37557 < len__5749__auto___37556)){
args__5755__auto__.push((arguments[i__5750__auto___37557]));

var G__37558 = (i__5750__auto___37557 + (1));
i__5750__auto___37557 = G__37558;
continue;
} else {
}
break;
...
/** @this {Function} */
(bb_web_ds_tools.views.datasets.deep_merge.cljs$lang$applyTo = (function (seq37316){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq37316));
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"datasets","datasets",1896364419)], null),(function (p1__37320_SHARP_){
return bb_web_ds_tools.views.datasets.deep_merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__37320_SHARP_,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"items","items",1031954938),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"new-dataset-state","new-dataset-state",1109324301),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"name","name",1843675177),"New Dataset",new cljs.core.Keyword(null,"text","text",-1790561697),"",new cljs.core.Keyword(null,"format","format",-1306924766),new cljs.core.Keyword(null,"csv","csv",-1164440893),new cljs.core.Keyword(null,"structure","structure",1563832083),new cljs.core.Keyword(null,"columnar","columnar",-1122999701)], null)], null)], 0));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-new-dataset-state","bb-web-ds-tools.views.datasets/update-new-dataset-state",-1930125405),(function (db,p__37362){
var vec__37363 = p__37362;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37363,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37363,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37363,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","add-dataset","bb-web-ds-tools.views.datasets/add-dataset",1462625692),(function (db,p__37371){
var vec__37372 = p__37371;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37372,(0),null);
var map__37375 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37372,(1),null);
var map__37375__$1 = cljs.core.__destructure_map(map__37375);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37375__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37375__$1,new cljs.core.Keyword(null,"data","data",-232669377));
...
var data_with_ids = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__37370_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__37370_SHARP_,new cljs.core.Keyword(null,"_uuid","_uuid",797900280),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.random_uuid()));
}),valid_data);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","delete-dataset","bb-web-ds-tools.views.datasets/delete-dataset",243110744),(function (db,p__37384){
var vec__37385 = p__37384;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37385,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37385,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-dataset-name","bb-web-ds-tools.views.datasets/update-dataset-name",798576715),(function (db,p__37388){
var vec__37389 = p__37388;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37389,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37389,(1),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37389,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),(function (db,p__37392){
var vec__37397 = p__37392;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37397,(0),null);
var dataset_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37397,(1),null);
var row_uuid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37397,(2),null);
var col_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37397,(3),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37397,(4),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),(function (db,p__37400){
var vec__37401 = p__37400;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37401,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37401,(1),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37401,(2),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37401,(3),null);
...
});})(i__37406,col,c__5501__auto__,size__5502__auto__,b__37407,s__37405__$2,temp__5825__auto__))
...
return (function (){
var map__37419 = cljs.core.deref(state);
var map__37419__$1 = cljs.core.__destructure_map(map__37419);
var name_val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37419__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37419__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37419__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var structure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37419__$1,new cljs.core.Keyword(null,"structure","structure",1563832083));
...
var fmt = cljs.core._nth(c__5501__auto__,i__37424);
cljs.core.chunk_append(b__37425,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),fmt,new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(format,fmt))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):""),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__37424,fmt,c__5501__auto__,size__5502__auto__,b__37425,s__37423__$2,temp__5825__auto__,map__37419,map__37419__$1,name_val,text,format,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state){
return (function (){
set_state(new cljs.core.Keyword(null,"format","format",-1306924766),fmt);

if(cljs.core.truth_((function (){var fexpr__37429 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"markdown","markdown",1227225089),null,new cljs.core.Keyword(null,"csv","csv",-1164440893),null,new cljs.core.Keyword(null,"tsv","tsv",-1254214356),null], null), null);
return (fexpr__37429.cljs$core$IFn$_invoke$arity$1 ? fexpr__37429.cljs$core$IFn$_invoke$arity$1(fmt) : fexpr__37429.call(null,fmt));
})())){
...
});})(i__37424,fmt,c__5501__auto__,size__5502__auto__,b__37425,s__37423__$2,temp__5825__auto__,map__37419,map__37419__$1,name_val,text,format,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37425),bb_web_ds_tools$views$datasets$importer_view_$_iter__37422(cljs.core.chunk_rest(s__37423__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37425),null);
}
} else {
var fmt = cljs.core.first(s__37423__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),fmt,new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(format,fmt))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):""),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (fmt,s__37423__$2,temp__5825__auto__,map__37419,map__37419__$1,name_val,text,format,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state){
return (function (){
set_state(new cljs.core.Keyword(null,"format","format",-1306924766),fmt);

if(cljs.core.truth_((function (){var fexpr__37430 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"markdown","markdown",1227225089),null,new cljs.core.Keyword(null,"csv","csv",-1164440893),null,new cljs.core.Keyword(null,"tsv","tsv",-1254214356),null], null), null);
return (fexpr__37430.cljs$core$IFn$_invoke$arity$1 ? fexpr__37430.cljs$core$IFn$_invoke$arity$1(fmt) : fexpr__37430.call(null,fmt));
})())){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),new cljs.core.Keyword(null,"columnar","columnar",-1122999701));
} else {
return null;
}
});})(fmt,s__37423__$2,temp__5825__auto__,map__37419,map__37419__$1,name_val,text,format,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state))
], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(fmt,new cljs.core.Keyword(null,"markdown","markdown",1227225089)))?"MD":clojure.string.upper_case(cljs.core.name(fmt)))], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__37422(cljs.core.rest(s__37423__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37434),bb_web_ds_tools$views$datasets$importer_view_$_iter__37431(cljs.core.chunk_rest(s__37432__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37434),null);
}
} else {
var s = cljs.core.first(s__37432__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"key","key",-1516042587),s,new cljs.core.Keyword(null,"disabled","disabled",-1529784218),(!(cljs.core.contains_QMARK_(supported_structures,s))),new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(structure__$1,s))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):(((!(cljs.core.contains_QMARK_(supported_structures,s))))?"opacity-50 cursor-not-allowed":"")),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (s,s__37432__$2,temp__5825__auto__,map__37419,map__37419__$1,name_val,text,format,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state){
return (function (){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),s);
});})(s,s__37432__$2,temp__5825__auto__,map__37419,map__37419__$1,name_val,text,format,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state))
], null),cljs.core.get.cljs$core$IFn$_invoke$arity$2(struct_labels,s)], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__37431(cljs.core.rest(s__37432__$2)));
}
} else {
return null;
}
...
var map__37448 = dataset;
var map__37448__$1 = cljs.core.__destructure_map(map__37448);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37448__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37448__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37448__$1,new cljs.core.Keyword(null,"columns","columns",1998437288));
var view_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37448__$1,new cljs.core.Keyword(null,"view-state","view-state",-976675614));
var map__37449 = view_state;
var map__37449__$1 = cljs.core.__destructure_map(map__37449);
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37449__$1,new cljs.core.Keyword(null,"page","page",849072397));
var rows_per_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37449__$1,new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959));
var filters = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37449__$1,new cljs.core.Keyword(null,"filters","filters",974726919));
var hidden_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37449__$1,new cljs.core.Keyword(null,"hidden-columns","hidden-columns",-1045524800));
var sort_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37449__$1,new cljs.core.Keyword(null,"sort-col","sort-col",-718754882));
var sort_dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37449__$1,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757));
var map__37450 = bb_web_ds_tools.utils.dataset_processing.process_table_data(data,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(view_state,new cljs.core.Keyword(null,"columns","columns",1998437288),columns));
var map__37450__$1 = cljs.core.__destructure_map(map__37450);
var page_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37450__$1,new cljs.core.Keyword(null,"page-data","page-data",1443840710));
var total_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37450__$1,new cljs.core.Keyword(null,"total-rows","total-rows",1745495528));
var start_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37450__$1,new cljs.core.Keyword(null,"start-idx","start-idx",-1600773745));
var end_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37450__$1,new cljs.core.Keyword(null,"end-idx","end-idx",-85750788));
var visible_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37450__$1,new cljs.core.Keyword(null,"visible-columns","visible-columns",1134718660));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_col,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"space-y-4 p-4"], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),["flex-wrap gap-4 items-end ",bb_web_ds_tools.theme.bg_toolbar," p-2 rounded shadow-sm"].join('')], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.label,"Rows"], null),new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.select,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),"py-1",new cljs.core.Keyword(null,"value","value",305978217),rows_per_page,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__37444_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959),parseInt(p1__37444_SHARP_.target.value)], null));
...
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"page","page",849072397),(page + (1))], null));
}),new cljs.core.Keyword(null,"disabled","disabled",-1529784218),(end_idx >= total_rows)], null),"Next"], null)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.table_container,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.table,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.thead,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__37458(s__37459){
return (new cljs.core.LazySeq(null,(function (){
var s__37459__$1 = s__37459;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__37459__$1);
if(temp__5825__auto__){
var s__37459__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__37459__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__37459__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__37461 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__37460 = (0);
while(true){
if((i__37460 < size__5502__auto__)){
var col = cljs.core._nth(c__5501__auto__,i__37460);
cljs.core.chunk_append(b__37461,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.th,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["cursor-pointer ",bb_web_ds_tools.theme.bg_item_hover].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__37460,col,c__5501__auto__,size__5502__auto__,b__37461,s__37459__$2,temp__5825__auto__,map__37448,map__37448__$1,id,data,columns,view_state,map__37449,map__37449__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37450,map__37450__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37461),bb_web_ds_tools$views$datasets$data_table_$_iter__37458(cljs.core.chunk_rest(s__37459__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37461),null);
}
} else {
var col = cljs.core.first(s__37459__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.th,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["cursor-pointer ",bb_web_ds_tools.theme.bg_item_hover].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (col,s__37459__$2,temp__5825__auto__,map__37448,map__37448__$1,id,data,columns,view_state,map__37449,map__37449__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37450,map__37450__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
var new_dir = ((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_col,col)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))))?new cljs.core.Keyword(null,"desc","desc",2093485764):new cljs.core.Keyword(null,"asc","asc",356854569));
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"sort-col","sort-col",-718754882),col], null));

return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757),new_dir], null));
});})(col,s__37459__$2,temp__5825__auto__,map__37448,map__37448__$1,id,data,columns,view_state,map__37449,map__37449__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37450,map__37450__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex items-center space-x-1"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),cljs.core.name(col)], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_col,col))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-[10px] transform translate-y-px"], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))?"\u25B2":"\u25BC")], null):null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__37458(cljs.core.rest(s__37459__$2)));
}
} else {
return null;
}
...
})()], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tbody,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__37466(s__37467){
return (new cljs.core.LazySeq(null,(function (){
var s__37467__$1 = s__37467;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__37467__$1);
if(temp__5825__auto__){
var s__37467__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__37467__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__37467__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__37469 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__37468 = (0);
while(true){
if((i__37468 < size__5502__auto__)){
var col = cljs.core._nth(c__5501__auto__,i__37468);
cljs.core.chunk_append(b__37469,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),["filter-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(col)].join(''),new cljs.core.Keyword(null,"class","class",-2030961996),"px-3 py-1.5"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-sm",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),["Filter ",cljs.core.name(col)].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(filters,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__37468,col,c__5501__auto__,size__5502__auto__,b__37469,s__37467__$2,temp__5825__auto__,map__37448,map__37448__$1,id,data,columns,view_state,map__37449,map__37449__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37450,map__37450__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__37445_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"filters","filters",974726919),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(filters,col,p1__37445_SHARP_.target.value)], null));
});})(i__37468,col,c__5501__auto__,size__5502__auto__,b__37469,s__37467__$2,temp__5825__auto__,map__37448,map__37448__$1,id,data,columns,view_state,map__37449,map__37449__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37450,map__37450__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__37575 = (i__37468 + (1));
i__37468 = G__37575;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37469),bb_web_ds_tools$views$datasets$data_table_$_iter__37466(cljs.core.chunk_rest(s__37467__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37469),null);
}
} else {
var col = cljs.core.first(s__37467__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),["filter-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(col)].join(''),new cljs.core.Keyword(null,"class","class",-2030961996),"px-3 py-1.5"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-sm",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),["Filter ",cljs.core.name(col)].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(filters,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__37467__$2,temp__5825__auto__,map__37448,map__37448__$1,id,data,columns,view_state,map__37449,map__37449__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37450,map__37450__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__37445_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"filters","filters",974726919),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(filters,col,p1__37445_SHARP_.target.value)], null));
});})(col,s__37467__$2,temp__5825__auto__,map__37448,map__37448__$1,id,data,columns,view_state,map__37449,map__37449__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37450,map__37450__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__37466(cljs.core.rest(s__37467__$2)));
}
} else {
return null;
}
...
return iter__5503__auto__(visible_columns);
})()], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__37470(s__37471){
return (new cljs.core.LazySeq(null,(function (){
var s__37471__$1 = s__37471;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__37471__$1);
if(temp__5825__auto__){
var s__37471__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__37471__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__37471__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__37473 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__37472 = (0);
while(true){
if((i__37472 < size__5502__auto__)){
var row = cljs.core._nth(c__5501__auto__,i__37472);
cljs.core.chunk_append(b__37473,(function (){var row_uuid = new cljs.core.Keyword(null,"_uuid","_uuid",797900280).cljs$core$IFn$_invoke$arity$1(row);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row_uuid], null),(function (){var iter__5503__auto__ = ((function (i__37472,row_uuid,row,c__5501__auto__,size__5502__auto__,b__37473,s__37471__$2,temp__5825__auto__,map__37448,map__37448__$1,id,data,columns,view_state,map__37449,map__37449__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37450,map__37450__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function bb_web_ds_tools$views$datasets$data_table_$_iter__37470_$_iter__37484(s__37485){
return (new cljs.core.LazySeq(null,((function (i__37472,row_uuid,row,c__5501__auto__,size__5502__auto__,b__37473,s__37471__$2,temp__5825__auto__,map__37448,map__37448__$1,id,data,columns,view_state,map__37449,map__37449__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37450,map__37450__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
var s__37485__$1 = s__37485;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__37485__$1);
if(temp__5825__auto____$1){
var s__37485__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__37485__$2)){
var c__5501__auto____$1 = cljs.core.chunk_first(s__37485__$2);
var size__5502__auto____$1 = cljs.core.count(c__5501__auto____$1);
var b__37487 = cljs.core.chunk_buffer(size__5502__auto____$1);
if((function (){var i__37486 = (0);
while(true){
if((i__37486 < size__5502__auto____$1)){
var col = cljs.core._nth(c__5501__auto____$1,i__37486);
cljs.core.chunk_append(b__37487,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__37486,i__37472,col,c__5501__auto____$1,size__5502__auto____$1,b__37487,s__37485__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__37473,s__37471__$2,temp__5825__auto__,map__37448,map__37448__$1,id,data,columns,view_state,map__37449,map__37449__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37450,map__37450__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__37446_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__37446_SHARP_.target.value], null));
});})(i__37486,i__37472,col,c__5501__auto____$1,size__5502__auto____$1,b__37487,s__37485__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__37473,s__37471__$2,temp__5825__auto__,map__37448,map__37448__$1,id,data,columns,view_state,map__37449,map__37449__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37450,map__37450__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__37578 = (i__37486 + (1));
i__37486 = G__37578;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37487),bb_web_ds_tools$views$datasets$data_table_$_iter__37470_$_iter__37484(cljs.core.chunk_rest(s__37485__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37487),null);
}
} else {
var col = cljs.core.first(s__37485__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__37472,col,s__37485__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__37473,s__37471__$2,temp__5825__auto__,map__37448,map__37448__$1,id,data,columns,view_state,map__37449,map__37449__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37450,map__37450__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__37446_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__37446_SHARP_.target.value], null));
});})(i__37472,col,s__37485__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__37473,s__37471__$2,temp__5825__auto__,map__37448,map__37448__$1,id,data,columns,view_state,map__37449,map__37449__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37450,map__37450__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__37470_$_iter__37484(cljs.core.rest(s__37485__$2)));
}
} else {
return null;
}
...
});})(i__37472,row_uuid,row,c__5501__auto__,size__5502__auto__,b__37473,s__37471__$2,temp__5825__auto__,map__37448,map__37448__$1,id,data,columns,view_state,map__37449,map__37449__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37450,map__37450__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
,null,null));
});})(i__37472,row_uuid,row,c__5501__auto__,size__5502__auto__,b__37473,s__37471__$2,temp__5825__auto__,map__37448,map__37448__$1,id,data,columns,view_state,map__37449,map__37449__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37450,map__37450__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
;
return iter__5503__auto__(visible_columns);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37473),bb_web_ds_tools$views$datasets$data_table_$_iter__37470(cljs.core.chunk_rest(s__37471__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37473),null);
}
} else {
var row = cljs.core.first(s__37471__$2);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row_uuid], null),(function (){var iter__5503__auto__ = ((function (row_uuid,row,s__37471__$2,temp__5825__auto__,map__37448,map__37448__$1,id,data,columns,view_state,map__37449,map__37449__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37450,map__37450__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function bb_web_ds_tools$views$datasets$data_table_$_iter__37470_$_iter__37494(s__37495){
return (new cljs.core.LazySeq(null,(function (){
var s__37495__$1 = s__37495;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__37495__$1);
if(temp__5825__auto____$1){
var s__37495__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__37495__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__37495__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__37497 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__37496 = (0);
while(true){
if((i__37496 < size__5502__auto__)){
var col = cljs.core._nth(c__5501__auto__,i__37496);
cljs.core.chunk_append(b__37497,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__37496,col,c__5501__auto__,size__5502__auto__,b__37497,s__37495__$2,temp__5825__auto____$1,row_uuid,row,s__37471__$2,temp__5825__auto__,map__37448,map__37448__$1,id,data,columns,view_state,map__37449,map__37449__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37450,map__37450__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__37446_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__37446_SHARP_.target.value], null));
});})(i__37496,col,c__5501__auto__,size__5502__auto__,b__37497,s__37495__$2,temp__5825__auto____$1,row_uuid,row,s__37471__$2,temp__5825__auto__,map__37448,map__37448__$1,id,data,columns,view_state,map__37449,map__37449__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37450,map__37450__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__37580 = (i__37496 + (1));
i__37496 = G__37580;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37497),bb_web_ds_tools$views$datasets$data_table_$_iter__37470_$_iter__37494(cljs.core.chunk_rest(s__37495__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37497),null);
}
} else {
var col = cljs.core.first(s__37495__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__37495__$2,temp__5825__auto____$1,row_uuid,row,s__37471__$2,temp__5825__auto__,map__37448,map__37448__$1,id,data,columns,view_state,map__37449,map__37449__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37450,map__37450__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__37446_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__37446_SHARP_.target.value], null));
});})(col,s__37495__$2,temp__5825__auto____$1,row_uuid,row,s__37471__$2,temp__5825__auto__,map__37448,map__37448__$1,id,data,columns,view_state,map__37449,map__37449__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37450,map__37450__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__37470_$_iter__37494(cljs.core.rest(s__37495__$2)));
}
} else {
return null;
}
...
});})(row_uuid,row,s__37471__$2,temp__5825__auto__,map__37448,map__37448__$1,id,data,columns,view_state,map__37449,map__37449__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__37450,map__37450__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
;
return iter__5503__auto__(visible_columns);
})()], null);
})(),bb_web_ds_tools$views$datasets$data_table_$_iter__37470(cljs.core.rest(s__37471__$2)));
}
} else {
return null;
}
...
})], null),"+ New Dataset"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex-grow overflow-y-auto p-2 space-y-1"], null),((cljs.core.seq(items))?(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$dataset_list_$_iter__37545(s__37546){
return (new cljs.core.LazySeq(null,(function (){
var s__37546__$1 = s__37546;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__37546__$1);
if(temp__5825__auto__){
var s__37546__$2 = temp__5825__auto__;
...
var vec__37549 = cljs.core._nth(c__5501__auto__,i__37547);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37549,(0),null);
var ds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37549,(1),null);
cljs.core.chunk_append(b__37548,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.datasets.dataset_list_item,id,ds,active_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__37591 = (i__37547 + (1));
i__37547 = G__37591;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37548),bb_web_ds_tools$views$datasets$dataset_list_$_iter__37545(cljs.core.chunk_rest(s__37546__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37548),null);
}
} else {
var vec__37552 = cljs.core.first(s__37546__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37552,(0),null);
var ds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37552,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.datasets.dataset_list_item,id,ds,active_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),bb_web_ds_tools$views$datasets$dataset_list_$_iter__37545(cljs.core.rest(s__37546__$2)));
}
} else {
return null;
}
