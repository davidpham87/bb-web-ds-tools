...
var len__5749__auto___28614 = arguments.length;
var i__5750__auto___28615 = (0);
while(true){
if((i__5750__auto___28615 < len__5749__auto___28614)){
args__5755__auto__.push((arguments[i__5750__auto___28615]));

var G__28616 = (i__5750__auto___28615 + (1));
i__5750__auto___28615 = G__28616;
continue;
} else {
}
break;
...
/** @this {Function} */
(bb_web_ds_tools.views.datasets.deep_merge.cljs$lang$applyTo = (function (seq28414){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq28414));
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"datasets","datasets",1896364419)], null),(function (p1__28439_SHARP_){
return bb_web_ds_tools.views.datasets.deep_merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__28439_SHARP_,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"items","items",1031954938),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"new-dataset-state","new-dataset-state",1109324301),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"name","name",1843675177),"New Dataset",new cljs.core.Keyword(null,"text","text",-1790561697),"",new cljs.core.Keyword(null,"format","format",-1306924766),new cljs.core.Keyword(null,"csv","csv",-1164440893),new cljs.core.Keyword(null,"structure","structure",1563832083),new cljs.core.Keyword(null,"columnar","columnar",-1122999701)], null)], null)], 0));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-new-dataset-state","bb-web-ds-tools.views.datasets/update-new-dataset-state",-1930125405),(function (db,p__28448){
var vec__28449 = p__28448;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28449,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28449,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28449,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","add-dataset","bb-web-ds-tools.views.datasets/add-dataset",1462625692),(function (db,p__28453){
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28457__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var id = cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.random_uuid());
var valid_data = ((cljs.core.seq(data))?((cljs.core.map_QMARK_(cljs.core.first(data)))?data:cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (row){
...
var data_with_ids = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__28452_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__28452_SHARP_,new cljs.core.Keyword(null,"_uuid","_uuid",797900280),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.random_uuid()));
}),valid_data);
...
})(),new cljs.core.Keyword(null,"data","data",-232669377),data_with_ids,new cljs.core.Keyword(null,"columns","columns",1998437288),columns,new cljs.core.Keyword(null,"view-state","view-state",-976675614),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"page","page",849072397),(0),new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959),(10),new cljs.core.Keyword(null,"filters","filters",974726919),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hidden-columns","hidden-columns",-1045524800),cljs.core.PersistentHashSet.EMPTY], null)], null)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","datasets","bb-web-ds-tools.views.datasets/datasets",-1461208347),new cljs.core.Keyword(null,"active-dataset-id","active-dataset-id",-735937827)], null),id);
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","delete-dataset","bb-web-ds-tools.views.datasets/delete-dataset",243110744),(function (db,p__28461){
var vec__28462 = p__28461;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28462,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28462,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-dataset-name","bb-web-ds-tools.views.datasets/update-dataset-name",798576715),(function (db,p__28465){
var vec__28466 = p__28465;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28466,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28466,(1),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28466,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),(function (db,p__28469){
var vec__28470 = p__28469;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28470,(0),null);
var dataset_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28470,(1),null);
var row_uuid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28470,(2),null);
var col_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28470,(3),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28470,(4),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),(function (db,p__28475){
var vec__28476 = p__28475;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28476,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28476,(1),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28476,(2),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28476,(3),null);
...
});})(i__28486,col,c__5501__auto__,size__5502__auto__,b__28487,s__28485__$2,temp__5825__auto__))
...
return (function (){
var map__28496 = cljs.core.deref(state);
var map__28496__$1 = cljs.core.__destructure_map(map__28496);
var name_val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28496__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28496__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28496__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var structure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28496__$1,new cljs.core.Keyword(null,"structure","structure",1563832083));
...
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_col,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"h-full space-y-4 p-4"], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"justify-between items-center"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3","h3",2067611163),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),["text-xl font-bold ",bb_web_ds_tools.theme.text_accent].join('')], null),"Create New Dataset"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"space-x-2"], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$importer_view_$_iter__28497(s__28498){
return (new cljs.core.LazySeq(null,(function (){
var s__28498__$1 = s__28498;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__28498__$1);
if(temp__5825__auto__){
var s__28498__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__28498__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__28498__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__28500 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__28499 = (0);
while(true){
if((i__28499 < size__5502__auto__)){
var fmt = cljs.core._nth(c__5501__auto__,i__28499);
cljs.core.chunk_append(b__28500,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),fmt,new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(format,fmt))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):""),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__28499,fmt,c__5501__auto__,size__5502__auto__,b__28500,s__28498__$2,temp__5825__auto__,map__28496,map__28496__$1,name_val,text,format,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state){
return (function (){
set_state(new cljs.core.Keyword(null,"format","format",-1306924766),fmt);

if(cljs.core.truth_((function (){var fexpr__28501 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"markdown","markdown",1227225089),null,new cljs.core.Keyword(null,"csv","csv",-1164440893),null,new cljs.core.Keyword(null,"tsv","tsv",-1254214356),null], null), null);
return (fexpr__28501.cljs$core$IFn$_invoke$arity$1 ? fexpr__28501.cljs$core$IFn$_invoke$arity$1(fmt) : fexpr__28501.call(null,fmt));
})())){
...
});})(i__28499,fmt,c__5501__auto__,size__5502__auto__,b__28500,s__28498__$2,temp__5825__auto__,map__28496,map__28496__$1,name_val,text,format,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28500),bb_web_ds_tools$views$datasets$importer_view_$_iter__28497(cljs.core.chunk_rest(s__28498__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28500),null);
}
} else {
var fmt = cljs.core.first(s__28498__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.button_xs,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),fmt,new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(format,fmt))?[bb_web_ds_tools.theme.bg_button_primary," text-white"].join(''):""),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (fmt,s__28498__$2,temp__5825__auto__,map__28496,map__28496__$1,name_val,text,format,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state){
return (function (){
set_state(new cljs.core.Keyword(null,"format","format",-1306924766),fmt);

if(cljs.core.truth_((function (){var fexpr__28502 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"markdown","markdown",1227225089),null,new cljs.core.Keyword(null,"csv","csv",-1164440893),null,new cljs.core.Keyword(null,"tsv","tsv",-1254214356),null], null), null);
return (fexpr__28502.cljs$core$IFn$_invoke$arity$1 ? fexpr__28502.cljs$core$IFn$_invoke$arity$1(fmt) : fexpr__28502.call(null,fmt));
})())){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),new cljs.core.Keyword(null,"columnar","columnar",-1122999701));
} else {
return null;
}
});})(fmt,s__28498__$2,temp__5825__auto__,map__28496,map__28496__$1,name_val,text,format,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state))
], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(fmt,new cljs.core.Keyword(null,"markdown","markdown",1227225089)))?"MD":clojure.string.upper_case(cljs.core.name(fmt)))], null),bb_web_ds_tools$views$datasets$importer_view_$_iter__28497(cljs.core.rest(s__28498__$2)));
}
} else {
return null;
}
...
})()], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"value","value",305978217),dataset_name,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Dataset Name",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__28493_SHARP_){
return set_state(new cljs.core.Keyword(null,"name","name",1843675177),p1__28493_SHARP_.target.value);
...
});})(i__28505,s,c__5501__auto__,size__5502__auto__,b__28506,s__28504__$2,temp__5825__auto__,map__28496,map__28496__$1,name_val,text,format,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state))
], null),cljs.core.get.cljs$core$IFn$_invoke$arity$2(struct_labels,s)], null));

var G__28620 = (i__28505 + (1));
i__28505 = G__28620;
continue;
} else {
return true;
...
return (function (){
return set_state(new cljs.core.Keyword(null,"structure","structure",1563832083),s);
});})(s,s__28504__$2,temp__5825__auto__,map__28496,map__28496__$1,name_val,text,format,structure,structure__$1,dataset_name,set_state,supported_structures,struct_labels,state))
...
var map__28511 = dataset;
var map__28511__$1 = cljs.core.__destructure_map(map__28511);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28511__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28511__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28511__$1,new cljs.core.Keyword(null,"columns","columns",1998437288));
var view_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28511__$1,new cljs.core.Keyword(null,"view-state","view-state",-976675614));
var map__28512 = view_state;
var map__28512__$1 = cljs.core.__destructure_map(map__28512);
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28512__$1,new cljs.core.Keyword(null,"page","page",849072397));
var rows_per_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28512__$1,new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959));
var filters = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28512__$1,new cljs.core.Keyword(null,"filters","filters",974726919));
var hidden_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28512__$1,new cljs.core.Keyword(null,"hidden-columns","hidden-columns",-1045524800));
var sort_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28512__$1,new cljs.core.Keyword(null,"sort-col","sort-col",-718754882));
var sort_dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28512__$1,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757));
var map__28513 = bb_web_ds_tools.utils.dataset_processing.process_table_data(data,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(view_state,new cljs.core.Keyword(null,"columns","columns",1998437288),columns));
var map__28513__$1 = cljs.core.__destructure_map(map__28513);
var page_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28513__$1,new cljs.core.Keyword(null,"page-data","page-data",1443840710));
var total_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28513__$1,new cljs.core.Keyword(null,"total-rows","total-rows",1745495528));
var start_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28513__$1,new cljs.core.Keyword(null,"start-idx","start-idx",-1600773745));
var end_idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28513__$1,new cljs.core.Keyword(null,"end-idx","end-idx",-85750788));
var visible_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28513__$1,new cljs.core.Keyword(null,"visible-columns","visible-columns",1134718660));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_col,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"space-y-4 p-4"], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.layout.flex_row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),["flex-wrap gap-4 items-end ",bb_web_ds_tools.theme.bg_toolbar," p-2 rounded shadow-sm"].join('')], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.label,"Rows"], null),new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.select,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),"py-1",new cljs.core.Keyword(null,"value","value",305978217),rows_per_page,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__28508_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"rows-per-page","rows-per-page",249655959),parseInt(p1__28508_SHARP_.target.value)], null));
...
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"page","page",849072397),(page + (1))], null));
}),new cljs.core.Keyword(null,"disabled","disabled",-1529784218),(end_idx >= total_rows)], null),"Next"], null)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.table_container,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.table,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.thead,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__28515(s__28516){
return (new cljs.core.LazySeq(null,(function (){
var s__28516__$1 = s__28516;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__28516__$1);
if(temp__5825__auto__){
var s__28516__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__28516__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__28516__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__28518 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__28517 = (0);
while(true){
if((i__28517 < size__5502__auto__)){
var col = cljs.core._nth(c__5501__auto__,i__28517);
cljs.core.chunk_append(b__28518,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.th,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["cursor-pointer ",bb_web_ds_tools.theme.bg_item_hover].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__28517,col,c__5501__auto__,size__5502__auto__,b__28518,s__28516__$2,temp__5825__auto__,map__28511,map__28511__$1,id,data,columns,view_state,map__28512,map__28512__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28513,map__28513__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
...
});})(i__28517,col,c__5501__auto__,size__5502__auto__,b__28518,s__28516__$2,temp__5825__auto__,map__28511,map__28511__$1,id,data,columns,view_state,map__28512,map__28512__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28513,map__28513__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28518),bb_web_ds_tools$views$datasets$data_table_$_iter__28515(cljs.core.chunk_rest(s__28516__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28518),null);
}
} else {
var col = cljs.core.first(s__28516__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.th,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),col,new cljs.core.Keyword(null,"class","class",-2030961996),["cursor-pointer ",bb_web_ds_tools.theme.bg_item_hover].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (col,s__28516__$2,temp__5825__auto__,map__28511,map__28511__$1,id,data,columns,view_state,map__28512,map__28512__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28513,map__28513__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
var new_dir = ((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_col,col)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))))?new cljs.core.Keyword(null,"desc","desc",2093485764):new cljs.core.Keyword(null,"asc","asc",356854569));
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"sort-col","sort-col",-718754882),col], null));

return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757),new_dir], null));
});})(col,s__28516__$2,temp__5825__auto__,map__28511,map__28511__$1,id,data,columns,view_state,map__28512,map__28512__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28513,map__28513__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex items-center space-x-1"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),cljs.core.name(col)], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_col,col))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-[10px] transform translate-y-px"], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_dir,new cljs.core.Keyword(null,"asc","asc",356854569)))?"\u25B2":"\u25BC")], null):null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__28515(cljs.core.rest(s__28516__$2)));
}
} else {
return null;
}
...
})()], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tbody,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__28521(s__28522){
return (new cljs.core.LazySeq(null,(function (){
var s__28522__$1 = s__28522;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__28522__$1);
if(temp__5825__auto__){
var s__28522__$2 = temp__5825__auto__;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28524),bb_web_ds_tools$views$datasets$data_table_$_iter__28521(cljs.core.chunk_rest(s__28522__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28524),null);
}
} else {
var col = cljs.core.first(s__28522__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),["filter-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(col)].join(''),new cljs.core.Keyword(null,"class","class",-2030961996),"px-3 py-1.5"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-sm",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),["Filter ",cljs.core.name(col)].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(filters,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__28522__$2,temp__5825__auto__,map__28511,map__28511__$1,id,data,columns,view_state,map__28512,map__28512__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28513,map__28513__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__28509_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-view-state","bb-web-ds-tools.views.datasets/update-view-state",951614371),id,new cljs.core.Keyword(null,"filters","filters",974726919),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(filters,col,p1__28509_SHARP_.target.value)], null));
});})(col,s__28522__$2,temp__5825__auto__,map__28511,map__28511__$1,id,data,columns,view_state,map__28512,map__28512__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28513,map__28513__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__28521(cljs.core.rest(s__28522__$2)));
}
} else {
return null;
}
...
return iter__5503__auto__(visible_columns);
})()], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$data_table_$_iter__28527(s__28528){
return (new cljs.core.LazySeq(null,(function (){
var s__28528__$1 = s__28528;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__28528__$1);
if(temp__5825__auto__){
var s__28528__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__28528__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__28528__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__28530 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__28529 = (0);
while(true){
if((i__28529 < size__5502__auto__)){
var row = cljs.core._nth(c__5501__auto__,i__28529);
cljs.core.chunk_append(b__28530,(function (){var row_uuid = new cljs.core.Keyword(null,"_uuid","_uuid",797900280).cljs$core$IFn$_invoke$arity$1(row);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row_uuid], null),(function (){var iter__5503__auto__ = ((function (i__28529,row_uuid,row,c__5501__auto__,size__5502__auto__,b__28530,s__28528__$2,temp__5825__auto__,map__28511,map__28511__$1,id,data,columns,view_state,map__28512,map__28512__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28513,map__28513__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function bb_web_ds_tools$views$datasets$data_table_$_iter__28527_$_iter__28531(s__28532){
return (new cljs.core.LazySeq(null,((function (i__28529,row_uuid,row,c__5501__auto__,size__5502__auto__,b__28530,s__28528__$2,temp__5825__auto__,map__28511,map__28511__$1,id,data,columns,view_state,map__28512,map__28512__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28513,map__28513__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (){
var s__28532__$1 = s__28532;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__28532__$1);
if(temp__5825__auto____$1){
var s__28532__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__28532__$2)){
var c__5501__auto____$1 = cljs.core.chunk_first(s__28532__$2);
var size__5502__auto____$1 = cljs.core.count(c__5501__auto____$1);
var b__28534 = cljs.core.chunk_buffer(size__5502__auto____$1);
if((function (){var i__28533 = (0);
while(true){
if((i__28533 < size__5502__auto____$1)){
var col = cljs.core._nth(c__5501__auto____$1,i__28533);
cljs.core.chunk_append(b__28534,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__28533,i__28529,col,c__5501__auto____$1,size__5502__auto____$1,b__28534,s__28532__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__28530,s__28528__$2,temp__5825__auto__,map__28511,map__28511__$1,id,data,columns,view_state,map__28512,map__28512__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28513,map__28513__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__28510_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__28510_SHARP_.target.value], null));
});})(i__28533,i__28529,col,c__5501__auto____$1,size__5502__auto____$1,b__28534,s__28532__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__28530,s__28528__$2,temp__5825__auto__,map__28511,map__28511__$1,id,data,columns,view_state,map__28512,map__28512__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28513,map__28513__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__28634 = (i__28533 + (1));
i__28533 = G__28634;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28534),bb_web_ds_tools$views$datasets$data_table_$_iter__28527_$_iter__28531(cljs.core.chunk_rest(s__28532__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28534),null);
}
} else {
var col = cljs.core.first(s__28532__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__28529,col,s__28532__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__28530,s__28528__$2,temp__5825__auto__,map__28511,map__28511__$1,id,data,columns,view_state,map__28512,map__28512__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28513,map__28513__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__28510_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__28510_SHARP_.target.value], null));
});})(i__28529,col,s__28532__$2,temp__5825__auto____$1,row_uuid,row,c__5501__auto__,size__5502__auto__,b__28530,s__28528__$2,temp__5825__auto__,map__28511,map__28511__$1,id,data,columns,view_state,map__28512,map__28512__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28513,map__28513__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__28527_$_iter__28531(cljs.core.rest(s__28532__$2)));
}
} else {
return null;
}
...
});})(i__28529,row_uuid,row,c__5501__auto__,size__5502__auto__,b__28530,s__28528__$2,temp__5825__auto__,map__28511,map__28511__$1,id,data,columns,view_state,map__28512,map__28512__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28513,map__28513__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
,null,null));
});})(i__28529,row_uuid,row,c__5501__auto__,size__5502__auto__,b__28530,s__28528__$2,temp__5825__auto__,map__28511,map__28511__$1,id,data,columns,view_state,map__28512,map__28512__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28513,map__28513__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
;
return iter__5503__auto__(visible_columns);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28530),bb_web_ds_tools$views$datasets$data_table_$_iter__28527(cljs.core.chunk_rest(s__28528__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28530),null);
}
} else {
var row = cljs.core.first(s__28528__$2);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.tr,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row_uuid], null),(function (){var iter__5503__auto__ = ((function (row_uuid,row,s__28528__$2,temp__5825__auto__,map__28511,map__28511__$1,id,data,columns,view_state,map__28512,map__28512__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28513,map__28513__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function bb_web_ds_tools$views$datasets$data_table_$_iter__28527_$_iter__28537(s__28538){
return (new cljs.core.LazySeq(null,(function (){
var s__28538__$1 = s__28538;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__28538__$1);
if(temp__5825__auto____$1){
var s__28538__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__28538__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__28538__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__28540 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__28539 = (0);
while(true){
if((i__28539 < size__5502__auto__)){
var col = cljs.core._nth(c__5501__auto__,i__28539);
cljs.core.chunk_append(b__28540,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__28539,col,c__5501__auto__,size__5502__auto__,b__28540,s__28538__$2,temp__5825__auto____$1,row_uuid,row,s__28528__$2,temp__5825__auto__,map__28511,map__28511__$1,id,data,columns,view_state,map__28512,map__28512__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28513,map__28513__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__28510_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__28510_SHARP_.target.value], null));
});})(i__28539,col,c__5501__auto__,size__5502__auto__,b__28540,s__28538__$2,temp__5825__auto____$1,row_uuid,row,s__28528__$2,temp__5825__auto__,map__28511,map__28511__$1,id,data,columns,view_state,map__28512,map__28512__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28513,map__28513__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null));

var G__28637 = (i__28539 + (1));
i__28539 = G__28637;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28540),bb_web_ds_tools$views$datasets$data_table_$_iter__28527_$_iter__28537(cljs.core.chunk_rest(s__28538__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28540),null);
}
} else {
var col = cljs.core.first(s__28538__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.td,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),col], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"class","class",-2030961996),["bg-transparent focus:",bb_web_ds_tools.theme.bg_input," focus:ring-1 ",bb_web_ds_tools.theme.ring_focus," rounded px-1 outline-none border-0"].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get.cljs$core$IFn$_invoke$arity$3(row,col,""),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (col,s__28538__$2,temp__5825__auto____$1,row_uuid,row,s__28528__$2,temp__5825__auto__,map__28511,map__28511__$1,id,data,columns,view_state,map__28512,map__28512__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28513,map__28513__$1,page_data,total_rows,start_idx,end_idx,visible_columns){
return (function (p1__28510_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.datasets","update-cell","bb-web-ds-tools.views.datasets/update-cell",-1975400601),id,row_uuid,col,p1__28510_SHARP_.target.value], null));
});})(col,s__28538__$2,temp__5825__auto____$1,row_uuid,row,s__28528__$2,temp__5825__auto__,map__28511,map__28511__$1,id,data,columns,view_state,map__28512,map__28512__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28513,map__28513__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
], null)], null)], null),bb_web_ds_tools$views$datasets$data_table_$_iter__28527_$_iter__28537(cljs.core.rest(s__28538__$2)));
}
} else {
return null;
}
...
});})(row_uuid,row,s__28528__$2,temp__5825__auto__,map__28511,map__28511__$1,id,data,columns,view_state,map__28512,map__28512__$1,page,rows_per_page,filters,hidden_columns,sort_col,sort_dir,map__28513,map__28513__$1,page_data,total_rows,start_idx,end_idx,visible_columns))
;
return iter__5503__auto__(visible_columns);
})()], null);
})(),bb_web_ds_tools$views$datasets$data_table_$_iter__28527(cljs.core.rest(s__28528__$2)));
}
} else {
return null;
}
...
})], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.dustbin_icon,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"w-5 h-5"], null)], null)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.datasets.data_table,dataset], null)], null);
});
...
})], null),"+ New Dataset"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex-grow overflow-y-auto p-2 space-y-1"], null),((cljs.core.seq(items))?(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$datasets$dataset_list_$_iter__28582(s__28583){
return (new cljs.core.LazySeq(null,(function (){
var s__28583__$1 = s__28583;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__28583__$1);
if(temp__5825__auto__){
var s__28583__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__28583__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__28583__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__28585 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__28584 = (0);
while(true){
if((i__28584 < size__5502__auto__)){
var vec__28586 = cljs.core._nth(c__5501__auto__,i__28584);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28586,(0),null);
var ds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28586,(1),null);
cljs.core.chunk_append(b__28585,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.datasets.dataset_list_item,id,ds,active_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__28650 = (i__28584 + (1));
i__28584 = G__28650;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28585),bb_web_ds_tools$views$datasets$dataset_list_$_iter__28582(cljs.core.chunk_rest(s__28583__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28585),null);
}
} else {
var vec__28599 = cljs.core.first(s__28583__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28599,(0),null);
var ds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28599,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.datasets.dataset_list_item,id,ds,active_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),bb_web_ds_tools$views$datasets$dataset_list_$_iter__28582(cljs.core.rest(s__28583__$2)));
}
} else {
return null;
}
