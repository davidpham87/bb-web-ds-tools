...
}catch (e37511){if((e37511 instanceof Error)){
var e = e37511;
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.gemma","set-loading","bb-web-ds-tools.views.gemma/set-loading",1961048351),(function (db,p__37515){
var vec__37516 = p__37515;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37516,(0),null);
var loading_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37516,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.gemma","set-error","bb-web-ds-tools.views.gemma/set-error",1578779084),(function (db,p__37519){
var vec__37520 = p__37519;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37520,(0),null);
var error = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37520,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.gemma","add-message","bb-web-ds-tools.views.gemma/add-message",-287683400),(function (db,p__37523){
var vec__37524 = p__37523;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37524,(0),null);
var role = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37524,(1),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37524,(2),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.gemma","load-model","bb-web-ds-tools.views.gemma/load-model",595672016),(function (p__37529,p__37530){
var map__37531 = p__37529;
var map__37531__$1 = cljs.core.__destructure_map(map__37531);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37531__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__37533 = p__37530;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37533,(0),null);
var model_url = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37533,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.gemma","send-message","bb-web-ds-tools.views.gemma/send-message",1070168611),(function (p__37543,p__37544){
var map__37545 = p__37543;
var map__37545__$1 = cljs.core.__destructure_map(map__37545);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37545__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__37546 = p__37544;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37546,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37546,(1),null);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [fork.reagent.form,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"initial-values","initial-values",1392120293),new cljs.core.PersistentArrayMap(null, 1, ["url",""], null),new cljs.core.Keyword(null,"prevent-default?","prevent-default?",-1165567888),true,new cljs.core.Keyword(null,"on-submit","on-submit",1227871159),(function (p__37549){
var map__37550 = p__37549;
var map__37550__$1 = cljs.core.__destructure_map(map__37550);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37550__$1,new cljs.core.Keyword(null,"values","values",372645556));
...
var loading_QMARK_ = cljs.core.deref(loading_QMARK__sub);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [fork.reagent.form,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"initial-values","initial-values",1392120293),new cljs.core.PersistentArrayMap(null, 1, ["text",""], null),new cljs.core.Keyword(null,"prevent-default?","prevent-default?",-1165567888),true,new cljs.core.Keyword(null,"on-submit","on-submit",1227871159),(function (p__37555){
var map__37556 = p__37555;
var map__37556__$1 = cljs.core.__destructure_map(map__37556);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37556__$1,new cljs.core.Keyword(null,"values","values",372645556));
var reset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37556__$1,new cljs.core.Keyword(null,"reset","reset",-800929946));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37563),bb_web_ds_tools$views$gemma$chat_interface_$_iter__37560(cljs.core.chunk_rest(s__37561__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37563),null);
}
} else {
var vec__37568 = cljs.core.first(s__37561__$2);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37568,(0),null);
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37568,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),idx,new cljs.core.Keyword(null,"class","class",-2030961996),["mb-4 ",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"role","role",-736691072).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"user","user",1532431356)))?"text-right":"text-left")].join('')], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),["inline-block px-4 py-2 rounded-lg max-w-[80%] ",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"role","role",-736691072).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"user","user",1532431356)))?"bg-[#7f9f7f] text-[#3f3f3f]":"bg-[#4f4f4f] text-[#dcdccc] border border-[#5f5f5f]")].join('')], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-xs opacity-75 mb-1 font-bold"], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"role","role",-736691072).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"user","user",1532431356)))?"You":"Gemma")], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.Keyword(null,"content","content",15833224).cljs$core$IFn$_invoke$arity$1(msg)], null)], null)], null),bb_web_ds_tools$views$gemma$chat_interface_$_iter__37560(cljs.core.rest(s__37561__$2)));
}
} else {
return null;
}
