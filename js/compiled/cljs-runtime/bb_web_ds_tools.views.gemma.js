...
}catch (e37526){if((e37526 instanceof Error)){
var e = e37526;
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.gemma","set-loading","bb-web-ds-tools.views.gemma/set-loading",1961048351),(function (db,p__37528){
var vec__37529 = p__37528;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37529,(0),null);
var loading_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37529,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.gemma","set-error","bb-web-ds-tools.views.gemma/set-error",1578779084),(function (db,p__37532){
var vec__37533 = p__37532;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37533,(0),null);
var error = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37533,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.gemma","add-message","bb-web-ds-tools.views.gemma/add-message",-287683400),(function (db,p__37540){
var vec__37541 = p__37540;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37541,(0),null);
var role = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37541,(1),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37541,(2),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.gemma","load-model","bb-web-ds-tools.views.gemma/load-model",595672016),(function (p__37544,p__37545){
var map__37546 = p__37544;
var map__37546__$1 = cljs.core.__destructure_map(map__37546);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37546__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__37547 = p__37545;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37547,(0),null);
var model_url = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37547,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.gemma","send-message","bb-web-ds-tools.views.gemma/send-message",1070168611),(function (p__37550,p__37551){
var map__37552 = p__37550;
var map__37552__$1 = cljs.core.__destructure_map(map__37552);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37552__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__37553 = p__37551;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37553,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37553,(1),null);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [fork.reagent.form,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"initial-values","initial-values",1392120293),new cljs.core.PersistentArrayMap(null, 1, ["url",""], null),new cljs.core.Keyword(null,"prevent-default?","prevent-default?",-1165567888),true,new cljs.core.Keyword(null,"on-submit","on-submit",1227871159),(function (p__37569){
var map__37570 = p__37569;
var map__37570__$1 = cljs.core.__destructure_map(map__37570);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37570__$1,new cljs.core.Keyword(null,"values","values",372645556));
...
})], null),(function (p__37571){
var map__37572 = p__37571;
var map__37572__$1 = cljs.core.__destructure_map(map__37572);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37572__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37572__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var handle_blur = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37572__$1,new cljs.core.Keyword(null,"handle-blur","handle-blur",-546639264));
var handle_submit = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37572__$1,new cljs.core.Keyword(null,"handle-submit","handle-submit",1732326917));
...
var loading_QMARK_ = cljs.core.deref(loading_QMARK__sub);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [fork.reagent.form,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"initial-values","initial-values",1392120293),new cljs.core.PersistentArrayMap(null, 1, ["text",""], null),new cljs.core.Keyword(null,"prevent-default?","prevent-default?",-1165567888),true,new cljs.core.Keyword(null,"on-submit","on-submit",1227871159),(function (p__37574){
var map__37575 = p__37574;
var map__37575__$1 = cljs.core.__destructure_map(map__37575);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37575__$1,new cljs.core.Keyword(null,"values","values",372645556));
var reset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37575__$1,new cljs.core.Keyword(null,"reset","reset",-800929946));
...
})], null),(function (p__37576){
var map__37577 = p__37576;
var map__37577__$1 = cljs.core.__destructure_map(map__37577);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37577__$1,new cljs.core.Keyword(null,"values","values",372645556));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37577__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
var handle_blur = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37577__$1,new cljs.core.Keyword(null,"handle-blur","handle-blur",-546639264));
var handle_submit = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37577__$1,new cljs.core.Keyword(null,"handle-submit","handle-submit",1732326917));
...
var vec__37591 = cljs.core._nth(c__5501__auto__,i__37580);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37591,(0),null);
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37591,(1),null);
...
var vec__37594 = cljs.core.first(s__37579__$2);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37594,(0),null);
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37594,(1),null);
