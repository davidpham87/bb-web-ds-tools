...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_25902 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_25902(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_25903 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_25903(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_25904 = (function (reader,ch){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_25904(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_25908 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_25908(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_25909 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_25909(reader);
}
});
...
var G__25915 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__25916 = s.append(c);
c = G__25915;
s = G__25916;
continue;
}
