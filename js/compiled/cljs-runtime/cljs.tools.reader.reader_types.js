...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_25918 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_25918(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_25919 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_25919(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_25920 = (function (reader,ch){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_25920(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_25922 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_25922(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_25930 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_25930(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_25931 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_25931(reader);
}
});
...
var G__25943 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__25944 = s.append(c);
c = G__25943;
s = G__25944;
continue;
}
