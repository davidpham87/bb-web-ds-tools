...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_25911 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_25911(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_25912 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_25912(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_25913 = (function (reader,ch){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_25913(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_25914 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_25914(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_25915 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_25915(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_25916 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_25916(reader);
}
});
...
var G__25932 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__25933 = s.append(c);
c = G__25932;
s = G__25933;
continue;
}
