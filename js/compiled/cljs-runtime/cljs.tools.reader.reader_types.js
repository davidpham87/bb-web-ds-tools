...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_25906 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_25906(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_25907 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_25907(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_25908 = (function (reader,ch){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_25908(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_25909 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_25909(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_25910 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_25910(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_25911 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_25911(reader);
}
});
...
var G__25925 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__25926 = s.append(c);
c = G__25925;
s = G__25926;
continue;
}
