...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_27815 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_27815(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_27816 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_27816(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27817 = (function (reader,ch){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27817(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27821 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27821(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27822 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27822(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27823 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27823(reader);
}
});
...
var G__27841 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__27842 = s.append(c);
c = G__27841;
s = G__27842;
continue;
}
