...
fork.core.initialize_state = (function fork$core$initialize_state(p__37238){
var map__37239 = p__37238;
var map__37239__$1 = cljs.core.__destructure_map(map__37239);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37239__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var keywordize_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37239__$1,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252));
var initial_values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37239__$1,new cljs.core.Keyword(null,"initial-values","initial-values",1392120293));
var initial_touched = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37239__$1,new cljs.core.Keyword(null,"initial-touched","initial-touched",-1887894494));
...
var el_name = (function (){var G__37241 = t;
...
fork.core.normalize_name = (function fork$core$normalize_name(k,p__37242){
var map__37243 = p__37242;
var map__37243__$1 = cljs.core.__destructure_map(map__37243);
var keywordize_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37243__$1,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252));
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,(function (p1__37247_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$4(p1__37247_SHARP_,new cljs.core.Keyword(null,"values","values",372645556),cljs.core.merge,new_values),new cljs.core.Keyword(null,"touched","touched",-609134419),(function (x,y){
...
return cljs.core.not_empty(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__37250){
var vec__37251 = p__37250;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37251,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37251,(1),null);
...
var len__5749__auto___37328 = arguments.length;
var i__5750__auto___37329 = (0);
while(true){
if((i__5750__auto___37329 < len__5749__auto___37328)){
args__5755__auto__.push((arguments[i__5750__auto___37329]));

var G__37330 = (i__5750__auto___37329 + (1));
i__5750__auto___37329 = G__37330;
continue;
} else {
}
break;
...
var ks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37261,(0),null);
...
var args__5755__auto__ = [];
var len__5749__auto___37351 = arguments.length;
var i__5750__auto___37352 = (0);
while(true){
if((i__5750__auto___37352 < len__5749__auto___37351)){
args__5755__auto__.push((arguments[i__5750__auto___37352]));

var G__37353 = (i__5750__auto___37352 + (1));
i__5750__auto___37352 = G__37353;
continue;
} else {
}
break;
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.update,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181),(function (p1__37264_SHARP_){
return fork.core.enable_logic(p1__37264_SHARP_,ks);
}));
}));
...
/** @this {Function} */
(fork.core.enable.cljs$lang$applyTo = (function (seq37265){
var G__37266 = cljs.core.first(seq37265);
var seq37265__$1 = cljs.core.next(seq37265);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37266,seq37265__$1);
}));
...
fork.core.set_handle_change_one = (function fork$core$set_handle_change_one(deref_state,p__37274){
var map__37275 = p__37274;
var map__37275__$1 = cljs.core.__destructure_map(map__37275);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37275__$1,new cljs.core.Keyword(null,"value","value",305978217));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37275__$1,new cljs.core.Keyword(null,"path","path",-188191168));
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,(function (p1__37276_SHARP_){
return fork.core.set_handle_change_one(p1__37276_SHARP_,params);
}));
} else {
...
fork.core.set_handle_blur = (function fork$core$set_handle_blur(p__37277,state){
var map__37278 = p__37277;
var map__37278__$1 = cljs.core.__destructure_map(map__37278);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37278__$1,new cljs.core.Keyword(null,"value","value",305978217));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37278__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var path__$1 = fork.core.vectorize_path(path);
...
var vec__37282 = cljs.core.last(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__37281_SHARP_,p2__37280_SHARP_){
if(typeof p2__37280_SHARP_ === 'number'){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__37281_SHARP_,p2__37280_SHARP_], null);
} else {
return null;
}
}),touched_el)));
var position = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37282,(0),null);
var curr_idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37282,(1),null);
if((curr_idx > idx)){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(s,cljs.core.cons(new cljs.core.Keyword(null,"values","values",372645556),vec_field_array_key),fork.core.vec_remove,idx),new cljs.core.Keyword(null,"touched","touched",-609134419),(function (p1__37285_SHARP_){
return fork.core.fieldarray_update_touched(p1__37285_SHARP_,vec_field_array_key,idx);
}));
}));
});
...
fork.core.handle_submit = (function fork$core$handle_submit(evt,p__37287){
var map__37288 = p__37287;
var map__37288__$1 = cljs.core.__destructure_map(map__37288);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37288__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var server = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37288__$1,new cljs.core.Keyword(null,"server","server",1499190120));
var on_submit = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37288__$1,new cljs.core.Keyword(null,"on-submit","on-submit",1227871159));
var prevent_default_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37288__$1,new cljs.core.Keyword(null,"prevent-default?","prevent-default?",-1165567888));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37288__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var validation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37288__$1,new cljs.core.Keyword(null,"validation","validation",-2141396518));
var already_submitting_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37288__$1,new cljs.core.Keyword(null,"already-submitting?","already-submitting?",1438118407));
var reset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37288__$1,new cljs.core.Keyword(null,"reset","reset",-800929946));
...
if(((cljs.core.not(already_submitting_QMARK_)) && ((((validation == null)) && ((((fork.core.resolve_server_validation(server) == null)) && (cljs.core.every_QMARK_((function (p1__37286_SHARP_){
return new cljs.core.Keyword(null,"waiting?","waiting?",-2117257215).cljs$core$IFn$_invoke$arity$1(p1__37286_SHARP_) === false;
...
return (on_submit.cljs$core$IFn$_invoke$arity$1 ? on_submit.cljs$core$IFn$_invoke$arity$1(G__37293) : on_submit.call(null,G__37293));
} else {
return null;
}
});
fork.core.send_server_request = (function fork$core$send_server_request(http_fn,p__37298){
var map__37299 = p__37298;
var map__37299__$1 = cljs.core.__destructure_map(map__37299);
var validation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37299__$1,new cljs.core.Keyword(null,"validation","validation",-2141396518));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37299__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var debounce = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37299__$1,new cljs.core.Keyword(null,"debounce","debounce",-871550296));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37299__$1,new cljs.core.Keyword(null,"value","value",305978217));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37299__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var evt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37299__$1,new cljs.core.Keyword(null,"evt","evt",-1251566867));
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37299__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var server_dispatch_logic = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37299__$1,new cljs.core.Keyword(null,"server-dispatch-logic","server-dispatch-logic",-465441551));
var throttle = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37299__$1,new cljs.core.Keyword(null,"throttle","throttle",-1860340776));
var input_key = name;
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.update_in,cljs.core.cons(new cljs.core.Keyword(null,"values","values",372645556),vec_field_array_key),(function (p1__37311_SHARP_){
return fork.core.vec_insert_at(fork.core.vec_remove(p1__37311_SHARP_,dragged_idx),dropped_idx,cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__37311_SHARP_,dragged_idx));
}));
});
fork.core.current_target_idx = (function fork$core$current_target_idx(state,k){
var G__37312 = cljs.core.deref(state);
var G__37312__$1 = (((G__37312 == null))?null:new cljs.core.Keyword(null,"drag-and-drop","drag-and-drop",-1528484051).cljs$core$IFn$_invoke$arity$1(G__37312));
var G__37312__$2 = (((G__37312__$1 == null))?null:(k.cljs$core$IFn$_invoke$arity$1 ? k.cljs$core$IFn$_invoke$arity$1(G__37312__$1) : k.call(null,G__37312__$1)));
if((G__37312__$2 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"idx-of-element-droppable-location","idx-of-element-droppable-location",1338425922).cljs$core$IFn$_invoke$arity$1(G__37312__$2);
}
});
fork.core.current_dragged_idx = (function fork$core$current_dragged_idx(state,k){
var G__37313 = cljs.core.deref(state);
var G__37313__$1 = (((G__37313 == null))?null:new cljs.core.Keyword(null,"drag-and-drop","drag-and-drop",-1528484051).cljs$core$IFn$_invoke$arity$1(G__37313));
var G__37313__$2 = (((G__37313__$1 == null))?null:(k.cljs$core$IFn$_invoke$arity$1 ? k.cljs$core$IFn$_invoke$arity$1(G__37313__$1) : k.call(null,G__37313__$1)));
if((G__37313__$2 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"idx-of-item-being-dragged","idx-of-item-being-dragged",1912676382).cljs$core$IFn$_invoke$arity$1(G__37313__$2);
}
});
...
}),(function (p1__37315_SHARP_){
return fork.core.set_handle_blur(p1__37315_SHARP_,state);
...
}),(function (p1__37314_SHARP_){
return fork.core.set_handle_change(p1__37314_SHARP_,state);
}),(function (k,idx){
...
return (function (p__37318,component){
var map__37319 = p__37318;
var map__37319__$1 = cljs.core.__destructure_map(map__37319);
var args = map__37319__$1;
var props__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37319__$1,new cljs.core.Keyword(null,"props","props",453281727));
