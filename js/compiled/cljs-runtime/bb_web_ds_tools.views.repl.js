...
var map__49424 = msg;
var map__49424__$1 = cljs.core.__destructure_map(map__49424);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49424__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49424__$1,new cljs.core.Keyword(null,"event","event",301435442));
var G__49425 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(type);
var G__49425__$1 = (((G__49425 instanceof cljs.core.Keyword))?G__49425.fqn:null);
switch (G__49425__$1) {
case "dispatch":
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.repl","eval-code","bb-web-ds-tools.views.repl/eval-code",1526213909),(function (p__49441,p__49442){
var map__49443 = p__49441;
var map__49443__$1 = cljs.core.__destructure_map(map__49443);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49443__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__49444 = p__49442;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49444,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49444,(1),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49444,(2),null);
if(cljs.core.truth_(cljs.core.deref(bb_web_ds_tools.views.repl.sci_worker))){
...
var vec__49453 = p__49451;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49453,(0),null);
var instance_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49453,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.repl","update-code","bb-web-ds-tools.views.repl/update-code",-179820027),(function (db,p__49462){
var vec__49464 = p__49462;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49464,(0),null);
var instance_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49464,(1),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49464,(2),null);
...
i = G__49639;
stack = G__49640;
in_string_QMARK_ = G__49641;
continue;
} else {
if(cljs.core.contains_QMARK_(delims,c)){
var G__49642 = (i - (1));
var G__49643 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(stack,(delims.cljs$core$IFn$_invoke$arity$1 ? delims.cljs$core$IFn$_invoke$arity$1(c) : delims.call(null,c)));
var G__49644 = false;
i = G__49642;
stack = G__49643;
in_string_QMARK_ = G__49644;
continue;
} else {
...
var G__49646 = (i - (1));
var G__49647 = new_stack;
var G__49648 = false;
i = G__49646;
stack = G__49647;
in_string_QMARK_ = G__49648;
continue;
}
} else {
var G__49649 = (i - (1));
...
bb_web_ds_tools.views.repl.repl_instance = (function bb_web_ds_tools$views$repl$repl_instance(p__49561){
var map__49562 = p__49561;
var map__49562__$1 = cljs.core.__destructure_map(map__49562);
var instance_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49562__$1,new cljs.core.Keyword(null,"instance-id","instance-id",951361263));
...
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.repl","eval-code","bb-web-ds-tools.views.repl/eval-code",1526213909),instance_id,code], null));
})], null),"Eval"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),["flex-grow rounded overflow-hidden border w-screen-1/2",bb_web_ds_tools.theme.border_default].join(''),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"height","height",1025178622),"85vh"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.editor.monaco_editor,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"value","value",305978217),code,new cljs.core.Keyword(null,"language","language",-1591107564),"clojure",new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"rulers","rulers",756731282),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(80)], null),new cljs.core.Keyword(null,"lineNumbers","lineNumbers",1374890941),"off"], null),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__49558_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.repl","update-code","bb-web-ds-tools.views.repl/update-code",-179820027),instance_id,p1__49558_SHARP_], null));
}),new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840),(function (p1__49559_SHARP_){
return bb_web_ds_tools.views.repl.setup_editor_actions(p1__49559_SHARP_,instance_id,mac_os_QMARK_);
...
var vec__49593 = cljs.core._nth(c__5501__auto__,i__49586);
var instance_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49593,(0),null);
cljs.core.chunk_append(b__49587,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.repl.repl_instance,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"instance-id","instance-id",951361263),instance_id], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),instance_id], null)));

var G__49673 = (i__49586 + (1));
i__49586 = G__49673;
continue;
} else {
return true;
