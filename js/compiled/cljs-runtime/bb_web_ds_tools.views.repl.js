...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.repl","eval-code","bb-web-ds-tools.views.repl/eval-code",1526213909),(function (_,p__49710){
var vec__49712 = p__49710;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49712,(0),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49712,(1),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49712,(2),null);
...
var instance_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49742,(1),null);
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("bb-web-ds-tools.views.repl","repl-instance-state","bb-web-ds-tools.views.repl/repl-instance-state",1214249521),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p__49747,_){
var vec__49748 = p__49747;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49748,(0),null);
...
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49753,(0),null);
var mac_os_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49753,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.repl","update-code","bb-web-ds-tools.views.repl/update-code",-179820027),(function (db,p__49758){
var vec__49760 = p__49758;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49760,(0),null);
var instance_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49760,(1),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49760,(2),null);
...
i = G__49919;
stack = G__49920;
in_string_QMARK_ = G__49921;
continue;
} else {
if(cljs.core.contains_QMARK_(delims,c)){
var G__49922 = (i - (1));
var G__49923 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(stack,(delims.cljs$core$IFn$_invoke$arity$1 ? delims.cljs$core$IFn$_invoke$arity$1(c) : delims.call(null,c)));
var G__49924 = false;
i = G__49922;
stack = G__49923;
in_string_QMARK_ = G__49924;
continue;
} else {
...
var G__49925 = (i - (1));
var G__49926 = new_stack;
var G__49927 = false;
i = G__49925;
stack = G__49926;
in_string_QMARK_ = G__49927;
continue;
}
} else {
var G__49928 = (i - (1));
...
bb_web_ds_tools.views.repl.repl_instance = (function bb_web_ds_tools$views$repl$repl_instance(p__49818){
var map__49819 = p__49818;
var map__49819__$1 = cljs.core.__destructure_map(map__49819);
var instance_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49819__$1,new cljs.core.Keyword(null,"instance-id","instance-id",951361263));
...
return (function (){
var map__49824 = cljs.core.deref(state_sub);
var map__49824__$1 = cljs.core.__destructure_map(map__49824);
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49824__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var mac_os_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49824__$1,new cljs.core.Keyword(null,"mac-os?","mac-os?",-1478507137));
...
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.repl","eval-code","bb-web-ds-tools.views.repl/eval-code",1526213909),instance_id,code], null));
})], null),"Eval"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),["flex-grow rounded overflow-hidden border w-screen-1/2",bb_web_ds_tools.theme.border_default].join(''),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"height","height",1025178622),"85vh"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.editor.monaco_editor,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"value","value",305978217),code,new cljs.core.Keyword(null,"language","language",-1591107564),"clojure",new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"rulers","rulers",756731282),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(80)], null),new cljs.core.Keyword(null,"lineNumbers","lineNumbers",1374890941),"off"], null),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__49813_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("bb-web-ds-tools.views.repl","update-code","bb-web-ds-tools.views.repl/update-code",-179820027),instance_id,p1__49813_SHARP_], null));
}),new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840),(function (p1__49815_SHARP_){
return bb_web_ds_tools.views.repl.setup_editor_actions(p1__49815_SHARP_,instance_id,mac_os_QMARK_);
...
return bb_web_ds_tools.runtime.sci.init_BANG_();
...
var s__49856__$1 = s__49856;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__49856__$1);
if(temp__5825__auto__){
var s__49856__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__49856__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__49856__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__49858 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__49857 = (0);
while(true){
if((i__49857 < size__5502__auto__)){
var vec__49859 = cljs.core._nth(c__5501__auto__,i__49857);
var instance_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49859,(0),null);
cljs.core.chunk_append(b__49858,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.repl.repl_instance,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"instance-id","instance-id",951361263),instance_id], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),instance_id], null)));

var G__49960 = (i__49857 + (1));
i__49857 = G__49960;
continue;
} else {
return true;
