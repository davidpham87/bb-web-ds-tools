...
cljs.analyzer.passes.and_or.simple_test_expr_QMARK_ = (function cljs$analyzer$passes$and_or$simple_test_expr_QMARK_(p__46716){
var map__46717 = p__46716;
var map__46717__$1 = cljs.core.__destructure_map(map__46717);
var ast = map__46717__$1;
var op = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46717__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
return cljs.core.boolean$((function (){var and__5023__auto__ = cljs.analyzer.passes.and_or.simple_op_QMARK_(ast);
if(and__5023__auto__){
var G__46719 = (function (){var or__5025__auto__ = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(ast);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
if(cljs.core.truth_((function (){var fexpr__46720 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"var","var",-769682797),null,new cljs.core.Keyword(null,"local","local",-1497766724),null], null), null);
return (fexpr__46720.cljs$core$IFn$_invoke$arity$1 ? fexpr__46720.cljs$core$IFn$_invoke$arity$1(op) : fexpr__46720.call(null,op));
})())){
...
var fexpr__46718 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol(null,"seq","seq",-177272256,null),"null",new cljs.core.Symbol(null,"boolean","boolean",-278886877,null),"null"], null), null);
return (fexpr__46718.cljs$core$IFn$_invoke$arity$1 ? fexpr__46718.cljs$core$IFn$_invoke$arity$1(G__46719) : fexpr__46718.call(null,G__46719));
} else {
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__46727_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(local,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(p1__46727_SHARP_));
}),xs);
}));
}),loop_lets);
}));
...
var G__46728 = cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(ast,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"env","env",-1815813235),new cljs.core.Keyword(null,"locals","locals",535295783)], null),cljs.core.dissoc,local);
...
return cljs.analyzer.passes.and_or.remove_loop_let(G__46728,local);
} else {
return G__46728;
}
});
...
var map__46729 = cljs.core.first(new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ast));
var map__46729__$1 = cljs.core.__destructure_map(map__46729);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46729__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46729__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var map__46730 = cljs.core.first(new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ast));
var map__46730__$1 = cljs.core.__destructure_map(map__46730);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46730__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46730__$1,new cljs.core.Keyword(null,"name","name",1843675177));
