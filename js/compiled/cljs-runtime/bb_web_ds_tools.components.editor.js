...
try{var map__37179 = reagent.core.props(this$);
var map__37179__$1 = cljs.core.__destructure_map(map__37179);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37179__$1,new cljs.core.Keyword(null,"value","value",305978217));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37179__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37179__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37179__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37179__$1,new cljs.core.Keyword(null,"on-focus","on-focus",-13737624));
var on_blur = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37179__$1,new cljs.core.Keyword(null,"on-blur","on-blur",814300747));
var on_mount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37179__$1,new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37179__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var sub_37211 = editor.onDidChangeModelContent((function (){
cljs.core.reset_BANG_(ignore_change_QMARK_,true);

var new_val_37212 = editor.getValue();
var temp__5825__auto___37213 = cljs.core.deref(on_change_ref);
if(cljs.core.truth_(temp__5825__auto___37213)){
var handler_37214 = temp__5825__auto___37213;
if(cljs.core.vector_QMARK_(handler_37214)){
re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(handler_37214,new_val_37212));
} else {
(handler_37214.cljs$core$IFn$_invoke$arity$1 ? handler_37214.cljs$core$IFn$_invoke$arity$1(new_val_37212) : handler_37214.call(null,new_val_37212));
}
} else {
}
...
cljs.core.reset_BANG_(subscription,sub_37211);
...
}}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (this$,p__37182){
var vec__37184 = p__37182;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37184,(0),null);
var old_props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37184,(1),null);
var map__37187 = reagent.core.props(this$);
var map__37187__$1 = cljs.core.__destructure_map(map__37187);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37187__$1,new cljs.core.Keyword(null,"value","value",305978217));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37187__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37187__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37187__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37187__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var lang_37215 = (function (){var or__5025__auto__ = language;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
var G__37188 = mode;
...
var model_37216 = editor.getModel();
var current_lang_37217 = (cljs.core.truth_(model_37216)?model_37216.getLanguageId():null);
if(cljs.core.truth_((function (){var and__5023__auto__ = model_37216;
if(cljs.core.truth_(and__5023__auto__)){
var and__5023__auto____$1 = lang_37215;
if(cljs.core.truth_(and__5023__auto____$1)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(current_lang_37217,lang_37215);
} else {
...
shadow.js.shim.module$monaco_editor$esm$vs$editor$editor_api.editor.setModelLanguage(model_37216,lang_37215);
} else {
}
...
var temp__5825__auto___37219 = cljs.core.deref(subscription);
if(cljs.core.truth_(temp__5825__auto___37219)){
var sub_37220 = temp__5825__auto___37219;
sub_37220.dispose();
} else {
}
...
var map__37190 = props;
var map__37190__$1 = cljs.core.__destructure_map(map__37190);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37190__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37190__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var G__37201 = bb_web_ds_tools.components.editor.get_code_to_eval(ed);
return (eval_action.cljs$core$IFn$_invoke$arity$1 ? eval_action.cljs$core$IFn$_invoke$arity$1(G__37201) : eval_action.call(null,G__37201));
})], null)));
});
bb_web_ds_tools.components.editor.render_output = (function bb_web_ds_tools$components$editor$render_output(output){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$components$editor$render_output_$_iter__37202(s__37203){
return (new cljs.core.LazySeq(null,(function (){
var s__37203__$1 = s__37203;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__37203__$1);
if(temp__5825__auto__){
var s__37203__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__37203__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__37203__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__37205 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__37204 = (0);
while(true){
if((i__37204 < size__5502__auto__)){
var map__37206 = cljs.core._nth(c__5501__auto__,i__37204);
var map__37206__$1 = cljs.core.__destructure_map(map__37206);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37206__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37206__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
cljs.core.chunk_append(b__37205,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__37207 = type;
var G__37207__$1 = (((G__37207 instanceof cljs.core.Keyword))?G__37207.fqn:null);
switch (G__37207__$1) {
case "result":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__37207__$1)].join('')));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37205),bb_web_ds_tools$components$editor$render_output_$_iter__37202(cljs.core.chunk_rest(s__37203__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37205),null);
}
} else {
var map__37208 = cljs.core.first(s__37203__$2);
var map__37208__$1 = cljs.core.__destructure_map(map__37208);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37208__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37208__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__37209 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__37209__$1)].join('')));

}
})()], null),text], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.random_uuid()], null)),bb_web_ds_tools$components$editor$render_output_$_iter__37202(cljs.core.rest(s__37203__$2)));
}
} else {
return null;
}
