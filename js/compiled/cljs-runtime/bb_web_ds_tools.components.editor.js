...
try{var map__37187 = reagent.core.props(this$);
...
var on_focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37187__$1,new cljs.core.Keyword(null,"on-focus","on-focus",-13737624));
var on_blur = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37187__$1,new cljs.core.Keyword(null,"on-blur","on-blur",814300747));
var on_mount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37187__$1,new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840));
...
var sub_37220 = editor.onDidChangeModelContent((function (){
cljs.core.reset_BANG_(ignore_change_QMARK_,true);

var new_val_37221 = editor.getValue();
var temp__5825__auto___37222 = cljs.core.deref(on_change_ref);
if(cljs.core.truth_(temp__5825__auto___37222)){
var handler_37223 = temp__5825__auto___37222;
if(cljs.core.vector_QMARK_(handler_37223)){
re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(handler_37223,new_val_37221));
} else {
(handler_37223.cljs$core$IFn$_invoke$arity$1 ? handler_37223.cljs$core$IFn$_invoke$arity$1(new_val_37221) : handler_37223.call(null,new_val_37221));
}
} else {
}
...
cljs.core.reset_BANG_(subscription,sub_37220);
...
var lang_37225 = (function (){var or__5025__auto__ = language;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
var G__37203 = mode;
...
var model_37226 = editor.getModel();
var current_lang_37227 = (cljs.core.truth_(model_37226)?model_37226.getLanguageId():null);
if(cljs.core.truth_((function (){var and__5023__auto__ = model_37226;
if(cljs.core.truth_(and__5023__auto__)){
var and__5023__auto____$1 = lang_37225;
if(cljs.core.truth_(and__5023__auto____$1)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(current_lang_37227,lang_37225);
} else {
...
shadow.js.shim.module$monaco_editor$esm$vs$editor$editor_api.editor.setModelLanguage(model_37226,lang_37225);
} else {
}
...
var temp__5825__auto___37232 = cljs.core.deref(subscription);
if(cljs.core.truth_(temp__5825__auto___37232)){
var sub_37233 = temp__5825__auto___37232;
sub_37233.dispose();
} else {
}
...
var map__37205 = props;
var map__37205__$1 = cljs.core.__destructure_map(map__37205);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37205__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37205__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var G__37206 = bb_web_ds_tools.components.editor.get_code_to_eval(ed);
return (eval_action.cljs$core$IFn$_invoke$arity$1 ? eval_action.cljs$core$IFn$_invoke$arity$1(G__37206) : eval_action.call(null,G__37206));
})], null)));
});
bb_web_ds_tools.components.editor.render_output = (function bb_web_ds_tools$components$editor$render_output(output){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$components$editor$render_output_$_iter__37207(s__37208){
return (new cljs.core.LazySeq(null,(function (){
var s__37208__$1 = s__37208;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__37208__$1);
if(temp__5825__auto__){
var s__37208__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__37208__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__37208__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__37210 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__37209 = (0);
while(true){
if((i__37209 < size__5502__auto__)){
var map__37211 = cljs.core._nth(c__5501__auto__,i__37209);
var map__37211__$1 = cljs.core.__destructure_map(map__37211);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37211__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37211__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
cljs.core.chunk_append(b__37210,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__37215 = type;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37210),bb_web_ds_tools$components$editor$render_output_$_iter__37207(cljs.core.chunk_rest(s__37208__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37210),null);
}
} else {
var map__37216 = cljs.core.first(s__37208__$2);
var map__37216__$1 = cljs.core.__destructure_map(map__37216);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37216__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37216__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__37217 = type;
var G__37217__$1 = (((G__37217 instanceof cljs.core.Keyword))?G__37217.fqn:null);
switch (G__37217__$1) {
case "result":
return bb_web_ds_tools.theme.text_primary;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__37217__$1)].join('')));

}
})()], null),text], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.random_uuid()], null)),bb_web_ds_tools$components$editor$render_output_$_iter__37207(cljs.core.rest(s__37208__$2)));
}
} else {
return null;
}
