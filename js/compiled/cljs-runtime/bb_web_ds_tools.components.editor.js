...
return true;
}catch (e37067){if((e37067 instanceof Error)){
var e = e37067;
...
try{var map__37071 = reagent.core.props(this$);
var map__37071__$1 = cljs.core.__destructure_map(map__37071);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37071__$1,new cljs.core.Keyword(null,"value","value",305978217));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37071__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37071__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37071__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37071__$1,new cljs.core.Keyword(null,"on-focus","on-focus",-13737624));
var on_blur = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37071__$1,new cljs.core.Keyword(null,"on-blur","on-blur",814300747));
var on_mount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37071__$1,new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37071__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var sub_37111 = editor.onDidChangeModelContent((function (){
cljs.core.reset_BANG_(ignore_change_QMARK_,true);

var new_val_37112 = editor.getValue();
var temp__5825__auto___37113 = cljs.core.deref(on_change_ref);
if(cljs.core.truth_(temp__5825__auto___37113)){
var handler_37114 = temp__5825__auto___37113;
if(cljs.core.vector_QMARK_(handler_37114)){
re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(handler_37114,new_val_37112));
} else {
(handler_37114.cljs$core$IFn$_invoke$arity$1 ? handler_37114.cljs$core$IFn$_invoke$arity$1(new_val_37112) : handler_37114.call(null,new_val_37112));
}
} else {
}
...
cljs.core.reset_BANG_(subscription,sub_37111);
...
}catch (e37068){if((e37068 instanceof Error)){
var e = e37068;
...
}}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (this$,p__37074){
var vec__37075 = p__37074;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37075,(0),null);
var old_props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37075,(1),null);
var map__37078 = reagent.core.props(this$);
var map__37078__$1 = cljs.core.__destructure_map(map__37078);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37078__$1,new cljs.core.Keyword(null,"value","value",305978217));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37078__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37078__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37078__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37078__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var lang_37115 = (function (){var or__5025__auto__ = language;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
var G__37083 = mode;
...
var model_37116 = editor.getModel();
var current_lang_37117 = (cljs.core.truth_(model_37116)?model_37116.getLanguageId():null);
if(cljs.core.truth_((function (){var and__5023__auto__ = model_37116;
if(cljs.core.truth_(and__5023__auto__)){
var and__5023__auto____$1 = lang_37115;
if(cljs.core.truth_(and__5023__auto____$1)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(current_lang_37117,lang_37115);
} else {
...
shadow.js.shim.module$monaco_editor$esm$vs$editor$editor_api.editor.setModelLanguage(model_37116,lang_37115);
} else {
}
...
var temp__5825__auto___37119 = cljs.core.deref(subscription);
if(cljs.core.truth_(temp__5825__auto___37119)){
var sub_37120 = temp__5825__auto___37119;
sub_37120.dispose();
} else {
}
...
var map__37084 = props;
var map__37084__$1 = cljs.core.__destructure_map(map__37084);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37084__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
var G__37091 = bb_web_ds_tools.components.editor.get_code_to_eval(ed);
return (eval_action.cljs$core$IFn$_invoke$arity$1 ? eval_action.cljs$core$IFn$_invoke$arity$1(G__37091) : eval_action.call(null,G__37091));
})], null)));
});
bb_web_ds_tools.components.editor.render_output = (function bb_web_ds_tools$components$editor$render_output(output){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$components$editor$render_output_$_iter__37093(s__37094){
return (new cljs.core.LazySeq(null,(function (){
var s__37094__$1 = s__37094;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__37094__$1);
if(temp__5825__auto__){
var s__37094__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__37094__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__37094__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__37096 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__37095 = (0);
while(true){
if((i__37095 < size__5502__auto__)){
var map__37097 = cljs.core._nth(c__5501__auto__,i__37095);
var map__37097__$1 = cljs.core.__destructure_map(map__37097);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37097__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37097__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
cljs.core.chunk_append(b__37096,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__37099 = type;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37096),bb_web_ds_tools$components$editor$render_output_$_iter__37093(cljs.core.chunk_rest(s__37094__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37096),null);
}
} else {
var map__37100 = cljs.core.first(s__37094__$2);
var map__37100__$1 = cljs.core.__destructure_map(map__37100);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37100__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37100__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__37101 = type;
var G__37101__$1 = (((G__37101 instanceof cljs.core.Keyword))?G__37101.fqn:null);
switch (G__37101__$1) {
case "result":
return bb_web_ds_tools.theme.text_primary;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__37101__$1)].join('')));

}
})()], null),text], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.random_uuid()], null)),bb_web_ds_tools$components$editor$render_output_$_iter__37093(cljs.core.rest(s__37094__$2)));
}
} else {
return null;
}
