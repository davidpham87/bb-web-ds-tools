...
try{var map__37092 = reagent.core.props(this$);
var map__37092__$1 = cljs.core.__destructure_map(map__37092);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37092__$1,new cljs.core.Keyword(null,"value","value",305978217));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37092__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37092__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37092__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37092__$1,new cljs.core.Keyword(null,"on-focus","on-focus",-13737624));
var on_blur = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37092__$1,new cljs.core.Keyword(null,"on-blur","on-blur",814300747));
var on_mount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37092__$1,new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37092__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var sub_37213 = editor.onDidChangeModelContent((function (){
cljs.core.reset_BANG_(ignore_change_QMARK_,true);

var new_val_37214 = editor.getValue();
var temp__5825__auto___37215 = cljs.core.deref(on_change_ref);
if(cljs.core.truth_(temp__5825__auto___37215)){
var handler_37216 = temp__5825__auto___37215;
if(cljs.core.vector_QMARK_(handler_37216)){
re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(handler_37216,new_val_37214));
} else {
(handler_37216.cljs$core$IFn$_invoke$arity$1 ? handler_37216.cljs$core$IFn$_invoke$arity$1(new_val_37214) : handler_37216.call(null,new_val_37214));
}
} else {
}
...
cljs.core.reset_BANG_(subscription,sub_37213);
...
}}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (this$,p__37109){
var vec__37110 = p__37109;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37110,(0),null);
var old_props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37110,(1),null);
var map__37113 = reagent.core.props(this$);
var map__37113__$1 = cljs.core.__destructure_map(map__37113);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37113__$1,new cljs.core.Keyword(null,"value","value",305978217));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37113__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37113__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37113__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37113__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var lang_37217 = (function (){var or__5025__auto__ = language;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
var G__37127 = mode;
...
var model_37218 = editor.getModel();
var current_lang_37219 = (cljs.core.truth_(model_37218)?model_37218.getLanguageId():null);
if(cljs.core.truth_((function (){var and__5023__auto__ = model_37218;
if(cljs.core.truth_(and__5023__auto__)){
var and__5023__auto____$1 = lang_37217;
if(cljs.core.truth_(and__5023__auto____$1)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(current_lang_37219,lang_37217);
} else {
...
shadow.js.shim.module$monaco_editor$esm$vs$editor$editor_api.editor.setModelLanguage(model_37218,lang_37217);
} else {
}
...
var temp__5825__auto___37223 = cljs.core.deref(subscription);
if(cljs.core.truth_(temp__5825__auto___37223)){
var sub_37224 = temp__5825__auto___37223;
sub_37224.dispose();
} else {
}
...
var map__37159 = props;
var map__37159__$1 = cljs.core.__destructure_map(map__37159);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37159__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37159__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var G__37181 = bb_web_ds_tools.components.editor.get_code_to_eval(ed);
return (eval_action.cljs$core$IFn$_invoke$arity$1 ? eval_action.cljs$core$IFn$_invoke$arity$1(G__37181) : eval_action.call(null,G__37181));
})], null)));
});
bb_web_ds_tools.components.editor.render_output = (function bb_web_ds_tools$components$editor$render_output(output){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$components$editor$render_output_$_iter__37183(s__37184){
return (new cljs.core.LazySeq(null,(function (){
var s__37184__$1 = s__37184;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__37184__$1);
if(temp__5825__auto__){
var s__37184__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__37184__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__37184__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__37186 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__37185 = (0);
while(true){
if((i__37185 < size__5502__auto__)){
var map__37198 = cljs.core._nth(c__5501__auto__,i__37185);
var map__37198__$1 = cljs.core.__destructure_map(map__37198);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37198__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37198__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
cljs.core.chunk_append(b__37186,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__37199 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__37199__$1)].join('')));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37186),bb_web_ds_tools$components$editor$render_output_$_iter__37183(cljs.core.chunk_rest(s__37184__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37186),null);
}
} else {
var map__37200 = cljs.core.first(s__37184__$2);
...
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37200__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__37202 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__37202__$1)].join('')));

}
})()], null),text], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.random_uuid()], null)),bb_web_ds_tools$components$editor$render_output_$_iter__37183(cljs.core.rest(s__37184__$2)));
}
} else {
return null;
}
