...
return true;
}catch (e28210){if((e28210 instanceof Error)){
var e = e28210;
...
try{var map__28218 = reagent.core.props(this$);
var map__28218__$1 = cljs.core.__destructure_map(map__28218);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28218__$1,new cljs.core.Keyword(null,"value","value",305978217));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28218__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28218__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28218__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28218__$1,new cljs.core.Keyword(null,"on-focus","on-focus",-13737624));
var on_blur = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28218__$1,new cljs.core.Keyword(null,"on-blur","on-blur",814300747));
var on_mount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28218__$1,new cljs.core.Keyword(null,"on-mount","on-mount",-1236735840));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28218__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var sub_28255 = editor.onDidChangeModelContent((function (){
cljs.core.reset_BANG_(ignore_change_QMARK_,true);

var new_val_28256 = editor.getValue();
var temp__5825__auto___28257 = cljs.core.deref(on_change_ref);
if(cljs.core.truth_(temp__5825__auto___28257)){
var handler_28258 = temp__5825__auto___28257;
if(cljs.core.vector_QMARK_(handler_28258)){
re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(handler_28258,new_val_28256));
} else {
(handler_28258.cljs$core$IFn$_invoke$arity$1 ? handler_28258.cljs$core$IFn$_invoke$arity$1(new_val_28256) : handler_28258.call(null,new_val_28256));
}
} else {
}
...
cljs.core.reset_BANG_(subscription,sub_28255);
...
}}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (this$,p__28223){
var vec__28224 = p__28223;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28224,(0),null);
var old_props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28224,(1),null);
var map__28227 = reagent.core.props(this$);
var map__28227__$1 = cljs.core.__destructure_map(map__28227);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28227__$1,new cljs.core.Keyword(null,"value","value",305978217));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28227__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28227__$1,new cljs.core.Keyword(null,"mode","mode",654403691));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28227__$1,new cljs.core.Keyword(null,"options","options",99638489));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28227__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var lang_28259 = (function (){var or__5025__auto__ = language;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
var G__28234 = mode;
...
var model_28260 = editor.getModel();
var current_lang_28261 = (cljs.core.truth_(model_28260)?model_28260.getLanguageId():null);
if(cljs.core.truth_((function (){var and__5023__auto__ = model_28260;
if(cljs.core.truth_(and__5023__auto__)){
var and__5023__auto____$1 = lang_28259;
if(cljs.core.truth_(and__5023__auto____$1)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(current_lang_28261,lang_28259);
} else {
...
shadow.js.shim.module$monaco_editor$esm$vs$editor$editor_api.editor.setModelLanguage(model_28260,lang_28259);
} else {
}
...
var temp__5825__auto___28263 = cljs.core.deref(subscription);
if(cljs.core.truth_(temp__5825__auto___28263)){
var sub_28264 = temp__5825__auto___28263;
sub_28264.dispose();
} else {
}
...
var map__28238 = props;
var map__28238__$1 = cljs.core.__destructure_map(map__28238);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28238__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28238__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var G__28241 = bb_web_ds_tools.components.editor.get_code_to_eval(ed);
return (eval_action.cljs$core$IFn$_invoke$arity$1 ? eval_action.cljs$core$IFn$_invoke$arity$1(G__28241) : eval_action.call(null,G__28241));
})], null)));
});
bb_web_ds_tools.components.editor.render_output = (function bb_web_ds_tools$components$editor$render_output(output){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),(function (){var iter__5503__auto__ = (function bb_web_ds_tools$components$editor$render_output_$_iter__28244(s__28245){
return (new cljs.core.LazySeq(null,(function (){
var s__28245__$1 = s__28245;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__28245__$1);
if(temp__5825__auto__){
var s__28245__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__28245__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__28245__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__28247 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__28246 = (0);
while(true){
if((i__28246 < size__5502__auto__)){
var map__28248 = cljs.core._nth(c__5501__auto__,i__28246);
var map__28248__$1 = cljs.core.__destructure_map(map__28248);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28248__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28248__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
cljs.core.chunk_append(b__28247,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__28249 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28249__$1)].join('')));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28247),bb_web_ds_tools$components$editor$render_output_$_iter__28244(cljs.core.chunk_rest(s__28245__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28247),null);
}
} else {
var map__28250 = cljs.core.first(s__28245__$2);
var map__28250__$1 = cljs.core.__destructure_map(map__28250);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28250__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28250__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__28251 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28251__$1)].join('')));

}
})()], null),text], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.random_uuid()], null)),bb_web_ds_tools$components$editor$render_output_$_iter__28244(cljs.core.rest(s__28245__$2)));
}
} else {
return null;
}
