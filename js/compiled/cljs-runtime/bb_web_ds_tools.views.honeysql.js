...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("honeysql","update-input","honeysql/update-input",1611103297),(function (db,p__38916){
var vec__38917 = p__38916;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38917,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38917,(1),null);
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("honeysql","panel-state","honeysql/panel-state",-660162611),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("honeysql","input","honeysql/input",201662062)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("honeysql","output","honeysql/output",-656227780)], null),(function (p__38927,_){
var vec__38928 = p__38927;
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38928,(0),null);
var output = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38928,(1),null);
