...
var G__22469 = o;
reagent.impl.template.goog$module$goog$object.set(G__22469,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__22564__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__22564 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__22565__i = 0, G__22565__a = new Array(arguments.length -  0);
while (G__22565__i < G__22565__a.length) {G__22565__a[G__22565__i] = arguments[G__22565__i + 0]; ++G__22565__i;}
  args = new cljs.core.IndexedSeq(G__22565__a,0,null);
} 
return G__22564__delegate.call(this,args);};
G__22564.cljs$lang$maxFixedArity = 0;
G__22564.cljs$lang$applyTo = (function (arglist__22566){
var args = cljs.core.seq(arglist__22566);
return G__22564__delegate(args);
});
G__22564.cljs$core$IFn$_invoke$arity$variadic = G__22564__delegate;
return G__22564;
})()
;
} else {
...
var G__22471 = o;
reagent.impl.template.goog$module$goog$object.set(G__22471,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var args = cljs.core.seq(arglist__22569);
...
var G__22473 = props;
var G__22473__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22473,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22473);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22473__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22475 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22475,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22475;
}
})(),id_class);
...
var temp__5825__auto___22574 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___22574)){
var d_22578 = temp__5825__auto___22574;
if((d_22578 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_22578.s}));
} else {
...
var G__22477 = (cljs.core.count(argv) - first_child);
switch (G__22477) {
case (0):
...
var vec__22479 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22479,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22479,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22479,(2),null);
...
var temp__5829__auto___22581 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22581 == null)){
} else {
var key_22582 = temp__5829__auto___22581;
(jsprops.key = key_22582);
}
...
var temp__5829__auto___22585 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22585 == null)){
} else {
var key_22586 = temp__5829__auto___22585;
(jsprops.key = key_22586);
}
...
var temp__5829__auto___22589 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22589 == null)){
} else {
var key_22590 = temp__5829__auto___22589;
(jsprops.key = key_22590);
}
...
var temp__5829__auto___22594 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___22594 == null)){
} else {
var key_22596 = temp__5829__auto___22594;
...
var temp__5829__auto___22601 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22601 == null)){
} else {
var key_22604 = temp__5829__auto___22601;
(jsprops.key = key_22604);
}
...
var temp__5829__auto___22606 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22606 == null)){
} else {
var key_22609 = temp__5829__auto___22606;
(jsprops.key = key_22609);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22520_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22520_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22525 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22525,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22525,(1),null);
...
break;
default:
var G__22630 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22631 = compiler;
v = G__22630;
compiler = G__22631;
continue;
...
var G__22554 = tag;
var G__22554__$1 = (((G__22554 instanceof cljs.core.Keyword))?G__22554.fqn:null);
switch (G__22554__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template22560 = (function (opts,id,fn_to_element,parse_fn,meta22561){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22560.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22562,meta22561__$1){
var self__ = this;
var _22562__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22560(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22561__$1));
}));

(reagent.impl.template.t_reagent$impl$template22560.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22562){
var self__ = this;
var _22562__$1 = this;
return self__.meta22561;
}));

(reagent.impl.template.t_reagent$impl$template22560.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22560.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22560.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22560.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22560.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22560.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22561","meta22561",-2010027231,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22560.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22560.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22560");

(reagent.impl.template.t_reagent$impl$template22560.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template22560");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22560.
 */
reagent.impl.template.__GT_t_reagent$impl$template22560 = (function reagent$impl$template$__GT_t_reagent$impl$template22560(opts,id,fn_to_element,parse_fn,meta22561){
return (new reagent.impl.template.t_reagent$impl$template22560(opts,id,fn_to_element,parse_fn,meta22561));
});
...
return (new reagent.impl.template.t_reagent$impl$template22560(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
