...
return cljs.core.cons(cljs.core.first(s),(function (){var G__38964 = (n - (1));
var G__38965 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__38964,G__38965) : clojure.test.check.rose_tree.exclude_nth.call(null,G__38964,G__38965));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__38970 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__38970) : f.call(null,G__38970));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38968_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__38968_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__38968_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38973_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__38973_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__38973_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__38974_SHARP_){
var G__38975 = clojure.test.check.rose_tree.root(p1__38974_SHARP_);
...
var iter__5503__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__38976(s__38977){
return (new cljs.core.LazySeq(null,(function (){
var s__38977__$1 = s__38977;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__38977__$1);
if(temp__5825__auto__){
var xs__6385__auto__ = temp__5825__auto__;
var vec__38984 = cljs.core.first(xs__6385__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38984,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38984,(1),null);
var iterys__5499__auto__ = ((function (s__38977__$1,vec__38984,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__38976_$_iter__38978(s__38979){
return (new cljs.core.LazySeq(null,((function (s__38977__$1,vec__38984,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function (){
var s__38979__$1 = s__38979;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__38979__$1);
if(temp__5825__auto____$1){
var s__38979__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__38979__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__38979__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__38981 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__38980 = (0);
while(true){
if((i__38980 < size__5502__auto__)){
var child = cljs.core._nth(c__5501__auto__,i__38980);
cljs.core.chunk_append(b__38981,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__39049 = (i__38980 + (1));
i__38980 = G__39049;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38981),clojure$test$check$rose_tree$permutations_$_iter__38976_$_iter__38978(cljs.core.chunk_rest(s__38979__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38981),null);
}
} else {
var child = cljs.core.first(s__38979__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__38976_$_iter__38978(cljs.core.rest(s__38979__$2)));
}
} else {
return null;
}
...
});})(s__38977__$1,vec__38984,rose,index,xs__6385__auto__,temp__5825__auto__))
,null,null));
});})(s__38977__$1,vec__38984,rose,index,xs__6385__auto__,temp__5825__auto__))
;
var fs__5500__auto__ = cljs.core.seq(iterys__5499__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__5500__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5500__auto__,clojure$test$check$rose_tree$permutations_$_iter__38976(cljs.core.rest(s__38977__$1)));
} else {
var G__39055 = cljs.core.rest(s__38977__$1);
s__38977__$1 = G__39055;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38993_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__38993_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__38993_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39001_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__39001_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__39001_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__39006 = f;
var G__39007 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__39006,G__39007) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__39006,G__39007));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__39012 = f;
var G__39013 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__39012,G__39013) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__39012,G__39013));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {
