...
return cljs.core.cons(cljs.core.first(s),(function (){var G__43413 = (n - (1));
var G__43414 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__43413,G__43414) : clojure.test.check.rose_tree.exclude_nth.call(null,G__43413,G__43414));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__43416 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__43416) : f.call(null,G__43416));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43415_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__43415_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__43415_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43417_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__43417_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__43417_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__43418_SHARP_){
var G__43419 = clojure.test.check.rose_tree.root(p1__43418_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__43419) : pred.call(null,G__43419));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__5503__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__43420(s__43421){
return (new cljs.core.LazySeq(null,(function (){
var s__43421__$1 = s__43421;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__43421__$1);
if(temp__5825__auto__){
var xs__6385__auto__ = temp__5825__auto__;
var vec__43426 = cljs.core.first(xs__6385__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43426,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43426,(1),null);
var iterys__5499__auto__ = ((function (s__43421__$1,vec__43426,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__43420_$_iter__43422(s__43423){
return (new cljs.core.LazySeq(null,((function (s__43421__$1,vec__43426,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function (){
var s__43423__$1 = s__43423;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__43423__$1);
if(temp__5825__auto____$1){
var s__43423__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__43423__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__43423__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__43425 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__43424 = (0);
while(true){
if((i__43424 < size__5502__auto__)){
var child = cljs.core._nth(c__5501__auto__,i__43424);
cljs.core.chunk_append(b__43425,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__43466 = (i__43424 + (1));
i__43424 = G__43466;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43425),clojure$test$check$rose_tree$permutations_$_iter__43420_$_iter__43422(cljs.core.chunk_rest(s__43423__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43425),null);
}
} else {
var child = cljs.core.first(s__43423__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__43420_$_iter__43422(cljs.core.rest(s__43423__$2)));
}
} else {
return null;
}
...
});})(s__43421__$1,vec__43426,rose,index,xs__6385__auto__,temp__5825__auto__))
,null,null));
});})(s__43421__$1,vec__43426,rose,index,xs__6385__auto__,temp__5825__auto__))
;
var fs__5500__auto__ = cljs.core.seq(iterys__5499__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__5500__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5500__auto__,clojure$test$check$rose_tree$permutations_$_iter__43420(cljs.core.rest(s__43421__$1)));
} else {
var G__43467 = cljs.core.rest(s__43421__$1);
s__43421__$1 = G__43467;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43429_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__43429_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__43429_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43441_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__43441_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__43441_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__43442 = f;
var G__43443 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__43442,G__43443) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__43442,G__43443));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__43448 = f;
var G__43449 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__43448,G__43449) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__43448,G__43449));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {
