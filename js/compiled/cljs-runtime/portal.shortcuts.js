...
if(cljs.core.truth_((function (){var fexpr__24569 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["Mac68K",null,"Macintosh",null,"MacPPC",null,"MacIntel",null], null), null);
return (fexpr__24569.cljs$core$IFn$_invoke$arity$1 ? fexpr__24569.cljs$core$IFn$_invoke$arity$1(platform) : fexpr__24569.call(null,platform));
})())){
return new cljs.core.Keyword("portal.shortcuts","osx","portal.shortcuts/osx",300522451);
} else {
if(cljs.core.truth_((function (){var fexpr__24570 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["WinCE",null,"Windows",null,"Win32",null,"Win64",null], null), null);
return (fexpr__24570.cljs$core$IFn$_invoke$arity$1 ? fexpr__24570.cljs$core$IFn$_invoke$arity$1(platform) : fexpr__24570.call(null,platform));
})())){
...
var iter__5503__auto__ = (function portal$shortcuts$log__GT_seq_$_iter__24571(s__24572){
return (new cljs.core.LazySeq(null,(function (){
var s__24572__$1 = s__24572;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__24572__$1);
if(temp__5825__auto__){
var s__24572__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__24572__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__24572__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__24574 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__24573 = (0);
while(true){
if((i__24573 < size__5502__auto__)){
var n = cljs.core._nth(c__5501__auto__,i__24573);
cljs.core.chunk_append(b__24574,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.reverse(cljs.core.take.cljs$core$IFn$_invoke$arity$2(n,log__$1))));

var G__24597 = (i__24573 + (1));
i__24573 = G__24597;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__24574),portal$shortcuts$log__GT_seq_$_iter__24571(cljs.core.chunk_rest(s__24572__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__24574),null);
}
} else {
var n = cljs.core.first(s__24572__$2);
return cljs.core.cons(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.reverse(cljs.core.take.cljs$core$IFn$_invoke$arity$2(n,log__$1))),portal$shortcuts$log__GT_seq_$_iter__24571(cljs.core.rest(s__24572__$2)));
}
} else {
return null;
}
...
var G__24575 = cljs.core.PersistentHashSet.createAsIfByAssoc([portal.shortcuts.event__GT_key(e)]);
var G__24575__$1 = (cljs.core.truth_(e.ctrlKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__24575,"control"):G__24575);
var G__24575__$2 = (cljs.core.truth_(e.metaKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__24575__$1,"meta"):G__24575__$1);
var G__24575__$3 = (cljs.core.truth_(e.shiftKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__24575__$2,"shift"):G__24575__$2);
if(cljs.core.truth_(e.altKey)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__24575__$3,"alt");
} else {
return G__24575__$3;
}
} else {
...
return cljs.core.some((function (p1__24580_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(mapping,p1__24580_SHARP_);
...
if(cljs.core.truth_(temp__5825__auto__)){
var e = temp__5825__auto__;
var G__24582 = e.target.tagName;
var fexpr__24581 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["SELECT",null,"INPUT",null,"BUTTON",null,"TEXTAREA",null], null), null);
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(portal.shortcuts.log,(function (p1__24584_SHARP_){
return cljs.core.take.cljs$core$IFn$_invoke$arity$2((5),cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__24584_SHARP_,e));
}));
...
return window.addEventListener("keydown",(function (p1__24588_SHARP_){
return portal.shortcuts.keydown(p1__24588_SHARP_);
}));
} else {
return null;
}
