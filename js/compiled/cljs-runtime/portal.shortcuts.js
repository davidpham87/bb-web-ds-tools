...
if(cljs.core.truth_((function (){var fexpr__24427 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["Mac68K",null,"Macintosh",null,"MacPPC",null,"MacIntel",null], null), null);
return (fexpr__24427.cljs$core$IFn$_invoke$arity$1 ? fexpr__24427.cljs$core$IFn$_invoke$arity$1(platform) : fexpr__24427.call(null,platform));
})())){
return new cljs.core.Keyword("portal.shortcuts","osx","portal.shortcuts/osx",300522451);
} else {
if(cljs.core.truth_((function (){var fexpr__24428 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["WinCE",null,"Windows",null,"Win32",null,"Win64",null], null), null);
return (fexpr__24428.cljs$core$IFn$_invoke$arity$1 ? fexpr__24428.cljs$core$IFn$_invoke$arity$1(platform) : fexpr__24428.call(null,platform));
})())){
...
var iter__5503__auto__ = (function portal$shortcuts$log__GT_seq_$_iter__24440(s__24441){
...
var n = cljs.core._nth(c__5501__auto__,i__24442);
cljs.core.chunk_append(b__24443,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.reverse(cljs.core.take.cljs$core$IFn$_invoke$arity$2(n,log__$1))));

var G__24510 = (i__24442 + (1));
i__24442 = G__24510;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__24443),portal$shortcuts$log__GT_seq_$_iter__24440(cljs.core.chunk_rest(s__24441__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__24443),null);
}
} else {
var n = cljs.core.first(s__24441__$2);
return cljs.core.cons(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.reverse(cljs.core.take.cljs$core$IFn$_invoke$arity$2(n,log__$1))),portal$shortcuts$log__GT_seq_$_iter__24440(cljs.core.rest(s__24441__$2)));
}
} else {
return null;
}
...
var G__24465 = cljs.core.PersistentHashSet.createAsIfByAssoc([portal.shortcuts.event__GT_key(e)]);
var G__24465__$1 = (cljs.core.truth_(e.ctrlKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__24465,"control"):G__24465);
var G__24465__$2 = (cljs.core.truth_(e.metaKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__24465__$1,"meta"):G__24465__$1);
var G__24465__$3 = (cljs.core.truth_(e.shiftKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__24465__$2,"shift"):G__24465__$2);
if(cljs.core.truth_(e.altKey)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__24465__$3,"alt");
} else {
return G__24465__$3;
}
} else {
...
return cljs.core.some((function (p1__24497_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(mapping,p1__24497_SHARP_);
...
if(cljs.core.truth_(temp__5825__auto__)){
var e = temp__5825__auto__;
var G__24499 = e.target.tagName;
var fexpr__24498 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["SELECT",null,"INPUT",null,"BUTTON",null,"TEXTAREA",null], null), null);
return (fexpr__24498.cljs$core$IFn$_invoke$arity$1 ? fexpr__24498.cljs$core$IFn$_invoke$arity$1(G__24499) : fexpr__24498.call(null,G__24499));
} else {
return null;
}
});
portal.shortcuts.keydown = (function portal$shortcuts$keydown(e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(portal.shortcuts.log,(function (p1__24500_SHARP_){
return cljs.core.take.cljs$core$IFn$_invoke$arity$2((5),cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__24500_SHARP_,e));
}));
...
return window.addEventListener("keydown",(function (p1__24504_SHARP_){
return portal.shortcuts.keydown(p1__24504_SHARP_);
}));
} else {
return null;
}
