...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-dispatch-logic","fork.re-frame/server-dispatch-logic",-1023921676),(function (db,p__37391){
var vec__37392 = p__37391;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37392,(0),null);
var config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37392,(1),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37392,(2),null);
...
var G__37396 = db;
var G__37396__$1 = ((cljs.core.seq(input_names))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__37396,path,(function (m){
...
return cljs.core.assoc_in(G__37396__$1,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"server","server",1499190120),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(config),new cljs.core.Keyword(null,"waiting?","waiting?",-2117257215)], null)),true);
} else {
return G__37396__$1;
}
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-set-waiting","fork.re-frame/server-set-waiting",-1277872097),(function (db,p__37400){
var vec__37411 = p__37400;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37411,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37411,(1),null);
var input_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37411,(2),null);
var bool = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37411,(3),null);
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("fork.re-frame","db","fork.re-frame/db",503486154),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__37414){
var vec__37415 = p__37414;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37415,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37415,(1),null);
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,path);
})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","clean","fork.re-frame/clean",-448599170),(function (db,p__37418){
var vec__37419 = p__37418;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37419,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37419,(1),null);
...
var G__37470__delegate = function (ks){
...
while (G__37471__i < G__37471__a.length) {G__37471__a[G__37471__i] = arguments[G__37471__i + 0]; ++G__37471__i;}
  ks = new cljs.core.IndexedSeq(G__37471__a,0,null);
} 
return G__37470__delegate.call(this,ks);};
G__37470.cljs$lang$maxFixedArity = 0;
G__37470.cljs$lang$applyTo = (function (arglist__37472){
var ks = cljs.core.seq(arglist__37472);
return G__37470__delegate(ks);
});
G__37470.cljs$core$IFn$_invoke$arity$variadic = G__37470__delegate;
return G__37470;
})()
,(function (p1__37439_SHARP_){
return fork.core.handle_blur(p1__37439_SHARP_,state);
}),(function (p1__37433_SHARP_){
return fork.core.set_values(p1__37433_SHARP_,state);
}),(function (p1__37438_SHARP_){
return fork.core.handle_change(p1__37438_SHARP_,state);
}),(function() { 
var G__37474__delegate = function (ks){
...
while (G__37476__i < G__37476__a.length) {G__37476__a[G__37476__i] = arguments[G__37476__i + 0]; ++G__37476__i;}
  ks = new cljs.core.IndexedSeq(G__37476__a,0,null);
} 
return G__37474__delegate.call(this,ks);};
G__37474.cljs$lang$maxFixedArity = 0;
G__37474.cljs$lang$applyTo = (function (arglist__37477){
var ks = cljs.core.seq(arglist__37477);
return G__37474__delegate(ks);
});
G__37474.cljs$core$IFn$_invoke$arity$variadic = G__37474__delegate;
return G__37474;
})()
,(function() { 
var G__37478__delegate = function (ks){
...
while (G__37479__i < G__37479__a.length) {G__37479__a[G__37479__i] = arguments[G__37479__i + 0]; ++G__37479__i;}
  ks = new cljs.core.IndexedSeq(G__37479__a,0,null);
} 
return G__37478__delegate.call(this,ks);};
G__37478.cljs$lang$maxFixedArity = 0;
G__37478.cljs$lang$applyTo = (function (arglist__37480){
var ks = cljs.core.seq(arglist__37480);
return G__37478__delegate(ks);
});
G__37478.cljs$core$IFn$_invoke$arity$variadic = G__37478__delegate;
return G__37478;
})()
,(function() { 
var G__37481__delegate = function (p__37450){
var vec__37451 = p__37450;
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37451,(0),null);
...
var p__37450 = null;
if (arguments.length > 0) {
var G__37485__i = 0, G__37485__a = new Array(arguments.length -  0);
while (G__37485__i < G__37485__a.length) {G__37485__a[G__37485__i] = arguments[G__37485__i + 0]; ++G__37485__i;}
  p__37450 = new cljs.core.IndexedSeq(G__37485__a,0,null);
} 
return G__37481__delegate.call(this,p__37450);};
G__37481.cljs$lang$maxFixedArity = 0;
G__37481.cljs$lang$applyTo = (function (arglist__37486){
var p__37450 = cljs.core.seq(arglist__37486);
return G__37481__delegate(p__37450);
});
G__37481.cljs$core$IFn$_invoke$arity$variadic = G__37481__delegate;
return G__37481;
})()
,(function (p1__37437_SHARP_){
return fork.core.set_handle_blur(p1__37437_SHARP_,state);
}),(function() { 
var G__37487__delegate = function (ks){
...
while (G__37488__i < G__37488__a.length) {G__37488__a[G__37488__i] = arguments[G__37488__i + 0]; ++G__37488__i;}
  ks = new cljs.core.IndexedSeq(G__37488__a,0,null);
} 
return G__37487__delegate.call(this,ks);};
G__37487.cljs$lang$maxFixedArity = 0;
G__37487.cljs$lang$applyTo = (function (arglist__37489){
var ks = cljs.core.seq(arglist__37489);
return G__37487__delegate(ks);
});
...
}),(function (p1__37435_SHARP_){
return fork.core.normalize_name(p1__37435_SHARP_,props);
...
}),(function (p1__37436_SHARP_){
return fork.core.set_handle_change(p1__37436_SHARP_,state);
}),(function (p1__37434_SHARP_){
return fork.core.disabled_QMARK_(state,p1__37434_SHARP_);
})]);
