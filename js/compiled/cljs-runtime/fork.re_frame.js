...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-dispatch-logic","fork.re-frame/server-dispatch-logic",-1023921676),(function (db,p__37424){
var vec__37425 = p__37424;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37425,(0),null);
var config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37425,(1),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37425,(2),null);
...
var G__37429 = db;
var G__37429__$1 = ((cljs.core.seq(input_names))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__37429,path,(function (m){
...
return cljs.core.assoc_in(G__37429__$1,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(path,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"server","server",1499190120),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(config),new cljs.core.Keyword(null,"waiting?","waiting?",-2117257215)], null)),true);
} else {
return G__37429__$1;
}
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","server-set-waiting","fork.re-frame/server-set-waiting",-1277872097),(function (db,p__37438){
var vec__37439 = p__37438;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37439,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37439,(1),null);
var input_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37439,(2),null);
var bool = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37439,(3),null);
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("fork.re-frame","db","fork.re-frame/db",503486154),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__37445){
var vec__37446 = p__37445;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37446,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37446,(1),null);
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,path);
})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("fork.re-frame","clean","fork.re-frame/clean",-448599170),(function (db,p__37452){
var vec__37453 = p__37452;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37453,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37453,(1),null);
...
var G__37480__delegate = function (ks){
...
while (G__37481__i < G__37481__a.length) {G__37481__a[G__37481__i] = arguments[G__37481__i + 0]; ++G__37481__i;}
  ks = new cljs.core.IndexedSeq(G__37481__a,0,null);
} 
return G__37480__delegate.call(this,ks);};
G__37480.cljs$lang$maxFixedArity = 0;
G__37480.cljs$lang$applyTo = (function (arglist__37482){
var ks = cljs.core.seq(arglist__37482);
return G__37480__delegate(ks);
});
G__37480.cljs$core$IFn$_invoke$arity$variadic = G__37480__delegate;
return G__37480;
})()
,(function (p1__37463_SHARP_){
return fork.core.handle_blur(p1__37463_SHARP_,state);
}),(function (p1__37457_SHARP_){
return fork.core.set_values(p1__37457_SHARP_,state);
}),(function (p1__37462_SHARP_){
return fork.core.handle_change(p1__37462_SHARP_,state);
}),(function() { 
var G__37483__delegate = function (ks){
...
while (G__37484__i < G__37484__a.length) {G__37484__a[G__37484__i] = arguments[G__37484__i + 0]; ++G__37484__i;}
  ks = new cljs.core.IndexedSeq(G__37484__a,0,null);
} 
return G__37483__delegate.call(this,ks);};
G__37483.cljs$lang$maxFixedArity = 0;
G__37483.cljs$lang$applyTo = (function (arglist__37485){
var ks = cljs.core.seq(arglist__37485);
return G__37483__delegate(ks);
});
G__37483.cljs$core$IFn$_invoke$arity$variadic = G__37483__delegate;
return G__37483;
})()
,(function() { 
var G__37486__delegate = function (ks){
...
while (G__37487__i < G__37487__a.length) {G__37487__a[G__37487__i] = arguments[G__37487__i + 0]; ++G__37487__i;}
  ks = new cljs.core.IndexedSeq(G__37487__a,0,null);
} 
return G__37486__delegate.call(this,ks);};
G__37486.cljs$lang$maxFixedArity = 0;
G__37486.cljs$lang$applyTo = (function (arglist__37488){
var ks = cljs.core.seq(arglist__37488);
return G__37486__delegate(ks);
});
G__37486.cljs$core$IFn$_invoke$arity$variadic = G__37486__delegate;
return G__37486;
})()
,(function() { 
var G__37489__delegate = function (p__37468){
var vec__37469 = p__37468;
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37469,(0),null);
...
while (G__37495__i < G__37495__a.length) {G__37495__a[G__37495__i] = arguments[G__37495__i + 0]; ++G__37495__i;}
  p__37468 = new cljs.core.IndexedSeq(G__37495__a,0,null);
} 
return G__37489__delegate.call(this,p__37468);};
G__37489.cljs$lang$maxFixedArity = 0;
G__37489.cljs$lang$applyTo = (function (arglist__37496){
var p__37468 = cljs.core.seq(arglist__37496);
return G__37489__delegate(p__37468);
});
G__37489.cljs$core$IFn$_invoke$arity$variadic = G__37489__delegate;
return G__37489;
})()
,(function (p1__37461_SHARP_){
return fork.core.set_handle_blur(p1__37461_SHARP_,state);
}),(function() { 
var G__37497__delegate = function (ks){
...
while (G__37498__i < G__37498__a.length) {G__37498__a[G__37498__i] = arguments[G__37498__i + 0]; ++G__37498__i;}
  ks = new cljs.core.IndexedSeq(G__37498__a,0,null);
} 
return G__37497__delegate.call(this,ks);};
G__37497.cljs$lang$maxFixedArity = 0;
G__37497.cljs$lang$applyTo = (function (arglist__37499){
var ks = cljs.core.seq(arglist__37499);
return G__37497__delegate(ks);
});
...
}),(function (p1__37459_SHARP_){
return fork.core.normalize_name(p1__37459_SHARP_,props);
...
}),(function (p1__37460_SHARP_){
return fork.core.set_handle_change(p1__37460_SHARP_,state);
}),(function (p1__37458_SHARP_){
return fork.core.disabled_QMARK_(state,p1__37458_SHARP_);
})]);
