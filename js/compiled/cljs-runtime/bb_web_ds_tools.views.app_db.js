...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","path-value","bb-web-ds-tools.views.app-db/path-value",1939920672),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__28320){
var vec__28321 = p__28320;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28321,(0),null);
var path_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28321,(1),null);
...
}catch (e28324){var ___$1 = e28324;
return new cljs.core.Keyword("bb-web-ds-tools.views.app-db","error","bb-web-ds-tools.views.app-db/error",-336701303);
}})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","set-active-path","bb-web-ds-tools.views.app-db/set-active-path",153735738),(function (db,p__28326){
var vec__28327 = p__28326;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28327,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28327,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","remove-watch-path","bb-web-ds-tools.views.app-db/remove-watch-path",178630062),(function (db,p__28337){
var vec__28338 = p__28337;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28338,(0),null);
var path_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28338,(1),null);
var watched_paths = cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"watched-paths","watched-paths",-1266999052)], null),cljs.core.PersistentVector.EMPTY);
var new_paths = cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__28336_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__28336_SHARP_,path_str);
}),watched_paths));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","update-watch-path","bb-web-ds-tools.views.app-db/update-watch-path",-1498068284),(function (db,p__28342){
var vec__28343 = p__28342;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28343,(0),null);
var old_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28343,(1),null);
var new_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28343,(2),null);
...
var G__28346 = cljs.core.assoc_in(db,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"watched-paths","watched-paths",-1266999052)], null),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(paths,idx,new_path));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(active_path,old_path)){
return cljs.core.assoc_in(G__28346,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"active-path","active-path",-899675889)], null),new_path);
} else {
return G__28346;
}
}
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","open-in-portal","bb-web-ds-tools.views.app-db/open-in-portal",-1055334551),(function (p__28347,_){
var map__28348 = p__28347;
var map__28348__$1 = cljs.core.__destructure_map(map__28348);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28348__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
})], null),"+ New Watch"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex-grow overflow-y-auto p-2 space-y-1"], null),((cljs.core.seq(watched_paths))?(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$app_db$path_list_$_iter__28357(s__28358){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28360),bb_web_ds_tools$views$app_db$path_list_$_iter__28357(cljs.core.chunk_rest(s__28358__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28360),null);
}
} else {
var path = cljs.core.first(s__28358__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.app_db.path_list_item,path,cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(path,active_path)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),path], null)),bb_web_ds_tools$views$app_db$path_list_$_iter__28357(cljs.core.rest(s__28358__$2)));
}
} else {
return null;
}
...
var with_let28367 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let28367","with-let28367",1689266220));
var temp__5829__auto___28434 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5829__auto___28434 == null)){
} else {
var c__21979__auto___28435 = temp__5829__auto___28434;
if((with_let28367.generation === c__21979__auto___28435.ratomGeneration)){
...
(with_let28367.generation = c__21979__auto___28435.ratomGeneration);
}

var init28368 = (with_let28367.length === (0));
var new_path = ((((init28368) || (cljs.core.not(with_let28367.hasOwnProperty((0))))))?(with_let28367[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1("")):(with_let28367[(0)]));
var res28370 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.card,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"p-8 flex flex-col items-center justify-center space-y-4 bg-transparent shadow-none h-full"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3","h3",2067611163),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-xl font-bold"], null),"Watch New Path"], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"w-full max-w-lg"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(new_path),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__28366_SHARP_){
return cljs.core.reset_BANG_(new_path,p1__28366_SHARP_.target.value);
