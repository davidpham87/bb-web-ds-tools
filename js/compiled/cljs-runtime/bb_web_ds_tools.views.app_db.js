...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","path-value","bb-web-ds-tools.views.app-db/path-value",1939920672),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__37138){
var vec__37139 = p__37138;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37139,(0),null);
var path_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37139,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","set-active-path","bb-web-ds-tools.views.app-db/set-active-path",153735738),(function (db,p__37150){
var vec__37151 = p__37150;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37151,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37151,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","add-watch-path","bb-web-ds-tools.views.app-db/add-watch-path",1822864858),(function (db,p__37154){
var vec__37155 = p__37154;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37155,(0),null);
var path_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37155,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","update-watch-path","bb-web-ds-tools.views.app-db/update-watch-path",-1498068284),(function (db,p__37179){
var vec__37180 = p__37179;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37180,(0),null);
var old_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37180,(1),null);
var new_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37180,(2),null);
...
return cljs.core.assoc_in(G__37186,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"active-path","active-path",-899675889)], null),new_path);
} else {
return G__37186;
}
}
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","open-in-portal","bb-web-ds-tools.views.app-db/open-in-portal",-1055334551),(function (p__37187,_){
var map__37188 = p__37187;
var map__37188__$1 = cljs.core.__destructure_map(map__37188);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37188__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
})], null),"+ New Watch"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex-grow overflow-y-auto p-2 space-y-1"], null),((cljs.core.seq(watched_paths))?(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$app_db$path_list_$_iter__37201(s__37202){
return (new cljs.core.LazySeq(null,(function (){
var s__37202__$1 = s__37202;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__37202__$1);
if(temp__5825__auto__){
var s__37202__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__37202__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__37202__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__37204 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__37203 = (0);
while(true){
if((i__37203 < size__5502__auto__)){
var path = cljs.core._nth(c__5501__auto__,i__37203);
cljs.core.chunk_append(b__37204,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.app_db.path_list_item,path,cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(path,active_path)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),path], null)));

var G__37231 = (i__37203 + (1));
i__37203 = G__37231;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37204),bb_web_ds_tools$views$app_db$path_list_$_iter__37201(cljs.core.chunk_rest(s__37202__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37204),null);
}
} else {
var path = cljs.core.first(s__37202__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.app_db.path_list_item,path,cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(path,active_path)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),path], null)),bb_web_ds_tools$views$app_db$path_list_$_iter__37201(cljs.core.rest(s__37202__$2)));
}
} else {
return null;
}
...
var with_let37217 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let37217","with-let37217",1838478910));
var temp__5829__auto___37232 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5829__auto___37232 == null)){
} else {
var c__35390__auto___37233 = temp__5829__auto___37232;
if((with_let37217.generation === c__35390__auto___37233.ratomGeneration)){
...
(with_let37217.generation = c__35390__auto___37233.ratomGeneration);
}

var init37218 = (with_let37217.length === (0));
var new_path = ((((init37218) || (cljs.core.not(with_let37217.hasOwnProperty((0))))))?(with_let37217[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1("")):(with_let37217[(0)]));
var res37219 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.card,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"p-8 flex flex-col items-center justify-center space-y-4 bg-transparent shadow-none h-full"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3","h3",2067611163),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-xl font-bold"], null),"Watch New Path"], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"w-full max-w-lg"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(new_path),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__37215_SHARP_){
return cljs.core.reset_BANG_(new_path,p1__37215_SHARP_.target.value);
