...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","path-value","bb-web-ds-tools.views.app-db/path-value",1939920672),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__37114){
var vec__37115 = p__37114;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37115,(0),null);
var path_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37115,(1),null);
...
}catch (e37118){var ___$1 = e37118;
return new cljs.core.Keyword("bb-web-ds-tools.views.app-db","error","bb-web-ds-tools.views.app-db/error",-336701303);
}})], 0));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","set-active-path","bb-web-ds-tools.views.app-db/set-active-path",153735738),(function (db,p__37122){
var vec__37123 = p__37122;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37123,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37123,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","add-watch-path","bb-web-ds-tools.views.app-db/add-watch-path",1822864858),(function (db,p__37142){
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","remove-watch-path","bb-web-ds-tools.views.app-db/remove-watch-path",178630062),(function (db,p__37154){
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","update-watch-path","bb-web-ds-tools.views.app-db/update-watch-path",-1498068284),(function (db,p__37162){
var vec__37163 = p__37162;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37163,(0),null);
var old_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37163,(1),null);
var new_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37163,(2),null);
...
var G__37166 = cljs.core.assoc_in(db,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"watched-paths","watched-paths",-1266999052)], null),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(paths,idx,new_path));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(active_path,old_path)){
return cljs.core.assoc_in(G__37166,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"active-path","active-path",-899675889)], null),new_path);
} else {
return G__37166;
}
}
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("bb-web-ds-tools.views.app-db","open-in-portal","bb-web-ds-tools.views.app-db/open-in-portal",-1055334551),(function (p__37171,_){
var map__37173 = p__37171;
var map__37173__$1 = cljs.core.__destructure_map(map__37173);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37173__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
})], null),"+ New Watch"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"flex-grow overflow-y-auto p-2 space-y-1"], null),((cljs.core.seq(watched_paths))?(function (){var iter__5503__auto__ = (function bb_web_ds_tools$views$app_db$path_list_$_iter__37191(s__37192){
return (new cljs.core.LazySeq(null,(function (){
var s__37192__$1 = s__37192;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__37192__$1);
if(temp__5825__auto__){
var s__37192__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__37192__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__37192__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__37194 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__37193 = (0);
while(true){
if((i__37193 < size__5502__auto__)){
var path = cljs.core._nth(c__5501__auto__,i__37193);
cljs.core.chunk_append(b__37194,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.app_db.path_list_item,path,cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(path,active_path)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),path], null)));

var G__37225 = (i__37193 + (1));
i__37193 = G__37225;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37194),bb_web_ds_tools$views$app_db$path_list_$_iter__37191(cljs.core.chunk_rest(s__37192__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37194),null);
}
} else {
var path = cljs.core.first(s__37192__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.views.app_db.path_list_item,path,cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(path,active_path)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),path], null)),bb_web_ds_tools$views$app_db$path_list_$_iter__37191(cljs.core.rest(s__37192__$2)));
}
} else {
return null;
}
...
var with_let37198 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let37198","with-let37198",-48801097));
var temp__5829__auto___37226 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5829__auto___37226 == null)){
} else {
var c__35390__auto___37227 = temp__5829__auto___37226;
if((with_let37198.generation === c__35390__auto___37227.ratomGeneration)){
...
(with_let37198.generation = c__35390__auto___37227.ratomGeneration);
}

var init37199 = (with_let37198.length === (0));
var new_path = ((((init37199) || (cljs.core.not(with_let37198.hasOwnProperty((0))))))?(with_let37198[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1("")):(with_let37198[(0)]));
var res37200 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.card,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"p-8 flex flex-col items-center justify-center space-y-4 bg-transparent shadow-none h-full"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3","h3",2067611163),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"text-xl font-bold"], null),"Watch New Path"], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"w-full max-w-lg"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bb_web_ds_tools.components.common.input,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(new_path),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__37197_SHARP_){
return cljs.core.reset_BANG_(new_path,p1__37197_SHARP_.target.value);
