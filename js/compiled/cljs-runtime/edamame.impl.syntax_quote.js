...
var G__26410 = cljs.core.next(s__$1);
var G__26411 = ret;
s__$1 = G__26410;
r = G__26411;
continue;
...
var G__26412 = cljs.core.next(s);
var G__26413 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(key_vals,cljs.core.key(e)),cljs.core.val(e));
s = G__26412;
key_vals = G__26413;
continue;
} else {
...
edamame.impl.syntax_quote.syntax_quote_STAR_ = (function edamame$impl$syntax_quote$syntax_quote_STAR_(p__26405,reader,form){
var map__26406 = p__26405;
var map__26406__$1 = cljs.core.__destructure_map(map__26406);
var ctx = map__26406__$1;
var gensyms = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26406__$1,new cljs.core.Keyword(null,"gensyms","gensyms",248713782));
...
var temp__5823__auto__ = (function (){var G__26407 = ctx;
var G__26407__$1 = (((G__26407 == null))?null:new cljs.core.Keyword(null,"ns-state","ns-state",-532270771).cljs$core$IFn$_invoke$arity$1(G__26407));
if((G__26407__$1 == null)){
return null;
} else {
return cljs.core.deref(G__26407__$1);
}
})();
if(cljs.core.truth_(temp__5823__auto__)){
var ns_state = temp__5823__auto__;
return (function (sym){
var temp__5823__auto____$1 = (function (){var G__26408 = cljs.core.namespace(sym);
if((G__26408 == null)){
return null;
} else {
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(G__26408);
}
})();
