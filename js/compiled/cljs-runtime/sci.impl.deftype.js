...
var hierarchy__5626__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__28047 = cljs.core.get_global_hierarchy;
return (fexpr__28047.cljs$core$IFn$_invoke$arity$0 ? fexpr__28047.cljs$core$IFn$_invoke$arity$0() : fexpr__28047.call(null));
})());
...
var sci$impl$deftype$SciPrintMethod$_sci_print_method$dyn_28130 = (function (x,w){
...
return sci$impl$deftype$SciPrintMethod$_sci_print_method$dyn_28130(x,w);
}
});
...
var len__5749__auto___28138 = arguments.length;
var i__5750__auto___28139 = (0);
while(true){
if((i__5750__auto___28139 < len__5749__auto___28138)){
args__5755__auto__.push((arguments[i__5750__auto___28139]));

var G__28140 = (i__5750__auto___28139 + (1));
i__5750__auto___28139 = G__28140;
continue;
} else {
}
break;
...
(sci.impl.deftype.deftype.cljs$core$IFn$_invoke$arity$variadic = (function (p__28094,_,ctx,record_name,fields,raw_protocol_impls){
var vec__28095 = p__28094;
var seq__28096 = cljs.core.seq(vec__28095);
var first__28097 = cljs.core.first(seq__28096);
var seq__28096__$1 = cljs.core.next(seq__28096);
var _fname = first__28097;
var ___$1 = seq__28096__$1;
var form = vec__28095;
...
var protocol_impls__$1 = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__28098,expr){
var vec__28099 = p__28098;
var seq__28100 = cljs.core.seq(vec__28099);
var first__28101 = cljs.core.first(seq__28100);
var seq__28100__$1 = cljs.core.next(seq__28100);
var protocol_name = first__28101;
var impls = seq__28100__$1;
var impls__$1 = cljs.core.group_by(cljs.core.first,impls);
var protocol = (function (){var G__28103 = ctx;
var G__28104 = new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ctx);
var G__28105 = protocol_name;
var fexpr__28102 = cljs.core.deref(sci.impl.utils.eval_resolve_state);
return (fexpr__28102.cljs$core$IFn$_invoke$arity$3 ? fexpr__28102.cljs$core$IFn$_invoke$arity$3(G__28103,G__28104,G__28105) : fexpr__28102.call(null,G__28103,G__28104,G__28105));
})();
...
var fq_meth_name = (function (p1__28084_SHARP_){
if(cljs.core.simple_symbol_QMARK_(p1__28084_SHARP_)){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(pns,cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__28084_SHARP_));
} else {
return p1__28084_SHARP_;
}
});
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__28106){
var vec__28107 = p__28106;
var method_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28107,(0),null);
var bodies = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28107,(1),null);
...
var G__28122 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(ctx,new cljs.core.Keyword(null,"deftype-fields","deftype-fields",-222569172),field_set,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"local->mutator","local->mutator",1004070878),cljs.core.zipmap(field_set,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (field){
return (function (this$,v){
return sci.impl.types._mutate(this$,field,v);
});
}),field_set))], 0));
var G__28123 = cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","defmethod","cljs.core/defmethod",-180785162,null),null,(1),null)),(new cljs.core.List(null,fq_meth_name(method_name),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,rec_type,null,(1),null)),bodies__$2], 0))));
var fexpr__28121 = cljs.core.deref(sci.impl.utils.analyze);
return (fexpr__28121.cljs$core$IFn$_invoke$arity$2 ? fexpr__28121.cljs$core$IFn$_invoke$arity$2(G__28122,G__28123) : fexpr__28121.call(null,G__28122,G__28123));
}
}),impls__$1);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([protocol_impls,raw_protocol_impls], 0));
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"do","do",1686842252,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","declare","cljs.core/declare",1312638100,null),null,(1),null)),(new cljs.core.List(null,record_name,null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,factory_fn_sym,null,(1),null))], 0)))),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"def","def",597100991,null),null,(1),null)),(new cljs.core.List(null,cljs.core.with_meta(record_name,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("sci","type","sci/type",1175422389),true], null)),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("sci.impl.deftype","-create-type","sci.impl.deftype/-create-type",-1020101113,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword("sci.impl","type-name","sci.impl/type-name",-1528979388),(new cljs.core.List(null,new cljs.core.Symbol(null,"quote","quote",1377916282,null),(new cljs.core.List(null,rec_type,null,(1),null)),(2),null)),new cljs.core.Keyword("sci.impl","type","sci.impl/type",1797552241),rec_type,new cljs.core.Keyword("sci.impl","constructor","sci.impl/constructor",1320345666),(new cljs.core.List(null,new cljs.core.Symbol(null,"var","var",870848730,null),(new cljs.core.List(null,factory_fn_sym,null,(1),null)),(2),null)),new cljs.core.Keyword("sci.impl","var","sci.impl/var",-2041185552),(new cljs.core.List(null,new cljs.core.Symbol(null,"var","var",870848730,null),(new cljs.core.List(null,record_name,null,(1),null)),(2),null))], null),null,(1),null))))),null,(1),null))], 0)))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","defn","cljs.core/defn",-1606493717,null),null,(1),null)),(new cljs.core.List(null,factory_fn_sym,null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.vec(cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"&","&",-2144855648,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"args__28085__auto__","args__28085__auto__",992986433,null),null,(1),null)))))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("sci.impl.deftype","->type-impl","sci.impl.deftype/->type-impl",-2121297742,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"quote","quote",1377916282,null),null,(1),null)),(new cljs.core.List(null,rec_type,null,(1),null))))),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,rec_type,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"var","var",870848730,null),null,(1),null)),(new cljs.core.List(null,record_name,null,(1),null))))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","zipmap","cljs.core/zipmap",-1902130674,null),null,(1),null)),(new cljs.core.List(null,(new cljs.core.List(null,new cljs.core.Symbol(null,"quote","quote",1377916282,null),(new cljs.core.List(null,fields,null,(1),null)),(2),null)),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,new cljs.core.Symbol(null,"args__28085__auto__","args__28085__auto__",992986433,null),null,(1),null))], 0)))),null,(1),null))], 0)))),null,(1),null))], 0)))),null,(1),null)),protocol_impls__$1,(new cljs.core.List(null,record_name,null,(1),null))], 0))));
}
}));
...
/** @this {Function} */
(sci.impl.deftype.deftype.cljs$lang$applyTo = (function (seq28086){
var G__28087 = cljs.core.first(seq28086);
var seq28086__$1 = cljs.core.next(seq28086);
var G__28088 = cljs.core.first(seq28086__$1);
var seq28086__$2 = cljs.core.next(seq28086__$1);
var G__28089 = cljs.core.first(seq28086__$2);
var seq28086__$3 = cljs.core.next(seq28086__$2);
var G__28090 = cljs.core.first(seq28086__$3);
var seq28086__$4 = cljs.core.next(seq28086__$3);
var G__28091 = cljs.core.first(seq28086__$4);
var seq28086__$5 = cljs.core.next(seq28086__$4);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28087,G__28088,G__28089,G__28090,G__28091,seq28086__$5);
}));
