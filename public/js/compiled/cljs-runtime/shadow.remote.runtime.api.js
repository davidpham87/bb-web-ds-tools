...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_49159 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_49159(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_49160 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_49160(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_49161 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_49161(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_49162 = (function (thing,opts){
...
var temp__5823__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.meta(thing),cljs.core.with_meta(new cljs.core.Symbol("shadow.remote.runtime.api","describe","shadow.remote.runtime.api/describe",1388020131,null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("cljs.analyzer","no-resolve","cljs.analyzer/no-resolve",-1872351017),true], null)));
if(temp__5823__auto__){
var meta_impl__4552__auto__ = temp__5823__auto__;
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_49162(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_49163 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_49163(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_49164 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_49164(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__49155,callback){
var map__49156 = p__49155;
var map__49156__$1 = cljs.core.__destructure_map(map__49156);
var input = map__49156__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49156__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49156__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
