...
var i_43877 = (0);
while(true){
if((i_43877 < arr.length)){
(arr[i_43877] = null);

var G__43878 = (i_43877 + (1));
i_43877 = G__43878;
continue;
} else {
}
...
var i_43885 = (self__.level + (1));
while(true){
if((i_43885 <= (new_level + (1)))){
(update[i_43885] = self__.header);

var G__43886 = (i_43885 + (1));
i_43885 = G__43886;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_43887 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_43887[i]));
} else {
x__$2.forward.push((((i < links_43887.length))?(links_43887[i]):null));
}

if((i < links_43887.length)){
(links_43887[i] = x__$2);
} else {
links_43887.push(x__$2);
}
...
var i_43908 = (0);
while(true){
if((i_43908 <= self__.level)){
var links_43909 = (update[i_43908]).forward;
if((x__$1 === (((i_43908 < links_43909.length))?(links_43909[i_43908]):null))){
(links_43909[i_43908] = (x__$1.forward[i_43908]));

var G__43910 = (i_43908 + (1));
i_43908 = G__43910;
continue;
} else {
var G__43911 = (i_43908 + (1));
i_43908 = G__43911;
continue;
}
} else {
...
var G__43913 = nx;
var G__43914 = (level__$1 - (1));
x = G__43913;
level__$1 = G__43914;
continue;
} else {
var G__43915 = x;
var G__43916 = (level__$1 - (1));
x = G__43915;
level__$1 = G__43916;
continue;
}
