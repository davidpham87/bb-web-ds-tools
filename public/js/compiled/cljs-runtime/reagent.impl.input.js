...
var G__51896 = shadow_root.activeElement;
active_element = G__51896;
continue;
} else {
...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__51883){
var map__51884 = p__51883;
var map__51884__$1 = cljs.core.__destructure_map(map__51884);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51884__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
if(cljs.core.truth_((function (){var or__4253__auto__ = (!((((node === reagent.impl.input.get_true_active_element())) && (((reagent.impl.input.has_selection_api_QMARK_(node.type)) && (((typeof rendered_value === 'string') && (typeof dom_value === 'string'))))))));
if(or__4253__auto__){
...
var _STAR_force_set_dom_value_STAR__orig_val__51885 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__51886 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__51886);
...
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__51885);
}}));
} else {
...
(jsprops.onChange = (function (p1__51889_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__51889_SHARP_);
}));
