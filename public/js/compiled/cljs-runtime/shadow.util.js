...
var len__4864__auto___46753 = arguments.length;
var i__4865__auto___46754 = (0);
while(true){
if((i__4865__auto___46754 < len__4864__auto___46753)){
args_arr__4885__auto__.push((arguments[i__4865__auto___46754]));

var G__46755 = (i__4865__auto___46754 + (1));
i__4865__auto___46754 = G__46755;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq46687){
var G__46688 = cljs.core.first(seq46687);
var seq46687__$1 = cljs.core.next(seq46687);
var G__46689 = cljs.core.first(seq46687__$1);
var seq46687__$2 = cljs.core.next(seq46687__$1);
var G__46690 = cljs.core.first(seq46687__$2);
var seq46687__$3 = cljs.core.next(seq46687__$2);
var G__46691 = cljs.core.first(seq46687__$3);
var seq46687__$4 = cljs.core.next(seq46687__$3);
var G__46692 = cljs.core.first(seq46687__$4);
var seq46687__$5 = cljs.core.next(seq46687__$4);
var G__46693 = cljs.core.first(seq46687__$5);
var seq46687__$6 = cljs.core.next(seq46687__$5);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46688,G__46689,G__46690,G__46691,G__46692,G__46693,seq46687__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__46736){
var vec__46737 = p__46736;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46737,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46737,(1),null);
