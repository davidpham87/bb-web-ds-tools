...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_41795 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_41795(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_41796 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_41796(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41798 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41798(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41800 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41800(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41801 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41801(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41802 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41802(reader);
}
});
...
var G__41824 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__41825 = s.append(c);
c = G__41824;
s = G__41825;
continue;
}
