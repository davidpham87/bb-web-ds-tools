...
(reagent.impl.template.UnsafeHTML.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/UnsafeHTML");
}));
...
var G__51898 = o;
reagent.impl.template.goog$module$goog$object.set(G__51898,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() {
var G__51916__delegate = function (args){
...
while (G__51917__i < G__51917__a.length) {G__51917__a[G__51917__i] = arguments[G__51917__i + 0]; ++G__51917__i;}
  args = new cljs.core.IndexedSeq(G__51917__a,0,null);
}
return G__51916__delegate.call(this,args);};
G__51916.cljs$lang$maxFixedArity = 0;
G__51916.cljs$lang$applyTo = (function (arglist__51918){
var args = cljs.core.seq(arglist__51918);
return G__51916__delegate(args);
});
...
var G__51899 = o;
reagent.impl.template.goog$module$goog$object.set(G__51899,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() {
var G__51919__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__51919 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__51920__i = 0, G__51920__a = new Array(arguments.length -  0);
while (G__51920__i < G__51920__a.length) {G__51920__a[G__51920__i] = arguments[G__51920__i + 0]; ++G__51920__i;}
  args = new cljs.core.IndexedSeq(G__51920__a,0,null);
}
return G__51919__delegate.call(this,args);};
G__51919.cljs$lang$maxFixedArity = 0;
G__51919.cljs$lang$applyTo = (function (arglist__51921){
var args = cljs.core.seq(arglist__51921);
return G__51919__delegate(args);
});
G__51919.cljs$core$IFn$_invoke$arity$variadic = G__51919__delegate;
return G__51919;
})()
;
} else {
...
var G__51900 = props;
var G__51900__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51900,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__51900);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51900__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__51901 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51901,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__51901;
}
})(),id_class);
...
var temp__5825__auto___51922 = (function (){var and__4251__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___51922)){
var d_51923 = temp__5825__auto___51922;
if((d_51923 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_51923.s}));
} else {
...
var G__51902 = (cljs.core.count(argv) - first_child);
switch (G__51902) {
case (0):
...
var vec__51903 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51903,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51903,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51903,(2),null);
...
var temp__5829__auto___51927 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___51927 == null)){
} else {
var key_51928 = temp__5829__auto___51927;
(jsprops.key = key_51928);
}
...
var temp__5829__auto___51931 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___51931 == null)){
} else {
var key_51932 = temp__5829__auto___51931;
(jsprops.key = key_51932);
}
...
var temp__5829__auto___51933 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___51933 == null)){
} else {
var key_51934 = temp__5829__auto___51933;
(jsprops.key = key_51934);
}
...
var temp__5829__auto___51935 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___51935 == null)){
} else {
var key_51936 = temp__5829__auto___51935;
(jsprops.key = key_51936);
}
...
var temp__5829__auto___51937 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___51937 == null)){
} else {
var key_51938 = temp__5829__auto___51937;
(jsprops.key = key_51938);
}
...
var temp__5829__auto___51939 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___51939 == null)){
} else {
var key_51940 = temp__5829__auto___51939;
(jsprops.key = key_51940);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51906_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__51906_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__51907 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51907,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51907,(1),null);
...
break;
default:
var G__51945 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__51946 = compiler;
v = G__51945;
compiler = G__51946;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template51913 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template51913 = (function (opts,id,fn_to_element,parse_fn,meta51914){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta51914 = meta51914;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template51913.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_51915,meta51914__$1){
var self__ = this;
var _51915__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template51913(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta51914__$1));
}));

(reagent.impl.template.t_reagent$impl$template51913.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_51915){
var self__ = this;
var _51915__$1 = this;
return self__.meta51914;
}));

(reagent.impl.template.t_reagent$impl$template51913.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template51913.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template51913.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template51913.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template51913.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template51913.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta51914","meta51914",217609308,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template51913.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template51913.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template51913");

(reagent.impl.template.t_reagent$impl$template51913.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template51913");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template51913.
 */
reagent.impl.template.__GT_t_reagent$impl$template51913 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template51913(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta51914){
return (new reagent.impl.template.t_reagent$impl$template51913(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta51914));
});

}

return (new reagent.impl.template.t_reagent$impl$template51913(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
